...
/*M55 code for P231213-05924 by shixuanxuan at 20231206 start*/
static bool ucsi_qti_get_usb_online(void)
{
...
/*M55 code for P231213-05924 by shixuanxuan at 20231206 end*/
			    ...
			    struct ucsi_connector_status *status, size_t len)
{
	...
	if (cmd_requested && offset == UCSI_MESSAGE_IN) {
		...
		/*M55 code for P231213-05924 by shixuanxuan at 20231206 start*/
		usb_online = ucsi_qti_get_usb_online();
		if (usb_online && conn_partner_type == UCSI_CONSTAT_PARTNER_TYPE_AUDIO) {
			conn_partner_type = UCSI_CONSTAT_PARTNER_TYPE_DFP;
			pr_info("Detect earphone assert, but vbus is high, return conn_partner_type DFP\n");
		}
		/*M55 code for P231213-05924 by shixuanxuan at 20231206 end*/
