...
__ss_static int __crashkey_parse_dt_name(struct builder *bd,
...
static int __crashkey_parse_dt_debug_level(struct builder *bd,
		struct device_node *np)
{
	struct crashkey_drvdata *drvdata =
			container_of(bd, struct crashkey_drvdata, bd);
...
__ss_static int __crashkey_parse_dt_panic_msg(struct builder *bd,
		struct device_node *np)
{
	struct crashkey_drvdata *drvdata =
			container_of(bd, struct crashkey_drvdata, bd);
...
__ss_static int __crashkey_parse_dt_interval(struct builder *bd,
		struct device_node *np)
{
	struct crashkey_drvdata *drvdata =
			container_of(bd, struct crashkey_drvdata, bd);
...
__ss_static int __crashkey_parse_dt_desired_pattern(struct builder *bd,
		struct device_node *np)
{
	struct crashkey_drvdata *drvdata =
			container_of(bd, struct crashkey_drvdata, bd);
...
__ss_static int __crashkey_probe_prolog(struct builder *bd)
{
	struct crashkey_drvdata *drvdata =
			container_of(bd, struct crashkey_drvdata, bd);
	struct crashkey_notify *notify = &drvdata->notify;
...
__ss_static int __crashkey_init_used_key(struct builder *bd)
{
	struct crashkey_drvdata *drvdata =
			container_of(bd, struct crashkey_drvdata, bd);
	struct device *dev = bd->dev;
