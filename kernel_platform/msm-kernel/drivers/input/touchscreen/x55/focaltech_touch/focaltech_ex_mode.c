...
int fts_ex_mode_recovery(struct fts_ts_data *ts_data)
{
    ...
    /*M55 code for QN6887A-1335 by yuli at 20231117 start*/
    #if FTS_SAMSUNG_FOD_EN
    if (ts_data->fod_enable) {
        fts_write_reg(0xCF, ts_data->fod_enable);
    }
    #endif // FTS_SAMSUNG_FOD_EN
    /*M55 code for QN6887A-1335 by yuli at 20231117 end*/
