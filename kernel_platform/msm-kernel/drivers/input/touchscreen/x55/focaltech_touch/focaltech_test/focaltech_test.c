        ...
        if (ret >= 0) {
            ...
            for (j = 0; j < 20; j++) {
                ...
                if ((ret >= 0) && (0x00 == mode)) {
                    ...
                    /*M55 code for QN6887A-1946 by yubo at 20231225 start*/
                    sys_delay(150);
                    /*M55 code for QN6887A-1946 by yubo at 20231225 end*/
                    return 0;
                } else
                    sys_delay(FACTORY_TEST_DELAY);
            }
...
int fts_ito_test(void)
{
    ...
    if (fts_data->ito_file) {
        snprintf(fwname, FILE_NAME_LENGTH, fts_data->ito_file);
    }
