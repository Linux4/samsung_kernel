...
#define SYNAPTICS_TS_NAME		"synaptics_fold"
#define SYNAPTICS_TS_I2C_NAME		"synaptics_i2c_fold"
...
int synaptics_ts_parse_fw_image(struct synaptics_ts_data *ts, const unsigned char *image,
		struct image_info *image_info);
