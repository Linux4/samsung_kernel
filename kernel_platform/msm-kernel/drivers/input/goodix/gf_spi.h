...
/*chose USE_PLATFORM_BUS or SPI_BUS,qcom don't need EN/DIS clk on AP,so use platform bus default*/
#define  USE_PLATFORM_BUS               1
#define  SAMSUNG_FP_SUPPORT             1
//#define  USE_SPI_BUS	                1

/*support screen_on/off msg notity to hal*/
//#define FB_CALLBACK_NOTITY
#define GF_PW_CTL                       1
