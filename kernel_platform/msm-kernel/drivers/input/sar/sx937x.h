...
#define SMTC_DRIVER_NAME        "SX937x"
#define SMTC_COMPATIBLE_NAME    "Semtech,SX937x"
...
#ifdef CONFIG_CUSTOM_FACTORY_BUILD
/* for right-up sar */
...
#define KEY_SAR4_CLOSE          0x27f
#define KEY_SAR4_FAR            0x280

#define SX937X_FACTORY_NODE
#else
#define SX937X_USER_NODE
#define SX937X_ANFR_LOGIC
