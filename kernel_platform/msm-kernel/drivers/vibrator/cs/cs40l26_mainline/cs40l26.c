		...
		u32 tuning)
{
	...
	if (cs40l26->pdata.is_f0_tracking) {
		strscpy(svc_tuning, CS40L26_SVC_TUNING_FILE_F0_PREFIX,
...
#ifdef CONFIG_CS40L26_SAMSUNG_FEATURE
		if (cs40l26->pdata.is_f0_tracking) {
			strscpy(wt_tuning, CS40L26_WT_FILE_F0_PREFIX,
...
#ifdef CONFIG_CS40L26_SAMSUNG_FEATURE
		if (cs40l26->pdata.is_f0_tracking) {
			strscpy(wt_tuning, CS40L26_WT_FILE_F0_NAME,
...
#ifdef CONFIG_CS40L26_SAMSUNG_FEATURE
		if (cs40l26->pdata.is_f0_tracking)
			strscpy(coeff_files[0], wt_tuning, CS40L26_WT_FILE_F0_CONCAT_NAME_LEN);
		else
	...
	if (cs40l26->fw_id == CS40L26_FW_ID) {
		...
		if (cs40l26->pdata.is_f0_tracking) {
			strscpy(coeff_files[2], svc_tuning,
				tuning ? CS40L26_SVC_TUNING_FILE_F0_CONCAT_NAME_LEN :
