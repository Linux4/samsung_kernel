/*
 * s2asl01_limiter.h
 * Samsung S2ASL01 Limitter Header
 *
...
#ifndef __S2ASL01_LIMITER_H
#define __S2ASL01_LIMITER_H __FILE__
...
#define S2ASL01_LIMITER_CORE_INT1		0x00
#define S2ASL01_LIMITER_CORE_INT2		0x01
#define S2ASL01_LIMITER_PM_INT		0x02
#define S2ASL01_LIMITER_CORE_INT1M		0x03
#define S2ASL01_LIMITER_CORE_INT2M		0x04
#define S2ASL01_LIMITER_PM_INTM		0x05
#define S2ASL01_LIMITER_CORE_STATUS1		0x06
#define S2ASL01_LIMITER_VAL1_VCHG		0x07
#define S2ASL01_LIMITER_VAL2_VCHG		0x08
#define S2ASL01_LIMITER_VAL1_VBAT		0x09
#define S2ASL01_LIMITER_VAL2_VBAT		0x0A
#define S2ASL01_LIMITER_VAL1_ICHG		0x0B
#define S2ASL01_LIMITER_VAL2_ICHG		0x0C
#define S2ASL01_LIMITER_VAL1_IDISCHG		0x0D
#define S2ASL01_LIMITER_VAL2_IDISCHG		0x0E
#define S2ASL01_LIMITER_CORE_CTRL1		0x0F
#define S2ASL01_LIMITER_CORE_CTRL2		0x10
#define S2ASL01_LIMITER_CORE_CTRL3		0x11
#define S2ASL01_LIMITER_CORE_CTRL4		0x12
#define S2ASL01_LIMITER_CORE_CTRL5		0x13
#define S2ASL01_LIMITER_CORE_CTRL6		0x14
#define S2ASL01_LIMITER_CORE_CTRL7		0x15
#define S2ASL01_LIMITER_CORE_CTRL8		0x16
#define S2ASL01_LIMITER_TOP_RECHG_CTRL1	0x17
#define S2ASL01_LIMITER_TOP_EOC_CTRL1		0x18
#define S2ASL01_LIMITER_TOP_EOC_CTRL2		0x19
#define S2ASL01_LIMITER_COMASK_CALDIS		0x1A // ?
#define S2ASL01_LIMITER_PM_ENABLE			0x1B
#define S2ASL01_LIMITER_PM_HYST_LEVEL1	0x1C // ?
#define S2ASL01_LIMITER_PM_HYST_LEVEL2	0x1D
#define S2ASL01_LIMITER_PM_V_OPTION		0x1E
#define S2ASL01_LIMITER_PM_I_OPTION		0x1F
#define S2ASL01_LIMITER_ID			0x29
#define S2ASL01_LIMITER_COMMON1		0x40
...
struct s2asl01_platform_data {
	...
	int bat_det;
	int bat_det2; /* sub_bat_det for main limiter, main_bat_det for sub limiter */
	int bat_enb;
	unsigned int chg_current_limit;
	unsigned int eoc; /* for interrupt setting, not used */
	unsigned int float_voltage; /* for interrupt setting, not used */
	unsigned int hys_vchg_level;
	unsigned int hys_vbat_level;
	unsigned int hys_ichg_level;
	unsigned int hys_idischg_level;
	unsigned int chg_current_fully_turnon;
	bool tsd_en;
};
