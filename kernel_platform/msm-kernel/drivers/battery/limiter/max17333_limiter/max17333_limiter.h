...
enum {
	VSHUTDOWNTHR_3V = 0x1,
	VSHUTDOWNTHR_3_4V = 0x3,
	VSHUTDOWNTHR_3_6V = 0x4,
	VSHUTDOWNTHR_4V = 0x6,
};
...
struct max17333_charger_data {
	...
	bool chg_block;
	unsigned int chg_curr;
	unsigned int chg_vol;
	unsigned int chgen;
	struct workqueue_struct *prot_wqueue;
	struct delayed_work prot_work;	
	struct wakeup_source	*protalrt_wake_lock;
};
