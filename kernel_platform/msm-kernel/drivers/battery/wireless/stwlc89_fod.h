...
#else
static inline struct mfc_fod *stwlc89_mfc_fod_init(struct device *dev, unsigned int fod_size, mfc_set_fod cb_func)
{ return ERR_PTR(MFC_FOD_DISABLED); }

static inline int stwlc89_mfc_fod_init_state(struct mfc_fod *fod)
{ return MFC_FOD_DISABLED; }
static inline int stwlc89_mfc_fod_refresh(struct mfc_fod *fod)
{ return MFC_FOD_DISABLED; }

static inline int stwlc89_mfc_fod_set_op_mode(struct mfc_fod *fod, int op_mode)
{ return MFC_FOD_DISABLED; }
static inline int stwlc89_mfc_fod_set_vendor_id(struct mfc_fod *fod, int vendor_id)
{ return MFC_FOD_DISABLED; }
static inline int stwlc89_mfc_fod_set_tx_id(struct mfc_fod *fod, int tx_id)
{ return MFC_FOD_DISABLED; }
static inline int stwlc89_mfc_fod_set_bat_state(struct mfc_fod *fod, int bat_state)
{ return MFC_FOD_DISABLED; }
static inline int stwlc89_mfc_fod_set_bat_cap(struct mfc_fod *fod, int bat_cap)
{ return MFC_FOD_DISABLED; }
static inline int stwlc89_mfc_fod_set_vout(struct mfc_fod *fod, int vout)
{ return MFC_FOD_DISABLED; }
static inline int stwlc89_mfc_fod_set_high_swell(struct mfc_fod *fod, bool state)
{ return MFC_FOD_DISABLED; }

static inline int stwlc89_mfc_fod_get_state(struct mfc_fod *fod, union mfc_fod_state *state)
{ return MFC_FOD_DISABLED; }
static inline int stwlc89_mfc_fod_get_ext(struct mfc_fod *fod, int ext_type, int *data)
{ return MFC_FOD_DISABLED; }
#endif
