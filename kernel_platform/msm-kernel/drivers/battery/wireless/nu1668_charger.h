...
#define NU1668								1
#define ENABLE_FOD 							1	// 0 means that use the default value in FW.
#define BIN_FILE_TOTAL_LENGTH				32768

#define NU1668_SRAM_BASE_ADDR				0x1200

/* REGISTER MAPS */
#define MFC_CHIP_ID_L_REG					0x00F1//0x1258
#define MFC_CHIP_ID_H_REG					0x00F0//0x1259
...
#define MFC_STATUS_L_REG				   	0x1276
#define MFC_STATUS_H_REG				   	0x1277
#define MFC_INT_A_L_REG						0x1274
#define MFC_INT_A_H_REG						0x1275
#define MFC_INT_A_ENABLE_L_REG				0x1200
#define MFC_INT_A_ENABLE_H_REG				0x1201
#define MFC_INT_A_CLEAR_L_REG				0x1202
#define MFC_INT_A_CLEAR_H_REG				0x1203

//#define MFC_CTRL_STS_REG					0x28  // no used in by Nuvolta

#define MFC_SYS_OP_MODE_REG					0x126B
#define MFC_BATTERY_CHG_STATUS_REG			0x1214
#define MFC_EPT_REG							0x1215 /* EPT(End of Power Transfer) cases. PMA has only EOC case */
#define MFC_ADC_VOUT_L_REG					0x127A
#define MFC_ADC_VOUT_H_REG					0x127B

#define MFC_VOUT_SET_L_REG					0x1216
#define MFC_VOUT_SET_H_REG					0x1217
#define MFC_VRECT_ADJ_REG					0x1218
...
#define MFC_TX_IUNO_LIMIT_L_REG				0x1238
#define MFC_TX_IUNO_LIMIT_H_REG				0x1239
...
#define MFC_ILIM_SET_REG					0x1219 /* ILim =  value * 0.1(A) + 0.1(A). 1.3A = 12*0.1 + 0.1 */
...
/* Common */
#define MFC_WPC_TRX_DATA2_COM_REG	        0x1210
#define MFC_WPC_TRX_DATA2_VALUE0_REG		0x1211
#define MFC_WPC_TRX_DATA2_VALUE1_REG		0x1212
/********************************************************************************/

#define MFC_ADT_TIMEOUT_PKT_REG				0x121B
#define MFC_ADT_TIMEOUT_STR_REG				0x121C

#define MFC_TX_IUNO_HYS_REG					0x123A
#define MFC_TX_IUNO_OFFSET_L_REG			0x123C
#define MFC_TX_IUNO_OFFSET_H_REG			0x123D

#define MFC_TX_OC_FOD1_LIMIT_L_REG			0x124C
#define MFC_TX_OC_FOD1_LIMIT_H_REG			0x124D
#define MFC_TX_OC_FOD2_LIMIT_L_REG			0x124E
...
#define MFC_TX_MAX_OP_FREQ_L_REG			0x1244 /* default 0x88 */
#define MFC_TX_MAX_OP_FREQ_H_REG			0x1245 /* default 0x02 */
/* TX Min Operating Frequency = 96 MHz/value, default is 113kHz (96MHz/0x351=113KHz) */
#define MFC_TX_MIN_OP_FREQ_L_REG			0x1246 /* default 0x51 */
#define MFC_TX_MIN_OP_FREQ_H_REG			0x1247 /* default 0x03 */
/* TX Digital Ping Frequency = 96 MHz/value, default is 145kHz (96MHz/0x296=145KHz) */
#define MFC_TX_PING_FREQ_L_REG				0x1248 /* default 0x96 */
#define MFC_TX_PING_FREQ_H_REG				0x1249 /* default 0x02 */
/* TX Mode Minimum Duty Setting Register, Min_Duty, default is 20%. value/256 * 100(0x33=20) */
#define MFC_TX_MIN_DUTY_SETTING_REG			0x124A /* default 0x33 */

#define MFC_INVERTER_CTRL_REG				0x124B  // not implemented. P2P HALF : 0x4B[7]
#define MFC_CMFET_CTRL_REG					0x121E

/* RX Mode Communication Modulation FET Ctrl */
#define MFC_MST_MODE_SEL_REG				0x1255
#define MFC_RX_OV_CLAMP_REG					0x121F
...
#define MFC_TX_FOD_CTRL_REG					0x1241 // this ?
//#define MFC_RC_PHM_PING_PERIOD_REG			0x1221 in RX mode. Not Implemented.

#define MIN_DUTY_SETTING_20_DATA	20
#define MIN_DUTY_SETTING_30_DATA	30
#define MIN_DUTY_SETTING_50_DATA	50

#define MFC_WPC_FOD_0A_REG					0x1224
#define MFC_WPC_FOD_0B_REG					0x1225
#define MFC_WPC_FOD_1A_REG					0x1226
#define MFC_WPC_FOD_1B_REG					0x1227
#define MFC_WPC_FOD_2A_REG					0x1228
#define MFC_WPC_FOD_2B_REG					0x1228
#define MFC_WPC_FOD_3A_REG					0x122A
#define MFC_WPC_FOD_3B_REG					0x122B
#define MFC_WPC_FOD_4A_REG					0x122C
#define MFC_WPC_FOD_4B_REG					0x122D
#define MFC_WPC_FOD_5A_REG					0x122E
#define MFC_WPC_FOD_5B_REG					0x122F
#define MFC_WPC_FOD_6A_REG					0x1230
#define MFC_WPC_FOD_6B_REG					0x1231
#define MFC_WPC_FOD_7A_REG					0x1232
#define MFC_WPC_FOD_7B_REG					0x1233
#define MFC_WPC_FOD_8A_REG					0x1234
#define MFC_WPC_FOD_8B_REG					0x1235
#define MFC_WPC_FOD_9A_REG					0x1236
#define MFC_WPC_FOD_9B_REG					0x1237
...
#define MFC_TX_FOD_GAIN_REG					0x1254
#define MFC_TX_FOD_OFFSET_L_REG				0x1250
#define MFC_TX_FOD_OFFSET_H_REG				0x1251
#define MFC_TX_FOD_THRESH1_L_REG			0x1252
...
#define MFC_TX_ID_VALUE_L_REG				0x1242
#define MFC_TX_ID_VALUE_H_REG				0x1243

#define MFC_DEMOD1_REG						0x123E
#define MFC_DEMOD2_REG						0x123F
...
#define MFC_CEP_TIME_OUT_REG				0x123B
...
#define MFC_FW_TIMER_CODE_0					0x126C
#define MFC_FW_TIMER_CODE_1					0x126D
#define MFC_FW_TIMER_CODE_2					0x126E
#define MFC_FW_TIMER_CODE_3					0x126F
#define MFC_FW_TIMER_CODE_4					0x1270
#define MFC_FW_TIMER_CODE_5					0x1271
#define MFC_FW_TIMER_CODE_6					0x1272
#define MFC_FW_TIMER_CODE_7					0x1273

#define MFC_PWR_HOLD_INTERVAL_REG			0x1240
...
#define MFC_RPP_SCALE_COEF_REG				0x1222
...
#define MFC_TX_Q_SSPTH_REG					0x121A
#define MFC_TX_Q_BASE_L_REG					0x129C
#define MFC_TX_Q_BASE_H_REG					0x129D
#define MFC_TX_COEFF_QFOD_TH0_REG			0x121D
#define MFC_TX_COEFF_QFOD_TH1_REG			0x1220
#define MFC_TX_COEFF_QFOD_TH2_REG			0x1256
#define MFC_TX_COEFF_QFOD_TH3_REG			0x1257
#define MFC_TX_COEFF_QFOD_TWS_TH3_L_REG		0x129E
#define MFC_TX_COEFF_QFOD_TWS_TH3_H_REG		0x129F
#define MFC_TX_COEFF_QFOD_PHONE_TH4_L_REG	0x12A0
