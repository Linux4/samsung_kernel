...
/* TX Min Operating Frequency = value/10kHz, default is 111KHz (0x456/10kHz = 111KHz) */
#define MFC_TX_MIN_OP_FREQ_L_REG			0x62 /* default 0x56 */
#define MFC_TX_MIN_OP_FREQ_H_REG			0x63 /* default 0x4 */
/* TX Digital Ping Frequency = value/10kHz, default is 145KHz (0x5AA/10kHz = 145KHz) */
#define MFC_TX_PING_FREQ_L_REG				0x64 /* default 0xAA */
#define MFC_TX_PING_FREQ_H_REG				0x65 /* default 0x5 */
