...
#define MFC_FLASH_FW_HEX_STM_ROM2_PATH	"mfc/mfc_fw_flash_stwlc89_rom2.bin" /* ROM2 */
#define MFC_FLASH_FW_HEX_STM_PATH	"mfc/mfc_fw_flash_stwlc89.bin" /* ROM3 */
/* for SPU FW update */
#define MFC_FW_SPU_BIN_PATH		"mfc/mfc_fw_spu_stwlc89.bin"

#define MFC_CHIP_REV_ROM2					0x10
#define MFC_CHIP_REV_ROM3					0x20
...
#define MFC_MPP_EPP_POTENTIAL_LOAD_POWER_L_REG  0xA6
#define MFC_MPP_EPP_POTENTIAL_LOAD_POWER_H_REG	0xA7
#define MFC_MPP_EPP_NEGOTIABLE_LOAD_POWER_L_REG 0xA8
#define MFC_MPP_EPP_NEGOTIABLE_LOAD_POWER_H_REG	0xA9
...
#define MFC_MPP_THERMAL_CTRL_REG	            0xAE
#define MFC_TX_WPC_AUTH_SUPPORT_REG	            0xAA

#define MFC_MPP_PROTOCOL_SELECT					0
#define MFC_MPP_PROTOCOL_SELECT_EPP				0
...
#define E_UNMATCHED_CHIP_REV_ID			0x8000000E
