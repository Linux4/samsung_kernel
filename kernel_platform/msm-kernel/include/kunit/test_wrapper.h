...
#define __module_test_suites(unique_array, unique_suites, ...)                 \
	static struct kunit_suite *unique_array[] = { __VA_ARGS__, NULL };     \
	static struct kunit_suite **unique_suites                              \
	__used __section(".kunit_test_suites") = unique_array

#define module_test_suites(__suites...)                                         \
	__module_test_suites(__UNIQUE_ID(array),	                        \
			    __UNIQUE_ID(suites),                                \
			    ##__suites)

// kunit_test_suite
#define module_test(suite)	module_test_suites((struct kunit_suite *)&suite)
// END
