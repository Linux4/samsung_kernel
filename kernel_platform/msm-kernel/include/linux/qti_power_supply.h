...
#define QTI_POWER_SUPPLY_TYPE_BMS		24
#define POWER_SUPPLY_TYPE_PARALLEL		25/* Parallel Path */
#define POWER_SUPPLY_TYPE_MAIN			26/* Main Path */
#define POWER_SUPPLY_TYPE_WIPOWER		27/* Wipower */
#define POWER_SUPPLY_TYPE_UFP			28/* Type-C UFP */
#define POWER_SUPPLY_TYPE_DFP			29/* Type-C DFP */
#define POWER_SUPPLY_TYPE_CHARGE_PUMP	30
