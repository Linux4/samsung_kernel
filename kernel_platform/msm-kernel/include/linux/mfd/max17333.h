...
#define MAX17333_RELEASE_VERSION	"2.2.34"
...
#define REG_HCHGTARG             0x79
#define REG_HCHGPWM              0x7A
...
#define REG_SOCHOLD              0xD0
#define REG_AVGCELL1             0xD4
#define REG_PROTSTATUS           0xD9
#define REG_FPROTSTAT            0xDA
#define REG_PCKP                 0xDB
#define REG_ODSCTH2              0xEE
#define REG_HPROTCFG             0xF0
#define REG_HPROTCFG2            0xF1
#define REG_ODSCCFG              0xF3
#define REG_SLEEP                0xF7
#define REG_VFOCV                0xFB
#define REG_VFSOC                0xFF

#define REG_TESTLOCK1            0x68
#define REG_TESTLOCK2            0x69
#define REG_TESTLOCK3            0x7E
#define REG_TESTCTRL             0x6A
...
#define REG_PROTALRTS_MASK	   0x0000
#define REG_PROTSTATUS_MASK	   0x0000

#define MAX17333_PROT_INT_MASK 0xFF80
...
#define BIT_CONFIG_PROTALRT_EN	BIT(0)

/* Odscth2 register bits for MAX17333 */
#define MAX17333_ODSCTH2_CCTH BITS(15, 9)
...
#define BIT_STATUS_RESERVE    BIT(0)

#define REG_STATUS_MASK       0x007F
...
/* nDesignCap register bits for MAX17333 */
#define MAX17333_NDESIGNCAP_VSCALE  BIT(3)

/* nVChgCfg1 register bits for MAX17333 */
#define MAX17333_NVCHGCFG1_ROOMCHGVOL  BITS(11, 4)

/* nOVPrtTh register bits for MAX17333 */
#define MAX17333_NOVPRTTH_DOVP  BITS(10, 6)
...
#define MAX17333_I2CCMD_MG_PCKP  BIT(14)
...
/* SOCHold register bits for MAX17333 */
#define MAX17333_SOC_HOLD_EN   BIT(12)

/* nChgCtrl2 register bits for MAX17333 */
#define MAX17333_NCHGCTRL2_MG_PCKP  BIT(5)
#define MAX17333_NCHGCTRL2_DISAUTOCHG  BIT(4)

/* ODSCCFG register bits for MAX17333 */
#define MAX17333_ODSCCFG_OCI  BIT(5)
...
/* Model Gauge PCKP */
enum {
	MAX17333_VCELL_EQUAL_VBATT = 0,
	MAX17333_VCELL_EQUAL_PKCP,
};
