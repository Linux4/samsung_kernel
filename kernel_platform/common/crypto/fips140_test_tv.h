...
const struct aead_testvec aes_gcm_tv_template[] = {
...
const struct drbg_testvec drbg_pr_hmac_sha256_tv_template[] = {
	{
...
const struct drbg_testvec drbg_nopr_hmac_sha256_tv_template[] = {
	{
...
const struct aead_test_suite aes_gcm_tv = {
	aes_gcm_tv_template,
	ARRAY_SIZE(aes_gcm_tv_template),
};

const struct drbg_test_suite drbg_pr_hmac_sha256_tv = {
	drbg_pr_hmac_sha256_tv_template,
	ARRAY_SIZE(drbg_pr_hmac_sha256_tv_template),
};

const struct drbg_test_suite drbg_nopr_hmac_sha256_tv = {
