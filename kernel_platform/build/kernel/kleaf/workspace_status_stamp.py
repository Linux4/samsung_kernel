...
def main():
  ...
  # NOTE: ES1 Pre-Release - Samsung does not use 'git' for managing the kernel
  # source tree.
  has_kernel_dir = os.path.isdir(kernel_dir + ".git")
@dataclasses.dataclass
...
if __name__ == '__main__':
    ...
    # SS server can not exec this script due to NO git repo, just return default string to avoid build err
    print("STABLE_SOURCE_DATE_EPOCHS", 0)
    print("STABLE_SCMVERSIONS", 0)
    sys.exit(0)
    #sys.exit(Stamp().main())
