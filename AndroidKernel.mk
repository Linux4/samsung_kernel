...
A5LTE_JPN_KDI_PROJECT ?= $(shell $(PERL) -e '$$of = "n"; while (<>) { if (/CONFIG_MACH_A5LTE_JPN_KDI=y/) { $$of = "y"; break; } } print $$of;' $(KERNEL_CONFIG))
...
HESTIALTE_PROJECT ?= $(shell $(PERL) -e '$$of = "n"; while (<>) { if (/CONFIG_MACH_HESTIALTE_EUR=y/) { $$of = "y"; break; } } print $$of;' $(KERNEL_CONFIG))
HESTIAATT_PROJECT ?= $(shell $(PERL) -e '$$of = "n"; while (<>) { if (/CONFIG_MACH_HESTIALTE_ATT=y/) { $$of = "y"; break; } } print $$of;' $(KERNEL_CONFIG))
...
ifeq "$(A5LTE_JPN_KDI_PROJECT)" "y"
DTS_FILES = $(wildcard $(TOP)/kernel/arch/arm/boot/dts/msm8226/msm8928-sec-a5lte_jpn_kdi*.dts)
endif
...
ifeq "$(HESTIALTE_PROJECT)" "y"
DTS_FILES = $(wildcard $(TOP)/kernel/arch/arm/boot/dts/msm8226/$msm8928-sec-hestia-r*.dts)
endif
ifeq "$(HESTIAATT_PROJECT)" "y"
DTS_FILES = $(wildcard $(TOP)/kernel/arch/arm/boot/dts/msm8226/$msm8928-sec-hestialteatt*.dts)
endif
