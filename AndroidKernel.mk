...
#+chk72538, xieshuaishuai.wt, ADD, 20201125, enable kernel debug feature
...
KERNEL_CONFIG_OVERRIDE += CONFIG_RMNET_DATA_DEBUG_PKT=y
KERNEL_CONFIG_OVERRIDE += CONFIG_CORESIGHT=y
KERNEL_CONFIG_OVERRIDE += CONFIG_CORESIGHT_LINK_AND_SINK_TMC=y
KERNEL_CONFIG_OVERRIDE += CONFIG_CORESIGHT_QCOM_REPLICATOR=y
KERNEL_CONFIG_OVERRIDE += CONFIG_CORESIGHT_STM=y
KERNEL_CONFIG_OVERRIDE += CONFIG_CORESIGHT_TPDA=y
KERNEL_CONFIG_OVERRIDE += CONFIG_CORESIGHT_TPDM=y
KERNEL_CONFIG_OVERRIDE += CONFIG_CORESIGHT_EVENT=y
KERNEL_CONFIG_OVERRIDE += CONFIG_CORESIGHT_HWEVENT=y
endif
...
#+chk72538, xieshuaishuai.wt, MODIFY, 20201125, enable kernel debug feature
