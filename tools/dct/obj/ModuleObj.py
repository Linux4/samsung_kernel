...
class ModuleObj:
    ...
    def writeComment():
        ...
        gen_str += ''' *This program is free software: you can redistribute it and/or modify\n'''
        gen_str += ''' *it under the terms of the GNU General Public License version 2 as\n'''
        gen_str += ''' *published by the Free Software Foundation.\n'''
        gen_str += ''' *\n'''
        gen_str += ''' *This program is distributed in the hope that it will be useful,\n'''
        gen_str += ''' *but WITHOUT ANY WARRANTY; without even the implied warranty of\n'''
        gen_str += ''' *MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE. See the\n'''
        gen_str += ''' *GNU General Public License for more details.\n'''
        gen_str += ''' *\n'''
        gen_str += ''' *You should have received a copy of the GNU General Public License\n'''
        gen_str += ''' *along with this program.\n'''
        gen_str += ''' *If not, see <http://www.gnu.org/licenses/>.\n'''
        gen_str += ''' */\n\n'''
