...
kunit_notifier_chain_init(max77775_alternate_test_module);
...
int test_executor_init(void)
{
	...
	int noti = 0;
#endif
#if IS_BUILTIN(CONFIG_KUNIT_TEST) // FIXME:
...
static __init int kunit_notifier_init(void)
{
	...
	*/
	...
	kunit_notifier_chain_register(max77775_alternate_test_module);
