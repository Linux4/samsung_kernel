...
#if defined(CONFIG_MACH_GRANDPRIMEVE3G) || defined(CONFIG_MACH_COREPRIMEVE3G) || defined(CONFIG_MACH_GRANDPRIME_DTV) || defined(CONFIG_MACH_J23G)
	extern bool factory_syssleep;
#endif
