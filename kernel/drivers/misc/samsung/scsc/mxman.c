...
static void mxman_failure_work(struct work_struct *work)
{
	...
	mif->irq_bit_set(mif, MIFINTRBIT_RESERVED_PANIC_WLAN, SCSC_MIF_ABS_TARGET_WLAN); /* SCSC_MIFINTR_TARGET_WLAN */
#ifdef CONFIG_SCSC_MX450_GDB_SUPPORT
	SCSC_TAG_INFO(MXMAN, "Setting MIFINTRBIT_RESERVED_PANIC_FXM_1\n");
	mif->irq_bit_set(mif, MIFINTRBIT_RESERVED_PANIC_FXM_1, SCSC_MIF_ABS_TARGET_FXM_1); /* SCSC_MIFINTR_TARGET_FXM_1 */
	SCSC_TAG_INFO(MXMAN, "Setting MIFINTRBIT_RESERVED_PANIC_FXM_2\n");
	mif->irq_bit_set(mif, MIFINTRBIT_RESERVED_PANIC_FXM_2, SCSC_MIF_ABS_TARGET_FXM_2); /* SCSC_MIFINTR_TARGET_FXM_2 */
#else
	SCSC_TAG_INFO(MXMAN, "Setting MIFINTRBIT_RESERVED_PANIC_FXM_1\n");
	mif->irq_bit_set(mif, MIFINTRBIT_RESERVED_PANIC_FXM_1, SCSC_MIF_ABS_TARGET_FXM_1); /* SCSC_MIFINTR_TARGET_FXM_1 */
#endif
