...
static void max77775_muic_enable_detecting_short(struct max77775_muic_data *muic_data)
{
...
static void max77775_muic_print_reg_log(struct work_struct *work)
{
	...
	md75_info_usb("%s USBC1:0x%02x, USBC2:0x%02x, BC:0x%02x, CC0:0x%x, CC1:0x%x, PD0:0x%x, PD1:0x%x attached_dev:%d\n",
