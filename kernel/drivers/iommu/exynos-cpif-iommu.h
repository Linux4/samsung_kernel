...
#define REG_MMU_CTRL_VID	0x8000
#define REG_MMU_CFG_VID		0x8004
#define REG_PT_BASE_PPN		0x800C
...
#define VID_CFG_USE_MASTER_SHAREABLE	(1 << 27)
...
#define REG_FAULT_ADDR_VA	0x1000
#define REG_FAULT_INFO0		0x1004
#define REG_FAULT_INFO1		0x1008
