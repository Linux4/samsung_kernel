...
#define EXYNOS_USBCON_VER_08_0_0 0x0800 /* dwc usb3p2/dp PHY controller, 9925 */
#define EXYNOS_USBCON_VER_08_0_1 0x0801 /* dwc usb3p2/dp PHY controller, 9945 */
...
struct exynos_usbphy_info {
	...
	/* Structure for additional Inforamtion */
	void *add_info;
