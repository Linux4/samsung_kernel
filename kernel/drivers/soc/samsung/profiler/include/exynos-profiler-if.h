...
extern s32 exynos_profiler_get_pb_margin_info(int id, u16 *no_boost);
extern void exynos_profiler_set_pb_params(int idx, int value);
extern int exynos_profiler_get_pb_params(int idx);
#endif
...
#if (PROFILER_VERSION >= 2)
s32 exynos_profiler_get_pb_margin_info(int id, u16 *no_boost) { PROFILER_UNUSED(id); PROFILER_UNUSED(no_boost); };
void exynos_profiler_set_pb_params(int idx, int value) { PROFILER_UNUSED(idx); PROFILER_UNUSED(value); };
int exynos_profiler_get_pb_params(int idx) { PROFILER_UNUSED(idx); };
#endif
#else
