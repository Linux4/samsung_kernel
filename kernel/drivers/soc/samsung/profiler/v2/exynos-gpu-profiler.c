#include <v2/exynos-gpu-profiler.h>
...
s32 gpupro_get_pb_margin_info(int id, u16 *no_boost)
{
	return exynos_profiler_get_pb_margin_info(id, no_boost);
}

void gpupro_set_pb_params(int idx, int value)
{
	exynos_profiler_set_pb_params(idx, value);
}

int gpupro_get_pb_params(int idx)
{
	return exynos_profiler_get_pb_params(idx);
}
...
struct private_fn_gpu gpu_pd_fn = {
	...
	.get_pb_margin_info	= &gpupro_get_pb_margin_info,
