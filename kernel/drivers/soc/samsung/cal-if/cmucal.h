...
#define FIXEDFACTOR(_id, _pid, _ratio)		\
[_id & MASK_OF_ID] = {	\
	.clk.id		= _id,				\
	.clk.pid	= _pid,				\
	.clk.name	= #_id,				\
...
extern unsigned int mux_dbg_offset;
extern unsigned int gate_dbg_offset;
extern unsigned int top_gate_dbg_offset;
...
extern void get_high_freq_pll_idx(int *high_freq_pll_list);
