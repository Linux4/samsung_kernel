...
enum qch_id {
    ...
    LH_AST_MI_OTF0_RGBP_MCFP_QCH,
    LH_AST_MI_OTF1_RGBP_MCFP_QCH,
    ...
    LH_AXI_MI_LD8_MCSC_MCFP_QCH,
    LH_AXI_MI_LD9_MCSC_MCFP_QCH,
    ...
    SYSREG_MCFP_QCH,
    LH_AST_MI_IOTF0_MCSC_QCH,
    LH_AST_MI_IOTF1_MCSC_QCH,
    ...
    SYSREG_MCSC_QCH,
    LH_AST_MI_OTF_MCFP_MCSC_QCH,
    LH_AST_MI_OTF_YUVP_MCSC_QCH,
    LH_AST_SI_IOTF0_MCSC_QCH,
    LH_AST_SI_IOTF1_MCSC_QCH,
    LH_AXI_SI_LD7_MCSC_MCFP_QCH,
    LH_AXI_SI_LD8_MCSC_MCFP_QCH,
    LH_AXI_SI_LD9_MCSC_MCFP_QCH,
    SHRP_QCH,
    SHRP_QCH_VOTF0,
    VGEN_LITE_SHRP_QCH,
    ...
    LH_ACEL_MI_ID0_IF_G3D_QCH,
    LH_ACEL_MI_ID1_IF_G3D_QCH,
    LH_ACEL_MI_ID2_IF_G3D_QCH,
    LH_ACEL_MI_ID3_IF_G3D_QCH,
    ...
    LH_ACEL_SI_ID0_IF_G3D_QCH,
    LH_ACEL_SI_ID1_IF_G3D_QCH,
    LH_ACEL_SI_ID2_IF_G3D_QCH,
    LH_ACEL_SI_ID3_IF_G3D_QCH,
    BAAW_P_MODEM_QCH,
    BAAW_P_PERIM_G3D_QCH,
    BDU_QCH,
    CACHEAID_NOCL0_QCH,
    CMU_NOCL0_QCH,
    D_TZPC_NOCL0_QCH,
    ...
    PPMU_TREX_P_PERIM_G3D_QCH,
    SIU_G7_PPMU_NOCL0_QCH,
    ...
    LH_AST_SI_OTF0_RGBP_MCFP_QCH,
    LH_AST_SI_OTF1_RGBP_MCFP_QCH,
