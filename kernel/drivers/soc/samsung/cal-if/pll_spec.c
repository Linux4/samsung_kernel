...
static unsigned int __pll_find_m(unsigned long long p, unsigned int s,
...
static int __pll_find_k(unsigned long long p, unsigned long long m, unsigned int s,
				 unsigned long long fin,
				 unsigned long long rate)
{
	rate <<= 16;
...
static unsigned int __pll_find_f(unsigned long long p, unsigned long long m, unsigned int s,
				 unsigned long long fin,
				 unsigned long long rate)
{
	rate <<= 24;
