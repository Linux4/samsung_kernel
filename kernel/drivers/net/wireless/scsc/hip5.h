...
#define HIP5_WLAN_TX_DAT_SIZE	0x280000 /* 2.5 MB */
/*** TX POOL - CTL POOL ***/
...
#define HIP5_WLAN_TOTAL_MEM	(HIP5_WLAN_CONFIG_SIZE + HIP5_WLAN_MIB_SIZE + \
				 HIP5_WLAN_TX_SIZE + HIP5_WLAN_RX_SIZE + HIP5_WLAN_DPD_BUF_SIZE) /* 764 KB + 32 KB + 3036 KB + 128 KB + 64 KB + 512 KB = 4536KB out of 4764KB */
#else
/*** TX POOL ***/
#define HIP5_WLAN_TX_OFFSET	(HIP5_WLAN_MIB_OFFSET + HIP5_WLAN_MIB_SIZE)
/*** TX POOL - DAT POOL ***/
...
/*** TOTAL : CONFIG POOL + TX POOL + RX POOL ***/
#define HIP5_WLAN_TOTAL_MEM	(HIP5_WLAN_CONFIG_SIZE + HIP5_WLAN_MIB_SIZE + \
				 HIP5_WLAN_TX_SIZE + HIP5_WLAN_RX_SIZE) /* 764 KB + 32 KB + 3328 KB + 512 KB + 64 KB  = 4700KB out of 4864KB */
#endif
