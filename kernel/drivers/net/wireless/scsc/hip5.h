...
#define HIP5_WLAN_TX_DATA_SIZE	    0x280000 /* 2.5 MB */
...
#define HIP5_WLAN_ZERO_COPY_RX_SIZE	0x200000 /* 1.5 MB */
...
#define HIP5_WLAN_ZERO_COPY_TOTAL_MEM	(HIP5_WLAN_CONFIG_SIZE + HIP5_WLAN_MIB_SIZE + \
				 HIP5_WLAN_ZERO_COPY_TX_SIZE + HIP5_WLAN_ZERO_COPY_RX_SIZE + HIP5_WLAN_DPD_BUF_SIZE)
...
#define SLSI_HIP_HIP5_OPT_INVALID_OFFSET 255
