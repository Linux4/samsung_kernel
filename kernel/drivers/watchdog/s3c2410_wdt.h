...
#define S5E9945_CLUSTER0_NONCPU_INT_EN		(0x1244)
#define S5E9945_CLUSTER2_NONCPU_INT_EN		(0x1844)
#define EXYNOS9945_RST_STAT_REG_OFFSET		(0x10)
#define S5E8845_CLUSTER0_NONCPU_INT_EN          (0x1244)
#define S5E8845_CLUSTER1_NONCPU_INT_EN          (0x1544)
#define EXYNOS8845_RST_STAT_REG_OFFSET          (0x10)
