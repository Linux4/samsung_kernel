...
/*
 * drivers/media/radio/exynos/s621/fm_low_struc.h
 *
 * Property and FM data define for SAMSUNG S621 chip
 *
...
#define USE_ADC_IQ_RESET
#undef USE_ADC_IQ_RESET
