...
/*
 * drivers/media/radio/exynos/s621/s621_io_map.h
 *
...
/* Declarations of read/write registers */
#define FM_SPEEDY_CTRL                                (0x10004000) /* RW  27 bits */
#define FM_SPEEDY_SLEEP_EN                            (0x10004004) /* RW   1 bits */
#define FM_SPEEDY_APB_CLK_FORCE                       (0x10004008) /* RW   1 bits */
#define FM_SPEEDY_CTRL_STAT_CLEAR                     (0x1000400C) /* RW   1 bits */
#define FM_SPEEDY_READBACK_LATENCY                    (0x10004010) /* RW   1 bits */
#define FM_SPEEDY_PAD_CTRL                            (0x10004014) /* RW   9 bits */
...
#define FM_SPEEDY_ADDR_MAX                            (0x10007020)
