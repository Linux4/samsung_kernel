...
/*
 * drivers/media/radio/exynos/s621/radio-s621.h
 *
 * V4L2 driver header for SAMSUNG s621 chip
 *
...
#define DEBUG_AUDIO_FM_CLK
#undef DEBUG_AUDIO_FM_CLK
...
#define V4L2_CID_USER_S621_BASE		(0x00980900 + 0x1070)
enum s621_ctrl_id {
	V4L2_CID_S621_CH_SPACING  = (V4L2_CID_USER_S621_BASE + 0x01),
	V4L2_CID_S621_CH_BAND    = (V4L2_CID_USER_S621_BASE + 0x02),
	V4L2_CID_S621_SOFT_STEREO_BLEND = (V4L2_CID_USER_S621_BASE + 0x03),
	V4L2_CID_S621_SOFT_STEREO_BLEND_COEFF = (V4L2_CID_USER_S621_BASE+0x04),
	V4L2_CID_S621_SOFT_MUTE_COEFF = (V4L2_CID_USER_S621_BASE + 0x5),
	V4L2_CID_S621_RSSI_CURR	= (V4L2_CID_USER_S621_BASE + 0x06),
	V4L2_CID_S621_SNR_CURR	= (V4L2_CID_USER_S621_BASE + 0x07),
	V4L2_CID_S621_SEEK_CANCEL	= (V4L2_CID_USER_S621_BASE + 0x08),
	V4L2_CID_S621_SEEK_MODE	= (V4L2_CID_USER_S621_BASE + 0x09),
	V4L2_CID_S621_RDS_ON = (V4L2_CID_USER_S621_BASE + 0x0A),
	V4L2_CID_S621_IF_COUNT1 = (V4L2_CID_USER_S621_BASE + 0x0B),
	V4L2_CID_S621_IF_COUNT2 = (V4L2_CID_USER_S621_BASE + 0x0C),
	V4L2_CID_S621_RSSI_TH = (V4L2_CID_USER_S621_BASE + 0x0D),
	V4L2_CID_S621_KERNEL_VER = (V4L2_CID_USER_S621_BASE + 0x0E),
	V4L2_CID_S621_SOFT_STEREO_BLEND_REF = (V4L2_CID_USER_S621_BASE+0x0F),
	V4L2_CID_S621_REG_RW_ADDR = (V4L2_CID_USER_S621_BASE + 0x10),
	V4L2_CID_S621_REG_RW = (V4L2_CID_USER_S621_BASE + 0x11),
...
/*	enum s621_power_state power_state;*/
	u8 power_mode;
	wait_queue_head_t  rds_read_queue;
};

/**
 * s621_core_lock() - lock the core device to get an exclusive access
 * to it.
 */
static inline void s621_core_lock_init(struct s621_core *core)
{
 ...
 * to it.
 */
static inline void s621_core_lock(struct s621_core *core)
{
 ...
 * to it.
 */
static inline  int __must_check s621_core_lock_interruptible(
		struct s621_core *core)
{
	int ret;
...
/**
 * s621_core_unlock() - unlock the core device to relinquish an
 * exclusive access to it.
 */
static inline void s621_core_unlock(struct s621_core *core)
{
...
enum s621_freq_bands {
	S621_BAND_FM,
	S621_BAND_AM,
};

enum s621_freq_bands_fm {
	S621_BAND_FM_US,
	S621_BAND_FM_JAPAN,
	S621_BAND_FM_CUSTOM,
	S621_BAND_FM_BAND_MAX,
};
...
/**
 * struct s621_radio - radio device
 *
 * @core: Pointer to underlying core device
 * @videodev: Pointer to video device created by V4L2 subsystem
 * @ops: Vtable of functions. See struct s621_radio_ops for details
...
/* Pin control */
	...
	struct pinctrl_state *pinctrl_state_elna;
...
extern bool fm_radio_on(struct s621_radio *radio);
extern void fm_radio_off(struct s621_radio *radio);
extern void fm_rds_on(struct s621_radio *radio);
extern void fm_rds_off(struct s621_radio *radio);
extern void fm_set_band(struct s621_radio *radio, u8 index);
extern int fm_boot(struct s621_radio *radio);
extern void fm_power_off(void);

extern int low_get_search_lvl(struct s621_radio *radio, u16 *value);
extern u16 fm_get_flags(struct s621_radio *radio);
extern int low_set_if_limit(struct s621_radio *radio, u16 value);
extern int low_set_search_lvl(struct s621_radio *radio, u16 value);
extern int low_set_freq(struct s621_radio *radio, u32 value);
extern int low_set_tuner_mode(struct s621_radio *radio, u16 value);
extern int low_set_mute_state(struct s621_radio *radio, u16 value);
extern int low_set_most_mode(struct s621_radio *radio, u16 value);
extern int low_set_most_blend(struct s621_radio *radio, u16 value);
extern int low_set_pause_lvl(struct s621_radio *radio, u16 value);
extern int low_set_pause_dur(struct s621_radio *radio, u16 value);
extern int low_set_demph_mode(struct s621_radio *radio, u16 value);
extern int low_set_rds_cntr(struct s621_radio *radio, u16 value);
extern int low_set_power(struct s621_radio *radio, u16 value);
extern u8 aggr_rssi_device_to_host(u16 val);
extern void fm_isr(struct s621_radio *radio);
extern void cancel_tuner_timer(struct s621_radio *radio);
extern int init_low_struc(struct s621_radio *radio);
extern void fm_speedy_m_int_enable(void);
extern void fm_speedy_m_int_disable(void);
#ifdef	ENABLE_RDS_WORK_QUEUE
extern void s621_rds_work(struct work_struct *work);
#endif	/*ENABLE_RDS_WORK_QUEUE*/
#ifdef	ENABLE_IF_WORK_QUEUE
extern void s621_if_work(struct work_struct *work);
#endif	/*ENABLE_IF_WORK_QUEUE*/

extern void s621_sig2_work(struct work_struct *work);
extern void s621_tune_work(struct work_struct *work);
#ifdef	RDS_POLLING_ENABLE
extern void s621_rds_poll_work(struct work_struct *work);
extern void fm_rds_periodic_update(unsigned long data);
extern void fm_rds_periodic_cancel(unsigned long data);
#endif	/*RDS_POLLING_ENABLE*/
#ifdef	IDLE_POLLING_ENABLE
extern void s621_idle_poll_work(struct work_struct *work);
extern void fm_idle_periodic_update(unsigned long data);
extern void fm_idle_periodic_cancel(unsigned long data);
#endif	/*IDLE_POLLING_ENABLE*/

extern void fm_set_blend_mute(struct s621_radio *radio);
...
extern void fm_update_rssi(struct s621_radio *radio);
extern void fm_update_snr(struct s621_radio *radio);
extern void fm_set_audio_gain(struct s621_radio *radio, u16 gain);
