...
static struct pablo_votfitf_ops is_votfitf_ops = {
	...
	.get_slave_leader_subdev = is_votf_get_slave_leader_subdev,
};
	...
	unsigned long subdev_id)
{
	...
	ldr_sd = pablo_get_votfitf()->get_slave_leader_subdev(group, type);
...
KUNIT_EXPORT_SYMBOL(is_votf_get_framemgr);
