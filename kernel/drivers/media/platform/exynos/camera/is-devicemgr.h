...
struct pablo_kunit_devicemgr_ops {
	void (*sensor_tag)(unsigned long data);
	int (*shot_callback)(struct is_group *, struct is_frame *, u32, enum is_device_type);
	int (*shot_done)(struct is_group *, struct is_frame *, u32);
	void (*late_shot_handle)(struct is_group *, struct is_frame *, u32);
};
