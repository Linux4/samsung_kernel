...
#define CAMERA2_MAX_IPC_VENDOR_LENGTH 3172
...
#define CHK_MODECHANGE_SCN(captureIntent)                                                          \
	(((captureIntent == AA_CAPTURE_INTENT_STILL_CAPTURE_REMOSAIC_SINGLE) ||                    \
	  ...
	  (captureIntent == AA_CAPTURE_INTENT_STILL_CAPTURE_REMOSAIC_EXPOSURE_DYNAMIC_SHOT)) ?     \
		 1 :                                                                               \
		 0)
...
enum is_subscenario_id {
	...
	ISS_SUB_SCENARIO_STILL_FULL_PREVIEW_WDR_AUTO =
		2, /* TODO: 2: Full resolution Preview (HDR Auto/Off) */
	ISS_SUB_SCENARIO_SUPER_NIGHT_SHOT_PREVIEW = 3, /* Super night Preview (HDR Auto) */

	ISS_SUB_SCENARIO_STILL_CAPTURE_WDR_AUTO =
		10, /* 10: Single/Burst/Snapshot capture (HDR Auto/Off) */
	ISS_SUB_SCENARIO_STILL_CAPTURE = 11, /* 11: Single capture (HDR Off) : Pro mode	 */
	ISS_SUB_SCENARIO_STILL_CAPTURE_LONG =
		12, /* 12: Single long capture (HDR Off) : Pro mode	 */
	ISS_SUB_SCENARIO_STILL_CAPTURE_DNG_REPROCESSING =
		13, /* TODO: 13: DNG capture (HDR Off) : Pro m */
	...
	ISS_SUB_SCENARIO_FULL_RESOLUTION_LOW_LIGHT_CAPTURE =
		20, /* 20: Full resolution Low Light Capture  (HDR Auto/Off) */
	ISS_SUB_SCENARIO_SUPER_NIGHT_CAPTURE_LONG_EXPOSURE =
		21, /* 21: Super night capture Long Exposure (HDR Auto) */
	ISS_SUB_SCENARIO_MERGED_STILL_CAPTURE_SHORT_REF_LLHDR =
		22, /* 22: Short Ref LLHDR capture (HDR Auto/Off) */
	ISS_SUB_SCENARIO_MERGED_STILL_REMOSAIC_CAPTURE_MFNR =
		23, /* 23: Remosaic TNR capture (HDR Auto/Off) */
	...
	ISS_SUB_SCENARIO_VIDEO_SUPER_STEADY_WDR_AUTO =
		34, /* 34: Super Steady : FHD 30fps ( HDR Auto ) */
	ISS_SUB_SCENARIO_VIDEO_SUPER_STEADY_WDR_ON =
		35, /* 35: Super Steady : FHD 30fps ( HDR On ) */
	...
	ISS_SUB_SCENARIO_FHD_VIDEO_HDR10_WDR_AUTO =
		46, /* 46: HDR10+ video (HDR Auto) : FHD 30fps	 */
	ISS_SUB_SCENARIO_UHD_VIDEO_HDR10_WDR_AUTO =
		47, /* 47: HDR10+ video (HDR Auto) : UHD 30fps */
	...
	ISS_SUB_SCENARIO_STILL_PREVIEW_3RD_PARTY_WDR_AUTO =
		67, /* 67: 3rd Party Preview (HDR Auto) */
	ISS_SUB_SCENARIO_VIDEO_3RD_PARTY_WDR_AUTO = 68, /* 68: 3rd Party Video (HDR Auto) */
	ISS_SUB_SCENARIO_STILL_CAPTURE_3RD_PARTY_WDR_AUTO =
		69, /* 69: 3rd Party Capture (HDR Auto) */
...
enum metadata_mode { METADATA_MODE_NONE, METADATA_MODE_FULL };
...
enum facedetect_mode { FACEDETECT_MODE_OFF = 1, FACEDETECT_MODE_SIMPLE, FACEDETECT_MODE_FULL };

enum stats_mode { STATS_MODE_OFF = 1, STATS_MODE_ON };
...
struct camera2_depth_sm {
	...
	enum depth_available_depth_stream_config
		availableDepthStreamConfigurations[CAMERA2_MAX_AVAILABLE_MODE][4];
...
struct camera2_ipc_udm {
	uint32_t vsLength;
	uint32_t vendorSpecific[CAMERA2_MAX_IPC_VENDOR_LENGTH];
};
...
struct camera2_pdaf_udm {
	uint16_t numCol;
	uint16_t numRow;
	struct camera2_pdaf_multi_result multiResult[CAMERA2_MAX_PDAF_MULTIROI_ROW]
