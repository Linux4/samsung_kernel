...
enum is_subscenario_id {
	...
	ISS_SUB_SCENARIO_3RD_PARTY_VIDEO_BINNING = 73,                              /* 73 : 3rd Party rear video binning (HDR Auto) */

	ISS_SUB_SCENARIO_FHD_VIDEO_CROPPED_REMOSAIC = 76,                           /* 76 : Cropped Remosaic Video (FHD AutoFps/30Fps/60Fps/SuperSteady) */
	ISS_SUB_SCENARIO_UHD_VIDEO_CROPPED_REMOSAIC = 77,                           /* 77 : Cropped Remosaic Video (UHD 30/60 Fps) */
	ISS_SUB_SCENARIO_FHD_VIDEO_CROPPED_REMOSAIC_HDR10_WDR_AUTO = 78,            /* 78 : Cropped Remosaic HDR10+ Video (FHD AutoFps/30/60 Fps) */
	ISS_SUB_SCENARIO_UHD_VIDEO_CROPPED_REMOSAIC_HDR10_WDR_AUTO = 79,            /* 79 : Cropped Remosaic HDR10+ Video (UHD 30/60 Fps)*/
	ISS_SUB_SCENARIO_SUPER_NIGHT_CROPPED_REMOSAIC_CAPTURE = 80,                 /* 80 : Super night cropped remosaic capture (HDR Auto) */

	ISS_SUB_SCENARIO_LIVE_OUTFOCUS_PREVIEW_IN_RCP = 81,                         /* 81: Bokeh RCP Preview  */
	ISS_SUB_SCENARIO_LIVE_OUTFOCUS_CAPTURE_TNR_IN_RCP = 82,                     /* 82: Bokeh RCP TNR capture (HDR Auto) */
	ISS_SUB_SCENARIO_LIVE_OUTFOCUS_CAPTURE_TNR_LLHDR_IN_RCP = 83,               /* 83: Bokeh RCP TNR LLS capture (0 EV) */
	ISS_SUB_SCENARIO_LIVE_OUTFOCUS_CAPTURE_NIGHT_IN_RCP = 84,                   /* 84: Bokeh RCP NIGHT capture (HDR Auto) */
	ISS_SUB_SCENARIO_LIVE_OUTFOCUS_CAPTURE_SINGLE_IN_RCP = 85,                  /* 85: Bokeh RCP TNR LLS capture (- EV) */
...
#define IS_VIDEO_SCENARIO(setfile)					\
	...
	|| ((setfile) == ISS_SUB_SCENARIO_FHD_VIDEO_CROPPED_REMOSAIC)	\
	|| ((setfile) == ISS_SUB_SCENARIO_UHD_VIDEO_CROPPED_REMOSAIC)	\
	|| ((setfile) == ISS_SUB_SCENARIO_FHD_VIDEO_CROPPED_REMOSAIC_HDR10_WDR_AUTO)		\
	|| ((setfile) == ISS_SUB_SCENARIO_UHD_VIDEO_CROPPED_REMOSAIC_HDR10_WDR_AUTO))
