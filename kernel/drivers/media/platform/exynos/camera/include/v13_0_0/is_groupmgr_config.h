...
#define GROUP_SLOT_BYRP         3
#define GROUP_SLOT_RGBP         4
#define GROUP_SLOT_YUVSC        5
#define GROUP_SLOT_MLSC         6
#define GROUP_SLOT_MTNR         7
#define GROUP_SLOT_MSNR         8
#define GROUP_SLOT_YUVP         9
#define GROUP_SLOT_MCS          10
#define GROUP_SLOT_MAX          11
