...
enum is_subscenario_id {
	...
	ISS_SUB_SCENARIO_STILL_REMOSAIC_PREVIEW = 1,                                  /* 1: Single preview (HDR On) */
	ISS_SUB_SCENARIO_STILL_SUPER_NIGHT_PREVIEW = 2,                           /* TODO: 2: Full resolution Preview (HDR Auto/Off) */
	ISS_SUB_SCENARIO_STILL_PORTRAIT_PREVIEW = 3,                              /* Super night Preview (HDR Auto) */
	ISS_SUB_SCENARIO_STILL_PREVIEW_PRO_MODE = 4,                              /* 4: ProMode Preview (HDR Off) */
	...
	ISS_SUB_SCENARIO_LIVE_OUTFOCUS_CAPTURE_WDR_AUTO = 12,      /* Bokeh capture (HDR Auto) */
	ISS_SUB_SCENARIO_STILL_REMOSAIC_SF_CAPTURE = 13,           /* 13: Remosaic Single Frame Capture (HighRes, RCC, RCP single) */
	ISS_SUB_SCENARIO_STILL_CAPTURE_MFHDR = 14,                 /* 14: MF/LL HDR single capture (HDR Auto/Off) */
	ISS_SUB_SCENARIO_STILL_3RD_PARTY_SF_CAPTURE = 15,          /* 15: 3rd Party Single Frame Capture */
	ISS_SUB_SCENARIO_REMOSAIC_ZOOM_MFHDR_SINGLE_CAPTURE = 16,  /* 16: Seamless Remosaic MFHDR single capture */
	ISS_SUB_SCENARIO_STILL_FACTORY_CAPTURE = 17,               /* 17: Factory Camera Capture */

	ISS_SUB_SCENARIO_STILL_MF_CAPTURE_MFHDR = 20,              /* 20: Multi Frame Capture (TNR, TNR in HDR) */
	ISS_SUB_SCENARIO_STILL_FLASH_MF_CAPTURE = 21,              /* 21: Flash Multi Frame Capture (TNR) */
	ISS_SUB_SCENARIO_CROPPED_REMOSAIC_CAPTURE = 22,            /* 22: Cropped remosaic single capture (HDR Auto/Off) */
	ISS_SUB_SCENARIO_CROPPED_REMOSAIC_CAPTURE_MFHDR = 23,      /* 23: Cropped Remosaic MFHDR Capture (HDR Auto/Off) */
	ISS_SUB_SCENARIO_MERGED_STILL_REMOSAIC_CAPTURE_MFHDR = 24, /* 24:Remosaic capture (HDR Auto/Off) */
	ISS_SUB_SCENARIO_STILL_MF_CAPTURE = 25,                    /* 25: Multi Frame Capture (TNR) */

	ISS_SUB_SCENARIO_NIGHT_CAPTURE = 30,                       /* 30: Night Capture (Night, Auto Night) */
	ISS_SUB_SCENARIO_AUTO_NIGHT_CAPTURE = 31,                  /* 31: Auto Night Capture (Super Resolution) */

	ISS_SUB_SCENARIO_FHD_VIDEO = 40,                           /* 40: FHD 30fps/60fps */
	ISS_SUB_SCENARIO_UHD_VIDEO = 41,                           /* 41: UHD 30fps/60fps */
	ISS_SUB_SCENARIO_PRO_VIDEO_FHD_30FPS30 = 42,               /* 42: PRO VIDEO FHD 30fps */
	ISS_SUB_SCENARIO_SUPER_STEADY_FHD_30FPS_VIDEO = 43,        /* 43: Super Steady FHD 30fps */
	ISS_SUB_SCENARIO_FHD_60FPS_WDR_AUTO = 44,                  /* 44: FHD 60fps (HDR Auto) */
	...
	ISS_SUB_SCENARIO_LIVE_HDR_MODE_AUTO_3P = 77,               /* TODO: 77: 3rd Party Video HDR */

	ISS_SUB_SCENARIO_HIGH_SPEED_VIDEO = 80,                    /* 80: HD 240fps (Slow motion, Super Slow motion) */
	...
	ISS_SUB_SCENARIO_SCANDIT_APP_SET_AF = 93,                  /* 93: TODO : SCANDIT App */
	ISS_SUB_SCENARIO_ILLUMINANCE = 94,                         /* 94: sABC */
	ISS_SUB_SCENARIO_FACE_LOCK = 95,                           /* 95: Face Unlock */
...
#define IS_VIDEO_SCENARIO(setfile)					\
	...
	|| ((setfile) == ISS_SUB_SCENARIO_PRO_VIDEO_FHD_30FPS30)			\
	|| ((setfile) == ISS_SUB_SCENARIO_FHD_60FPS_WDR_AUTO)		\
	|| ((setfile) == ISS_SUB_SCENARIO_UHD_VIDEO)			\
	|| ((setfile) == ISS_SUB_SCENARIO_HIGH_SPEED_VIDEO))
...
struct camera2_aa_dm {
	...
	uint32_t				vendor_appliedSeamlessMode;
