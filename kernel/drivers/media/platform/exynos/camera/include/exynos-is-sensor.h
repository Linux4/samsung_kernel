...
#define CSIS_MAX_NUM_DMA_HW 5
#define CSIS_MAX_NUM_DMA_ATTACH 2

static const char *const vc_names[CSIS_MAX_NUM_DMA_ATTACH][DMA_VIRTUAL_CH_MAX] = {
	{ "WDMA_A_VC0", "WDMA_A_VC1", "WDMA_A_VC2", "WDMA_A_VC3" },
	{ "WDMA_B_VC0", "WDMA_B_VC1", "WDMA_B_VC2", "WDMA_B_VC3" },
};
...
enum itf_vc_sensor_mode {
	...
	VC_SENSOR_MODE_2PD_MODE3_BIN,	/* 2PD_MODE3 + V2H2 sensor mode */
	...
	VC_SENSOR_MODE_IMX_2X2OCL_1_VBIN_BIN,	/* Vbin mode + V2H2 sensor mode */
...
enum link_vc_out_type { LINK_VC_OUT_SINGLE = 0, LINK_VC_OUT_MULTI, LINK_VC_OUT_MAX };
...
struct is_sensor_cfg {
	...
	struct is_vci_config output[CSIS_MAX_NUM_DMA_ATTACH][DMA_VIRTUAL_CH_MAX];
	...
	u32 dvfs_lv_csis;
	u32 ex_mode_extra;
	int img_vc[CSI_OTF_OUT_CH_NUM];
	u32 hpd_vc[CSI_OTF_OUT_CH_NUM];
	u32 vpd_vc[CSI_OTF_OUT_CH_NUM];
	int special_vc_sensor_mode;
	u32 dma_num;
	u32 link_vc[CSIS_MAX_NUM_DMA_ATTACH][DMA_VIRTUAL_CH_MAX];
	u32 dma_idx[CSI_VIRTUAL_CH_MAX][LINK_VC_OUT_MAX];
	u32 dma_vc[CSI_VIRTUAL_CH_MAX][LINK_VC_OUT_MAX];
	u32 link_vc_out_idx[CSI_VIRTUAL_CH_MAX];
	u32 otf_out_id[CSI_OTF_OUT_CH_NUM];
};
