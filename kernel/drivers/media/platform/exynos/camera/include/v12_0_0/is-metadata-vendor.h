...
enum is_subscenario_id {
	...
	ISS_SUB_SCENARIO_CROPPED_REMOSAIC_CAPTURE = 21,                             /* 21: Cropped remosaic capture (HDR Auto/Off) */
	ISS_SUB_SCENARIO_STILL_CAPTURE_HYBRID_HDR = 22,                             /* 22: Hybrid HDR AIDenoiser Capture (HDR Auto/Off) */
