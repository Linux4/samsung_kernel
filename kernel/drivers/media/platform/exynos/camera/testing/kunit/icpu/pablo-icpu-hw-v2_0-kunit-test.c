...
{
	HW_OPS(panic_handler, test_pdata.mcuctl_core_reg_base, test_pdata.sysctrl_reg_base);
}

static void pablo_icpu_hw_print_debug_reg_kunit_test(struct kunit *test)
{
	HW_OPS(print_debug_reg, test_pdata.mcuctl_core_reg_base, test_pdata.sysctrl_reg_base);
}
...
struct kunit_suite pablo_icpu_hw_kunit_test_suite = {
	.name = "pablo-icpu-hw-v2_0-kunit-test",
