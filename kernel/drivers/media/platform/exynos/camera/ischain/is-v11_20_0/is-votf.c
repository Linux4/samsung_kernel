...
KUNIT_EXPORT_SYMBOL(is_votf_get_token_size);
...
KUNIT_EXPORT_SYMBOL(is_votf_get_master_vinfo);
...
KUNIT_EXPORT_SYMBOL(is_votf_get_slave_vinfo);
...
KUNIT_EXPORT_SYMBOL(is_votf_get_slave_leader_subdev);
...
KUNIT_EXPORT_SYMBOL(is_hw_pdp_set_votf_config);
...
KUNIT_EXPORT_SYMBOL(is_hw_mcsc_set_votf_size_config);
...
KUNIT_EXPORT_SYMBOL(is_votf_subdev_flush);
...
KUNIT_EXPORT_SYMBOL(is_votf_subdev_create_link);
...
KUNIT_EXPORT_SYMBOL(is_votf_subdev_destroy_link);
#endif
