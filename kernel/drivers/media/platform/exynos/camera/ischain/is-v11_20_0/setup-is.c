...
static struct is_clk is_clk_list[] = {
	...
	REGISTER_CLK("GATE_LH_AST_MI_OTF0_CSISCSTAT_QCH"), /* CSTAT0 */
	REGISTER_CLK("GATE_LH_AST_MI_OTF1_CSISCSTAT_QCH"), /* CSTAT1 */
	REGISTER_CLK("GATE_LME_QCH"), /* LME0 */
...
KUNIT_EXPORT_SYMBOL(is_set_rate);
...
KUNIT_EXPORT_SYMBOL(is_get_rate);
...
KUNIT_EXPORT_SYMBOL(is_get_hw_rate);
...
KUNIT_EXPORT_SYMBOL(is_disable);
...
KUNIT_EXPORT_SYMBOL(is_enabled_clk_disable);
...
KUNIT_EXPORT_SYMBOL(is_set_parent_dt);
...
KUNIT_EXPORT_SYMBOL(is_set_rate_dt);
...
KUNIT_EXPORT_SYMBOL(is_enable_dt);
...
KUNIT_EXPORT_SYMBOL(is_disable_dt);
...
static int exynos_is_print_clk(struct device *dev)
{
	...
	is_get_rate_dt(dev, "GATE_LME_QCH"); /* LME0 */
...
KUNIT_EXPORT_SYMBOL(is_dump_rate_dt);
...
static int exynos_is_dump_clk(struct device *dev)
{
	...
	is_dump_rate_dt(dev, "GATE_LME_QCH"); /* LME0 */
...
static int exynos_is_clk_on(struct device *dev)
{
	...
	is_enable(dev, "GATE_LH_AST_MI_OTF0_CSISCSTAT_QCH"); /* cstat */
	is_enable(dev, "GATE_LH_AST_MI_OTF1_CSISCSTAT_QCH"); /* cstat */
	is_enable(dev, "GATE_LME_QCH"); /* LME0 */
...
static int exynos_is_clk_off(struct device *dev)
{
	...
	is_disable(dev, "GATE_LH_AST_MI_OTF0_CSISCSTAT_QCH"); /* cstat */
	is_disable(dev, "GATE_LH_AST_MI_OTF1_CSISCSTAT_QCH"); /* cstat */
	is_disable(dev, "GATE_LME_QCH"); /* LME0 */
