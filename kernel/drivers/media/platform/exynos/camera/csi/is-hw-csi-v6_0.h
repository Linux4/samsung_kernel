...
#ifndef IS_HW_CSIS_V6_H
#define IS_HW_CSIS_V6_H
...
enum is_hw_csi_dma_int_src {
	...
	CSIS_INT_DMA_LASTDATA_OR_LASTADDR_ERR = 14,
	CSIS_INT_DMA_WC_ERR = 15,
	CSIS_INT_DMA_FSTART_IN_FLUSH = 16,	/* [16] ~ [18] */
	CSIS_INT_DMA_SBWC_OVERLAP_VIOLATION = 19,
	CSIS_INT_DMA_OVERLAP = 20,		/* [20] ~ [23] */
	CSIS_INT_DMA_FRAME_DROP = 24,		/* [24] ~ [27] */
	CSIS_INT_DMA_C2COM_LOST_FLUSH = 28,	/* [28] ~ [30] */
	CSIS_INT_DMA_VOTF_GLOBAL_ERR = 31,
};
...
#define CSIS_DMA_IRQ_MASK	((0)\
				...
				|(1 << CSIS_INT_DMA_LASTDATA_OR_LASTADDR_ERR) \
				|(1 << CSIS_INT_DMA_WC_ERR) \
				...
				|(1 << CSIS_INT_DMA_VOTF_GLOBAL_ERR)\
				)
...
enum is_hw_csi_dma_cmn_reg_name {
	...
	CSIS_DMA_CMN_R_CSIS_TZINFO_CSIS_MUX,
...
enum is_hw_csi_dma_cmn_reg_field {
	...
	/* TZINFO_CSIS_MUX */
	CSIS_DMA_CMN_F_TZINFO_CSIS_MUX,
...
enum is_hw_csi_dmax_reg_name {
	...
	CSIS_DMAX_R_LOSSY_QUALITY_CONTROL,
	CSIS_DMAX_REG_CNT
};
...
static const struct is_reg csi_dmax_regs[CSIS_DMAX_REG_CNT] = {
	...
	{0x00D4, "CSIS_DMAX_LOSSY_QUALITY_CONTROL"},
};
...
enum is_hw_csi_dmax_reg_field {
	...
	/* CSIS_DMAX_LOSSY_QUALITY_CONTROL */
	CSIS_DMAX_F_LOSSY_DMA_COMP_LOSSY_QUALITY_CONTROL,
...
static struct is_field csi_dmax_fields[CSIS_DMAX_REG_FIELD_CNT] = {
	...
	/* CSIS_DMAX_LOSSY_QUALITY_CONTROL */
	{"LOSSY_DMA_COMP_LOSSY_QUALITY_CONTROL,", 0, 1, RW, 0x0},
};
