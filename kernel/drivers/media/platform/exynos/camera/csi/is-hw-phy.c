...
#define PHY_ADDR_SC_GNR_CON0 0x00
#define PHY_ADDR_SD_GNR_CON0 0x00
#define PHY_ADDR_SD_ANA_CON2 0x10
...
{
	struct phy_setfile sf = { PHY_ADDR_SC_GNR_CON0, 1, 1, 1, 0, 0 };
	u32 lane_ofs = 0x100;
	const int retry = 20;
	int cnt, i;
...
{
	void __iomem *base;
	u32 ofs_sfr1 = PHY_ADDR_SD_GNR_CON0;
	u32 ofs_sfr2 = PHY_ADDR_SD_ANA_CON2;
	u32 val1 = 0, val2 = 0;
	u32 lane_ofs = 0x100;
	int ret = 0;
	int i;
