...
typedef void (*icpu_itf_ihc_err_handler_t)(void *cookie, char *str);
...
struct pablo_icpu_itf_api {
	...
	int (*register_err_handler)(void *cookie, icpu_itf_ihc_err_handler_t callback);
