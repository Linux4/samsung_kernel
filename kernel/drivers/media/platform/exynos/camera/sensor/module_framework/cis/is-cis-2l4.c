...
int sensor_2l4_cis_log_status(struct v4l2_subdev *subdev)
{
	...
	ret = cis->ixc_ops->read16(cis->client, 0xEA2A, &data16);
	if (unlikely(!ret)) pr_info("0xEA2A(0x%x)\n", data16);
	else goto i2c_err;
	ret = cis->ixc_ops->read16(cis->client, 0xEA2C, &data16);
	...
	ret = cis->ixc_ops->read16(cis->client, 0x0002, &data16);
	...
	ret = cis->ixc_ops->read16(cis->client, 0x020E, &data16);
	if (unlikely(!ret)) pr_info("0x020E(0x%x)\n", data16);
	else goto i2c_err;
	ret = cis->ixc_ops->read16(cis->client, 0x021E, &data16);
	if (unlikely(!ret)) pr_info("0x021E(0x%x)\n", data16);
	else goto i2c_err;
	ret = cis->ixc_ops->read16(cis->client, 0x0226, &data16);
	if (unlikely(!ret)) pr_info("0x0226(0x%x)\n", data16);
	else goto i2c_err;
	ret = cis->ixc_ops->read16(cis->client, 0x0340, &data16);
	if (unlikely(!ret)) pr_info("0x0340(0x%x)\n", data16);
	else goto i2c_err;
	ret = cis->ixc_ops->read16(cis->client, 0x0700, &data16);
	if (unlikely(!ret)) pr_info("0x0700(0x%x)\n", data16);
	else goto i2c_err;
	ret = cis->ixc_ops->read16(cis->client, 0x0702, &data16);
	if (unlikely(!ret)) pr_info("0x0702(0x%x)\n", data16);
	else goto i2c_err;
	ret = cis->ixc_ops->read16(cis->client, 0x0A70, &data16);
	if (unlikely(!ret)) pr_info("0x0A70(0x%x)\n", data16);
	else goto i2c_err;
	ret = cis->ixc_ops->read16(cis->client, 0x0A72, &data16);
	if (unlikely(!ret)) pr_info("0x0A72(0x%x)\n", data16);
	else goto i2c_err;
	ret = cis->ixc_ops->read16(cis->client, 0x0A78, &data16);
	if (unlikely(!ret)) pr_info("0x0A78(0x%x)\n", data16);
	else goto i2c_err;
	ret = cis->ixc_ops->read16(cis->client, 0x0A7A, &data16);
	if (unlikely(!ret)) pr_info("0x0A7A(0x%x)\n", data16);
	else goto i2c_err;
	ret = cis->ixc_ops->read16(cis->client, 0x0A7C, &data16);
	if (unlikely(!ret)) pr_info("0x0A7C(0x%x)\n", data16);
	else goto i2c_err;
	ret = cis->ixc_ops->read16(cis->client, 0x0C80, &data16);
