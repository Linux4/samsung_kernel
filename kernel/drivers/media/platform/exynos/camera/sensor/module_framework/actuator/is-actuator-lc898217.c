...
long sensor_lc898217_actuator_ioctl(struct v4l2_subdev *subdev, unsigned int cmd, void *arg)
{
	int ret = 0;
	...
	case SENSOR_IOCTL_ACT_S_CTRL:
		ret = sensor_lc898217_actuator_s_ctrl(subdev, ctrl);
		if (ret) {
	...
	case SENSOR_IOCTL_ACT_G_CTRL:
		ret = sensor_lc898217_actuator_g_ctrl(subdev, ctrl);
		if (ret) {
...
static const struct v4l2_subdev_core_ops core_ops = {
	...
	.ioctl = sensor_lc898217_actuator_ioctl,
};
...
static int sensor_lc898217_actuator_probe_i2c(struct i2c_client *client,
...
static struct i2c_driver sensor_actuator_lc898217_driver = {
	.probe  = sensor_lc898217_actuator_probe_i2c,
	.driver = {
		.name	= ACTUATOR_NAME,
		.owner	= THIS_MODULE,
