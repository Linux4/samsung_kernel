...
int is_eeprom_5e9_get_cal_data(struct v4l2_subdev *subdev)
{
	...
	if (ret) {
		...
		ret = is_eeprom_module_read(eeprom->client, EEPROM_ADD_CRC_FST, eeprom->data, EEPROM_DATA_SIZE);
		if (ret < 0) {
...
static int sensor_eeprom_5e9_probe_i2c(struct i2c_client *client,
...
static struct i2c_driver sensor_eeprom_5e9_driver = {
	.probe  = sensor_eeprom_5e9_probe_i2c,
	.driver = {
