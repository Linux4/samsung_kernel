...
static void pdp_hw_s_pd_size(void __iomem *base, u32 width, u32 height, u32 hwformat,
	u32 img_pixelsize, u32 potf_en, bool vpd_pdstat_en)
{
	u32 format;
	u32 byte_per_line;
	u32 unpack_fmt;
	...
	u32 num_buffers, u32 binning, u32 position)
{
	...
	potf_en = CHECK_POTF_EN(sensor_cfg->input[pdp->af_vc].extformat);
	...
	pdp_hw_s_pd_size(base, pd_width, pd_height, pd_hwformat, img_pixelsize, potf_en, vpd_pdstat_en);
...
void pdp_hw_s_input_mux(struct is_pdp *pdp)
{
