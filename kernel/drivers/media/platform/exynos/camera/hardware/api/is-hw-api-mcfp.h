...
void mcfp_hw_s_clock(void __iomem *base, bool on);
...
void mcfp_hw_g_img_bitshift(void __iomem *base, u32 set_id, u32 *shift,
	u32 *shift_chroma, u32 *offset, u32 *offset_chroma);
void mcfp_hw_g_wgt_bitshift(void __iomem *base, u32 set_id, u32 *shift);
void mcfp_hw_s_crc(void __iomem *base, u32 seed);

u32 mcfp_hw_g_reg_cnt(void);
void mcfp_hw_s_8x8_mv_mode(void __iomem *base, u32 set_id, u32 enable);
void mcfp_hw_s_dtp(void __iomem *base, u32 enable, enum mcfp_dtp_type type,
	u32 y, u32 u, u32 v, enum mcfp_dtp_color_bar cb);
void mcfp_hw_s_geomatch_mode(void __iomem *base, u32 set_id, u32 tnr_mode);
void mcfp_hw_s_mixer_mode(void __iomem *base, u32 set_id, u32 tnr_mode);
void mcfp_hw_init_pmio_config(struct pmio_config *cfg);
void mcfp_hw_pmio_write_test(void __iomem *base, u32 set_id);
void mcfp_hw_pmio_read_test(void __iomem *base, u32 set_id);
#endif
