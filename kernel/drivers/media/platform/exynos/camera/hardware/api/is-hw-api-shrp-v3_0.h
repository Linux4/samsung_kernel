...
enum shrp_mux_select {
	SHRP_MUX_RECOMP_BYPASS_IN = (0 << 0),
	SHRP_MUX_RECOMP_ENABLE_IN = (1 << 0),
	SHRP_MUX_CINFIFO = (0 << 8),
	SHRP_MUX_RDMA_YUV = (1 << 8),
	SHRP_MUX_SEGMAP_OTF = (0 << 16),
	SHRP_MUX_SEGMAP_RDMA = (1 << 16),
	SHRP_MUX_HFDECOMP_OTF = (0 << 24),
	SHRP_MUX_HFDECOMP_RDMA = (1 << 24),
};

enum shrp_demux_select {
	SHRP_DEMUX_HF_RECOMP_IN = (0 << 0),
	SHRP_DEMUX_HF_MCSC_IN = (1 << 0),
};
...
int shrp_hw_get_input_dva(u32 id, u32 *cmd, pdma_addr_t **input_dva, struct shrp_param_set *param_set);
