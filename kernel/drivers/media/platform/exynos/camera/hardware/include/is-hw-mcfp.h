...
enum is_hw_mcfp_subdev {
	...
	MCFP_SUBDEV_W,
	MCFP_SUBDEV_END,
	MCFP_SUBDEV_PREV_YUV_2NR = MCFP_SUBDEV_END,
	MCFP_SUBDEV_PREV_W_2NR,
	MCFP_SUBDEV_YUV_2NR,
	MCFP_SUBDEV_W_2NR,
	MCFP_SUBDEV_MAX,
};

static const char *mcfp_internal_buf_name[MCFP_SUBDEV_MAX] = {
	"MCFP_PY",
	"MCFP_PW",
	"MCFP_CY",
	"MCFP_CW",
...
struct is_hw_mcfp {
	...
	u32				repeat_state;
	unsigned long			state;
	struct pablo_internal_subdev	subdev[IS_STREAM_COUNT][MCFP_SUBDEV_MAX];
