...
struct constant_vector {
	 ...
	 * @details producer : compiler
	 * @n consumer : all
	 * @n description : It means the target to use the binary (enum ncp_core_type)
	 */
	u32 target;
	/**
	 * @brief constant fifo data offset
	 * @details producer : compiler
	 * @n consumer : all
	 * @n description : constant fifo data offset in byte from header(zero base)
	 */
	u32 offset;
	/**
	 * @brief size in byte
	 * @details producer : compiler
	 * @n consumer : firmware
	 * @n description : size of constant fifo data
	 */
	u32 size;
};
...
struct cu_vector {
	 ...
	 * @details producer : compiler
	 * @n consumer : all
	 * @n description : Abstract id of cu operation
	 */
	u32 op_id;
	/**
	 * @brief program memroy addr
	 * @details producer : compiler
	 * @n consumer : all
	 * @n description : It means the target to use the binary
	 */
	u32 binary_offset;
	/**
	 * @brief size in byte
	 * @details producer : compiler
	 * @n consumer : firmware
	 * @n description : size of cu binary(sush as pm/lut/fraction length)
	 */
	u32 size;
};
...
struct ntc_vector {
	/**
	 * @brief ntc meta data offset
	 * @details producer : compiler
	 * @n consumer : all
	 * @n description : ntc meta data offset in byte from header(zero base)
	 */
	u32 offset;
};
...
struct ncp_header {
	 ...
	 * @details producer : compiler
	 * @n consumer : firmware
	 * @n description : an abi version number required for the current
	 */
	u32 abi_version;
	/**
	 * @brief model name
	...
	/**
	 * @brief constant vector offset
	 * @details producer : compiler
	 * @n consumer : all
	 * @n description : constant vector offset in byte from header(zero base)
	 */
	u32 constant_vector_offset;
	/**
	 * @brief the number of constant vector
	 * @details producer : compiler
	 * @n consumer : all
	 * @n description : n
	 */
	u32 constant_vector_cnt;
	/**
	 * @brief cu vector offset
	 * @details producer : compiler
	 * @n consumer : all
	 * @n description : cu vector offset in byte from header(zero base)
	 */
	u32 cu_vector_offset;
	/**
	 * @brief the number of cu vector
	 * @details producer : compiler
	 * @n consumer : all
	 * @n description : n
	 */
	u32 cu_vector_cnt;
	/**
	 * @brief ntc vector offset
	 * @details producer : compiler
	 * @n consumer : all
	 * @n description : ntc vector offset in byte from header(zero base)
	 */
	u32 ntc_vector_offset;
	/**
	 ...
	 * @details producer : driver
	 * @n consumer : firmware
	 * @n description : this should be not zero(usually session id)
	 * if a user wants to enable fence, otherwise zero
	 */
	u32 fence_flag;
	/**
	 * @brief power limiting mode
	 * @details producer : compiler
	 * @n consumer : firmware
	 * @n description : Several models required to limit the power resource
	 * When the inference needs to use power-level,
	 * FW is going to turn on FREQ_SCALING register
	 */
	u32 power_scaling;
	/**
	 * @brief featuremapdata type
	 * @details producer : compiler
	 * @n consumer : firmware
	 * @n description : represents the featuremapdata type of the model
	 */
