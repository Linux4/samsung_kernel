...
enum sgpu_bpmd_layout_packet_kind {
	...
	SGPU_BPMD_LAYOUT_PACKET_PT,
	SGPU_BPMD_LAYOUT_PACKET_INDEXED_REG,
	SGPU_BPMD_LAYOUT_PACKET_MULTI_READ_REG,
...
void sgpu_bpmd_layout_dump_header_version(struct sgpu_bpmd_output *sbo,
					  uint32_t major,
					  uint32_t minor);
enum sgpu_bpmd_layout_ring_type
