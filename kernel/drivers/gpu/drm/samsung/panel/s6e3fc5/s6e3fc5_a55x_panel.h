/*
 * linux/drivers/video/fbdev/exynos/panel/s6e3fc5/s6e3fc5_a55x_panel.h
 *
...
#ifndef __S6E3FC5_A55X_PANEL_H__
#define __S6E3FC5_A55X_PANEL_H__

#include "../panel.h"
#include "../panel_drv.h"
#include "oled_function.h"
#include "s6e3fc5.h"
#include "s6e3fc5_a55x.h"
#include "s6e3fc5_dimming.h"
#ifdef CONFIG_USDM_MDNIE
#include "s6e3fc5_a55x_panel_mdnie.h"
#endif
#include "s6e3fc5_a55x_panel_dimming.h"
#ifdef CONFIG_USDM_PANEL_AOD_BL
#include "s6e3fc5_a55x_panel_aod_dimming.h"
#endif
#include "s6e3fc5_a55x_resol.h"

#ifdef CONFIG_USDM_PANEL_RCD
#include "s6e3fc5_a55x_rcd.h"
#endif
...
static u8 a55x_brt_table[S6E3FC5_TOTAL_STEP][2] = {
...
static u8 a55x_acl_opr_table[MAX_PANEL_HBM][MAX_S6E3FC5_ACL_OPR][1] = {
	[PANEL_HBM_OFF] = {
...
static u8 a55x_lpm_on_table[2][1] = {
	[ALPM_MODE] = { 0x23 },
	[HLPM_MODE] = { 0x23 },
};

static u8 a55x_ffc_table[MAX_S6E3FC5_HS_CLK][2] = {
...
static u8 a55x_fps_table[MAX_S6E3FC5_VRR][1] = {
...
static u8 a55x_te_frame_sel_table[MAX_S6E3FC5_VRR][12] = {
	[S6E3FC5_VRR_120HS] = {
...
static struct maptbl a55x_maptbl[MAX_MAPTBL] = {
	[GAMMA_MODE2_MAPTBL] = DEFINE_2D_MAPTBL(a55x_brt_table, &DDI_FUNC(S6E3FC5_MAPTBL_INIT_GAMMA_MODE2_BRT), &OLED_FUNC(OLED_MAPTBL_GETIDX_GM2_BRT), &OLED_FUNC(OLED_MAPTBL_COPY_DEFAULT)),
	[HBM_ONOFF_MAPTBL] = DEFINE_3D_MAPTBL(a55x_hbm_transition_table, &OLED_FUNC(OLED_MAPTBL_INIT_DEFAULT), &DDI_FUNC(S6E3FC5_MAPTBL_GETIDX_HBM_TRANSITION), &OLED_FUNC(OLED_MAPTBL_COPY_DEFAULT)),
	[ACL_OPR_MAPTBL] = DEFINE_3D_MAPTBL(a55x_acl_opr_table, &OLED_FUNC(OLED_MAPTBL_INIT_DEFAULT), &DDI_FUNC(S6E3FC5_MAPTBL_GETIDX_ACL_OPR), &OLED_FUNC(OLED_MAPTBL_COPY_DEFAULT)),
	[TSET_MAPTBL] = DEFINE_0D_MAPTBL(a55x_tset_table, &OLED_FUNC(OLED_MAPTBL_INIT_DEFAULT), NULL, &OLED_FUNC(OLED_MAPTBL_COPY_TSET)),
	[LPM_NIT_MAPTBL] = DEFINE_2D_MAPTBL(a55x_lpm_nit_table, &DDI_FUNC(S6E3FC5_MAPTBL_INIT_LPM_BRT), &DDI_FUNC(S6E3FC5_MAPTBL_GETIDX_LPM_BRT), &OLED_FUNC(OLED_MAPTBL_COPY_DEFAULT)),
	[TE_FRAME_SEL_MAPTBL] = DEFINE_2D_MAPTBL(a55x_te_frame_sel_table, &OLED_FUNC(OLED_MAPTBL_INIT_DEFAULT), &DDI_FUNC(S6E3FC5_MAPTBL_GETIDX_VRR), &OLED_FUNC(OLED_MAPTBL_COPY_DEFAULT)),
	[FPS_MAPTBL] = DEFINE_2D_MAPTBL(a55x_fps_table, &OLED_FUNC(OLED_MAPTBL_INIT_DEFAULT), &DDI_FUNC(S6E3FC5_MAPTBL_GETIDX_VRR), &OLED_FUNC(OLED_MAPTBL_COPY_DEFAULT)),
	[SET_FFC_MAPTBL] = DEFINE_2D_MAPTBL(a55x_ffc_table, &OLED_FUNC(OLED_MAPTBL_INIT_DEFAULT), &DDI_FUNC(S6E3FC5_MAPTBL_GETIDX_FFC), &OLED_FUNC(OLED_MAPTBL_COPY_DEFAULT)),
};

/* ===================================================================================== */
/* ============================== [S6E3FC5 COMMAND TABLE] ============================== */
/* ===================================================================================== */
static u8 A55X_KEY1_ENABLE[] = { 0x9F, 0xA5, 0xA5 };
static u8 A55X_KEY2_ENABLE[] = { 0xF0, 0x5A, 0x5A };
static u8 A55X_KEY3_ENABLE[] = { 0xFC, 0x5A, 0x5A };

static u8 A55X_KEY1_DISABLE[] = { 0x9F, 0x5A, 0x5A };
...
static DEFINE_VARIABLE_PACKET(a55x_tset_set, DSI_PKT_TYPE_WR, A55X_TSET_SET, 0x01);

static u8 A55X_AOD_AOR_MAX[] = { 0x66, 0x01, 0x09, 0x40 };
...
// static u8 A55X_AOD_VAINT[] = { 0xF4, 0x28 };
// static DEFINE_STATIC_PACKET(a55x_aod_vaint, DSI_PKT_TYPE_WR, A55X_AOD_VAINT, 0x7A);

// static u8 A55X_AOD_SETTING[] = { 0x68, 0x02 };
// static DEFINE_STATIC_PACKET(a55x_aod_setting, DSI_PKT_TYPE_WR, A55X_AOD_SETTING, 0);

static u8 A55X_AOD_AOR[] = { 0x66, 0x00 };
static DEFINE_STATIC_PACKET(a55x_aod_aor, DSI_PKT_TYPE_WR, A55X_AOD_AOR, 0x52);

static u8 A55X_LPM_PORCH_ON[] = { 0xF2, 0x02, 0x56 };
static DEFINE_STATIC_PACKET(a55x_lpm_porch_on, DSI_PKT_TYPE_WR, A55X_LPM_PORCH_ON, 0x1F);

static u8 A55X_SWIRE_NO_PULSE[] = { 0xB5, 0x00 };
static DEFINE_STATIC_PACKET(a55x_swire_no_pulse, DSI_PKT_TYPE_WR, A55X_SWIRE_NO_PULSE, 0x0A);

static u8 A55X_SWIRE_NO_PULSE_LPM_OFF[] = { 0xB5, 0x00, 0x00, 0x00 };
static DEFINE_STATIC_PACKET(a55x_swire_no_pulse_lpm_off, DSI_PKT_TYPE_WR, A55X_SWIRE_NO_PULSE_LPM_OFF, 0x08);

// static u8 A55X_LPM_OFF_SYNC_CTRL[] = {
// 	0x66, 0x10
// };
// static DEFINE_STATIC_PACKET(a55x_lpm_off_sync_ctrl, DSI_PKT_TYPE_WR, A55X_LPM_OFF_SYNC_CTRL, 0x0F);

static u8 A55X_LPM_PORCH_OFF[] = { 0xF2, 0x02, 0x7E };
static DEFINE_STATIC_PACKET(a55x_lpm_porch_off, DSI_PKT_TYPE_WR, A55X_LPM_PORCH_OFF, 0x1F);

static u8 A55X_NORMAL_MODE[] = { 0x53, 0x28 };
static DEFINE_STATIC_PACKET(a55x_normal_mode, DSI_PKT_TYPE_WR, A55X_NORMAL_MODE, 0);

// static u8 A55X_NORMAL_SETTING[] = { 0x68, 0x02, 0x01 };
// static DEFINE_STATIC_PACKET(a55x_normal_setting, DSI_PKT_TYPE_WR, A55X_NORMAL_SETTING, 0);

static u8 A55X_BLACK_FRAME_OFF[] = { 0xBB, 0x05, 0x0C, 0x0C };
static DEFINE_STATIC_PACKET(a55x_black_frame_off, DSI_PKT_TYPE_WR, A55X_BLACK_FRAME_OFF, 0x03);

static u8 A55X_BLACK_FRAME_ON[] = { 0xBB, 0x05, 0x00, 0x0C };
static DEFINE_STATIC_PACKET(a55x_black_frame_on, DSI_PKT_TYPE_WR, A55X_BLACK_FRAME_ON, 0x03);
...
static u8 A55X_DECODER_TEST_CASET[] = { 0x2A, 0x00, 0x00, 0x04, 0x37 };
static DEFINE_STATIC_PACKET(a55x_decoder_test_caset, DSI_PKT_TYPE_WR, A55X_DECODER_TEST_CASET, 0x00);

static u8 A55X_DECODER_TEST_PASET[] = { 0x2B, 0x00, 0x00, 0x09, 0x23 };
static DEFINE_STATIC_PACKET(a55x_decoder_test_paset, DSI_PKT_TYPE_WR, A55X_DECODER_TEST_PASET, 0x00);

static u8 A55X_DECODER_TEST_2C[] = { 0x2C, 0x00 };
static DEFINE_STATIC_PACKET(a55x_decoder_test_2c, DSI_PKT_TYPE_WR, A55X_DECODER_TEST_2C, 0x00);

static u8 A55X_DECODER_CRC_PATTERN_ENABLE[] = { 0xBE, 0x07 };
static DEFINE_STATIC_PACKET(a55x_decoder_crc_pattern_enable, DSI_PKT_TYPE_WR, A55X_DECODER_CRC_PATTERN_ENABLE, 0x00);

static u8 A55X_DECODER_READ_SET_1[] = { 0xD8, 0x11 };
static DEFINE_STATIC_PACKET(a55x_decoder_read_set_1, DSI_PKT_TYPE_WR, A55X_DECODER_READ_SET_1, 0x27);

static u8 A55X_DECODER_READ_SET_2[] = { 0xD8, 0x20 };
static DEFINE_STATIC_PACKET(a55x_decoder_read_set_2, DSI_PKT_TYPE_WR, A55X_DECODER_READ_SET_2, 0x27);

static u8 A55X_DECODER_VDDM_LOW_SET_1[] = { 0xD7, 0x04 };
static DEFINE_STATIC_PACKET(a55x_decoder_vddm_low_set_1, DSI_PKT_TYPE_WR, A55X_DECODER_VDDM_LOW_SET_1, 0x02);

static u8 A55X_DECODER_VDDM_LOW_SET_2[] = { 0xF4, 0x07 };
static DEFINE_STATIC_PACKET(a55x_decoder_vddm_low_set_2, DSI_PKT_TYPE_WR, A55X_DECODER_VDDM_LOW_SET_2, 0x0F);

static u8 A55X_DECODER_FUSING_UPDATE_1[] = { 0xFE, 0xB0 };
static DEFINE_STATIC_PACKET(a55x_decoder_fusing_update_1, DSI_PKT_TYPE_WR, A55X_DECODER_FUSING_UPDATE_1, 0x00);

static u8 A55X_DECODER_FUSING_UPDATE_2[] = { 0xFE, 0x30 };
static DEFINE_STATIC_PACKET(a55x_decoder_fusing_update_2, DSI_PKT_TYPE_WR, A55X_DECODER_FUSING_UPDATE_2, 0x0F);

static u8 A55X_DECODER_CRC_PATERN_DISABLE[] = { 0xBE, 0x00 };
static DEFINE_STATIC_PACKET(a55x_decoder_crc_pattern_disable, DSI_PKT_TYPE_WR, A55X_DECODER_CRC_PATERN_DISABLE, 0x00);

static u8 A55X_DECODER_VDDM_RETURN_SET_1[] = { 0xD7, 0x00 };
static DEFINE_STATIC_PACKET(a55x_decoder_vddm_return_set_1, DSI_PKT_TYPE_WR, A55X_DECODER_VDDM_RETURN_SET_1, 0x02);

static u8 A55X_DECODER_VDDM_RETURN_SET_2[] = { 0xF4, 0x00 };
static DEFINE_STATIC_PACKET(a55x_decoder_vddm_return_set_2, DSI_PKT_TYPE_WR, A55X_DECODER_VDDM_RETURN_SET_2, 0x0F);
#endif
...
static u8 A55X_TE_SETTING_1[] = {
	0xBD,
	0x81
};
static DEFINE_STATIC_PACKET(a55x_te_setting_1, DSI_PKT_TYPE_WR, A55X_TE_SETTING_1, 0x01);

static u8 A55X_TE_SETTING_2[] = {
	0xBD,
	0x40, 0x00, 0x00, 0x00, 0x00
};
static DEFINE_STATIC_PACKET(a55x_te_setting_2, DSI_PKT_TYPE_WR, A55X_TE_SETTING_2, 0x81);
...
static u8 A55X_TE_SHIFT[] = {
	0xB9,
	0x04, 0x00, 0x00, 0x00, 0x09, 0x0F, 0x00, 0x0F // 130us
	// 0x04, 0x00, 0x00, 0x00, 0x06, 0xf9, 0x00, 0x0F // 2msec
};
static DEFINE_STATIC_PACKET(a55x_te_shift, DSI_PKT_TYPE_WR, A55X_TE_SHIFT, 0);

static u8 A55X_TE_SHIFT_HLPM[] = {
	0xB9,
	0x04, 0x00, 0x00, 0x00, 0x09, 0x36, 0x00, 0x0F // 130us
};
static DEFINE_STATIC_PACKET(a55x_te_shift_hlpm, DSI_PKT_TYPE_WR, A55X_TE_SHIFT_HLPM, 0);

static u8 A55X_ERR_FG_ENABLE[] = { 0xE5, 0x15 };
static DEFINE_STATIC_PACKET(a55x_err_fg_enable, DSI_PKT_TYPE_WR, A55X_ERR_FG_ENABLE, 0);

static u8 A55X_ERR_FG_DISABLE[] = { 0xE5, 0x05 };
...
static u8 A55X_TSP_VSYNC_ENABLE1[] = {
	0xF2, 0xE8,
};
static u8 A55X_TSP_VSYNC_ENABLE2[] = {
	0xB9,
	0xB8, 0x6E
};
static u8 A55X_TSP_VSYNC_ENABLE3[] = {
	0xB9,
	0x00, 0x00, 0x04, 0x3D
};
static DEFINE_STATIC_PACKET(a55x_tsp_vsync_enable1, DSI_PKT_TYPE_WR, A55X_TSP_VSYNC_ENABLE1, 0x05);
static DEFINE_STATIC_PACKET(a55x_tsp_vsync_enable2, DSI_PKT_TYPE_WR, A55X_TSP_VSYNC_ENABLE2, 0x64);
static DEFINE_STATIC_PACKET(a55x_tsp_vsync_enable3, DSI_PKT_TYPE_WR, A55X_TSP_VSYNC_ENABLE3, 0x6A);

static u8 A55X_FPS[] = { 0x60, 0x08, 0x00 };
static DEFINE_PKTUI(a55x_fps, &a55x_maptbl[FPS_MAPTBL], 1);
...
static u8 A55X_FOD_ENTER[] = {
	0xB5, 0x14
};
static DEFINE_STATIC_PACKET(a55x_fod_enter, DSI_PKT_TYPE_WR, A55X_FOD_ENTER, 0);

static u8 A55X_FOD_EXIT[] = {
	0xB5, 0x14
};
static DEFINE_STATIC_PACKET(a55x_fod_exit, DSI_PKT_TYPE_WR, A55X_FOD_EXIT, 0);

static u8 A55X_TIG_ENABLE[] = {
	0xBF, 0x01, 0x00
};
static DEFINE_STATIC_PACKET(a55x_tig_enable, DSI_PKT_TYPE_WR, A55X_TIG_ENABLE, 0);

static u8 A55X_TIG_DISABLE[] = {
	0xBF, 0x00, 0x00
};
static DEFINE_STATIC_PACKET(a55x_tig_disable, DSI_PKT_TYPE_WR, A55X_TIG_DISABLE, 0);

static u8 A55X_DSC[] = { 0x01 };
static DEFINE_STATIC_PACKET(a55x_dsc, DSI_PKT_TYPE_WR_COMP, A55X_DSC, 0);
...
static DEFINE_STATIC_PACKET(a55x_pps, DSI_PKT_TYPE_WR_PPS, A55X_PPS, 0);

static u8 A55X_FFC_SETTING_1[] = {
	0xC5,
	0x68, 0xB9
};
static DEFINE_PKTUI(a55x_ffc_setting_1, &a55x_maptbl[SET_FFC_MAPTBL], 1);
static DEFINE_VARIABLE_PACKET(a55x_ffc_setting_1, DSI_PKT_TYPE_WR, A55X_FFC_SETTING_1, 0x3A);

static u8 A55X_FFC_SETTING_2[] = {
	0xC5,
	0x11, 0x10, 0x50, 0x05
};
static DEFINE_STATIC_PACKET(a55x_ffc_setting_2, DSI_PKT_TYPE_WR, A55X_FFC_SETTING_2, 0x36);

static u8 A55X_POWER_SEQ_IMPROVE[] = {
	0xCB,
	0xFF
};
static DEFINE_STATIC_PACKET(a55x_power_seq_improve, DSI_PKT_TYPE_WR, A55X_POWER_SEQ_IMPROVE, 0x1F);
...
#ifdef CONFIG_USDM_FACTORY_DSC_CRC_TEST
static u8 A55X_CRC_PATTERN_TEST_ON[] = {
	0xBE,
	0x05
};
static DEFINE_STATIC_PACKET(a55x_crc_pattern_test_on, DSI_PKT_TYPE_WR, A55X_CRC_PATTERN_TEST_ON, 0);

static u8 A55X_CRC_PATTERN_TEST_OFF[] = {
	0xBE,
	0x00
};
static DEFINE_STATIC_PACKET(a55x_crc_pattern_test_off, DSI_PKT_TYPE_WR, A55X_CRC_PATTERN_TEST_OFF, 0);

static u8 A55X_CRC_PATTERN_ENABLE[] = {
	0xBE,
	0x07
};
static DEFINE_STATIC_PACKET(a55x_crc_pattern_enable, DSI_PKT_TYPE_WR, A55X_CRC_PATTERN_ENABLE, 0);

static u8 A55X_CRC_READ_SETTING1[] = {
	0xD8,
	0x11
};
static DEFINE_STATIC_PACKET(a55x_crc_read_setting1, DSI_PKT_TYPE_WR, A55X_CRC_READ_SETTING1, 0x27);

static u8 A55X_CRC_READ_SETTING2[] = {
	0xD8,
	0x20
};
static DEFINE_STATIC_PACKET(a55x_crc_read_setting2, DSI_PKT_TYPE_WR, A55X_CRC_READ_SETTING2, 0x27);

#ifdef CONFIG_USDM_FACTORY
static u8 A55X_VDDM_LOW_SETTING[] = {
	0xD7,
	0x04
};
static DEFINE_STATIC_PACKET(a55x_vddm_low_setting, DSI_PKT_TYPE_WR, A55X_VDDM_LOW_SETTING, 0x02);
#else
static u8 A55X_VDDM_LOW_SETTING[] = {
	0xD7,
	0x00
...
static DEFINE_STATIC_PACKET(a55x_vddm_low_setting, DSI_PKT_TYPE_WR, A55X_VDDM_LOW_SETTING, 0x02);
#endif
static u8 A55X_VDDM_RETURN_SETTING[] = {
	0xD7,
	0x00
};
static DEFINE_STATIC_PACKET(a55x_vddm_return_setting, DSI_PKT_TYPE_WR, A55X_VDDM_RETURN_SETTING, 0x02);
#endif


#ifdef CONFIG_USDM_FACTORY_ECC_TEST
static u8 A55X_ECC_ENABLE[] = {
	0xF8,
	0x01
};

static u8 A55X_ECC_DISABLE[] = {
	0xF8,
	0x00
};

static DEFINE_STATIC_PACKET(a55x_ecc_enable, DSI_PKT_TYPE_WR, A55X_ECC_ENABLE, 0x02);
static DEFINE_STATIC_PACKET(a55x_ecc_disable, DSI_PKT_TYPE_WR, A55X_ECC_DISABLE, 0x02);
#endif
...
static DEFINE_VARIABLE_PACKET(a55x_te_frame_sel, DSI_PKT_TYPE_WR, A55X_TE_FRAME_SEL, 0);

static DEFINE_RULE_BASED_COND(a55x_cond_is_id_ge_03, PANEL_PROPERTY_PANEL_ID_3, GE, 0x03);
...
static void *a55x_common_setting_cmdtbl[] = {
	...
	&PKTINFO(a55x_cmd_fifo_setting),

	/* common setting */
	/* 4.1.1 TE(Vsync) ON/OFF */
	&PKTINFO(a55x_te_on),
	&PKTINFO(a55x_te_shift),
	...
	&PKTINFO(a55x_tsp_vsync_enable1),
	&PKTINFO(a55x_tsp_vsync_enable2),
	&PKTINFO(a55x_tsp_vsync_enable3),
	...
	&PKTINFO(a55x_elvss_timing_setting),
	&PKTINFO(a55x_panel_update),

	/* 4.1.13 Fixed TE (@HS 60Hz) */
	&PKTINFO(a55x_te_setting_1),
	&PKTINFO(a55x_te_setting_2),
	&PKTINFO(a55x_panel_update),

	&CONDINFO_IF(a55x_cond_is_id_ge_03),
                &PKTINFO(a55x_power_seq_improve),
                &PKTINFO(a55x_panel_update),
	&CONDINFO_FI(a55x_cond_is_id_ge_03),
...
static void *a55x_display_on_cmdtbl[] = {
	&CONDINFO_IF(a55x_cond_is_panel_state_lpm),
		&KEYINFO(a55x_level2_key_enable),
		&PKTINFO(a55x_tig_enable),
		&KEYINFO(a55x_level2_key_disable),
		&DLYINFO(a55x_wait_17msec),
	&CONDINFO_FI(a55x_cond_is_panel_state_lpm),
	&KEYINFO(a55x_level1_key_enable),
...
static void *a55x_decoder_test_cmdtbl[] = {
	&KEYINFO(a55x_level2_key_enable),
	&KEYINFO(a55x_level3_key_enable),
	&PKTINFO(a55x_decoder_test_caset),
	&PKTINFO(a55x_decoder_test_paset),
	&PKTINFO(a55x_decoder_test_2c),
	&PKTINFO(a55x_crc_pattern_test_on),
	&DLYINFO(a55x_wait_crc_test_50msec),
	&PKTINFO(a55x_crc_pattern_test_off),
	&DLYINFO(a55x_wait_crc_test_50msec),
	&PKTINFO(a55x_crc_pattern_enable),
	&PKTINFO(a55x_crc_read_setting1),
	&DLYINFO(a55x_wait_crc_test_50msec),
	&s6e3fc5_restbl[RES_DECODER_TEST1],
	&PKTINFO(a55x_crc_read_setting2),
	&DLYINFO(a55x_wait_crc_test_50msec),
	&s6e3fc5_restbl[RES_DECODER_TEST2],
	&DLYINFO(a55x_wait_crc_test_50msec),
	&PKTINFO(a55x_vddm_low_setting),
	&PKTINFO(a55x_crc_pattern_test_on),
	&DLYINFO(a55x_wait_crc_test_50msec),
	&PKTINFO(a55x_crc_pattern_test_off),
	&DLYINFO(a55x_wait_crc_test_50msec),
	...
	&PKTINFO(a55x_crc_pattern_test_off),
	&PKTINFO(a55x_vddm_return_setting),
	&KEYINFO(a55x_level2_key_disable),
	&KEYINFO(a55x_level3_key_disable),
};
#endif
...
static void *a55x_ecc_test_cmdtbl[] = {
	&KEYINFO(a55x_level2_key_enable),
	&KEYINFO(a55x_level3_key_enable),
	&PKTINFO(a55x_ecc_enable),
	&s6e3fc5_restbl[RES_ECC_TEST],
	&PKTINFO(a55x_ecc_disable),
	&KEYINFO(a55x_level2_key_disable),
	&KEYINFO(a55x_level3_key_disable),
};
#endif
...
struct common_panel_info s6e3fc5_a55x_panel_info = {
	.ldi_name = "s6e3fc5",
	.name = "s6e3fc5_a55x",
	.model = "AMS642DF01",
	.vendor = "SDC",
	...
	.common_panel_modes = &s6e3fc5_a55x_display_modes,
#endif
	.mres = {
		.nr_resol = ARRAY_SIZE(s6e3fc5_a55x_default_resol),
		.resol = s6e3fc5_a55x_default_resol,
	},
	.vrrtbl = s6e3fc5_a55x_default_vrrtbl,
	.nr_vrrtbl = ARRAY_SIZE(s6e3fc5_a55x_default_vrrtbl),
	.maptbl = a55x_maptbl,
...
#ifdef CONFIG_USDM_MDNIE
	.mdnie_tune = &s6e3fc5_a55x_mdnie_tune,
#endif
	.panel_dim_info = {
		[PANEL_BL_SUBDEV_TYPE_DISP] = &s6e3fc5_a55x_panel_dimming_info,
#ifdef CONFIG_USDM_PANEL_AOD_BL
		[PANEL_BL_SUBDEV_TYPE_AOD] = &s6e3fc5_a55x_panel_aod_dimming_info,
#endif
	},
#ifdef CONFIG_USDM_PANEL_RCD
	.rcd_data = &s6e3fc5_a55x_rcd,
#endif
};

#endif /* __S6E3FC5_A55X_PANEL_H__ */
