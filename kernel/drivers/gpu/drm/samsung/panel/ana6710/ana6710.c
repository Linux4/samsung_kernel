...
int ana6710_maptbl_getidx_hbm_with_local_hbm_transition(struct maptbl *tbl)
{
	int layer, row, col;
	struct panel_bl_device *panel_bl;
	struct panel_device *panel = (struct panel_device *)tbl->pdata;
...
struct pnobj_func ana6710_function_table[MAX_ANA6710_FUNCTION] = {
	...
	[ANA6710_MAPTBL_GETIDX_HBM_WITH_LOCAL_HBM_TRANSITION] = __PNOBJ_FUNC_INITIALIZER(ANA6710_MAPTBL_GETIDX_HBM_WITH_LOCAL_HBM_TRANSITION, ana6710_maptbl_getidx_hbm_with_local_hbm_transition),
