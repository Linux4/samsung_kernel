...
/* USBDPPHY_TCA_CTRL base address	0x178E0000 */

#define TCA_REG_TCA_CLK_RST 				(0x0)
...
#define TCA_REG_TCA_INTR_EN 				(0x4)
...
#define TCA_REG_TCA_INTR_STS 				(0x8)
...
#define TCA_REG_TCA_GCFG 				(0x10)
#define TCA_REG_OP_MODE 				(0x3 << 0)
#define TCA_REG_ROLE_HSTDEV 				(0x1 << 4)
#define TCA_REG_PHYSAFE_RESET_EN 			(0x1 << 8)

#define TCA_REG_TCA_TCPC 				(0x14)
#define TCA_REG_TCPC_MUX_CONTROL 			(0x3 << 0)
#define TCA_REG_TCPC_CONNECTOR_ORIENTATION 		(0x1 << 2)
#define TCA_REG_TCPC_LOW_POWER_EN 			(0x1 << 3)
#define TCA_REG_TCPC_VALID 				(0x1 << 4)

#define TCA_REG_TCA_SYSMODE_CFG 			(0x18)
...
#define TCA_REG_TCA_CTRLSYNCMODE_CFG0 			(0x20)
...
#define TCA_REG_TCA_CTRLSYNCMODE_CFG1 			(0x24)
#define TCA_REG_XA_TIMEOUT_VAL 				(0xFFFFF << 0)

#define TCA_REG_TCA_CTRLSYNCMODE_DBG0 			(0x28)
...
#define TCA_REG_TCA_GEN_STATUS 				(0x34)
...
#define TCA_REG_TCA_VBUS_CTRL 				(0x40)
...
#define TCA_REG_TCA_VBUS_STATUS 			(0x44)
...
#define TCA_REG_TCA_INFO_REG 				(0xFC)
