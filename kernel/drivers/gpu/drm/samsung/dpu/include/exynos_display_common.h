...
/*
 * Use EXPORT_SYMBOL_FOR_DPU_TESTS_ONLY() for functions that shall
 * only be visible for dpu kunit tests.
 */
#if IS_ENABLED(CONFIG_DRM_SAMSUNG_KUNIT_TEST)
#define EXPORT_SYMBOL_FOR_DPU_TESTS_ONLY(x) EXPORT_SYMBOL(x)
#else
#define EXPORT_SYMBOL_FOR_DPU_TESTS_ONLY(x)
#endif
