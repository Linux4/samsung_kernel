...
#define MIPI_DSI_ERR_BIT_MASK			(0x3f7f)
...
enum dsim_wide_freq_hop_range {
	DSIM_WIDE_FRE_HOP_LOW = 0,
	DSIM_WIDE_FRE_HOP_MID,
	DSIM_WIDE_FRE_HOP_HIGH,
};
...
#else
static inline bool dsim_reg_is_pll_sleep_state(u32 id) { return 0; }
static inline int dsim_reg_wait_exit_pll_sleep(u32 id) { return 0; }
#endif

#if defined(CONFIG_EXYNOS_PLL_SLEEP)
void dsim_reg_set_pll_sleep_enable(u32 id, u32 en);
#else
static inline void dsim_reg_set_pll_sleep_enable(u32 id, u32 en) { }
#endif
