...
#define DMA_SRC_STRIDE_3			0x005C
#define DMA_STRIDE__SEL				(1 << 31)
#define DMA_STRIDE_(_v)				((_v) << 0)
#define DMA_STRIDE__MASK			(0xFFFFFFFF << 0)
...
#define GLB_DPU_VERSION				(0x07020000)
...
#define GLB_OUTSTANDING_COUNT_MASK		0xff
...
#define DPP_BEXT_MODE(_v)			((_v) << 8)
#define DPP_BEXT_MODE_MASK			(1 << 8)
#define DPP_BEXT_MSB_COPY			DPP_BEXT_MODE(0)
#define DPP_BEXT_ZERO_PADDING			DPP_BEXT_MODE(1)
#define DPP_ALPHA_SEL(_v)			((_v) << 7)
#define DPP_ALPHA_SEL_MASK			(1 << 7)
#define DPP_ALPHA_PER_FRAME			DPP_ALPHA_SEL(0)
#define DPP_ALPHA_PER_PIXEL			DPP_ALPHA_SEL(1)
