...
#define DMA_RCD_FRAME_DONE_IRQ			(1 << 16)
#define DMA_RCD_ALL_IRQ_CLEAR			(0x7B << 16) // 0xFFFF -> 0x7B
...
#define DMA_RCD_ALL_IRQ_MASK			(0x7B << 1) // 0xF6 -> (0x7B << 1)
...
#define DMA_RCD_SRC_HEIGHT_MASK			(0xFFFF << 16)
#define DMA_RCD_SRC_WIDTH(_v)			((_v) << 0)
#define DMA_RCD_SRC_WIDTH_MASK			(0xFFFF << 0)

#define DMA_RCD_SRC_OFFSET			0x0014
#define DMA_RCD_SRC_OFFSET_Y(_v)		((_v) << 16)
#define DMA_RCD_SRC_OFFSET_Y_MASK		(0x3FFF << 16)
#define DMA_RCD_SRC_OFFSET_X(_v)		((_v) << 0)
#define DMA_RCD_SRC_OFFSET_X_MASK		(0x3FFF << 0)
...
#define DMA_RCD_SLV_SECURITY			0x0204

#define DMA_RCD_DEBUG_CTRL			0x0300
#define DMA_RCD_DEBUG_CTRL_SEL(_v)		((_v) << 16)
#define DMA_RCD_DEBUG_CTRL_SEL_MASK		(0xFFFF << 16)
#define DMA_RCD_DEBUG_CTRL_EN			(1 << 0)

#define DMA_RCD_DEBUG_DATA			0x0304

#define DMA_RCD_IN_REQ_DEST			0x0308
#define DMA_RCD_REQ_DEST_SEL(_v)		((_v) << 0)
#define DMA_RCD_REQ_DEST_SEL_MASK		(0x3 << 0)

#define DMA_RCD_PSLV_ERR_CTRL			0x030C
#define DMA_RCD_PSLV_ERR_CTRL_EN		(1 << 0)

#define DMA_RCD_S_CONFIG_ERR_STATUS		0x0740
#define DMA_RCD_CFG_ERR_ROTATION		(1 << 21)
#define DMA_RCD_CFG_ERR_IMG_HEIGHT_ROTATION	(1 << 20)
#define DMA_RCD_CFG_ERR_AFBC			(1 << 18)
#define DMA_RCD_CFG_ERR_SAJC			IDMA_CFG_ERR_AFBC
#define DMA_RCD_CFG_ERR_SBWC			(1 << 17)
#define DMA_RCD_CFG_ERR_BLOCK			(1 << 16)
#define DMA_RCD_CFG_ERR_FORMAT			(1 << 15)
#define DMA_RCD_CFG_ERR_STRIDE3			(1 << 14)
#define DMA_RCD_CFG_ERR_STRIDE2			(1 << 13)
#define DMA_RCD_CFG_ERR_STRIDE1			(1 << 12)
#define DMA_RCD_CFG_ERR_STRIDE0			(1 << 11)
#define DMA_RCD_CFG_ERR_CHROM_STRIDE		(1 << 10)
#define DMA_RCD_CFG_ERR_BASE_ADDR_P3            (1 << 9) // C2
#define DMA_RCD_CFG_ERR_BASE_ADDR_P2            (1 << 8) // Y2
#define DMA_RCD_CFG_ERR_BASE_ADDR_P1            (1 << 7) // C8
#define DMA_RCD_CFG_ERR_BASE_ADDR_P0            (1 << 6) // Y8
#define DMA_RCD_CFG_ERR_SRC_OFFSET_Y		(1 << 5)
#define DMA_RCD_CFG_ERR_SRC_OFFSET_X		(1 << 4)
#define DMA_RCD_CFG_ERR_IMG_HEIGHT		(1 << 3)
#define DMA_RCD_CFG_ERR_IMG_WIDTH		(1 << 2)
#define DMA_RCD_CFG_ERR_SRC_HEIGH		(1 << 1)
#define DMA_RCD_CFG_ERR_SRC_WIDTH		(1 << 0)
#define DMA_RCD_CFG_ERR_GET(_v)			(((_v) >> 0) & 0x37FFFF)
