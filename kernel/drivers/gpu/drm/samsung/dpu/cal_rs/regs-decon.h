...
#define DECON_VERSION_INFO			(0x06260000)
...
#define SHD_REG_UP_REQ_DQE_CGC			(1 << 30) // decon0 only
#define SHD_REG_UP_REQ_DQE_ROI			(1 << 29)
#define SHD_REG_UP_REQ_DQE			(1 << 28)
#define SHD_REG_UP_REQ_MDNIE			(1 << 27) // decon0 only
...
#define INT_EN_MDNIE				(1 << 22) // decon0 only
...
#define INT_PEND_MDNIE				(1 << 22) //decon0 only
...
#define BLD_EXT_CON				(0x0244)
#define BLENDER_DITHER_FCNT_OFFSET_F(_v)	(_v << 12)
#define BLENDER_DITHER_MASK_SEL_F(_v)		(_v << 9)
#define BLENDER_DITHER_MASK_SPIN_F(_v)		(_v << 8)
#define BLENDER_DITHER_BIT_F(_v)		(_v << 7)
#define BLENDER_DITHER_TYPE_F(_v)		(_v << 5)
#define BLENDER_DITHER_EN_F			(1 << 4)
#define BLENDER_DITHER_EN_F_MASK		(0x1 << 4)
#define BLENDER_EXT_TYPE_F(_v)			(_v << 1)
#define BLENDER_EXT_EN_F			(1 << 0)
#define BLENDER_EXT_EN_MASK			(0x1 << 0)
 ...
 * [20] AUTO_CG_EN_MDNIE (1=en / 0=dis)
...
#define WIN_PIXELMAP(_id)			(WIN_OFFSET(_id) + 0x20)
#define WIN_PIXELMAP_VALUE_F(_v)		((_v) << 4)
#define WIN_PIXELMAP_VALUE_F_MASK		(0x3 << 4)
#define WIN_PIXELMAP_CTL_F(_v)			((_v) << 0)
#define WIN_PIXELMAP_CTL_F_MASK		(0x3 << 0)
...
#define DSC_DEBUG_EN(_id)			(COMP_OFFSET(_id) + 0x0078)
...
/* MDNIE_** register set - Register offset and bit fields are not added*/
