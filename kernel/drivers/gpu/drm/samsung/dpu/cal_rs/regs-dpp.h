 ...
 *  L0, L1, L2, L3, L4, L5, L6, L7
 */
#define RDMA_AFBC_PARAM				0x0070 // not supported in s5e8845
...
#define GLB_DPU_VERSION                         (0x06260000)
...
#define RCD_ALL_IRQ_CLEAR               (0x7B << 16) // 0xFFFF -> 0x7B
...
#define RCD_ALL_IRQ_MASK                (0x7B << 1) // 0xF6 -> (0x7B << 1)
...
#define RCD_PIX_VALUE(_v)               ((_v) << 24)
#define RCD_PIX_VALUE_MASK              (0xFF << 24)
...
#define RCD_DATA_SAHRE_TYPE_P0(_v)      ((_v) << 4)
#define RCD_DATA_SAHRE_TYPE_P0_MASK     (0x3 << 4)
...
#define RCD_CFG_ERR_ROTATION            (1 << 21)
#define RCD_CFG_ERR_IMG_HEIGHT_ROTATION (1 << 20)
#define RCD_CFG_ERR_AFBC                (1 << 18)
#define RCD_CFG_ERR_SAJC                IDMA_CFG_ERR_AFBC
#define RCD_CFG_ERR_SBWC                (1 << 17)
#define RCD_CFG_ERR_BLOCK               (1 << 16)
#define RCD_CFG_ERR_FORMAT              (1 << 15)
#define RCD_CFG_ERR_STRIDE3             (1 << 14)
#define RCD_CFG_ERR_STRIDE2             (1 << 13)
#define RCD_CFG_ERR_STRIDE1             (1 << 12)
#define RCD_CFG_ERR_STRIDE0             (1 << 11)
#define RCD_CFG_ERR_CHROM_STRIDE        (1 << 10)
#define RCD_CFG_ERR_BASE_ADDR_P3        (1 << 9) // C2
#define RCD_CFG_ERR_BASE_ADDR_P2        (1 << 8) // Y2
#define RCD_CFG_ERR_BASE_ADDR_P1        (1 << 7) // C8
#define RCD_CFG_ERR_BASE_ADDR_P0        (1 << 6) // Y8
#define RCD_CFG_ERR_SRC_OFFSET_Y        (1 << 5)
#define RCD_CFG_ERR_SRC_OFFSET_X        (1 << 4)
#define RCD_CFG_ERR_IMG_HEIGHT          (1 << 3)
#define RCD_CFG_ERR_IMG_WIDTH           (1 << 2)
#define RCD_CFG_ERR_SRC_HEIGH           (1 << 1)
#define RCD_CFG_ERR_SRC_WIDTH           (1 << 0)
#define RCD_CFG_ERR_GET(_v)             (((_v) >> 0) & 0x37FFFF)
...
// Looks like Pamir-9925 register sets are similar to Papaya, REVISIT
