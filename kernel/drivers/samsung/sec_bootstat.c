 ...
 * freq[4] : cluster0 / cluster1L / cluster1H / cluster2
 * temp[7] : cluster0 / cluster1L / cluster1H / cluster2 / g3d / isp / npu
 */
...
{
	seq_printf(m, "%-50s %6u %6u %6d %4d %4d %4d %4d L%d%d%d%d M%d%d%d B%d %2d %2d %2d %2d %2d %2d %2d\n",
...
static int sec_boot_stat_proc_show(struct seq_file *m, void *v)
{
	...
	seq_puts(m, "boot event                                           time  ktime  delta f_c0 f_c1L f_c1H f_c2  online_mask   B  MH  ML  L  G  I  N\n");
	seq_puts(m, "----------------------------------------------------------------------------------------------------------------------\n");
