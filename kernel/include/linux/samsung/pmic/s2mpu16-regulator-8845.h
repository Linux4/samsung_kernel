...
#define S2MPU16_BUCK_MODE_SHIFT		2
#define S2MPU16_BUCK_MODE_MASK		0x0C
#define S2MPU16_BUCK_AUTO_MODE		(0x02 << S2MPU16_BUCK_MODE_SHIFT)
#define S2MPU16_BUCK_FCCM_MODE		(0x03 << S2MPU16_BUCK_MODE_SHIFT)
