...
#ifndef _EXYNOS_CPIF_IOMMU_INCLUDE_H
#define _EXYNOS_CPIF_IOMMU_INCLUDE_H
...
static inline void cpif_sysmmu_enable(void (*function)(bool)) { return; }
...
#endif /* _EXYNOS_CPIF_IOMMU_INCLUDE_H */
