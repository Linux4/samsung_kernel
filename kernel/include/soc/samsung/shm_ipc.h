...
#else /* CONFIG_SHM_IPC */
static inline int cp_shmem_get_mem_map_on_cp_flag(void) { return 0; }
void __iomem *cp_shmem_get_region_with_size(u32 idx, u32 size) { return NULL; }
static inline void __iomem *cp_shmem_get_region(u32 idx) { return NULL; }
static inline void __iomem *cp_shmem_get_nc_region(unsigned long base, u32 size) { return NULL; }
static inline void cp_shmem_release_region(u32 idx) { return; }
static inline void cp_shmem_release_rmem(u32 idx, u32 headroom) { return; }
static inline unsigned long cp_shmem_get_base(u32 idx) { return 0; }
static inline u32 cp_shmem_get_size(u32 idx) { return 0; }
static inline void cp_shmem_set_size(u32 idx, u32 size) { return 0; }
