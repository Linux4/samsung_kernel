...
#ifndef _DT_BINDINGS_EXYNOS_9935_ESCA_IPC_H
#define _DT_BINDINGS_EXYNOS_9935_ESCA_IPC_H
...
#define ESCA_IPC_APP__LLC			(ESCA_IPC_APP__BASE + 3)
#define ESCA_IPC_APP__BCM			(ESCA_IPC_APP__BASE + 4)
#define ESCA_IPC_APP__DM_SYNC			(ESCA_IPC_APP__BASE + 5)
#define ESCA_IPC_APP__NOTI_TMU			(ESCA_IPC_APP__BASE + 6)
#define ESCA_IPC_APP__DM_REQ			(ESCA_IPC_APP__BASE + 7)

#endif		/* _DT_BINDINGS_EXYNOS_9935_ESCA_IPC_H */
