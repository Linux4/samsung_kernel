...
static struct audio_gpio_attr aud_gpios[MT6989_AFE_GPIO_GPIO_NUM] = {
	...
	[MT6989_AFE_GPIO_AP_DMIC_OFF] = {"aud-gpio-ap-dmic-off", false, NULL},
	[MT6989_AFE_GPIO_AP_DMIC_ON] = {"aud-gpio-ap-dmic-on", false, NULL},
	[MT6989_AFE_GPIO_AP_DMIC1_OFF] = {"aud-gpio-ap-dmic34-off", false, NULL},
	[MT6989_AFE_GPIO_AP_DMIC1_ON] = {"aud-gpio-ap-dmic34-on", false, NULL},
	[MT6989_AFE_GPIO_AP_DMIC2_OFF] = {"aud-gpio-ap-dmic56-off", false, NULL},
	[MT6989_AFE_GPIO_AP_DMIC2_ON] = {"aud-gpio-ap-dmic56-on", false, NULL},
			    ...
			    int dai, int uplink)
{
	...
	case MT6989_DAI_AP_DMIC:
		if (enable)
			mt6989_afe_gpio_select(afe, MT6989_AFE_GPIO_AP_DMIC_ON);
		else
			mt6989_afe_gpio_select(afe, MT6989_AFE_GPIO_AP_DMIC_OFF);
		break;
	case MT6989_DAI_AP_DMIC_CH34:
		dev_info(afe->dev, "%s(), DMIC1 enable, need GPIO number\n", __func__);
		if (enable)
			mt6989_afe_gpio_select(afe, MT6989_AFE_GPIO_AP_DMIC1_ON);
		else
			mt6989_afe_gpio_select(afe, MT6989_AFE_GPIO_AP_DMIC1_OFF);
		break;
	case MT6989_DAI_AP_DMIC_CH56:
		dev_info(afe->dev, "%s(), DMIC2 enable, need GPIO number\n", __func__);
		if (enable)
			mt6989_afe_gpio_select(afe, MT6989_AFE_GPIO_AP_DMIC2_ON);
		else
			mt6989_afe_gpio_select(afe, MT6989_AFE_GPIO_AP_DMIC2_OFF);
		break;
	default:
