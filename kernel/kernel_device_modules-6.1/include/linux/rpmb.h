...
enum rpmb_request {
	...
	RPMB_REQ_PURGE_ENABLE = 0x0008,
	RPMB_REQ_PURGE_STATUS_READ = 0x0009,
};
...
enum rpmb_response {
	...
	RPMB_RESP_PURGE_ENABLE = 0x0800,
	RPMB_RESP_PURGE_STATUS_READ = 0x0900,
};

enum rpmb_purge_status {
	RPMB_PURGE_STA_NOT_INITED = 0,
	RPMB_PURGE_STA_IN_PROGRESS,
	RPMB_PURGE_STA_SUCCESS_COMPL,
	RPMB_PURGE_STA_GENR_FAILURE,
	RPMB_PURGE_STA_MAX
};
