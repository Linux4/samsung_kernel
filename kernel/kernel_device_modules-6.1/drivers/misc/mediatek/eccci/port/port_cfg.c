...
/* network port first for performace */
	...
	/* Ccmni8 feature only for special use */
	...
	{CCCI_CCMNI22_TX, CCCI_CCMNI22_RX, DATA1_TX_Q, DATA2_RX_Q,
		0xF0 | DATA_TX_ACK_Q, 0xFF, DPMAIF_HIF_ID, 0,
		&net_port_ops, 21, NET_IF_NAME"21",},
	{CCCI_CCMNI23_TX, CCCI_CCMNI23_RX, DATA1_TX_Q, DATA2_RX_Q,
		0xF0 | DATA_TX_ACK_Q, 0xFF, DPMAIF_HIF_ID, 0,
		&net_port_ops, 22, NET_IF_NAME"22",},
	{CCCI_CCMNI24_TX, CCCI_CCMNI24_RX, DATA1_TX_Q, DATA2_RX_Q,
		0xF0 | DATA_TX_ACK_Q, 0xFF, DPMAIF_HIF_ID, 0,
		&net_port_ops, 23, NET_IF_NAME"23",},
	{CCCI_CCMNI25_TX, CCCI_CCMNI25_RX, DATA1_TX_Q, DATA2_RX_Q,
		0xF0 | DATA_TX_ACK_Q, 0xFF, DPMAIF_HIF_ID, 0,
		&net_port_ops, 24, NET_IF_NAME"24",},
	{CCCI_CCMNI26_TX, CCCI_CCMNI26_RX, DATA1_TX_Q, DATA2_RX_Q,
		0xF0 | DATA_TX_ACK_Q, 0xFF, DPMAIF_HIF_ID, 0,
		&net_port_ops, 25, NET_IF_NAME"25",},
	{CCCI_CCMNI27_TX, CCCI_CCMNI27_RX, DATA1_TX_Q, DATA2_RX_Q,
		0xF0 | DATA_TX_ACK_Q, 0xFF, DPMAIF_HIF_ID, 0,
		&net_port_ops, 26, NET_IF_NAME"26",},
	{CCCI_CCMNI28_TX, CCCI_CCMNI28_RX, DATA1_TX_Q, DATA2_RX_Q,
		0xF0 | DATA_TX_ACK_Q, 0xFF, DPMAIF_HIF_ID, 0,
		&net_port_ops, 27, NET_IF_NAME"27",},
	{CCCI_CCMNI29_TX, CCCI_CCMNI29_RX, DATA1_TX_Q, DATA2_RX_Q,
		0xF0 | DATA_TX_ACK_Q, 0xFF, DPMAIF_HIF_ID, 0,
		&net_port_ops, 28, NET_IF_NAME"28",},
	{CCCI_CCMNI30_TX, CCCI_CCMNI30_RX, DATA1_TX_Q, DATA2_RX_Q,
		0xF0 | DATA_TX_ACK_Q, 0xFF, DPMAIF_HIF_ID, 0,
		&net_port_ops, 29, NET_IF_NAME"29",},
	/* char port, notes ccci_monitor must be first
	 * for get_port_by_minor() implement
	 */
	{CCCI_PCM_TX, CCCI_PCM_RX, 0, 0, 0xFF, 0xFF, MD1_NORMAL_HIF,
