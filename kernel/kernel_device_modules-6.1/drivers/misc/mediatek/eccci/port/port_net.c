...
int ccci_get_ccmni_channel(int ccmni_idx, struct ccmni_ch *channel)
{
	...
	case 20:
		...
		break;
	case 21:
		channel->rx = CCCI_CCMNI22_RX;
		channel->rx_ack = 0xFF;
		channel->tx = CCCI_CCMNI22_TX;
		channel->tx_ack = 0xFF;
		channel->dl_ack = CCCI_CCMNI22_TX;
		break;
	case 22:
		channel->rx = CCCI_CCMNI23_RX;
		channel->rx_ack = 0xFF;
		channel->tx = CCCI_CCMNI23_TX;
		channel->tx_ack = 0xFF;
		channel->dl_ack = CCCI_CCMNI23_TX;
		break;
	case 23:
		channel->rx = CCCI_CCMNI24_RX;
		channel->rx_ack = 0xFF;
		channel->tx = CCCI_CCMNI24_TX;
		channel->tx_ack = 0xFF;
		channel->dl_ack = CCCI_CCMNI24_TX;
		break;
	case 24:
		channel->rx = CCCI_CCMNI25_RX;
		channel->rx_ack = 0xFF;
		channel->tx = CCCI_CCMNI25_TX;
		channel->tx_ack = 0xFF;
		channel->dl_ack = CCCI_CCMNI25_TX;
		break;
	case 25:
		channel->rx = CCCI_CCMNI26_RX;
		channel->rx_ack = 0xFF;
		channel->tx = CCCI_CCMNI26_TX;
		channel->tx_ack = 0xFF;
		channel->dl_ack = CCCI_CCMNI26_TX;
		break;
	case 26:
		channel->rx = CCCI_CCMNI27_RX;
		channel->rx_ack = 0xFF;
		channel->tx = CCCI_CCMNI27_TX;
		channel->tx_ack = 0xFF;
		channel->dl_ack = CCCI_CCMNI27_TX;
		break;
	case 27:
		channel->rx = CCCI_CCMNI28_RX;
		channel->rx_ack = 0xFF;
		channel->tx = CCCI_CCMNI28_TX;
		channel->tx_ack = 0xFF;
		channel->dl_ack = CCCI_CCMNI28_TX;
		break;
	case 28:
		channel->rx = CCCI_CCMNI29_RX;
		channel->rx_ack = 0xFF;
		channel->tx = CCCI_CCMNI29_TX;
		channel->tx_ack = 0xFF;
		channel->dl_ack = CCCI_CCMNI29_TX;
		break;
	case 29:
		channel->rx = CCCI_CCMNI30_RX;
		channel->rx_ack = 0xFF;
		channel->tx = CCCI_CCMNI30_TX;
		channel->tx_ack = 0xFF;
		channel->dl_ack = CCCI_CCMNI30_TX;
		break;
	default:
