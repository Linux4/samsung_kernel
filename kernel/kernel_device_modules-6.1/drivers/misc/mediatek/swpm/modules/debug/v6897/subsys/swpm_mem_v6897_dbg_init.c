...
int __init swpm_mem_v6897_dbg_init(void)
{
...
void __exit swpm_mem_v6897_dbg_exit(void)
{
	swpm_mem_v6897_exit();
}

module_init(swpm_mem_v6897_dbg_init);
module_exit(swpm_mem_v6897_dbg_exit);

MODULE_LICENSE("GPL");
MODULE_DESCRIPTION("v6897 SWPM mem debug module");
