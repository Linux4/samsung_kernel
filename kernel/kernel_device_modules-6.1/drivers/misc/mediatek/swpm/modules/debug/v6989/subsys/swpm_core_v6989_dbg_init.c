...
void __exit swpm_core_v6989_dbg_exit(void)
{
	swpm_core_v6989_exit();
}

module_init(swpm_core_v6989_dbg_init);
module_exit(swpm_core_v6989_dbg_exit);

MODULE_LICENSE("GPL");
MODULE_DESCRIPTION("v6989 SWPM core debug module");
