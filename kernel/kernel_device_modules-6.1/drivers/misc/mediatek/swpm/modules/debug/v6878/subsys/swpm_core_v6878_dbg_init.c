...
void __exit swpm_core_v6878_dbg_exit(void)
{
	swpm_core_v6878_exit();
}

module_init(swpm_core_v6878_dbg_init);
module_exit(swpm_core_v6878_dbg_exit);

MODULE_LICENSE("GPL");
MODULE_DESCRIPTION("v6878 SWPM core debug module");
