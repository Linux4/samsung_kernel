...
static struct rfhw_power_t rfhw_6989[TX_DBM_NUM] = {
	[TX_2G_DBM] = {
		.pa_power = {
			{ 1136,  1024,  848,  704,  576,  480,
			   400,  274,  221,   177,   113,   73},   /*MAX*/
			{ 1136,  1024,  848,  704,  576,  480,
			   400,  274,  221,   177,   113,   73} }, /*AVG*/
		.rf_power = {
			{  200,  195,  193,  178,  171,  156,
			   151,  150,  148,  147,  151,  152},   /*MAX*/
			{  200,  195,  193,  178,  171,  156,
			   151,  150,  148,  147,  151,  152} }, /*AVG*/
		.section = {
			31, 30, 28, 26, 24, 22, 20, 18, 14, 10,  6,  0}
	},
	...
	[TX_3G_DBM] = {
		.pa_power = {
			{  2742, 2358, 1537, 1367, 871,  788,
			   593,  539,  459,  364,  340,  254},   /*MAX*/
			{  2742, 2358, 1537, 1367, 871,  788,
			   593,  539,  459,  364,  340,  254} }, /*AVG*/
		.rf_power = {
			{  335,  358,  270,  278,  234,  232,
			   286,  242,  243,  238,  239,  215},   /*MAX*/
			{  335,  358,  270,  278,  234,  232,
			   286,  242,  243,  238,  239,  215} }, /*AVG*/
		.section = {
			23, 22, 21, 20, 19, 18, 17, 15,  14,  13,  9,  0}
	},
	...
	[TX_4G_CC0_DBM] = {
		.pa_power = {
			{  1840, 1273, 1072, 822, 757,  549,
			   417,  285,  258,  245,  183,  108},   /*MAX*/
			{  1840, 1273, 1072, 822, 757,  549,
			   417,  285,  258,  245,  183,  108} }, /*AVG*/
		.rf_power = {
			{  308,  292,  291,  294,  267,  267,
			   264,  269,  254,  237,  257,  241},   /*MAX*/
			{  308,  292,  291,  294,  267,  267,
			   264,  269,  254,  237,  257,  241} }, /*AVG*/
		.section = {
			23, 22, 21, 20, 18, 17, 15, 13,  12,  11,  6,  0}
	},
	...
	[TX_NR_CC0_DBM] = {
		.pa_power = {
			{  4582,  4462,  4442,  3802,  3130,  3028,
			   1994,  1674,  1660,  1316,  403,  220},   /*MAX*/
			{  4582,  4462,  4442,  3802,  3130,  3028,
			   1994,  1674,  1660,  1316,  403,  220} }, /*AVG*/
		.rf_power = {
			{  513,  505,  502,  492,  486,  483,
			   493,  488,  488,  486,  464,  475},   /*MAX*/
			{  513,  505,  502,  492,  486,  483,
			   493,  488,  488,  486,  464,  475} }, /*AVG*/
		.section = {
			23, 21, 20, 19, 18, 17, 14, 13,  11,  7,  4,  0}
	},
...
static struct scenario_power_type_t md_scen_power_6878[SCENARIO_NUM] = {
	[S_STANDBY]		= {    1,    1},
	[S_2G_IDLE]		= {    50,  50},
	[S_C2K_DATALINK] = {   53,  53},
	[S_3G_IDLE]		= {    54,  54},
...
static struct rfhw_power_t rfhw_6878[TX_DBM_NUM] = {
	[TX_2G_DBM] = {
		.pa_power = {
			{ 876,  684,  543,  436,  349,  282,
			   228,  186,  153,   126,   89,   58},   /*MAX*/
