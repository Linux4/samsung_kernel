...
#define WSM_FFA			4	/** Buffer mapping uses FFA handles */
...
struct cmd_open {
	...
	union {
		...
		struct mclf_header	tl_header;	/** Service header */
	};
	u32		unused_gpta;	/** Check on is_gpta is now unused*/
};
 ...
 * Allowed memory type here are WSM_L1 and WSM_FFA.
 */
