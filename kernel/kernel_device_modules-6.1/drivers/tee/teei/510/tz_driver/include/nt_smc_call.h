...
#define ID_FIELD_F_FAST_SMC_CALL		1UL
#define ID_FIELD_F_STANDARD_SMC_CALL		0UL
#define ID_FIELD_W_64				1UL
#define ID_FIELD_W_32				0UL

#define ID_FIELD_T_ARM_SERVICE			0UL
#define ID_FIELD_T_CPU_SERVICE			1UL
#define ID_FIELD_T_SIP_SERVICE			2UL
#define ID_FIELD_T_OEM_SERVICE			3UL
#define ID_FIELD_T_STANDARD_SERVICE		4UL
/*TA Call 48-49*/
#define ID_FIELD_T_TA_SERVICE0			48UL
#define ID_FIELD_T_TA_SERVICE1			49UL
/*TOS Call 50-63*/
#define ID_FIELD_T_TRUSTED_OS_SERVICE0		50UL
#define ID_FIELD_T_TRUSTED_OS_SERVICE1		51UL
#define ID_FIELD_T_TRUSTED_OS_SERVICE2		52UL
#define ID_FIELD_T_TRUSTED_OS_SERVICE3		53UL
...
#define N_INIT_T_SOTER_POOL        \
		MAKE_SMC_CALL_ID(ID_FIELD_F_FAST_SMC_CALL, \
		ID_FIELD_W_32, ID_FIELD_T_TRUSTED_OS_SERVICE2, 15)
