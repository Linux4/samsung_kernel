...
enum {
	SOTER_SEC_WORLD_ID_TLOG,
	SOTER_SEC_WORLD_ID_VFS,
	SOTER_SEC_WORLD_ID_POOL,
	SOTER_SEC_WORLD_ID_NQ,
	SOTER_SEC_WORLD_ID_MAX
};

extern unsigned long soter_sec_world_id[];
