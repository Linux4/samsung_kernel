...
#if 0//def CONFIG_IMGSENSOR_SYSFS
 ...
 */
int set_sm5714_rear_flash(const char *buf, size_t count)
{
	int ret;
	u32 store_value;
	struct sm5714_fled_data *fled = g_sm5714_fled;
...
EXPORT_SYMBOL_GPL(set_sm5714_rear_flash);

int get_sm5714_rear_flash(char *buf)
{
	struct sm5714_fled_data *fled = g_sm5714_fled;
...
EXPORT_SYMBOL_GPL(get_sm5714_rear_flash);
