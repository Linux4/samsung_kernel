...
static const struct mtk_pin_desc mtk_pins_mt6989[] = {
	...
	MTK_PIN_NODRV(
		...
		MTK_FUNCTION(1, "TP_DIQ_MIPI_M_SCLK")
	),
	MTK_PIN_NODRV(
		26, "GPIO26",
		MTK_EINT_FUNCTION(NO_EINT_SUPPORT, NO_EINT_SUPPORT),
		MTK_FUNCTION(0, "GPIO26"),
		MTK_FUNCTION(1, "TP_DIQ_MIPI_M_SDATA")
	),
	MTK_PIN_NODRV(
		27, "GPIO27",
	...
	MTK_PIN_NODRV(
		...
		MTK_FUNCTION(1, "TP_IRQ")
	),
	MTK_PIN_NODRV(
		29, "GPIO29",
		MTK_EINT_FUNCTION(NO_EINT_SUPPORT, NO_EINT_SUPPORT),
		MTK_FUNCTION(0, "GPIO29"),
		MTK_FUNCTION(1, "TP_IO_SUSB")
	),
	MTK_PIN_NODRV(
		30, "GPIO30",
		MTK_EINT_FUNCTION(NO_EINT_SUPPORT, NO_EINT_SUPPORT),
