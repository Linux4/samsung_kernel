...
#define WACOM_DEBUG_PRINT_TIMEINFO		0x10
...
struct wacom_i2c {
	...
	int pen_pdct_direction;		/* for dual garage */
...
void wacom_disable_mode(struct wacom_i2c *wac_i2c, u8 mode);
