...
#define SEC_INPUT_DEFAULT_AVDD_NAME	"tsp-avdd-ldo"
#define SEC_INPUT_DEFAULT_DVDD_NAME	"tsp-io-ldo"
...
extern void sec_input_irq_disable(struct sec_ts_plat_data *pdata);
extern void sec_input_irq_enable(struct sec_ts_plat_data *pdata);
extern void sec_input_irq_disable_nosync(struct sec_ts_plat_data *pdata);
