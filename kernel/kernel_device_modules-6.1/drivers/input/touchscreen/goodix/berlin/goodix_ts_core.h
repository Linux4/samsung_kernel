...
int goodix_get_config_proc(struct goodix_ts_data *ts, const struct firmware *firmware);
...
int goodix_fw_update_init(struct goodix_ts_data *ts, const struct firmware *firmware);
