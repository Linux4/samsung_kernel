...
#define FLASH_CX_PAGE_START		29	/* /< starting page which
						 * contain Cx data */
...
/* FIFO */
#define FIFO_EVENT_SIZE 16	/* /< number of bytes of one event */
...
#ifdef I2C_INTERFACE
#define FIFO_CMD_READALL	0x61	/* /< command to read all the events in
					 * the FIFO */
#else
