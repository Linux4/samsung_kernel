...
/* /< if defined allow to use and test special functions
...
/* Allow to compute init data on phone during production */
...
#ifdef FW_H_FILE
	#define FW_SIZE_NAME tab_s10p_fw_size /* /< name of the variable in \
										* the FW header file which   \
										* specified the dimension of \
										* the FW data array */
	#define FW_ARRAY_NAME tab_s10p_fw	  /* /< name of the variable in the FW  \
...
/* **** PANEL SPECIFICATION **** */
#define X_AXIS_MAX	1752	/* /< Max X coordinate of the display */
#define X_AXIS_MIN	0	/* /< min X coordinate of the display */
#define Y_AXIS_MAX	2800	/* /< Max Y coordinate of the display */
