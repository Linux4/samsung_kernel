...
//FIXME : This is for only bringup. becauseof 90degree rotation ,need to revise later.
	rotated_x = pdata->coord[tid].y;
	rotated_y =  pdata->max_x - pdata->coord[tid].x - 1;
	rotated_x = rotated_x * pdata->max_x / pdata->max_y;
	rotated_y = rotated_y * pdata->max_y / pdata->max_x;
	pdata->coord[tid].x = rotated_x;
	pdata->coord[tid].y = rotated_y;
//FIXME
