...
static ssize_t proximity_stk3afx_prox_trim_show(char *buf)
{
...
static ssize_t proximity_stk3afx_prox_cal_store(const char *buf, size_t size)
{
	int ret = 0;
