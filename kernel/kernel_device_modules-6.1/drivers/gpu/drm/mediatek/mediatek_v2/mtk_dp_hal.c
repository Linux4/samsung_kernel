...
void mhal_DPTx_PHYSetting(struct mtk_dp *mtk_dp)
{
	...
	msWrite4Byte(mtk_dp, 0x1338, value);
	msWrite4Byte(mtk_dp, 0x1438, value);
	...
	msWrite4Byte(mtk_dp, 0x133C, value);
	msWrite4Byte(mtk_dp, 0x143C, value);
	...
	msWrite4Byte(mtk_dp, 0x1340, value);
	msWrite4Byte(mtk_dp, 0x1440, value);
	...
	msWrite4Byte(mtk_dp, 0x1344, value);
	msWrite4Byte(mtk_dp, 0x1444, value);
	...
	msWrite4Byte(mtk_dp, 0x1348, value);
	msWrite4Byte(mtk_dp, 0x1448, value);
	...
	msWrite4Byte(mtk_dp, 0x134C, value);
	msWrite4Byte(mtk_dp, 0x144C, value);
...
//PORTING FROM CTP
	...
	if (mtk_dp->sec_dp && mtk_dp->sec_dp->funcs.get_aux_level) {
		...
		msWrite4ByteMask(mtk_dp, DP_PHT_GLB_DPAUX_TX,
			aux_level << DP_PHT_GLB_DPAUX_TX_POS, BITMASK(6:3));
	}
#else
	// AUX setting DP_PHT_GLB_DPAUX_TX
	msWrite4ByteMask(mtk_dp, DP_PHT_GLB_DPAUX_TX,
		0xA << DP_PHT_GLB_DPAUX_TX_POS, BITMASK(6:3));
#endif
