...
//-------------------------------------
	...
	lcm_dcs_write_seq_static(ctx, 0xE0, 0xC3, 0x69, 0xFF, 0x1D, 0x00, 
            0x00, 0xC6, 0xCC, 0x00, 0xAA, 0x1A); /* HBM IRC MODE : Flat Gamma Z */
	lcm_dcs_write_seq_static(ctx, 0xF0, 0xA5, 0xA5);
...
static const struct of_device_id lcm_of_match[] = {
	{ .compatible = "anapass,ana38407-wqxga-dphy-cmd", },
	{ }
};
...
static struct mipi_dsi_driver lcm_driver = {
	...
	.remove = lcm_remove,
	.driver = {
		.name = "panel-ana38407-wqxga-dphy-cmd",
		.owner = THIS_MODULE,
