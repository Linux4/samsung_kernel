...
#include "ana38407_gts10p_panel.h"
#include "ana38407_gts10p_ezop.h"
...
static struct panel_prop_list ana38407_gts10p_property_array[] = {
#ifdef CONFIG_USDM_MDNIE
	__DIMEN_PROPERTY_RANGE_INITIALIZER(OLED_MDNIE_NIGHT_LEVEL_PROPERTY,
			0, 0, ANA38407_GTS10P_MAX_NIGHT_LEVEL,
			oled_mdnie_night_level_property_update),
	__DIMEN_PROPERTY_RANGE_INITIALIZER(OLED_MDNIE_HBM_CE_LEVEL_PROPERTY,
			0, 0, ANA38407_GTS10P_MAX_HBM_CE_LEVEL,
			oled_mdnie_hbm_ce_level_property_update),
#endif
};

__visible_for_testing int __init ana38407_gts10p_panel_init(void)
{
	struct common_panel_info *cpi = &ana38407_gts10p_panel_info;

	ana38407_init(cpi);

	cpi->ezop_json = EZOP_JSON_BUFFER;
	cpi->prop_lists[USDM_DRV_LEVEL_MODEL] = ana38407_gts10p_property_array;
	cpi->num_prop_lists[USDM_DRV_LEVEL_MODEL] = ARRAY_SIZE(ana38407_gts10p_property_array);
...
__visible_for_testing void __exit ana38407_gts10p_panel_exit(void)
{
	deregister_common_panel(&ana38407_gts10p_panel_info);
}

module_init(ana38407_gts10p_panel_init)
module_exit(ana38407_gts10p_panel_exit)
