/*
 * linux/drivers/video/fbdev/exynos/panel/ana38407/ana38407_gts10p_aod_panel.h
 *
...
#ifndef __ANA38407_GTS10P_AOD_PANEL_H__
#define __ANA38407_GTS10P_AOD_PANEL_H__

#include "oled_common_aod.h"
#include "ana38407_gts10p_self_mask_img.h"
#include "ana38407_aod.h"

#define ANA38407_GTS10P_SELF_MASK_VALID_CRC_1 (0xD3)
#define ANA38407_GTS10P_SELF_MASK_VALID_CRC_2 (0x9B)

static u8 ana38407_gts10p_self_mask_crc[] = {
	ANA38407_GTS10P_SELF_MASK_VALID_CRC_1,
	ANA38407_GTS10P_SELF_MASK_VALID_CRC_2,
};
...
static char ANA38407_AOD_FACTORY_SELF_MASK_ENA[] = {
	0x7A,
	0x05, 0x00, 0x00, 0x02, 0x00, 0x00, 0x03, 0xE7, 0x06, 0x74, 0x06,
	0xD7, 0x09, 0xF2, 0x03, 0x28, 0x0A, 0x7A, 0x03, 0xB0, 0x00, 0x00,
...
static DEFINE_RULE_BASED_COND(gts10p_cond_is_factory_selfmask,
		PANEL_PROPERTY_IS_FACTORY_MODE, EQ, 1);

static void *ana38407_gts10p_aod_self_mask_ena_cmdtbl[] = {
	&KEYINFO(ana38407_aod_l2_key_enable),
	&PKTINFO(ana38407_aod_self_mask_ctrl_ena),
	&KEYINFO(ana38407_aod_l2_key_disable),
};
static DEFINE_SEQINFO(gts10p_self_mask_ena_seq, ana38407_gts10p_aod_self_mask_ena_cmdtbl);
...
static void *ana38407_gts10p_aod_self_mask_dis_cmdtbl[] = {
	&KEYINFO(ana38407_aod_l2_key_enable),
...
// --------------------- check sum control ----------------------------
static DEFINE_STATIC_PACKET_WITH_OPTION(ana38407_gts10p_aod_self_mask_img_pkt,
		DSI_PKT_TYPE_WR_SR, ANA38407_GTS10P_SELF_MASK_IMG, 0, PKT_OPTION_SR_ALIGN_16);

#if 0
static DEFINE_STATIC_PACKET_WITH_OPTION(ana38407_gts10p_aod_self_mask_crc_img_pkt,
		DSI_PKT_TYPE_WR_SR, ANA38407_GTS10P_SELF_MASK_CRC_IMG, 0, PKT_OPTION_SR_ALIGN_16);
...
static void *ana38407_gts10p_aod_self_mask_crc_cmdtbl[] = {
	...
	&PKTINFO(ana38407_gts10p_aod_self_mask_crc_img_pkt),
...
static void *ana38407_gts10p_aod_self_mask_img_cmdtbl[] = {
	&KEYINFO(ana38407_aod_l1_key_enable),
	&KEYINFO(ana38407_aod_l2_key_enable),
	...
	&DLYINFO(ana38407_aod_self_spsram_sel_delay),
	&PKTINFO(ana38407_gts10p_aod_self_mask_img_pkt),
	&DLYINFO(ana38407_aod_self_spsram_write_delay),
...
static DEFINE_SEQINFO(gts10p_self_mask_img_seq, ana38407_gts10p_aod_self_mask_img_cmdtbl);

static struct seqinfo ana38407_gts10p_aod_seqtbl[] = {
	SEQINFO_INIT(SELF_MASK_IMG_SEQ, ana38407_gts10p_aod_self_mask_img_cmdtbl),
	SEQINFO_INIT(SELF_MASK_ENA_SEQ, ana38407_gts10p_aod_self_mask_ena_cmdtbl),
	SEQINFO_INIT(SELF_MASK_DIS_SEQ, ana38407_gts10p_aod_self_mask_dis_cmdtbl),
//	SEQINFO_INIT(SELF_MASK_CRC_SEQ, ana38407_gts10p_aod_self_mask_crc_cmdtbl),
};

static struct aod_tune ana38407_gts10p_aod = {
	.name = "ana38407_gts10p_aod",
	.nr_seqtbl = ARRAY_SIZE(ana38407_gts10p_aod_seqtbl),
	.seqtbl = ana38407_gts10p_aod_seqtbl,
	.nr_maptbl = ARRAY_SIZE(ana38407_aod_maptbl),
	.maptbl = ana38407_aod_maptbl,
	.self_mask_en = true,
	.self_mask_crc = ana38407_gts10p_self_mask_crc,
	.self_mask_crc_len = ARRAY_SIZE(ana38407_gts10p_self_mask_crc),
};
#endif
