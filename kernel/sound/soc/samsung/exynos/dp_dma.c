...
#if IS_ENABLED(CONFIG_SEC_DISPLAYPORT) /*IS_ENABLED(CONFIG_SOC_EXYNOS9810) || IS_ENABLED(CONFIG_SOC_EXYNOS9820)*/
#define USE_SWITCH 1
...
#if IS_ENABLED(CONFIG_SEC_DISPLAYPORT)/*defined(CONFIG_SOC_EXYNOS9810) || defined(CONFIG_SOC_EXYNOS9820)*/
