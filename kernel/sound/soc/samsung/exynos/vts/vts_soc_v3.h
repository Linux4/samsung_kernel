...
#ifndef __SND_SOC_VTS_DEP_SOC_V3_H
#define __SND_SOC_VTS_DEP_SOC_V3_H
...
#define BUFFER_BYTES_MAX (0xF0000)
#define PERIOD_BYTES_MIN (SZ_4)
#define PERIOD_BYTES_MAX (BUFFER_BYTES_MAX / 3)
...
#define VTS_ITMON_NAME "SS_VTS" /* refer to bootloader/platform/s5e9935/debug/itmon.c */

#define VTS_SRAM_SZ 0x200000

#endif /* __SND_SOC_VTS_DEP_SOC_V3_H */
