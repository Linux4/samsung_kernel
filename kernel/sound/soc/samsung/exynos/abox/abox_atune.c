...
static const struct snd_kcontrol_new atune_controls[] = {
	...
	SOC_SINGLE("SPUS0 PREGAIN FADE IN COUNTER", SPUS_USGAIN_FADEIN_CNT(0),
			0, FADEIN_CNT_MASK, 0),
	SOC_SINGLE("SPUS0 PREGAIN FADE OUT COUNTER", SPUS_USGAIN_FADEOUT_CNT(0),
			0, FADEOUT_CNT_MASK, 0),
#endif
	...
	SOC_SINGLE_XR_SX("SPUS0 POSTGAIN VOL CHANGE FADE OUT",
			...
			1, 32, INT_MIN, 0, 0),
#if !IS_ENABLED(CONFIG_SOC_S5E8835)
	SOC_SINGLE("SPUS0 POSTGAIN FADE IN COUNTER", SPUS_DSGAIN_FADEIN_CNT(0),
			0, FADEIN_CNT_MASK, 0),
	SOC_SINGLE("SPUS0 POSTGAIN FADE OUT COUNTER", SPUS_DSGAIN_FADEOUT_CNT(0),
			0, FADEOUT_CNT_MASK, 0),
#endif
	...
	SOC_SINGLE_XR_SX("SPUM0 PREGAIN VOL CHANGE FADE OUT",
			...
			1, 32, INT_MIN, 0, 0),
#if !IS_ENABLED(CONFIG_SOC_S5E8835)
	SOC_SINGLE("SPUM0 PREGAIN FADE IN COUNTER", SPUM_USGAIN_FADEIN_CNT(0),
			0, FADEIN_CNT_MASK, 0),
	SOC_SINGLE("SPUM0 PREGAIN FADE OUT COUNTER", SPUM_USGAIN_FADEOUT_CNT(0),
			0, FADEOUT_CNT_MASK, 0),
#endif
	...
	SOC_SINGLE_XR_SX("SPUM0 POSTGAIN VOL CHANGE FADE OUT",
			...
			1, 32, INT_MIN, 0, 0),
#if !IS_ENABLED(CONFIG_SOC_S5E8835)
	SOC_SINGLE("SPUM0 POSTGAIN FADE IN COUNTER", SPUM_DSGAIN_FADEIN_CNT(0),
			0, FADEIN_CNT_MASK, 0),
	SOC_SINGLE("SPUM0 POSTGAIN FADE OUT COUNTER", SPUM_DSGAIN_FADEOUT_CNT(0),
			0, FADEOUT_CNT_MASK, 0),
#endif
...
static const struct snd_kcontrol_new atune1_controls[] = {
	...
	SOC_SINGLE_XR_SX("SPUS1 PREGAIN VOL CHANGE FADE OUT",
			...
			1, 32, INT_MIN, 0, 0),
	SOC_SINGLE("SPUS1 PREGAIN FADE IN COUNTER", SPUS_USGAIN_FADEIN_CNT(1),
			0, FADEIN_CNT_MASK, 0),
	SOC_SINGLE("SPUS1 PREGAIN FADE OUT COUNTER", SPUS_USGAIN_FADEOUT_CNT(1),
			0, FADEOUT_CNT_MASK, 0),
	...
	SOC_SINGLE_XR_SX("SPUS1 POSTGAIN VOL CHANGE FADE OUT",
			...
			1, 32, INT_MIN, 0, 0),
	SOC_SINGLE("SPUS1 POSTGAIN FADE IN COUNTER", SPUS_DSGAIN_FADEIN_CNT(1),
			0, FADEIN_CNT_MASK, 0),
	SOC_SINGLE("SPUS1 POSTGAIN FADE OUT COUNTER", SPUS_DSGAIN_FADEOUT_CNT(1),
			0, FADEOUT_CNT_MASK, 0),
	...
	SOC_SINGLE_XR_SX("SPUM1 PREGAIN VOL CHANGE FADE OUT",
			...
			1, 32, INT_MIN, 0, 0),
	SOC_SINGLE("SPUM1 PREGAIN FADE IN COUNTER", SPUM_USGAIN_FADEIN_CNT(1),
			0, FADEIN_CNT_MASK, 0),
	SOC_SINGLE("SPUM1 PREGAIN FADE OUT COUNTER", SPUM_USGAIN_FADEOUT_CNT(1),
			0, FADEOUT_CNT_MASK, 0),
	...
	SOC_SINGLE_XR_SX("SPUM1 POSTGAIN VOL CHANGE FADE OUT",
			...
			1, 32, INT_MIN, 0, 0),
	SOC_SINGLE("SPUM1 POSTGAIN FADE IN COUNTER", SPUM_DSGAIN_FADEIN_CNT(1),
			0, FADEIN_CNT_MASK, 0),
	SOC_SINGLE("SPUM1 POSTGAIN FADE OUT COUNTER", SPUM_DSGAIN_FADEOUT_CNT(1),
			0, FADEOUT_CNT_MASK, 0),
		...
		struct snd_kcontrol *k, int e)
{
	...
	return spus_pregain_event(data, e, 0, 0);
}
		...
		struct snd_kcontrol *k, int e)
{
	...
	return spus_pregain_event(data, e, 1, 0);
}
