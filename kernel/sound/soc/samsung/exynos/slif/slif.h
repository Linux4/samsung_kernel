...
/* 3. DMIC AUD value */
#if (IS_ENABLED(CONFIG_SOC_S5E9925) || IS_ENABLED(CONFIG_SOC_S5E9935) || IS_ENABLED(CONFIG_SOC_S5E9945))
#define SLIF_DMIC_AUD_NUM			(3)
#elif (IS_ENABLED(CONFIG_SOC_S5E8825) || IS_ENABLED(CONFIG_SOC_S5E8835) || IS_ENABLED(CONFIG_SOC_S5E8845))
...
struct slif_data {
	...
	struct clk_path bclk_path[CLK_MAX_CNT];
