...
#CROSS_COMPILE   ?= ../PLATFORM/prebuilts/clang/host/linux-x86/clang-r416183b/bin/aarch64-linux-gnu-

CROSS_COMPILE=$(srctree)/toolchain/clang/host/linux-x86/clang-r416183b/bin/aarch64-linux-gnu-
