...
static struct wake_lock gs_wakelock_t = {0};
...
static int gxy_alarm_set_alarm(char *alarm_data)
{
    ...
    switch ((int)cmd_input[0]) {
        ...
        case '1':
            ...
            // base_time_sec_t.tv_sec -= sys_tz.tz_minuteswest * 60; //add timezone
...
static void sapa_init(void)
{
    ...
    if ((boot_mode == KERNEL_POWER_OFF_CHARGING_BOOT ||
        ...
        wake_lock_init(&gs_wakelock_t, WAKE_LOCK_SUSPEND, "SAPA");
...
static void sapa_exit(void)
{
    ...
    if ((boot_mode == KERNEL_POWER_OFF_CHARGING_BOOT ||
        ...
        wake_lock_destroy(&gs_wakelock_t);
    }
}
...
MODULE_DESCRIPTION("power_on_alarm Driver based on MTK");
