...
/*
 * CN3929AF voice coil motor driver
 *
 *
 */
...
#define AF_DRVNAME "CN3929AF_DRV"
...
/*Tab A9 code for  AX6739A-962 by rongyi at 20230609 start */
...
/* ////////////////////////////////////////////////////////////// */
long CN3929AF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command, unsigned long a_u4Param)
{
	long i4RetValue = 0;
...
int CN3929AF_Release(struct inode *a_pstInode, struct file *a_pstFile)
{
	LOG_INF("Start\n");
...
/*Tab A9 code for  AX6739A-962 by rongyi at 20230609 end */

int CN3929AF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient, spinlock_t *pAF_SpinLock, int *pAF_Opened)
{
...
int CN3929AF_GetFileName(unsigned char *pFileName)
{
