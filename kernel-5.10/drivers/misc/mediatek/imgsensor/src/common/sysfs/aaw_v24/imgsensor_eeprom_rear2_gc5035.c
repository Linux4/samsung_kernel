...
#define REAR2_GC5035_MAX_CAL_SIZE               (0x06A5 + 0x1)

#define REAR2_GC5035_HEADER_CHECKSUM_LEN        (0x0051 - 0x0000 + 0x1)
#define REAR2_GC5035_MODULE_DATA_CHECKSUM_LEN   (0x047B - 0x0056 + 0x1)

#define REAR2_GC5035_CONVERTED_MAX_CAL_SIZE     (0x09F5 + 0x1)
#define REAR2_GC5035_CONVERTED_AWB_CHECKSUM_LEN (0x006B - 0x0060 + 0x1)
#define REAR2_GC5035_CONVERTED_LSC_CHECKSUM_LEN (0x07CB - 0x0070 + 0x1)
...
const struct imgsensor_vendor_rom_addr rear2_gc5035_cal_addr = {
	...
	.rom_module_module_info_start_addr      = 0x0056,
	...
	.rom_converted_max_cal_size             = REAR2_GC5035_CONVERTED_MAX_CAL_SIZE,
