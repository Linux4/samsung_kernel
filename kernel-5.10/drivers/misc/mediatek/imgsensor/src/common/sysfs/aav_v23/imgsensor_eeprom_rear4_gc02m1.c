...
#define REAR4_GC02M1_MAX_CAL_SIZE               (0x047F + 0x1)

#define REAR4_GC02M1_HEADER_CHECKSUM_LEN        (0x004B + 0x1)
#define REAR4_GC02M1_OEM_CHECKSUM_LEN           -1
#define REAR4_GC02M1_AWB_CHECKSUM_LEN           -1
#define REAR4_GC02M1_SHADING_CHECKSUM_LEN       -1
#define REAR4_GC02M1_MODULE_CHECKSUM_LEN        (0x047B - 0x0050 + 0x1)

#define REAR4_GC02M1_CONVERTED_MAX_CAL_SIZE     (0x07CF + 0x1)
...
const struct imgsensor_vendor_rom_addr rear4_gc02m1_cal_addr = {
	...
	.rom_module_checksum_addr               = 0x47C,
	.rom_module_checksum_len                = REAR4_GC02M1_MODULE_CHECKSUM_LEN,
