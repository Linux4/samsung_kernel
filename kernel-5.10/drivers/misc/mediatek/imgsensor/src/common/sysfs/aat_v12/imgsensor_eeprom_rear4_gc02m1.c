...
#define IMGSENSOR_REAR4_MAX_CAL_SIZE (0x07CF + 0x1)
#define REAR4_HEADER_CHECKSUM_LEN (0x00FB + 0x1)
#define REAR4_OEM_CHECKSUM_LEN (0x019B - 0x0100 + 0x1)
#define REAR4_AWB_CHECKSUM_LEN (0x01AB - 0x1A0 + 0x1)
#define REAR4_SHADING_CHECKSUM_LEN (0x05AB - 0x01B0 + 0x1)

#define REAR4_CONVERTED_MAX_CAL_SIZE (0x0B2F + 0x1)
#define REAR4_CONVERTED_AWB_CHECKSUM_LEN (0x01AB - 0x01A0 + 0x1)
#define REAR4_CONVERTED_LSC_CHECKSUM_LEN (0x090B - 0x01B0 + 0x1)
...
const struct imgsensor_vendor_rom_addr rear4_gc02m1_cal_addr = {
	...
	.rom_header_main_mtf_data_addr              = 0x0134, // It must be in af area, not in factory area in cal data
