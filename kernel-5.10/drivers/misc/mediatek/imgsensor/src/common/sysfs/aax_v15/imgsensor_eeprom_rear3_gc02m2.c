/* A15-LTE cal map for GCO2M2*/

#include "imgsensor_eeprom_rear3_gc02m2.h"

#define REAR3_GC02M2_MAX_CAL_SIZE               (0x07CF + 0x1)

#define REAR3_GC02M2_HEADER_CHECKSUM_LEN        (0x00FB + 0x1)
#define REAR3_GC02M2_OEM_CHECKSUM_LEN           (0x019B - 0x0100 + 0x1)
#define REAR3_GC02M2_AWB_CHECKSUM_LEN           (0x01AB - 0x01A0 + 0x1)
#define REAR3_GC02M2_SHADING_CHECKSUM_LEN       (0x05AB - 0x01B0 + 0x1)

#define REAR3_GC02M2_CONVERTED_MAX_CAL_SIZE     (0x0B2F + 0x1)
#define REAR3_GC02M2_CONVERTED_AWB_CHECKSUM_LEN (0x01AB - 0x01A0 + 0x1)
#define REAR3_GC02M2_CONVERTED_LSC_CHECKSUM_LEN (0x090B - 0x01B0 + 0x1)

const struct rom_converted_cal_addr rear3_gc02m2_converted_cal_addr = {
	.rom_awb_cal_data_start_addr            = 0x01A0,
	.rom_awb_checksum_addr                  = 0x01AC,
	.rom_awb_checksum_len                   = (REAR3_GC02M2_CONVERTED_AWB_CHECKSUM_LEN),
	.rom_shading_cal_data_start_addr        = 0x01B0,
	.rom_shading_checksum_addr              = 0x090C,
	.rom_shading_checksum_len               = (REAR3_GC02M2_CONVERTED_LSC_CHECKSUM_LEN),
};

const struct imgsensor_vendor_rom_addr rear3_gc02m2_cal_addr = {
	/* Set '-1' if not used */
	.camera_module_es_version               = 'A',
	.cal_map_es_version                     = '1',
	.rom_max_cal_size                       = REAR3_GC02M2_MAX_CAL_SIZE,
	...
	.rom_header_checksum_len                = REAR3_GC02M2_HEADER_CHECKSUM_LEN,
	...
	.rom_oem_checksum_len                   = REAR3_GC02M2_OEM_CHECKSUM_LEN,
	...
	.rom_awb_checksum_addr                  = 0x01AC,
	.rom_awb_checksum_len                   = REAR3_GC02M2_AWB_CHECKSUM_LEN,

	.rom_shading_cal_data_start_addr        = 0x01B0,
	.rom_shading_module_info_start_addr     = -1,
	.rom_shading_checksum_addr              = 0x05AC,
	.rom_shading_checksum_len               = REAR3_GC02M2_SHADING_CHECKSUM_LEN,
	...
	.converted_cal_addr                     = &rear3_gc02m2_converted_cal_addr,
	.rom_converted_max_cal_size             = REAR3_GC02M2_CONVERTED_MAX_CAL_SIZE,
