//Not confirmed - copied from A12
#include "imgsensor_eeprom_rear3_gc02m1.h"

#define IMGSENSOR_REAR3_MAX_CAL_SIZE (0x05AF + 0x1)
#define REAR3_HEADER_CHECKSUM_LEN (0x00FB + 0x1)
#define REAR3_OEM_CHECKSUM_LEN (0x019B - 0x0100 + 0x1)
#define REAR3_AWB_CHECKSUM_LEN (0x01AB - 0x1A0 + 0x1)
#define REAR3_SHADING_CHECKSUM_LEN (0x05AB - 0x01B0 + 0x1)

#define REAR3_CONVERTED_MAX_CAL_SIZE (0x090F + 0x1)
#define REAR3_CONVERTED_AWB_CHECKSUM_LEN (0x01AB - 0x01A0 + 0x1)
#define REAR3_CONVERTED_LSC_CHECKSUM_LEN (0x090B - 0x01B0 + 0x1)
...
const struct rom_converted_cal_addr rear3_gc02m1_converted_cal_addr = {
	...
	.rom_awb_checksum_len                       = (REAR3_CONVERTED_AWB_CHECKSUM_LEN),
	.rom_shading_cal_data_start_addr            = 0x01B0,
	.rom_shading_checksum_addr                  = 0x090C,
	.rom_shading_checksum_len                   = (REAR3_CONVERTED_LSC_CHECKSUM_LEN),
};
...
const struct imgsensor_vendor_rom_addr rear3_gc02m1_cal_addr = {
	...
	.rom_max_cal_size                           = IMGSENSOR_REAR3_MAX_CAL_SIZE,
	...
	.rom_converted_max_cal_size                 = REAR3_CONVERTED_MAX_CAL_SIZE,
