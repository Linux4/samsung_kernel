...
#include "a0902backhi846st_mipi_raw.h"

#define PFX "a0902backhi846st_mipi_raw"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = A0902_BACK_HI846ST_SENSOR_ID,
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[5] =
{
 ...
 { 3280, 2464,   0,   6,   3280, 2452,   3280, 2452,   8, 2, 3264, 2448,   0, 0, 3264, 2448}, // video
 { 3280, 2464,   0,   6,   3280, 2452,   3280, 2452,   8, 2, 3264, 2448,   0, 0, 3264, 2448}, //hight speed video
...
{
	LOG_INF("wwj sensor id = %x,%x",(read_cmos_sensor(0x0F17) << 8),read_cmos_sensor(0x0F16));
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
	...
	LOG_INF("wwj get_imgsensor_id i2c write id : 0x%x, sensor id: 0x%x\n",imgsensor.i2c_write_id, *sensor_id);
	if (*sensor_id != imgsensor_info.sensor_id) {
			...
			UINT8 *feature_para, UINT32 *feature_para_len)
{
	...
	*(feature_data + 1) = imgsensor_info.min_shutter;
	...
	case SENSOR_FEATURE_GET_PIXEL_CLOCK_FREQ_BY_SCENARIO:
		...
		printk("hi846 read pclk X is %d!!!", *(feature_data + 1));
		break;
...
UINT32 A0902BACKHI846ST_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
