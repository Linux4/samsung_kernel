...
#include "sec_cmd.h"
/*Tab A9 code for SR-AX6739A-01-259 by wenyaqi at 20230523 start*/
#if IS_ENABLED(CONFIG_DRV_SAMSUNG)
#include <linux/sec_class.h>
#endif // CONFIG_DRV_SAMSUNG
/*Tab A9 code for SR-AX6739A-01-259 by wenyaqi at 20230523 end*/
...
extern int g_key_power_state;
extern int g_key_volumedown_state;
extern int g_key_volumeup_state;
...
/*Tab A9 code for P230531-03383 by hehaoran5 at 20230606 start*/
...
/*Tab A9 code for P230531-03383 by hehaoran5 at 20230606 end*/
...
static ssize_t keycode_pressed_show(struct device *dev, struct device_attribute *attr, char *buf)
{
    return snprintf(buf, PAGE_SIZE, "%d:%d,%d:%d,%d:%d\n",KEY_POWER,
        g_key_power_state,KEY_VOLUMEDOWN,g_key_volumedown_state,KEY_VOLUMEUP,g_key_volumeup_state);
}
            ...
            int len, int devt)
{
    ...
    /*Tab A9 code for SR-AX6739A-01-334 by zhangxiongyi at 20230518 start*/
    #ifdef CONFIG_CUSTOM_PROJECT_OT11
    /*Tab A9 code for SR-AX6739A-01-334 by wenyaqi at 20230523 start*/
    #if IS_ENABLED(CONFIG_DRV_SAMSUNG)
    sec_key = sec_device_create(NULL, "sec_key");
    #else
    sec_key = device_create(sec_class, NULL, MKDEV(DEVT, 0), NULL, "sec_key");
    #endif // CONFIG_DRV_SAMSUNG
    /*Tab A9 code for SR-AX6739A-01-334 by wenyaqi at 20230523 end*/
    if (IS_ERR(sec_key)) {
