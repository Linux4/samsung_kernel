...
struct chipone_ts_data {
    ...
    struct work_struct cts_charger_notify_wq;
    /*Tab A9 code for SR-AX6739A-01-652 by suyurui at 20230617 start*/
    ...
    struct notifier_block charger_notify;
    int earphone_status;
    int cts_charger_state;
    /*Tab A9 code for SR-AX6739A-01-652 by suyurui at 20230617 end*/
};
...
/*Tab A9 code for SR-AX6739A-01-654 by suyurui at 20230605 start*/
extern void tp_enable_gesture_wakeup(void);
extern void tp_disable_gesture_wakeup(void);
/*Tab A9 code for SR-AX6739A-01-654 by suyurui at 20230605 end*/
 ...
 *                                        3 +----+ 1              *
 **************************************************************/
extern int cts_swap_x_y(struct cts_device *cts_dev, u16 *data);
extern int cts_swap_cap_x_y(struct cts_device *cts_dev, u8 *data);
