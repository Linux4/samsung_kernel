...
static void himax_mcu_power_on_init(void)
{
    ...
    g_core_fp.fp_register_write(pfw_op->addr_hand_blade_addr, tmp_data, DATA_LEN_4);
    #endif //SEC_PALM_FUNC
...
static void hx_ap_notify_fw_sus(int suspend)
{
    ...
    /*Tab A9 code for SR-AX6739A-01-258 by suyurui at 20230522 start*/
    #if defined(SEC_PALM_FUNC)
    himax_parse_assign_cmd(fw_data_hand_blade_on_off, data_tmp, 4);
    g_core_fp.fp_register_write(pfw_op->addr_hand_blade_addr, data_tmp, DATA_LEN_4);
    #endif //SEC_PALM_FUNC
    /*Tab A9 code for SR-AX6739A-01-258 by suyurui at 20230522 end*/
    do {
...
/* CORE_FW */
    ...
    himax_parse_assign_cmd(fw_earphone_addr,
        pfw_op->addr_earphone,
        sizeof(pfw_op->addr_earphone));
    /*Tab A9 code for SR-AX6739A-01-611 by zhawei at 20230516 end*/
    /*Tab A9 code for SR-AX6739A-01-258 by suyurui at 20230522 start*/
    #if defined(SEC_PALM_FUNC)
    himax_parse_assign_cmd(fw_addr_hand_blade_addr, pfw_op->addr_hand_blade_addr,
