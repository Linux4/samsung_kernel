...
/*Tab A9 code for AX6739A-2640 by zhawei at 20230808 start*/
static void lcm_panel_init(struct lcm *ctx)
{
    ...
    lcm_dcs_write_seq_static(ctx, 0xE0, 0x00,0x03,0x0A,0x0E,0x13,0x1A,0x2D,0x32,0x3B,0x37,0x52,0x5B,0x64,0x77,0x78,0x84,0x8F,0xA4,0xA4,0x51,0x58,0x5F,0x63,0x00,0x03,0x0A,0x0E,0x13,0x1A,0x2D,0x32,0x3B,0x37,0x52,0x5B,0x64,0x77,0x78,0x84,0x8F,0xA4,0xA4,0x51,0x58,0x5F,0x63);
...
/*Tab A9 code for AX6739A-2640 by zhawei at 20230808 end*/
...
static int lcm_probe(struct mipi_dsi_device *dsi)
{
    ...
    pr_err("%s+ lcm,hx83102e xx inx\n", __func__);

    /*Tab A9 code for SR-AX6739A-01-768 by yuli at 20230718 start*/
    if (lcm_detect_panel("hx83102e_xx_inx")) {
        pr_err("%s- lcm,hx83102e_xx_inx\n", __func__);
        return -ENODEV;
    }
...
static struct mipi_dsi_driver lcm_driver = {
    ...
    .remove = lcm_remove,
    .driver = {
        .name = "lcd_hx83102e_xx_inx_video",
        .owner = THIS_MODULE,
