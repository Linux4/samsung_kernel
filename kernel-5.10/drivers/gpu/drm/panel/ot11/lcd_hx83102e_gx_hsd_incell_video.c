...
static void lcm_panel_init(struct lcm *ctx)
{
    ...
    lcm_dcs_write_seq_static(ctx, 0xB1,0x10,0xFA,0xAF,0xAF,0x30,0x30,0xB1,0x4D,0x2F,0x36,0x36,0x36,0x36,0x22,0x21,0x15,0x00);
    lcm_dcs_write_seq_static(ctx, 0xB2,0x00,0x20,0x35,0x3C,0x00,0x22,0xD4,0x4B,0x00,0x00,0x00,0x00,0x15,0x20,0x57,0x00);
    lcm_dcs_write_seq_static(ctx, 0xB4,0x10,0x10,0x01,0x01,0x88,0x88,0x68,0x50,0x01,0x8F,0x01,0x58,0x00,0xFF,0x00,0xFF);
    lcm_dcs_write_seq_static(ctx, 0xD2,0x30,0x30);
    lcm_dcs_write_seq_static(ctx, 0xBF,0xFC,0x85,0x80,0x9C,0x36,0x00,0x04);
    lcm_dcs_write_seq_static(ctx, 0xD3,0x00,0x00,0x00,0x00,0x3C,0x3D,0x00,0x00,0x00,0x27,0x27,0x22,0x0F,0x23,0x23,0x04,0x00,0x32,0x10,0x22,0x00,0x22,0x32,0x15,0x62,0x05,0x62,0x32,0x10,0x08,0x00,0x00,0x00,0x00,0x2B,0x50,0xB6,0xC8,0x2C,0x4F,0xB6,0xC8,0x0F);
    lcm_dcs_write_seq_static(ctx, 0xE0,0x00,0x06,0x0E,0x14,0x1C,0x2E,0x47,0x4F,0x57,0x53,0x6D,0x73,0x78,0x88,0x88,0x93,0x9E,0xB2,0xB1,0x57,0x5E,0x68,0x7A,0x00,0x06,0x0E,0x14,0x1C,0x2E,0x47,0x4F,0x57,0x53,0x6D,0x73,0x78,0x88,0x88,0x93,0x9E,0xB2,0xB1,0x57,0x5E,0x68,0x7A);
    ...
    lcm_dcs_write_seq_static(ctx, 0xD5,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x19,0x19,0x18,0x18,0x1A,0x1A,0x1B,0x1B,0x00,0x01,0x02,0x03,0x04,0x05,0x06,0x07,0x20,0x21,0x24,0x25,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18);
    lcm_dcs_write_seq_static(ctx, 0xD6,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x19,0x19,0x1A,0x1A,0x1B,0x1B,0x03,0x02,0x01,0x00,0x07,0x06,0x05,0x04,0x25,0x24,0x21,0x20,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18);
    lcm_dcs_write_seq_static(ctx, 0xD0,0x07,0x04,0x05);
    lcm_dcs_write_seq_static(ctx, 0xE7,0x12,0x13,0x02,0x02,0x55,0x00,0x0E,0x0E,0x00,0x26,0x29,0x72,0x1C,0x72,0x01,0x27,0x00,0x00,0x00,0x00,0x17,0x00,0x68);
    lcm_dcs_write_seq_static(ctx, 0xBD,0x01);
    lcm_dcs_write_seq_static(ctx, 0xE7,0x01,0x30,0x01,0x94,0x0D,0xB5,0x0E);
    lcm_dcs_write_seq_static(ctx, 0xBD,0x02);
    ...
    lcm_dcs_write_seq_static(ctx, 0xBA,0x70,0x23,0xA8,0x83,0xF2,0x80,0xC0,0x0D);
    lcm_dcs_write_seq_static(ctx, 0xBD,0x03);
    lcm_dcs_write_seq_static(ctx, 0xB2,0x80);
    lcm_dcs_write_seq_static(ctx, 0xBD,0x00);
    lcm_dcs_write_seq_static(ctx, 0xC8,0x00,0x04,0x04,0x00,0x00,0x82);
...
static int lcm_unprepare(struct drm_panel *panel)
{
    ...
    /*
     * ctx->lcd_reset_gpio = devm_gpiod_get(ctx->dev, "reset", 0,GPIOD_OUT_HIGH);
     * gpiod_set_value(ctx->lcd_reset_gpio, 0);
     * devm_gpiod_put(ctx->dev, ctx->lcd_reset_gpio);
     */
...
static int lcm_probe(struct mipi_dsi_device *dsi)
{
    ...
    pr_err("%s+ lcm,hx83102e gx hsd\n", __func__);

    /*Tab A9 code for SR-AX6739A-01-768 by yuli at 20230718 start*/
    if (lcm_detect_panel("hx83102e_gx_hsd")) {
        pr_err("%s- lcm,hx83102e_gx_hsd\n", __func__);
        return -ENODEV;
    }
...
static struct mipi_dsi_driver lcm_driver = {
    ...
    .remove = lcm_remove,
    .driver = {
        .name = "lcd_hx83102e_gx_hsd_incell_video",
        .owner = THIS_MODULE,
