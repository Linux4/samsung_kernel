...
static void lcm_panel_init(struct lcm *ctx)
{
	...
	lcm_dcs_write_seq_static(ctx, 0xC5, 0x0D, 0x10, 0x80, 0x05);
	lcm_dcs_write_seq_static(ctx, 0xB0, 0x00, 0x2E, 0xC5);
	lcm_dcs_write_seq_static(ctx, 0xC5, 0x73, 0x2B);
	lcm_dcs_write_seq_static(ctx, 0xF0, 0xA5, 0xA5);
	...
	/* 4.1.7 PCD Setting */
	lcm_dcs_write_seq_static(ctx, 0xF0, 0x5A, 0x5A);
	lcm_dcs_write_seq_static(ctx, 0xCC, 0x5C, 0x51);
	lcm_dcs_write_seq_static(ctx, 0xF0, 0xA5, 0xA5);
	...
	{REGFLAG_DELAY, 20, {} },
	{0xF0, 2, {0x5A, 0x5A} },
	{0xB0, 3, {0x01, 0xB4, 0x65} },
	{0x65, 32, {0x0C, 0x54, 0x0B, 0xB6, 0x0B, 0xB6, 0x0B,
				0xB6, 0x0B, 0x3A, 0x0A, 0xBC, 0x09, 0xC4,
				0x08, 0xCA, 0x07, 0xD0, 0x06, 0xD8, 0x05,
				0xDC, 0x04, 0xE4, 0x03, 0x78, 0x01, 0xF8,
				0x01, 0xF8, 0x00, 0x20} },
	{0x60, 2, {0x00, 0x04} },
	{0xB0, 3, {0x00, 0x08, 0xF2} },
	{0xF2, 1, {0xBC} },
	{REGFLAG_DELAY, 20, {} },
	{0xB0, 3, {0x00, 0x2A, 0x6A} },
	{0x6A, 3, {0x07, 0x00, 0xC0} },
	{0xF7, 1, {0x0F} },
	{REGFLAG_DELAY, 20, {} },
	{0xB0, 3, {0x00, 0x28, 0x68} },
	{0x68, 1, {0x02} },
	{0xF7, 1, {0x0F} },
	{0xF0, 2, {0xA5, 0xA5} },
#endif

	/* 4.1.13 ASWIRE Pulse Off Setting */
	...
	lcm_dcs_write_seq_static(ctx, 0xB0, 0x00, 0x08, 0xF2);
	lcm_dcs_write_seq_static(ctx, 0xF2, 0x0C);
	lcm_dcs_write_seq_static(ctx, 0xB0, 0x00, 0x2A, 0x6A);
	lcm_dcs_write_seq_static(ctx, 0x6A, 0x00, 0x00, 0x00);
	lcm_dcs_write_seq_static(ctx, 0xB0, 0x00, 0x28, 0x68);
...
static struct mipi_dsi_driver lcm_driver = {
	...
	.remove = lcm_remove,
	.driver = {
		.name = "panel-s6e3fc3-s2dos15-cmd-2340",
		.owner = THIS_MODULE,
...
MODULE_DESCRIPTION("s6e3fc3 FHDP CMD LCD Panel(2340) Driver");
