/*
 * linux/drivers/video/fbdev/exynos/panel/s6e8fc3/s6e8fc3_a15_aod_panel.h
 *
...
#ifndef __S6E8FC3_A15_AOD_PANEL_H__
#define __S6E8FC3_A15_AOD_PANEL_H__
...
static u8 s6e8fc3_a15_self_mask_crc[] = {
	...
	S6E8FC3_A15SELF_MASK_VALID_CRC_2,
};
...
static DEFINE_RULE_BASED_COND(a15_cond_is_factory_selfmask,
		PANEL_PROPERTY_IS_FACTORY_MODE, EQ, 1);

static void *s6e8fc3_a15_aod_self_mask_ena_cmdtbl[] = {
	&KEYINFO(s6e8fc3_aod_l2_key_enable),
	&CONDINFO_IF(a15_cond_is_factory_selfmask),
		&PKTINFO(s6e8fc3_aod_factory_self_mask_ctrl_ena),
	&CONDINFO_EL(a15_cond_is_factory_selfmask),
		&PKTINFO(s6e8fc3_aod_self_mask_ctrl_ena),
	&CONDINFO_FI(a15_cond_is_factory_selfmask),
...
static void *s6e8fc3_a15_aod_self_mask_dis_cmdtbl[] = {
	&KEYINFO(s6e8fc3_aod_l2_key_enable),
...
// --------------------- check sum control ----------------------------
static DEFINE_STATIC_PACKET_WITH_OPTION(s6e8fc3_a15_aod_self_mask_img_pkt,
		DSI_PKT_TYPE_WR_SR, S6E8FC3_A15_SELF_MASK_IMG, 0, PKT_OPTION_SR_ALIGN_16);

#if defined(__PANEL_NOT_USED_VARIABLE__)
static DEFINE_STATIC_PACKET_WITH_OPTION(s6e8fc3_a15_aod_self_mask_crc_img_pkt,
...
static void *s6e8fc3_a15_aod_self_mask_img_cmdtbl[] = {
	...
	&DLYINFO(s6e8fc3_aod_self_spsram_sel_delay),
	&PKTINFO(s6e8fc3_a15_aod_self_mask_img_pkt),
	&DLYINFO(s6e8fc3_aod_self_spsram_write_delay),
...
static struct seqinfo s6e8fc3_a15_aod_seqtbl[] = {
...
static struct aod_tune s6e8fc3_a15_aod = {
	.name = "s6e8fc3_a15_aod",
	.nr_seqtbl = ARRAY_SIZE(s6e8fc3_a15_aod_seqtbl),
	.seqtbl = s6e8fc3_a15_aod_seqtbl,
	.nr_maptbl = ARRAY_SIZE(s6e8fc3_aod_maptbl),
	.maptbl = s6e8fc3_aod_maptbl,
	.self_mask_en = true,
	.self_mask_crc = s6e8fc3_a15_self_mask_crc,
	.self_mask_crc_len = ARRAY_SIZE(s6e8fc3_a15_self_mask_crc),
};
#endif
