...
{
    return single_open(file, fh_ctrl_proc_read, PDE_DATA(inode));
}
...
static const struct proc_ops ctrl_fops2 = {
    .proc_open = fh_ctrl_proc_open2,
    .proc_write = fh_ctrl_proc_write2,
 	.proc_read = seq_read,
