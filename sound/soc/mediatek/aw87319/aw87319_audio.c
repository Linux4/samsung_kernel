...
#define AW87319_DRIVER_VERSION  "v1.2.1"
...
static unsigned char aw87319_vspk_cfg_default[] = {0x9B, 0x07, 0x28, 0x05, 0x04, 0x0D, 0x03, 0x52, 0x28, 0x02};
...
unsigned char aw87319_audio_voice_speaker(void)
{
    ...
    i2c_write_reg(0x01, aw87319_vspk_reg_val(0x01)&0xFB);        // Class D Enable; Boost Enable
    ...
    i2c_write_reg(0x01, aw87319_vspk_reg_val(0x01));             // CHIP Enable; Class D Enable; Boost Enable
 ...
 ******************************************************************************/
static void aw87319_voice_speaker_cfg_loaded(const struct firmware *cont, void *context)
{
    unsigned int i;
...
static void aw87319_receiver_cfg_loaded(const struct firmware *cont, void *context)
{
    ...
    ret = request_firmware_nowait(THIS_MODULE, FW_ACTION_HOTPLUG, aw87319_vspk_name, 
            &aw87319->i2c_client->dev, GFP_KERNEL, NULL, aw87319_voice_speaker_cfg_loaded);
    if(ret) {
        aw87319->vspk_cfg_update_flag = 0;
        pr_err("%s: request_firmware_nowait failed with read %s", __func__, aw87319_vspk_name);
    }
}
