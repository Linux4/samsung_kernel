 ...
 * Register Access
 *******************************************/
#define AW88194_REG_NONE_ACCESS		(0)
#define AW88194_REG_RD_ACCESS		(1 << 0)
#define AW88194_REG_WR_ACCESS		(1 << 1)
...
#define AW88194_BIT_SYSST_CHECK_MASK \
	   (~(AW88194_BIT_SYSST_UVLOS | \
	   AW88194_BIT_SYSST_BSTOCS | \
	   AW88194_BIT_SYSST_BSTS | \
	   AW88194_BIT_SYSST_SWS | \
	   AW88194_BIT_SYSST_NOCLKS | \
	   AW88194_BIT_SYSST_CLKS | \
	   AW88194_BIT_SYSST_OCDS | \
	   AW88194_BIT_SYSST_OTHS | \
	   AW88194_BIT_SYSST_PLLS))
#define AW88194_BIT_SYSST_CHECK \
	   (AW88194_BIT_SYSST_BSTS | \
	   AW88194_BIT_SYSST_SWS | \
	   AW88194_BIT_SYSST_CLKS | \
	   AW88194_BIT_SYSST_PLLS)

#define AW88194_BIT_IIS_CHECK_MASK \
	   (~(AW88194_BIT_SYSST_UVLOS | \
	   AW88194_BIT_SYSST_NOCLKS | \
	   AW88194_BIT_SYSST_CLKS | \
	   AW88194_BIT_SYSST_OCDS | \
...
/* EFRL */
#define AW88194_BIT_EFRL_VENDOR_ID_MASK			(~(15 << 0))

/********************************************
 * DSP
 *******************************************/
#define AW88194_DSP_BASE_ADDR				(0x8600)
#define AW88194_DSP_REG_CFG_MBMEC_GLBCFG		(0x8662)
#define AW88194_DSP_REG_CFG_MBMEC_ACTAMPTH		(0x8664)
#define AW88194_DSP_REG_CFG_MBMEC_NOISEAMPTH		(0x8666)
#define AW88194_DSP_REG_CFG_ADPZ_USTEPN			(0x867B)
#define AW88194_DSP_REG_CFG_ADPZ_RE			(0x8677)

#define AW88194_DSP_REG_ST_STE_RE			(0x81A6)
#define AW88194_DSP_REG_ST_STE_RE_DECIMAL_SHIFT		(12)
#define AW88194_DSP_REG_ST_STE_TE			(0x81A8)
#define AW88194_DSP_REG_ST_STE_TE_DECIMAL_SHIFT		(0)
#define AW88194_DSP_REG_ST_ADPZ_A1FILTER		(0x8732)
#define AW88194_DSP_REG_ST_ADPZ_A1_DECIMAL_SHIFT	(17)
#define AW88194_DSP_REG_ST_ADPZ_A2FILTER		(0x8734)
#define AW88194_DSP_REG_ST_ADPZ_A2_DECIMAL_SHIFT	(17)
#define AW88194_DSP_REG_VCALB				(0x866D)
#define AW88194_DSP_REG_VMAX				(0x8614)
#define AW88194_DSP_REG_TEMP_FACTOR			(0x8682)

/********************************************
 * Vcalb
 *******************************************/
#define AW88194_VCAL_FACTOR				(1 << 12)
#define AW88194_VSCAL_FACTOR				(1550)
#define AW88194_EF_ISENSE_GAINERR_SLP			(0x78)
#define AW88194_EF_ISENSE_GAINERR_SLP_MASK		(255 << 0)
#define AW88194_EF_ISENSE_GAINERR_SLP_NEG		(0xff00)
#define AW88194_EF_ISENSE_GAINERR_SLP_SIGN_MASK		(1 << 7)
#define AW88194_EF_ISENSE_GAINERR_SLP_PROCT		(0xc0)
#define AW88194_EF_ISENSE_GAINERR_SLP_PROCT_MASK	(0xFF3F)

#define AW88194_ISCAL_FACTOR				(426)
#define AW88194_EF_VSENSE_GAIN				(0x79)
#define AW88194_EF_VSENSE_GAIN_MASK			(63 << 0)
#define AW88194_EF_VSENSE_GAIN_SHIFT			(10)
#define AW88194_EF_VSENSE_GAIN_NEG			(0xffe0)
#define AW88194_EF_VSENSE_GAIN_SIGN_MASK		(1 << 5)
#define AW88194_EF_VSENSE_GAIN_PROCT			(0x38)
#define AW88194_EF_VSENSE_GAIN_PROCT_MASK		(0xFFC7)

#define AW88194_ICABLK_FACTOR				(2)
#define AW88194_VCABLK_FACTOR				(5)
#define AW88194_CABL_BASE_VALUE				(1000)
...
#define AW88194_HAGC_GAIN_SHIFT				(8)
#define AW88194_HAGC_GAIN_MASK				(0x00ff)

#define AW88194_TEMP_SIGN_MASK				(1 << 9)
#define AW88194_TEMP_NEG_MASK				(0xFC00)
#define AW88194_INT_10BIT				(1023)
