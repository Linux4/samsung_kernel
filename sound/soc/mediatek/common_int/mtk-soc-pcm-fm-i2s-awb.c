		...
		struct snd_ctl_elem_value *ucontrol)
{
	...
	if (GetFmI2sInPathEnable() == true)
		SetHwDigitalGain(mfm_i2s_RecordVol,
...
#ifdef CONFIG_MTK_TC10_FEATURE
	/* Set HW_GAIN */
	SetHwDigitalGainMode(Soc_Aud_Hw_Digital_Gain_HW_DIGITAL_GAIN2,
...
static struct snd_soc_platform_driver mtk_soc_platform = {
	.ops = &mtk_fm_i2s_awb_ops, .probe = mtk_afe_fm_i2s_awb_probe,
};
