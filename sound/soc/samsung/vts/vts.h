...
/* A71 Model */
#define SOUND_MODEL_SVOICE_OFFSET (0xA1000)
#define SOUND_MODEL_GOOGLE_OFFSET (0xAA000)

#if defined(CONFIG_SOC_EXYNOS9630)
#define LOG_BUFFER_BYTES_MAX	(0x800)
#define VTS_SRAMLOG_MSGS_OFFSET (0xBF000)
#define VTS_SRAMLOG_SIZE_MAX	(0x2000)
#else
