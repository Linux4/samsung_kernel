...
static void i2s_init_bit_slice(struct i2s_dai *i2s)
{
	if (i2s->quirks & QUIRK_SUPPORTS_TDM) {	/* IIS V5.1 (new) */
		...
		i2s->lrp_b   = EXYNOS3475_MOD_LRP;
		i2s->cdclk_b = EXYNOS3475_MOD_CDCLKCON;
		i2s->slave_b = EXYNOS3475_MOD_SLAVE;
		i2s->rclks_b = EXYNOS3475_MOD_RCLKSRC;
		i2s->txr_sht = EXYNOS3475_MOD_TXR_SHIFT;
		i2s->txr_msk = EXYNOS3475_MOD_TXR_MASK;
		i2s->sdf_sht = EXYNOS3475_MOD_SDF_SHIFT;
		i2s->rfs_sht = EXYNOS3475_MOD_RCLK_SHIFT;
		i2s->rfs_msk = EXYNOS3475_MOD_RCLK_MASK;
		i2s->bfs_sht = EXYNOS3475_MOD_BCLK_SHIFT;
		i2s->bfs_msk = EXYNOS3475_MOD_BCLK_MASK;
	} else {				/* IIS V5.1 (old) */
		i2s->lrp_b   = MOD_LRP;
