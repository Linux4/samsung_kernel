/*
 *  exynos9630_aud3003x_sysfs_cb.c
...
#include "../codecs/aud3003x.h"

#ifdef CONFIG_SND_SOC_SAMSUNG_SYSFS_EARJACK
#ifdef CONFIG_SND_SOC_AUD3003X_5PIN
#include "../codecs/aud3003x-5pin.h"
#endif /* CONFIG_SND_SOC_AUD3003X_5PIN */
#ifdef CONFIG_SND_SOC_AUD3003X_6PIN
#include "../codecs/aud3003x-6pin.h"
#endif /* CONFIG_SND_SOC_AUD3003X_6PIN */
#endif /* CONFIG_SND_SOC_SAMSUNG_SYSFS_EARJACK */

static struct snd_soc_component *aud3003x_component;

#ifdef CONFIG_SND_SOC_SAMSUNG_SYSFS_EARJACK
static int get_jack_status(void)
{
	struct snd_soc_component *component = aud3003x_component;
	struct aud3003x_priv *aud3003x = dev_get_drvdata(component->dev);
...
void register_exynos9630_aud3003x_sysfs_cb(struct snd_soc_component *component)
{
	aud3003x_component = component;
...
EXPORT_SYMBOL_GPL(register_exynos9630_aud3003x_sysfs_cb);
