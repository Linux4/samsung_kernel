...
static int smdk7580_aif2_startup(struct snd_pcm_substream *substream)
{
	struct snd_soc_pcm_runtime *rtd = substream->private_data;
	struct snd_soc_card *card = rtd->card;
...
void smdk7580_aif2_shutdown(struct snd_pcm_substream *substream)
{
	struct snd_soc_pcm_runtime *rtd = substream->private_data;
	struct snd_soc_card *card = rtd->card;
...
static int smdk7580_aif1_startup(struct snd_pcm_substream *substream)
{
	s2801x_startup(S2801X_IF_AP);
	return 0;
}

void smdk7580_aif1_shutdown(struct snd_pcm_substream *substream)
{
...
static struct snd_soc_ops smdk7580_aif1_ops = {
	...
	.startup = smdk7580_aif1_startup,
	.shutdown = smdk7580_aif1_shutdown,
};

static struct snd_soc_ops smdk7580_aif2_ops = {
	.hw_params = smdk7580_aif2_hw_params,
	.startup = smdk7580_aif2_startup,
	.shutdown = smdk7580_aif2_shutdown,
};
