...
#if IS_ENABLED(CONFIG_SND_SOC_SAMSUNG_EXYNOS8535_AW882XX)
...
static const struct of_device_id exynos_sound_of_match[] = {
	{ .compatible = "samsung,exynos8535-audio", },
	{},
};
...
MODULE_DESCRIPTION("ALSA SoC Exynos8535 Sound Driver");
MODULE_LICENSE("GPL");
MODULE_ALIAS("platform:exynos8535-audio");
