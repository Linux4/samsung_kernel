 ...
 * @return	error code or 0
 */
extern int abox_ipc_send_atomic(struct device *dev, const ABOX_IPC_MSG *ipc,
		size_t size, const void *bundle, size_t bundle_size);
 ...
 * @param[in]	dev	abox device
*/
extern void abox_ipc_init_dev(struct device *dev);
