...
extern void dp_audio_dma_trigger(struct displayport_audio_config_data *audio_config_data);
#else
int dp_audio_config(struct displayport_audio_config_data *audio_config_data)
{
	return -ENODEV;
}
void dp_audio_dma_trigger(struct displayport_audio_config_data *audio_config_data)
{
}
#endif
