...
static int tert_mi2s_switch_enable_1;//Chk30757,liujun5.wt modify 20200413 ,modify for smart PA bringup
...
//+Chk30757,liujun5.wt modify 20200413 ,modify for smart PA bringup & add for audio ATA :hsmic_speaker
static int msm_routing_get_tert_mi2s_switch_mixer_1(
				struct snd_kcontrol *kcontrol,
				struct snd_ctl_elem_value *ucontrol)
{
	ucontrol->value.integer.value[0] = tert_mi2s_switch_enable_1;
	pr_debug("%s: TERT MI2S Switch enable %ld\n", __func__,
		ucontrol->value.integer.value[0]);
	return 0;
}

static int msm_routing_put_tert_mi2s_switch_mixer_1(
				struct snd_kcontrol *kcontrol,
				struct snd_ctl_elem_value *ucontrol)
{
	struct snd_soc_dapm_widget_list *wlist =
	...
	if (ucontrol->value.integer.value[0])
		...
		snd_soc_dapm_mixer_update_power(widget->dapm, kcontrol, 0,
						update);
	tert_mi2s_switch_enable_1 = ucontrol->value.integer.value[0];
	return 1;
}
//+Chk30757,liujun5.wt modify 20200413 ,modify for smart PA bringup & add for audio ATA :hsmic_speaker
...
//+Chk30757,liujun5.wt modify 20200413 ,modify for smart PA bringup & add for audio ATA :hsmic_speaker
static const struct snd_kcontrol_new tert_mi2s_rx_switch_mixer_controls_1 =
	SOC_SINGLE_EXT("Switch", SND_SOC_NOPM,
	0, 1, 0, msm_routing_get_tert_mi2s_switch_mixer_1,
	msm_routing_put_tert_mi2s_switch_mixer_1);
//-Chk30757,liujun5.wt modify 20200413 ,modify for smart PA bringup & add for audio ATA :hsmic_speaker
...
//+Chk30757,liujun5.wt modify 20200413 ,modify for smart PA bringup & add for audio ATA :hsmic_speaker
	SND_SOC_DAPM_SWITCH("TERT_MI2S_RX_DL_HL_1", SND_SOC_NOPM, 0, 0,
				&tert_mi2s_rx_switch_mixer_controls_1),
//-Chk30757,liujun5.wt modify 20200413 ,modify for smart PA bringup & add for audio ATA :hsmic_speaker
...
static const struct snd_soc_dapm_route intercon[] = {
	...
	//+Chk30757,liujun5.wt modify 20200413 ,modify for smart PA bringup & add for audio ATA :hsmic_speaker
	{"TERT_MI2S_RX_DL_HL_1", "Switch", "INT4_MI2S_DL_HL"},
	{"TERT_MI2S_RX", NULL, "TERT_MI2S_RX_DL_HL_1"},
	//-Chk30757,liujun5.wt modify 20200413 ,modify for smart PA bringup & add for audio ATA :hsmic_speaker
	...
	{"TERT_MI2S_RX Port Mixer", "INT3_MI2S_TX", "INT3_MI2S_TX"},//Chk30757,liujun5.wt modify 20200413 ,modify for smart PA bringup & add for audio ATA :hsmic_speaker
