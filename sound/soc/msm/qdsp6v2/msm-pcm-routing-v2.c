...
static const struct snd_kcontrol_new slimbus_rx_mixer_controls[] = {
	...
	msm_routing_put_audio_mixer),
	SOC_SINGLE_EXT("MultiMedia27", MSM_BACKEND_DAI_SLIMBUS_0_RX,
...
static const struct snd_kcontrol_new quaternary_mi2s_rx_mixer_controls[] = {
	...
	MSM_FRONTEND_DAI_MULTIMEDIA22, 1, 0, msm_routing_get_audio_mixer,
	msm_routing_put_audio_mixer),
	SOC_SINGLE_EXT("MultiMedia23", MSM_BACKEND_DAI_QUATERNARY_MI2S_RX,
	MSM_FRONTEND_DAI_MULTIMEDIA23, 1, 0, msm_routing_get_audio_mixer,
	msm_routing_put_audio_mixer),
	SOC_SINGLE_EXT("MultiMedia24", MSM_BACKEND_DAI_QUATERNARY_MI2S_RX,
	MSM_FRONTEND_DAI_MULTIMEDIA24, 1, 0, msm_routing_get_audio_mixer,
	msm_routing_put_audio_mixer),
	SOC_SINGLE_EXT("MultiMedia25", MSM_BACKEND_DAI_QUATERNARY_MI2S_RX,
	MSM_FRONTEND_DAI_MULTIMEDIA25, 1, 0, msm_routing_get_audio_mixer,
	msm_routing_put_audio_mixer),
	SOC_SINGLE_EXT("MultiMedia26", MSM_BACKEND_DAI_QUATERNARY_MI2S_RX,
	MSM_FRONTEND_DAI_MULTIMEDIA26, 1, 0, msm_routing_get_audio_mixer,
	msm_routing_put_audio_mixer),
	SOC_SINGLE_EXT("MultiMedia27", MSM_BACKEND_DAI_QUATERNARY_MI2S_RX,
	MSM_FRONTEND_DAI_MULTIMEDIA27, 1, 0, msm_routing_get_audio_mixer,
	msm_routing_put_audio_mixer),
...
#endif
#if defined(CONFIG_SND_SOC_4SPK_MULTI_DAI)
	SOC_SINGLE_EXT("MultiMedia21", MSM_BACKEND_DAI_PRI_MI2S_RX,
	MSM_FRONTEND_DAI_MULTIMEDIA21, 1, 0, msm_routing_get_audio_mixer,
	msm_routing_put_audio_mixer),
	SOC_SINGLE_EXT("MultiMedia22", MSM_BACKEND_DAI_PRI_MI2S_RX,
	MSM_FRONTEND_DAI_MULTIMEDIA22, 1, 0, msm_routing_get_audio_mixer,
	msm_routing_put_audio_mixer),
	SOC_SINGLE_EXT("MultiMedia23", MSM_BACKEND_DAI_PRI_MI2S_RX,
	MSM_FRONTEND_DAI_MULTIMEDIA23, 1, 0, msm_routing_get_audio_mixer,
	msm_routing_put_audio_mixer),
	SOC_SINGLE_EXT("MultiMedia24", MSM_BACKEND_DAI_PRI_MI2S_RX,
	MSM_FRONTEND_DAI_MULTIMEDIA24, 1, 0, msm_routing_get_audio_mixer,
	msm_routing_put_audio_mixer),
	SOC_SINGLE_EXT("MultiMedia25", MSM_BACKEND_DAI_PRI_MI2S_RX,
	MSM_FRONTEND_DAI_MULTIMEDIA25, 1, 0, msm_routing_get_audio_mixer,
	msm_routing_put_audio_mixer),
	SOC_SINGLE_EXT("MultiMedia26", MSM_BACKEND_DAI_PRI_MI2S_RX,
	MSM_FRONTEND_DAI_MULTIMEDIA26, 1, 0, msm_routing_get_audio_mixer,
	msm_routing_put_audio_mixer),
	SOC_SINGLE_EXT("MultiMedia27", MSM_BACKEND_DAI_PRI_MI2S_RX,
	MSM_FRONTEND_DAI_MULTIMEDIA27, 1, 0, msm_routing_get_audio_mixer,
	msm_routing_put_audio_mixer),
...
#endif
#if defined(CONFIG_SND_SOC_4SPK_MULTI_DAI)
	SND_SOC_DAPM_AIF_OUT("MM_DL21", "MultiMedia21 Playback", 0, 0, 0, 0),
	SND_SOC_DAPM_AIF_OUT("MM_DL22", "MultiMedia22 Playback", 0, 0, 0, 0),
	SND_SOC_DAPM_AIF_OUT("MM_DL23", "MultiMedia23 Playback", 0, 0, 0, 0),	
	SND_SOC_DAPM_AIF_OUT("MM_DL24", "MultiMedia24 Playback", 0, 0, 0, 0),
	SND_SOC_DAPM_AIF_OUT("MM_DL25", "MultiMedia25 Playback", 0, 0, 0, 0),
	SND_SOC_DAPM_AIF_OUT("MM_DL26", "MultiMedia26 Playback", 0, 0, 0, 0),
	SND_SOC_DAPM_AIF_OUT("MM_DL27", "MultiMedia27 Playback", 0, 0, 0, 0),
	SND_SOC_DAPM_AIF_OUT("MM_DL28", "MultiMedia28 Playback", 0, 0, 0, 0),
#endif
...
static const struct snd_soc_dapm_route intercon[] = {
	...
	{"SLIMBUS_0_RX Audio Mixer", "MultiMedia27", "MM_DL27"},
	{"SLIMBUS_0_RX Audio Mixer", "MultiMedia28", "MM_DL28"},	
#endif
...
#endif
#if defined(CONFIG_SND_SOC_4SPK_MULTI_DAI)
	{"MultiMedia21 Mixer", "SLIM_0_TX", "SLIMBUS_0_TX"},
	{"MultiMedia22 Mixer", "SLIM_0_TX", "SLIMBUS_0_TX"},
	{"MultiMedia23 Mixer", "SLIM_0_TX", "SLIMBUS_0_TX"},
	{"MultiMedia24 Mixer", "SLIM_0_TX", "SLIMBUS_0_TX"},
	...
	{"QUAT_MI2S_RX Audio Mixer", "MultiMedia23", "MM_DL23"},
	{"QUAT_MI2S_RX Audio Mixer", "MultiMedia24", "MM_DL24"},
	{"QUAT_MI2S_RX Audio Mixer", "MultiMedia25", "MM_DL25"},
	{"QUAT_MI2S_RX Audio Mixer", "MultiMedia26", "MM_DL26"},
	{"QUAT_MI2S_RX Audio Mixer", "MultiMedia27", "MM_DL27"},
	{"QUAT_MI2S_RX Audio Mixer", "MultiMedia28", "MM_DL28"},	
#endif
...
#endif
#if defined(CONFIG_SND_SOC_4SPK_MULTI_DAI)
	{"PRI_MI2S_RX Audio Mixer", "MultiMedia21", "MM_DL21"},
	{"PRI_MI2S_RX Audio Mixer", "MultiMedia22", "MM_DL22"},	
	{"PRI_MI2S_RX Audio Mixer", "MultiMedia23", "MM_DL23"},
	{"PRI_MI2S_RX Audio Mixer", "MultiMedia24", "MM_DL24"},
	{"PRI_MI2S_RX Audio Mixer", "MultiMedia25", "MM_DL25"},
	{"PRI_MI2S_RX Audio Mixer", "MultiMedia26", "MM_DL26"},
	{"PRI_MI2S_RX Audio Mixer", "MultiMedia27", "MM_DL27"},
	{"PRI_MI2S_RX Audio Mixer", "MultiMedia28", "MM_DL28"},	
#endif
