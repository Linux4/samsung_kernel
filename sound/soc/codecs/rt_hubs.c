...
static const DECLARE_TLV_DB_SCALE(recvboost_tlv, -600, 600, 0);
static const DECLARE_TLV_DB_SCALE(spkboost_tlv, 600, 300, 0);
static const DECLARE_TLV_DB_SCALE(hpboost_tlv, -1200, 100, 0);
...
/* Analogue Volume */
	...
	SOC_SINGLE_TLV("LHP Boost Volume",
		RT5511_LHP_DRV_VOL, 0, 15, 0, hpboost_tlv),
	SOC_SINGLE_TLV("RHP Boost Volume",
		RT5511_RHP_DRV_VOL, 0, 15, 0, hpboost_tlv),
...
static const struct snd_kcontrol_new lhpdac_to_right_hp_boost =
...
/* Output Boost Driver */
	...
	SND_SOC_DAPM_MIXER("HPR Boost", SND_SOC_NOPM, 0, 0,
		right_hp_boost, ARRAY_SIZE(left_hp_boost)),
