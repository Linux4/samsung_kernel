...
#ifndef _S2803X_REGISTERS_H
#define _S2803X_REGISTERS_H

/**
 * Register addresses
 */
#define S2803X_REG_00_SOFT_RSTB		(0x00 * 4)
#define S2803X_REG_01_IN1_CTL1		(0x01 * 4)
#define S2803X_REG_02_IN1_CTL2		(0x02 * 4)
#define S2803X_REG_03_IN1_CTL3		(0x03 * 4)
#define S2803X_REG_04_IN2_CTL1		(0x04 * 4)
#define S2803X_REG_05_IN2_CTL2		(0x05 * 4)
#define S2803X_REG_06_IN2_CTL3		(0x06 * 4)
#define S2803X_REG_07_IN3_CTL1		(0x07 * 4)
#define S2803X_REG_08_IN3_CTL2		(0x08 * 4)
#define S2803X_REG_09_IN3_CTL3		(0x09 * 4)
#define S2803X_REG_0A_HQ_CTL		(0x0a * 4)
#define S2803X_REG_0B_SLOT_L		(0x0b * 4)
#define S2803X_REG_0C_SLOT_R		(0x0c * 4)
#define S2803X_REG_0D_RMIX_CTL		(0x0d * 4)
#define S2803X_REG_0E_TSLOT		(0x0e * 4)
#define S2803X_REG_0F_DIG_EN		(0x0f * 4)
#define S2803X_REG_10_DMIX1		(0x10 * 4)
#define S2803X_REG_11_DMIX2		(0x11 * 4)
#define S2803X_REG_16_DOUTMX1		(0x16 * 4)
#define S2803X_REG_17_DOUTMX2		(0x17 * 4)
#define S2803X_REG_68_ALC_CTL		(0x68 * 4)
#define S2803X_REG_69_ALC_GA1		(0x69 * 4)
#define S2803X_REG_6A_ALC_GA2		(0x6a * 4)
#define S2803X_REG_6B_ALC_LVL		(0x6b * 4)
#define S2803X_REG_6C_ALC_LVR		(0x6c * 4)
#define S2803X_REG_6D_ALC_HLD		(0x6d * 4)
#define S2803X_REG_6E_ALC_ATK		(0x6e * 4)
#define S2803X_REG_6F_ALC_DCY		(0x6f * 4)
#define S2803X_REG_70_ALC_NG		(0x70 * 4)
#define S2803X_REG_71_ALC_SGL		(0x71 * 4)
#define S2803X_REG_72_ALC_SGR		(0x72 * 4)

#define S2803X_MAX_REGISTER		S2803X_REG_72_ALC_SGR

/**
 * Description of bit-fields of various registers
 */

/* S2803X_REG_00_SOFT_RSTB */
#define SOFT_RSTB_DATA_RSTB_SHIFT	1
#define SOFT_RSTB_SYS_RSTB_SHIFT	0

/**
 * S2803X_REG_01_IN1_CTL1
 * S2803X_REG_04_IN2_CTL1
...
/* S2803X_REG_03_IN1_CTL3 */
/* S2803X_REG_06_IN2_CTL3 */
/* S2803X_REG_09_IN3_CTL3 */
...
#define DMIX1_MIX_EN2_MASK		BIT(DMIX1_MIX_EN2_SHIFT)
