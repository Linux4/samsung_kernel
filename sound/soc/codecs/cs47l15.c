...
SND_SOC_DAPM_DEMUX("HPOUT1 Demux", SND_SOC_NOPM, 0, 0, &cs47l15_outdemux),  //temp_wangqin
...
static int cs47l15_codec_probe(struct snd_soc_codec *codec)
{
	...
	printk("cs47l15_codec_probe666 ret= %d\n",ret);
	if (ret != 0) {
		dev_err(arizona->dev,
	...
	printk("cs47l15_codec_probe777 finsih\n");
