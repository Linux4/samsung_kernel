...
const struct snd_soc_dapm_widget es_codec_dapm_widgets[] = {
	...
	SND_SOC_DAPM_DAC("DAC0L", "PORTA Playback offload", SND_SOC_NOPM, 0, 0),
	SND_SOC_DAPM_DAC("DAC0R", "PORTA Playback offload", SND_SOC_NOPM, 0, 0),
	SND_SOC_DAPM_DAC("DAC1L", "PORTA Playback offload", SND_SOC_NOPM, 0, 0),
	SND_SOC_DAPM_DAC("DAC1R", "PORTA Playback offload", SND_SOC_NOPM, 0, 0),

	SND_SOC_DAPM_DAC("DAC0L", "PORTA Playback voice", SND_SOC_NOPM, 0, 0),
	SND_SOC_DAPM_DAC("DAC0R", "PORTA Playback voice", SND_SOC_NOPM, 0, 0),
	SND_SOC_DAPM_DAC("DAC1L", "PORTA Playback voice", SND_SOC_NOPM, 0, 0),
	SND_SOC_DAPM_DAC("DAC1R", "PORTA Playback voice", SND_SOC_NOPM, 0, 0),
