...
int es705_remote_route_enable(struct snd_soc_dai *dai)
{
	...
	case ES705_SLIM_1_PB:
		rc = es705_priv.rx1_route_enable;
		break;

	case ES705_SLIM_1_CAP:
		rc = es705_priv.tx1_route_enable;
		break;

	case ES705_SLIM_2_PB:
		rc = es705_priv.rx2_route_enable;
		break;

#if defined(SUPPORT_DAI_3)
	case ES705_SLIM_2_CAP:
		rc = es705_priv.tx2_route_enable;
		break;
#endif
	...
	dev_dbg(es705_priv.dev, "%s():dai->name = %s dai->id = %d rc = %d\n",
		__func__, dai->name, dai->id, rc);
