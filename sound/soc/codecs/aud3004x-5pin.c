...
static void aud3004x_ldet_adc_work(struct work_struct *work)
{
	...
	dev_info(dev, "%s called, ldet adc: %d\n", __func__, jackstate->ldet_adc);
...
static void aud3004x_jack_parse_dt(struct aud3004x_priv *aud3004x)
{
	...
	dev_info(dev, "LDET delay: %d, MDET delay: %d, ANT LDET delay: %d, Mic adc range: %d,"
	...
	dev_info(dev, "LDET adc threshold value: %d %d %d %d\n",
	...
	dev_info(dev, "LDET VTH: %d, LDET POP: %d\n",
