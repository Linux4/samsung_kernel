...
{
    struct aw8896 *aw8896 = snd_soc_component_get_drvdata(codec_dai->component);
...
/*
static int aw8896_codec_readable(struct snd_soc_component *component,
    unsigned int reg)
{
...
static struct snd_soc_component_driver soc_component_dev_aw8896 = {
    .probe = aw8896_probe,
