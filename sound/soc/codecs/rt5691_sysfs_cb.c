...
#include "rt5691.h"
#include "rt5691_sysfs_cb.h"

static struct snd_soc_component *rt5691_component;

static int get_jack_status(void)
{
	struct snd_soc_component *component = rt5691_component;
	struct rt5691_priv *rt5691 = snd_soc_component_get_drvdata(component);
	int status = rt5691->jack_type;
	int report = 0;
...
void register_rt5691_sysfs_cb(struct snd_soc_component *component)
{
	rt5691_component = component;
...
EXPORT_SYMBOL_GPL(register_rt5691_sysfs_cb);
