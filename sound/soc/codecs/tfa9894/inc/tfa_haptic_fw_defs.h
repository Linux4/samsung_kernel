...
/* firmware constants */
#define FW_XMEM_NR_OBJECTS1		6	/* nr of objs in table1 */
#define FW_XMEM_NR_OBJECTS2		5	/* nr of objs in table2 */
...
#define FW_XMEM_VOLUME_DB			4360  /* ducking attenutation */
#define FW_XMEM_DELAY_ATTACK_SMP	4361  /* delay_attack_smp */
...
#define FW_HB_STOP_OBJ	(0xffffff) /* idle object */
#define FW_HB_SILENCE_OBJ (FW_XMEM_NR_OBJECTS1 - 1) /* silence object */
#define FW_HB_RECALC_OBJ 3	/* default recalc object */
#define FW_HB_MAX_OBJ	(FW_XMEM_NR_OBJECTS1 + FW_XMEM_NR_OBJECTS2)
#define FW_HB_SEQ_OBJ	FW_HB_MAX_OBJ /* sequencer virtual objs base */
