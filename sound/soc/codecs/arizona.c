		       ...
		       int source, unsigned int freq, int dir)
{
	...
	struct reg_default dspclk_seq[2];
			   ...
			   struct snd_soc_dai *dai)
{
	...
	if(1)
	{
		return 0; //wangqin todo, for compress playing, it has no substream->runtime..
	}
