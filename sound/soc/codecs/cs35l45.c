...
static void cs35l45_log_status(struct cs35l45_private *cs35l45, int mute)
{
	static unsigned int regs[] = {
		...
		CS35L45_CHIP_STATUS,	CS35L45_IRQ1_STS_1,
		CS35L45_IRQ1_STS_2,	CS35L45_IRQ1_STS_3,
		CS35L45_IRQ1_STS_4,	CS35L45_IRQ1_STS_5,
		CS35L45_IRQ1_STS_7,	CS35L45_IRQ1_STS_8,
		CS35L45_IRQ1_STS_18,
	};
...
static int cs35l45_pcm_mute(struct snd_soc_dai *dai, int mute)
{
	struct cs35l45_private *cs35l45 =
				snd_soc_component_get_drvdata(dai->component);
...
static int cs35l45_component_probe(struct snd_soc_component *component)
{
	...
	amp_cfg.exit_temp = cs35l45->pdata.pwr_params_cfg.exit_temp &
			    (~CS35L45_VALID_PDATA);
	amp_cfg.perform_vimon_cal = cs35l45->pdata.perform_vimon_cal;
...
static int cs35l45_parse_of_data(struct cs35l45_private *cs35l45)
{
	...
	pdata->perform_vimon_cal = of_property_read_bool(node,
							"cirrus,perform_vimon_cal");
