...
static void sprd_codec_power_disable(struct snd_soc_codec *codec)
{
	...
	pr_info("sprd_codec_power_disable 1 0x%x", pmureg);
	...
	pmureg = snd_soc_read(codec, SOC_REG(ANA_PMU0));
	pr_info("sprd_codec_power_disable 2 0x%x", pmureg);
}
...
static void sprd_codec_power_enable(struct snd_soc_codec *codec)
{
	...
	pmureg = snd_soc_read(codec, SOC_REG(ANA_PMU0));
	pr_info("sprd_codec_power_enable 1 0x%x", pmureg);
	...
	pmureg = snd_soc_read(codec, SOC_REG(ANA_PMU0));
	pr_info("sprd_codec_power_enable 2 0x%x", pmureg);
