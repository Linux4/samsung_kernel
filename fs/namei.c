...
/**
 * lookup_one_len2 - filesystem helper to lookup single pathname component
 * @name:	pathname component to lookup
...
/**
 * vfs_unlink2 - unlink a filesystem object
 * @mnt:
...
/**
 * vfs_rename2 - rename a filesystem object
 * @mnt:
