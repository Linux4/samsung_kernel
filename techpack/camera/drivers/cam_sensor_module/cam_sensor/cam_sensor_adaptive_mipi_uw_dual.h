...
#ifndef _CAM_SENSOR_ADAPTIVE_MIPI_UW_DUAL_H_
#define _CAM_SENSOR_ADAPTIVE_MIPI_UW_DUAL_H_

#include "cam_sensor_dev.h"

int num_uw_dual_mipi_setting = 4;
...
#endif /* _CAM_SENSOR_ADAPTIVE_MIPI_UW_DUAL_H_ */
