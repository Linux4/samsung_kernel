...
#elif defined(CONFIG_SEC_A52SXQ_PROJECT) || defined(CONFIG_SEC_GTACTPRO2_PROJECT) || defined(CONFIG_SEC_GTACT4PRO_PROJECT) || defined(CONFIG_SEC_GTACT4PROWIFI_PROJECT)
#define AF_CAL_NEAR_OFFSET_FROM_AF                  0x000C
