                                ...
                                uint8_t *memptr)
{
    ...
    CAM_INFO(CAM_EEPROM,"addr = 0x%02X memptr[0]=%c *memptr=%c", addr * 8, memptr[0], *memptr);
                                      ...
                                      struct cam_eeprom_memory_block_t *block)
{
    ...
    CAM_INFO(CAM_EEPROM,"load_otp_setfile=%d index=%d",
		sizeof(load_sensor_otp_setfile_reg)/sizeof(struct cam_sensor_i2c_reg_array), e_ctrl->soc_info.index);
