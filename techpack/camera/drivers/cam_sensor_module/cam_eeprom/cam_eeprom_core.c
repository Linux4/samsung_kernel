...
//        CAM_ERR(CAM_EEPROM, "front_af_cal[0] macro: %d, front_af_cal[9] pan: %d", front_af_cal[0], front_af_cal[9]);
        ...
        /* rear module id */
            memcpy(rear_module_id, &e_ctrl->cal_data.mapdata[REAR_MODULE_ID_ADDR], FROM_MODULE_ID_SIZE);
    ...
    const char *update_fw_ver, cam_eeprom_fw_version_idx update_fw_index, cam_eeprom_idx_type idx)
{
    ...
    //Fix for Prevent issues with CIS's 88120, 87400, 87165, 85528 and 83576 - START
    pCAM_fw_version = NULL;
	pCAM_fw_full_version = NULL;
	pEEPROM_fw_version = NULL;
	pPHONE_fw_version = NULL;
	pLOAD_fw_version = NULL;
    //Fix for Prevent issues with CIS's 88120, 87400, 87165, 85528 and 83576 - END
