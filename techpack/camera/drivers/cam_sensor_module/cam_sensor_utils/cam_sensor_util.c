...
struct cam_sensor_id_stats cam_sensor_id_stats_front;
struct cam_sensor_id_stats cam_sensor_id_stats_rear;
//-P86801AA1 huangxiaofeng.wt,ADD,2023/08/01, Added the status of the front camera, fixed the issue of using front and rear shots together
	...
	uint16_t power_setting_size)
{
	...
	for (i = 0; i < power_setting_size; i++) {
		...
		//+bug P86801AA1-1797, jiangzhongyuan.wt, ADD, 20230717, Fix c5590 DVDD power interference issue.
...
//+P86801AA1 huangxiaofeng.wt,ADD,2023/08/01, Added the status of the front camera, fixed the issue of using front and rear shots together
			if(cam_sensor_id_stats_front.cam_stats == CAM_STATS_TURE && power_setting->seq_type == SENSOR_STANDBY){
				CAM_INFO(CAM_SENSOR, "cam_stats == TURE, skip SENSOR_RESET");
				break;
			}
//-P86801AA1 huangxiaofeng.wt,ADD,2023/08/01, Added the status of the front camera, fixed the issue of using front and rear shots together
			...
			if (power_setting->seq_val < num_vreg) {
				...
				if (power_setting->valid_config) {
					if(cam_sensor_id_stats_front.cam_stats == CAM_STATS_TURE){
						if(cam_sensor_id_stats_front.last_voltage == CAM_VOLTAGE_W11_1200000){
							seq_min_volt = CAM_VOLTAGE_W11_1200000;
							seq_max_volt = CAM_VOLTAGE_W11_1200000;
							cam_sensor_id_stats_rear.last_voltage = CAM_VOLTAGE_W11_1200000;
						}else{
							seq_min_volt = CAM_VOLTAGE_W11_1300000;
							seq_max_volt = CAM_VOLTAGE_W11_1300000;
							cam_sensor_id_stats_rear.last_voltage = CAM_VOLTAGE_W11_1300000;
						}
					}else if(cam_sensor_id_stats_rear.cam_stats == CAM_STATS_TURE){
						if(cam_sensor_id_stats_rear.last_voltage == CAM_VOLTAGE_W11_1300000){
							seq_min_volt = CAM_VOLTAGE_W11_1300000;
							seq_max_volt = CAM_VOLTAGE_W11_1300000;
							cam_sensor_id_stats_front.last_voltage = CAM_VOLTAGE_W11_1300000;
						}else{
							seq_min_volt = CAM_VOLTAGE_W11_1200000;
							seq_max_volt = CAM_VOLTAGE_W11_1200000;
							cam_sensor_id_stats_front.last_voltage = CAM_VOLTAGE_W11_1200000;
					   }
					}else{
						seq_min_volt = power_setting->config_val;
						seq_max_volt = power_setting->config_val;
						cam_sensor_id_stats_front.last_voltage = power_setting->config_val;
						cam_sensor_id_stats_rear.last_voltage = power_setting->config_val;
					}
				//-P86801AA1 huangxiaofeng.wt,ADD,2023/08/01, Added the status of the front camera, fixed the issue of using front and rear shots together
				} else {
