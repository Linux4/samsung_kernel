...
#define O5_SENSORNAME_MAXLENGTH 25
...
enum msm_camera_power_seq_type {
	...
	SENSOR_CUSTOM_GPIO1,
	SENSOR_CUSTOM_GPIO2,
	/*zql1838 code for camera bringup by zhangpeng at 2020/5/11 start*/
	...
	SENSOR_WL2864C_VAF,
	#endif
	/*zql1838 code for camera bringup by zhangpeng at 2020/5/11 end*/	
	SENSOR_SEQ_TYPE_MAX,
};
...
struct cam_camera_slave_info {
	...
	char sensor_name[O5_SENSORNAME_MAXLENGTH];
};
