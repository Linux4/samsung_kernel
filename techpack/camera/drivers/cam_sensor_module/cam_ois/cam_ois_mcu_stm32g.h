...
int cam_ois_cmd_notifier_call_chain(unsigned long val, void *v);
int cam_ois_reg_read_notifier_call_chain(unsigned long val, void *v);
...
int cam_ois_factory_mode(int op);
#endif
