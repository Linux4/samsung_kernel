...
#elif defined(CONFIG_TAS25XX_ALGO) && defined(CONFIG_SND_SOC_TAS2562)
...
#if defined(CONFIG_TAS25XX_ALGO) && defined(CONFIG_SND_SOC_TAS2562)
			...
			u16 port_id)
{
	...
	pr_info("%s: max_excursion %d %d count_exceeded_excursion %d %d"
