...
//+P86801AA1, zhangtao10.wt, ADD, 2023/05/13, add smartpa code
...
#define CONFIG_SND_SOC_AWINIC_AW882XX	//P86801AA1, zhangtao10.wt, ADD, 2023/04/25, smartpa driver code
...
//+P86801AA1, zhangtao10.wt, ADD, 2023/05/13, add smartpa code
#ifdef CONFIG_SND_SOC_FS19XX
		// TODO make sure: uint32_t *payload = data->payload;
...
int q6afe_send_fsm_pkt(struct fsm_afe *afe, uint8_t *param, uint32_t param_size)
{
	...
	if (afe->op_set) { // set params
		if (param_size <= (afe->cal_block->map_data.map_size
