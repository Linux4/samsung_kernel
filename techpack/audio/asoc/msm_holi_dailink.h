...
SND_SOC_DAILINK_DEFS(sec_tdm_rx_0_aw,
	...
	DAILINK_COMP_ARRAY(COMP_CODEC("aw882xx_smartpa.1-0034", "aw882xx-aif-1-34"),
					...
					COMP_CODEC("aw882xx_smartpa.1-0036", "aw882xx-aif-1-36"),
					COMP_CODEC("aw882xx_smartpa.1-0037", "aw882xx-aif-1-37")),
	DAILINK_COMP_ARRAY(COMP_PLATFORM("msm-pcm-routing")));
SND_SOC_DAILINK_DEFS(sec_tdm_rx_0_fsm,
	DAILINK_COMP_ARRAY(COMP_CPU("msm-dai-q6-tdm.36880")),
	DAILINK_COMP_ARRAY(COMP_CODEC("fs16xx.1-0038", "fs16xx-aif")),
	DAILINK_COMP_ARRAY(COMP_PLATFORM("msm-pcm-routing")));
#else
