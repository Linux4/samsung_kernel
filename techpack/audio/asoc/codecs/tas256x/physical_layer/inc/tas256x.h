...
#define TAS256X_ICN_NG_MASK  (0x01 << 5)
#define TAS256X_ICN_NG_ENABLE  (0x20)
#define TAS256X_ICN_NG_DISABLE  (0x00)

#define TAS256X_SAR_CFG_REG  TAS256X_REG(0x0, 0x0, 0x3A)
...
#define TAS256X_DMIN_VALUE  TAS256X_REG(0x0, 0xfd, 0x3e)
#define TAS256X_DMIN_SWEEP  TAS256X_REG(0x0, 0x01, 0x2b)
...
/*Brown Out Protection Control*/
#define TAS256X_BOOST_ALWAYS_ON  TAS256X_REG(0x64, 0x07, 0x38)
#define TAS256X_BOOST_ALWAYS_OFF  TAS256X_REG(0x64, 0x7, 0x44)
...
#define TAS256X_MSB_DEM      TAS256X_REG(0x00, 0xfd, 0x3F)
#define TAS256X_DITHER      TAS256X_REG(0x00, 0xfd, 0x0C)
#define TAS256X_LSB_DEM      TAS256X_REG(0x00, 0xfd, 0x44)
#define TAS256X_CLK_SWEEP      TAS256X_REG(0x00, 0xfd, 0x48)
...
#if IS_ENABLED(CONFIG_TAS256X_REINIT)
/* Added for sysfs nodes */
#define TAS256X_SYSFS_CLASS_NAME	"tas256x"
#define TAS256X_CODEC_DIR_NAME		"codec"

struct tas256x_sysfs {
	struct tas256x_priv *p_tas256x;
	struct class *tas256x_class;
	struct device *reinit_dev;
};
#endif /* CONFIG_TAS256X_REINIT */
...
struct tas256x_priv {
	...
	int profile_cfg_id;
#endif
	/* Added to Support Algo Get/Set Bypass */
	int algo_bypass;
	/* Added for receiver only project support */
	int rcv_only;
#if IS_ENABLED(CONFIG_TAS256X_REINIT)
	/* Added for sysfs nodes support */
	struct tas256x_sysfs *tas_sysfs;
#endif
};
