...
//+P230725-07531,zhangtao10.wt,add,2023/08/13,add mbhc debug log
#define DEBUG_LOG_PRINTK 1
//-P230725-07531,zhangtao10.wt,add,2023/08/13,add mbhc debug log
//+P86801AA1-12927,zhangtao10.wt,add,2023/08/30,increace headset debounce
				...
				enum snd_jack_types jack_type)
{
	...
	bool is_pa_on = false;
	u8 fsm_en = 0;
	bool is_lineout = false; //P230811-07919,zhangtao10.wt,modify,2023/09/09,prohibit recognition as lineout

	WCD_MBHC_RSC_ASSERT_LOCKED(mbhc);
//+P86801AA1, daisiqing.wt, ADD, 2023/05/11, add car AUX
