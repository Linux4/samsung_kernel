...
static int ss_blic_ktz8864b_configure(struct i2c_client *client)
{
	u8 check;
				  ...
				  const struct i2c_device_id *id)
{
	...
	ss_blic_ktz8864b_configure(client);
...
module_init(ss_blic_ktz8864b_init);
module_exit(ss_blic_ktz8864b_exit);

MODULE_DESCRIPTION("ss_blic_ktz8864b_i2c driver");
MODULE_LICENSE("GPL");
