...
__visible_for_testing struct dsi_panel_cmd_set *__ss_vrr(struct samsung_display_driver_data *vdd,
...
void S6E3HAB_AMB677TY01_WQHD_init(struct samsung_display_driver_data *vdd)
{
	...
	vdd->panel_func.convert_GAMMA_to_V = convert_GAMMA_to_V_S6E3HAB_AMB677TY01;
	vdd->panel_func.convert_V_to_GAMMA = convert_V_to_GAMMA_S6E3HAB_AMB677TY01;
