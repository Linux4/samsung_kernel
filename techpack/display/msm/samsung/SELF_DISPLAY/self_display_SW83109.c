...
#include "self_display_SW83109.h"
 ...
 */
void make_self_dispaly_img_cmds_SW83109(struct samsung_display_driver_data *vdd,
		int cmd, u32 op)
{
...
void make_mass_self_display_img_cmds_SW83109(struct samsung_display_driver_data *vdd,
		int cmd, u32 op)
{
	struct dsi_cmd_desc *tcmds;
	struct dsi_panel_cmd_set *pcmds;
...
int self_display_init_SW83109(struct samsung_display_driver_data *vdd)
{
	int ret = 0;
