...
#include "self_display_A73_S6E3FC3_AMB667BV01.h"
 ...
 */
void make_self_dispaly_img_cmds_A73_S6E3FC3_AMB667BV01(struct samsung_display_driver_data *vdd,
		int cmd, u32 op)
{
	...
	LCD_INFO(vdd, "[A73_S6E3FC3_AMB667BV01] ++\n");
...
void make_mass_self_display_img_cmds_A73_S6E3FC3_AMB667BV01(struct samsung_display_driver_data *vdd,
		int cmd, u32 op)
{
	struct dsi_cmd_desc *tcmds;
	struct dsi_panel_cmd_set *pcmds;
	...
	LCD_INFO(vdd, "[A73_S6E3FC3_AMB667BV01] [%s] total data size [%d], total cmd len[%d], cmd count [%d]\n",
	...
	LCD_INFO(vdd, "[A73_S6E3FC3_AMB667BV01] Total Cmd Count(%d), Last Cmd Payload Len(%d)\n",
...
static void self_mask_img_write(struct samsung_display_driver_data *vdd)
{
	...
	LCD_DEBUG(vdd, "[A73_S6E3FC3_AMB667BV01] ++\n");
	...
	LCD_INFO(vdd, "[A73_S6E3FC3_AMB667BV01] TX_SELF_MASK_IMAGE\n");
...
static int self_mask_on(struct samsung_display_driver_data *vdd, int enable)
{
	...
	LCD_INFO(vdd, "[A73_S6E3FC3_AMB667BV01] ++ (%d)\n", enable);
...
static int self_display_open(struct inode *inode, struct file *file)
{
	...
	LCD_INFO(vdd, "[A73_S6E3FC3_AMB667BV01] [open]\n");
...
static int self_display_release(struct inode *inode, struct file *file)
{
	...
	LCD_INFO(vdd, "[A73_S6E3FC3_AMB667BV01] [release]\n");
...
int self_display_init_A73_S6E3FC3_AMB667BV01(struct samsung_display_driver_data *vdd)
{
	int ret = 0;
	...
	LCD_INFO(vdd, "[A73_S6E3FC3_AMB667BV01] Success to register self_disp device..(%d)\n", ret);
