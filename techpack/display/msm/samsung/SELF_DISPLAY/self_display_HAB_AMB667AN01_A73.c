...
#include "self_display_HAB_AMB667AN01_A73.h"
		...
		int cmd, u32 op)
{
	...
	LCD_INFO(vdd, "[HAB_AMB667AN01_A73] ++\n");
		...
		int cmd, u32 op)
{
	...
	LCD_INFO(vdd, "[HAB_AMB667AN01_A73] [%s] total data size [%d], total cmd len[%d], cmd count [%d]\n",
	...
	LCD_INFO(vdd, "[HAB_AMB667AN01_A73] Total Cmd Count(%d), Last Cmd Payload Len(%d)\n", c_cnt, tcmds[c_cnt-1].msg.tx_len);
...
int self_display_init_HAB_AMB667AN01_A73(struct samsung_display_driver_data *vdd)
{
	...
	LCD_INFO(vdd, "[HAB_AMB667AN01_A73] Success to register self_disp device..(%d)\n", ret);
