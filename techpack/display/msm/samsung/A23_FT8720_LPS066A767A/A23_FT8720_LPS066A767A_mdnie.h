...
#ifndef _SAMSUNG_DSI_MDNIE_A23_FT8720_LPS066A767A_
#define _SAMSUNG_DSI_MDNIE_A23_FT8720_LPS066A767A_
...
static struct dsi_cmd_desc DSI0_CAMERA_MDNIE[] = {
	{{0, MIPI_DSI_DCS_LONG_WRITE, 0, 0, 0, sizeof(DSI0_CAMERA_MDNIE_1), DSI0_CAMERA_MDNIE_1, 0, NULL}, false, 0},
	{{0, MIPI_DSI_DCS_LONG_WRITE, 0, 0, 0, sizeof(DSI0_CAMERA_MDNIE_2), DSI0_CAMERA_MDNIE_2, 0, NULL}, false, 0},
	{{0, MIPI_DSI_DCS_LONG_WRITE, 0, 0, 0, sizeof(DSI0_CAMERA_MDNIE_3), DSI0_CAMERA_MDNIE_3, 0, NULL}, false, 0},
};

static struct dsi_cmd_desc DSI0_EBOOK_MDNIE[] = {
	{{0, MIPI_DSI_DCS_LONG_WRITE, 0, 0, 0, sizeof(DSI0_EBOOK_MDNIE_1), DSI0_EBOOK_MDNIE_1, 0, NULL}, false, 0},
	{{0, MIPI_DSI_DCS_LONG_WRITE, 0, 0, 0, sizeof(DSI0_EBOOK_MDNIE_2), DSI0_EBOOK_MDNIE_2, 0, NULL}, false, 0},
	{{0, MIPI_DSI_DCS_LONG_WRITE, 0, 0, 0, sizeof(DSI0_EBOOK_MDNIE_3), DSI0_EBOOK_MDNIE_3, 0, NULL}, false, 0},
...
static struct dsi_cmd_desc DSI0_LIGHT_NOTIFICATION_MDNIE[] = {
	{{0, MIPI_DSI_DCS_LONG_WRITE, 0, 0, 0, sizeof(DSI0_UI_MDNIE_1), DSI0_UI_MDNIE_1, 0, NULL}, false, 0},
	{{0, MIPI_DSI_DCS_LONG_WRITE, 0, 0, 0, sizeof(DSI0_UI_MDNIE_2), DSI0_UI_MDNIE_2, 0, NULL}, false, 0},
	{{0, MIPI_DSI_DCS_LONG_WRITE, 0, 0, 0, sizeof(DSI0_UI_MDNIE_3), DSI0_UI_MDNIE_3, 0, NULL}, false, 0},
};
...
static struct dsi_cmd_desc DSI0_VIDEO_MDNIE[] = {
	{{0, MIPI_DSI_DCS_LONG_WRITE, 0, 0, 0, sizeof(DSI0_VIDEO_MDNIE_1), DSI0_VIDEO_MDNIE_1, 0, NULL}, false, 0},
	{{0, MIPI_DSI_DCS_LONG_WRITE, 0, 0, 0, sizeof(DSI0_VIDEO_MDNIE_2), DSI0_VIDEO_MDNIE_2, 0, NULL}, false, 0},
	{{0, MIPI_DSI_DCS_LONG_WRITE, 0, 0, 0, sizeof(DSI0_VIDEO_MDNIE_3), DSI0_VIDEO_MDNIE_3, 0, NULL}, false, 0},
};
static struct dsi_cmd_desc DSI0_GAME_LOW_MDNIE[] = {
	{{0, MIPI_DSI_DCS_LONG_WRITE, 0, 0, 0, sizeof(DSI0_GAME_LOW_MDNIE_1), DSI0_GAME_LOW_MDNIE_1, 0, NULL}, false, 0},
	{{0, MIPI_DSI_DCS_LONG_WRITE, 0, 0, 0, sizeof(DSI0_GAME_LOW_MDNIE_2), DSI0_GAME_LOW_MDNIE_2, 0, NULL}, false, 0},
	{{0, MIPI_DSI_DCS_LONG_WRITE, 0, 0, 0, sizeof(DSI0_GAME_LOW_MDNIE_3), DSI0_GAME_LOW_MDNIE_3, 0, NULL}, false, 0},

};
static struct dsi_cmd_desc DSI0_GAME_MID_MDNIE[] = {
	{{0, MIPI_DSI_DCS_LONG_WRITE, 0, 0, 0, sizeof(DSI0_GAME_MID_MDNIE_1), DSI0_GAME_MID_MDNIE_1, 0, NULL}, false, 0},
	{{0, MIPI_DSI_DCS_LONG_WRITE, 0, 0, 0, sizeof(DSI0_GAME_MID_MDNIE_2), DSI0_GAME_MID_MDNIE_2, 0, NULL}, false, 0},
	{{0, MIPI_DSI_DCS_LONG_WRITE, 0, 0, 0, sizeof(DSI0_GAME_MID_MDNIE_3), DSI0_GAME_MID_MDNIE_3, 0, NULL}, false, 0},
};
static struct dsi_cmd_desc DSI0_GAME_HIGH_MDNIE[] = {
	{{0, MIPI_DSI_DCS_LONG_WRITE, 0, 0, 0, sizeof(DSI0_GAME_HIGH_MDNIE_1), DSI0_GAME_HIGH_MDNIE_1, 0, NULL}, false, 0},
	{{0, MIPI_DSI_DCS_LONG_WRITE, 0, 0, 0, sizeof(DSI0_GAME_HIGH_MDNIE_2), DSI0_GAME_HIGH_MDNIE_2, 0, NULL}, false, 0},
	{{0, MIPI_DSI_DCS_LONG_WRITE, 0, 0, 0, sizeof(DSI0_GAME_HIGH_MDNIE_3), DSI0_GAME_HIGH_MDNIE_3, 0, NULL}, false, 0},
};
...
#endif /*_DSI_TCON_MDNIE_LITE_DATA_FHD_A23_FT8720_LPS066A767A_H_*/
