...
*/
#include "ss_dsi_panel_S6E3FC3_AMB641ZR02.h"
#include "ss_dsi_mdnie_S6E3FC3_AMB641ZR02.h"
...
static void ss_gray_spot(struct samsung_display_driver_data *vdd, int enable)
{
	...
	if (enable) {
		...
		idx = ss_get_cmd_idx(pcmds_off, 0x00, 0x63);
		/* TX_GRAY_SPOT_TEST_OFF : replace 0xXX, 0xXX, 0xXX */
