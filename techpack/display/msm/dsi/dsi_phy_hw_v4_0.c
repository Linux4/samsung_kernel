			    ...
			    struct dsi_phy_cfg *cfg)
{
	...
	if (phy->version == DSI_PHY_VERSION_4_2) {
		...
		//+P86801AA1,liuyongliang.wt,add,2023.06.06, modify mipi voltage
		vreg_ctrl_0 = less_than_1500_mhz ? 0x50 : 0x52;
		//-P86801AA1,liuyongliang.wt,add,2023.06.06, modify mipi voltage
	...
	DSI_W32(phy, DSIPHY_CMN_CTRL_2, 0x41);
	pr_err("WT_LCD,MIPI VOL: vreg_ctrl_0:0x%x, glbl_str_swi_cal_sel_ctrl:0x%x, glbl_hstx_str_ctrl_0:0x%x, DSIPHY_CMN_CTRL_2:0x%x\n",
									vreg_ctrl_0,glbl_str_swi_cal_sel_ctrl,glbl_hstx_str_ctrl_0,DSIPHY_CMN_CTRL_2);
