...
if [ "${REGION}" == "${CARRIER}" ]; then
	...
	VARIANT_DEFCONFIG=msm8952_sec_${MODEL}_${REGION}_${CARRIER}_defconfig
fi
...
FUNC_BUILD_KERNEL()
{
    ...
    echo '--base 0x80000000 --cmdline "console=ttyHSL0,115200,n8 androidboot.console=ttyHSL0 androidboot.hardware=qcom user_debug=31 msm_rtb.filter=0x3F ehci-hcd.park=3 androidboot.bootdevice=7824900.sdhci" --pagesize 2048 --tags_offset 0x01E00000 --ramdisk_offset 0x02000000 --os_version 8.0.0 --os_patch_level 2018-04-01'   >  $PRODUCT_OUT/mkbootimg_ver_args.txt   
