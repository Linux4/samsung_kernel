...
extern inline void kdp_set_mnt_root_sb(struct vfsmount *mnt, struct dentry *mnt_root, struct super_block *mnt_sb);
extern void kdp_set_mnt_flags(struct vfsmount *mnt, int flags);
extern inline void kdp_clear_mnt_flags(struct vfsmount *mnt, int flags);
extern inline void kdp_assign_mnt_flags(struct vfsmount *mnt, int flags);
extern void kdp_set_mnt_userns(struct vfsmount *mnt, struct user_namespace *userns);
extern inline void kdp_set_test(unsigned long long  a, unsigned long long b, unsigned long long c);
