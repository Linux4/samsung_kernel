...
//+S98901AA1-827, zhouweijie.wt, add, 2024/04/15, sia81xx bring up
	if (smartpa_type == sia81xx) {
		pr_info("%s sia device has been registered\n",__func__);
		return EEXIST;
	}
//-S98901AA1-827, zhouweijie.wt, add, 2024/04/15, sia81xx bring up
...
//+S98901AA1-827, zhouweijie.wt, add, 2024/04/15, sia81xx bring up
	if (aw883xx->chip_id == AW883XX_PID_2049) {
		pr_info("%s awinic detect device seccess\n",__func__);
		smartpa_type =snd_soc_set_smartpa_type("aw883xx_i2c_probe", aw88394);
	} else {
