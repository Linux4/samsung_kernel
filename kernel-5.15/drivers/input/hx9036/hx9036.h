...
#define HX9036_TEST_ON_MTK_DEMO_XY6761 0 //客户平台上务必将此宏定义设置为0
#define HX9036_CHANNEL_ALL_EN  0//开机打开所有通道

#define HX9036_DRIVER_NAME "hx9036" //i2c addr: HX9036=0x1B
#define HX9036_CH_NUM 8
#define HX9036_MAX_XFER_SIZE 32

#define HX9036_ODR_MS 100
...
struct hx9036_channel_info {
    ...
    int type;
#if !HX9036_REPORT_EVKEY
    struct sensors_classdev hx9036_sensors_classdev;
#endif
    struct input_dev *hx9036_input_dev;
    int keycode;
};
...
static struct hx9036_channel_info hx9036_channels[] = {
    {
        .name = "hx9036_ch0",
        .enabled = false,
        .used = false,
...
static struct hx9036_addr_val_pair hx9036_reg_init_list[] = {
    ...
    {PAGE0_4E_TC_NOSR_CFG0,              0x42},
    {PAGE0_4F_TC_NOSR_CFG1,              0x42},
    {PAGE0_50_TC_NOSR_CFG2,              0x42},
    {PAGE0_51_TC_NOSR_CFG3,              0x42},
    {PAGE0_52_TC_AVG_CFG0,               0x51},
    {PAGE0_53_TC_AVG_CFG1,               0x51},
    {PAGE0_54_TC_AVG_CFG2,               0x51},
    {PAGE0_55_TC_AVG_CFG3,               0x51},

    {PAGE0_78_RANGE_CFG_0,               0x13}, //ch1 ch0 ： (N+1)* 1.25pF
    {PAGE0_79_RANGE_CFG_1,               0x03}, //ch3 ch2
    {PAGE0_7A_RANGE_CFG_2,               0x11}, //ch5 ch4
    {PAGE0_7B_RANGE_CFG_3,               0x00}, //ch7 ch6 json config available last line.

    {PAGE0_7C_DAC_SWAP_CFG,              0x41}, //ch6 ch0
    ...
    {PAGE0_9C_DSP_CONFIG_CTRL9,          0x70}, // high 4 byte (n+1)*(-2048)

    {PAGE0_9D_CAP_INI_CFG0,              0xF4}, //7:4
    ...
    {PAGE0_B9_CH0_COE_CFG_0,             0x10},
    {PAGE0_BB_CH1_COE_CFG_0,             0x3B},
    {PAGE0_BD_CH2_COE_CFG_0,             0x40},
    {PAGE0_BF_CH3_COE_CFG_0,             0x3B},
    {PAGE0_C1_CH4_COE_CFG_0,             0x2A},
    {PAGE0_C3_CH5_COE_CFG_0,             0x3B},
    {PAGE0_C5_CH6_COE_CFG_0,             0x1E},
    {PAGE0_C7_CH7_COE_CFG_0,             0x3B},

    {PAGE0_C9_PROX_HIGH_THRES1_CFG0,     0x3F}, //PROX_HIGH_THRES1
    {PAGE0_CA_PROX_HIGH_THRES1_CFG1,     0x25},
    {PAGE0_CB_PROX_HIGH_THRES1_CFG2,     0x3F},
    {PAGE0_CC_PROX_HIGH_THRES1_CFG3,     0x00},
    {PAGE0_CD_PROX_HIGH_THRES1_CFG4,     0x3F},
    {PAGE0_CE_PROX_HIGH_THRES1_CFG5,     0x23},
    {PAGE0_CF_PROX_HIGH_THRES1_CFG6,     0x3F},
    {PAGE0_D0_PROX_HIGH_THRES1_CFG7,     0x24},
    ...
    {PAGE0_E2_SAMPLE_NUM_0,              0x17},
    {PAGE0_E3_SAMPLE_NUM_1,              0x00},
    {PAGE0_E4_INTEGRATION_NUM_0,         0x17},
    {PAGE0_E5_INTEGRATION_NUM_1,         0x00},
    {PAGE0_ED_LPOUT_DELTA_CFG,           0xF7}, //1: close usefilter

    {PAGE1_A3_LP_OUT_DELTA_THRES_CH1_CFG0, 0x50},
    {PAGE1_A9_LP_OUT_DELTA_THRES_CH3_CFG0, 0x20},
    {PAGE1_AF_LP_OUT_DELTA_THRES_CH5_CFG0, 0x50},
    {PAGE1_B5_LP_OUT_DELTA_THRES_CH7_CFG0, 0x50},
    {PAGE1_C0_BL_IN_NO_UP_NUM_SEL0,      0x50},
    {PAGE1_C1_BL_IN_NO_UP_NUM_SEL1,      0x50},
    {PAGE1_C2_BL_IN_NO_UP_NUM_SEL2,      0x50},
    {PAGE1_C3_BL_IN_NO_UP_NUM_SEL3,      0x50},


    {PAGE1_C4_LP_SIGN_THRES_EN,          0x00},//lp_thres
    {PAGE1_C5_LP_SIGN_THRES_CH0,         0xFF},

    {PAGE1_CF_BL_ALPHA_UP_DN_SEL,        0x00},
    ...
    {PAGE1_1C_REG_TO_ANA8,               0xE0},

    {PAGE2_F0_CH_CFG_ADD0,               0x03},
    {PAGE2_F1_CH_CFG_ADD1,               0x02},
    {PAGE2_F2_CH_CFG_ADD2,               0x03},
    {PAGE2_F3_CH_CFG_ADD3,               0x02},
    {PAGE2_F4_CH_CFG_ADD4,               0x03},
    {PAGE2_F5_CH_CFG_ADD5,               0x02},
    {PAGE2_F6_CH_CFG_ADD6,               0x03},
    {PAGE2_F7_CH_CFG_ADD7,               0x02},
    {PAGE2_FC_CH_SUB_CFG,                0x1B},
