...
//	.clock = 276480,// Pixel Clock = vtotal * htotal * vrefresh(60) / 1000;
//	.hdisplay = HAC,
//	.hsync_start = HAC + HFP,
...
static struct drm_display_mode default_mode = {
	.clock = 184320,// Pixel Clock = vtotal * htotal * vrefresh(90) / 1000;
	.hdisplay = HAC,
	.hsync_start = HAC + HFP,
	.hsync_end = HAC + HFP + HSA,
	.htotal = HAC + HFP + HSA + HBP,
...
static int lcm_probe(struct mipi_dsi_device *dsi)
{
	...
	"s6e8fc3,ams645fw01,fhdp,vdo,no_dsc,a15");
	if (!lcd_comp) {
...
static struct mipi_dsi_driver lcm_driver = {
	...
	.remove = lcm_remove,
	.driver = {
		.name = "panel-s6e8fc3-ams645fw01-vdo-dsc-a15",
		.owner = THIS_MODULE,
...
MODULE_DESCRIPTION("s6e8fc3 fhdp LCD Panel Driver for a15");
