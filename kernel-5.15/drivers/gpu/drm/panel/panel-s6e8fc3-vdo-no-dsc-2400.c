...
static struct LCM_setting_table init_setting_cmd[] = {
	...
	{3, {0xF0, 0x5A, 0x5A}},
	{8, {0xDF, 0x09, 0x30 , 0x95, 0x28, 0xAC, 0x28, 0xAC}},
	{3, {0xF0, 0xA5, 0xA5}},
...
#if 0   // VIO28 use instead of VDD_LCD_3P0 gpio control
...
static struct drm_display_mode default_mode = {
	.clock = 276092,// Pixel Clock = vtotal * htotal * vrefresh(90) / 1000;
	.hdisplay = HAC,
	.hsync_start = HAC + HFP,
	.hsync_end = HAC + HFP + HSA,
	.htotal = HAC + HFP + HSA + HBP,
...
static const struct of_device_id lcm_of_match[] = {
	{ .compatible = "s6e8fc3,fhdp,vdo,no_dsc_2400", },
	{ }
};
...
static struct mipi_dsi_driver lcm_driver = {
	...
	.remove = lcm_remove,
	.driver = {
		.name = "panel-s6e8fc3-vdo-no-dsc-2400",
		.owner = THIS_MODULE,
