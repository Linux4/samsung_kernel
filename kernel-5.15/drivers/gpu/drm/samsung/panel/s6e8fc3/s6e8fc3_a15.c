...
{
	struct common_panel_info *cpi = &s6e8fc3_a16_panel_info;
	panel_info("s6e8fc3_a15_panel_init start, lcm_id = %d\n", lcm_id);

	if(1 == lcm_id)
	{
		cpi = &s6e8fc3_a15_panel_info;
		panel_info("s6e8fc3_a15_panel_init use a15 info\n");
	}
	else if(0 == lcm_id)
	{
		return 0;  //no lcd
...
{
	panel_info("s6e8fc3_a15_panel_exit start\n");
	...
	{
		deregister_common_panel(&s6e8fc3_a16_panel_info);
	}
}
