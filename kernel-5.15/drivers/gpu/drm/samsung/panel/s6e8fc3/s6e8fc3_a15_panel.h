...
static u8 a15_acl_opr_table[MAX_S6E8FC3_ACL_OPR][1] = {
	...
	[S6E8FC3_ACL_OPR_1] = { 0x00 }, /* ACL ON, OPR 8% */
	[S6E8FC3_ACL_OPR_2] = { 0x00 }, /* ACL ON, OPR 15% */
	[S6E8FC3_ACL_OPR_3] = { 0x00 }, /* ACL ON, OPR 15% */
};
...
static DEFINE_PANEL_MDELAY(a15_wait_110msec, 110);
...
static DEFINE_PANEL_MDELAY(a15_wait_40msec, 40);
static DEFINE_PANEL_MDELAY(a15_wait_70msec, 70);

static DEFINE_PANEL_MDELAY(a15_wait_sleep_out_20msec, 20);
static DEFINE_PANEL_MDELAY(a15_wait_display_off, 25);

static DEFINE_PANEL_MDELAY(a15_wait_sleep_in, 130);
...
static u8 A15_FPS_1[] = { 0x60, 0x01, 0x00};
...
static u8 A15_DSC[] = { 0x9D, 0x00 }; //0: close pps data; 1: open pps data
static DEFINE_STATIC_PACKET(a15_dsc, DSI_PKT_TYPE_WR, A15_DSC, 0);

static u8 A16_DSC[] = { 0x9D, 0x01 }; //0: close pps data; 1: open pps data
static DEFINE_STATIC_PACKET(a16_dsc, DSI_PKT_TYPE_WR, A16_DSC, 0);
...
//data for a16 start
static u8 A15_SRC_SETTING[] = { 0xB0, 0x00, 0x8A, 0xC3 };
static DEFINE_STATIC_PACKET(a15_src_setting, DSI_PKT_TYPE_WR, A15_SRC_SETTING, 0x00);

static u8 A15_ACL_SETTING[] = { 0xB0, 0x00, 0x0D, 0xB4 };
static DEFINE_STATIC_PACKET(a15_acl_setting, DSI_PKT_TYPE_WR, A15_ACL_SETTING, 0x00);

static u8 A15_PCD_SETTING[] = { 0xEA, 0x4C, 0x50 };
static DEFINE_STATIC_PACKET(a15_pcd_setting, DSI_PKT_TYPE_WR, A15_PCD_SETTING, 0x00);

static u8 A15_SMOOTH_DIMMING_SETTING[] = { 0xB0, 0x00, 0x0D, 0xB2 };
static DEFINE_STATIC_PACKET(a15_smooth_dimming_setting, DSI_PKT_TYPE_WR, A15_SMOOTH_DIMMING_SETTING, 0x00);

//static u8 A15_MAX_DIMMING_1_SETTING[] = { 0x51, 0x07, 0xFF };
//static DEFINE_STATIC_PACKET(a15_max_dimming_1_setting, DSI_PKT_TYPE_WR, A15_MAX_DIMMING_1_SETTING, 0x00);

//static u8 A15_MAX_DIMMING_2_SETTING[] = { 0xB0, 0x00, 0x89, 0xB1 };
//static DEFINE_STATIC_PACKET(a15_max_dimming_2_setting, DSI_PKT_TYPE_WR, A15_MAX_DIMMING_2_SETTING, 0x00);

static u8 A15_MAX_DIMMING_3_SETTING[] = { 0xB1, 0x6F, 0xD3, 0x03, 0x00 };
static DEFINE_STATIC_PACKET(a15_max_dimming_3_setting, DSI_PKT_TYPE_WR, A15_MAX_DIMMING_3_SETTING, 0x00);

//static u8 A15_HBM_INTERPOLATION_SETTING[] = { 0x51, 0x0F, 0xFF };
//static DEFINE_STATIC_PACKET(a15_hbm_interpolation_setting, DSI_PKT_TYPE_WR, A15_HBM_INTERPOLATION_SETTING, 0x00);

static u8 A15_TE[] = { 0x35, 0x00 };
static DEFINE_STATIC_PACKET(a15_te, DSI_PKT_TYPE_WR, A15_TE, 0);

static u8 A16_VSYNC_GLOBAL_PARA[] = { 0xB0, 0x00, 0x11, 0xE8 };
static DEFINE_STATIC_PACKET(a16_vync_global_para, DSI_PKT_TYPE_WR, A16_VSYNC_GLOBAL_PARA, 0);

static u8 A16_VSYNC_WIDTH[] = { 0xE8, 0x20 };
static DEFINE_STATIC_PACKET(a16_vsync_width, DSI_PKT_TYPE_WR, A16_VSYNC_WIDTH, 0);

static u8 A16_HBM_INTERPOLATION_DIMMING_GLOBAL_PARA[] = { 0xB0, 0x00, 0xF8, 0xB5 };
static DEFINE_STATIC_PACKET(a16_hbm_interpolation_dimming_global_para, DSI_PKT_TYPE_WR, A16_HBM_INTERPOLATION_DIMMING_GLOBAL_PARA, 0x00);

static u8 A16_HBM_INTERPOLATION_DIMMING_IRC_MODE_SETTING[] = { 0xB5, 0x01, 0x00, 0x00, 0x00, 0x86, 0xE2, 0x44, 0x80, 0x00, 0x00, 0xFF, 0xF4, 0xFF, 0x9C};
static DEFINE_STATIC_PACKET(a16_hbm_interpolation_dimming_irc_mode_setting, DSI_PKT_TYPE_WR, A16_HBM_INTERPOLATION_DIMMING_IRC_MODE_SETTING, 0x00);
...
static void *a15_common_setting_cmdtbl[] = {
	...
	//4.1.6 ACL Setting
	&PKTINFO(a15_acl_setting),

	&PKTINFO(a15_acl_set),
	/* 4.1.7 PCD Setting */
	&PKTINFO(a15_pcd_setting),

	/* 4.1.8 Smooth Dimming Setting */
	&PKTINFO(a15_smooth_dimming_setting),
	...
	/* 4.2.1 Max & Dimming */
	&PKTINFO(a15_fps_1),
	&PKTINFO(a15_normal_mode),
	//&PKTINFO(a15_max_dimming_1_setting),
	//&PKTINFO(a15_max_dimming_2_setting),
	&PKTINFO(a15_max_dimming_3_setting),
	&PKTINFO(a15_panel_update),

	/* 4.2.2 HBM & Interpolation Dimming 8 00~420nit) */
	&PKTINFO(a15_fps_1),
	&PKTINFO(a15_normal_mode),
	//&PKTINFO(a15_hbm_interpolation_setting),
	//&PKTINFO(a15_max_dimming_2_setting),
	&PKTINFO(a15_panel_update),
	...
	&DLYINFO(a15_wait_70msec),
	&PKTINFO(a15_display_on),
	&DLYINFO(a15_wait_40msec),
...
static void *a16_common_setting_cmdtbl[] = {
	&KEYINFO(a15_level1_key_enable),
	&KEYINFO(a15_level2_key_enable),
	&KEYINFO(a15_level3_key_enable),
	...
	/* 4.1.4 FFC SET, 898Mbps */
	&PKTINFO(a15_ffc_default),

	/* 4.1.5 Vsync Setting */
	&PKTINFO(a15_tsp_vsync_on),
	&PKTINFO(a16_vync_global_para),
	&PKTINFO(a16_vsync_width),
	&PKTINFO(a15_panel_update),
	...
	&PKTINFO(a15_normal_mode),
	//&PKTINFO(a15_hbm_interpolation_setting),
	&PKTINFO(a16_hbm_interpolation_dimming_global_para),
	&PKTINFO(a16_hbm_interpolation_dimming_irc_mode_setting),
	&PKTINFO(a15_panel_update),
...
static void *a16_init_cmdtbl[] = {
	&PNOBJ_CONFIG(a15_set_separate_tx_on),
	&DLYINFO(a15_wait_10msec),
	&PKTINFO(a15_sleep_out),
	&DLYINFO(a15_wait_110msec),

	&SEQINFO(a16_common_setting_seq),
...
static void *a15_set_bl_param_cmdtbl[] = {
	&PKTINFO(a15_osc_setting_1),
	&PKTINFO(a15_osc_setting_2),
	&PKTINFO(a15_osc_setting_3),
	&PKTINFO(a15_fps_1),
...
static struct seqinfo a16_seqtbl[] = {
	SEQINFO_INIT(PANEL_INIT_SEQ, a16_init_cmdtbl),
	SEQINFO_INIT(PANEL_RES_INIT_SEQ, a15_res_init_cmdtbl),
	SEQINFO_INIT(PANEL_SET_BL_SEQ, a15_set_bl_cmdtbl),
	SEQINFO_INIT(PANEL_DISPLAY_ON_SEQ, a15_display_on_cmdtbl),
	SEQINFO_INIT(PANEL_DISPLAY_OFF_SEQ, a15_display_off_cmdtbl),
...
struct common_panel_info s6e8fc3_a16_panel_info = {
	.ldi_name = "s6e8fc3",
	.name = "s6e8fc3_a15x",
	.model = "AMS638YQ01",
	.vendor = "SDC",
	...
	.nr_maptbl = ARRAY_SIZE(a15_maptbl),
	.seqtbl = a16_seqtbl,
	.nr_seqtbl = ARRAY_SIZE(a16_seqtbl),
	.rditbl = s6e8fc3_rditbl,
	.nr_rditbl = ARRAY_SIZE(s6e8fc3_rditbl),
	.restbl = s6e8fc3_restbl,
	.nr_restbl = ARRAY_SIZE(s6e8fc3_restbl),
