/*
 * linux/drivers/video/fbdev/exynos/panel/s6e8fc3/s6e8fc3_a15x_panel_dimming.h
 *
...
#ifndef __S6E8FC3_A15X_PANEL_DIMMING_H___
#define __S6E8FC3_A15X_PANEL_DIMMING_H___
#include "../dimming.h"
 ...
 * PANEL : PRE
 */
#define S6E8FC3_NR_STEP (S6E8FC3_A15X_NR_LUMINANCE)
#define S6E8FC3_HBM_STEP (S6E8FC3_A15X_NR_HBM_LUMINANCE)
#define S6E8FC3_TOTAL_STEP (S6E8FC3_NR_STEP + S6E8FC3_HBM_STEP)

static unsigned int a15x_brt_tbl[S6E8FC3_TOTAL_STEP] = {
	...
	BRT(476), BRT(477), BRT(478), BRT(479), BRT(480), BRT(481), BRT(482), BRT(483),
};

static unsigned int a15x_lum_tbl[S6E8FC3_A15X_TOTAL_NR_LUMINANCE] = {
	/* normal 1 + 10x25 + 5 = 256 */
	2,
	2, 3, 3, 4, 5, 5, 6, 7, 7, 8,
	...
	67, 68, 70, 71, 73, 74, 76, 77, 78, 80,
	81, 83, 84, 86, 87, 89, 90, 92, 93, 95,
	96, 98, 99, 101, 102, 104, 105, 107, 108, 110,
	112, 113, 115, 116, 118, 119, 121, 123, 124, 126,
	127, 129, 131, 132, 134, 136, 137, 139, 140, 142,
	144, 145, 147, 149, 150, 152, 154, 156, 157, 159,
	161, 162, 164, 166, 167, 169, 171, 173, 174, 176,
	178, 180, 181, 183, 185, 187, 188, 190, 192, 194,
	195, 197, 199, 201, 203, 204, 206, 208, 210, 212,
	214, 215, 217, 219, 221, 223, 225, 226, 228, 230,
	232, 234, 236, 237, 239, 241, 243, 245, 247, 249,
	251, 253, 254, 256, 258, 260, 262, 264, 266, 268,
	270, 272, 274, 275, 277, 279, 281, 283, 285, 287,
	...
	411, 414, 416, 418, 420,
	/* hbm 5 + 10x22 + 8 = 228 */
	426, 428, 430, 432, 433, 435, 436, 438, 440, 441,
	443, 445, 446, 448, 450, 451, 453, 455, 456, 458,
	460, 461, 463, 464, 466, 468, 469, 471, 473, 474,
	476, 478, 479, 481, 483, 484, 486, 488, 489, 491,
	492, 494, 496, 497, 499, 501, 502, 504, 506, 507,
	509, 511, 512, 514, 516, 517, 519, 520, 522, 524,
	525, 527, 529, 530, 532, 534, 535, 537, 539, 540,
	542, 544, 545, 547, 548, 550, 552, 553, 555, 557,
	558, 560, 562, 563, 565, 567, 568, 570, 572, 573,
	575, 576, 578, 580, 581, 583, 585, 586, 588, 590,
	591, 593, 595, 596, 598, 600, 601, 603, 604, 606,
	608, 609, 611, 613, 614, 616, 618, 619, 621, 623,
	624, 626, 628, 629, 631, 632, 634, 636, 637, 639,
	641, 642, 644, 646, 647, 649, 651, 652, 654, 656,
	657, 659, 660, 662, 664, 665, 667, 669, 670, 672,
	674, 675, 677, 679, 680, 682, 684, 685, 687, 688,
	690, 692, 693, 695, 697, 698, 700, 702, 703, 705,
	707, 708, 710, 712, 713, 715, 716, 718, 720, 721,
	723, 725, 726, 728, 730, 731, 733, 735, 736, 738,
	740, 741, 743, 744, 746, 748, 749, 751, 753, 754,
	756, 758, 759, 761, 763, 764, 766, 768, 769, 771,
	772, 774, 776, 777, 779, 781, 782, 784, 786, 787,
	789, 791, 792, 794, 796, 797, 799, 800,
};

static unsigned int a15x_step_cnt_tbl[S6E8FC3_TOTAL_STEP] = {
	[0 ... S6E8FC3_TOTAL_STEP - 1] = 1,
};

static struct brightness_table s6e8fc3_a15x_panel_brightness_table = {
	.control_type = BRIGHTNESS_CONTROL_TYPE_GAMMA_MODE2,
	.brt = a15x_brt_tbl,
	.sz_brt = ARRAY_SIZE(a15x_brt_tbl),
	.sz_ui_brt = S6E8FC3_NR_STEP,
	.sz_hbm_brt = S6E8FC3_HBM_STEP,
	.lum = a15x_lum_tbl,
	.sz_lum = S6E8FC3_A15X_TOTAL_NR_LUMINANCE,
	.sz_ui_lum = S6E8FC3_A15X_NR_LUMINANCE,
	.sz_hbm_lum = S6E8FC3_A15X_NR_HBM_LUMINANCE,
	.sz_ext_hbm_lum = 0,
	.brt_to_step = NULL,
	.sz_brt_to_step = 0,
	.step_cnt = a15x_step_cnt_tbl,
	.sz_step_cnt = ARRAY_SIZE(a15x_step_cnt_tbl),
	.vtotal = 0,
};

static struct panel_dimming_info s6e8fc3_a15x_panel_dimming_info = {
	.name = "s6e8fc3_a15x",
	.dim_init_info = {
		NULL,
	},
	...
	.brt_tbl = &s6e8fc3_a15x_panel_brightness_table,
	/* dimming parameters */
	.dimming_maptbl = NULL,
	.dim_flash_on = false,
	.hbm_aor = NULL,
};
#endif /* __S6E8FC3_PANEL_DIMMING_H___ */
