						...
						char *test_desc)
{
	...
	ASSERT_EQ(0,
		  mem_alloc_simple_test(mem_type, NULL, reg_final_state,
					un_order_size_cfg),
		  test_desc);
	return UT_STATE_PASS;
}
					      ...
					      char *test_desc)
{
	...
	ASSERT_EQ(0,
		  mem_alloc_page_test(mem_type, NULL, reg_final_state,
				      un_order_size_cfg),
		  test_desc);
	return UT_STATE_PASS;
}
...
tmem_regmgr_region_defer_off_test(struct ut_params *params, char *test_desc)
{
	...
	ASSERT_EQ(0,
		  mem_regmgr_region_defer_off_test(mem_type, NULL,
						   reg_final_state),
		  test_desc);
	return UT_STATE_PASS;
}
...
tmem_regmgr_region_online_count_test(struct ut_params *params, char *test_desc)
{
	...
	ASSERT_EQ(0,
		  mem_regmgr_region_online_count_test(mem_type, NULL,
						      reg_final_state),
		  test_desc);
	return UT_STATE_PASS;
}
...
tmem_region_on_off_stress_test(struct ut_params *params, char *test_desc)
{
	...
	ASSERT_EQ(
		0,
		mem_region_on_off_stress_test(mem_type, reg_final_state, round),
		test_desc);
	return UT_STATE_PASS;
}
...
static struct test_case test_cases[] = {
	...
	CASE(SECMEM_UT_PROC_REGION_SIMPLE_ALLOC,
	     "SVP-region-based Alloc Simple", TRUSTED_MEM_SVP_REGION,
	...
	CASE(SECMEM_UT_PROC_ALIGNMENT, "SVP Alloc Alignment",
	     TRUSTED_MEM_SVP_REGION, REGMGR_REGION_FINAL_STATE_OFF, 0,
	     tmem_alloc_alignment_test),
	CASE(SECMEM_UT_PROC_SATURATION, "SVP Saturation",
	     TRUSTED_MEM_SVP_REGION, REGMGR_REGION_FINAL_STATE_OFF, 1,
	...
	CASE(PMEM_UT_PROC_BASIC, "PROT Basic", TRUSTED_MEM_PROT_REGION,
	     REGMGR_REGION_FINAL_STATE_OFF, 0, tmem_basic_test),
	CASE(PMEM_UT_PROC_SIMPLE_ALLOC, "PROT Alloc Simple",
	...
	CASE(PMEM_UT_PROC_UNORDERED_SIZE, "PROT Alloc Un-ordered Size",
	     TRUSTED_MEM_PROT_REGION, REGMGR_REGION_FINAL_STATE_OFF,
	     MEM_UNORDER_SIZE_TEST_CFG_ENABLE, tmem_alloc_simple_test),
	CASE(PMEM_UT_PROC_ALIGNMENT, "PROT Alloc Alignment",
	     TRUSTED_MEM_PROT_REGION, REGMGR_REGION_FINAL_STATE_OFF, 0,
	     tmem_alloc_alignment_test),
	CASE(PMEM_UT_PROC_SATURATION, "PROT Saturation",
	     TRUSTED_MEM_PROT_REGION, REGMGR_REGION_FINAL_STATE_OFF, 1,
	     tmem_alloc_saturation_test),
	...
	CASE(WFD_SMEM_UT_PROC_BASIC, "WFD Basic", TRUSTED_MEM_WFD_REGION,
	     REGMGR_REGION_FINAL_STATE_OFF, 0, tmem_basic_test),
	CASE(WFD_SMEM_UT_PROC_SIMPLE_ALLOC, "WFD Alloc Simple",
	     TRUSTED_MEM_WFD_REGION, REGMGR_REGION_FINAL_STATE_OFF,
	     MEM_UNORDER_SIZE_TEST_CFG_DISABLE, tmem_alloc_simple_test),
	CASE(WFD_SMEM_UT_PROC_UNORDERED_SIZE, "WFD Alloc Un-ordered Size",
	     TRUSTED_MEM_WFD_REGION, REGMGR_REGION_FINAL_STATE_OFF,
	     MEM_UNORDER_SIZE_TEST_CFG_ENABLE, tmem_alloc_simple_test),
	CASE(WFD_SMEM_UT_PROC_ALIGNMENT, "WFD Alloc Alignment",
	     TRUSTED_MEM_WFD_REGION, REGMGR_REGION_FINAL_STATE_OFF, 0,
	     tmem_alloc_alignment_test),
	CASE(WFD_SMEM_UT_PROC_SATURATION, "WFD Saturation",
	     TRUSTED_MEM_WFD_REGION, REGMGR_REGION_FINAL_STATE_OFF, 1,
	     tmem_alloc_saturation_test),
	...
	CASE(AP_TUI_UT_PROC_BASIC, "TUI Basic", TRUSTED_MEM_TUI_REGION,
	     REGMGR_REGION_FINAL_STATE_OFF, 0, tmem_basic_test),
	...
	CASE(AP_SAPU_DATA_SHM_UT_PROC_BASIC, "SAPU_DATA_SHM Basic",
	     ...
	     tmem_basic_test),
	CASE(AP_SAPU_DATA_SHM_UT_PROC_SIMPLE_ALLOC,
	     "SAPU_DATA_SHM Alloc Simple", TRUSTED_MEM_SAPU_DATA_SHM,
	     REGMGR_REGION_FINAL_STATE_OFF, MEM_UNORDER_SIZE_TEST_CFG_DISABLE,
	     tmem_alloc_simple_test),
	...
	CASE(AP_SAPU_ENGINE_SHM_UT_PROC_BASIC, "SAPU_ENGINE_SHM Basic",
	     ...
	     tmem_basic_test),
	CASE(AP_SAPU_ENGINE_SHM_UT_PROC_SIMPLE_ALLOC,
	     "SAPU_ENGINE_SHM Alloc Simple", TRUSTED_MEM_SAPU_ENGINE_SHM,
	     REGMGR_REGION_FINAL_STATE_OFF, MEM_UNORDER_SIZE_TEST_CFG_DISABLE,
	     tmem_alloc_simple_test),
