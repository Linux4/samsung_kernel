...
extern int PD9402AF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
				spinlock_t *pAF_SpinLock, int *pAF_Opened);
extern long PD9402AF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
				unsigned long a_u4Param);
extern int PD9402AF_Release(struct inode *a_pstInode, struct file *a_pstFile);
extern int PD9402AF_PowerDown(struct i2c_client *pstAF_I2Cclient,
				int *pAF_Opened);
extern int PD9402AF_GetFileName(unsigned char *pFileName);
