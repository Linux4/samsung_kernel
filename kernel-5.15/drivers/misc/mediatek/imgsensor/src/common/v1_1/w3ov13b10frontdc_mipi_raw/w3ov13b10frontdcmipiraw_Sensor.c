 ...
 * Filename:
 * ---------
 *     W3OV13B10FRONTDC2Qmipi_Sensor.c
 *
 * Project:
 * --------
 *	 ALPS
 ...
 * Setting version:
 * ------------
 *   update full pd setting for W3OV13B10FRONTDC2QEB_03B
 *------------------------------------------------------------------------------
 * Upper this line, this part is controlled by CC/CQ. DO NOT MODIFY!!
 *============================================================================
 ****************************************************************************/

#define PFX "W3OV13B10FRONTDC_camera_sensor"
...
#include "w3ov13b10frontdcmipiraw_Sensor.h"
#include "w3ov13b10frontdc_Sensor_setting.h"
...
static struct stCAM_CAL_DATAINFO_STRUCT w3ov13b10frontdc_eeprom_data ={
	.sensorID= W3OV13B10FRONTDC_SENSOR_ID,
	.deviceID = 0x02,
	.dataLength = 0x0778,
...
static struct stCAM_CAL_CHECKSUM_STRUCT w3ov13b10frontdc_Checksum[5] =
{
...
static kal_uint16 w3ov13b10frontdc_read_eeprom(kal_uint32 addr)
{
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = W3OV13B10FRONTDC_SENSOR_ID,
	...
	.max_frame_length = 0x7ff7,	/* max framelength by sensor register's limitation */
	...
	.isp_driving_current = ISP_DRIVING_4MA,   //4MA
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[5] = {
	...
	{ 4208, 3120, 0,   0, 4208, 3120, 4208, 3120,  0,   0,	 4208, 3120, 0,   0,   4208, 3120},
	/* video */
	{ 4208, 3120, 0,   0, 4208, 3120, 4208, 3120,  0, 376,	 4208, 2368, 0,   0,   4208, 2368},
	/* hs video */
	{ 4208, 3120, 0,   0, 4208, 3120, 4208, 3120,  0,   0,	 4208, 3120, 0,   0,   4208, 3120},
	/* slim video */
	{ 4208, 3120, 0,   0, 4208, 3120, 4208, 3120,  0,   0,	 4208, 3120, 0,   0,   4208, 3120}
...
static void preview_setting(void)
{
	...
	_length = sizeof(addr_data_pair_preview_ov13b10) / sizeof(kal_uint16);
	ov13b10_table_write_cmos_sensor(
...
static void capture_setting(kal_uint16 currefps)
{
	...
	_length = sizeof(addr_data_pair_capture_ov13b10) / sizeof(kal_uint16);
	ov13b10_table_write_cmos_sensor(
			addr_data_pair_capture_ov13b10,
			_length);
}
...
static void normal_video_setting(kal_uint16 currefps)
{
	...
	_length = sizeof(addr_data_pair_video_ov13b10) / sizeof(kal_uint16);
	ov13b10_table_write_cmos_sensor(
...
static void hs_video_setting(void)
{
	...
	_length = sizeof(addr_data_pair_hs_video_ov13b10) / sizeof(kal_uint16);
	ov13b10_table_write_cmos_sensor(
...
static void slim_video_setting(void)
{
	...
	_length = sizeof(addr_data_pair_slim_video_ov13b10) / sizeof(kal_uint16);
	ov13b10_table_write_cmos_sensor(
...
#if OTP_PORTING
				imgSensorReadEepromData(&w3ov13b10frontdc_eeprom_data,w3ov13b10frontdc_Checksum);
				if((w3ov13b10frontdc_eeprom_data.sensorVendorid >> 24) != w3ov13b10frontdc_read_eeprom(0x0001)) {
					if(w3ov13b10frontdc_eeprom_data.dataBuffer != NULL) {
						kfree(w3ov13b10frontdc_eeprom_data.dataBuffer);
						w3ov13b10frontdc_eeprom_data.dataBuffer = NULL;
					}
					pr_info("w3ov13b10frontdc get eeprom data failed\n");
					*sensor_id = 0xFFFFFFFF;
					return ERROR_SENSOR_CONNECT_FAIL;
				} else {
					pr_info("w3ov13b10frontdc get eeprom data success\n");
				}
#endif
			...
			UINT8 *feature_para, UINT32 *feature_para_len)
{
    ...
    case SENSOR_FEATURE_GET_OFFSET_TO_START_OF_EXPOSURE:
        *(MUINT32 *)(uintptr_t)(*(feature_data + 1)) = 1831400;
        break;
...
UINT32 W3OV13B10FRONTDC_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
