...
#if defined(W3S5KJN1REARTXD_MIPI_RAW)
	{
		SENSOR_DRVNAME_W3S5KJN1REARTXD_MIPI_RAW,
		{
			{RST, Vol_Low, 0},
			{AVDD1, Vol_1200, 0},
			{DOVDD, Vol_1800, 0},
...
#if defined(W3HI5022QREARJK_MIPI_RAW)
	{
		SENSOR_DRVNAME_W3HI5022QREARJK_MIPI_RAW,
		{
			{RST, Vol_Low, 0},
			{AVDD1, Vol_1200, 0},
			{DOVDD, Vol_1800, 1},
...
#if defined(W3GC50E0REARTXD_MIPI_RAW)
	{
		SENSOR_DRVNAME_W3GC50E0REARTXD_MIPI_RAW,
		{
			{DOVDD, Vol_1800, 1},
			{DVDD, Vol_1100, 1},
			{AVDD, Vol_2800, 2},
...
#if defined(W3OV13B10FRONTDC_MIPI_RAW)
	{
		SENSOR_DRVNAME_W3OV13B10FRONTDC_MIPI_RAW,
		{
			{RST, Vol_Low, 1},
			{AVDD1, Vol_1200, 0},
			{DOVDD, Vol_1800, 0},
...
#if defined(W3SC1300CSFRONTTXD_MIPI_RAW)
	{
		SENSOR_DRVNAME_W3SC1300CSFRONTTXD_MIPI_RAW,
		{
			{RST, Vol_Low, 0},
			{DOVDD, Vol_1800, 1},
			//{DVDD_1V2,Vol_Low,0},
...
#if defined(W3GC13A0FRONTLH_MIPI_RAW)
	{
		SENSOR_DRVNAME_W3GC13A0FRONTLH_MIPI_RAW,
		{
			{RST, Vol_Low, 0},
			{AVDD1, Vol_1200, 0},
			{DOVDD, Vol_1800, 1},
...
#if defined(W3SC1321CSFRONTLCE_MIPI_RAW)
	{
		SENSOR_DRVNAME_W3SC1321CSFRONTLCE_MIPI_RAW,
		{
			{DOVDD, Vol_1800, 1},
			{DVDD, Vol_1200, 1},
			{AVDD, Vol_2800, 2},
...
#if defined(W3GC5035WIDESJ_MIPI_RAW)
	{
		SENSOR_DRVNAME_W3GC5035WIDESJ_MIPI_RAW,
		{
			{AVDD1, Vol_1200, 0},
			{DOVDD, Vol_1800, 1},
  			{DVDD, Vol_1200, 1},
...
#if defined(W3SC520CSWIDELCE_MIPI_RAW)
	{
		SENSOR_DRVNAME_W3SC520CSWIDELCE_MIPI_RAW,
		{
			{RST, Vol_Low, 5},
			{AVDD1, Vol_1200, 0},
			{DOVDD, Vol_1800, 1},
...
#if defined(W3SC201ACSMICROCXT_MIPI_RAW)
	{
		SENSOR_DRVNAME_W3SC201ACSMICROCXT_MIPI_RAW,
		{
			{RST, Vol_Low, 0},
			{AVDD1, Vol_1200, 0},
			{DVDD, Vol_1200, 0},
...
#if defined(W3GC02M3MICROLH_MIPI_RAW)
	{
		SENSOR_DRVNAME_W3GC02M3MICROLH_MIPI_RAW,
		{
			{RST, Vol_Low, 0},
			{AVDD1, Vol_1200, 0},
			{DVDD, Vol_1200, 0},
...
#endif
#if defined(W3C2599MICROSJ_MIPI_RAW)
	{
		SENSOR_DRVNAME_W3C2599MICROSJ_MIPI_RAW,
		{
			{RST, Vol_Low, 0},
			{AVDD1, Vol_1200, 0},
			{DVDD, Vol_1200, 0},
