...
{W3OV13B10FRONTDC_SENSOR_ID,	SENSOR_DRVNAME_W3OV13B10FRONTDC_MIPI_RAW,
	W3OV13B10FRONTDC_MIPI_RAW_SensorInit},
#endif

#if defined(W3S5KJN1REARTXD_MIPI_RAW)
{W3S5KJN1REARTXD_SENSOR_ID,	SENSOR_DRVNAME_W3S5KJN1REARTXD_MIPI_RAW,
	W3S5KJN1REARTXD_MIPI_RAW_SensorInit},
#endif

#if defined(W3HI5022QREARJK_MIPI_RAW)
{W3HI5022QREARJK_SENSOR_ID,	SENSOR_DRVNAME_W3HI5022QREARJK_MIPI_RAW,
	W3HI5022QREARJK_MIPI_RAW_SensorInit},
#endif

#if defined(W3GC50E0REARTXD_MIPI_RAW)
{W3GC50E0REARTXD_SENSOR_ID,	SENSOR_DRVNAME_W3GC50E0REARTXD_MIPI_RAW,
	W3GC50E0REARTXD_MIPI_RAW_SensorInit},
#endif

#if defined(W3GC13A0FRONTLH_MIPI_RAW)
{W3GC13A0FRONTLH_SENSOR_ID, SENSOR_DRVNAME_W3GC13A0FRONTLH_MIPI_RAW,
	W3GC13A0FRONTLH_MIPI_RAW_SensorInit},
#endif

#if defined(W3SC1300CSFRONTTXD_MIPI_RAW)
{W3SC1300CSFRONTTXD_SENSOR_ID, SENSOR_DRVNAME_W3SC1300CSFRONTTXD_MIPI_RAW,
	W3SC1300CSFRONTTXD_MIPI_RAW_SensorInit},
#endif

#if defined(W3SC1321CSFRONTLCE_MIPI_RAW)
{W3SC1321CSFRONTLCE_SENSOR_ID, SENSOR_DRVNAME_W3SC1321CSFRONTLCE_MIPI_RAW,
	W3SC1321CSFRONTLCE_MIPI_RAW_SensorInit},
#endif

#if defined(W3GC5035WIDESJ_MIPI_RAW)
{W3GC5035WIDESJ_SENSOR_ID, SENSOR_DRVNAME_W3GC5035WIDESJ_MIPI_RAW,
	W3GC5035WIDESJ_MIPI_RAW_SensorInit},
#endif

#if defined(W3SC520CSWIDELCE_MIPI_RAW)
{W3SC520CSWIDELCE_SENSOR_ID, SENSOR_DRVNAME_W3SC520CSWIDELCE_MIPI_RAW,
	W3SC520CSWIDELCE_MIPI_RAW_SensorInit},
#endif

#if defined(W3SC201ACSMICROCXT_MIPI_RAW)
{W3SC201ACSMICROCXT_SENSOR_ID, SENSOR_DRVNAME_W3SC201ACSMICROCXT_MIPI_RAW,
	W3SC201ACSMICROCXT_MIPI_RAW_SensorInit},
#endif

#if defined(W3GC02M3MICROLH_MIPI_RAW)
{W3GC02M3MICROLH_SENSOR_ID, SENSOR_DRVNAME_W3GC02M3MICROLH_MIPI_RAW,
	W3GC02M3MICROLH_MIPI_RAW_SensorInit},
#endif

#if defined(W3C2599MICROSJ_MIPI_RAW)
{W3C2599MICROSJ_SENSOR_ID, SENSOR_DRVNAME_W3C2599MICROSJ_MIPI_RAW,
	W3C2599MICROSJ_MIPI_RAW_SensorInit},
#endif
//-S98901AA1-4013,lijiazhen2.wt,ADD,2024/04/17,W3 rear/front/wide/macro camera bringup
