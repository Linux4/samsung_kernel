...
#include "w3sc201acsmicrocxtmipiraw_Sensor.h"
...
static struct imgsensor_info_struct imgsensor_info = {
    .sensor_id = W3SC201ACSMICROCXT_SENSOR_ID,
...
static struct stCAM_CAL_DATAINFO_STRUCT w3sc202csmicrolh_eeprom_data ={
	.sensorID= W3SC201ACSMICROCXT_SENSOR_ID,
	.deviceID = 0x08,
	.dataLength = 0x0778,
...
static struct stCAM_CAL_CHECKSUM_STRUCT w3sc202csmicrolh_checksum[6] =
{
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
        ...
        do {
            *sensor_id = return_sensor_id();
            ...
            if (*sensor_id == imgsensor_info.sensor_id) {
				//+w3 camera bring up --otp porting
				imgSensorReadEepromData(&w3sc202csmicrolh_eeprom_data,w3sc202csmicrolh_checksum);
				if((w3sc202csmicrolh_eeprom_data.sensorVendorid >> 24)!= read_eeprom(0x0001)) {
					pr_err("cwd w3sc202csmicrolh get eeprom data failed\n");
					if(w3sc202csmicrolh_eeprom_data.dataBuffer != NULL) {
						kfree(w3sc202csmicrolh_eeprom_data.dataBuffer);
						w3sc202csmicrolh_eeprom_data.dataBuffer = NULL;
					}
					//*sensor_id = 0xFFFFFFFF;
					//return ERROR_SENSOR_CONNECT_FAIL;
				} else {
					LOG_INF("cwd w3sc202csmicrolh get eeprom data success\n");  
				}
				//-w3 camera bring up --otp porting
    ...
    if (*sensor_id != imgsensor_info.sensor_id) {
        ...
        pr_err("w3sc202csmicrolh Read id fail,sensor id: 0x%x\n", *sensor_id);
        *sensor_id = 0xFFFFFFFF;
        return ERROR_SENSOR_CONNECT_FAIL;
    }
    return ERROR_NONE;
...
UINT32 W3SC201ACSMICROCXT_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT  **pfFunc)
{
