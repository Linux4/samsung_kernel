...
#include "w3s5kjn1reartxd_mipiraw_Sensor.h"
//#include "imgsensor_common.h"

#define VENDOR_EDIT 1

/***************Modify Following Strings for Debug**********************/
#define PFX "w3s5kjn1reartxd_camera_sensor"
#define LOG_1 LOG_INF("w3s5kjn1reartxd,MIPI 4LANE\n")
/****************************   Modify end    **************************/
#define LOG_INF(format, args...) pr_err(PFX "[%s] " format, __func__, ##args)
#define LOG_ERR(format, args...) pr_err(PFX "[%s] " format, __func__, ##args)

#define DEVICE_VERSION_S5KJN103     "w3s5kjn1reartxd"
...
#define W3_TXD_S5KJN1_OTP 1
#define USE_BURST_MODE 1
#define JN1_HW_GGC_SIZE 173
#define JN1_HW_GGC_START_ADDR 0x3027

#define TXD_S5KJN1_OTP_XTC_OFFSET   0x0D5E
#define TXD_S5KJN1_OTP_SENSORXTC_OFFSET   0x1B0E
#define TXD_S5KJN1_OTP_PDXTC_OFFSET   0x1E10
#define TXD_S5KJN1_OTP_SWGCC_OFFSET   0x2DB2
...
#define EEPROM_GT9778_ID 0xA0   //EEPROM slave id
...
static struct imgsensor_info_struct imgsensor_info = {
    .sensor_id = W3S5KJN1REARTXD_SENSOR_ID,
    .module_id = 0x19,
...
static kal_int32 write_Module_data(ACDK_SENSOR_ENGMODE_STEREO_STRUCT * pStereodata)
{
    ...
    if(pStereodata != NULL) {
        ...
        if ((pStereodata->uSensorId == W3_S5KJN1_REAR_TXD_SENSOR_ID) && (data_length == DUALCAM_CALI_DATA_LENGTH)
                     ...
                     kal_bool auto_extend_en)
{
    ...
    LOG_INF("Exit! shutter =%d, framelength =%d/%d, dummy_line=%d, auto_extend=%d fps:%d\n",
	shutter, imgsensor.frame_length, frame_length, dummy_line, read_cmos_sensor(0x0350),realtime_fps);
}    /* set_shutter_frame_length */
...
static kal_uint16 set_gain(kal_uint16 gain)
{
    ...
    write_cmos_sensor_8(0x0104, 0x0001);
    write_cmos_sensor_8(0x0204, (reg_gain >> 8));
    write_cmos_sensor_8(0x0104, 0x0000);
...
static void w3s5kjn1reartxd03_set_lsc_reg_setting(
...
static kal_uint32 streaming_control(kal_bool enable)
{
    ...
    int i = 0;
    int framecnt = 0;
    LOG_INF("streaming_enable: %d cur_fps:%d\n", enable, imgsensor.current_fps);
    if (enable) {
...
static kal_uint16 w3s5kjn1reartxd03_init_setting[] = {
	0x6226, 0x0001,
	0x6028, 0x2400,
	0x602A, 0x801C,
	0x6F12, 0x1743,
...
static kal_uint16 w3s5kjn1reartxd03_capture_setting[] = {
	0xFCFC, 0x2400,
	0x0710, 0x0002,
	0x0712, 0x0804,
	0x0714, 0x0100,
...
static kal_uint16 w3s5kjn1reartxd03_preview_setting[] = {
	0xFCFC, 0x2400,
	0x0710, 0x0002,
	0x0712, 0x0804,
	0x0714, 0x0100,
...
static kal_uint16 w3s5kjn1reartxd03_normal_video_setting[] = {
	0xFCFC,	0x2400,
	0x1A28,	0x4c00,
	0x065a,	0x0000,
	0x1B26,	0x6F80,
...
static kal_uint16 w3s5kjn1reartxd03_hs_video_setting[] = {
	0xFCFC, 0x2400,
	0x0710, 0x0004,
	0x0712, 0x0401,
	0x0714, 0x0100,
...
static kal_uint16 w3s5kjn1reartxd03_slim_video_setting[] = {
	0x6028, 0x2400,
	0x602A, 0x1A28,
	0x6F12, 0x4C00,
	0x602A, 0x065A,
...
static kal_uint16 w3s5kjn1reartxd03_custom1_setting[] = {
	0xFCFC, 0x2400,
	0x0710, 0x0002,
	0x0712, 0x0804,
	0x0714, 0x0100,
...
static kal_uint16 w3s5kjn1reartxd03_custom2_setting[] = {
	0xFCFC, 0x2400,
	0x0710, 0x0010,
	0x0712, 0x0201,
	0x0714, 0x0800,
...
static kal_uint16 w3s5kjn1reartxd03_custom3_setting[] = {
	0x6028, 0x2400,
	0x602A, 0x1A28,
	0x6F12, 0x4C00,
	0x602A, 0x065A,
...
static void sensor_init(void)
{
	...
	mdelay(5);
	table_write_cmos_sensor(w3s5kjn1reartxd03_init_setting,
        sizeof(w3s5kjn1reartxd03_init_setting) / sizeof(kal_uint16));
...
static void preview_setting(void)
{
    ...
    table_write_cmos_sensor(w3s5kjn1reartxd03_preview_setting,
        sizeof(w3s5kjn1reartxd03_preview_setting)/sizeof(kal_uint16));
...
static void capture_setting(kal_uint16 currefps)
{
    ...
    table_write_cmos_sensor(w3s5kjn1reartxd03_capture_setting,
        sizeof(w3s5kjn1reartxd03_capture_setting)/sizeof(kal_uint16));
...
static void normal_video_setting(kal_uint16 currefps)
{
    ...
    table_write_cmos_sensor(w3s5kjn1reartxd03_normal_video_setting,
        sizeof(w3s5kjn1reartxd03_normal_video_setting)/sizeof(kal_uint16));
    LOG_INF("X\n");
}
...
static void hs_video_setting(void)
{
    ...
    table_write_cmos_sensor(w3s5kjn1reartxd03_hs_video_setting,
        sizeof(w3s5kjn1reartxd03_hs_video_setting)/sizeof(kal_uint16));
    LOG_INF("X\n");
}
...
static void slim_video_setting(void)
{
    ...
    table_write_cmos_sensor(w3s5kjn1reartxd03_slim_video_setting,
        sizeof(w3s5kjn1reartxd03_slim_video_setting)/sizeof(kal_uint16));
    LOG_INF("X\n");
}
...
static void custom1_setting(void)
{
    ...
    /*************MIPI output setting************/
    table_write_cmos_sensor(w3s5kjn1reartxd03_custom1_setting,
        sizeof(w3s5kjn1reartxd03_custom1_setting)/sizeof(kal_uint16));
    LOG_INF("X");
}
...
static void custom2_setting(void)
{
    ...
    /*************MIPI output setting************/
    table_write_cmos_sensor(w3s5kjn1reartxd03_custom2_setting,
        sizeof(w3s5kjn1reartxd03_custom2_setting)/sizeof(kal_uint16));
    LOG_INF("X");
}
...
static void custom3_setting(void)
{
    ...
    /*************MIPI output setting************/
    table_write_cmos_sensor(w3s5kjn1reartxd03_custom3_setting,
        sizeof(w3s5kjn1reartxd03_custom3_setting)/sizeof(kal_uint16));
    LOG_INF("X");
}

static struct stCAM_CAL_DATAINFO_STRUCT w3s5kjn1reartxd_eeprom_data ={
    .sensorID= W3S5KJN1REARTXD_SENSOR_ID,
    .deviceID = 0x01,
    .dataLength = 0x3183,
...
static struct stCAM_CAL_CHECKSUM_STRUCT w3s5kjn1reartxd_Checksum[14] =
{
...
extern void imgSensorReadEepromData(struct stCAM_CAL_DATAINFO_STRUCT* pData, struct stCAM_CAL_CHECKSUM_STRUCT* checkData);
...
static void read_alldata_from_eeprom()
{
	...
	if (is_read_four_cell != 1) {
		...
		for (i = 0; i < ALL_OTP_SIZE; i++)
			all_otp_data[i] = read_cmos_eeprom_8(i);
		is_read_four_cell = 1;
	}
}
        ...
        do {
            *sensor_id = ((read_cmos_sensor_8(0x0000) << 8)
            ...
            if (*sensor_id == imgsensor_info.sensor_id) {
                ...
                imgSensorReadEepromData(&w3s5kjn1reartxd_eeprom_data,w3s5kjn1reartxd_Checksum);
                read_alldata_from_eeprom();
                if((w3s5kjn1reartxd_eeprom_data.sensorVendorid >> 24) != read_eeprom(0x0001)){
                    if(w3s5kjn1reartxd_eeprom_data.dataBuffer != NULL) {
                       kfree(w3s5kjn1reartxd_eeprom_data.dataBuffer);
                       w3s5kjn1reartxd_eeprom_data.dataBuffer = NULL;
                    }
                } else {
                    #if W3_TXD_S5KJN1_OTP
                    read_eepromData_HW_GGC();
                    memcpy(XTCBuffer, (kal_uint8*)&all_otp_data[TXD_S5KJN1_OTP_XTC_OFFSET+1], S5KJN1_OTP_XTC_LEN);
                    memcpy(SENSORXTCBuffer, (kal_uint8*)&all_otp_data[TXD_S5KJN1_OTP_SENSORXTC_OFFSET+1], S5KJN1_OTP_SENSORXTC_LEN);
                    memcpy(PDXTCXTCBuffer, (kal_uint8*)&all_otp_data[TXD_S5KJN1_OTP_PDXTC_OFFSET+1], S5KJN1_OTP_PDXTC_LEN);
                    memcpy(SWGCCBuffer, (kal_uint8*)&all_otp_data[TXD_S5KJN1_OTP_SWGCC_OFFSET+1], S5KJN1_OTP_SWGCC_LEN);
                    #endif
                }
                 ...
                 UINT8 *feature_para, UINT32 *feature_para_len)
{
    ...
    case SENSOR_FEATURE_GET_OFFSET_TO_START_OF_EXPOSURE:
        *(MUINT32 *)(uintptr_t)(*(feature_data + 1)) = 1556200;
        break;
    //-bug767771, liangyiyi.wt, ADD, 2022/8/31, modify for fixed sensor_fusion of its test fail
    ...
    case SENSOR_FEATURE_GET_4CELL_DATA:/*get 4 cell data from eeprom*/
        {
            ...
            LOG_INF("sw-remosaic read Cross type:%d,datasize:%d",type,size);
    ...
    case SENSOR_FEATURE_SET_LSC_TBL:
    {
        ...
        w3s5kjn1reartxd03_set_lsc_reg_setting(index, feature_data_16,
...
UINT32 W3S5KJN1REARTXD_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
