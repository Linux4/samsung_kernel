 ...
 * Filename:
 * ---------
 *	 W3SC1300CSFRONTTXDmipi_Sensor.c
 *
 * Project:
 * --------
 *	 ALPS
...
#include "w3sc1300csfronttxd_mipiraw.h"
//#include "w3sc1300csfronttxd_pdaf_cal.h"
#define PFX "W3SC1300CSFRONTTXD_camera_sensor"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = W3SC1300CSFRONTTXD_SENSOR_ID,
	...
	.pre = {
		...
		.mipi_pixel_rate = 547200000, /* unit , ns */
	...
	.slim_video = {
		...
		//+bug783860,liangyiyi.wt,ADD,2022/07/25,modify for fix w3sc1300csfronttxd photo is black pictures
		.min_gain = 64,
		.max_gain = 2048,
		.min_gain_iso = 50,
		.exp_step = 1,
		...
		.isp_driving_current = ISP_DRIVING_4MA,//bug 767771,liangyiyi.wt, MODIFY, 2022.10.31, modify the sc1300mcs mclk drive current to 2MA for solve RF interference
...
{
	LOG_INF("Smartsens_SC1300MCS dummyline = %d, dummypixels = %d \n", imgsensor.dummy_line, imgsensor.dummy_pixel);
...
{
	return ((read_cmos_sensor(0x3107) << 8) | read_cmos_sensor(0x3108)); //0xc628
}
static void set_max_framerate(UINT16 framerate,kal_bool min_framelength_en)
{
	...
	LOG_INF("Smartsens_SC1300MCS framerate = %d, min framelength should enable %d \n", framerate,min_framelength_en);
...
static void write_shutter(kal_uint32 shutter)
{
	...
	LOG_INF("Smartsens_SC1300MCS gsl_debug shutter =%d, framelength =%d,ExpReg 0x3e20=%x, 0x3e00=%x, 0x3e01=%x, 0x3e02=%x\n",
...
static void set_shutter_frame_length(kal_uint16 shutter, kal_uint16 frame_length)
{
	...
	LOG_INF("Smartsens_SC1300MCS shutter = %d, framelength = %d/%d, dummy_line= %d\n", shutter, imgsensor.frame_length,
...
//kal_uint16 iii = 4;
  if (gain < BASEGAIN)
   ...
   // spin_unlock(&imgsensor_drv_lock);
    ...
    LOG_INF("Smartsens_SC1300MCS gsldebug gain = %d ,again = 0x%x, dgain(0x3e07)= 0x%x end\n", gain, read_cmos_sensor(0x3e09),read_cmos_sensor(0x3e07));
...
write_cmos_sensor8(0x36e9,0x27);
write_cmos_sensor8(0x36f9,0x04);
write_cmos_sensor8(0x301f,0xac);
...
write_cmos_sensor8(0x4837,0x17);
...
LOG_INF("Smartsens_SC1300MCS initial setting  0X301f = 0x%x \n", read_cmos_sensor(0x301F));
...
static void preview_setting(void)
{
	...
	write_cmos_sensor8(0x36e9,0x27);
	write_cmos_sensor8(0x36f9,0x04);
	write_cmos_sensor8(0x301f,0xad);
	write_cmos_sensor8(0x3106,0x01);
	...
	LOG_INF("Smartsens_SC1300MCS preview setting  0X301f = 0x%x \n", read_cmos_sensor(0x301F));	
}	/*	preview_setting  */
...
write_cmos_sensor8(0x59ec,0x0c);
write_cmos_sensor8(0x59ed,0x04);
LOG_INF("Smartsens_SC1300MCS normal video setting  0X301f = 0x%x \n", read_cmos_sensor(0x301F));
LOG_INF("end \n");
}
...
write_cmos_sensor8(0x59ec,0x0c);
write_cmos_sensor8(0x59ed,0x04);
LOG_INF("Smartsens_SC1300MCS HS video setting  0X301f = 0x%x \n", read_cmos_sensor(0x301F));
	LOG_INF("end \n");
}
...
write_cmos_sensor8(0x59ec,0x0c);
write_cmos_sensor8(0x59ed,0x04);
LOG_INF("Smartsens_SC1300MCS Slim video setting  0X301f = 0x%x \n", read_cmos_sensor(0x301F));
LOG_INF("end \n");
}
//+songshiyang.wt, ADD, 2022/02/25, add main camera w3sc1300csfronttxd eeprom bring up
//-bug 767771,liangyiyi.wt, MODIFY, 2022.8.15, update the 2st and 3st front camera setting by fae
//-bug 767771,liangyiyi.wt, MODIFY, 2022.10.5,Modify the setting of sc1300 stream on by fae
//-bug 767771,liangyiyi.wt, MODIFY, 2022.10.26, modify sc1300mcs setting for solve RF interference and optimize high-temperature BLC stability by fae
...
#if OTP_PORTING
#define EEPROM_W3SC1300CSFRONTTXD_ID 0xA0

#include "cam_cal_define.h"
#include <linux/slab.h>


static struct stCAM_CAL_DATAINFO_STRUCT w3sc1300csfronttxd_eeprom_data ={
	.sensorID= W3SC1300CSFRONTTXD_SENSOR_ID,
	.deviceID = 0x02,
	.dataLength = 0x0778,
...
static struct stCAM_CAL_CHECKSUM_STRUCT w3sc1300csfronttxd_Checksum[5] =
{
...
static kal_uint16 w3sc1300csfronttxd_read_eeprom(kal_uint32 addr)
{
     kal_uint16 get_byte=0;

     char pu_send_cmd[2] = { (char)(addr >> 8), (char)(addr & 0xFF) };
     iReadRegI2C(pu_send_cmd, 2, (u8*)&get_byte, 1, EEPROM_W3SC1300CSFRONTTXD_ID);
...
//+songshiyang.wt, ADD, 2022/02/25, add main camera w3sc1300csfronttxd eeprom bring up
#if OTP_PORTING
				imgSensorReadEepromData(&w3sc1300csfronttxd_eeprom_data,w3sc1300csfronttxd_Checksum);
				if((w3sc1300csfronttxd_eeprom_data.sensorVendorid >> 24) != w3sc1300csfronttxd_read_eeprom(0x0001)) {
					if(w3sc1300csfronttxd_eeprom_data.dataBuffer != NULL) {
						kfree(w3sc1300csfronttxd_eeprom_data.dataBuffer);
						w3sc1300csfronttxd_eeprom_data.dataBuffer = NULL;
					}
					LOG_INF("w3sc1300csfronttxd get eeprom data failed\n");
					*sensor_id = 0xFFFFFFFF;
					return ERROR_SENSOR_CONNECT_FAIL;
				} else {
					LOG_INF("w3sc1300csfronttxd get eeprom data success\n");
				}
#endif
//-songshiyang.wt, ADD, 2022/02/25, add main camera w3sc1300csfronttxd eeprom bring up
				pr_err("w3sc1300csfronttxd i2c write id : 0x%x, sensor id: 0x%x\n",
	...
	if (*sensor_id != imgsensor_info.sensor_id) {
		pr_err("w3sc1300csfronttxd Read id fail,sensor id: 0x%x\n", *sensor_id);
		*sensor_id = 0xFFFFFFFF;
		return ERROR_SENSOR_CONNECT_FAIL;
	}
	return ERROR_NONE;
							 ...
							 UINT8 *feature_para,UINT32 *feature_para_len)
{
	...
	case SENSOR_FEATURE_GET_PDAF_DATA:
		...
		w3sc1300csfronttxd_read_eeprom((kal_uint16 )(*feature_data),(char*)(uintptr_t)(*(feature_data+1)),(kal_uint32)(*(feature_data+2)));
		break;
#endif
...
UINT32 W3SC1300CSFRONTTXD_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
