...
#include "gc02m2mipiraw_setfile.h"

/****************************Modify Following Strings for Debug***************/
#define PFX "GC02M2 D/D"
/****************************   Modify end    ********************/
...
#define TRANSFER_UNIT (2)
#define MULTI_WRITE 1
#if MULTI_WRITE
#define I2C_BUFFER_LEN (TRANSFER_UNIT * 255) /* trans# max is 255, each (TRANSFER_UNIT) bytes */
#else
...
static kal_uint16 set_gain(kal_uint16 gain)
{
	...
	if ((iReg >= ANALOG_GAIN_1) && (iReg < ANALOG_GAIN_2)) {
		...
		LOG_DBG("GC02M2MIPI analogic gain 1x, GC02M2MIPI add pregain = %d\n", temp);
		...
		write_cmos_sensor(0xb1, (temp >> 8) & 0x3f);
		write_cmos_sensor(0xb2, (temp & 0xff));
		LOG_DBG("GC02M2MIPI analogic gain 1.185x, GC02M2MIPI add pregain = %d\n", temp);
		...
		write_cmos_sensor(0xb1, (temp >> 8) & 0x3f);
		write_cmos_sensor(0xb2, (temp & 0xff));
		LOG_DBG("GC02M2MIPI analogic gain 1.4x, GC02M2MIPI add pregain = %d\n", temp);
		...
		write_cmos_sensor(0xb1, (temp >> 8) & 0x3f);
		write_cmos_sensor(0xb2, (temp & 0xff));
		LOG_DBG("GC02M2MIPI analogic gain 1.659x, GC02M2MIPI add pregain = %d\n", temp);
		...
		write_cmos_sensor(0xb1, (temp >> 8) & 0x3f);
		write_cmos_sensor(0xb2, (temp & 0xff));
		LOG_DBG("GC02M2MIPI analogic gain 2.0x, GC02M2MIPI add pregain = %d\n", temp);
		...
		write_cmos_sensor(0xb1, (temp >> 8) & 0x3f);
		write_cmos_sensor(0xb2, (temp & 0xff));
		LOG_DBG("GC02M2MIPI analogic gain 2.37x, GC02M2MIPI add pregain = %d\n", temp);
		...
		write_cmos_sensor(0xb1, (temp >> 8) & 0x3f);
		write_cmos_sensor(0xb2, (temp & 0xff));
		LOG_DBG("GC02M2MIPI analogic gain 2.8x, GC02M2MIPI add pregain = %d\n", temp);
		...
		write_cmos_sensor(0xb1, (temp >> 8) & 0x3f);
		write_cmos_sensor(0xb2, (temp & 0xff));
		LOG_DBG("GC02M2MIPI analogic gain 3.318x, GC02M2MIPI add pregain = %d\n", temp);
		...
		write_cmos_sensor(0xb1, (temp >> 8) & 0x3f);
		write_cmos_sensor(0xb2, (temp & 0xff));
		LOG_DBG("GC02M2MIPI analogic gain 4.0x, GC02M2MIPI add pregain = %d\n", temp);
		...
		write_cmos_sensor(0xb1, (temp >> 8) & 0x3f);
		write_cmos_sensor(0xb2, (temp & 0xff));
		LOG_DBG("GC02M2MIPI analogic gain 4.74x, GC02M2MIPI add pregain = %d\n", temp);
		...
		write_cmos_sensor(0xb1, (temp >> 8) & 0x3f);
		write_cmos_sensor(0xb2, (temp & 0xff));
		LOG_DBG("GC02M2MIPI analogic gain 5.6x, GC02M2MIPI add pregain = %d\n", temp);
		...
		write_cmos_sensor(0xb1, (temp >> 8) & 0x3f);
		write_cmos_sensor(0xb2, (temp & 0xff));
		LOG_DBG("GC02M2MIPI analogic gain 6.636x, GC02M2MIPI add pregain = %d\n", temp);
		...
		write_cmos_sensor(0xb1, (temp >> 8) & 0x3f);
		write_cmos_sensor(0xb2, (temp & 0xff));
		LOG_DBG("GC02M2MIPI analogic gain 8.0x, GC02M2MIPI add pregain = %d\n", temp);
		...
		write_cmos_sensor(0xb1, (temp >> 8) & 0x3f);
		write_cmos_sensor(0xb2, (temp & 0xff));
		LOG_DBG("GC02M2MIPI analogic gain 9.48x, GC02M2MIPI add pregain = %d\n", temp);
		...
		write_cmos_sensor(0xb1, (temp >> 8) & 0x3f);
		write_cmos_sensor(0xb2, (temp & 0xff));
		LOG_DBG("GC02M2MIPI analogic gain 11.2x, GC02M2MIPI add pregain = %d\n", temp);
		...
		write_cmos_sensor(0xb1, (temp >> 8) & 0x3f);
		write_cmos_sensor(0xb2, (temp & 0xff));
		LOG_DBG("GC02M2MIPI analogic gain 13.2725x, GC02M2MIPI add pregain = %d\n", temp);
	} else {
		write_cmos_sensor(0xfe, 0x00);
		write_cmos_sensor(0xb6, 0x0f);
		temp = 1024 * iReg / ANALOG_GAIN_16;
		write_cmos_sensor(0xb1, (temp >> 8) & 0x3f);
		write_cmos_sensor(0xb2, (temp & 0xff));
		LOG_DBG("GC02M2MIPI analogic gain 16x, GC02M2MIPI add pregain = %d\n", temp);
	}
...
static int set_mode_setfile(enum IMGSENSOR_MODE mode)
{
	...
	LOG_INF(" - E");
	LOG_INF("mode: %s", gc02m2_setfile_info[mode].name);

	if ((gc02m2_setfile_info[mode].setfile == NULL) || (gc02m2_setfile_info[mode].size == 0)) {
		LOG_ERR("failed, mode: %d", mode);
		ret = -1;
	} else
		ret = table_write_cmos_sensor(gc02m2_setfile_info[mode].setfile, gc02m2_setfile_info[mode].size);
...
static kal_uint32 open(void)
{
	...
	/*Don't Remove!! */
	//gc02m2_gcore_identify_otp();

	/* initail sequence write in  */
	ret = sensor_init();

	/*write registers from sram */
	//gc02m2_gcore_update_otp();
...
{
	switch (sensor_id) {
	case GC02M2_SENSOR_ID: //for macro sensor
		LOG_INF("set imgsensor info for GC02M2");
...
static kal_uint8 gc02m2_otp_read_byte(kal_uint16 addr)
{
...
static void gc02m2_otp_off_setting(void)
{
	write_cmos_sensor(0xf3, 0x00);
	write_cmos_sensor(0xfe, 0x00);
}

int gc02m2_read_otp_cal(unsigned int addr, unsigned char *data, unsigned int size)
{
	kal_uint32 i = 0;
	kal_uint8 read_addr = GC02M2_OTP_START_ADDR;
	...
	if (write_cmos_sensor(0xf3, 0x30) < 0) {
		...
		gc02m2_otp_off_setting();
		return -1;
	}
	write_cmos_sensor(0xfe, 0x02); //Page_2_select

	for (i = 0; i < size; i++) {
		*(data + i) = gc02m2_otp_read_byte(read_addr);
