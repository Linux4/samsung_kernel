...
#define BQ27XXX_ATTR(_name)				\
{							\
	.attr = {.name = #_name, .mode = 0664},	\
	.show = bq27xxx_show_attrs,			\
	.store = bq27xxx_store_attrs,			\
}
enum {
	SOC = 0,
	CYCLE,
...
typedef struct bq27xxx_fuelgauge_platform_data {
	int capacity_calculation_type;
} bq27xxx_fuelgauge_platform_data_t;
...
struct bq27xxx_device_info {
	...
	bq27xxx_fuelgauge_platform_data_t *pdata;
