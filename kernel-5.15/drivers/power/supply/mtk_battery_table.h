...
/*ui_soc related */
#define DIFFERENCE_FULL_CV		300 /*0.01%*/
#define PSEUDO1_EN				1
...
#define BATTERYID_GPIO_SUPPORT 2

struct batteryid_info {
	struct device *dev;
	struct pinctrl *pinctrl;
	struct pinctrl_state *active[BATTERYID_GPIO_SUPPORT];
	struct pinctrl_state *sleep[BATTERYID_GPIO_SUPPORT];
	struct pinctrl_state *idle[BATTERYID_GPIO_SUPPORT];
	int active_value[BATTERYID_GPIO_SUPPORT];
	int sleep_value[BATTERYID_GPIO_SUPPORT];
	int idle_value[BATTERYID_GPIO_SUPPORT];
	int hwid_status[BATTERYID_GPIO_SUPPORT];
};

enum battid_hwidstatus {
	HIGH_RESISTANCE,
	EXTTERNAL_PULLDOWN,
	EXTTERNAL_PULLUP,
};
...
enum batteryid {
	TWO_HIGHRESISTANCE, // ¶þ¹©,·ÉÃ«ÍÈ.
	EXTPULLDOWN_HIGHRESISTANCE,
	HIGHRESISTANCE_EXTPULLDOWN,
	TWO_EXTPULLDOWN,
	EXTPULLUP_HIGHRESISTANCE,
	EXTPULLUP_EXTPULLDOWN,
	HIGHRESISTANCE_EXTPULLUP,
	EXTPULLDOWN_EXTPULLUP,
	TWO_EXTPULLUP,
	BATTERYID_INVALID,
};
...
#if (BAT_NTC_10 == 1)
struct fg_temp fg_temp_table[26] = {
		{-40, 195652},
		{-35, 148171},
		{-30, 113347},
		{-25, 87559},
