...
int secchip_enable_clk(struct i2c_adapter *adap)
{
	struct mtk_i2c *i2c = i2c_get_adapdata(adap);
	int ret;
...
EXPORT_SYMBOL(secchip_enable_clk);

int secchip_disable_clk(struct i2c_adapter *adap)
{
	struct mtk_i2c *i2c = i2c_get_adapdata(adap);
...
EXPORT_SYMBOL(secchip_disable_clk);
