...
#endif
#if defined(CONFIG_TOUCHSCREEN_MMS134)
...
extern void mms_charger_status_cb(int status);
...
#elif defined (CONFIG_TOUCHSCREEN_FOCALTECH)
static struct ft5x0x_ts_platform_data ft5x0x_ts_info = {
	.irq_gpio_number	= GPIO_TOUCH_IRQ,
	.reset_gpio_number	= GPIO_TOUCH_RESET,
	.vdd_name			= "vdd28",
};
#elif defined (CONFIG_TOUCHSCREEN_MMS134)
static struct mms_platform_data mms_pdata = {
	.max_x = 479,
	.max_y = 799,
	.irqflags = IRQF_ONESHOT,
	.gpio_int = 52,
	.vdd_regulator_volt_1_8v = 1800000,
	.vdd_regulator_volt_3_0v = 3000000,
	.inkernel_fw_name = "melfas/CS02_ME_00.fw",
	.ums_fw_name = "/sdcard/mms134s.fw",
};
#endif

#if defined  (CONFIG_SENSORS_K3DH) || defined(CONFIG_SENSORS_K2HH)
#define ACCEL_INT_GPIO_PIN 194
