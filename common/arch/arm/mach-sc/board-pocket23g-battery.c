...
static sec_charging_current_t charging_current_table[] = {
	...
	{550,   550,    120,    20 * 60},     /* POWER_SUPPLY_TYPE_MAINS */
	{450,   450,    120,    20 * 60},     /* POWER_SUPPLY_TYPE_USB */
	{500,   500,    120,    20 * 60},     /* POWER_SUPPLY_TYPE_USB_DCP */
	{500,   500,    120,    20 * 60},     /* POWER_SUPPLY_TYPE_USB_CDP */
	{500,   500,    120,    20 * 60},     /* POWER_SUPPLY_TYPE_USB_ACA */
	...
	{550,   550,    120,    20 * 60},     /* POWER_SUPPLY_TYPE_UARTOFF */
};
...
static struct battery_data_t stc3117_battery_data[] = {
		...
		.CC_cnf = 250,      /* nominal CC_cnf, coming from battery characterisation*/
		.VM_cnf = 280,      /* nominal VM cnf , coming from battery characterisation*/
		.Rint = 221,			/* nominal internal impedance*/
	...
	.OCVValue[15] = 4150,             /* OCV curve adjustment */
	.OCVValue[14] = 4056,             /* OCV curve adjustment */
	.OCVValue[13] = 3974,             /* OCV curve adjustment */
	.OCVValue[12] = 3916,             /* OCV curve adjustment */
	.OCVValue[11] = 3890,             /* OCV curve adjustment */
	.OCVValue[10] = 3855,             /* OCV curve adjustment */
	.OCVValue[9] = 3796,              /* OCV curve adjustment */
	.OCVValue[8] = 3776,              /* OCV curve adjustment */
	.OCVValue[7] = 3766,              /* OCV curve adjustment */
	...
	.OCVValue[2] = 3666,              /* OCV curve adjustment */
	.OCVValue[1] = 3608,              /* OCV curve adjustment */
...
static struct battery_data_t sprd2713_battery_data[] = {
{
	...
	.cnom = 1230,        /* nominal capacity in mAh */
