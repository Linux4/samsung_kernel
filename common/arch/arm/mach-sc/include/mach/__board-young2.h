...
#define HEADSET_BUTTVOL_MEDIA_MAX         153
#define HEADSET_BUTTVOL_VOLUP_MIN         153
#define HEADSET_BUTTVOL_VOLUP_MAX         300
#define HEADSET_BUTTVOL_VOLDOWN_MIN       300
#define HEADSET_BUTTVOL_VOLDOWN_MAX       9999

#define HEADSET_TYPEVOL_NOMIC_MIN         0
#define HEADSET_TYPEVOL_NOMIC_MAX         899
