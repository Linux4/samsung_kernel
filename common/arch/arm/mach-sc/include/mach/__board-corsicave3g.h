...
#define HEADSET_BUTTVOL_MEDIA_MAX         160
#define HEADSET_BUTTVOL_VOLUP_MIN         160
#define HEADSET_BUTTVOL_VOLUP_MAX         310
#define HEADSET_BUTTVOL_VOLDOWN_MIN       310
#define HEADSET_BUTTVOL_VOLDOWN_MAX       3000

#define HEADSET_TYPEVOL_NOMIC_MIN         0
#define HEADSET_TYPEVOL_NOMIC_MAX         940
