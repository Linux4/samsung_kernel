...
static const unsigned int board_keymap_rev00[] = {
	KEY(0, 0, KEY_VOLUMEDOWN),
	KEY(1, 0, KEY_VOLUMEUP),
	KEY(0, 1, KEY_HOME),
};
static const struct matrix_keymap_data customize_keymap_rev00 = {
	.keymap = board_keymap_rev00,
	.keymap_size = ARRAY_SIZE(board_keymap_rev00),
};
...
static struct sci_keypad_platform_data sci_keypad_data_rev00 = {
	.rows_choose_hw = CUSTOM_KEYPAD_ROWS,
	.cols_choose_hw = CUSTOM_KEYPAD_COLS,
	.rows_number = ROWS,
	.cols_number = COLS,
	.keymap_data = &customize_keymap_rev00,
	.support_long_key = 0,
	.repeat = 0,
	.debounce_time = 5000,
};
...
static struct tsp_dev_info ist30xx_info = {
	.gpio = GPIO_TOUCH_IRQ,
	.tsp_1_8v_ldo = "vddsim2",
	.tsp_3_0v_ldo = "vddcammot",
...
static struct sec_therm_adc_table adc_siop_temp_table[] = {
 	{1155 ,  600}, 
	{1335 ,  550}, 
	{1516 ,  500}, 
	{1664 ,  450},	 
...
static struct sec_therm_platform_data sec_therm_pdata = {
	.adc_arr_size	= ARRAY_SIZE(adc_siop_temp_table),
	.adc_channel	= 2,
	.adc_table	= adc_siop_temp_table,
};
...
static void __init sc8830_init_machine(void)
{
	...
	if(get_hw_rev() > BOARD_DEFAULT_REV)
		...
		platform_device_add_data(&sprd_keypad_device,(const void*)&sci_keypad_data_rev00,sizeof(sci_keypad_data_rev00));
}

static void sprd_open_classg(void)
{
