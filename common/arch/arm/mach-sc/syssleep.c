...
{
	#ifdef CONFIG_SPRD_MODEM_TD
  sci_glb_write(REG_PMU_APB_PD_CP1_ARM9_CFG, BIT(25), -1UL);
	sci_glb_write(REG_PMU_APB_PD_CP1_GSM_CFG, BIT(25), -1UL);
	sci_glb_write(REG_PMU_APB_PD_CP1_TD_CFG, BIT(25), -1UL);
	sci_glb_write(REG_PMU_APB_PD_CP1_L1RAM_CFG, BIT(25), -1UL);
	sci_glb_write(REG_PMU_APB_PD_CP1_SYS_CFG,  BIT(25) | BIT(28), -1UL);	
	#else
