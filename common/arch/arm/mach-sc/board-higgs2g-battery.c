...
static sec_charging_current_t charging_current_table[] = {
	...
	{700,   700,    130,    20 * 60},     /* POWER_SUPPLY_TYPE_MAINS */
	{450,   450,    130,    20 * 60},     /* POWER_SUPPLY_TYPE_USB */
	{450,   450,    130,    20 * 60},     /* POWER_SUPPLY_TYPE_USB_DCP */
	{450,   450,    130,    20 * 60},     /* POWER_SUPPLY_TYPE_USB_CDP */
	{450,   450,    130,    20 * 60},     /* POWER_SUPPLY_TYPE_USB_ACA */
	{550,   500,    130,    20 * 60},     /* POWER_SUPPLY_TYPE_MISC */
	{0,     0,      0,      0},     /* POWER_SUPPLY_TYPE_BMS */
	{0,     0,      0,      0},     /* POWER_SUPPLY_TYPE_CARDOCK */
	{500,   500,    130,    20 * 60},     /* POWER_SUPPLY_TYPE_WPC */
	{700,   700,    130,    20 * 60},     /* POWER_SUPPLY_TYPE_UARTOFF */
};
...
static struct battery_data_t stc3117_battery_data[] = {
		...
		.CC_cnf = 359,      /* nominal CC_cnf, coming from battery characterisation*/
		.VM_cnf = 455,      /* nominal VM cnf , coming from battery characterisation*/
		.Rint = 266,			/* nominal internal impedance*/
  		.Cnom = 1800,       /* nominal capacity in mAh, coming from battery characterisation*/
		.Rsense = 10,       /* sense resistor mOhms*/
		.RelaxCurrent = 90, /* current for relaxation in mA (< C/20) */
	...
	.OCVValue[15] = 4301,            /* OCV curve adjustment */
	.OCVValue[14] = 4184,            /* OCV curve adjustment */
	.OCVValue[13] = 4086,            /* OCV curve adjustment */
	.OCVValue[12] = 3976,            /* OCV curve adjustment */
	.OCVValue[11] = 3954,            /* OCV curve adjustment */
	.OCVValue[10] = 3915,            /* OCV curve adjustment */
	.OCVValue[9] = 3826,             /* OCV curve adjustment */
	.OCVValue[8] = 3793,             /* OCV curve adjustment */
	...
	.OCVValue[3] = 3686,             /* OCV curve adjustment */
	.OCVValue[2] = 3680,             /* OCV curve adjustment */
	.OCVValue[1] = 3631,             /* OCV curve adjustment */
...
static struct battery_data_t sprd2713_battery_data[] = {
{
	...
	.rsense_real = 213,      /* sense resistor 0.1mOhm from real environment*/
...
{
	pr_info("%s: higgs2g battery init\n", __func__);
#ifdef CONFIG_FUELGAUGE_STC3117
