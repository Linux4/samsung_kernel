...
static struct resource sprd_i2c_resources4[] = {
	[0] = {
		.start = SPRD_I2C4_BASE,
		.end   = SPRD_I2C4_BASE + SZ_4K -1,
		.name  = "i2c4_res",
		.flags = IORESOURCE_MEM,
	},
	[1] = {
...
struct platform_device sprd_i2c_device4 = {
	.name           = "sprd-i2c",
	.id             =  4,
	.num_resources  = ARRAY_SIZE(sprd_i2c_resources4),
	.resource       = sprd_i2c_resources4,
};
...
/*
* Plz maintain as below
* Modified based on 1.2.0
* sejong123.park, 14/03/05
*/
static struct headset_buttons sprd_headset_buttons[] = {
#if defined(CONFIG_INPUT_SPRD_CALI_HEADSET) || defined(CONFIG_INPUT_SPRD_HEADSET_SHARK)
	{
...
static struct resource sprd_battery_resources[] = {
	    ...
	    [3] = {
                .start = EIC_POWER_PBINT2,
                .end = EIC_POWER_PBINT2,
                .name = "jig_on",
                .flags = IORESOURCE_IO,
        }
};
