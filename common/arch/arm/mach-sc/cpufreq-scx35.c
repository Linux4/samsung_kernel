...
static struct cpufreq_table_data __sc8830t_cpufreq_table_data_es = {
	.freq_tbl = {
		{0, 1200000},
		{1, 1000000},
		{2, SHARK_TDPLL_FREQUENCY},
...
static struct cpufreq_table_data __sc7727st_cpufreq_table_data_es = {
	.freq_tbl = {
		{0, 1200000},
		{1, 1000000},
		{2, SHARK_TDPLL_FREQUENCY},
...
#ifdef CONFIG_SCX35_1300MHZ
static struct cpufreq_table_data __sc8830t_cpufreq_table_data_es_1300 = {
	.freq_tbl = {
		{0, 1300000},
		{1, 1200000},
		{2, 1000000},
...
static struct cpufreq_table_data __sc7727st_cpufreq_table_data_es_1300 = {
	.freq_tbl = {
		{0, 1300000},
		{1, 1200000},
		{2, 1000000},
...
struct cpufreq_table_data *sc8830t_cpufreq_table_data_es;
...
static int __init sprd_cpufreq_modinit(void)
{
	...
	sc8830t_cpufreq_table_data_es =
				&__sc8830t_cpufreq_table_data_es_1300;
#else
	sc8830t_cpufreq_table_data_es =
				&__sc8830t_cpufreq_table_data_es;
#endif /* CONFIG_SCX35_1300MHZ */

#ifdef CONFIG_OF
	soc = of_find_node_by_path("/soc");
	if (soc) {
		unsigned int val;
		unsigned int boost_vdd_arm = 0;

		if (of_find_property(soc, "boost_vdd_arm_voltage", NULL)) {
			pr_info("boost_vdd_arm_voltage\n");
			boost_vdd_arm = 1;
			sc8830t_cpufreq_table_data_es =
					&__sc7727st_cpufreq_table_data_es;
		}

#if defined (CONFIG_SCX35_1300MHZ)
		if (!of_property_read_u32(soc, "enable-clk-1300mhz", &val)) {
			if (val && boost_vdd_arm) {
				pr_info("enable-clk-1300mhz = %d\n", val);
				sc8830t_cpufreq_table_data_es =
					&__sc7727st_cpufreq_table_data_es_1300;
			}
		}
#endif /* CONFIG_SCX35_1300MHZ */
	}
