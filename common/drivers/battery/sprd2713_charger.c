...
/*OVP interrupt to sprd2713_charge.c,and OVP state is polled by sec_battery.c */
/*Had better use interrupt for OVP,if OVI occur,should stop charging immediately*/
	...
	request_irq(irq_vchg_ovi, sprdchg_vchg_ovi_irq,
	...
	request_irq(irq_vf_det, sprdchg_vf_det_irq,
