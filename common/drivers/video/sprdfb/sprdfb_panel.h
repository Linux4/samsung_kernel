...
typedef int32_t (*i2c_write_16bits_t)(uint16_t reg,
			bool reg_is_8bit, uint16_t val, bool val_is_8bit);
typedef int32_t (*i2c_read_16bits_t)(uint16_t reg,
			bool reg_is_8bit, uint16_t *val, bool val_is_8bit);
...
struct panel_operations {
	...
	int32_t (*panel_pwr_ctrl) (struct panel_spec *self, int on_off);
};
