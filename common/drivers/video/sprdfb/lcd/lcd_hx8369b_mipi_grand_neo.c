/* drivers/video/sprdfb/lcd_hx8369b_mipi_grand_neo.c
 *
...
static LCM_Init_Code init_data[] = {
	...
	{LCM_SEND(95), {93,0,0xD5,0x00,0x00,0x08,0x03,0x30,0x00,0x00,0x10,0x01,0x00,0x00,0x00,0x01,0x39,0x45,0x00,0x00,0x0D,0x44,0x39,0x37,
							0x00,0x00,0x02,0x04,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x03,0x00,0x00,0x00,0x00,0x00,0x37,0x59,0x18,0x10,
							0x00,0x00,0x05,0x00,0x00,0x40,0x28,0x69,0x40,0x00,0x00,0x00,0x00,0x00,0x26,0x49,0x08,0x00,0x00,0x00,0x04,
							0x00,0x00,0x51,0x39,0x78,0x50,0x00,0x00,0x01,0x00,0x00,0x00,0x01,0x00,0x00,0x00,0x07,0xF8,0x0F,0xFF,0xFF,
							0x07,0xF8,0x0F,0xFF,0xFF,0x00,0x20,0x5A}},
	...
	{LCM_SEND(130),{128,0,}},
	{LCM_SEND(7),{5,0,0xE3,0x0F,0x0F,0x11,0x11}},
	{LCM_SEND(2),{0xEA,0x7A}},
	{LCM_SEND(6),{4,0,0xC6,0x41,0xFF,0x7C}},
	/* gamma setting */
	{LCM_SEND(38), {36,0,0xE0,0x00,0x1B,0x21,0x27,0x30,0x3F,0x2D,0x46,0x0A,0x11,0x11,0x14,0x15,0x15,0x16,0x13,0x17,0x00,
							0x1B,0x21,0x27,0x30,0x3F,0x2C,0x45,0x09,0x0F,0x11,0x15,0x17,0x15,0x16,0x13,0x17,0x01}},

	{LCM_SEND(1), {0x11}},
	{LCM_SLEEP(180)},
	{LCM_SEND(1), {0x29}},
	{LCM_SLEEP(10)},
	// Set Backlight Control and CABC off
	{LCM_SEND(5),{3,0,0xC9,0x0F,0x00}},
	{LCM_SEND(5),{3,0,0x51,0xFF,0x3C}},
	{LCM_SEND(5),{3,0,0x53,0x24,0x08}},
	{LCM_SEND(5),{3,0,0x55,0x00,0x2C}},
	{LCM_SLEEP(5)},
};

static LCM_Init_Code init_data_dtc[] = {
	// SETEXTC
	{LCM_SEND(6),{4,0,0xB9,0xFF,0x83,0x69}},
	// Delay of 10 ms
	{LCM_SLEEP(10)},
	...
	{LCM_SEND(9),{7,0,0xC0,0x73,0x50,0x00,0x20,0xC4,0x00}},
	// SECDGC
	{LCM_SEND(130),{128,0,}},
	// Set EQ
	{LCM_SEND(7),{5,0,0xE3,0x0F,0x0F,0x11,0x11}},
	// Set Panel
	{LCM_SEND(2),{0xEA,0x7A}},
	...
	{LCM_SEND(6),{4,0,0xC6,0x41,0xFF,0x7C}},
	// Set Gamma
	{LCM_SEND(38),{36,0,0xE0,0x00,0x24,0x23,0x27,0x30,0x3F,0x30,0x46,0x0E,0x10,0x0F,0x13,0x15,0x13,0x15,0x16,0x19,0x00,0x24,
							0x23,0x27,0x30,0x3F,0x30,0x46,0x0E,0x10,0x0F,0x13,0x15,0x13,0x15,0x16,0x19,0x01}},
	// Sleep Out
	{LCM_SEND(1),{0x11}},
	{LCM_SLEEP(180)},
	// Display On
...
static int32_t hx8369b_mipi_init(struct panel_spec *self)
{
    ...
    if(lcd_id_from_uboot == 0x55C090) {
        ...
        init = init_data_dtc;
        init_cmd_len = ARRAY_SIZE(init_data_dtc);
    }
...
#ifdef CONFIG_LCD_ESD_RECOVERY
struct esd_det_info hx8369b_esd_info_dtc = {
	.name = "hx8369b_dtc",
	.mode = ESD_DET_INTERRUPT,
	.gpio = 236,
	.state = ESD_DET_NOT_INITIALIZED,
...
*/
	sprdfb_panel_register(&lcd_hx8369b_mipi_dtc);
