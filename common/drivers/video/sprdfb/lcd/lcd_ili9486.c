...
static int32_t ili9486_set_direction(struct panel_spec *self,
							uint16_t direction)
{
...
static int32_t ili9486_enter_sleep(struct panel_spec *self,
							uint8_t is_sleep)
{
	if (is_sleep)
		/*send_cmd(0x10);*/
...
{
	pr_info("sprdfb_111: [%s]:  0x%x!\n", __func__, lcd_ili9486.lcd_id);
