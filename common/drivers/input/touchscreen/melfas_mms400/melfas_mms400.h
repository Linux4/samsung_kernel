...
//Firmware update
#define INTERNAL_FW_NAME			"melfas/melfas_mms400.fw"			//firmware included in the kernel
#define EXTERNAL_FW_PATH			"/sdcard/melfas_mms400.mfsb"	//path of external storage
