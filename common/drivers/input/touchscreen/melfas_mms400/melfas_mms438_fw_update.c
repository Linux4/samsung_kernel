/*
 * MELFAS MMS438/449/458 Touchscreen Driver - Firmware Update
 *
...
//				dev_err(&client->dev, "%s [ERROR] version mismatch after flash. Section[%d] : Chip[0x%04X] != File[0x%04X]\n", __func__, i, ver_chip[img[i]->type], ver_file[i]);
