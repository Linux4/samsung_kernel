...
#define IST30XXC_INTERNAL_CMCS_BIN   (1)
...
#define IST30XXC_CMCS_MSG_VALID     (0x8FAB0FAB)
#define IST30XXC_CMCS_TIMEOUT       (10000) // unit : msec

#define IST30XXC_CMCS_CM            ("CM")
#define IST30XXC_CMCS_CS            ("CS")

// CMCS addr
#define IST30XXC_CMCS_CHECKSUM      IST30XXC_DA_ADDR(0x300B0100)
#define IST30XXC_CMCS_CS_CHECKSUM   IST30XXC_DA_ADDR(0x300B0108)
#define IST30XXC_CMCS_PATTERN       IST30XXC_DA_ADDR(0x300B0104)

#define ENABLE_CM_MODE(n)           (n & 1)
#define ENABLE_CS_MODE(n)           ((n >> 1) & 1)

#define IST30XXC_CMCS_NAME           "ist30xxc.cms"
#define IST30XXC_CMCS_MAGIC          "CMCS2TAG"
...
typedef struct _CMCS_BUF {
	s16	cm[IST30XXC_NODE_TOTAL_NUM];
	s16	spec_min[IST30XXC_NODE_TOTAL_NUM];
    s16 spec_max[IST30XXC_NODE_TOTAL_NUM];
	s16	slope0[IST30XXC_NODE_TOTAL_NUM];
	s16	slope1[IST30XXC_NODE_TOTAL_NUM];
	s16	cs[IST30XXC_NODE_TOTAL_NUM];
} CMCS_BUF;
