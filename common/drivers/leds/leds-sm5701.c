...
#if defined(CONFIG_MACH_VIVALTO3MVE3G_LTN) || defined(CONFIG_MACH_VIVALTO3MVEML3G) || defined(CONFIG_MACH_J1POP3G)
#define flash_enable_gpio 81
#define flash_torch_gpio 83
#else
...
static int leds_sm5701_probe(struct platform_device *pdev)
{
        ...
        */
        ...
        if (err < 0)
                goto err_out;
    #if  defined (CONFIG_MACH_VIVALTO5MVE3G) || defined(CONFIG_MACH_VIVALTO3MVE3G_LTN) || defined(CONFIG_MACH_VIVALTO3MVEML3G) \
