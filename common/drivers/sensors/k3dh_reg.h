...
#if defined(CONFIG_MACH_NEVISTD) || defined(CONFIG_MACH_GARDA) || defined(CONFIG_MACH_KYLEVE) || defined(CONFIG_MACH_LOGAN) || defined(CONFIG_MACH_GARDAVE)
#define USES_MOVEMENT_RECOGNITION
#endif
 /* Need to enable at least one of these INT PIN to use interrupt */
#if defined(CONFIG_MACH_GARDA) || defined(CONFIG_MACH_KYLEVE) || defined(CONFIG_MACH_LOGAN) || defined(CONFIG_MACH_GARDAVE)
#define USE_INT1_PIN
#endif
