...
#elif defined(CONFIG_MACH_GOYAVE3G_SEA)
...
#if  defined (CONFIG_MACH_CORE3_W)|| defined(CONFIG_MACH_J13G) || defined (CONFIG_MACH_GRANDNEOVE3G) || defined (CONFIG_MACH_VIVALTO5MVE3G)
...
int sensor_k_probe(struct platform_device *pdev)
{
...
#if  defined (CONFIG_MACH_CORE3_W) || defined (CONFIG_MACH_GRANDNEOVE3G) || defined(CONFIG_MACH_J13G) || (CONFIG_MACH_VIVALTO5MVE3G)
    ...
    || defined (CONFIG_MACH_VIVALTO5MVE3G)|| defined(CONFIG_MACH_GOYAVE3G) || defined(CONFIG_MACH_GOYAVEWIFI) || defined(CONFIG_MACH_GOYAVE3G_SEA)
...
#elif defined(CONFIG_MACH_GOYAVE3G) || defined(CONFIG_MACH_GOYAVEWIFI) || defined(CONFIG_MACH_GOYAVE3G_SEA)

#define REAR_SENSOR_NAME	"SR200PC20 N\n"

#if defined(CONFIG_MACH_GOYAVE3G_SEA)
#define FRONT_SENSOR_NAME	"SR200PC20M N\n"
#endif
