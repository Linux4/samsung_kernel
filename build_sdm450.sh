...
if [ "$BUILD_COMMAND" == "a6plte_eur_open" ]; then
	...
	USE_FINGERPRINT_TZ="false"
	KASLR_DEFCONFIG=
elif [ "$BUILD_COMMAND" == "a6plte_chn_hk" ]; then
	BUILD_PRODUCT=a6plte_chn_hk
	PRODUCT_NAME=a6plte_chn
	SIGN_MODEL=
	USE_FINGERPRINT_TZ="false"
	KASLR_DEFCONFIG=
	...
	SIGN_MODEL=
	USE_FINGERPRINT_TZ="false"
elif [ "$BUILD_COMMAND" == "a6plte_mea_open" ]; then
	BUILD_PRODUCT=a6plte_mea_open
	PRODUCT_NAME=a6plte_mea
	SIGN_MODEL=
	USE_FINGERPRINT_TZ="false"
	...
	KASLR_DEFCONFIG=
        ...
        USE_FINGERPRINT_TZ="false"
        KASLR_DEFCONFIG=
elif [ "$BUILD_COMMAND" == "j8y18lte_cis_ser" ]; then
        BUILD_PRODUCT=j8y18lte_cis_ser 
        PRODUCT_NAME=j8y18lte_cis
        SIGN_MODEL=
        USE_FINGERPRINT_TZ="false"
        KASLR_DEFCONFIG=
elif [ "$BUILD_COMMAND" == "j8y18lte_swa_open" ]; then
        BUILD_PRODUCT=j8y18lte_swa_open 
        PRODUCT_NAME=j8y18lte_swa
        SIGN_MODEL=
        USE_FINGERPRINT_TZ="false"
        KASLR_DEFCONFIG=
elif [ "$BUILD_COMMAND" == "j8y18lte_sea_open" ]; then
        BUILD_PRODUCT=j8y18lte_sea_open
        PRODUCT_NAME=j8y18lte_sea
        SIGN_MODEL=
        USE_FINGERPRINT_TZ="false"
        KASLR_DEFCONFIG=
elif [ "$BUILD_COMMAND" == "j8y18lte_mea_jv" ]; then
        BUILD_PRODUCT=j8y18lte_mea_jv 
        PRODUCT_NAME=j8y18lte_mea
        SIGN_MODEL=
        USE_FINGERPRINT_TZ="false"
        KASLR_DEFCONFIG=
elif [ "$BUILD_COMMAND" == "j8y18lte_swa_ins" ]; then
        BUILD_PRODUCT=j8y18lte_swa_ins 
        PRODUCT_NAME=j8y18lte_swa
        SIGN_MODEL=
        USE_FINGERPRINT_TZ="false"
        KASLR_DEFCONFIG=
...
SECFUNC_PRINT_HELP()
{
	...
	echo "      j8y18lte_sea_open"
	echo "      j8y18lte_mea_jv"
	echo "      j8y18lte_swa_ins"
	echo "  \$2 : "
