...
#KERNEL_LLVM_BIN=$BUILD_ROOT_DIR/android/prebuilts/clang/host/linux-x86/clang-r377782c/bin/clang
...
FUNC_BUILD_KERNEL()
{
    ...
    echo "Dummy vbmeta for kenrel only QB" > $PRODUCT_OUT/vbmeta.img
	...
	cat ${__dts_dir}/qcom/*.dtb > $PRODUCT_OUT/dtb.img
