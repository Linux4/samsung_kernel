...
make -C $(pwd) O=output ARCH=arm CROSS_COMPILE=$(pwd)/../PLATFORM/prebuilts/gcc/linux-x86/arm/arm-eabi-4.7/bin/arm-eabi- msm8226-sec_defconfig VARIANT_DEFCONFIG=msm8226-sec_ms013g_eur_defconfig SELINUX_DEFCONFIG=selinux_defconfig
