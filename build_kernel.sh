...
make -C $(pwd) O=$(pwd)/out ARCH=arm64 CROSS_COMPILE=aarch64-linux-android- KCFLAGS=-mno-android VARIANT_DEFCONFIG=a9y18qlte_chn_hk_defconfig sdm660_sec_defconfig SELINUX_DEFCONFIG=selinux_defconfig
