...
export ARCH=arm64
export PROJECT_NAME=a42xuq
export SEC_BUILD_CONF_SIGNER_MODEL_NAME=SM-A426U1_NA_XAA_QKEY3
mkdir out
...
make -j8 -C $(pwd) O=$(pwd)/out $KERNEL_MAKE_ENV ARCH=arm64 CROSS_COMPILE=$BUILD_CROSS_COMPILE REAL_CC=$KERNEL_LLVM_BIN CLANG_TRIPLE=$CLANG_TRIPLE a42xuq_usa_open_defconfig
