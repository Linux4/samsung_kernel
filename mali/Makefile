...
ifeq ($(DFS_MAX_FREQ),512000)
export EXTRA_DEFINES += -DGPU_MAX_FREQ_512M
endif
...
#export CONFIG_MALI_PERF_DEBUG_TRACE=y
#export EXTRA_DEFINES += -DCONFIG_MALI_PERF_DEBUG_TRACE
