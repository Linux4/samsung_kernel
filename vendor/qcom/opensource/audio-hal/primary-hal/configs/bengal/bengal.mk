...
#zhangsen1 loopback playback packages
AUDIO_AGM += loopback.sh
AUDIO_AGM += spk_pb.wav
AUDIO_AGM += rcv_pb.wav
AUDIO_AGM += file112.wav
AUDIO_AGM += MP3_1KHZ_L.wav
AUDIO_AGM += 1K-ST-1.wav
AUDIO_AGM += 2K-ST-1.wav
AUDIO_AGM += 3K-ST-1.wav
AUDIO_AGM += 200-ST-1.wav
AUDIO_AGM += 500-ST-1.wav
AUDIO_AGM += SW-ST-7.wav
AUDIO_AGM += SW-ST-19.wav
AUDIO_AGM += SW-ST-20.wav
AUDIO_AGM += loopbacktest
AUDIO_AGM += ftm_loopback
AUDIO_AGM += playback.sh
AUDIO_AGM += record.sh
AUDIO_AGM += record_playback.sh
AUDIO_AGM += AT_playback_1K.sh
AUDIO_AGM += 1K-ST-1.sh
AUDIO_AGM += 2K-ST-1.sh
AUDIO_AGM += 3K-ST-1.sh
AUDIO_AGM += 200-ST-1.sh
AUDIO_AGM += 500-ST-1.sh
AUDIO_AGM += SW-ST-7.sh
AUDIO_AGM += SW-ST-19.sh
AUDIO_AGM += SW-ST-20.sh
AUDIO_AGM += playback_sweep_sound.sh
...
PRODUCT_PACKAGES += IDP_factory_acdb_cal.acdb
PRODUCT_PACKAGES += IDP_factory_workspaceFileXml.qwsp
PRODUCT_PACKAGES += IDP_user_acdb_cal.acdb
PRODUCT_PACKAGES += IDP_user_workspaceFileXml.qwsp
PRODUCT_PACKAGES += IDP_user_sea_acdb_cal.acdb
PRODUCT_PACKAGES += IDP_user_sea_workspaceFileXml.qwsp
PRODUCT_PACKAGES += IDP_user_swa_acdb_cal.acdb
PRODUCT_PACKAGES += IDP_user_swa_workspaceFileXml.qwsp
PRODUCT_PACKAGES += IDP_user_eur_acdb_cal.acdb
PRODUCT_PACKAGES += IDP_user_eur_workspaceFileXml.qwsp
PRODUCT_PACKAGES += IDP_user_mea_acdb_cal.acdb
PRODUCT_PACKAGES += IDP_user_mea_workspaceFileXml.qwsp
PRODUCT_PACKAGES += IDP_user_cis_acdb_cal.acdb
PRODUCT_PACKAGES += IDP_user_cis_workspaceFileXml.qwsp
PRODUCT_PACKAGES += IDP_user_afr_acdb_cal.acdb
PRODUCT_PACKAGES += IDP_user_afr_workspaceFileXml.qwsp
PRODUCT_PACKAGES += IDP_user_swaffourteen_acdb_cal.acdb
...
PRODUCT_COPY_FILES += \
    ...
    $(CONFIG_HAL_SRC_DIR)/mixer_paths_user_bengal_idp.xml:$(TARGET_COPY_OUT_VENDOR)/etc/user/mixer_paths_user_bengal_idp.xml \
    $(CONFIG_HAL_SRC_DIR)/mixer_paths_factory_bengal_idp.xml:$(TARGET_COPY_OUT_VENDOR)/etc/factory/mixer_paths_factory_bengal_idp.xml \
    ...
    $(CONFIG_PAL_SRC_DIR)/resourcemanager_user_bengal_idp.xml:$(TARGET_COPY_OUT_VENDOR)/etc/user/resourcemanager_user_bengal_idp.xml \
    $(CONFIG_PAL_SRC_DIR)/resourcemanager_factory_bengal_idp.xml:$(TARGET_COPY_OUT_VENDOR)/etc/factory/resourcemanager_factory_bengal_idp.xml \
    ...
    $(CONFIG_PAL_SRC_DIR)/factoryusecaseKvManager.xml:$(TARGET_COPY_OUT_VENDOR)/etc/factory/factoryusecaseKvManager.xml \
    $(CONFIG_PAL_SRC_DIR)/userusecaseKvManager.xml:$(TARGET_COPY_OUT_VENDOR)/etc/user/userusecaseKvManager.xml \
...
#zhangsen1 audio factory test file copy vendor/etc/
PRODUCT_COPY_FILES += \
    vendor/qcom/proprietary/mm-audio/factory_lc_test/spk_pb.wav:$(TARGET_COPY_OUT_VENDOR)/etc/spk_pb.wav \
    vendor/qcom/proprietary/mm-audio/factory_lc_test/rcv_pb.wav:$(TARGET_COPY_OUT_VENDOR)/etc/rcv_pb.wav \
    vendor/qcom/proprietary/mm-audio/factory_lc_test/headphone.wav:$(TARGET_COPY_OUT_VENDOR)/etc/headphone.wav \
    vendor/qcom/proprietary/mm-audio/factory_lc_test/MP3_1KHZ_L.wav:$(TARGET_COPY_OUT_VENDOR)/etc/MP3_1KHZ_L.wav \
    vendor/qcom/proprietary/mm-audio/factory_lc_test/1K-ST-1.wav:$(TARGET_COPY_OUT_VENDOR)/etc/1K-ST-1.wav \
    vendor/qcom/proprietary/mm-audio/factory_lc_test/2K-ST-1.wav:$(TARGET_COPY_OUT_VENDOR)/etc/2K-ST-1.wav \
    vendor/qcom/proprietary/mm-audio/factory_lc_test/3K-ST-1.wav:$(TARGET_COPY_OUT_VENDOR)/etc/3K-ST-1.wav \
    vendor/qcom/proprietary/mm-audio/factory_lc_test/200-ST-1.wav:$(TARGET_COPY_OUT_VENDOR)/etc/200-ST-1.wav \
    vendor/qcom/proprietary/mm-audio/factory_lc_test/500-ST-1.wav:$(TARGET_COPY_OUT_VENDOR)/etc/500-ST-1.wav \
    vendor/qcom/proprietary/mm-audio/factory_lc_test/SW-ST-7.wav:$(TARGET_COPY_OUT_VENDOR)/etc/SW-ST-7.wav \
    vendor/qcom/proprietary/mm-audio/factory_lc_test/SW-ST-19.wav:$(TARGET_COPY_OUT_VENDOR)/etc/SW-ST-19.wav \
    vendor/qcom/proprietary/mm-audio/factory_lc_test/SW-ST-20.wav:$(TARGET_COPY_OUT_VENDOR)/etc/SW-ST-20.wav \
...
PRODUCT_PROPERTY_OVERRIDES += persist.audio.algo.bypass=false
PRODUCT_PROPERTY_OVERRIDES += sys.smartpa.support=0
PRODUCT_PROPERTY_OVERRIDES += sys.submic.support=1
