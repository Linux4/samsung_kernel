...
ifeq (1,0)
############################################
#[qcom original audio feature - not used
...
PRODUCT_COPY_FILES += \
    vendor/qcom/opensource/audio-hal/primary-hal/configs/taro/audconf/$(PROJECT_NAME)/$(TARGET_PRODUCT)/mixer_usb_gray.xml:$(TARGET_COPY_OUT_VENDOR)/etc/mixer_usb_gray.xml \
    vendor/qcom/opensource/audio-hal/primary-hal/configs/taro/audconf/$(PROJECT_NAME)/$(TARGET_PRODUCT)/mixer_usb_default.xml:$(TARGET_COPY_OUT_VENDOR)/etc/mixer_usb_default.xml
