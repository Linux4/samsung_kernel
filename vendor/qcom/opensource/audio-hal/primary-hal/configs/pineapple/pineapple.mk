...
PRODUCT_COPY_FILES += \
    vendor/qcom/opensource/audio-hal/primary-hal/configs/pineapple/audconf/$(PROJECT_NAME)/$(TARGET_PRODUCT)/mixer_usb_gray.xml:$(TARGET_COPY_OUT_VENDOR)/etc/mixer_usb_gray.xml \
    vendor/qcom/opensource/audio-hal/primary-hal/configs/pineapple/audconf/$(PROJECT_NAME)/$(TARGET_PRODUCT)/mixer_usb_default.xml:$(TARGET_COPY_OUT_VENDOR)/etc/mixer_usb_default.xml

# include audio rc file
PRODUCT_COPY_FILES += \
    vendor/qcom/opensource/audio-hal/primary-hal/configs/pineapple/init.audio.samsung.rc:$(TARGET_COPY_OUT_VENDOR)/etc/init/init.audio.samsung.rc
