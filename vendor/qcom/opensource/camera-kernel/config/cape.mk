...
ifeq ($(PROJECT_NAME), $(filter $(PROJECT_NAME),b0q g0q r0q q4q v4q))
...
ifeq ($(PROJECT_NAME), $(filter $(PROJECT_NAME),b4q e4q))
ccflags-y += -DCONFIG_SEC_B4Q_PROJECT=1
ccflags-y += -DCONFIG_SAMSUNG_OIS_MCU_STM32=1
ccflags-y += -DCONFIG_CAMERA_SYSFS_V2=1
ccflags-y += -DCONFIG_CAMERA_FRAME_CNT_DBG=1
ccflags-y += -DCONFIG_CAMERA_FRAME_CNT_CHECK=1
...
ifeq ($(PROJECT_NAME), $(filter $(PROJECT_NAME),q4q v4q))
ccflags-y += -DCONFIG_SEC_Q4Q_PROJECT=1
ccflags-y += -DCONFIG_SENSOR_RETENTION=1
