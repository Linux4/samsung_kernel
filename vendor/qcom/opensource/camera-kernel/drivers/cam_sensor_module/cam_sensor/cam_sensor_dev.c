...
/*M55 code for QN6887A-8 by rongyi at 2023/08/16 start*/
...
char *cameraModuleInfo[5] = {NULL,NULL,NULL,NULL,NULL};
...
#ifdef CONFIG_ARCH_X55
    proc_entry = proc_create(CAM_MODULE_INFO,0777, NULL,&hqextend_cameraModuleInfo_fops);
    if (NULL == proc_entry) {
        pr_err("Create proc/cameraModuleInfo failed\n");
        remove_proc_entry(CAM_MODULE_INFO, NULL);
    }
#endif
/*M55 code for QN6887A-8 by rongyi at 2023/08/16 end*/
