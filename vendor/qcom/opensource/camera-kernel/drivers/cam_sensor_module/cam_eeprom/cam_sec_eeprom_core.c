...
#if defined(CONFIG_SEC_E1Q_PROJECT) || defined(CONFIG_SEC_E2Q_PROJECT) || defined(CONFIG_SEC_E3Q_PROJECT) || defined(CONFIG_SEC_Q6Q_PROJECT)
...
static int cam_sec_eeprom_module_info_set_load_version(int rev, struct cam_eeprom_ctrl_t *e_ctrl, ModuleInfo_t *mInfo)
{
	...
	&& !defined(CONFIG_SEC_Q6Q_PROJECT)
