	...
	enum cci_i2c_sync sync_en)
{
	...
	trace_cam_cci_burst(cci_dev->soc_info.index, master, queue,
		...
		c_ctrl->cci_info->sid);
	CAM_INFO(CAM_CCI, "CCI%d_I2C_M%d_Q%d : START for sid: 0x%x size: %d",
	...
	CAM_INFO(CAM_CCI, "CCI%d_I2C_M%d_Q%d num words to Queue: %d th_irq_ref_cnt: %d cci_dev: %p",
		cci_dev->soc_info.index, master, queue, num_word_written_to_queue,
	...
	trace_cam_cci_burst(cci_dev->soc_info.index, master, queue,
		...
		c_ctrl->cci_info->sid);
	CAM_INFO(CAM_CCI, "CCI%d_I2C_M%d_Q%d : completed ....for sid: 0x%x size: %d",
		cci_dev->soc_info.index, master, queue, c_ctrl->cci_info->sid, i2c_msg->size);
