...
# M55 code for SR-QN6887A-01-579&SR-QN6887A-01-575 by yingboyang at 2023/08/30 start
LOCAL_SHARED_LIBRARIES := \
    ...
    libaudioroute \
    libats
# M55 code for SR-QN6887A-01-579&SR-QN6887A-01-575 by yingboyang at 2023/08/30 end
...
# M55 code for SR-QN6887A-01-579&SR-QN6887A-01-575 by yingboyang at 2023/08/30 start
ifeq ($(CUSTOM_PROJECT_X55),x55)
    LOCAL_CFLAGS += -DCUSTOM_PROJECT_X55
endif

ifeq ($(strip $(ODM_CUSTOM_FACTORY_BUILD)),true)
    LOCAL_CFLAGS += -DODM_CUSTOM_FACTORY_BUILD
endif
# M55 code for SR-QN6887A-01-579&SR-QN6887A-01-575 by yingboyang at 2023/08/30 end
# M55 code for QN6887A-393 by hujincan at 2023/10/27 start
ifeq ($(strip $(ODM_CUSTOM_BUILD)),true)
    LOCAL_CFLAGS += -DODM_CUSTOM_BUILD
endif
# M55 code for QN6887A-393 by hujincan at 2023/10/27 end
