			   ...
			   struct sar_limit_cmd_params *sar_limit_cmd)
{
	...
	hdd_enter();
	/* M55 code for SR-QN6887A-01-174 by lijun at 20231017 start */
	hdd_err("wifi sar hdd_convert_sarv1_to_sarv2  version = %d",hdd_ctx->sar_version);
	/* M55 code for SR-QN6887A-01-174 by lijun at 20231017 end */
...
send_sar_limits:
        /* M55 code for SR-QN6887A-01-174 by lijun at 20231017 start */
        hdd_err("wifi sar will enter send_sar_limits");
        /* M55 code for SR-QN6887A-01-174 by lijun at 20231017 end */
