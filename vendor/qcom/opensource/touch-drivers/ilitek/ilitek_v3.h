...
#define DRIVER_VERSION			"3.0.9.0.230110.230407"
#define ENABLE			1
#define DISABLE			0
#define K			(1024)
#define M			(K * K)
...
#define GENERIC_KERNEL_IMAGE            DISABLE    /*not follow gki for fac*/
#else
...
/* for 9882V flow*/
#define ENABLE_SPICASCADE_V2  	ENABLE
...
({									\
	pr_err("ILITEK:[INFO] (%s, %d): " fmt, __func__, __LINE__, ##arg);	\
})									\
...
do {									\
	if (debug_en)						\
	pr_err("ILITEK:[DBG] (%s, %d): " fmt, __func__, __LINE__, ##arg);	\
} while (0)
...
//#define TDDI_DEV_ID				    "tchip,ilitek"
#define TDDI_DEV_ID				    "ILITEK_TDDI"

#define ILITEK_ILI7807S                "ili7807s"
#define ILITEK_ILI77600A               "ili77600a"
#define ILITEK_ILI7807S_PANEL          "tianma"
...
#define CMD_MODE_EN_REG					0x06202C
...
extern int ilitek_tp_module_flage;
