...
#ifndef CONFIG_TOUCHSCREEN_HIMAX_IC_HX83112F
#define CONFIG_TOUCHSCREEN_HIMAX_IC_HX83112F
#endif
...
#define D(x...) pr_err("[HXTP][D] " x)
#define I(x...) pr_err("[HXTP][I] " x)
#define W(x...) pr_err("[HXTP][W] " x)
#define E(x...) pr_err("[HXTP][E] " x)
#define DIF(x...) \
do { \
	if (debug_flag) \
...
#define HIMAX_CARDCTL_FILENAME_BOE "hx83112f_BOE_mp.csv"
#define HIMAX_CARDCTL_FILENAME_TXD "hx83112f_TXD_mp.csv"

extern char *himax_mp_card_control_file_name;
extern int himax_tp_module_flage;
extern bool TP_usb_plugged_in_flag;

enum HX83112F_TP_MODULE {
	HX83112F_TXD = 0,
	HX83112F_BOE
};
