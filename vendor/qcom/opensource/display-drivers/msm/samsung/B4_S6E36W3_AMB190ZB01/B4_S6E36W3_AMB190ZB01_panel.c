 ...
 *
*/
#include "B4_S6E36W3_AMB190ZB01_panel.h"
#include "B4_S6E36W3_AMB190ZB01_mdnie.h"
...
static int dsi_update_mdnie_data(struct samsung_display_driver_data *vdd)
{
	...
	mdnie_data->DSI_RGB_SENSOR_MDNIE_3 = RGB_SENSOR_MDNIE_2;
	mdnie_data->DSI_TRANS_DIMMING_MDNIE = RGB_SENSOR_MDNIE_2;
