...
*/
#include "E2_S6E3FAC_AMB655AY01_panel.h"
#include "E2_S6E3FAC_AMB655AY01_mdnie.h"
...
static int update_analog1_E2_S6E3FAC_AMB655AY01(
			struct samsung_display_driver_data *vdd,
...
static int update_analog2_E2_S6E3FAC_AMB655AY01(
			struct samsung_display_driver_data *vdd,
			char *val, struct ss_cmd_desc *cmd)
{
	int i = -1;
...
static int update_analog3_E2_S6E3FAC_AMB655AY01(
			struct samsung_display_driver_data *vdd,
			char *val, struct ss_cmd_desc *cmd)
{
	int i = -1;
...
static int update_aor_E2_S6E3FAC_AMB655AY01(struct samsung_display_driver_data *vdd,
			char *val, struct ss_cmd_desc *cmd)
{
	struct cmd_ref_state *state = &vdd->cmd_ref_state;
	int cur_rr = state->cur_refresh_rate;
...
void E2_S6E3FAC_AMB655AY01_FHD_init(struct samsung_display_driver_data *vdd)
{
	...
	vdd->h_buf = E2_S6E3FAC_AMB655AY01_PDF_DATA;
	vdd->h_size = sizeof(E2_S6E3FAC_AMB655AY01_PDF_DATA);
	...
	register_op_sym_cb(vdd, "AOR", update_aor_E2_S6E3FAC_AMB655AY01, true);
#if 0
	register_op_sym_cb(vdd, "ANALOG_OFFSET_1",
			update_analog1_E2_S6E3FAC_AMB655AY01, true);
	register_op_sym_cb(vdd, "ANALOG_OFFSET_2",
			update_analog2_E2_S6E3FAC_AMB655AY01, true);
	register_op_sym_cb(vdd, "ANALOG_OFFSET_3",
			update_analog3_E2_S6E3FAC_AMB655AY01, true);
#endif
	update_glut_map(vdd);
}
