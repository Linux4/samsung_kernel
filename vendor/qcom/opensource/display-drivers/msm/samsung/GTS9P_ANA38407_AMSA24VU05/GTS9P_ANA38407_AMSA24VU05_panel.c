...
#include "GTS9P_ANA38407_AMSA24VU05_panel.h"
#include "GTS9P_ANA38407_AMSA24VU05_mdnie.h"
...
void GTS9P_ANA38407_AMSA24VU05_WQXGA_init(struct samsung_display_driver_data *vdd)
{
	...
	//vdd->debug_data->print_cmds = true; //Release this for test
	...
	vdd->h_buf = GTS9P_ANA38407_AMSA24VU05_PDF_DATA;
	vdd->h_size = sizeof(GTS9P_ANA38407_AMSA24VU05_PDF_DATA);
	...
	LCD_INFO(vdd, "GTS9P_ANA38407_AMSA24VU05 : --\n");
}
