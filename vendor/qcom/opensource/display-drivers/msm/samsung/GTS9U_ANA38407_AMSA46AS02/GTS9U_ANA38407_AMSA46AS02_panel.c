...
#include "GTS9U_ANA38407_AMSA46AS02_panel.h"
#include "GTS9U_ANA38407_AMSA46AS02_mdnie.h"
...
static int samsung_panel_on_post(struct samsung_display_driver_data *vdd)
{
	...
	/* Tab S9 Ultra FW Update Panel Target LCD_ID = 0x800003 ~ 0x800004 */
...
void GTS9U_ANA38407_AMSA46AS02_WQXGA_init(struct samsung_display_driver_data *vdd)
{
	...
	vdd->h_buf = GTS9U_ANA38407_AMSA46AS02_PDF_DATA;
	vdd->h_size = sizeof(GTS9U_ANA38407_AMSA46AS02_PDF_DATA);
	...
	LCD_INFO(vdd, "GTS9U_ANA38407_AMSA46AS02 : ---\n");
}
