...
*/
#include "GTS8_NT36523_TL109BVMS2_panel.h"

static int ss_buck_control_ex(struct samsung_display_driver_data *vdd)
{ /* isl98608 */
	u8 buf[2] = {0, 0};
...
void GTS8_NT36523_TL109BVMS2_WQXGA_init(struct samsung_display_driver_data *vdd)
{
	...
	/* BLIC, BUCK control */
	vdd->panel_func.samsung_buck_control = ss_buck_control_ex;
