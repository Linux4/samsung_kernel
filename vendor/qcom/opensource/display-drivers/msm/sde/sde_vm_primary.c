...
static int _sde_vm_reclaim(struct sde_kms *sde_kms)
{
	...
	/*M55 code for P240111-04942 by hehaoran at 20240121 start*/
	atomic_set(&sde_kms->trusted_display_enabled, 0);
	/*M55 code for P240111-04942 by hehaoran at 20240121 end*/
end:
	return rc;
}
...
static int _sde_vm_release(struct sde_kms *kms)
{
	...
	/*M55 code for P240111-04942 by hehaoran at 20240121 start*/
	atomic_set(&kms->trusted_display_enabled, 1);
	/*M55 code for P240111-04942 by hehaoran at 20240121 end*/
	goto done;
