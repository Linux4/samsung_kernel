...
#include "imgsensor_otp_front_hi1337fu.h"
 
#define FRONT_HI1337FU_MAX_CAL_SIZE               (0x04E6 + 0x0026)
#define FRONT_HI1337FU_HEADER_CHECKSUM_LEN        (0x004B - 0x0000 + 0x1)
#define FRONT_HI1337FU_MODULE_DATA_CHECKSUM_LEN   (0x04C8 - 0x0050)

#define FRONT_HI1337FU_CONVERTED_MAX_CAL_SIZE     (0x087F + 0x1)
#define FRONT_HI1337FU_CONVERTED_AWB_CHECKSUM_LEN (0x006B - 0x0060 + 0x1)
#define FRONT_HI1337FU_CONVERTED_LSC_CHECKSUM_LEN (0x07CB - 0x0070 + 0x1)
...
const struct imgsensor_vendor_rom_addr front_hi1337fu_cal_addr = {
	...
	.rom_module_checksum_len                = (FRONT_HI1337FU_MODULE_DATA_CHECKSUM_LEN),
