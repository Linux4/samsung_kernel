...
#define REAR2_HI847_MAX_CAL_SIZE               (0x04E6 + 0x0026)
#define REAR2_HI847_HEADER_CHECKSUM_LEN        (0x004C)
#define REAR2_HI847_MODULE_DATA_CHECKSUM_LEN   (0x04C8 - 0x0050)

#define REAR2_HI847_CONVERTED_MAX_CAL_SIZE     (0x087F + 0x1) 
#define REAR2_HI847_CONVERTED_AWB_CHECKSUM_LEN (0x006B - 0x0060 + 0x1)
#define REAR2_HI847_CONVERTED_LSC_CHECKSUM_LEN (0x07CB - 0x0070 + 0x1)

const struct rom_converted_cal_addr rear2_hi847_converted_cal_addr = {
	.rom_awb_cal_data_start_addr     = 0x0050,
	.rom_awb_checksum_addr           = 0x006C,
	.rom_awb_checksum_len            = REAR2_HI847_CONVERTED_AWB_CHECKSUM_LEN,
	.rom_shading_cal_data_start_addr = 0x0070,
	.rom_shading_checksum_addr       = 0x07CC,
	.rom_shading_checksum_len        = REAR2_HI847_CONVERTED_LSC_CHECKSUM_LEN,
};

const struct imgsensor_vendor_rom_addr rear2_hi847_cal_addr = {
	/* Set '-1' if not used */

	.camera_module_es_version               = 'A',
	.cal_map_es_version                     = '1',
	.rom_max_cal_size                       = REAR2_HI847_MAX_CAL_SIZE,
	...
	.rom_header_checksum_len                = (REAR2_HI847_HEADER_CHECKSUM_LEN),
	...
	.rom_module_checksum_addr               = 0x04C8,
	.rom_module_checksum_len                = (REAR2_HI847_MODULE_DATA_CHECKSUM_LEN),
	...
	.rom_shading_cal_data_start_addr        = 0x005A,
	...
	.converted_cal_addr                     = &rear2_hi847_converted_cal_addr,
	.rom_converted_max_cal_size             = REAR2_HI847_CONVERTED_MAX_CAL_SIZE,
