...
#define FRONT_HI1337F_MAX_CAL_SIZE               (0x11CF + 0x1)

#define FRONT_HI1337F_HEADER_CHECKSUM_LEN        (0x007B - 0x0000 + 0x1)
#define FRONT_HI1337F_MODULE_CAL_DATA_CHECKSUM_LEN        (0x04EB - 0x0080 + 0x1)

#define FRONT_HI1337F_CONVERTED_MAX_CAL_SIZE     (0x153F + 0x1)
#define FRONT_HI1337F_CONVERTED_AWB_CHECKSUM_LEN (0x009B - 0x0090 + 0x1)
#define FRONT_HI1337F_CONVERTED_LSC_CHECKSUM_LEN (0x07FB - 0x00A0 + 0x1)

const struct rom_converted_cal_addr front_hi1337f_converted_cal_addr = {
	.rom_awb_cal_data_start_addr            = 0x0080,
	.rom_awb_checksum_addr                  = 0x009C,
	.rom_awb_checksum_len                   = (FRONT_HI1337F_CONVERTED_AWB_CHECKSUM_LEN),
	.rom_shading_cal_data_start_addr        = 0x00A0,
	.rom_shading_checksum_addr              = 0x07FC,
	.rom_shading_checksum_len               = (FRONT_HI1337F_CONVERTED_LSC_CHECKSUM_LEN),
};

const struct imgsensor_vendor_rom_addr front_hi1337f_cal_addr = {
	/* Set '-1' if not used */
	.camera_module_es_version               = 'A',
	.cal_map_es_version                     = '1',
	.rom_max_cal_size                       = FRONT_HI1337F_MAX_CAL_SIZE,
	.rom_header_cal_data_start_addr         = 0x00,
	.rom_header_main_module_info_start_addr = 0x1A,
	...
	.rom_header_checksum_len                = FRONT_HI1337F_HEADER_CHECKSUM_LEN,
	...
	.rom_module_cal_data_start_addr         = 0x0080,
	.rom_module_module_info_start_addr      = -1,
	.rom_module_checksum_addr               = 0x04EC,
	.rom_module_checksum_len                = FRONT_HI1337F_MODULE_CAL_DATA_CHECKSUM_LEN,
	...
	.rom_shading_cal_data_start_addr        = 0x008B,
	...
	.converted_cal_addr                     = &front_hi1337f_converted_cal_addr,
	.rom_converted_max_cal_size             = FRONT_HI1337F_CONVERTED_MAX_CAL_SIZE,
