...
********************************************************************************
*/
static int consys_clk_get_from_dts_mt6895(struct platform_device *pdev);
static int consys_clock_buffer_ctrl_mt6895(unsigned int enable);
static unsigned int consys_soc_chipid_get_mt6895(void);
static void consys_clock_fail_dump_mt6895(void);
static unsigned int consys_get_hw_ver_mt6895(void);
static int consys_thermal_query_mt6895(void);
...
struct consys_hw_ops_struct g_consys_hw_ops_mt6895 = {
	/* load from dts */
	/* TODO: mtcmos should move to a independent module */
	.consys_plt_clk_get_from_dts = consys_clk_get_from_dts_mt6895,

	/* clock */
	.consys_plt_clock_buffer_ctrl = consys_clock_buffer_ctrl_mt6895,
	.consys_plt_co_clock_type = consys_co_clock_type_mt6895,

	/* POS */
	.consys_plt_conninfra_on_power_ctrl = consys_conninfra_on_power_ctrl_mt6895,
	.consys_plt_set_if_pinmux = consys_set_if_pinmux_mt6895,

	.consys_plt_polling_consys_chipid = consys_polling_chipid_mt6895,
	.consys_plt_d_die_cfg = connsys_d_die_cfg_mt6895,
	.consys_plt_spi_master_cfg = connsys_spi_master_cfg_mt6895,
	.consys_plt_a_die_cfg = connsys_a_die_cfg_mt6895,
	.consys_plt_afe_wbg_cal = connsys_afe_wbg_cal_mt6895,
	.consys_plt_afe_sw_patch = connsys_afe_sw_patch_mt6895,
	.consys_plt_subsys_pll_initial = connsys_subsys_pll_initial_mt6895,
	.consys_plt_low_power_setting = connsys_low_power_setting_mt6895,
	.consys_plt_soc_chipid_get = consys_soc_chipid_get_mt6895,
	.consys_plt_conninfra_wakeup = consys_conninfra_wakeup_mt6895,
	.consys_plt_conninfra_sleep = consys_conninfra_sleep_mt6895,
	.consys_plt_is_rc_mode_enable = consys_is_rc_mode_enable_mt6895,

	/* debug */
	.consys_plt_clock_fail_dump = consys_clock_fail_dump_mt6895,
	.consys_plt_get_hw_ver = consys_get_hw_ver_mt6895,

	.consys_plt_spi_read = consys_spi_read_mt6895,
	.consys_plt_spi_write = consys_spi_write_mt6895,
	.consys_plt_spi_update_bits = consys_spi_update_bits_mt6895,
	.consys_plt_spi_clock_switch = consys_spi_clock_switch_mt6895,
	.consys_plt_subsys_status_update = consys_subsys_status_update_mt6895,
...
extern struct consys_reg_mng_ops g_dev_consys_reg_ops_mt6895;
extern struct consys_platform_emi_ops g_consys_platform_emi_ops_mt6895;
extern struct consys_platform_pmic_ops g_consys_platform_pmic_ops_mt6895;
extern struct consys_platform_coredump_ops g_consys_platform_coredump_ops_mt6895;

const struct conninfra_plat_data mt6895_plat_data = {
	.chip_id = PLATFORM_SOC_CHIP,
	.consys_hw_version = CONN_HW_VER,
	.hw_ops = &g_consys_hw_ops_mt6895,
	.reg_ops = &g_dev_consys_reg_ops_mt6895,
	.platform_emi_ops = &g_consys_platform_emi_ops_mt6895,
	.platform_pmic_ops = &g_consys_platform_pmic_ops_mt6895,
	.platform_coredump_ops = &g_consys_platform_coredump_ops_mt6895,
...
int consys_clk_get_from_dts_mt6895(struct platform_device *pdev)
{
...
int consys_platform_spm_conn_ctrl_mt6895(unsigned int enable)
{
	int ret = 0;
...
int consys_clock_buffer_ctrl_mt6895(unsigned int enable)
{
...
unsigned int consys_soc_chipid_get_mt6895(void)
{
	return PLATFORM_SOC_CHIP;
}

void consys_clock_fail_dump_mt6895(void)
{
...
int consys_enable_power_dump_mt6895(void)
{
...
{
	memcpy(&g_consys_plat_therm_data, input, sizeof(struct consys_plat_thermal_data_mt6895));
}

#define PRINT_THERMAL_LOG 0
static int calculate_thermal_temperature(int y)
{
	struct consys_plat_thermal_data_mt6895 *data = &g_consys_plat_therm_data;
	int t;
	int const_offset = 30;
...
int consys_thermal_query_mt6895(void)
{
...
#define CONN_GPT2_CTRL_AP_EN	0x38
	...
	if (addr == NULL) {
		pr_notice("GPT2_CTRL_BASE remap fail");
		return -1;
	}
	...
	if (consys_sema_acquire_timeout_mt6895(CONN_SEMA_THERMAL_INDEX, CONN_SEMA_TIMEOUT) == CONN_SEMA_GET_FAIL) {
		pr_notice("[THERM QRY] Require semaphore fail\n");
	...
	consys_sema_release_mt6895(CONN_SEMA_THERMAL_INDEX);
	connsys_adie_top_ck_en_ctl_mt6895(false);
...
static int consys_pre_cal_backup_mt6895(unsigned int offset, unsigned int size)
{
	...
	pr_info("[%s] emi base=0x%x offset=0x%x size=%d", __func__, g_con_emi_phy_base, offset, size);
