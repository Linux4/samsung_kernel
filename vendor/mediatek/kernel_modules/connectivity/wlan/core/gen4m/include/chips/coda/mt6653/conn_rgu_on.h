//[File]            : conn_rgu_on.h
//[Revision time]   : Tue Jul 19 19:30:14 2022
...
#define CONN_RGU_ON_ECC_CTRL_MEM_HWCTL_PDN_ADDR                (CONN_RGU_ON_BASE + 0x0A8) // 00A8
#define CONN_RGU_ON_ECC_CTRL_MEM_SWCTL_PDN_ADDR                (CONN_RGU_ON_BASE + 0x0AC) // 00AC
#define CONN_RGU_ON_ECC_CTRL_MEM_SWCTL_ISOINT_ADDR             (CONN_RGU_ON_BASE + 0x0B0) // 00B0
...
#define CONN_RGU_ON_ECC_CTRL_MEM_PDN_ST_ADDR                   (CONN_RGU_ON_BASE + 0x470) // 0470
#define CONN_RGU_ON_ECC_CTRL_MEM_ISOINT_ST_ADDR                (CONN_RGU_ON_BASE + 0x474) // 0474
...
/* =====================================================================================
  ...
  ---ECC_CTRL_MEM_HWCTL_PDN (0x18000000 + 0x0A8)---

    ECC_CTRL_MEM_HWCTL_PDN[0]    - (RW) 0: power-on/power-down control by S/W CR *_SWCTL_*
                                     1: power-on/power-down control by H/W
    RESERVED1[31..1]             - (RO) Reserved bits

 =====================================================================================*/
#define CONN_RGU_ON_ECC_CTRL_MEM_HWCTL_PDN_ECC_CTRL_MEM_HWCTL_PDN_ADDR CONN_RGU_ON_ECC_CTRL_MEM_HWCTL_PDN_ADDR
#define CONN_RGU_ON_ECC_CTRL_MEM_HWCTL_PDN_ECC_CTRL_MEM_HWCTL_PDN_MASK 0x00000001                // ECC_CTRL_MEM_HWCTL_PDN[0]
#define CONN_RGU_ON_ECC_CTRL_MEM_HWCTL_PDN_ECC_CTRL_MEM_HWCTL_PDN_SHFT 0

/* =====================================================================================

  ---ECC_CTRL_MEM_SWCTL_PDN (0x18000000 + 0x0AC)---

    ECC_CTRL_MEM_SWCTL_PDN[0]    - (RW) 0: power-down=0
                                     1: power-down=1
    RESERVED1[31..1]             - (RO) Reserved bits

 =====================================================================================*/
#define CONN_RGU_ON_ECC_CTRL_MEM_SWCTL_PDN_ECC_CTRL_MEM_SWCTL_PDN_ADDR CONN_RGU_ON_ECC_CTRL_MEM_SWCTL_PDN_ADDR
#define CONN_RGU_ON_ECC_CTRL_MEM_SWCTL_PDN_ECC_CTRL_MEM_SWCTL_PDN_MASK 0x00000001                // ECC_CTRL_MEM_SWCTL_PDN[0]
#define CONN_RGU_ON_ECC_CTRL_MEM_SWCTL_PDN_ECC_CTRL_MEM_SWCTL_PDN_SHFT 0

/* =====================================================================================

  ---ECC_CTRL_MEM_SWCTL_ISOINT (0x18000000 + 0x0B0)---

    ECC_CTRL_MEM_SWCTL_ISOINT[0] - (RW) 0: isoint=0
                                     1: isoint=1
    RESERVED1[31..1]             - (RO) Reserved bits

 =====================================================================================*/
#define CONN_RGU_ON_ECC_CTRL_MEM_SWCTL_ISOINT_ECC_CTRL_MEM_SWCTL_ISOINT_ADDR CONN_RGU_ON_ECC_CTRL_MEM_SWCTL_ISOINT_ADDR
#define CONN_RGU_ON_ECC_CTRL_MEM_SWCTL_ISOINT_ECC_CTRL_MEM_SWCTL_ISOINT_MASK 0x00000001                // ECC_CTRL_MEM_SWCTL_ISOINT[0]
#define CONN_RGU_ON_ECC_CTRL_MEM_SWCTL_ISOINT_ECC_CTRL_MEM_SWCTL_ISOINT_SHFT 0
...
/* =====================================================================================
  ...
  ---WFSYS_WM_WDT_EN (0x18000000 + 0x100)---
    ...
    WFSYS_WM_WDT_RESET_ENABLE[3..0] - (RW) WFSYS WM WDT reset to CONN_INFRA, WFSYS and BGFSYS enable, disable
                                     ...
                                     [3]
                                     0: disable WFSYS WM WDT reset to iiiCONN_INFRAiii (SUBSYS only)
                                     1: enable WFSYS WM WDT reset to iiiCONN_INFRAiii (SUBSYS only)
                                     [2]
                                     0: disable WFSYS WM WDT reset to iiiBGFSYSiii
                                     1: enable WFSYS WM WDT reset to iiiBGFSYSiii
                                     [1]
                                     0: disable WFSYS WM WDT reset to iiiWFSYSiii
                                     1: enable WFSYS WM WDT reset to iiiWFSYSiii
                                     [0]
                                     0: disable WFSYS WM WDT reset to iiiCONN_INFRAiii
                                     1: enable WFSYS WM WDT reset to iiiCONN_INFRAiii
    RESERVED4[31..4]             - (RO) Reserved bits
...
/* =====================================================================================
  ...
  ---WFSYS_WA_WDT_EN (0x18000000 + 0x104)---
    ...
    WFSYS_WA_WDT_RESET_ENABLE[3..0] - (RW) WFSYS WA WDT reset to CONN_INFRA, WFSYS and BGFSYS enable, disable
                                     Note that these 3-bit CR do not be reset by WDT reset, they are reset by power-on reset only
                                     [3]
                                     0: disable WFSYS WA WDT reset to iiiCONN_INFRAiii (SUBSYS only)
                                     1: enable WFSYS WA WDT reset to iiiCONN_INFRAiii (SUBSYS only)
                                     [2]
                                     0: disable WFSYS WA WDT reset to iiiBGFSYSiii
                                     1: enable WFSYS WA WDT reset to iiiBGFSYSiii
                                     [1]
                                     0: disable WFSYS WA WDT reset to iiiWFSYSiii
                                     1: enable WFSYS WA WDT reset to iiiWFSYSiii
                                     [0]
                                     0: disable WFSYS WA WDT reset to iiiCONN_INFRAiii
                                     1: enable WFSYS WA WDT reset to iiiCONN_INFRAiii
    RESERVED4[31..4]             - (RO) Reserved bits
...
/* =====================================================================================
  ...
  ---ECC_CTRL_MEM_PDN_ST (0x18000000 + 0x470)---

    ECC_CTRL_MEM_PDN_ST[0]       - (RO) 0: power-down=0
                                     1: power-down=1
    RESERVED1[31..1]             - (RO) Reserved bits

 =====================================================================================*/
#define CONN_RGU_ON_ECC_CTRL_MEM_PDN_ST_ECC_CTRL_MEM_PDN_ST_ADDR CONN_RGU_ON_ECC_CTRL_MEM_PDN_ST_ADDR
#define CONN_RGU_ON_ECC_CTRL_MEM_PDN_ST_ECC_CTRL_MEM_PDN_ST_MASK 0x00000001                // ECC_CTRL_MEM_PDN_ST[0]
#define CONN_RGU_ON_ECC_CTRL_MEM_PDN_ST_ECC_CTRL_MEM_PDN_ST_SHFT 0

/* =====================================================================================

  ---ECC_CTRL_MEM_ISOINT_ST (0x18000000 + 0x474)---

    ECC_CTRL_MEM_ISOINT_ST[0]    - (RO) 0: isoint=0
                                     1: isoint=1
    RESERVED1[31..1]             - (RO) Reserved bits

 =====================================================================================*/
#define CONN_RGU_ON_ECC_CTRL_MEM_ISOINT_ST_ECC_CTRL_MEM_ISOINT_ST_ADDR CONN_RGU_ON_ECC_CTRL_MEM_ISOINT_ST_ADDR
#define CONN_RGU_ON_ECC_CTRL_MEM_ISOINT_ST_ECC_CTRL_MEM_ISOINT_ST_MASK 0x00000001                // ECC_CTRL_MEM_ISOINT_ST[0]
#define CONN_RGU_ON_ECC_CTRL_MEM_ISOINT_ST_ECC_CTRL_MEM_ISOINT_ST_SHFT 0
