...
#define CONNAC3X_RX_VT_NSTS_MASK		BITS(7, 10)
#define CONNAC3X_RX_VT_NSTS_OFFSET		7
#define CONNAC3X_RX_VT_BEAMFORMED_MASK		BIT(11)
#define CONNAC3X_RX_VT_BEAMFORMED_OFFSET	11
#define CONNAC3X_RX_VT_LDPC_MASK		BIT(12)
#define CONNAC3X_RX_VT_LDPC_OFFSET		12
