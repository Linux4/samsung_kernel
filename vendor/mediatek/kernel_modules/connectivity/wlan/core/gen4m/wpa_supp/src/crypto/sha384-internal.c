...
/* This is based on SHA384 implementation in LibTomCrypt that was released */
/* into public domain by Tom St Denis. */
...
int
sha384_process(struct sha384_state *md, const unsigned char *in,
	       unsigned long inlen) {
 ...
 */
int
sha384_done(struct sha384_state *md, unsigned char *out) {
