...
#define CONFIG_CRYPTO_INTERNAL 1 /*add by Jerry*/
...
#ifdef VERBOSE /* SAK */
void
SHAPrintContext(struct SHA1Context *context, char *msg) {
...
void
SHA1Init(struct SHA1Context *context) {
...
void
SHA1Update(struct SHA1Context *context, const void *_data, u32 len) {
	u32 i, j;
...
void
SHA1Final(unsigned char digest[20], struct SHA1Context *context) {
	u32 i;
