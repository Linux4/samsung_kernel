...
static struct map_desc exynos7580_iodesc[] __initdata = {
	{
		...
		.virtual	= (unsigned long)EXYNOS7580_VA_SYSREG_ISP,
		.pfn		= __phys_to_pfn(EXYNOS7580_PA_SYSREG_ISP),
		.length		= SZ_8K,
		.type		= MT_DEVICE,
	}, {
		.virtual	= (unsigned long)S5P_VA_FIMCLITE0,
		.pfn		= __phys_to_pfn(EXYNOS7580_PA_FIMC_BNSA),
		.length		= SZ_4K,
		.type		= MT_DEVICE,
	}, {
		.virtual	= (unsigned long)S5P_VA_FIMCLITE1,
		.pfn		= __phys_to_pfn(EXYNOS7580_PA_FIMC_BNSB),
		.length		= SZ_4K,
		.type		=  MT_DEVICE,
	}, {
		.virtual	= (unsigned long)S5P_VA_MIPICSI0,
		.pfn		= __phys_to_pfn(EXYNOS7580_PA_MIPI_CSIS0),
		.length		= SZ_4K,
		.type		= MT_DEVICE,
	}, {
		.virtual	= (unsigned long)S5P_VA_MIPICSI1,
		.pfn		= __phys_to_pfn(EXYNOS7580_PA_MIPI_CSIS1),
		.length		= SZ_4K,
		.type		= MT_DEVICE,
	}, {
