...
extern unsigned int register_match_abb(enum asv_type_id target_type, unsigned int target_freq);
...
#else
static inline unsigned int register_match_abb(enum asv_type_id target_type, unsigned int target_freq)
{return 0;}
