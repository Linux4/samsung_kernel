...
#define EXYNOS7420_REV_0	(0x0)
#define EXYNOS7420_REV_1_0	(0x10)
#define EXYNOS7420_REV_1_1	(0x11)
#define EXYNOS7420_REV_1_2	(0x12)

#if defined(CONFIG_SOC_EXYNOS7580)
# define soc_is_exynos7580()	is_samsung_exynos7580()
bool is_exynos7580_ver1(void);
# define soc_is_exynos7580_v1()	is_exynos7580_ver1()
#else
# define soc_is_exynos7580()	0
#endif

#define EXYNOS7580_REV_0	(0x0)
#define EXYNOS7580_REV_0_1	(0x01)
