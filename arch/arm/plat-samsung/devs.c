...
#elif defined(CONFIG_MACH_ESPRESSO3250) || defined(CONFIG_MACH_UNIVERSAL3472)
#if defined(CONFIG_ESPRESSO_REV0_0)
	[4] = DEFINE_RES_IRQ(IRQ_EINT(31)),
#elif defined(CONFIG_ESPRESSO_REV0_1)
	[4] = DEFINE_RES_IRQ(IRQ_EINT(4)),
#endif
#endif
};
