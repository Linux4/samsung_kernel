...
struct esd_det_info {
	...
	int poll_preiod;/* Interval for  polling time*/
	int irq_cnt_nums;/* verification count times of irq*/
	...
	bool (*is_active)(void);	/* device activated */
