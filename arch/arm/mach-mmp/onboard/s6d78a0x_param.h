...
#define S6D78A0X_DISP_ON_DELAY (10)
...
static u8 s6d78a0x_es2_reg_B5h[] = {
	0xB5,
	0x10
};
...
static u8 s6d78a0x_es2_reg_36h[] = {0x36, 0x18};
...
static u8 s6d78a0x_es2_reg_FAh[] = {
	0xFA,
	0x25, 0x38, 0x26, 0x26, 0x1F,
	0x19, 0x1D, 0x1F, 0x1F, 0x23,
	0x1E, 0x1F, 0x29, 0x25, 0x38,
	0x26, 0x26, 0x1F, 0x19, 0x1D,
	0x1F, 0x1F, 0x23, 0x1E, 0x1F,
	0x29, 0x25, 0x38, 0x26, 0x26,
	0x1F, 0x19, 0x1D, 0x1F, 0x1F,
	0x23, 0x1E, 0x1F, 0x29,
};

static u8 s6d78a0x_es2_reg_FBh[] = {
	0xFB,
	0x0B, 0x3C, 0x2E, 0x2E, 0x25,
	0x1F, 0x23, 0x1F, 0x1B, 0x19,
	0x0E, 0x09, 0x0F, 0x0B, 0x3C,
	0x2E, 0x2E, 0x25, 0x1F, 0x23,
	0x1F, 0x1B, 0x19, 0x0E, 0x09,
	0x0F, 0x0B, 0x3C, 0x2E, 0x2E,
	0x25, 0x1F, 0x23, 0x1F, 0x1B,
	0x19, 0x0E, 0x09, 0x0F,
};
...
static struct dsi_cmd_desc s6d78a0x_es2_video_display_init_cmds[] = {
	...
	{DSI_DI_DCS_SWRITE1, HS_MODE, 0, sizeof(s6d78a0x_es2_reg_B5h), s6d78a0x_es2_reg_B5h},
...
static struct dsi_cmd_desc s6d78a0x_video_sleep_out_cmds[] = {
	{DSI_DI_DCS_SWRITE1, HS_MODE, /*S6D78A0X_SLEEP_OUT_DELAY*/0, sizeof(exit_sleep),exit_sleep},
};

static struct dsi_cmd_desc s6d78a0x_video_display_on_cmds[] = {
	{DSI_DI_DCS_SWRITE1, HS_MODE, /*S6D78A0X_DISP_ON_DELAY*/0, sizeof(display_on),display_on},
};

static struct dsi_cmd_desc s6d78a0x_video_display_off_cmds[] = {
	{DSI_DI_DCS_SWRITE1, HS_MODE, /*S6D78A0X_DISP_OFF_DELAY*/0, sizeof(display_off),display_off},
};

static struct dsi_cmd_desc s6d78a0x_video_sleep_in_cmds[] = {
	{DSI_DI_DCS_SWRITE1, HS_MODE, /*S6D78A0X_SLEEP_IN_DELAY*/0, sizeof(enter_sleep),enter_sleep},
};
