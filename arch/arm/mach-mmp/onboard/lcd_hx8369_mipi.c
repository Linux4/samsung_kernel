...
#ifdef  CONFIG_MACH_CS02 || CONFIG_MACH_GOLDEN
...
static struct pxa168fb_mach_info mipi_lcd_info = {
	...
	.phy_init = dsi_init,
	.phy_info = &dsiinfo,
#if defined(CONFIG_MACH_ARUBA_TD) || defined(CONFIG_MACH_CS02) || defined(CONFIG_MACH_GOLDEN)
	.width = 52,
	.height = 86,
#else
	.width = 61,
...
#if defined CONFIG_MACH_CS02 || defined CONFIG_MACH_GOLDEN
