...
static int usb_phy_init_internal(void __iomem *base)
{
	...
	writew(DRV_SLEWRATE(0x2) | IMP_CAL_DLY(0x2) |
		...
		&phy->utmi_tx_reg2);
#if defined(CONFIG_MACH_CS02) || defined(CONFIG_MACH_WILCOX) || defined(CONFIG_MACH_GOYA) || defined(CONFIG_MACH_DEGA)
	...
	writew(PHASE_FREEZE_DLY | ACQ_LENGTH(0x2) | SQ_LENGTH(0x2) |
		DISCON_THRESH(0x2) | SQ_THRESH(0x6) | INTPI(0x1),
		&phy->utmi_rx_reg0);
#elif defined(CONFIG_MACH_CS05)
	writew(PHASE_FREEZE_DLY | ACQ_LENGTH(0x2) | SQ_LENGTH(0x2) |
		DISCON_THRESH(0x2) | SQ_THRESH(0xe) | INTPI(0x1),
		&phy->utmi_rx_reg0);
#else
	writew(PHASE_FREEZE_DLY | ACQ_LENGTH(0x2) | SQ_LENGTH(0x2) |
