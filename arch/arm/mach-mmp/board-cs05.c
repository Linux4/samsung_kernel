...
static unsigned long helandkb_pin_config[] __initdata = {
	...
	GPIO003_GPIO_3 | MFP_LPM_INPUT | MFP_PULL_FLOAT, /* PRJ_ON_HOTKEY */
	
	GPIO004_GPIO_4  | MFP_PULL_LOW | MFP_LPM_DRIVE_LOW, /* PRJ_ON */
	// QL uses dedicated power & external pull up. make them float
	GPIO005_GPIO_5 | MFP_PULL_LOW | MFP_LPM_DRIVE_LOW, /* MPR_I2C0_SCL */
	GPIO006_GPIO_6 | MFP_PULL_LOW | MFP_LPM_DRIVE_LOW, /* MPR_I2C0_SDL */
...
#define GPIO010_ACC_INT		(GPIO010_GPIO_10 | MFP_PULL_LOW | MFP_LPM_INPUT)
	GPIO08_CHG_STAT,
	GPIO009_GPIO_9 | MFP_LPM_INPUT | MFP_PULL_HIGH, /* NC */
	GPIO010_ACC_INT,
...
#define GPIO018_LCD_RESET		GPIO018_GPIO_18 | MFP_PULL_LOW | MFP_LPM_DRIVE_LOW
...
#define GPIO017_CHG_SDA	(GPIO017_GPIO_17 | MFP_PULL_HIGH )
	...
	GPIO030_GPIO_30 | MFP_PULL_LOW | MFP_LPM_DRIVE_LOW,
	GPIO031_GPIO_31 |MFP_LPM_INPUT | MFP_PULL_LOW, /* FLM */

#define GPIO032_HW_REV_MOD_2            (GPIO032_GPIO_32 | MFP_PULL_FLOAT)

	GPIO032_HW_REV_MOD_2,

	// CAM LDO Control. Leave them as GPIO out control
	GPIO033_GPIO_33 | MFP_PULL_LOW ,
	GPIO034_GPIO_34 | MFP_PULL_LOW , /*LOW -> TO VX*/
...
#define GPIO051_WLAN_PD		(GPIO051_GPIO_51 | MFP_PULL_FLOAT)
...
#define GPIO081_GPIO_VT_CAM_RST		(GPIO081_GPIO_81 | MFP_PULL_LOW | MFP_LPM_DRIVE_LOW)
#define GPIO082_GPIO_VT_CAM_EN	(GPIO082_GPIO_82 | MFP_PULL_LOW | MFP_LPM_DRIVE_LOW)
#define GPIO083_GPIO_HOST_WU_WLAN	(GPIO083_GPIO_83 | MFP_PULL_LOW | MFP_LPM_DRIVE_LOW)
...
#define GPIO125_VX6B3E_RESET	(GPIO125_VCXO_REQ | MFP_PULL_LOW | MFP_LPM_DRIVE_LOW)
	...
	MMC1_WP_MMC1_WP | MFP_LPM_INPUT | MFP_PULL_HIGH, /* NC */
...
//	GPIO127_GPIO_127 | MFP_PULL_HIGH | MFP_LPM_DRIVE_LOW,
	SM_BEN1_GPIO_127 | MFP_PULL_LOW | MFP_LPM_DRIVE_LOW, 

	SM_CSN0_GPIO_103 | MFP_LPM_INPUT | MFP_PULL_HIGH, /* NC */
...
//	SM_RDY_GPIO_3 | MFP_PULL_HIGH | MFP_LPM_FLOAT,
	...
	ND_IO12_ND_DAT12 | MFP_PULL_LOW,
	ND_IO11_ND_DAT11 | MFP_PULL_LOW,
...
|| defined(CONFIG_SENSORS_BMA254) \
|| defined(CONFIG_SENSORS_ACCELOMETER_BMA25X)
...
#elif defined(CONFIG_BACKLIGHT_GENERIC)    
...
static struct sdhci_pxa_platdata pxa988_sdh_platdata_mmc3 = {
	...
	.host_caps2 = MMC_CAP2_CACHE_CTRL,
	.quirks2	= SDHCI_QUIRK2_BUS_CLK_GATE_ENABLED,
...
static struct rt8547_platform_data rt8547_pdata = {
	...
	.timeout_current = TIMEOUT_CURRENT_100MA,
};
