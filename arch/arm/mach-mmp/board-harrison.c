...
static unsigned long emeidkb_pin_config[] __initdata = {
	...
	GPIO004_GPIO_4,			/* 	MOT_EN */
	GPIO005_GPIO_5,			/* 	VSYS_OK */
	GPIO006_GPIO_6,			/* 	AP_AGPS_RESETn	*/
	GPIO007_GPIO_7,			/* AP_AGPS_ONOFF */
	GPIO008_GPIO_8,			/* FET_EN */
#define GPIO09_LCD_BL_CTRL		GPIO009_GPIO_9 | MFP_LPM_DRIVE_LOW

	GPIO09_LCD_BL_CTRL,
	GPIO010_GPIO_10,		/* ACC_INT */
	GPIO011_GPIO_11,		/* 3G_DCDC_EN */
	GPIO012_GPIO_12,		/* COM_DET */
	GPIO013_KP_DKIN4,
	GPIO014_GPIO_14,		/* 5M_CAM_STBY */
	GPIO015_GPIO_15,		/* 5M_CAM_RST */
	GPIO016_GPIO_16,		/* GPIO SCL */
	GPIO017_GPIO_17,		/* GPIO SDA */
	GPIO018_GPIO_18,		/* LVDS_RST */
	GPIO019_GPIO_19,		/* LCD_EN */
	GPIO020_GPIO_20,		/* HP MUTE */
	...
	GPIO031_GPIO_31,		/* BOOT MODE */
	GPIO032_GPIO_32,		/* HW_REVE_MODE */

	GPIO033_GPIO_33,		/* CHG_STS */
	GPIO034_GPIO_34,		/* WLAN_BT_RESET */
	GPIO035_GPIO_35,		/* SNSR_I2C_SCL */
	GPIO036_GPIO_36,		/* SNSR_I2C_SDA */
...
#define GPIO050_GPIO_BARA_INT1	GPIO050_GPIO_50
	...
	GPIO081_GPIO_81,		/* CAM_VGA_nSTBY */
	GPIO082_GPIO_82,		/* CAM_VGA_nRST */	

	GPIO083_GPIO_83,		/* HOST_WU_WLAN */
	GPIO084_GPIO_84,		/* WLAN_WU_HOST */

	GPIO085_GPIO_85,		/* HW_REV_MOD1 */
	GPIO086_GPIO_86,		/* HW_REV_MOD0 */
	...
	GPIO090_GPIO_90,	/* TFLASH_DETECT */

	GPIO091_GPIO_91,	/* JACK2AP_INT_N */
	GPIO092_GPIO_92,	/* PROXI INT */
	GPIO093_GPIO_93,	/* MUIC INT */
	GPIO094_GPIO_94,	/* TSP INT */
	GPIO095_GPIO_95,	/* FEUL ALERT */

	GPIO096_GPIO_96,	/* KEY LED EN */
	GPIO097_GPIO_97,	/* LCD BL EN */
	GPIO098_GPIO_98,	/* CHG_EN */
	CLK_REQ_GPIO_123,	/* WLAN PD */
	GPIO124_GPIO_124,	/* CODEC_INTN */
				...
				struct pm80x_platform_data *pdata)
{
	...
	/* LDO enable 0x51, 0x52, 0x53, LDO1, 3, 5, 7, 16,17,18,19 */
	regmap_write(chip->subchip->regmap_power, 0x51, 0x54);
	regmap_write(chip->subchip->regmap_power, 0x52, 0x80);
...
#endif
#if defined(CONFIG_CHARGER_SMB358)
static struct smb358_platform_data  smb358_charger_info = {
	.cd = mfp_to_gpio(GPIO098_GPIO_98),
...
static struct i2c_board_info emeidkb_pwr_i2c_info[] = {
	...
	{ 
		.type		= "smb358",
		.addr		= 0x6A,
		.platform_data	= &smb358_charger_info,
		.irq		= MMP_GPIO_TO_IRQ(mfp_to_gpio(GPIO033_GPIO_33)), 
	},
#endif
};
...
static struct i2c_gpio_platform_data i2c_stc3115_bus_data = {
    .sda_pin = mfp_to_gpio(MFP_PIN_GPIO52),
	  .scl_pin = mfp_to_gpio(MFP_PIN_GPIO51),
	  .udelay  = 3,  //// brian :3
	  .timeout = 100,
};
...
#define MFP_WIB_PDn		(CLK_REQ_GPIO_123 | MFP_PULL_FLOAT)
...
#define MFP_RF_EN              GPIO011_GPIO_11
static int harrison_enable_RF(void)
{
...
static void __init emeidkb_init(void)
{
	...
	pxa988_add_pwm(4);
       platform_device_register(&harrison_lcd_backlight_devices);
