...
#elif defined(CONFIG_MACH_WILCOX) || defined(CONFIG_MACH_DEGA) || defined(CONFIG_MACH_BAFFINQ)
...
#elif defined(CONFIG_MACH_CS02) || defined(CONFIG_MACH_GOLDEN) || defined(CONFIG_MACH_GOYA)
