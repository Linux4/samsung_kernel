...
#endif
#if defined(CONFIG_SM5414_CHARGER)
#include <mach/sm5414_charger.h>
#endif
...
#define GPIO004_AP_AGPS_ONOFF	(GPIO004_GPIO_4 | MFP_PULL_LOW)
	GPIO004_AP_AGPS_ONOFF,
...
//	GPIO005_GPIO_5 | MFP_LPM_FLOAT, /* MPR_I2C0_SCL */
	GPIO006_GPIO_6 | MFP_PULL_FLOAT | MFP_LPM_DRIVE_LOW,
	GPIO007_GPIO_7 | MFP_PULL_FLOAT | MFP_LPM_DRIVE_LOW,
...
#define GPIO051_WLAN_PD		(GPIO051_GPIO_51)
	...
	GPIO078_CAM_PCLK | MFP_PULL_LOW | MFP_LPM_DRIVE_LOW,
...
#define GPIO089_AP_AGPS_CLK_DIS		(GPIO089_GPIO_89 | MFP_PULL_LOW) // GPIO089_GPS_CLK, <= Disable GPS Eclk because of noise(spur).
...
static unsigned long irda_pin_config[] __initdata = {
	GPIO031_GPIO_31 | MFP_LPM_INPUT | MFP_PULL_LOW,
	GPIO098_GPIO_98 | MFP_LPM_INPUT | MFP_PULL_LOW,
	SM_CSN0_GPIO_103 | MFP_LPM_INPUT | MFP_PULL_LOW,
	SM_CSN1_GPIO_104 | MFP_LPM_INPUT | MFP_PULL_LOW,
	SM_BEN0_GPIO126 | MFP_LPM_INPUT | MFP_PULL_LOW,
	SM_BEN1_GPIO_127 | MFP_LPM_INPUT | MFP_PULL_LOW,
};
...
static struct regulator_consumer_supply regulator_supplies[] = {
	...
	[PM822_ID_LDO11] = REGULATOR_SUPPLY("vmmc",  "sdhci-pxav3.0"),
...
static struct regulator_init_data pm822_regulator_data[] = {
	...
	[PM822_ID_LDO11] = REG_INIT(LDO11, 1200000, 3300000, 0, 0),
				...
				struct pm822_platform_data *pdata)
{
	...
	/* Set Bias current fo GPADC1 as 31uA) */
	regmap_read(chip->subchip->regmap_gpadc, PM822_GPADC_BIAS2, &data);
	data = (data & 0xf) | 0x6;
	regmap_write(chip->subchip->regmap_gpadc, PM822_GPADC_BIAS2, data);
...
#endif //CONFIG_SENSORS_GRIP_SX9500
/* End of SENSOR */
...
static void gps_power_on(void)
{
	...
	gps_on = mfp_to_gpio(GPIO004_AP_AGPS_ONOFF);
...
*/
 ...
 || defined(CONFIG_SENSORS_GP2A_PROXIMITY)
	...
	mfp_config(ARRAY_AND_SIZE(irda_pin_config));
