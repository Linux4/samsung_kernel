/* arch/arm/mach-mmp/board-degas-battery.c
 *
...
static sec_charging_current_t charging_current_table[] = {
	...
	{950,  1500,   350,    1800},     /* POWER_SUPPLY_TYPE_MAINS */
	{450,   650,    250,    1800},     /* POWER_SUPPLY_TYPE_USB */
	{550,   500,    250,    1800},     /* POWER_SUPPLY_TYPE_USB_DCP */
	{550,   500,    250,    1800},     /* POWER_SUPPLY_TYPE_USB_CDP */
	{550,   500,    250,    1800},     /* POWER_SUPPLY_TYPE_USB_ACA */
	{550,   500,    250,   1800},     /* POWER_SUPPLY_TYPE_MISC */
	{0,     0,      0,      0},     /* POWER_SUPPLY_TYPE_CARDOCK */
	{550,   500,    250,    1800},     /* POWER_SUPPLY_TYPE_WPC */
	{1050,  1050,   250,    1800},     /* POWER_SUPPLY_TYPE_UARTOFF */
};
...
static bool sec_chg_gpio_init(void)
{
	...
	ret = gpio_request(mfp_to_gpio(GPIO020_GPIO_20), "sm5414_CD");
	if(ret)
		return false;
...
static int sec_bat_check_cable_callback(void)
{
	...
	nCHG_EN = gpio_get_value(mfp_to_gpio(GPIO020_GPIO_20));

	pr_info("%s : nCHG_EN : %d\n", __func__, nCHG_EN);

	// Logic needed to change, active low GPIO008_GPIO_8, almost always 1
	// check nCHG_EN (active low) instead to check if charger is enabled
	if (nCHG_EN)
		current_cable_type = POWER_SUPPLY_TYPE_BATTERY; //charger disabled
	else
		current_cable_type = POWER_SUPPLY_TYPE_MAINS;
#if 0
...
//	SEC_BATTERY_CABLE_SOURCE_EXTENDED,
	...
	.full_condition_type = SEC_BATTERY_FULLCHARGED_SOC |
...
void __init pxa986_degas_battery_init(void)
{
	pr_info("%s: degas charger init\n", __func__);
