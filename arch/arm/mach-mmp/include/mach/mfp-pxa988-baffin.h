...
#define GPIO089_GPS_ECLK		MFP_CFG(GPIO89, AF5)
...
#define MMC1_DAT3_MMC1_DAT3		MFP_CFG_DRV(MMC1_DAT3, AF0,DS01X)
#define MMC1_DAT2_MMC1_DAT2		MFP_CFG_DRV(MMC1_DAT2, AF0,DS01X)
#define MMC1_DAT1_MMC1_DAT1		MFP_CFG_DRV(MMC1_DAT1, AF0,DS01X)
#define MMC1_DAT0_MMC1_DAT0		MFP_CFG_DRV(MMC1_DAT0, AF0,DS01X)
#define MMC1_CMD_MMC1_CMD		MFP_CFG_DRV(MMC1_CMD, AF0,DS01X)
#define MMC1_CLK_MMC1_CLK		MFP_CFG_DRV(MMC1_CLK, AF0,DS01X)
