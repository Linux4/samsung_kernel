...
enum RT8547_TORCH_CURRENT{
	RT8547_TORCH_200MA = 2,
	RT8547_TORCH_300MA = 3,
	RT8547_TORCH_400MA = 4,
};
...
extern struct device *dev_r; // Used both s5k4ecgx_jcam.c and samsung_camera_cs05.c
extern struct device *dev_f; // Used both s5k4ecgx_jcam.c and samsung_camera_cs05.c
