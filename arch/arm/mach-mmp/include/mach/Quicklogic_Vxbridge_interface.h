...
int lcd_power(struct pxa168fb_info *fbi, unsigned int, unsigned int, int);
...
#else
#define MID_BRIGHTNESS_LEVEL		122
#endif
#define LOW_BRIGHTNESS_LEVEL		10
#define DIM_BRIGHTNESS_LEVEL		9
...
static struct Quicklogic_backlight_value backlight_table[2] = {
	{
	.max = 241,
	.mid = 122,
	.low = 10,
