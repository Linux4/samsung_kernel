...
struct pxa168fb_mipi_lcd_driver {
	...
	int (*init)(struct pxa168fb_info *);		/* before video on */
	int (*enable)(struct pxa168fb_info *);		/* before video on */
	int (*panel_start)(struct pxa168fb_info *);	/* after video on */
	int (*disable)(struct pxa168fb_info *);		/* before video off */
};
