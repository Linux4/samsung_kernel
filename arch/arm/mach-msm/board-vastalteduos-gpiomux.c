...
#define WLAN_DATA1	43
#define WLAN_DATA2	44
...
#if defined(CONFIG_MACH_VASTALTE_CHN_CMCC_DUOS)
static struct msm_gpiomux_config vasta_rev2_settings[] __initdata = {
	GPIOMUX_SET_NC(110),
	{
		.gpio = 38,
		.settings = {
...
static struct gpiomux_setting lcd_bl_i2c_cfg = {
	.func = GPIOMUX_FUNC_GPIO,
	.drv = GPIOMUX_DRV_2MA,
	.pull = GPIOMUX_PULL_NONE,
	.dir = GPIOMUX_IN,
...
static struct msm_gpiomux_config msm_lcd_configs[] __initdata = {
	{
		.gpio = 0,
		.settings = {
			[GPIOMUX_ACTIVE]    = &lcd_bl_i2c_cfg,
			[GPIOMUX_SUSPENDED] = &lcd_bl_i2c_cfg,
		},
	},
	{
		.gpio = 1,
...
static struct msm_gpiomux_config msm_lcd_configs_rev5[] __initdata = {
	{
		.gpio = 0,
		.settings = {
			[GPIOMUX_ACTIVE]    = &lcd_bl_i2c_cfg,
...
#ifdef CONFIG_MACH_VASTALTE_CHN_CMCC_DUOS
static struct gpiomux_setting qc_sim_slot_config = {
		.func = GPIOMUX_FUNC_GPIO,
		.drv  = GPIOMUX_DRV_2MA,
		.pull = GPIOMUX_PULL_DOWN,
		.dir  = GPIOMUX_OUT_LOW,
...
static struct gpiomux_setting ktd2026_i2c_config = {
		.func = GPIOMUX_FUNC_GPIO,
		.drv  = GPIOMUX_DRV_2MA,
		.pull = GPIOMUX_PULL_NONE,
		.dir  = GPIOMUX_IN,
...
static struct msm_gpiomux_config ktd2026_led_config[] __initdata = {
	{
		.gpio   = 118,           /* SVC_LED_SCL */
		.settings = {
			[GPIOMUX_ACTIVE]    = &ktd2026_i2c_config,
			[GPIOMUX_SUSPENDED] = &ktd2026_i2c_config,
	        },
	},
	{
		.gpio   = 117,           /* SVC_LED_SDA */
		.settings = {
			[GPIOMUX_ACTIVE]    = &ktd2026_i2c_config,
			[GPIOMUX_SUSPENDED] = &ktd2026_i2c_config,
	        },
...
static struct msm_gpiomux_config qc_sim_slot_switch_config[] __initdata = {
	{
		.gpio   = 75,           /* QC_SIM_SLOT_SWITCH */
		.settings = {
			[GPIOMUX_ACTIVE]    = &qc_sim_slot_config,
			[GPIOMUX_SUSPENDED] = &qc_sim_slot_config,
	        },
	},
};
#endif
...
static struct gpiomux_setting cam_settings[] = {
	...
	{
		.func = GPIOMUX_FUNC_GPIO, /*suspend*/ /* 13 */ //8
		.drv = GPIOMUX_DRV_2MA,
		.pull = GPIOMUX_PULL_NONE,
		.dir = GPIOMUX_IN,
	},
...
void __init msm8226_init_gpiomux(void)
{
...
#if defined(CONFIG_MACH_VASTALTE_CHN_CMCC_DUOS)
	if(system_rev < 3)
		msm_gpiomux_install(vasta_rev2_settings, ARRAY_SIZE(vasta_rev2_settings));
#endif
	...
	if (system_rev >= 5)
		msm_gpiomux_install_nowrite(msm_lcd_configs_rev5,ARRAY_SIZE(msm_lcd_configs_rev5));
	else
		msm_gpiomux_install_nowrite(msm_lcd_configs,ARRAY_SIZE(msm_lcd_configs));

#if defined(CONFIG_MACH_VASTALTE_CHN_CMCC_DUOS)
	msm_gpiomux_install(msm8226_qsc_ipc_configs_rev03,
		ARRAY_SIZE(msm8226_qsc_ipc_configs_rev03));
...
#if defined(CONFIG_MACH_VASTALTE_CHN_CMCC_DUOS)
       msm_gpiomux_install(ktd2026_led_config,
			        ARRAY_SIZE(ktd2026_led_config));
       msm_gpiomux_install(qc_sim_slot_switch_config,
			        ARRAY_SIZE(qc_sim_slot_switch_config));
#endif
}
