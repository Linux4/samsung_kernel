...
ifeq ($(CONFIG_MACH_MS01),y)
		...
		dtb-$(CONFIG_ARCH_MSM8226)	+= msm8926-sec-hlitesgltechn-r05.dtb
		dtb-$(CONFIG_ARCH_MSM8226)	+= msm8926-sec-hlitesgltechn-r08.dtb
		dtb-$(CONFIG_ARCH_MSM8226)	+= msm8926-sec-hlitesgltechn-r09.dtb
