...
static struct msm_gpiomux_config synaptics_lte_rev3_configs[] __initdata = {
...
#if defined(CONFIG_MACH_RUBENSLTE_OPEN)
	if(system_rev == 3)
		msm_gpiomux_install(synaptics_lte_rev3_configs,
			ARRAY_SIZE(synaptics_lte_rev3_configs));
#endif
