...
#if FIXED_AUDIO
	sci_glb_clr(REG_PMU_APB_MEM_PD_CFG0, BITS_AON_MEM_PD_CFG_VBC(3)); //AON_MEM_PD_CFG_VBC
	sci_glb_clr(REG_PMU_APB_MEM_PD_CFG0, BITS_AON_MEM_PD_CFG_AUD(3)); //AON_MEM_PD_CFG_AUD
#endif
#endif
	return 0;
}
...
#ifdef CONFIG_SND_SPRD_DIGITAL_FM
#if FIXED_AUDIO
	sci_glb_set(REG_PMU_APB_MEM_PD_CFG0, BITS_AON_MEM_PD_CFG_VBC(1)); //AON_MEM_PD_CFG_VBC
	sci_glb_set(REG_PMU_APB_MEM_PD_CFG0, BITS_AON_MEM_PD_CFG_AUD(1)); //AON_MEM_PD_CFG_AUD
#endif
#endif
	return 0;
}
