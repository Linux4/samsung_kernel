...
/* Kanas battery parameter version 20140209 */
...
static gain_table_prop rt5033_battery_suspend_param3[] =				/// 25oC in suspend mode
{
	{3300, 29, 42, 96, 5},
	{4300, 29, 42, 96, 5},
};

static gain_table_prop rt5033_battery_suspend_param4[] =				/// 45oC in suspend
{
	{3300, 15, 70, 111, 5},
	{4300, 15, 70, 111, 5},
};
...
{
	{
		...
		.param3_suspend = rt5033_battery_suspend_param3,
		.param3_size_suspend = sizeof(rt5033_battery_suspend_param3)/sizeof(gain_table_prop),
		.param4 = rt5033_battery_param4,
		.param4_size = sizeof(rt5033_battery_param4)/sizeof(gain_table_prop),
		.param4_suspend = rt5033_battery_suspend_param4,
		.param4_size_suspend = sizeof(rt5033_battery_suspend_param4)/sizeof(gain_table_prop),
...
static int gps_enable_control(int flag)
{
        ...
        if (flag && (!f_enabled)) {
#ifdef CONFIG_KANAS_HARDWARE_VERSION02
