		...
		unsigned char timing, struct mmc_host *mmc)
{
	...
	if (soc_is_exynos3250() || soc_is_exynos3472() || soc_is_exynos4415() ||
...
static void exynos_dwmci_cfg_smu(void *data, u32 action)
{
	...
	if ((!soc_is_exynos5420() && !soc_is_exynos5260() &&
				!soc_is_exynos4415() && !soc_is_exynos3250() && !soc_is_exynos3472()) || action != 0)
		return;
...
EXYNOS5_DWMCI_RESOURCE(2);
	...
	!defined(CONFIG_SOC_EXYNOS4415) && !defined(CONFIG_SOC_EXYNOS3250) && !defined(CONFIG_SOC_EXYNOS3472)
	...
	if ((soc_is_exynos4210()) || soc_is_exynos4212() ||
		...
		if (slot_id < ARRAY_SIZE(exynos5_dwmci_devs))
			...
			pr_err("%s: slot %d is not supported\n", __func__,
			       slot_id);
	} else if ((soc_is_exynos3250()) || soc_is_exynos3472() || soc_is_exynos4415()) {
