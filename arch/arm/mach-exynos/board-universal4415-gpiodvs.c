...
static u32 exynos4415_gpio_num[] = {
    EXYNOS4_GPA0(0),
    EXYNOS4_GPA0(1),
    EXYNOS4_GPA0(2),
    EXYNOS4_GPA0(3),
...
#define AP_GPIO_COUNT (sizeof(exynos4415_gpio_num)/sizeof(u32))
/****************************************************************/
...
{
	int gpio;
	gpio = exynos4415_gpio_num[gpionum];
