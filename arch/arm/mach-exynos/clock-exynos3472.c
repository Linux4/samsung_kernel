/* linux/arch/arm/mach-exynos/clock-exynos3472.c
 *
 * Copyright (c) 2010-2012 Samsung Electronics Co., Ltd.
 *		http://www.samsung.com
 *
 * EXYNOS3472 - Clock support
 *
...
/*
   will be called exynos3472_setup_clocks, ops should be set before this routine
...
#ifdef CONFIG_PM
static struct sleep_save exynos3472_clock_save[] = {
...
static struct sleep_save exynos3472_epll_save[] = {
	SAVE_ITEM(EXYNOS3_EPLL_LOCK),
	SAVE_ITEM(EXYNOS3_EPLL_CON0),
	SAVE_ITEM(EXYNOS3_EPLL_CON1),
};

static struct sleep_save exynos3472_vpll_save[] = {
...
static struct clksrc_clk exynos3_clk_sclk_epll_muxed = {
	...
	.reg_src_stat = { .reg = EXYNOS3_CLKMUX_STAT_TOP, .shift = 4, .size = 3 },
};

static struct clk *clk_src_mout_mpll_mif_list[] = {
	[0] = &clk_fin_mpll,
	[1] = &exynos3_clk_sclk_mpll_mif.clk,
};

struct clksrc_sources clk_src_mout_mpll_mif = {
	.sources	= clk_src_mout_mpll_mif_list,
	.nr_sources	= ARRAY_SIZE(clk_src_mout_mpll_mif_list),
};

static struct clksrc_clk exynos3_clk_mout_mpll_mif = {
	.clk	= {
		.name		= "mout_mpll_mif",
	},
	.sources = &clk_src_mout_mpll_mif,
	.reg_src = { .reg = EXYNOS3_CLKSRC_DMC, .shift = 12, .size = 1 },
	.reg_src_stat = { .reg = EXYNOS3_CLKMUX_STAT_DMC, .shift = 16, .size = 3 },
};
...
static struct clksrc_clk exynos3_clk_mout_vpll = {
	...
	.reg_src_stat = { .reg = EXYNOS3_CLKMUX_STAT_TOP, .shift = 8, .size = 3 },
};
...
static struct clk *clk_src_mpll_bpllin_list[] = {
	[0] = &exynos3_clk_mout_mpll_mif.clk,
...
static struct clksrc_clk exynos3_clk_dout_dmc_pre = {
	...
	.reg_src_stat = { .reg = EXYNOS3_CLKMUX_STAT_DMC, .shift = 4, .size = 3 },
...
static struct clksrc_clk exynos3_clk_sclk_dphy = {
	...
	.reg_src_stat = { .reg = EXYNOS3_CLKMUX_STAT_DMC, .shift = 8, .size = 3 },
...
static struct clksrc_clk exynos3_clk_mout_left_bus_user = {
	...
	.reg_src_stat = { .reg = EXYNOS3_CLKMUX_STAT_LEFTBUS, .shift = 4, .size = 3 },
};
...
static struct clksrc_clk exynos3_clk_aclk_gdl = {
	...
	.reg_src_stat = { .reg = EXYNOS3_CLKMUX_STAT_LEFTBUS, .shift = 0, .size = 3 },
...
static struct clksrc_clk exynos3_clk_mout_right_bus_user = {
	...
	.reg_src_stat = { .reg = EXYNOS3_CLKMUX_STAT_RIGHTBUS, .shift = 4, .size = 3 },
};
...
static struct clksrc_clk exynos3_clk_aclk_gdr = {
	...
	.reg_src_stat = { .reg = EXYNOS3_CLKMUX_STAT_RIGHTBUS, .shift = 0, .size = 3 },
...
static struct clksrc_clk exynos3_clk_aclk_200 = {
	...
	.reg_src_stat = { .reg = EXYNOS3_CLKMUX_STAT_TOP, .shift = 24, .size = 3 },
...
static struct clksrc_clk exynos3_clk_aclk_160 = {
	...
	.reg_src_stat = { .reg = EXYNOS3_CLKMUX_STAT_TOP, .shift = 20, .size = 3 },
...
static struct clksrc_clk exynos3_clk_aclk_100 = {
	...
	.reg_src_stat = { .reg = EXYNOS3_CLKMUX_STAT_TOP, .shift = 16, .size = 3 },
...
static struct clksrc_clk exynos3_clk_mout_ebi = {
	...
	.reg_src_stat = { .reg = EXYNOS3_CLKMUX_STAT_TOP, .shift = 28, .size = 3 },
};
...
static struct clksrc_clk exynos3_clk_sclk_ebi = {
	...
	.reg_src_stat = { .reg = EXYNOS3_CLKMUX_STAT_TOP, .shift = 0, .size = 3 },
...
static struct clksrc_clk exynos3_clk_mout_aclk_266_0 = {
	...
	.reg_src_stat = { .reg = EXYNOS3_CLKMUX_STAT_TOP1, .shift = 0, .size = 3 },
};
...
static struct clksrc_clk exynos3_clk_mout_aclk_266_1 = {
	...
	.reg_src_stat = { .reg = EXYNOS3_CLKMUX_STAT_TOP1, .shift = 4, .size = 3 },
};
...
static struct clksrc_clk exynos3_clk_dout_aclk_266 = {
	...
	.reg_src_stat = { .reg = EXYNOS3_CLKMUX_STAT_TOP1, .shift = 12, .size = 3 },
...
static struct clksrc_clk exynos3_clk_mout_mfc0 = {
	...
	.reg_src_stat = { .reg = EXYNOS3_CLKMUX_STAT_MFC, .shift = 0, .size = 3 },
};
...
static struct clksrc_clk exynos3_clk_mout_mfc1 = {
	...
	.reg_src_stat = { .reg = EXYNOS3_CLKMUX_STAT_MFC, .shift = 4, .size = 3 },
};
...
static struct clksrc_clk exynos3_clk_sclk_mfc = {
	...
	.reg_src_stat = { .reg = EXYNOS3_CLKMUX_STAT_MFC, .shift = 8, .size = 3 },
...
static struct clksrc_clk exynos3_clk_mout_g3d0 = {
	...
	.reg_src_stat = { .reg = EXYNOS3_CLKMUX_STAT_G3D, .shift = 0, .size = 3 },
};
...
static struct clksrc_clk exynos3_clk_mout_g3d1 = {
	...
	.reg_src_stat = { .reg = EXYNOS3_CLKMUX_STAT_G3D, .shift = 4, .size = 3 },
};
...
static struct clksrc_clk exynos3_clk_sclk_g3d = {
	...
	.reg_src_stat = { .reg = EXYNOS3_CLKMUX_STAT_G3D, .shift = 8, .size = 3 },
...
static struct clk exynos3_dma_clocks[] = {
	{
		.name		= "dma",
		.devname	= "dma-pl330.0",
...
static struct clk exynos3_init_clocks_off[] = {
	...
	/*TOP: G3D*/
	{
		.name		= "qe.g3d",
		.enable		= exynos3_clk_ip_g3d_ctrl,
		.parent		= &exynos3_clk_sclk_g3d.clk,
		.ctrlbit	= (1 << 2),
	},
	{
		.name		= "g3d.ppmu",
...
static struct clk_lookup exynos3_clk_lookup[] = {
	...
	CLKDEV_INIT("dma-pl330.0", "apb_pclk", &exynos3_dma_clocks[0]),
	CLKDEV_INIT("dma-pl330.1", "apb_pclk", &exynos3_dma_clocks[1]),
	CLKDEV_INIT("dma-pl330.2", "apb_pclk", &exynos3_dma_clocks[2]),
...
#ifdef CONFIG_PM
static int exynos3472_clock_suspend(void)
{
	s3c_pm_do_save(exynos3472_clock_save, ARRAY_SIZE(exynos3472_clock_save));
	s3c_pm_do_save(exynos3472_epll_save, ARRAY_SIZE(exynos3472_epll_save));
	s3c_pm_do_save(exynos3472_vpll_save, ARRAY_SIZE(exynos3472_vpll_save));

	return 0;
}

static void exynos3472_pll_wait_locktime(void __iomem *con_reg, int shift_value)
{
	unsigned int tmp;
...
static void exynos3472_clock_resume(void)
{
	s3c_pm_do_restore_core(exynos3472_clock_save, ARRAY_SIZE(exynos3472_clock_save));

	s3c_pm_do_restore_core(exynos3472_epll_save, ARRAY_SIZE(exynos3472_epll_save));
	s3c_pm_do_restore_core(exynos3472_vpll_save, ARRAY_SIZE(exynos3472_vpll_save));

	exynos3472_pll_wait_locktime(EXYNOS3_EPLL_CON0, EXYNOS3_PLLCON0_LOCKED_SHIFT);
	exynos3472_pll_wait_locktime(EXYNOS3_VPLL_CON0, EXYNOS3_PLLCON0_LOCKED_SHIFT);
	exynos3472_pll_wait_locktime(EXYNOS3_UPLL_CON0, EXYNOS3_PLLCON0_LOCKED_SHIFT);

	clk_fout_apll.rate = s5p_get_pll35xx(xtal_rate, __raw_readl(EXYNOS3_APLL_CON0));
}
#else
#define exynos3472_clock_suspend NULL
#define exynos3472_clock_resume NULL
#endif

struct syscore_ops exynos3_clock_syscore_ops = {
	.suspend	= exynos3472_clock_suspend,
	.resume		= exynos3472_clock_resume,
};

void __init_or_cpufreq exynos3472_setup_clocks(void)
{
...
void __init exynos3472_register_clocks(void)
{
	int ptr;
	...
	s3c_register_clocks(exynos3_dma_clocks, ARRAY_SIZE(exynos3_dma_clocks));
	s3c_disable_clocks(exynos3_dma_clocks, ARRAY_SIZE(exynos3_dma_clocks));
