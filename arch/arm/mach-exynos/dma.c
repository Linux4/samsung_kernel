...
static u8 exynos3472_pdma0_peri[] = {
	DMACH_MAX,
	DMACH_MAX,
	DMACH_PCM0_RX,
	DMACH_PCM0_TX,
...
static u8 exynos3472_pdma1_peri[] = {
	DMACH_MAX,
	DMACH_MAX,
	DMACH_MAX,
	DMACH_MAX,
...
static int __init exynos_dma_init(void)
{
	...
	if (soc_is_exynos4210()) {
		...
		exynos_pdma0_pdata.nr_valid_peri =
			ARRAY_SIZE(exynos3472_pdma0_peri);
		exynos_pdma0_pdata.peri_id = exynos3472_pdma0_peri;
		exynos_pdma1_pdata.nr_valid_peri =
			ARRAY_SIZE(exynos3472_pdma1_peri);
		exynos_pdma1_pdata.peri_id = exynos3472_pdma1_peri;
