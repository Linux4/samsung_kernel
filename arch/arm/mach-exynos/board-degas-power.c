...
static struct regulator_consumer_supply s2m_ldo29_consumer =
	REGULATOR_SUPPLY("vlcd_3v3", NULL);
...
static struct regulator_consumer_supply s2m_ldo32_consumer =
	REGULATOR_SUPPLY("vdd_tsp_2v8", NULL);
...
static struct sec_regulator_data exynos_regulators_rev02[] = {
...
struct sec_opmode_data s2mpu01a_opmode_data_rev02[S2MPU01A_REG_MAX] = {
...
static int sec_cfg_irq(void)
{
	...
	s3c_gpio_setpull(pin, S3C_GPIO_PULL_NONE); //ext pull up.
...
void __init exynos4_smdk4270_power_init(void)
{
	...
	i2c_register_board_info(0, i2c_devs0, ARRAY_SIZE(i2c_devs0));
        ...
        if( system_rev < 0x5 ){  /* Rev0.3 (0x05) */
                exynos4_s2m_pdata.num_regulators = ARRAY_SIZE(exynos_regulators_rev02);
                exynos4_s2m_pdata.regulators = exynos_regulators_rev02;
                exynos4_s2m_pdata.opmode_data = s2mpu01a_opmode_data_rev02;
        }
