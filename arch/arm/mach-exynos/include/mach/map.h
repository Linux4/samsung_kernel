...
#define EXYNOS3475_PA_PMU_LPI_ISP	0x144E0000
#define EXYNOS3475_PA_PMU_LPI_MIF	0x10440000
...
#define EXYNOS4_PA_SDRAM		0x20000000		// exynos3475
...
#define EXYNOS5433_PA_BTS_G3D0		0x14A00000
#define EXYNOS5433_PA_BTS_G3D1		0x14A20000
...
#define EXYNOS3475_VA_PMU_LPI_ISP	(S5P_VA_PMU + SZ_64K + (SZ_4K * 0))
#define EXYNOS3475_VA_PMU_LPI_MIF	(S5P_VA_PMU + SZ_64K + (SZ_4K * 1))
//#define EXYNOS3475_VA_SYSREG_CPU	(S5P_VA_PMU + SZ_64K + (SZ_4K * 2))
//#define EXYNOS3475_VA_SYSREG_G3D	(S5P_VA_PMU + SZ_64K + (SZ_4K * 3))

#define EXYNOS3475_PA_GPIO_ALIVE	0x139B0000
...
#define EXYNOS3475_PA_SYSREG_CPU		0x10910000
#define EXYNOS3475_PA_SYSREG_G3D		0x11450000

/* DISPAUD SYSREG ADDRESS */
#define EXYNOS3475_PA_SYSREG_DISP	0x14890000

/* CAMERA IP PA */
#define EXYNOS3475_PA_FIMC_BNS_L	0x14410000
#define EXYNOS3475_PA_MIPI_CSIS0	0x14420000
#define EXYNOS3475_PA_FIMC_ISP0		0x14400000
#define EXYNOS3475_PA_SCALER		0x14430000
#define EXYNOS3475_PA_FIMC_FD		0x14440000

#define EXYNOS3475_VA_CMU_TOP		(S5P_VA_CMU + (SZ_4K * 0))
#define EXYNOS3475_VA_CMU_MIF		(S5P_VA_CMU + (SZ_4K * 1)) /* SZ_8K */
#define EXYNOS3475_VA_CMU_CPU		(S5P_VA_CMU + (SZ_4K * 3)) /* SZ_8K */
#define EXYNOS3475_VA_CMU_IMEM		(S5P_VA_CMU + (SZ_4K * 5))
#define EXYNOS3475_VA_CMU_G3D		(S5P_VA_CMU + (SZ_4K * 6))
#define EXYNOS3475_VA_CMU_BUS0		(S5P_VA_CMU + (SZ_4K * 7))
#define EXYNOS3475_VA_CMU_MFCMSCL	(S5P_VA_CMU + (SZ_4K * 8))
#define EXYNOS3475_VA_CMU_BUS2		(S5P_VA_CMU + (SZ_4K * 9))
#define EXYNOS3475_VA_CMU_FSYS		(S5P_VA_CMU + (SZ_4K * 10))
#define EXYNOS3475_VA_CMU_PERI		(S5P_VA_CMU + (SZ_4K * 11))
#define EXYNOS3475_VA_CMU_ISP		(S5P_VA_CMU + (SZ_4K * 12))
#define EXYNOS3475_VA_CMU_DISPAUD	(S5P_VA_CMU + (SZ_4K * 13))

/* CAMERA IP SYSREG */
#define EXYNOS3475_PA_SYSREG_ISP	0x144F0000
