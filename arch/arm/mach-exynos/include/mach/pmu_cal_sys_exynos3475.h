...
#ifndef __PMU_CAL_SYS_EXYNOS3475_H__
#define __PMU_CAL_SYS_EXYNOS3475_H__
...
/* firmware only */
#include "Types.h"
#define PMU_BASE_ADDR	0x10460000
enum sys_powerdown {
	SYS_SICD,
	SYS_AFTR,
	SYS_LPD,
...
#define PMU_SYNC_CTRL                                   (PMU_BASE_ADDR + 0x0004)
#define SFR_ACCESS_CONTROL_REG                          (PMU_BASE_ADDR + 0x0008)
#define CLKREQ_PAD_CONTROL                              (PMU_BASE_ADDR + 0x000C)
#define CP_CTRL_NS                                      (PMU_BASE_ADDR + 0x0030)
#define CP_CTRL_S                                       (PMU_BASE_ADDR + 0x0034)
#define CP_STAT                                         (PMU_BASE_ADDR + 0x0038)
#define CP_DEBUG                                        (PMU_BASE_ADDR + 0x003C)
#define CP_DURATION                                     (PMU_BASE_ADDR + 0x0040)
#define CP_SEMAPHORE                                    (PMU_BASE_ADDR + 0x0044)
...
#define CENTRAL_SEQ_OPTION1                             (PMU_BASE_ADDR + 0x020C)
...
#define IDLE_IP0                                        (PMU_BASE_ADDR + 0x03E0)
#define IDLE_IP1                                        (PMU_BASE_ADDR + 0x03E4)
#define IDLE_IP2                                        (PMU_BASE_ADDR + 0x03E8)
#define IDLE_IP3                                        (PMU_BASE_ADDR + 0x03EC)
#define IDLE_IP0_MASK                                   (PMU_BASE_ADDR + 0x03F0)
#define IDLE_IP1_MASK                                   (PMU_BASE_ADDR + 0x03F4)
#define IDLE_IP2_MASK                                   (PMU_BASE_ADDR + 0x03F8)
#define IDLE_IP3_MASK                                   (PMU_BASE_ADDR + 0x03FC)
...
#define RESET_LPI_TIMEOUT                               (PMU_BASE_ADDR + 0x0420)
...
#define EINT_WAKEUP_MASK                                (PMU_BASE_ADDR + 0x0608)
#define WAKEUP_MASK                                     (PMU_BASE_ADDR + 0x060C)
#define WAKEUP_MASK2                                    (PMU_BASE_ADDR + 0x0610)
#define WAKEUP_INTERRUPT                                (PMU_BASE_ADDR + 0x0614)
...
#define MMC_CONWKUP_CTRL                                (PMU_BASE_ADDR + 0x0688)
...
#define UPACG_AT_CMU                                    (PMU_BASE_ADDR + 0x0790)
...
#define ACK_LAST_CPU                                    (PMU_BASE_ADDR + 0x0940)
...
#define PMUDBG_CPU_L2_STATUS                            (PMU_BASE_ADDR + 0x0F18)
#define PMUDBG_CPU_NONCPU_STATUS                        (PMU_BASE_ADDR + 0x0F1C)
...
#define RETENTION_CMU_TOP_SYS_PWR_REG                   (PMU_BASE_ADDR + 0x1108)
...
#define RETENTION_CMU_MIF_SYS_PWR_REG                   (PMU_BASE_ADDR + 0x1128)
#define RESET_CMU_MIF_SYS_PWR_REG                       (PMU_BASE_ADDR + 0x112C)
#define DDRPHY_CLKSTOP_SYS_PWR_REG                      (PMU_BASE_ADDR + 0x1130)
...
#define MEMORY_IMEM_ALIVEIRAM_SYS_PWR_REG               (PMU_BASE_ADDR + 0x11E0)
...
#define TCXO_SYS_PWR_REG                                (PMU_BASE_ADDR + 0x128C)
...
#define DISPAUD_SYS_PWR_REG                             (PMU_BASE_ADDR + 0x1410)
...
#define CLKRUN_CMU_DISPAUD_SYS_PWR_REG                  (PMU_BASE_ADDR + 0x1450)
...
#define CLKSTOP_CMU_DISPAUD_SYS_PWR_REG                 (PMU_BASE_ADDR + 0x1490)
...
#define DISABLE_PLL_CMU_DISPAUD_SYS_PWR_REG             (PMU_BASE_ADDR + 0x14D0)
...
#define RESET_LOGIC_DISPAUD_SYS_PWR_REG                 (PMU_BASE_ADDR + 0x1510)
...
#define RESET_CMU_DISPAUD_SYS_PWR_REG                   (PMU_BASE_ADDR + 0x1590)
...
#define RETENTION_CMU_TOP_CONFIGURATION                 (PMU_BASE_ADDR + 0x2840)
#define RETENTION_CMU_TOP_STATUS                        (PMU_BASE_ADDR + 0x2844)
#define RETENTION_CMU_TOP_OPTION                        (PMU_BASE_ADDR + 0x2848)
#define RETENTION_CMU_TOP_DURATION0                     (PMU_BASE_ADDR + 0x2850)
#define RETENTION_CMU_TOP_DURATION1                     (PMU_BASE_ADDR + 0x2854)
#define RETENTION_CMU_TOP_DURATION2                     (PMU_BASE_ADDR + 0x2858)
#define RETENTION_CMU_TOP_DURATION3                     (PMU_BASE_ADDR + 0x285C)
...
#define RETENTION_CMU_MIF_CONFIGURATION                 (PMU_BASE_ADDR + 0x2940)
#define RETENTION_CMU_MIF_STATUS                        (PMU_BASE_ADDR + 0x2944)
#define RETENTION_CMU_MIF_OPTION                        (PMU_BASE_ADDR + 0x2948)
#define RETENTION_CMU_MIF_DURATION0                     (PMU_BASE_ADDR + 0x2950)
#define RETENTION_CMU_MIF_DURATION1                     (PMU_BASE_ADDR + 0x2954)
#define RETENTION_CMU_MIF_DURATION2                     (PMU_BASE_ADDR + 0x2958)
#define RETENTION_CMU_MIF_DURATION3                     (PMU_BASE_ADDR + 0x295C)
...
#define DDRPHY_CLKSTOP_CONFIGURATION                    (PMU_BASE_ADDR + 0x2980)
#define DDRPHY_CLKSTOP_STATUS                           (PMU_BASE_ADDR + 0x2984)
#define DDRPHY_CLKSTOP_OPTION                           (PMU_BASE_ADDR + 0x2988)
#define DDRPHY_CLKSTOP_DURATION0                        (PMU_BASE_ADDR + 0x2990)
#define DDRPHY_CLKSTOP_DURATION1                        (PMU_BASE_ADDR + 0x2994)
#define DDRPHY_CLKSTOP_DURATION2                        (PMU_BASE_ADDR + 0x2998)
#define DDRPHY_CLKSTOP_DURATION3                        (PMU_BASE_ADDR + 0x299C)
...
#define DISABLE_PLL_CMU_TOP_DURATION3                   (PMU_BASE_ADDR + 0x2A1C)
...
#define DISABLE_PLL_AUD_PLL_DURATION3                   (PMU_BASE_ADDR + 0x2A3C)
...
#define CLEANY_BUS_CONFIGURATION                        (PMU_BASE_ADDR + 0x2E60)
#define CLEANY_BUS_STATUS                               (PMU_BASE_ADDR + 0x2E64)
#define CLEANY_BUS_OPTION                               (PMU_BASE_ADDR + 0x2E68)
#define CLEANY_BUS_DURATION0                            (PMU_BASE_ADDR + 0x2E70)
#define CLEANY_BUS_DURATION1                            (PMU_BASE_ADDR + 0x2E74)
#define CLEANY_BUS_DURATION2                            (PMU_BASE_ADDR + 0x2E78)
#define CLEANY_BUS_DURATION3                            (PMU_BASE_ADDR + 0x2E7C)
#define LOGIC_RESET_CP_CONFIGURATION                    (PMU_BASE_ADDR + 0x2E80)
#define LOGIC_RESET_CP_STATUS                           (PMU_BASE_ADDR + 0x2E84)
#define LOGIC_RESET_CP_OPTION                           (PMU_BASE_ADDR + 0x2E88)
#define LOGIC_RESET_CP_DURATION0                        (PMU_BASE_ADDR + 0x2E90)
#define LOGIC_RESET_CP_DURATION1                        (PMU_BASE_ADDR + 0x2E94)
#define LOGIC_RESET_CP_DURATION2                        (PMU_BASE_ADDR + 0x2E98)
#define LOGIC_RESET_CP_DURATION3                        (PMU_BASE_ADDR + 0x2E9C)
#define TCXO_GATE_CONFIGURATION                         (PMU_BASE_ADDR + 0x2EA0)
#define TCXO_GATE_STATUS                                (PMU_BASE_ADDR + 0x2EA4)
#define TCXO_GATE_OPTION                                (PMU_BASE_ADDR + 0x2EA8)
#define TCXO_GATE_DURATION0                             (PMU_BASE_ADDR + 0x2EB0)
#define TCXO_GATE_DURATION1                             (PMU_BASE_ADDR + 0x2EB4)
#define TCXO_GATE_DURATION2                             (PMU_BASE_ADDR + 0x2EB8)
#define TCXO_GATE_DURATION3                             (PMU_BASE_ADDR + 0x2EBC)
#define RESET_ASB_CP_CONFIGURATION                      (PMU_BASE_ADDR + 0x2EC0)
#define RESET_ASB_CP_STATUS                             (PMU_BASE_ADDR + 0x2EC4)
#define RESET_ASB_CP_OPTION                             (PMU_BASE_ADDR + 0x2EC8)
#define RESET_ASB_CP_DURATION0                          (PMU_BASE_ADDR + 0x2ED0)
#define RESET_ASB_CP_DURATION1                          (PMU_BASE_ADDR + 0x2ED4)
#define RESET_ASB_CP_DURATION2                          (PMU_BASE_ADDR + 0x2ED8)
#define RESET_ASB_CP_DURATION3                          (PMU_BASE_ADDR + 0x2EDC)
#define RESET_ASB_MIF_CONFIGURATION                     (PMU_BASE_ADDR + 0x2EE0)
#define RESET_ASB_MIF_STATUS                            (PMU_BASE_ADDR + 0x2EE4)
#define RESET_ASB_MIF_OPTION                            (PMU_BASE_ADDR + 0x2EE8)
#define RESET_ASB_MIF_DURATION0                         (PMU_BASE_ADDR + 0x2EF0)
#define RESET_ASB_MIF_DURATION1                         (PMU_BASE_ADDR + 0x2EF4)
#define RESET_ASB_MIF_DURATION2                         (PMU_BASE_ADDR + 0x2EF8)
#define RESET_ASB_MIF_DURATION3                         (PMU_BASE_ADDR + 0x2EFC)
#define MEMORY_IMEM_ALIVEIRAM_CONFIGURATION             (PMU_BASE_ADDR + 0x2F00)
#define MEMORY_IMEM_ALIVEIRAM_STATUS                    (PMU_BASE_ADDR + 0x2F04)
#define MEMORY_IMEM_ALIVEIRAM_OPTION                    (PMU_BASE_ADDR + 0x2F08)
#define MEMORY_IMEM_ALIVEIRAM_DURATION0                 (PMU_BASE_ADDR + 0x2F10)
#define MEMORY_IMEM_ALIVEIRAM_DURATION1                 (PMU_BASE_ADDR + 0x2F14)
#define MEMORY_IMEM_ALIVEIRAM_DURATION2                 (PMU_BASE_ADDR + 0x2F18)
#define MEMORY_IMEM_ALIVEIRAM_DURATION3                 (PMU_BASE_ADDR + 0x2F1C)
...
#define PAD_RETENTION_USBXTI_CONFIGURATION              (PMU_BASE_ADDR + 0x32A0)
#define PAD_RETENTION_USBXTI_STATUS                     (PMU_BASE_ADDR + 0x32A4)
#define PAD_RETENTION_USBXTI_OPTION                     (PMU_BASE_ADDR + 0x32A8)
#define PAD_RETENTION_USBXTI_DURATION0                  (PMU_BASE_ADDR + 0x32B0)
#define PAD_RETENTION_USBXTI_DURATION1                  (PMU_BASE_ADDR + 0x32B4)
#define PAD_RETENTION_USBXTI_DURATION2                  (PMU_BASE_ADDR + 0x32B8)
#define PAD_RETENTION_USBXTI_DURATION3                  (PMU_BASE_ADDR + 0x32BC)
...
#define TCXO_CONFIGURATION                              (PMU_BASE_ADDR + 0x3460)
#define TCXO_STATUS                                     (PMU_BASE_ADDR + 0x3464)
#define TCXO_OPTION                                     (PMU_BASE_ADDR + 0x3468)
#define TCXO_DURATION0                                  (PMU_BASE_ADDR + 0x3470)
#define TCXO_DURATION1                                  (PMU_BASE_ADDR + 0x3474)
#define TCXO_DURATION2                                  (PMU_BASE_ADDR + 0x3478)
#define TCXO_DURATION3                                  (PMU_BASE_ADDR + 0x347C)
...
#define DISPAUD_CONFIGURATION                           (PMU_BASE_ADDR + 0x4080)
#define DISPAUD_STATUS                                  (PMU_BASE_ADDR + 0x4084)
#define DISPAUD_OPTION                                  (PMU_BASE_ADDR + 0x4088)
#define DISPAUD_DURATION0                               (PMU_BASE_ADDR + 0x4090)
#define DISPAUD_DURATION1                               (PMU_BASE_ADDR + 0x4094)
#define DISPAUD_DURATION2                               (PMU_BASE_ADDR + 0x4098)
#define DISPAUD_DURATION3                               (PMU_BASE_ADDR + 0x409C)
...
#define CLKRUN_CMU_DISPAUD_CONFIGURATION                (PMU_BASE_ADDR + 0x4280)
#define CLKRUN_CMU_DISPAUD_STATUS                       (PMU_BASE_ADDR + 0x4284)
#define CLKRUN_CMU_DISPAUD_OPTION                       (PMU_BASE_ADDR + 0x4288)
#define CLKRUN_CMU_DISPAUD_DURATION0                    (PMU_BASE_ADDR + 0x4290)
#define CLKRUN_CMU_DISPAUD_DURATION1                    (PMU_BASE_ADDR + 0x4294)
#define CLKRUN_CMU_DISPAUD_DURATION2                    (PMU_BASE_ADDR + 0x4298)
#define CLKRUN_CMU_DISPAUD_DURATION3                    (PMU_BASE_ADDR + 0x429C)
...
#define CLKSTOP_CMU_DISPAUD_CONFIGURATION               (PMU_BASE_ADDR + 0x4480)
#define CLKSTOP_CMU_DISPAUD_STATUS                      (PMU_BASE_ADDR + 0x4484)
#define CLKSTOP_CMU_DISPAUD_OPTION                      (PMU_BASE_ADDR + 0x4488)
#define CLKSTOP_CMU_DISPAUD_DURATION0                   (PMU_BASE_ADDR + 0x4490)
#define CLKSTOP_CMU_DISPAUD_DURATION1                   (PMU_BASE_ADDR + 0x4494)
#define CLKSTOP_CMU_DISPAUD_DURATION2                   (PMU_BASE_ADDR + 0x4498)
#define CLKSTOP_CMU_DISPAUD_DURATION3                   (PMU_BASE_ADDR + 0x449C)
...
#define DISABLE_PLL_CMU_G3D_DURATION3                   (PMU_BASE_ADDR + 0x467C)
#define DISABLE_PLL_CMU_DISPAUD_CONFIGURATION           (PMU_BASE_ADDR + 0x4680)
#define DISABLE_PLL_CMU_DISPAUD_STATUS                  (PMU_BASE_ADDR + 0x4684)
#define DISABLE_PLL_CMU_DISPAUD_OPTION                  (PMU_BASE_ADDR + 0x4688)
#define DISABLE_PLL_CMU_DISPAUD_DURATION0               (PMU_BASE_ADDR + 0x4690)
#define DISABLE_PLL_CMU_DISPAUD_DURATION1               (PMU_BASE_ADDR + 0x4694)
#define DISABLE_PLL_CMU_DISPAUD_DURATION2               (PMU_BASE_ADDR + 0x4698)
#define DISABLE_PLL_CMU_DISPAUD_DURATION3               (PMU_BASE_ADDR + 0x469C)
...
#define DISABLE_PLL_CMU_ISP_DURATION3                   (PMU_BASE_ADDR + 0x475C)
...
#define DISABLE_PLL_CMU_MFCMSCL_DURATION3               (PMU_BASE_ADDR + 0x479C)
...
#define RESET_LOGIC_DISPAUD_CONFIGURATION               (PMU_BASE_ADDR + 0x4880)
#define RESET_LOGIC_DISPAUD_STATUS                      (PMU_BASE_ADDR + 0x4884)
#define RESET_LOGIC_DISPAUD_OPTION                      (PMU_BASE_ADDR + 0x4888)
#define RESET_LOGIC_DISPAUD_DURATION0                   (PMU_BASE_ADDR + 0x4890)
#define RESET_LOGIC_DISPAUD_DURATION1                   (PMU_BASE_ADDR + 0x4894)
#define RESET_LOGIC_DISPAUD_DURATION2                   (PMU_BASE_ADDR + 0x4898)
#define RESET_LOGIC_DISPAUD_DURATION3                   (PMU_BASE_ADDR + 0x489C)
...
#define RESET_CMU_DISPAUD_CONFIGURATION                 (PMU_BASE_ADDR + 0x4C80)
#define RESET_CMU_DISPAUD_STATUS                        (PMU_BASE_ADDR + 0x4C84)
#define RESET_CMU_DISPAUD_OPTION                        (PMU_BASE_ADDR + 0x4C88)
#define RESET_CMU_DISPAUD_DURATION0                     (PMU_BASE_ADDR + 0x4C90)
#define RESET_CMU_DISPAUD_DURATION1                     (PMU_BASE_ADDR + 0x4C94)
#define RESET_CMU_DISPAUD_DURATION2                     (PMU_BASE_ADDR + 0x4C98)
#define RESET_CMU_DISPAUD_DURATION3                     (PMU_BASE_ADDR + 0x4C9C)
...
#define NFC_CLK_CTRL                                    (PMU_BASE_ADDR + 0x6008)
#define AP_DVS_CTRL                                     (PMU_BASE_ADDR + 0x6200)
#define CP_DVS_CTRL                                     (PMU_BASE_ADDR + 0x6300)
#define CP_DVS_STATUS                                   (PMU_BASE_ADDR + 0x6304)
#define CP_DVS_COUNTER                                  (PMU_BASE_ADDR + 0x6308)
#define IRQ_SELECTION                                   (PMU_BASE_ADDR + 0x6800)

extern bool is_cp_aud_enabled(void);
#endif /* __PMU_CAL_SYS_EXYNOS3475_H__ */
