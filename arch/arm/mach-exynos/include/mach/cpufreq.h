...
/* EMA_UP_VALUE(4) target volt less than equal to 0.9V */
#define EMA_UP_VOLT		900000
/* EMA_DOWN_VALUE(1) target volt greater than equal 1.1V */
#define EMA_DOWN_VOLT		1100000
#define COLD_VOLT_OFFSET	50000
#endif

#if defined(CONFIG_ARCH_EXYNOS3)
#if defined(CONFIG_ARM_EXYNOS3250_CPUFREQ) || defined(CONFIG_ARM_EXYNOS3472_CPUFREQ)
#define COLD_VOLT_OFFSET        50000
#endif
