...
#if defined(CONFIG_SOC_EXYNOS5433) || defined(CONFIG_SOC_EXYNOS3475)
...
#define SDMMC_DATA(x)		(x)
	...
	defined(CONFIG_SOC_EXYNOS5433) || defined(CONFIG_SOC_EXYNOS3475)
...
#define DWMCI_MPSECURITY_NSKEYREG		BIT(15)
#define DWMCI_MPSECURITY_USEOTPMASK		BIT(12)
#endif

/* FMP DISK KEY */
#if defined(CONFIG_SOC_EXYNOS3475)
#define SDMMC_MPDEK0				(SDMMC_EMMCP_BASE + 0x20)
#define SDMMC_MPDTK0 				(SDMMC_EMMCP_BASE + 0x40)
#define MAX_DISK_KEY_SIZE			64
#endif
