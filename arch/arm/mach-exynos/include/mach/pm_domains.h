...
#ifdef CONFIG_SOC_EXYNOS3472
#define EXYNOS_GPD(PD, BASE, NAME, ON, OFF, CALLBACKON, CALLBACKOFF, INTERRUPT, BTS)	\
...
#ifdef CONFIG_SOC_EXYNOS3472
#define EXYNOS3472_COMMON_GPD(PD, BASE, NAME, BTS)					\
	EXYNOS_GPD(PD,									\
		BASE,									\
		NAME,									\
...
#ifdef CONFIG_SOC_EXYNOS3472
#define NUM_OF_PD       5
struct exynos_pm_domain *exynos3472_pm_domain(int index);
#endif
