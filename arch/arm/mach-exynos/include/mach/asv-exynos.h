...
static inline  void add_asv_member(struct asv_info *exynos_asv_info) {}
static inline struct asv_info *asv_get(enum asv_type_id exynos_asv_type_id) {return 0;}
static inline unsigned int exynos_get_asv_info(int id) {return 0;}
static inline unsigned int get_match_volt(enum asv_type_id target_type, unsigned int target_freq) {return 0;}
...
static inline unsigned int get_sub_grp_match_asv_grp(enum asv_type_id target_type, unsigned int lv) {return 0;}
