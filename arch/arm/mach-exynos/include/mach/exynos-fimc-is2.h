/* linux/arch/arm/mach-exynos/include/mach/exynos-fimc-is2.h
 *
 * Copyright (C) 2011 Samsung Electronics, Co. Ltd
 *
 * Exynos 5 series FIMC-IS2 slave device support
 *
 * This program is free software; you can redistribute it and/or modify
 * it under the terms of the GNU General Public License version 2 as
 * published by the Free Software Foundation.
 */
#ifndef EXYNOS_FIMC_IS2_H_
#define EXYNOS_FIMC_IS2_H_
...
enum FIMC_IS_SCENARIO_ID {
	...
	FIMC_IS_SN_FRONT_PREVIEW_BINNING,
	...
	FIMC_IS_SN_REAR_PREVIEW_BINNING,
