...
static void exynos5410_gscl_ctrl_save(bool on)
{
	...
	* from arch/arm/mach-exynos/pm_domains.c:16:
	* arch/arm/mach-exynos/pm_domains.c: In function 'exynos_pd_power':
	* arch/arm/include/asm/io.h:52:43: error:'gscl0' may be used uninitialized
