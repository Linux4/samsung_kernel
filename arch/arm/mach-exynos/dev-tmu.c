...
static struct resource tmu_resource_3472[] = {
	[0] = DEFINE_RES_MEM(EXYNOS3_PA_TMU, SZ_16K),
	[1] = DEFINE_RES_IRQ(EXYNOS3_IRQ_TMU),
};

struct platform_device exynos3472_device_tmu = {
	.name	= "exynos3-tmu",
	.id		= -1,
	.num_resources	= ARRAY_SIZE(tmu_resource_3472),
	.resource	= tmu_resource_3472,
};
#endif
