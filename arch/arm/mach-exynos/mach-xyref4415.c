...
#define XYREF4415_UCON_DEFAULT	(S3C2410_UCON_TXILEVEL |	\
...
#define XYREF4415_ULCON_DEFAULT	S3C2410_LCON_CS8

#define XYREF4415_UFCON_DEFAULT	(S3C2410_UFCON_FIFOMODE |	\
				 S5PV210_UFCON_TXTRIG4 |	\
				 S5PV210_UFCON_RXTRIG4)

static struct s3c2410_uartcfg xyref4415_uartcfgs[] __initdata = {
	[0] = {
		.hwport		= 0,
		.flags		= 0,
		.ucon		= XYREF4415_UCON_DEFAULT,
		.ulcon		= XYREF4415_ULCON_DEFAULT,
		.ufcon		= XYREF4415_UFCON_DEFAULT,
	},
	[1] = {
		.hwport		= 1,
		.flags		= 0,
...
/* ADC */
static struct s3c_adc_platdata xyref4415_adc_data __initdata = {
...
static struct platform_device *xyref4415_devices[] __initdata = {
	&s3c_device_wdt,
	&s3c_device_adc,
	&exynos4_device_g3d,
...
static void __init xyref4415_map_io(void)
{
	clk_xusbxti.rate = 24000000;

	exynos_init_io(NULL, 0);
	s3c24xx_init_clocks(clk_xusbxti.rate);
	s3c24xx_init_uarts(xyref4415_uartcfgs, ARRAY_SIZE(xyref4415_uartcfgs));
}

static void __init xyref4415_machine_init(void)
{
	s3c_adc_set_platdata(&xyref4415_adc_data);
	s3c_watchdog_set_platdata(&xyref4415_watchdog_platform_data);

	exynos4415_xyref4415_clock_init();
	exynos4_xyref4415_input_init();
	exynos4_xyref4415_usb_init();
	exynos4_xyref4415_power_init();
	exynos4415_xyref4415_mmc_init();
	exynos4_xyref4415_display_init();
	exynos4_xyref4415_media_init();
	exynos4_xyref4415_audio_init();
	exynos4_xyref4415_camera_init();

	platform_add_devices(xyref4415_devices, ARRAY_SIZE(xyref4415_devices));
}

MACHINE_START(XYREF4415, "XYREF4415")
	/* Maintainer: Kukjin Kim <kgene.kim@samsung.com> */
	.atag_offset	= 0x100,
	.init_irq	= exynos4_init_irq,
	.map_io		= xyref4415_map_io,
	.handle_irq	= gic_handle_irq,
	.init_machine	= xyref4415_machine_init,
	.timer		= &exynos4_timer,
