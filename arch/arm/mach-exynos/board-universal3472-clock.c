...
static int exynos3472_acp_clock_init(void)
{
...
static int exynos3472_peril_clock_init(void)
{
	struct clk *aclk_gpr;
...
static int exynos3472_spi_clock_init(void)
{
...
static int exynos3472_mmc_clock_init(void)
{
	...
	clk_set_rate(sclk_mmc0, 800 * MHZ);
	clk_set_rate(sclk_mmc1, 800 * MHZ);
	clk_set_rate(sclk_mmc2, 800 * MHZ);
...
static int exynos3472_mipi_clock_init(void)
{
...
static int exynos3472_uart_clock_init(void)
{
...
static int exynos3472_func_clk_cam_init(void)
{
...
static int exynos3472_mfc_clock_init(void)
{
...
static int exynos3472_disp_clock_init(void)
{
...
static int exynos3472_adc_clock_setup(void)
{
...
void __init exynos3_universal3472_clock_init(void)
{
	if (exynos3472_acp_clock_init())
		pr_err("failed to init acp clock\n");

	if (exynos3472_peril_clock_init())
		pr_err("failed to init peril clock\n");

	if (exynos3472_uart_clock_init())
		pr_err("failed to init uart clock\n");

	if (exynos3472_mmc_clock_init())
		pr_err("failed to init emmc clock\n");

	if (exynos3472_mipi_clock_init())
		pr_err("failed to init mipi clock\n");

	if (exynos3472_spi_clock_init())
		pr_err("failed to init spi clock\n");

	if (exynos3472_func_clk_cam_init())
		pr_err("failed to init cam block clock\n");

	if (exynos3472_mfc_clock_init())
		pr_err("failed to init mfc clock\n");

	if (exynos3472_disp_clock_init())
		pr_err("failed to init display clock\n");

	if (exynos3472_adc_clock_setup())
