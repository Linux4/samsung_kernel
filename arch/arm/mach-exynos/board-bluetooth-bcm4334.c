...
static unsigned int bt_uart_on_table[][4] = {
	{GPIO_BT_UART_RXD, S3C_GPIO_SFN(2), 2, S3C_GPIO_PULL_NONE},
	{GPIO_BT_UART_TXD, S3C_GPIO_SFN(2), 2, S3C_GPIO_PULL_NONE},
	{GPIO_BT_UART_CTS, S3C_GPIO_SFN(2), 2, S3C_GPIO_PULL_NONE},
	{GPIO_BT_UART_RTS, S3C_GPIO_SFN(2), 2, S3C_GPIO_PULL_NONE},
};
