/* linux/arch/arm/mach-exynos/board-xyref4415-input.c
 *
...
#define	GPIO_TSP_INT	EXYNOS4_GPF0(1)
...
void __init synaptics_tsp_init(void)
{
	...
	i2c_register_board_info(5, synaptics_i2c_devs0,
...
#define GPIO_POWER_BUTTON	EXYNOS4_GPX2(1)
#define GPIO_VOLUP_BUTTON	EXYNOS4_GPX2(0)
#define GPIO_VOLDOWN_BUTTON	EXYNOS4_GPX2(7)
#define GPIO_HOMEPAGE_BUTTON	EXYNOS4_GPX0(3)
...
static struct gpio_keys_button smdk4415_button[] = {
	{
		.code = KEY_POWER,
...
static struct gpio_keys_platform_data smdk4415_gpiokeys_platform_data = {
	smdk4415_button,
	ARRAY_SIZE(smdk4415_button),
};


static struct platform_device smdk4415_gpio_keys = {
	.name	= "gpio-keys",
	.dev	= {
		.platform_data = &smdk4415_gpiokeys_platform_data,
	},
};

static struct platform_device *smdk4415_input_devices[] __initdata = {
...
void __init exynos4_xyref4415_input_init(void)
{
	sec_class = class_create(THIS_MODULE, "sec");
#if defined(CONFIG_TOUCHSCREEN_SYNAPTICS_I2C_RMI)
	tsp_check_and_init();
#endif
	smdk4415_gpio_keys_config_setup();
	platform_add_devices(smdk4415_input_devices,
			ARRAY_SIZE(smdk4415_input_devices));
}
