 ...
 */
#ifndef _EXYNOS_CPIF_IOMMU_H_
#define _EXYNOS_CPIF_IOMMU_H_
...
#define REG_MMU_CTRL		0x8000
#define REG_MMU_CFG		0x8004
#define REG_MMU_FLUSH		0x8010
#define REG_MMU_FLUSH_ENTRY	0x8014
#define REG_MMU_FLUSH_RANGE	0x8018
#define REG_FLUSH_RANGE_START	0x8020
#define REG_FLUSH_RANGE_END	0x8024
#define TLB_INVALIDATE		BIT(0)

#define REG_FAULT_STATUS		0x8060
#define REG_FAULT_CLEAR			0x8064
#define REG_FAULT_VA			0x8070
#define REG_FAULT_INFO0			0x8074
#define REG_FAULT_INFO1			0x8078
#define REG_FAULT_INFO2			0x807C
...
#define REG_PT_BASE_PPN			0x8404
#define REG_CONTEXT_CFG_ATTR		0x8408

#define CFG_SHAREABLE      (1 << 29)
#define CFG_SHAREABLE_OVRD (1 << 28)
#define CFG_USE_MASTER_SHAREABLE	(1 << 27)
...
#define MMU_MIN_VER(val)	((val >> 8) & 0x7F)
#define MMU_REV_VER(val)	((val) & 0xFF)
#define MMU_RAW_VER(reg)	(((reg) >> 16) & 0x7FFF)
...
/* For SysMMU v9 */
#define REG_MMU_PMMU_PTLB_INFO			0x3400
#define REG_MMU_STLB_INFO			0x3800
