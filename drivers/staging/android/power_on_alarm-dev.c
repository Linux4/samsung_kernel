...
static struct rtc_time alarm_str2time(char *str, int length)
{
	...
	for (countNum = 1; countNum < 13; countNum++){
		/* QN3979 add HQ00001 modify power_on_alarm by shixuanxuan at 2021/02/05 start */
		if ((str[countNum] > '0') && (str[countNum] <='9')){
		/* QN3979 add HQ00001 modify power_on_alarm by shixuanxuan at 2021/02/05 end */
