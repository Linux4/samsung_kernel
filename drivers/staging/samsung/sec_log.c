...
#define SEC_LOGGER_BASE		0x44900000
#define SEC_LOG_BASE		0x43700000
#define SEC_LASTKMSG_BASE	0x43900000

#define SEC_DEBUG_BL_VER1	"G615FXXU2BRL3"
#define SEC_DEBUG_BL_VER2	"G615FUDDU2BRL3"

static u32 __initdata seclogger_base = SEC_LOGGER_BASE;
static u32 __initdata seclogger_size = SZ_2M;
...
static int __init sec_last_kmsg_late_init(void)
{
	...
	// TODO : This is for Fist O MR FOTA only !!
	if (strncmp(sec_debug_bl_ver, SEC_DEBUG_BL_VER1,
			strlen(SEC_DEBUG_BL_VER1)) == 0 ||
			strncmp(sec_debug_bl_ver, SEC_DEBUG_BL_VER2,
			strlen(SEC_DEBUG_BL_VER2)) == 0)
		kernel_restart("fota_bl");
