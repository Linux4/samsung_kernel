...
static ssize_t fcd_matrix_show(struct device *dev, char *buf)
{
	struct ssp_data *data = dev_get_drvdata(dev);

	return sprintf(buf,
		"%u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u\n",
		data->fcd_matrix[0], data->fcd_matrix[1], data->fcd_matrix[2], data->fcd_matrix[3],
		data->fcd_matrix[4], data->fcd_matrix[5], data->fcd_matrix[6], data->fcd_matrix[7],
		data->fcd_matrix[8], data->fcd_matrix[9], data->fcd_matrix[10], data->fcd_matrix[11],
		data->fcd_matrix[12], data->fcd_matrix[13], data->fcd_matrix[14], data->fcd_matrix[15],
		data->fcd_matrix[16], data->fcd_matrix[17], data->fcd_matrix[18], data->fcd_matrix[19],
		data->fcd_matrix[20], data->fcd_matrix[21], data->fcd_matrix[22], data->fcd_matrix[23],
		data->fcd_matrix[24], data->fcd_matrix[25], data->fcd_matrix[26]);
}

static ssize_t fcd_matrix_store(struct device *dev, const char *buf, size_t size)
{
	struct ssp_data *data = dev_get_drvdata(dev);
	u8 val[PDC_SIZE] = {0, };
	int iRet;
	...
	for (i = 0; i < PDC_SIZE; i++)
		data->fcd_matrix[i] = val[i];

	pr_info("[SSP] %s : %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u\n",
		__func__, data->fcd_matrix[0], data->fcd_matrix[1], data->fcd_matrix[2], data->fcd_matrix[3],
		data->fcd_matrix[4], data->fcd_matrix[5], data->fcd_matrix[6], data->fcd_matrix[7],
		data->fcd_matrix[8], data->fcd_matrix[9], data->fcd_matrix[10], data->fcd_matrix[11],
		data->fcd_matrix[12], data->fcd_matrix[13], data->fcd_matrix[14], data->fcd_matrix[15],
		data->fcd_matrix[16], data->fcd_matrix[17], data->fcd_matrix[18], data->fcd_matrix[19],
...
struct magnetometer_t mag_ak09918c = {
	...
	.get_fcd_magnetic_matrix = fcd_matrix_show,
	.set_fcd_magnetic_matrix = fcd_matrix_store,
};
