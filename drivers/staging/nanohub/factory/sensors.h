...
int set_fcd_matrix(struct ssp_data *data);
...
typedef struct magnetometer_t {
	...
	ssize_t (*get_fcd_magnetic_matrix)(struct device *, char *);
	ssize_t (*set_fcd_magnetic_matrix)(struct device *, const char *, size_t);
...
#ifdef CONFIG_SENSORS_STK33915
struct proximity_t* get_prox_stk33915(void);
#endif
