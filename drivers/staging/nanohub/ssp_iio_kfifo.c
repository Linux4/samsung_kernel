...
static const struct iio_buffer_setup_ops ssp_iio_buffer_setup_ops = {
...
int ssp_iio_configure_kfifo(struct iio_dev *indio_dev, int bytes)
{
	...
	indio_dev->setup_ops = &ssp_iio_buffer_setup_ops;
	/*
