...
static ssize_t set_online_cpu_show(struct kobject *kobj,
...
static ssize_t set_online_cpu_store(struct kobject *kobj,
...
static struct kobj_attribute cpuhp_set_online =
__ATTR(set_online_cpu, 0644, set_online_cpu_show, set_online_cpu_store);
