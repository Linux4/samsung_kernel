...
inline unsigned int get_boundary_wo_spare(struct freq_table *freq_table,
			s32 freq_delta_ratio, s32 cur_idx);
inline unsigned int get_boundary_freq(struct freq_table *freq_table,
...
inline void __scale_state_in_freq(struct freq_table *freq_table,
			s32 min_freq_idx, s32 max_freq_idx,
			u64 *active_state, u64 *clkoff_state,
			s32 freq_delta_ratio, s32 flag, s32 cur_idx);
inline void scale_state_in_freq(struct freq_table *freq_table,
			s32 min_freq_idx, s32 max_freq_idx,
			u64 *active_state, u64 *clkoff_state,
