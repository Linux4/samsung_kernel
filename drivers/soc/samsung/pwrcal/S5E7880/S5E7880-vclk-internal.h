...
//GRPGATE_EXTERN(gate_ccore_common)
GRPGATE_EXTERN(gate_ccore_qch_lh_cp)
GRPGATE_EXTERN(gate_ccore_qch_lh_gnss)
GRPGATE_EXTERN(gate_ccore_adcif)
GRPGATE_EXTERN(gate_ccore_hsi2c_mif)
GRPGATE_EXTERN(gate_cpucl0_ppmu)
GRPGATE_EXTERN(gate_cpucl0_bts)
GRPGATE_EXTERN(gate_cpucl1_ppmu)
GRPGATE_EXTERN(gate_cpucl1_bts)
...
GRPGATE_EXTERN(gate_fsys_ufs)
GRPGATE_EXTERN(gate_fsys_intmem)
...
GRPGATE_EXTERN(gate_dispaud_common_dsim1)
...
GRPGATE_EXTERN(gate_dispaud_dsim1)
...
UMUX_EXTERN(umux_dispaud_clkphy_dispaud_mipiphy_txbyteclkhs_0_user)
UMUX_EXTERN(umux_dispaud_clkphy_dispaud_mipiphy_rxclkesc0_0_user)
UMUX_EXTERN(umux_dispaud_clkphy_dispaud_mipiphy_txbyteclkhs_1_user)
UMUX_EXTERN(umux_dispaud_clkphy_dispaud_mipiphy_rxclkesc0_1_user)
...
UMUX_EXTERN(umux_isp_clkphy_isp_s_rxbyteclkhs1_s4_user)
UMUX_EXTERN(umux_isp_clkphy_isp_s_rxbyteclkhs2_s4_user)
UMUX_EXTERN(umux_isp_clkphy_isp_s_rxbyteclkhs3_s4_user)
UMUX_EXTERN(umux_isp_clkphy_isp_s_rxbyteclkhs0_s4s_user)
UMUX_EXTERN(umux_isp_clkphy_isp_s_rxbyteclkhs1_s4s_user)
UMUX_EXTERN(umux_isp_clkphy_isp_s_rxbyteclkhs2_s4s_user)
UMUX_EXTERN(umux_isp_clkphy_isp_s_rxbyteclkhs3_s4s_user)
