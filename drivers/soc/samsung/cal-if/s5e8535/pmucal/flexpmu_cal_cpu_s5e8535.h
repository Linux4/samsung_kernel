...
struct pmucal_seq core00_off[] = {
	...
	PMUCAL_SEQ_DESC(PMUCAL_CLEAR_PEND, "GRP1_INTR_BID_CLEAR", 0x11870000, 0x010c, (0x1 << 8), (0x1 << 8), 0x11870000, 0x0108, (0x1 << 8), (0x1 << 8) | (0x1 << 8)),
};
...
struct pmucal_seq core01_on[] = {
	...
	PMUCAL_SEQ_DESC(PMUCAL_CLEAR_PEND, "GRP2_INTR_BID_CLEAR", 0x11870000, 0x020c, (0x1 << 1), (0x1 << 1), 0x11870000, 0x0208, (0x1 << 1), (0x1 << 1) | (0x1 << 1)),
};
...
struct pmucal_seq core01_off[] = {
	...
	PMUCAL_SEQ_DESC(PMUCAL_CLEAR_PEND, "GRP1_INTR_BID_CLEAR", 0x11870000, 0x010c, (0x1 << 1), (0x1 << 1), 0x11870000, 0x0108, (0x1 << 1), (0x1 << 1) | (0x1 << 1)),
	PMUCAL_SEQ_DESC(PMUCAL_CLEAR_PEND, "GRP1_INTR_BID_CLEAR", 0x11870000, 0x010c, (0x1 << 9), (0x1 << 9), 0x11870000, 0x0108, (0x1 << 9), (0x1 << 9) | (0x1 << 9)),
};
...
struct pmucal_seq core02_on[] = {
	...
	PMUCAL_SEQ_DESC(PMUCAL_CLEAR_PEND, "GRP2_INTR_BID_CLEAR", 0x11870000, 0x020c, (0x1 << 2), (0x1 << 2), 0x11870000, 0x0208, (0x1 << 2), (0x1 << 2) | (0x1 << 2)),
};
...
struct pmucal_seq core02_off[] = {
	...
	PMUCAL_SEQ_DESC(PMUCAL_CLEAR_PEND, "GRP1_INTR_BID_CLEAR", 0x11870000, 0x010c, (0x1 << 2), (0x1 << 2), 0x11870000, 0x0108, (0x1 << 2), (0x1 << 2) | (0x1 << 2)),
	PMUCAL_SEQ_DESC(PMUCAL_CLEAR_PEND, "GRP1_INTR_BID_CLEAR", 0x11870000, 0x010c, (0x1 << 10), (0x1 << 10), 0x11870000, 0x0108, (0x1 << 10), (0x1 << 10) | (0x1 << 10)),
};
...
struct pmucal_seq core03_on[] = {
	...
	PMUCAL_SEQ_DESC(PMUCAL_CLEAR_PEND, "GRP2_INTR_BID_CLEAR", 0x11870000, 0x020c, (0x1 << 3), (0x1 << 3), 0x11870000, 0x0208, (0x1 << 3), (0x1 << 3) | (0x1 << 3)),
};
...
struct pmucal_seq core03_off[] = {
	...
	PMUCAL_SEQ_DESC(PMUCAL_CLEAR_PEND, "GRP1_INTR_BID_CLEAR", 0x11870000, 0x010c, (0x1 << 3), (0x1 << 3), 0x11870000, 0x0108, (0x1 << 3), (0x1 << 3) | (0x1 << 3)),
	PMUCAL_SEQ_DESC(PMUCAL_CLEAR_PEND, "GRP1_INTR_BID_CLEAR", 0x11870000, 0x010c, (0x1 << 11), (0x1 << 11), 0x11870000, 0x0108, (0x1 << 11), (0x1 << 11) | (0x1 << 11)),
};
...
struct pmucal_seq core04_on[] = {
	...
	PMUCAL_SEQ_DESC(PMUCAL_CLEAR_PEND, "GRP2_INTR_BID_CLEAR", 0x11870000, 0x020c, (0x1 << 4), (0x1 << 4), 0x11870000, 0x0208, (0x1 << 4), (0x1 << 4) | (0x1 << 4)),
};
...
struct pmucal_seq core04_off[] = {
	...
	PMUCAL_SEQ_DESC(PMUCAL_CLEAR_PEND, "GRP1_INTR_BID_CLEAR", 0x11870000, 0x010c, (0x1 << 4), (0x1 << 4), 0x11870000, 0x0108, (0x1 << 4), (0x1 << 4) | (0x1 << 4)),
	PMUCAL_SEQ_DESC(PMUCAL_CLEAR_PEND, "GRP1_INTR_BID_CLEAR", 0x11870000, 0x010c, (0x1 << 12), (0x1 << 12), 0x11870000, 0x0108, (0x1 << 12), (0x1 << 12) | (0x1 << 12)),
};

struct pmucal_seq core04_status[] = {
	PMUCAL_SEQ_DESC(PMUCAL_READ, "CLUSTER0_CPU4_STATUS", 0x11860000, 0x1204, (0x1 << 0), 0, 0, 0, 0xffffffff, 0),
};
...
struct pmucal_seq core05_on[] = {
	...
	PMUCAL_SEQ_DESC(PMUCAL_CLEAR_PEND, "GRP2_INTR_BID_CLEAR", 0x11870000, 0x020c, (0x1 << 5), (0x1 << 5), 0x11870000, 0x0208, (0x1 << 5), (0x1 << 5) | (0x1 << 5)),
};
...
struct pmucal_seq core05_off[] = {
	...
	PMUCAL_SEQ_DESC(PMUCAL_CLEAR_PEND, "GRP1_INTR_BID_CLEAR", 0x11870000, 0x010c, (0x1 << 5), (0x1 << 5), 0x11870000, 0x0108, (0x1 << 5), (0x1 << 5) | (0x1 << 5)),
	PMUCAL_SEQ_DESC(PMUCAL_CLEAR_PEND, "GRP1_INTR_BID_CLEAR", 0x11870000, 0x010c, (0x1 << 13), (0x1 << 13), 0x11870000, 0x0108, (0x1 << 13), (0x1 << 13) | (0x1 << 13)),
};

struct pmucal_seq core05_status[] = {
	PMUCAL_SEQ_DESC(PMUCAL_READ, "CLUSTER0_CPU5_STATUS", 0x11860000, 0x1284, (0x1 << 0), 0, 0, 0, 0xffffffff, 0),
};
...
struct pmucal_seq core10_on[] = {
	...
	PMUCAL_SEQ_DESC(PMUCAL_CLEAR_PEND, "GRP2_INTR_BID_CLEAR", 0x11870000, 0x020c, (0x1 << 6), (0x1 << 6), 0x11870000, 0x0208, (0x1 << 6), (0x1 << 6) | (0x1 << 6)),
};
...
struct pmucal_seq core10_off[] = {
	...
	PMUCAL_SEQ_DESC(PMUCAL_CLEAR_PEND, "GRP1_INTR_BID_CLEAR", 0x11870000, 0x010c, (0x1 << 6), (0x1 << 6), 0x11870000, 0x0108, (0x1 << 6), (0x1 << 6) | (0x1 << 6)),
	PMUCAL_SEQ_DESC(PMUCAL_CLEAR_PEND, "GRP1_INTR_BID_CLEAR", 0x11870000, 0x010c, (0x1 << 14), (0x1 << 14), 0x11870000, 0x0108, (0x1 << 14), (0x1 << 14) | (0x1 << 14)),
};

struct pmucal_seq core10_status[] = {
	PMUCAL_SEQ_DESC(PMUCAL_READ, "CLUSTER1_CPU0_STATUS", 0x11860000, 0x1504, (0x1 << 0), 0, 0, 0, 0xffffffff, 0),
};
...
struct pmucal_seq core11_on[] = {
	...
	PMUCAL_SEQ_DESC(PMUCAL_CLEAR_PEND, "GRP2_INTR_BID_CLEAR", 0x11870000, 0x020c, (0x1 << 7), (0x1 << 7), 0x11870000, 0x0208, (0x1 << 7), (0x1 << 7) | (0x1 << 7)),
};
...
struct pmucal_seq core11_off[] = {
	...
	PMUCAL_SEQ_DESC(PMUCAL_CLEAR_PEND, "GRP1_INTR_BID_CLEAR", 0x11870000, 0x010c, (0x1 << 7), (0x1 << 7), 0x11870000, 0x0108, (0x1 << 7), (0x1 << 7) | (0x1 << 7)),
	PMUCAL_SEQ_DESC(PMUCAL_CLEAR_PEND, "GRP1_INTR_BID_CLEAR", 0x11870000, 0x010c, (0x1 << 15), (0x1 << 15), 0x11870000, 0x0108, (0x1 << 15), (0x1 << 15) | (0x1 << 15)),
};

struct pmucal_seq core11_status[] = {
	PMUCAL_SEQ_DESC(PMUCAL_READ, "CLUSTER1_CPU1_STATUS", 0x11860000, 0x1584, (0x1 << 0), 0, 0, 0, 0xffffffff, 0),
};
...
struct pmucal_seq cluster0_status[] = {
	PMUCAL_SEQ_DESC(PMUCAL_READ, "CLUSTER0_NONCPU_STATUS", 0x11860000, 0x1404, (0x1 << 0), 0, 0, 0, 0xffffffff, 0),
};
...
struct pmucal_seq cluster1_status[] = {
	PMUCAL_SEQ_DESC(PMUCAL_READ, "CLUSTER1_NONCPU_STATUS", 0x11860000, 0x1704, (0x1 << 0), 0, 0, 0, 0xffffffff, 0),
};
...
struct pmucal_seq core10_on[] = {
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "HCHGEN_CLKMUX_CPU_CMU_CPUCL1_HCHGEN_CLKMUX_CPU", 0x10830000, 0x0004, (0x1 << 5), (0x1 << 5), 0, 0, 0xffffffff, 0),
	PMUCAL_SEQ_DESC(PMUCAL_EXT_FUNC, "cluster1_cpu_up", 0, 0, 0x31, 0x0, 0, 0, 0, 0),
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "HCHGEN_CLKMUX_CPU_CMU_CPUCL1_HCHGEN_CLKMUX_CPU", 0x10830000, 0x0004, (0x1 << 5), (0x0 << 5), 0, 0, 0xffffffff, 0),
};
