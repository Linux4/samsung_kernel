#ifndef __ASV_EXYNOS8535_H__
#define __ASV_EXYNOS8535_H__
...
struct asv_tbl_info {
	...
	unsigned cp_mcw_modify_group:4;
...
int print_asv_table(char *buf)
{
	...
	size += sprintf(buf + size, "  cp_mcw grp : %d\n",
	       asv_tbl.cp_mcw_asv_group + asv_tbl.cp_mcw_modify_group);
