...
#include "pmucal/flexpmu_cal_cpu_s5e8535.h"
#include "pmucal/flexpmu_cal_local_s5e8535.h"
#include "pmucal/flexpmu_cal_p2vmap_s5e8535.h"
#include "pmucal/flexpmu_cal_system_s5e8535.h"
#include "pmucal/flexpmu_cal_define_s5e8535.h"

#if IS_ENABLED(CONFIG_CP_PMUCAL)
#include "../pmucal/include/pmucal_cp.h"
#include "pmucal/pmucal_cp_s5e8535.h"
#endif

#if IS_ENABLED(CONFIG_GNSS_PMUCAL)
#include "pmucal/include/pmucal_gnss.h"
#include "pmucal/pmucal_gnss_s5e8535.h"
#endif

#if IS_ENABLED(CONFIG_CHUB_PMUCAL)
#include "../pmucal/include/pmucal_chub.h"
#include "pmucal/pmucal_chub_s5e8535.h"
#endif
...
#include "cmucal/clkout_s5e8535.c"
#include "acpm_dvfs_s5e8535.h"
#include "asv_s5e8535.h"
#include "../ra.h"
#include <linux/smc.h>
...
#define S5E8535_CMU_TOP_BASE		(0x12900000)
...
unsigned int frac_rpll_list[8];
unsigned int frac_rpll_size;

unsigned int s5e8535_frac_rpll_list[] = {
	PLL_SHARED0,
	PLL_SHARED1,
	PLL_G3D,
	PLL_MMC,
...
void s5e8535_cal_data_init(void)
{
	int i;
...
//	pmucal_sys_powermode[SYS_SLEEP_HSI1ON] = CPU_INFORM_SLEEP_HSI1ON;
	...
	cmu_top = ioremap(S5E8535_CMU_TOP_BASE, SZ_4K);
	if (!cmu_top)
		pr_err("%s: cmu_top ioremap failed\n", __func__);

	frac_rpll_size = ARRAY_SIZE(s5e8535_frac_rpll_list);
	for (i = 0; i < frac_rpll_size; i++)
		frac_rpll_list[i] = s5e8535_frac_rpll_list[i];

}

void (*cal_data_init)(void) = s5e8535_cal_data_init;
