...
struct cmucal_pll_table pll_aud_rate_table[] = {
	PLL_RATE_MPSK(1550000000, 222, 11, 0, 0),
	PLL_RATE_MPSK(1200000000, 125, 8, 0, 0),
	PLL_RATE_MPSK(800000000, 125, 12, 0, 0),
	PLL_RATE_MPSK(400000000, 125, 12, 1, 0),
	PLL_RATE_MPSK(200000000, 125, 12, 2, 0),
};

struct cmucal_pll_table pll_mmc_rate_table[] = {
	PLL_RATE_MPSK(808000000, 125, 12, 0, 0),
	PLL_RATE_MPSK(404000000, 125, 12, 1, 0),
	PLL_RATE_MPSK(101000000, 125, 12, 3, 0),
};

struct cmucal_pll_table pll_shared0_rate_table[] = {
	PLL_RATE_MPSK(1066000000, 111, 8, 0, 0),
};

struct cmucal_pll_table pll_shared1_rate_table[] = {
	PLL_RATE_MPSK(936000000, 73, 6, 0, 0),
};
...
struct cmucal_pll_table pll_shared3_rate_table[] = {
	PLL_RATE_MPSK(750000000, 87, 9, 0, 0),
	PLL_RATE_MPSK(750000000, 82, 9, 0, 0),
};

struct cmucal_pll_table pll_shared4_rate_table[] = {
	PLL_RATE_MPSK(670000000, 95, 11, 0, 0),
};

struct cmucal_pll_table pll_shared_mif_rate_table[] = {
	PLL_RATE_MPSK(2028000000, 132, 5, 0, 0),
	PLL_RATE_MPSK(1690000000, 66, 3, 0, 0),
	PLL_RATE_MPSK(842000000, 263, 12, 1, 0),
};

struct cmucal_pll_table pll_cpucl0_rate_table[] = {
	PLL_RATE_MPSK(2100000000, 139, 6, 0, 0),
	PLL_RATE_MPSK(1900000000, 125, 6, 0, 0),
	PLL_RATE_MPSK(1700000000, 164, 9, 0, 0),
	PLL_RATE_MPSK(1200000000, 52, 4, 0, 0),
	PLL_RATE_MPSK(600000000, 52, 4, 1, 0),
	PLL_RATE_MPSK(200000000, 78, 5, 3, 0),
};

struct cmucal_pll_table pll_cpucl1_rate_table[] = {
	PLL_RATE_MPSK(2800000000, 359, 12, 0, 0),
	PLL_RATE_MPSK(2300000000, 99, 4, 0, 0),
	PLL_RATE_MPSK(1900000000, 125, 6, 0, 0),
	PLL_RATE_MPSK(1300000000, 143, 10, 0, 0),
	PLL_RATE_MPSK(650000000, 143, 10, 1, 0),
	PLL_RATE_MPSK(300000000, 78, 5, 2, 0),
};

struct cmucal_pll_table pll_cpucl2_rate_table[] = {
	PLL_RATE_MPSK(3000000000, 130, 4, 0, 0),
	PLL_RATE_MPSK(2500000000, 82, 3, 0, 0),
	PLL_RATE_MPSK(2000000000, 177, 8, 0, 0),
	PLL_RATE_MPSK(1400000000, 78, 5, 0, 0),
	PLL_RATE_MPSK(700000000, 92, 3, 2, 0),
	PLL_RATE_MPSK(300000000, 78, 5, 2, 0),
};

struct cmucal_pll_table pll_dsu_rate_table[] = {
	PLL_RATE_MPSK(2100000000, 139, 6, 0, 0),
	PLL_RATE_MPSK(1750000000, 78, 4, 0, 0),
	PLL_RATE_MPSK(1400000000, 125, 4, 1, 0),
	PLL_RATE_MPSK(1000000000, 177, 8, 1, 0),
	PLL_RATE_MPSK(500000000, 83, 4, 2, 0),
	PLL_RATE_MPSK(200000000, 78, 5, 3, 0),
};

struct cmucal_pll_table pll_g3d_rate_table[] = {
	PLL_RATE_MPSK(1300000000, 203, 12, 0, 0),
	PLL_RATE_MPSK(1025000000, 120, 9, 0, 0),
	PLL_RATE_MPSK(750000000, 78, 4, 1, 0),
	PLL_RATE_MPSK(450000000, 82, 7, 1, 0),
};
...
struct cmucal_pll_table pll_mif_main_rate_table[] = {
	PLL_RATE_MPSK(4265999872, 361, 13, 0, 0),
	PLL_RATE_MPSK(3080000000, 401, 10, 1, 0),
	PLL_RATE_MPSK(1690000000, 154, 7, 1, 0),
	PLL_RATE_MPSK(842000000, 285, 13, 2, 0),
};
...
struct cmucal_pll_table pll_mif_s2d_rate_table[] = {
	PLL_RATE_MPSK(400000000, 125, 12, 2, 0),
};

unsigned int cmucal_pll_size = 17;
struct cmucal_pll cmucal_pll_list[] = {
	CLK_RPLL(frd_4312_rpll, PLL_AUD, FREE_OSCCLK_AUD, PLL_LOCKTIME_PLL_AUD_PLL_LOCK_TIME, PLL_CON3_PLL_AUD_ENABLE, PLL_CON3_PLL_AUD_STABLE, PLL_CON3_PLL_AUD_DIV_P, PLL_CON3_PLL_AUD_DIV_M, PLL_CON3_PLL_AUD_DIV_S, PLL_CON8_PLL_AUD_F, pll_aud_rate_table, 0, 0),
	CLK_RPLL(frd_4312_rpll, PLL_MMC, FREE_OSCCLK_CMU, PLL_LOCKTIME_PLL_MMC_PLL_LOCK_TIME, PLL_CON3_PLL_MMC_ENABLE, PLL_CON3_PLL_MMC_STABLE, PLL_CON3_PLL_MMC_DIV_P, PLL_CON3_PLL_MMC_DIV_M, PLL_CON3_PLL_MMC_DIV_S, PLL_CON8_PLL_MMC_F, pll_mmc_rate_table, 0, 0),
	CLK_RPLL(frd_4312_rpll, PLL_SHARED0, FREE_OSCCLK_CMU, PLL_LOCKTIME_PLL_SHARED0_PLL_LOCK_TIME, PLL_CON3_PLL_SHARED0_ENABLE, PLL_CON3_PLL_SHARED0_STABLE, PLL_CON3_PLL_SHARED0_DIV_P, PLL_CON3_PLL_SHARED0_DIV_M, PLL_CON3_PLL_SHARED0_DIV_S, PLL_CON8_PLL_SHARED0_F, pll_shared0_rate_table, 0, 0),
	CLK_RPLL(frd_4312_rpll, PLL_SHARED1, FREE_OSCCLK_CMU, PLL_LOCKTIME_PLL_SHARED1_PLL_LOCK_TIME, PLL_CON3_PLL_SHARED1_ENABLE, PLL_CON3_PLL_SHARED1_STABLE, PLL_CON3_PLL_SHARED1_DIV_P, PLL_CON3_PLL_SHARED1_DIV_M, PLL_CON3_PLL_SHARED1_DIV_S, PLL_CON8_PLL_SHARED1_F, pll_shared1_rate_table, 0, 0),
	CLK_RPLL(frd_4312_rpll, PLL_SHARED2, FREE_OSCCLK_CMU, PLL_LOCKTIME_PLL_SHARED2_PLL_LOCK_TIME, PLL_CON3_PLL_SHARED2_ENABLE, PLL_CON3_PLL_SHARED2_STABLE, PLL_CON3_PLL_SHARED2_DIV_P, PLL_CON3_PLL_SHARED2_DIV_M, PLL_CON3_PLL_SHARED2_DIV_S, PLL_CON8_PLL_SHARED2_F, pll_shared2_rate_table, 0, 0),
	CLK_RPLL(frd_4312_rpll, PLL_SHARED3, FREE_OSCCLK_CMU, PLL_LOCKTIME_PLL_SHARED3_PLL_LOCK_TIME, PLL_CON3_PLL_SHARED3_ENABLE, PLL_CON3_PLL_SHARED3_STABLE, PLL_CON3_PLL_SHARED3_DIV_P, PLL_CON3_PLL_SHARED3_DIV_M, PLL_CON3_PLL_SHARED3_DIV_S, PLL_CON8_PLL_SHARED3_F, pll_shared3_rate_table, 0, 0),
	CLK_RPLL(frd_4312_rpll, PLL_SHARED4, FREE_OSCCLK_CMU, PLL_LOCKTIME_PLL_SHARED4_PLL_LOCK_TIME, PLL_CON3_PLL_SHARED4_ENABLE, PLL_CON3_PLL_SHARED4_STABLE, PLL_CON3_PLL_SHARED4_DIV_P, PLL_CON3_PLL_SHARED4_DIV_M, PLL_CON3_PLL_SHARED4_DIV_S, PLL_CON8_PLL_SHARED4_F, pll_shared4_rate_table, 0, 0),
	CLK_RPLL(frd_4312_rpll, PLL_SHARED_MIF, FREE_OSCCLK_CMU, PLL_LOCKTIME_PLL_SHARED_MIF_PLL_LOCK_TIME, PLL_CON3_PLL_SHARED_MIF_ENABLE, PLL_CON3_PLL_SHARED_MIF_STABLE, PLL_CON3_PLL_SHARED_MIF_DIV_P, PLL_CON3_PLL_SHARED_MIF_DIV_M, PLL_CON3_PLL_SHARED_MIF_DIV_S, PLL_CON8_PLL_SHARED_MIF_F, pll_shared_mif_rate_table, 0, 0),
	CLK_RPLL(frd_4312_rpll, PLL_CPUCL0, FREE_OSCCLK_CPUCL0, PLL_LOCKTIME_PLL_CPUCL0_PLL_LOCK_TIME, PLL_CON3_PLL_CPUCL0_ENABLE, PLL_CON3_PLL_CPUCL0_STABLE, PLL_CON3_PLL_CPUCL0_DIV_P, PLL_CON3_PLL_CPUCL0_DIV_M, PLL_CON3_PLL_CPUCL0_DIV_S, PLL_CON8_PLL_CPUCL0_F, pll_cpucl0_rate_table, 0, 0),
	CLK_RPLL(frd_4312_rpll, PLL_CPUCL1, FREE_OSCCLK_CPUCL1, PLL_LOCKTIME_PLL_CPUCL1_PLL_LOCK_TIME, PLL_CON3_PLL_CPUCL1_ENABLE, PLL_CON3_PLL_CPUCL1_STABLE, PLL_CON3_PLL_CPUCL1_DIV_P, PLL_CON3_PLL_CPUCL1_DIV_M, PLL_CON3_PLL_CPUCL1_DIV_S, PLL_CON8_PLL_CPUCL1_F, pll_cpucl1_rate_table, 0, 0),
	CLK_RPLL(frd_4312_rpll, PLL_CPUCL2, FREE_OSCCLK_CPUCL2, PLL_LOCKTIME_PLL_CPUCL2_PLL_LOCK_TIME, PLL_CON3_PLL_CPUCL2_ENABLE, PLL_CON3_PLL_CPUCL2_STABLE, PLL_CON3_PLL_CPUCL2_DIV_P, PLL_CON3_PLL_CPUCL2_DIV_M, PLL_CON3_PLL_CPUCL2_DIV_S, PLL_CON8_PLL_CPUCL2_F, pll_cpucl2_rate_table, 0, 0),
	CLK_RPLL(frd_4312_rpll, PLL_DSU, FREE_OSCCLK_DSU, PLL_LOCKTIME_PLL_DSU_PLL_LOCK_TIME, PLL_CON3_PLL_DSU_ENABLE, PLL_CON3_PLL_DSU_STABLE, PLL_CON3_PLL_DSU_DIV_P, PLL_CON3_PLL_DSU_DIV_M, PLL_CON3_PLL_DSU_DIV_S, PLL_CON8_PLL_DSU_F, pll_dsu_rate_table, 0, 0),
	CLK_RPLL(frd_4312_rpll, PLL_G3D, FREE_OSCCLK_G3DCORE, PLL_LOCKTIME_PLL_G3D_PLL_LOCK_TIME, PLL_CON3_PLL_G3D_ENABLE, PLL_CON3_PLL_G3D_STABLE, PLL_CON3_PLL_G3D_DIV_P, PLL_CON3_PLL_G3D_DIV_M, PLL_CON3_PLL_G3D_DIV_S, PLL_CON8_PLL_G3D_F, pll_g3d_rate_table, 0, 0),
	CLK_RPLL(frd_4312_rpll, PLL_G3D1, FREE_OSCCLK_G3DCORE, PLL_LOCKTIME_PLL_G3D1_PLL_LOCK_TIME, PLL_CON3_PLL_G3D1_ENABLE, PLL_CON3_PLL_G3D1_STABLE, PLL_CON3_PLL_G3D1_DIV_P, PLL_CON3_PLL_G3D1_DIV_M, PLL_CON3_PLL_G3D1_DIV_S, PLL_CON8_PLL_G3D1_F, pll_g3d1_rate_table, 0, 0),
	CLK_RPLL(frd_4702_tpll, PLL_MIF_MAIN, FREE_OSCCLK_MIF, PLL_LOCKTIME_PLL_MIF_MAIN_PLL_LOCK_TIME, PLL_CON3_PLL_MIF_MAIN_ENABLE, PLL_CON3_PLL_MIF_MAIN_STABLE, PLL_CON3_PLL_MIF_MAIN_DIV_P, PLL_CON3_PLL_MIF_MAIN_DIV_M, PLL_CON3_PLL_MIF_MAIN_DIV_S, 0, pll_mif_main_rate_table, 0, 0),
	CLK_RPLL(frd_4702_tpll, PLL_MIF_SUB, FREE_OSCCLK_MIF, PLL_LOCKTIME_PLL_MIF_SUB_PLL_LOCK_TIME, PLL_CON3_PLL_MIF_SUB_ENABLE, PLL_CON3_PLL_MIF_SUB_STABLE, PLL_CON3_PLL_MIF_SUB_DIV_P, PLL_CON3_PLL_MIF_SUB_DIV_M, PLL_CON3_PLL_MIF_SUB_DIV_S, 0, pll_mif_sub_rate_table, 0, 0),
	CLK_RPLL(frd_4702_tpll, PLL_MIF_S2D, OSCCLK_S2D, PLL_LOCKTIME_PLL_MIF_S2D_PLL_LOCK_TIME, PLL_CON3_PLL_MIF_S2D_ENABLE, PLL_CON3_PLL_MIF_S2D_STABLE, PLL_CON3_PLL_MIF_S2D_DIV_P, PLL_CON3_PLL_MIF_S2D_DIV_M, PLL_CON3_PLL_MIF_S2D_DIV_S, 0, pll_mif_s2d_rate_table, 0, 0),
};
...
enum clk_id cmucal_mux_clk_alive_timer_asm_parents[] = {
	OSCCLK_RCO_ALIVE,
	FREE_OSCCLK_ALIVE,
};
enum clk_id cmucal_mux_clkalive_ufd_peri_parents[] = {
	MUX_CLK_RCO_ALIVE_USER,
	RCO_400,
	MUX_CLKCMU_ALIVE_NOC_USER,
	OSCCLK_RCO_ALIVE,
};
enum clk_id cmucal_mux_clk_aoccsis_noc_parents[] = {
	MUX_CLKCMU_AOCCSIS_NOC_USER,
	MUX_CLKALIVE_AOCCSIS_NOC_USER,
};
enum clk_id cmucal_mux_clk_aoccsis_dcphy_parents[] = {
...
enum clk_id cmucal_mux_clkcmu_cpucl1_switch_l_parents[] = {
	PLL_SHARED0_D1,
	PLL_SHARED1_D1,
	PLL_SHARED2_D1,
	PLL_SHARED3_D1,
...
enum clk_id cmucal_mux_clkcmu_aoccsis_noc_parents[] = {
	PLL_SHARED2_D1,
	PLL_SHARED3_D1,
	PLL_SHARED4_D1,
	PLL_SHARED0_D2,
...
enum clk_id cmucal_mux_clkcmu_aoccsis_ois_mcu_parents[] = {
	PLL_SHARED0_D2,
	PLL_SHARED2_D2,
};
...
enum clk_id cmucal_mux_clkcmu_mfd_mfd_parents[] = {
	PLL_SHARED1_D1,
	PLL_SHARED2_D1,
	PLL_SHARED3_D1,
	PLL_SHARED4_D1,
...
enum clk_id cmucal_mux_clkcmu_aoccsis_dcphy_parents[] = {
	PLL_SHARED0_D2,
	PLL_SHARED1_D2,
	PLL_SHARED2_D2,
	PLL_SHARED4_D2,
...
enum clk_id cmucal_mux_clkcmu_gnpu1_noc_parents[] = {
	PLL_SHARED0_D1,
	PLL_SHARED1_D1,
	PLL_SHARED2_D1,
	PLL_SHARED3_D1,
...
enum clk_id cmucal_clkcmu_gnpu1_noc_parents[] = {
	DIV_CLKCMU_GNPU1_NOC,
	GATE_CLKCMU_GNPU1_NOC_ALT,
};
enum clk_id cmucal_mux_clkcmu_icpu_noc_1_parents[] = {
	PLL_SHARED0_D1,
	PLL_SHARED1_D1,
	PLL_SHARED2_D1,
	PLL_SHARED3_D1,
...
enum clk_id cmucal_clkcmu_icpu_noc_0_parents[] = {
	DIV_CLKCMU_ICPU_NOC_0,
	GATE_CLKCMU_ICPU_NOC_0_ALT,
};
enum clk_id cmucal_mux_clkcmu_gnpu_xmaa_parents[] = {
	PLL_SHARED0_D1,
	PLL_SHARED1_D1,
	PLL_SHARED2_D1,
	PLL_SHARED3_D1,
...
enum clk_id cmucal_clkcmu_gnpu_xmaa_parents[] = {
	DIV_CLKCMU_GNPU_XMAA,
	GATE_CLKCMU_GNPU_XMAA_ALT,
};
enum clk_id cmucal_mux_clkcmu_gnpu1_xmaa_parents[] = {
	PLL_SHARED0_D1,
	PLL_SHARED1_D1,
	PLL_SHARED2_D1,
	PLL_SHARED3_D1,
...
enum clk_id cmucal_clkcmu_gnpu1_xmaa_parents[] = {
...
enum clk_id cmucal_mux_clkcmu_cpucl1_switch_h_parents[] = {
	PLL_SHARED0_D1,
	PLL_SHARED1_D1,
	PLL_SHARED2_D1,
	PLL_SHARED3_D1,
...
enum clk_id cmucal_mux_clk_cpucl1_idleclkdown_3_parents[] = {
	CPUCL1_CPM3,
	MUX_CLKCMU_CPUCL1_SWITCH_L_USER,
	FREE_OSCCLK_CPUCL1,
	FREE_OSCCLK_CPUCL1,
};
enum clk_id cmucal_mux_clk_cpucl1_ddd_3_parents[] = {
...
enum clk_id cmucal_mux_clk_g3d_powerip_parents[] = {
	MUX_CLK_G3D_PLL,
	MUX_CLKCMU_G3D_SWITCH_USER,
	FREE_OSCCLK_G3DCORE,
	FREE_OSCCLK_G3DCORE,
...
enum clk_id cmucal_mux_clk_gnpu_xmaa_parents[] = {
...
enum clk_id cmucal_mux_clk_peric0_dbg_uart_parents[] = {
	FREE_OSCCLK_PERIC0,
	MUX_CLKCMU_PERIC0_IP0_USER,
	MUX_CLKCMU_PERIC0_IP1_USER,
	FREE_OSCCLK_PERIC0,
};
enum clk_id cmucal_mux_clk_peric0_usi10_parents[] = {
	FREE_OSCCLK_PERIC0,
	MUX_CLKCMU_PERIC0_IP0_USER,
	MUX_CLKCMU_PERIC0_IP1_USER,
	FREE_OSCCLK_PERIC0,
...
enum clk_id cmucal_mux_clk_vts_dmic_parents[] = {
...
enum clk_id cmucal_mux_clkcmu_aoccsis_dcphy_user_parents[] = {
	FREE_OSCCLK_AOCCSIS,
	CLKCMU_AOCCSIS_DCPHY,
};
enum clk_id cmucal_mux_clkcmu_aoccsis_noc_user_parents[] = {
	FREE_OSCCLK_AOCCSIS,
	CLKCMU_AOCCSIS_NOC,
};
enum clk_id cmucal_mux_clkalive_aoccsis_noc_user_parents[] = {
	FREE_OSCCLK_AOCCSIS,
	CLKALIVE_AOCCSIS_NOC,
};
enum clk_id cmucal_mux_clkcmu_aoccsis_ois_mcu_user_parents[] = {
	FREE_OSCCLK_AOCCSIS,
...
enum clk_id cmucal_mux_clkcmu_cpucl1_switch_l_user_parents[] = {
	FREE_OSCCLK_CPUCL1,
	CLKCMU_CPUCL1_SWITCH_L,
};
enum clk_id cmucal_mux_clkcmu_cpucl1_switch_h_user_parents[] = {
	FREE_OSCCLK_CPUCL1,
	FREE_OSCCLK_CMU,
};
...
enum clk_id cmucal_mux_clkaoccsis_csis_nocd_user_parents[] = {
	FREE_OSCCLK_CSIS,
	CLKAOCCSIS_CSIS_NOCD,
};
enum clk_id cmucal_mux_clkaoccsis_csis_nocp_user_parents[] = {
	FREE_OSCCLK_CSIS,
	CLKAOCCSIS_CSIS_NOCP,
};
enum clk_id cmucal_mux_clkaoccsis_csis_ois_mcu_user_parents[] = {
	FREE_OSCCLK_CSIS,
...
enum clk_id cmucal_mux_clkalive_dsp_noc_user_parents[] = {
	FREE_OSCCLK_DSP,
	CLKALIVE_DSP_NOC,
};
...
enum clk_id cmucal_mux_clkcmu_gnpu_xmaa_user_parents[] = {
	FREE_OSCCLK_GNPU,
	CLKCMU_GNPU_XMAA,
};
...
enum clk_id cmucal_mux_clkcmu_icpu_noc_1_user_parents[] = {
	FREE_OSCCLK_ICPU,
	CLKCMU_ICPU_NOC_1,
};
...
enum clk_id cmucal_mux_clkcmu_mfd_mfd_user_parents[] = {
	FREE_OSCCLK_MFD,
	CLKCMU_MFD_MFD,
};
...
enum clk_id cmucal_mux_clkalive_ufd_peri_user_parents[] = {
	FREE_OSCCLK_UFD,
	CLKALIVE_UFD_PERI,
};
...
unsigned int cmucal_mux_size = 375;
struct cmucal_mux cmucal_mux_list[] = {
	...
	CLK_MUX(MUX_CLK_ALIVE_TIMER_ASM, cmucal_mux_clk_alive_timer_asm_parents, CLK_CON_MUX_MUX_CLK_ALIVE_TIMER_ASM_SELECT, CLK_CON_MUX_MUX_CLK_ALIVE_TIMER_ASM_BUSY, CLK_CON_MUX_MUX_CLK_ALIVE_TIMER_ASM_ENABLE_AUTOMATIC_CLKGATING),
	CLK_MUX(MUX_CLKALIVE_UFD_PERI, cmucal_mux_clkalive_ufd_peri_parents, CLK_CON_MUX_MUX_CLKALIVE_UFD_PERI_SELECT, CLK_CON_MUX_MUX_CLKALIVE_UFD_PERI_BUSY, CLK_CON_MUX_MUX_CLKALIVE_UFD_PERI_ENABLE_AUTOMATIC_CLKGATING),
	CLK_MUX(MUX_CLK_AOCCSIS_NOC, cmucal_mux_clk_aoccsis_noc_parents, CLK_CON_MUX_MUX_CLK_AOCCSIS_NOC_SELECT, CLK_CON_MUX_MUX_CLK_AOCCSIS_NOC_BUSY, CLK_CON_MUX_MUX_CLK_AOCCSIS_NOC_ENABLE_AUTOMATIC_CLKGATING),
	CLK_MUX(MUX_CLK_AOCCSIS_DCPHY, cmucal_mux_clk_aoccsis_dcphy_parents, CLK_CON_MUX_MUX_CLK_AOCCSIS_DCPHY_SELECT, CLK_CON_MUX_MUX_CLK_AOCCSIS_DCPHY_BUSY, CLK_CON_MUX_MUX_CLK_AOCCSIS_DCPHY_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_MUX(MUX_CLKCMU_CPUCL1_SWITCH_L, cmucal_mux_clkcmu_cpucl1_switch_l_parents, CLK_CON_MUX_MUX_CLKCMU_CPUCL1_SWITCH_L_SELECT, CLK_CON_MUX_MUX_CLKCMU_CPUCL1_SWITCH_L_BUSY, CLK_CON_MUX_MUX_CLKCMU_CPUCL1_SWITCH_L_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_MUX(MUX_CLKCMU_AOCCSIS_NOC, cmucal_mux_clkcmu_aoccsis_noc_parents, CLK_CON_MUX_MUX_CLKCMU_AOCCSIS_NOC_SELECT, CLK_CON_MUX_MUX_CLKCMU_AOCCSIS_NOC_BUSY, CLK_CON_MUX_MUX_CLKCMU_AOCCSIS_NOC_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_MUX(MUX_CLKCMU_AOCCSIS_OIS_MCU, cmucal_mux_clkcmu_aoccsis_ois_mcu_parents, CLK_CON_MUX_MUX_CLKCMU_AOCCSIS_OIS_MCU_SELECT, CLK_CON_MUX_MUX_CLKCMU_AOCCSIS_OIS_MCU_BUSY, CLK_CON_MUX_MUX_CLKCMU_AOCCSIS_OIS_MCU_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_MUX(MUX_CLKCMU_MFD_MFD, cmucal_mux_clkcmu_mfd_mfd_parents, CLK_CON_MUX_MUX_CLKCMU_MFD_MFD_SELECT, CLK_CON_MUX_MUX_CLKCMU_MFD_MFD_BUSY, CLK_CON_MUX_MUX_CLKCMU_MFD_MFD_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_MUX(MUX_CLKCMU_AOCCSIS_DCPHY, cmucal_mux_clkcmu_aoccsis_dcphy_parents, CLK_CON_MUX_MUX_CLKCMU_AOCCSIS_DCPHY_SELECT, CLK_CON_MUX_MUX_CLKCMU_AOCCSIS_DCPHY_BUSY, CLK_CON_MUX_MUX_CLKCMU_AOCCSIS_DCPHY_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_MUX(MUX_CLKCMU_ICPU_NOC_0, cmucal_mux_clkcmu_icpu_noc_0_parents, CLK_CON_MUX_MUX_CLKCMU_ICPU_NOC_0_SELECT, CLK_CON_MUX_MUX_CLKCMU_ICPU_NOC_0_BUSY, CLK_CON_MUX_MUX_CLKCMU_ICPU_NOC_0_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_MUX(MUX_CLKCMU_M2M_JPEG, cmucal_mux_clkcmu_m2m_jpeg_parents, CLK_CON_MUX_MUX_CLKCMU_M2M_JPEG_SELECT, CLK_CON_MUX_MUX_CLKCMU_M2M_JPEG_BUSY, CLK_CON_MUX_MUX_CLKCMU_M2M_JPEG_ENABLE_AUTOMATIC_CLKGATING),
	CLK_MUX(MUX_CLKCMU_GNPU1_NOC, cmucal_mux_clkcmu_gnpu1_noc_parents, CLK_CON_MUX_MUX_CLKCMU_GNPU1_NOC_SELECT, CLK_CON_MUX_MUX_CLKCMU_GNPU1_NOC_BUSY, CLK_CON_MUX_MUX_CLKCMU_GNPU1_NOC_ENABLE_AUTOMATIC_CLKGATING),
	CLK_MUX(CLKCMU_GNPU1_NOC, cmucal_clkcmu_gnpu1_noc_parents, CLK_CON_MUX_CLKCMU_GNPU1_NOC_SELECT, CLK_CON_MUX_CLKCMU_GNPU1_NOC_BUSY, CLK_CON_MUX_CLKCMU_GNPU1_NOC_ENABLE_AUTOMATIC_CLKGATING),
	CLK_MUX(MUX_CLKCMU_ICPU_NOC_1, cmucal_mux_clkcmu_icpu_noc_1_parents, CLK_CON_MUX_MUX_CLKCMU_ICPU_NOC_1_SELECT, CLK_CON_MUX_MUX_CLKCMU_ICPU_NOC_1_BUSY, CLK_CON_MUX_MUX_CLKCMU_ICPU_NOC_1_ENABLE_AUTOMATIC_CLKGATING),
	CLK_MUX(CLKCMU_ICPU_NOC_0, cmucal_clkcmu_icpu_noc_0_parents, CLK_CON_MUX_CLKCMU_ICPU_NOC_0_SELECT, CLK_CON_MUX_CLKCMU_ICPU_NOC_0_BUSY, CLK_CON_MUX_CLKCMU_ICPU_NOC_0_ENABLE_AUTOMATIC_CLKGATING),
	CLK_MUX(MUX_CLKCMU_GNPU_XMAA, cmucal_mux_clkcmu_gnpu_xmaa_parents, CLK_CON_MUX_MUX_CLKCMU_GNPU_XMAA_SELECT, CLK_CON_MUX_MUX_CLKCMU_GNPU_XMAA_BUSY, CLK_CON_MUX_MUX_CLKCMU_GNPU_XMAA_ENABLE_AUTOMATIC_CLKGATING),
	CLK_MUX(CLKCMU_GNPU_XMAA, cmucal_clkcmu_gnpu_xmaa_parents, CLK_CON_MUX_CLKCMU_GNPU_XMAA_SELECT, CLK_CON_MUX_CLKCMU_GNPU_XMAA_BUSY, CLK_CON_MUX_CLKCMU_GNPU_XMAA_ENABLE_AUTOMATIC_CLKGATING),
	CLK_MUX(MUX_CLKCMU_GNPU1_XMAA, cmucal_mux_clkcmu_gnpu1_xmaa_parents, CLK_CON_MUX_MUX_CLKCMU_GNPU1_XMAA_SELECT, CLK_CON_MUX_MUX_CLKCMU_GNPU1_XMAA_BUSY, CLK_CON_MUX_MUX_CLKCMU_GNPU1_XMAA_ENABLE_AUTOMATIC_CLKGATING),
	CLK_MUX(CLKCMU_GNPU1_XMAA, cmucal_clkcmu_gnpu1_xmaa_parents, CLK_CON_MUX_CLKCMU_GNPU1_XMAA_SELECT, CLK_CON_MUX_CLKCMU_GNPU1_XMAA_BUSY, CLK_CON_MUX_CLKCMU_GNPU1_XMAA_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_MUX(MUX_CLKCMU_CPUCL1_SWITCH_H, cmucal_mux_clkcmu_cpucl1_switch_h_parents, CLK_CON_MUX_MUX_CLKCMU_CPUCL1_SWITCH_H_SELECT, CLK_CON_MUX_MUX_CLKCMU_CPUCL1_SWITCH_H_BUSY, CLK_CON_MUX_MUX_CLKCMU_CPUCL1_SWITCH_H_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_MUX(MUX_CLK_CPUCL1_IDLECLKDOWN_3, cmucal_mux_clk_cpucl1_idleclkdown_3_parents, CLK_CON_MUX_MUX_CLK_CPUCL1_IDLECLKDOWN_3_SELECT, CLK_CON_MUX_MUX_CLK_CPUCL1_IDLECLKDOWN_3_BUSY, CLK_CON_MUX_MUX_CLK_CPUCL1_IDLECLKDOWN_3_ENABLE_AUTOMATIC_CLKGATING),
	CLK_MUX(MUX_CLK_CPUCL1_DDD_3, cmucal_mux_clk_cpucl1_ddd_3_parents, CLK_CON_MUX_MUX_CLK_CPUCL1_DDD_3_SELECT, CLK_CON_MUX_MUX_CLK_CPUCL1_DDD_3_BUSY, CLK_CON_MUX_MUX_CLK_CPUCL1_DDD_3_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_MUX(MUX_CLK_G3D_POWERIP, cmucal_mux_clk_g3d_powerip_parents, CLK_CON_MUX_MUX_CLK_G3D_POWERIP_SELECT, CLK_CON_MUX_MUX_CLK_G3D_POWERIP_BUSY, CLK_CON_MUX_MUX_CLK_G3D_POWERIP_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_MUX(MUX_CLK_GNPU_XMAA, cmucal_mux_clk_gnpu_xmaa_parents, CLK_CON_MUX_MUX_CLK_GNPU_XMAA_SELECT, CLK_CON_MUX_MUX_CLK_GNPU_XMAA_BUSY, CLK_CON_MUX_MUX_CLK_GNPU_XMAA_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_MUX(MUX_CLK_PERIC0_DBG_UART, cmucal_mux_clk_peric0_dbg_uart_parents, CLK_CON_MUX_MUX_CLK_PERIC0_DBG_UART_SELECT, CLK_CON_MUX_MUX_CLK_PERIC0_DBG_UART_BUSY, CLK_CON_MUX_MUX_CLK_PERIC0_DBG_UART_ENABLE_AUTOMATIC_CLKGATING),
	CLK_MUX(MUX_CLK_PERIC0_USI10, cmucal_mux_clk_peric0_usi10_parents, CLK_CON_MUX_MUX_CLK_PERIC0_USI10_SELECT, CLK_CON_MUX_MUX_CLK_PERIC0_USI10_BUSY, CLK_CON_MUX_MUX_CLK_PERIC0_USI10_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_MUX(MUX_CLK_VTS_DMIC, cmucal_mux_clk_vts_dmic_parents, CLK_CON_MUX_MUX_CLK_VTS_DMIC_SELECT, CLK_CON_MUX_MUX_CLK_VTS_DMIC_BUSY, CLK_CON_MUX_MUX_CLK_VTS_DMIC_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_MUX(AOCCSIS_CMU_AOCCSIS_CLKOUT, NULL, EMPTY_CAL_ID, EMPTY_CAL_ID, EMPTY_CAL_ID),
	...
	CLK_MUX(ICPU_CMU_ICPU_CLKOUT, NULL, EMPTY_CAL_ID, EMPTY_CAL_ID, EMPTY_CAL_ID),
	...
	CLK_MUX(MFD_CMU_MFD_CLKOUT, NULL, EMPTY_CAL_ID, EMPTY_CAL_ID, EMPTY_CAL_ID),
	...
	CLK_MUX(MUX_CLKCMU_AOCCSIS_DCPHY_USER, cmucal_mux_clkcmu_aoccsis_dcphy_user_parents, PLL_CON0_MUX_CLKCMU_AOCCSIS_DCPHY_USER_MUX_SEL, PLL_CON0_MUX_CLKCMU_AOCCSIS_DCPHY_USER_BUSY, PLL_CON1_MUX_CLKCMU_AOCCSIS_DCPHY_USER_ENABLE_AUTOMATIC_CLKGATING),
	CLK_MUX(MUX_CLKCMU_AOCCSIS_NOC_USER, cmucal_mux_clkcmu_aoccsis_noc_user_parents, PLL_CON0_MUX_CLKCMU_AOCCSIS_NOC_USER_MUX_SEL, PLL_CON0_MUX_CLKCMU_AOCCSIS_NOC_USER_BUSY, PLL_CON1_MUX_CLKCMU_AOCCSIS_NOC_USER_ENABLE_AUTOMATIC_CLKGATING),
	CLK_MUX(MUX_CLKALIVE_AOCCSIS_NOC_USER, cmucal_mux_clkalive_aoccsis_noc_user_parents, PLL_CON0_MUX_CLKALIVE_AOCCSIS_NOC_USER_MUX_SEL, PLL_CON0_MUX_CLKALIVE_AOCCSIS_NOC_USER_BUSY, PLL_CON1_MUX_CLKALIVE_AOCCSIS_NOC_USER_ENABLE_AUTOMATIC_CLKGATING),
	CLK_MUX(MUX_CLKCMU_AOCCSIS_OIS_MCU_USER, cmucal_mux_clkcmu_aoccsis_ois_mcu_user_parents, PLL_CON0_MUX_CLKCMU_AOCCSIS_OIS_MCU_USER_MUX_SEL, PLL_CON0_MUX_CLKCMU_AOCCSIS_OIS_MCU_USER_BUSY, PLL_CON1_MUX_CLKCMU_AOCCSIS_OIS_MCU_USER_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_MUX(MUX_CLKCMU_CPUCL1_SWITCH_L_USER, cmucal_mux_clkcmu_cpucl1_switch_l_user_parents, PLL_CON0_MUX_CLKCMU_CPUCL1_SWITCH_L_USER_MUX_SEL, PLL_CON0_MUX_CLKCMU_CPUCL1_SWITCH_L_USER_BUSY, PLL_CON1_MUX_CLKCMU_CPUCL1_SWITCH_L_USER_ENABLE_AUTOMATIC_CLKGATING),
	CLK_MUX(MUX_CLKCMU_CPUCL1_SWITCH_H_USER, cmucal_mux_clkcmu_cpucl1_switch_h_user_parents, PLL_CON0_MUX_CLKCMU_CPUCL1_SWITCH_H_USER_MUX_SEL, PLL_CON0_MUX_CLKCMU_CPUCL1_SWITCH_H_USER_BUSY, PLL_CON1_MUX_CLKCMU_CPUCL1_SWITCH_H_USER_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_MUX(MUX_CLKAOCCSIS_CSIS_NOCD_USER, cmucal_mux_clkaoccsis_csis_nocd_user_parents, PLL_CON0_MUX_CLKAOCCSIS_CSIS_NOCD_USER_MUX_SEL, PLL_CON0_MUX_CLKAOCCSIS_CSIS_NOCD_USER_BUSY, PLL_CON1_MUX_CLKAOCCSIS_CSIS_NOCD_USER_ENABLE_AUTOMATIC_CLKGATING),
	CLK_MUX(MUX_CLKAOCCSIS_CSIS_NOCP_USER, cmucal_mux_clkaoccsis_csis_nocp_user_parents, PLL_CON0_MUX_CLKAOCCSIS_CSIS_NOCP_USER_MUX_SEL, PLL_CON0_MUX_CLKAOCCSIS_CSIS_NOCP_USER_BUSY, PLL_CON1_MUX_CLKAOCCSIS_CSIS_NOCP_USER_ENABLE_AUTOMATIC_CLKGATING),
	CLK_MUX(MUX_CLKAOCCSIS_CSIS_OIS_MCU_USER, cmucal_mux_clkaoccsis_csis_ois_mcu_user_parents, PLL_CON0_MUX_CLKAOCCSIS_CSIS_OIS_MCU_USER_MUX_SEL, PLL_CON0_MUX_CLKAOCCSIS_CSIS_OIS_MCU_USER_BUSY, PLL_CON1_MUX_CLKAOCCSIS_CSIS_OIS_MCU_USER_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_MUX(MUX_CLKALIVE_DSP_NOC_USER, cmucal_mux_clkalive_dsp_noc_user_parents, PLL_CON0_MUX_CLKALIVE_DSP_NOC_USER_MUX_SEL, PLL_CON0_MUX_CLKALIVE_DSP_NOC_USER_BUSY, PLL_CON1_MUX_CLKALIVE_DSP_NOC_USER_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_MUX(MUX_CLKCMU_GNPU_XMAA_USER, cmucal_mux_clkcmu_gnpu_xmaa_user_parents, PLL_CON0_MUX_CLKCMU_GNPU_XMAA_USER_MUX_SEL, PLL_CON0_MUX_CLKCMU_GNPU_XMAA_USER_BUSY, PLL_CON1_MUX_CLKCMU_GNPU_XMAA_USER_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_MUX(MUX_CLKCMU_ICPU_NOC_0_USER, cmucal_mux_clkcmu_icpu_noc_0_user_parents, PLL_CON0_MUX_CLKCMU_ICPU_NOC_0_USER_MUX_SEL, PLL_CON0_MUX_CLKCMU_ICPU_NOC_0_USER_BUSY, PLL_CON1_MUX_CLKCMU_ICPU_NOC_0_USER_ENABLE_AUTOMATIC_CLKGATING),
	CLK_MUX(MUX_CLKCMU_ICPU_NOC_1_USER, cmucal_mux_clkcmu_icpu_noc_1_user_parents, PLL_CON0_MUX_CLKCMU_ICPU_NOC_1_USER_MUX_SEL, PLL_CON0_MUX_CLKCMU_ICPU_NOC_1_USER_BUSY, PLL_CON1_MUX_CLKCMU_ICPU_NOC_1_USER_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_MUX(MUX_CLKCMU_M2M_JPEG_USER, cmucal_mux_clkcmu_m2m_jpeg_user_parents, PLL_CON0_MUX_CLKCMU_M2M_JPEG_USER_MUX_SEL, PLL_CON0_MUX_CLKCMU_M2M_JPEG_USER_BUSY, PLL_CON1_MUX_CLKCMU_M2M_JPEG_USER_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_MUX(MUX_CLKCMU_MFD_MFD_USER, cmucal_mux_clkcmu_mfd_mfd_user_parents, PLL_CON0_MUX_CLKCMU_MFD_MFD_USER_MUX_SEL, PLL_CON0_MUX_CLKCMU_MFD_MFD_USER_BUSY, PLL_CON1_MUX_CLKCMU_MFD_MFD_USER_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_MUX(MUX_CLKALIVE_UFD_PERI_USER, cmucal_mux_clkalive_ufd_peri_user_parents, PLL_CON0_MUX_CLKALIVE_UFD_PERI_USER_MUX_SEL, PLL_CON0_MUX_CLKALIVE_UFD_PERI_USER_BUSY, PLL_CON1_MUX_CLKALIVE_UFD_PERI_USER_ENABLE_AUTOMATIC_CLKGATING),
...
unsigned int cmucal_div_size = 253;
struct cmucal_div cmucal_div_list[] = {
	...
	CLK_DIV(CLKALIVE_AOCCSIS_NOC, GATE_CLKALIVE_AOCCSIS_NOC, CLK_CON_DIV_CLKALIVE_AOCCSIS_NOC_DIVRATIO, CLK_CON_DIV_CLKALIVE_AOCCSIS_NOC_BUSY, CLK_CON_DIV_CLKALIVE_AOCCSIS_NOC_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_DIV(CLKALIVE_UFD_PERI, GATE_CLKALIVE_UFD_PERI, CLK_CON_DIV_CLKALIVE_UFD_PERI_DIVRATIO, CLK_CON_DIV_CLKALIVE_UFD_PERI_BUSY, CLK_CON_DIV_CLKALIVE_UFD_PERI_ENABLE_AUTOMATIC_CLKGATING),
	CLK_DIV(DIV_CLK_ALIVE_ECU, MUX_CLK_RCO_ALIVE_USER, CLK_CON_DIV_DIV_CLK_ALIVE_ECU_DIVRATIO, CLK_CON_DIV_DIV_CLK_ALIVE_ECU_BUSY, CLK_CON_DIV_DIV_CLK_ALIVE_ECU_ENABLE_AUTOMATIC_CLKGATING),
	CLK_DIV(DIV_CLK_AOCCSIS_NOCP, MUX_CLK_AOCCSIS_NOC, CLK_CON_DIV_DIV_CLK_AOCCSIS_NOCP_DIVRATIO, CLK_CON_DIV_DIV_CLK_AOCCSIS_NOCP_BUSY, CLK_CON_DIV_DIV_CLK_AOCCSIS_NOCP_ENABLE_AUTOMATIC_CLKGATING),
	CLK_DIV(DIV_CLK_AOCCSIS_DCPHY, MUX_CLK_AOCCSIS_DCPHY, CLK_CON_DIV_DIV_CLK_AOCCSIS_DCPHY_DIVRATIO, CLK_CON_DIV_DIV_CLK_AOCCSIS_DCPHY_BUSY, CLK_CON_DIV_DIV_CLK_AOCCSIS_DCPHY_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_DIV(DIV_CLK_AUD_ECU, FREE_OSCCLK_AUD, CLK_CON_DIV_DIV_CLK_AUD_ECU_DIVRATIO, CLK_CON_DIV_DIV_CLK_AUD_ECU_BUSY, CLK_CON_DIV_DIV_CLK_AUD_ECU_ENABLE_AUTOMATIC_CLKGATING),
	CLK_DIV(DIV_CLK_BRP_NOCP, MUX_CLKCMU_BRP_NOC_USER, CLK_CON_DIV_DIV_CLK_BRP_NOCP_DIVRATIO, CLK_CON_DIV_DIV_CLK_BRP_NOCP_BUSY, CLK_CON_DIV_DIV_CLK_BRP_NOCP_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_DIV(DIV_CLK_CHUB_SERIAL_LIF_US_PROX_CORE, MUX_CLKALIVE_CHUB_RCO_USER, CLK_CON_DIV_DIV_CLK_CHUB_SERIAL_LIF_US_PROX_CORE_DIVRATIO, CLK_CON_DIV_DIV_CLK_CHUB_SERIAL_LIF_US_PROX_CORE_BUSY, CLK_CON_DIV_DIV_CLK_CHUB_SERIAL_LIF_US_PROX_CORE_ENABLE_AUTOMATIC_CLKGATING),
	CLK_DIV(DIV_CLK_CHUB_SERIAL_LIF_US_PROX, MUX_CLKALIVE_CHUB_RCO_USER, CLK_CON_DIV_DIV_CLK_CHUB_SERIAL_LIF_US_PROX_DIVRATIO, CLK_CON_DIV_DIV_CLK_CHUB_SERIAL_LIF_US_PROX_BUSY, CLK_CON_DIV_DIV_CLK_CHUB_SERIAL_LIF_US_PROX_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_DIV(DIV_CLK_CHUBVTS_ECU, FREE_OSCCLK_CHUBVTS, CLK_CON_DIV_DIV_CLK_CHUBVTS_ECU_DIVRATIO, CLK_CON_DIV_DIV_CLK_CHUBVTS_ECU_BUSY, CLK_CON_DIV_DIV_CLK_CHUBVTS_ECU_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_DIV(CLKCMU_AOCCSIS_NOC, GATE_CLKCMU_AOCCSIS_NOC, CLK_CON_DIV_CLKCMU_AOCCSIS_NOC_DIVRATIO, CLK_CON_DIV_CLKCMU_AOCCSIS_NOC_BUSY, CLK_CON_DIV_CLKCMU_AOCCSIS_NOC_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_DIV(CLKCMU_AOCCSIS_OIS_MCU, GATE_CLKCMU_AOCCSIS_OIS_MCU, CLK_CON_DIV_CLKCMU_AOCCSIS_OIS_MCU_DIVRATIO, CLK_CON_DIV_CLKCMU_AOCCSIS_OIS_MCU_BUSY, CLK_CON_DIV_CLKCMU_AOCCSIS_OIS_MCU_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_DIV(CLKCMU_MFD_MFD, GATE_CLKCMU_MFD_MFD, CLK_CON_DIV_CLKCMU_MFD_MFD_DIVRATIO, CLK_CON_DIV_CLKCMU_MFD_MFD_BUSY, CLK_CON_DIV_CLKCMU_MFD_MFD_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_DIV(CLKCMU_AOCCSIS_DCPHY, GATE_CLKCMU_AOCCSIS_DCPHY, CLK_CON_DIV_CLKCMU_AOCCSIS_DCPHY_DIVRATIO, CLK_CON_DIV_CLKCMU_AOCCSIS_DCPHY_BUSY, CLK_CON_DIV_CLKCMU_AOCCSIS_DCPHY_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_DIV(CLKCMU_AUD_AUDIF0, GATE_CLKCMU_AUD_AUDIF0, CLK_CON_DIV_CLKCMU_AUD_AUDIF0_DIVRATIO, CLK_CON_DIV_CLKCMU_AUD_AUDIF0_BUSY, CLK_CON_DIV_CLKCMU_AUD_AUDIF0_ENABLE_AUTOMATIC_CLKGATING),
	CLK_DIV(CLKCMU_AUD_AUDIF1, GATE_CLKCMU_AUD_AUDIF1, CLK_CON_DIV_CLKCMU_AUD_AUDIF1_DIVRATIO, CLK_CON_DIV_CLKCMU_AUD_AUDIF1_BUSY, CLK_CON_DIV_CLKCMU_AUD_AUDIF1_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_DIV(CLKCMU_CPUCL1_SWITCH_L, GATE_CLKCMU_CPUCL1_SWITCH_L, CLK_CON_DIV_CLKCMU_CPUCL1_SWITCH_L_DIVRATIO, CLK_CON_DIV_CLKCMU_CPUCL1_SWITCH_L_BUSY, CLK_CON_DIV_CLKCMU_CPUCL1_SWITCH_L_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_DIV(CLKCMU_CPUCL0_DBG_NOC, GATE_CLKCMU_CPUCL0_DBG_NOC, CLK_CON_DIV_CLKCMU_CPUCL0_DBG_NOC_DIVRATIO, CLK_CON_DIV_CLKCMU_CPUCL0_DBG_NOC_BUSY, CLK_CON_DIV_CLKCMU_CPUCL0_DBG_NOC_ENABLE_AUTOMATIC_CLKGATING),
	CLK_DIV(CLKCMU_DNC_NOC, GATE_CLKCMU_DNC_NOC, CLK_CON_DIV_CLKCMU_DNC_NOC_DIVRATIO, CLK_CON_DIV_CLKCMU_DNC_NOC_BUSY, CLK_CON_DIV_CLKCMU_DNC_NOC_ENABLE_AUTOMATIC_CLKGATING),
	CLK_DIV(CLKCMU_SDMA_NOC, GATE_CLKCMU_SDMA_NOC, CLK_CON_DIV_CLKCMU_SDMA_NOC_DIVRATIO, CLK_CON_DIV_CLKCMU_SDMA_NOC_BUSY, CLK_CON_DIV_CLKCMU_SDMA_NOC_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_DIV(CLKCMU_M2M_NOC, GATE_CLKCMU_M2M_NOC, CLK_CON_DIV_CLKCMU_M2M_NOC_DIVRATIO, CLK_CON_DIV_CLKCMU_M2M_NOC_BUSY, CLK_CON_DIV_CLKCMU_M2M_NOC_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_DIV(CLKCMU_NOCL1B_NOC0, GATE_CLKCMU_NOCL1B_NOC0, CLK_CON_DIV_CLKCMU_NOCL1B_NOC0_DIVRATIO, CLK_CON_DIV_CLKCMU_NOCL1B_NOC0_BUSY, CLK_CON_DIV_CLKCMU_NOCL1B_NOC0_ENABLE_AUTOMATIC_CLKGATING),
	CLK_DIV(CLKCMU_NOCL1C_NOC, GATE_CLKCMU_NOCL1C_NOC, CLK_CON_DIV_CLKCMU_NOCL1C_NOC_DIVRATIO, CLK_CON_DIV_CLKCMU_NOCL1C_NOC_BUSY, CLK_CON_DIV_CLKCMU_NOCL1C_NOC_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_DIV(CLKCMU_UFS_MMC_CARD, GATE_CLKCMU_UFS_MMC_CARD, CLK_CON_DIV_CLKCMU_UFS_MMC_CARD_DIVRATIO, CLK_CON_DIV_CLKCMU_UFS_MMC_CARD_BUSY, CLK_CON_DIV_CLKCMU_UFS_MMC_CARD_ENABLE_AUTOMATIC_CLKGATING),
	CLK_DIV(DIV_CLKCMU_ICPU_NOC_0, GATE_CLKCMU_ICPU_NOC_0, CLK_CON_DIV_DIV_CLKCMU_ICPU_NOC_0_DIVRATIO, CLK_CON_DIV_DIV_CLKCMU_ICPU_NOC_0_BUSY, CLK_CON_DIV_DIV_CLKCMU_ICPU_NOC_0_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_DIV(CLKCMU_M2M_JPEG, GATE_CLKCMU_M2M_JPEG, CLK_CON_DIV_CLKCMU_M2M_JPEG_DIVRATIO, CLK_CON_DIV_CLKCMU_M2M_JPEG_BUSY, CLK_CON_DIV_CLKCMU_M2M_JPEG_ENABLE_AUTOMATIC_CLKGATING),
	CLK_DIV(DIV_CLKCMU_GNPU1_NOC, GATE_CLKCMU_GNPU1_NOC, CLK_CON_DIV_DIV_CLKCMU_GNPU1_NOC_DIVRATIO, CLK_CON_DIV_DIV_CLKCMU_GNPU1_NOC_BUSY, CLK_CON_DIV_DIV_CLKCMU_GNPU1_NOC_ENABLE_AUTOMATIC_CLKGATING),
	CLK_DIV(CLKCMU_ICPU_NOC_1, GATE_CLKCMU_ICPU_NOC_1, CLK_CON_DIV_CLKCMU_ICPU_NOC_1_DIVRATIO, CLK_CON_DIV_CLKCMU_ICPU_NOC_1_BUSY, CLK_CON_DIV_CLKCMU_ICPU_NOC_1_ENABLE_AUTOMATIC_CLKGATING),
	CLK_DIV(DIV_CLKCMU_GNPU_XMAA, GATE_CLKCMU_GNPU_XMAA, CLK_CON_DIV_DIV_CLKCMU_GNPU_XMAA_DIVRATIO, CLK_CON_DIV_DIV_CLKCMU_GNPU_XMAA_BUSY, CLK_CON_DIV_DIV_CLKCMU_GNPU_XMAA_ENABLE_AUTOMATIC_CLKGATING),
	CLK_DIV(DIV_CLKCMU_GNPU1_XMAA, GATE_CLKCMU_GNPU1_XMAA, CLK_CON_DIV_DIV_CLKCMU_GNPU1_XMAA_DIVRATIO, CLK_CON_DIV_DIV_CLKCMU_GNPU1_XMAA_BUSY, CLK_CON_DIV_DIV_CLKCMU_GNPU1_XMAA_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_DIV(DIV_CLK_CPUCL0_GLB_ECU, FREE_OSCCLK_CPUCL0_GLB, CLK_CON_DIV_DIV_CLK_CPUCL0_GLB_ECU_DIVRATIO, CLK_CON_DIV_DIV_CLK_CPUCL0_GLB_ECU_BUSY, CLK_CON_DIV_DIV_CLK_CPUCL0_GLB_ECU_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_DIV(DIV_CLK_CPUCL1_CORE_3, MUX_CLK_CPUCL1_IDLECLKDOWN_3, CLK_CON_DIV_DIV_CLK_CPUCL1_CORE_3_DIVRATIO, CLK_CON_DIV_DIV_CLK_CPUCL1_CORE_3_BUSY, CLK_CON_DIV_DIV_CLK_CPUCL1_CORE_3_ENABLE_AUTOMATIC_CLKGATING),
	CLK_DIV(CLK_CPUCL1_DDD_3, MUX_CLK_CPUCL1_DDD_3, CLK_CON_DIV_CLK_CPUCL1_DDD_3_DIVRATIO, CLK_CON_DIV_CLK_CPUCL1_DDD_3_BUSY, CLK_CON_DIV_CLK_CPUCL1_DDD_3_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_DIV(DIV_CLK_DPUB_ECU, FREE_OSCCLK_DPUB, CLK_CON_DIV_DIV_CLK_DPUB_ECU_DIVRATIO, CLK_CON_DIV_DIV_CLK_DPUB_ECU_BUSY, CLK_CON_DIV_DIV_CLK_DPUB_ECU_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_DIV(DIV_CLK_DPUF0_ECU, FREE_OSCCLK_DPUF0, CLK_CON_DIV_DIV_CLK_DPUF0_ECU_DIVRATIO, CLK_CON_DIV_DIV_CLK_DPUF0_ECU_BUSY, CLK_CON_DIV_DIV_CLK_DPUF0_ECU_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_DIV(DIV_CLK_DPUF1_ECU, FREE_OSCCLK_DPUF1, CLK_CON_DIV_DIV_CLK_DPUF1_ECU_DIVRATIO, CLK_CON_DIV_DIV_CLK_DPUF1_ECU_BUSY, CLK_CON_DIV_DIV_CLK_DPUF1_ECU_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_DIV(DIV_CLK_G3D_ECU, FREE_OSCCLK_G3DCORE, CLK_CON_DIV_DIV_CLK_G3D_ECU_DIVRATIO, CLK_CON_DIV_DIV_CLK_G3D_ECU_BUSY, CLK_CON_DIV_DIV_CLK_G3D_ECU_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_DIV(DIV_CLK_HSI0_ECU, FREE_OSCCLK_HSI0, CLK_CON_DIV_DIV_CLK_HSI0_ECU_DIVRATIO, CLK_CON_DIV_DIV_CLK_HSI0_ECU_BUSY, CLK_CON_DIV_DIV_CLK_HSI0_ECU_ENABLE_AUTOMATIC_CLKGATING),
	CLK_DIV(DIV_CLK_HSI1_ECU, FREE_OSCCLK_HSI1, CLK_CON_DIV_DIV_CLK_HSI1_ECU_DIVRATIO, CLK_CON_DIV_DIV_CLK_HSI1_ECU_BUSY, CLK_CON_DIV_DIV_CLK_HSI1_ECU_ENABLE_AUTOMATIC_CLKGATING),
	CLK_DIV(DIV_CLK_ICPU_NOCP, MUX_CLKCMU_ICPU_NOC_0_USER, CLK_CON_DIV_DIV_CLK_ICPU_NOCP_DIVRATIO, CLK_CON_DIV_DIV_CLK_ICPU_NOCP_BUSY, CLK_CON_DIV_DIV_CLK_ICPU_NOCP_ENABLE_AUTOMATIC_CLKGATING),
	CLK_DIV(DIV_CLK_ICPU_PCLKDBG, MUX_CLKCMU_ICPU_NOC_0_USER, CLK_CON_DIV_DIV_CLK_ICPU_PCLKDBG_DIVRATIO, CLK_CON_DIV_DIV_CLK_ICPU_PCLKDBG_BUSY, CLK_CON_DIV_DIV_CLK_ICPU_PCLKDBG_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_DIV(DIV_CLK_MCFP_NOCP, MUX_CLKCMU_MCFP_NOC_USER, CLK_CON_DIV_DIV_CLK_MCFP_NOCP_DIVRATIO, CLK_CON_DIV_DIV_CLK_MCFP_NOCP_BUSY, CLK_CON_DIV_DIV_CLK_MCFP_NOCP_ENABLE_AUTOMATIC_CLKGATING),
	CLK_DIV(DIV_CLK_MCSC_NOCP, MUX_CLKCMU_MCSC_NOC_USER, CLK_CON_DIV_DIV_CLK_MCSC_NOCP_DIVRATIO, CLK_CON_DIV_DIV_CLK_MCSC_NOCP_BUSY, CLK_CON_DIV_DIV_CLK_MCSC_NOCP_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_DIV(DIV_CLK_MFC_ECU, FREE_OSCCLK_MFC, CLK_CON_DIV_DIV_CLK_MFC_ECU_DIVRATIO, CLK_CON_DIV_DIV_CLK_MFC_ECU_BUSY, CLK_CON_DIV_DIV_CLK_MFC_ECU_ENABLE_AUTOMATIC_CLKGATING),
	CLK_DIV(DIV_CLK_MFD_NOCP, MUX_CLKCMU_MFD_MFD_USER, CLK_CON_DIV_DIV_CLK_MFD_NOCP_DIVRATIO, CLK_CON_DIV_DIV_CLK_MFD_NOCP_BUSY, CLK_CON_DIV_DIV_CLK_MFD_NOCP_ENABLE_AUTOMATIC_CLKGATING),
	CLK_DIV(DIV_CLK_MFD_ECU, FREE_OSCCLK_MFD, CLK_CON_DIV_DIV_CLK_MFD_ECU_DIVRATIO, CLK_CON_DIV_DIV_CLK_MFD_ECU_BUSY, CLK_CON_DIV_DIV_CLK_MFD_ECU_ENABLE_AUTOMATIC_CLKGATING),
	CLK_DIV(DIV_CLK_MIF_ECU, FREE_OSCCLK_MIF, CLK_CON_DIV_DIV_CLK_MIF_ECU_DIVRATIO, CLK_CON_DIV_DIV_CLK_MIF_ECU_BUSY, CLK_CON_DIV_DIV_CLK_MIF_ECU_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_DIV(DIV_CLK_NOCL0_ECU, FREE_OSCCLK_NOCL0, CLK_CON_DIV_DIV_CLK_NOCL0_ECU_DIVRATIO, CLK_CON_DIV_DIV_CLK_NOCL0_ECU_BUSY, CLK_CON_DIV_DIV_CLK_NOCL0_ECU_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_DIV(DIV_CLK_NOCL1A_ECU, FREE_OSCCLK_NOCL1A, CLK_CON_DIV_DIV_CLK_NOCL1A_ECU_DIVRATIO, CLK_CON_DIV_DIV_CLK_NOCL1A_ECU_BUSY, CLK_CON_DIV_DIV_CLK_NOCL1A_ECU_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_DIV(DIV_CLK_NOCL1B_ECU, FREE_OSCCLK_NOCL1B, CLK_CON_DIV_DIV_CLK_NOCL1B_ECU_DIVRATIO, CLK_CON_DIV_DIV_CLK_NOCL1B_ECU_BUSY, CLK_CON_DIV_DIV_CLK_NOCL1B_ECU_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_DIV(DIV_CLK_NOCL1C_ECU, FREE_OSCCLK_NOCL1C, CLK_CON_DIV_DIV_CLK_NOCL1C_ECU_DIVRATIO, CLK_CON_DIV_DIV_CLK_NOCL1C_ECU_BUSY, CLK_CON_DIV_DIV_CLK_NOCL1C_ECU_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_DIV(DIV_CLK_PERIC0_DBG_UART, MUX_CLK_PERIC0_DBG_UART, CLK_CON_DIV_DIV_CLK_PERIC0_DBG_UART_DIVRATIO, CLK_CON_DIV_DIV_CLK_PERIC0_DBG_UART_BUSY, CLK_CON_DIV_DIV_CLK_PERIC0_DBG_UART_ENABLE_AUTOMATIC_CLKGATING),
	CLK_DIV(DIV_CLK_PERIC0_USI10, MUX_CLK_PERIC0_USI10, CLK_CON_DIV_DIV_CLK_PERIC0_USI10_DIVRATIO, CLK_CON_DIV_DIV_CLK_PERIC0_USI10_BUSY, CLK_CON_DIV_DIV_CLK_PERIC0_USI10_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_DIV(DIV_CLK_RGBP_NOCP, MUX_CLKCMU_RGBP_NOC_USER, CLK_CON_DIV_DIV_CLK_RGBP_NOCP_DIVRATIO, CLK_CON_DIV_DIV_CLK_RGBP_NOCP_BUSY, CLK_CON_DIV_DIV_CLK_RGBP_NOCP_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_DIV(DIV_CLK_UFD_I2C, MUX_CLKALIVE_UFD_NOC_USER, CLK_CON_DIV_DIV_CLK_UFD_I2C_DIVRATIO, CLK_CON_DIV_DIV_CLK_UFD_I2C_BUSY, CLK_CON_DIV_DIV_CLK_UFD_I2C_ENABLE_AUTOMATIC_CLKGATING),
	CLK_DIV(DIV_CLK_UFD_NOC, MUX_CLKALIVE_UFD_NOC_USER, CLK_CON_DIV_DIV_CLK_UFD_NOC_DIVRATIO, CLK_CON_DIV_DIV_CLK_UFD_NOC_BUSY, CLK_CON_DIV_DIV_CLK_UFD_NOC_ENABLE_AUTOMATIC_CLKGATING),
	CLK_DIV(DIV_CLK_UFS_ECU, FREE_OSCCLK_UFS, CLK_CON_DIV_DIV_CLK_UFS_ECU_DIVRATIO, CLK_CON_DIV_DIV_CLK_UFS_ECU_BUSY, CLK_CON_DIV_DIV_CLK_UFS_ECU_ENABLE_AUTOMATIC_CLKGATING),
	CLK_DIV(DIV_CLK_VTS_DMIC_IF, DIV_CLK_VTS_AUD_DMIC, CLK_CON_DIV_DIV_CLK_VTS_DMIC_IF_DIVRATIO, CLK_CON_DIV_DIV_CLK_VTS_DMIC_IF_BUSY, CLK_CON_DIV_DIV_CLK_VTS_DMIC_IF_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_DIV(DIV_CLK_VTS_SERIAL_LIF, MUX_CLK_VTS_DMIC, CLK_CON_DIV_DIV_CLK_VTS_SERIAL_LIF_DIVRATIO, CLK_CON_DIV_DIV_CLK_VTS_SERIAL_LIF_BUSY, CLK_CON_DIV_DIV_CLK_VTS_SERIAL_LIF_ENABLE_AUTOMATIC_CLKGATING),
	CLK_DIV(DIV_CLK_VTS_SERIAL_LIF_CORE, MUX_CLK_VTS_DMIC, CLK_CON_DIV_DIV_CLK_VTS_SERIAL_LIF_CORE_DIVRATIO, CLK_CON_DIV_DIV_CLK_VTS_SERIAL_LIF_CORE_BUSY, CLK_CON_DIV_DIV_CLK_VTS_SERIAL_LIF_CORE_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_DIV(DIV_CLK_VTS_AUD_DMIC, MUX_CLK_VTS_DMIC, CLK_CON_DIV_DIV_CLK_VTS_AUD_DMIC_DIVRATIO, CLK_CON_DIV_DIV_CLK_VTS_AUD_DMIC_BUSY, CLK_CON_DIV_DIV_CLK_VTS_AUD_DMIC_ENABLE_AUTOMATIC_CLKGATING),
	CLK_DIV(DIV_CLK_VTS_SERIAL_LIF_US_PROX_CORE, MUX_CLK_VTS_DMIC, CLK_CON_DIV_DIV_CLK_VTS_SERIAL_LIF_US_PROX_CORE_DIVRATIO, CLK_CON_DIV_DIV_CLK_VTS_SERIAL_LIF_US_PROX_CORE_BUSY, CLK_CON_DIV_DIV_CLK_VTS_SERIAL_LIF_US_PROX_CORE_ENABLE_AUTOMATIC_CLKGATING),
	CLK_DIV(DIV_CLK_VTS_SERIAL_LIF_US_PROX, MUX_CLK_VTS_DMIC, CLK_CON_DIV_DIV_CLK_VTS_SERIAL_LIF_US_PROX_DIVRATIO, CLK_CON_DIV_DIV_CLK_VTS_SERIAL_LIF_US_PROX_BUSY, CLK_CON_DIV_DIV_CLK_VTS_SERIAL_LIF_US_PROX_ENABLE_AUTOMATIC_CLKGATING),
	CLK_DIV(DIV_CLK_YUVP_NOCP, MUX_CLKCMU_YUVP_NOC_USER, CLK_CON_DIV_DIV_CLK_YUVP_NOCP_DIVRATIO, CLK_CON_DIV_DIV_CLK_YUVP_NOCP_BUSY, CLK_CON_DIV_DIV_CLK_YUVP_NOCP_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_DIV(DIV_CLK_CPUCL1_CORE_1, MUX_CLK_CPUCL1_IDLECLKDOWN_1, EMPTY_CAL_ID, CLK_CON_DIV_DIV_CLK_CPUCL1_CORE_1_BUSY, CLK_CON_DIV_DIV_CLK_CPUCL1_CORE_1_ENABLE_AUTOMATIC_CLKGATING),
	CLK_DIV(DIV_CLK_CPUCL1_CORE_2, MUX_CLK_CPUCL1_IDLECLKDOWN_2, EMPTY_CAL_ID, CLK_CON_DIV_DIV_CLK_CPUCL1_CORE_2_BUSY, CLK_CON_DIV_DIV_CLK_CPUCL1_CORE_2_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_DIV(DIV_CLK_GNPU_XMAA, MUX_CLK_GNPU_XMAA, EMPTY_CAL_ID, CLK_CON_DIV_DIV_CLK_GNPU_XMAA_BUSY, CLK_CON_DIV_DIV_CLK_GNPU_XMAA_ENABLE_AUTOMATIC_CLKGATING),
...
unsigned int cmucal_gate_size = 2357;
struct cmucal_gate cmucal_gate_list[] = {
	...
	CLK_GATE(CLK_BLK_ALIVE_UID_RTC_0_IPCLKPORT_PCLK, DIV_CLK_ALIVE_NOC, CLK_CON_GAT_CLK_BLK_ALIVE_UID_RTC_0_IPCLKPORT_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_ALIVE_UID_RTC_0_IPCLKPORT_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_ALIVE_UID_RTC_0_IPCLKPORT_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_ALIVE_UID_RTC_S_IPCLKPORT_PCLK, DIV_CLK_ALIVE_NOC, CLK_CON_GAT_CLK_BLK_ALIVE_UID_RTC_S_IPCLKPORT_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_ALIVE_UID_RTC_S_IPCLKPORT_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_ALIVE_UID_RTC_S_IPCLKPORT_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_ALIVE_UID_D_TZPC_ALIVE_IPCLKPORT_PCLK, DIV_CLK_ALIVE_NOC, CLK_CON_GAT_CLK_BLK_ALIVE_UID_D_TZPC_ALIVE_IPCLKPORT_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_ALIVE_UID_D_TZPC_ALIVE_IPCLKPORT_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_ALIVE_UID_D_TZPC_ALIVE_IPCLKPORT_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_ALIVE_UID_GREBEINTEGRATION0_IPCLKPORT_HCLK, DIV_CLK_ALIVE_NOC, CLK_CON_GAT_CLK_BLK_ALIVE_UID_GREBEINTEGRATION0_IPCLKPORT_HCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_ALIVE_UID_GREBEINTEGRATION0_IPCLKPORT_HCLK_MANUAL, CLK_CON_GAT_CLK_BLK_ALIVE_UID_GREBEINTEGRATION0_IPCLKPORT_HCLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_ALIVE_UID_SLH_AXI_MI_P_MODEMALIVE_IPCLKPORT_I_CLK, DIV_CLK_ALIVE_NOC, CLK_CON_GAT_CLK_BLK_ALIVE_UID_SLH_AXI_MI_P_MODEMALIVE_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_ALIVE_UID_SLH_AXI_MI_P_MODEMALIVE_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_ALIVE_UID_SLH_AXI_MI_P_MODEMALIVE_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_ALIVE_UID_SLH_AXI_MI_D_CHUBVTSALIVE_IPCLKPORT_I_CLK, DIV_CLK_ALIVE_NOC, CLK_CON_GAT_CLK_BLK_ALIVE_UID_SLH_AXI_MI_D_CHUBVTSALIVE_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_ALIVE_UID_SLH_AXI_MI_D_CHUBVTSALIVE_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_ALIVE_UID_SLH_AXI_MI_D_CHUBVTSALIVE_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_ALIVE_UID_SLH_AXI_SI_P_ALIVECMGP_IPCLKPORT_I_CLK, DIV_CLK_ALIVE_NOC, CLK_CON_GAT_CLK_BLK_ALIVE_UID_SLH_AXI_SI_P_ALIVECMGP_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_ALIVE_UID_SLH_AXI_SI_P_ALIVECMGP_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_ALIVE_UID_SLH_AXI_SI_P_ALIVECMGP_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_ALIVE_UID_SLH_AXI_SI_P_ALIVECHUBVTS_IPCLKPORT_I_CLK, DIV_CLK_ALIVE_NOC, CLK_CON_GAT_CLK_BLK_ALIVE_UID_SLH_AXI_SI_P_ALIVECHUBVTS_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_ALIVE_UID_SLH_AXI_SI_P_ALIVECHUBVTS_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_ALIVE_UID_SLH_AXI_SI_P_ALIVECHUBVTS_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_ALIVE_UID_RSTNSYNC_CLK_ALIVE_APM0_IPCLKPORT_CLK, DIV_CLK_ALIVE_NOC, CLK_CON_GAT_CLK_BLK_ALIVE_UID_RSTNSYNC_CLK_ALIVE_APM0_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_ALIVE_UID_RSTNSYNC_CLK_ALIVE_APM0_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_ALIVE_UID_RSTNSYNC_CLK_ALIVE_APM0_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_ALIVE_UID_WDT_APM0_IPCLKPORT_PCLK, DIV_CLK_ALIVE_NOC, CLK_CON_GAT_CLK_BLK_ALIVE_UID_WDT_APM0_IPCLKPORT_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_ALIVE_UID_WDT_APM0_IPCLKPORT_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_ALIVE_UID_WDT_APM0_IPCLKPORT_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_ALIVE_UID_RTC_1_IPCLKPORT_PCLK, DIV_CLK_ALIVE_NOC, CLK_CON_GAT_CLK_BLK_ALIVE_UID_RTC_1_IPCLKPORT_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_ALIVE_UID_RTC_1_IPCLKPORT_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_ALIVE_UID_RTC_1_IPCLKPORT_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_ALIVE_UID_SLH_AXI_MI_D_GNSSALIVE_IPCLKPORT_I_CLK, DIV_CLK_ALIVE_NOC, CLK_CON_GAT_CLK_BLK_ALIVE_UID_SLH_AXI_MI_D_GNSSALIVE_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_ALIVE_UID_SLH_AXI_MI_D_GNSSALIVE_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_ALIVE_UID_SLH_AXI_MI_D_GNSSALIVE_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_ALIVE_UID_SLH_AXI_SI_P_ALIVECPUCL0_PPU_IPCLKPORT_I_CLK, DIV_CLK_ALIVE_NOC, CLK_CON_GAT_CLK_BLK_ALIVE_UID_SLH_AXI_SI_P_ALIVECPUCL0_PPU_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_ALIVE_UID_SLH_AXI_SI_P_ALIVECPUCL0_PPU_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_ALIVE_UID_SLH_AXI_SI_P_ALIVECPUCL0_PPU_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_ALIVE_UID_LH_AXI_SI_P_APM_INT_IPCLKPORT_I_CLK, DIV_CLK_ALIVE_NOC, CLK_CON_GAT_CLK_BLK_ALIVE_UID_LH_AXI_SI_P_APM_INT_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_ALIVE_UID_LH_AXI_SI_P_APM_INT_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_ALIVE_UID_LH_AXI_SI_P_APM_INT_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_ALIVE_UID_LH_AXI_MI_D_DBGCORE_INT_IPCLKPORT_I_CLK, DIV_CLK_ALIVE_NOC, CLK_CON_GAT_CLK_BLK_ALIVE_UID_LH_AXI_MI_D_DBGCORE_INT_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_ALIVE_UID_LH_AXI_MI_D_DBGCORE_INT_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_ALIVE_UID_LH_AXI_MI_D_DBGCORE_INT_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_ALIVE_UID_RSTNSYNC_SR_CLK_ALIVE_TIMER_IPCLKPORT_CLK, MUX_CLK_ALIVE_TIMER, CLK_CON_GAT_CLK_BLK_ALIVE_UID_RSTNSYNC_SR_CLK_ALIVE_TIMER_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_ALIVE_UID_RSTNSYNC_SR_CLK_ALIVE_TIMER_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_ALIVE_UID_RSTNSYNC_SR_CLK_ALIVE_TIMER_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_ALIVE_UID_SLH_AXI_SI_P_ALIVE_DNC_IPCLKPORT_I_CLK, DIV_CLK_ALIVE_NOC, CLK_CON_GAT_CLK_BLK_ALIVE_UID_SLH_AXI_SI_P_ALIVE_DNC_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_ALIVE_UID_SLH_AXI_SI_P_ALIVE_DNC_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_ALIVE_UID_SLH_AXI_SI_P_ALIVE_DNC_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_ALIVE_UID_APM_DTA_IPCLKPORT_PCLK, DIV_CLK_ALIVE_NOC, CLK_CON_GAT_CLK_BLK_ALIVE_UID_APM_DTA_IPCLKPORT_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_ALIVE_UID_APM_DTA_IPCLKPORT_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_ALIVE_UID_APM_DTA_IPCLKPORT_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_ALIVE_UID_RTC_S_IPCLKPORT_OSCCLK, OSCCLK_RCO_ALIVE, CLK_CON_GAT_CLK_BLK_ALIVE_UID_RTC_S_IPCLKPORT_OSCCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_ALIVE_UID_RTC_S_IPCLKPORT_OSCCLK_MANUAL, CLK_CON_GAT_CLK_BLK_ALIVE_UID_RTC_S_IPCLKPORT_OSCCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_ALIVE_UID_RTC_1_IPCLKPORT_OSCCLK, OSCCLK_RCO_ALIVE, CLK_CON_GAT_CLK_BLK_ALIVE_UID_RTC_1_IPCLKPORT_OSCCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_ALIVE_UID_RTC_1_IPCLKPORT_OSCCLK_MANUAL, CLK_CON_GAT_CLK_BLK_ALIVE_UID_RTC_1_IPCLKPORT_OSCCLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(GATE_CLKALIVE_AOCCSIS_NOC, MUX_CLKALIVE_CSIS_NOC, CLK_CON_GAT_GATE_CLKALIVE_AOCCSIS_NOC_CG_VAL, CLK_CON_GAT_GATE_CLKALIVE_AOCCSIS_NOC_MANUAL, CLK_CON_GAT_GATE_CLKALIVE_AOCCSIS_NOC_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_ALIVE_UID_YAMIN_MCU_ASM_IPCLKPORT_CLKIN, DIV_CLK_ALIVE_NOC, CLK_CON_GAT_CLK_BLK_ALIVE_UID_YAMIN_MCU_ASM_IPCLKPORT_CLKIN_CG_VAL, CLK_CON_GAT_CLK_BLK_ALIVE_UID_YAMIN_MCU_ASM_IPCLKPORT_CLKIN_MANUAL, CLK_CON_GAT_CLK_BLK_ALIVE_UID_YAMIN_MCU_ASM_IPCLKPORT_CLKIN_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_ALIVE_UID_YAMIN_MCU_ASM_IPCLKPORT_DBGCLK, DIV_CLK_ALIVE_NOC, CLK_CON_GAT_CLK_BLK_ALIVE_UID_YAMIN_MCU_ASM_IPCLKPORT_DBGCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_ALIVE_UID_YAMIN_MCU_ASM_IPCLKPORT_DBGCLK_MANUAL, CLK_CON_GAT_CLK_BLK_ALIVE_UID_YAMIN_MCU_ASM_IPCLKPORT_DBGCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_ALIVE_UID_YAMIN_MCU_ASM_IPCLKPORT_IWICCLK, DIV_CLK_ALIVE_NOC, CLK_CON_GAT_CLK_BLK_ALIVE_UID_YAMIN_MCU_ASM_IPCLKPORT_IWICCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_ALIVE_UID_YAMIN_MCU_ASM_IPCLKPORT_IWICCLK_MANUAL, CLK_CON_GAT_CLK_BLK_ALIVE_UID_YAMIN_MCU_ASM_IPCLKPORT_IWICCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_ALIVE_UID_RSTNSYNC_CLK_ALIVE_ASM_IPCLKPORT_CLK, DIV_CLK_ALIVE_NOC, CLK_CON_GAT_CLK_BLK_ALIVE_UID_RSTNSYNC_CLK_ALIVE_ASM_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_ALIVE_UID_RSTNSYNC_CLK_ALIVE_ASM_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_ALIVE_UID_RSTNSYNC_CLK_ALIVE_ASM_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_ALIVE_UID_ASYNCINTERRUPT_ASM_IPCLKPORT_CLK, DIV_CLK_ALIVE_NOC, CLK_CON_GAT_CLK_BLK_ALIVE_UID_ASYNCINTERRUPT_ASM_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_ALIVE_UID_ASYNCINTERRUPT_ASM_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_ALIVE_UID_ASYNCINTERRUPT_ASM_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_ALIVE_UID_BAAW_ASM_IPCLKPORT_I_PCLK, DIV_CLK_ALIVE_NOC, CLK_CON_GAT_CLK_BLK_ALIVE_UID_BAAW_ASM_IPCLKPORT_I_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_ALIVE_UID_BAAW_ASM_IPCLKPORT_I_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_ALIVE_UID_BAAW_ASM_IPCLKPORT_I_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_ALIVE_UID_TIMER_ASM_IPCLKPORT_PCLK, DIV_CLK_ALIVE_NOC, CLK_CON_GAT_CLK_BLK_ALIVE_UID_TIMER_ASM_IPCLKPORT_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_ALIVE_UID_TIMER_ASM_IPCLKPORT_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_ALIVE_UID_TIMER_ASM_IPCLKPORT_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_ALIVE_UID_MAILBOX_AP_ASM_IPCLKPORT_PCLK, DIV_CLK_ALIVE_NOC, CLK_CON_GAT_CLK_BLK_ALIVE_UID_MAILBOX_AP_ASM_IPCLKPORT_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_ALIVE_UID_MAILBOX_AP_ASM_IPCLKPORT_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_ALIVE_UID_MAILBOX_AP_ASM_IPCLKPORT_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_ALIVE_UID_MAILBOX_APM_ASM_IPCLKPORT_PCLK, DIV_CLK_ALIVE_NOC, CLK_CON_GAT_CLK_BLK_ALIVE_UID_MAILBOX_APM_ASM_IPCLKPORT_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_ALIVE_UID_MAILBOX_APM_ASM_IPCLKPORT_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_ALIVE_UID_MAILBOX_APM_ASM_IPCLKPORT_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_ALIVE_UID_MAILBOX_ASM_CP_IPCLKPORT_PCLK, DIV_CLK_ALIVE_NOC, CLK_CON_GAT_CLK_BLK_ALIVE_UID_MAILBOX_ASM_CP_IPCLKPORT_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_ALIVE_UID_MAILBOX_ASM_CP_IPCLKPORT_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_ALIVE_UID_MAILBOX_ASM_CP_IPCLKPORT_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_ALIVE_UID_WDT_ASM_IPCLKPORT_PCLK, DIV_CLK_ALIVE_NOC, CLK_CON_GAT_CLK_BLK_ALIVE_UID_WDT_ASM_IPCLKPORT_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_ALIVE_UID_WDT_ASM_IPCLKPORT_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_ALIVE_UID_WDT_ASM_IPCLKPORT_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_ALIVE_UID_ASYNCAHB_MI_ASM_IPCLKPORT_HCLKM, DIV_CLK_ALIVE_NOC, CLK_CON_GAT_CLK_BLK_ALIVE_UID_ASYNCAHB_MI_ASM_IPCLKPORT_HCLKM_CG_VAL, CLK_CON_GAT_CLK_BLK_ALIVE_UID_ASYNCAHB_MI_ASM_IPCLKPORT_HCLKM_MANUAL, CLK_CON_GAT_CLK_BLK_ALIVE_UID_ASYNCAHB_MI_ASM_IPCLKPORT_HCLKM_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_ALIVE_UID_RSTNSYNC_SR_CLK_ALIVE_TIMER_ASM_IPCLKPORT_CLK, MUX_CLK_ALIVE_TIMER_ASM, CLK_CON_GAT_CLK_BLK_ALIVE_UID_RSTNSYNC_SR_CLK_ALIVE_TIMER_ASM_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_ALIVE_UID_RSTNSYNC_SR_CLK_ALIVE_TIMER_ASM_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_ALIVE_UID_RSTNSYNC_SR_CLK_ALIVE_TIMER_ASM_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_ALIVE_UID_ECU_ALIVE_IPCLKPORT_PCLK, DIV_CLK_ALIVE_NOC, CLK_CON_GAT_CLK_BLK_ALIVE_UID_ECU_ALIVE_IPCLKPORT_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_ALIVE_UID_ECU_ALIVE_IPCLKPORT_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_ALIVE_UID_ECU_ALIVE_IPCLKPORT_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(GATE_CLKALIVE_UFD_PERI, MUX_CLKALIVE_UFD_PERI, CLK_CON_GAT_GATE_CLKALIVE_UFD_PERI_CG_VAL, CLK_CON_GAT_GATE_CLKALIVE_UFD_PERI_MANUAL, CLK_CON_GAT_GATE_CLKALIVE_UFD_PERI_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_ALIVE_UID_ASYNCAHB_MI_APM0_IPCLKPORT_HCLKM, OSCCLK_RCO_ALIVE, CLK_CON_GAT_CLK_BLK_ALIVE_UID_ASYNCAHB_MI_APM0_IPCLKPORT_HCLKM_CG_VAL, CLK_CON_GAT_CLK_BLK_ALIVE_UID_ASYNCAHB_MI_APM0_IPCLKPORT_HCLKM_MANUAL, CLK_CON_GAT_CLK_BLK_ALIVE_UID_ASYNCAHB_MI_APM0_IPCLKPORT_HCLKM_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_ALIVE_UID_S2PC_ALIVE_IPCLKPORT_PCLK, DIV_CLK_ALIVE_NOC, CLK_CON_GAT_CLK_BLK_ALIVE_UID_S2PC_ALIVE_IPCLKPORT_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_ALIVE_UID_S2PC_ALIVE_IPCLKPORT_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_ALIVE_UID_S2PC_ALIVE_IPCLKPORT_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_ALIVE_UID_GREBEINTEGRATION1_IPCLKPORT_HCLK, DIV_CLK_ALIVE_NOC, CLK_CON_GAT_CLK_BLK_ALIVE_UID_GREBEINTEGRATION1_IPCLKPORT_HCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_ALIVE_UID_GREBEINTEGRATION1_IPCLKPORT_HCLK_MANUAL, CLK_CON_GAT_CLK_BLK_ALIVE_UID_GREBEINTEGRATION1_IPCLKPORT_HCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_ALIVE_UID_WDT_APM1_IPCLKPORT_PCLK, DIV_CLK_ALIVE_NOC, CLK_CON_GAT_CLK_BLK_ALIVE_UID_WDT_APM1_IPCLKPORT_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_ALIVE_UID_WDT_APM1_IPCLKPORT_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_ALIVE_UID_WDT_APM1_IPCLKPORT_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_ALIVE_UID_MAILBOX_APM0_APM1_IPCLKPORT_PCLK, DIV_CLK_ALIVE_NOC, CLK_CON_GAT_CLK_BLK_ALIVE_UID_MAILBOX_APM0_APM1_IPCLKPORT_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_ALIVE_UID_MAILBOX_APM0_APM1_IPCLKPORT_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_ALIVE_UID_MAILBOX_APM0_APM1_IPCLKPORT_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_ALIVE_UID_MAILBOX_ASM_APM1_IPCLKPORT_PCLK, DIV_CLK_ALIVE_NOC, CLK_CON_GAT_CLK_BLK_ALIVE_UID_MAILBOX_ASM_APM1_IPCLKPORT_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_ALIVE_UID_MAILBOX_ASM_APM1_IPCLKPORT_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_ALIVE_UID_MAILBOX_ASM_APM1_IPCLKPORT_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_ALIVE_UID_ASYNCAHB_MI_APM1_IPCLKPORT_HCLKM, OSCCLK_RCO_ALIVE, CLK_CON_GAT_CLK_BLK_ALIVE_UID_ASYNCAHB_MI_APM1_IPCLKPORT_HCLKM_CG_VAL, CLK_CON_GAT_CLK_BLK_ALIVE_UID_ASYNCAHB_MI_APM1_IPCLKPORT_HCLKM_MANUAL, CLK_CON_GAT_CLK_BLK_ALIVE_UID_ASYNCAHB_MI_APM1_IPCLKPORT_HCLKM_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_ALIVE_UID_RSTNSYNC_CLK_ALIVE_APM1_IPCLKPORT_CLK, DIV_CLK_ALIVE_NOC, CLK_CON_GAT_CLK_BLK_ALIVE_UID_RSTNSYNC_CLK_ALIVE_APM1_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_ALIVE_UID_RSTNSYNC_CLK_ALIVE_APM1_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_ALIVE_UID_RSTNSYNC_CLK_ALIVE_APM1_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_ALIVE_UID_ECU_ALIVE_IPCLKPORT_CLK, DIV_CLK_ALIVE_ECU, CLK_CON_GAT_CLK_BLK_ALIVE_UID_ECU_ALIVE_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_ALIVE_UID_ECU_ALIVE_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_ALIVE_UID_ECU_ALIVE_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_ALIVE_UID_RSTNSYNC_SR_CLK_ALIVE_ECU_IPCLKPORT_CLK, DIV_CLK_ALIVE_ECU, CLK_CON_GAT_CLK_BLK_ALIVE_UID_RSTNSYNC_SR_CLK_ALIVE_ECU_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_ALIVE_UID_RSTNSYNC_SR_CLK_ALIVE_ECU_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_ALIVE_UID_RSTNSYNC_SR_CLK_ALIVE_ECU_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_ALIVE_UID_AHB_BUSMATRIX_ALIVE1_IPCLKPORT_HCLK, DIV_CLK_ALIVE_NOC, CLK_CON_GAT_CLK_BLK_ALIVE_UID_AHB_BUSMATRIX_ALIVE1_IPCLKPORT_HCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_ALIVE_UID_AHB_BUSMATRIX_ALIVE1_IPCLKPORT_HCLK_MANUAL, CLK_CON_GAT_CLK_BLK_ALIVE_UID_AHB_BUSMATRIX_ALIVE1_IPCLKPORT_HCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLKAOCCSIS_CSIS_NOCD, MUX_CLK_AOCCSIS_NOC, CLK_CON_GAT_CLKAOCCSIS_CSIS_NOCD_CG_VAL, CLK_CON_GAT_CLKAOCCSIS_CSIS_NOCD_MANUAL, CLK_CON_GAT_CLKAOCCSIS_CSIS_NOCD_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLKAOCCSIS_CSIS_NOCP, DIV_CLK_AOCCSIS_NOCP, CLK_CON_GAT_CLKAOCCSIS_CSIS_NOCP_CG_VAL, CLK_CON_GAT_CLKAOCCSIS_CSIS_NOCP_MANUAL, CLK_CON_GAT_CLKAOCCSIS_CSIS_NOCP_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLKAOCCSIS_CSIS_OIS_MCU, MUX_CLKCMU_AOCCSIS_OIS_MCU_USER, CLK_CON_GAT_CLKAOCCSIS_CSIS_OIS_MCU_CG_VAL, CLK_CON_GAT_CLKAOCCSIS_CSIS_OIS_MCU_MANUAL, CLK_CON_GAT_CLKAOCCSIS_CSIS_OIS_MCU_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_AOCCSIS_UID_AOCCSIS_CMU_AOCCSIS_IPCLKPORT_PCLK, DIV_CLK_AOCCSIS_NOCP, CLK_CON_GAT_CLK_BLK_AOCCSIS_UID_AOCCSIS_CMU_AOCCSIS_IPCLKPORT_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_AOCCSIS_UID_AOCCSIS_CMU_AOCCSIS_IPCLKPORT_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_AOCCSIS_UID_AOCCSIS_CMU_AOCCSIS_IPCLKPORT_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_AOCCSIS_UID_D_TZPC_AOCCSIS_IPCLKPORT_PCLK, DIV_CLK_AOCCSIS_NOCP, CLK_CON_GAT_CLK_BLK_AOCCSIS_UID_D_TZPC_AOCCSIS_IPCLKPORT_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_AOCCSIS_UID_D_TZPC_AOCCSIS_IPCLKPORT_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_AOCCSIS_UID_D_TZPC_AOCCSIS_IPCLKPORT_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_AOCCSIS_UID_MIPI_PHY_LINK_WRAP_IPCLKPORT_CSIS_LINK_ACLK_CSIS0, MUX_CLK_AOCCSIS_NOC, CLK_CON_GAT_CLK_BLK_AOCCSIS_UID_MIPI_PHY_LINK_WRAP_IPCLKPORT_CSIS_LINK_ACLK_CSIS0_CG_VAL, CLK_CON_GAT_CLK_BLK_AOCCSIS_UID_MIPI_PHY_LINK_WRAP_IPCLKPORT_CSIS_LINK_ACLK_CSIS0_MANUAL, CLK_CON_GAT_CLK_BLK_AOCCSIS_UID_MIPI_PHY_LINK_WRAP_IPCLKPORT_CSIS_LINK_ACLK_CSIS0_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_AOCCSIS_UID_MIPI_PHY_LINK_WRAP_IPCLKPORT_CSIS_LINK_ACLK_CSIS1, MUX_CLK_AOCCSIS_NOC, CLK_CON_GAT_CLK_BLK_AOCCSIS_UID_MIPI_PHY_LINK_WRAP_IPCLKPORT_CSIS_LINK_ACLK_CSIS1_CG_VAL, CLK_CON_GAT_CLK_BLK_AOCCSIS_UID_MIPI_PHY_LINK_WRAP_IPCLKPORT_CSIS_LINK_ACLK_CSIS1_MANUAL, CLK_CON_GAT_CLK_BLK_AOCCSIS_UID_MIPI_PHY_LINK_WRAP_IPCLKPORT_CSIS_LINK_ACLK_CSIS1_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_AOCCSIS_UID_MIPI_PHY_LINK_WRAP_IPCLKPORT_CSIS_LINK_ACLK_CSIS2, MUX_CLK_AOCCSIS_NOC, CLK_CON_GAT_CLK_BLK_AOCCSIS_UID_MIPI_PHY_LINK_WRAP_IPCLKPORT_CSIS_LINK_ACLK_CSIS2_CG_VAL, CLK_CON_GAT_CLK_BLK_AOCCSIS_UID_MIPI_PHY_LINK_WRAP_IPCLKPORT_CSIS_LINK_ACLK_CSIS2_MANUAL, CLK_CON_GAT_CLK_BLK_AOCCSIS_UID_MIPI_PHY_LINK_WRAP_IPCLKPORT_CSIS_LINK_ACLK_CSIS2_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_AOCCSIS_UID_MIPI_PHY_LINK_WRAP_IPCLKPORT_CSIS_LINK_ACLK_CSIS3, MUX_CLK_AOCCSIS_NOC, CLK_CON_GAT_CLK_BLK_AOCCSIS_UID_MIPI_PHY_LINK_WRAP_IPCLKPORT_CSIS_LINK_ACLK_CSIS3_CG_VAL, CLK_CON_GAT_CLK_BLK_AOCCSIS_UID_MIPI_PHY_LINK_WRAP_IPCLKPORT_CSIS_LINK_ACLK_CSIS3_MANUAL, CLK_CON_GAT_CLK_BLK_AOCCSIS_UID_MIPI_PHY_LINK_WRAP_IPCLKPORT_CSIS_LINK_ACLK_CSIS3_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_AOCCSIS_UID_MIPI_PHY_LINK_WRAP_IPCLKPORT_CSIS_LINK_ACLK_CSIS4, MUX_CLK_AOCCSIS_NOC, CLK_CON_GAT_CLK_BLK_AOCCSIS_UID_MIPI_PHY_LINK_WRAP_IPCLKPORT_CSIS_LINK_ACLK_CSIS4_CG_VAL, CLK_CON_GAT_CLK_BLK_AOCCSIS_UID_MIPI_PHY_LINK_WRAP_IPCLKPORT_CSIS_LINK_ACLK_CSIS4_MANUAL, CLK_CON_GAT_CLK_BLK_AOCCSIS_UID_MIPI_PHY_LINK_WRAP_IPCLKPORT_CSIS_LINK_ACLK_CSIS4_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_AOCCSIS_UID_MIPI_PHY_LINK_WRAP_IPCLKPORT_CSIS_LINK_ACLK_CSIS5, MUX_CLK_AOCCSIS_NOC, CLK_CON_GAT_CLK_BLK_AOCCSIS_UID_MIPI_PHY_LINK_WRAP_IPCLKPORT_CSIS_LINK_ACLK_CSIS5_CG_VAL, CLK_CON_GAT_CLK_BLK_AOCCSIS_UID_MIPI_PHY_LINK_WRAP_IPCLKPORT_CSIS_LINK_ACLK_CSIS5_MANUAL, CLK_CON_GAT_CLK_BLK_AOCCSIS_UID_MIPI_PHY_LINK_WRAP_IPCLKPORT_CSIS_LINK_ACLK_CSIS5_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_AOCCSIS_UID_MIPI_PHY_LINK_WRAP_IPCLKPORT_CSIS_LINK_ACLK_CSIS6, MUX_CLK_AOCCSIS_NOC, CLK_CON_GAT_CLK_BLK_AOCCSIS_UID_MIPI_PHY_LINK_WRAP_IPCLKPORT_CSIS_LINK_ACLK_CSIS6_CG_VAL, CLK_CON_GAT_CLK_BLK_AOCCSIS_UID_MIPI_PHY_LINK_WRAP_IPCLKPORT_CSIS_LINK_ACLK_CSIS6_MANUAL, CLK_CON_GAT_CLK_BLK_AOCCSIS_UID_MIPI_PHY_LINK_WRAP_IPCLKPORT_CSIS_LINK_ACLK_CSIS6_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_AOCCSIS_UID_MIPI_PHY_LINK_WRAP_IPCLKPORT_CSIS_LINK_I_FD_ACLK, MUX_CLK_AOCCSIS_NOC, CLK_CON_GAT_CLK_BLK_AOCCSIS_UID_MIPI_PHY_LINK_WRAP_IPCLKPORT_CSIS_LINK_I_FD_ACLK_CG_VAL, CLK_CON_GAT_CLK_BLK_AOCCSIS_UID_MIPI_PHY_LINK_WRAP_IPCLKPORT_CSIS_LINK_I_FD_ACLK_MANUAL, CLK_CON_GAT_CLK_BLK_AOCCSIS_UID_MIPI_PHY_LINK_WRAP_IPCLKPORT_CSIS_LINK_I_FD_ACLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_AOCCSIS_UID_MIPI_PHY_LINK_WRAP_IPCLKPORT_CSIS_LINK_PCLK_CSIS0, DIV_CLK_AOCCSIS_NOCP, CLK_CON_GAT_CLK_BLK_AOCCSIS_UID_MIPI_PHY_LINK_WRAP_IPCLKPORT_CSIS_LINK_PCLK_CSIS0_CG_VAL, CLK_CON_GAT_CLK_BLK_AOCCSIS_UID_MIPI_PHY_LINK_WRAP_IPCLKPORT_CSIS_LINK_PCLK_CSIS0_MANUAL, CLK_CON_GAT_CLK_BLK_AOCCSIS_UID_MIPI_PHY_LINK_WRAP_IPCLKPORT_CSIS_LINK_PCLK_CSIS0_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_AOCCSIS_UID_MIPI_PHY_LINK_WRAP_IPCLKPORT_CSIS_LINK_PCLK_CSIS1, DIV_CLK_AOCCSIS_NOCP, CLK_CON_GAT_CLK_BLK_AOCCSIS_UID_MIPI_PHY_LINK_WRAP_IPCLKPORT_CSIS_LINK_PCLK_CSIS1_CG_VAL, CLK_CON_GAT_CLK_BLK_AOCCSIS_UID_MIPI_PHY_LINK_WRAP_IPCLKPORT_CSIS_LINK_PCLK_CSIS1_MANUAL, CLK_CON_GAT_CLK_BLK_AOCCSIS_UID_MIPI_PHY_LINK_WRAP_IPCLKPORT_CSIS_LINK_PCLK_CSIS1_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_AOCCSIS_UID_MIPI_PHY_LINK_WRAP_IPCLKPORT_CSIS_LINK_PCLK_CSIS2, DIV_CLK_AOCCSIS_NOCP, CLK_CON_GAT_CLK_BLK_AOCCSIS_UID_MIPI_PHY_LINK_WRAP_IPCLKPORT_CSIS_LINK_PCLK_CSIS2_CG_VAL, CLK_CON_GAT_CLK_BLK_AOCCSIS_UID_MIPI_PHY_LINK_WRAP_IPCLKPORT_CSIS_LINK_PCLK_CSIS2_MANUAL, CLK_CON_GAT_CLK_BLK_AOCCSIS_UID_MIPI_PHY_LINK_WRAP_IPCLKPORT_CSIS_LINK_PCLK_CSIS2_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_AOCCSIS_UID_MIPI_PHY_LINK_WRAP_IPCLKPORT_CSIS_LINK_PCLK_CSIS4, DIV_CLK_AOCCSIS_NOCP, CLK_CON_GAT_CLK_BLK_AOCCSIS_UID_MIPI_PHY_LINK_WRAP_IPCLKPORT_CSIS_LINK_PCLK_CSIS4_CG_VAL, CLK_CON_GAT_CLK_BLK_AOCCSIS_UID_MIPI_PHY_LINK_WRAP_IPCLKPORT_CSIS_LINK_PCLK_CSIS4_MANUAL, CLK_CON_GAT_CLK_BLK_AOCCSIS_UID_MIPI_PHY_LINK_WRAP_IPCLKPORT_CSIS_LINK_PCLK_CSIS4_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_AOCCSIS_UID_MIPI_PHY_LINK_WRAP_IPCLKPORT_CSIS_LINK_PCLK_CSIS3, DIV_CLK_AOCCSIS_NOCP, CLK_CON_GAT_CLK_BLK_AOCCSIS_UID_MIPI_PHY_LINK_WRAP_IPCLKPORT_CSIS_LINK_PCLK_CSIS3_CG_VAL, CLK_CON_GAT_CLK_BLK_AOCCSIS_UID_MIPI_PHY_LINK_WRAP_IPCLKPORT_CSIS_LINK_PCLK_CSIS3_MANUAL, CLK_CON_GAT_CLK_BLK_AOCCSIS_UID_MIPI_PHY_LINK_WRAP_IPCLKPORT_CSIS_LINK_PCLK_CSIS3_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_AOCCSIS_UID_MIPI_PHY_LINK_WRAP_IPCLKPORT_CSIS_LINK_PCLK_CSIS5, DIV_CLK_AOCCSIS_NOCP, CLK_CON_GAT_CLK_BLK_AOCCSIS_UID_MIPI_PHY_LINK_WRAP_IPCLKPORT_CSIS_LINK_PCLK_CSIS5_CG_VAL, CLK_CON_GAT_CLK_BLK_AOCCSIS_UID_MIPI_PHY_LINK_WRAP_IPCLKPORT_CSIS_LINK_PCLK_CSIS5_MANUAL, CLK_CON_GAT_CLK_BLK_AOCCSIS_UID_MIPI_PHY_LINK_WRAP_IPCLKPORT_CSIS_LINK_PCLK_CSIS5_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_AOCCSIS_UID_MIPI_PHY_LINK_WRAP_IPCLKPORT_CSIS_LINK_PCLK_CSIS6, DIV_CLK_AOCCSIS_NOCP, CLK_CON_GAT_CLK_BLK_AOCCSIS_UID_MIPI_PHY_LINK_WRAP_IPCLKPORT_CSIS_LINK_PCLK_CSIS6_CG_VAL, CLK_CON_GAT_CLK_BLK_AOCCSIS_UID_MIPI_PHY_LINK_WRAP_IPCLKPORT_CSIS_LINK_PCLK_CSIS6_MANUAL, CLK_CON_GAT_CLK_BLK_AOCCSIS_UID_MIPI_PHY_LINK_WRAP_IPCLKPORT_CSIS_LINK_PCLK_CSIS6_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_AOCCSIS_UID_XIU_P1_CSIS_IPCLKPORT_ACLK, DIV_CLK_AOCCSIS_NOCP, CLK_CON_GAT_CLK_BLK_AOCCSIS_UID_XIU_P1_CSIS_IPCLKPORT_ACLK_CG_VAL, CLK_CON_GAT_CLK_BLK_AOCCSIS_UID_XIU_P1_CSIS_IPCLKPORT_ACLK_MANUAL, CLK_CON_GAT_CLK_BLK_AOCCSIS_UID_XIU_P1_CSIS_IPCLKPORT_ACLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_AOCCSIS_UID_AD_APB_MIPI_PHY_IPCLKPORT_PCLKM, DIV_CLK_AOCCSIS_DCPHY, CLK_CON_GAT_CLK_BLK_AOCCSIS_UID_AD_APB_MIPI_PHY_IPCLKPORT_PCLKM_CG_VAL, CLK_CON_GAT_CLK_BLK_AOCCSIS_UID_AD_APB_MIPI_PHY_IPCLKPORT_PCLKM_MANUAL, CLK_CON_GAT_CLK_BLK_AOCCSIS_UID_AD_APB_MIPI_PHY_IPCLKPORT_PCLKM_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_AOCCSIS_UID_SLH_AXI_MI_P_UFDCSIS_IPCLKPORT_I_CLK, DIV_CLK_AOCCSIS_NOCP, CLK_CON_GAT_CLK_BLK_AOCCSIS_UID_SLH_AXI_MI_P_UFDCSIS_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_AOCCSIS_UID_SLH_AXI_MI_P_UFDCSIS_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_AOCCSIS_UID_SLH_AXI_MI_P_UFDCSIS_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_AOCCSIS_UID_SYSREG_AOCCSIS_IPCLKPORT_PCLK, DIV_CLK_AOCCSIS_NOCP, CLK_CON_GAT_CLK_BLK_AOCCSIS_UID_SYSREG_AOCCSIS_IPCLKPORT_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_AOCCSIS_UID_SYSREG_AOCCSIS_IPCLKPORT_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_AOCCSIS_UID_SYSREG_AOCCSIS_IPCLKPORT_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_AOCCSIS_UID_SLH_AST_SI_OTF_CSISUFD_IPCLKPORT_I_CLK, MUX_CLK_AOCCSIS_NOC, CLK_CON_GAT_CLK_BLK_AOCCSIS_UID_SLH_AST_SI_OTF_CSISUFD_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_AOCCSIS_UID_SLH_AST_SI_OTF_CSISUFD_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_AOCCSIS_UID_SLH_AST_SI_OTF_CSISUFD_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_AOCCSIS_UID_LH_AXI_MI_P_P0P1_CSIS_INT_IPCLKPORT_I_CLK, DIV_CLK_AOCCSIS_NOCP, CLK_CON_GAT_CLK_BLK_AOCCSIS_UID_LH_AXI_MI_P_P0P1_CSIS_INT_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_AOCCSIS_UID_LH_AXI_MI_P_P0P1_CSIS_INT_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_AOCCSIS_UID_LH_AXI_MI_P_P0P1_CSIS_INT_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_AOCCSIS_UID_RSTNSYNC_CLK_AOCCSIS_DCPHY_IPCLKPORT_CLK, DIV_CLK_AOCCSIS_DCPHY, CLK_CON_GAT_CLK_BLK_AOCCSIS_UID_RSTNSYNC_CLK_AOCCSIS_DCPHY_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_AOCCSIS_UID_RSTNSYNC_CLK_AOCCSIS_DCPHY_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_AOCCSIS_UID_RSTNSYNC_CLK_AOCCSIS_DCPHY_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_AOCCSIS_UID_RSTNSYNC_CLK_AOCCSIS_NOCD_IPCLKPORT_CLK, MUX_CLK_AOCCSIS_NOC, CLK_CON_GAT_CLK_BLK_AOCCSIS_UID_RSTNSYNC_CLK_AOCCSIS_NOCD_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_AOCCSIS_UID_RSTNSYNC_CLK_AOCCSIS_NOCD_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_AOCCSIS_UID_RSTNSYNC_CLK_AOCCSIS_NOCD_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_AOCCSIS_UID_RSTNSYNC_CLK_AOCCSIS_NOCP_IPCLKPORT_CLK, DIV_CLK_AOCCSIS_NOCP, CLK_CON_GAT_CLK_BLK_AOCCSIS_UID_RSTNSYNC_CLK_AOCCSIS_NOCP_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_AOCCSIS_UID_RSTNSYNC_CLK_AOCCSIS_NOCP_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_AOCCSIS_UID_RSTNSYNC_CLK_AOCCSIS_NOCP_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_AOCCSIS_UID_RSTNSYNC_SR_CLK_AOCCSIS_NOCD_IPCLKPORT_CLK, MUX_CLK_AOCCSIS_NOC, CLK_CON_GAT_CLK_BLK_AOCCSIS_UID_RSTNSYNC_SR_CLK_AOCCSIS_NOCD_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_AOCCSIS_UID_RSTNSYNC_SR_CLK_AOCCSIS_NOCD_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_AOCCSIS_UID_RSTNSYNC_SR_CLK_AOCCSIS_NOCD_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_AOCCSIS_UID_RSTNSYNC_SR_CLK_AOCCSIS_NOCP_IPCLKPORT_CLK, DIV_CLK_AOCCSIS_NOCP, CLK_CON_GAT_CLK_BLK_AOCCSIS_UID_RSTNSYNC_SR_CLK_AOCCSIS_NOCP_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_AOCCSIS_UID_RSTNSYNC_SR_CLK_AOCCSIS_NOCP_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_AOCCSIS_UID_RSTNSYNC_SR_CLK_AOCCSIS_NOCP_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_AUD_UID_AD_APB_SMMU_AUD_S2_IPCLKPORT_PCLKM, DIV_CLK_AUD_NOC, CLK_CON_GAT_CLK_BLK_AUD_UID_AD_APB_SMMU_AUD_S2_IPCLKPORT_PCLKM_CG_VAL, CLK_CON_GAT_CLK_BLK_AUD_UID_AD_APB_SMMU_AUD_S2_IPCLKPORT_PCLKM_MANUAL, CLK_CON_GAT_CLK_BLK_AUD_UID_AD_APB_SMMU_AUD_S2_IPCLKPORT_PCLKM_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_AUD_UID_AD_APB_SMMU_AUD_NS_IPCLKPORT_PCLKM, DIV_CLK_AUD_NOC, CLK_CON_GAT_CLK_BLK_AUD_UID_AD_APB_SMMU_AUD_NS_IPCLKPORT_PCLKM_CG_VAL, CLK_CON_GAT_CLK_BLK_AUD_UID_AD_APB_SMMU_AUD_NS_IPCLKPORT_PCLKM_MANUAL, CLK_CON_GAT_CLK_BLK_AUD_UID_AD_APB_SMMU_AUD_NS_IPCLKPORT_PCLKM_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_AUD_UID_SLH_AXI_MI_D_HSI0AUD_IPCLKPORT_I_CLK, DIV_CLK_AUD_NOC, CLK_CON_GAT_CLK_BLK_AUD_UID_SLH_AXI_MI_D_HSI0AUD_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_AUD_UID_SLH_AXI_MI_D_HSI0AUD_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_AUD_UID_SLH_AXI_MI_D_HSI0AUD_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_AUD_UID_LH_ACEL_SI_D_AUD_IPCLKPORT_I_CLK, DIV_CLK_AUD_NOC, CLK_CON_GAT_CLK_BLK_AUD_UID_LH_ACEL_SI_D_AUD_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_AUD_UID_LH_ACEL_SI_D_AUD_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_AUD_UID_LH_ACEL_SI_D_AUD_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_AUD_UID_SLH_AXI_SI_P_AUDCHUBVTS_IPCLKPORT_I_CLK, DIV_CLK_AUD_NOC, CLK_CON_GAT_CLK_BLK_AUD_UID_SLH_AXI_SI_P_AUDCHUBVTS_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_AUD_UID_SLH_AXI_SI_P_AUDCHUBVTS_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_AUD_UID_SLH_AXI_SI_P_AUDCHUBVTS_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_AUD_UID_SMMU_AUD_S0_IPCLKPORT_CLK, DIV_CLK_AUD_NOC, CLK_CON_GAT_CLK_BLK_AUD_UID_SMMU_AUD_S0_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_AUD_UID_SMMU_AUD_S0_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_AUD_UID_SMMU_AUD_S0_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_AUD_UID_SLH_AXI_SI_D_AUDHSI0_IPCLKPORT_I_CLK, DIV_CLK_AUD_NOC, CLK_CON_GAT_CLK_BLK_AUD_UID_SLH_AXI_SI_D_AUDHSI0_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_AUD_UID_SLH_AXI_SI_D_AUDHSI0_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_AUD_UID_SLH_AXI_SI_D_AUDHSI0_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_AUD_UID_LH_AXI_SI_P_PERI_ASB_INT_IPCLKPORT_I_CLK, DIV_CLK_AUD_NOCP, CLK_CON_GAT_CLK_BLK_AUD_UID_LH_AXI_SI_P_PERI_ASB_INT_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_AUD_UID_LH_AXI_SI_P_PERI_ASB_INT_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_AUD_UID_LH_AXI_SI_P_PERI_ASB_INT_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_AUD_UID_LH_AXI_MI_P_PERI_ASB_INT_IPCLKPORT_I_CLK, DIV_CLK_AUD_NOC, CLK_CON_GAT_CLK_BLK_AUD_UID_LH_AXI_MI_P_PERI_ASB_INT_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_AUD_UID_LH_AXI_MI_P_PERI_ASB_INT_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_AUD_UID_LH_AXI_MI_P_PERI_ASB_INT_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_AUD_UID_SMMU_AUD_S0_PMMU0_IPCLKPORT_CLK, DIV_CLK_AUD_NOC, CLK_CON_GAT_CLK_BLK_AUD_UID_SMMU_AUD_S0_PMMU0_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_AUD_UID_SMMU_AUD_S0_PMMU0_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_AUD_UID_SMMU_AUD_S0_PMMU0_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_AUD_UID_XIU_MMU_AUD_IPCLKPORT_ACLK, DIV_CLK_AUD_NOC, CLK_CON_GAT_CLK_BLK_AUD_UID_XIU_MMU_AUD_IPCLKPORT_ACLK_CG_VAL, CLK_CON_GAT_CLK_BLK_AUD_UID_XIU_MMU_AUD_IPCLKPORT_ACLK_MANUAL, CLK_CON_GAT_CLK_BLK_AUD_UID_XIU_MMU_AUD_IPCLKPORT_ACLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_AUD_UID_ECU_AUD_IPCLKPORT_PCLK, DIV_CLK_AUD_NOCP, CLK_CON_GAT_CLK_BLK_AUD_UID_ECU_AUD_IPCLKPORT_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_AUD_UID_ECU_AUD_IPCLKPORT_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_AUD_UID_ECU_AUD_IPCLKPORT_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_AUD_UID_ECU_AUD_IPCLKPORT_CLK, DIV_CLK_AUD_ECU, CLK_CON_GAT_CLK_BLK_AUD_UID_ECU_AUD_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_AUD_UID_ECU_AUD_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_AUD_UID_ECU_AUD_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_AUD_UID_RSTNSYNC_SR_CLK_AUD_ECU_IPCLKPORT_CLK, DIV_CLK_AUD_ECU, CLK_CON_GAT_CLK_BLK_AUD_UID_RSTNSYNC_SR_CLK_AUD_ECU_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_AUD_UID_RSTNSYNC_SR_CLK_AUD_ECU_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_AUD_UID_RSTNSYNC_SR_CLK_AUD_ECU_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_BRP_UID_AD_APB_BYRP_IPCLKPORT_PCLKM, MUX_CLKCMU_BRP_NOC_USER, CLK_CON_GAT_CLK_BLK_BRP_UID_AD_APB_BYRP_IPCLKPORT_PCLKM_CG_VAL, CLK_CON_GAT_CLK_BLK_BRP_UID_AD_APB_BYRP_IPCLKPORT_PCLKM_MANUAL, CLK_CON_GAT_CLK_BLK_BRP_UID_AD_APB_BYRP_IPCLKPORT_PCLKM_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_BRP_UID_LH_AXI_SI_D_BRP_IPCLKPORT_I_CLK, MUX_CLKCMU_BRP_NOC_USER, CLK_CON_GAT_CLK_BLK_BRP_UID_LH_AXI_SI_D_BRP_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_BRP_UID_LH_AXI_SI_D_BRP_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_BRP_UID_LH_AXI_SI_D_BRP_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_BRP_UID_PPMU_D_BRP_IPCLKPORT_ACLK, MUX_CLKCMU_BRP_NOC_USER, CLK_CON_GAT_CLK_BLK_BRP_UID_PPMU_D_BRP_IPCLKPORT_ACLK_CG_VAL, CLK_CON_GAT_CLK_BLK_BRP_UID_PPMU_D_BRP_IPCLKPORT_ACLK_MANUAL, CLK_CON_GAT_CLK_BLK_BRP_UID_PPMU_D_BRP_IPCLKPORT_ACLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_BRP_UID_PPMU_D_BRP_IPCLKPORT_PCLK, DIV_CLK_BRP_NOCP, CLK_CON_GAT_CLK_BLK_BRP_UID_PPMU_D_BRP_IPCLKPORT_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_BRP_UID_PPMU_D_BRP_IPCLKPORT_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_BRP_UID_PPMU_D_BRP_IPCLKPORT_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_BRP_UID_SYSMMU_BRP_S0_PMMU0_IPCLKPORT_CLK, MUX_CLKCMU_BRP_NOC_USER, CLK_CON_GAT_CLK_BLK_BRP_UID_SYSMMU_BRP_S0_PMMU0_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_BRP_UID_SYSMMU_BRP_S0_PMMU0_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_BRP_UID_SYSMMU_BRP_S0_PMMU0_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_BRP_UID_XIU_D_BRP_IPCLKPORT_ACLK, MUX_CLKCMU_BRP_NOC_USER, CLK_CON_GAT_CLK_BLK_BRP_UID_XIU_D_BRP_IPCLKPORT_ACLK_CG_VAL, CLK_CON_GAT_CLK_BLK_BRP_UID_XIU_D_BRP_IPCLKPORT_ACLK_MANUAL, CLK_CON_GAT_CLK_BLK_BRP_UID_XIU_D_BRP_IPCLKPORT_ACLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_BRP_UID_RSTNSYNC_CLK_BRP_NOCD_IPCLKPORT_CLK, MUX_CLKCMU_BRP_NOC_USER, CLK_CON_GAT_CLK_BLK_BRP_UID_RSTNSYNC_CLK_BRP_NOCD_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_BRP_UID_RSTNSYNC_CLK_BRP_NOCD_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_BRP_UID_RSTNSYNC_CLK_BRP_NOCD_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_BRP_UID_BYRP_IPCLKPORT_CLK, MUX_CLKCMU_BRP_NOC_USER, CLK_CON_GAT_CLK_BLK_BRP_UID_BYRP_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_BRP_UID_BYRP_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_BRP_UID_BYRP_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_BRP_UID_BYRP_IPCLKPORT_CLK_VOTF0, MUX_CLKCMU_BRP_NOC_USER, CLK_CON_GAT_CLK_BLK_BRP_UID_BYRP_IPCLKPORT_CLK_VOTF0_CG_VAL, CLK_CON_GAT_CLK_BLK_BRP_UID_BYRP_IPCLKPORT_CLK_VOTF0_MANUAL, CLK_CON_GAT_CLK_BLK_BRP_UID_BYRP_IPCLKPORT_CLK_VOTF0_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_BRP_UID_BYRP_IPCLKPORT_CLK_VOTF1, MUX_CLKCMU_BRP_NOC_USER, CLK_CON_GAT_CLK_BLK_BRP_UID_BYRP_IPCLKPORT_CLK_VOTF1_CG_VAL, CLK_CON_GAT_CLK_BLK_BRP_UID_BYRP_IPCLKPORT_CLK_VOTF1_MANUAL, CLK_CON_GAT_CLK_BLK_BRP_UID_BYRP_IPCLKPORT_CLK_VOTF1_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_BRP_UID_VGEN_LITE_BYRP_IPCLKPORT_CLK, MUX_CLKCMU_BRP_NOC_USER, CLK_CON_GAT_CLK_BLK_BRP_UID_VGEN_LITE_BYRP_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_BRP_UID_VGEN_LITE_BYRP_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_BRP_UID_VGEN_LITE_BYRP_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_BRP_UID_SLH_AST_SI_G_PPMU_BRP_IPCLKPORT_I_CLK, MUX_CLKCMU_BRP_NOC_USER, CLK_CON_GAT_CLK_BLK_BRP_UID_SLH_AST_SI_G_PPMU_BRP_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_BRP_UID_SLH_AST_SI_G_PPMU_BRP_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_BRP_UID_SLH_AST_SI_G_PPMU_BRP_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_BRP_UID_RSTNSYNC_SR_CLK_BRP_NOCD_IPCLKPORT_CLK, MUX_CLKCMU_BRP_NOC_USER, CLK_CON_GAT_CLK_BLK_BRP_UID_RSTNSYNC_SR_CLK_BRP_NOCD_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_BRP_UID_RSTNSYNC_SR_CLK_BRP_NOCD_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_BRP_UID_RSTNSYNC_SR_CLK_BRP_NOCD_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_BRP_UID_LH_AXI_SI_D_BRPRGBP_IPCLKPORT_I_CLK, MUX_CLKCMU_BRP_NOC_USER, CLK_CON_GAT_CLK_BLK_BRP_UID_LH_AXI_SI_D_BRPRGBP_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_BRP_UID_LH_AXI_SI_D_BRPRGBP_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_BRP_UID_LH_AXI_SI_D_BRPRGBP_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_BRP_UID_SYSMMU_BRP_S0_IPCLKPORT_CLK, MUX_CLKCMU_BRP_NOC_USER, CLK_CON_GAT_CLK_BLK_BRP_UID_SYSMMU_BRP_S0_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_BRP_UID_SYSMMU_BRP_S0_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_BRP_UID_SYSMMU_BRP_S0_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_BRP_UID_LH_AST_MI_OTF_CSISBRP_IPCLKPORT_I_CLK, MUX_CLKCMU_BRP_NOC_USER, CLK_CON_GAT_CLK_BLK_BRP_UID_LH_AST_MI_OTF_CSISBRP_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_BRP_UID_LH_AST_MI_OTF_CSISBRP_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_BRP_UID_LH_AST_MI_OTF_CSISBRP_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_BRP_UID_LH_AST_SI_OTF_BRPRGBP_IPCLKPORT_I_CLK, MUX_CLKCMU_BRP_NOC_USER, CLK_CON_GAT_CLK_BLK_BRP_UID_LH_AST_SI_OTF_BRPRGBP_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_BRP_UID_LH_AST_SI_OTF_BRPRGBP_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_BRP_UID_LH_AST_SI_OTF_BRPRGBP_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_BRP_UID_XIU_MMU_BRP_IPCLKPORT_ACLK, MUX_CLKCMU_BRP_NOC_USER, CLK_CON_GAT_CLK_BLK_BRP_UID_XIU_MMU_BRP_IPCLKPORT_ACLK_CG_VAL, CLK_CON_GAT_CLK_BLK_BRP_UID_XIU_MMU_BRP_IPCLKPORT_ACLK_MANUAL, CLK_CON_GAT_CLK_BLK_BRP_UID_XIU_MMU_BRP_IPCLKPORT_ACLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_CHUB_UID_LH_AXI_MI_P_VC2CHUB_INT_IPCLKPORT_I_CLK, DIV_CLK_CHUB_NOC, CLK_CON_GAT_CLK_BLK_CHUB_UID_LH_AXI_MI_P_VC2CHUB_INT_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_CHUB_UID_LH_AXI_MI_P_VC2CHUB_INT_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_CHUB_UID_LH_AXI_MI_P_VC2CHUB_INT_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_CHUB_UID_LH_AXI_SI_D_CHUB2VC_INT_IPCLKPORT_I_CLK, DIV_CLK_CHUB_NOC, CLK_CON_GAT_CLK_BLK_CHUB_UID_LH_AXI_SI_D_CHUB2VC_INT_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_CHUB_UID_LH_AXI_SI_D_CHUB2VC_INT_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_CHUB_UID_LH_AXI_SI_D_CHUB2VC_INT_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_CHUB_UID_RSTNSYNC_SR_CLK_CHUB_SERIAL_LIF_US_PROX_CORE_IPCLKPORT_CLK, DIV_CLK_CHUB_SERIAL_LIF_US_PROX_CORE, CLK_CON_GAT_CLK_BLK_CHUB_UID_RSTNSYNC_SR_CLK_CHUB_SERIAL_LIF_US_PROX_CORE_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_CHUB_UID_RSTNSYNC_SR_CLK_CHUB_SERIAL_LIF_US_PROX_CORE_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_CHUB_UID_RSTNSYNC_SR_CLK_CHUB_SERIAL_LIF_US_PROX_CORE_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_CHUB_UID_SERIAL_LIF_US_PROX_CHUB_IPCLKPORT_PCLK, DIV_CLK_CHUB_NOC, CLK_CON_GAT_CLK_BLK_CHUB_UID_SERIAL_LIF_US_PROX_CHUB_IPCLKPORT_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_CHUB_UID_SERIAL_LIF_US_PROX_CHUB_IPCLKPORT_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_CHUB_UID_SERIAL_LIF_US_PROX_CHUB_IPCLKPORT_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_CHUB_UID_SERIAL_LIF_US_PROX_CHUB_IPCLKPORT_CCLK, DIV_CLK_CHUB_SERIAL_LIF_US_PROX_CORE, CLK_CON_GAT_CLK_BLK_CHUB_UID_SERIAL_LIF_US_PROX_CHUB_IPCLKPORT_CCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_CHUB_UID_SERIAL_LIF_US_PROX_CHUB_IPCLKPORT_CCLK_MANUAL, CLK_CON_GAT_CLK_BLK_CHUB_UID_SERIAL_LIF_US_PROX_CHUB_IPCLKPORT_CCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_CHUB_UID_SERIAL_LIF_US_PROX_CHUB_IPCLKPORT_TX_BCLK, DIV_CLK_CHUB_SERIAL_LIF_US_PROX, CLK_CON_GAT_CLK_BLK_CHUB_UID_SERIAL_LIF_US_PROX_CHUB_IPCLKPORT_TX_BCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_CHUB_UID_SERIAL_LIF_US_PROX_CHUB_IPCLKPORT_TX_BCLK_MANUAL, CLK_CON_GAT_CLK_BLK_CHUB_UID_SERIAL_LIF_US_PROX_CHUB_IPCLKPORT_TX_BCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_CHUB_UID_RSTNSYNC_SR_CLK_CHUB_SERIAL_LIF_US_PROX_IPCLKPORT_CLK, DIV_CLK_CHUB_SERIAL_LIF_US_PROX, CLK_CON_GAT_CLK_BLK_CHUB_UID_RSTNSYNC_SR_CLK_CHUB_SERIAL_LIF_US_PROX_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_CHUB_UID_RSTNSYNC_SR_CLK_CHUB_SERIAL_LIF_US_PROX_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_CHUB_UID_RSTNSYNC_SR_CLK_CHUB_SERIAL_LIF_US_PROX_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_CHUB_UID_SERIAL_LIF_US_PROX_CHUB_IPCLKPORT_ACLK, DIV_CLK_CHUB_NOC, CLK_CON_GAT_CLK_BLK_CHUB_UID_SERIAL_LIF_US_PROX_CHUB_IPCLKPORT_ACLK_CG_VAL, CLK_CON_GAT_CLK_BLK_CHUB_UID_SERIAL_LIF_US_PROX_CHUB_IPCLKPORT_ACLK_MANUAL, CLK_CON_GAT_CLK_BLK_CHUB_UID_SERIAL_LIF_US_PROX_CHUB_IPCLKPORT_ACLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_CHUBVTS_UID_LH_AXI_SI_P_VC2VTS_INT_IPCLKPORT_I_CLK, DIV_CLK_CHUBVTS_NOC, CLK_CON_GAT_CLK_BLK_CHUBVTS_UID_LH_AXI_SI_P_VC2VTS_INT_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_CHUBVTS_UID_LH_AXI_SI_P_VC2VTS_INT_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_CHUBVTS_UID_LH_AXI_SI_P_VC2VTS_INT_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_CHUBVTS_UID_LH_AXI_SI_P_VC2CHUB_INT_IPCLKPORT_I_CLK, DIV_CLK_CHUBVTS_NOC, CLK_CON_GAT_CLK_BLK_CHUBVTS_UID_LH_AXI_SI_P_VC2CHUB_INT_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_CHUBVTS_UID_LH_AXI_SI_P_VC2CHUB_INT_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_CHUBVTS_UID_LH_AXI_SI_P_VC2CHUB_INT_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_CHUBVTS_UID_SLH_AXI_MI_P_SDMACHUBVTS_IPCLKPORT_I_CLK, DIV_CLK_CHUBVTS_NOC, CLK_CON_GAT_CLK_BLK_CHUBVTS_UID_SLH_AXI_MI_P_SDMACHUBVTS_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_CHUBVTS_UID_SLH_AXI_MI_P_SDMACHUBVTS_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_CHUBVTS_UID_SLH_AXI_MI_P_SDMACHUBVTS_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_CHUBVTS_UID_LH_AXI_MI_D_VTS2VC_INT_IPCLKPORT_I_CLK, DIV_CLK_CHUBVTS_NOC, CLK_CON_GAT_CLK_BLK_CHUBVTS_UID_LH_AXI_MI_D_VTS2VC_INT_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_CHUBVTS_UID_LH_AXI_MI_D_VTS2VC_INT_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_CHUBVTS_UID_LH_AXI_MI_D_VTS2VC_INT_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_CHUBVTS_UID_LH_AXI_MI_D_CHUB2VC_INT_IPCLKPORT_I_CLK, DIV_CLK_CHUBVTS_NOC, CLK_CON_GAT_CLK_BLK_CHUBVTS_UID_LH_AXI_MI_D_CHUB2VC_INT_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_CHUBVTS_UID_LH_AXI_MI_D_CHUB2VC_INT_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_CHUBVTS_UID_LH_AXI_MI_D_CHUB2VC_INT_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_CHUBVTS_UID_SLH_AXI_MI_P_ALIVECHUBVTS_IPCLKPORT_I_CLK, DIV_CLK_CHUBVTS_NOC, CLK_CON_GAT_CLK_BLK_CHUBVTS_UID_SLH_AXI_MI_P_ALIVECHUBVTS_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_CHUBVTS_UID_SLH_AXI_MI_P_ALIVECHUBVTS_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_CHUBVTS_UID_SLH_AXI_MI_P_ALIVECHUBVTS_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_CHUBVTS_UID_SLH_AXI_SI_D_CHUBVTSALIVE_IPCLKPORT_I_CLK, DIV_CLK_CHUBVTS_NOC, CLK_CON_GAT_CLK_BLK_CHUBVTS_UID_SLH_AXI_SI_D_CHUBVTSALIVE_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_CHUBVTS_UID_SLH_AXI_SI_D_CHUBVTSALIVE_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_CHUBVTS_UID_SLH_AXI_SI_D_CHUBVTSALIVE_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_CHUBVTS_UID_BPS_LP_SDMACHUBVTS_IPCLKPORT_I_CLK, DIV_CLK_CHUBVTS_NOC, CLK_CON_GAT_CLK_BLK_CHUBVTS_UID_BPS_LP_SDMACHUBVTS_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_CHUBVTS_UID_BPS_LP_SDMACHUBVTS_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_CHUBVTS_UID_BPS_LP_SDMACHUBVTS_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_CHUBVTS_UID_SLH_AXI_MI_P_AUDCHUBVTS_IPCLKPORT_I_CLK, DIV_CLK_CHUBVTS_NOC, CLK_CON_GAT_CLK_BLK_CHUBVTS_UID_SLH_AXI_MI_P_AUDCHUBVTS_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_CHUBVTS_UID_SLH_AXI_MI_P_AUDCHUBVTS_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_CHUBVTS_UID_SLH_AXI_MI_P_AUDCHUBVTS_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_CHUBVTS_UID_ECU_CHUBVTS_IPCLKPORT_PCLK, DIV_CLK_CHUBVTS_NOC, CLK_CON_GAT_CLK_BLK_CHUBVTS_UID_ECU_CHUBVTS_IPCLKPORT_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_CHUBVTS_UID_ECU_CHUBVTS_IPCLKPORT_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_CHUBVTS_UID_ECU_CHUBVTS_IPCLKPORT_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_CHUBVTS_UID_S2PC_CHUBVTS_IPCLKPORT_PCLK, DIV_CLK_CHUBVTS_NOC, CLK_CON_GAT_CLK_BLK_CHUBVTS_UID_S2PC_CHUBVTS_IPCLKPORT_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_CHUBVTS_UID_S2PC_CHUBVTS_IPCLKPORT_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_CHUBVTS_UID_S2PC_CHUBVTS_IPCLKPORT_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_CHUBVTS_UID_ECU_CHUBVTS_IPCLKPORT_CLK, DIV_CLK_CHUBVTS_ECU, CLK_CON_GAT_CLK_BLK_CHUBVTS_UID_ECU_CHUBVTS_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_CHUBVTS_UID_ECU_CHUBVTS_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_CHUBVTS_UID_ECU_CHUBVTS_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_CHUBVTS_UID_RSTNSYNC_SR_CLK_CHUBVTS_ECU_IPCLKPORT_CLK, DIV_CLK_CHUBVTS_ECU, CLK_CON_GAT_CLK_BLK_CHUBVTS_UID_RSTNSYNC_SR_CLK_CHUBVTS_ECU_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_CHUBVTS_UID_RSTNSYNC_SR_CLK_CHUBVTS_ECU_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_CHUBVTS_UID_RSTNSYNC_SR_CLK_CHUBVTS_ECU_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_CMGP_UID_SLH_AXI_MI_P_ALIVECMGP_IPCLKPORT_I_CLK, MUX_CLKALIVE_CMGP_NOC_USER, CLK_CON_GAT_CLK_BLK_CMGP_UID_SLH_AXI_MI_P_ALIVECMGP_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_CMGP_UID_SLH_AXI_MI_P_ALIVECMGP_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_CMGP_UID_SLH_AXI_MI_P_ALIVECMGP_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_CMGP_UID_SLH_AXI_SI_P_CMGPUFD_IPCLKPORT_I_CLK, MUX_CLKALIVE_CMGP_NOC_USER, CLK_CON_GAT_CLK_BLK_CMGP_UID_SLH_AXI_SI_P_CMGPUFD_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_CMGP_UID_SLH_AXI_SI_P_CMGPUFD_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_CMGP_UID_SLH_AXI_SI_P_CMGPUFD_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(GATE_CLKCMU_AOCCSIS_NOC, MUX_CLKCMU_AOCCSIS_NOC, CLK_CON_GAT_GATE_CLKCMU_AOCCSIS_NOC_CG_VAL, CLK_CON_GAT_GATE_CLKCMU_AOCCSIS_NOC_MANUAL, CLK_CON_GAT_GATE_CLKCMU_AOCCSIS_NOC_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(GATE_CLKCMU_AOCCSIS_OIS_MCU, MUX_CLKCMU_AOCCSIS_OIS_MCU, CLK_CON_GAT_GATE_CLKCMU_AOCCSIS_OIS_MCU_CG_VAL, CLK_CON_GAT_GATE_CLKCMU_AOCCSIS_OIS_MCU_MANUAL, CLK_CON_GAT_GATE_CLKCMU_AOCCSIS_OIS_MCU_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(GATE_CLKCMU_MFD_MFD, MUX_CLKCMU_MFD_MFD, CLK_CON_GAT_GATE_CLKCMU_MFD_MFD_CG_VAL, CLK_CON_GAT_GATE_CLKCMU_MFD_MFD_MANUAL, CLK_CON_GAT_GATE_CLKCMU_MFD_MFD_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(GATE_CLKCMU_AOCCSIS_DCPHY, MUX_CLKCMU_AOCCSIS_DCPHY, CLK_CON_GAT_GATE_CLKCMU_AOCCSIS_DCPHY_CG_VAL, CLK_CON_GAT_GATE_CLKCMU_AOCCSIS_DCPHY_MANUAL, CLK_CON_GAT_GATE_CLKCMU_AOCCSIS_DCPHY_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(GATE_CLKCMU_CPUCL1_SWITCH_L, MUX_CLKCMU_CPUCL1_SWITCH_L, CLK_CON_GAT_GATE_CLKCMU_CPUCL1_SWITCH_L_CG_VAL, CLK_CON_GAT_GATE_CLKCMU_CPUCL1_SWITCH_L_MANUAL, CLK_CON_GAT_GATE_CLKCMU_CPUCL1_SWITCH_L_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(GATE_CLKCMU_ICPU_NOC_0, MUX_CLKCMU_ICPU_NOC_0, CLK_CON_GAT_GATE_CLKCMU_ICPU_NOC_0_CG_VAL, CLK_CON_GAT_GATE_CLKCMU_ICPU_NOC_0_MANUAL, CLK_CON_GAT_GATE_CLKCMU_ICPU_NOC_0_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(GATE_CLKCMU_M2M_JPEG, MUX_CLKCMU_M2M_JPEG, CLK_CON_GAT_GATE_CLKCMU_M2M_JPEG_CG_VAL, CLK_CON_GAT_GATE_CLKCMU_M2M_JPEG_MANUAL, CLK_CON_GAT_GATE_CLKCMU_M2M_JPEG_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(GATE_CLKCMU_GNPU1_NOC, MUX_CLKCMU_GNPU1_NOC, CLK_CON_GAT_GATE_CLKCMU_GNPU1_NOC_CG_VAL, CLK_CON_GAT_GATE_CLKCMU_GNPU1_NOC_MANUAL, CLK_CON_GAT_GATE_CLKCMU_GNPU1_NOC_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(GATE_CLKCMU_ICPU_NOC_1, MUX_CLKCMU_ICPU_NOC_1, CLK_CON_GAT_GATE_CLKCMU_ICPU_NOC_1_CG_VAL, CLK_CON_GAT_GATE_CLKCMU_ICPU_NOC_1_MANUAL, CLK_CON_GAT_GATE_CLKCMU_ICPU_NOC_1_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(GATE_CLKCMU_GNPU_XMAA, MUX_CLKCMU_GNPU_XMAA, CLK_CON_GAT_GATE_CLKCMU_GNPU_XMAA_CG_VAL, CLK_CON_GAT_GATE_CLKCMU_GNPU_XMAA_MANUAL, CLK_CON_GAT_GATE_CLKCMU_GNPU_XMAA_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(GATE_CLKCMU_GNPU1_XMAA, MUX_CLKCMU_GNPU1_XMAA, CLK_CON_GAT_GATE_CLKCMU_GNPU1_XMAA_CG_VAL, CLK_CON_GAT_GATE_CLKCMU_GNPU1_XMAA_MANUAL, CLK_CON_GAT_GATE_CLKCMU_GNPU1_XMAA_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(GATE_CLKCMU_GNPU_NOC_ALT, PLL_SHARED_MIF, CLK_CON_GAT_GATE_CLKCMU_GNPU_NOC_ALT_CG_VAL, CLK_CON_GAT_GATE_CLKCMU_GNPU_NOC_ALT_MANUAL, CLK_CON_GAT_GATE_CLKCMU_GNPU_NOC_ALT_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(GATE_CLKCMU_GNPU_XMAA_ALT, PLL_SHARED_MIF, CLK_CON_GAT_GATE_CLKCMU_GNPU_XMAA_ALT_CG_VAL, CLK_CON_GAT_GATE_CLKCMU_GNPU_XMAA_ALT_MANUAL, CLK_CON_GAT_GATE_CLKCMU_GNPU_XMAA_ALT_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(GATE_CLKCMU_GNPU1_NOC_ALT, PLL_SHARED_MIF, CLK_CON_GAT_GATE_CLKCMU_GNPU1_NOC_ALT_CG_VAL, CLK_CON_GAT_GATE_CLKCMU_GNPU1_NOC_ALT_MANUAL, CLK_CON_GAT_GATE_CLKCMU_GNPU1_NOC_ALT_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(GATE_CLKCMU_GNPU1_XMAA_ALT, PLL_SHARED_MIF, CLK_CON_GAT_GATE_CLKCMU_GNPU1_XMAA_ALT_CG_VAL, CLK_CON_GAT_GATE_CLKCMU_GNPU1_XMAA_ALT_MANUAL, CLK_CON_GAT_GATE_CLKCMU_GNPU1_XMAA_ALT_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(GATE_CLKCMU_DSP_NOC_ALT, PLL_SHARED_MIF, CLK_CON_GAT_GATE_CLKCMU_DSP_NOC_ALT_CG_VAL, CLK_CON_GAT_GATE_CLKCMU_DSP_NOC_ALT_MANUAL, CLK_CON_GAT_GATE_CLKCMU_DSP_NOC_ALT_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(GATE_CLKCMU_ICPU_NOC_0_ALT, PLL_SHARED_MIF, CLK_CON_GAT_GATE_CLKCMU_ICPU_NOC_0_ALT_CG_VAL, CLK_CON_GAT_GATE_CLKCMU_ICPU_NOC_0_ALT_MANUAL, CLK_CON_GAT_GATE_CLKCMU_ICPU_NOC_0_ALT_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(GATE_CLKCMU_CPUCL1_SWITCH_H, MUX_CLKCMU_CPUCL1_SWITCH_H, CLK_CON_GAT_GATE_CLKCMU_CPUCL1_SWITCH_H_CG_VAL, CLK_CON_GAT_GATE_CLKCMU_CPUCL1_SWITCH_H_MANUAL, CLK_CON_GAT_GATE_CLKCMU_CPUCL1_SWITCH_H_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_CPUCL0_COMPLEX0CLK, DIV_CLK_CPUCL0_CORE, CLK_CON_GAT_CLK_CPUCL0_COMPLEX0CLK_CG_VAL, CLK_CON_GAT_CLK_CPUCL0_COMPLEX0CLK_MANUAL, CLK_CON_GAT_CLK_CPUCL0_COMPLEX0CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_CPUCL0_COMPLEX1CLK, DIV_CLK_CPUCL0_CORE, CLK_CON_GAT_CLK_CPUCL0_COMPLEX1CLK_CG_VAL, CLK_CON_GAT_CLK_CPUCL0_COMPLEX1CLK_MANUAL, CLK_CON_GAT_CLK_CPUCL0_COMPLEX1CLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_CPUCL0_GLB_UID_LH_ATB_MI_T_CLUSTER0_INT_IPCLKPORT_I_CLK, MUX_CLKCMU_CPUCL0_DBG_NOC_USER, CLK_CON_GAT_CLK_BLK_CPUCL0_GLB_UID_LH_ATB_MI_T_CLUSTER0_INT_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_CPUCL0_GLB_UID_LH_ATB_MI_T_CLUSTER0_INT_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_CPUCL0_GLB_UID_LH_ATB_MI_T_CLUSTER0_INT_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_CPUCL0_GLB_UID_SLH_AXI_MI_G_ALIVECPUCL0_DBGCORE_IPCLKPORT_I_CLK, DIV_CLK_CPUCL0_DBG_NOC, CLK_CON_GAT_CLK_BLK_CPUCL0_GLB_UID_SLH_AXI_MI_G_ALIVECPUCL0_DBGCORE_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_CPUCL0_GLB_UID_SLH_AXI_MI_G_ALIVECPUCL0_DBGCORE_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_CPUCL0_GLB_UID_SLH_AXI_MI_G_ALIVECPUCL0_DBGCORE_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_CPUCL0_GLB_UID_LH_AXI_MI_G_CSSYS_INT_IPCLKPORT_I_CLK, DIV_CLK_CPUCL0_DBG_NOC, CLK_CON_GAT_CLK_BLK_CPUCL0_GLB_UID_LH_AXI_MI_G_CSSYS_INT_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_CPUCL0_GLB_UID_LH_AXI_MI_G_CSSYS_INT_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_CPUCL0_GLB_UID_LH_AXI_MI_G_CSSYS_INT_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_CPUCL0_GLB_UID_LH_AXI_MI_G_DBGCORE_INT_IPCLKPORT_I_CLK, MUX_CLKCMU_CPUCL0_GLB_NOCP_USER, CLK_CON_GAT_CLK_BLK_CPUCL0_GLB_UID_LH_AXI_MI_G_DBGCORE_INT_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_CPUCL0_GLB_UID_LH_AXI_MI_G_DBGCORE_INT_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_CPUCL0_GLB_UID_LH_AXI_MI_G_DBGCORE_INT_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_CPUCL0_GLB_UID_LH_AXI_MI_G_ETR_INT_IPCLKPORT_I_CLK, DIV_CLK_CPUCL0_DBG_NOC, CLK_CON_GAT_CLK_BLK_CPUCL0_GLB_UID_LH_AXI_MI_G_ETR_INT_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_CPUCL0_GLB_UID_LH_AXI_MI_G_ETR_INT_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_CPUCL0_GLB_UID_LH_AXI_MI_G_ETR_INT_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_CPUCL0_GLB_UID_LH_AXI_MI_G_STM_INT_IPCLKPORT_I_CLK, MUX_CLKCMU_CPUCL0_DBG_NOC_USER, CLK_CON_GAT_CLK_BLK_CPUCL0_GLB_UID_LH_AXI_MI_G_STM_INT_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_CPUCL0_GLB_UID_LH_AXI_MI_G_STM_INT_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_CPUCL0_GLB_UID_LH_AXI_MI_G_STM_INT_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_CPUCL0_GLB_UID_LH_AXI_SI_G_CSSYS_INT_IPCLKPORT_I_CLK, DIV_CLK_CPUCL0_DBG_PCLKDBG, CLK_CON_GAT_CLK_BLK_CPUCL0_GLB_UID_LH_AXI_SI_G_CSSYS_INT_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_CPUCL0_GLB_UID_LH_AXI_SI_G_CSSYS_INT_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_CPUCL0_GLB_UID_LH_AXI_SI_G_CSSYS_INT_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_CPUCL0_GLB_UID_LH_AXI_SI_G_DBGCORE_INT_IPCLKPORT_I_CLK, DIV_CLK_CPUCL0_DBG_NOC, CLK_CON_GAT_CLK_BLK_CPUCL0_GLB_UID_LH_AXI_SI_G_DBGCORE_INT_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_CPUCL0_GLB_UID_LH_AXI_SI_G_DBGCORE_INT_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_CPUCL0_GLB_UID_LH_AXI_SI_G_DBGCORE_INT_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_CPUCL0_GLB_UID_LH_AXI_SI_G_ETR_INT_IPCLKPORT_I_CLK, MUX_CLKCMU_CPUCL0_DBG_NOC_USER, CLK_CON_GAT_CLK_BLK_CPUCL0_GLB_UID_LH_AXI_SI_G_ETR_INT_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_CPUCL0_GLB_UID_LH_AXI_SI_G_ETR_INT_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_CPUCL0_GLB_UID_LH_AXI_SI_G_ETR_INT_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_CPUCL0_GLB_UID_LH_AXI_SI_G_STM_INT_IPCLKPORT_I_CLK, MUX_CLKCMU_CPUCL0_GLB_NOCP_USER, CLK_CON_GAT_CLK_BLK_CPUCL0_GLB_UID_LH_AXI_SI_G_STM_INT_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_CPUCL0_GLB_UID_LH_AXI_SI_G_STM_INT_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_CPUCL0_GLB_UID_LH_AXI_SI_G_STM_INT_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_CPUCL0_GLB_UID_PMU_PCSM_IPCLKPORT_PCLK, MUX_CLKCMU_CPUCL0_GLB_NOCP_USER, CLK_CON_GAT_CLK_BLK_CPUCL0_GLB_UID_PMU_PCSM_IPCLKPORT_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_CPUCL0_GLB_UID_PMU_PCSM_IPCLKPORT_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_CPUCL0_GLB_UID_PMU_PCSM_IPCLKPORT_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_CPUCL0_GLB_UID_LH_ATB_MI_T_DDCMID3_INT_IPCLKPORT_I_CLK, MUX_CLKCMU_CPUCL0_DBG_NOC_USER, CLK_CON_GAT_CLK_BLK_CPUCL0_GLB_UID_LH_ATB_MI_T_DDCMID3_INT_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_CPUCL0_GLB_UID_LH_ATB_MI_T_DDCMID3_INT_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_CPUCL0_GLB_UID_LH_ATB_MI_T_DDCMID3_INT_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_CPUCL0_GLB_UID_LH_ATB_MI_T_DDCMID0_INT_IPCLKPORT_I_CLK, MUX_CLKCMU_CPUCL0_DBG_NOC_USER, CLK_CON_GAT_CLK_BLK_CPUCL0_GLB_UID_LH_ATB_MI_T_DDCMID0_INT_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_CPUCL0_GLB_UID_LH_ATB_MI_T_DDCMID0_INT_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_CPUCL0_GLB_UID_LH_ATB_MI_T_DDCMID0_INT_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_CPUCL0_GLB_UID_LH_ATB_MI_T_DDCMID1_INT_IPCLKPORT_I_CLK, MUX_CLKCMU_CPUCL0_DBG_NOC_USER, CLK_CON_GAT_CLK_BLK_CPUCL0_GLB_UID_LH_ATB_MI_T_DDCMID1_INT_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_CPUCL0_GLB_UID_LH_ATB_MI_T_DDCMID1_INT_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_CPUCL0_GLB_UID_LH_ATB_MI_T_DDCMID1_INT_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_CPUCL0_GLB_UID_LH_ATB_MI_T_DDCMID2_INT_IPCLKPORT_I_CLK, MUX_CLKCMU_CPUCL0_DBG_NOC_USER, CLK_CON_GAT_CLK_BLK_CPUCL0_GLB_UID_LH_ATB_MI_T_DDCMID2_INT_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_CPUCL0_GLB_UID_LH_ATB_MI_T_DDCMID2_INT_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_CPUCL0_GLB_UID_LH_ATB_MI_T_DDCMID2_INT_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_CPUCL0_GLB_UID_LH_ATB_MI_T_DDCBIG_INT_IPCLKPORT_I_CLK, MUX_CLKCMU_CPUCL0_DBG_NOC_USER, CLK_CON_GAT_CLK_BLK_CPUCL0_GLB_UID_LH_ATB_MI_T_DDCBIG_INT_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_CPUCL0_GLB_UID_LH_ATB_MI_T_DDCBIG_INT_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_CPUCL0_GLB_UID_LH_ATB_MI_T_DDCBIG_INT_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_CPUCL0_GLB_UID_DLDO_SM_BIG0_IPCLKPORT_PCLK, MUX_CLKCMU_CPUCL0_GLB_NOCP_USER, CLK_CON_GAT_CLK_BLK_CPUCL0_GLB_UID_DLDO_SM_BIG0_IPCLKPORT_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_CPUCL0_GLB_UID_DLDO_SM_BIG0_IPCLKPORT_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_CPUCL0_GLB_UID_DLDO_SM_BIG0_IPCLKPORT_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_CPUCL0_GLB_UID_DLDO_SM_MID0_IPCLKPORT_PCLK, MUX_CLKCMU_CPUCL0_GLB_NOCP_USER, CLK_CON_GAT_CLK_BLK_CPUCL0_GLB_UID_DLDO_SM_MID0_IPCLKPORT_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_CPUCL0_GLB_UID_DLDO_SM_MID0_IPCLKPORT_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_CPUCL0_GLB_UID_DLDO_SM_MID0_IPCLKPORT_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_CPUCL0_GLB_UID_DLDO_SM_MID1_IPCLKPORT_PCLK, MUX_CLKCMU_CPUCL0_GLB_NOCP_USER, CLK_CON_GAT_CLK_BLK_CPUCL0_GLB_UID_DLDO_SM_MID1_IPCLKPORT_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_CPUCL0_GLB_UID_DLDO_SM_MID1_IPCLKPORT_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_CPUCL0_GLB_UID_DLDO_SM_MID1_IPCLKPORT_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_CPUCL0_GLB_UID_DLDO_SM_MID2_IPCLKPORT_PCLK, MUX_CLKCMU_CPUCL0_GLB_NOCP_USER, CLK_CON_GAT_CLK_BLK_CPUCL0_GLB_UID_DLDO_SM_MID2_IPCLKPORT_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_CPUCL0_GLB_UID_DLDO_SM_MID2_IPCLKPORT_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_CPUCL0_GLB_UID_DLDO_SM_MID2_IPCLKPORT_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_CPUCL0_GLB_UID_DLDO_SM_MID3_IPCLKPORT_PCLK, MUX_CLKCMU_CPUCL0_GLB_NOCP_USER, CLK_CON_GAT_CLK_BLK_CPUCL0_GLB_UID_DLDO_SM_MID3_IPCLKPORT_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_CPUCL0_GLB_UID_DLDO_SM_MID3_IPCLKPORT_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_CPUCL0_GLB_UID_DLDO_SM_MID3_IPCLKPORT_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_CPUCL0_GLB_UID_ECU_CPUCL0_0_IPCLKPORT_PCLK, MUX_CLKCMU_CPUCL0_GLB_NOCP_USER, CLK_CON_GAT_CLK_BLK_CPUCL0_GLB_UID_ECU_CPUCL0_0_IPCLKPORT_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_CPUCL0_GLB_UID_ECU_CPUCL0_0_IPCLKPORT_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_CPUCL0_GLB_UID_ECU_CPUCL0_0_IPCLKPORT_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_CPUCL0_GLB_UID_ECU_CPUCL0_1_IPCLKPORT_PCLK, MUX_CLKCMU_CPUCL0_GLB_NOCP_USER, CLK_CON_GAT_CLK_BLK_CPUCL0_GLB_UID_ECU_CPUCL0_1_IPCLKPORT_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_CPUCL0_GLB_UID_ECU_CPUCL0_1_IPCLKPORT_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_CPUCL0_GLB_UID_ECU_CPUCL0_1_IPCLKPORT_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_CPUCL0_GLB_UID_ECU_CPUCL0_0_IPCLKPORT_CLK, DIV_CLK_CPUCL0_GLB_ECU, CLK_CON_GAT_CLK_BLK_CPUCL0_GLB_UID_ECU_CPUCL0_0_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_CPUCL0_GLB_UID_ECU_CPUCL0_0_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_CPUCL0_GLB_UID_ECU_CPUCL0_0_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_CPUCL0_GLB_UID_ECU_CPUCL0_1_IPCLKPORT_CLK, DIV_CLK_CPUCL0_GLB_ECU, CLK_CON_GAT_CLK_BLK_CPUCL0_GLB_UID_ECU_CPUCL0_1_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_CPUCL0_GLB_UID_ECU_CPUCL0_1_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_CPUCL0_GLB_UID_ECU_CPUCL0_1_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_CPUCL0_GLB_UID_RSTNSYNC_SR_CLK_CPUCL0_GLB_ECU_IPCLKPORT_CLK, DIV_CLK_CPUCL0_GLB_ECU, CLK_CON_GAT_CLK_BLK_CPUCL0_GLB_UID_RSTNSYNC_SR_CLK_CPUCL0_GLB_ECU_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_CPUCL0_GLB_UID_RSTNSYNC_SR_CLK_CPUCL0_GLB_ECU_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_CPUCL0_GLB_UID_RSTNSYNC_SR_CLK_CPUCL0_GLB_ECU_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_CPUCL1_UID_HTU_CPUCL1_3_IPCLKPORT_I_PCLK, MUX_CLKCMU_CPUCL0_GLB_NOCP_USER, CLK_CON_GAT_CLK_BLK_CPUCL1_UID_HTU_CPUCL1_3_IPCLKPORT_I_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_CPUCL1_UID_HTU_CPUCL1_3_IPCLKPORT_I_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_CPUCL1_UID_HTU_CPUCL1_3_IPCLKPORT_I_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CPUCL1_GCPM0, DIV_CLK_CPUCL1_CORE_0, CLK_CON_GAT_CPUCL1_GCPM0_CG_VAL, CLK_CON_GAT_CPUCL1_GCPM0_MANUAL, CLK_CON_GAT_CPUCL1_GCPM0_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CPUCL1_GCPM1, DIV_CLK_CPUCL1_CORE_1, CLK_CON_GAT_CPUCL1_GCPM1_CG_VAL, CLK_CON_GAT_CPUCL1_GCPM1_MANUAL, CLK_CON_GAT_CPUCL1_GCPM1_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CPUCL1_GCPM2, DIV_CLK_CPUCL1_CORE_2, CLK_CON_GAT_CPUCL1_GCPM2_CG_VAL, CLK_CON_GAT_CPUCL1_GCPM2_MANUAL, CLK_CON_GAT_CPUCL1_GCPM2_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CPUCL1_GCPM3, DIV_CLK_CPUCL1_CORE_3, CLK_CON_GAT_CPUCL1_GCPM3_CG_VAL, CLK_CON_GAT_CPUCL1_GCPM3_MANUAL, CLK_CON_GAT_CPUCL1_GCPM3_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_CPUCL1_UID_HTU_CPUCL1_3_IPCLKPORT_I_CLK, MUX_CLK_CPUCL1_HTU, CLK_CON_GAT_CLK_BLK_CPUCL1_UID_HTU_CPUCL1_3_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_CPUCL1_UID_HTU_CPUCL1_3_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_CPUCL1_UID_HTU_CPUCL1_3_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CPUCL1_CPM3, PLL_CPUCL1, CLK_CON_GAT_CPUCL1_CPM3_CG_VAL, CLK_CON_GAT_CPUCL1_CPM3_MANUAL, CLK_CON_GAT_CPUCL1_CPM3_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CPUCL2_GCPM, DIV_CLK_CPUCL2_CORE, CLK_CON_GAT_CPUCL2_GCPM_CG_VAL, CLK_CON_GAT_CPUCL2_GCPM_MANUAL, CLK_CON_GAT_CPUCL2_GCPM_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_CSIS_UID_AD_APB_CSIS_WDMA_IPCLKPORT_PCLKM, MUX_CLKAOCCSIS_CSIS_NOCD_USER, CLK_CON_GAT_CLK_BLK_CSIS_UID_AD_APB_CSIS_WDMA_IPCLKPORT_PCLKM_CG_VAL, CLK_CON_GAT_CLK_BLK_CSIS_UID_AD_APB_CSIS_WDMA_IPCLKPORT_PCLKM_MANUAL, CLK_CON_GAT_CLK_BLK_CSIS_UID_AD_APB_CSIS_WDMA_IPCLKPORT_PCLKM_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_CSIS_UID_CSIS_PDP_IPCLKPORT_ACLK_DMA, MUX_CLKAOCCSIS_CSIS_NOCD_USER, CLK_CON_GAT_CLK_BLK_CSIS_UID_CSIS_PDP_IPCLKPORT_ACLK_DMA_CG_VAL, CLK_CON_GAT_CLK_BLK_CSIS_UID_CSIS_PDP_IPCLKPORT_ACLK_DMA_MANUAL, CLK_CON_GAT_CLK_BLK_CSIS_UID_CSIS_PDP_IPCLKPORT_ACLK_DMA_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_CSIS_UID_CSIS_PDP_IPCLKPORT_ACLK_TOP, MUX_CLKAOCCSIS_CSIS_NOCD_USER, CLK_CON_GAT_CLK_BLK_CSIS_UID_CSIS_PDP_IPCLKPORT_ACLK_TOP_CG_VAL, CLK_CON_GAT_CLK_BLK_CSIS_UID_CSIS_PDP_IPCLKPORT_ACLK_TOP_MANUAL, CLK_CON_GAT_CLK_BLK_CSIS_UID_CSIS_PDP_IPCLKPORT_ACLK_TOP_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_CSIS_UID_CSIS_PDP_IPCLKPORT_ACLK_VOTF0, MUX_CLKAOCCSIS_CSIS_NOCD_USER, CLK_CON_GAT_CLK_BLK_CSIS_UID_CSIS_PDP_IPCLKPORT_ACLK_VOTF0_CG_VAL, CLK_CON_GAT_CLK_BLK_CSIS_UID_CSIS_PDP_IPCLKPORT_ACLK_VOTF0_MANUAL, CLK_CON_GAT_CLK_BLK_CSIS_UID_CSIS_PDP_IPCLKPORT_ACLK_VOTF0_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_CSIS_UID_CSIS_PDP_IPCLKPORT_ACLK_VOTF1, MUX_CLKAOCCSIS_CSIS_NOCD_USER, CLK_CON_GAT_CLK_BLK_CSIS_UID_CSIS_PDP_IPCLKPORT_ACLK_VOTF1_CG_VAL, CLK_CON_GAT_CLK_BLK_CSIS_UID_CSIS_PDP_IPCLKPORT_ACLK_VOTF1_MANUAL, CLK_CON_GAT_CLK_BLK_CSIS_UID_CSIS_PDP_IPCLKPORT_ACLK_VOTF1_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_CSIS_UID_CSIS_PDP_IPCLKPORT_I_PDP_C2CLK, MUX_CLKAOCCSIS_CSIS_NOCD_USER, CLK_CON_GAT_CLK_BLK_CSIS_UID_CSIS_PDP_IPCLKPORT_I_PDP_C2CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_CSIS_UID_CSIS_PDP_IPCLKPORT_I_PDP_C2CLK_MANUAL, CLK_CON_GAT_CLK_BLK_CSIS_UID_CSIS_PDP_IPCLKPORT_I_PDP_C2CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_CSIS_UID_CSIS_PDP_IPCLKPORT_I_PDP_CLK, MUX_CLKAOCCSIS_CSIS_NOCD_USER, CLK_CON_GAT_CLK_BLK_CSIS_UID_CSIS_PDP_IPCLKPORT_I_PDP_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_CSIS_UID_CSIS_PDP_IPCLKPORT_I_PDP_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_CSIS_UID_CSIS_PDP_IPCLKPORT_I_PDP_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_CSIS_UID_LH_AST_SI_OTF_CSISBRP_IPCLKPORT_I_CLK, MUX_CLKAOCCSIS_CSIS_NOCD_USER, CLK_CON_GAT_CLK_BLK_CSIS_UID_LH_AST_SI_OTF_CSISBRP_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_CSIS_UID_LH_AST_SI_OTF_CSISBRP_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_CSIS_UID_LH_AST_SI_OTF_CSISBRP_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_CSIS_UID_LH_AST_SI_OTF0_CSISCSTAT_IPCLKPORT_I_CLK, MUX_CLKAOCCSIS_CSIS_NOCD_USER, CLK_CON_GAT_CLK_BLK_CSIS_UID_LH_AST_SI_OTF0_CSISCSTAT_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_CSIS_UID_LH_AST_SI_OTF0_CSISCSTAT_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_CSIS_UID_LH_AST_SI_OTF0_CSISCSTAT_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_CSIS_UID_LH_AST_SI_OTF1_CSISCSTAT_IPCLKPORT_I_CLK, MUX_CLKAOCCSIS_CSIS_NOCD_USER, CLK_CON_GAT_CLK_BLK_CSIS_UID_LH_AST_SI_OTF1_CSISCSTAT_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_CSIS_UID_LH_AST_SI_OTF1_CSISCSTAT_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_CSIS_UID_LH_AST_SI_OTF1_CSISCSTAT_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_CSIS_UID_LH_AST_SI_OTF2_CSISCSTAT_IPCLKPORT_I_CLK, MUX_CLKAOCCSIS_CSIS_NOCD_USER, CLK_CON_GAT_CLK_BLK_CSIS_UID_LH_AST_SI_OTF2_CSISCSTAT_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_CSIS_UID_LH_AST_SI_OTF2_CSISCSTAT_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_CSIS_UID_LH_AST_SI_OTF2_CSISCSTAT_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_CSIS_UID_LH_AST_SI_OTF3_CSISCSTAT_IPCLKPORT_I_CLK, MUX_CLKAOCCSIS_CSIS_NOCD_USER, CLK_CON_GAT_CLK_BLK_CSIS_UID_LH_AST_SI_OTF3_CSISCSTAT_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_CSIS_UID_LH_AST_SI_OTF3_CSISCSTAT_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_CSIS_UID_LH_AST_SI_OTF3_CSISCSTAT_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_CSIS_UID_LH_AXI_SI_D0_CSIS_IPCLKPORT_I_CLK, MUX_CLKAOCCSIS_CSIS_NOCD_USER, CLK_CON_GAT_CLK_BLK_CSIS_UID_LH_AXI_SI_D0_CSIS_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_CSIS_UID_LH_AXI_SI_D0_CSIS_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_CSIS_UID_LH_AXI_SI_D0_CSIS_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_CSIS_UID_LH_AXI_SI_D1_CSIS_IPCLKPORT_I_CLK, MUX_CLKAOCCSIS_CSIS_NOCD_USER, CLK_CON_GAT_CLK_BLK_CSIS_UID_LH_AXI_SI_D1_CSIS_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_CSIS_UID_LH_AXI_SI_D1_CSIS_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_CSIS_UID_LH_AXI_SI_D1_CSIS_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_CSIS_UID_LH_AXI_SI_D2_CSIS_IPCLKPORT_I_CLK, MUX_CLKAOCCSIS_CSIS_NOCD_USER, CLK_CON_GAT_CLK_BLK_CSIS_UID_LH_AXI_SI_D2_CSIS_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_CSIS_UID_LH_AXI_SI_D2_CSIS_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_CSIS_UID_LH_AXI_SI_D2_CSIS_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_CSIS_UID_OIS_MCU_TOP_IPCLKPORT_I_ACLK, MUX_CLKAOCCSIS_CSIS_OIS_MCU_USER, CLK_CON_GAT_CLK_BLK_CSIS_UID_OIS_MCU_TOP_IPCLKPORT_I_ACLK_CG_VAL, CLK_CON_GAT_CLK_BLK_CSIS_UID_OIS_MCU_TOP_IPCLKPORT_I_ACLK_MANUAL, CLK_CON_GAT_CLK_BLK_CSIS_UID_OIS_MCU_TOP_IPCLKPORT_I_ACLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_CSIS_UID_PPMU_D0_IPCLKPORT_ACLK, MUX_CLKAOCCSIS_CSIS_NOCD_USER, CLK_CON_GAT_CLK_BLK_CSIS_UID_PPMU_D0_IPCLKPORT_ACLK_CG_VAL, CLK_CON_GAT_CLK_BLK_CSIS_UID_PPMU_D0_IPCLKPORT_ACLK_MANUAL, CLK_CON_GAT_CLK_BLK_CSIS_UID_PPMU_D0_IPCLKPORT_ACLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_CSIS_UID_PPMU_D0_IPCLKPORT_PCLK, MUX_CLKAOCCSIS_CSIS_NOCP_USER, CLK_CON_GAT_CLK_BLK_CSIS_UID_PPMU_D0_IPCLKPORT_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_CSIS_UID_PPMU_D0_IPCLKPORT_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_CSIS_UID_PPMU_D0_IPCLKPORT_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_CSIS_UID_PPMU_D1_IPCLKPORT_ACLK, MUX_CLKAOCCSIS_CSIS_NOCD_USER, CLK_CON_GAT_CLK_BLK_CSIS_UID_PPMU_D1_IPCLKPORT_ACLK_CG_VAL, CLK_CON_GAT_CLK_BLK_CSIS_UID_PPMU_D1_IPCLKPORT_ACLK_MANUAL, CLK_CON_GAT_CLK_BLK_CSIS_UID_PPMU_D1_IPCLKPORT_ACLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_CSIS_UID_PPMU_D1_IPCLKPORT_PCLK, MUX_CLKAOCCSIS_CSIS_NOCP_USER, CLK_CON_GAT_CLK_BLK_CSIS_UID_PPMU_D1_IPCLKPORT_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_CSIS_UID_PPMU_D1_IPCLKPORT_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_CSIS_UID_PPMU_D1_IPCLKPORT_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_CSIS_UID_PPMU_D2_IPCLKPORT_ACLK, MUX_CLKAOCCSIS_CSIS_NOCD_USER, CLK_CON_GAT_CLK_BLK_CSIS_UID_PPMU_D2_IPCLKPORT_ACLK_CG_VAL, CLK_CON_GAT_CLK_BLK_CSIS_UID_PPMU_D2_IPCLKPORT_ACLK_MANUAL, CLK_CON_GAT_CLK_BLK_CSIS_UID_PPMU_D2_IPCLKPORT_ACLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_CSIS_UID_PPMU_D2_IPCLKPORT_PCLK, MUX_CLKAOCCSIS_CSIS_NOCP_USER, CLK_CON_GAT_CLK_BLK_CSIS_UID_PPMU_D2_IPCLKPORT_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_CSIS_UID_PPMU_D2_IPCLKPORT_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_CSIS_UID_PPMU_D2_IPCLKPORT_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_CSIS_UID_QE_CSIS_WDMA0_IPCLKPORT_ACLK, MUX_CLKAOCCSIS_CSIS_NOCD_USER, CLK_CON_GAT_CLK_BLK_CSIS_UID_QE_CSIS_WDMA0_IPCLKPORT_ACLK_CG_VAL, CLK_CON_GAT_CLK_BLK_CSIS_UID_QE_CSIS_WDMA0_IPCLKPORT_ACLK_MANUAL, CLK_CON_GAT_CLK_BLK_CSIS_UID_QE_CSIS_WDMA0_IPCLKPORT_ACLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_CSIS_UID_QE_CSIS_WDMA0_IPCLKPORT_PCLK, MUX_CLKAOCCSIS_CSIS_NOCP_USER, CLK_CON_GAT_CLK_BLK_CSIS_UID_QE_CSIS_WDMA0_IPCLKPORT_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_CSIS_UID_QE_CSIS_WDMA0_IPCLKPORT_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_CSIS_UID_QE_CSIS_WDMA0_IPCLKPORT_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_CSIS_UID_QE_CSIS_WDMA1_IPCLKPORT_ACLK, MUX_CLKAOCCSIS_CSIS_NOCD_USER, CLK_CON_GAT_CLK_BLK_CSIS_UID_QE_CSIS_WDMA1_IPCLKPORT_ACLK_CG_VAL, CLK_CON_GAT_CLK_BLK_CSIS_UID_QE_CSIS_WDMA1_IPCLKPORT_ACLK_MANUAL, CLK_CON_GAT_CLK_BLK_CSIS_UID_QE_CSIS_WDMA1_IPCLKPORT_ACLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_CSIS_UID_QE_CSIS_WDMA1_IPCLKPORT_PCLK, MUX_CLKAOCCSIS_CSIS_NOCP_USER, CLK_CON_GAT_CLK_BLK_CSIS_UID_QE_CSIS_WDMA1_IPCLKPORT_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_CSIS_UID_QE_CSIS_WDMA1_IPCLKPORT_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_CSIS_UID_QE_CSIS_WDMA1_IPCLKPORT_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_CSIS_UID_QE_CSIS_WDMA2_IPCLKPORT_ACLK, MUX_CLKAOCCSIS_CSIS_NOCD_USER, CLK_CON_GAT_CLK_BLK_CSIS_UID_QE_CSIS_WDMA2_IPCLKPORT_ACLK_CG_VAL, CLK_CON_GAT_CLK_BLK_CSIS_UID_QE_CSIS_WDMA2_IPCLKPORT_ACLK_MANUAL, CLK_CON_GAT_CLK_BLK_CSIS_UID_QE_CSIS_WDMA2_IPCLKPORT_ACLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_CSIS_UID_QE_CSIS_WDMA2_IPCLKPORT_PCLK, MUX_CLKAOCCSIS_CSIS_NOCP_USER, CLK_CON_GAT_CLK_BLK_CSIS_UID_QE_CSIS_WDMA2_IPCLKPORT_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_CSIS_UID_QE_CSIS_WDMA2_IPCLKPORT_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_CSIS_UID_QE_CSIS_WDMA2_IPCLKPORT_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_CSIS_UID_QE_CSIS_WDMA3_IPCLKPORT_ACLK, MUX_CLKAOCCSIS_CSIS_NOCD_USER, CLK_CON_GAT_CLK_BLK_CSIS_UID_QE_CSIS_WDMA3_IPCLKPORT_ACLK_CG_VAL, CLK_CON_GAT_CLK_BLK_CSIS_UID_QE_CSIS_WDMA3_IPCLKPORT_ACLK_MANUAL, CLK_CON_GAT_CLK_BLK_CSIS_UID_QE_CSIS_WDMA3_IPCLKPORT_ACLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_CSIS_UID_QE_CSIS_WDMA3_IPCLKPORT_PCLK, MUX_CLKAOCCSIS_CSIS_NOCP_USER, CLK_CON_GAT_CLK_BLK_CSIS_UID_QE_CSIS_WDMA3_IPCLKPORT_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_CSIS_UID_QE_CSIS_WDMA3_IPCLKPORT_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_CSIS_UID_QE_CSIS_WDMA3_IPCLKPORT_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_CSIS_UID_QE_CSIS_WDMA4_IPCLKPORT_ACLK, MUX_CLKAOCCSIS_CSIS_NOCD_USER, CLK_CON_GAT_CLK_BLK_CSIS_UID_QE_CSIS_WDMA4_IPCLKPORT_ACLK_CG_VAL, CLK_CON_GAT_CLK_BLK_CSIS_UID_QE_CSIS_WDMA4_IPCLKPORT_ACLK_MANUAL, CLK_CON_GAT_CLK_BLK_CSIS_UID_QE_CSIS_WDMA4_IPCLKPORT_ACLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_CSIS_UID_QE_CSIS_WDMA4_IPCLKPORT_PCLK, MUX_CLKAOCCSIS_CSIS_NOCP_USER, CLK_CON_GAT_CLK_BLK_CSIS_UID_QE_CSIS_WDMA4_IPCLKPORT_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_CSIS_UID_QE_CSIS_WDMA4_IPCLKPORT_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_CSIS_UID_QE_CSIS_WDMA4_IPCLKPORT_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_CSIS_UID_QE_PDP_D0_IPCLKPORT_ACLK, MUX_CLKAOCCSIS_CSIS_NOCD_USER, CLK_CON_GAT_CLK_BLK_CSIS_UID_QE_PDP_D0_IPCLKPORT_ACLK_CG_VAL, CLK_CON_GAT_CLK_BLK_CSIS_UID_QE_PDP_D0_IPCLKPORT_ACLK_MANUAL, CLK_CON_GAT_CLK_BLK_CSIS_UID_QE_PDP_D0_IPCLKPORT_ACLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_CSIS_UID_QE_PDP_D0_IPCLKPORT_PCLK, MUX_CLKAOCCSIS_CSIS_NOCP_USER, CLK_CON_GAT_CLK_BLK_CSIS_UID_QE_PDP_D0_IPCLKPORT_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_CSIS_UID_QE_PDP_D0_IPCLKPORT_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_CSIS_UID_QE_PDP_D0_IPCLKPORT_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_CSIS_UID_SIU_G_PPMU_CSIS_IPCLKPORT_I_ACLK, MUX_CLKAOCCSIS_CSIS_NOCD_USER, CLK_CON_GAT_CLK_BLK_CSIS_UID_SIU_G_PPMU_CSIS_IPCLKPORT_I_ACLK_CG_VAL, CLK_CON_GAT_CLK_BLK_CSIS_UID_SIU_G_PPMU_CSIS_IPCLKPORT_I_ACLK_MANUAL, CLK_CON_GAT_CLK_BLK_CSIS_UID_SIU_G_PPMU_CSIS_IPCLKPORT_I_ACLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_CSIS_UID_SLH_AST_SI_G_PPMU_CSIS_IPCLKPORT_I_CLK, MUX_CLKAOCCSIS_CSIS_NOCD_USER, CLK_CON_GAT_CLK_BLK_CSIS_UID_SLH_AST_SI_G_PPMU_CSIS_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_CSIS_UID_SLH_AST_SI_G_PPMU_CSIS_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_CSIS_UID_SLH_AST_SI_G_PPMU_CSIS_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_CSIS_UID_XIU_P0_CSIS_IPCLKPORT_ACLK, MUX_CLKAOCCSIS_CSIS_NOCP_USER, CLK_CON_GAT_CLK_BLK_CSIS_UID_XIU_P0_CSIS_IPCLKPORT_ACLK_CG_VAL, CLK_CON_GAT_CLK_BLK_CSIS_UID_XIU_P0_CSIS_IPCLKPORT_ACLK_MANUAL, CLK_CON_GAT_CLK_BLK_CSIS_UID_XIU_P0_CSIS_IPCLKPORT_ACLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_CSIS_UID_SLH_AXI_SI_P_CSISPERIC2_IPCLKPORT_I_CLK, MUX_CLKAOCCSIS_CSIS_OIS_MCU_USER, CLK_CON_GAT_CLK_BLK_CSIS_UID_SLH_AXI_SI_P_CSISPERIC2_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_CSIS_UID_SLH_AXI_SI_P_CSISPERIC2_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_CSIS_UID_SLH_AXI_SI_P_CSISPERIC2_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_CSIS_UID_SYSMMU_CSIS_S0_PMMU0_IPCLKPORT_CLK, MUX_CLKAOCCSIS_CSIS_NOCD_USER, CLK_CON_GAT_CLK_BLK_CSIS_UID_SYSMMU_CSIS_S0_PMMU0_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_CSIS_UID_SYSMMU_CSIS_S0_PMMU0_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_CSIS_UID_SYSMMU_CSIS_S0_PMMU0_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_CSIS_UID_SYSMMU_CSIS_S0_PMMU1_IPCLKPORT_CLK, MUX_CLKAOCCSIS_CSIS_NOCD_USER, CLK_CON_GAT_CLK_BLK_CSIS_UID_SYSMMU_CSIS_S0_PMMU1_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_CSIS_UID_SYSMMU_CSIS_S0_PMMU1_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_CSIS_UID_SYSMMU_CSIS_S0_PMMU1_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_CSIS_UID_SYSMMU_CSIS_S0_PMMU2_IPCLKPORT_CLK, MUX_CLKAOCCSIS_CSIS_NOCD_USER, CLK_CON_GAT_CLK_BLK_CSIS_UID_SYSMMU_CSIS_S0_PMMU2_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_CSIS_UID_SYSMMU_CSIS_S0_PMMU2_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_CSIS_UID_SYSMMU_CSIS_S0_PMMU2_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_CSIS_UID_VGEN_LITE_D0_IPCLKPORT_CLK, MUX_CLKAOCCSIS_CSIS_NOCD_USER, CLK_CON_GAT_CLK_BLK_CSIS_UID_VGEN_LITE_D0_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_CSIS_UID_VGEN_LITE_D0_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_CSIS_UID_VGEN_LITE_D0_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_CSIS_UID_VGEN_LITE_D1_IPCLKPORT_CLK, MUX_CLKAOCCSIS_CSIS_NOCD_USER, CLK_CON_GAT_CLK_BLK_CSIS_UID_VGEN_LITE_D1_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_CSIS_UID_VGEN_LITE_D1_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_CSIS_UID_VGEN_LITE_D1_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_CSIS_UID_XIU_D0_CSIS_IPCLKPORT_ACLK, MUX_CLKAOCCSIS_CSIS_NOCD_USER, CLK_CON_GAT_CLK_BLK_CSIS_UID_XIU_D0_CSIS_IPCLKPORT_ACLK_CG_VAL, CLK_CON_GAT_CLK_BLK_CSIS_UID_XIU_D0_CSIS_IPCLKPORT_ACLK_MANUAL, CLK_CON_GAT_CLK_BLK_CSIS_UID_XIU_D0_CSIS_IPCLKPORT_ACLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_CSIS_UID_XIU_D1_CSIS_IPCLKPORT_ACLK, MUX_CLKAOCCSIS_CSIS_NOCD_USER, CLK_CON_GAT_CLK_BLK_CSIS_UID_XIU_D1_CSIS_IPCLKPORT_ACLK_CG_VAL, CLK_CON_GAT_CLK_BLK_CSIS_UID_XIU_D1_CSIS_IPCLKPORT_ACLK_MANUAL, CLK_CON_GAT_CLK_BLK_CSIS_UID_XIU_D1_CSIS_IPCLKPORT_ACLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_CSIS_UID_XIU_D2_CSIS_IPCLKPORT_ACLK, MUX_CLKAOCCSIS_CSIS_NOCD_USER, CLK_CON_GAT_CLK_BLK_CSIS_UID_XIU_D2_CSIS_IPCLKPORT_ACLK_CG_VAL, CLK_CON_GAT_CLK_BLK_CSIS_UID_XIU_D2_CSIS_IPCLKPORT_ACLK_MANUAL, CLK_CON_GAT_CLK_BLK_CSIS_UID_XIU_D2_CSIS_IPCLKPORT_ACLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_CSIS_UID_RSTNSYNC_CLK_CSIS_NOCD_IPCLKPORT_CLK, MUX_CLKAOCCSIS_CSIS_NOCD_USER, CLK_CON_GAT_CLK_BLK_CSIS_UID_RSTNSYNC_CLK_CSIS_NOCD_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_CSIS_UID_RSTNSYNC_CLK_CSIS_NOCD_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_CSIS_UID_RSTNSYNC_CLK_CSIS_NOCD_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_CSIS_UID_RSTNSYNC_CLK_CSIS_NOCP_IPCLKPORT_CLK, MUX_CLKAOCCSIS_CSIS_NOCP_USER, CLK_CON_GAT_CLK_BLK_CSIS_UID_RSTNSYNC_CLK_CSIS_NOCP_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_CSIS_UID_RSTNSYNC_CLK_CSIS_NOCP_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_CSIS_UID_RSTNSYNC_CLK_CSIS_NOCP_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_CSIS_UID_RSTNSYNC_SR_CLK_CSIS_NOCD_IPCLKPORT_CLK, MUX_CLKAOCCSIS_CSIS_NOCD_USER, CLK_CON_GAT_CLK_BLK_CSIS_UID_RSTNSYNC_SR_CLK_CSIS_NOCD_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_CSIS_UID_RSTNSYNC_SR_CLK_CSIS_NOCD_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_CSIS_UID_RSTNSYNC_SR_CLK_CSIS_NOCD_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_CSIS_UID_RSTNSYNC_CLK_CSIS_OIS_MCU_IPCLKPORT_CLK, MUX_CLKAOCCSIS_CSIS_OIS_MCU_USER, CLK_CON_GAT_CLK_BLK_CSIS_UID_RSTNSYNC_CLK_CSIS_OIS_MCU_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_CSIS_UID_RSTNSYNC_CLK_CSIS_OIS_MCU_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_CSIS_UID_RSTNSYNC_CLK_CSIS_OIS_MCU_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_CSIS_UID_RSTNSYNC_CLK_CSIS_OIS_MCU_CPU_SW_RESET_IPCLKPORT_CLK, MUX_CLKAOCCSIS_CSIS_OIS_MCU_USER, CLK_CON_GAT_CLK_BLK_CSIS_UID_RSTNSYNC_CLK_CSIS_OIS_MCU_CPU_SW_RESET_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_CSIS_UID_RSTNSYNC_CLK_CSIS_OIS_MCU_CPU_SW_RESET_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_CSIS_UID_RSTNSYNC_CLK_CSIS_OIS_MCU_CPU_SW_RESET_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_CSIS_UID_RSTNSYNC_SR_CLK_CSIS_OIS_MCU_IPCLKPORT_CLK, MUX_CLKAOCCSIS_CSIS_OIS_MCU_USER, CLK_CON_GAT_CLK_BLK_CSIS_UID_RSTNSYNC_SR_CLK_CSIS_OIS_MCU_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_CSIS_UID_RSTNSYNC_SR_CLK_CSIS_OIS_MCU_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_CSIS_UID_RSTNSYNC_SR_CLK_CSIS_OIS_MCU_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_CSIS_UID_RSTNSYNC_SR_CLK_CSIS_NOCP_IPCLKPORT_CLK, MUX_CLKAOCCSIS_CSIS_NOCP_USER, CLK_CON_GAT_CLK_BLK_CSIS_UID_RSTNSYNC_SR_CLK_CSIS_NOCP_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_CSIS_UID_RSTNSYNC_SR_CLK_CSIS_NOCP_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_CSIS_UID_RSTNSYNC_SR_CLK_CSIS_NOCP_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_CSIS_UID_SLH_AXI_MI_P_CSIS_IPCLKPORT_I_CLK, MUX_CLKAOCCSIS_CSIS_NOCP_USER, CLK_CON_GAT_CLK_BLK_CSIS_UID_SLH_AXI_MI_P_CSIS_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_CSIS_UID_SLH_AXI_MI_P_CSIS_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_CSIS_UID_SLH_AXI_MI_P_CSIS_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_CSIS_UID_LH_AXI_SI_P_P0OIS_CSIS_INT_IPCLKPORT_I_CLK, MUX_CLKAOCCSIS_CSIS_NOCP_USER, CLK_CON_GAT_CLK_BLK_CSIS_UID_LH_AXI_SI_P_P0OIS_CSIS_INT_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_CSIS_UID_LH_AXI_SI_P_P0OIS_CSIS_INT_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_CSIS_UID_LH_AXI_SI_P_P0OIS_CSIS_INT_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_CSIS_UID_LH_AXI_SI_P_P0P1_CSIS_INT_IPCLKPORT_I_CLK, MUX_CLKAOCCSIS_CSIS_NOCP_USER, CLK_CON_GAT_CLK_BLK_CSIS_UID_LH_AXI_SI_P_P0P1_CSIS_INT_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_CSIS_UID_LH_AXI_SI_P_P0P1_CSIS_INT_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_CSIS_UID_LH_AXI_SI_P_P0P1_CSIS_INT_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_CSIS_UID_LH_AXI_MI_P_P0OIS_CSIS_INT_IPCLKPORT_I_CLK, MUX_CLKAOCCSIS_CSIS_OIS_MCU_USER, CLK_CON_GAT_CLK_BLK_CSIS_UID_LH_AXI_MI_P_P0OIS_CSIS_INT_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_CSIS_UID_LH_AXI_MI_P_P0OIS_CSIS_INT_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_CSIS_UID_LH_AXI_MI_P_P0OIS_CSIS_INT_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_CSIS_UID_CSIS_CMU_CSIS_IPCLKPORT_PCLK, MUX_CLKAOCCSIS_CSIS_NOCP_USER, CLK_CON_GAT_CLK_BLK_CSIS_UID_CSIS_CMU_CSIS_IPCLKPORT_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_CSIS_UID_CSIS_CMU_CSIS_IPCLKPORT_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_CSIS_UID_CSIS_CMU_CSIS_IPCLKPORT_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_CSIS_UID_BLK_CSIS_FRC_OTP_DESERIAL_IPCLKPORT_I_CLK, FREE_OSCCLK_CSIS, CLK_CON_GAT_CLK_BLK_CSIS_UID_BLK_CSIS_FRC_OTP_DESERIAL_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_CSIS_UID_BLK_CSIS_FRC_OTP_DESERIAL_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_CSIS_UID_BLK_CSIS_FRC_OTP_DESERIAL_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_CSIS_UID_SYSREG_CSIS_IPCLKPORT_PCLK, MUX_CLKAOCCSIS_CSIS_NOCP_USER, CLK_CON_GAT_CLK_BLK_CSIS_UID_SYSREG_CSIS_IPCLKPORT_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_CSIS_UID_SYSREG_CSIS_IPCLKPORT_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_CSIS_UID_SYSREG_CSIS_IPCLKPORT_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_CSIS_UID_SYSMMU_CSIS_S0_IPCLKPORT_CLK, MUX_CLKAOCCSIS_CSIS_NOCD_USER, CLK_CON_GAT_CLK_BLK_CSIS_UID_SYSMMU_CSIS_S0_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_CSIS_UID_SYSMMU_CSIS_S0_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_CSIS_UID_SYSMMU_CSIS_S0_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_CSIS_UID_XIU_MMU_CSIS_IPCLKPORT_ACLK, MUX_CLKAOCCSIS_CSIS_NOCD_USER, CLK_CON_GAT_CLK_BLK_CSIS_UID_XIU_MMU_CSIS_IPCLKPORT_ACLK_CG_VAL, CLK_CON_GAT_CLK_BLK_CSIS_UID_XIU_MMU_CSIS_IPCLKPORT_ACLK_MANUAL, CLK_CON_GAT_CLK_BLK_CSIS_UID_XIU_MMU_CSIS_IPCLKPORT_ACLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_CSIS_UID_D_TZPC_CSIS_IPCLKPORT_PCLK, MUX_CLKAOCCSIS_CSIS_NOCP_USER, CLK_CON_GAT_CLK_BLK_CSIS_UID_D_TZPC_CSIS_IPCLKPORT_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_CSIS_UID_D_TZPC_CSIS_IPCLKPORT_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_CSIS_UID_D_TZPC_CSIS_IPCLKPORT_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_CSTAT_UID_SYSMMU_CSTAT_S0_IPCLKPORT_CLK, MUX_CLKCMU_CSTAT_NOC_USER, CLK_CON_GAT_CLK_BLK_CSTAT_UID_SYSMMU_CSTAT_S0_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_CSTAT_UID_SYSMMU_CSTAT_S0_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_CSTAT_UID_SYSMMU_CSTAT_S0_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_CSTAT_UID_XIU_MMU_CSTAT_IPCLKPORT_ACLK, MUX_CLKCMU_CSTAT_NOC_USER, CLK_CON_GAT_CLK_BLK_CSTAT_UID_XIU_MMU_CSTAT_IPCLKPORT_ACLK_CG_VAL, CLK_CON_GAT_CLK_BLK_CSTAT_UID_XIU_MMU_CSTAT_IPCLKPORT_ACLK_MANUAL, CLK_CON_GAT_CLK_BLK_CSTAT_UID_XIU_MMU_CSTAT_IPCLKPORT_ACLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_CSTAT_UID_SYSMMU_CSTAT_S0_PMMU0_IPCLKPORT_CLK, MUX_CLKCMU_CSTAT_NOC_USER, CLK_CON_GAT_CLK_BLK_CSTAT_UID_SYSMMU_CSTAT_S0_PMMU0_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_CSTAT_UID_SYSMMU_CSTAT_S0_PMMU0_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_CSTAT_UID_SYSMMU_CSTAT_S0_PMMU0_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_CSTAT_UID_XIU_P_CSTAT_IPCLKPORT_ACLK, DIV_CLK_CSTAT_NOCP, CLK_CON_GAT_CLK_BLK_CSTAT_UID_XIU_P_CSTAT_IPCLKPORT_ACLK_CG_VAL, CLK_CON_GAT_CLK_BLK_CSTAT_UID_XIU_P_CSTAT_IPCLKPORT_ACLK_MANUAL, CLK_CON_GAT_CLK_BLK_CSTAT_UID_XIU_P_CSTAT_IPCLKPORT_ACLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_DBGCORE_UID_LH_AXI_MI_P_APM_INT_IPCLKPORT_I_CLK, MUX_CLK_DBGCORE_NOC, CLK_CON_GAT_CLK_BLK_DBGCORE_UID_LH_AXI_MI_P_APM_INT_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_DBGCORE_UID_LH_AXI_MI_P_APM_INT_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_DBGCORE_UID_LH_AXI_MI_P_APM_INT_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_DBGCORE_UID_SLH_AXI_SI_G_ALIVECPUCL0_DBGCORE_IPCLKPORT_I_CLK, MUX_CLK_DBGCORE_NOC, CLK_CON_GAT_CLK_BLK_DBGCORE_UID_SLH_AXI_SI_G_ALIVECPUCL0_DBGCORE_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_DBGCORE_UID_SLH_AXI_SI_G_ALIVECPUCL0_DBGCORE_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_DBGCORE_UID_SLH_AXI_SI_G_ALIVECPUCL0_DBGCORE_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_DBGCORE_UID_SLH_AXI_SI_G_ALIVEMIF_SCAN2DRAM_IPCLKPORT_I_CLK, MUX_CLK_DBGCORE_NOC, CLK_CON_GAT_CLK_BLK_DBGCORE_UID_SLH_AXI_SI_G_ALIVEMIF_SCAN2DRAM_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_DBGCORE_UID_SLH_AXI_SI_G_ALIVEMIF_SCAN2DRAM_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_DBGCORE_UID_SLH_AXI_SI_G_ALIVEMIF_SCAN2DRAM_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_DBGCORE_UID_LH_AXI_SI_D_DBGCORE_INT_IPCLKPORT_I_CLK, MUX_CLK_DBGCORE_NOC, CLK_CON_GAT_CLK_BLK_DBGCORE_UID_LH_AXI_SI_D_DBGCORE_INT_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_DBGCORE_UID_LH_AXI_SI_D_DBGCORE_INT_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_DBGCORE_UID_LH_AXI_SI_D_DBGCORE_INT_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_DBGCORE_UID_RSTNSYNC_SR_CLK_DBGCORE_FREE_OSCCLK_IPCLKPORT_CLK, MUX_FREE_OSCCLK_DBGCORE, CLK_CON_GAT_CLK_BLK_DBGCORE_UID_RSTNSYNC_SR_CLK_DBGCORE_FREE_OSCCLK_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_DBGCORE_UID_RSTNSYNC_SR_CLK_DBGCORE_FREE_OSCCLK_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_DBGCORE_UID_RSTNSYNC_SR_CLK_DBGCORE_FREE_OSCCLK_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_DBGCORE_UID_APBIF_CSSYS_ALIVE_IPCLKPORT_PCLK, MUX_FREE_OSCCLK_DBGCORE, CLK_CON_GAT_CLK_BLK_DBGCORE_UID_APBIF_CSSYS_ALIVE_IPCLKPORT_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_DBGCORE_UID_APBIF_CSSYS_ALIVE_IPCLKPORT_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_DBGCORE_UID_APBIF_CSSYS_ALIVE_IPCLKPORT_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_DNC_UID_LH_AXI_MI_D_CTRL_DSP_DNC_IPCLKPORT_I_CLK, DIV_CLK_DNC_NOC, CLK_CON_GAT_CLK_BLK_DNC_UID_LH_AXI_MI_D_CTRL_DSP_DNC_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_DNC_UID_LH_AXI_MI_D_CTRL_DSP_DNC_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_DNC_UID_LH_AXI_MI_D_CTRL_DSP_DNC_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_DNC_UID_LH_AXI_MI_D_DRAM_DSP_DNC_IPCLKPORT_I_CLK, DIV_CLK_DNC_NOC, CLK_CON_GAT_CLK_BLK_DNC_UID_LH_AXI_MI_D_DRAM_DSP_DNC_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_DNC_UID_LH_AXI_MI_D_DRAM_DSP_DNC_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_DNC_UID_LH_AXI_MI_D_DRAM_DSP_DNC_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_DNC_UID_LH_AXI_MI_D_DRAM_GNPU0_DNC_IPCLKPORT_I_CLK, DIV_CLK_DNC_NOC, CLK_CON_GAT_CLK_BLK_DNC_UID_LH_AXI_MI_D_DRAM_GNPU0_DNC_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_DNC_UID_LH_AXI_MI_D_DRAM_GNPU0_DNC_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_DNC_UID_LH_AXI_MI_D_DRAM_GNPU0_DNC_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_DNC_UID_LH_AXI_MI_D_DRAM_GNPU1_DNC_IPCLKPORT_I_CLK, DIV_CLK_DNC_NOC, CLK_CON_GAT_CLK_BLK_DNC_UID_LH_AXI_MI_D_DRAM_GNPU1_DNC_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_DNC_UID_LH_AXI_MI_D_DRAM_GNPU1_DNC_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_DNC_UID_LH_AXI_MI_D_DRAM_GNPU1_DNC_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_DNC_UID_LH_AXI_MI_D_CTRL_GNPU0_DNC_IPCLKPORT_I_CLK, DIV_CLK_DNC_NOC, CLK_CON_GAT_CLK_BLK_DNC_UID_LH_AXI_MI_D_CTRL_GNPU0_DNC_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_DNC_UID_LH_AXI_MI_D_CTRL_GNPU0_DNC_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_DNC_UID_LH_AXI_MI_D_CTRL_GNPU0_DNC_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_DNC_UID_LH_AXI_MI_D_CTRL_GNPU1_DNC_IPCLKPORT_I_CLK, DIV_CLK_DNC_NOC, CLK_CON_GAT_CLK_BLK_DNC_UID_LH_AXI_MI_D_CTRL_GNPU1_DNC_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_DNC_UID_LH_AXI_MI_D_CTRL_GNPU1_DNC_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_DNC_UID_LH_AXI_MI_D_CTRL_GNPU1_DNC_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_DNC_UID_LH_AXI_SI_D_CTRL_DNC_DSP_IPCLKPORT_I_CLK, DIV_CLK_DNC_NOC, CLK_CON_GAT_CLK_BLK_DNC_UID_LH_AXI_SI_D_CTRL_DNC_DSP_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_DNC_UID_LH_AXI_SI_D_CTRL_DNC_DSP_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_DNC_UID_LH_AXI_SI_D_CTRL_DNC_DSP_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_DNC_UID_LH_AXI_MI_D_MMU_SDMA0_DNC_IPCLKPORT_I_CLK, DIV_CLK_DNC_NOC, CLK_CON_GAT_CLK_BLK_DNC_UID_LH_AXI_MI_D_MMU_SDMA0_DNC_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_DNC_UID_LH_AXI_MI_D_MMU_SDMA0_DNC_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_DNC_UID_LH_AXI_MI_D_MMU_SDMA0_DNC_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_DNC_UID_LH_AXI_SI_D_CTRL_DNC_GNPU1_IPCLKPORT_I_CLK, DIV_CLK_DNC_NOC, CLK_CON_GAT_CLK_BLK_DNC_UID_LH_AXI_SI_D_CTRL_DNC_GNPU1_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_DNC_UID_LH_AXI_SI_D_CTRL_DNC_GNPU1_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_DNC_UID_LH_AXI_SI_D_CTRL_DNC_GNPU1_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_DNC_UID_LH_AXI_SI_D_CTRL_DNC_GNPU0_IPCLKPORT_I_CLK, DIV_CLK_DNC_NOC, CLK_CON_GAT_CLK_BLK_DNC_UID_LH_AXI_SI_D_CTRL_DNC_GNPU0_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_DNC_UID_LH_AXI_SI_D_CTRL_DNC_GNPU0_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_DNC_UID_LH_AXI_SI_D_CTRL_DNC_GNPU0_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_DNC_UID_AS_APB_VGEN_DNC_IPCLKPORT_PCLKM, DIV_CLK_DNC_NOC, CLK_CON_GAT_CLK_BLK_DNC_UID_AS_APB_VGEN_DNC_IPCLKPORT_PCLKM_CG_VAL, CLK_CON_GAT_CLK_BLK_DNC_UID_AS_APB_VGEN_DNC_IPCLKPORT_PCLKM_MANUAL, CLK_CON_GAT_CLK_BLK_DNC_UID_AS_APB_VGEN_DNC_IPCLKPORT_PCLKM_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_DNC_UID_LH_AXI_SI_D_CTRL_DNC_SDMA_IPCLKPORT_I_CLK, DIV_CLK_DNC_NOC, CLK_CON_GAT_CLK_BLK_DNC_UID_LH_AXI_SI_D_CTRL_DNC_SDMA_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_DNC_UID_LH_AXI_SI_D_CTRL_DNC_SDMA_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_DNC_UID_LH_AXI_SI_D_CTRL_DNC_SDMA_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_DNC_UID_SLH_AXI_SI_P_DNC_GNPU0_IPCLKPORT_I_CLK, DIV_CLK_DNC_NOCP, CLK_CON_GAT_CLK_BLK_DNC_UID_SLH_AXI_SI_P_DNC_GNPU0_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_DNC_UID_SLH_AXI_SI_P_DNC_GNPU0_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_DNC_UID_SLH_AXI_SI_P_DNC_GNPU0_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_DNC_UID_SLH_AXI_SI_P_DNC_GNPU1_IPCLKPORT_I_CLK, DIV_CLK_DNC_NOCP, CLK_CON_GAT_CLK_BLK_DNC_UID_SLH_AXI_SI_P_DNC_GNPU1_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_DNC_UID_SLH_AXI_SI_P_DNC_GNPU1_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_DNC_UID_SLH_AXI_SI_P_DNC_GNPU1_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_DNC_UID_SLH_AXI_SI_P_DNC_DSP_IPCLKPORT_I_CLK, DIV_CLK_DNC_NOCP, CLK_CON_GAT_CLK_BLK_DNC_UID_SLH_AXI_SI_P_DNC_DSP_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_DNC_UID_SLH_AXI_SI_P_DNC_DSP_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_DNC_UID_SLH_AXI_SI_P_DNC_DSP_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_DNC_UID_SLH_AXI_SI_P_DNC_SDMA_IPCLKPORT_I_CLK, DIV_CLK_DNC_NOCP, CLK_CON_GAT_CLK_BLK_DNC_UID_SLH_AXI_SI_P_DNC_SDMA_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_DNC_UID_SLH_AXI_SI_P_DNC_SDMA_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_DNC_UID_SLH_AXI_SI_P_DNC_SDMA_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_DNC_UID_LH_AXI_SI_D_SRAM_DNC_SDMA_IPCLKPORT_I_CLK, DIV_CLK_DNC_NOC, CLK_CON_GAT_CLK_BLK_DNC_UID_LH_AXI_SI_D_SRAM_DNC_SDMA_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_DNC_UID_LH_AXI_SI_D_SRAM_DNC_SDMA_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_DNC_UID_LH_AXI_SI_D_SRAM_DNC_SDMA_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_DNC_UID_LH_AXI_SI_IPDNC_INT_IPCLKPORT_I_CLK, DIV_CLK_DNC_NOCP, CLK_CON_GAT_CLK_BLK_DNC_UID_LH_AXI_SI_IPDNC_INT_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_DNC_UID_LH_AXI_SI_IPDNC_INT_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_DNC_UID_LH_AXI_SI_IPDNC_INT_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_DNC_UID_LH_AXI_MI_IPDNC_INT_IPCLKPORT_I_CLK, DIV_CLK_DNC_NOC, CLK_CON_GAT_CLK_BLK_DNC_UID_LH_AXI_MI_IPDNC_INT_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_DNC_UID_LH_AXI_MI_IPDNC_INT_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_DNC_UID_LH_AXI_MI_IPDNC_INT_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_DNC_UID_SLH_AXI_MI_P_ALIVE_DNC_IPCLKPORT_I_CLK, DIV_CLK_DNC_NOCP, CLK_CON_GAT_CLK_BLK_DNC_UID_SLH_AXI_MI_P_ALIVE_DNC_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_DNC_UID_SLH_AXI_MI_P_ALIVE_DNC_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_DNC_UID_SLH_AXI_MI_P_ALIVE_DNC_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_DNC_UID_XIU_D_DNC_IPCLKPORT_ACLK, DIV_CLK_DNC_NOC, CLK_CON_GAT_CLK_BLK_DNC_UID_XIU_D_DNC_IPCLKPORT_ACLK_CG_VAL, CLK_CON_GAT_CLK_BLK_DNC_UID_XIU_D_DNC_IPCLKPORT_ACLK_MANUAL, CLK_CON_GAT_CLK_BLK_DNC_UID_XIU_D_DNC_IPCLKPORT_ACLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_DNC_UID_LH_AXI_MI_D_MMU_SDMA1_DNC_IPCLKPORT_I_CLK, DIV_CLK_DNC_NOC, CLK_CON_GAT_CLK_BLK_DNC_UID_LH_AXI_MI_D_MMU_SDMA1_DNC_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_DNC_UID_LH_AXI_MI_D_MMU_SDMA1_DNC_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_DNC_UID_LH_AXI_MI_D_MMU_SDMA1_DNC_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_DNC_UID_LH_AXI_MI_D_MMU_SDMA2_DNC_IPCLKPORT_I_CLK, DIV_CLK_DNC_NOC, CLK_CON_GAT_CLK_BLK_DNC_UID_LH_AXI_MI_D_MMU_SDMA2_DNC_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_DNC_UID_LH_AXI_MI_D_MMU_SDMA2_DNC_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_DNC_UID_LH_AXI_MI_D_MMU_SDMA2_DNC_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_DNC_UID_LH_AXI_MI_D_MMU_SDMA3_DNC_IPCLKPORT_I_CLK, DIV_CLK_DNC_NOC, CLK_CON_GAT_CLK_BLK_DNC_UID_LH_AXI_MI_D_MMU_SDMA3_DNC_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_DNC_UID_LH_AXI_MI_D_MMU_SDMA3_DNC_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_DNC_UID_LH_AXI_MI_D_MMU_SDMA3_DNC_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_DNC_UID_LH_TAXI_SI_D0_DNC_NOCL1A_IPCLKPORT_I_CLK, DIV_CLK_DNC_NOC, CLK_CON_GAT_CLK_BLK_DNC_UID_LH_TAXI_SI_D0_DNC_NOCL1A_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_DNC_UID_LH_TAXI_SI_D0_DNC_NOCL1A_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_DNC_UID_LH_TAXI_SI_D0_DNC_NOCL1A_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_DNC_UID_LH_TAXI_SI_D1_DNC_NOCL1A_IPCLKPORT_I_CLK, DIV_CLK_DNC_NOC, CLK_CON_GAT_CLK_BLK_DNC_UID_LH_TAXI_SI_D1_DNC_NOCL1A_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_DNC_UID_LH_TAXI_SI_D1_DNC_NOCL1A_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_DNC_UID_LH_TAXI_SI_D1_DNC_NOCL1A_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_DNC_UID_LH_TAXI_SI_D2_DNC_NOCL1A_IPCLKPORT_I_CLK, DIV_CLK_DNC_NOC, CLK_CON_GAT_CLK_BLK_DNC_UID_LH_TAXI_SI_D2_DNC_NOCL1A_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_DNC_UID_LH_TAXI_SI_D2_DNC_NOCL1A_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_DNC_UID_LH_TAXI_SI_D2_DNC_NOCL1A_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_DNC_UID_LH_TAXI_SI_D3_DNC_NOCL1A_IPCLKPORT_I_CLK, DIV_CLK_DNC_NOC, CLK_CON_GAT_CLK_BLK_DNC_UID_LH_TAXI_SI_D3_DNC_NOCL1A_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_DNC_UID_LH_TAXI_SI_D3_DNC_NOCL1A_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_DNC_UID_LH_TAXI_SI_D3_DNC_NOCL1A_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_DNC_UID_PPMU_DNC0_IPCLKPORT_ACLK, DIV_CLK_DNC_NOC, CLK_CON_GAT_CLK_BLK_DNC_UID_PPMU_DNC0_IPCLKPORT_ACLK_CG_VAL, CLK_CON_GAT_CLK_BLK_DNC_UID_PPMU_DNC0_IPCLKPORT_ACLK_MANUAL, CLK_CON_GAT_CLK_BLK_DNC_UID_PPMU_DNC0_IPCLKPORT_ACLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_DNC_UID_PPMU_DNC0_IPCLKPORT_PCLK, DIV_CLK_DNC_NOCP, CLK_CON_GAT_CLK_BLK_DNC_UID_PPMU_DNC0_IPCLKPORT_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_DNC_UID_PPMU_DNC0_IPCLKPORT_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_DNC_UID_PPMU_DNC0_IPCLKPORT_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_DNC_UID_PPMU_DNC1_IPCLKPORT_ACLK, DIV_CLK_DNC_NOC, CLK_CON_GAT_CLK_BLK_DNC_UID_PPMU_DNC1_IPCLKPORT_ACLK_CG_VAL, CLK_CON_GAT_CLK_BLK_DNC_UID_PPMU_DNC1_IPCLKPORT_ACLK_MANUAL, CLK_CON_GAT_CLK_BLK_DNC_UID_PPMU_DNC1_IPCLKPORT_ACLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_DNC_UID_PPMU_DNC1_IPCLKPORT_PCLK, DIV_CLK_DNC_NOCP, CLK_CON_GAT_CLK_BLK_DNC_UID_PPMU_DNC1_IPCLKPORT_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_DNC_UID_PPMU_DNC1_IPCLKPORT_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_DNC_UID_PPMU_DNC1_IPCLKPORT_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_DNC_UID_PPMU_DNC2_IPCLKPORT_ACLK, DIV_CLK_DNC_NOC, CLK_CON_GAT_CLK_BLK_DNC_UID_PPMU_DNC2_IPCLKPORT_ACLK_CG_VAL, CLK_CON_GAT_CLK_BLK_DNC_UID_PPMU_DNC2_IPCLKPORT_ACLK_MANUAL, CLK_CON_GAT_CLK_BLK_DNC_UID_PPMU_DNC2_IPCLKPORT_ACLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_DNC_UID_PPMU_DNC2_IPCLKPORT_PCLK, DIV_CLK_DNC_NOCP, CLK_CON_GAT_CLK_BLK_DNC_UID_PPMU_DNC2_IPCLKPORT_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_DNC_UID_PPMU_DNC2_IPCLKPORT_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_DNC_UID_PPMU_DNC2_IPCLKPORT_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_DNC_UID_PPMU_DNC3_IPCLKPORT_ACLK, DIV_CLK_DNC_NOC, CLK_CON_GAT_CLK_BLK_DNC_UID_PPMU_DNC3_IPCLKPORT_ACLK_CG_VAL, CLK_CON_GAT_CLK_BLK_DNC_UID_PPMU_DNC3_IPCLKPORT_ACLK_MANUAL, CLK_CON_GAT_CLK_BLK_DNC_UID_PPMU_DNC3_IPCLKPORT_ACLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_DNC_UID_PPMU_DNC3_IPCLKPORT_PCLK, DIV_CLK_DNC_NOCP, CLK_CON_GAT_CLK_BLK_DNC_UID_PPMU_DNC3_IPCLKPORT_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_DNC_UID_PPMU_DNC3_IPCLKPORT_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_DNC_UID_PPMU_DNC3_IPCLKPORT_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_DNC_UID_SYSMMU_DNC_S0_IPCLKPORT_CLK, DIV_CLK_DNC_NOC, CLK_CON_GAT_CLK_BLK_DNC_UID_SYSMMU_DNC_S0_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_DNC_UID_SYSMMU_DNC_S0_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_DNC_UID_SYSMMU_DNC_S0_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_DNC_UID_SYSMMU_DNC_S0_PMMU0_IPCLKPORT_CLK, DIV_CLK_DNC_NOC, CLK_CON_GAT_CLK_BLK_DNC_UID_SYSMMU_DNC_S0_PMMU0_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_DNC_UID_SYSMMU_DNC_S0_PMMU0_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_DNC_UID_SYSMMU_DNC_S0_PMMU0_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_DNC_UID_SYSMMU_DNC_S0_PMMU1_IPCLKPORT_CLK, DIV_CLK_DNC_NOC, CLK_CON_GAT_CLK_BLK_DNC_UID_SYSMMU_DNC_S0_PMMU1_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_DNC_UID_SYSMMU_DNC_S0_PMMU1_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_DNC_UID_SYSMMU_DNC_S0_PMMU1_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_DNC_UID_SYSMMU_DNC_S0_PMMU2_IPCLKPORT_CLK, DIV_CLK_DNC_NOC, CLK_CON_GAT_CLK_BLK_DNC_UID_SYSMMU_DNC_S0_PMMU2_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_DNC_UID_SYSMMU_DNC_S0_PMMU2_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_DNC_UID_SYSMMU_DNC_S0_PMMU2_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_DNC_UID_SYSMMU_DNC_S0_PMMU3_IPCLKPORT_CLK, DIV_CLK_DNC_NOC, CLK_CON_GAT_CLK_BLK_DNC_UID_SYSMMU_DNC_S0_PMMU3_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_DNC_UID_SYSMMU_DNC_S0_PMMU3_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_DNC_UID_SYSMMU_DNC_S0_PMMU3_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_DNC_UID_SYSMMU_DNC_S1_IPCLKPORT_CLK, DIV_CLK_DNC_NOC, CLK_CON_GAT_CLK_BLK_DNC_UID_SYSMMU_DNC_S1_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_DNC_UID_SYSMMU_DNC_S1_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_DNC_UID_SYSMMU_DNC_S1_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_DNC_UID_SYSMMU_DNC_S1_PMMU0_IPCLKPORT_CLK, DIV_CLK_DNC_NOC, CLK_CON_GAT_CLK_BLK_DNC_UID_SYSMMU_DNC_S1_PMMU0_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_DNC_UID_SYSMMU_DNC_S1_PMMU0_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_DNC_UID_SYSMMU_DNC_S1_PMMU0_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_DNC_UID_S2PC_DNC_IPCLKPORT_PCLK, DIV_CLK_DNC_NOCP, CLK_CON_GAT_CLK_BLK_DNC_UID_S2PC_DNC_IPCLKPORT_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_DNC_UID_S2PC_DNC_IPCLKPORT_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_DNC_UID_S2PC_DNC_IPCLKPORT_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_DPUB_UID_ECU_DPUB_IPCLKPORT_PCLK, DIV_CLK_DPUB_NOCP, CLK_CON_GAT_CLK_BLK_DPUB_UID_ECU_DPUB_IPCLKPORT_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_DPUB_UID_ECU_DPUB_IPCLKPORT_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_DPUB_UID_ECU_DPUB_IPCLKPORT_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_DPUB_UID_ECU_DPUB_IPCLKPORT_CLK, DIV_CLK_DPUB_ECU, CLK_CON_GAT_CLK_BLK_DPUB_UID_ECU_DPUB_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_DPUB_UID_ECU_DPUB_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_DPUB_UID_ECU_DPUB_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_DPUB_UID_RSTNSYNC_SR_CLK_DPUB_ECU_IPCLKPORT_CLK, DIV_CLK_DPUB_ECU, CLK_CON_GAT_CLK_BLK_DPUB_UID_RSTNSYNC_SR_CLK_DPUB_ECU_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_DPUB_UID_RSTNSYNC_SR_CLK_DPUB_ECU_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_DPUB_UID_RSTNSYNC_SR_CLK_DPUB_ECU_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_DPUF0_UID_PPMU_D0_DPUF0_IPCLKPORT_ACLK, MUX_CLKCMU_DPUF0_NOC_USER, CLK_CON_GAT_CLK_BLK_DPUF0_UID_PPMU_D0_DPUF0_IPCLKPORT_ACLK_CG_VAL, CLK_CON_GAT_CLK_BLK_DPUF0_UID_PPMU_D0_DPUF0_IPCLKPORT_ACLK_MANUAL, CLK_CON_GAT_CLK_BLK_DPUF0_UID_PPMU_D0_DPUF0_IPCLKPORT_ACLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_DPUF0_UID_PPMU_D0_DPUF0_IPCLKPORT_PCLK, DIV_CLK_DPUF0_NOCP, CLK_CON_GAT_CLK_BLK_DPUF0_UID_PPMU_D0_DPUF0_IPCLKPORT_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_DPUF0_UID_PPMU_D0_DPUF0_IPCLKPORT_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_DPUF0_UID_PPMU_D0_DPUF0_IPCLKPORT_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_DPUF0_UID_PPMU_D1_DPUF0_IPCLKPORT_ACLK, MUX_CLKCMU_DPUF0_NOC_USER, CLK_CON_GAT_CLK_BLK_DPUF0_UID_PPMU_D1_DPUF0_IPCLKPORT_ACLK_CG_VAL, CLK_CON_GAT_CLK_BLK_DPUF0_UID_PPMU_D1_DPUF0_IPCLKPORT_ACLK_MANUAL, CLK_CON_GAT_CLK_BLK_DPUF0_UID_PPMU_D1_DPUF0_IPCLKPORT_ACLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_DPUF0_UID_PPMU_D1_DPUF0_IPCLKPORT_PCLK, DIV_CLK_DPUF0_NOCP, CLK_CON_GAT_CLK_BLK_DPUF0_UID_PPMU_D1_DPUF0_IPCLKPORT_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_DPUF0_UID_PPMU_D1_DPUF0_IPCLKPORT_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_DPUF0_UID_PPMU_D1_DPUF0_IPCLKPORT_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_DPUF0_UID_SYSMMU_DPUF_S1_PMMU0_IPCLKPORT_CLK, MUX_CLKCMU_DPUF0_NOC_USER, CLK_CON_GAT_CLK_BLK_DPUF0_UID_SYSMMU_DPUF_S1_PMMU0_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_DPUF0_UID_SYSMMU_DPUF_S1_PMMU0_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_DPUF0_UID_SYSMMU_DPUF_S1_PMMU0_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_DPUF0_UID_SYSMMU_DPUF_S0_PMMU0_IPCLKPORT_CLK, MUX_CLKCMU_DPUF0_NOC_USER, CLK_CON_GAT_CLK_BLK_DPUF0_UID_SYSMMU_DPUF_S0_PMMU0_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_DPUF0_UID_SYSMMU_DPUF_S0_PMMU0_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_DPUF0_UID_SYSMMU_DPUF_S0_PMMU0_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_DPUF0_UID_SLH_AST_SI_G_PPMU_DPUF0_IPCLKPORT_I_CLK, MUX_CLKCMU_DPUF0_NOC_USER, CLK_CON_GAT_CLK_BLK_DPUF0_UID_SLH_AST_SI_G_PPMU_DPUF0_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_DPUF0_UID_SLH_AST_SI_G_PPMU_DPUF0_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_DPUF0_UID_SLH_AST_SI_G_PPMU_DPUF0_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_DPUF0_UID_LH_AXI_SI_D0_DPUF0_IPCLKPORT_I_CLK, MUX_CLKCMU_DPUF0_NOC_USER, CLK_CON_GAT_CLK_BLK_DPUF0_UID_LH_AXI_SI_D0_DPUF0_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_DPUF0_UID_LH_AXI_SI_D0_DPUF0_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_DPUF0_UID_LH_AXI_SI_D0_DPUF0_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_DPUF0_UID_DPUF0_IPCLKPORT_ACLK_SRAMC, MUX_CLKCMU_DPUF0_NOC_USER, CLK_CON_GAT_CLK_BLK_DPUF0_UID_DPUF0_IPCLKPORT_ACLK_SRAMC_CG_VAL, CLK_CON_GAT_CLK_BLK_DPUF0_UID_DPUF0_IPCLKPORT_ACLK_SRAMC_MANUAL, CLK_CON_GAT_CLK_BLK_DPUF0_UID_DPUF0_IPCLKPORT_ACLK_SRAMC_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_DPUF0_UID_PPMU_D1_DPUF1_IPCLKPORT_ACLK, MUX_CLKCMU_DPUF0_NOC_USER, CLK_CON_GAT_CLK_BLK_DPUF0_UID_PPMU_D1_DPUF1_IPCLKPORT_ACLK_CG_VAL, CLK_CON_GAT_CLK_BLK_DPUF0_UID_PPMU_D1_DPUF1_IPCLKPORT_ACLK_MANUAL, CLK_CON_GAT_CLK_BLK_DPUF0_UID_PPMU_D1_DPUF1_IPCLKPORT_ACLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_DPUF0_UID_PPMU_D1_DPUF1_IPCLKPORT_PCLK, DIV_CLK_DPUF0_NOCP, CLK_CON_GAT_CLK_BLK_DPUF0_UID_PPMU_D1_DPUF1_IPCLKPORT_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_DPUF0_UID_PPMU_D1_DPUF1_IPCLKPORT_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_DPUF0_UID_PPMU_D1_DPUF1_IPCLKPORT_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_DPUF0_UID_PPMU_D0_DPUF1_IPCLKPORT_ACLK, MUX_CLKCMU_DPUF0_NOC_USER, CLK_CON_GAT_CLK_BLK_DPUF0_UID_PPMU_D0_DPUF1_IPCLKPORT_ACLK_CG_VAL, CLK_CON_GAT_CLK_BLK_DPUF0_UID_PPMU_D0_DPUF1_IPCLKPORT_ACLK_MANUAL, CLK_CON_GAT_CLK_BLK_DPUF0_UID_PPMU_D0_DPUF1_IPCLKPORT_ACLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_DPUF0_UID_PPMU_D0_DPUF1_IPCLKPORT_PCLK, DIV_CLK_DPUF0_NOCP, CLK_CON_GAT_CLK_BLK_DPUF0_UID_PPMU_D0_DPUF1_IPCLKPORT_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_DPUF0_UID_PPMU_D0_DPUF1_IPCLKPORT_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_DPUF0_UID_PPMU_D0_DPUF1_IPCLKPORT_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_DPUF0_UID_SYSMMU_DPUF_S0_PMMU1_IPCLKPORT_CLK, MUX_CLKCMU_DPUF0_NOC_USER, CLK_CON_GAT_CLK_BLK_DPUF0_UID_SYSMMU_DPUF_S0_PMMU1_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_DPUF0_UID_SYSMMU_DPUF_S0_PMMU1_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_DPUF0_UID_SYSMMU_DPUF_S0_PMMU1_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_DPUF0_UID_SYSMMU_DPUF_S1_PMMU1_IPCLKPORT_CLK, MUX_CLKCMU_DPUF0_NOC_USER, CLK_CON_GAT_CLK_BLK_DPUF0_UID_SYSMMU_DPUF_S1_PMMU1_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_DPUF0_UID_SYSMMU_DPUF_S1_PMMU1_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_DPUF0_UID_SYSMMU_DPUF_S1_PMMU1_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_DPUF0_UID_RSTNSYNC_SR_CLK_DPUF0_NOCP_IPCLKPORT_CLK, DIV_CLK_DPUF0_NOCP, CLK_CON_GAT_CLK_BLK_DPUF0_UID_RSTNSYNC_SR_CLK_DPUF0_NOCP_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_DPUF0_UID_RSTNSYNC_SR_CLK_DPUF0_NOCP_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_DPUF0_UID_RSTNSYNC_SR_CLK_DPUF0_NOCP_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_DPUF0_UID_BLK_DPUF0_FRC_OTP_DESERIAL_IPCLKPORT_I_CLK, FREE_OSCCLK_DPUF0, CLK_CON_GAT_CLK_BLK_DPUF0_UID_BLK_DPUF0_FRC_OTP_DESERIAL_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_DPUF0_UID_BLK_DPUF0_FRC_OTP_DESERIAL_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_DPUF0_UID_BLK_DPUF0_FRC_OTP_DESERIAL_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_DPUF0_UID_SYSMMU_DPUF_S0_IPCLKPORT_CLK, MUX_CLKCMU_DPUF0_NOC_USER, CLK_CON_GAT_CLK_BLK_DPUF0_UID_SYSMMU_DPUF_S0_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_DPUF0_UID_SYSMMU_DPUF_S0_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_DPUF0_UID_SYSMMU_DPUF_S0_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_DPUF0_UID_SYSMMU_DPUF_S1_IPCLKPORT_CLK, MUX_CLKCMU_DPUF0_NOC_USER, CLK_CON_GAT_CLK_BLK_DPUF0_UID_SYSMMU_DPUF_S1_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_DPUF0_UID_SYSMMU_DPUF_S1_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_DPUF0_UID_SYSMMU_DPUF_S1_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_DPUF0_UID_ECU_DPUF0_IPCLKPORT_PCLK, DIV_CLK_DPUF0_NOCP, CLK_CON_GAT_CLK_BLK_DPUF0_UID_ECU_DPUF0_IPCLKPORT_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_DPUF0_UID_ECU_DPUF0_IPCLKPORT_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_DPUF0_UID_ECU_DPUF0_IPCLKPORT_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_DPUF0_UID_SLH_AXI_SI_P_DPUF0DPUF1_IPCLKPORT_I_CLK, DIV_CLK_DPUF0_NOCP, CLK_CON_GAT_CLK_BLK_DPUF0_UID_SLH_AXI_SI_P_DPUF0DPUF1_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_DPUF0_UID_SLH_AXI_SI_P_DPUF0DPUF1_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_DPUF0_UID_SLH_AXI_SI_P_DPUF0DPUF1_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_DPUF0_UID_RSTNSYNC_SR_CLK_DPUF0_FREE_OSCCLK_IPCLKPORT_CLK, FREE_OSCCLK_DPUF0, CLK_CON_GAT_CLK_BLK_DPUF0_UID_RSTNSYNC_SR_CLK_DPUF0_FREE_OSCCLK_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_DPUF0_UID_RSTNSYNC_SR_CLK_DPUF0_FREE_OSCCLK_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_DPUF0_UID_RSTNSYNC_SR_CLK_DPUF0_FREE_OSCCLK_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_DPUF0_UID_ECU_DPUF0_IPCLKPORT_CLK, DIV_CLK_DPUF0_ECU, CLK_CON_GAT_CLK_BLK_DPUF0_UID_ECU_DPUF0_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_DPUF0_UID_ECU_DPUF0_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_DPUF0_UID_ECU_DPUF0_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_DPUF0_UID_RSTNSYNC_SR_CLK_DPUF0_ECU_IPCLKPORT_CLK, DIV_CLK_DPUF0_ECU, CLK_CON_GAT_CLK_BLK_DPUF0_UID_RSTNSYNC_SR_CLK_DPUF0_ECU_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_DPUF0_UID_RSTNSYNC_SR_CLK_DPUF0_ECU_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_DPUF0_UID_RSTNSYNC_SR_CLK_DPUF0_ECU_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_DPUF1_UID_SLH_AXI_MI_P_DPUF0DPUF1_IPCLKPORT_I_CLK, DIV_CLK_DPUF1_NOCP, CLK_CON_GAT_CLK_BLK_DPUF1_UID_SLH_AXI_MI_P_DPUF0DPUF1_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_DPUF1_UID_SLH_AXI_MI_P_DPUF0DPUF1_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_DPUF1_UID_SLH_AXI_MI_P_DPUF0DPUF1_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_DPUF1_UID_DPUF1_IPCLKPORT_ACLK_SRAMC, MUX_CLKCMU_DPUF1_NOC_USER, CLK_CON_GAT_CLK_BLK_DPUF1_UID_DPUF1_IPCLKPORT_ACLK_SRAMC_CG_VAL, CLK_CON_GAT_CLK_BLK_DPUF1_UID_DPUF1_IPCLKPORT_ACLK_SRAMC_MANUAL, CLK_CON_GAT_CLK_BLK_DPUF1_UID_DPUF1_IPCLKPORT_ACLK_SRAMC_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_DPUF1_UID_ECU_DPUF1_IPCLKPORT_PCLK, DIV_CLK_DPUF1_NOCP, CLK_CON_GAT_CLK_BLK_DPUF1_UID_ECU_DPUF1_IPCLKPORT_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_DPUF1_UID_ECU_DPUF1_IPCLKPORT_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_DPUF1_UID_ECU_DPUF1_IPCLKPORT_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_DPUF1_UID_RSTNSYNC_SR_CLK_DPUF1_NOCP_IPCLKPORT_CLK, DIV_CLK_DPUF1_NOCP, CLK_CON_GAT_CLK_BLK_DPUF1_UID_RSTNSYNC_SR_CLK_DPUF1_NOCP_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_DPUF1_UID_RSTNSYNC_SR_CLK_DPUF1_NOCP_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_DPUF1_UID_RSTNSYNC_SR_CLK_DPUF1_NOCP_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_DPUF1_UID_BLK_DPUF1_FRC_OTP_DESERIAL_IPCLKPORT_I_CLK, FREE_OSCCLK_DPUF1, CLK_CON_GAT_CLK_BLK_DPUF1_UID_BLK_DPUF1_FRC_OTP_DESERIAL_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_DPUF1_UID_BLK_DPUF1_FRC_OTP_DESERIAL_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_DPUF1_UID_BLK_DPUF1_FRC_OTP_DESERIAL_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_DPUF1_UID_RSTNSYNC_SR_CLK_DPUF1_FREE_OSCCLK_IPCLKPORT_CLK, FREE_OSCCLK_DPUF1, CLK_CON_GAT_CLK_BLK_DPUF1_UID_RSTNSYNC_SR_CLK_DPUF1_FREE_OSCCLK_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_DPUF1_UID_RSTNSYNC_SR_CLK_DPUF1_FREE_OSCCLK_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_DPUF1_UID_RSTNSYNC_SR_CLK_DPUF1_FREE_OSCCLK_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_DPUF1_UID_ECU_DPUF1_IPCLKPORT_CLK, DIV_CLK_DPUF1_ECU, CLK_CON_GAT_CLK_BLK_DPUF1_UID_ECU_DPUF1_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_DPUF1_UID_ECU_DPUF1_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_DPUF1_UID_ECU_DPUF1_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_DPUF1_UID_RSTNSYNC_SR_CLK_DPUF1_ECU_IPCLKPORT_CLK, DIV_CLK_DPUF1_ECU, CLK_CON_GAT_CLK_BLK_DPUF1_UID_RSTNSYNC_SR_CLK_DPUF1_ECU_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_DPUF1_UID_RSTNSYNC_SR_CLK_DPUF1_ECU_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_DPUF1_UID_RSTNSYNC_SR_CLK_DPUF1_ECU_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_DSP_UID_LH_AST_SI_D_SRAM_DSP_SDMA_IPCLKPORT_I_CLK, DIV_CLK_DSP_NOC, CLK_CON_GAT_CLK_BLK_DSP_UID_LH_AST_SI_D_SRAM_DSP_SDMA_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_DSP_UID_LH_AST_SI_D_SRAM_DSP_SDMA_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_DSP_UID_LH_AST_SI_D_SRAM_DSP_SDMA_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_DSP_UID_SLH_AXI_MI_P_DNC_DSP_IPCLKPORT_I_CLK, DIV_CLK_DSP_NOCP, CLK_CON_GAT_CLK_BLK_DSP_UID_SLH_AXI_MI_P_DNC_DSP_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_DSP_UID_SLH_AXI_MI_P_DNC_DSP_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_DSP_UID_SLH_AXI_MI_P_DNC_DSP_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_DSP_UID_LH_AXI_MI_D_SRAM_SDMA_DSP_IPCLKPORT_I_CLK, DIV_CLK_DSP_NOC, CLK_CON_GAT_CLK_BLK_DSP_UID_LH_AXI_MI_D_SRAM_SDMA_DSP_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_DSP_UID_LH_AXI_MI_D_SRAM_SDMA_DSP_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_DSP_UID_LH_AXI_MI_D_SRAM_SDMA_DSP_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_DSP_UID_LH_AXI_MI_D_CTRL_DNC_DSP_IPCLKPORT_I_CLK, DIV_CLK_DSP_NOC, CLK_CON_GAT_CLK_BLK_DSP_UID_LH_AXI_MI_D_CTRL_DNC_DSP_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_DSP_UID_LH_AXI_MI_D_CTRL_DNC_DSP_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_DSP_UID_LH_AXI_MI_D_CTRL_DNC_DSP_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_DSP_UID_LH_AXI_SI_D_CTRL_DSP_DNC_IPCLKPORT_I_CLK, DIV_CLK_DSP_NOC, CLK_CON_GAT_CLK_BLK_DSP_UID_LH_AXI_SI_D_CTRL_DSP_DNC_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_DSP_UID_LH_AXI_SI_D_CTRL_DSP_DNC_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_DSP_UID_LH_AXI_SI_D_CTRL_DSP_DNC_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_DSP_UID_LH_AXI_SI_D_DRAM_DSP_DNC_IPCLKPORT_I_CLK, DIV_CLK_DSP_NOC, CLK_CON_GAT_CLK_BLK_DSP_UID_LH_AXI_SI_D_DRAM_DSP_DNC_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_DSP_UID_LH_AXI_SI_D_DRAM_DSP_DNC_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_DSP_UID_LH_AXI_SI_D_DRAM_DSP_DNC_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_DSU_UID_LH_ATB_SI_T_CLUSTER0_INT_IPCLKPORT_I_CLK, DIV_CLK_CLUSTER_ATCLK, CLK_CON_GAT_CLK_BLK_DSU_UID_LH_ATB_SI_T_CLUSTER0_INT_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_DSU_UID_LH_ATB_SI_T_CLUSTER0_INT_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_DSU_UID_LH_ATB_SI_T_CLUSTER0_INT_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_DSU_UID_SLH_AXI_MI_P_ALIVECPUCL0_PPU_IPCLKPORT_I_CLK, DIV_CLK_CLUSTER_ATCLK, CLK_CON_GAT_CLK_BLK_DSU_UID_SLH_AXI_MI_P_ALIVECPUCL0_PPU_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_DSU_UID_SLH_AXI_MI_P_ALIVECPUCL0_PPU_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_DSU_UID_SLH_AXI_MI_P_ALIVECPUCL0_PPU_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_DSU_UID_LH_AXI_MI_P_UTILITY_INT_IPCLKPORT_I_CLK, DIV_CLK_CLUSTER_ATCLK, CLK_CON_GAT_CLK_BLK_DSU_UID_LH_AXI_MI_P_UTILITY_INT_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_DSU_UID_LH_AXI_MI_P_UTILITY_INT_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_DSU_UID_LH_AXI_MI_P_UTILITY_INT_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_DSU_UID_LH_AST_MI_D_PERISCPUCL0_IRI_GICCPU_CLUSTER0_IPCLKPORT_I_CLK, DIV_CLK_CLUSTER_ATCLK, CLK_CON_GAT_CLK_BLK_DSU_UID_LH_AST_MI_D_PERISCPUCL0_IRI_GICCPU_CLUSTER0_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_DSU_UID_LH_AST_MI_D_PERISCPUCL0_IRI_GICCPU_CLUSTER0_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_DSU_UID_LH_AST_MI_D_PERISCPUCL0_IRI_GICCPU_CLUSTER0_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_DSU_UID_LH_AST_SI_D_CPUCL0PERIS_ICC_CPUGIC_CLUSTER0_IPCLKPORT_I_CLK, DIV_CLK_CLUSTER_ATCLK, CLK_CON_GAT_CLK_BLK_DSU_UID_LH_AST_SI_D_CPUCL0PERIS_ICC_CPUGIC_CLUSTER0_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_DSU_UID_LH_AST_SI_D_CPUCL0PERIS_ICC_CPUGIC_CLUSTER0_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_DSU_UID_LH_AST_SI_D_CPUCL0PERIS_ICC_CPUGIC_CLUSTER0_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_DSU_UID_LH_AXI_SI_P_UTILITY_INT_IPCLKPORT_I_CLK, DIV_CLK_CLUSTER_MPCLK, CLK_CON_GAT_CLK_BLK_DSU_UID_LH_AXI_SI_P_UTILITY_INT_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_DSU_UID_LH_AXI_SI_P_UTILITY_INT_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_DSU_UID_LH_AXI_SI_P_UTILITY_INT_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_DSU_UID_CPUCL0_CON_IPCLKPORT_I_PERIPHCLK, DIV_CLK_CLUSTER_ATCLK, CLK_CON_GAT_CLK_BLK_DSU_UID_CPUCL0_CON_IPCLKPORT_I_PERIPHCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_DSU_UID_CPUCL0_CON_IPCLKPORT_I_PERIPHCLK_MANUAL, CLK_CON_GAT_CLK_BLK_DSU_UID_CPUCL0_CON_IPCLKPORT_I_PERIPHCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_CLUSTER0_SCLK, DIV_CLK_DSU_CLUSTER, CLK_CON_GAT_CLK_CLUSTER0_SCLK_CG_VAL, CLK_CON_GAT_CLK_CLUSTER0_SCLK_MANUAL, CLK_CON_GAT_CLK_CLUSTER0_SCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_CLUSTER0_ATCLK, DIV_CLK_CLUSTER_ATCLK, CLK_CON_GAT_CLK_CLUSTER0_ATCLK_CG_VAL, CLK_CON_GAT_CLK_CLUSTER0_ATCLK_MANUAL, CLK_CON_GAT_CLK_CLUSTER0_ATCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_CLUSTER0_GICCLK, DIV_CLK_CLUSTER_ATCLK, CLK_CON_GAT_CLK_CLUSTER0_GICCLK_CG_VAL, CLK_CON_GAT_CLK_CLUSTER0_GICCLK_MANUAL, CLK_CON_GAT_CLK_CLUSTER0_GICCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_CLUSTER0_PCLK, DIV_CLK_CLUSTER_ATCLK, CLK_CON_GAT_CLK_CLUSTER0_PCLK_CG_VAL, CLK_CON_GAT_CLK_CLUSTER0_PCLK_MANUAL, CLK_CON_GAT_CLK_CLUSTER0_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_CLUSTER0_PERIPHCLK, DIV_CLK_CLUSTER_ATCLK, CLK_CON_GAT_CLK_CLUSTER0_PERIPHCLK_CG_VAL, CLK_CON_GAT_CLK_CLUSTER0_PERIPHCLK_MANUAL, CLK_CON_GAT_CLK_CLUSTER0_PERIPHCLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_DSU_UID_DFP_GASKET_0_IPCLKPORT_CLK, DIV_CLK_CLUSTER_ACLK, CLK_CON_GAT_CLK_BLK_DSU_UID_DFP_GASKET_0_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_DSU_UID_DFP_GASKET_0_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_DSU_UID_DFP_GASKET_0_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_DSU_UID_DFP_GASKET_1_IPCLKPORT_CLK, DIV_CLK_CLUSTER_ACLK, CLK_CON_GAT_CLK_BLK_DSU_UID_DFP_GASKET_1_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_DSU_UID_DFP_GASKET_1_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_DSU_UID_DFP_GASKET_1_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_DSU_UID_LH_PACE_ASYNC_MFP_D0_IPCLKPORT_I_CLK, DIV_CLK_CLUSTER_ACLK, CLK_CON_GAT_CLK_BLK_DSU_UID_LH_PACE_ASYNC_MFP_D0_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_DSU_UID_LH_PACE_ASYNC_MFP_D0_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_DSU_UID_LH_PACE_ASYNC_MFP_D0_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_DSU_UID_LH_PACE_ASYNC_MFP_D1_IPCLKPORT_I_CLK, DIV_CLK_CLUSTER_ACLK, CLK_CON_GAT_CLK_BLK_DSU_UID_LH_PACE_ASYNC_MFP_D1_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_DSU_UID_LH_PACE_ASYNC_MFP_D1_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_DSU_UID_LH_PACE_ASYNC_MFP_D1_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_DSU_UID_LH_PACE_ASYNC_MFP_D2_IPCLKPORT_I_CLK, DIV_CLK_CLUSTER_ACLK, CLK_CON_GAT_CLK_BLK_DSU_UID_LH_PACE_ASYNC_MFP_D2_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_DSU_UID_LH_PACE_ASYNC_MFP_D2_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_DSU_UID_LH_PACE_ASYNC_MFP_D2_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_DSU_UID_LH_PACE_ASYNC_MFP_D3_IPCLKPORT_I_CLK, DIV_CLK_CLUSTER_ACLK, CLK_CON_GAT_CLK_BLK_DSU_UID_LH_PACE_ASYNC_MFP_D3_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_DSU_UID_LH_PACE_ASYNC_MFP_D3_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_DSU_UID_LH_PACE_ASYNC_MFP_D3_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_DSU_UID_PPC_INSTRRUN_CLUSTER0_2_IPCLKPORT_PCLK, MUX_CLKCMU_CPUCL0_GLB_NOCP_USER, CLK_CON_GAT_CLK_BLK_DSU_UID_PPC_INSTRRUN_CLUSTER0_2_IPCLKPORT_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_DSU_UID_PPC_INSTRRUN_CLUSTER0_2_IPCLKPORT_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_DSU_UID_PPC_INSTRRUN_CLUSTER0_2_IPCLKPORT_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_DSU_UID_PPC_INSTRRET_CLUSTER0_2_IPCLKPORT_PCLK, MUX_CLKCMU_CPUCL0_GLB_NOCP_USER, CLK_CON_GAT_CLK_BLK_DSU_UID_PPC_INSTRRET_CLUSTER0_2_IPCLKPORT_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_DSU_UID_PPC_INSTRRET_CLUSTER0_2_IPCLKPORT_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_DSU_UID_PPC_INSTRRET_CLUSTER0_2_IPCLKPORT_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_DSU_UID_PPC_INSTRRET_CLUSTER0_2_IPCLKPORT_CLK, DIV_CLK_CLUSTER_ATCLK, CLK_CON_GAT_CLK_BLK_DSU_UID_PPC_INSTRRET_CLUSTER0_2_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_DSU_UID_PPC_INSTRRET_CLUSTER0_2_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_DSU_UID_PPC_INSTRRET_CLUSTER0_2_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_DSU_UID_PPC_INSTRRUN_CLUSTER0_2_IPCLKPORT_CLK, DIV_CLK_CLUSTER_ATCLK, CLK_CON_GAT_CLK_BLK_DSU_UID_PPC_INSTRRUN_CLUSTER0_2_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_DSU_UID_PPC_INSTRRUN_CLUSTER0_2_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_DSU_UID_PPC_INSTRRUN_CLUSTER0_2_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_G3D_UID_LH_AXI_SI_P_G3D_INT_IPCLKPORT_I_CLK, MUX_CLKCMU_G3D_NOCP_USER, CLK_CON_GAT_CLK_BLK_G3D_UID_LH_AXI_SI_P_G3D_INT_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_G3D_UID_LH_AXI_SI_P_G3D_INT_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_G3D_UID_LH_AXI_SI_P_G3D_INT_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_G3D_UID_OTP_DESERIAL_G3D_IPCLKPORT_I_CLK, FREE_OSCCLK_G3D, CLK_CON_GAT_CLK_BLK_G3D_UID_OTP_DESERIAL_G3D_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_G3D_UID_OTP_DESERIAL_G3D_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_G3D_UID_OTP_DESERIAL_G3D_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_G3DCORE_UID_ADD_G3D_IPCLKPORT_CLK, MUX_CLK_G3D_POWERIP, CLK_CON_GAT_CLK_BLK_G3DCORE_UID_ADD_G3D_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_G3DCORE_UID_ADD_G3D_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_G3DCORE_UID_ADD_G3D_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_G3DCORE_UID_HTU_G3D_IPCLKPORT_I_CLK, MUX_CLK_G3D_POWERIP, CLK_CON_GAT_CLK_BLK_G3DCORE_UID_HTU_G3D_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_G3DCORE_UID_HTU_G3D_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_G3DCORE_UID_HTU_G3D_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_G3DCORE_UID_STR_MUX_G3D_IPCLKPORT_CLK_CORE, MUX_CLK_G3D_POWERIP, CLK_CON_GAT_CLK_BLK_G3DCORE_UID_STR_MUX_G3D_IPCLKPORT_CLK_CORE_CG_VAL, CLK_CON_GAT_CLK_BLK_G3DCORE_UID_STR_MUX_G3D_IPCLKPORT_CLK_CORE_MANUAL, CLK_CON_GAT_CLK_BLK_G3DCORE_UID_STR_MUX_G3D_IPCLKPORT_CLK_CORE_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_G3DCORE_UID_ECU_G3D_IPCLKPORT_PCLK, MUX_CLKCMU_G3D_NOCP_USER, CLK_CON_GAT_CLK_BLK_G3DCORE_UID_ECU_G3D_IPCLKPORT_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_G3DCORE_UID_ECU_G3D_IPCLKPORT_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_G3DCORE_UID_ECU_G3D_IPCLKPORT_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(G3D_GCPM, DIV_CLK_G3D_CORE, CLK_CON_GAT_G3D_GCPM_CG_VAL, CLK_CON_GAT_G3D_GCPM_MANUAL, CLK_CON_GAT_G3D_GCPM_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_G3DCORE_UID_ECU_G3D_IPCLKPORT_CLK, DIV_CLK_G3D_ECU, CLK_CON_GAT_CLK_BLK_G3DCORE_UID_ECU_G3D_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_G3DCORE_UID_ECU_G3D_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_G3DCORE_UID_ECU_G3D_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_G3DCORE_UID_RSTNSYNC_SR_CLK_G3D_ECU_IPCLKPORT_CLK, DIV_CLK_G3D_ECU, CLK_CON_GAT_CLK_BLK_G3DCORE_UID_RSTNSYNC_SR_CLK_G3D_ECU_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_G3DCORE_UID_RSTNSYNC_SR_CLK_G3D_ECU_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_G3DCORE_UID_RSTNSYNC_SR_CLK_G3D_ECU_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_GNPU_UID_LH_AXI_SI_D_DRAM_GNPU_DNC_IPCLKPORT_I_CLK, DIV_CLK_GNPU_NOC, CLK_CON_GAT_CLK_BLK_GNPU_UID_LH_AXI_SI_D_DRAM_GNPU_DNC_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_GNPU_UID_LH_AXI_SI_D_DRAM_GNPU_DNC_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_GNPU_UID_LH_AXI_SI_D_DRAM_GNPU_DNC_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_GNPU_UID_LH_AXI_SI_D_CTRL_GNPU_DNC_IPCLKPORT_I_CLK, DIV_CLK_GNPU_NOC, CLK_CON_GAT_CLK_BLK_GNPU_UID_LH_AXI_SI_D_CTRL_GNPU_DNC_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_GNPU_UID_LH_AXI_SI_D_CTRL_GNPU_DNC_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_GNPU_UID_LH_AXI_SI_D_CTRL_GNPU_DNC_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_GNPU_UID_SLH_AXI_MI_P_DNC_GNPU_IPCLKPORT_I_CLK, DIV_CLK_GNPU_NOCP, CLK_CON_GAT_CLK_BLK_GNPU_UID_SLH_AXI_MI_P_DNC_GNPU_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_GNPU_UID_SLH_AXI_MI_P_DNC_GNPU_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_GNPU_UID_SLH_AXI_MI_P_DNC_GNPU_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_GNPU_UID_LH_AXI_MI_D_CTRL_DNC_GNPU_IPCLKPORT_I_CLK, DIV_CLK_GNPU_NOC, CLK_CON_GAT_CLK_BLK_GNPU_UID_LH_AXI_MI_D_CTRL_DNC_GNPU_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_GNPU_UID_LH_AXI_MI_D_CTRL_DNC_GNPU_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_GNPU_UID_LH_AXI_MI_D_CTRL_DNC_GNPU_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_GNPU_UID_LH_AST_SI_D_SRAM_RDREQ0_GNPU_SDMA_IPCLKPORT_I_CLK, DIV_CLK_GNPU_NOC, CLK_CON_GAT_CLK_BLK_GNPU_UID_LH_AST_SI_D_SRAM_RDREQ0_GNPU_SDMA_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_GNPU_UID_LH_AST_SI_D_SRAM_RDREQ0_GNPU_SDMA_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_GNPU_UID_LH_AST_SI_D_SRAM_RDREQ0_GNPU_SDMA_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_GNPU_UID_LH_AST_SI_D_SRAM_RDREQ1_GNPU_SDMA_IPCLKPORT_I_CLK, DIV_CLK_GNPU_NOC, CLK_CON_GAT_CLK_BLK_GNPU_UID_LH_AST_SI_D_SRAM_RDREQ1_GNPU_SDMA_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_GNPU_UID_LH_AST_SI_D_SRAM_RDREQ1_GNPU_SDMA_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_GNPU_UID_LH_AST_SI_D_SRAM_RDREQ1_GNPU_SDMA_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_GNPU_UID_LH_AST_SI_D_SRAM_RDREQ2_GNPU_SDMA_IPCLKPORT_I_CLK, DIV_CLK_GNPU_NOC, CLK_CON_GAT_CLK_BLK_GNPU_UID_LH_AST_SI_D_SRAM_RDREQ2_GNPU_SDMA_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_GNPU_UID_LH_AST_SI_D_SRAM_RDREQ2_GNPU_SDMA_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_GNPU_UID_LH_AST_SI_D_SRAM_RDREQ2_GNPU_SDMA_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_GNPU_UID_LH_AST_SI_D_SRAM_WR0_GNPU_SDMA_IPCLKPORT_I_CLK, DIV_CLK_GNPU_NOC, CLK_CON_GAT_CLK_BLK_GNPU_UID_LH_AST_SI_D_SRAM_WR0_GNPU_SDMA_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_GNPU_UID_LH_AST_SI_D_SRAM_WR0_GNPU_SDMA_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_GNPU_UID_LH_AST_SI_D_SRAM_WR0_GNPU_SDMA_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_GNPU_UID_LH_AST_SI_D_SRAM_WR1_GNPU_SDMA_IPCLKPORT_I_CLK, DIV_CLK_GNPU_NOC, CLK_CON_GAT_CLK_BLK_GNPU_UID_LH_AST_SI_D_SRAM_WR1_GNPU_SDMA_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_GNPU_UID_LH_AST_SI_D_SRAM_WR1_GNPU_SDMA_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_GNPU_UID_LH_AST_SI_D_SRAM_WR1_GNPU_SDMA_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_GNPU_UID_LH_AST_SI_D_SRAM_WR2_GNPU_SDMA_IPCLKPORT_I_CLK, DIV_CLK_GNPU_NOC, CLK_CON_GAT_CLK_BLK_GNPU_UID_LH_AST_SI_D_SRAM_WR2_GNPU_SDMA_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_GNPU_UID_LH_AST_SI_D_SRAM_WR2_GNPU_SDMA_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_GNPU_UID_LH_AST_SI_D_SRAM_WR2_GNPU_SDMA_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_GNPU_UID_LH_AST_MI_D_SRAM_CSTFIFO_SDMA_GNPU_IPCLKPORT_I_CLK, DIV_CLK_GNPU_NOC, CLK_CON_GAT_CLK_BLK_GNPU_UID_LH_AST_MI_D_SRAM_CSTFIFO_SDMA_GNPU_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_GNPU_UID_LH_AST_MI_D_SRAM_CSTFIFO_SDMA_GNPU_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_GNPU_UID_LH_AST_MI_D_SRAM_CSTFIFO_SDMA_GNPU_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_GNPU_UID_LH_AST_MI_D_SRAM_RDRSP0_SDMA_GNPU_IPCLKPORT_I_CLK, DIV_CLK_GNPU_NOC, CLK_CON_GAT_CLK_BLK_GNPU_UID_LH_AST_MI_D_SRAM_RDRSP0_SDMA_GNPU_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_GNPU_UID_LH_AST_MI_D_SRAM_RDRSP0_SDMA_GNPU_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_GNPU_UID_LH_AST_MI_D_SRAM_RDRSP0_SDMA_GNPU_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_GNPU_UID_LH_AST_MI_D_SRAM_RDRSP1_SDMA_GNPU_IPCLKPORT_I_CLK, DIV_CLK_GNPU_NOC, CLK_CON_GAT_CLK_BLK_GNPU_UID_LH_AST_MI_D_SRAM_RDRSP1_SDMA_GNPU_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_GNPU_UID_LH_AST_MI_D_SRAM_RDRSP1_SDMA_GNPU_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_GNPU_UID_LH_AST_MI_D_SRAM_RDRSP1_SDMA_GNPU_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_GNPU_UID_LH_AST_MI_D_SRAM_RDRSP2_SDMA_GNPU_IPCLKPORT_I_CLK, DIV_CLK_GNPU_NOC, CLK_CON_GAT_CLK_BLK_GNPU_UID_LH_AST_MI_D_SRAM_RDRSP2_SDMA_GNPU_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_GNPU_UID_LH_AST_MI_D_SRAM_RDRSP2_SDMA_GNPU_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_GNPU_UID_LH_AST_MI_D_SRAM_RDRSP2_SDMA_GNPU_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_GNPU_UID_LH_AST_SI_D_SRAM_RDREQ3_GNPU_SDMA_IPCLKPORT_I_CLK, DIV_CLK_GNPU_NOC, CLK_CON_GAT_CLK_BLK_GNPU_UID_LH_AST_SI_D_SRAM_RDREQ3_GNPU_SDMA_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_GNPU_UID_LH_AST_SI_D_SRAM_RDREQ3_GNPU_SDMA_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_GNPU_UID_LH_AST_SI_D_SRAM_RDREQ3_GNPU_SDMA_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_GNPU_UID_LH_AST_SI_D_SRAM_RDREQ4_GNPU_SDMA_IPCLKPORT_I_CLK, DIV_CLK_GNPU_NOC, CLK_CON_GAT_CLK_BLK_GNPU_UID_LH_AST_SI_D_SRAM_RDREQ4_GNPU_SDMA_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_GNPU_UID_LH_AST_SI_D_SRAM_RDREQ4_GNPU_SDMA_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_GNPU_UID_LH_AST_SI_D_SRAM_RDREQ4_GNPU_SDMA_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_GNPU_UID_LH_AST_SI_D_SRAM_RDREQ5_GNPU_SDMA_IPCLKPORT_I_CLK, DIV_CLK_GNPU_NOC, CLK_CON_GAT_CLK_BLK_GNPU_UID_LH_AST_SI_D_SRAM_RDREQ5_GNPU_SDMA_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_GNPU_UID_LH_AST_SI_D_SRAM_RDREQ5_GNPU_SDMA_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_GNPU_UID_LH_AST_SI_D_SRAM_RDREQ5_GNPU_SDMA_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_GNPU_UID_IP_NPUCORE_IPCLKPORT_CLK_XMAA1, DIV_CLK_GNPU_XMAA, CLK_CON_GAT_CLK_BLK_GNPU_UID_IP_NPUCORE_IPCLKPORT_CLK_XMAA1_CG_VAL, CLK_CON_GAT_CLK_BLK_GNPU_UID_IP_NPUCORE_IPCLKPORT_CLK_XMAA1_MANUAL, CLK_CON_GAT_CLK_BLK_GNPU_UID_IP_NPUCORE_IPCLKPORT_CLK_XMAA1_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_GNPU_UID_IP_NPUCORE_IPCLKPORT_CLK_XMAA0, DIV_CLK_GNPU_XMAA, CLK_CON_GAT_CLK_BLK_GNPU_UID_IP_NPUCORE_IPCLKPORT_CLK_XMAA0_CG_VAL, CLK_CON_GAT_CLK_BLK_GNPU_UID_IP_NPUCORE_IPCLKPORT_CLK_XMAA0_MANUAL, CLK_CON_GAT_CLK_BLK_GNPU_UID_IP_NPUCORE_IPCLKPORT_CLK_XMAA0_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_GNPU_UID_LH_AST_MI_D_SRAM_RDRSP3_SDMA_GNPU_IPCLKPORT_I_CLK, DIV_CLK_GNPU_NOC, CLK_CON_GAT_CLK_BLK_GNPU_UID_LH_AST_MI_D_SRAM_RDRSP3_SDMA_GNPU_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_GNPU_UID_LH_AST_MI_D_SRAM_RDRSP3_SDMA_GNPU_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_GNPU_UID_LH_AST_MI_D_SRAM_RDRSP3_SDMA_GNPU_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_GNPU_UID_LH_AST_MI_D_SRAM_RDRSP4_SDMA_GNPU_IPCLKPORT_I_CLK, DIV_CLK_GNPU_NOC, CLK_CON_GAT_CLK_BLK_GNPU_UID_LH_AST_MI_D_SRAM_RDRSP4_SDMA_GNPU_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_GNPU_UID_LH_AST_MI_D_SRAM_RDRSP4_SDMA_GNPU_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_GNPU_UID_LH_AST_MI_D_SRAM_RDRSP4_SDMA_GNPU_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_GNPU_UID_LH_AST_MI_D_SRAM_RDRSP5_SDMA_GNPU_IPCLKPORT_I_CLK, DIV_CLK_GNPU_NOC, CLK_CON_GAT_CLK_BLK_GNPU_UID_LH_AST_MI_D_SRAM_RDRSP5_SDMA_GNPU_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_GNPU_UID_LH_AST_MI_D_SRAM_RDRSP5_SDMA_GNPU_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_GNPU_UID_LH_AST_MI_D_SRAM_RDRSP5_SDMA_GNPU_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_GNPU_UID_HTU_GNPU_IPCLKPORT_I_PCLK, DIV_CLK_GNPU_NOCP, CLK_CON_GAT_CLK_BLK_GNPU_UID_HTU_GNPU_IPCLKPORT_I_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_GNPU_UID_HTU_GNPU_IPCLKPORT_I_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_GNPU_UID_HTU_GNPU_IPCLKPORT_I_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_GNPU_UID_HTU_GNPU_IPCLKPORT_I_CLK, MUX_CLK_GNPU_NOC, CLK_CON_GAT_CLK_BLK_GNPU_UID_HTU_GNPU_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_GNPU_UID_HTU_GNPU_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_GNPU_UID_HTU_GNPU_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_GNPU_UID_RSTNSYNC_SR_CLK_GNPU_POWERIP_IPCLKPORT_CLK, MUX_CLK_GNPU_NOC, CLK_CON_GAT_CLK_BLK_GNPU_UID_RSTNSYNC_SR_CLK_GNPU_POWERIP_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_GNPU_UID_RSTNSYNC_SR_CLK_GNPU_POWERIP_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_GNPU_UID_RSTNSYNC_SR_CLK_GNPU_POWERIP_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_GNPU_UID_RSTNSYNC_SR_CLK_GNPU_FREE_OSCCLK_IPCLKPORT_CLK, FREE_OSCCLK_GNPU, CLK_CON_GAT_CLK_BLK_GNPU_UID_RSTNSYNC_SR_CLK_GNPU_FREE_OSCCLK_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_GNPU_UID_RSTNSYNC_SR_CLK_GNPU_FREE_OSCCLK_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_GNPU_UID_RSTNSYNC_SR_CLK_GNPU_FREE_OSCCLK_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_GNPU_UID_RSTNSYNC_CLK_GNPU_FREE_OSCCLK_IPCLKPORT_CLK, FREE_OSCCLK_GNPU, CLK_CON_GAT_CLK_BLK_GNPU_UID_RSTNSYNC_CLK_GNPU_FREE_OSCCLK_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_GNPU_UID_RSTNSYNC_CLK_GNPU_FREE_OSCCLK_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_GNPU_UID_RSTNSYNC_CLK_GNPU_FREE_OSCCLK_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_HSI0_UID_SLH_AXI_SI_D_HSI0AUD_IPCLKPORT_I_CLK, MUX_CLK_HSI0_NOC, CLK_CON_GAT_CLK_BLK_HSI0_UID_SLH_AXI_SI_D_HSI0AUD_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_HSI0_UID_SLH_AXI_SI_D_HSI0AUD_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_HSI0_UID_SLH_AXI_SI_D_HSI0AUD_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_HSI0_UID_S2MPU_HSI0_S0_IPCLKPORT_CLK, MUX_CLK_HSI0_NOC, CLK_CON_GAT_CLK_BLK_HSI0_UID_S2MPU_HSI0_S0_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_HSI0_UID_S2MPU_HSI0_S0_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_HSI0_UID_S2MPU_HSI0_S0_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_HSI0_UID_SLH_AXI_MI_D_AUDHSI0_IPCLKPORT_I_CLK, MUX_CLK_HSI0_NOC, CLK_CON_GAT_CLK_BLK_HSI0_UID_SLH_AXI_MI_D_AUDHSI0_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_HSI0_UID_SLH_AXI_MI_D_AUDHSI0_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_HSI0_UID_SLH_AXI_MI_D_AUDHSI0_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_HSI0_UID_S2MPU_HSI0_S0_PMMU0_IPCLKPORT_CLK, MUX_CLK_HSI0_NOC, CLK_CON_GAT_CLK_BLK_HSI0_UID_S2MPU_HSI0_S0_PMMU0_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_HSI0_UID_S2MPU_HSI0_S0_PMMU0_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_HSI0_UID_S2MPU_HSI0_S0_PMMU0_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_HSI0_UID_ECU_HSI0_IPCLKPORT_PCLK, MUX_CLK_HSI0_NOC, CLK_CON_GAT_CLK_BLK_HSI0_UID_ECU_HSI0_IPCLKPORT_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_HSI0_UID_ECU_HSI0_IPCLKPORT_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_HSI0_UID_ECU_HSI0_IPCLKPORT_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_HSI0_UID_S2PC_HSI0_IPCLKPORT_PCLK, MUX_CLK_HSI0_NOC, CLK_CON_GAT_CLK_BLK_HSI0_UID_S2PC_HSI0_IPCLKPORT_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_HSI0_UID_S2PC_HSI0_IPCLKPORT_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_HSI0_UID_S2PC_HSI0_IPCLKPORT_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_HSI0_UID_ECU_HSI0_IPCLKPORT_CLK, DIV_CLK_HSI0_ECU, CLK_CON_GAT_CLK_BLK_HSI0_UID_ECU_HSI0_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_HSI0_UID_ECU_HSI0_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_HSI0_UID_ECU_HSI0_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_HSI0_UID_RSTNSYNC_SR_CLK_HSI0_ECU_IPCLKPORT_CLK, DIV_CLK_HSI0_ECU, CLK_CON_GAT_CLK_BLK_HSI0_UID_RSTNSYNC_SR_CLK_HSI0_ECU_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_HSI0_UID_RSTNSYNC_SR_CLK_HSI0_ECU_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_HSI0_UID_RSTNSYNC_SR_CLK_HSI0_ECU_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_HSI1_UID_PCIE_GEN3_1L_IPCLKPORT_PCIE_SUB_CTRL_A_G3X1_PHY_REFCLK_IN, MUX_CLKCMU_HSI1_PCIE_USER, CLK_CON_GAT_CLK_BLK_HSI1_UID_PCIE_GEN3_1L_IPCLKPORT_PCIE_SUB_CTRL_A_G3X1_PHY_REFCLK_IN_CG_VAL, CLK_CON_GAT_CLK_BLK_HSI1_UID_PCIE_GEN3_1L_IPCLKPORT_PCIE_SUB_CTRL_A_G3X1_PHY_REFCLK_IN_MANUAL, CLK_CON_GAT_CLK_BLK_HSI1_UID_PCIE_GEN3_1L_IPCLKPORT_PCIE_SUB_CTRL_A_G3X1_PHY_REFCLK_IN_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_HSI1_UID_PCIE_GEN3_1L_IPCLKPORT_PCIE_QUADRA_G3X1_DWC_PCIE_CTL_INST_0_DBI_ACLK_UG, MUX_CLKCMU_HSI1_NOC_USER, CLK_CON_GAT_CLK_BLK_HSI1_UID_PCIE_GEN3_1L_IPCLKPORT_PCIE_QUADRA_G3X1_DWC_PCIE_CTL_INST_0_DBI_ACLK_UG_CG_VAL, CLK_CON_GAT_CLK_BLK_HSI1_UID_PCIE_GEN3_1L_IPCLKPORT_PCIE_QUADRA_G3X1_DWC_PCIE_CTL_INST_0_DBI_ACLK_UG_MANUAL, CLK_CON_GAT_CLK_BLK_HSI1_UID_PCIE_GEN3_1L_IPCLKPORT_PCIE_QUADRA_G3X1_DWC_PCIE_CTL_INST_0_DBI_ACLK_UG_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_HSI1_UID_PCIE_GEN3_1L_IPCLKPORT_PCIE_PHY_TOP_X1_INST_0_PIPE_PAL_PCIE_X1_INST_0_I_APB_PCLK, MUX_CLKCMU_HSI1_NOC_USER, CLK_CON_GAT_CLK_BLK_HSI1_UID_PCIE_GEN3_1L_IPCLKPORT_PCIE_PHY_TOP_X1_INST_0_PIPE_PAL_PCIE_X1_INST_0_I_APB_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_HSI1_UID_PCIE_GEN3_1L_IPCLKPORT_PCIE_PHY_TOP_X1_INST_0_PIPE_PAL_PCIE_X1_INST_0_I_APB_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_HSI1_UID_PCIE_GEN3_1L_IPCLKPORT_PCIE_PHY_TOP_X1_INST_0_PIPE_PAL_PCIE_X1_INST_0_I_APB_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_HSI1_UID_PCIE_GEN3_1L_IPCLKPORT_PCIE_003_PCIE_SUB_CTRL_G3X1_INST_0_I_DRIVER_APB_CLK, MUX_CLKCMU_HSI1_NOC_USER, CLK_CON_GAT_CLK_BLK_HSI1_UID_PCIE_GEN3_1L_IPCLKPORT_PCIE_003_PCIE_SUB_CTRL_G3X1_INST_0_I_DRIVER_APB_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_HSI1_UID_PCIE_GEN3_1L_IPCLKPORT_PCIE_003_PCIE_SUB_CTRL_G3X1_INST_0_I_DRIVER_APB_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_HSI1_UID_PCIE_GEN3_1L_IPCLKPORT_PCIE_003_PCIE_SUB_CTRL_G3X1_INST_0_I_DRIVER_APB_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_HSI1_UID_PCIE_GEN3_1L_IPCLKPORT_PCIE_QUADRA_G3X1_DWC_PCIE_CTL_INST_0_MSTR_ACLK_UG, MUX_CLKCMU_HSI1_NOC_USER, CLK_CON_GAT_CLK_BLK_HSI1_UID_PCIE_GEN3_1L_IPCLKPORT_PCIE_QUADRA_G3X1_DWC_PCIE_CTL_INST_0_MSTR_ACLK_UG_CG_VAL, CLK_CON_GAT_CLK_BLK_HSI1_UID_PCIE_GEN3_1L_IPCLKPORT_PCIE_QUADRA_G3X1_DWC_PCIE_CTL_INST_0_MSTR_ACLK_UG_MANUAL, CLK_CON_GAT_CLK_BLK_HSI1_UID_PCIE_GEN3_1L_IPCLKPORT_PCIE_QUADRA_G3X1_DWC_PCIE_CTL_INST_0_MSTR_ACLK_UG_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_HSI1_UID_PCIE_GEN3_2L_IPCLKPORT_PCIE_PAMIR_G3X2_DWC_PCIE_CTL_INST_0_DBI_ACLK_UG, MUX_CLKCMU_HSI1_NOC_USER, CLK_CON_GAT_CLK_BLK_HSI1_UID_PCIE_GEN3_2L_IPCLKPORT_PCIE_PAMIR_G3X2_DWC_PCIE_CTL_INST_0_DBI_ACLK_UG_CG_VAL, CLK_CON_GAT_CLK_BLK_HSI1_UID_PCIE_GEN3_2L_IPCLKPORT_PCIE_PAMIR_G3X2_DWC_PCIE_CTL_INST_0_DBI_ACLK_UG_MANUAL, CLK_CON_GAT_CLK_BLK_HSI1_UID_PCIE_GEN3_2L_IPCLKPORT_PCIE_PAMIR_G3X2_DWC_PCIE_CTL_INST_0_DBI_ACLK_UG_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_HSI1_UID_PCIE_GEN3_2L_IPCLKPORT_PCIE_PAMIR_G3X2_DWC_PCIE_CTL_INST_0_MSTR_ACLK_UG, MUX_CLKCMU_HSI1_NOC_USER, CLK_CON_GAT_CLK_BLK_HSI1_UID_PCIE_GEN3_2L_IPCLKPORT_PCIE_PAMIR_G3X2_DWC_PCIE_CTL_INST_0_MSTR_ACLK_UG_CG_VAL, CLK_CON_GAT_CLK_BLK_HSI1_UID_PCIE_GEN3_2L_IPCLKPORT_PCIE_PAMIR_G3X2_DWC_PCIE_CTL_INST_0_MSTR_ACLK_UG_MANUAL, CLK_CON_GAT_CLK_BLK_HSI1_UID_PCIE_GEN3_2L_IPCLKPORT_PCIE_PAMIR_G3X2_DWC_PCIE_CTL_INST_0_MSTR_ACLK_UG_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_HSI1_UID_PCIE_GEN3_2L_IPCLKPORT_PCIE_PAMIR_G3X2_DWC_PCIE_CTL_INST_0_SLV_ACLK_UG, MUX_CLKCMU_HSI1_NOC_USER, CLK_CON_GAT_CLK_BLK_HSI1_UID_PCIE_GEN3_2L_IPCLKPORT_PCIE_PAMIR_G3X2_DWC_PCIE_CTL_INST_0_SLV_ACLK_UG_CG_VAL, CLK_CON_GAT_CLK_BLK_HSI1_UID_PCIE_GEN3_2L_IPCLKPORT_PCIE_PAMIR_G3X2_DWC_PCIE_CTL_INST_0_SLV_ACLK_UG_MANUAL, CLK_CON_GAT_CLK_BLK_HSI1_UID_PCIE_GEN3_2L_IPCLKPORT_PCIE_PAMIR_G3X2_DWC_PCIE_CTL_INST_0_SLV_ACLK_UG_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_HSI1_UID_PCIE_GEN3_2L_IPCLKPORT_PCIE_003_PCIE_SUB_CTRL_INST_0_I_DRIVER_APB_CLK, MUX_CLKCMU_HSI1_NOC_USER, CLK_CON_GAT_CLK_BLK_HSI1_UID_PCIE_GEN3_2L_IPCLKPORT_PCIE_003_PCIE_SUB_CTRL_INST_0_I_DRIVER_APB_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_HSI1_UID_PCIE_GEN3_2L_IPCLKPORT_PCIE_003_PCIE_SUB_CTRL_INST_0_I_DRIVER_APB_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_HSI1_UID_PCIE_GEN3_2L_IPCLKPORT_PCIE_003_PCIE_SUB_CTRL_INST_0_I_DRIVER_APB_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_HSI1_UID_PCIE_GEN3_2L_IPCLKPORT_PCIE_PHY_TOP_INST_0_PHY_UDBG_I_APB_PCLK, MUX_CLKCMU_HSI1_NOC_USER, CLK_CON_GAT_CLK_BLK_HSI1_UID_PCIE_GEN3_2L_IPCLKPORT_PCIE_PHY_TOP_INST_0_PHY_UDBG_I_APB_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_HSI1_UID_PCIE_GEN3_2L_IPCLKPORT_PCIE_PHY_TOP_INST_0_PHY_UDBG_I_APB_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_HSI1_UID_PCIE_GEN3_2L_IPCLKPORT_PCIE_PHY_TOP_INST_0_PHY_UDBG_I_APB_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_HSI1_UID_PCIE_GEN3_2L_IPCLKPORT_PCIE_PHY_TOP_INST_0_PIPE_PAL_PCIE_INST_0_I_APB_PCLK, MUX_CLKCMU_HSI1_NOC_USER, CLK_CON_GAT_CLK_BLK_HSI1_UID_PCIE_GEN3_2L_IPCLKPORT_PCIE_PHY_TOP_INST_0_PIPE_PAL_PCIE_INST_0_I_APB_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_HSI1_UID_PCIE_GEN3_2L_IPCLKPORT_PCIE_PHY_TOP_INST_0_PIPE_PAL_PCIE_INST_0_I_APB_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_HSI1_UID_PCIE_GEN3_2L_IPCLKPORT_PCIE_PHY_TOP_INST_0_PIPE_PAL_PCIE_INST_0_I_APB_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_HSI1_UID_PCIE_IA__DEBUG_1_IPCLKPORT_I_CLK, MUX_CLKCMU_HSI1_NOC_USER, CLK_CON_GAT_CLK_BLK_HSI1_UID_PCIE_IA__DEBUG_1_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_HSI1_UID_PCIE_IA__DEBUG_1_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_HSI1_UID_PCIE_IA__DEBUG_1_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_HSI1_UID_SYSMMU_HSI1_S0_PMMU0_IPCLKPORT_CLK, MUX_CLKCMU_HSI1_NOC_USER, CLK_CON_GAT_CLK_BLK_HSI1_UID_SYSMMU_HSI1_S0_PMMU0_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_HSI1_UID_SYSMMU_HSI1_S0_PMMU0_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_HSI1_UID_SYSMMU_HSI1_S0_PMMU0_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_HSI1_UID_PCIE_IA__DEBUG_0_IPCLKPORT_I_CLK, MUX_CLKCMU_HSI1_NOC_USER, CLK_CON_GAT_CLK_BLK_HSI1_UID_PCIE_IA__DEBUG_0_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_HSI1_UID_PCIE_IA__DEBUG_0_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_HSI1_UID_PCIE_IA__DEBUG_0_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_HSI1_UID_PCIE_GEN3_1L_IPCLKPORT_PCIE_QUADRA_G3X1_DWC_PCIE_CTL_INST_0_SLV_ACLK_UG, MUX_CLKCMU_HSI1_NOC_USER, CLK_CON_GAT_CLK_BLK_HSI1_UID_PCIE_GEN3_1L_IPCLKPORT_PCIE_QUADRA_G3X1_DWC_PCIE_CTL_INST_0_SLV_ACLK_UG_CG_VAL, CLK_CON_GAT_CLK_BLK_HSI1_UID_PCIE_GEN3_1L_IPCLKPORT_PCIE_QUADRA_G3X1_DWC_PCIE_CTL_INST_0_SLV_ACLK_UG_MANUAL, CLK_CON_GAT_CLK_BLK_HSI1_UID_PCIE_GEN3_1L_IPCLKPORT_PCIE_QUADRA_G3X1_DWC_PCIE_CTL_INST_0_SLV_ACLK_UG_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_HSI1_UID_PCIE_GEN3_2L_IPCLKPORT_PCIE_SUB_CTRL_A_G3X2_PHY_REFCLK_IN, MUX_CLKCMU_HSI1_PCIE_USER, CLK_CON_GAT_CLK_BLK_HSI1_UID_PCIE_GEN3_2L_IPCLKPORT_PCIE_SUB_CTRL_A_G3X2_PHY_REFCLK_IN_CG_VAL, CLK_CON_GAT_CLK_BLK_HSI1_UID_PCIE_GEN3_2L_IPCLKPORT_PCIE_SUB_CTRL_A_G3X2_PHY_REFCLK_IN_MANUAL, CLK_CON_GAT_CLK_BLK_HSI1_UID_PCIE_GEN3_2L_IPCLKPORT_PCIE_SUB_CTRL_A_G3X2_PHY_REFCLK_IN_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_HSI1_UID_PCIE_GEN3_1L_IPCLKPORT_PCIE_PHY_TOP_X1_INST_0_SF_PCIEPHY_X1_QCH_TM_WRAPPER_INST_0_I_APB_PCLK, MUX_CLKCMU_HSI1_NOC_USER, CLK_CON_GAT_CLK_BLK_HSI1_UID_PCIE_GEN3_1L_IPCLKPORT_PCIE_PHY_TOP_X1_INST_0_SF_PCIEPHY_X1_QCH_TM_WRAPPER_INST_0_I_APB_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_HSI1_UID_PCIE_GEN3_1L_IPCLKPORT_PCIE_PHY_TOP_X1_INST_0_SF_PCIEPHY_X1_QCH_TM_WRAPPER_INST_0_I_APB_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_HSI1_UID_PCIE_GEN3_1L_IPCLKPORT_PCIE_PHY_TOP_X1_INST_0_SF_PCIEPHY_X1_QCH_TM_WRAPPER_INST_0_I_APB_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_HSI1_UID_PCIE_GEN3_2L_IPCLKPORT_PCIE_SOC_CTRL_GEN3A_IPCLK, MUX_CLKCMU_HSI1_NOC_USER, CLK_CON_GAT_CLK_BLK_HSI1_UID_PCIE_GEN3_2L_IPCLKPORT_PCIE_SOC_CTRL_GEN3A_IPCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_HSI1_UID_PCIE_GEN3_2L_IPCLKPORT_PCIE_SOC_CTRL_GEN3A_IPCLK_MANUAL, CLK_CON_GAT_CLK_BLK_HSI1_UID_PCIE_GEN3_2L_IPCLKPORT_PCIE_SOC_CTRL_GEN3A_IPCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_HSI1_UID_PCIE_GEN3_1L_IPCLKPORT_PCIE_PHY_TOP_X1_INST_0_PHY_UDBG_I_APB_PCLK, MUX_CLKCMU_HSI1_NOC_USER, CLK_CON_GAT_CLK_BLK_HSI1_UID_PCIE_GEN3_1L_IPCLKPORT_PCIE_PHY_TOP_X1_INST_0_PHY_UDBG_I_APB_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_HSI1_UID_PCIE_GEN3_1L_IPCLKPORT_PCIE_PHY_TOP_X1_INST_0_PHY_UDBG_I_APB_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_HSI1_UID_PCIE_GEN3_1L_IPCLKPORT_PCIE_PHY_TOP_X1_INST_0_PHY_UDBG_I_APB_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_HSI1_UID_PCIE_GEN3_1L_IPCLKPORT_PCIE_SOC_CTRL_GEN3A_IPCLK, MUX_CLKCMU_HSI1_NOC_USER, CLK_CON_GAT_CLK_BLK_HSI1_UID_PCIE_GEN3_1L_IPCLKPORT_PCIE_SOC_CTRL_GEN3A_IPCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_HSI1_UID_PCIE_GEN3_1L_IPCLKPORT_PCIE_SOC_CTRL_GEN3A_IPCLK_MANUAL, CLK_CON_GAT_CLK_BLK_HSI1_UID_PCIE_GEN3_1L_IPCLKPORT_PCIE_SOC_CTRL_GEN3A_IPCLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_HSI1_UID_PCIE_GEN3_2L_IPCLKPORT_PCIE_PHY_TOP_INST_0_SF_PCIEPHY_X2_QCH_TM_WRAPPER_INST_0_I_APB_PCLK, MUX_CLKCMU_HSI1_NOC_USER, CLK_CON_GAT_CLK_BLK_HSI1_UID_PCIE_GEN3_2L_IPCLKPORT_PCIE_PHY_TOP_INST_0_SF_PCIEPHY_X2_QCH_TM_WRAPPER_INST_0_I_APB_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_HSI1_UID_PCIE_GEN3_2L_IPCLKPORT_PCIE_PHY_TOP_INST_0_SF_PCIEPHY_X2_QCH_TM_WRAPPER_INST_0_I_APB_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_HSI1_UID_PCIE_GEN3_2L_IPCLKPORT_PCIE_PHY_TOP_INST_0_SF_PCIEPHY_X2_QCH_TM_WRAPPER_INST_0_I_APB_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_HSI1_UID_PCIE_IA__DEBUG_2_IPCLKPORT_I_CLK, MUX_CLKCMU_HSI1_NOC_USER, CLK_CON_GAT_CLK_BLK_HSI1_UID_PCIE_IA__DEBUG_2_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_HSI1_UID_PCIE_IA__DEBUG_2_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_HSI1_UID_PCIE_IA__DEBUG_2_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_HSI1_UID_SYSMMU_HSI1_S0_IPCLKPORT_CLK, MUX_CLKCMU_HSI1_NOC_USER, CLK_CON_GAT_CLK_BLK_HSI1_UID_SYSMMU_HSI1_S0_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_HSI1_UID_SYSMMU_HSI1_S0_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_HSI1_UID_SYSMMU_HSI1_S0_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_HSI1_UID_XIU_MMU_HSI1_IPCLKPORT_ACLK, MUX_CLKCMU_HSI1_NOC_USER, CLK_CON_GAT_CLK_BLK_HSI1_UID_XIU_MMU_HSI1_IPCLKPORT_ACLK_CG_VAL, CLK_CON_GAT_CLK_BLK_HSI1_UID_XIU_MMU_HSI1_IPCLKPORT_ACLK_MANUAL, CLK_CON_GAT_CLK_BLK_HSI1_UID_XIU_MMU_HSI1_IPCLKPORT_ACLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_HSI1_UID_ECU_HSI1_IPCLKPORT_PCLK, MUX_CLKCMU_HSI1_NOC_USER, CLK_CON_GAT_CLK_BLK_HSI1_UID_ECU_HSI1_IPCLKPORT_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_HSI1_UID_ECU_HSI1_IPCLKPORT_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_HSI1_UID_ECU_HSI1_IPCLKPORT_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_HSI1_UID_ECU_HSI1_IPCLKPORT_CLK, DIV_CLK_HSI1_ECU, CLK_CON_GAT_CLK_BLK_HSI1_UID_ECU_HSI1_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_HSI1_UID_ECU_HSI1_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_HSI1_UID_ECU_HSI1_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_HSI1_UID_RSTNSYNC_SR_CLK_HSI1_ECU_IPCLKPORT_CLK, DIV_CLK_HSI1_ECU, CLK_CON_GAT_CLK_BLK_HSI1_UID_RSTNSYNC_SR_CLK_HSI1_ECU_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_HSI1_UID_RSTNSYNC_SR_CLK_HSI1_ECU_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_HSI1_UID_RSTNSYNC_SR_CLK_HSI1_ECU_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_ICPU_UID_ICPU_CMU_ICPU_IPCLKPORT_PCLK, DIV_CLK_ICPU_NOCP, CLK_CON_GAT_CLK_BLK_ICPU_UID_ICPU_CMU_ICPU_IPCLKPORT_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_ICPU_UID_ICPU_CMU_ICPU_IPCLKPORT_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_ICPU_UID_ICPU_CMU_ICPU_IPCLKPORT_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_ICPU_UID_SYSREG_ICPU_IPCLKPORT_PCLK, DIV_CLK_ICPU_NOCP, CLK_CON_GAT_CLK_BLK_ICPU_UID_SYSREG_ICPU_IPCLKPORT_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_ICPU_UID_SYSREG_ICPU_IPCLKPORT_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_ICPU_UID_SYSREG_ICPU_IPCLKPORT_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_ICPU_UID_D_TZPC_ICPU_IPCLKPORT_PCLK, DIV_CLK_ICPU_NOCP, CLK_CON_GAT_CLK_BLK_ICPU_UID_D_TZPC_ICPU_IPCLKPORT_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_ICPU_UID_D_TZPC_ICPU_IPCLKPORT_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_ICPU_UID_D_TZPC_ICPU_IPCLKPORT_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_ICPU_UID_PPMU_D_ICPU_IPCLKPORT_PCLK, DIV_CLK_ICPU_NOCP, CLK_CON_GAT_CLK_BLK_ICPU_UID_PPMU_D_ICPU_IPCLKPORT_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_ICPU_UID_PPMU_D_ICPU_IPCLKPORT_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_ICPU_UID_PPMU_D_ICPU_IPCLKPORT_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_ICPU_UID_BLK_ICPU_FRC_OTP_DESERIAL_IPCLKPORT_I_CLK, FREE_OSCCLK_ICPU, CLK_CON_GAT_CLK_BLK_ICPU_UID_BLK_ICPU_FRC_OTP_DESERIAL_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_ICPU_UID_BLK_ICPU_FRC_OTP_DESERIAL_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_ICPU_UID_BLK_ICPU_FRC_OTP_DESERIAL_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_ICPU_UID_SLH_AXI_MI_P_ICPU_IPCLKPORT_I_CLK, DIV_CLK_ICPU_NOCP, CLK_CON_GAT_CLK_BLK_ICPU_UID_SLH_AXI_MI_P_ICPU_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_ICPU_UID_SLH_AXI_MI_P_ICPU_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_ICPU_UID_SLH_AXI_MI_P_ICPU_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_ICPU_UID_ICPU_IPCLKPORT_CORE_CLK, MUX_CLKCMU_ICPU_NOC_0_USER, CLK_CON_GAT_CLK_BLK_ICPU_UID_ICPU_IPCLKPORT_CORE_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_ICPU_UID_ICPU_IPCLKPORT_CORE_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_ICPU_UID_ICPU_IPCLKPORT_CORE_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_ICPU_UID_RSTNSYNC_CLK_ICPU_NOCD_0_IPCLKPORT_CLK, MUX_CLKCMU_ICPU_NOC_0_USER, CLK_CON_GAT_CLK_BLK_ICPU_UID_RSTNSYNC_CLK_ICPU_NOCD_0_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_ICPU_UID_RSTNSYNC_CLK_ICPU_NOCD_0_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_ICPU_UID_RSTNSYNC_CLK_ICPU_NOCD_0_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_ICPU_UID_RSTNSYNC_CLK_ICPU_NOCP_IPCLKPORT_CLK, DIV_CLK_ICPU_NOCP, CLK_CON_GAT_CLK_BLK_ICPU_UID_RSTNSYNC_CLK_ICPU_NOCP_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_ICPU_UID_RSTNSYNC_CLK_ICPU_NOCP_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_ICPU_UID_RSTNSYNC_CLK_ICPU_NOCP_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_ICPU_UID_RSTNSYNC_SR_CLK_ICPU_NOCD_0_IPCLKPORT_CLK, MUX_CLKCMU_ICPU_NOC_0_USER, CLK_CON_GAT_CLK_BLK_ICPU_UID_RSTNSYNC_SR_CLK_ICPU_NOCD_0_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_ICPU_UID_RSTNSYNC_SR_CLK_ICPU_NOCD_0_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_ICPU_UID_RSTNSYNC_SR_CLK_ICPU_NOCD_0_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_ICPU_UID_RSTNSYNC_SR_CLK_ICPU_NOCP_IPCLKPORT_CLK, DIV_CLK_ICPU_NOCP, CLK_CON_GAT_CLK_BLK_ICPU_UID_RSTNSYNC_SR_CLK_ICPU_NOCP_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_ICPU_UID_RSTNSYNC_SR_CLK_ICPU_NOCP_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_ICPU_UID_RSTNSYNC_SR_CLK_ICPU_NOCP_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_ICPU_UID_LH_ACEL_SI_D_ICPU_IPCLKPORT_I_CLK, DIV_CLK_ICPU_NOCP, CLK_CON_GAT_CLK_BLK_ICPU_UID_LH_ACEL_SI_D_ICPU_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_ICPU_UID_LH_ACEL_SI_D_ICPU_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_ICPU_UID_LH_ACEL_SI_D_ICPU_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_ICPU_UID_LH_AXI_MI_ICPU1_INT_IPCLKPORT_I_CLK, DIV_CLK_ICPU_NOCP, CLK_CON_GAT_CLK_BLK_ICPU_UID_LH_AXI_MI_ICPU1_INT_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_ICPU_UID_LH_AXI_MI_ICPU1_INT_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_ICPU_UID_LH_AXI_MI_ICPU1_INT_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_ICPU_UID_LH_AXI_SI_ICPU0_INT_IPCLKPORT_I_CLK, DIV_CLK_ICPU_NOCP, CLK_CON_GAT_CLK_BLK_ICPU_UID_LH_AXI_SI_ICPU0_INT_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_ICPU_UID_LH_AXI_SI_ICPU0_INT_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_ICPU_UID_LH_AXI_SI_ICPU0_INT_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_ICPU_UID_PPMU_D_ICPU_IPCLKPORT_ACLK, DIV_CLK_ICPU_NOCP, CLK_CON_GAT_CLK_BLK_ICPU_UID_PPMU_D_ICPU_IPCLKPORT_ACLK_CG_VAL, CLK_CON_GAT_CLK_BLK_ICPU_UID_PPMU_D_ICPU_IPCLKPORT_ACLK_MANUAL, CLK_CON_GAT_CLK_BLK_ICPU_UID_PPMU_D_ICPU_IPCLKPORT_ACLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_ICPU_UID_SYSMMU_ICPU_S0_IPCLKPORT_CLK, DIV_CLK_ICPU_NOCP, CLK_CON_GAT_CLK_BLK_ICPU_UID_SYSMMU_ICPU_S0_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_ICPU_UID_SYSMMU_ICPU_S0_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_ICPU_UID_SYSMMU_ICPU_S0_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_ICPU_UID_SYSMMU_ICPU_S0_PMMU0_IPCLKPORT_CLK, DIV_CLK_ICPU_NOCP, CLK_CON_GAT_CLK_BLK_ICPU_UID_SYSMMU_ICPU_S0_PMMU0_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_ICPU_UID_SYSMMU_ICPU_S0_PMMU0_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_ICPU_UID_SYSMMU_ICPU_S0_PMMU0_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_ICPU_UID_XIU_MMU_ICPU_IPCLKPORT_ACLK, DIV_CLK_ICPU_NOCP, CLK_CON_GAT_CLK_BLK_ICPU_UID_XIU_MMU_ICPU_IPCLKPORT_ACLK_CG_VAL, CLK_CON_GAT_CLK_BLK_ICPU_UID_XIU_MMU_ICPU_IPCLKPORT_ACLK_MANUAL, CLK_CON_GAT_CLK_BLK_ICPU_UID_XIU_MMU_ICPU_IPCLKPORT_ACLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_ICPU_UID_VGEN_LITE_ICPU_IPCLKPORT_CLK, DIV_CLK_ICPU_NOCP, CLK_CON_GAT_CLK_BLK_ICPU_UID_VGEN_LITE_ICPU_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_ICPU_UID_VGEN_LITE_ICPU_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_ICPU_UID_VGEN_LITE_ICPU_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_ICPU_UID_ICPU_IPCLKPORT_PERI_CLK, MUX_CLKCMU_ICPU_NOC_1_USER, CLK_CON_GAT_CLK_BLK_ICPU_UID_ICPU_IPCLKPORT_PERI_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_ICPU_UID_ICPU_IPCLKPORT_PERI_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_ICPU_UID_ICPU_IPCLKPORT_PERI_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_ICPU_UID_LH_AXI_MI_ICPU0_INT_IPCLKPORT_I_CLK, MUX_CLKCMU_ICPU_NOC_1_USER, CLK_CON_GAT_CLK_BLK_ICPU_UID_LH_AXI_MI_ICPU0_INT_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_ICPU_UID_LH_AXI_MI_ICPU0_INT_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_ICPU_UID_LH_AXI_MI_ICPU0_INT_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_ICPU_UID_LH_AXI_SI_ICPU1_INT_IPCLKPORT_I_CLK, MUX_CLKCMU_ICPU_NOC_1_USER, CLK_CON_GAT_CLK_BLK_ICPU_UID_LH_AXI_SI_ICPU1_INT_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_ICPU_UID_LH_AXI_SI_ICPU1_INT_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_ICPU_UID_LH_AXI_SI_ICPU1_INT_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_ICPU_UID_RSTNSYNC_CLK_ICPU_NOCD_1_IPCLKPORT_CLK, MUX_CLKCMU_ICPU_NOC_1_USER, CLK_CON_GAT_CLK_BLK_ICPU_UID_RSTNSYNC_CLK_ICPU_NOCD_1_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_ICPU_UID_RSTNSYNC_CLK_ICPU_NOCD_1_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_ICPU_UID_RSTNSYNC_CLK_ICPU_NOCD_1_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_ICPU_UID_RSTNSYNC_SR_CLK_ICPU_NOCD_1_IPCLKPORT_CLK, MUX_CLKCMU_ICPU_NOC_1_USER, CLK_CON_GAT_CLK_BLK_ICPU_UID_RSTNSYNC_SR_CLK_ICPU_NOCD_1_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_ICPU_UID_RSTNSYNC_SR_CLK_ICPU_NOCD_1_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_ICPU_UID_RSTNSYNC_SR_CLK_ICPU_NOCD_1_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_ICPU_UID_SLH_AST_SI_G_PPMU_ICPU_IPCLKPORT_I_CLK, DIV_CLK_ICPU_NOCP, CLK_CON_GAT_CLK_BLK_ICPU_UID_SLH_AST_SI_G_PPMU_ICPU_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_ICPU_UID_SLH_AST_SI_G_PPMU_ICPU_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_ICPU_UID_SLH_AST_SI_G_PPMU_ICPU_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_ICPU_UID_RSTNSYNC_SR_CLK_ICPU_FREE_OSCCLK_IPCLKPORT_CLK, FREE_OSCCLK_ICPU, CLK_CON_GAT_CLK_BLK_ICPU_UID_RSTNSYNC_SR_CLK_ICPU_FREE_OSCCLK_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_ICPU_UID_RSTNSYNC_SR_CLK_ICPU_FREE_OSCCLK_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_ICPU_UID_RSTNSYNC_SR_CLK_ICPU_FREE_OSCCLK_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_ICPU_UID_ICPU_IPCLKPORT_CPU_SI_CLK, MUX_CLKCMU_ICPU_NOC_0_USER, CLK_CON_GAT_CLK_BLK_ICPU_UID_ICPU_IPCLKPORT_CPU_SI_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_ICPU_UID_ICPU_IPCLKPORT_CPU_SI_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_ICPU_UID_ICPU_IPCLKPORT_CPU_SI_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_ICPU_UID_ICPU_IPCLKPORT_PERI_MI_CLK, MUX_CLKCMU_ICPU_NOC_1_USER, CLK_CON_GAT_CLK_BLK_ICPU_UID_ICPU_IPCLKPORT_PERI_MI_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_ICPU_UID_ICPU_IPCLKPORT_PERI_MI_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_ICPU_UID_ICPU_IPCLKPORT_PERI_MI_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_ICPU_UID_ICPU_IPCLKPORT_DAP_CLK, DIV_CLK_ICPU_PCLKDBG, CLK_CON_GAT_CLK_BLK_ICPU_UID_ICPU_IPCLKPORT_DAP_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_ICPU_UID_ICPU_IPCLKPORT_DAP_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_ICPU_UID_ICPU_IPCLKPORT_DAP_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_ICPU_UID_RSTNSYNC_CLK_ICPU_FREE_OSCCLK_IPCLKPORT_CLK, FREE_OSCCLK_ICPU, CLK_CON_GAT_CLK_BLK_ICPU_UID_RSTNSYNC_CLK_ICPU_FREE_OSCCLK_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_ICPU_UID_RSTNSYNC_CLK_ICPU_FREE_OSCCLK_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_ICPU_UID_RSTNSYNC_CLK_ICPU_FREE_OSCCLK_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_ICPU_UID_RSTNSYNC_CLK_ICPU_PCLKDBG_IPCLKPORT_CLK, DIV_CLK_ICPU_PCLKDBG, CLK_CON_GAT_CLK_BLK_ICPU_UID_RSTNSYNC_CLK_ICPU_PCLKDBG_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_ICPU_UID_RSTNSYNC_CLK_ICPU_PCLKDBG_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_ICPU_UID_RSTNSYNC_CLK_ICPU_PCLKDBG_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_ICPU_UID_RSTNSYNC_CLK_ICPU_CPUPO_IPCLKPORT_CLK, MUX_CLKCMU_ICPU_NOC_0_USER, CLK_CON_GAT_CLK_BLK_ICPU_UID_RSTNSYNC_CLK_ICPU_CPUPO_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_ICPU_UID_RSTNSYNC_CLK_ICPU_CPUPO_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_ICPU_UID_RSTNSYNC_CLK_ICPU_CPUPO_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_ICPU_UID_RSTNSYNC_CLK_ICPU_CORE_IPCLKPORT_CLK, MUX_CLKCMU_ICPU_NOC_0_USER, CLK_CON_GAT_CLK_BLK_ICPU_UID_RSTNSYNC_CLK_ICPU_CORE_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_ICPU_UID_RSTNSYNC_CLK_ICPU_CORE_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_ICPU_UID_RSTNSYNC_CLK_ICPU_CORE_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_ICPU_UID_RSTNSYNC_CLK_ICPU_CPU_DBG_IPCLKPORT_CLK, MUX_CLKCMU_ICPU_NOC_0_USER, CLK_CON_GAT_CLK_BLK_ICPU_UID_RSTNSYNC_CLK_ICPU_CPU_DBG_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_ICPU_UID_RSTNSYNC_CLK_ICPU_CPU_DBG_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_ICPU_UID_RSTNSYNC_CLK_ICPU_CPU_DBG_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_LME_UID_LH_ACEL_SI_D0_LME_IPCLKPORT_I_CLK, MUX_CLKCMU_LME_NOC_USER, CLK_CON_GAT_CLK_BLK_LME_UID_LH_ACEL_SI_D0_LME_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_LME_UID_LH_ACEL_SI_D0_LME_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_LME_UID_LH_ACEL_SI_D0_LME_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_LME_UID_PPMU_D1_LME_IPCLKPORT_ACLK, MUX_CLKCMU_LME_NOC_USER, CLK_CON_GAT_CLK_BLK_LME_UID_PPMU_D1_LME_IPCLKPORT_ACLK_CG_VAL, CLK_CON_GAT_CLK_BLK_LME_UID_PPMU_D1_LME_IPCLKPORT_ACLK_MANUAL, CLK_CON_GAT_CLK_BLK_LME_UID_PPMU_D1_LME_IPCLKPORT_ACLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_LME_UID_PPMU_D1_LME_IPCLKPORT_PCLK, DIV_CLK_LME_NOCP, CLK_CON_GAT_CLK_BLK_LME_UID_PPMU_D1_LME_IPCLKPORT_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_LME_UID_PPMU_D1_LME_IPCLKPORT_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_LME_UID_PPMU_D1_LME_IPCLKPORT_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_LME_UID_LH_ACEL_SI_D1_LME_IPCLKPORT_I_CLK, MUX_CLKCMU_LME_NOC_USER, CLK_CON_GAT_CLK_BLK_LME_UID_LH_ACEL_SI_D1_LME_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_LME_UID_LH_ACEL_SI_D1_LME_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_LME_UID_LH_ACEL_SI_D1_LME_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_LME_UID_LH_AST_SI_OTF1_LMEMFC_IPCLKPORT_I_CLK, MUX_CLKCMU_LME_NOC_USER, CLK_CON_GAT_CLK_BLK_LME_UID_LH_AST_SI_OTF1_LMEMFC_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_LME_UID_LH_AST_SI_OTF1_LMEMFC_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_LME_UID_LH_AST_SI_OTF1_LMEMFC_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_LME_UID_LH_AST_SI_OTF0_LMEMFC_IPCLKPORT_I_CLK, MUX_CLKCMU_LME_NOC_USER, CLK_CON_GAT_CLK_BLK_LME_UID_LH_AST_SI_OTF0_LMEMFC_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_LME_UID_LH_AST_SI_OTF0_LMEMFC_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_LME_UID_LH_AST_SI_OTF0_LMEMFC_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_LME_UID_SIU_G_PPMU_LME_IPCLKPORT_I_ACLK, MUX_CLKCMU_LME_NOC_USER, CLK_CON_GAT_CLK_BLK_LME_UID_SIU_G_PPMU_LME_IPCLKPORT_I_ACLK_CG_VAL, CLK_CON_GAT_CLK_BLK_LME_UID_SIU_G_PPMU_LME_IPCLKPORT_I_ACLK_MANUAL, CLK_CON_GAT_CLK_BLK_LME_UID_SIU_G_PPMU_LME_IPCLKPORT_I_ACLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_LME_UID_VGEN_LITE_LME1_IPCLKPORT_CLK, MUX_CLKCMU_LME_NOC_USER, CLK_CON_GAT_CLK_BLK_LME_UID_VGEN_LITE_LME1_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_LME_UID_VGEN_LITE_LME1_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_LME_UID_VGEN_LITE_LME1_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_LME_UID_SYSMMU_LME_S0_IPCLKPORT_CLK, MUX_CLKCMU_LME_NOC_USER, CLK_CON_GAT_CLK_BLK_LME_UID_SYSMMU_LME_S0_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_LME_UID_SYSMMU_LME_S0_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_LME_UID_SYSMMU_LME_S0_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_LME_UID_SYSMMU_LME_S0_PMMU0_IPCLKPORT_CLK, MUX_CLKCMU_LME_NOC_USER, CLK_CON_GAT_CLK_BLK_LME_UID_SYSMMU_LME_S0_PMMU0_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_LME_UID_SYSMMU_LME_S0_PMMU0_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_LME_UID_SYSMMU_LME_S0_PMMU0_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_LME_UID_XIU_D1_LME_IPCLKPORT_ACLK, MUX_CLKCMU_LME_NOC_USER, CLK_CON_GAT_CLK_BLK_LME_UID_XIU_D1_LME_IPCLKPORT_ACLK_CG_VAL, CLK_CON_GAT_CLK_BLK_LME_UID_XIU_D1_LME_IPCLKPORT_ACLK_MANUAL, CLK_CON_GAT_CLK_BLK_LME_UID_XIU_D1_LME_IPCLKPORT_ACLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_LME_UID_XIU_MMU_LME_IPCLKPORT_ACLK, MUX_CLKCMU_LME_NOC_USER, CLK_CON_GAT_CLK_BLK_LME_UID_XIU_MMU_LME_IPCLKPORT_ACLK_CG_VAL, CLK_CON_GAT_CLK_BLK_LME_UID_XIU_MMU_LME_IPCLKPORT_ACLK_MANUAL, CLK_CON_GAT_CLK_BLK_LME_UID_XIU_MMU_LME_IPCLKPORT_ACLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_LME_UID_GDC1_IPCLKPORT_CLK, MUX_CLKCMU_LME_NOC_USER, CLK_CON_GAT_CLK_BLK_LME_UID_GDC1_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_LME_UID_GDC1_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_LME_UID_GDC1_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_LME_UID_GDC1_IPCLKPORT_C2CLK_M, MUX_CLKCMU_LME_NOC_USER, CLK_CON_GAT_CLK_BLK_LME_UID_GDC1_IPCLKPORT_C2CLK_M_CG_VAL, CLK_CON_GAT_CLK_BLK_LME_UID_GDC1_IPCLKPORT_C2CLK_M_MANUAL, CLK_CON_GAT_CLK_BLK_LME_UID_GDC1_IPCLKPORT_C2CLK_M_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_LME_UID_GDC1_IPCLKPORT_C2CLK_S, MUX_CLKCMU_LME_NOC_USER, CLK_CON_GAT_CLK_BLK_LME_UID_GDC1_IPCLKPORT_C2CLK_S_CG_VAL, CLK_CON_GAT_CLK_BLK_LME_UID_GDC1_IPCLKPORT_C2CLK_S_MANUAL, CLK_CON_GAT_CLK_BLK_LME_UID_GDC1_IPCLKPORT_C2CLK_S_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_LME_UID_PPMU_D2_LME_IPCLKPORT_ACLK, MUX_CLKCMU_LME_NOC_USER, CLK_CON_GAT_CLK_BLK_LME_UID_PPMU_D2_LME_IPCLKPORT_ACLK_CG_VAL, CLK_CON_GAT_CLK_BLK_LME_UID_PPMU_D2_LME_IPCLKPORT_ACLK_MANUAL, CLK_CON_GAT_CLK_BLK_LME_UID_PPMU_D2_LME_IPCLKPORT_ACLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_LME_UID_PPMU_D2_LME_IPCLKPORT_PCLK, DIV_CLK_LME_NOCP, CLK_CON_GAT_CLK_BLK_LME_UID_PPMU_D2_LME_IPCLKPORT_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_LME_UID_PPMU_D2_LME_IPCLKPORT_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_LME_UID_PPMU_D2_LME_IPCLKPORT_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_LME_UID_SYSMMU_LME_S0_PMMU1_IPCLKPORT_CLK, MUX_CLKCMU_LME_NOC_USER, CLK_CON_GAT_CLK_BLK_LME_UID_SYSMMU_LME_S0_PMMU1_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_LME_UID_SYSMMU_LME_S0_PMMU1_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_LME_UID_SYSMMU_LME_S0_PMMU1_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_LME_UID_LH_AXI_SI_D2_LME_IPCLKPORT_I_CLK, MUX_CLKCMU_LME_NOC_USER, CLK_CON_GAT_CLK_BLK_LME_UID_LH_AXI_SI_D2_LME_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_LME_UID_LH_AXI_SI_D2_LME_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_LME_UID_LH_AXI_SI_D2_LME_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_M2M_UID_SYSMMU_M2M_S0_IPCLKPORT_CLK, MUX_CLKCMU_M2M_NOC_USER, CLK_CON_GAT_CLK_BLK_M2M_UID_SYSMMU_M2M_S0_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_M2M_UID_SYSMMU_M2M_S0_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_M2M_UID_SYSMMU_M2M_S0_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_M2M_UID_XIU_D0_M2M_IPCLKPORT_ACLK, MUX_CLKCMU_M2M_NOC_USER, CLK_CON_GAT_CLK_BLK_M2M_UID_XIU_D0_M2M_IPCLKPORT_ACLK_CG_VAL, CLK_CON_GAT_CLK_BLK_M2M_UID_XIU_D0_M2M_IPCLKPORT_ACLK_MANUAL, CLK_CON_GAT_CLK_BLK_M2M_UID_XIU_D0_M2M_IPCLKPORT_ACLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_M2M_UID_XIU_MMU0_M2M_IPCLKPORT_ACLK, MUX_CLKCMU_M2M_NOC_USER, CLK_CON_GAT_CLK_BLK_M2M_UID_XIU_MMU0_M2M_IPCLKPORT_ACLK_CG_VAL, CLK_CON_GAT_CLK_BLK_M2M_UID_XIU_MMU0_M2M_IPCLKPORT_ACLK_MANUAL, CLK_CON_GAT_CLK_BLK_M2M_UID_XIU_MMU0_M2M_IPCLKPORT_ACLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_M2M_UID_SYSMMU_M2M_S0_PMMU0_IPCLKPORT_CLK, MUX_CLKCMU_M2M_NOC_USER, CLK_CON_GAT_CLK_BLK_M2M_UID_SYSMMU_M2M_S0_PMMU0_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_M2M_UID_SYSMMU_M2M_S0_PMMU0_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_M2M_UID_SYSMMU_M2M_S0_PMMU0_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_M2M_UID_AS_APB_JPEG0_IPCLKPORT_PCLKM, MUX_CLKCMU_M2M_JPEG_USER, CLK_CON_GAT_CLK_BLK_M2M_UID_AS_APB_JPEG0_IPCLKPORT_PCLKM_CG_VAL, CLK_CON_GAT_CLK_BLK_M2M_UID_AS_APB_JPEG0_IPCLKPORT_PCLKM_MANUAL, CLK_CON_GAT_CLK_BLK_M2M_UID_AS_APB_JPEG0_IPCLKPORT_PCLKM_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_M2M_UID_LH_AXI_SI_JPEG0_INT_IPCLKPORT_I_CLK, MUX_CLKCMU_M2M_JPEG_USER, CLK_CON_GAT_CLK_BLK_M2M_UID_LH_AXI_SI_JPEG0_INT_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_M2M_UID_LH_AXI_SI_JPEG0_INT_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_M2M_UID_LH_AXI_SI_JPEG0_INT_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_M2M_UID_LH_AXI_MI_JPEG0_INT_IPCLKPORT_I_CLK, MUX_CLKCMU_M2M_NOC_USER, CLK_CON_GAT_CLK_BLK_M2M_UID_LH_AXI_MI_JPEG0_INT_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_M2M_UID_LH_AXI_MI_JPEG0_INT_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_M2M_UID_LH_AXI_MI_JPEG0_INT_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_M2M_UID_LH_AXI_SI_JPEG1_INT_IPCLKPORT_I_CLK, MUX_CLKCMU_M2M_JPEG_USER, CLK_CON_GAT_CLK_BLK_M2M_UID_LH_AXI_SI_JPEG1_INT_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_M2M_UID_LH_AXI_SI_JPEG1_INT_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_M2M_UID_LH_AXI_SI_JPEG1_INT_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_M2M_UID_LH_AXI_MI_JPEG1_INT_IPCLKPORT_I_CLK, MUX_CLKCMU_M2M_NOC_USER, CLK_CON_GAT_CLK_BLK_M2M_UID_LH_AXI_MI_JPEG1_INT_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_M2M_UID_LH_AXI_MI_JPEG1_INT_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_M2M_UID_LH_AXI_MI_JPEG1_INT_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_M2M_UID_JPEG0_IPCLKPORT_I_SMFC_CLK, MUX_CLKCMU_M2M_JPEG_USER, CLK_CON_GAT_CLK_BLK_M2M_UID_JPEG0_IPCLKPORT_I_SMFC_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_M2M_UID_JPEG0_IPCLKPORT_I_SMFC_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_M2M_UID_JPEG0_IPCLKPORT_I_SMFC_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_M2M_UID_JPEG1_IPCLKPORT_I_SMFC_CLK, MUX_CLKCMU_M2M_JPEG_USER, CLK_CON_GAT_CLK_BLK_M2M_UID_JPEG1_IPCLKPORT_I_SMFC_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_M2M_UID_JPEG1_IPCLKPORT_I_SMFC_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_M2M_UID_JPEG1_IPCLKPORT_I_SMFC_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_M2M_UID_RSTNSYNC_CLK_M2M_JPEG_IPCLKPORT_CLK, MUX_CLKCMU_M2M_JPEG_USER, CLK_CON_GAT_CLK_BLK_M2M_UID_RSTNSYNC_CLK_M2M_JPEG_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_M2M_UID_RSTNSYNC_CLK_M2M_JPEG_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_M2M_UID_RSTNSYNC_CLK_M2M_JPEG_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_M2M_UID_RSTNSYNC_SR_CLK_M2M_JPEG_IPCLKPORT_CLK, MUX_CLKCMU_M2M_JPEG_USER, CLK_CON_GAT_CLK_BLK_M2M_UID_RSTNSYNC_SR_CLK_M2M_JPEG_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_M2M_UID_RSTNSYNC_SR_CLK_M2M_JPEG_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_M2M_UID_RSTNSYNC_SR_CLK_M2M_JPEG_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_M2M_UID_FRC_MC_IPCLKPORT_I_CLK, MUX_CLKCMU_M2M_NOC_USER, CLK_CON_GAT_CLK_BLK_M2M_UID_FRC_MC_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_M2M_UID_FRC_MC_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_M2M_UID_FRC_MC_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_MCFP_UID_LH_AXI_SI_D1_MCFP_IPCLKPORT_I_CLK, MUX_CLKCMU_MCFP_NOC_USER, CLK_CON_GAT_CLK_BLK_MCFP_UID_LH_AXI_SI_D1_MCFP_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MCFP_UID_LH_AXI_SI_D1_MCFP_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_MCFP_UID_LH_AXI_SI_D1_MCFP_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MCFP_UID_LH_AXI_SI_D2_MCFP_IPCLKPORT_I_CLK, MUX_CLKCMU_MCFP_NOC_USER, CLK_CON_GAT_CLK_BLK_MCFP_UID_LH_AXI_SI_D2_MCFP_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MCFP_UID_LH_AXI_SI_D2_MCFP_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_MCFP_UID_LH_AXI_SI_D2_MCFP_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_MCFP_UID_PPMU_D1_MCFP_IPCLKPORT_ACLK, MUX_CLKCMU_MCFP_NOC_USER, CLK_CON_GAT_CLK_BLK_MCFP_UID_PPMU_D1_MCFP_IPCLKPORT_ACLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MCFP_UID_PPMU_D1_MCFP_IPCLKPORT_ACLK_MANUAL, CLK_CON_GAT_CLK_BLK_MCFP_UID_PPMU_D1_MCFP_IPCLKPORT_ACLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_MCFP_UID_PPMU_D2_MCFP_IPCLKPORT_ACLK, MUX_CLKCMU_MCFP_NOC_USER, CLK_CON_GAT_CLK_BLK_MCFP_UID_PPMU_D2_MCFP_IPCLKPORT_ACLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MCFP_UID_PPMU_D2_MCFP_IPCLKPORT_ACLK_MANUAL, CLK_CON_GAT_CLK_BLK_MCFP_UID_PPMU_D2_MCFP_IPCLKPORT_ACLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_MCFP_UID_SYSMMU_MCFP_S0_PMMU1_IPCLKPORT_CLK, MUX_CLKCMU_MCFP_NOC_USER, CLK_CON_GAT_CLK_BLK_MCFP_UID_SYSMMU_MCFP_S0_PMMU1_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MCFP_UID_SYSMMU_MCFP_S0_PMMU1_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_MCFP_UID_SYSMMU_MCFP_S0_PMMU1_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MCFP_UID_SYSMMU_MCFP_S1_PMMU0_IPCLKPORT_CLK, MUX_CLKCMU_MCFP_NOC_USER, CLK_CON_GAT_CLK_BLK_MCFP_UID_SYSMMU_MCFP_S1_PMMU0_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MCFP_UID_SYSMMU_MCFP_S1_PMMU0_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_MCFP_UID_SYSMMU_MCFP_S1_PMMU0_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_MCFP_UID_XIU_D1_MCFP_IPCLKPORT_ACLK, MUX_CLKCMU_MCFP_NOC_USER, CLK_CON_GAT_CLK_BLK_MCFP_UID_XIU_D1_MCFP_IPCLKPORT_ACLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MCFP_UID_XIU_D1_MCFP_IPCLKPORT_ACLK_MANUAL, CLK_CON_GAT_CLK_BLK_MCFP_UID_XIU_D1_MCFP_IPCLKPORT_ACLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MCFP_UID_XIU_D2_MCFP_IPCLKPORT_ACLK, MUX_CLKCMU_MCFP_NOC_USER, CLK_CON_GAT_CLK_BLK_MCFP_UID_XIU_D2_MCFP_IPCLKPORT_ACLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MCFP_UID_XIU_D2_MCFP_IPCLKPORT_ACLK_MANUAL, CLK_CON_GAT_CLK_BLK_MCFP_UID_XIU_D2_MCFP_IPCLKPORT_ACLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MCFP_UID_VGEN_LITE_D1_MCFP_IPCLKPORT_CLK, MUX_CLKCMU_MCFP_NOC_USER, CLK_CON_GAT_CLK_BLK_MCFP_UID_VGEN_LITE_D1_MCFP_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MCFP_UID_VGEN_LITE_D1_MCFP_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_MCFP_UID_VGEN_LITE_D1_MCFP_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MCFP_UID_SLH_AST_SI_G_PPMU_MCFP_IPCLKPORT_I_CLK, MUX_CLKCMU_MCFP_NOC_USER, CLK_CON_GAT_CLK_BLK_MCFP_UID_SLH_AST_SI_G_PPMU_MCFP_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MCFP_UID_SLH_AST_SI_G_PPMU_MCFP_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_MCFP_UID_SLH_AST_SI_G_PPMU_MCFP_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MCFP_UID_SIU_G_PPMU_MCFP_IPCLKPORT_I_ACLK, MUX_CLKCMU_MCFP_NOC_USER, CLK_CON_GAT_CLK_BLK_MCFP_UID_SIU_G_PPMU_MCFP_IPCLKPORT_I_ACLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MCFP_UID_SIU_G_PPMU_MCFP_IPCLKPORT_I_ACLK_MANUAL, CLK_CON_GAT_CLK_BLK_MCFP_UID_SIU_G_PPMU_MCFP_IPCLKPORT_I_ACLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MCFP_UID_RSTNSYNC_SR_CLK_MCFP_NOCD_IPCLKPORT_CLK, MUX_CLKCMU_MCFP_NOC_USER, CLK_CON_GAT_CLK_BLK_MCFP_UID_RSTNSYNC_SR_CLK_MCFP_NOCD_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MCFP_UID_RSTNSYNC_SR_CLK_MCFP_NOCD_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_MCFP_UID_RSTNSYNC_SR_CLK_MCFP_NOCD_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MCFP_UID_AD_APB_MCFP_IPCLKPORT_PCLKM, MUX_CLKCMU_MCFP_NOC_USER, CLK_CON_GAT_CLK_BLK_MCFP_UID_AD_APB_MCFP_IPCLKPORT_PCLKM_CG_VAL, CLK_CON_GAT_CLK_BLK_MCFP_UID_AD_APB_MCFP_IPCLKPORT_PCLKM_MANUAL, CLK_CON_GAT_CLK_BLK_MCFP_UID_AD_APB_MCFP_IPCLKPORT_PCLKM_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MCFP_UID_PPMU_D0_MCFP_IPCLKPORT_ACLK, MUX_CLKCMU_MCFP_NOC_USER, CLK_CON_GAT_CLK_BLK_MCFP_UID_PPMU_D0_MCFP_IPCLKPORT_ACLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MCFP_UID_PPMU_D0_MCFP_IPCLKPORT_ACLK_MANUAL, CLK_CON_GAT_CLK_BLK_MCFP_UID_PPMU_D0_MCFP_IPCLKPORT_ACLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MCFP_UID_PPMU_D3_MCFP_IPCLKPORT_ACLK, MUX_CLKCMU_MCFP_NOC_USER, CLK_CON_GAT_CLK_BLK_MCFP_UID_PPMU_D3_MCFP_IPCLKPORT_ACLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MCFP_UID_PPMU_D3_MCFP_IPCLKPORT_ACLK_MANUAL, CLK_CON_GAT_CLK_BLK_MCFP_UID_PPMU_D3_MCFP_IPCLKPORT_ACLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_MCFP_UID_PPMU_D4_MCFP_IPCLKPORT_ACLK, MUX_CLKCMU_MCFP_NOC_USER, CLK_CON_GAT_CLK_BLK_MCFP_UID_PPMU_D4_MCFP_IPCLKPORT_ACLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MCFP_UID_PPMU_D4_MCFP_IPCLKPORT_ACLK_MANUAL, CLK_CON_GAT_CLK_BLK_MCFP_UID_PPMU_D4_MCFP_IPCLKPORT_ACLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_MCFP_UID_SYSMMU_MCFP_S0_PMMU0_IPCLKPORT_CLK, MUX_CLKCMU_MCFP_NOC_USER, CLK_CON_GAT_CLK_BLK_MCFP_UID_SYSMMU_MCFP_S0_PMMU0_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MCFP_UID_SYSMMU_MCFP_S0_PMMU0_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_MCFP_UID_SYSMMU_MCFP_S0_PMMU0_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MCFP_UID_SYSMMU_MCFP_S1_PMMU1_IPCLKPORT_CLK, MUX_CLKCMU_MCFP_NOC_USER, CLK_CON_GAT_CLK_BLK_MCFP_UID_SYSMMU_MCFP_S1_PMMU1_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MCFP_UID_SYSMMU_MCFP_S1_PMMU1_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_MCFP_UID_SYSMMU_MCFP_S1_PMMU1_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MCFP_UID_SYSMMU_MCFP_S1_PMMU2_IPCLKPORT_CLK, MUX_CLKCMU_MCFP_NOC_USER, CLK_CON_GAT_CLK_BLK_MCFP_UID_SYSMMU_MCFP_S1_PMMU2_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MCFP_UID_SYSMMU_MCFP_S1_PMMU2_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_MCFP_UID_SYSMMU_MCFP_S1_PMMU2_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MCFP_UID_LH_ACEL_SI_D0_MCFP_IPCLKPORT_I_CLK, MUX_CLKCMU_MCFP_NOC_USER, CLK_CON_GAT_CLK_BLK_MCFP_UID_LH_ACEL_SI_D0_MCFP_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MCFP_UID_LH_ACEL_SI_D0_MCFP_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_MCFP_UID_LH_ACEL_SI_D0_MCFP_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MCFP_UID_LH_ACEL_SI_D3_MCFP_IPCLKPORT_I_CLK, MUX_CLKCMU_MCFP_NOC_USER, CLK_CON_GAT_CLK_BLK_MCFP_UID_LH_ACEL_SI_D3_MCFP_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MCFP_UID_LH_ACEL_SI_D3_MCFP_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_MCFP_UID_LH_ACEL_SI_D3_MCFP_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MCFP_UID_LH_ACEL_SI_D4_MCFP_IPCLKPORT_I_CLK, MUX_CLKCMU_MCFP_NOC_USER, CLK_CON_GAT_CLK_BLK_MCFP_UID_LH_ACEL_SI_D4_MCFP_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MCFP_UID_LH_ACEL_SI_D4_MCFP_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_MCFP_UID_LH_ACEL_SI_D4_MCFP_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MCFP_UID_XIU_D3_MCFP_IPCLKPORT_ACLK, MUX_CLKCMU_MCFP_NOC_USER, CLK_CON_GAT_CLK_BLK_MCFP_UID_XIU_D3_MCFP_IPCLKPORT_ACLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MCFP_UID_XIU_D3_MCFP_IPCLKPORT_ACLK_MANUAL, CLK_CON_GAT_CLK_BLK_MCFP_UID_XIU_D3_MCFP_IPCLKPORT_ACLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MCFP_UID_XIU_D4_MCFP_IPCLKPORT_ACLK, MUX_CLKCMU_MCFP_NOC_USER, CLK_CON_GAT_CLK_BLK_MCFP_UID_XIU_D4_MCFP_IPCLKPORT_ACLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MCFP_UID_XIU_D4_MCFP_IPCLKPORT_ACLK_MANUAL, CLK_CON_GAT_CLK_BLK_MCFP_UID_XIU_D4_MCFP_IPCLKPORT_ACLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MCFP_UID_VGEN_LITE_D0_MCFP_IPCLKPORT_CLK, MUX_CLKCMU_MCFP_NOC_USER, CLK_CON_GAT_CLK_BLK_MCFP_UID_VGEN_LITE_D0_MCFP_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MCFP_UID_VGEN_LITE_D0_MCFP_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_MCFP_UID_VGEN_LITE_D0_MCFP_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MCFP_UID_MCFP_IPCLKPORT_CLK, MUX_CLKCMU_MCFP_NOC_USER, CLK_CON_GAT_CLK_BLK_MCFP_UID_MCFP_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MCFP_UID_MCFP_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_MCFP_UID_MCFP_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MCFP_UID_LH_AST_SI_OTF_MCFPYUVP_IPCLKPORT_I_CLK, MUX_CLKCMU_MCFP_NOC_USER, CLK_CON_GAT_CLK_BLK_MCFP_UID_LH_AST_SI_OTF_MCFPYUVP_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MCFP_UID_LH_AST_SI_OTF_MCFPYUVP_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_MCFP_UID_LH_AST_SI_OTF_MCFPYUVP_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MCFP_UID_LH_AST_MI_OTF_RGBPMCFP_IPCLKPORT_I_CLK, MUX_CLKCMU_MCFP_NOC_USER, CLK_CON_GAT_CLK_BLK_MCFP_UID_LH_AST_MI_OTF_RGBPMCFP_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MCFP_UID_LH_AST_MI_OTF_RGBPMCFP_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_MCFP_UID_LH_AST_MI_OTF_RGBPMCFP_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MCFP_UID_RSTNSYNC_SR_CLK_MCFP_NOCP_IPCLKPORT_CLK, DIV_CLK_MCFP_NOCP, CLK_CON_GAT_CLK_BLK_MCFP_UID_RSTNSYNC_SR_CLK_MCFP_NOCP_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MCFP_UID_RSTNSYNC_SR_CLK_MCFP_NOCP_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_MCFP_UID_RSTNSYNC_SR_CLK_MCFP_NOCP_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MCFP_UID_LH_AXI_MI_D6_MCSCMCFP_IPCLKPORT_I_CLK, MUX_CLKCMU_MCFP_NOC_USER, CLK_CON_GAT_CLK_BLK_MCFP_UID_LH_AXI_MI_D6_MCSCMCFP_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MCFP_UID_LH_AXI_MI_D6_MCSCMCFP_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_MCFP_UID_LH_AXI_MI_D6_MCSCMCFP_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MCFP_UID_LH_AXI_MI_D0_MCSCMCFP_IPCLKPORT_I_CLK, MUX_CLKCMU_MCFP_NOC_USER, CLK_CON_GAT_CLK_BLK_MCFP_UID_LH_AXI_MI_D0_MCSCMCFP_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MCFP_UID_LH_AXI_MI_D0_MCSCMCFP_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_MCFP_UID_LH_AXI_MI_D0_MCSCMCFP_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MCFP_UID_LH_AXI_MI_D1_MCSCMCFP_IPCLKPORT_I_CLK, MUX_CLKCMU_MCFP_NOC_USER, CLK_CON_GAT_CLK_BLK_MCFP_UID_LH_AXI_MI_D1_MCSCMCFP_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MCFP_UID_LH_AXI_MI_D1_MCSCMCFP_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_MCFP_UID_LH_AXI_MI_D1_MCSCMCFP_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MCFP_UID_LH_AXI_MI_D2_MCSCMCFP_IPCLKPORT_I_CLK, MUX_CLKCMU_MCFP_NOC_USER, CLK_CON_GAT_CLK_BLK_MCFP_UID_LH_AXI_MI_D2_MCSCMCFP_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MCFP_UID_LH_AXI_MI_D2_MCSCMCFP_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_MCFP_UID_LH_AXI_MI_D2_MCSCMCFP_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MCFP_UID_LH_AXI_MI_D3_MCSCMCFP_IPCLKPORT_I_CLK, MUX_CLKCMU_MCFP_NOC_USER, CLK_CON_GAT_CLK_BLK_MCFP_UID_LH_AXI_MI_D3_MCSCMCFP_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MCFP_UID_LH_AXI_MI_D3_MCSCMCFP_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_MCFP_UID_LH_AXI_MI_D3_MCSCMCFP_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MCFP_UID_LH_AXI_MI_D4_MCSCMCFP_IPCLKPORT_I_CLK, MUX_CLKCMU_MCFP_NOC_USER, CLK_CON_GAT_CLK_BLK_MCFP_UID_LH_AXI_MI_D4_MCSCMCFP_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MCFP_UID_LH_AXI_MI_D4_MCSCMCFP_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_MCFP_UID_LH_AXI_MI_D4_MCSCMCFP_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MCFP_UID_LH_AXI_MI_D5_MCSCMCFP_IPCLKPORT_I_CLK, MUX_CLKCMU_MCFP_NOC_USER, CLK_CON_GAT_CLK_BLK_MCFP_UID_LH_AXI_MI_D5_MCSCMCFP_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MCFP_UID_LH_AXI_MI_D5_MCSCMCFP_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_MCFP_UID_LH_AXI_MI_D5_MCSCMCFP_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MCFP_UID_BLK_MCFP_FRC_OTP_DESERIAL_IPCLKPORT_I_CLK, FREE_OSCCLK_MCFP, CLK_CON_GAT_CLK_BLK_MCFP_UID_BLK_MCFP_FRC_OTP_DESERIAL_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MCFP_UID_BLK_MCFP_FRC_OTP_DESERIAL_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_MCFP_UID_BLK_MCFP_FRC_OTP_DESERIAL_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MCFP_UID_LH_AST_MI_OTF_YUVPMCFP_IPCLKPORT_I_CLK, MUX_CLKCMU_MCFP_NOC_USER, CLK_CON_GAT_CLK_BLK_MCFP_UID_LH_AST_MI_OTF_YUVPMCFP_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MCFP_UID_LH_AST_MI_OTF_YUVPMCFP_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_MCFP_UID_LH_AST_MI_OTF_YUVPMCFP_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MCFP_UID_SYSMMU_MCFP_S0_IPCLKPORT_CLK, MUX_CLKCMU_MCFP_NOC_USER, CLK_CON_GAT_CLK_BLK_MCFP_UID_SYSMMU_MCFP_S0_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MCFP_UID_SYSMMU_MCFP_S0_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_MCFP_UID_SYSMMU_MCFP_S0_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MCFP_UID_SYSMMU_MCFP_S1_IPCLKPORT_CLK, MUX_CLKCMU_MCFP_NOC_USER, CLK_CON_GAT_CLK_BLK_MCFP_UID_SYSMMU_MCFP_S1_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MCFP_UID_SYSMMU_MCFP_S1_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_MCFP_UID_SYSMMU_MCFP_S1_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MCFP_UID_XIU_MMU0_MCFP_IPCLKPORT_ACLK, MUX_CLKCMU_MCFP_NOC_USER, CLK_CON_GAT_CLK_BLK_MCFP_UID_XIU_MMU0_MCFP_IPCLKPORT_ACLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MCFP_UID_XIU_MMU0_MCFP_IPCLKPORT_ACLK_MANUAL, CLK_CON_GAT_CLK_BLK_MCFP_UID_XIU_MMU0_MCFP_IPCLKPORT_ACLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MCFP_UID_XIU_MMU1_MCFP_IPCLKPORT_ACLK, MUX_CLKCMU_MCFP_NOC_USER, CLK_CON_GAT_CLK_BLK_MCFP_UID_XIU_MMU1_MCFP_IPCLKPORT_ACLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MCFP_UID_XIU_MMU1_MCFP_IPCLKPORT_ACLK_MANUAL, CLK_CON_GAT_CLK_BLK_MCFP_UID_XIU_MMU1_MCFP_IPCLKPORT_ACLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MCFP_UID_XIU_D0_MCFP_IPCLKPORT_ACLK, MUX_CLKCMU_MCFP_NOC_USER, CLK_CON_GAT_CLK_BLK_MCFP_UID_XIU_D0_MCFP_IPCLKPORT_ACLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MCFP_UID_XIU_D0_MCFP_IPCLKPORT_ACLK_MANUAL, CLK_CON_GAT_CLK_BLK_MCFP_UID_XIU_D0_MCFP_IPCLKPORT_ACLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MCFP_UID_LH_AXI_MI_D7_MCSCMCFP_IPCLKPORT_I_CLK, MUX_CLKCMU_MCFP_NOC_USER, CLK_CON_GAT_CLK_BLK_MCFP_UID_LH_AXI_MI_D7_MCSCMCFP_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MCFP_UID_LH_AXI_MI_D7_MCSCMCFP_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_MCFP_UID_LH_AXI_MI_D7_MCSCMCFP_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_MCSC_UID_AD_APB_MCSC_IPCLKPORT_PCLKM, MUX_CLKCMU_MCSC_NOC_USER, CLK_CON_GAT_CLK_BLK_MCSC_UID_AD_APB_MCSC_IPCLKPORT_PCLKM_CG_VAL, CLK_CON_GAT_CLK_BLK_MCSC_UID_AD_APB_MCSC_IPCLKPORT_PCLKM_MANUAL, CLK_CON_GAT_CLK_BLK_MCSC_UID_AD_APB_MCSC_IPCLKPORT_PCLKM_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MCSC_UID_MCSC_IPCLKPORT_C2R_CLK, MUX_CLKCMU_MCSC_NOC_USER, CLK_CON_GAT_CLK_BLK_MCSC_UID_MCSC_IPCLKPORT_C2R_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MCSC_UID_MCSC_IPCLKPORT_C2R_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_MCSC_UID_MCSC_IPCLKPORT_C2R_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MCSC_UID_LH_AXI_SI_D3_MCSCMCFP_IPCLKPORT_I_CLK, MUX_CLKCMU_MCSC_NOC_USER, CLK_CON_GAT_CLK_BLK_MCSC_UID_LH_AXI_SI_D3_MCSCMCFP_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MCSC_UID_LH_AXI_SI_D3_MCSCMCFP_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_MCSC_UID_LH_AXI_SI_D3_MCSCMCFP_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MCSC_UID_LH_AXI_SI_D4_MCSCMCFP_IPCLKPORT_I_CLK, MUX_CLKCMU_MCSC_NOC_USER, CLK_CON_GAT_CLK_BLK_MCSC_UID_LH_AXI_SI_D4_MCSCMCFP_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MCSC_UID_LH_AXI_SI_D4_MCSCMCFP_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_MCSC_UID_LH_AXI_SI_D4_MCSCMCFP_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_MCSC_UID_LH_AST_MI_OTF_YUVPMCSC_IPCLKPORT_I_CLK, MUX_CLKCMU_MCSC_NOC_USER, CLK_CON_GAT_CLK_BLK_MCSC_UID_LH_AST_MI_OTF_YUVPMCSC_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MCSC_UID_LH_AST_MI_OTF_YUVPMCSC_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_MCSC_UID_LH_AST_MI_OTF_YUVPMCSC_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MCSC_UID_LH_AXI_SI_D0_MCSCMCFP_IPCLKPORT_I_CLK, MUX_CLKCMU_MCSC_NOC_USER, CLK_CON_GAT_CLK_BLK_MCSC_UID_LH_AXI_SI_D0_MCSCMCFP_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MCSC_UID_LH_AXI_SI_D0_MCSCMCFP_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_MCSC_UID_LH_AXI_SI_D0_MCSCMCFP_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MCSC_UID_LH_AXI_SI_D1_MCSCMCFP_IPCLKPORT_I_CLK, MUX_CLKCMU_MCSC_NOC_USER, CLK_CON_GAT_CLK_BLK_MCSC_UID_LH_AXI_SI_D1_MCSCMCFP_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MCSC_UID_LH_AXI_SI_D1_MCSCMCFP_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_MCSC_UID_LH_AXI_SI_D1_MCSCMCFP_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MCSC_UID_LH_AXI_SI_D2_MCSCMCFP_IPCLKPORT_I_CLK, MUX_CLKCMU_MCSC_NOC_USER, CLK_CON_GAT_CLK_BLK_MCSC_UID_LH_AXI_SI_D2_MCSCMCFP_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MCSC_UID_LH_AXI_SI_D2_MCSCMCFP_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_MCSC_UID_LH_AXI_SI_D2_MCSCMCFP_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MCSC_UID_RSTNSYNC_SR_CLK_MCSC_NOCD_IPCLKPORT_CLK, MUX_CLKCMU_MCSC_NOC_USER, CLK_CON_GAT_CLK_BLK_MCSC_UID_RSTNSYNC_SR_CLK_MCSC_NOCD_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MCSC_UID_RSTNSYNC_SR_CLK_MCSC_NOCD_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_MCSC_UID_RSTNSYNC_SR_CLK_MCSC_NOCD_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MCSC_UID_MCSC_IPCLKPORT_C2W_CLK, MUX_CLKCMU_MCSC_NOC_USER, CLK_CON_GAT_CLK_BLK_MCSC_UID_MCSC_IPCLKPORT_C2W_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MCSC_UID_MCSC_IPCLKPORT_C2W_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_MCSC_UID_MCSC_IPCLKPORT_C2W_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MCSC_UID_MCSC_IPCLKPORT_CLK, MUX_CLKCMU_MCSC_NOC_USER, CLK_CON_GAT_CLK_BLK_MCSC_UID_MCSC_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MCSC_UID_MCSC_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_MCSC_UID_MCSC_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_MCSC_UID_LH_AXI_SI_D5_MCSCMCFP_IPCLKPORT_I_CLK, MUX_CLKCMU_MCSC_NOC_USER, CLK_CON_GAT_CLK_BLK_MCSC_UID_LH_AXI_SI_D5_MCSCMCFP_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MCSC_UID_LH_AXI_SI_D5_MCSCMCFP_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_MCSC_UID_LH_AXI_SI_D5_MCSCMCFP_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MCSC_UID_LH_AXI_SI_D6_MCSCMCFP_IPCLKPORT_I_CLK, MUX_CLKCMU_MCSC_NOC_USER, CLK_CON_GAT_CLK_BLK_MCSC_UID_LH_AXI_SI_D6_MCSCMCFP_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MCSC_UID_LH_AXI_SI_D6_MCSCMCFP_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_MCSC_UID_LH_AXI_SI_D6_MCSCMCFP_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MCSC_UID_LH_AXI_SI_D7_MCSCMCFP_IPCLKPORT_I_CLK, MUX_CLKCMU_MCSC_NOC_USER, CLK_CON_GAT_CLK_BLK_MCSC_UID_LH_AXI_SI_D7_MCSCMCFP_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MCSC_UID_LH_AXI_SI_D7_MCSCMCFP_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_MCSC_UID_LH_AXI_SI_D7_MCSCMCFP_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MCSC_UID_VGEN_LITE_MCSC_IPCLKPORT_CLK, MUX_CLKCMU_MCSC_NOC_USER, CLK_CON_GAT_CLK_BLK_MCSC_UID_VGEN_LITE_MCSC_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MCSC_UID_VGEN_LITE_MCSC_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_MCSC_UID_VGEN_LITE_MCSC_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_MFC_UID_XIU_D_MFC_IPCLKPORT_ACLK, MUX_CLKCMU_MFC_MFC_USER, CLK_CON_GAT_CLK_BLK_MFC_UID_XIU_D_MFC_IPCLKPORT_ACLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MFC_UID_XIU_D_MFC_IPCLKPORT_ACLK_MANUAL, CLK_CON_GAT_CLK_BLK_MFC_UID_XIU_D_MFC_IPCLKPORT_ACLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MFC_UID_WFD_IPCLKPORT_ACLK, MUX_CLKCMU_MFC_WFD_USER, CLK_CON_GAT_CLK_BLK_MFC_UID_WFD_IPCLKPORT_ACLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MFC_UID_WFD_IPCLKPORT_ACLK_MANUAL, CLK_CON_GAT_CLK_BLK_MFC_UID_WFD_IPCLKPORT_ACLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MFC_UID_SYSMMU_MFC_S0_PMMU0_IPCLKPORT_CLK, MUX_CLKCMU_MFC_MFC_USER, CLK_CON_GAT_CLK_BLK_MFC_UID_SYSMMU_MFC_S0_PMMU0_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MFC_UID_SYSMMU_MFC_S0_PMMU0_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_MFC_UID_SYSMMU_MFC_S0_PMMU0_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MFC_UID_RSTNSYNC_CLK_MFC_NOCP_IPCLKPORT_CLK, DIV_CLK_MFC_NOCP, CLK_CON_GAT_CLK_BLK_MFC_UID_RSTNSYNC_CLK_MFC_NOCP_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MFC_UID_RSTNSYNC_CLK_MFC_NOCP_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_MFC_UID_RSTNSYNC_CLK_MFC_NOCP_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MFC_UID_RSTNSYNC_SR_CLK_MFC_NOCD_WFD_SW_RESET_IPCLKPORT_CLK, MUX_CLKCMU_MFC_WFD_USER, CLK_CON_GAT_CLK_BLK_MFC_UID_RSTNSYNC_SR_CLK_MFC_NOCD_WFD_SW_RESET_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MFC_UID_RSTNSYNC_SR_CLK_MFC_NOCD_WFD_SW_RESET_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_MFC_UID_RSTNSYNC_SR_CLK_MFC_NOCD_WFD_SW_RESET_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MFC_UID_RSTNSYNC_SR_CLK_MFC_NOCD_WFD_IPCLKPORT_CLK, MUX_CLKCMU_MFC_WFD_USER, CLK_CON_GAT_CLK_BLK_MFC_UID_RSTNSYNC_SR_CLK_MFC_NOCD_WFD_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MFC_UID_RSTNSYNC_SR_CLK_MFC_NOCD_WFD_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_MFC_UID_RSTNSYNC_SR_CLK_MFC_NOCD_WFD_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MFC_UID_RSTNSYNC_CLK_MFC_NOCD_MFC_SW_RESET_IPCLKPORT_CLK, MUX_CLKCMU_MFC_MFC_USER, CLK_CON_GAT_CLK_BLK_MFC_UID_RSTNSYNC_CLK_MFC_NOCD_MFC_SW_RESET_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MFC_UID_RSTNSYNC_CLK_MFC_NOCD_MFC_SW_RESET_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_MFC_UID_RSTNSYNC_CLK_MFC_NOCD_MFC_SW_RESET_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MFC_UID_RSTNSYNC_SR_CLK_MFC_NOCD_MFC_IPCLKPORT_CLK, MUX_CLKCMU_MFC_MFC_USER, CLK_CON_GAT_CLK_BLK_MFC_UID_RSTNSYNC_SR_CLK_MFC_NOCD_MFC_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MFC_UID_RSTNSYNC_SR_CLK_MFC_NOCD_MFC_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_MFC_UID_RSTNSYNC_SR_CLK_MFC_NOCD_MFC_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MFC_UID_RSTNSYNC_SR_CLK_MFC_NOCD_LH_ATB_MFC_SI_SW_RESET_IPCLKPORT_CLK, MUX_CLKCMU_MFC_MFC_USER, CLK_CON_GAT_CLK_BLK_MFC_UID_RSTNSYNC_SR_CLK_MFC_NOCD_LH_ATB_MFC_SI_SW_RESET_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MFC_UID_RSTNSYNC_SR_CLK_MFC_NOCD_LH_ATB_MFC_SI_SW_RESET_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_MFC_UID_RSTNSYNC_SR_CLK_MFC_NOCD_LH_ATB_MFC_SI_SW_RESET_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MFC_UID_RSTNSYNC_SR_CLK_MFC_NOCD_LH_ATB_MFC_MI_SW_RESET_IPCLKPORT_CLK, MUX_CLKCMU_MFC_WFD_USER, CLK_CON_GAT_CLK_BLK_MFC_UID_RSTNSYNC_SR_CLK_MFC_NOCD_LH_ATB_MFC_MI_SW_RESET_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MFC_UID_RSTNSYNC_SR_CLK_MFC_NOCD_LH_ATB_MFC_MI_SW_RESET_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_MFC_UID_RSTNSYNC_SR_CLK_MFC_NOCD_LH_ATB_MFC_MI_SW_RESET_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MFC_UID_RSTNSYNC_SR_CLK_MFC_NOCD_LH_AST_SI_OTF3_MFC_SW_RESET_IPCLKPORT_CLK, MUX_CLKCMU_MFC_MFC_USER, CLK_CON_GAT_CLK_BLK_MFC_UID_RSTNSYNC_SR_CLK_MFC_NOCD_LH_AST_SI_OTF3_MFC_SW_RESET_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MFC_UID_RSTNSYNC_SR_CLK_MFC_NOCD_LH_AST_SI_OTF3_MFC_SW_RESET_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_MFC_UID_RSTNSYNC_SR_CLK_MFC_NOCD_LH_AST_SI_OTF3_MFC_SW_RESET_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MFC_UID_RSTNSYNC_SR_CLK_MFC_NOCD_LH_AST_SI_OTF2_MFC_SW_RESET_IPCLKPORT_CLK, MUX_CLKCMU_MFC_MFC_USER, CLK_CON_GAT_CLK_BLK_MFC_UID_RSTNSYNC_SR_CLK_MFC_NOCD_LH_AST_SI_OTF2_MFC_SW_RESET_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MFC_UID_RSTNSYNC_SR_CLK_MFC_NOCD_LH_AST_SI_OTF2_MFC_SW_RESET_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_MFC_UID_RSTNSYNC_SR_CLK_MFC_NOCD_LH_AST_SI_OTF2_MFC_SW_RESET_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MFC_UID_RSTNSYNC_SR_CLK_MFC_NOCD_LH_AST_SI_OTF1_MFC_SW_RESET_IPCLKPORT_CLK, MUX_CLKCMU_MFC_MFC_USER, CLK_CON_GAT_CLK_BLK_MFC_UID_RSTNSYNC_SR_CLK_MFC_NOCD_LH_AST_SI_OTF1_MFC_SW_RESET_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MFC_UID_RSTNSYNC_SR_CLK_MFC_NOCD_LH_AST_SI_OTF1_MFC_SW_RESET_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_MFC_UID_RSTNSYNC_SR_CLK_MFC_NOCD_LH_AST_SI_OTF1_MFC_SW_RESET_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MFC_UID_RSTNSYNC_SR_CLK_MFC_NOCD_LH_AST_SI_OTF0_MFC_SW_RESET_IPCLKPORT_CLK, MUX_CLKCMU_MFC_MFC_USER, CLK_CON_GAT_CLK_BLK_MFC_UID_RSTNSYNC_SR_CLK_MFC_NOCD_LH_AST_SI_OTF0_MFC_SW_RESET_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MFC_UID_RSTNSYNC_SR_CLK_MFC_NOCD_LH_AST_SI_OTF0_MFC_SW_RESET_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_MFC_UID_RSTNSYNC_SR_CLK_MFC_NOCD_LH_AST_SI_OTF0_MFC_SW_RESET_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MFC_UID_RSTNSYNC_SR_CLK_MFC_NOCD_LH_AST_MI_OTF2_MFC_SW_RESET_IPCLKPORT_CLK, MUX_CLKCMU_MFC_MFC_USER, CLK_CON_GAT_CLK_BLK_MFC_UID_RSTNSYNC_SR_CLK_MFC_NOCD_LH_AST_MI_OTF2_MFC_SW_RESET_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MFC_UID_RSTNSYNC_SR_CLK_MFC_NOCD_LH_AST_MI_OTF2_MFC_SW_RESET_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_MFC_UID_RSTNSYNC_SR_CLK_MFC_NOCD_LH_AST_MI_OTF2_MFC_SW_RESET_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MFC_UID_RSTNSYNC_SR_CLK_MFC_NOCD_LH_AST_MI_OTF3_MFC_SW_RESET_IPCLKPORT_CLK, MUX_CLKCMU_MFC_MFC_USER, CLK_CON_GAT_CLK_BLK_MFC_UID_RSTNSYNC_SR_CLK_MFC_NOCD_LH_AST_MI_OTF3_MFC_SW_RESET_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MFC_UID_RSTNSYNC_SR_CLK_MFC_NOCD_LH_AST_MI_OTF3_MFC_SW_RESET_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_MFC_UID_RSTNSYNC_SR_CLK_MFC_NOCD_LH_AST_MI_OTF3_MFC_SW_RESET_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MFC_UID_RSTNSYNC_SR_CLK_MFC_NOCD_LH_AST_MI_OTF1_MFC_SW_RESET_IPCLKPORT_CLK, MUX_CLKCMU_MFC_MFC_USER, CLK_CON_GAT_CLK_BLK_MFC_UID_RSTNSYNC_SR_CLK_MFC_NOCD_LH_AST_MI_OTF1_MFC_SW_RESET_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MFC_UID_RSTNSYNC_SR_CLK_MFC_NOCD_LH_AST_MI_OTF1_MFC_SW_RESET_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_MFC_UID_RSTNSYNC_SR_CLK_MFC_NOCD_LH_AST_MI_OTF1_MFC_SW_RESET_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MFC_UID_RSTNSYNC_SR_CLK_MFC_NOCD_LH_AST_MI_OTF0_MFC_SW_RESET_IPCLKPORT_CLK, MUX_CLKCMU_MFC_MFC_USER, CLK_CON_GAT_CLK_BLK_MFC_UID_RSTNSYNC_SR_CLK_MFC_NOCD_LH_AST_MI_OTF0_MFC_SW_RESET_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MFC_UID_RSTNSYNC_SR_CLK_MFC_NOCD_LH_AST_MI_OTF0_MFC_SW_RESET_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_MFC_UID_RSTNSYNC_SR_CLK_MFC_NOCD_LH_AST_MI_OTF0_MFC_SW_RESET_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MFC_UID_PPMU_D2_WFD_IPCLKPORT_PCLK, DIV_CLK_MFC_NOCP, CLK_CON_GAT_CLK_BLK_MFC_UID_PPMU_D2_WFD_IPCLKPORT_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MFC_UID_PPMU_D2_WFD_IPCLKPORT_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_MFC_UID_PPMU_D2_WFD_IPCLKPORT_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MFC_UID_PPMU_D1_MFC_IPCLKPORT_ACLK, MUX_CLKCMU_MFC_MFC_USER, CLK_CON_GAT_CLK_BLK_MFC_UID_PPMU_D1_MFC_IPCLKPORT_ACLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MFC_UID_PPMU_D1_MFC_IPCLKPORT_ACLK_MANUAL, CLK_CON_GAT_CLK_BLK_MFC_UID_PPMU_D1_MFC_IPCLKPORT_ACLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MFC_UID_PPMU_D1_MFC_IPCLKPORT_PCLK, DIV_CLK_MFC_NOCP, CLK_CON_GAT_CLK_BLK_MFC_UID_PPMU_D1_MFC_IPCLKPORT_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MFC_UID_PPMU_D1_MFC_IPCLKPORT_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_MFC_UID_PPMU_D1_MFC_IPCLKPORT_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MFC_UID_PPMU_D0_MFC_IPCLKPORT_ACLK, MUX_CLKCMU_MFC_MFC_USER, CLK_CON_GAT_CLK_BLK_MFC_UID_PPMU_D0_MFC_IPCLKPORT_ACLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MFC_UID_PPMU_D0_MFC_IPCLKPORT_ACLK_MANUAL, CLK_CON_GAT_CLK_BLK_MFC_UID_PPMU_D0_MFC_IPCLKPORT_ACLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MFC_UID_PPMU_D0_MFC_IPCLKPORT_PCLK, DIV_CLK_MFC_NOCP, CLK_CON_GAT_CLK_BLK_MFC_UID_PPMU_D0_MFC_IPCLKPORT_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MFC_UID_PPMU_D0_MFC_IPCLKPORT_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_MFC_UID_PPMU_D0_MFC_IPCLKPORT_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MFC_UID_MFC_IPCLKPORT_ACLK, MUX_CLKCMU_MFC_MFC_USER, CLK_CON_GAT_CLK_BLK_MFC_UID_MFC_IPCLKPORT_ACLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MFC_UID_MFC_IPCLKPORT_ACLK_MANUAL, CLK_CON_GAT_CLK_BLK_MFC_UID_MFC_IPCLKPORT_ACLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MFC_UID_MFC_IPCLKPORT_C2CLK, MUX_CLKCMU_MFC_MFC_USER, CLK_CON_GAT_CLK_BLK_MFC_UID_MFC_IPCLKPORT_C2CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MFC_UID_MFC_IPCLKPORT_C2CLK_MANUAL, CLK_CON_GAT_CLK_BLK_MFC_UID_MFC_IPCLKPORT_C2CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MFC_UID_LH_ATB_MFC_IPCLKPORT_I_CLK_SI, MUX_CLKCMU_MFC_MFC_USER, CLK_CON_GAT_CLK_BLK_MFC_UID_LH_ATB_MFC_IPCLKPORT_I_CLK_SI_CG_VAL, CLK_CON_GAT_CLK_BLK_MFC_UID_LH_ATB_MFC_IPCLKPORT_I_CLK_SI_MANUAL, CLK_CON_GAT_CLK_BLK_MFC_UID_LH_ATB_MFC_IPCLKPORT_I_CLK_SI_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MFC_UID_LH_ATB_MFC_IPCLKPORT_I_CLK_MI, MUX_CLKCMU_MFC_WFD_USER, CLK_CON_GAT_CLK_BLK_MFC_UID_LH_ATB_MFC_IPCLKPORT_I_CLK_MI_CG_VAL, CLK_CON_GAT_CLK_BLK_MFC_UID_LH_ATB_MFC_IPCLKPORT_I_CLK_MI_MANUAL, CLK_CON_GAT_CLK_BLK_MFC_UID_LH_ATB_MFC_IPCLKPORT_I_CLK_MI_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MFC_UID_LH_AXI_SI_D1_MFC_IPCLKPORT_I_CLK, MUX_CLKCMU_MFC_MFC_USER, CLK_CON_GAT_CLK_BLK_MFC_UID_LH_AXI_SI_D1_MFC_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MFC_UID_LH_AXI_SI_D1_MFC_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_MFC_UID_LH_AXI_SI_D1_MFC_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MFC_UID_LH_AXI_SI_D0_MFC_IPCLKPORT_I_CLK, MUX_CLKCMU_MFC_MFC_USER, CLK_CON_GAT_CLK_BLK_MFC_UID_LH_AXI_SI_D0_MFC_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MFC_UID_LH_AXI_SI_D0_MFC_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_MFC_UID_LH_AXI_SI_D0_MFC_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MFC_UID_LH_AST_SI_OTF2_MFCMFD_IPCLKPORT_I_CLK, MUX_CLKCMU_MFC_MFC_USER, CLK_CON_GAT_CLK_BLK_MFC_UID_LH_AST_SI_OTF2_MFCMFD_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MFC_UID_LH_AST_SI_OTF2_MFCMFD_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_MFC_UID_LH_AST_SI_OTF2_MFCMFD_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MFC_UID_LH_AST_SI_OTF1_MFCMFD_IPCLKPORT_I_CLK, MUX_CLKCMU_MFC_MFC_USER, CLK_CON_GAT_CLK_BLK_MFC_UID_LH_AST_SI_OTF1_MFCMFD_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MFC_UID_LH_AST_SI_OTF1_MFCMFD_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_MFC_UID_LH_AST_SI_OTF1_MFCMFD_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MFC_UID_LH_AST_SI_OTF0_MFCMFD_IPCLKPORT_I_CLK, MUX_CLKCMU_MFC_MFC_USER, CLK_CON_GAT_CLK_BLK_MFC_UID_LH_AST_SI_OTF0_MFCMFD_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MFC_UID_LH_AST_SI_OTF0_MFCMFD_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_MFC_UID_LH_AST_SI_OTF0_MFCMFD_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MFC_UID_SLH_AXI_MI_P_MFC_IPCLKPORT_I_CLK, DIV_CLK_MFC_NOCP, CLK_CON_GAT_CLK_BLK_MFC_UID_SLH_AXI_MI_P_MFC_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MFC_UID_SLH_AXI_MI_P_MFC_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_MFC_UID_SLH_AXI_MI_P_MFC_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MFC_UID_LH_AST_MI_OTF3_MFDMFC_IPCLKPORT_I_CLK, MUX_CLKCMU_MFC_MFC_USER, CLK_CON_GAT_CLK_BLK_MFC_UID_LH_AST_MI_OTF3_MFDMFC_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MFC_UID_LH_AST_MI_OTF3_MFDMFC_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_MFC_UID_LH_AST_MI_OTF3_MFDMFC_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MFC_UID_LH_AST_MI_OTF2_MFDMFC_IPCLKPORT_I_CLK, MUX_CLKCMU_MFC_MFC_USER, CLK_CON_GAT_CLK_BLK_MFC_UID_LH_AST_MI_OTF2_MFDMFC_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MFC_UID_LH_AST_MI_OTF2_MFDMFC_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_MFC_UID_LH_AST_MI_OTF2_MFDMFC_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MFC_UID_LH_AST_MI_OTF1_MFDMFC_IPCLKPORT_I_CLK, MUX_CLKCMU_MFC_MFC_USER, CLK_CON_GAT_CLK_BLK_MFC_UID_LH_AST_MI_OTF1_MFDMFC_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MFC_UID_LH_AST_MI_OTF1_MFDMFC_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_MFC_UID_LH_AST_MI_OTF1_MFDMFC_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MFC_UID_LH_AST_MI_OTF0_MFDMFC_IPCLKPORT_I_CLK, MUX_CLKCMU_MFC_MFC_USER, CLK_CON_GAT_CLK_BLK_MFC_UID_LH_AST_MI_OTF0_MFDMFC_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MFC_UID_LH_AST_MI_OTF0_MFDMFC_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_MFC_UID_LH_AST_MI_OTF0_MFDMFC_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MFC_UID_D_TZPC_MFC_IPCLKPORT_PCLK, DIV_CLK_MFC_NOCP, CLK_CON_GAT_CLK_BLK_MFC_UID_D_TZPC_MFC_IPCLKPORT_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MFC_UID_D_TZPC_MFC_IPCLKPORT_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_MFC_UID_D_TZPC_MFC_IPCLKPORT_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MFC_UID_ADS_APB_MFCMFD_IPCLKPORT_PCLKS, MUX_CLKCMU_MFC_MFC_USER, CLK_CON_GAT_CLK_BLK_MFC_UID_ADS_APB_MFCMFD_IPCLKPORT_PCLKS_CG_VAL, CLK_CON_GAT_CLK_BLK_MFC_UID_ADS_APB_MFCMFD_IPCLKPORT_PCLKS_MANUAL, CLK_CON_GAT_CLK_BLK_MFC_UID_ADS_APB_MFCMFD_IPCLKPORT_PCLKS_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MFC_UID_AS_APB_MFC_IPCLKPORT_PCLKM, MUX_CLKCMU_MFC_MFC_USER, CLK_CON_GAT_CLK_BLK_MFC_UID_AS_APB_MFC_IPCLKPORT_PCLKM_CG_VAL, CLK_CON_GAT_CLK_BLK_MFC_UID_AS_APB_MFC_IPCLKPORT_PCLKM_MANUAL, CLK_CON_GAT_CLK_BLK_MFC_UID_AS_APB_MFC_IPCLKPORT_PCLKM_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MFC_UID_AS_APB_WFD_NS_IPCLKPORT_PCLKM, MUX_CLKCMU_MFC_WFD_USER, CLK_CON_GAT_CLK_BLK_MFC_UID_AS_APB_WFD_NS_IPCLKPORT_PCLKM_CG_VAL, CLK_CON_GAT_CLK_BLK_MFC_UID_AS_APB_WFD_NS_IPCLKPORT_PCLKM_MANUAL, CLK_CON_GAT_CLK_BLK_MFC_UID_AS_APB_WFD_NS_IPCLKPORT_PCLKM_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MFC_UID_SYSREG_MFC_IPCLKPORT_PCLK, DIV_CLK_MFC_NOCP, CLK_CON_GAT_CLK_BLK_MFC_UID_SYSREG_MFC_IPCLKPORT_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MFC_UID_SYSREG_MFC_IPCLKPORT_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_MFC_UID_SYSREG_MFC_IPCLKPORT_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MFC_UID_LH_AST_SI_OTF3_MFCMFD_IPCLKPORT_I_CLK, MUX_CLKCMU_MFC_MFC_USER, CLK_CON_GAT_CLK_BLK_MFC_UID_LH_AST_SI_OTF3_MFCMFD_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MFC_UID_LH_AST_SI_OTF3_MFCMFD_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_MFC_UID_LH_AST_SI_OTF3_MFCMFD_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MFC_UID_SYSMMU_MFC_S0_PMMU1_IPCLKPORT_CLK, MUX_CLKCMU_MFC_MFC_USER, CLK_CON_GAT_CLK_BLK_MFC_UID_SYSMMU_MFC_S0_PMMU1_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MFC_UID_SYSMMU_MFC_S0_PMMU1_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_MFC_UID_SYSMMU_MFC_S0_PMMU1_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MFC_UID_SLH_AST_SI_G_PPMU_MFC_IPCLKPORT_I_CLK, MUX_CLKCMU_MFC_MFC_USER, CLK_CON_GAT_CLK_BLK_MFC_UID_SLH_AST_SI_G_PPMU_MFC_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MFC_UID_SLH_AST_SI_G_PPMU_MFC_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_MFC_UID_SLH_AST_SI_G_PPMU_MFC_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MFC_UID_SIU_G_PPMU_MFC_IPCLKPORT_I_ACLK, MUX_CLKCMU_MFC_MFC_USER, CLK_CON_GAT_CLK_BLK_MFC_UID_SIU_G_PPMU_MFC_IPCLKPORT_I_ACLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MFC_UID_SIU_G_PPMU_MFC_IPCLKPORT_I_ACLK_MANUAL, CLK_CON_GAT_CLK_BLK_MFC_UID_SIU_G_PPMU_MFC_IPCLKPORT_I_ACLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MFC_UID_VGEN_LITE_MFC_IPCLKPORT_CLK, MUX_CLKCMU_MFC_MFC_USER, CLK_CON_GAT_CLK_BLK_MFC_UID_VGEN_LITE_MFC_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MFC_UID_VGEN_LITE_MFC_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_MFC_UID_VGEN_LITE_MFC_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MFC_UID_PPMU_D2_WFD_IPCLKPORT_ACLK, MUX_CLKCMU_MFC_MFC_USER, CLK_CON_GAT_CLK_BLK_MFC_UID_PPMU_D2_WFD_IPCLKPORT_ACLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MFC_UID_PPMU_D2_WFD_IPCLKPORT_ACLK_MANUAL, CLK_CON_GAT_CLK_BLK_MFC_UID_PPMU_D2_WFD_IPCLKPORT_ACLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MFC_UID_RSTNSYNC_CLK_MFC_NOCD_MFC_IPCLKPORT_CLK, MUX_CLKCMU_MFC_MFC_USER, CLK_CON_GAT_CLK_BLK_MFC_UID_RSTNSYNC_CLK_MFC_NOCD_MFC_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MFC_UID_RSTNSYNC_CLK_MFC_NOCD_MFC_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_MFC_UID_RSTNSYNC_CLK_MFC_NOCD_MFC_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MFC_UID_RSTNSYNC_SR_CLK_MFC_NOCP_IPCLKPORT_CLK, DIV_CLK_MFC_NOCP, CLK_CON_GAT_CLK_BLK_MFC_UID_RSTNSYNC_SR_CLK_MFC_NOCP_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MFC_UID_RSTNSYNC_SR_CLK_MFC_NOCP_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_MFC_UID_RSTNSYNC_SR_CLK_MFC_NOCP_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MFC_UID_LH_AXI_SI_D_MFC_INT_IPCLKPORT_I_CLK, MUX_CLKCMU_MFC_WFD_USER, CLK_CON_GAT_CLK_BLK_MFC_UID_LH_AXI_SI_D_MFC_INT_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MFC_UID_LH_AXI_SI_D_MFC_INT_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_MFC_UID_LH_AXI_SI_D_MFC_INT_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MFC_UID_LH_AXI_MI_D_MFC_INT_IPCLKPORT_I_CLK, MUX_CLKCMU_MFC_MFC_USER, CLK_CON_GAT_CLK_BLK_MFC_UID_LH_AXI_MI_D_MFC_INT_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MFC_UID_LH_AXI_MI_D_MFC_INT_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_MFC_UID_LH_AXI_MI_D_MFC_INT_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MFC_UID_BLK_MFC_FRC_OTP_DESERIAL_IPCLKPORT_I_CLK, FREE_OSCCLK_MFC, CLK_CON_GAT_CLK_BLK_MFC_UID_BLK_MFC_FRC_OTP_DESERIAL_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MFC_UID_BLK_MFC_FRC_OTP_DESERIAL_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_MFC_UID_BLK_MFC_FRC_OTP_DESERIAL_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MFC_UID_RSTNSYNC_SR_CLK_MFC_NOCD_MFC_SW_RESET_IPCLKPORT_CLK, MUX_CLKCMU_MFC_MFC_USER, CLK_CON_GAT_CLK_BLK_MFC_UID_RSTNSYNC_SR_CLK_MFC_NOCD_MFC_SW_RESET_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MFC_UID_RSTNSYNC_SR_CLK_MFC_NOCD_MFC_SW_RESET_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_MFC_UID_RSTNSYNC_SR_CLK_MFC_NOCD_MFC_SW_RESET_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MFC_UID_RSTNSYNC_CLK_MFC_NOCD_WFD_IPCLKPORT_CLK, MUX_CLKCMU_MFC_WFD_USER, CLK_CON_GAT_CLK_BLK_MFC_UID_RSTNSYNC_CLK_MFC_NOCD_WFD_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MFC_UID_RSTNSYNC_CLK_MFC_NOCD_WFD_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_MFC_UID_RSTNSYNC_CLK_MFC_NOCD_WFD_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MFC_UID_SYSMMU_MFC_S0_IPCLKPORT_CLK, MUX_CLKCMU_MFC_MFC_USER, CLK_CON_GAT_CLK_BLK_MFC_UID_SYSMMU_MFC_S0_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MFC_UID_SYSMMU_MFC_S0_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_MFC_UID_SYSMMU_MFC_S0_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MFC_UID_XIU_MMU_MFC_IPCLKPORT_ACLK, MUX_CLKCMU_MFC_MFC_USER, CLK_CON_GAT_CLK_BLK_MFC_UID_XIU_MMU_MFC_IPCLKPORT_ACLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MFC_UID_XIU_MMU_MFC_IPCLKPORT_ACLK_MANUAL, CLK_CON_GAT_CLK_BLK_MFC_UID_XIU_MMU_MFC_IPCLKPORT_ACLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MFC_UID_LH_AST_MI_OTF0_LMEMFC_IPCLKPORT_I_CLK, MUX_CLKCMU_MFC_MFC_USER, CLK_CON_GAT_CLK_BLK_MFC_UID_LH_AST_MI_OTF0_LMEMFC_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MFC_UID_LH_AST_MI_OTF0_LMEMFC_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_MFC_UID_LH_AST_MI_OTF0_LMEMFC_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MFC_UID_LH_AST_MI_OTF1_LMEMFC_IPCLKPORT_I_CLK, MUX_CLKCMU_MFC_MFC_USER, CLK_CON_GAT_CLK_BLK_MFC_UID_LH_AST_MI_OTF1_LMEMFC_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MFC_UID_LH_AST_MI_OTF1_LMEMFC_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_MFC_UID_LH_AST_MI_OTF1_LMEMFC_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MFC_UID_ECU_MFC_IPCLKPORT_PCLK, DIV_CLK_MFC_NOCP, CLK_CON_GAT_CLK_BLK_MFC_UID_ECU_MFC_IPCLKPORT_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MFC_UID_ECU_MFC_IPCLKPORT_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_MFC_UID_ECU_MFC_IPCLKPORT_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MFC_UID_ECU_MFC_IPCLKPORT_CLK, DIV_CLK_MFC_ECU, CLK_CON_GAT_CLK_BLK_MFC_UID_ECU_MFC_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MFC_UID_ECU_MFC_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_MFC_UID_ECU_MFC_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MFC_UID_RSTNSYNC_SR_CLK_MFC_ECU_IPCLKPORT_CLK, DIV_CLK_MFC_ECU, CLK_CON_GAT_CLK_BLK_MFC_UID_RSTNSYNC_SR_CLK_MFC_ECU_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MFC_UID_RSTNSYNC_SR_CLK_MFC_ECU_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_MFC_UID_RSTNSYNC_SR_CLK_MFC_ECU_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MFD_UID_MFD_CMU_MFD_IPCLKPORT_PCLK, DIV_CLK_MFD_NOCP, CLK_CON_GAT_CLK_BLK_MFD_UID_MFD_CMU_MFD_IPCLKPORT_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MFD_UID_MFD_CMU_MFD_IPCLKPORT_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_MFD_UID_MFD_CMU_MFD_IPCLKPORT_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MFD_UID_SYSREG_MFD_IPCLKPORT_PCLK, DIV_CLK_MFD_NOCP, CLK_CON_GAT_CLK_BLK_MFD_UID_SYSREG_MFD_IPCLKPORT_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MFD_UID_SYSREG_MFD_IPCLKPORT_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_MFD_UID_SYSREG_MFD_IPCLKPORT_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MFD_UID_SYSMMU_MFD_S0_PMMU0_IPCLKPORT_CLK, MUX_CLKCMU_MFD_MFD_USER, CLK_CON_GAT_CLK_BLK_MFD_UID_SYSMMU_MFD_S0_PMMU0_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MFD_UID_SYSMMU_MFD_S0_PMMU0_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_MFD_UID_SYSMMU_MFD_S0_PMMU0_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MFD_UID_RSTNSYNC_CLK_MFD_NOCP_IPCLKPORT_CLK, DIV_CLK_MFD_NOCP, CLK_CON_GAT_CLK_BLK_MFD_UID_RSTNSYNC_CLK_MFD_NOCP_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MFD_UID_RSTNSYNC_CLK_MFD_NOCP_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_MFD_UID_RSTNSYNC_CLK_MFD_NOCP_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MFD_UID_RSTNSYNC_CLK_MFD_NOCD_MFD_SW_RESET_IPCLKPORT_CLK, MUX_CLKCMU_MFD_MFD_USER, CLK_CON_GAT_CLK_BLK_MFD_UID_RSTNSYNC_CLK_MFD_NOCD_MFD_SW_RESET_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MFD_UID_RSTNSYNC_CLK_MFD_NOCD_MFD_SW_RESET_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_MFD_UID_RSTNSYNC_CLK_MFD_NOCD_MFD_SW_RESET_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MFD_UID_RSTNSYNC_CLK_MFD_NOCD_MFD_IPCLKPORT_CLK, MUX_CLKCMU_MFD_MFD_USER, CLK_CON_GAT_CLK_BLK_MFD_UID_RSTNSYNC_CLK_MFD_NOCD_MFD_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MFD_UID_RSTNSYNC_CLK_MFD_NOCD_MFD_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_MFD_UID_RSTNSYNC_CLK_MFD_NOCD_MFD_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MFD_UID_RSTNSYNC_SR_CLK_MFD_NOCD_LH_AST_SI_OTF3_MFD_SW_RESET_IPCLKPORT_CLK, MUX_CLKCMU_MFD_MFD_USER, CLK_CON_GAT_CLK_BLK_MFD_UID_RSTNSYNC_SR_CLK_MFD_NOCD_LH_AST_SI_OTF3_MFD_SW_RESET_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MFD_UID_RSTNSYNC_SR_CLK_MFD_NOCD_LH_AST_SI_OTF3_MFD_SW_RESET_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_MFD_UID_RSTNSYNC_SR_CLK_MFD_NOCD_LH_AST_SI_OTF3_MFD_SW_RESET_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MFD_UID_RSTNSYNC_SR_CLK_MFD_NOCD_LH_AST_SI_OTF2_MFD_SW_RESET_IPCLKPORT_CLK, MUX_CLKCMU_MFD_MFD_USER, CLK_CON_GAT_CLK_BLK_MFD_UID_RSTNSYNC_SR_CLK_MFD_NOCD_LH_AST_SI_OTF2_MFD_SW_RESET_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MFD_UID_RSTNSYNC_SR_CLK_MFD_NOCD_LH_AST_SI_OTF2_MFD_SW_RESET_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_MFD_UID_RSTNSYNC_SR_CLK_MFD_NOCD_LH_AST_SI_OTF2_MFD_SW_RESET_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MFD_UID_RSTNSYNC_SR_CLK_MFD_NOCD_LH_AST_SI_OTF1_MFD_SW_RESET_IPCLKPORT_CLK, MUX_CLKCMU_MFD_MFD_USER, CLK_CON_GAT_CLK_BLK_MFD_UID_RSTNSYNC_SR_CLK_MFD_NOCD_LH_AST_SI_OTF1_MFD_SW_RESET_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MFD_UID_RSTNSYNC_SR_CLK_MFD_NOCD_LH_AST_SI_OTF1_MFD_SW_RESET_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_MFD_UID_RSTNSYNC_SR_CLK_MFD_NOCD_LH_AST_SI_OTF1_MFD_SW_RESET_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MFD_UID_RSTNSYNC_SR_CLK_MFD_NOCD_LH_AST_SI_OTF0_MFD_SW_RESET_IPCLKPORT_CLK, MUX_CLKCMU_MFD_MFD_USER, CLK_CON_GAT_CLK_BLK_MFD_UID_RSTNSYNC_SR_CLK_MFD_NOCD_LH_AST_SI_OTF0_MFD_SW_RESET_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MFD_UID_RSTNSYNC_SR_CLK_MFD_NOCD_LH_AST_SI_OTF0_MFD_SW_RESET_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_MFD_UID_RSTNSYNC_SR_CLK_MFD_NOCD_LH_AST_SI_OTF0_MFD_SW_RESET_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MFD_UID_RSTNSYNC_SR_CLK_MFD_NOCD_LH_AST_MI_OTF3_MFD_SW_RESET_IPCLKPORT_CLK, MUX_CLKCMU_MFD_MFD_USER, CLK_CON_GAT_CLK_BLK_MFD_UID_RSTNSYNC_SR_CLK_MFD_NOCD_LH_AST_MI_OTF3_MFD_SW_RESET_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MFD_UID_RSTNSYNC_SR_CLK_MFD_NOCD_LH_AST_MI_OTF3_MFD_SW_RESET_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_MFD_UID_RSTNSYNC_SR_CLK_MFD_NOCD_LH_AST_MI_OTF3_MFD_SW_RESET_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MFD_UID_LH_AST_MI_OTF0_MFCMFD_IPCLKPORT_I_CLK, MUX_CLKCMU_MFD_MFD_USER, CLK_CON_GAT_CLK_BLK_MFD_UID_LH_AST_MI_OTF0_MFCMFD_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MFD_UID_LH_AST_MI_OTF0_MFCMFD_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_MFD_UID_LH_AST_MI_OTF0_MFCMFD_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MFD_UID_D_TZPC_MFD_IPCLKPORT_PCLK, DIV_CLK_MFD_NOCP, CLK_CON_GAT_CLK_BLK_MFD_UID_D_TZPC_MFD_IPCLKPORT_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MFD_UID_D_TZPC_MFD_IPCLKPORT_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_MFD_UID_D_TZPC_MFD_IPCLKPORT_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MFD_UID_AS_APB_MFD_IPCLKPORT_PCLKM, MUX_CLKCMU_MFD_MFD_USER, CLK_CON_GAT_CLK_BLK_MFD_UID_AS_APB_MFD_IPCLKPORT_PCLKM_CG_VAL, CLK_CON_GAT_CLK_BLK_MFD_UID_AS_APB_MFD_IPCLKPORT_PCLKM_MANUAL, CLK_CON_GAT_CLK_BLK_MFD_UID_AS_APB_MFD_IPCLKPORT_PCLKM_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MFD_UID_ADM_APB_MFCMFD_IPCLKPORT_PCLKM, MUX_CLKCMU_MFD_MFD_USER, CLK_CON_GAT_CLK_BLK_MFD_UID_ADM_APB_MFCMFD_IPCLKPORT_PCLKM_CG_VAL, CLK_CON_GAT_CLK_BLK_MFD_UID_ADM_APB_MFCMFD_IPCLKPORT_PCLKM_MANUAL, CLK_CON_GAT_CLK_BLK_MFD_UID_ADM_APB_MFCMFD_IPCLKPORT_PCLKM_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MFD_UID_LH_AST_MI_OTF1_MFCMFD_IPCLKPORT_I_CLK, MUX_CLKCMU_MFD_MFD_USER, CLK_CON_GAT_CLK_BLK_MFD_UID_LH_AST_MI_OTF1_MFCMFD_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MFD_UID_LH_AST_MI_OTF1_MFCMFD_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_MFD_UID_LH_AST_MI_OTF1_MFCMFD_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MFD_UID_LH_AST_MI_OTF2_MFCMFD_IPCLKPORT_I_CLK, MUX_CLKCMU_MFD_MFD_USER, CLK_CON_GAT_CLK_BLK_MFD_UID_LH_AST_MI_OTF2_MFCMFD_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MFD_UID_LH_AST_MI_OTF2_MFCMFD_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_MFD_UID_LH_AST_MI_OTF2_MFCMFD_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MFD_UID_LH_AST_MI_OTF3_MFCMFD_IPCLKPORT_I_CLK, MUX_CLKCMU_MFD_MFD_USER, CLK_CON_GAT_CLK_BLK_MFD_UID_LH_AST_MI_OTF3_MFCMFD_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MFD_UID_LH_AST_MI_OTF3_MFCMFD_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_MFD_UID_LH_AST_MI_OTF3_MFCMFD_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MFD_UID_SLH_AXI_MI_P_MFD_IPCLKPORT_I_CLK, DIV_CLK_MFD_NOCP, CLK_CON_GAT_CLK_BLK_MFD_UID_SLH_AXI_MI_P_MFD_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MFD_UID_SLH_AXI_MI_P_MFD_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_MFD_UID_SLH_AXI_MI_P_MFD_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MFD_UID_LH_AST_SI_OTF0_MFDMFC_IPCLKPORT_I_CLK, MUX_CLKCMU_MFD_MFD_USER, CLK_CON_GAT_CLK_BLK_MFD_UID_LH_AST_SI_OTF0_MFDMFC_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MFD_UID_LH_AST_SI_OTF0_MFDMFC_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_MFD_UID_LH_AST_SI_OTF0_MFDMFC_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MFD_UID_LH_AST_SI_OTF1_MFDMFC_IPCLKPORT_I_CLK, MUX_CLKCMU_MFD_MFD_USER, CLK_CON_GAT_CLK_BLK_MFD_UID_LH_AST_SI_OTF1_MFDMFC_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MFD_UID_LH_AST_SI_OTF1_MFDMFC_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_MFD_UID_LH_AST_SI_OTF1_MFDMFC_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MFD_UID_LH_AST_SI_OTF2_MFDMFC_IPCLKPORT_I_CLK, MUX_CLKCMU_MFD_MFD_USER, CLK_CON_GAT_CLK_BLK_MFD_UID_LH_AST_SI_OTF2_MFDMFC_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MFD_UID_LH_AST_SI_OTF2_MFDMFC_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_MFD_UID_LH_AST_SI_OTF2_MFDMFC_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MFD_UID_LH_AST_SI_OTF3_MFDMFC_IPCLKPORT_I_CLK, MUX_CLKCMU_MFD_MFD_USER, CLK_CON_GAT_CLK_BLK_MFD_UID_LH_AST_SI_OTF3_MFDMFC_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MFD_UID_LH_AST_SI_OTF3_MFDMFC_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_MFD_UID_LH_AST_SI_OTF3_MFDMFC_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MFD_UID_LH_AXI_SI_D0_MFD_IPCLKPORT_I_CLK, MUX_CLKCMU_MFD_MFD_USER, CLK_CON_GAT_CLK_BLK_MFD_UID_LH_AXI_SI_D0_MFD_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MFD_UID_LH_AXI_SI_D0_MFD_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_MFD_UID_LH_AXI_SI_D0_MFD_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MFD_UID_LH_AXI_SI_D1_MFD_IPCLKPORT_I_CLK, MUX_CLKCMU_MFD_MFD_USER, CLK_CON_GAT_CLK_BLK_MFD_UID_LH_AXI_SI_D1_MFD_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MFD_UID_LH_AXI_SI_D1_MFD_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_MFD_UID_LH_AXI_SI_D1_MFD_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MFD_UID_MFD_IPCLKPORT_ACLK, MUX_CLKCMU_MFD_MFD_USER, CLK_CON_GAT_CLK_BLK_MFD_UID_MFD_IPCLKPORT_ACLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MFD_UID_MFD_IPCLKPORT_ACLK_MANUAL, CLK_CON_GAT_CLK_BLK_MFD_UID_MFD_IPCLKPORT_ACLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MFD_UID_PPMU_D0_MFD_IPCLKPORT_ACLK, MUX_CLKCMU_MFD_MFD_USER, CLK_CON_GAT_CLK_BLK_MFD_UID_PPMU_D0_MFD_IPCLKPORT_ACLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MFD_UID_PPMU_D0_MFD_IPCLKPORT_ACLK_MANUAL, CLK_CON_GAT_CLK_BLK_MFD_UID_PPMU_D0_MFD_IPCLKPORT_ACLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MFD_UID_PPMU_D0_MFD_IPCLKPORT_PCLK, DIV_CLK_MFD_NOCP, CLK_CON_GAT_CLK_BLK_MFD_UID_PPMU_D0_MFD_IPCLKPORT_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MFD_UID_PPMU_D0_MFD_IPCLKPORT_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_MFD_UID_PPMU_D0_MFD_IPCLKPORT_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MFD_UID_PPMU_D1_MFD_IPCLKPORT_PCLK, DIV_CLK_MFD_NOCP, CLK_CON_GAT_CLK_BLK_MFD_UID_PPMU_D1_MFD_IPCLKPORT_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MFD_UID_PPMU_D1_MFD_IPCLKPORT_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_MFD_UID_PPMU_D1_MFD_IPCLKPORT_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MFD_UID_PPMU_D1_MFD_IPCLKPORT_ACLK, MUX_CLKCMU_MFD_MFD_USER, CLK_CON_GAT_CLK_BLK_MFD_UID_PPMU_D1_MFD_IPCLKPORT_ACLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MFD_UID_PPMU_D1_MFD_IPCLKPORT_ACLK_MANUAL, CLK_CON_GAT_CLK_BLK_MFD_UID_PPMU_D1_MFD_IPCLKPORT_ACLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MFD_UID_RSTNSYNC_SR_CLK_MFD_NOCD_LH_AST_MI_OTF0_MFD_SW_RESET_IPCLKPORT_CLK, MUX_CLKCMU_MFD_MFD_USER, CLK_CON_GAT_CLK_BLK_MFD_UID_RSTNSYNC_SR_CLK_MFD_NOCD_LH_AST_MI_OTF0_MFD_SW_RESET_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MFD_UID_RSTNSYNC_SR_CLK_MFD_NOCD_LH_AST_MI_OTF0_MFD_SW_RESET_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_MFD_UID_RSTNSYNC_SR_CLK_MFD_NOCD_LH_AST_MI_OTF0_MFD_SW_RESET_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MFD_UID_RSTNSYNC_SR_CLK_MFD_NOCD_LH_AST_MI_OTF1_MFD_SW_RESET_IPCLKPORT_CLK, MUX_CLKCMU_MFD_MFD_USER, CLK_CON_GAT_CLK_BLK_MFD_UID_RSTNSYNC_SR_CLK_MFD_NOCD_LH_AST_MI_OTF1_MFD_SW_RESET_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MFD_UID_RSTNSYNC_SR_CLK_MFD_NOCD_LH_AST_MI_OTF1_MFD_SW_RESET_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_MFD_UID_RSTNSYNC_SR_CLK_MFD_NOCD_LH_AST_MI_OTF1_MFD_SW_RESET_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MFD_UID_RSTNSYNC_SR_CLK_MFD_NOCD_LH_AST_MI_OTF2_MFD_SW_RESET_IPCLKPORT_CLK, MUX_CLKCMU_MFD_MFD_USER, CLK_CON_GAT_CLK_BLK_MFD_UID_RSTNSYNC_SR_CLK_MFD_NOCD_LH_AST_MI_OTF2_MFD_SW_RESET_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MFD_UID_RSTNSYNC_SR_CLK_MFD_NOCD_LH_AST_MI_OTF2_MFD_SW_RESET_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_MFD_UID_RSTNSYNC_SR_CLK_MFD_NOCD_LH_AST_MI_OTF2_MFD_SW_RESET_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MFD_UID_SYSMMU_MFD_S0_PMMU1_IPCLKPORT_CLK, MUX_CLKCMU_MFD_MFD_USER, CLK_CON_GAT_CLK_BLK_MFD_UID_SYSMMU_MFD_S0_PMMU1_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MFD_UID_SYSMMU_MFD_S0_PMMU1_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_MFD_UID_SYSMMU_MFD_S0_PMMU1_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MFD_UID_VGEN_LITE_MFD_IPCLKPORT_CLK, MUX_CLKCMU_MFD_MFD_USER, CLK_CON_GAT_CLK_BLK_MFD_UID_VGEN_LITE_MFD_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MFD_UID_VGEN_LITE_MFD_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_MFD_UID_VGEN_LITE_MFD_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MFD_UID_SLH_AST_SI_G_PPMU_MFD_IPCLKPORT_I_CLK, MUX_CLKCMU_MFD_MFD_USER, CLK_CON_GAT_CLK_BLK_MFD_UID_SLH_AST_SI_G_PPMU_MFD_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MFD_UID_SLH_AST_SI_G_PPMU_MFD_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_MFD_UID_SLH_AST_SI_G_PPMU_MFD_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MFD_UID_SIU_G_PPMU_MFD_IPCLKPORT_I_ACLK, MUX_CLKCMU_MFD_MFD_USER, CLK_CON_GAT_CLK_BLK_MFD_UID_SIU_G_PPMU_MFD_IPCLKPORT_I_ACLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MFD_UID_SIU_G_PPMU_MFD_IPCLKPORT_I_ACLK_MANUAL, CLK_CON_GAT_CLK_BLK_MFD_UID_SIU_G_PPMU_MFD_IPCLKPORT_I_ACLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MFD_UID_RSTNSYNC_SR_CLK_MFD_NOCD_MFD_IPCLKPORT_CLK, MUX_CLKCMU_MFD_MFD_USER, CLK_CON_GAT_CLK_BLK_MFD_UID_RSTNSYNC_SR_CLK_MFD_NOCD_MFD_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MFD_UID_RSTNSYNC_SR_CLK_MFD_NOCD_MFD_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_MFD_UID_RSTNSYNC_SR_CLK_MFD_NOCD_MFD_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MFD_UID_RSTNSYNC_SR_CLK_MFD_NOCP_IPCLKPORT_CLK, DIV_CLK_MFD_NOCP, CLK_CON_GAT_CLK_BLK_MFD_UID_RSTNSYNC_SR_CLK_MFD_NOCP_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MFD_UID_RSTNSYNC_SR_CLK_MFD_NOCP_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_MFD_UID_RSTNSYNC_SR_CLK_MFD_NOCP_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MFD_UID_BLK_MFD_FRC_OTP_DESERIAL_IPCLKPORT_I_CLK, FREE_OSCCLK_MFD, CLK_CON_GAT_CLK_BLK_MFD_UID_BLK_MFD_FRC_OTP_DESERIAL_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MFD_UID_BLK_MFD_FRC_OTP_DESERIAL_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_MFD_UID_BLK_MFD_FRC_OTP_DESERIAL_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MFD_UID_RSTNSYNC_SR_CLK_MFD_NOCD_MFD_SW_RESET_IPCLKPORT_CLK, MUX_CLKCMU_MFD_MFD_USER, CLK_CON_GAT_CLK_BLK_MFD_UID_RSTNSYNC_SR_CLK_MFD_NOCD_MFD_SW_RESET_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MFD_UID_RSTNSYNC_SR_CLK_MFD_NOCD_MFD_SW_RESET_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_MFD_UID_RSTNSYNC_SR_CLK_MFD_NOCD_MFD_SW_RESET_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MFD_UID_XIU_MMU_MFD_IPCLKPORT_ACLK, MUX_CLKCMU_MFD_MFD_USER, CLK_CON_GAT_CLK_BLK_MFD_UID_XIU_MMU_MFD_IPCLKPORT_ACLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MFD_UID_XIU_MMU_MFD_IPCLKPORT_ACLK_MANUAL, CLK_CON_GAT_CLK_BLK_MFD_UID_XIU_MMU_MFD_IPCLKPORT_ACLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MFD_UID_SYSMMU_MFD_S0_IPCLKPORT_CLK, MUX_CLKCMU_MFD_MFD_USER, CLK_CON_GAT_CLK_BLK_MFD_UID_SYSMMU_MFD_S0_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MFD_UID_SYSMMU_MFD_S0_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_MFD_UID_SYSMMU_MFD_S0_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MFD_UID_PPMU_D2_MFD_IPCLKPORT_ACLK, MUX_CLKCMU_MFD_MFD_USER, CLK_CON_GAT_CLK_BLK_MFD_UID_PPMU_D2_MFD_IPCLKPORT_ACLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MFD_UID_PPMU_D2_MFD_IPCLKPORT_ACLK_MANUAL, CLK_CON_GAT_CLK_BLK_MFD_UID_PPMU_D2_MFD_IPCLKPORT_ACLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MFD_UID_PPMU_D2_MFD_IPCLKPORT_PCLK, DIV_CLK_MFD_NOCP, CLK_CON_GAT_CLK_BLK_MFD_UID_PPMU_D2_MFD_IPCLKPORT_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MFD_UID_PPMU_D2_MFD_IPCLKPORT_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_MFD_UID_PPMU_D2_MFD_IPCLKPORT_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MFD_UID_PPMU_D3_MFD_IPCLKPORT_ACLK, MUX_CLKCMU_MFD_MFD_USER, CLK_CON_GAT_CLK_BLK_MFD_UID_PPMU_D3_MFD_IPCLKPORT_ACLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MFD_UID_PPMU_D3_MFD_IPCLKPORT_ACLK_MANUAL, CLK_CON_GAT_CLK_BLK_MFD_UID_PPMU_D3_MFD_IPCLKPORT_ACLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MFD_UID_PPMU_D3_MFD_IPCLKPORT_PCLK, DIV_CLK_MFD_NOCP, CLK_CON_GAT_CLK_BLK_MFD_UID_PPMU_D3_MFD_IPCLKPORT_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MFD_UID_PPMU_D3_MFD_IPCLKPORT_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_MFD_UID_PPMU_D3_MFD_IPCLKPORT_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MFD_UID_LH_AXI_MI_D_MFD0_INT_IPCLKPORT_I_CLK, MUX_CLKCMU_MFD_MFD_USER, CLK_CON_GAT_CLK_BLK_MFD_UID_LH_AXI_MI_D_MFD0_INT_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MFD_UID_LH_AXI_MI_D_MFD0_INT_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_MFD_UID_LH_AXI_MI_D_MFD0_INT_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MFD_UID_LH_AXI_MI_D_MFD1_INT_IPCLKPORT_I_CLK, MUX_CLKCMU_MFD_MFD_USER, CLK_CON_GAT_CLK_BLK_MFD_UID_LH_AXI_MI_D_MFD1_INT_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MFD_UID_LH_AXI_MI_D_MFD1_INT_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_MFD_UID_LH_AXI_MI_D_MFD1_INT_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MFD_UID_LH_AXI_SI_D_MFD0_INT_IPCLKPORT_I_CLK, MUX_CLKCMU_MFD_MFD_USER, CLK_CON_GAT_CLK_BLK_MFD_UID_LH_AXI_SI_D_MFD0_INT_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MFD_UID_LH_AXI_SI_D_MFD0_INT_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_MFD_UID_LH_AXI_SI_D_MFD0_INT_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MFD_UID_LH_AXI_SI_D_MFD1_INT_IPCLKPORT_I_CLK, MUX_CLKCMU_MFD_MFD_USER, CLK_CON_GAT_CLK_BLK_MFD_UID_LH_AXI_SI_D_MFD1_INT_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MFD_UID_LH_AXI_SI_D_MFD1_INT_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_MFD_UID_LH_AXI_SI_D_MFD1_INT_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MFD_UID_MFD_IPCLKPORT_CLK_FG, MUX_CLKCMU_MFD_MFD_USER, CLK_CON_GAT_CLK_BLK_MFD_UID_MFD_IPCLKPORT_CLK_FG_CG_VAL, CLK_CON_GAT_CLK_BLK_MFD_UID_MFD_IPCLKPORT_CLK_FG_MANUAL, CLK_CON_GAT_CLK_BLK_MFD_UID_MFD_IPCLKPORT_CLK_FG_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MFD_UID_XIU_D0_MFD_IPCLKPORT_ACLK, MUX_CLKCMU_MFD_MFD_USER, CLK_CON_GAT_CLK_BLK_MFD_UID_XIU_D0_MFD_IPCLKPORT_ACLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MFD_UID_XIU_D0_MFD_IPCLKPORT_ACLK_MANUAL, CLK_CON_GAT_CLK_BLK_MFD_UID_XIU_D0_MFD_IPCLKPORT_ACLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MFD_UID_XIU_D1_MFD_IPCLKPORT_ACLK, MUX_CLKCMU_MFD_MFD_USER, CLK_CON_GAT_CLK_BLK_MFD_UID_XIU_D1_MFD_IPCLKPORT_ACLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MFD_UID_XIU_D1_MFD_IPCLKPORT_ACLK_MANUAL, CLK_CON_GAT_CLK_BLK_MFD_UID_XIU_D1_MFD_IPCLKPORT_ACLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MFD_UID_AS_APB_MFD_FG_IPCLKPORT_PCLKM, MUX_CLKCMU_MFD_MFD_USER, CLK_CON_GAT_CLK_BLK_MFD_UID_AS_APB_MFD_FG_IPCLKPORT_PCLKM_CG_VAL, CLK_CON_GAT_CLK_BLK_MFD_UID_AS_APB_MFD_FG_IPCLKPORT_PCLKM_MANUAL, CLK_CON_GAT_CLK_BLK_MFD_UID_AS_APB_MFD_FG_IPCLKPORT_PCLKM_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MFD_UID_RSTNSYNC_CLK_MFD_NOCD_FG_IPCLKPORT_CLK, MUX_CLKCMU_MFD_MFD_USER, CLK_CON_GAT_CLK_BLK_MFD_UID_RSTNSYNC_CLK_MFD_NOCD_FG_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MFD_UID_RSTNSYNC_CLK_MFD_NOCD_FG_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_MFD_UID_RSTNSYNC_CLK_MFD_NOCD_FG_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MFD_UID_RSTNSYNC_SR_CLK_MFD_NOCD_FG_IPCLKPORT_CLK, MUX_CLKCMU_MFD_MFD_USER, CLK_CON_GAT_CLK_BLK_MFD_UID_RSTNSYNC_SR_CLK_MFD_NOCD_FG_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MFD_UID_RSTNSYNC_SR_CLK_MFD_NOCD_FG_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_MFD_UID_RSTNSYNC_SR_CLK_MFD_NOCD_FG_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MFD_UID_ECU_MFD_IPCLKPORT_PCLK, DIV_CLK_MFD_NOCP, CLK_CON_GAT_CLK_BLK_MFD_UID_ECU_MFD_IPCLKPORT_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MFD_UID_ECU_MFD_IPCLKPORT_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_MFD_UID_ECU_MFD_IPCLKPORT_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MFD_UID_ECU_MFD_IPCLKPORT_CLK, DIV_CLK_MFD_ECU, CLK_CON_GAT_CLK_BLK_MFD_UID_ECU_MFD_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MFD_UID_ECU_MFD_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_MFD_UID_ECU_MFD_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MFD_UID_RSTNSYNC_SR_CLK_MFD_ECU_IPCLKPORT_CLK, DIV_CLK_MFD_ECU, CLK_CON_GAT_CLK_BLK_MFD_UID_RSTNSYNC_SR_CLK_MFD_ECU_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MFD_UID_RSTNSYNC_SR_CLK_MFD_ECU_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_MFD_UID_RSTNSYNC_SR_CLK_MFD_ECU_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_MIF_UID_ECU_MIF_IPCLKPORT_PCLK, MUX_CLKCMU_MIF_NOCP_USER, CLK_CON_GAT_CLK_BLK_MIF_UID_ECU_MIF_IPCLKPORT_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MIF_UID_ECU_MIF_IPCLKPORT_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_MIF_UID_ECU_MIF_IPCLKPORT_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_MIF_UID_SLH_AST_SI_G_PPMU_MIF_IPCLKPORT_I_CLK, DIV_CLK_MIF_NOCD, CLK_CON_GAT_CLK_BLK_MIF_UID_SLH_AST_SI_G_PPMU_MIF_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MIF_UID_SLH_AST_SI_G_PPMU_MIF_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_MIF_UID_SLH_AST_SI_G_PPMU_MIF_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MIF_UID_ECU_MIF_IPCLKPORT_CLK, DIV_CLK_MIF_ECU, CLK_CON_GAT_CLK_BLK_MIF_UID_ECU_MIF_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MIF_UID_ECU_MIF_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_MIF_UID_ECU_MIF_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_MIF_UID_RSTNSYNC_SR_CLK_MIF_ECU_IPCLKPORT_CLK, DIV_CLK_MIF_ECU, CLK_CON_GAT_CLK_BLK_MIF_UID_RSTNSYNC_SR_CLK_MIF_ECU_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_MIF_UID_RSTNSYNC_SR_CLK_MIF_ECU_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_MIF_UID_RSTNSYNC_SR_CLK_MIF_ECU_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_NOCL0_UID_APB_ASYNC_S2MPU_G3D_S0_IPCLKPORT_PCLKM, MUX_CLKCMU_NOCL0_NOC_USER, CLK_CON_GAT_CLK_BLK_NOCL0_UID_APB_ASYNC_S2MPU_G3D_S0_IPCLKPORT_PCLKM_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL0_UID_APB_ASYNC_S2MPU_G3D_S0_IPCLKPORT_PCLKM_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL0_UID_APB_ASYNC_S2MPU_G3D_S0_IPCLKPORT_PCLKM_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_NOCL0_UID_LH_AXI_MI_D1_MODEM_IPCLKPORT_I_CLK, MUX_CLKCMU_NOCL0_NOC_USER, CLK_CON_GAT_CLK_BLK_NOCL0_UID_LH_AXI_MI_D1_MODEM_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL0_UID_LH_AXI_MI_D1_MODEM_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL0_UID_LH_AXI_MI_D1_MODEM_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_NOCL0_UID_LH_ACEL_MI_D_AUD_IPCLKPORT_I_CLK, MUX_CLKCMU_NOCL0_NOC_USER, CLK_CON_GAT_CLK_BLK_NOCL0_UID_LH_ACEL_MI_D_AUD_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL0_UID_LH_ACEL_MI_D_AUD_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL0_UID_LH_ACEL_MI_D_AUD_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_NOCL0_UID_SYSMMU_MODEM_S0_PMMU0_IPCLKPORT_CLK, MUX_CLKCMU_NOCL0_NOC_USER, CLK_CON_GAT_CLK_BLK_NOCL0_UID_SYSMMU_MODEM_S0_PMMU0_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL0_UID_SYSMMU_MODEM_S0_PMMU0_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL0_UID_SYSMMU_MODEM_S0_PMMU0_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_NOCL0_UID_SYSMMU_MODEM_S0_IPCLKPORT_CLK, MUX_CLKCMU_NOCL0_NOC_USER, CLK_CON_GAT_CLK_BLK_NOCL0_UID_SYSMMU_MODEM_S0_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL0_UID_SYSMMU_MODEM_S0_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL0_UID_SYSMMU_MODEM_S0_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_NOCL0_UID_S2MPU_G3D_S0_IPCLKPORT_CLK, MUX_CLKCMU_NOCL0_NOC_USER, CLK_CON_GAT_CLK_BLK_NOCL0_UID_S2MPU_G3D_S0_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL0_UID_S2MPU_G3D_S0_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL0_UID_S2MPU_G3D_S0_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_NOCL0_UID_LH_AST_SI_G_PPMU_P_CLUSTER0_INT_IPCLKPORT_I_CLK, DIV_CLK_NOCL0_NOCP, CLK_CON_GAT_CLK_BLK_NOCL0_UID_LH_AST_SI_G_PPMU_P_CLUSTER0_INT_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL0_UID_LH_AST_SI_G_PPMU_P_CLUSTER0_INT_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL0_UID_LH_AST_SI_G_PPMU_P_CLUSTER0_INT_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_NOCL0_UID_LH_ACEL_MI_D_SSP_IPCLKPORT_I_CLK, MUX_CLKCMU_NOCL0_NOC_USER, CLK_CON_GAT_CLK_BLK_NOCL0_UID_LH_ACEL_MI_D_SSP_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL0_UID_LH_ACEL_MI_D_SSP_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL0_UID_LH_ACEL_MI_D_SSP_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_NOCL0_UID_LH_AST_SI_G_DEBUG_MUX_NOCL0_INT_IPCLKPORT_I_CLK, DIV_CLK_NOCL0_NOCP, CLK_CON_GAT_CLK_BLK_NOCL0_UID_LH_AST_SI_G_DEBUG_MUX_NOCL0_INT_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL0_UID_LH_AST_SI_G_DEBUG_MUX_NOCL0_INT_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL0_UID_LH_AST_SI_G_DEBUG_MUX_NOCL0_INT_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_NOCL0_UID_S2MPU_G3D_S0_PMMU0_IPCLKPORT_CLK, MUX_CLKCMU_NOCL0_NOC_USER, CLK_CON_GAT_CLK_BLK_NOCL0_UID_S2MPU_G3D_S0_PMMU0_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL0_UID_S2MPU_G3D_S0_PMMU0_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL0_UID_S2MPU_G3D_S0_PMMU0_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_NOCL0_UID_S2MPU_G3D_S0_PMMU1_IPCLKPORT_CLK, MUX_CLKCMU_NOCL0_NOC_USER, CLK_CON_GAT_CLK_BLK_NOCL0_UID_S2MPU_G3D_S0_PMMU1_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL0_UID_S2MPU_G3D_S0_PMMU1_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL0_UID_S2MPU_G3D_S0_PMMU1_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_NOCL0_UID_S2MPU_G3D_S0_PMMU2_IPCLKPORT_CLK, MUX_CLKCMU_NOCL0_NOC_USER, CLK_CON_GAT_CLK_BLK_NOCL0_UID_S2MPU_G3D_S0_PMMU2_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL0_UID_S2MPU_G3D_S0_PMMU2_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL0_UID_S2MPU_G3D_S0_PMMU2_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_NOCL0_UID_S2MPU_G3D_S0_PMMU3_IPCLKPORT_CLK, MUX_CLKCMU_NOCL0_NOC_USER, CLK_CON_GAT_CLK_BLK_NOCL0_UID_S2MPU_G3D_S0_PMMU3_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL0_UID_S2MPU_G3D_S0_PMMU3_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL0_UID_S2MPU_G3D_S0_PMMU3_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_NOCL0_UID_LH_AST_MI_G_DEBUG_MUX_NOCL0_INT_IPCLKPORT_I_CLK, MUX_CLKCMU_NOCL0_NOC_USER, CLK_CON_GAT_CLK_BLK_NOCL0_UID_LH_AST_MI_G_DEBUG_MUX_NOCL0_INT_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL0_UID_LH_AST_MI_G_DEBUG_MUX_NOCL0_INT_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL0_UID_LH_AST_MI_G_DEBUG_MUX_NOCL0_INT_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_NOCL0_UID_XIU_MMU_MODEM_IPCLKPORT_ACLK, MUX_CLKCMU_NOCL0_NOC_USER, CLK_CON_GAT_CLK_BLK_NOCL0_UID_XIU_MMU_MODEM_IPCLKPORT_ACLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL0_UID_XIU_MMU_MODEM_IPCLKPORT_ACLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL0_UID_XIU_MMU_MODEM_IPCLKPORT_ACLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_NOCL0_UID_XIU_D0_NOCL0_IPCLKPORT_ACLK, MUX_CLKCMU_NOCL0_NOC_USER, CLK_CON_GAT_CLK_BLK_NOCL0_UID_XIU_D0_NOCL0_IPCLKPORT_ACLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL0_UID_XIU_D0_NOCL0_IPCLKPORT_ACLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL0_UID_XIU_D0_NOCL0_IPCLKPORT_ACLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_NOCL0_UID_XIU_D1_NOCL0_IPCLKPORT_ACLK, MUX_CLKCMU_NOCL0_NOC_USER, CLK_CON_GAT_CLK_BLK_NOCL0_UID_XIU_D1_NOCL0_IPCLKPORT_ACLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL0_UID_XIU_D1_NOCL0_IPCLKPORT_ACLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL0_UID_XIU_D1_NOCL0_IPCLKPORT_ACLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_NOCL0_UID_LH_TAXI_MI_D0_NOCL1C_NOCL0_IPCLKPORT_I_CLK, MUX_CLKCMU_NOCL0_NOC_USER, CLK_CON_GAT_CLK_BLK_NOCL0_UID_LH_TAXI_MI_D0_NOCL1C_NOCL0_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL0_UID_LH_TAXI_MI_D0_NOCL1C_NOCL0_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL0_UID_LH_TAXI_MI_D0_NOCL1C_NOCL0_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_NOCL0_UID_LH_TAXI_MI_D1_NOCL1C_NOCL0_IPCLKPORT_I_CLK, MUX_CLKCMU_NOCL0_NOC_USER, CLK_CON_GAT_CLK_BLK_NOCL0_UID_LH_TAXI_MI_D1_NOCL1C_NOCL0_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL0_UID_LH_TAXI_MI_D1_NOCL1C_NOCL0_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL0_UID_LH_TAXI_MI_D1_NOCL1C_NOCL0_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_NOCL0_UID_LH_TAXI_MI_D0_NOCL1A_NOCL0_IPCLKPORT_I_CLK, MUX_CLKCMU_NOCL0_NOC_USER, CLK_CON_GAT_CLK_BLK_NOCL0_UID_LH_TAXI_MI_D0_NOCL1A_NOCL0_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL0_UID_LH_TAXI_MI_D0_NOCL1A_NOCL0_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL0_UID_LH_TAXI_MI_D0_NOCL1A_NOCL0_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_NOCL0_UID_LH_TAXI_MI_D1_NOCL1A_NOCL0_IPCLKPORT_I_CLK, MUX_CLKCMU_NOCL0_NOC_USER, CLK_CON_GAT_CLK_BLK_NOCL0_UID_LH_TAXI_MI_D1_NOCL1A_NOCL0_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL0_UID_LH_TAXI_MI_D1_NOCL1A_NOCL0_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL0_UID_LH_TAXI_MI_D1_NOCL1A_NOCL0_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_NOCL0_UID_LH_TAXI_MI_D2_NOCL1A_NOCL0_IPCLKPORT_I_CLK, MUX_CLKCMU_NOCL0_NOC_USER, CLK_CON_GAT_CLK_BLK_NOCL0_UID_LH_TAXI_MI_D2_NOCL1A_NOCL0_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL0_UID_LH_TAXI_MI_D2_NOCL1A_NOCL0_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL0_UID_LH_TAXI_MI_D2_NOCL1A_NOCL0_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_NOCL0_UID_LH_TAXI_MI_D3_NOCL1A_NOCL0_IPCLKPORT_I_CLK, MUX_CLKCMU_NOCL0_NOC_USER, CLK_CON_GAT_CLK_BLK_NOCL0_UID_LH_TAXI_MI_D3_NOCL1A_NOCL0_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL0_UID_LH_TAXI_MI_D3_NOCL1A_NOCL0_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL0_UID_LH_TAXI_MI_D3_NOCL1A_NOCL0_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_NOCL0_UID_LH_TAXI_MI_D_NOCL1B_NOCL0_IPCLKPORT_I_CLK, MUX_CLKCMU_NOCL0_NOC_USER, CLK_CON_GAT_CLK_BLK_NOCL0_UID_LH_TAXI_MI_D_NOCL1B_NOCL0_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL0_UID_LH_TAXI_MI_D_NOCL1B_NOCL0_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL0_UID_LH_TAXI_MI_D_NOCL1B_NOCL0_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_NOCL0_UID_LH_TAXI_SI_P_NOCL0_NOCL1B_IPCLKPORT_I_CLK, DIV_CLK_NOCL0_NOCP, CLK_CON_GAT_CLK_BLK_NOCL0_UID_LH_TAXI_SI_P_NOCL0_NOCL1B_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL0_UID_LH_TAXI_SI_P_NOCL0_NOCL1B_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL0_UID_LH_TAXI_SI_P_NOCL0_NOCL1B_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_NOCL0_UID_LH_TAXI_SI_P_NOCL0_NOCL1C_IPCLKPORT_I_CLK, DIV_CLK_NOCL0_NOCP, CLK_CON_GAT_CLK_BLK_NOCL0_UID_LH_TAXI_SI_P_NOCL0_NOCL1C_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL0_UID_LH_TAXI_SI_P_NOCL0_NOCL1C_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL0_UID_LH_TAXI_SI_P_NOCL0_NOCL1C_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_NOCL0_UID_LH_TAXI_SI_P_NOCL0_NOCL1A_IPCLKPORT_I_CLK, DIV_CLK_NOCL0_NOCP, CLK_CON_GAT_CLK_BLK_NOCL0_UID_LH_TAXI_SI_P_NOCL0_NOCL1A_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL0_UID_LH_TAXI_SI_P_NOCL0_NOCL1A_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL0_UID_LH_TAXI_SI_P_NOCL0_NOCL1A_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_NOCL0_UID_LH_AXI_MI_G_CSSYS_IPCLKPORT_I_CLK, MUX_CLKCMU_NOCL0_NOC_USER, CLK_CON_GAT_CLK_BLK_NOCL0_UID_LH_AXI_MI_G_CSSYS_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL0_UID_LH_AXI_MI_G_CSSYS_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL0_UID_LH_AXI_MI_G_CSSYS_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_NOCL0_UID_PPMU_TREX_D0_MODEM_IPCLKPORT_ACLK, MUX_CLKCMU_NOCL0_NOC_USER, CLK_CON_GAT_CLK_BLK_NOCL0_UID_PPMU_TREX_D0_MODEM_IPCLKPORT_ACLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL0_UID_PPMU_TREX_D0_MODEM_IPCLKPORT_ACLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL0_UID_PPMU_TREX_D0_MODEM_IPCLKPORT_ACLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_NOCL0_UID_PPMU_TREX_D0_MODEM_IPCLKPORT_PCLK, DIV_CLK_NOCL0_NOCP, CLK_CON_GAT_CLK_BLK_NOCL0_UID_PPMU_TREX_D0_MODEM_IPCLKPORT_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL0_UID_PPMU_TREX_D0_MODEM_IPCLKPORT_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL0_UID_PPMU_TREX_D0_MODEM_IPCLKPORT_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_NOCL0_UID_PPMU_TREX_D1_MODEM_IPCLKPORT_ACLK, MUX_CLKCMU_NOCL0_NOC_USER, CLK_CON_GAT_CLK_BLK_NOCL0_UID_PPMU_TREX_D1_MODEM_IPCLKPORT_ACLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL0_UID_PPMU_TREX_D1_MODEM_IPCLKPORT_ACLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL0_UID_PPMU_TREX_D1_MODEM_IPCLKPORT_ACLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_NOCL0_UID_PPMU_TREX_D1_MODEM_IPCLKPORT_PCLK, DIV_CLK_NOCL0_NOCP, CLK_CON_GAT_CLK_BLK_NOCL0_UID_PPMU_TREX_D1_MODEM_IPCLKPORT_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL0_UID_PPMU_TREX_D1_MODEM_IPCLKPORT_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL0_UID_PPMU_TREX_D1_MODEM_IPCLKPORT_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_NOCL0_UID_PPMU_TREX_D2_MODEM_IPCLKPORT_ACLK, MUX_CLKCMU_NOCL0_NOC_USER, CLK_CON_GAT_CLK_BLK_NOCL0_UID_PPMU_TREX_D2_MODEM_IPCLKPORT_ACLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL0_UID_PPMU_TREX_D2_MODEM_IPCLKPORT_ACLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL0_UID_PPMU_TREX_D2_MODEM_IPCLKPORT_ACLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_NOCL0_UID_PPMU_TREX_D2_MODEM_IPCLKPORT_PCLK, DIV_CLK_NOCL0_NOCP, CLK_CON_GAT_CLK_BLK_NOCL0_UID_PPMU_TREX_D2_MODEM_IPCLKPORT_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL0_UID_PPMU_TREX_D2_MODEM_IPCLKPORT_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL0_UID_PPMU_TREX_D2_MODEM_IPCLKPORT_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_NOCL0_UID_PPMU_TREX_IRPS0_IPCLKPORT_ACLK, MUX_CLKCMU_NOCL0_NOC_USER, CLK_CON_GAT_CLK_BLK_NOCL0_UID_PPMU_TREX_IRPS0_IPCLKPORT_ACLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL0_UID_PPMU_TREX_IRPS0_IPCLKPORT_ACLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL0_UID_PPMU_TREX_IRPS0_IPCLKPORT_ACLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_NOCL0_UID_PPMU_TREX_IRPS0_IPCLKPORT_PCLK, DIV_CLK_NOCL0_NOCP, CLK_CON_GAT_CLK_BLK_NOCL0_UID_PPMU_TREX_IRPS0_IPCLKPORT_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL0_UID_PPMU_TREX_IRPS0_IPCLKPORT_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL0_UID_PPMU_TREX_IRPS0_IPCLKPORT_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_NOCL0_UID_PPMU_TREX_D0_ACP_IPCLKPORT_ACLK, MUX_CLKCMU_NOCL0_NOC_USER, CLK_CON_GAT_CLK_BLK_NOCL0_UID_PPMU_TREX_D0_ACP_IPCLKPORT_ACLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL0_UID_PPMU_TREX_D0_ACP_IPCLKPORT_ACLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL0_UID_PPMU_TREX_D0_ACP_IPCLKPORT_ACLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_NOCL0_UID_PPMU_TREX_D0_ACP_IPCLKPORT_PCLK, DIV_CLK_NOCL0_NOCP, CLK_CON_GAT_CLK_BLK_NOCL0_UID_PPMU_TREX_D0_ACP_IPCLKPORT_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL0_UID_PPMU_TREX_D0_ACP_IPCLKPORT_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL0_UID_PPMU_TREX_D0_ACP_IPCLKPORT_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_NOCL0_UID_PPMU_TREX_D1_ACP_IPCLKPORT_ACLK, MUX_CLKCMU_NOCL0_NOC_USER, CLK_CON_GAT_CLK_BLK_NOCL0_UID_PPMU_TREX_D1_ACP_IPCLKPORT_ACLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL0_UID_PPMU_TREX_D1_ACP_IPCLKPORT_ACLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL0_UID_PPMU_TREX_D1_ACP_IPCLKPORT_ACLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_NOCL0_UID_PPMU_TREX_D1_ACP_IPCLKPORT_PCLK, DIV_CLK_NOCL0_NOCP, CLK_CON_GAT_CLK_BLK_NOCL0_UID_PPMU_TREX_D1_ACP_IPCLKPORT_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL0_UID_PPMU_TREX_D1_ACP_IPCLKPORT_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL0_UID_PPMU_TREX_D1_ACP_IPCLKPORT_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_NOCL0_UID_PPMU_TREX_DP_NOCL0_IPCLKPORT_ACLK, MUX_CLKCMU_NOCL0_NOC_USER, CLK_CON_GAT_CLK_BLK_NOCL0_UID_PPMU_TREX_DP_NOCL0_IPCLKPORT_ACLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL0_UID_PPMU_TREX_DP_NOCL0_IPCLKPORT_ACLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL0_UID_PPMU_TREX_DP_NOCL0_IPCLKPORT_ACLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_NOCL0_UID_PPMU_TREX_DP_NOCL0_IPCLKPORT_PCLK, DIV_CLK_NOCL0_NOCP, CLK_CON_GAT_CLK_BLK_NOCL0_UID_PPMU_TREX_DP_NOCL0_IPCLKPORT_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL0_UID_PPMU_TREX_DP_NOCL0_IPCLKPORT_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL0_UID_PPMU_TREX_DP_NOCL0_IPCLKPORT_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_NOCL0_UID_PPMU_TREX_IRPS1_IPCLKPORT_ACLK, MUX_CLKCMU_NOCL0_NOC_USER, CLK_CON_GAT_CLK_BLK_NOCL0_UID_PPMU_TREX_IRPS1_IPCLKPORT_ACLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL0_UID_PPMU_TREX_IRPS1_IPCLKPORT_ACLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL0_UID_PPMU_TREX_IRPS1_IPCLKPORT_ACLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_NOCL0_UID_PPMU_TREX_IRPS1_IPCLKPORT_PCLK, DIV_CLK_NOCL0_NOCP, CLK_CON_GAT_CLK_BLK_NOCL0_UID_PPMU_TREX_IRPS1_IPCLKPORT_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL0_UID_PPMU_TREX_IRPS1_IPCLKPORT_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL0_UID_PPMU_TREX_IRPS1_IPCLKPORT_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_NOCL0_UID_PPMU_TREX_IRPS2_IPCLKPORT_ACLK, MUX_CLKCMU_NOCL0_NOC_USER, CLK_CON_GAT_CLK_BLK_NOCL0_UID_PPMU_TREX_IRPS2_IPCLKPORT_ACLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL0_UID_PPMU_TREX_IRPS2_IPCLKPORT_ACLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL0_UID_PPMU_TREX_IRPS2_IPCLKPORT_ACLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_NOCL0_UID_PPMU_TREX_IRPS2_IPCLKPORT_PCLK, DIV_CLK_NOCL0_NOCP, CLK_CON_GAT_CLK_BLK_NOCL0_UID_PPMU_TREX_IRPS2_IPCLKPORT_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL0_UID_PPMU_TREX_IRPS2_IPCLKPORT_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL0_UID_PPMU_TREX_IRPS2_IPCLKPORT_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_NOCL0_UID_PPMU_TREX_SCI_IRPM_IPCLKPORT_PCLK, DIV_CLK_NOCL0_NOCP, CLK_CON_GAT_CLK_BLK_NOCL0_UID_PPMU_TREX_SCI_IRPM_IPCLKPORT_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL0_UID_PPMU_TREX_SCI_IRPM_IPCLKPORT_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL0_UID_PPMU_TREX_SCI_IRPM_IPCLKPORT_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_NOCL0_UID_PPMU_TREX_SCI_IRPM_IPCLKPORT_ACLK, MUX_CLKCMU_NOCL0_NOC_USER, CLK_CON_GAT_CLK_BLK_NOCL0_UID_PPMU_TREX_SCI_IRPM_IPCLKPORT_ACLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL0_UID_PPMU_TREX_SCI_IRPM_IPCLKPORT_ACLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL0_UID_PPMU_TREX_SCI_IRPM_IPCLKPORT_ACLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_NOCL0_UID_PPMU_TREX_SCI_CCM1_IPCLKPORT_ACLK, MUX_CLKCMU_NOCL0_NOC_USER, CLK_CON_GAT_CLK_BLK_NOCL0_UID_PPMU_TREX_SCI_CCM1_IPCLKPORT_ACLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL0_UID_PPMU_TREX_SCI_CCM1_IPCLKPORT_ACLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL0_UID_PPMU_TREX_SCI_CCM1_IPCLKPORT_ACLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_NOCL0_UID_PPMU_TREX_SCI_CCM1_IPCLKPORT_PCLK, DIV_CLK_NOCL0_NOCP, CLK_CON_GAT_CLK_BLK_NOCL0_UID_PPMU_TREX_SCI_CCM1_IPCLKPORT_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL0_UID_PPMU_TREX_SCI_CCM1_IPCLKPORT_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL0_UID_PPMU_TREX_SCI_CCM1_IPCLKPORT_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_NOCL0_UID_PPMU_TREX_SCI_CCM0_IPCLKPORT_ACLK, MUX_CLKCMU_NOCL0_NOC_USER, CLK_CON_GAT_CLK_BLK_NOCL0_UID_PPMU_TREX_SCI_CCM0_IPCLKPORT_ACLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL0_UID_PPMU_TREX_SCI_CCM0_IPCLKPORT_ACLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL0_UID_PPMU_TREX_SCI_CCM0_IPCLKPORT_ACLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_NOCL0_UID_PPMU_TREX_SCI_CCM0_IPCLKPORT_PCLK, DIV_CLK_NOCL0_NOCP, CLK_CON_GAT_CLK_BLK_NOCL0_UID_PPMU_TREX_SCI_CCM0_IPCLKPORT_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL0_UID_PPMU_TREX_SCI_CCM0_IPCLKPORT_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL0_UID_PPMU_TREX_SCI_CCM0_IPCLKPORT_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_NOCL0_UID_PPMU_TREX_IRPS3_IPCLKPORT_ACLK, MUX_CLKCMU_NOCL0_NOC_USER, CLK_CON_GAT_CLK_BLK_NOCL0_UID_PPMU_TREX_IRPS3_IPCLKPORT_ACLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL0_UID_PPMU_TREX_IRPS3_IPCLKPORT_ACLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL0_UID_PPMU_TREX_IRPS3_IPCLKPORT_ACLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_NOCL0_UID_PPMU_TREX_IRPS3_IPCLKPORT_PCLK, DIV_CLK_NOCL0_NOCP, CLK_CON_GAT_CLK_BLK_NOCL0_UID_PPMU_TREX_IRPS3_IPCLKPORT_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL0_UID_PPMU_TREX_IRPS3_IPCLKPORT_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL0_UID_PPMU_TREX_IRPS3_IPCLKPORT_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_NOCL0_UID_PPMU_TREX_P_CLUSTER0_IPCLKPORT_PCLK, DIV_CLK_NOCL0_NOCP, CLK_CON_GAT_CLK_BLK_NOCL0_UID_PPMU_TREX_P_CLUSTER0_IPCLKPORT_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL0_UID_PPMU_TREX_P_CLUSTER0_IPCLKPORT_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL0_UID_PPMU_TREX_P_CLUSTER0_IPCLKPORT_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_NOCL0_UID_ECU_NOCL0_IPCLKPORT_PCLK, DIV_CLK_NOCL0_NOCP, CLK_CON_GAT_CLK_BLK_NOCL0_UID_ECU_NOCL0_IPCLKPORT_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL0_UID_ECU_NOCL0_IPCLKPORT_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL0_UID_ECU_NOCL0_IPCLKPORT_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_NOCL0_UID_S2MPU_ALIVE_S0_IPCLKPORT_CLK, MUX_CLKCMU_NOCL0_NOC_USER, CLK_CON_GAT_CLK_BLK_NOCL0_UID_S2MPU_ALIVE_S0_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL0_UID_S2MPU_ALIVE_S0_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL0_UID_S2MPU_ALIVE_S0_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_NOCL0_UID_S2MPU_ALIVE_S0_PMMU0_IPCLKPORT_CLK, MUX_CLKCMU_NOCL0_NOC_USER, CLK_CON_GAT_CLK_BLK_NOCL0_UID_S2MPU_ALIVE_S0_PMMU0_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL0_UID_S2MPU_ALIVE_S0_PMMU0_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL0_UID_S2MPU_ALIVE_S0_PMMU0_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_NOCL0_UID_DS_S2MPU_ALIVE_S0_IPCLKPORT_MAINCLK, MUX_CLKCMU_NOCL0_NOC_USER, CLK_CON_GAT_CLK_BLK_NOCL0_UID_DS_S2MPU_ALIVE_S0_IPCLKPORT_MAINCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL0_UID_DS_S2MPU_ALIVE_S0_IPCLKPORT_MAINCLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL0_UID_DS_S2MPU_ALIVE_S0_IPCLKPORT_MAINCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_NOCL0_UID_PPMU_TREX_P_CLUSTER0_IPCLKPORT_ACLK, DIV_CLK_NOCL0_NOCP, CLK_CON_GAT_CLK_BLK_NOCL0_UID_PPMU_TREX_P_CLUSTER0_IPCLKPORT_ACLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL0_UID_PPMU_TREX_P_CLUSTER0_IPCLKPORT_ACLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL0_UID_PPMU_TREX_P_CLUSTER0_IPCLKPORT_ACLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_NOCL0_UID_LH_AST_MI_G_PPMU_P_CLUSTER0_INT_IPCLKPORT_I_CLK, MUX_CLKCMU_NOCL0_NOC_USER, CLK_CON_GAT_CLK_BLK_NOCL0_UID_LH_AST_MI_G_PPMU_P_CLUSTER0_INT_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL0_UID_LH_AST_MI_G_PPMU_P_CLUSTER0_INT_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL0_UID_LH_AST_MI_G_PPMU_P_CLUSTER0_INT_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_NOCL0_UID_BAAW_APM_IPCLKPORT_I_PCLK, DIV_CLK_NOCL0_NOCP, CLK_CON_GAT_CLK_BLK_NOCL0_UID_BAAW_APM_IPCLKPORT_I_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL0_UID_BAAW_APM_IPCLKPORT_I_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL0_UID_BAAW_APM_IPCLKPORT_I_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_NOCL0_UID_ECU_NOCL0_IPCLKPORT_CLK, DIV_CLK_NOCL0_ECU, CLK_CON_GAT_CLK_BLK_NOCL0_UID_ECU_NOCL0_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL0_UID_ECU_NOCL0_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL0_UID_ECU_NOCL0_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_NOCL0_UID_RSTNSYNC_SR_CLK_NOCL0_ECU_IPCLKPORT_CLK, DIV_CLK_NOCL0_ECU, CLK_CON_GAT_CLK_BLK_NOCL0_UID_RSTNSYNC_SR_CLK_NOCL0_ECU_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL0_UID_RSTNSYNC_SR_CLK_NOCL0_ECU_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL0_UID_RSTNSYNC_SR_CLK_NOCL0_ECU_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_NOCL1A_UID_SLH_AXI_SI_P_MFD_IPCLKPORT_I_CLK, DIV_CLK_NOCL1A_NOCP, CLK_CON_GAT_CLK_BLK_NOCL1A_UID_SLH_AXI_SI_P_MFD_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL1A_UID_SLH_AXI_SI_P_MFD_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL1A_UID_SLH_AXI_SI_P_MFD_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_NOCL1A_UID_LH_AXI_MI_D1_MFD_IPCLKPORT_I_CLK, MUX_CLKCMU_NOCL1A_NOC_USER, CLK_CON_GAT_CLK_BLK_NOCL1A_UID_LH_AXI_MI_D1_MFD_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL1A_UID_LH_AXI_MI_D1_MFD_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL1A_UID_LH_AXI_MI_D1_MFD_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_NOCL1A_UID_LH_AXI_MI_D1_MFC_IPCLKPORT_I_CLK, MUX_CLKCMU_NOCL1A_NOC_USER, CLK_CON_GAT_CLK_BLK_NOCL1A_UID_LH_AXI_MI_D1_MFC_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL1A_UID_LH_AXI_MI_D1_MFC_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL1A_UID_LH_AXI_MI_D1_MFC_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_NOCL1A_UID_SLH_AXI_SI_P_MFC_IPCLKPORT_I_CLK, DIV_CLK_NOCL1A_NOCP, CLK_CON_GAT_CLK_BLK_NOCL1A_UID_SLH_AXI_SI_P_MFC_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL1A_UID_SLH_AXI_SI_P_MFC_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL1A_UID_SLH_AXI_SI_P_MFC_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_NOCL1A_UID_LH_ACEL_MI_D0_LME_IPCLKPORT_I_CLK, MUX_CLKCMU_NOCL1A_NOC_USER, CLK_CON_GAT_CLK_BLK_NOCL1A_UID_LH_ACEL_MI_D0_LME_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL1A_UID_LH_ACEL_MI_D0_LME_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL1A_UID_LH_ACEL_MI_D0_LME_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_NOCL1A_UID_LH_AXI_MI_D0_MFD_IPCLKPORT_I_CLK, MUX_CLKCMU_NOCL1A_NOC_USER, CLK_CON_GAT_CLK_BLK_NOCL1A_UID_LH_AXI_MI_D0_MFD_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL1A_UID_LH_AXI_MI_D0_MFD_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL1A_UID_LH_AXI_MI_D0_MFD_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_NOCL1A_UID_LH_AXI_MI_D0_MFC_IPCLKPORT_I_CLK, MUX_CLKCMU_NOCL1A_NOC_USER, CLK_CON_GAT_CLK_BLK_NOCL1A_UID_LH_AXI_MI_D0_MFC_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL1A_UID_LH_AXI_MI_D0_MFC_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL1A_UID_LH_AXI_MI_D0_MFC_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_NOCL1A_UID_SLH_AST_MI_G_PPMU_MFC_IPCLKPORT_I_CLK, MUX_CLKCMU_NOCL1A_NOC_USER, CLK_CON_GAT_CLK_BLK_NOCL1A_UID_SLH_AST_MI_G_PPMU_MFC_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL1A_UID_SLH_AST_MI_G_PPMU_MFC_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL1A_UID_SLH_AST_MI_G_PPMU_MFC_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_NOCL1A_UID_SLH_AST_MI_G_PPMU_MFD_IPCLKPORT_I_CLK, MUX_CLKCMU_NOCL1A_NOC_USER, CLK_CON_GAT_CLK_BLK_NOCL1A_UID_SLH_AST_MI_G_PPMU_MFD_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL1A_UID_SLH_AST_MI_G_PPMU_MFD_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL1A_UID_SLH_AST_MI_G_PPMU_MFD_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_NOCL1A_UID_LH_AST_MI_G_DEBUG_MUX_NOCL1A_INT_IPCLKPORT_I_CLK, MUX_CLKCMU_NOCL1A_NOC_USER, CLK_CON_GAT_CLK_BLK_NOCL1A_UID_LH_AST_MI_G_DEBUG_MUX_NOCL1A_INT_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL1A_UID_LH_AST_MI_G_DEBUG_MUX_NOCL1A_INT_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL1A_UID_LH_AST_MI_G_DEBUG_MUX_NOCL1A_INT_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_NOCL1A_UID_LH_AST_SI_G_DEBUG_MUX_NOCL1A_INT_IPCLKPORT_I_CLK, DIV_CLK_NOCL1A_NOCP, CLK_CON_GAT_CLK_BLK_NOCL1A_UID_LH_AST_SI_G_DEBUG_MUX_NOCL1A_INT_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL1A_UID_LH_AST_SI_G_DEBUG_MUX_NOCL1A_INT_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL1A_UID_LH_AST_SI_G_DEBUG_MUX_NOCL1A_INT_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_NOCL1A_UID_LH_AXI_MI_D1_DPUF0_IPCLKPORT_I_CLK, MUX_CLKCMU_NOCL1A_NOC_USER, CLK_CON_GAT_CLK_BLK_NOCL1A_UID_LH_AXI_MI_D1_DPUF0_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL1A_UID_LH_AXI_MI_D1_DPUF0_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL1A_UID_LH_AXI_MI_D1_DPUF0_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_NOCL1A_UID_LH_AXI_MI_D2_LME_IPCLKPORT_I_CLK, MUX_CLKCMU_NOCL1A_NOC_USER, CLK_CON_GAT_CLK_BLK_NOCL1A_UID_LH_AXI_MI_D2_LME_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL1A_UID_LH_AXI_MI_D2_LME_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL1A_UID_LH_AXI_MI_D2_LME_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_NOCL1A_UID_SLH_AST_MI_G_PPMU_DPUF0_IPCLKPORT_I_CLK, MUX_CLKCMU_NOCL1A_NOC_USER, CLK_CON_GAT_CLK_BLK_NOCL1A_UID_SLH_AST_MI_G_PPMU_DPUF0_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL1A_UID_SLH_AST_MI_G_PPMU_DPUF0_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL1A_UID_SLH_AST_MI_G_PPMU_DPUF0_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_NOCL1A_UID_LH_AXI_MI_D0_DPUF0_IPCLKPORT_I_CLK, MUX_CLKCMU_NOCL1A_NOC_USER, CLK_CON_GAT_CLK_BLK_NOCL1A_UID_LH_AXI_MI_D0_DPUF0_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL1A_UID_LH_AXI_MI_D0_DPUF0_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL1A_UID_LH_AXI_MI_D0_DPUF0_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_NOCL1A_UID_SLH_AXI_SI_P_DPUF0_IPCLKPORT_I_CLK, DIV_CLK_NOCL1A_NOCP, CLK_CON_GAT_CLK_BLK_NOCL1A_UID_SLH_AXI_SI_P_DPUF0_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL1A_UID_SLH_AXI_SI_P_DPUF0_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL1A_UID_SLH_AXI_SI_P_DPUF0_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_NOCL1A_UID_LH_ACEL_MI_D1_LME_IPCLKPORT_I_CLK, MUX_CLKCMU_NOCL1A_NOC_USER, CLK_CON_GAT_CLK_BLK_NOCL1A_UID_LH_ACEL_MI_D1_LME_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL1A_UID_LH_ACEL_MI_D1_LME_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL1A_UID_LH_ACEL_MI_D1_LME_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_NOCL1A_UID_LH_TAXI_MI_D0_DNC_NOCL1A_IPCLKPORT_I_CLK, MUX_CLKCMU_NOCL1A_NOC_USER, CLK_CON_GAT_CLK_BLK_NOCL1A_UID_LH_TAXI_MI_D0_DNC_NOCL1A_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL1A_UID_LH_TAXI_MI_D0_DNC_NOCL1A_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL1A_UID_LH_TAXI_MI_D0_DNC_NOCL1A_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_NOCL1A_UID_LH_TAXI_MI_D1_DNC_NOCL1A_IPCLKPORT_I_CLK, MUX_CLKCMU_NOCL1A_NOC_USER, CLK_CON_GAT_CLK_BLK_NOCL1A_UID_LH_TAXI_MI_D1_DNC_NOCL1A_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL1A_UID_LH_TAXI_MI_D1_DNC_NOCL1A_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL1A_UID_LH_TAXI_MI_D1_DNC_NOCL1A_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_NOCL1A_UID_LH_TAXI_MI_D2_DNC_NOCL1A_IPCLKPORT_I_CLK, MUX_CLKCMU_NOCL1A_NOC_USER, CLK_CON_GAT_CLK_BLK_NOCL1A_UID_LH_TAXI_MI_D2_DNC_NOCL1A_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL1A_UID_LH_TAXI_MI_D2_DNC_NOCL1A_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL1A_UID_LH_TAXI_MI_D2_DNC_NOCL1A_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_NOCL1A_UID_LH_TAXI_MI_D3_DNC_NOCL1A_IPCLKPORT_I_CLK, MUX_CLKCMU_NOCL1A_NOC_USER, CLK_CON_GAT_CLK_BLK_NOCL1A_UID_LH_TAXI_MI_D3_DNC_NOCL1A_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL1A_UID_LH_TAXI_MI_D3_DNC_NOCL1A_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL1A_UID_LH_TAXI_MI_D3_DNC_NOCL1A_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_NOCL1A_UID_LH_TAXI_MI_P_NOCL0_NOCL1A_IPCLKPORT_I_CLK, DIV_CLK_NOCL1A_NOCP, CLK_CON_GAT_CLK_BLK_NOCL1A_UID_LH_TAXI_MI_P_NOCL0_NOCL1A_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL1A_UID_LH_TAXI_MI_P_NOCL0_NOCL1A_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL1A_UID_LH_TAXI_MI_P_NOCL0_NOCL1A_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_NOCL1A_UID_LH_TAXI_SI_D0_NOCL1A_NOCL0_IPCLKPORT_I_CLK, MUX_CLKCMU_NOCL1A_NOC_USER, CLK_CON_GAT_CLK_BLK_NOCL1A_UID_LH_TAXI_SI_D0_NOCL1A_NOCL0_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL1A_UID_LH_TAXI_SI_D0_NOCL1A_NOCL0_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL1A_UID_LH_TAXI_SI_D0_NOCL1A_NOCL0_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_NOCL1A_UID_LH_TAXI_SI_D1_NOCL1A_NOCL0_IPCLKPORT_I_CLK, MUX_CLKCMU_NOCL1A_NOC_USER, CLK_CON_GAT_CLK_BLK_NOCL1A_UID_LH_TAXI_SI_D1_NOCL1A_NOCL0_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL1A_UID_LH_TAXI_SI_D1_NOCL1A_NOCL0_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL1A_UID_LH_TAXI_SI_D1_NOCL1A_NOCL0_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_NOCL1A_UID_LH_TAXI_SI_D2_NOCL1A_NOCL0_IPCLKPORT_I_CLK, MUX_CLKCMU_NOCL1A_NOC_USER, CLK_CON_GAT_CLK_BLK_NOCL1A_UID_LH_TAXI_SI_D2_NOCL1A_NOCL0_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL1A_UID_LH_TAXI_SI_D2_NOCL1A_NOCL0_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL1A_UID_LH_TAXI_SI_D2_NOCL1A_NOCL0_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_NOCL1A_UID_LH_TAXI_SI_D3_NOCL1A_NOCL0_IPCLKPORT_I_CLK, MUX_CLKCMU_NOCL1A_NOC_USER, CLK_CON_GAT_CLK_BLK_NOCL1A_UID_LH_TAXI_SI_D3_NOCL1A_NOCL0_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL1A_UID_LH_TAXI_SI_D3_NOCL1A_NOCL0_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL1A_UID_LH_TAXI_SI_D3_NOCL1A_NOCL0_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_NOCL1A_UID_ECU_NOCL1A_IPCLKPORT_PCLK, DIV_CLK_NOCL1A_NOCP, CLK_CON_GAT_CLK_BLK_NOCL1A_UID_ECU_NOCL1A_IPCLKPORT_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL1A_UID_ECU_NOCL1A_IPCLKPORT_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL1A_UID_ECU_NOCL1A_IPCLKPORT_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_NOCL1A_UID_PPMU_S0_NOCL1A_IPCLKPORT_PCLK, DIV_CLK_NOCL1A_NOCP, CLK_CON_GAT_CLK_BLK_NOCL1A_UID_PPMU_S0_NOCL1A_IPCLKPORT_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL1A_UID_PPMU_S0_NOCL1A_IPCLKPORT_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL1A_UID_PPMU_S0_NOCL1A_IPCLKPORT_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_NOCL1A_UID_PPMU_S0_NOCL1A_IPCLKPORT_ACLK, MUX_CLKCMU_NOCL1A_NOC_USER, CLK_CON_GAT_CLK_BLK_NOCL1A_UID_PPMU_S0_NOCL1A_IPCLKPORT_ACLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL1A_UID_PPMU_S0_NOCL1A_IPCLKPORT_ACLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL1A_UID_PPMU_S0_NOCL1A_IPCLKPORT_ACLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_NOCL1A_UID_PPMU_S1_NOCL1A_IPCLKPORT_PCLK, DIV_CLK_NOCL1A_NOCP, CLK_CON_GAT_CLK_BLK_NOCL1A_UID_PPMU_S1_NOCL1A_IPCLKPORT_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL1A_UID_PPMU_S1_NOCL1A_IPCLKPORT_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL1A_UID_PPMU_S1_NOCL1A_IPCLKPORT_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_NOCL1A_UID_PPMU_S1_NOCL1A_IPCLKPORT_ACLK, MUX_CLKCMU_NOCL1A_NOC_USER, CLK_CON_GAT_CLK_BLK_NOCL1A_UID_PPMU_S1_NOCL1A_IPCLKPORT_ACLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL1A_UID_PPMU_S1_NOCL1A_IPCLKPORT_ACLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL1A_UID_PPMU_S1_NOCL1A_IPCLKPORT_ACLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_NOCL1A_UID_PPMU_S2_NOCL1A_IPCLKPORT_PCLK, DIV_CLK_NOCL1A_NOCP, CLK_CON_GAT_CLK_BLK_NOCL1A_UID_PPMU_S2_NOCL1A_IPCLKPORT_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL1A_UID_PPMU_S2_NOCL1A_IPCLKPORT_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL1A_UID_PPMU_S2_NOCL1A_IPCLKPORT_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_NOCL1A_UID_PPMU_S2_NOCL1A_IPCLKPORT_ACLK, MUX_CLKCMU_NOCL1A_NOC_USER, CLK_CON_GAT_CLK_BLK_NOCL1A_UID_PPMU_S2_NOCL1A_IPCLKPORT_ACLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL1A_UID_PPMU_S2_NOCL1A_IPCLKPORT_ACLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL1A_UID_PPMU_S2_NOCL1A_IPCLKPORT_ACLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_NOCL1A_UID_PPMU_S3_NOCL1A_IPCLKPORT_ACLK, MUX_CLKCMU_NOCL1A_NOC_USER, CLK_CON_GAT_CLK_BLK_NOCL1A_UID_PPMU_S3_NOCL1A_IPCLKPORT_ACLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL1A_UID_PPMU_S3_NOCL1A_IPCLKPORT_ACLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL1A_UID_PPMU_S3_NOCL1A_IPCLKPORT_ACLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_NOCL1A_UID_PPMU_S3_NOCL1A_IPCLKPORT_PCLK, DIV_CLK_NOCL1A_NOCP, CLK_CON_GAT_CLK_BLK_NOCL1A_UID_PPMU_S3_NOCL1A_IPCLKPORT_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL1A_UID_PPMU_S3_NOCL1A_IPCLKPORT_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL1A_UID_PPMU_S3_NOCL1A_IPCLKPORT_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_NOCL1A_UID_ECU_NOCL1A_IPCLKPORT_CLK, DIV_CLK_NOCL1A_ECU, CLK_CON_GAT_CLK_BLK_NOCL1A_UID_ECU_NOCL1A_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL1A_UID_ECU_NOCL1A_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL1A_UID_ECU_NOCL1A_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_NOCL1A_UID_RSTNSYNC_SR_CLK_NOCL1A_ECU_IPCLKPORT_CLK, DIV_CLK_NOCL1A_ECU, CLK_CON_GAT_CLK_BLK_NOCL1A_UID_RSTNSYNC_SR_CLK_NOCL1A_ECU_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL1A_UID_RSTNSYNC_SR_CLK_NOCL1A_ECU_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL1A_UID_RSTNSYNC_SR_CLK_NOCL1A_ECU_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_NOCL1B_UID_AD_APB_S2MPU_NOCL1B_S0_IPCLKPORT_PCLKM, MUX_CLKCMU_NOCL1B_NOC1_USER, CLK_CON_GAT_CLK_BLK_NOCL1B_UID_AD_APB_S2MPU_NOCL1B_S0_IPCLKPORT_PCLKM_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL1B_UID_AD_APB_S2MPU_NOCL1B_S0_IPCLKPORT_PCLKM_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL1B_UID_AD_APB_S2MPU_NOCL1B_S0_IPCLKPORT_PCLKM_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_NOCL1B_UID_S2MPU_NOCL1B_S0_PMMU0_IPCLKPORT_CLK, MUX_CLKCMU_NOCL1B_NOC1_USER, CLK_CON_GAT_CLK_BLK_NOCL1B_UID_S2MPU_NOCL1B_S0_PMMU0_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL1B_UID_S2MPU_NOCL1B_S0_PMMU0_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL1B_UID_S2MPU_NOCL1B_S0_PMMU0_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_NOCL1B_UID_S2MPU_NOCL1B_S0_PMMU1_IPCLKPORT_CLK, MUX_CLKCMU_NOCL1B_NOC1_USER, CLK_CON_GAT_CLK_BLK_NOCL1B_UID_S2MPU_NOCL1B_S0_PMMU1_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL1B_UID_S2MPU_NOCL1B_S0_PMMU1_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL1B_UID_S2MPU_NOCL1B_S0_PMMU1_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_NOCL1B_UID_LH_ACEL_MI_D_DIT_INT_IPCLKPORT_I_CLK, MUX_CLKCMU_NOCL1B_NOC0_USER, CLK_CON_GAT_CLK_BLK_NOCL1B_UID_LH_ACEL_MI_D_DIT_INT_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL1B_UID_LH_ACEL_MI_D_DIT_INT_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL1B_UID_LH_ACEL_MI_D_DIT_INT_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_NOCL1B_UID_LH_ACEL_SI_D_DIT_INT_IPCLKPORT_I_CLK, MUX_CLKCMU_NOCL1B_NOC1_USER, CLK_CON_GAT_CLK_BLK_NOCL1B_UID_LH_ACEL_SI_D_DIT_INT_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL1B_UID_LH_ACEL_SI_D_DIT_INT_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL1B_UID_LH_ACEL_SI_D_DIT_INT_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_NOCL1B_UID_LH_AST_SI_G_PPMU_XIU_D_TT_INT_IPCLKPORT_I_CLK, MUX_CLKCMU_NOCL1B_NOC1_USER, CLK_CON_GAT_CLK_BLK_NOCL1B_UID_LH_AST_SI_G_PPMU_XIU_D_TT_INT_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL1B_UID_LH_AST_SI_G_PPMU_XIU_D_TT_INT_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL1B_UID_LH_AST_SI_G_PPMU_XIU_D_TT_INT_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_NOCL1B_UID_LH_AST_SI_G_PPMU_DIT_INT_IPCLKPORT_I_CLK, MUX_CLKCMU_NOCL1B_NOC1_USER, CLK_CON_GAT_CLK_BLK_NOCL1B_UID_LH_AST_SI_G_PPMU_DIT_INT_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL1B_UID_LH_AST_SI_G_PPMU_DIT_INT_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL1B_UID_LH_AST_SI_G_PPMU_DIT_INT_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_NOCL1B_UID_LH_AST_MI_G_PPMU_XIU_D_TT_INT_IPCLKPORT_I_CLK, MUX_CLKCMU_NOCL1B_NOC0_USER, CLK_CON_GAT_CLK_BLK_NOCL1B_UID_LH_AST_MI_G_PPMU_XIU_D_TT_INT_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL1B_UID_LH_AST_MI_G_PPMU_XIU_D_TT_INT_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL1B_UID_LH_AST_MI_G_PPMU_XIU_D_TT_INT_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_NOCL1B_UID_LH_AST_MI_G_PPMU_DIT_INT_IPCLKPORT_I_CLK, MUX_CLKCMU_NOCL1B_NOC0_USER, CLK_CON_GAT_CLK_BLK_NOCL1B_UID_LH_AST_MI_G_PPMU_DIT_INT_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL1B_UID_LH_AST_MI_G_PPMU_DIT_INT_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL1B_UID_LH_AST_MI_G_PPMU_DIT_INT_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_NOCL1B_UID_LH_AST_MI_G_DEBUG_MUX_NOCL1B_INT_IPCLKPORT_I_CLK, MUX_CLKCMU_NOCL1B_NOC0_USER, CLK_CON_GAT_CLK_BLK_NOCL1B_UID_LH_AST_MI_G_DEBUG_MUX_NOCL1B_INT_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL1B_UID_LH_AST_MI_G_DEBUG_MUX_NOCL1B_INT_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL1B_UID_LH_AST_MI_G_DEBUG_MUX_NOCL1B_INT_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_NOCL1B_UID_LH_AST_SI_G_DEBUG_MUX_NOCL1B_INT_IPCLKPORT_I_CLK, DIV_CLK_NOCL1B_NOCP, CLK_CON_GAT_CLK_BLK_NOCL1B_UID_LH_AST_SI_G_DEBUG_MUX_NOCL1B_INT_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL1B_UID_LH_AST_SI_G_DEBUG_MUX_NOCL1B_INT_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL1B_UID_LH_AST_SI_G_DEBUG_MUX_NOCL1B_INT_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_NOCL1B_UID_LH_AXI_MI_D_TT_INT_IPCLKPORT_I_CLK, MUX_CLKCMU_NOCL1B_NOC0_USER, CLK_CON_GAT_CLK_BLK_NOCL1B_UID_LH_AXI_MI_D_TT_INT_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL1B_UID_LH_AXI_MI_D_TT_INT_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL1B_UID_LH_AXI_MI_D_TT_INT_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_NOCL1B_UID_LH_AXI_SI_D_TT_INT_IPCLKPORT_I_CLK, MUX_CLKCMU_NOCL1B_NOC1_USER, CLK_CON_GAT_CLK_BLK_NOCL1B_UID_LH_AXI_SI_D_TT_INT_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL1B_UID_LH_AXI_SI_D_TT_INT_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL1B_UID_LH_AXI_SI_D_TT_INT_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_NOCL1B_UID_S2MPU_NOCL1B_S0_IPCLKPORT_CLK, MUX_CLKCMU_NOCL1B_NOC1_USER, CLK_CON_GAT_CLK_BLK_NOCL1B_UID_S2MPU_NOCL1B_S0_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL1B_UID_S2MPU_NOCL1B_S0_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL1B_UID_S2MPU_NOCL1B_S0_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_NOCL1B_UID_XIU_MMU_NOCL1B_IPCLKPORT_ACLK, MUX_CLKCMU_NOCL1B_NOC1_USER, CLK_CON_GAT_CLK_BLK_NOCL1B_UID_XIU_MMU_NOCL1B_IPCLKPORT_ACLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL1B_UID_XIU_MMU_NOCL1B_IPCLKPORT_ACLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL1B_UID_XIU_MMU_NOCL1B_IPCLKPORT_ACLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_NOCL1B_UID_LH_TAXI_MI_P_NOCL0_NOCL1B_IPCLKPORT_I_CLK, DIV_CLK_NOCL1B_NOCP, CLK_CON_GAT_CLK_BLK_NOCL1B_UID_LH_TAXI_MI_P_NOCL0_NOCL1B_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL1B_UID_LH_TAXI_MI_P_NOCL0_NOCL1B_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL1B_UID_LH_TAXI_MI_P_NOCL0_NOCL1B_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_NOCL1B_UID_LH_TAXI_SI_D_NOCL1B_NOCL0_IPCLKPORT_I_CLK, MUX_CLKCMU_NOCL1B_NOC0_USER, CLK_CON_GAT_CLK_BLK_NOCL1B_UID_LH_TAXI_SI_D_NOCL1B_NOCL0_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL1B_UID_LH_TAXI_SI_D_NOCL1B_NOCL0_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL1B_UID_LH_TAXI_SI_D_NOCL1B_NOCL0_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_NOCL1B_UID_ECU_NOCL1B_IPCLKPORT_PCLK, DIV_CLK_NOCL1B_NOCP, CLK_CON_GAT_CLK_BLK_NOCL1B_UID_ECU_NOCL1B_IPCLKPORT_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL1B_UID_ECU_NOCL1B_IPCLKPORT_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL1B_UID_ECU_NOCL1B_IPCLKPORT_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_NOCL1B_UID_PPMU_S0_NOCL1B_IPCLKPORT_ACLK, MUX_CLKCMU_NOCL1B_NOC0_USER, CLK_CON_GAT_CLK_BLK_NOCL1B_UID_PPMU_S0_NOCL1B_IPCLKPORT_ACLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL1B_UID_PPMU_S0_NOCL1B_IPCLKPORT_ACLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL1B_UID_PPMU_S0_NOCL1B_IPCLKPORT_ACLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_NOCL1B_UID_PPMU_S0_NOCL1B_IPCLKPORT_PCLK, DIV_CLK_NOCL1B_NOCP, CLK_CON_GAT_CLK_BLK_NOCL1B_UID_PPMU_S0_NOCL1B_IPCLKPORT_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL1B_UID_PPMU_S0_NOCL1B_IPCLKPORT_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL1B_UID_PPMU_S0_NOCL1B_IPCLKPORT_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_NOCL1B_UID_ECU_NOCL1B_IPCLKPORT_CLK, DIV_CLK_NOCL1B_ECU, CLK_CON_GAT_CLK_BLK_NOCL1B_UID_ECU_NOCL1B_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL1B_UID_ECU_NOCL1B_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL1B_UID_ECU_NOCL1B_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_NOCL1B_UID_RSTNSYNC_SR_CLK_NOCL1B_ECU_IPCLKPORT_CLK, DIV_CLK_NOCL1B_ECU, CLK_CON_GAT_CLK_BLK_NOCL1B_UID_RSTNSYNC_SR_CLK_NOCL1B_ECU_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL1B_UID_RSTNSYNC_SR_CLK_NOCL1B_ECU_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL1B_UID_RSTNSYNC_SR_CLK_NOCL1B_ECU_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_NOCL1C_UID_LH_AXI_MI_D2_MCFP_IPCLKPORT_I_CLK, MUX_CLKCMU_NOCL1C_NOC_USER, CLK_CON_GAT_CLK_BLK_NOCL1C_UID_LH_AXI_MI_D2_MCFP_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL1C_UID_LH_AXI_MI_D2_MCFP_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL1C_UID_LH_AXI_MI_D2_MCFP_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_NOCL1C_UID_LH_ACEL_MI_D0_MCFP_IPCLKPORT_I_CLK, MUX_CLKCMU_NOCL1C_NOC_USER, CLK_CON_GAT_CLK_BLK_NOCL1C_UID_LH_ACEL_MI_D0_MCFP_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL1C_UID_LH_ACEL_MI_D0_MCFP_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL1C_UID_LH_ACEL_MI_D0_MCFP_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_NOCL1C_UID_LH_AXI_MI_D1_MCFP_IPCLKPORT_I_CLK, MUX_CLKCMU_NOCL1C_NOC_USER, CLK_CON_GAT_CLK_BLK_NOCL1C_UID_LH_AXI_MI_D1_MCFP_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL1C_UID_LH_AXI_MI_D1_MCFP_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL1C_UID_LH_AXI_MI_D1_MCFP_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_NOCL1C_UID_LH_AST_MI_G_DEBUG_MUX_NOCL1C_INT_IPCLKPORT_I_CLK, MUX_CLKCMU_NOCL1C_NOC_USER, CLK_CON_GAT_CLK_BLK_NOCL1C_UID_LH_AST_MI_G_DEBUG_MUX_NOCL1C_INT_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL1C_UID_LH_AST_MI_G_DEBUG_MUX_NOCL1C_INT_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL1C_UID_LH_AST_MI_G_DEBUG_MUX_NOCL1C_INT_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_NOCL1C_UID_LH_AST_SI_G_DEBUG_MUX_NOCL1C_INT_IPCLKPORT_I_CLK, DIV_CLK_NOCL1C_NOCP, CLK_CON_GAT_CLK_BLK_NOCL1C_UID_LH_AST_SI_G_DEBUG_MUX_NOCL1C_INT_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL1C_UID_LH_AST_SI_G_DEBUG_MUX_NOCL1C_INT_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL1C_UID_LH_AST_SI_G_DEBUG_MUX_NOCL1C_INT_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_NOCL1C_UID_LH_ACEL_MI_D3_MCFP_IPCLKPORT_I_CLK, MUX_CLKCMU_NOCL1C_NOC_USER, CLK_CON_GAT_CLK_BLK_NOCL1C_UID_LH_ACEL_MI_D3_MCFP_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL1C_UID_LH_ACEL_MI_D3_MCFP_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL1C_UID_LH_ACEL_MI_D3_MCFP_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_NOCL1C_UID_LH_ACEL_MI_D4_MCFP_IPCLKPORT_I_CLK, MUX_CLKCMU_NOCL1C_NOC_USER, CLK_CON_GAT_CLK_BLK_NOCL1C_UID_LH_ACEL_MI_D4_MCFP_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL1C_UID_LH_ACEL_MI_D4_MCFP_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL1C_UID_LH_ACEL_MI_D4_MCFP_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_NOCL1C_UID_LH_AXI_MI_D_BRP_IPCLKPORT_I_CLK, MUX_CLKCMU_NOCL1C_NOC_USER, CLK_CON_GAT_CLK_BLK_NOCL1C_UID_LH_AXI_MI_D_BRP_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL1C_UID_LH_AXI_MI_D_BRP_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL1C_UID_LH_AXI_MI_D_BRP_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_NOCL1C_UID_LH_AXI_MI_D0_RGBP_IPCLKPORT_I_CLK, MUX_CLKCMU_NOCL1C_NOC_USER, CLK_CON_GAT_CLK_BLK_NOCL1C_UID_LH_AXI_MI_D0_RGBP_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL1C_UID_LH_AXI_MI_D0_RGBP_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL1C_UID_LH_AXI_MI_D0_RGBP_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_NOCL1C_UID_LH_AXI_MI_D1_RGBP_IPCLKPORT_I_CLK, MUX_CLKCMU_NOCL1C_NOC_USER, CLK_CON_GAT_CLK_BLK_NOCL1C_UID_LH_AXI_MI_D1_RGBP_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL1C_UID_LH_AXI_MI_D1_RGBP_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL1C_UID_LH_AXI_MI_D1_RGBP_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_NOCL1C_UID_LH_AXI_MI_D1_YUVP_IPCLKPORT_I_CLK, MUX_CLKCMU_NOCL1C_NOC_USER, CLK_CON_GAT_CLK_BLK_NOCL1C_UID_LH_AXI_MI_D1_YUVP_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL1C_UID_LH_AXI_MI_D1_YUVP_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL1C_UID_LH_AXI_MI_D1_YUVP_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_NOCL1C_UID_SLH_AXI_SI_P_ICPU_IPCLKPORT_I_CLK, DIV_CLK_NOCL1C_NOCP, CLK_CON_GAT_CLK_BLK_NOCL1C_UID_SLH_AXI_SI_P_ICPU_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL1C_UID_SLH_AXI_SI_P_ICPU_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL1C_UID_SLH_AXI_SI_P_ICPU_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_NOCL1C_UID_SLH_AXI_SI_P_RGBP_IPCLKPORT_I_CLK, DIV_CLK_NOCL1C_NOCP, CLK_CON_GAT_CLK_BLK_NOCL1C_UID_SLH_AXI_SI_P_RGBP_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL1C_UID_SLH_AXI_SI_P_RGBP_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL1C_UID_SLH_AXI_SI_P_RGBP_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_NOCL1C_UID_LH_ACEL_MI_D_ICPU_IPCLKPORT_I_CLK, MUX_CLKCMU_NOCL1C_NOC_USER, CLK_CON_GAT_CLK_BLK_NOCL1C_UID_LH_ACEL_MI_D_ICPU_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL1C_UID_LH_ACEL_MI_D_ICPU_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL1C_UID_LH_ACEL_MI_D_ICPU_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_NOCL1C_UID_TREX_P_NOCL1C_IPCLKPORT_ACLK_NOCL1C, MUX_CLKCMU_NOCL1C_NOC_USER, CLK_CON_GAT_CLK_BLK_NOCL1C_UID_TREX_P_NOCL1C_IPCLKPORT_ACLK_NOCL1C_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL1C_UID_TREX_P_NOCL1C_IPCLKPORT_ACLK_NOCL1C_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL1C_UID_TREX_P_NOCL1C_IPCLKPORT_ACLK_NOCL1C_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_NOCL1C_UID_SLH_AST_MI_G_PPMU_ICPU_IPCLKPORT_I_CLK, MUX_CLKCMU_NOCL1C_NOC_USER, CLK_CON_GAT_CLK_BLK_NOCL1C_UID_SLH_AST_MI_G_PPMU_ICPU_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL1C_UID_SLH_AST_MI_G_PPMU_ICPU_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL1C_UID_SLH_AST_MI_G_PPMU_ICPU_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_NOCL1C_UID_SLH_AST_MI_G_PPMU_RGBP_IPCLKPORT_I_CLK, MUX_CLKCMU_NOCL1C_NOC_USER, CLK_CON_GAT_CLK_BLK_NOCL1C_UID_SLH_AST_MI_G_PPMU_RGBP_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL1C_UID_SLH_AST_MI_G_PPMU_RGBP_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL1C_UID_SLH_AST_MI_G_PPMU_RGBP_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_NOCL1C_UID_LH_TAXI_MI_P_NOCL0_NOCL1C_IPCLKPORT_I_CLK, DIV_CLK_NOCL1C_NOCP, CLK_CON_GAT_CLK_BLK_NOCL1C_UID_LH_TAXI_MI_P_NOCL0_NOCL1C_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL1C_UID_LH_TAXI_MI_P_NOCL0_NOCL1C_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL1C_UID_LH_TAXI_MI_P_NOCL0_NOCL1C_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_NOCL1C_UID_LH_TAXI_SI_D0_NOCL1C_NOCL0_IPCLKPORT_I_CLK, MUX_CLKCMU_NOCL1C_NOC_USER, CLK_CON_GAT_CLK_BLK_NOCL1C_UID_LH_TAXI_SI_D0_NOCL1C_NOCL0_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL1C_UID_LH_TAXI_SI_D0_NOCL1C_NOCL0_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL1C_UID_LH_TAXI_SI_D0_NOCL1C_NOCL0_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_NOCL1C_UID_LH_TAXI_SI_D1_NOCL1C_NOCL0_IPCLKPORT_I_CLK, MUX_CLKCMU_NOCL1C_NOC_USER, CLK_CON_GAT_CLK_BLK_NOCL1C_UID_LH_TAXI_SI_D1_NOCL1C_NOCL0_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL1C_UID_LH_TAXI_SI_D1_NOCL1C_NOCL0_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL1C_UID_LH_TAXI_SI_D1_NOCL1C_NOCL0_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_NOCL1C_UID_ECU_NOCL1C_IPCLKPORT_PCLK, DIV_CLK_NOCL1C_NOCP, CLK_CON_GAT_CLK_BLK_NOCL1C_UID_ECU_NOCL1C_IPCLKPORT_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL1C_UID_ECU_NOCL1C_IPCLKPORT_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL1C_UID_ECU_NOCL1C_IPCLKPORT_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_NOCL1C_UID_PPMU_S0_NOCL1C_IPCLKPORT_ACLK, MUX_CLKCMU_NOCL1C_NOC_USER, CLK_CON_GAT_CLK_BLK_NOCL1C_UID_PPMU_S0_NOCL1C_IPCLKPORT_ACLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL1C_UID_PPMU_S0_NOCL1C_IPCLKPORT_ACLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL1C_UID_PPMU_S0_NOCL1C_IPCLKPORT_ACLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_NOCL1C_UID_PPMU_S0_NOCL1C_IPCLKPORT_PCLK, DIV_CLK_NOCL1C_NOCP, CLK_CON_GAT_CLK_BLK_NOCL1C_UID_PPMU_S0_NOCL1C_IPCLKPORT_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL1C_UID_PPMU_S0_NOCL1C_IPCLKPORT_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL1C_UID_PPMU_S0_NOCL1C_IPCLKPORT_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_NOCL1C_UID_PPMU_S1_NOCL1C_IPCLKPORT_ACLK, MUX_CLKCMU_NOCL1C_NOC_USER, CLK_CON_GAT_CLK_BLK_NOCL1C_UID_PPMU_S1_NOCL1C_IPCLKPORT_ACLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL1C_UID_PPMU_S1_NOCL1C_IPCLKPORT_ACLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL1C_UID_PPMU_S1_NOCL1C_IPCLKPORT_ACLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_NOCL1C_UID_PPMU_S1_NOCL1C_IPCLKPORT_PCLK, DIV_CLK_NOCL1C_NOCP, CLK_CON_GAT_CLK_BLK_NOCL1C_UID_PPMU_S1_NOCL1C_IPCLKPORT_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL1C_UID_PPMU_S1_NOCL1C_IPCLKPORT_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL1C_UID_PPMU_S1_NOCL1C_IPCLKPORT_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_NOCL1C_UID_PPMU_DP_NOCL1C_IPCLKPORT_ACLK, MUX_CLKCMU_NOCL1C_NOC_USER, CLK_CON_GAT_CLK_BLK_NOCL1C_UID_PPMU_DP_NOCL1C_IPCLKPORT_ACLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL1C_UID_PPMU_DP_NOCL1C_IPCLKPORT_ACLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL1C_UID_PPMU_DP_NOCL1C_IPCLKPORT_ACLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_NOCL1C_UID_PPMU_DP_NOCL1C_IPCLKPORT_PCLK, DIV_CLK_NOCL1C_NOCP, CLK_CON_GAT_CLK_BLK_NOCL1C_UID_PPMU_DP_NOCL1C_IPCLKPORT_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL1C_UID_PPMU_DP_NOCL1C_IPCLKPORT_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL1C_UID_PPMU_DP_NOCL1C_IPCLKPORT_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_NOCL1C_UID_SIU_2X1_P1_NOCL1C_IPCLKPORT_I_ACLK, MUX_CLKCMU_NOCL1C_NOC_USER, CLK_CON_GAT_CLK_BLK_NOCL1C_UID_SIU_2X1_P1_NOCL1C_IPCLKPORT_I_ACLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL1C_UID_SIU_2X1_P1_NOCL1C_IPCLKPORT_I_ACLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL1C_UID_SIU_2X1_P1_NOCL1C_IPCLKPORT_I_ACLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_NOCL1C_UID_SIU_2X1_P0_NOCL1C_IPCLKPORT_I_ACLK, MUX_CLKCMU_NOCL1C_NOC_USER, CLK_CON_GAT_CLK_BLK_NOCL1C_UID_SIU_2X1_P0_NOCL1C_IPCLKPORT_I_ACLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL1C_UID_SIU_2X1_P0_NOCL1C_IPCLKPORT_I_ACLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL1C_UID_SIU_2X1_P0_NOCL1C_IPCLKPORT_I_ACLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_NOCL1C_UID_SLH_AXI_SI_P_MCFP_IPCLKPORT_I_CLK, DIV_CLK_NOCL1C_NOCP, CLK_CON_GAT_CLK_BLK_NOCL1C_UID_SLH_AXI_SI_P_MCFP_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL1C_UID_SLH_AXI_SI_P_MCFP_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL1C_UID_SLH_AXI_SI_P_MCFP_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_NOCL1C_UID_SLH_AST_MI_G_PPMU_MCFP_IPCLKPORT_I_CLK, MUX_CLKCMU_NOCL1C_NOC_USER, CLK_CON_GAT_CLK_BLK_NOCL1C_UID_SLH_AST_MI_G_PPMU_MCFP_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL1C_UID_SLH_AST_MI_G_PPMU_MCFP_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL1C_UID_SLH_AST_MI_G_PPMU_MCFP_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_NOCL1C_UID_ECU_NOCL1C_IPCLKPORT_CLK, DIV_CLK_NOCL1C_ECU, CLK_CON_GAT_CLK_BLK_NOCL1C_UID_ECU_NOCL1C_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL1C_UID_ECU_NOCL1C_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL1C_UID_ECU_NOCL1C_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_NOCL1C_UID_RSTNSYNC_SR_CLK_NOCL1C_ECU_IPCLKPORT_CLK, DIV_CLK_NOCL1C_ECU, CLK_CON_GAT_CLK_BLK_NOCL1C_UID_RSTNSYNC_SR_CLK_NOCL1C_ECU_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_NOCL1C_UID_RSTNSYNC_SR_CLK_NOCL1C_ECU_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_NOCL1C_UID_RSTNSYNC_SR_CLK_NOCL1C_ECU_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_PERIC0_UID_I3C04_IPCLKPORT_I_PCLK, MUX_CLKCMU_PERIC0_NOC_USER, CLK_CON_GAT_CLK_BLK_PERIC0_UID_I3C04_IPCLKPORT_I_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_PERIC0_UID_I3C04_IPCLKPORT_I_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_PERIC0_UID_I3C04_IPCLKPORT_I_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_PERIC0_UID_I3C04_IPCLKPORT_I_SCLK, DIV_CLK_PERIC0_I2C, CLK_CON_GAT_CLK_BLK_PERIC0_UID_I3C04_IPCLKPORT_I_SCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_PERIC0_UID_I3C04_IPCLKPORT_I_SCLK_MANUAL, CLK_CON_GAT_CLK_BLK_PERIC0_UID_I3C04_IPCLKPORT_I_SCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_PERIC0_UID_I3C05_IPCLKPORT_I_PCLK, MUX_CLKCMU_PERIC0_NOC_USER, CLK_CON_GAT_CLK_BLK_PERIC0_UID_I3C05_IPCLKPORT_I_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_PERIC0_UID_I3C05_IPCLKPORT_I_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_PERIC0_UID_I3C05_IPCLKPORT_I_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_PERIC0_UID_I3C05_IPCLKPORT_I_SCLK, DIV_CLK_PERIC0_I2C, CLK_CON_GAT_CLK_BLK_PERIC0_UID_I3C05_IPCLKPORT_I_SCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_PERIC0_UID_I3C05_IPCLKPORT_I_SCLK_MANUAL, CLK_CON_GAT_CLK_BLK_PERIC0_UID_I3C05_IPCLKPORT_I_SCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_PERIC0_UID_PWM_IPCLKPORT_I_PCLK_S0, MUX_CLKCMU_PERIC0_NOC_USER, CLK_CON_GAT_CLK_BLK_PERIC0_UID_PWM_IPCLKPORT_I_PCLK_S0_CG_VAL, CLK_CON_GAT_CLK_BLK_PERIC0_UID_PWM_IPCLKPORT_I_PCLK_S0_MANUAL, CLK_CON_GAT_CLK_BLK_PERIC0_UID_PWM_IPCLKPORT_I_PCLK_S0_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_PERIC0_UID_USI10_USI_IPCLKPORT_PCLK, MUX_CLKCMU_PERIC0_NOC_USER, CLK_CON_GAT_CLK_BLK_PERIC0_UID_USI10_USI_IPCLKPORT_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_PERIC0_UID_USI10_USI_IPCLKPORT_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_PERIC0_UID_USI10_USI_IPCLKPORT_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_PERIC0_UID_USI10_I2C_IPCLKPORT_IPCLK, DIV_CLK_PERIC0_I2C, CLK_CON_GAT_CLK_BLK_PERIC0_UID_USI10_I2C_IPCLKPORT_IPCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_PERIC0_UID_USI10_I2C_IPCLKPORT_IPCLK_MANUAL, CLK_CON_GAT_CLK_BLK_PERIC0_UID_USI10_I2C_IPCLKPORT_IPCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_PERIC0_UID_USI10_I2C_IPCLKPORT_PCLK, MUX_CLKCMU_PERIC0_NOC_USER, CLK_CON_GAT_CLK_BLK_PERIC0_UID_USI10_I2C_IPCLKPORT_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_PERIC0_UID_USI10_I2C_IPCLKPORT_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_PERIC0_UID_USI10_I2C_IPCLKPORT_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_PERIC0_UID_USI10_USI_IPCLKPORT_IPCLK, DIV_CLK_PERIC0_USI10, CLK_CON_GAT_CLK_BLK_PERIC0_UID_USI10_USI_IPCLKPORT_IPCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_PERIC0_UID_USI10_USI_IPCLKPORT_IPCLK_MANUAL, CLK_CON_GAT_CLK_BLK_PERIC0_UID_USI10_USI_IPCLKPORT_IPCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_PERIC0_UID_RSTNSYNC_SR_CLK_PERIC0_USI10_IPCLKPORT_CLK, DIV_CLK_PERIC0_USI10, CLK_CON_GAT_CLK_BLK_PERIC0_UID_RSTNSYNC_SR_CLK_PERIC0_USI10_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_PERIC0_UID_RSTNSYNC_SR_CLK_PERIC0_USI10_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_PERIC0_UID_RSTNSYNC_SR_CLK_PERIC0_USI10_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_PERIC0_UID_RSTNSYNC_SR_CLK_PERIC0_DBG_UART_IPCLKPORT_CLK, DIV_CLK_PERIC0_DBG_UART, CLK_CON_GAT_CLK_BLK_PERIC0_UID_RSTNSYNC_SR_CLK_PERIC0_DBG_UART_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_PERIC0_UID_RSTNSYNC_SR_CLK_PERIC0_DBG_UART_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_PERIC0_UID_RSTNSYNC_SR_CLK_PERIC0_DBG_UART_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_PERIC0_UID_DBG_UART_IPCLKPORT_IPCLK, DIV_CLK_PERIC0_DBG_UART, CLK_CON_GAT_CLK_BLK_PERIC0_UID_DBG_UART_IPCLKPORT_IPCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_PERIC0_UID_DBG_UART_IPCLKPORT_IPCLK_MANUAL, CLK_CON_GAT_CLK_BLK_PERIC0_UID_DBG_UART_IPCLKPORT_IPCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_PERIC0_UID_DBG_UART_IPCLKPORT_PCLK, MUX_CLKCMU_PERIC0_NOC_USER, CLK_CON_GAT_CLK_BLK_PERIC0_UID_DBG_UART_IPCLKPORT_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_PERIC0_UID_DBG_UART_IPCLKPORT_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_PERIC0_UID_DBG_UART_IPCLKPORT_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_PERIC0_UID_USI12_I2C_IPCLKPORT_IPCLK, DIV_CLK_PERIC0_I2C, CLK_CON_GAT_CLK_BLK_PERIC0_UID_USI12_I2C_IPCLKPORT_IPCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_PERIC0_UID_USI12_I2C_IPCLKPORT_IPCLK_MANUAL, CLK_CON_GAT_CLK_BLK_PERIC0_UID_USI12_I2C_IPCLKPORT_IPCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_PERIC0_UID_USI12_I2C_IPCLKPORT_PCLK, MUX_CLKCMU_PERIC0_NOC_USER, CLK_CON_GAT_CLK_BLK_PERIC0_UID_USI12_I2C_IPCLKPORT_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_PERIC0_UID_USI12_I2C_IPCLKPORT_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_PERIC0_UID_USI12_I2C_IPCLKPORT_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_PERIC0_UID_USI13_I2C_IPCLKPORT_IPCLK, DIV_CLK_PERIC0_I2C, CLK_CON_GAT_CLK_BLK_PERIC0_UID_USI13_I2C_IPCLKPORT_IPCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_PERIC0_UID_USI13_I2C_IPCLKPORT_IPCLK_MANUAL, CLK_CON_GAT_CLK_BLK_PERIC0_UID_USI13_I2C_IPCLKPORT_IPCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_PERIC0_UID_USI13_I2C_IPCLKPORT_PCLK, MUX_CLKCMU_PERIC0_NOC_USER, CLK_CON_GAT_CLK_BLK_PERIC0_UID_USI13_I2C_IPCLKPORT_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_PERIC0_UID_USI13_I2C_IPCLKPORT_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_PERIC0_UID_USI13_I2C_IPCLKPORT_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_PERIC0_UID_USI14_I2C_IPCLKPORT_IPCLK, DIV_CLK_PERIC0_I2C, CLK_CON_GAT_CLK_BLK_PERIC0_UID_USI14_I2C_IPCLKPORT_IPCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_PERIC0_UID_USI14_I2C_IPCLKPORT_IPCLK_MANUAL, CLK_CON_GAT_CLK_BLK_PERIC0_UID_USI14_I2C_IPCLKPORT_IPCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_PERIC0_UID_USI14_I2C_IPCLKPORT_PCLK, MUX_CLKCMU_PERIC0_NOC_USER, CLK_CON_GAT_CLK_BLK_PERIC0_UID_USI14_I2C_IPCLKPORT_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_PERIC0_UID_USI14_I2C_IPCLKPORT_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_PERIC0_UID_USI14_I2C_IPCLKPORT_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_PERIC0_UID_USI15_I2C_IPCLKPORT_IPCLK, DIV_CLK_PERIC0_I2C, CLK_CON_GAT_CLK_BLK_PERIC0_UID_USI15_I2C_IPCLKPORT_IPCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_PERIC0_UID_USI15_I2C_IPCLKPORT_IPCLK_MANUAL, CLK_CON_GAT_CLK_BLK_PERIC0_UID_USI15_I2C_IPCLKPORT_IPCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_PERIC0_UID_USI15_I2C_IPCLKPORT_PCLK, MUX_CLKCMU_PERIC0_NOC_USER, CLK_CON_GAT_CLK_BLK_PERIC0_UID_USI15_I2C_IPCLKPORT_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_PERIC0_UID_USI15_I2C_IPCLKPORT_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_PERIC0_UID_USI15_I2C_IPCLKPORT_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_PERIC0_UID_USI16_I2C_IPCLKPORT_IPCLK, DIV_CLK_PERIC0_I2C, CLK_CON_GAT_CLK_BLK_PERIC0_UID_USI16_I2C_IPCLKPORT_IPCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_PERIC0_UID_USI16_I2C_IPCLKPORT_IPCLK_MANUAL, CLK_CON_GAT_CLK_BLK_PERIC0_UID_USI16_I2C_IPCLKPORT_IPCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_PERIC0_UID_USI16_I2C_IPCLKPORT_PCLK, MUX_CLKCMU_PERIC0_NOC_USER, CLK_CON_GAT_CLK_BLK_PERIC0_UID_USI16_I2C_IPCLKPORT_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_PERIC0_UID_USI16_I2C_IPCLKPORT_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_PERIC0_UID_USI16_I2C_IPCLKPORT_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_PERIC1_UID_PERIC1_I2C_IPCLKPORT_PCLK, MUX_CLKCMU_PERIC1_NOC_USER, CLK_CON_GAT_CLK_BLK_PERIC1_UID_PERIC1_I2C_IPCLKPORT_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_PERIC1_UID_PERIC1_I2C_IPCLKPORT_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_PERIC1_UID_PERIC1_I2C_IPCLKPORT_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_PERIC1_UID_PERIC1_I2C_IPCLKPORT_IPCLK, DIV_CLK_PERIC1_I2C, CLK_CON_GAT_CLK_BLK_PERIC1_UID_PERIC1_I2C_IPCLKPORT_IPCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_PERIC1_UID_PERIC1_I2C_IPCLKPORT_IPCLK_MANUAL, CLK_CON_GAT_CLK_BLK_PERIC1_UID_PERIC1_I2C_IPCLKPORT_IPCLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_PERIC2_UID_SLH_AXI_MI_P_CSISPERIC2_IPCLKPORT_I_CLK, MUX_CLKCMU_PERIC2_NOC_USER, CLK_CON_GAT_CLK_BLK_PERIC2_UID_SLH_AXI_MI_P_CSISPERIC2_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_PERIC2_UID_SLH_AXI_MI_P_CSISPERIC2_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_PERIC2_UID_SLH_AXI_MI_P_CSISPERIC2_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_PERIC2_UID_USI21_I2C_IPCLKPORT_IPCLK, DIV_CLK_PERIC2_I2C, CLK_CON_GAT_CLK_BLK_PERIC2_UID_USI21_I2C_IPCLKPORT_IPCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_PERIC2_UID_USI21_I2C_IPCLKPORT_IPCLK_MANUAL, CLK_CON_GAT_CLK_BLK_PERIC2_UID_USI21_I2C_IPCLKPORT_IPCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_PERIC2_UID_USI21_I2C_IPCLKPORT_PCLK, MUX_CLKCMU_PERIC2_NOC_USER, CLK_CON_GAT_CLK_BLK_PERIC2_UID_USI21_I2C_IPCLKPORT_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_PERIC2_UID_USI21_I2C_IPCLKPORT_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_PERIC2_UID_USI21_I2C_IPCLKPORT_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_PERIC2_UID_USI20_I2C_IPCLKPORT_IPCLK, DIV_CLK_PERIC2_I2C, CLK_CON_GAT_CLK_BLK_PERIC2_UID_USI20_I2C_IPCLKPORT_IPCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_PERIC2_UID_USI20_I2C_IPCLKPORT_IPCLK_MANUAL, CLK_CON_GAT_CLK_BLK_PERIC2_UID_USI20_I2C_IPCLKPORT_IPCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_PERIC2_UID_USI20_I2C_IPCLKPORT_PCLK, MUX_CLKCMU_PERIC2_NOC_USER, CLK_CON_GAT_CLK_BLK_PERIC2_UID_USI20_I2C_IPCLKPORT_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_PERIC2_UID_USI20_I2C_IPCLKPORT_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_PERIC2_UID_USI20_I2C_IPCLKPORT_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_PERIC2_UID_USI19_I2C_IPCLKPORT_IPCLK, DIV_CLK_PERIC2_I2C, CLK_CON_GAT_CLK_BLK_PERIC2_UID_USI19_I2C_IPCLKPORT_IPCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_PERIC2_UID_USI19_I2C_IPCLKPORT_IPCLK_MANUAL, CLK_CON_GAT_CLK_BLK_PERIC2_UID_USI19_I2C_IPCLKPORT_IPCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_PERIC2_UID_USI19_I2C_IPCLKPORT_PCLK, MUX_CLKCMU_PERIC2_NOC_USER, CLK_CON_GAT_CLK_BLK_PERIC2_UID_USI19_I2C_IPCLKPORT_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_PERIC2_UID_USI19_I2C_IPCLKPORT_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_PERIC2_UID_USI19_I2C_IPCLKPORT_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_PERIC2_UID_USI18_I2C_IPCLKPORT_IPCLK, DIV_CLK_PERIC2_I2C, CLK_CON_GAT_CLK_BLK_PERIC2_UID_USI18_I2C_IPCLKPORT_IPCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_PERIC2_UID_USI18_I2C_IPCLKPORT_IPCLK_MANUAL, CLK_CON_GAT_CLK_BLK_PERIC2_UID_USI18_I2C_IPCLKPORT_IPCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_PERIC2_UID_USI18_I2C_IPCLKPORT_PCLK, MUX_CLKCMU_PERIC2_NOC_USER, CLK_CON_GAT_CLK_BLK_PERIC2_UID_USI18_I2C_IPCLKPORT_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_PERIC2_UID_USI18_I2C_IPCLKPORT_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_PERIC2_UID_USI18_I2C_IPCLKPORT_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_PERIC2_UID_USI17_I2C_IPCLKPORT_IPCLK, DIV_CLK_PERIC2_I2C, CLK_CON_GAT_CLK_BLK_PERIC2_UID_USI17_I2C_IPCLKPORT_IPCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_PERIC2_UID_USI17_I2C_IPCLKPORT_IPCLK_MANUAL, CLK_CON_GAT_CLK_BLK_PERIC2_UID_USI17_I2C_IPCLKPORT_IPCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_PERIC2_UID_USI17_I2C_IPCLKPORT_PCLK, MUX_CLKCMU_PERIC2_NOC_USER, CLK_CON_GAT_CLK_BLK_PERIC2_UID_USI17_I2C_IPCLKPORT_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_PERIC2_UID_USI17_I2C_IPCLKPORT_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_PERIC2_UID_USI17_I2C_IPCLKPORT_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_PERIS_UID_LH_AST_MI_D_CPUCL0PERIS_ICC_CPUGIC_CLUSTER0_IPCLKPORT_I_CLK, MUX_CLK_PERIS_GIC, CLK_CON_GAT_CLK_BLK_PERIS_UID_LH_AST_MI_D_CPUCL0PERIS_ICC_CPUGIC_CLUSTER0_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_PERIS_UID_LH_AST_MI_D_CPUCL0PERIS_ICC_CPUGIC_CLUSTER0_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_PERIS_UID_LH_AST_MI_D_CPUCL0PERIS_ICC_CPUGIC_CLUSTER0_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_PERIS_UID_LH_AST_SI_D_PERISCPUCL0_IRI_GICCPU_CLUSTER0_IPCLKPORT_I_CLK, MUX_CLK_PERIS_GIC, CLK_CON_GAT_CLK_BLK_PERIS_UID_LH_AST_SI_D_PERISCPUCL0_IRI_GICCPU_CLUSTER0_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_PERIS_UID_LH_AST_SI_D_PERISCPUCL0_IRI_GICCPU_CLUSTER0_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_PERIS_UID_LH_AST_SI_D_PERISCPUCL0_IRI_GICCPU_CLUSTER0_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_PERIS_UID_TMU_1_IPCLKPORT_PCLK, MUX_CLKCMU_PERIS_NOC_USER, CLK_CON_GAT_CLK_BLK_PERIS_UID_TMU_1_IPCLKPORT_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_PERIS_UID_TMU_1_IPCLKPORT_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_PERIS_UID_TMU_1_IPCLKPORT_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_PERIS_UID_TMU_0_IPCLKPORT_PCLK, MUX_CLKCMU_PERIS_NOC_USER, CLK_CON_GAT_CLK_BLK_PERIS_UID_TMU_0_IPCLKPORT_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_PERIS_UID_TMU_0_IPCLKPORT_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_PERIS_UID_TMU_0_IPCLKPORT_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_PERIS_UID_OTP_CON_BISR_IPCLKPORT_I_OSCCLK, FREE_OSCCLK_PERIS, CLK_CON_GAT_CLK_BLK_PERIS_UID_OTP_CON_BISR_IPCLKPORT_I_OSCCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_PERIS_UID_OTP_CON_BISR_IPCLKPORT_I_OSCCLK_MANUAL, CLK_CON_GAT_CLK_BLK_PERIS_UID_OTP_CON_BISR_IPCLKPORT_I_OSCCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_PERIS_UID_OTP_CON_BISR_IPCLKPORT_PCLK, MUX_CLKCMU_PERIS_NOC_USER, CLK_CON_GAT_CLK_BLK_PERIS_UID_OTP_CON_BISR_IPCLKPORT_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_PERIS_UID_OTP_CON_BISR_IPCLKPORT_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_PERIS_UID_OTP_CON_BISR_IPCLKPORT_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_PERIS_UID_TMU_2_IPCLKPORT_PCLK, MUX_CLKCMU_PERIS_NOC_USER, CLK_CON_GAT_CLK_BLK_PERIS_UID_TMU_2_IPCLKPORT_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_PERIS_UID_TMU_2_IPCLKPORT_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_PERIS_UID_TMU_2_IPCLKPORT_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_PERIS_UID_SPC_PERIS_IPCLKPORT_PCLK, MUX_CLKCMU_PERIS_NOC_USER, CLK_CON_GAT_CLK_BLK_PERIS_UID_SPC_PERIS_IPCLKPORT_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_PERIS_UID_SPC_PERIS_IPCLKPORT_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_PERIS_UID_SPC_PERIS_IPCLKPORT_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_PERIS_UID_MCT_SUB_IPCLKPORT_PCLK, MUX_CLKCMU_PERIS_NOC_USER, CLK_CON_GAT_CLK_BLK_PERIS_UID_MCT_SUB_IPCLKPORT_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_PERIS_UID_MCT_SUB_IPCLKPORT_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_PERIS_UID_MCT_SUB_IPCLKPORT_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_PERIS_UID_TMU_3_IPCLKPORT_PCLK, MUX_CLKCMU_PERIS_NOC_USER, CLK_CON_GAT_CLK_BLK_PERIS_UID_TMU_3_IPCLKPORT_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_PERIS_UID_TMU_3_IPCLKPORT_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_PERIS_UID_TMU_3_IPCLKPORT_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_RGBP_UID_LH_AXI_SI_D0_RGBP_IPCLKPORT_I_CLK, MUX_CLKCMU_RGBP_NOC_USER, CLK_CON_GAT_CLK_BLK_RGBP_UID_LH_AXI_SI_D0_RGBP_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_RGBP_UID_LH_AXI_SI_D0_RGBP_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_RGBP_UID_LH_AXI_SI_D0_RGBP_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_RGBP_UID_XIU_MMU_RGBP_IPCLKPORT_ACLK, MUX_CLKCMU_RGBP_NOC_USER, CLK_CON_GAT_CLK_BLK_RGBP_UID_XIU_MMU_RGBP_IPCLKPORT_ACLK_CG_VAL, CLK_CON_GAT_CLK_BLK_RGBP_UID_XIU_MMU_RGBP_IPCLKPORT_ACLK_MANUAL, CLK_CON_GAT_CLK_BLK_RGBP_UID_XIU_MMU_RGBP_IPCLKPORT_ACLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_RGBP_UID_BLK_RGBP_FRC_OTP_DESERIAL_IPCLKPORT_I_CLK, FREE_OSCCLK_RGBP, CLK_CON_GAT_CLK_BLK_RGBP_UID_BLK_RGBP_FRC_OTP_DESERIAL_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_RGBP_UID_BLK_RGBP_FRC_OTP_DESERIAL_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_RGBP_UID_BLK_RGBP_FRC_OTP_DESERIAL_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_RGBP_UID_PPMU_D0_RGBP_IPCLKPORT_ACLK, MUX_CLKCMU_RGBP_NOC_USER, CLK_CON_GAT_CLK_BLK_RGBP_UID_PPMU_D0_RGBP_IPCLKPORT_ACLK_CG_VAL, CLK_CON_GAT_CLK_BLK_RGBP_UID_PPMU_D0_RGBP_IPCLKPORT_ACLK_MANUAL, CLK_CON_GAT_CLK_BLK_RGBP_UID_PPMU_D0_RGBP_IPCLKPORT_ACLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_RGBP_UID_VGEN_LITE_RGBP_IPCLKPORT_CLK, MUX_CLKCMU_RGBP_NOC_USER, CLK_CON_GAT_CLK_BLK_RGBP_UID_VGEN_LITE_RGBP_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_RGBP_UID_VGEN_LITE_RGBP_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_RGBP_UID_VGEN_LITE_RGBP_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_RGBP_UID_L_SIU_RGBP_IPCLKPORT_I_ACLK, MUX_CLKCMU_RGBP_NOC_USER, CLK_CON_GAT_CLK_BLK_RGBP_UID_L_SIU_RGBP_IPCLKPORT_I_ACLK_CG_VAL, CLK_CON_GAT_CLK_BLK_RGBP_UID_L_SIU_RGBP_IPCLKPORT_I_ACLK_MANUAL, CLK_CON_GAT_CLK_BLK_RGBP_UID_L_SIU_RGBP_IPCLKPORT_I_ACLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_RGBP_UID_LH_AST_SI_OTF_RGBPMCFP_IPCLKPORT_I_CLK, MUX_CLKCMU_RGBP_NOC_USER, CLK_CON_GAT_CLK_BLK_RGBP_UID_LH_AST_SI_OTF_RGBPMCFP_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_RGBP_UID_LH_AST_SI_OTF_RGBPMCFP_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_RGBP_UID_LH_AST_SI_OTF_RGBPMCFP_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_RGBP_UID_SYSMMU_RGBP_S0_PMMU1_IPCLKPORT_CLK, MUX_CLKCMU_RGBP_NOC_USER, CLK_CON_GAT_CLK_BLK_RGBP_UID_SYSMMU_RGBP_S0_PMMU1_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_RGBP_UID_SYSMMU_RGBP_S0_PMMU1_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_RGBP_UID_SYSMMU_RGBP_S0_PMMU1_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_RGBP_UID_SYSMMU_RGBP_S0_IPCLKPORT_CLK, MUX_CLKCMU_RGBP_NOC_USER, CLK_CON_GAT_CLK_BLK_RGBP_UID_SYSMMU_RGBP_S0_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_RGBP_UID_SYSMMU_RGBP_S0_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_RGBP_UID_SYSMMU_RGBP_S0_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_RGBP_UID_RGBP_IPCLKPORT_CLK, MUX_CLKCMU_RGBP_NOC_USER, CLK_CON_GAT_CLK_BLK_RGBP_UID_RGBP_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_RGBP_UID_RGBP_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_RGBP_UID_RGBP_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_RGBP_UID_RGBP_IPCLKPORT_CLK_VOTF1, MUX_CLKCMU_RGBP_NOC_USER, CLK_CON_GAT_CLK_BLK_RGBP_UID_RGBP_IPCLKPORT_CLK_VOTF1_CG_VAL, CLK_CON_GAT_CLK_BLK_RGBP_UID_RGBP_IPCLKPORT_CLK_VOTF1_MANUAL, CLK_CON_GAT_CLK_BLK_RGBP_UID_RGBP_IPCLKPORT_CLK_VOTF1_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_RGBP_UID_RGBP_IPCLKPORT_CLK_VOTF0, MUX_CLKCMU_RGBP_NOC_USER, CLK_CON_GAT_CLK_BLK_RGBP_UID_RGBP_IPCLKPORT_CLK_VOTF0_CG_VAL, CLK_CON_GAT_CLK_BLK_RGBP_UID_RGBP_IPCLKPORT_CLK_VOTF0_MANUAL, CLK_CON_GAT_CLK_BLK_RGBP_UID_RGBP_IPCLKPORT_CLK_VOTF0_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_RGBP_UID_XIU_D1_RGBP_IPCLKPORT_ACLK, MUX_CLKCMU_RGBP_NOC_USER, CLK_CON_GAT_CLK_BLK_RGBP_UID_XIU_D1_RGBP_IPCLKPORT_ACLK_CG_VAL, CLK_CON_GAT_CLK_BLK_RGBP_UID_XIU_D1_RGBP_IPCLKPORT_ACLK_MANUAL, CLK_CON_GAT_CLK_BLK_RGBP_UID_XIU_D1_RGBP_IPCLKPORT_ACLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_RGBP_UID_SLH_AST_SI_G_PPMU_RGBP_IPCLKPORT_I_CLK, MUX_CLKCMU_RGBP_NOC_USER, CLK_CON_GAT_CLK_BLK_RGBP_UID_SLH_AST_SI_G_PPMU_RGBP_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_RGBP_UID_SLH_AST_SI_G_PPMU_RGBP_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_RGBP_UID_SLH_AST_SI_G_PPMU_RGBP_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_RGBP_UID_AD_APB_RGBP_IPCLKPORT_PCLKM, MUX_CLKCMU_RGBP_NOC_USER, CLK_CON_GAT_CLK_BLK_RGBP_UID_AD_APB_RGBP_IPCLKPORT_PCLKM_CG_VAL, CLK_CON_GAT_CLK_BLK_RGBP_UID_AD_APB_RGBP_IPCLKPORT_PCLKM_MANUAL, CLK_CON_GAT_CLK_BLK_RGBP_UID_AD_APB_RGBP_IPCLKPORT_PCLKM_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_RGBP_UID_XIU_D0_RGBP_IPCLKPORT_ACLK, MUX_CLKCMU_RGBP_NOC_USER, CLK_CON_GAT_CLK_BLK_RGBP_UID_XIU_D0_RGBP_IPCLKPORT_ACLK_CG_VAL, CLK_CON_GAT_CLK_BLK_RGBP_UID_XIU_D0_RGBP_IPCLKPORT_ACLK_MANUAL, CLK_CON_GAT_CLK_BLK_RGBP_UID_XIU_D0_RGBP_IPCLKPORT_ACLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_RGBP_UID_LH_AXI_SI_D1_RGBP_IPCLKPORT_I_CLK, MUX_CLKCMU_RGBP_NOC_USER, CLK_CON_GAT_CLK_BLK_RGBP_UID_LH_AXI_SI_D1_RGBP_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_RGBP_UID_LH_AXI_SI_D1_RGBP_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_RGBP_UID_LH_AXI_SI_D1_RGBP_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_RGBP_UID_SYSMMU_RGBP_S0_PMMU0_IPCLKPORT_CLK, MUX_CLKCMU_RGBP_NOC_USER, CLK_CON_GAT_CLK_BLK_RGBP_UID_SYSMMU_RGBP_S0_PMMU0_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_RGBP_UID_SYSMMU_RGBP_S0_PMMU0_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_RGBP_UID_SYSMMU_RGBP_S0_PMMU0_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_RGBP_UID_LH_AST_MI_OTF_BRPRGBP_IPCLKPORT_I_CLK, MUX_CLKCMU_RGBP_NOC_USER, CLK_CON_GAT_CLK_BLK_RGBP_UID_LH_AST_MI_OTF_BRPRGBP_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_RGBP_UID_LH_AST_MI_OTF_BRPRGBP_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_RGBP_UID_LH_AST_MI_OTF_BRPRGBP_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_RGBP_UID_PPMU_D1_RGBP_IPCLKPORT_ACLK, MUX_CLKCMU_RGBP_NOC_USER, CLK_CON_GAT_CLK_BLK_RGBP_UID_PPMU_D1_RGBP_IPCLKPORT_ACLK_CG_VAL, CLK_CON_GAT_CLK_BLK_RGBP_UID_PPMU_D1_RGBP_IPCLKPORT_ACLK_MANUAL, CLK_CON_GAT_CLK_BLK_RGBP_UID_PPMU_D1_RGBP_IPCLKPORT_ACLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_RGBP_UID_RSTNSYNC_CLK_RGBP_NOCD_IPCLKPORT_CLK, MUX_CLKCMU_RGBP_NOC_USER, CLK_CON_GAT_CLK_BLK_RGBP_UID_RSTNSYNC_CLK_RGBP_NOCD_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_RGBP_UID_RSTNSYNC_CLK_RGBP_NOCD_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_RGBP_UID_RSTNSYNC_CLK_RGBP_NOCD_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_RGBP_UID_RSTNSYNC_SR_CLK_RGBP_FREE_OSCCLK_IPCLKPORT_CLK, FREE_OSCCLK_RGBP, CLK_CON_GAT_CLK_BLK_RGBP_UID_RSTNSYNC_SR_CLK_RGBP_FREE_OSCCLK_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_RGBP_UID_RSTNSYNC_SR_CLK_RGBP_FREE_OSCCLK_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_RGBP_UID_RSTNSYNC_SR_CLK_RGBP_FREE_OSCCLK_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_RGBP_UID_RSTNSYNC_SR_CLK_RGBP_NOCD_IPCLKPORT_CLK, MUX_CLKCMU_RGBP_NOC_USER, CLK_CON_GAT_CLK_BLK_RGBP_UID_RSTNSYNC_SR_CLK_RGBP_NOCD_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_RGBP_UID_RSTNSYNC_SR_CLK_RGBP_NOCD_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_RGBP_UID_RSTNSYNC_SR_CLK_RGBP_NOCD_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_RGBP_UID_RSTNSYNC_SR_CLK_RGBP_NOCP_IPCLKPORT_CLK, DIV_CLK_RGBP_NOCP, CLK_CON_GAT_CLK_BLK_RGBP_UID_RSTNSYNC_SR_CLK_RGBP_NOCP_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_RGBP_UID_RSTNSYNC_SR_CLK_RGBP_NOCP_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_RGBP_UID_RSTNSYNC_SR_CLK_RGBP_NOCP_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_RGBP_UID_LH_AXI_MI_D_BRPRGBP_IPCLKPORT_I_CLK, MUX_CLKCMU_RGBP_NOC_USER, CLK_CON_GAT_CLK_BLK_RGBP_UID_LH_AXI_MI_D_BRPRGBP_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_RGBP_UID_LH_AXI_MI_D_BRPRGBP_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_RGBP_UID_LH_AXI_MI_D_BRPRGBP_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_S2D_UID_SLH_AXI_MI_G_ALIVEMIF_SCAN2DRAM_IPCLKPORT_I_CLK, MUX_CLK_S2D_CORE, CLK_CON_GAT_CLK_BLK_S2D_UID_SLH_AXI_MI_G_ALIVEMIF_SCAN2DRAM_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_S2D_UID_SLH_AXI_MI_G_ALIVEMIF_SCAN2DRAM_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_S2D_UID_SLH_AXI_MI_G_ALIVEMIF_SCAN2DRAM_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_SDMA_UID_LH_AST_MI_D_SRAM_WR1_GNPU1_SDMA_IPCLKPORT_I_CLK, DIV_CLK_SDMA_NOC, CLK_CON_GAT_CLK_BLK_SDMA_UID_LH_AST_MI_D_SRAM_WR1_GNPU1_SDMA_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_SDMA_UID_LH_AST_MI_D_SRAM_WR1_GNPU1_SDMA_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_SDMA_UID_LH_AST_MI_D_SRAM_WR1_GNPU1_SDMA_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_SDMA_UID_LH_AST_MI_D_SRAM_WR1_GNPU0_SDMA_IPCLKPORT_I_CLK, DIV_CLK_SDMA_NOC, CLK_CON_GAT_CLK_BLK_SDMA_UID_LH_AST_MI_D_SRAM_WR1_GNPU0_SDMA_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_SDMA_UID_LH_AST_MI_D_SRAM_WR1_GNPU0_SDMA_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_SDMA_UID_LH_AST_MI_D_SRAM_WR1_GNPU0_SDMA_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_SDMA_UID_LH_AST_MI_D_SRAM_WR2_GNPU1_SDMA_IPCLKPORT_I_CLK, DIV_CLK_SDMA_NOC, CLK_CON_GAT_CLK_BLK_SDMA_UID_LH_AST_MI_D_SRAM_WR2_GNPU1_SDMA_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_SDMA_UID_LH_AST_MI_D_SRAM_WR2_GNPU1_SDMA_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_SDMA_UID_LH_AST_MI_D_SRAM_WR2_GNPU1_SDMA_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_SDMA_UID_LH_AST_MI_D_SRAM_WR2_GNPU0_SDMA_IPCLKPORT_I_CLK, DIV_CLK_SDMA_NOC, CLK_CON_GAT_CLK_BLK_SDMA_UID_LH_AST_MI_D_SRAM_WR2_GNPU0_SDMA_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_SDMA_UID_LH_AST_MI_D_SRAM_WR2_GNPU0_SDMA_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_SDMA_UID_LH_AST_MI_D_SRAM_WR2_GNPU0_SDMA_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_SDMA_UID_LH_AST_SI_D_SRAM_RDRSP2_SDMA_GNPU0_IPCLKPORT_I_CLK, DIV_CLK_SDMA_NOC, CLK_CON_GAT_CLK_BLK_SDMA_UID_LH_AST_SI_D_SRAM_RDRSP2_SDMA_GNPU0_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_SDMA_UID_LH_AST_SI_D_SRAM_RDRSP2_SDMA_GNPU0_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_SDMA_UID_LH_AST_SI_D_SRAM_RDRSP2_SDMA_GNPU0_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_SDMA_UID_SLH_AXI_MI_P_DNC_SDMA_IPCLKPORT_I_CLK, DIV_CLK_SDMA_NOCP, CLK_CON_GAT_CLK_BLK_SDMA_UID_SLH_AXI_MI_P_DNC_SDMA_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_SDMA_UID_SLH_AXI_MI_P_DNC_SDMA_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_SDMA_UID_SLH_AXI_MI_P_DNC_SDMA_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_SDMA_UID_LH_AST_SI_D_SRAM_RDRSP1_SDMA_GNPU1_IPCLKPORT_I_CLK, DIV_CLK_SDMA_NOC, CLK_CON_GAT_CLK_BLK_SDMA_UID_LH_AST_SI_D_SRAM_RDRSP1_SDMA_GNPU1_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_SDMA_UID_LH_AST_SI_D_SRAM_RDRSP1_SDMA_GNPU1_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_SDMA_UID_LH_AST_SI_D_SRAM_RDRSP1_SDMA_GNPU1_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_SDMA_UID_LH_AST_MI_D_SRAM_WR0_GNPU1_SDMA_IPCLKPORT_I_CLK, DIV_CLK_SDMA_NOC, CLK_CON_GAT_CLK_BLK_SDMA_UID_LH_AST_MI_D_SRAM_WR0_GNPU1_SDMA_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_SDMA_UID_LH_AST_MI_D_SRAM_WR0_GNPU1_SDMA_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_SDMA_UID_LH_AST_MI_D_SRAM_WR0_GNPU1_SDMA_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_SDMA_UID_IP_SDMA_WRAP_IPCLKPORT_CLK, DIV_CLK_SDMA_NOC, CLK_CON_GAT_CLK_BLK_SDMA_UID_IP_SDMA_WRAP_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_SDMA_UID_IP_SDMA_WRAP_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_SDMA_UID_IP_SDMA_WRAP_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_SDMA_UID_LH_AST_MI_D_SRAM_WR0_GNPU0_SDMA_IPCLKPORT_I_CLK, DIV_CLK_SDMA_NOC, CLK_CON_GAT_CLK_BLK_SDMA_UID_LH_AST_MI_D_SRAM_WR0_GNPU0_SDMA_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_SDMA_UID_LH_AST_MI_D_SRAM_WR0_GNPU0_SDMA_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_SDMA_UID_LH_AST_MI_D_SRAM_WR0_GNPU0_SDMA_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_SDMA_UID_LH_AST_MI_OTF_UFDSDMA_IPCLKPORT_I_CLK, DIV_CLK_SDMA_NOC, CLK_CON_GAT_CLK_BLK_SDMA_UID_LH_AST_MI_OTF_UFDSDMA_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_SDMA_UID_LH_AST_MI_OTF_UFDSDMA_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_SDMA_UID_LH_AST_MI_OTF_UFDSDMA_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_SDMA_UID_LH_AST_SI_D_SRAM_RDRSP0_SDMA_GNPU0_IPCLKPORT_I_CLK, DIV_CLK_SDMA_NOC, CLK_CON_GAT_CLK_BLK_SDMA_UID_LH_AST_SI_D_SRAM_RDRSP0_SDMA_GNPU0_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_SDMA_UID_LH_AST_SI_D_SRAM_RDRSP0_SDMA_GNPU0_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_SDMA_UID_LH_AST_SI_D_SRAM_RDRSP0_SDMA_GNPU0_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_SDMA_UID_LH_AST_SI_D_SRAM_RDRSP0_SDMA_GNPU1_IPCLKPORT_I_CLK, DIV_CLK_SDMA_NOC, CLK_CON_GAT_CLK_BLK_SDMA_UID_LH_AST_SI_D_SRAM_RDRSP0_SDMA_GNPU1_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_SDMA_UID_LH_AST_SI_D_SRAM_RDRSP0_SDMA_GNPU1_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_SDMA_UID_LH_AST_SI_D_SRAM_RDRSP0_SDMA_GNPU1_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_SDMA_UID_LH_AST_SI_D_SRAM_RDRSP1_SDMA_GNPU0_IPCLKPORT_I_CLK, DIV_CLK_SDMA_NOC, CLK_CON_GAT_CLK_BLK_SDMA_UID_LH_AST_SI_D_SRAM_RDRSP1_SDMA_GNPU0_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_SDMA_UID_LH_AST_SI_D_SRAM_RDRSP1_SDMA_GNPU0_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_SDMA_UID_LH_AST_SI_D_SRAM_RDRSP1_SDMA_GNPU0_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_SDMA_UID_LH_AST_SI_D_SRAM_RDRSP2_SDMA_GNPU1_IPCLKPORT_I_CLK, DIV_CLK_SDMA_NOC, CLK_CON_GAT_CLK_BLK_SDMA_UID_LH_AST_SI_D_SRAM_RDRSP2_SDMA_GNPU1_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_SDMA_UID_LH_AST_SI_D_SRAM_RDRSP2_SDMA_GNPU1_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_SDMA_UID_LH_AST_SI_D_SRAM_RDRSP2_SDMA_GNPU1_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_SDMA_UID_LH_AST_MI_D_SRAM_RDREQ0_GNPU0_SDMA_IPCLKPORT_I_CLK, DIV_CLK_SDMA_NOC, CLK_CON_GAT_CLK_BLK_SDMA_UID_LH_AST_MI_D_SRAM_RDREQ0_GNPU0_SDMA_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_SDMA_UID_LH_AST_MI_D_SRAM_RDREQ0_GNPU0_SDMA_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_SDMA_UID_LH_AST_MI_D_SRAM_RDREQ0_GNPU0_SDMA_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_SDMA_UID_LH_AST_MI_D_SRAM_RDREQ0_GNPU1_SDMA_IPCLKPORT_I_CLK, DIV_CLK_SDMA_NOC, CLK_CON_GAT_CLK_BLK_SDMA_UID_LH_AST_MI_D_SRAM_RDREQ0_GNPU1_SDMA_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_SDMA_UID_LH_AST_MI_D_SRAM_RDREQ0_GNPU1_SDMA_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_SDMA_UID_LH_AST_MI_D_SRAM_RDREQ0_GNPU1_SDMA_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_SDMA_UID_LH_AST_MI_D_SRAM_RDREQ1_GNPU0_SDMA_IPCLKPORT_I_CLK, DIV_CLK_SDMA_NOC, CLK_CON_GAT_CLK_BLK_SDMA_UID_LH_AST_MI_D_SRAM_RDREQ1_GNPU0_SDMA_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_SDMA_UID_LH_AST_MI_D_SRAM_RDREQ1_GNPU0_SDMA_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_SDMA_UID_LH_AST_MI_D_SRAM_RDREQ1_GNPU0_SDMA_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_SDMA_UID_LH_AST_MI_D_SRAM_RDREQ1_GNPU1_SDMA_IPCLKPORT_I_CLK, DIV_CLK_SDMA_NOC, CLK_CON_GAT_CLK_BLK_SDMA_UID_LH_AST_MI_D_SRAM_RDREQ1_GNPU1_SDMA_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_SDMA_UID_LH_AST_MI_D_SRAM_RDREQ1_GNPU1_SDMA_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_SDMA_UID_LH_AST_MI_D_SRAM_RDREQ1_GNPU1_SDMA_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_SDMA_UID_LH_AST_MI_D_SRAM_RDREQ2_GNPU0_SDMA_IPCLKPORT_I_CLK, DIV_CLK_SDMA_NOC, CLK_CON_GAT_CLK_BLK_SDMA_UID_LH_AST_MI_D_SRAM_RDREQ2_GNPU0_SDMA_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_SDMA_UID_LH_AST_MI_D_SRAM_RDREQ2_GNPU0_SDMA_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_SDMA_UID_LH_AST_MI_D_SRAM_RDREQ2_GNPU0_SDMA_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_SDMA_UID_LH_AST_MI_D_SRAM_RDREQ2_GNPU1_SDMA_IPCLKPORT_I_CLK, DIV_CLK_SDMA_NOC, CLK_CON_GAT_CLK_BLK_SDMA_UID_LH_AST_MI_D_SRAM_RDREQ2_GNPU1_SDMA_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_SDMA_UID_LH_AST_MI_D_SRAM_RDREQ2_GNPU1_SDMA_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_SDMA_UID_LH_AST_MI_D_SRAM_RDREQ2_GNPU1_SDMA_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_SDMA_UID_LH_AXI_MI_D_CTRL_DNC_SDMA_IPCLKPORT_I_CLK, DIV_CLK_SDMA_NOC, CLK_CON_GAT_CLK_BLK_SDMA_UID_LH_AXI_MI_D_CTRL_DNC_SDMA_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_SDMA_UID_LH_AXI_MI_D_CTRL_DNC_SDMA_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_SDMA_UID_LH_AXI_MI_D_CTRL_DNC_SDMA_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_SDMA_UID_LH_AXI_MI_D_SRAM_DNC_SDMA_IPCLKPORT_I_CLK, DIV_CLK_SDMA_NOC, CLK_CON_GAT_CLK_BLK_SDMA_UID_LH_AXI_MI_D_SRAM_DNC_SDMA_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_SDMA_UID_LH_AXI_MI_D_SRAM_DNC_SDMA_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_SDMA_UID_LH_AXI_MI_D_SRAM_DNC_SDMA_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_SDMA_UID_LH_AST_MI_D_SRAM_DSP_SDMA_IPCLKPORT_I_CLK, DIV_CLK_SDMA_NOC, CLK_CON_GAT_CLK_BLK_SDMA_UID_LH_AST_MI_D_SRAM_DSP_SDMA_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_SDMA_UID_LH_AST_MI_D_SRAM_DSP_SDMA_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_SDMA_UID_LH_AST_MI_D_SRAM_DSP_SDMA_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_SDMA_UID_LH_AXI_SI_D_SRAM_SDMA_DSP_IPCLKPORT_I_CLK, DIV_CLK_SDMA_NOC, CLK_CON_GAT_CLK_BLK_SDMA_UID_LH_AXI_SI_D_SRAM_SDMA_DSP_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_SDMA_UID_LH_AXI_SI_D_SRAM_SDMA_DSP_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_SDMA_UID_LH_AXI_SI_D_SRAM_SDMA_DSP_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_SDMA_UID_SLH_AXI_MI_D_UFDSDMA_IPCLKPORT_I_CLK, DIV_CLK_SDMA_NOC, CLK_CON_GAT_CLK_BLK_SDMA_UID_SLH_AXI_MI_D_UFDSDMA_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_SDMA_UID_SLH_AXI_MI_D_UFDSDMA_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_SDMA_UID_SLH_AXI_MI_D_UFDSDMA_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_SDMA_UID_BAAW_SDMACHUBVTS_IPCLKPORT_I_PCLK, DIV_CLK_SDMA_NOCP, CLK_CON_GAT_CLK_BLK_SDMA_UID_BAAW_SDMACHUBVTS_IPCLKPORT_I_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_SDMA_UID_BAAW_SDMACHUBVTS_IPCLKPORT_I_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_SDMA_UID_BAAW_SDMACHUBVTS_IPCLKPORT_I_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_SDMA_UID_SLH_AXI_SI_P_SDMACHUBVTS_IPCLKPORT_I_CLK, DIV_CLK_SDMA_NOC, CLK_CON_GAT_CLK_BLK_SDMA_UID_SLH_AXI_SI_P_SDMACHUBVTS_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_SDMA_UID_SLH_AXI_SI_P_SDMACHUBVTS_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_SDMA_UID_SLH_AXI_SI_P_SDMACHUBVTS_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_SDMA_UID_LH_AST_SI_D_SRAM_CSTFIFO_SDMA_GNPU0_IPCLKPORT_I_CLK, DIV_CLK_SDMA_NOC, CLK_CON_GAT_CLK_BLK_SDMA_UID_LH_AST_SI_D_SRAM_CSTFIFO_SDMA_GNPU0_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_SDMA_UID_LH_AST_SI_D_SRAM_CSTFIFO_SDMA_GNPU0_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_SDMA_UID_LH_AST_SI_D_SRAM_CSTFIFO_SDMA_GNPU0_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_SDMA_UID_LH_AST_SI_D_SRAM_CSTFIFO_SDMA_GNPU1_IPCLKPORT_I_CLK, DIV_CLK_SDMA_NOC, CLK_CON_GAT_CLK_BLK_SDMA_UID_LH_AST_SI_D_SRAM_CSTFIFO_SDMA_GNPU1_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_SDMA_UID_LH_AST_SI_D_SRAM_CSTFIFO_SDMA_GNPU1_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_SDMA_UID_LH_AST_SI_D_SRAM_CSTFIFO_SDMA_GNPU1_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_SDMA_UID_LH_AST_MI_D_SRAM_RDREQ5_GNPU1_SDMA_IPCLKPORT_I_CLK, DIV_CLK_SDMA_NOC, CLK_CON_GAT_CLK_BLK_SDMA_UID_LH_AST_MI_D_SRAM_RDREQ5_GNPU1_SDMA_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_SDMA_UID_LH_AST_MI_D_SRAM_RDREQ5_GNPU1_SDMA_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_SDMA_UID_LH_AST_MI_D_SRAM_RDREQ5_GNPU1_SDMA_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_SDMA_UID_LH_AST_MI_D_SRAM_RDREQ5_GNPU0_SDMA_IPCLKPORT_I_CLK, DIV_CLK_SDMA_NOC, CLK_CON_GAT_CLK_BLK_SDMA_UID_LH_AST_MI_D_SRAM_RDREQ5_GNPU0_SDMA_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_SDMA_UID_LH_AST_MI_D_SRAM_RDREQ5_GNPU0_SDMA_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_SDMA_UID_LH_AST_MI_D_SRAM_RDREQ5_GNPU0_SDMA_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_SDMA_UID_LH_AST_MI_D_SRAM_RDREQ4_GNPU1_SDMA_IPCLKPORT_I_CLK, DIV_CLK_SDMA_NOC, CLK_CON_GAT_CLK_BLK_SDMA_UID_LH_AST_MI_D_SRAM_RDREQ4_GNPU1_SDMA_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_SDMA_UID_LH_AST_MI_D_SRAM_RDREQ4_GNPU1_SDMA_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_SDMA_UID_LH_AST_MI_D_SRAM_RDREQ4_GNPU1_SDMA_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_SDMA_UID_LH_AST_MI_D_SRAM_RDREQ4_GNPU0_SDMA_IPCLKPORT_I_CLK, DIV_CLK_SDMA_NOC, CLK_CON_GAT_CLK_BLK_SDMA_UID_LH_AST_MI_D_SRAM_RDREQ4_GNPU0_SDMA_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_SDMA_UID_LH_AST_MI_D_SRAM_RDREQ4_GNPU0_SDMA_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_SDMA_UID_LH_AST_MI_D_SRAM_RDREQ4_GNPU0_SDMA_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_SDMA_UID_LH_AST_MI_D_SRAM_RDREQ3_GNPU1_SDMA_IPCLKPORT_I_CLK, DIV_CLK_SDMA_NOC, CLK_CON_GAT_CLK_BLK_SDMA_UID_LH_AST_MI_D_SRAM_RDREQ3_GNPU1_SDMA_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_SDMA_UID_LH_AST_MI_D_SRAM_RDREQ3_GNPU1_SDMA_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_SDMA_UID_LH_AST_MI_D_SRAM_RDREQ3_GNPU1_SDMA_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_SDMA_UID_LH_AST_MI_D_SRAM_RDREQ3_GNPU0_SDMA_IPCLKPORT_I_CLK, DIV_CLK_SDMA_NOC, CLK_CON_GAT_CLK_BLK_SDMA_UID_LH_AST_MI_D_SRAM_RDREQ3_GNPU0_SDMA_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_SDMA_UID_LH_AST_MI_D_SRAM_RDREQ3_GNPU0_SDMA_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_SDMA_UID_LH_AST_MI_D_SRAM_RDREQ3_GNPU0_SDMA_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_SDMA_UID_LH_AXI_SI_D_MMU_SDMA0_DNC_IPCLKPORT_I_CLK, DIV_CLK_SDMA_NOC, CLK_CON_GAT_CLK_BLK_SDMA_UID_LH_AXI_SI_D_MMU_SDMA0_DNC_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_SDMA_UID_LH_AXI_SI_D_MMU_SDMA0_DNC_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_SDMA_UID_LH_AXI_SI_D_MMU_SDMA0_DNC_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_SDMA_UID_LH_AXI_SI_D_MMU_SDMA1_DNC_IPCLKPORT_I_CLK, DIV_CLK_SDMA_NOC, CLK_CON_GAT_CLK_BLK_SDMA_UID_LH_AXI_SI_D_MMU_SDMA1_DNC_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_SDMA_UID_LH_AXI_SI_D_MMU_SDMA1_DNC_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_SDMA_UID_LH_AXI_SI_D_MMU_SDMA1_DNC_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_SDMA_UID_LH_AXI_SI_D_MMU_SDMA2_DNC_IPCLKPORT_I_CLK, DIV_CLK_SDMA_NOC, CLK_CON_GAT_CLK_BLK_SDMA_UID_LH_AXI_SI_D_MMU_SDMA2_DNC_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_SDMA_UID_LH_AXI_SI_D_MMU_SDMA2_DNC_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_SDMA_UID_LH_AXI_SI_D_MMU_SDMA2_DNC_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_SDMA_UID_LH_AXI_SI_D_MMU_SDMA3_DNC_IPCLKPORT_I_CLK, DIV_CLK_SDMA_NOC, CLK_CON_GAT_CLK_BLK_SDMA_UID_LH_AXI_SI_D_MMU_SDMA3_DNC_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_SDMA_UID_LH_AXI_SI_D_MMU_SDMA3_DNC_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_SDMA_UID_LH_AXI_SI_D_MMU_SDMA3_DNC_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_SDMA_UID_LH_AST_SI_D_SRAM_RDRSP3_SDMA_GNPU0_IPCLKPORT_I_CLK, DIV_CLK_SDMA_NOC, CLK_CON_GAT_CLK_BLK_SDMA_UID_LH_AST_SI_D_SRAM_RDRSP3_SDMA_GNPU0_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_SDMA_UID_LH_AST_SI_D_SRAM_RDRSP3_SDMA_GNPU0_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_SDMA_UID_LH_AST_SI_D_SRAM_RDRSP3_SDMA_GNPU0_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_SDMA_UID_LH_AST_SI_D_SRAM_RDRSP3_SDMA_GNPU1_IPCLKPORT_I_CLK, DIV_CLK_SDMA_NOC, CLK_CON_GAT_CLK_BLK_SDMA_UID_LH_AST_SI_D_SRAM_RDRSP3_SDMA_GNPU1_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_SDMA_UID_LH_AST_SI_D_SRAM_RDRSP3_SDMA_GNPU1_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_SDMA_UID_LH_AST_SI_D_SRAM_RDRSP3_SDMA_GNPU1_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_SDMA_UID_LH_AST_SI_D_SRAM_RDRSP4_SDMA_GNPU0_IPCLKPORT_I_CLK, DIV_CLK_SDMA_NOC, CLK_CON_GAT_CLK_BLK_SDMA_UID_LH_AST_SI_D_SRAM_RDRSP4_SDMA_GNPU0_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_SDMA_UID_LH_AST_SI_D_SRAM_RDRSP4_SDMA_GNPU0_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_SDMA_UID_LH_AST_SI_D_SRAM_RDRSP4_SDMA_GNPU0_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_SDMA_UID_LH_AST_SI_D_SRAM_RDRSP4_SDMA_GNPU1_IPCLKPORT_I_CLK, DIV_CLK_SDMA_NOC, CLK_CON_GAT_CLK_BLK_SDMA_UID_LH_AST_SI_D_SRAM_RDRSP4_SDMA_GNPU1_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_SDMA_UID_LH_AST_SI_D_SRAM_RDRSP4_SDMA_GNPU1_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_SDMA_UID_LH_AST_SI_D_SRAM_RDRSP4_SDMA_GNPU1_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_SDMA_UID_LH_AST_SI_D_SRAM_RDRSP5_SDMA_GNPU0_IPCLKPORT_I_CLK, DIV_CLK_SDMA_NOC, CLK_CON_GAT_CLK_BLK_SDMA_UID_LH_AST_SI_D_SRAM_RDRSP5_SDMA_GNPU0_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_SDMA_UID_LH_AST_SI_D_SRAM_RDRSP5_SDMA_GNPU0_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_SDMA_UID_LH_AST_SI_D_SRAM_RDRSP5_SDMA_GNPU0_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_SDMA_UID_LH_AST_SI_D_SRAM_RDRSP5_SDMA_GNPU1_IPCLKPORT_I_CLK, DIV_CLK_SDMA_NOC, CLK_CON_GAT_CLK_BLK_SDMA_UID_LH_AST_SI_D_SRAM_RDRSP5_SDMA_GNPU1_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_SDMA_UID_LH_AST_SI_D_SRAM_RDRSP5_SDMA_GNPU1_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_SDMA_UID_LH_AST_SI_D_SRAM_RDRSP5_SDMA_GNPU1_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_SSP_UID_BAAW_SC_CP_IPCLKPORT_I_PCLK, DIV_CLK_SSP_NOCP, CLK_CON_GAT_CLK_BLK_SSP_UID_BAAW_SC_CP_IPCLKPORT_I_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_SSP_UID_BAAW_SC_CP_IPCLKPORT_I_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_SSP_UID_BAAW_SC_CP_IPCLKPORT_I_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_SSP_UID_LH_AXI_MI_D_STRONG_INT_IPCLKPORT_I_CLK, MUX_CLKCMU_SSP_NOC_USER, CLK_CON_GAT_CLK_BLK_SSP_UID_LH_AXI_MI_D_STRONG_INT_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_SSP_UID_LH_AXI_MI_D_STRONG_INT_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_SSP_UID_LH_AXI_MI_D_STRONG_INT_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_SSP_UID_LH_ACEL_SI_D_SSP_IPCLKPORT_I_CLK, MUX_CLKCMU_SSP_NOC_USER, CLK_CON_GAT_CLK_BLK_SSP_UID_LH_ACEL_SI_D_SSP_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_SSP_UID_LH_ACEL_SI_D_SSP_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_SSP_UID_LH_ACEL_SI_D_SSP_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_SSP_UID_SC_IPCLKPORT_I_ACLK, MUX_CLKCMU_SSP_NOC_USER, CLK_CON_GAT_CLK_BLK_SSP_UID_SC_IPCLKPORT_I_ACLK_CG_VAL, CLK_CON_GAT_CLK_BLK_SSP_UID_SC_IPCLKPORT_I_ACLK_MANUAL, CLK_CON_GAT_CLK_BLK_SSP_UID_SC_IPCLKPORT_I_ACLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_SSP_UID_SC_IPCLKPORT_I_PCLK, DIV_CLK_SSP_NOCP, CLK_CON_GAT_CLK_BLK_SSP_UID_SC_IPCLKPORT_I_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_SSP_UID_SC_IPCLKPORT_I_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_SSP_UID_SC_IPCLKPORT_I_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_SSP_UID_S2MPU_SSP_S0_IPCLKPORT_CLK, MUX_CLKCMU_SSP_NOC_USER, CLK_CON_GAT_CLK_BLK_SSP_UID_S2MPU_SSP_S0_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_SSP_UID_S2MPU_SSP_S0_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_SSP_UID_S2MPU_SSP_S0_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_SSP_UID_OTP_DESERIAL_SC_HIDE_SECKEY_IPCLKPORT_I_CLK, FREE_OSCCLK_SSP, CLK_CON_GAT_CLK_BLK_SSP_UID_OTP_DESERIAL_SC_HIDE_SECKEY_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_SSP_UID_OTP_DESERIAL_SC_HIDE_SECKEY_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_SSP_UID_OTP_DESERIAL_SC_HIDE_SECKEY_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_SSP_UID_S2MPU_SSP_S0_PMMU0_IPCLKPORT_CLK, MUX_CLKCMU_SSP_NOC_USER, CLK_CON_GAT_CLK_BLK_SSP_UID_S2MPU_SSP_S0_PMMU0_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_SSP_UID_S2MPU_SSP_S0_PMMU0_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_SSP_UID_S2MPU_SSP_S0_PMMU0_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_SSP_UID_XIU_MMU_SSP_IPCLKPORT_ACLK, MUX_CLKCMU_SSP_NOC_USER, CLK_CON_GAT_CLK_BLK_SSP_UID_XIU_MMU_SSP_IPCLKPORT_ACLK_CG_VAL, CLK_CON_GAT_CLK_BLK_SSP_UID_XIU_MMU_SSP_IPCLKPORT_ACLK_MANUAL, CLK_CON_GAT_CLK_BLK_SSP_UID_XIU_MMU_SSP_IPCLKPORT_ACLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_SSP_UID_LH_AXI_SI_P_PSP_INT_IPCLKPORT_I_CLK, DIV_CLK_SSP_NOCP, CLK_CON_GAT_CLK_BLK_SSP_UID_LH_AXI_SI_P_PSP_INT_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_SSP_UID_LH_AXI_SI_P_PSP_INT_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_SSP_UID_LH_AXI_SI_P_PSP_INT_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_SSP_UID_SS_PSP_IPCLKPORT_CM35P_CLKIN, MUX_CLKCMU_SSP_NOC_USER, CLK_CON_GAT_CLK_BLK_SSP_UID_SS_PSP_IPCLKPORT_CM35P_CLKIN_CG_VAL, CLK_CON_GAT_CLK_BLK_SSP_UID_SS_PSP_IPCLKPORT_CM35P_CLKIN_MANUAL, CLK_CON_GAT_CLK_BLK_SSP_UID_SS_PSP_IPCLKPORT_CM35P_CLKIN_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_SSP_UID_SS_PSP_IPCLKPORT_SC_PSP_ACLK, MUX_CLKCMU_SSP_NOC_USER, CLK_CON_GAT_CLK_BLK_SSP_UID_SS_PSP_IPCLKPORT_SC_PSP_ACLK_CG_VAL, CLK_CON_GAT_CLK_BLK_SSP_UID_SS_PSP_IPCLKPORT_SC_PSP_ACLK_MANUAL, CLK_CON_GAT_CLK_BLK_SSP_UID_SS_PSP_IPCLKPORT_SC_PSP_ACLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_SSP_UID_SS_PSP_IPCLKPORT_SC_PSP_PCLK, MUX_CLKCMU_SSP_NOC_USER, CLK_CON_GAT_CLK_BLK_SSP_UID_SS_PSP_IPCLKPORT_SC_PSP_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_SSP_UID_SS_PSP_IPCLKPORT_SC_PSP_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_SSP_UID_SS_PSP_IPCLKPORT_SC_PSP_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_SSP_UID_SS_PSP_IPCLKPORT_DS_ACLK, MUX_CLKCMU_SSP_NOC_USER, CLK_CON_GAT_CLK_BLK_SSP_UID_SS_PSP_IPCLKPORT_DS_ACLK_CG_VAL, CLK_CON_GAT_CLK_BLK_SSP_UID_SS_PSP_IPCLKPORT_DS_ACLK_MANUAL, CLK_CON_GAT_CLK_BLK_SSP_UID_SS_PSP_IPCLKPORT_DS_ACLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_SSP_UID_SS_PSP_IPCLKPORT_PUF_ICLK, MUX_CLKCMU_SSP_NOC_USER, CLK_CON_GAT_CLK_BLK_SSP_UID_SS_PSP_IPCLKPORT_PUF_ICLK_CG_VAL, CLK_CON_GAT_CLK_BLK_SSP_UID_SS_PSP_IPCLKPORT_PUF_ICLK_MANUAL, CLK_CON_GAT_CLK_BLK_SSP_UID_SS_PSP_IPCLKPORT_PUF_ICLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_SSP_UID_SS_PSP_IPCLKPORT_MAILBOX_AP_CLK, MUX_CLKCMU_SSP_NOC_USER, CLK_CON_GAT_CLK_BLK_SSP_UID_SS_PSP_IPCLKPORT_MAILBOX_AP_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_SSP_UID_SS_PSP_IPCLKPORT_MAILBOX_AP_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_SSP_UID_SS_PSP_IPCLKPORT_MAILBOX_AP_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_SSP_UID_SS_PSP_IPCLKPORT_MAILBOX_CP_CLK, MUX_CLKCMU_SSP_NOC_USER, CLK_CON_GAT_CLK_BLK_SSP_UID_SS_PSP_IPCLKPORT_MAILBOX_CP_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_SSP_UID_SS_PSP_IPCLKPORT_MAILBOX_CP_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_SSP_UID_SS_PSP_IPCLKPORT_MAILBOX_CP_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_SSP_UID_SS_PSP_IPCLKPORT_LH_P_CLK, MUX_CLKCMU_SSP_NOC_USER, CLK_CON_GAT_CLK_BLK_SSP_UID_SS_PSP_IPCLKPORT_LH_P_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_SSP_UID_SS_PSP_IPCLKPORT_LH_P_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_SSP_UID_SS_PSP_IPCLKPORT_LH_P_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_SSP_UID_SS_PSP_IPCLKPORT_LH_D_CLK, MUX_CLKCMU_SSP_NOC_USER, CLK_CON_GAT_CLK_BLK_SSP_UID_SS_PSP_IPCLKPORT_LH_D_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_SSP_UID_SS_PSP_IPCLKPORT_LH_D_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_SSP_UID_SS_PSP_IPCLKPORT_LH_D_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_SSP_UID_SS_PSP_IPCLKPORT_DAP_ASYNC_CLK, MUX_CLKCMU_SSP_NOC_USER, CLK_CON_GAT_CLK_BLK_SSP_UID_SS_PSP_IPCLKPORT_DAP_ASYNC_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_SSP_UID_SS_PSP_IPCLKPORT_DAP_ASYNC_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_SSP_UID_SS_PSP_IPCLKPORT_DAP_ASYNC_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_SSP_UID_SS_PSP_IPCLKPORT_SYSREG_PCLK, MUX_CLKCMU_SSP_NOC_USER, CLK_CON_GAT_CLK_BLK_SSP_UID_SS_PSP_IPCLKPORT_SYSREG_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_SSP_UID_SS_PSP_IPCLKPORT_SYSREG_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_SSP_UID_SS_PSP_IPCLKPORT_SYSREG_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_SSP_UID_SS_PSP_IPCLKPORT_BAAW_CLK, MUX_CLKCMU_SSP_NOC_USER, CLK_CON_GAT_CLK_BLK_SSP_UID_SS_PSP_IPCLKPORT_BAAW_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_SSP_UID_SS_PSP_IPCLKPORT_BAAW_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_SSP_UID_SS_PSP_IPCLKPORT_BAAW_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_SSP_UID_SS_PSP_IPCLKPORT_AHB_DP_HCLK, MUX_CLKCMU_SSP_NOC_USER, CLK_CON_GAT_CLK_BLK_SSP_UID_SS_PSP_IPCLKPORT_AHB_DP_HCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_SSP_UID_SS_PSP_IPCLKPORT_AHB_DP_HCLK_MANUAL, CLK_CON_GAT_CLK_BLK_SSP_UID_SS_PSP_IPCLKPORT_AHB_DP_HCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_SSP_UID_SS_PSP_IPCLKPORT_XIU_DP_CLK, MUX_CLKCMU_SSP_NOC_USER, CLK_CON_GAT_CLK_BLK_SSP_UID_SS_PSP_IPCLKPORT_XIU_DP_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_SSP_UID_SS_PSP_IPCLKPORT_XIU_DP_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_SSP_UID_SS_PSP_IPCLKPORT_XIU_DP_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_SSP_UID_LH_AXI_MI_D_PSP_INT_IPCLKPORT_I_CLK, MUX_CLKCMU_SSP_NOC_USER, CLK_CON_GAT_CLK_BLK_SSP_UID_LH_AXI_MI_D_PSP_INT_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_SSP_UID_LH_AXI_MI_D_PSP_INT_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_SSP_UID_LH_AXI_MI_D_PSP_INT_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_SSP_UID_BAAW_SC_IPCLKPORT_I_PCLK, DIV_CLK_SSP_NOCP, CLK_CON_GAT_CLK_BLK_SSP_UID_BAAW_SC_IPCLKPORT_I_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_SSP_UID_BAAW_SC_IPCLKPORT_I_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_SSP_UID_BAAW_SC_IPCLKPORT_I_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_SSP_UID_OTP_DESERIAL_PUF_IPCLKPORT_I_CLK, FREE_OSCCLK_SSP, CLK_CON_GAT_CLK_BLK_SSP_UID_OTP_DESERIAL_PUF_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_SSP_UID_OTP_DESERIAL_PUF_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_SSP_UID_OTP_DESERIAL_PUF_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_SSP_UID_RSTNSYNC_SR_CLK_SSP_PUF_IPCLKPORT_CLK, MUX_CLKCMU_SSP_NOC_USER, CLK_CON_GAT_CLK_BLK_SSP_UID_RSTNSYNC_SR_CLK_SSP_PUF_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_SSP_UID_RSTNSYNC_SR_CLK_SSP_PUF_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_SSP_UID_RSTNSYNC_SR_CLK_SSP_PUF_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_UFD_UID_UFD_CMU_UFD_IPCLKPORT_PCLK, DIV_CLK_UFD_NOC, CLK_CON_GAT_CLK_BLK_UFD_UID_UFD_CMU_UFD_IPCLKPORT_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_UFD_UID_UFD_CMU_UFD_IPCLKPORT_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_UFD_UID_UFD_CMU_UFD_IPCLKPORT_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_UFD_UID_D_TZPC_UFD_IPCLKPORT_PCLK, DIV_CLK_UFD_NOC, CLK_CON_GAT_CLK_BLK_UFD_UID_D_TZPC_UFD_IPCLKPORT_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_UFD_UID_D_TZPC_UFD_IPCLKPORT_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_UFD_UID_D_TZPC_UFD_IPCLKPORT_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_UFD_UID_RSTNSYNC_CLK_UFD_NOC_IPCLKPORT_CLK, DIV_CLK_UFD_NOC, CLK_CON_GAT_CLK_BLK_UFD_UID_RSTNSYNC_CLK_UFD_NOC_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_UFD_UID_RSTNSYNC_CLK_UFD_NOC_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_UFD_UID_RSTNSYNC_CLK_UFD_NOC_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_UFD_UID_SLH_AXI_MI_P_CMGPUFD_IPCLKPORT_I_CLK, DIV_CLK_UFD_NOC, CLK_CON_GAT_CLK_BLK_UFD_UID_SLH_AXI_MI_P_CMGPUFD_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_UFD_UID_SLH_AXI_MI_P_CMGPUFD_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_UFD_UID_SLH_AXI_MI_P_CMGPUFD_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_UFD_UID_SLH_AXI_MI_P_UFD_IPCLKPORT_I_CLK, DIV_CLK_UFD_NOC, CLK_CON_GAT_CLK_BLK_UFD_UID_SLH_AXI_MI_P_UFD_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_UFD_UID_SLH_AXI_MI_P_UFD_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_UFD_UID_SLH_AXI_MI_P_UFD_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_UFD_UID_PDMA_UFD_IPCLKPORT_ACLK, DIV_CLK_UFD_NOC, CLK_CON_GAT_CLK_BLK_UFD_UID_PDMA_UFD_IPCLKPORT_ACLK_CG_VAL, CLK_CON_GAT_CLK_BLK_UFD_UID_PDMA_UFD_IPCLKPORT_ACLK_MANUAL, CLK_CON_GAT_CLK_BLK_UFD_UID_PDMA_UFD_IPCLKPORT_ACLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_UFD_UID_SYSREG_UFD_IPCLKPORT_PCLK, DIV_CLK_UFD_NOC, CLK_CON_GAT_CLK_BLK_UFD_UID_SYSREG_UFD_IPCLKPORT_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_UFD_UID_SYSREG_UFD_IPCLKPORT_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_UFD_UID_SYSREG_UFD_IPCLKPORT_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_UFD_UID_UFD_IPCLKPORT_CLK, DIV_CLK_UFD_NOC, CLK_CON_GAT_CLK_BLK_UFD_UID_UFD_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_UFD_UID_UFD_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_UFD_UID_UFD_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_UFD_UID_XIU_DP_UFD_IPCLKPORT_ACLK, DIV_CLK_UFD_NOC, CLK_CON_GAT_CLK_BLK_UFD_UID_XIU_DP_UFD_IPCLKPORT_ACLK_CG_VAL, CLK_CON_GAT_CLK_BLK_UFD_UID_XIU_DP_UFD_IPCLKPORT_ACLK_MANUAL, CLK_CON_GAT_CLK_BLK_UFD_UID_XIU_DP_UFD_IPCLKPORT_ACLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_UFD_UID_PPMU_D_UFD_IPCLKPORT_PCLK, DIV_CLK_UFD_NOC, CLK_CON_GAT_CLK_BLK_UFD_UID_PPMU_D_UFD_IPCLKPORT_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_UFD_UID_PPMU_D_UFD_IPCLKPORT_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_UFD_UID_PPMU_D_UFD_IPCLKPORT_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_UFD_UID_PPMU_D_UFD_IPCLKPORT_ACLK, DIV_CLK_UFD_NOC, CLK_CON_GAT_CLK_BLK_UFD_UID_PPMU_D_UFD_IPCLKPORT_ACLK_CG_VAL, CLK_CON_GAT_CLK_BLK_UFD_UID_PPMU_D_UFD_IPCLKPORT_ACLK_MANUAL, CLK_CON_GAT_CLK_BLK_UFD_UID_PPMU_D_UFD_IPCLKPORT_ACLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_UFD_UID_VGEN_LITE_D_UFD_IPCLKPORT_CLK, DIV_CLK_UFD_NOC, CLK_CON_GAT_CLK_BLK_UFD_UID_VGEN_LITE_D_UFD_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_UFD_UID_VGEN_LITE_D_UFD_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_UFD_UID_VGEN_LITE_D_UFD_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_UFD_UID_SLH_AXI_SI_D_UFD_IPCLKPORT_I_CLK, DIV_CLK_UFD_NOC, CLK_CON_GAT_CLK_BLK_UFD_UID_SLH_AXI_SI_D_UFD_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_UFD_UID_SLH_AXI_SI_D_UFD_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_UFD_UID_SLH_AXI_SI_D_UFD_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_UFD_UID_XIU_D_UFD_IPCLKPORT_ACLK, DIV_CLK_UFD_NOC, CLK_CON_GAT_CLK_BLK_UFD_UID_XIU_D_UFD_IPCLKPORT_ACLK_CG_VAL, CLK_CON_GAT_CLK_BLK_UFD_UID_XIU_D_UFD_IPCLKPORT_ACLK_MANUAL, CLK_CON_GAT_CLK_BLK_UFD_UID_XIU_D_UFD_IPCLKPORT_ACLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_UFD_UID_SLH_AXI_SI_D_UFDSDMA_IPCLKPORT_I_CLK, DIV_CLK_UFD_NOC, CLK_CON_GAT_CLK_BLK_UFD_UID_SLH_AXI_SI_D_UFDSDMA_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_UFD_UID_SLH_AXI_SI_D_UFDSDMA_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_UFD_UID_SLH_AXI_SI_D_UFDSDMA_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_UFD_UID_SRAM_MIU_UFD_IPCLKPORT_ACLK, DIV_CLK_UFD_NOC, CLK_CON_GAT_CLK_BLK_UFD_UID_SRAM_MIU_UFD_IPCLKPORT_ACLK_CG_VAL, CLK_CON_GAT_CLK_BLK_UFD_UID_SRAM_MIU_UFD_IPCLKPORT_ACLK_MANUAL, CLK_CON_GAT_CLK_BLK_UFD_UID_SRAM_MIU_UFD_IPCLKPORT_ACLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_UFD_UID_BAAW_D_UFDSDMA_IPCLKPORT_I_PCLK, DIV_CLK_UFD_NOC, CLK_CON_GAT_CLK_BLK_UFD_UID_BAAW_D_UFDSDMA_IPCLKPORT_I_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_UFD_UID_BAAW_D_UFDSDMA_IPCLKPORT_I_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_UFD_UID_BAAW_D_UFDSDMA_IPCLKPORT_I_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_UFD_UID_SYSREG_UFD_SECURE_IPCLKPORT_PCLK, DIV_CLK_UFD_NOC, CLK_CON_GAT_CLK_BLK_UFD_UID_SYSREG_UFD_SECURE_IPCLKPORT_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_UFD_UID_SYSREG_UFD_SECURE_IPCLKPORT_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_UFD_UID_SYSREG_UFD_SECURE_IPCLKPORT_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_UFD_UID_RSTNSYNC_SR_CLK_UFD_NOC_IPCLKPORT_CLK, DIV_CLK_UFD_NOC, CLK_CON_GAT_CLK_BLK_UFD_UID_RSTNSYNC_SR_CLK_UFD_NOC_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_UFD_UID_RSTNSYNC_SR_CLK_UFD_NOC_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_UFD_UID_RSTNSYNC_SR_CLK_UFD_NOC_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_UFD_UID_ID_COMP_UFD_IPCLKPORT_I_CLK, DIV_CLK_UFD_NOC, CLK_CON_GAT_CLK_BLK_UFD_UID_ID_COMP_UFD_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_UFD_UID_ID_COMP_UFD_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_UFD_UID_ID_COMP_UFD_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_UFD_UID_SLH_AXI_SI_P_UFDCSIS_IPCLKPORT_I_CLK, DIV_CLK_UFD_NOC, CLK_CON_GAT_CLK_BLK_UFD_UID_SLH_AXI_SI_P_UFDCSIS_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_UFD_UID_SLH_AXI_SI_P_UFDCSIS_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_UFD_UID_SLH_AXI_SI_P_UFDCSIS_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_UFD_UID_SLH_AST_MI_OTF_CSISUFD_IPCLKPORT_I_CLK, DIV_CLK_UFD_NOC, CLK_CON_GAT_CLK_BLK_UFD_UID_SLH_AST_MI_OTF_CSISUFD_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_UFD_UID_SLH_AST_MI_OTF_CSISUFD_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_UFD_UID_SLH_AST_MI_OTF_CSISUFD_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_UFD_UID_SYSMMU_UFD_S0_PMMU0_IPCLKPORT_CLK, DIV_CLK_UFD_NOC, CLK_CON_GAT_CLK_BLK_UFD_UID_SYSMMU_UFD_S0_PMMU0_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_UFD_UID_SYSMMU_UFD_S0_PMMU0_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_UFD_UID_SYSMMU_UFD_S0_PMMU0_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_UFD_UID_SLH_AST_SI_G_PPMU_UFD_IPCLKPORT_I_CLK, DIV_CLK_UFD_NOC, CLK_CON_GAT_CLK_BLK_UFD_UID_SLH_AST_SI_G_PPMU_UFD_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_UFD_UID_SLH_AST_SI_G_PPMU_UFD_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_UFD_UID_SLH_AST_SI_G_PPMU_UFD_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_UFD_UID_LH_AST_SI_OTF_UFDSDMA_IPCLKPORT_I_CLK, DIV_CLK_UFD_NOC, CLK_CON_GAT_CLK_BLK_UFD_UID_LH_AST_SI_OTF_UFDSDMA_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_UFD_UID_LH_AST_SI_OTF_UFDSDMA_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_UFD_UID_LH_AST_SI_OTF_UFDSDMA_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_UFD_UID_RSTNSYNC_SR_CLK_UFD_NOC_LH_AST_SI_OTF_UFDSDMA_SW_RESET_IPCLKPORT_CLK, DIV_CLK_UFD_NOC, CLK_CON_GAT_CLK_BLK_UFD_UID_RSTNSYNC_SR_CLK_UFD_NOC_LH_AST_SI_OTF_UFDSDMA_SW_RESET_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_UFD_UID_RSTNSYNC_SR_CLK_UFD_NOC_LH_AST_SI_OTF_UFDSDMA_SW_RESET_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_UFD_UID_RSTNSYNC_SR_CLK_UFD_NOC_LH_AST_SI_OTF_UFDSDMA_SW_RESET_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_UFD_UID_RSTNSYNC_SR_CLK_UFD_NOC_SLH_AST_MI_OTF_CSISUFD_SW_RESET_IPCLKPORT_CLK, DIV_CLK_UFD_NOC, CLK_CON_GAT_CLK_BLK_UFD_UID_RSTNSYNC_SR_CLK_UFD_NOC_SLH_AST_MI_OTF_CSISUFD_SW_RESET_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_UFD_UID_RSTNSYNC_SR_CLK_UFD_NOC_SLH_AST_MI_OTF_CSISUFD_SW_RESET_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_UFD_UID_RSTNSYNC_SR_CLK_UFD_NOC_SLH_AST_MI_OTF_CSISUFD_SW_RESET_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_UFD_UID_RSTNSYNC_SR_CLK_UFD_NOC_UFD_SW_RESET_IPCLKPORT_CLK, DIV_CLK_UFD_NOC, CLK_CON_GAT_CLK_BLK_UFD_UID_RSTNSYNC_SR_CLK_UFD_NOC_UFD_SW_RESET_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_UFD_UID_RSTNSYNC_SR_CLK_UFD_NOC_UFD_SW_RESET_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_UFD_UID_RSTNSYNC_SR_CLK_UFD_NOC_UFD_SW_RESET_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_UFD_UID_AXI_DS_128TO32_UFD_IPCLKPORT_MAINCLK, DIV_CLK_UFD_NOC, CLK_CON_GAT_CLK_BLK_UFD_UID_AXI_DS_128TO32_UFD_IPCLKPORT_MAINCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_UFD_UID_AXI_DS_128TO32_UFD_IPCLKPORT_MAINCLK_MANUAL, CLK_CON_GAT_CLK_BLK_UFD_UID_AXI_DS_128TO32_UFD_IPCLKPORT_MAINCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_UFD_UID_SYSMMU_UFD_S0_IPCLKPORT_CLK, DIV_CLK_UFD_NOC, CLK_CON_GAT_CLK_BLK_UFD_UID_SYSMMU_UFD_S0_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_UFD_UID_SYSMMU_UFD_S0_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_UFD_UID_SYSMMU_UFD_S0_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_UFD_UID_XIU_MMU_UFD_IPCLKPORT_ACLK, DIV_CLK_UFD_NOC, CLK_CON_GAT_CLK_BLK_UFD_UID_XIU_MMU_UFD_IPCLKPORT_ACLK_CG_VAL, CLK_CON_GAT_CLK_BLK_UFD_UID_XIU_MMU_UFD_IPCLKPORT_ACLK_MANUAL, CLK_CON_GAT_CLK_BLK_UFD_UID_XIU_MMU_UFD_IPCLKPORT_ACLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_UFD_UID_I2C_UFD_IPCLKPORT_PCLK, DIV_CLK_UFD_NOC, CLK_CON_GAT_CLK_BLK_UFD_UID_I2C_UFD_IPCLKPORT_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_UFD_UID_I2C_UFD_IPCLKPORT_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_UFD_UID_I2C_UFD_IPCLKPORT_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_UFD_UID_I2C_UFD_IPCLKPORT_IPCLK, DIV_CLK_UFD_I2C, CLK_CON_GAT_CLK_BLK_UFD_UID_I2C_UFD_IPCLKPORT_IPCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_UFD_UID_I2C_UFD_IPCLKPORT_IPCLK_MANUAL, CLK_CON_GAT_CLK_BLK_UFD_UID_I2C_UFD_IPCLKPORT_IPCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_UFD_UID_RSTNSYNC_CLK_UFD_I2C_IPCLKPORT_CLK, DIV_CLK_UFD_I2C, CLK_CON_GAT_CLK_BLK_UFD_UID_RSTNSYNC_CLK_UFD_I2C_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_UFD_UID_RSTNSYNC_CLK_UFD_I2C_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_UFD_UID_RSTNSYNC_CLK_UFD_I2C_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_UFD_UID_RSTNSYNC_SR_CLK_UFD_I2C_IPCLKPORT_CLK, DIV_CLK_UFD_I2C, CLK_CON_GAT_CLK_BLK_UFD_UID_RSTNSYNC_SR_CLK_UFD_I2C_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_UFD_UID_RSTNSYNC_SR_CLK_UFD_I2C_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_UFD_UID_RSTNSYNC_SR_CLK_UFD_I2C_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_UFD_UID_I3C_UFD_IPCLKPORT_I_PCLK, DIV_CLK_UFD_NOC, CLK_CON_GAT_CLK_BLK_UFD_UID_I3C_UFD_IPCLKPORT_I_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_UFD_UID_I3C_UFD_IPCLKPORT_I_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_UFD_UID_I3C_UFD_IPCLKPORT_I_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_UFD_UID_I3C_UFD_IPCLKPORT_I_SCLK, DIV_CLK_UFD_I2C, CLK_CON_GAT_CLK_BLK_UFD_UID_I3C_UFD_IPCLKPORT_I_SCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_UFD_UID_I3C_UFD_IPCLKPORT_I_SCLK_MANUAL, CLK_CON_GAT_CLK_BLK_UFD_UID_I3C_UFD_IPCLKPORT_I_SCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_UFD_UID_S2PC_UFD_IPCLKPORT_PCLK, DIV_CLK_UFD_NOC, CLK_CON_GAT_CLK_BLK_UFD_UID_S2PC_UFD_IPCLKPORT_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_UFD_UID_S2PC_UFD_IPCLKPORT_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_UFD_UID_S2PC_UFD_IPCLKPORT_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_UFS_UID_S2MPU_UFS_S0_PMMU0_IPCLKPORT_CLK, MUX_CLKCMU_UFS_NOC_USER, CLK_CON_GAT_CLK_BLK_UFS_UID_S2MPU_UFS_S0_PMMU0_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_UFS_UID_S2MPU_UFS_S0_PMMU0_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_UFS_UID_S2MPU_UFS_S0_PMMU0_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_UFS_UID_S2MPU_UFS_S0_IPCLKPORT_CLK, MUX_CLKCMU_UFS_NOC_USER, CLK_CON_GAT_CLK_BLK_UFS_UID_S2MPU_UFS_S0_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_UFS_UID_S2MPU_UFS_S0_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_UFS_UID_S2MPU_UFS_S0_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_UFS_UID_XIU_MMU_UFS_IPCLKPORT_ACLK, MUX_CLKCMU_UFS_NOC_USER, CLK_CON_GAT_CLK_BLK_UFS_UID_XIU_MMU_UFS_IPCLKPORT_ACLK_CG_VAL, CLK_CON_GAT_CLK_BLK_UFS_UID_XIU_MMU_UFS_IPCLKPORT_ACLK_MANUAL, CLK_CON_GAT_CLK_BLK_UFS_UID_XIU_MMU_UFS_IPCLKPORT_ACLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_UFS_UID_ECU_UFS_IPCLKPORT_PCLK, MUX_CLKCMU_UFS_NOC_USER, CLK_CON_GAT_CLK_BLK_UFS_UID_ECU_UFS_IPCLKPORT_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_UFS_UID_ECU_UFS_IPCLKPORT_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_UFS_UID_ECU_UFS_IPCLKPORT_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_UFS_UID_ECU_UFS_IPCLKPORT_CLK, DIV_CLK_UFS_ECU, CLK_CON_GAT_CLK_BLK_UFS_UID_ECU_UFS_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_UFS_UID_ECU_UFS_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_UFS_UID_ECU_UFS_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_UFS_UID_RSTNSYNC_SR_CLK_UFS_ECU_IPCLKPORT_CLK, DIV_CLK_UFS_ECU, CLK_CON_GAT_CLK_BLK_UFS_UID_RSTNSYNC_SR_CLK_UFS_ECU_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_UFS_UID_RSTNSYNC_SR_CLK_UFS_ECU_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_UFS_UID_RSTNSYNC_SR_CLK_UFS_ECU_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_VTS_AUD_DMIC, DIV_CLK_VTS_AUD_DMIC, CLK_CON_GAT_CLK_VTS_AUD_DMIC_CG_VAL, CLK_CON_GAT_CLK_VTS_AUD_DMIC_MANUAL, CLK_CON_GAT_CLK_VTS_AUD_DMIC_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_VTS_UID_LH_AXI_MI_P_VC2VTS_INT_IPCLKPORT_I_CLK, DIV_CLK_VTS_NOC, CLK_CON_GAT_CLK_BLK_VTS_UID_LH_AXI_MI_P_VC2VTS_INT_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_VTS_UID_LH_AXI_MI_P_VC2VTS_INT_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_VTS_UID_LH_AXI_MI_P_VC2VTS_INT_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_VTS_UID_LH_AXI_SI_D_VTS2VC_INT_IPCLKPORT_I_CLK, DIV_CLK_VTS_NOC, CLK_CON_GAT_CLK_BLK_VTS_UID_LH_AXI_SI_D_VTS2VC_INT_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_VTS_UID_LH_AXI_SI_D_VTS2VC_INT_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_VTS_UID_LH_AXI_SI_D_VTS2VC_INT_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_VTS_UID_SERIAL_LIF_US_PROX_VTS_IPCLKPORT_ACLK, DIV_CLK_VTS_NOC, CLK_CON_GAT_CLK_BLK_VTS_UID_SERIAL_LIF_US_PROX_VTS_IPCLKPORT_ACLK_CG_VAL, CLK_CON_GAT_CLK_BLK_VTS_UID_SERIAL_LIF_US_PROX_VTS_IPCLKPORT_ACLK_MANUAL, CLK_CON_GAT_CLK_BLK_VTS_UID_SERIAL_LIF_US_PROX_VTS_IPCLKPORT_ACLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_VTS_UID_SERIAL_LIF_US_PROX_VTS_IPCLKPORT_PCLK, DIV_CLK_VTS_NOC, CLK_CON_GAT_CLK_BLK_VTS_UID_SERIAL_LIF_US_PROX_VTS_IPCLKPORT_PCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_VTS_UID_SERIAL_LIF_US_PROX_VTS_IPCLKPORT_PCLK_MANUAL, CLK_CON_GAT_CLK_BLK_VTS_UID_SERIAL_LIF_US_PROX_VTS_IPCLKPORT_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_VTS_UID_RSTNSYNC_SR_CLK_VTS_SERIAL_LIF_US_PROX_CORE_IPCLKPORT_CLK, DIV_CLK_VTS_SERIAL_LIF_US_PROX_CORE, CLK_CON_GAT_CLK_BLK_VTS_UID_RSTNSYNC_SR_CLK_VTS_SERIAL_LIF_US_PROX_CORE_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_VTS_UID_RSTNSYNC_SR_CLK_VTS_SERIAL_LIF_US_PROX_CORE_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_VTS_UID_RSTNSYNC_SR_CLK_VTS_SERIAL_LIF_US_PROX_CORE_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_VTS_UID_SERIAL_LIF_US_PROX_VTS_IPCLKPORT_RX_BCLK, DIV_CLK_VTS_SERIAL_LIF_US_PROX, CLK_CON_GAT_CLK_BLK_VTS_UID_SERIAL_LIF_US_PROX_VTS_IPCLKPORT_RX_BCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_VTS_UID_SERIAL_LIF_US_PROX_VTS_IPCLKPORT_RX_BCLK_MANUAL, CLK_CON_GAT_CLK_BLK_VTS_UID_SERIAL_LIF_US_PROX_VTS_IPCLKPORT_RX_BCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_VTS_UID_SERIAL_LIF_US_PROX_VTS_IPCLKPORT_CCLK, DIV_CLK_VTS_SERIAL_LIF_US_PROX_CORE, CLK_CON_GAT_CLK_BLK_VTS_UID_SERIAL_LIF_US_PROX_VTS_IPCLKPORT_CCLK_CG_VAL, CLK_CON_GAT_CLK_BLK_VTS_UID_SERIAL_LIF_US_PROX_VTS_IPCLKPORT_CCLK_MANUAL, CLK_CON_GAT_CLK_BLK_VTS_UID_SERIAL_LIF_US_PROX_VTS_IPCLKPORT_CCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_VTS_UID_RSTNSYNC_SR_CLK_VTS_SERIAL_LIF_US_PROX_IPCLKPORT_CLK, DIV_CLK_VTS_SERIAL_LIF_US_PROX, CLK_CON_GAT_CLK_BLK_VTS_UID_RSTNSYNC_SR_CLK_VTS_SERIAL_LIF_US_PROX_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_VTS_UID_RSTNSYNC_SR_CLK_VTS_SERIAL_LIF_US_PROX_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_VTS_UID_RSTNSYNC_SR_CLK_VTS_SERIAL_LIF_US_PROX_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_VTS_UID_PDM_DELAY_REMOVER_IPCLKPORT_DMIC_DIV_CLK, DIV_CLK_VTS_DMIC_IF_DIV2, CLK_CON_GAT_CLK_BLK_VTS_UID_PDM_DELAY_REMOVER_IPCLKPORT_DMIC_DIV_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_VTS_UID_PDM_DELAY_REMOVER_IPCLKPORT_DMIC_DIV_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_VTS_UID_PDM_DELAY_REMOVER_IPCLKPORT_DMIC_DIV_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_VTS_UID_RSTNSYNC_CLK_VTS_AUD_PDM_IPCLKPORT_CLK, CLK_VTS_AUD_DMIC, CLK_CON_GAT_CLK_BLK_VTS_UID_RSTNSYNC_CLK_VTS_AUD_PDM_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_VTS_UID_RSTNSYNC_CLK_VTS_AUD_PDM_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_VTS_UID_RSTNSYNC_CLK_VTS_AUD_PDM_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_YUVP_UID_PPMU_D0_YUVP_IPCLKPORT_ACLK, MUX_CLKCMU_YUVP_NOC_USER, CLK_CON_GAT_CLK_BLK_YUVP_UID_PPMU_D0_YUVP_IPCLKPORT_ACLK_CG_VAL, CLK_CON_GAT_CLK_BLK_YUVP_UID_PPMU_D0_YUVP_IPCLKPORT_ACLK_MANUAL, CLK_CON_GAT_CLK_BLK_YUVP_UID_PPMU_D0_YUVP_IPCLKPORT_ACLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_YUVP_UID_SYSMMU_YUVP_S0_PMMU0_IPCLKPORT_CLK, MUX_CLKCMU_YUVP_NOC_USER, CLK_CON_GAT_CLK_BLK_YUVP_UID_SYSMMU_YUVP_S0_PMMU0_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_YUVP_UID_SYSMMU_YUVP_S0_PMMU0_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_YUVP_UID_SYSMMU_YUVP_S0_PMMU0_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_YUVP_UID_XIU_D0_YUVP_IPCLKPORT_ACLK, MUX_CLKCMU_YUVP_NOC_USER, CLK_CON_GAT_CLK_BLK_YUVP_UID_XIU_D0_YUVP_IPCLKPORT_ACLK_CG_VAL, CLK_CON_GAT_CLK_BLK_YUVP_UID_XIU_D0_YUVP_IPCLKPORT_ACLK_MANUAL, CLK_CON_GAT_CLK_BLK_YUVP_UID_XIU_D0_YUVP_IPCLKPORT_ACLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_YUVP_UID_YUVP_IPCLKPORT_CLK, MUX_CLKCMU_YUVP_NOC_USER, CLK_CON_GAT_CLK_BLK_YUVP_UID_YUVP_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_YUVP_UID_YUVP_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_YUVP_UID_YUVP_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_YUVP_UID_LH_AST_SI_OTF_YUVPMCSC_IPCLKPORT_I_CLK, MUX_CLKCMU_YUVP_NOC_USER, CLK_CON_GAT_CLK_BLK_YUVP_UID_LH_AST_SI_OTF_YUVPMCSC_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_YUVP_UID_LH_AST_SI_OTF_YUVPMCSC_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_YUVP_UID_LH_AST_SI_OTF_YUVPMCSC_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_YUVP_UID_VGEN_LITE_YUVP_IPCLKPORT_CLK, MUX_CLKCMU_YUVP_NOC_USER, CLK_CON_GAT_CLK_BLK_YUVP_UID_VGEN_LITE_YUVP_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_YUVP_UID_VGEN_LITE_YUVP_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_YUVP_UID_VGEN_LITE_YUVP_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_YUVP_UID_SLH_AST_SI_G_PPMU_YUVP_IPCLKPORT_I_CLK, MUX_CLKCMU_YUVP_NOC_USER, CLK_CON_GAT_CLK_BLK_YUVP_UID_SLH_AST_SI_G_PPMU_YUVP_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_YUVP_UID_SLH_AST_SI_G_PPMU_YUVP_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_YUVP_UID_SLH_AST_SI_G_PPMU_YUVP_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_YUVP_UID_RSTNSYNC_SR_CLK_YUVP_NOCD_IPCLKPORT_CLK, MUX_CLKCMU_YUVP_NOC_USER, CLK_CON_GAT_CLK_BLK_YUVP_UID_RSTNSYNC_SR_CLK_YUVP_NOCD_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_YUVP_UID_RSTNSYNC_SR_CLK_YUVP_NOCD_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_YUVP_UID_RSTNSYNC_SR_CLK_YUVP_NOCD_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_YUVP_UID_PPMU_D1_YUVP_IPCLKPORT_ACLK, MUX_CLKCMU_YUVP_NOC_USER, CLK_CON_GAT_CLK_BLK_YUVP_UID_PPMU_D1_YUVP_IPCLKPORT_ACLK_CG_VAL, CLK_CON_GAT_CLK_BLK_YUVP_UID_PPMU_D1_YUVP_IPCLKPORT_ACLK_MANUAL, CLK_CON_GAT_CLK_BLK_YUVP_UID_PPMU_D1_YUVP_IPCLKPORT_ACLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_YUVP_UID_LH_AXI_SI_D0_YUVP_IPCLKPORT_I_CLK, MUX_CLKCMU_YUVP_NOC_USER, CLK_CON_GAT_CLK_BLK_YUVP_UID_LH_AXI_SI_D0_YUVP_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_YUVP_UID_LH_AXI_SI_D0_YUVP_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_YUVP_UID_LH_AXI_SI_D0_YUVP_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_YUVP_UID_LH_AXI_SI_D1_YUVP_IPCLKPORT_I_CLK, MUX_CLKCMU_YUVP_NOC_USER, CLK_CON_GAT_CLK_BLK_YUVP_UID_LH_AXI_SI_D1_YUVP_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_YUVP_UID_LH_AXI_SI_D1_YUVP_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_YUVP_UID_LH_AXI_SI_D1_YUVP_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_YUVP_UID_XIU_D1_YUVP_IPCLKPORT_ACLK, MUX_CLKCMU_YUVP_NOC_USER, CLK_CON_GAT_CLK_BLK_YUVP_UID_XIU_D1_YUVP_IPCLKPORT_ACLK_CG_VAL, CLK_CON_GAT_CLK_BLK_YUVP_UID_XIU_D1_YUVP_IPCLKPORT_ACLK_MANUAL, CLK_CON_GAT_CLK_BLK_YUVP_UID_XIU_D1_YUVP_IPCLKPORT_ACLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_YUVP_UID_SYSMMU_YUVP_S0_PMMU1_IPCLKPORT_CLK, MUX_CLKCMU_YUVP_NOC_USER, CLK_CON_GAT_CLK_BLK_YUVP_UID_SYSMMU_YUVP_S0_PMMU1_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_YUVP_UID_SYSMMU_YUVP_S0_PMMU1_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_YUVP_UID_SYSMMU_YUVP_S0_PMMU1_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_YUVP_UID_LH_AST_SI_OTF_YUVPMCFP_IPCLKPORT_I_CLK, MUX_CLKCMU_YUVP_NOC_USER, CLK_CON_GAT_CLK_BLK_YUVP_UID_LH_AST_SI_OTF_YUVPMCFP_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_YUVP_UID_LH_AST_SI_OTF_YUVPMCFP_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_YUVP_UID_LH_AST_SI_OTF_YUVPMCFP_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_YUVP_UID_YUVP_IPCLKPORT_CLK_VOTF0, MUX_CLKCMU_YUVP_NOC_USER, CLK_CON_GAT_CLK_BLK_YUVP_UID_YUVP_IPCLKPORT_CLK_VOTF0_CG_VAL, CLK_CON_GAT_CLK_BLK_YUVP_UID_YUVP_IPCLKPORT_CLK_VOTF0_MANUAL, CLK_CON_GAT_CLK_BLK_YUVP_UID_YUVP_IPCLKPORT_CLK_VOTF0_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(CLK_BLK_YUVP_UID_SYSMMU_YUVP_S0_IPCLKPORT_CLK, MUX_CLKCMU_YUVP_NOC_USER, CLK_CON_GAT_CLK_BLK_YUVP_UID_SYSMMU_YUVP_S0_IPCLKPORT_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_YUVP_UID_SYSMMU_YUVP_S0_IPCLKPORT_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_YUVP_UID_SYSMMU_YUVP_S0_IPCLKPORT_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_YUVP_UID_XIU_MMU_YUVP_IPCLKPORT_ACLK, MUX_CLKCMU_YUVP_NOC_USER, CLK_CON_GAT_CLK_BLK_YUVP_UID_XIU_MMU_YUVP_IPCLKPORT_ACLK_CG_VAL, CLK_CON_GAT_CLK_BLK_YUVP_UID_XIU_MMU_YUVP_IPCLKPORT_ACLK_MANUAL, CLK_CON_GAT_CLK_BLK_YUVP_UID_XIU_MMU_YUVP_IPCLKPORT_ACLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_YUVP_UID_AD_APB_YUVP_IPCLKPORT_PCLKM, MUX_CLKCMU_YUVP_NOC_USER, CLK_CON_GAT_CLK_BLK_YUVP_UID_AD_APB_YUVP_IPCLKPORT_PCLKM_CG_VAL, CLK_CON_GAT_CLK_BLK_YUVP_UID_AD_APB_YUVP_IPCLKPORT_PCLKM_MANUAL, CLK_CON_GAT_CLK_BLK_YUVP_UID_AD_APB_YUVP_IPCLKPORT_PCLKM_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_YUVP_UID_LH_AST_MI_OTF_MCFPYUVP_IPCLKPORT_I_CLK, MUX_CLKCMU_YUVP_NOC_USER, CLK_CON_GAT_CLK_BLK_YUVP_UID_LH_AST_MI_OTF_MCFPYUVP_IPCLKPORT_I_CLK_CG_VAL, CLK_CON_GAT_CLK_BLK_YUVP_UID_LH_AST_MI_OTF_MCFPYUVP_IPCLKPORT_I_CLK_MANUAL, CLK_CON_GAT_CLK_BLK_YUVP_UID_LH_AST_MI_OTF_MCFPYUVP_IPCLKPORT_I_CLK_ENABLE_AUTOMATIC_CLKGATING),
};

unsigned int cmucal_fixed_rate_size = 91;
struct cmucal_clk_fixed_rate cmucal_fixed_rate_list[] = {
	...
	FIXEDRATE(FREE_OSCCLK_AOCCSIS, 76800000, EMPTY_CAL_ID),
	...
	FIXEDRATE(FREE_OSCCLK_ICPU, 100000000, EMPTY_CAL_ID),
	...
	FIXEDRATE(FREE_OSCCLK_MFC, 76800000, EMPTY_CAL_ID),
	FIXEDRATE(FREE_OSCCLK_MFD, 76800000, EMPTY_CAL_ID),
	...
	FIXEDRATE(FREE_OSCCLK_RGBP, 100000000, EMPTY_CAL_ID),
	...
	FIXEDRATE(FREE_OSCCLK_STRONG, 76800000, EMPTY_CAL_ID),
...
unsigned int cmucal_fixed_factor_size = 61;
struct cmucal_clk_fixed_factor cmucal_fixed_factor_list[] = {
	...
	FIXEDFACTOR(CLK_CPUCL1_DDD_CTRL_3, CLK_CPUCL1_DDD_3, 3, CLK_CON_DIV_CLK_CPUCL1_DDD_CTRL_3_ENABLE_AUTOMATIC_CLKGATING),
	...
	FIXEDFACTOR(CLKCMU_OTP, FREE_OSCCLK_PERIS, 7, CLK_CON_DIV_CLKCMU_OTP_ENABLE_AUTOMATIC_CLKGATING),
