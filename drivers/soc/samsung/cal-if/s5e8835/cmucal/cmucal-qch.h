...
#include "../../cmucal.h"
enum qch_id {
    GREBEINTEGRATION_QCH_GREBE = QCH_TYPE,
    ...
    LH_AXI_MI_D0_G3D_QCH,
    LH_AXI_MI_D_MFC_QCH,
    LH_AXI_MI_D1_G3D_QCH,
    LH_AST_MI_G_NOCL1A_NOCL0_QCH,
    LH_AST_MI_G_CAM_NOCL0_QCH,
    VGEN_LITE_NOCL0_QCH,
    ...
    QE_CSIS0_QCH,
    OIS_MCU_TOP_QCH,
    SLH_AXI_SI_LP_CSISPERI_QCH,
    LH_AXI_MI_LP_OIS_MCU_INT_QCH,
    ...
    MAILBOX_AP_VTS_QCH,
    DMIC_AHB0_QCH_PCLK,
    LH_AXI_MI_P_MVTS_INT_QCH,
    HWACG_SYS_DMIC2_QCH,
    HWACG_SYS_DMIC0_QCH,
    TIMER_VTS_QCH,
    MAILBOX_ABOX_VTS_QCH,
    LH_AXI_SI_P_SVTS_INT_QCH,
    CMU_VTS_QCH,
    DMIC_AHB2_QCH_PCLK,
    ...
    LH_AXI_MI_P_SVTS_INT_QCH,
    SWEEPER_C_CHUBVTS_QCH,
    BAAW_VTS_QCH,
    SLH_AXI_SI_D_CHUBVTSALIVE_QCH,
    LH_AXI_SI_P_MCHUB_INT_QCH,
    LH_AXI_SI_P_MVTS_INT_QCH,
    CMU_CHUBVTS_QCH,
    SYSREG_USB_QCH,
    VGEN_LITE_USB_QCH,
    LH_AXI_SI_D_USB_QCH,
    ...
    SYSMMU_D1_G3D_QCH,
    SYSMMU_D0_G3D_QCH,
    LH_AXI_SI_D1_G3D_QCH,
    LH_AXI_SI_D0_G3D_QCH,
    PPMU_D0_G3D_QCH,
    VGEN_LITE_D_G3D_QCH,
    ...
    HTU_G3D_QCH_PCLK,
    GPU_QCH,
    LH_AXI_SI_D_NPU0NPUS_RQ_QCH,
    LH_AXI_MI_D1_NPUSNPU0_QCH,
    LH_AXI_SI_D_NPU0NPUS_CMDQ_QCH,
    LH_AXI_MI_D0_NPUSNPU0_QCH,
    SLH_AXI_MI_P_NPU0_QCH,
    SYSREG_NPU0_QCH,
    D_TZPC_NPU0_QCH,
    CMU_NPU0_QCH,
    LH_AXI_MI_D_NPUSNPU0_CTRL_QCH,
    IP_NPUCORE_QCH_ACLK,
    IP_NPUCORE_QCH_PCLK,
    VGEN_LITE_NPUS_QCH,
    SYSMMU_D0_NPUS_QCH_S1,
    SYSMMU_D0_NPUS_QCH_S2,
    LH_AXI_SI_D_NPUSNPU0_CTRL_QCH,
    LH_AXI_SI_D1_NPUSNPU0_QCH,
    LH_AXI_MI_P_NPUS_INT_QCH,
    SYSMMU_D1_NPUS_QCH_S1,
    SYSMMU_D1_NPUS_QCH_S2,
    LH_AXI_SI_D1_NPUS_QCH,
    LH_AXI_MI_D_NPU0NPUS_RQ_QCH,
    LH_AXI_MI_D_NPU0NPUS_CMDQ_QCH,
    LH_AXI_SI_D0_NPUS_QCH,
    LH_AXI_SI_D0_NPUSNPU0_QCH,
    IP_NPUS_QCH,
    IP_NPUS_QCH_CPU,
    IP_NPUS_QCH_NEON,
    IP_NPUS_QCH_C2A0,
    ...
    PPMU_D3_RGBP_QCH,
    CMU_RGBP_QCH,
    LH_AXI_MI_D2_RGBP_INT_QCH,
    LH_AXI_MI_D1_CSTAT_QCH,
    LH_AXI_MI_D1_CSIS_QCH,
    LH_AST_SI_G_CAM_NOCL0_QCH,
    LH_AXI_MI_D1_RGBP_INT_QCH,
    LH_TAXI_SI_D1_CAM_NOCL0_QCH,
    LH_AXI_MI_D_ICPU_QCH,
    LH_AXI_MI_D_YUVP_QCH,
    LH_AXI_MI_D0_RGBP_INT_QCH,
    LH_TAXI_SI_D0_CAM_NOCL0_QCH,
    LH_AXI_MI_D0_CSTAT_QCH,
    LH_AXI_MI_D0_CSIS_QCH,
    LH_AXI_MI_D3_RGBP_INT_QCH,
...
enum option_id {
    CTRL_OPTION_S5E8835 = OPTION_TYPE,
    CTRL_OPTION_TOP,
    CTRL_OPTION_ALIVE,
    CTRL_OPTION_S2D,
    CTRL_OPTION_NOCL0,
