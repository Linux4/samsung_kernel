...
struct pmucal_seq core12_status[] = {
	PMUCAL_SEQ_DESC(PMUCAL_READ, "CLUSTER1_CPU2_STATUS", 0x11860000, 0x1604, (0x1 << 0), 0, 0, 0, 0xffffffff, 0),
};
...
struct pmucal_seq core13_status[] = {
	PMUCAL_SEQ_DESC(PMUCAL_READ, "CLUSTER1_CPU3_STATUS", 0x11860000, 0x1684, (0x1 << 0), 0, 0, 0, 0xffffffff, 0),
};
...
struct pmucal_seq core00_on[] = {
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "HCHGEN_CLKMUX_CPU_CMU_CPUCL0_HCHGEN_CLKMUX_CPU", 0x10820000, 0x0004, (0x1 << 5), (0x1 << 5), 0, 0, 0xffffffff, 0),
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "HCHGEN_CLKMUX_CPU_SW_CMU_CPUCL0_HCHGEN_CLKMUX_CPU", 0x10820000, 0x0008, (0x1 << 5), (0x1 << 5), 0, 0, 0xffffffff, 0),
	PMUCAL_SEQ_DESC(PMUCAL_EXT_FUNC, "cluster0_cpu_up", 0, 0, 0x21, 0x0, 0, 0, 0, 0),
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "HCHGEN_CLKMUX_CPU_CMU_CPUCL0_HCHGEN_CLKMUX_CPU", 0x10820000, 0x0004, (0x1 << 5), (0x0 << 5), 0, 0, 0xffffffff, 0),
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "HCHGEN_CLKMUX_CPU_SW_CMU_CPUCL0_HCHGEN_CLKMUX_CPU", 0x10820000, 0x0008, (0x1 << 5), (0x0 << 5), 0, 0, 0xffffffff, 0),
};
...
struct pmucal_seq core10_on[] = {
	...
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "HCHGEN_CLKMUX_CPU_SW_CMU_CPUCL1_HCHGEN_CLKMUX_CPU", 0x10830000, 0x0008, (0x1 << 5), (0x1 << 5), 0, 0, 0xffffffff, 0),
	...
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "HCHGEN_CLKMUX_CPU_SW_CMU_CPUCL1_HCHGEN_CLKMUX_CPU", 0x10830000, 0x0008, (0x1 << 5), (0x0 << 5), 0, 0, 0xffffffff, 0),
};
