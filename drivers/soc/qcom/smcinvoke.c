	...
	*tz_acked = false;
	...
	while (1) {
		...
		if (desc.ret[0] == QSEOS_RESULT_INCOMPLETE ||
			...
			/* qseecom fills result inside ret0 and the response type
			 * inside ret1. Swapping the values here according to the
			 * normal smcinvoke flow
			 */
			req->result = (int32_t)desc.ret[0];
