...
static int handle_alloc_req(void *req_h, void *req, void *conn_h)
{
	...
	pr_info("%s: alloc_resp.num_bytes :%d, alloc_resp.handle :%lx, \
				alloc_resp.mem_req_result :%lx\n", __func__,
				alloc_resp.num_bytes, (unsigned long int)alloc_resp.handle,
