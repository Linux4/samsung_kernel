			...
			char *buf)
{
	...
	if(strstr(saved_command_line,"dsi_ft8203")!= NULL)
	{
		strncpy(lcd_tp_info, "ft8203", strlen("ft8203"));
	}
	else if(strstr(saved_command_line,"dsi_hx83102j_starry") != NULL)
	{
		strncpy(lcd_tp_info, "starry", strlen("starry"));
	}
	else if(strstr(saved_command_line,"dsi_hx83102j_lide") != NULL)
	{
		strncpy(lcd_tp_info, "lide", strlen("lide"));
	}
	else if(strstr(saved_command_line,"dsi_icnl9958r") != NULL)
	{
