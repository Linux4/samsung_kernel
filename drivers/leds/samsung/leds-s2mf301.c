...
static void s2mf301_fled_init(struct s2mf301_fled_data *fled)
{
	...
	s2mf301_update_reg(i2c, S2MF301_FLED_CTRL1,
	  S2MF301_FLED_FLASH_GPIO << S2MF301_FLED_FLASH_SHIFT, S2MF301_CHX_FLASH_FLED_EN);
	s2mf301_update_reg(i2c, S2MF301_FLED_CTRL1,
	  S2MF301_FLED_TORCH_GPIO << S2MF301_FLED_TORCH_SHIFT, S2MF301_CHX_TORCH_FLED_EN);
#if IS_ENABLED(DEBUG_TEST_READ)
	s2mf301_fled_test_read(fled);
#endif
}
...
static DEVICE_ATTR(rear_flash, S_IRUSR|S_IWUSR|S_IRGRP|S_IWGRP|S_IROTH,
	s2mf301_rear_flash_show, s2mf301_rear_flash_store);
