...
#if defined(CONFIG_SEC_XCOVER3_PROJECT) || defined(CONFIG_MACH_J3LTE_CHN_CTC) || defined( CONFIG_MACH_J3LTE_KOR_OPEN )||defined( CONFIG_MACH_J5XLTE_EUR_OPEN )||defined( CONFIG_MACH_J5X3G_MEA_JV )||defined( CONFIG_MACH_J7_USA_SPR )||defined( CONFIG_MACH_J3LTE_USA_VZW)
