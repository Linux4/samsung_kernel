...
static int s2mu107_led_suspend(struct device *dev)
{
...
static int s2mu107_led_resume(struct device *dev)
{
	pr_info("%s\n", __func__);
...
static const struct dev_pm_ops s2mu107_led_pm_ops = {
	.suspend                = s2mu107_led_suspend,
	.resume                 = s2mu107_led_resume,
};
