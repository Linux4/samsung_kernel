...
ssize_t sm5714_store(const char *buf)
{
	u32 store_value;
	int ret;
	struct sm5714_fled_data *fled = g_sm5714_fled;
...
EXPORT_SYMBOL(sm5714_store);

ssize_t sm5714_show(char *buf)
{
	struct sm5714_fled_data *fled = g_sm5714_fled;
...
{
#if defined(CONFIG_MACH_A23XQ_USA_TFN) || defined(CONFIG_MACH_A23XQ_USA_OPEN) || defined(CONFIG_MACH_A23XQ_USA_SINGLE)
	return 0;
#endif
#if defined(CONFIG_SEC_A23XQ_PROJECT)
#if defined(CONFIG_MACH_A23XQ_USA_SINGLEW)
	if(get_hw_rev_for_vois()>=13){
