...
#if defined(CONFIG_MACH_GRANDPRIMEVE3G) || defined(CONFIG_MACH_COREPRIMEVE3G) || defined(CONFIG_MACH_J23G)
...
#elif defined(CONFIG_MACH_COREPRIMEVE3G) || defined(CONFIG_MACH_J23G)
