...
#undef USE_MPI_LIBRARY	// use MPI library for bignum
#ifdef USE_MPI_LIBRARY
#include <linux/mpi.h>
...
{
#ifdef USE_MPI_LIBRARY
	return mpihelp_mul_1((mpi_ptr_t)rp, (mpi_ptr_t)up, 
						(mpi_size_t)n, (mpi_limb_t)vl);
#else 
...
{
#ifdef USE_MPI_LIBRARY
	return mpihelp_addmul_1((mpi_ptr_t)rp, (mpi_ptr_t)up, 
						(mpi_size_t)n, (mpi_limb_t)vl);
#else
