...
#if defined(CONFIG_EXYNOS7580_BTS)
...
typedef enum {
	...
	BTS_SYSREG_FIMC_SC_SEL,
	BTS_SYSREG_FIMC_FD_SEL
...
typedef enum {
	...
	BTS_SYSREG_ISP0,		/* FIMC_SCL, FIMC_FD, FIMC_ISP */
	BTS_SYSREG_ISP1,		/* CPU_ISP, FIMC_BNS_L, FIMC_BNS */
...
/* SYSREG offsets */
#define DISP_XIU_DISP_QOS_CON			0x600
