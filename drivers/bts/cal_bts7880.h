...
#if defined(CONFIG_EXYNOS7880_BTS)
...
typedef enum {
	...
	BTS_SYSREG_MODAPIF_CP,
	BTS_SYSREG_MODAPIF_GNSS,
	BTS_SYSREG_CCORE_CPU,
	BTS_SYSREG_CCORE_APL,
	BTS_SYSREG_MFCMSCL0,
	BTS_SYSREG_MFCMSCL1,
...
#define ISP_XIU_ISP1_AR_AC_TARGET_CON		0x1050
#define ISP_XIU_ISP1_AW_AC_TARGET_CON		0x1054

#define MFCMSCL_QOS_CON_MFC			0x600
#define MFCMSCL_QOS_CON_MSCL			0x604

#define FSYS_QOS_CON0				0x600
#define FSYS_QOS_CON1				0x604
#define FSYS_QOS_CON2				0x608

#define PMUALIVE_MODAPIF_CP_QOS_CON		0x078
#define PMUALIVE_MODAPIF_GNSS_QOS_CON		0x0B8
#define CCORE_CPU_QOS_CON			0x224
#define CCORE_APL_QOS_CON			0x228

#define CP_QOS_OVERRIDE				0x1
#define GNSS_QOS_OVERRIDE			0x1

#define XIU0_AR_TIDEMARK			0x250
#define XIU0_AW_TIDEMARK			0x254
#define XIU1_AR_TIDEMARK			0x258
#define XIU1_AW_TIDEMARK			0x25C

#define BUSD0_M0				0x1000
#define BUSD0_S0				0x1004
#define BUSD0_S1				0x1008

#define XIU_IS1_TARGET				0x1054

#define IDMA_G0_IN_CON				0x1008
#define IDMA_G1_IN_CON				0x2008
#define IDMA_G2_IN_CON				0x3008
#define IDMA_VG0_IN_CON				0x4008

#define G3D_RQOS_CONTROL			0x100
#define G3D_WQOS_CONTROL			0x180
#define G3D_RQOS_MODE				0x104
#define G3D_WQOS_MODE				0x184
#define G3D_RMO_UPPER				0x240
#define G3D_RMO_LOWER				0x244
#define G3D_WMO_UPPER				0x340
#define G3D_WMO_LOWER				0x344
