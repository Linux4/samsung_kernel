...
#define MMSS_CAMSS_GP0_CMD_RCGR		((void __iomem *)(virt_mmss_gp0_base + 0x0))    //GCC_GP0_CMD_RCGR
#define MMSS_CAMSS_GP0_CFG_RCGR		((void __iomem *)(virt_mmss_gp0_base + 0x4))    //GCC_GP0_CFG_RCGR
#define MMSS_CAMSS_GP0_M		((void __iomem *)(virt_mmss_gp0_base + 0x8))    //GCC_GP1_M 
#define MMSS_CAMSS_GP0_N		((void __iomem *)(virt_mmss_gp0_base + 0xC))    //GCC_GP1_N
#define MMSS_CAMSS_GP0_D		((void __iomem *)(virt_mmss_gp0_base + 0x10))   //GCC_GP1_D
