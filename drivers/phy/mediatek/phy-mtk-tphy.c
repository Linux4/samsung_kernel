				     ...
				     enum phy_mode mode)
{
	...
	case PHY_MODE_USB_DEVICE:
		...
		device_property_read_u32(dev, "mediatek,eye-disc",
				 &instance->eye_disc);
		device_property_read_u32(dev, "mediatek,eye-sqth",
				 &instance->eye_sqth);
		device_property_read_u32(dev, "mediatek,eye-intr_cal",
				 &instance->eye_intr_cal);
	...
	case PHY_MODE_USB_HOST:
		...
		device_property_read_u32(dev, "mediatek,host-eye-disc",
				 &instance->eye_disc);
		device_property_read_u32(dev, "mediatek,host-eye-sqth",
				 &instance->eye_sqth);
		device_property_read_u32(dev, "mediatek,host-eye-intrl_cal",
				 &instance->eye_intr_cal);
		u2_phy_props_set(tphy, instance);
		break;
			     ...
			     struct mtk_phy_instance *instance)
{
	...
	dev_info(dev, "%s, bc12:%d, src:%d, vrt:%d, term:%d, rev6:%d, dis:%d sqth:%d intr_cal:%d\n",
		__func__, instance->bc12_en, instance->eye_src,
		instance->eye_vrt, instance->eye_term, instance->eye_rev6,
		instance->eye_disc, instance->eye_sqth, instance->eye_intr_cal);
