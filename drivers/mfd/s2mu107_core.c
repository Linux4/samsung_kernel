			     ...
			     const struct i2c_device_id *dev_id)
{
	...
	if (pdata) {
		s2mu107->pdata = pdata;
#if defined(CONFIG_PM_S2MU107) || defined(CONFIG_CHARGER_S2MU107) || defined(CONFIG_LEDS_S2MU107_FLASH) || defined(CONFIG_MUIC_S2MU107) || defined(CONFIG_HV_MUIC_S2MU107_AFC) || defined(CONFIG_CHARGER_S2MU107_DIRECT)
