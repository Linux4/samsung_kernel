...
{
	s2mpu15->vgpio = devm_i2c_new_dummy_device(s2mpu15->dev, s2mpu15->i2c->adapter, I2C_ADDR_TEMP);
	s2mpu15->pmic1 = devm_i2c_new_dummy_device(s2mpu15->dev, s2mpu15->i2c->adapter, I2C_ADDR_PMIC1);
	s2mpu15->pmic2 = devm_i2c_new_dummy_device(s2mpu15->dev, s2mpu15->i2c->adapter, I2C_ADDR_PMIC2);
	s2mpu15->rtc = devm_i2c_new_dummy_device(s2mpu15->dev, s2mpu15->i2c->adapter, I2C_ADDR_RTC);
	s2mpu15->close1 = devm_i2c_new_dummy_device(s2mpu15->dev, s2mpu15->i2c->adapter, I2C_ADDR_CLOSE1);
	s2mpu15->close2 = devm_i2c_new_dummy_device(s2mpu15->dev, s2mpu15->i2c->adapter, I2C_ADDR_CLOSE2);
	s2mpu15->adc_i2c = devm_i2c_new_dummy_device(s2mpu15->dev, s2mpu15->i2c->adapter, I2C_ADDR_ADC);
	s2mpu15->gpio = s2mpu15->pmic1; // TODO: Check GPIO bitmap

	s2mpu15->i2c->addr = I2C_ADDR_COM;	/* forced COMMON address */
	s2mpu15->vgpio->addr = I2C_ADDR_VGPIO;
