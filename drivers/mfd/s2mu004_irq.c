...
static irqreturn_t s2mu004_irq_thread(int irq, void *data)
{
	...
	u8 temp_vdadc;
	u8 chg_status;
	u8 adc, dev_type1, dev_type2, dev_type3;
	...
	*/
	...
	/* adc, dev_type1~3 */
	ret = s2mu004_read_reg(s2mu004->i2c, S2MU004_REG_MUIC_ADC,
				&adc);
	ret = s2mu004_read_reg(s2mu004->i2c, S2MU004_REG_MUIC_DEVICE_TYPE1,
				&dev_type1);
	ret = s2mu004_read_reg(s2mu004->i2c, S2MU004_REG_MUIC_DEVICE_TYPE2,
				&dev_type2);
	ret = s2mu004_read_reg(s2mu004->i2c, S2MU004_REG_MUIC_DEVICE_TYPE3,
				&dev_type3);
