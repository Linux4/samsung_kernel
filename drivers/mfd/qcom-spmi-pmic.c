...
#ifdef CONFIG_SEC_PM
#define MAX_REGMAP_COUNT	6
static struct regmap *global_regmap[MAX_REGMAP_COUNT];
#endif /* CONFIG_SEC_PM */
...
#ifdef CONFIG_SEC_PM
struct regmap *get_globl_regmap(int usid)
{
	return global_regmap[usid];
}
EXPORT_SYMBOL_GPL(get_globl_regmap);
#endif /* CONFIG_SEC_PM */
...
#ifdef CONFIG_SEC_PM
	global_regmap[sdev->usid] = regmap;
#endif /* CONFIG_SEC_PM */
