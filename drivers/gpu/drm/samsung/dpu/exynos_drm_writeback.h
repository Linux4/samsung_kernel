...
static inline void writeback_exit_hibernation(struct writeback_device *wb) { return; }
static inline void writeback_enter_hibernation(struct writeback_device *wb) { return; }
#endif
