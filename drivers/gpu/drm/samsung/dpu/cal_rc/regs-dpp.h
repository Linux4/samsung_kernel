...
#define MAX_SAJC_PER_DPUF	4		/* TODO: delete */
...
enum dpp_regs_id {
	...
	REGS_DPP6_ID,
	REGS_DPP7_ID,
/* TBD: for other channels RCD/FCMD/WB
	REGS_DPP8_ID,
	REGS_DPP9_ID,
	REGS_DPP10_ID,
	REGS_DPP11_ID,
 ...
 * base address : 0x1489_0000 (DPU_DMA)
 * < Layer.offset >
...
#define IDMA_ERR_ADDR_P4                        (1 << 3) // C2 - P3
...
#define ODMA_DST_OFFSET_Y_MASK			(0x3FFF << 16) // 0x1FFF -> 0x3FFF
#define ODMA_DST_OFFSET_X(_v)			((_v) << 0)
#define ODMA_DST_OFFSET_X_MASK			(0x3FFF << 0)  // 0x1FFF -> 0x3FFF

#define ODMA_IMG_HEIGHT(_v)			((_v) << 16)
#define ODMA_IMG_HEIGHT_MASK			(0x3FFF << 16) // 0x1FFF -> 0x3FFF
#define ODMA_IMG_WIDTH(_v)			((_v) << 0)
#define ODMA_IMG_WIDTH_MASK			(0x3FFF << 0) // 0x1FFF -> 0x3FFF
...
/*************** REVISIT to add the L12 register settings **********/
...
/*************** REVISIT to add the L14 register settings **********/
/* Check below config or the Orange9815*/
 ...
 *-------------------------------------------------------------------
 */
#if 0 // TBD:  Not seen in Papaya, REVISIT
...
// Looks like Pamir-9925 register sets are similar ot Papaya, REVISIT
...
#define IDX_QUOTIENT(_i, den)			((_i) / (den))
#define IDX_REMAINDER(_i, den)			((_i) % (den))

#define C2S_TRS_ENABLE(_n)		(0x0300 + 0x0100 * IDX_QUOTIENT(_n, 5) \
						+ 0x2C * IDX_REMAINDER(_n, 5))
#define VOTF_TRS_EN				(1 << 0)

#define C2S_CON_LOST_RECOVER_CONFIG(_n)	(0x0304 + 0x0100 * IDX_QUOTIENT(_n, 5) \
						+ 0x2C * IDX_REMAINDER(_n, 5))
#define VOTF_CON_LOST_FLUSH_EN			(1 << 1)
#define VOTF_CON_LOST_RECOVER_EN		(1 << 0)

#define C2S_TRS_LIMIT(_n)		(0x0308 + 0x0100 * IDX_QUOTIENT(_n, 5) \
						+ 0x2C * IDX_REMAINDER(_n, 5))
#define VOTF_TRS_LIMIT_NUM			(0xFF << 0)

#define C2S_TOKEN_CROP_START(_n)	(0x030C + 0x0100 * IDX_QUOTIENT(_n, 5) \
						+ 0x2C * IDX_REMAINDER(_n, 5))
#define VOTF_CROP_START				(0xFFF << 0)

#define C2S_CROP_ENABLE(_n)		(0x0310 + 0x0100 * IDX_QUOTIENT(_n, 5) \
						+ 0x2C * IDX_REMAINDER(_n, 5))
#define VOTF_CROP_EN				(0x1 << 0)

#define C2S_LINE_IN_FIRST_TOKEN(_n)	(0x0314 + 0x0100 * IDX_QUOTIENT(_n, 5) \
						+ 0x2C * IDX_REMAINDER(_n, 5))
#define VOTF_FIRST_TOKEN			(0xFF << 0)

#define C2S_LINE_IN_TOKEN(_n)		(0x0318 + 0x0100 * IDX_QUOTIENT(_n, 5) \
						+ 0x2C * IDX_REMAINDER(_n, 5))
#define VOTF_LINE_TOKEN				(0xFF << 0)

#define C2S_LINE_COUNT(_n)		(0x031C + 0x0100 * IDX_QUOTIENT(_n, 5) \
						+ 0x2C * IDX_REMAINDER(_n, 5))
 ...
 * base address : 0x1484_0000(DPU_DPP0)
 * < Layer.offset >
...
#define DPP_SCL_SCALED_IMG_HEIGHT_MASK		(0x3FFF << 16) // 0x1FFF -> 0x3FFF
#define DPP_SCL_SCALED_IMG_WIDTH(_v)		((_v) << 0)
#define DPP_SCL_SCALED_IMG_WIDTH_MASK		(0x3FFF << 0)  // 0x1FFF -> 0x3FFF

#define DPP_COM_SCL_MAIN_H_RATIO		0x0204
#define DPP_SCL_H_RATIO(_v)			((_v) << 0)
#define DPP_SCL_H_RATIO_MASK			(0xFFFFFF << 0) // 0x7FFFFF -> 0xFFFFFF

#define DPP_COM_SCL_MAIN_V_RATIO		0x0208
#define DPP_SCL_V_RATIO(_v)			((_v) << 0)
#define DPP_SCL_V_RATIO_MASK			(0xFFFFFF << 0) // 0x7FFFFF -> 0xFFFFFF
...
#define DPP_V_COEF(n, s, x)			(0x210 + (n) * 0x4 +	\
						(s) * 0x24 + (x) * 0x1B0)
/* For 8k split - Is this applicable for Papaya ??? */
#if 0
#define DPP_SCL_YHPOSITION			0x0570
#define DPP_SCL_YHPOS_I(_v)			((_v) << 20)
#define DPP_SCL_YHPOS_I_MASK			(0xFFF << 20)
#define DPP_SCL_YHPOS_F(_v)			((_v) << 0)
#define DPP_SCL_YHPOS_F_MASK			(0xFFFFF << 0)

#define DPP_SCL_YVPOSITION			0x0574
#define DPP_SCL_YVPOS_I(_v)			((_v) << 20)
#define DPP_SCL_YVPOS_I_MASK			(0xFFF << 20)
#define DPP_SCL_YVPOS_F(_v)			((_v) << 0)
#define DPP_SCL_YVPOS_F_MASK			(0xFFFFF << 0)

#define DPP_SCL_CHPOSITION			0x0578
#define DPP_SCL_CHPOS_I(_v)			((_v) << 20)
#define DPP_SCL_CHPOS_I_MASK			(0xFFF << 20)
#define DPP_SCL_CHPOS_F(_v)			((_v) << 0)
#define DPP_SCL_CHPOS_F_MASK			(0xFFFFF << 0)

#define DPP_SCL_CVPOSITION			0x057C
#define DPP_SCL_CVPOS_I(_v)			((_v) << 20)
#define DPP_SCL_CVPOS_I_MASK			(0xFFF << 20)
#define DPP_SCL_CVPOS_F(_v)			((_v) << 0)
#define DPP_SCL_CVPOS_F_MASK			(0xFFFFF << 0)
