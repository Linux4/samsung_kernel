...
#define S6E3FC3_SELF_MASK_CRC_OFS	1
...
static struct resinfo s6e3fc3_restbl[MAX_RESTBL] = {
	...
	[RES_CCD_CHKSUM_PASS_LIST] = {
		...
		.data = S6E3FC3_CCD_CHKSUM_PASS_LIST,
		.dlen = ARRAY_SIZE(S6E3FC3_CCD_CHKSUM_PASS_LIST),
		.resui = NULL,
		.nr_resui = 0,
	},
#endif
...
#endif
	[DUMP_SELF_MASK_CRC] = DUMPINFO_INIT_V2(self_mask_crc, &s6e3fc3_restbl[RES_SELF_MASK_CRC], &OLED_FUNC(OLED_DUMP_SHOW_SELF_MASK_CRC), self_mask_crc_expects),
