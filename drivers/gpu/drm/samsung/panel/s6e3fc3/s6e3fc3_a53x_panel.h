...
static u8 A53X_FOD_ENTER_1[] = {
	0x63, 0xF1, 0x00
};
static DEFINE_STATIC_PACKET(a53x_fod_enter_1, DSI_PKT_TYPE_WR, A53X_FOD_ENTER_1, 0x203);

static u8 A53X_FOD_ENTER_2[] = {
	0xB5, 0x14
};
static DEFINE_STATIC_PACKET(a53x_fod_enter_2, DSI_PKT_TYPE_WR, A53X_FOD_ENTER_2, 0);

static u8 A53X_FOD_ENTER_3[] = {
	0x63, 0xF0, 0x07
};
static DEFINE_STATIC_PACKET(a53x_fod_enter_3, DSI_PKT_TYPE_WR, A53X_FOD_ENTER_3, 0x203);

static u8 A53X_FOD_EXIT_1[] = {
	0x63, 0xF1, 0x07
};
static DEFINE_STATIC_PACKET(a53x_fod_exit_1, DSI_PKT_TYPE_WR, A53X_FOD_EXIT_1, 0x203);

static u8 A53X_FOD_EXIT_2[] = {
	0xB5, 0x14
};
static DEFINE_STATIC_PACKET(a53x_fod_exit_2, DSI_PKT_TYPE_WR, A53X_FOD_EXIT_2, 0);

static u8 A53X_FOD_EXIT_3[] = {
	0x63, 0xF0, 0x00
};
static DEFINE_STATIC_PACKET(a53x_fod_exit_3, DSI_PKT_TYPE_WR, A53X_FOD_EXIT_3, 0x203);
...
static void *a53x_mask_layer_enter_br_cmdtbl[] = {
	...
	&PKTINFO(a53x_acl_control),
	&PKTINFO(a53x_dimming_speed),
	&PKTINFO(a53x_fod_enter_1),
	&PKTINFO(a53x_hbm_transition),
	&PKTINFO(a53x_wrdisbv),
	&PKTINFO(a53x_fod_enter_2),
...
static void *a53x_mask_layer_exit_br_cmdtbl[] = {
	...
	&PKTINFO(a53x_dimming_speed),
	&PKTINFO(a53x_fod_exit_1),
	&PKTINFO(a53x_hbm_transition),
	&PKTINFO(a53x_wrdisbv),
	&PKTINFO(a53x_fod_exit_2),
