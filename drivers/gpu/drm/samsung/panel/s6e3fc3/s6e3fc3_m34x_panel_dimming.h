/*
 * linux/drivers/video/fbdev/exynos/panel/s6e3fc3/s6e3fc3_m34x_panel_dimming.h
 *
...
#ifndef __S6E3FC3_M34X_PANEL_DIMMING_H___
#define __S6E3FC3_M34X_PANEL_DIMMING_H___
#include "../dimming.h"
...
static unsigned int m34x_brt_tbl[S6E3FC3_TOTAL_STEP] = {
...
static unsigned int m34x_lum_tbl[S6E3FC3_M34X_TOTAL_NR_LUMINANCE] = {
	/* normal 8x32 */
	2, 2, 3, 4, 4, 5, 6, 7,
...
static unsigned int m34x_step_cnt_tbl[S6E3FC3_TOTAL_STEP] = {
	[0 ... S6E3FC3_TOTAL_STEP - 1] = 1,
};

static struct brightness_table s6e3fc3_m34x_panel_brightness_table = {
	.control_type = BRIGHTNESS_CONTROL_TYPE_GAMMA_MODE2,
	.brt = m34x_brt_tbl,
	.sz_brt = ARRAY_SIZE(m34x_brt_tbl),
	.sz_ui_brt = S6E3FC3_NR_STEP,
	.sz_hbm_brt = S6E3FC3_HBM_STEP,
	.lum = m34x_lum_tbl,
	.sz_lum = S6E3FC3_M34X_TOTAL_NR_LUMINANCE,
	.sz_ui_lum = S6E3FC3_M34X_NR_LUMINANCE,
	.sz_hbm_lum = S6E3FC3_M34X_NR_HBM_LUMINANCE,
	.sz_ext_hbm_lum = 0,
	.brt_to_step = NULL,
	.sz_brt_to_step = 0,
	.step_cnt = m34x_step_cnt_tbl,
	.sz_step_cnt = ARRAY_SIZE(m34x_step_cnt_tbl),
	.vtotal = 0,
};

static struct panel_dimming_info s6e3fc3_m34x_panel_dimming_info = {
	.name = "s6e3fc3_m34x",
	.dim_init_info = {
		NULL,
	},
	...
	.brt_tbl = &s6e3fc3_m34x_panel_brightness_table,
	/* dimming parameters */
	.dimming_maptbl = NULL,
	.dim_flash_on = false,
	.hbm_aor = NULL,
