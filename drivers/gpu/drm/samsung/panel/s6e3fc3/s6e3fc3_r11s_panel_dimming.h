/*
 * linux/drivers/video/fbdev/exynos/panel/s6e3fc3/s6e3fc3_r11s_panel_dimming.h
 *
...
#ifndef __S6E3FC3_R11S_PANEL_DIMMING_H___
#define __S6E3FC3_R11S_PANEL_DIMMING_H___
#include "../dimming.h"
...
#define S6E3FC3_HBM_STEP (248)
#define S6E3FC3_TOTAL_STEP (S6E3FC3_NR_STEP + S6E3FC3_HBM_STEP)

static unsigned int r11s_brt_tbl[S6E3FC3_TOTAL_STEP] = {
	...
	BRT(496), BRT(497), BRT(498), BRT(499), BRT(500), BRT(501), BRT(502), BRT(503),
};

static unsigned int r11s_lum_tbl[S6E3FC3_R11S_TOTAL_NR_LUMINANCE] = {
	/* normal 8x32 */
	2, 2, 3, 4, 4, 5, 6, 7,
	...
	173, 175, 177, 179, 181, 183, 183, 187,
	...
	/* hbm 8x31 */
	516, 518, 520, 522, 524, 525, 527, 529,
	531, 533, 535, 537, 539, 541, 543, 545,
	547, 549, 551, 553, 555, 557, 559, 561,
	563, 565, 567, 569, 571, 573, 575, 576,
	...
	767, 769, 771, 773, 775, 776, 778, 780,
	782, 784, 786, 788, 790, 792, 794, 796,
	798, 800, 802, 804, 806, 808, 810, 812,
	814, 816, 818, 820, 822, 824, 825, 827,
	...
	924, 925, 927, 929, 931, 933, 935, 937,
	939, 941, 943, 945, 947, 949, 951, 953,
	955, 957, 959, 961, 963, 965, 967, 969,
	971, 973, 975, 976, 978, 980, 982, 984,
	986, 988, 990, 992, 994, 996, 998, 1000,
};

static unsigned int r11s_step_cnt_tbl[S6E3FC3_TOTAL_STEP] = {
	[0 ... S6E3FC3_TOTAL_STEP - 1] = 1,
};

static struct brightness_table s6e3fc3_r11s_panel_brightness_table = {
	...
	.lum = r11s_lum_tbl,
	.sz_lum = S6E3FC3_R11S_TOTAL_NR_LUMINANCE,
	.sz_ui_lum = S6E3FC3_R11S_NR_LUMINANCE,
	.sz_hbm_lum = S6E3FC3_R11S_NR_HBM_LUMINANCE,
	.sz_ext_hbm_lum = 0,
	.brt_to_step = NULL,
	.sz_brt_to_step = 0,
...
static struct panel_dimming_info s6e3fc3_r11s_panel_dimming_info = {
	.name = "s6e3fc3_r11s",
	.dim_init_info = {
		NULL,
	},
	...
	.brt_tbl = &s6e3fc3_r11s_panel_brightness_table,
	/* dimming parameters */
	.dimming_maptbl = NULL,
	.dim_flash_on = false,
	.hbm_aor = NULL,
