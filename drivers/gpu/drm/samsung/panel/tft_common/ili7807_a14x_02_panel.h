...
bool is_a14x_fps_90hz(struct panel_device *panel)
{
...
static struct maptbl ili7807_a14x_02_maptbl[MAX_MAPTBL] = {
	[BRT_MAPTBL] = DEFINE_2D_MAPTBL(ili7807_a14x_02_brt_table, init_brt_table, getidx_brt_table, copy_common_maptbl),
};
...
static DEFINE_PANEL_MDELAY(ili7807_a14x_02_wait_60msec, 60); /* 4 frame */
static DEFINE_PANEL_MDELAY(ili7807_a14x_02_wait_100msec, 100);
static DEFINE_PANEL_MDELAY(ili7807_a14x_02_wait_1msec, 1);
static DEFINE_PANEL_MDELAY(ili7807_a14x_02_wait_2msec, 2);

static DEFINE_COND(ili7807_a14x_02_cond_is_fps_90hz, is_a14x_fps_90hz);
...
static void *ili7807_a14x_02_dummy_cmdtbl[] = {
	NULL,
};

static struct seqinfo ili7807_a14x_02_seqtbl[MAX_PANEL_SEQ] = {
	[PANEL_INIT_SEQ] = SEQINFO_INIT("init-seq", ili7807_a14x_02_init_cmdtbl),
	[PANEL_RES_INIT_SEQ] = SEQINFO_INIT("resource-init-seq", ili7807_a14x_02_res_init_cmdtbl),
	[PANEL_SET_BL_SEQ] = SEQINFO_INIT("set-bl-seq", ili7807_a14x_02_set_bl_cmdtbl),
	[PANEL_DISPLAY_MODE_SEQ] = SEQINFO_INIT("display-mode-seq", ili7807_a14x_02_display_mode_cmdtbl),
...
static DEFINE_PANEL_MDELAY(ili7807_a14x_02_blic_wait_delay, 2);
...
static struct seqinfo ili7807_a14x_02_ktz8864_seq_tbl[MAX_PANEL_BLIC_SEQ] = {
	[PANEL_BLIC_I2C_ON_SEQ] = SEQINFO_INIT("i2c-init-seq", ili7807_a14x_02_ktz8864_init_cmdtbl),
	[PANEL_BLIC_I2C_OFF_SEQ] = SEQINFO_INIT("i2c-exit-seq", ili7807_a14x_02_ktz8864_exit_cmdtbl),
};
