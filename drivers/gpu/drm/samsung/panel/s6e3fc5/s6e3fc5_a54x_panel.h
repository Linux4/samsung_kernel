...
#ifdef CONFIG_SUPPORT_XTALK_MODE
static u8 A54X_XTALK_MODE[] = { 0xD9, 0x60 };
static DEFINE_PKTUI(a54x_xtalk_mode, &a54x_maptbl[VGH_MAPTBL], 1);
static DEFINE_VARIABLE_PACKET(a54x_xtalk_mode, DSI_PKT_TYPE_WR, A54X_XTALK_MODE, 0x1C);
#endif
