...
__visible_for_testing void __exit s6e3fc5_a54x_panel_exit(void)
{
	deregister_common_panel(&s6e3fc5_a54x_panel_info);
}

module_init(s6e3fc5_a54x_panel_init)
module_exit(s6e3fc5_a54x_panel_exit)
