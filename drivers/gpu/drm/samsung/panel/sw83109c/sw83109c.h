...
enum sw83109c_function {
	SW83109C_MAPTBL_INIT_GAMMA_MODE2_BRT,
	SW83109C_MAPTBL_INIT_LPM_BRT,
	SW83109C_MAPTBL_GETIDX_LPM_BRT,
	SW83109C_MAPTBL_COPY_FMEM,
	SW83109C_MAPTBL_GETIDX_VRR_FPS,
	SW83109C_MAPTBL_GETIDX_FFC,
	SW83109C_MAPTBL_GETIDX_ACL_OPR,
	SW83109C_MAPTBL_GETIDX_ACL_ONOFF,
	MAX_SW83109C_FUNCTION,
};

extern struct pnobj_func sw83109c_function_table[MAX_SW83109C_FUNCTION];

#undef DDI_FUNC
#define DDI_FUNC(_index) (sw83109c_function_table[_index])
...
static struct dumpinfo sw83109c_dmptbl[] = {
	[DUMP_RDDSM] = DUMPINFO_INIT_V2(rddsm, &sw83109c_restbl[RES_RDDSM], &OLED_FUNC(OLED_DUMP_SHOW_RDDSM), rddsm_expects),
	[DUMP_ERR_FG] = DUMPINFO_INIT_V2(err_fg, &sw83109c_restbl[RES_ERR_FG], &OLED_FUNC(OLED_DUMP_SHOW_EXPECTS), err_fg_expects),
	[DUMP_DSI_ERR] = DUMPINFO_INIT_V2(dsi_err, &sw83109c_restbl[RES_DSI_ERR], &OLED_FUNC(OLED_DUMP_SHOW_DSI_ERR), dsie_cnt_expects),
#ifdef CONFIG_USDM_DDI_CMDLOG
	[DUMP_CMDLOG] = DUMPINFO_INIT_V2(cmdlog, &sw83109c_restbl[RES_CMDLOG], &OLED_FUNC(OLED_DUMP_SHOW_CMDLOG), cmdlog_expects),
#endif
};
