...
static struct maptbl m54x_maptbl[MAX_MAPTBL] = {
	[GAMMA_MODE2_MAPTBL] = DEFINE_2D_MAPTBL(m54x_brt_table, &DDI_FUNC(SW83109C_MAPTBL_INIT_GAMMA_MODE2_BRT), &OLED_FUNC(OLED_MAPTBL_GETIDX_GM2_BRT), &OLED_FUNC(OLED_MAPTBL_COPY_DEFAULT)),
	[TSET_MAPTBL] = DEFINE_0D_MAPTBL(m54x_tset_table, &OLED_FUNC(OLED_MAPTBL_INIT_DEFAULT), NULL, &OLED_FUNC(OLED_MAPTBL_COPY_TSET)),
	[FMEM_MAPTBL] = DEFINE_0D_MAPTBL(m54x_fmem_table, &OLED_FUNC(OLED_MAPTBL_INIT_DEFAULT), NULL, &DDI_FUNC(SW83109C_MAPTBL_COPY_FMEM)),
	[LPM_NIT_MAPTBL] = DEFINE_2D_MAPTBL(m54x_lpm_nit_table, &DDI_FUNC(SW83109C_MAPTBL_INIT_LPM_BRT), &DDI_FUNC(SW83109C_MAPTBL_GETIDX_LPM_BRT), &OLED_FUNC(OLED_MAPTBL_COPY_DEFAULT)),
	[FPS_1_MAPTBL] = DEFINE_2D_MAPTBL(m54x_fps_1_table, &OLED_FUNC(OLED_MAPTBL_INIT_DEFAULT), &DDI_FUNC(SW83109C_MAPTBL_GETIDX_VRR_FPS), &OLED_FUNC(OLED_MAPTBL_COPY_DEFAULT)),
	[FPS_2_MAPTBL] = DEFINE_2D_MAPTBL(m54x_fps_2_table, &OLED_FUNC(OLED_MAPTBL_INIT_DEFAULT), &DDI_FUNC(SW83109C_MAPTBL_GETIDX_VRR_FPS), &OLED_FUNC(OLED_MAPTBL_COPY_DEFAULT)),
	[FFC_MAPTBL] = DEFINE_2D_MAPTBL(m54x_ffc_table, &OLED_FUNC(OLED_MAPTBL_INIT_DEFAULT), &DDI_FUNC(SW83109C_MAPTBL_GETIDX_FFC), &OLED_FUNC(OLED_MAPTBL_COPY_DEFAULT)),
	[ACL_ONOFF_MAPTBL] = DEFINE_2D_MAPTBL(m54x_acl_onoff_table, &OLED_FUNC(OLED_MAPTBL_INIT_DEFAULT), &DDI_FUNC(SW83109C_MAPTBL_GETIDX_ACL_ONOFF), &OLED_FUNC(OLED_MAPTBL_COPY_DEFAULT)),
	[ACL_OPR_MAPTBL] = DEFINE_2D_MAPTBL(m54x_acl_opr_table, &OLED_FUNC(OLED_MAPTBL_INIT_DEFAULT), &DDI_FUNC(SW83109C_MAPTBL_GETIDX_ACL_OPR), &OLED_FUNC(OLED_MAPTBL_COPY_DEFAULT)),
	[AOD_TO_GAMMA_MODE2_MAPTBL] = DEFINE_2D_MAPTBL(m54x_aod_to_gm2_nit_table, &OLED_FUNC(OLED_MAPTBL_INIT_DEFAULT), &DDI_FUNC(SW83109C_MAPTBL_GETIDX_LPM_BRT), &OLED_FUNC(OLED_MAPTBL_COPY_DEFAULT)),
};
