/*
 * linux/drivers/video/fbdev/exynos/panel/sw83109c/sw83109c_m54x_panel_dimming.h
 *
...
#ifndef __SW83109C_M54X_PANEL_DIMMING_H___
#define __SW83109C_M54X_PANEL_DIMMING_H___
#include "../dimming.h"
 ...
 * PANEL : PRE
 */
#define SW83109C_NR_STEP (256)
#define SW83109C_HBM_STEP (231)
#define SW83109C_TOTAL_STEP (SW83109C_NR_STEP + SW83109C_HBM_STEP)

static unsigned int m54x_brt_tbl[SW83109C_TOTAL_STEP] = {
...
static unsigned int m54x_lum_tbl[SW83109C_M54X_TOTAL_NR_LUMINANCE] = {
	/* normal 8x32 */
	2, 2, 3, 3, 4, 5, 5, 6,
	7, 7, 8, 9, 10, 11, 12, 13,
	...
	107, 108, 110, 112, 113, 115, 116, 118,
	119, 121, 123, 124, 126, 127, 129, 131,
	132, 134, 136, 137, 139, 140, 142, 144,
	145, 147, 149, 150, 152, 154, 156, 157,
	159, 161, 162, 164, 166, 167, 169, 171,
	173, 174, 176, 178, 180, 181, 183, 185,
	187, 188, 190, 192, 194, 195, 197, 199,
	201, 203, 204, 206, 208, 210, 212, 214,
	215, 217, 219, 221, 223, 225, 226, 228,
	230, 232, 234, 236, 237, 239, 241, 243,
	245, 247, 249, 251, 253, 254, 256, 258,
	...
	355, 357, 359, 361, 363, 365, 368, 370,
	372, 374, 376, 378, 380, 382, 384, 386,
	388, 390, 393, 395, 397, 399, 401, 403,
	405, 407, 409, 411, 414, 416, 418, 420,
	/* hbm 8x28+7 */
	425, 426, 428, 430, 432, 433, 435, 437,
	438, 440, 441, 443, 445, 446, 448, 450,
	451, 453, 454, 456, 458, 460, 461, 463,
	464, 466, 467, 469, 471, 473, 474, 476,
	477, 479, 480, 482, 484, 486, 487, 489,
	490, 492, 493, 495, 497, 499, 500, 502,
	503, 505, 506, 508, 510, 512, 513, 515,
	516, 518, 519, 521, 523, 525, 526, 528,
	529, 531, 532, 534, 536, 538, 539, 541,
	542, 544, 545, 547, 549, 551, 552, 554,
	555, 557, 558, 560, 562, 564, 565, 567,
	568, 570, 571, 573, 575, 577, 578, 580,
	581, 583, 585, 586, 588, 590, 591, 593,
	594, 596, 598, 599, 601, 603, 604, 606,
	607, 609, 611, 613, 614, 616, 618, 619,
	621, 622, 624, 626, 627, 629, 631, 632,
	634, 635, 637, 639, 640, 642, 644, 645,
	647, 648, 650, 652, 654, 655, 657, 658,
	660, 661, 663, 665, 667, 668, 670, 671,
	673, 674, 676, 678, 680, 681, 683, 684,
	686, 687, 689, 691, 693, 694, 696, 697,
	699, 700, 702, 704, 706, 707, 709, 710,
	712, 713, 715, 717, 719, 720, 722, 723,
	725, 726, 728, 730, 732, 733, 735, 736,
	738, 739, 741, 743, 745, 746, 748, 749,
	751, 752, 754, 756, 758, 759, 761, 762,
	764, 765, 767, 769, 771, 772, 774, 775,
	777, 779, 780, 782, 784, 785, 787, 788,
	790, 792, 793, 795, 797, 798, 800
};

static unsigned int m54x_step_cnt_tbl[SW83109C_TOTAL_STEP] = {
	[0 ... SW83109C_TOTAL_STEP - 1] = 1,
};

struct brightness_table sw83109c_m54x_panel_brightness_table = {
	.control_type = BRIGHTNESS_CONTROL_TYPE_GAMMA_MODE2,
	.brt = m54x_brt_tbl,
	.sz_brt = ARRAY_SIZE(m54x_brt_tbl),
	.sz_ui_brt = SW83109C_NR_STEP,
	.sz_hbm_brt = SW83109C_HBM_STEP,
	.lum = m54x_lum_tbl,
	.sz_lum = SW83109C_M54X_TOTAL_NR_LUMINANCE,
	.sz_ui_lum = SW83109C_M54X_NR_LUMINANCE,
	.sz_hbm_lum = SW83109C_M54X_NR_HBM_LUMINANCE,
	.sz_ext_hbm_lum = 0,
	.brt_to_step = NULL,
	.sz_brt_to_step = 0,
	.step_cnt = m54x_step_cnt_tbl,
	.sz_step_cnt = ARRAY_SIZE(m54x_step_cnt_tbl),
	.vtotal = 0,
};

static struct panel_dimming_info sw83109c_m54x_panel_dimming_info = {
	.name = "sw83109c_m54x",
	.dim_init_info = {
		NULL,
	},
	...
	.brt_tbl = &sw83109c_m54x_panel_brightness_table,
	/* dimming parameters */
	.dimming_maptbl = NULL,
	.dim_flash_on = false,
	.hbm_aor = NULL,
};
#endif /* __SW83109C_PANEL_DIMMING_H___ */
