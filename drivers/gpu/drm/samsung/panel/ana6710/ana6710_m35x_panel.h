/*
 * linux/drivers/video/fbdev/exynos/panel/ana6710/ana6710_m35x_panel.h
 *
...
#ifndef __ANA6710_M35X_PANEL_H__
#define __ANA6710_M35X_PANEL_H__

#include "../panel.h"
#include "../panel_drv.h"
#include "oled_function.h"
#include "ana6710.h"
#include "ana6710_m35x.h"
#include "ana6710_dimming.h"
#ifdef CONFIG_USDM_MDNIE
#include "ana6710_m35x_panel_mdnie.h"
#endif
#include "ana6710_m35x_panel_dimming.h"
#ifdef CONFIG_USDM_PANEL_AOD_BL
#include "ana6710_m35x_panel_aod_dimming.h"
#endif
#include "ana6710_m35x_resol.h"

#ifdef CONFIG_USDM_PANEL_RCD
#include "ana6710_m35x_rcd.h"
#endif
...
static u8 m35x_brt_table[ANA6710_TOTAL_STEP][2] = {
...
static u8 m35x_acl_opr_table[MAX_PANEL_HBM][MAX_ANA6710_ACL_OPR][1] = {
	[PANEL_HBM_OFF] = {
...
static u8 m35x_ffc_table[MAX_ANA6710_HS_CLK][8] = {
...
static u8 m35x_fps_table[MAX_ANA6710_VRR][1] = {
...
static u8 m35x_te_setting_table[MAX_ANA6710_VRR][4] = {
...
static u8 m35x_te_frame_sel_table[MAX_ANA6710_VRR][2] = {
...
static struct maptbl m35x_maptbl[MAX_MAPTBL] = {
	[GAMMA_MODE2_MAPTBL] = DEFINE_2D_MAPTBL(m35x_brt_table, &DDI_FUNC(ANA6710_MAPTBL_INIT_GAMMA_MODE2_BRT), &OLED_FUNC(OLED_MAPTBL_GETIDX_GM2_BRT), &OLED_FUNC(OLED_MAPTBL_COPY_DEFAULT)),
	[HBM_ONOFF_MAPTBL] = DEFINE_3D_MAPTBL(m35x_hbm_transition_table, &OLED_FUNC(OLED_MAPTBL_INIT_DEFAULT), &DDI_FUNC(ANA6710_MAPTBL_GETIDX_HBM_TRANSITION), &OLED_FUNC(OLED_MAPTBL_COPY_DEFAULT)),
	[ACL_OPR_MAPTBL] = DEFINE_3D_MAPTBL(m35x_acl_opr_table, &OLED_FUNC(OLED_MAPTBL_INIT_DEFAULT), &DDI_FUNC(ANA6710_MAPTBL_GETIDX_ACL_OPR), &OLED_FUNC(OLED_MAPTBL_COPY_DEFAULT)),
	[TSET_MAPTBL] = DEFINE_0D_MAPTBL(m35x_tset_table, &OLED_FUNC(OLED_MAPTBL_INIT_DEFAULT), NULL, &OLED_FUNC(OLED_MAPTBL_COPY_TSET)),
	[LPM_NIT_MAPTBL] = DEFINE_2D_MAPTBL(m35x_lpm_nit_table, &DDI_FUNC(ANA6710_MAPTBL_INIT_LPM_BRT), &DDI_FUNC(ANA6710_MAPTBL_GETIDX_LPM_BRT), &OLED_FUNC(OLED_MAPTBL_COPY_DEFAULT)),
	[TE_SETTING_MAPTBL] = DEFINE_2D_MAPTBL(m35x_te_setting_table, &OLED_FUNC(OLED_MAPTBL_INIT_DEFAULT), &DDI_FUNC(ANA6710_MAPTBL_GETIDX_VRR), &OLED_FUNC(OLED_MAPTBL_COPY_DEFAULT)),
	[TE_FRAME_SEL_MAPTBL] = DEFINE_2D_MAPTBL(m35x_te_frame_sel_table, &OLED_FUNC(OLED_MAPTBL_INIT_DEFAULT), &DDI_FUNC(ANA6710_MAPTBL_GETIDX_VRR), &OLED_FUNC(OLED_MAPTBL_COPY_DEFAULT)),
	[FPS_MAPTBL] = DEFINE_2D_MAPTBL(m35x_fps_table, &OLED_FUNC(OLED_MAPTBL_INIT_DEFAULT), &DDI_FUNC(ANA6710_MAPTBL_GETIDX_VRR), &OLED_FUNC(OLED_MAPTBL_COPY_DEFAULT)),
	[SET_FFC_MAPTBL] = DEFINE_2D_MAPTBL(m35x_ffc_table, &OLED_FUNC(OLED_MAPTBL_INIT_DEFAULT), &DDI_FUNC(ANA6710_MAPTBL_GETIDX_FFC), &OLED_FUNC(OLED_MAPTBL_COPY_DEFAULT)),
};

/* ===================================================================================== */
/* ============================== [ANA6710 COMMAND TABLE] ============================== */
/* ===================================================================================== */
static u8 M35X_KEY1_ENABLE[] = { 0x9F, 0x5A, 0x5A };
static u8 M35X_KEY2_ENABLE[] = { 0xF0, 0x5A, 0x5A };
static u8 M35X_KEY3_ENABLE[] = { 0xFC, 0x5A, 0x5A };

static u8 M35X_KEY1_DISABLE[] = { 0x9F, 0xA5, 0xA5 };
...
static DEFINE_VARIABLE_PACKET(m35x_tset_set, DSI_PKT_TYPE_WR, M35X_TSET_SET, 0x4B);

static u8 M35X_AOD_AOR_MAX[] = { 0xB1, 0x01, 0x09, 0x40};
...
static u8 M35X_AOD_AOR[] = { 0xB1, 0x00 };
static DEFINE_STATIC_PACKET(m35x_aod_aor, DSI_PKT_TYPE_WR, M35X_AOD_AOR, 0x52);

static u8 M35X_SWIRE_NO_PULSE[] = {
	0xF3,
	0x00,
};
static DEFINE_STATIC_PACKET(m35x_swire_no_pulse, DSI_PKT_TYPE_WR, M35X_SWIRE_NO_PULSE, 0x0A);

static u8 M35X_SWIRE_NO_PULSE_LPM_OFF[] = {
	0xF3,
	0x00, 0x00, 0x00
};
static DEFINE_STATIC_PACKET(m35x_swire_no_pulse_lpm_off, DSI_PKT_TYPE_WR, M35X_SWIRE_NO_PULSE_LPM_OFF, 0x06);

static u8 M35X_CURRENT_IMPROVE[] = {
	0xFB,
	0x05
};
static DEFINE_STATIC_PACKET(m35x_current_improve, DSI_PKT_TYPE_WR, M35X_CURRENT_IMPROVE, 0x00);

static u8 M35X_SMOOTH_DIMMING_1F[] = {
	0xB1,
	0x01
};
static DEFINE_STATIC_PACKET(m35x_smooth_dimming_1f, DSI_PKT_TYPE_WR, M35X_SMOOTH_DIMMING_1F, 0x10);

static u8 M35X_SMOOTH_DIMMING_15F[] = {
	0xB1,
	0x0F
};
static DEFINE_STATIC_PACKET(m35x_smooth_dimming_15f, DSI_PKT_TYPE_WR, M35X_SMOOTH_DIMMING_15F, 0x10);

static u8 M35X_TEST_ENABLE[] = {
	0xF2,
	0x11
};
static DEFINE_STATIC_PACKET(m35x_test_enable, DSI_PKT_TYPE_WR, M35X_TEST_ENABLE, 0x20);

static u8 M35X_TE_SHIFT_NORMAL[] = {
	0xB9,
	0x10, 0x90, 0x0F, 0x0F  // 130usec
};
static DEFINE_STATIC_PACKET(m35x_te_shift_normal, DSI_PKT_TYPE_WR, M35X_TE_SHIFT_NORMAL, 0x00);

static u8 M35X_TE_SHIFT_ALPM[] = {
	0xB9,
	0x10, 0x90, 0x2A, 0x0F  // 130usec
};
static DEFINE_STATIC_PACKET(m35x_te_shift_alpm, DSI_PKT_TYPE_WR, M35X_TE_SHIFT_ALPM, 0x00);

static u8 M35X_NORMAL_MODE[] = { 0x53, 0x28 };
static DEFINE_STATIC_PACKET(m35x_normal_mode, DSI_PKT_TYPE_WR, M35X_NORMAL_MODE, 0);

static u8 M35X_BLACK_FRAME_OFF[] = { 0x6A, 0x57, 0x00 };
static DEFINE_STATIC_PACKET(m35x_black_frame_off, DSI_PKT_TYPE_WR, M35X_BLACK_FRAME_OFF, 0x4C);

static u8 M35X_BLACK_FRAME_ON[] = { 0x6A, 0x54, 0x00 };
static DEFINE_STATIC_PACKET(m35x_black_frame_on, DSI_PKT_TYPE_WR, M35X_BLACK_FRAME_ON, 0x4C);
...
static DEFINE_PANEL_MDELAY(m35x_wait_ecc_test_50msec, 50);
...
static u8 M35X_CELL_ID_READ_ON[] = {
	0xE2,
	0x01,
};
static DEFINE_STATIC_PACKET(m35x_cell_id_read_on, DSI_PKT_TYPE_WR, M35X_CELL_ID_READ_ON, 0);

static u8 M35X_ERR_FG_ENABLE[] = {
	0xED,
	0x46, 0x00, 0x0B, 0x0A /* ERR_FG ON */
};
static DEFINE_STATIC_PACKET(m35x_err_fg_enable, DSI_PKT_TYPE_WR, M35X_ERR_FG_ENABLE, 0);

static u8 M35X_ERR_FG_DISABLE[] = {
	0xED,
...
static u8 M35X_TSP_VSYNC_NORMAL[] = {
	0xB9,
	0x05, 0x44, 0xEE, 0xEE, 0x55, 0x00, 0x00, 0x00, 0x61, 0x00, 0x00, 0x01
};
static DEFINE_STATIC_PACKET(m35x_tsp_vsync_normal, DSI_PKT_TYPE_WR, M35X_TSP_VSYNC_NORMAL, 0x14);

static u8 M35X_TSP_VSYNC_ALPM[] = {
	0xB9,
	0x05, 0x44, 0xEE, 0xEE, 0x55, 0x00, 0x00, 0x00, 0x42, 0x00, 0x00, 0x01
};
static DEFINE_STATIC_PACKET(m35x_tsp_vsync_alpm, DSI_PKT_TYPE_WR, M35X_TSP_VSYNC_ALPM, 0x14);

static u8 M35X_FPS[] = { 0x60, 0x00, 0x40 };
static DEFINE_PKTUI(m35x_fps, &m35x_maptbl[FPS_MAPTBL], 2);
...
static DEFINE_STATIC_PACKET(m35x_dsc, DSI_PKT_TYPE_WR, M35X_DSC, 0);
...
static DEFINE_STATIC_PACKET(m35x_pps, DSI_PKT_TYPE_WR, M35X_PPS, 0);

static u8 M35X_FFC_SETTING_1[] = {
	0xF8,
	0x00,
};
static DEFINE_STATIC_PACKET(m35x_ffc_setting_1, DSI_PKT_TYPE_WR, M35X_FFC_SETTING_1, 0x01);

static u8 M35X_FFC_SETTING_2[] = {
	0xF8,
	0x00, 0x11, 0x11, 0xE9, 0x31, 0x31, 0x31, 0x31
};
static DEFINE_PKTUI(m35x_ffc_setting_2, &m35x_maptbl[SET_FFC_MAPTBL], 1);
static DEFINE_VARIABLE_PACKET(m35x_ffc_setting_2, DSI_PKT_TYPE_WR, M35X_FFC_SETTING_2, 0x08);

static u8 M35X_FFC_SETTING_3[] = {
	0xF8,
	0x10,
};
static DEFINE_STATIC_PACKET(m35x_ffc_setting_3, DSI_PKT_TYPE_WR, M35X_FFC_SETTING_3, 0x01);
...
static u8 M35X_CRC_TEST_ENABLE[] = {
	0xF2,
	0x11
};
static DEFINE_STATIC_PACKET(m35x_crc_test_enable, DSI_PKT_TYPE_WR, M35X_CRC_TEST_ENABLE, 0x20);

static u8 M35X_CRC_VDDL_HIGH[] = {
	0xF8,
	0x0B
};
static DEFINE_STATIC_PACKET(m35x_crc_vddl_high, DSI_PKT_TYPE_WR, M35X_CRC_VDDL_HIGH, 0x15);

static u8 M35X_DECODER_TEST_ENABLE_1[] = {
	0xFB,
	0x00
};
static DEFINE_STATIC_PACKET(m35x_decoder_test_enable_1, DSI_PKT_TYPE_WR, M35X_DECODER_TEST_ENABLE_1, 0);

static u8 M35X_DECODER_TEST_ENABLE_2[] = {
	0xFB,
	0x01
};
static DEFINE_STATIC_PACKET(m35x_decoder_test_enable_2, DSI_PKT_TYPE_WR, M35X_DECODER_TEST_ENABLE_2, 0x0D);

static u8 M35X_DECODER_TEST_DISABLE_1[] = {
	0xFB,
	0x05
};
static DEFINE_STATIC_PACKET(m35x_decoder_test_disable_1, DSI_PKT_TYPE_WR, M35X_DECODER_TEST_DISABLE_1, 0);

static u8 M35X_DECODER_TEST_DISABLE_2[] = {
	0xFB,
	0x00
};
static DEFINE_STATIC_PACKET(m35x_decoder_test_disable_2, DSI_PKT_TYPE_WR, M35X_DECODER_TEST_DISABLE_2, 0x0D);
...
static u8 M35X_ECC_SETTING_ENABLE[] = {
	0xF2,
	0xE1
};
static DEFINE_STATIC_PACKET(m35x_ecc_setting_enable, DSI_PKT_TYPE_WR, M35X_ECC_SETTING_ENABLE, 0x14);

static u8 M35X_ECC_TEST_ENABLE[] = {
	0xF2,
	0x11
};
static DEFINE_STATIC_PACKET(m35x_ecc_test_enable, DSI_PKT_TYPE_WR, M35X_ECC_TEST_ENABLE, 0x20);

static u8 M35X_ECC_SETTING_DISABLE[] = {
	0xF2,
	0xE5
};

static DEFINE_STATIC_PACKET(m35x_ecc_setting_disable, DSI_PKT_TYPE_WR, M35X_ECC_SETTING_DISABLE, 0x14);
#endif

static u8 M35X_TE_SETTING1[] = {
	0xB9,
	0x10, 0x90, 0x0F, 0x0F
};
static DEFINE_PKTUI(m35x_te_setting1, &m35x_maptbl[TE_SETTING_MAPTBL], 1);
static DEFINE_VARIABLE_PACKET(m35x_te_setting1, DSI_PKT_TYPE_WR, M35X_TE_SETTING1, 0);
...
static DEFINE_VARIABLE_PACKET(m35x_te_frame_sel, DSI_PKT_TYPE_WR, M35X_TE_FRAME_SEL, 0x07);
...
static void *m35x_common_setting_cmdtbl[] = {
	...
	&PKTINFO(m35x_ffc_setting_3),
	&DLYINFO(m35x_wait_10msec),
	&PKTINFO(m35x_panel_update),

	/* TSP vsync */
	&PKTINFO(m35x_tsp_vsync_normal),
	&PKTINFO(m35x_panel_update),
...
static void *m35x_alpm_init_cmdtbl[] = {
	...
	&PKTINFO(m35x_panel_update),
	&PKTINFO(m35x_tsp_vsync_alpm),
	&PKTINFO(m35x_panel_update),
	&PKTINFO(m35x_te_shift_alpm),
	&KEYINFO(m35x_level2_key_disable),
...
static void *m35x_decoder_test_cmdtbl[] = {
	...
	&PKTINFO(m35x_decoder_test_enable_1),
	&PKTINFO(m35x_decoder_test_enable_2),
	&DLYINFO(m35x_wait_crc_test_50msec),
	&ana6710_restbl[RES_DECODER_TEST3],
	&PKTINFO(m35x_decoder_test_disable_1),
	&PKTINFO(m35x_decoder_test_disable_2),
...
static void *m35x_ecc_test_cmdtbl[] = {
	&KEYINFO(m35x_level2_key_enable),
	&KEYINFO(m35x_level3_key_enable),
	&PKTINFO(m35x_ecc_setting_enable),
	&PKTINFO(m35x_ecc_test_enable),
	&DLYINFO(m35x_wait_crc_test_50msec),
	&DLYINFO(m35x_wait_crc_test_50msec),
	&ana6710_restbl[RES_ECC_TEST],
	&PKTINFO(m35x_ecc_setting_disable),
	&KEYINFO(m35x_level2_key_disable),
	&KEYINFO(m35x_level3_key_disable),
};
#endif
...
struct common_panel_info ana6710_m35x_panel_info = {
	.ldi_name = "ana6710",
	.name = "ana6710_m35x",
	.model = "AMS642DF01",
	.vendor = "SDC",
	...
	.common_panel_modes = &ana6710_m35x_display_modes,
#endif
	.mres = {
		.nr_resol = ARRAY_SIZE(ana6710_m35x_default_resol),
		.resol = ana6710_m35x_default_resol,
	},
	.vrrtbl = ana6710_m35x_default_vrrtbl,
	.nr_vrrtbl = ARRAY_SIZE(ana6710_m35x_default_vrrtbl),
	.maptbl = m35x_maptbl,
...
#ifdef CONFIG_USDM_MDNIE
	.mdnie_tune = &ana6710_m35x_mdnie_tune,
#endif
	.panel_dim_info = {
		[PANEL_BL_SUBDEV_TYPE_DISP] = &ana6710_m35x_panel_dimming_info,
#ifdef CONFIG_USDM_PANEL_AOD_BL
		[PANEL_BL_SUBDEV_TYPE_AOD] = &ana6710_m35x_panel_aod_dimming_info,
#endif
	},
#ifdef CONFIG_USDM_PANEL_RCD
	.rcd_data = &ana6710_m35x_rcd,
#endif
};

#endif /* __ANA6710_M35X_PANEL_H__ */
