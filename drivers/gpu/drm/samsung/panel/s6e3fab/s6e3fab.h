...
__visible_for_testing int init_elvss_cal_offset_table(struct maptbl *tbl);
...
__visible_for_testing int getidx_hbm_and_transition_table(struct maptbl *tbl);
...
__visible_for_testing int getidx_gamma_brt_index_table(struct maptbl *tbl);
...
#ifdef CONFIG_SUPPORT_GRAM_CHECKSUM
__visible_for_testing int s6e3fab_getidx_vddm_table(struct maptbl *);
__visible_for_testing int s6e3fab_getidx_gram_img_pattern_table(struct maptbl *tbl);
#endif
#if defined(CONFIG_SUPPORT_FAST_DISCHARGE)
...
//__visible_for_testing int getidx_mafpc_enable_table(struct maptbl *tbl);
...
#endif
__visible_for_testing int getidx_vrr_aor_fq_brt_table(struct maptbl *tbl);
__visible_for_testing int getidx_vrr_table(struct maptbl *tbl);
__visible_for_testing int getidx_vrr_osc_mode_table(struct maptbl *tbl);
...
__visible_for_testing int s6e3fab_mtp_gamma_check(struct panel_device *panel, void *data, u32 len);
#endif
