/*
 * linux/drivers/video/fbdev/exynos/panel/sw83109/sw83109_m54x_panel_dimming.h
 *
...
#ifndef __SW83109_M54X_PANEL_DIMMING_H___
#define __SW83109_M54X_PANEL_DIMMING_H___
#include "../dimming.h"
 ...
 * PANEL : PRE
 */
#define SW83109_NR_STEP (256)
#define SW83109_HBM_STEP (231)
#define SW83109_TOTAL_STEP (SW83109_NR_STEP + SW83109_HBM_STEP)

static unsigned int m54x_brt_tbl[SW83109_TOTAL_STEP] = {
...
static unsigned int m54x_lum_tbl[SW83109_M54X_TOTAL_NR_LUMINANCE] = {
	/* normal 8x32 */
	2, 2, 3, 3, 4, 5, 5, 6,
	7, 7, 8, 9, 10, 11, 12, 13,
...
static unsigned int m54x_step_cnt_tbl[SW83109_TOTAL_STEP] = {
	[0 ... SW83109_TOTAL_STEP - 1] = 1,
};

struct brightness_table sw83109_m54x_panel_brightness_table = {
	.control_type = BRIGHTNESS_CONTROL_TYPE_GAMMA_MODE2,
	.brt = m54x_brt_tbl,
	.sz_brt = ARRAY_SIZE(m54x_brt_tbl),
	.sz_ui_brt = SW83109_NR_STEP,
	.sz_hbm_brt = SW83109_HBM_STEP,
	.lum = m54x_lum_tbl,
	.sz_lum = SW83109_M54X_TOTAL_NR_LUMINANCE,
	.sz_ui_lum = SW83109_M54X_NR_LUMINANCE,
	.sz_hbm_lum = SW83109_M54X_NR_HBM_LUMINANCE,
	.sz_ext_hbm_lum = 0,
	.brt_to_step = NULL,
	.sz_brt_to_step = 0,
...
static struct panel_dimming_info sw83109_m54x_panel_dimming_info = {
	.name = "sw83109_m54x",
	.dim_init_info = {
		NULL,
	},
	...
	.brt_tbl = &sw83109_m54x_panel_brightness_table,
	/* dimming parameters */
	.dimming_maptbl = NULL,
	.dim_flash_on = false,
	.hbm_aor = NULL,
};
#endif /* __SW83109_PANEL_DIMMING_H___ */
