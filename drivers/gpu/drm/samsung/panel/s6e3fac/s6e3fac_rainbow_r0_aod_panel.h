...
static DEFINE_STATIC_PACKET_WITH_OPTION(s6e3fac_rainbow_r0_aod_self_mask_img_pkt,
		DSI_PKT_TYPE_SR_FAST, RAINBOW_R0_SELF_MASK_IMG, 0, PKT_OPTION_SR_ALIGN_16);
...
static struct seqinfo s6e3fac_rainbow_r0_aod_seqtbl[MAX_AOD_SEQ] = {
	[SELF_MASK_IMG_SEQ] = SEQINFO_INIT("self_mask_img", s6e3fac_rainbow_r0_aod_self_mask_img_cmdtbl),
