...
__visible_for_testing int get_s6e3had_unbound3_id(struct panel_device *panel);
__visible_for_testing int get_s6e3had_96hs_mode(int vrr);
__visible_for_testing int get_s6e3had_brt_direction(struct panel_device *panel);
__visible_for_testing int find_s6e3had_vrr(struct panel_vrr *vrr);
__visible_for_testing int getidx_s6e3had_lfd_frame_idx(int fps, int mode);
__visible_for_testing int get_s6e3had_lfd_min_freq(u32 scalability, u32 vrr_fps_index);
__visible_for_testing int get_s6e3had_lpm_lfd_min_freq(u32 scalability);
__visible_for_testing int s6e3had_get_vrr_lfd_min_div_count(struct panel_info *panel_data);
__visible_for_testing int s6e3had_get_vrr_lfd_max_div_count(struct panel_info *panel_data);
__visible_for_testing DECLARE_REDIRECT_MOCKABLE(s6e3had_get_vrr_lfd_max_freq, RETURNS(int), PARAMS(struct panel_info *));
__visible_for_testing DECLARE_REDIRECT_MOCKABLE(s6e3had_get_vrr_lfd_min_freq, RETURNS(int), PARAMS(struct panel_info *));
__visible_for_testing int getidx_s6e3had_vrr_mode(int mode);
...
#endif
__visible_for_testing int gamma_ctoi_70byte(s32 (*dst)[MAX_COLOR], u8 *src);
__visible_for_testing int gamma_ctoi_84byte(s32 (*dst)[MAX_COLOR], u8 *src);
__visible_for_testing int gamma_sum(s32 (*dst)[MAX_COLOR], s32 (*src)[MAX_COLOR], s32 (*offset)[MAX_COLOR]);
...
__visible_for_testing int init_gamma_write_table(struct maptbl *tbl, int vrr_idx, int offset, int len);
...
__visible_for_testing int getidx_gm2_elvss_table(struct maptbl *tbl);
__visible_for_testing int getidx_sync_control_table(struct maptbl *tbl);
__visible_for_testing int getidx_hbm_transition_table(struct maptbl *tbl);
__visible_for_testing int getidx_hbm_table(struct maptbl *tbl);
__visible_for_testing int getidx_acl_opr_table(struct maptbl *);
__visible_for_testing int getidx_acl_start_point_table(struct maptbl *tbl);
...
__visible_for_testing int getidx_read_addr_table(struct maptbl *tbl);
...
__visible_for_testing int getidx_lpm_mode_table(struct maptbl *);
__visible_for_testing int getidx_lpm_fps_table(struct maptbl *);
...
__visible_for_testing void copy_vaint_maptbl(struct maptbl *, u8 *);
#ifdef CONFIG_SUPPORT_GRAYSPOT_TEST
__visible_for_testing void copy_grayspot_cal_maptbl(struct maptbl *tbl, u8 *dst);
#endif
...
#ifdef CONFIG_SUPPORT_GRAM_CHECKSUM
__visible_for_testing int s6e3had_getidx_vddm_table(struct maptbl *);
__visible_for_testing int s6e3had_getidx_gram_img_pattern_table(struct maptbl *tbl);
#endif
...
__visible_for_testing int getidx_mafpc_vbp_maptbl(struct maptbl *tbl);
...
__visible_for_testing bool is_vrr_96hs_mode(struct panel_device *panel);
__visible_for_testing bool is_vrr_96hs_hbm_enter(struct panel_device *panel);

#ifdef CONFIG_SUPPORT_BRIGHTDOT_TEST
__visible_for_testing int s6e3had_getidx_brightdot_aor_table(struct maptbl *tbl);
__visible_for_testing bool s6e3had_is_brightdot_enabled(struct panel_device *panel);
#endif
__visible_for_testing int init_gamma_write_96hs_0_table(struct maptbl *tbl);
__visible_for_testing int init_gamma_write_96hs_1_table(struct maptbl *tbl);
#endif /* __S6E3HAD_H__ */
