...
static u8 unbound3_a3_s0_ffc_table[] = {
	0xC5,
	0x11, 0x10, 0x50, 0x05, 0x49, 0x23 /* default 1443 */
};

#ifdef CONFIG_SUPPORT_MAFPC
static u8 unbound3_a3_s0_mafpc_enable_table[2][1] = {
	{ 0x00 },
	{ 0x51 },
};

static u8 unbound3_a3_s0_mafpc_vbp_table[2][1] = {
	{ 0x1F },	/* ID3 < E2 */
	{ 0x20 },	/* ID3 >= E2 */
};
#endif
...
#endif
#ifdef CONFIG_DYNAMIC_MIPI
	[DM_SET_FFC_MAPTBL] = DEFINE_1D_MAPTBL(unbound3_a3_s0_ffc_table, init_common_table, NULL, dynamic_mipi_set_ffc),
#endif
#ifdef CONFIG_SUPPORT_MAFPC
	[MAFPC_ENA_MAPTBL] = DEFINE_2D_MAPTBL(unbound3_a3_s0_mafpc_enable_table, init_common_table, getidx_mafpc_enable_maptbl, copy_mafpc_enable_maptbl),
	[MAFPC_VBP_MAPTBL] = DEFINE_2D_MAPTBL(unbound3_a3_s0_mafpc_vbp_table, init_common_table, getidx_mafpc_vbp_maptbl, copy_common_maptbl),
...
static DEFINE_STATIC_PACKET(unbound3_a3_s0_set_ffc, DSI_PKT_TYPE_WR, UNBOUND3_A3_S0_FFC, 0x12);
#endif
...
static DECLARE_PKTUI(unbound3_a3_s0_mafpc_enable) = {
	{ .offset = S6E3HAD_MAFPC_ENA_REG + 1, .maptbl = &unbound3_a3_s0_maptbl[MAFPC_ENA_MAPTBL] },
	{ .offset = S6E3HAD_MAFPC_VBP_REG + 1, .maptbl = &unbound3_a3_s0_maptbl[MAFPC_VBP_MAPTBL] },
	{ .offset = S6E3HAD_MAFPC_CTRL_CMD_OFFSET + 1, .maptbl = &unbound3_a3_s0_maptbl[MAFPC_CTRL_MAPTBL] },
};
