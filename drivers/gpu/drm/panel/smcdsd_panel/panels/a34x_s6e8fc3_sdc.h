...
#ifndef __S6E8FC3_SDC_00_H__
#define __S6E8FC3_SDC_00_H__
...
#include "mdnie.h"
#include "a34x_s6e8fc3_sdc_00_mdnie.h"
#endif

#if defined(CONFIG_SMCDSD_DYNAMIC_MIPI)
#include "a34x_s6e8fc3_sdc_00_freq.h"
#endif

#include "a34x_s6e8fc3_sdc_00_param.h"
...
static struct msg_package *PACKAGE_S6E8FC3_SDC_00[MSG_IDX_MAX] = {
	[MSG_IDX_BASE] = PACKAGE_S6E8FC3_SDC,
	[MSG_IDX_BRIGHTNESS] = PACKAGE_S6E8FC3_SDC_00_BRIGHTNESS,
};

static struct msg_package **PACKAGE_LIST = PACKAGE_S6E8FC3_SDC_00;

#if 0
static struct msg_package PACKAGE_S6E8FC3_SDC_00_DUMP[MSG_IDX_MAX] = {
	[MSG_IDX_BASE] = { __ADDRESS(PACKAGE_S6E8FC3_SDC) },
	[MSG_IDX_BRIGHTNESS] = { __ADDRESS(PACKAGE_S6E8FC3_SDC_00_BRIGHTNESS) },
};

static struct msg_package *PACKAGE_LIST_DUMP = PACKAGE_S6E8FC3_SDC_00_DUMP;
#endif
