...
static int smcdsd_panel_path_lock(struct platform_device *p, bool need_lock)
{
	struct lcd_info *lcd = get_lcd_info(p);
...
struct mipi_dsi_lcd_driver td4150_mipi_lcd_driver = {
	...
	.lcm_path_lock	= smcdsd_panel_path_lock,
};
