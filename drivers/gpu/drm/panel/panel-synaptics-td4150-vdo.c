			  ...
			  const struct i2c_device_id *id)
{
	...
	pr_info("[LCM][I2C][TD4150] %s\n", __func__);
	pr_debug("[LCM][I2C][TD4150] NT: info==>name=%s addr=0x%x\n", client->name,
		 client->addr);
...
static int _lcm_i2c_write_bytes(unsigned char addr, unsigned char value)
{
	...
	if (client == NULL) {
		pr_err("ERROR!![TD4150] _lcm_i2c_client is null\n");
		return 0;
	}
	...
	if (ret < 0)
		pr_err("[LCM][ERROR][TD4150] _lcm_i2c write data fail !!\n");
...
static int __init _lcm_i2c_init(void)
{
	...
	pr_info("[LCM][I2C][TD4150] %s success\n", __func__);
	return 0;
}
...
static void lcm_panel_init(struct lcm *ctx)
{
	...
	lcm_dcs_write_seq_static(ctx, 0xB6,
		0x30, 0x6A, 0x00, 0x06, 0xC3, 0x03);
	lcm_dcs_write_seq_static(ctx, 0xB7,	0x11, 0x00, 0x00, 0x00);
	lcm_dcs_write_seq_static(ctx, 0xB8,
		0x00, 0x78, 0x64, 0x10, 0x64, 0xB4);
	lcm_dcs_write_seq_static(ctx, 0xB9,
		0x00, 0x78, 0x64, 0x10, 0x64, 0xB4);
	lcm_dcs_write_seq_static(ctx, 0xBA,
		0x07, 0x6A, 0x55, 0x0F, 0x32, 0x44);
	...
	lcm_dcs_write_seq_static(ctx, 0xC3,
	...
	lcm_dcs_write_seq_static(ctx, 0xC4,
		...
		0x57, 0x55, 0x55, 0x55);
	lcm_dcs_write_seq_static(ctx, 0xC5,
		0x08, 0x00, 0x00, 0x00, 0x00);
	lcm_dcs_write_seq_static(ctx, 0xC6,
		...
		0x50, 0x00, 0x33, 0x03);
	lcm_dcs_write_seq_static(ctx, 0xC7,
		0x00, 0x00, 0x00, 0x4E, 0x00, 0x5F, 0x00, 0x69, 0x00, 0x81,
	...
	lcm_dcs_write_seq_static(ctx, 0xC8,
	...
	lcm_dcs_write_seq_static(ctx, 0xCA,
	...
	lcm_dcs_write_seq_static(ctx, 0xCB,
	...
	lcm_dcs_write_seq_static(ctx, 0xCE,
	...
	lcm_dcs_write_seq_static(ctx, 0xD1,
		...
		0x13, 0x13, 0x00);
	lcm_dcs_write_seq_static(ctx, 0xD2, 0x0F, 0x00, 0x00);
	...
	lcm_dcs_write_seq_static(ctx, 0xD6, 0xC0,
		0xdc, 0x02, 0xdc);
	lcm_dcs_write_seq_static(ctx, 0xD6, 0xc0);
	lcm_dcs_write_seq_static(ctx, 0xD7,
...
static struct mipi_dsi_driver lcm_driver = {
	...
	.remove = lcm_remove,
	.driver = {
		.name = "panel-k6853v1_64-td4150-vdo",
		.owner = THIS_MODULE,
