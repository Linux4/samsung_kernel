...
void disp_aal_notify_backlight_changed(int trans_backlight)
{
	...
	int prev_backlight;	//bug773028,pengzhenhua1.wt,add,20220714,lcd bringup
	...
	prev_backlight = atomic_read(&g_aal_backlight_notified);	//bug773028,pengzhenhua1.wt,add,20220714,lcd bringup
	atomic_set(&g_aal_backlight_notified, trans_backlight);

	service_flags = 0;
	if ((prev_backlight == 0) && (prev_backlight != trans_backlight))	//bug773028,pengzhenhua1.wt,add,20220714,lcd bringup
		service_flags = AAL_SERVICE_FORCE_UPDATE;	//bug773028,pengzhenhua1.wt,add,20220714,lcd bringup
...
#endif
//+bug773028,pengzhenhua1.wt,add,20220714,lcd bringup
