...
#define DPTX_AUD_CONFIG1_HBR_MODE_SHIFT         10
#define DPTX_AUD_CONFIG1_HBR_MODE_MASK          BIT(10)
...
#define DPTX_VIDEO_VMSA3_PIX_ENC_YCBCR420_SHIFT           30
