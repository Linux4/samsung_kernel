...
static const unsigned char aw99703_reg_access[AW99703_REG_MAX] = {
...
#ifdef CONFIG_LCD_I2C_BACKLIGHT_SUPPORT
int aw99703_set_brightness(int brt_val);
#else
static inline int aw99703_set_brightness(int brt_val)
{
	return 0;
}
#endif
