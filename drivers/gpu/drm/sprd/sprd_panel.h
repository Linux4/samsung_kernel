...
enum {
	...
	CMD_CODE_SLEEP_IN,
	CMD_CODE_SLEEP_OUT,
	CMD_CODE_DEEP_SLEEP_IN,	//Bug760817, pengzhenhua1.wt, add, 20220525, lcd bringup
	CMD_OLED_BRIGHTNESS,
	CMD_OLED_REG_LOCK,
	CMD_OLED_REG_UNLOCK,
	CMD_CODE_DOZE_IN,
	CMD_CODE_DOZE_OUT,
	CMD_CODE_ESD_MASTER,	//Bug760817, pengzhenhua1.wt, add, 20220525, lcd bringup
	CMD_CODE_ESD_SLAVE,		//Bug760817, pengzhenhua1.wt, add, 20220525, lcd bringup
	CMD_CODE_RESERVED2,
	CMD_CODE_RESERVED3,
	CMD_CODE_RESERVED4,
	CMD_CODE_RESERVED5,
...
struct panel_info {
	...
	struct gpio_desc *iovdd_en_gpio;	//Bug760817, pengzhenhua1.wt, add, 20220718, lcd bringup
