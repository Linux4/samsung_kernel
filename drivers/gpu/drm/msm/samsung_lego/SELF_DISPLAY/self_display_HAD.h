...
#ifndef __SELF_DISPLAY_HAD_H__
#define __SELF_DISPLAY_HAD_H__
...
int self_display_init_HAD(struct samsung_display_driver_data *vdd);
void make_self_dispaly_img_cmds_HAD(struct samsung_display_driver_data *vdd,
		int cmd, u32 op);
void make_mass_self_display_img_cmds_HAD(struct samsung_display_driver_data *vdd,
		int cmd, u32 op);
