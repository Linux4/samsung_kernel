...
#include "ss_dsi_reading_mode_NT36672A_B6P064YQ5LP.h"
...
static void backlight_tft_late_on(struct samsung_display_driver_data *vdd)
{
	...
	if(vdd->reading_mode.cur_level != vdd->reading_mode.max_level)
...
//	vdd->mdss_panel_tft_outdoormode_update=ss_panel_tft_outdoormode_update;
	...
	vdd->reading_mode.cur_level = READING_MODE_MAX_LEVEL_NT36672A_B6P064YQ5LP;
	vdd->reading_mode.max_level = READING_MODE_MAX_LEVEL_NT36672A_B6P064YQ5LP;
	vdd->reading_mode.dsi_tune_size = READING_MODE_TUNE_SIZE_NT36672A_B6P064YQ5LP;
