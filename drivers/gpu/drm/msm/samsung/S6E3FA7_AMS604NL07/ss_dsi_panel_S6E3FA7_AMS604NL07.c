...
*/
#include "ss_dsi_panel_S6E3FA7_AMS604NL07.h"
#include "ss_dsi_mdnie_S6E3FA7_AMS604NL07.h"
#include "ss_dsi_interpolation_S6E3FA7_AMS604NL07.h"
...
static struct dsi_panel_cmd_set *ss_hbm_etc(struct samsung_display_driver_data *vdd, int *level_key)
{
	...
	*/
	...
	/*	0xB4 : ACL CONTROL */
	if (vdd->mdnie.mdnie_tune_state_dsi->mdnie_app == GALLERY_APP) {
...
static void samsung_panel_init(struct samsung_display_driver_data *vdd)
{
	...
	vdd->panel_func.samsung_smart_get_conf = smart_get_conf_S6E3FA7_AMS604NL07;

	/* GAMMA FLASH */
	vdd->panel_func.gen_hbm_interpolation_gamma = gen_hbm_interpolation_gamma_S6E3FA7_AMS604NL07;
	vdd->panel_func.gen_hbm_interpolation_irc = gen_hbm_interpolation_irc_S6E3FA7_AMS604NL07;
	vdd->panel_func.gen_normal_interpolation_irc = gen_normal_interpolation_irc_S6E3FA7_AMS604NL07;
	vdd->panel_func.samsung_flash_gamma_support = flash_gamma_support_S6E3FA7_AMS604NL07;
	vdd->panel_func.samsung_interpolation_init = init_interpolation_S6E3FA7_AMS604NL07;
	...
	vdd->panel_func.samsung_smart_get_conf_hmt = smart_get_conf_S6E3FA7_AMS604NL07_hmt;
...
static int __init samsung_panel_initialize(void)
{
	...
	char panel_string[] = "ss_dsi_panel_S6E3FA7_AMS604NL07_FHD";
