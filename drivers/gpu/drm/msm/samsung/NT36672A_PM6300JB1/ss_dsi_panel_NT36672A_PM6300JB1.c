 ...
 *
*/
#include "ss_dsi_mdnie_NT36672A_PM6300JB1.h"
#include "ss_dsi_reading_mode_NT36672A_PM6300JB1.h"
#include "ss_dsi_panel_NT36672A_PM6300JB1.h"
...
//	vdd->mdss_panel_tft_outdoormode_update=ss_panel_tft_outdoormode_update;
	...
	vdd->reading_mode.cur_level = READING_MODE_MAX_LEVEL_NT36672A_PM6300JB1;
	vdd->reading_mode.max_level = READING_MODE_MAX_LEVEL_NT36672A_PM6300JB1;
	vdd->reading_mode.dsi_tune_size = READING_MODE_TUNE_SIZE_NT36672A_PM6300JB1;
...
static int __init samsung_panel_initialize(void)
{
	...
	char panel_string[] = "ss_dsi_panel_NT36672A_PM6300JB1_FHD";
