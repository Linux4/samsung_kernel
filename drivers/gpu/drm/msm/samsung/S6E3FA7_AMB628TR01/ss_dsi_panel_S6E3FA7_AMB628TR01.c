...
static char coordinate_data_1[][COORDINATE_DATA_SIZE] = {
	...
	{0xfe, 0x00, 0xff, 0x00, 0xfe, 0x00}, /* Tune_2 */
	{0xfa, 0x00, 0xfd, 0x00, 0xff, 0x00}, /* Tune_3 */
	{0xfd, 0x00, 0xff, 0x00, 0xf9, 0x00}, /* Tune_4 */
	{0xfc, 0x00, 0xff, 0x00, 0xfc, 0x00}, /* Tune_5 */
	{0xfa, 0x00, 0xff, 0x00, 0xff, 0x00}, /* Tune_6 */
	{0xfa, 0x00, 0xff, 0x00, 0xf7, 0x00}, /* Tune_7 */
	{0xfa, 0x00, 0xff, 0x00, 0xfa, 0x00}, /* Tune_8 */
	{0xf8, 0x00, 0xff, 0x00, 0xfd, 0x00}, /* Tune_9 */
};

/* sRGB/Adobe RGB Mode */
static char coordinate_data_2[][COORDINATE_DATA_SIZE] = {
	{0xff, 0x00, 0xff, 0x00, 0xff, 0x00}, /* dummy */
	{0xff, 0x00, 0xfc, 0x00, 0xf3, 0x00}, /* Tune_1 */
	{0xff, 0x00, 0xfd, 0x00, 0xf6, 0x00}, /* Tune_2 */
	{0xff, 0x00, 0xff, 0x00, 0xfa, 0x00}, /* Tune_3 */
	{0xff, 0x00, 0xfe, 0x00, 0xf3, 0x00}, /* Tune_4 */
	{0xff, 0x00, 0xff, 0x00, 0xf6, 0x00}, /* Tune_5 */
	{0xfe, 0x00, 0xff, 0x00, 0xf9, 0x00}, /* Tune_6 */
	{0xfe, 0x00, 0xff, 0x00, 0xf3, 0x00}, /* Tune_7 */
	{0xfe, 0x00, 0xff, 0x00, 0xf5, 0x00}, /* Tune_8 */
	{0xfc, 0x00, 0xff, 0x00, 0xf7, 0x00}, /* Tune_9 */
};
