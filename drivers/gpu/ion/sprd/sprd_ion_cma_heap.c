...
static ion_phys_addr_t ion_cma_allocate(struct ion_heap *heap,
				      unsigned long size,
				      unsigned long align)
{
...
static void ion_cma_free(struct ion_heap *heap, ion_phys_addr_t addr,
		       unsigned long size)
{
	struct ion_cma_heap *cma_heap =
		container_of(heap, struct ion_cma_heap, heap);
...
static void *ion_cma_heap_map_kernel(struct ion_heap *heap,
				   struct ion_buffer *buffer)
{
...
static void ion_cma_heap_unmap_kernel(struct ion_heap *heap,
				    struct ion_buffer *buffer)
{
...
struct ion_heap *ion_custom_heap_create(struct ion_platform_heap *heap_data, struct device *dev)
{
	struct ion_cma_heap *cma_heap;
...
void ion_custom_heap_destroy(struct ion_heap *heap)
{
	struct ion_cma_heap *cma_heap =
		container_of(heap, struct  ion_cma_heap, heap);
	if(cma_heap->pool)
