...
typedef struct hwc_resources {
	unsigned int arith_words;
	unsigned int ls_issues;
	unsigned int tex_issues;
	unsigned int tripipe_active;
#ifdef MALI_SEC_HWCNT_VERT
	unsigned int gpu_active;
	unsigned int js0_active;
	unsigned int tiler_active;
	unsigned int external_read_bits;
#endif
} hwc_resources;
#endif
