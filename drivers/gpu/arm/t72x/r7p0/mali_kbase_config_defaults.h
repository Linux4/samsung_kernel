 ...
 */
#define DEFAULT_JS_HARD_STOP_TICKS_SS    (60) /* 6s */
#define DEFAULT_JS_HARD_STOP_TICKS_SS_8408  (300) /* 30s */

/*
 * Default minimum number of scheduling ticks before CL jobs are hard-stopped.
 */
#define DEFAULT_JS_HARD_STOP_TICKS_CL    (60) /* 6s */
 ...
 * "stuck" job
 */
#define DEFAULT_JS_RESET_TICKS_SS           (65) /* 6.5s */
 ...
 * "stuck" CL job.
 */
#define DEFAULT_JS_RESET_TICKS_CL        (65) /* 6.5s */
