 ...
 */
#define DEFAULT_JS_SCHEDULING_PERIOD_NS    (100000000u) /* 100ms => 50ms */
 ...
 * context)
 */
#define DEFAULT_JS_SOFT_STOP_TICKS       (50) /* 100ms-200ms => 5s */

/*
 * Default minimum number of scheduling ticks before CL jobs are soft-stopped.
 */
#define DEFAULT_JS_SOFT_STOP_TICKS_CL    (50) /* 100ms-200ms => 5s */

/*
 * Default minimum number of scheduling ticks before jobs are hard-stopped
 */
#define DEFAULT_JS_HARD_STOP_TICKS_SS    (70) /* 5s => 7s */
#define DEFAULT_JS_HARD_STOP_TICKS_SS_8408  (300) /* 30s -> 15s */

/*
 * Default minimum number of scheduling ticks before CL jobs are hard-stopped.
 */
#define DEFAULT_JS_HARD_STOP_TICKS_CL    (70) /* 5s => 7s */
 ...
 */
#define DEFAULT_JS_SOFT_JOB_TIMEOUT ((u32)5000) /* 3s => 5s */

/*
 * Default minimum number of scheduling ticks before the GPU is reset to clear a
 * "stuck" job
 */
#define DEFAULT_JS_RESET_TICKS_SS           (75) /* 5.5s => 7.5s */
 ...
 * "stuck" CL job.
 */
#define DEFAULT_JS_RESET_TICKS_CL        (75) /* 5.5s => 7.5s */
