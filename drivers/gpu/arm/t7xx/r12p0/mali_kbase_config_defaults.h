 ...
 * context)
 */
#define DEFAULT_JS_SOFT_STOP_TICKS       (10) /* 1s */

/*
 * Default minimum number of scheduling ticks before CL jobs are soft-stopped.
 */
#define DEFAULT_JS_SOFT_STOP_TICKS_CL    (10) /* 1s */

/*
 * Default minimum number of scheduling ticks before jobs are hard-stopped
 */
#define DEFAULT_JS_HARD_STOP_TICKS_SS    (60) /* 3s */
#define DEFAULT_JS_HARD_STOP_TICKS_SS_8408  (300) /* 30s -> 15s */

/*
 * Default minimum number of scheduling ticks before CL jobs are hard-stopped.
 */
#define DEFAULT_JS_HARD_STOP_TICKS_CL    (60) /* 3s */
 ...
 * "stuck" job
 */
#define DEFAULT_JS_RESET_TICKS_SS           (65) /* 3.25s */
 ...
 * "stuck" CL job.
 */
#define DEFAULT_JS_RESET_TICKS_CL        (65) /* 3.25s */
