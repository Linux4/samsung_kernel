...
/* MALI_SEC_INTEGRATION */
/*
 * struct kbase_ioctl_slsi_amigo_flags - Read amigo flags
...
#define KBASE_IOCTL_SLSI_AMIGO_FLAGS \
	_IOR(KBASE_IOCTL_EXTRA_TYPE, 0, struct kbase_ioctl_slsi_amigo_flags)

/* MALI_SEC_INTEGRATION */
/*
 * struct kbase_ioctl_slsi_util_info - Read gpu utilization info
 * @util_avg: avg cpu util of gpu driver
 * @heavy_gpu: flag indicating heavy gpu usage
 */
...
#define KBASE_IOCTL_SLSI_UTIL_INFO \
	_IOR(KBASE_IOCTL_EXTRA_TYPE, 1, struct kbase_ioctl_slsi_util_info)
...
#define KBASE_IOCTL_SLSI_PMQOS \
	_IOW(KBASE_IOCTL_EXTRA_TYPE, 2, struct kbase_ioctl_slsi_pmqos)
