...
//+P230727-02276,xieshuaishuai.wt,MODIFY,20230730,press power key + vol up, goto recovery mode.
...
#else
	pr_err("The production version are not allowed to enter download mode.\n");
#endif
//-P230727-02276,xieshuaishuai.wt,MODIFY,20230730,press power key + vol up, goto recovery mode.
}
