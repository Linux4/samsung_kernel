...
#define SGM41513_REG_Q1_FULLON_MASK           GENMASK(6, 6)
    ...
    if (ret) {
        ...
        if (ret)
            ...
            ret = sgm41513_update_bits(info, SGM41513_REG_2,
                      SGM41513_REG_Q1_FULLON_MASK,
                      SGM41513_REG_Q1_FULLON_MASK);
        if (ret) {
            dev_err(info->dev, "reset sgm41513 Q1 FULLON failed\n");
            return ret;
        }
        /* HS03 code for SL6215DEV-734 by shixuanxuan at 20210906 end */
    }
...
static int sgm41513_charger_start_charge(struct sgm41513_charger_info *info)
{
    ...
    ret = sgm41513_update_bits(info, SGM41513_REG_5,
                 ...
                 0x01 << SGM41513_REG_WATCHDOG_TIMER_SHIFT);
    if (ret) {
