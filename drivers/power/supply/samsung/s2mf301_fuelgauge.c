...
static void s2mf301_reset_fg(struct s2mf301_fuelgauge_data *fuelgauge)
{
	...
	s2mf301_read_reg_byte(fuelgauge->i2c, S2MF301_REG_RBATCAP_OCV_NEW_IN, &temp);
	temp |= 0x01;
	...
	s2mf301_write_and_verify_reg_byte(fuelgauge->i2c, S2MF301_REG_RBATCAP_OCV_NEW_IN, fuelgauge->info.batcap[0]);
