...
struct afc_dev {
	...
	//struct gpio_desc *afc_switch_gpiod;
	//struct gpio_desc *afc_data_gpiod;
	int32_t afc_switch_gpio;
	int32_t afc_data_gpio;
	enum of_gpio_flags afc_switch_flag;
	enum of_gpio_flags afc_data_flag;
};
