...
static ssize_t power_supply_show_property(struct device *dev,
	...
	if (psp == POWER_SUPPLY_PROP_TYPE) {
		...
		/* Tab A7 lite_U code for P240216-02710 by shanxinkai at 20240329 start */
		#if defined(CONFIG_HQ_PROJECT_OT8)
		if (value.intval == POWER_SUPPLY_TYPE_USB_CDP)
		{
			value.intval = POWER_SUPPLY_TYPE_USB;
		}
		#endif
		/* Tab A7 lite_U code for P240216-02710 by shanxinkai at 20240329 end */
	} else {
...
/* hs14 code for SR-AL6528A-01-321 by gaozhengwei at 2022/09/22 end */
	...
	POWER_SUPPLY_ATTR(reset_battery_cycle),
	#endif
...
/* hs14 code for SR-AL6528A-01-244 by shanxinkai at 2022/11/04 end */
...
#if defined (CONFIG_CHARGER_CP_PPS)
    POWER_SUPPLY_ATTR(vbus_volt),
    POWER_SUPPLY_ATTR(ibus_current),
    POWER_SUPPLY_ATTR(vbat_volt),
    POWER_SUPPLY_ATTR(ibat_current),
    POWER_SUPPLY_ATTR(cpm_temp),
#endif
	...
	POWER_SUPPLY_ATTR(cp_otg_enable),
	POWER_SUPPLY_ATTR(cp_adc_enable),
