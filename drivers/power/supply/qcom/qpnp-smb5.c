...
static enum power_supply_property smb5_usb_props[] = {
	...
	/* QN3979 add for SR-QN3979-01-58 add usb connector thermal by shixuanxuan at 2021/01/05 start */
	POWER_SUPPLY_PROP_CONNECTOR_TEMP,
	/* QN3979 add for SR-QN3979-01-58 add usb connector thermal by shixuanxuan at 2021/01/05 end */
};
		...
		union power_supply_propval *val)
{
	...
	case POWER_SUPPLY_PROP_INPUT_VOLTAGE_SETTLED:
		...
		break;
	/* QN3979 add for SR-QN3979-01-58 add usb connector thermal by shixuanxuan at 2021/02/12 start */
	case POWER_SUPPLY_PROP_CONNECTOR_TEMP:
		rc = hq_smblib_get_conn_temp(chg, val);
		break;
	/* QN3979 add for SR-QN3979-01-58 add usb connector thermal by shixuanxuan at 2021/02/12 end */
	default:
...
static const struct power_supply_desc usb_psy_desc = {
	.name = "usb",
	/* F52 code for P210330-04518 & P210429-03220 Fix No USB Charging PoP when two phone connected with C-C cable by qiaodan at 2021/05/01 start */
	.type = POWER_SUPPLY_TYPE_USB_PD,
	/* F52 code for P210330-04518 & P210429-03220 Fix No USB Charging PoP when two phone connected with C-C cable by qiaodan at 2021/05/01 end */
...
/* QN3979 add for SR-QN3979-01-255 Add otg psy by shixuanxuan at 2021/02/04 start */
/*************************
		...
		union power_supply_propval *val)
{
	...
	case POWER_SUPPLY_PROP_TYPE:
		...
		break;
	case POWER_SUPPLY_PROP_ONLINE:
		rc = smblib_get_prop_usb_otg(chg,val);
		break;

	default:
		pr_err("otg power supply prop %d not supported\n", psp);
		return -EINVAL;
	}
...
static int smb5_otg_prop_is_writeable(struct power_supply *psy,
		enum power_supply_property psp)
{
	switch (psp) {
...
static const struct power_supply_desc otg_psy_desc = {
	...
	.property_is_writeable = smb5_otg_prop_is_writeable,
};
...
#endif
/* QN3979 add for SR-QN3979-01-255 Add otg psy by shixuanxuan at 2021/02/04 end */
...
static enum power_supply_property smb5_batt_props[] = {
	...
	POWER_SUPPLY_PROP_CONSTANT_CHARGE_CURRENT_MAX,
	/* QN3979 add for SR-QN3979-01-217 Add batt_misc_event sysFs node by shixuanxuan at 2021/02/04 start */
	#if !defined(HQ_FACTORY_BUILD)
	POWER_SUPPLY_PROP_BATT_MISC_EVENT,
	#endif
	/* QN3979 add for SR-QN3979-01-217 Add batt_misc_event sysFs node by shixuanxuan at 2021/02/04 end */
	...
	/* QN3979 add for SR-QN3979-01-219 Provid battery/online node by shixuanxuan at 2021/02/10 start */
	#if !defined(HQ_FACTORY_BUILD)	//ss version
	POWER_SUPPLY_PROP_ONLINE,
	#endif
	/* QN3979 add for SR-QN3979-01-219 Provid battery/online node by shixuanxuan at 2021/02/10 end */
	POWER_SUPPLY_PROP_CHARGE_FULL,
	POWER_SUPPLY_PROP_FORCE_RECHARGE,
	POWER_SUPPLY_PROP_CHARGE_FULL_DESIGN,
	/* F52 code for P210306-00812 Remove "time_to_full_now" by gaochao at 2021/03/12 start */
	#if defined(HQ_FACTORY_BUILD) // factory binary
	POWER_SUPPLY_PROP_TIME_TO_FULL_NOW,
	#endif
	/* F52 code for P210306-00812 Remove "time_to_full_now" by gaochao at 2021/03/12 end */
	POWER_SUPPLY_PROP_FCC_STEPPER_ENABLE,
	/* QN3979 add for SR-QN3979-01-230 Disable charging over 80 by shixuanxuan at 2020/02/03 start */
	#if defined(HQ_FACTORY_BUILD) //factory version
	POWER_SUPPLY_PROP_CHARGING_ENABLED,
	POWER_SUPPLY_PROP_BATT_CAPACITY_CONTROL,
	#endif
	/* QN3979 add for SR-QN3979-01-230 Disable charging over 80 by shixuanxuan at 2020/02/03 end */
	/* QN3979 add for SR-QN3979-01-256 Add battery_current_ua and battery_cycle node by shixuanxuan at 2020/02/06 start */
	#if !defined(HQ_FACTORY_BUILD)	//ss version
	...
	//- SS_charging, add battery_cycle node
	#endif
	/* QN3979 add for SR-QN3979-01-256 Add battery_current_ua and battery_cycle node by shixuanxuan at 2020/02/06 end */
	/* QN3979 add for SR-QN3979-01-226 Add Retail App function by wenyaqi at 2021/02/10 start */
	#ifndef HQ_FACTORY_BUILD //ss version
	POWER_SUPPLY_PROP_STORE_MODE,
	#endif
	/* QN3979 add for SR-QN3979-01-226 Add Retail App function by wenyaqi at 2021/02/10 end */
	/* F52 code for QN3979-302 Add AFC feature by gaochao at 2021/02/26 start */
	#if defined(CONFIG_AFC)
	...
	#endif
	/* F52 code for QN3979-302 Add AFC feature by gaochao at 2021/02/26 end */
	/* F52 for SR-QN3979-01-227 by shixuanxuan at 2021/03/12 start */
	#ifndef HQ_FACTORY_BUILD //ss version
	POWER_SUPPLY_PROP_BATT_SLATE_MODE,
	#endif
	/* F52 for SR-QN3979-01-227 by shixuanxuan at 2021/03/12 end */
	/* F52 for SR-QN3979-01-222 by shixuanxuan at 2021/03/12 start */
	#if !defined(HQ_FACTORY_BUILD) //ss version
	POWER_SUPPLY_PROP_BATT_CURRENT_EVENT,
	#endif
	/* F52 for SR-QN3979-01-222 by shixuanxuan at 2021/03/12 end */
	/* F52 code for SR-QN3979-01-805 SEC_FLOATING_FEATURE_BATTERY_SUPPORT_HV_DURING_CHARGING by gaochao at 2021/04/05 start */
	#if defined(CONFIG_AFC)
	POWER_SUPPLY_PROP_CUSTOM_FINE_TUNE_HV_RESUME_DEBUG,
	#endif
	/* F52 code for SR-QN3979-01-805 SEC_FLOATING_FEATURE_BATTERY_SUPPORT_HV_DURING_CHARGING by gaochao at 2021/04/05 end */
	/* QN3979 for SR-QN3979-01-742 add battery protect function by shixuanxuan at 2021/04/25 start */
	#if !defined(HQ_FACTORY_BUILD)
	POWER_SUPPLY_PROP_BATT_PROTECT,
	POWER_SUPPLY_PROP_BATT_PROTECT_ENABLE,
	#endif
	/* QN3979 for SR-QN3979-01-742 add battery protect function by shixuanxuan at 2021/04/25 end */
};
		...
		union power_supply_propval *val)
{
	...
	case POWER_SUPPLY_PROP_STATUS:
		...
		if ((val->intval == POWER_SUPPLY_STATUS_NOT_CHARGING) && usb_online && (chg->re_chg == 0))
		{
			val->intval = POWER_SUPPLY_STATUS_CHARGING;
			pr_err("lk restart charing, intval = %d, usb_online = %d\n", val->intval, usb_online);
		}
		break;
	case POWER_SUPPLY_PROP_HEALTH:
	...
	case POWER_SUPPLY_PROP_CAPACITY:
		rc = smblib_get_prop_batt_capacity(chg, val);
			/* QN3979 add for SR-QN3979-01-230 Disable charging over 80 by shixuanxuan at 2020/02/03 start */
		#if defined(HQ_FACTORY_BUILD) //factory version
		if (chg->batt_capacity_control_flag == 1)
		{
			if (val->intval >= CAPACITY_OF_STOP_CHARGE)
			{
				if (chg->charging_enable_flag != 0)
				{
					pval.intval = 0;
					smblib_set_prop_battery_charging_enabled(chg, &pval);
					pr_info("The battery capacity is over %d%%! Charging disabled!\n", CAPACITY_OF_STOP_CHARGE);
				}
			}
			else
			{
				if (chg->charging_enable_flag != 1)
				{
					pval.intval = 1;
					smblib_set_prop_battery_charging_enabled(chg, &pval);
					pr_info("The battery capacity is below %d%%, Charging enabled!\n", CAPACITY_OF_STOP_CHARGE);
				}
			}
		}
		else
		{
			if (chg->charging_enable_flag != 2)
			{
				pval.intval = 1;
				smblib_set_prop_battery_charging_enabled(chg, &pval);
				chg->charging_enable_flag = 2;
				pr_info("Disable Battery Soc control!Charging enabled!\n");
			}
		}
		#endif
		/* QN3979 add for SR-QN3979-01-230 Disable charging over 80 by shixuanxuan at 2020/02/03 end */
	...
	case POWER_SUPPLY_PROP_CONSTANT_CHARGE_CURRENT_MAX:
		val->intval = get_client_vote(chg->fcc_votable,
					      BATT_PROFILE_VOTER);
		break;
	/* QN3979 add for SR-QN3979-01-217 Add batt_misc_event sysFs node by shixuanxuan at 2021/01/26 start */
	#if !defined(HQ_FACTORY_BUILD)
	case POWER_SUPPLY_PROP_BATT_MISC_EVENT:
		smblib_get_prop_batt_batt_misc_event_samsung(chg, val);
		break;
	#endif
	/* QN3979 add for SR-QN3979-01-217 Add batt_misc_event sysFs node by shixuanxuan at 2021/01/26 end */
	/* QN3979 for SR-QN3979-01-742 add battery protect function by shixuanxuan at 2021/04/25 start */
	#if !defined(HQ_FACTORY_BUILD)
	case POWER_SUPPLY_PROP_BATT_PROTECT:
		val->intval = chg->en_batt_protect;
		break;
	case POWER_SUPPLY_PROP_BATT_PROTECT_ENABLE:
		val->intval = chg->batt_protect_flag;
		break;
	#endif
	/* QN3979 for SR-QN3979-01-742 add battery protect function by shixuanxuan at 2021/04/25 end */
	...
	case POWER_SUPPLY_PROP_HV_CHARGER_STATUS:
		...
		if (chg->hv_disable) {
			...
			if ((chg->real_charger_type == POWER_SUPPLY_TYPE_AFC)
				...
				|| (chg->real_charger_type == POWER_SUPPLY_TYPE_USB_PD_DRP))
				val->intval = 1;
		}
		break;
	...
	/* F52 code for SR-QN3979-01-805 SEC_FLOATING_FEATURE_BATTERY_SUPPORT_HV_DURING_CHARGING by gaochao at 2021/04/05 start */
	#if defined(CONFIG_AFC)
	case POWER_SUPPLY_PROP_CUSTOM_FINE_TUNE_HV_RESUME_DEBUG:
		val->intval = chg->custom_fine_tune_hv_resume_debug;
		break;
	#endif
	/* F52 code for SR-QN3979-01-805 SEC_FLOATING_FEATURE_BATTERY_SUPPORT_HV_DURING_CHARGING by gaochao at 2021/04/05 end */
	/* F52 code for P210306-00812 Remove "time_to_full_now" by gaochao at 2021/03/12 start */
	...
	case POWER_SUPPLY_PROP_CHARGING_ENABLED:
		...
		break;
	case POWER_SUPPLY_PROP_BATT_CAPACITY_CONTROL:
		val->intval = chg->batt_capacity_control_flag;
		break;
	#endif
	/* QN3979 add for SR-QN3979-01-230 Disable charging over 80 by shixuanxuan at 2020/02/03 end */
	/* QN3979 add for SR-QN3979-01-226 Add Retail App function by wenyaqi at 2021/02/10 start */
	...
	case POWER_SUPPLY_PROP_STORE_MODE:
		smblib_get_prop_ss_store_mode(chg, val);
		break;
	#endif
	/* QN3979 add for SR-QN3979-01-226 Add Retail App function by wenyaqi at 2021/02/10 end */
	default:
		...
		const union power_supply_propval *val)
{
	...
	#if !defined(HQ_FACTORY_BUILD)
	case POWER_SUPPLY_PROP_BATT_PROTECT_ENABLE:
		chg->batt_protect_flag = val->intval;
		break;
	#endif
	/* QN3979 for SR-QN3979-01-742 add battery protect function by shixuanxuan at 2021/04/25 end */
	case POWER_SUPPLY_PROP_VOLTAGE_QNOVO:
	...
	#if defined(HQ_FACTORY_BUILD) //factory version
	case POWER_SUPPLY_PROP_BATT_CAPACITY_CONTROL:
		 chg->batt_capacity_control_flag = val->intval;
		break;
	#endif
	/* QN3979 add for SR-QN3979-01-230 Disable charging over 80 by shixuanxuan at 2020/02/03 end */
	/* QN3979 add for SR-QN3979-01-226 Add Retail App function by wenyaqi at 2021/02/10 start */
	#ifndef HQ_FACTORY_BUILD //ss version
	case POWER_SUPPLY_PROP_STORE_MODE:
		smblib_set_prop_ss_store_mode(chg, val);
		break;
	#endif
	/* QN3979 add for SR-QN3979-01-226 Add Retail App function by wenyaqi at 2021/02/10 end */
	...
	case POWER_SUPPLY_PROP_AFC_RESULT:
		...
		break;
	case POWER_SUPPLY_PROP_HV_DISABLE:
		/* F52 code for P211221-04056 by gaochao at 2022/01/04 start */
		smblib_hv_resume(chg, val);
		/* F52 code for P211221-04056 by gaochao at 2022/01/04 end */
		break;
	#endif
	/* F52 code for QN3979-302 Add AFC feature by gaochao at 2021/02/26 end */
	/* F52 code for SR-QN3979-01-805 SEC_FLOATING_FEATURE_BATTERY_SUPPORT_HV_DURING_CHARGING by gaochao at 2021/04/05 start */
	#if defined(CONFIG_AFC)
	case POWER_SUPPLY_PROP_CUSTOM_FINE_TUNE_HV_RESUME_DEBUG:
		chg->custom_fine_tune_hv_resume_debug = val->intval;
		break;
	#endif
	/* F52 code for SR-QN3979-01-805 SEC_FLOATING_FEATURE_BATTERY_SUPPORT_HV_DURING_CHARGING by gaochao at 2021/04/05 end */
	default:
		...
		enum power_supply_property psp)
{
	...
	#endif
	/* F52 code for SR-QN3979-01-805 SEC_FLOATING_FEATURE_BATTERY_SUPPORT_HV_DURING_CHARGING by gaochao at 2021/04/05 end */
	/* F52 code for QN3979-302 Add AFC feature by gaochao at 2021/03/03 start */
	#if defined(CONFIG_AFC)
	case POWER_SUPPLY_PROP_HV_DISABLE:
	#endif
	/* F52 code for QN3979-302 Add AFC feature by gaochao at 2021/03/03 end */
	/* QN3979 add for SR-QN3979-01-256 Add battery_current_ua and battery_cycle node by shixuanxuan at 2020/02/06 start */
	#if !defined(HQ_FACTORY_BUILD)	//ss version
	case POWER_SUPPLY_PROP_RECHARGE_VBAT:
	//+ SS_charging, add battery_cycle node
	...
	#endif
	/* QN3979 add for SR-QN3979-01-226 Add Retail App function by wenyaqi at 2021/02/10 end */
	/* F52 add for SR-QN3979-01-227 Add batt_slate_mode by shixuanxuan at 2021/03/11 start */
	#ifndef HQ_FACTORY_BUILD //ss version
	case POWER_SUPPLY_PROP_BATT_SLATE_MODE:
	#endif
	/* F52 add for SR-QN3979-01-227 Add batt_slate_mode by shixuanxuan at 2021/03/11 end */
	/* QN3979 for SR-QN3979-01-742 add battery protect function by shixuanxuan at 2021/04/25 start */
	#if !defined(HQ_FACTORY_BUILD)
	 case POWER_SUPPLY_PROP_BATT_PROTECT_ENABLE:
	#endif
...
static int smb5_init_hw(struct smb5 *chip)
{
	...
	if (rc < 0) {
		pr_err("Couldn't config HVDCP rc=%d\n", rc);
		return rc;
	}
	// smblib_hvdcp_detect_enable(chg, false);
	#endif
	...
	/* F52 add for QN3979-301 Enable Huawei cable charging by shixuanxuan at 2020/03/15 start */
	rc = smblib_write(chg, 0x154A, 0x17);
	if (rc < 0) {
		dev_err(chg->dev, "Couldn't set 0x154A rc=%d\n", rc);
		return rc;
	}
	/* F52 add for QN3979-301 Enable Huawei cable charging by shixuanxuan at 2020/03/15 end */
	/* F52 add for P210625-05186 Modify Xiaomi Ta offmode charging by shixuanxuan at 2021/7/19 start */
	rc = smblib_write(chg, 0x1360, 0x0c);
	if (rc < 0) {
		dev_err(chg->dev, "Couldn't set 0x1360 rc=%d\n", rc);
		return rc;
	}
	/* F52 add for P210625-05186 Modify Xiaomi Ta offmode charging by shixuanxuan at 2021/7/19 end */
	return rc;
}
...
void hq_vbus_control_gpio_init(struct smb_charger *chg, struct platform_device *pdev)
{
	...
	chg->vbus_conn_flag = 1;
	chg->vbus_control_gpio = of_get_named_gpio(pdev->dev.of_node, "draw-VBUS-GPIO11", 0);
	rc = gpio_request(chg->vbus_control_gpio, "draw-VBUS-GPIO11");
	if (!rc) {
		pr_info("line=%d: Success to request draw-VBUS-GPIO11=%d\n",
	...
	rc = gpio_direction_output(chg->vbus_control_gpio, DRAW_VBUS_GPIO11_LOW);
	if (rc)	{
...
/* QN3979 add for SR-QN3979-01-58 add usb connector thermal by shixuanxuan at 2021/02/12 end */
/* QN3979 for SR-QN3979-01-792 HARD JEITA threshold optimized by shixuanxuan at 2021/03/03 start */
struct smb_charger *smbchg_dev = NULL;
/* QN3979 for SR-QN3979-01-792 HARD JEITA threshold optimized by shixuanxuan at 2021/03/03 end */
...
static int smb5_probe(struct platform_device *pdev)
{
	...
	/* QN3979 for SR-QN3979-01-742 add battery protect function by shixuanxuan at 2021/04/25 start */
	#if !defined(HQ_FACTORY_BUILD) //factory version
	chg->batt_protect_flag = ENABLE_BATT_PROTECT;
	chg->en_batt_protect = DISABLE_BATT_PROTECT;
	chg->over_cap_count = 0;
	chg->cap_hold_count = 0;
	chg->recharge_count = 0;
	/* F52 add for HQ00001 modify battery long time protect function by shixuanxuan at 2021/06/14 start */
	chg->current_time = 0;
	/* F52 add for HQ00001 modify battery long time protect function by shixuanxuan at 2021/06/14 end */
	chg->base_time = 0;
	chg->vbus_rising = 0;
	#endif
	/* QN3979 for SR-QN3979-01-742 add battery protect function by shixuanxuan at 2021/04/25 end */
	/* F52 code add for QN3979-4218 modify charge_done in advance by shixuanxuan at 20210610 start */
	chg->re_chg = 1;
	/* F52 code add for QN3979-4218 modify charge_done in advance by shixuanxuan at 20210610 end */
	/* QN3979 for SR-QN3979-01-792 HARD JEITA threshold optimized by shixuanxuan at 2021/03/03 start */
	smbchg_dev = chg;
	...
	/* QN3979 add for SR-QN3979-01-230 Disable charging over 80 by shixuanxuan at 2020/02/03 start */
	#if defined(HQ_FACTORY_BUILD) //factory version
	chg->charging_enable_flag = 1;
	chg->batt_capacity_control_flag = STOP_CHARGING;
	#endif
	/* QN3979 add for SR-QN3979-01-230 Disable charging over 80 by shixuanxuan at 2020/02/03 start */
