...
/* QN3979 add for SR-QN3979-01-58 add usb connector thermal by shixuanxuan at 2021/01/05 start */
#define CHG_ALERT_HOT  70000 	//70degC
#define CHG_ALERT_WARM 60000 	//60degC
#define USB_CONN_TIME 60000	//delay 60s
enum {
	DRAW_VBUS_GPIO11_LOW,	/* disconnect VBUS to GND */
	DRAW_VBUS_GPIO11_HIGH,	/* connect VBUS to GND */
};
/* QN3979 add for SR-QN3979-01-58 add usb connector thermal by shixuanxuan at 2021/01/05 end */
/* F52 code for QN3979-302 Add AFC feature by gaochao at 2021/02/26 start */
#if defined(CONFIG_AFC)
...
#define SS_ICL_SUSPEND_VOTER	"SS_ICL_SUSPEND_VOTER"
#define STORE_MODE_VOTER	"STORE_MODE_VOTER"
#define STORE_MODE_FCC	500000
#define RETAIL_APP_DETECT_TIMER	60000

#define SS_STORE_MODE_ENABLE	1
#define SS_STORE_MODE_DISABLE	0

#define SS_RETAIL_APP_DISCHG_THRES	70
#define SS_RETAIL_APP_CHG_THRES	60
#define SS_RETAIL_APP_DISCHG_THRES_VZW	35
#define SS_RETAIL_APP_CHG_THRES_VZW	30
#endif
/* QN3979 add for SR-QN3979-01-226 Add Retail App function by wenyaqi at 2021/02/10 end */
/* F52 code for QN3979-302 Add AFC feature by gaochao at 2021/02/26 start */
#if defined(CONFIG_AFC)
#define AFC_START_TIME			1000
...
#define AFC_SHCEDULE_TIME				3000
#define QC_MONITOR_TIME				6000
#define HVDCP_INCREASE_THRESHOLD	6500000
#endif
...
#define TSUSPEND 259200//10800// 3days=259200 (s)
...
/* F52 code for P210430-05240 by gaochao at 2021/05/03 start */
#if !defined(HQ_FACTORY_BUILD) // SEP Binary
#define BATTERY_CHARGING_LOG_START_TIME		60000
#else
#define BATTERY_CHARGING_LOG_START_TIME		20000
#endif
/* F52 code for P210430-05240 by gaochao at 2021/05/03 end */
#define BATTERY_CHARGING_LOG_SCHEDULE_TIME	20000
...
struct smb_charger {
	...
	/* QN3979 add for SR-QN3979-01-58 add usb connector thermal by shixuanxuan at 2021/01/05 start */
	struct delayed_work	usb_conn_work;
	/* QN3979 add for SR-QN3979-01-58 add usb connector thermal by shixuanxuan at 2021/01/05 end */
	/* QN3979 add for SR-QN3979-01-226 Add Retail App function by wenyaqi at 2021/02/10 start */
	#ifndef HQ_FACTORY_BUILD	//ss version
	struct delayed_work	retail_app_work;
	#endif
	/* QN3979 add for SR-QN3979-01-226 Add Retail App function by wenyaqi at 2021/02/10 end */

	/* F52 code for QN3979-60 Add log for battery charging by gaochao at 2021/02/20 start */
	struct delayed_work	battery_chg_info_work;
	/* F52 code for QN3979-60 Add log for battery charging by gaochao at 2021/02/20 end */
	/* F52 code for QN3979-302 Add AFC feature by gaochao at 2021/02/26 start */
	#if defined(CONFIG_AFC)
	struct delayed_work    compliant_check_work;
	struct delayed_work    afc_start_work;
	/* F52 code for SR-QN3979-01-805 QC2.0 and QC3.0 for disabling hv_disable during charging by gaochao at 2021/04/19 start */
	#if !defined(HQ_FACTORY_BUILD) // SEP Binary
	struct delayed_work    qc_monitor_work;
	#endif
	/* F52 code for SR-QN3979-01-805 QC2.0 and QC3.0 for disabling hv_disable during charging by gaochao at 2021/04/19 end */
	#endif
	/* F52 code for QN3979-302 Add AFC feature by gaochao at 2021/02/26 end */
	...
	#endif
	/* QN3979 add for SR-QN3979-01-230 Disable charging over 80 by shixuanxuan at 2020/02/03 end */
	/* F52 code for QN3979-60 Add AFC feature by gaochao at 2021/02/26 start */
	#if defined(CONFIG_AFC)
	...
	#endif
	/* F52 code for QN3979-60 Add AFC feature by gaochao at 2021/02/26 end */
	/* F52 code for SR-QN3979-01-805 SEC_FLOATING_FEATURE_BATTERY_SUPPORT_HV_DURING_CHARGING by gaochao at 2021/04/05 start */
	#if defined(CONFIG_AFC)
	struct delayed_work		hv_resume_work;
	int			custom_fine_tune_hv_resume_debug;
...
/* F52 code for SR-QN3979-01-805 SEC_FLOATING_FEATURE_BATTERY_SUPPORT_HV_DURING_CHARGING by gaochao at 2021/04/05 start */
#if defined(CONFIG_AFC)
void smblib_hv_resume(struct smb_charger *chg,
	const union power_supply_propval *val);
#endif
/* F52 code for SR-QN3979-01-805 SEC_FLOATING_FEATURE_BATTERY_SUPPORT_HV_DURING_CHARGING by gaochao at 2021/04/05 end */
