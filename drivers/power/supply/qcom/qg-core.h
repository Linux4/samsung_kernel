...
struct qg_batt_props {
	...
	/* QN3979 add for SR-QN3979-01-257 Import battery aging by shixuanxuan at 2020/02/07 start */
	#if !defined(HQ_FACTORY_BUILD)	//ss version
	bool			qg_batt_aging_enable;
	int			recharge_vbat_mv;
	#endif
	/* QN3979 add for SR-QN3979-01-257 Import battery aging by shixuanxuan at 2020/02/07 end */
};
