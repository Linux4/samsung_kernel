...
#ifdef CONFIG_USB_NOTIFY_LAYER
	send_otg_notify(o_notify, NOTIFY_EVENT_VBUS, enable && usb_data_enabled);
#endif
}
...
#ifdef CONFIG_USB_NOTIFY_LAYER
	send_otg_notify(o_notify, NOTIFY_EVENT_HOST, enable && usb_data_enabled);
#endif
}
