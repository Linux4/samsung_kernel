...
#ifdef CONFIG_N28_CHARGER_PRIVATE
	if (adapter_is_support_pd_pps() && !g_cp_charging.cp_leave) {
		if (sw_jeita->sm == TEMP_T3_TO_T4) {
...
#if defined CONFIG_N28_CHARGER_PRIVATE || defined WT_COMPILE_FACTORY_VERSION
/* -Bug SSNA-9203,zhouxiaopeng2.wt,20230607, Current station shipmodecurrent too high */
