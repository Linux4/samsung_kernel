...
static struct delayed_work fan_t32s_timer_work;
...
static void fan5405_Reset32sTimer(unsigned long data)
{
	...
	schedule_delayed_work(&fan_t32s_timer_work, HZ*10);
...
void fan5405_TA_StartCharging(void)
{
    ...
    fan5405_SetValue(FAN5405_REG_IBAT, FAN5405_ITERM,FAN5405_ITERM_SHIFT, ITERM146);  //146ma
	...
	struct i2c_client *client, const struct i2c_device_id *id)
{
	...
	INIT_DELAYED_WORK(&fan_t32s_timer_work, fan5405_Reset32sTimer);
	schedule_work(&fan_t32s_timer_work);
