...
void board_battery_init(struct platform_device *pdev, struct sec_battery_info *battery)
{
	...
	battery->swelling_low_temp_block_1st = BATT_SWELLING_LOW_TEMP_BLOCK_1st;
	battery->swelling_low_temp_recov_1st = BATT_SWELLING_LOW_TEMP_RECOV_1st;
	battery->swelling_low_temp_block_2nd = BATT_SWELLING_LOW_TEMP_BLOCK_2nd;
	battery->swelling_low_temp_recov_2nd = BATT_SWELLING_LOW_TEMP_RECOV_2nd;
#else
