...
static int s2mu005_get_soc_from_ocv(struct s2mu005_fuelgauge_data *fuelgauge, int target_ocv)
{
	...
	int soc_arr_evt2[TABLE_SIZE] = {11037, 10506, 9975, 9444, 8912, 8381, 7850, 7319, 6787, 6256, 5725, 5193, 4662, 4131, 3600, 3068, 2537, 2006, 1475, 944, 412, -119}; // * 0.01%
	int ocv_arr_evt2[TABLE_SIZE] = {44745, 44094, 43443, 42796, 42176, 41570, 41000, 40473, 40001, 39558, 39064, 38617, 38335, 38118, 37950, 37817, 37662, 37453, 37164, 36884, 36707, 33173}; // *0.1mV
...
static void s2mu005_reset_fg(struct s2mu005_fuelgauge_data *fuelgauge)
{
	...
	u8 table3[88] = {204, 11, 70, 11, 193, 10, 61, 10, 190, 9,
	...
	u8 table4[22] = {57, 54, 52, 51, 53, 50, 50, 52, 51, 52, 51,
					53, 54, 56, 55, 54, 57, 61, 56, 57, 59, 154,
	};
