...
static int s2mu106_fg_dev_pinctrl_configure_irq(struct s2mu106_fuelgauge_data *fuelgauge)
{
				...
				const struct i2c_device_id *id)
{
	...
	ret = s2mu106_fg_dev_pinctrl_configure_irq(fuelgauge);
	if (ret)
		pr_err("%s: Failed s2mu106_fg_dev_pinctrl_configure_irq\n", __func__);
