...
#define DCDC_ISSUE_CHARGING_MAX 60
#define DCDC_ISSUE_CHARGING_MIN 50
...
typedef struct sec_battery_platform_data {
	...
	/* set a different input current when siop level is 20 */
	int input_current_by_siop_20;
	int hv_input_current_by_siop_20;
	int input_current_by_siop_10;
	int hv_input_current_by_siop_10;
	int input_current_by_siop_0;
	int hv_input_current_by_siop_0;
