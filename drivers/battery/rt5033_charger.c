		...
		int current_limit)
{
	...
	if (data == 0) { /* Mega2, need to disable input current limit (000) */
		rt5033_assign_bits(i2c, RT5033_CHG_CTRL1,
			RT5033_HIGHER_OCP << RT5033_HIGHER_OCP_SHIFT,
				RT5033_HIGHER_OCP << RT5033_HIGHER_OCP_SHIFT);
	} else {
		if (data < 0)
			data = 1;
		rt5033_clr_bits(i2c,
			RT5033_CHG_CTRL1, RT5033_HIGHER_OCP << RT5033_HIGHER_OCP_SHIFT);
	}
