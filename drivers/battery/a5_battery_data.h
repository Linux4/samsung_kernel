...
#if defined(CONFIG_MACH_A5_EUR_OPEN) || defined(CONFIG_MACH_A53G_EUR_OPEN) || defined(CONFIG_MACH_A5U_EUR_OPEN) || defined(CONFIG_MACH_A5U_KOR_OPEN)
...
#if defined(CONFIG_MACH_A5_EUR_OPEN) || defined(CONFIG_MACH_A53G_EUR_OPEN) || defined(CONFIG_MACH_A5U_CAN_BMC) || defined(CONFIG_MACH_A5U_EUR_OPEN) || defined(CONFIG_MACH_A5U_KOR_OPEN)
