...
static void s2mu003_reset_fg(struct s2mu003_fuelgauge_data *fuelgauge)
{
	...
	static u8 model_param1[] = {
		 115, 11, 241, 10, 111, 10, 237, 9, 117, 9, 3, 9, 153, 8, 54, 8, 223, 7, 143, 7, 11, 7, 203,
		 6, 155, 6, 115, 6, 83, 6, 57, 6, 19, 6, 226, 5, 143, 5, 119, 5, 152, 4, 189, 1, 5, 9, 147,
		 8, 33, 8, 174, 7, 60, 7, 202, 6, 88, 6, 229, 5, 115, 5, 1, 5, 143, 4, 28, 4, 170, 3, 56, 3,
		 198, 2, 84, 2, 225, 1, 111, 1, 253, 0, 138, 0, 24, 0, 208, 15, 254, 41, 220, 41, 138, 41, 83,
		 41, 40, 19, 38, 19, 242, 237, 242, 237, 242, 237, 242, 237, 176, 173, 176, 186, 176, 186,
	};
	...
	i2c_smbus_write_byte_data(fuelgauge->i2c, 0x0E, 0x28);
		...
		i2c_smbus_write_byte_data(fuelgauge->i2c, 0x10, 0xF6);
		i2c_smbus_write_byte_data(fuelgauge->i2c, 0x11, 0x09);
#endif
