		...
		struct sec_battery_info *battery)
{
	...
	if (ret) {
		pr_info("%s: swelling_low_temp_current is Empty, Defualt value %dmA\n",
	...
	if (ret) {
		pr_info("%s: swelling_low_temp_topoff is Empty, Defualt value %dmA\n",
	...
	if (ret) {
		pr_info("%s: swelling_hign_temp_current is Empty, Defualt value %dmA\n",
	...
	if (ret) {
		pr_info("%s: swelling_high_temp_topoff is Empty, Defualt value %dmA\n",
			__func__, BATT_SWELLING_TOPOFF_CURRENT);
	...
	if (ret) {
		pr_info("%s: swelling_wc_high_temp_current is Empty, Defualt value %dmA \n",
			__func__, BATT_SWELLING_LOW_CHG_CURRENT);
	...
	if (ret) {
		pr_info("%s: swelling_wc_low_temp_current is Empty, Defualt value %dmA \n",
			__func__, BATT_SWELLING_LOW_CHG_CURRENT);
