...
#define ISSUPP_11ACENABLED(FwCapInfo) (FwCapInfo & (MBIT(13)|MBIT(14)))

#define ISSUPP_11AC2GENABLED(FwCapInfo) (FwCapInfo & MBIT(13))
#define ISSUPP_11AC5GENABLED(FwCapInfo) (FwCapInfo & MBIT(14))
...
#define ISSUPP_11ACSUBEAMFORMEE(Dot11acDevCap) (Dot11acDevCap & MBIT(10))
/** HW_SPEC Dot11acDevCap : SU Beamformer support */
#define ISSUPP_11ACSUBEAMFORMER(Dot11acDevCap) (Dot11acDevCap & MBIT(9))
...
/** HW_SPEC Dot11acDevCap : ReSet Compressed Steering Number of Beamformer Antenna */
...
/** HW_SPEC Dot11acDevCap : ReSet support of Channel BW 20/40/80/160/80+80 MHz */
#define RESET_11ACBW8080(Dot11acDevCap) (Dot11acDevCap &= ~MBIT(3))
/** HW_SPEC Dot11acDevCap : ReSet support of Channel BW 20/40/80/160 MHz */
