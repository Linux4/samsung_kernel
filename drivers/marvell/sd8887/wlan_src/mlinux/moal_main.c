...
/** Driver version */
char driver_version[] =
	"SD8887-%s-M" KERN_VERSION "14" MLAN_RELEASE_VERSION
	"-GPL" "-(" "FP" FPNUM ")"
#ifdef	DEBUG_LEVEL2
	"-dbg"
#endif
...
woal_dump_sdio_reg_info(moal_handle * phandle, t_u8 * drv_buf)
{
	...
	unsigned int reg_table[] = { 0x58, 0x5C, 0x5D, 0x60, 0x61, 0x62,
...
#define DEBUG_DUMP_CTRL_REG               0xA3
#define DEBUG_DUMP_FIRST_REG              0xA2
#define DEBUG_DUMP_START_REG              0xA4
#define DEBUG_DUMP_END_REG                0xAA
#define ITCM_SIZE                         0x4C000
#define SQRAM_SIZE                        0x58000
