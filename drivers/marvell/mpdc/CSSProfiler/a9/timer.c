...
static enum hrtimer_restart hrtimer_func(struct hrtimer *hrtimer)
{
	...
	delay_in_ns = g_tbs_settings_css.interval * NSEC_PER_USEC;
...
{
	ktime_t ktime;
	unsigned long long delay_in_ns = g_tbs_settings_css.interval * NSEC_PER_USEC;
...
int start_tbs_css(bool is_start_paused)
{
	int ret;
