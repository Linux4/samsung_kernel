...
extern struct css_sampling_op_mach css_sampling_op_a7;

extern bool write_sample(PXD32_CSS_Call_Stack_V2 * sample_rec);

extern bool g_launched_app_exit_css;
extern bool g_is_image_load_set_css;
extern bool g_is_app_exit_set_css;

/* the pid of auto launched application */
extern pid_t g_launch_app_pid_css;
/* the full path of the wait image */
extern char g_image_load_path_css[PATH_MAX];

extern struct css_sampling_op_mach * css_samp_op;

DECLARE_PER_CPU(struct RingBufferInfo, g_sample_buffer_css);
extern struct RingBufferInfo g_module_buffer_css;
DECLARE_PER_CPU(char *, g_bt_buffer_css);

extern struct CSSTimerSettings g_tbs_settings_css;
extern struct CSSEventSettings g_ebs_settings_css;
extern bool g_calibration_mode_css;
extern bool g_is_image_load_set_css;
extern bool g_is_app_exit_set_css;
...
extern bool g_launched_app_exit_css;
extern void** system_call_table_css;

extern wait_queue_head_t pxcss_kd_wait;

extern unsigned long long g_sample_count_css;

extern unsigned long get_timestamp_freq_css(void);

extern int handle_image_loaded_css(void);
