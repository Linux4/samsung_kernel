...
extern struct hs_sampling_op_mach hs_sampling_op_a7;

extern bool write_sample(unsigned int cpu, PXD32_Hotspot_Sample_V2 * sample_rec);

extern struct RingBufferInfo g_module_buffer_hs;
DECLARE_PER_CPU(struct RingBufferInfo, g_sample_buffer_hs);

extern unsigned long long g_sample_count_hs;

extern void** system_call_table_hs;
extern wait_queue_head_t pxhs_kd_wait;

extern struct HSTimerSettings g_tbs_settings_hs;
extern struct HSEventSettings g_ebs_settings_hs;
extern bool g_calibration_mode_hs;

extern bool g_is_image_load_set_hs;
extern bool g_is_app_exit_set_hs;
extern bool g_launched_app_exit_hs;

/* the full path of the wait image */
extern char g_image_load_path_hs[PATH_MAX];

/* the pid of auto launched application */
extern pid_t g_launch_app_pid_hs;

extern int handle_image_loaded_hs(void);
