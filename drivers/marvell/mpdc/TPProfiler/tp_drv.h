...
extern struct RingBufferInfo g_event_buffer_tp;
extern PXD32_DWord convert_to_PXD32_DWord(unsigned long long n);

extern pid_t g_mpdc_tgid;
extern struct RingBufferInfo g_event_buffer_tp;
extern struct RingBufferInfo g_module_buffer_tp;
...
extern char g_image_load_path_tp[PATH_MAX];
/* the pid of auto launched application */
extern pid_t g_launch_app_pid_tp;
extern pid_t g_tgid;

extern bool g_launched_app_exit_tp;
extern bool g_is_image_load_set_tp;
extern bool g_is_app_exit_set_tp;

//extern struct px_tp_dsa *g_dsa;
extern void** system_call_table_tp;

extern int start_module_tracking_tp(void);
extern int stop_module_tracking_tp(void);
extern int start_functions_hooking(void);
extern int stop_functions_hooking(void);
extern int add_module_record_tp(struct add_module_data * data);
