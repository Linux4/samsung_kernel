...
typedef gcsDATABASE_RECORD_PTR *        gcsDATABASE_RECORD_PTR_PTR;
...
typedef struct _gcsDATABASE
{
    ...
    gctUINT                             conAllocSucc;
    gctUINT                             conAllocFail;
    gctUINT32                           conAllocTime;
    gctUINT                             virtAllocSucc;
    gctUINT                             virtAllocFail;
    gctUINT32                           virtAllocTime;
    gctUINT                             ionAllocSucc;
    gctUINT                             ionAllocFail;
    gctUINT32                           ionAllocTime;
    gctUINT                             resAllocSucc;
    gctUINT                             resAllocFail;
    gctUINT32                           resAllocTime;
    ...
    gcsDATABASE_RECORD_PTR_PTR          htable;
#if gcdSECURE_USER
    /* Secure cache. */
...
#define gcdPROFILE_NODES_NUM    1000
...
struct _gckDB
{
    ...
    gctBOOL                     isIdle[2];
    gctUINT64                   switchCount[2];
    gctUINT64                   beginTime[2];
    gctUINT64                   endTime[2];
    gctUINT64                   lastIdle[2];
    gctUINT64                   lastBusy[2];
    gctUINT64                   idleTime[2];
    gctUINT64                   lastSlowdown[2];
    gctUINT64                   lastSlowdownIdle[2];
    /* profiling data */
    gctPOINTER                  profMutex;
    gckProfNode                 profNode[gcdPROFILE_NODES_NUM];
    gckProfNode                 profNode2D[gcdPROFILE_NODES_NUM];
    gctUINT32                   lastNodeIndex[2];
};
...
typedef union _gcuVIDMEM_NODE
{
    ...
    struct _gcsVIDMEM_NODE_VIDMEM
    {
        ...
        gctCHAR                 funcName[gcdMAX_FUNC_NAME_LEN];
        gctINT                  line;
    }
    VidMem;
