...
gceSTATUS
gcoTEXTURE_SetTiling(
    IN gcoTEXTURE Texture,
    IN gceTILING Tiling
    );

#if MRVL_ENABLE_LINEAR_TEXTURE
gceSTATUS
gcoTEXTURE_SetLinearTextureAttribute(
    IN gcoTEXTURE Texture,
    IN gceTEXTURE_LINEAR_TEXTURE_ATTRIBUTE LinearTextureAttribute
    );
#endif
/******************************************************************************\
******************************* gcoSTREAM Object ******************************
