...
/*
    inlcude marvell define options
*/
#include "gc_hal_options_mrvl.h"
...
/*
    gcdPOWER_CONTROL_DELAY
        ...
        The delay in microseconds required to wait until the GPU has woke up
...
#   define gcdPOWER_CONTROL_DELAY               100
#endif
...
#       define gcdGPU_2D_TIMEOUT                30000
#   endif
#endif
