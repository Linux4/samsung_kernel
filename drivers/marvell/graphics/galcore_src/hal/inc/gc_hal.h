...
#define gckOS_AllocateNonPagedMemory(Os,InUserSpace,Bytes,Physical,Logical)\
            _gckOS_AllocateNonPagedMemory(Os,InUserSpace,Bytes,Physical,Logical,__FUNCTION__, __LINE__)
...
#define gckOS_AllocateContiguous(Os,InUserSpace,Bytes,Physical,Logical)\
            _gckOS_AllocateContiguous(Os,InUserSpace,Bytes,Physical,Logical,__FUNCTION__, __LINE__)
