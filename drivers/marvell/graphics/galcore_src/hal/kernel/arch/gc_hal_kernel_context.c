...
#define _ENABLE(reg, field)                                                    \
    do                                                                         \
    {                                                                          \
	if (((((gctUINT32) (data)) >> (0 ? reg_MASK_ ## field) & ((gctUINT32) ((((1 ? reg_MASK_ ## field) - (0 ? reg_MASK_ ## field) + 1) == 32) ? ~0 : (~(~0 << ((1 ? reg_MASK_ ## field) - (0 ? reg_MASK_ ## field) + 1)))))) == (reg_MASK_ ## field_ENABLED & ((gctUINT32) ((((1 ? reg_MASK_ ## field) - (0 ? reg_MASK_ ## field) + 1) == 32) ? ~0 : (~(~0 << ((1 ? reg_MASK_ ## field) - (0 ? reg_MASK_ ## field) + 1))))))))           \
	        {                                                                      \
	enable |= ((((gctUINT32)(((gctUINT32) ((((1 ? reg_field) - (0 ? reg_field) + 1) == 32) ? ~0 : (~(~0 << ((1 ? reg_field) - (0 ? reg_field) + 1))))))) << (0 ? reg_field)));                                \
	        }                                                                      \
    }                                                                          \
    while (gcvFALSE)
    ...
    )
{
    ...
    if (needCopy && (Context->recordArrayMap == gcvNULL))
    {
        ...
        gcmkONERROR(gckOS_Allocate(
            Context->os,
            gcmSIZEOF(struct _gcsRECORD_ARRAY_MAP) * gcdCONTEXT_BUFFER_COUNT,
...
#if gcmIS_DEBUG(gcdDEBUG_CODE) && gcdENABLE_3D
...
OnError:
    ...
    {
        /* Free record array. */
        for(i = 0; i < allocateCount - 1; i++)
        {
            recordArrayMap = &Context->recordArrayMap[i];
            gcmkVERIFY_OK(gcmkOS_SAFE_FREE(Context->os, recordArrayMap->kData));
        }
        gcmkVERIFY_OK(gcmkOS_SAFE_FREE(Context->os, Context->recordArrayMap));
    }
