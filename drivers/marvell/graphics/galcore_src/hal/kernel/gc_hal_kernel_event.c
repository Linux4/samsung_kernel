    ...
    )
{
    ...
    if (Event->kernel->recovery == 0)
    {
        ...
        if (intrAcknowledge != 0)
        {
            gctUINT32 intrEnbl;
            void __iomem * vir_addr;
            gctUINT32 value_rigster;
            ...
            gcmkPRINT("  INTR_ENABLE=0x%x", intrEnbl);

            vir_addr = ioremap(0xd1df9200, 0x10);
            value_rigster = readl(vir_addr);
            gcmkPRINT("  0xd1df9200=0x%x", value_rigster);
            vir_addr = ioremap(0xd1df9204, 0x10);
            value_rigster = readl(vir_addr);
            gcmkPRINT("  0xd1df9204=0x%x", value_rigster);
            vir_addr = ioremap(0xd1df9208, 0x10);
            value_rigster = readl(vir_addr);
            gcmkPRINT("  0xd1df9208=0x%x", value_rigster);
            vir_addr = ioremap(0xd1df920c, 0x10);
            value_rigster = readl(vir_addr);
            gcmkPRINT("  0xd1df920c=0x%x", value_rigster);
            vir_addr = ioremap(0xd1df9100, 0x10);
            value_rigster = readl(vir_addr);
            gcmkPRINT("  0xd1df9100=0x%x", value_rigster);
            vir_addr = ioremap(0xd1df9104, 0x10);
            value_rigster = readl(vir_addr);
            gcmkPRINT("  0xd1df9104=0x%x", value_rigster);
            vir_addr = ioremap(0xd1df9108, 0x10);
            value_rigster = readl(vir_addr);
            gcmkPRINT("  0xd1df9108=0x%x", value_rigster);
            vir_addr = ioremap(0xd1df910c, 0x10);
            value_rigster = readl(vir_addr);
            gcmkPRINT("  0xd1df910c=0x%x", value_rigster);
            vir_addr = ioremap(0xd4282200, 0x10);
            value_rigster = readl(vir_addr);
            gcmkPRINT("  0xd4282200=0x%x", value_rigster);
            vir_addr = ioremap(0xd4282204, 0x10);
            value_rigster = readl(vir_addr);
            gcmkPRINT("  0xd4282204=0x%x", value_rigster);
            vir_addr = ioremap(0xd4282208, 0x10);
            value_rigster = readl(vir_addr);
            gcmkPRINT("  0xd4282208=0x%x", value_rigster);
        }
    }
#endif
