...
Retry_selftest:
        ...
        pr_info("[SSP] %s: self test srdiff_X = %+8d.%06d, srdiff_Y = %+8d.%06d, srdiff_Z = %+8d.%06d\n", __func__, (int) (srdiff_X * 100) / 1024, (int) (srdiff_X * 100) % 1024,
                (int) (srdiff_Y * 100) / 1024, (int) (srdiff_Y * 100) % 1024, (int) (srdiff_Z * 100) / 1024, (int) (srdiff_Z * 100) % 1024);

        /* read 12bytes set/reset sum data*/
        srsum_X = (int) ((buf_selftest[16] << 24) + (buf_selftest[15] << 16) + (buf_selftest[14] << 8) + buf_selftest[13]);
        srsum_Y = (int) ((buf_selftest[20] << 24) + (buf_selftest[19] << 16) + (buf_selftest[18] << 8) + buf_selftest[17]);
        srsum_Z = (int) ((buf_selftest[24] << 24) + (buf_selftest[23] << 16) + (buf_selftest[22] << 8) + buf_selftest[21]);

        pr_info("[SSP] %s: self test srsum_X = %+8d.%06d, srsum_Y = %+8d.%06d, srsum_Z = %+8d.%06d\n", __func__, (int) (srsum_X * 100) / 1024, (int) (srsum_X * 100) % 1024,
                (int) (srsum_Y * 100) / 1024, (int) (srsum_Y * 100) % 1024, (int) (srsum_Z * 100) / 1024, (int) (srsum_Z * 100) % 1024);
        ...
        pr_info("[SSP] %s: self test ref_X = %+8d.%06d, ref_Y = %+8d.%06d, ref_Z = %+8d.%06d\n", __func__, (int) (ref_X * 100) / 1024, (int) (ref_X * 100) % 1024, (int) (ref_Y * 100) / 1024,
                (int) (ref_Y * 100) % 1024, (int) (ref_Z * 100) / 1024, (int) (ref_Z * 100) % 1024);
        ...
        if (buf_selftest[0] == 0) {
                ...
                pr_err("[SSP] %s: self test fail %d", __func__, buf_selftest[0]/*Selftest result*/);
        }
...
exit:
        ...
        ret = sprintf(buf, "%d,%d,%d,%d,%d,%d,%d,%d,%d,%d\n", result[0], result[1], ratio_X, ratio_Y, ratio_Z, result[2], result[3], iADC_X, iADC_Y, iADC_Z);
