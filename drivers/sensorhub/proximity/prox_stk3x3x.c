 ...
 */
ssize_t set_proximity_stk3x3x_avg_raw_data(struct ssp_data *data, const char *buf)
{
        char chTempbuf[8] = { 0, };
        int ret;
        int64_t dEnable;
...
struct proximity_sensor_operations* get_proximity_stk3x3x_function_pointer(struct ssp_data *data)
{
