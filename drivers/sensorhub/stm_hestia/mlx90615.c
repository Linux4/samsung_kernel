...
static void mlx90615_work_func(struct work_struct *work)
{
	...
	mlx90615->ambient_temp = total_a / 5;
	mlx90615->object_temp = total_o / 5;
#else

	mlx90615->ambient_temp = ambient;
	mlx90615->object_temp = object;
