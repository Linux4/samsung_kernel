...
ssize_t get_gyro_icm42632m_name(char *buf)
{
        return sprintf(buf, "%s\n", "ICM42632M");
}

ssize_t get_gyro_icm42632m_vendor(char *buf)
{
        return sprintf(buf, "%s\n", "TDK");
}

ssize_t get_gyro_icm42632m_power_off(char *buf)
{
        ssp_infof();
...
ssize_t get_gyro_icm42632m_power_on(char *buf)
{
        ssp_infof();
...
ssize_t get_gyro_icm42632m_temperature(struct ssp_data *data, char *buf)
{
        char *buffer = NULL;
        int buffer_length = 0;
...
u32 icm42632m_selftest_sqrt(u32 sqsum)
{
        u32 sq_rt;
        u32 g0, g1, g2, g3, g4;
        u32 seed;
...
ssize_t get_gyro_icm42632m_selftest(struct ssp_data *data, char *buf)
{
        char *temp_buf = NULL;
...
struct gyroscope_sensor_operations gyro_icm42632m_ops = {
        .get_gyro_name = get_gyro_icm42632m_name,
        .get_gyro_vendor = get_gyro_icm42632m_vendor,
        .get_gyro_power_off = get_gyro_icm42632m_power_off,
        .get_gyro_power_on = get_gyro_icm42632m_power_on,
        .get_gyro_temperature = get_gyro_icm42632m_temperature,
        .get_gyro_selftest = get_gyro_icm42632m_selftest,
};

struct gyroscope_sensor_operations* get_gyroscope_icm42632m_function_pointer(struct ssp_data *data)
{
