...
#else
#define BL_FW_NAME                      "ssp_stmf410_a2018.fw"
#define BL_UMS_FW_NAME                  "ssp_stmf410_a2018.bin"
#endif
...
#define WR_UNPROT_COMMAND       0x73  /* Write unprotect command */
#define RO_UNPROT_COMMAND       0x92  /* Readout unprotect command */
...
#define XOR_WR_UNPROT_COMMAND   0x8C  /* Write unprotect command */
#define XOR_RO_UNPROT_COMMAND   0x6D  /* Readout unprotect command */
