...
#include "ssp_data.h"
#ifndef CONFIG_SSP_SENSOR_HUB_MTK
#include "ssp_firmware_version.h"
#endif
/*************************************************************************/
/* factory Sysfs                                                         */
/*************************************************************************/
#ifdef CONFIG_SSP_SENSOR_HUB_MTK
#define MODEL_NAME      "CHUB_MT6853"
#else
...
exit:
	...
	return sprintf(buf, "%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%u,%u,%u,%u,%u,%u,%u,0,0,0,0,%d,%d\n",
		       fsb[SENSOR_TYPE_ACCELEROMETER].x, fsb[SENSOR_TYPE_ACCELEROMETER].y,
		       fsb[SENSOR_TYPE_ACCELEROMETER].z, fsb[SENSOR_TYPE_GYROSCOPE].x,
		       fsb[SENSOR_TYPE_GYROSCOPE].y, fsb[SENSOR_TYPE_GYROSCOPE].z,
		       fsb[SENSOR_TYPE_GEOMAGNETIC_FIELD].cal_x,
