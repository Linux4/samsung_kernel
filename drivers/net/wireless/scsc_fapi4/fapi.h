...
#define FAPI_CONTROL_SAP_VERSION                 0x0d02
#define FAPI_TEST_SAP_VERSION                    0x0d02
#define FAPI_DEBUG_SAP_VERSION                   0x0d02
...
#define FAPI_SCANTYPE_FIRST_ILLEGAL                 0x0011
...
#define TEST_SPARE_SIGNAL_1_REQ               0x901a
#define TEST_SPARE_SIGNAL_2_REQ               0x901b
#define TEST_SPARE_SIGNAL_3_REQ               0x901c
...
#define TEST_SPARE_SIGNAL_1_CFM               0x9112
#define TEST_SPARE_SIGNAL_2_CFM               0x9113
#define TEST_SPARE_SIGNAL_3_CFM               0x9114
...
#define TEST_SPARE_SIGNAL_1_IND               0x9304
#define TEST_SPARE_SIGNAL_2_IND               0x9305
#define TEST_SPARE_SIGNAL_3_IND               0x9306
...
struct fapi_signal {
	...
	union {
		...
		struct {
			...
			__le32 spare_3;
			u8     dr[0];
		} __packed mlme_set_cckm_keys_req;
		struct {
			__le16 vif;
			__le32 spare_1;
			__le32 spare_2;
		...
		struct {
			...
			__le32 spare_3;
			u8     dr[0];
		} __packed mlme_blockack_control_req;
		struct {
			__le16 vif;
			u8     peer_sta_address[ETH_ALEN];
			__le16 tdls_action;
		...
		struct {
			...
			__le32 spare_3;
			u8     dr[0];
		} __packed mlme_set_cckm_keys_cfm;
		struct {
			__le16 vif;
			__le16 result_code;
			__le32 spare_1;
		...
		struct {
			...
			__le32 spare_3;
			u8     dr[0];
		} __packed mlme_blockack_control_cfm;
		struct {
			__le16 vif;
			__le16 result_code;
			__le32 spare_1;
		...
		struct {
			...
			__le32 spare_3;
			u8     dr[0];
		} __packed mlme_rmc_leader_selected_ind;
		struct {
			__le16 vif;
			u8     peer_sta_address[ETH_ALEN];
			__le16 peer_index;
