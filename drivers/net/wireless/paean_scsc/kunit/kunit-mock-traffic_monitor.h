...
#define slsi_traffic_mon_event_tx(args...)		kunit_mock_slsi_traffic_mon_event_tx(args)
...
#define slsi_traffic_mon_event_rx
...
static void kunit_mock_slsi_traffic_mon_event_tx(struct slsi_dev *sdev, struct net_device *dev, u32 len)
{
	return;
}
