 ...
 *
 * $Id: wl_cfgp2p.c 842666 2019-09-24 07:53:05Z $
 *
 */
#include <typedefs.h>
#include <linuxver.h>
...
#if defined(WL_DISABLE_HE_P2P)
	if ((bssidx = wl_get_bssidx_by_wdev(cfg, dev->ieee80211_ptr)) < 0) {
		WL_ERR(("Find index failed\n"));
		return BCME_ERROR;
	}
	WL_DBG(("Disabling back HE for P2P\n"));
	wl_cfg80211_set_he_mode(dev, cfg, bssidx, WL_IF_TYPE_P2P_DISC, FALSE);
#endif /* WL_DISABLE_HE_P2P */
...
#if defined(WL_DISABLE_HE_P2P)
	WL_DBG(("Enabling back HE for P2P\n"));
	wl_cfg80211_set_he_mode(dev, cfg, bssidx, WL_IF_TYPE_P2P_DISC, TRUE);
#endif /* WL_DISABLE_HE_P2P */
