...
#define QWLAN_VERSION_EXTRA            "H-HS200612A"
#elif defined(QCA_WIFI_QCA6490) // Hastings Prime
#define QWLAN_VERSION_EXTRA            "H-HP200612A"
#else
#define QWLAN_VERSION_EXTRA            "H-QCOM"
#endif 
#define QWLAN_VERSION_BUILD            2

#if defined(QCA_WIFI_QCA6390) //Hastings
#define QWLAN_VERSIONSTR               "5.2.022.2H-HS200612A"
#elif defined(QCA_WIFI_QCA6490) // Hastings Prime
#define QWLAN_VERSIONSTR               "5.2.022.2H-HP200612A"
#else
#define QWLAN_VERSIONSTR               "5.2.022.2H-QCOM"
#endif
