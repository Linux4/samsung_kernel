...
// for file operation compatibility
	...
	// kernel has enable the corresponding API
		...
		#error "*Error, KERNEL does not enable the CONFIG_FW_LOADER(_MODULE) for DHD_LINUX_STD_FW_API!"
		...
		#error "*Error, Makefile should pick up either 'DHD_LINUX_STD_FW_API' or 'DHD_SUPPORT_VFS_CALL'!"
...
#else
static inline int dhd_read_macaddr_from_file(dhd_pub_t *dhdp, struct ether_addr *dest_mac) { return 0; }
