...
struct sec_battery_platform_data {
	...
	/* 
	 * AFC 1.0 : 
	 *	15W TA :  (9v x 1.67A) / (5v x 2A) .
	 *	25W TA :  (12v x 2.1A) / (9v x 1.67A) / (5v x 2A) .
	 */
	...
	/* AFC 2.0 : 18W TA :  (9v/8v/7v/6v/5v) x 1.95A */
	int chg_18w_high_temp;
	int chg_18w_high_temp_recovery;
	int chg_18w_high_temp_size;
	int *chg_18w_high_temp_input_voltage;
	int *chg_18w_high_temp_fast_charging_current;
...
#define is_hv_afc_wire_type(cable_type) ( \
	...
	cable_type == POWER_SUPPLY_TYPE_HV_MAINS_18W || \
