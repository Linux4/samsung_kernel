	...
	case POWER_SUPPLY_PROP_CHARGING_ENABLED:
		...
		if (buck_state) {
			...
			if (!sm5705_charger_check_oper_otg_mode_on()) {
				...
				sm5705_update_reg(charger->i2c, SM5705_REG_CNTL, SM5705_CHARGER_OP_MODE_WPC_OTG_CHG_ON, 0x07);
				pr_info("update op_mode : SM5705_CHARGER_OP_MODE_WPC_OTG_CHG_ON\n");
			} else {
				sm5705_update_reg(charger->i2c, SM5705_REG_CNTL, SM5705_CHARGER_OP_MODE_USB_OTG, 0x07);
				pr_info("update op_mode : SM5705_CHARGER_OP_MODE_USB_OTG\n");
			}
		} else {
