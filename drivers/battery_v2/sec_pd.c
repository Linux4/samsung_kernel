...
void (*fp_change_thermal_source_cap)(int enable, int max_cur);
#endif
...
#if defined(CONFIG_SUPPORT_9V_D2D_CHARGING)
void change_thermal_source_cap(int enable, int max_cur)
{
	if (fp_change_thermal_source_cap)
		fp_change_thermal_source_cap(enable, max_cur);
}
#endif
