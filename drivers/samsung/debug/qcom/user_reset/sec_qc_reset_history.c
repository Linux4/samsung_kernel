...
static const struct file_operations reset_history_fops = {
	.owner = THIS_MODULE,
	.open = sec_qc_reset_history_proc_open,
	.read = sec_qc_reset_history_proc_read,
	.llseek = sec_qc_reset_history_proc_lseek,
	.release = sec_qc_reset_history_proc_release,
};
...
int __qc_reset_history_init(struct builder *bd)
{
	...
	reset_history->proc = proc_create_data(node_name, 0440, NULL,
			&reset_history_fops, reset_history);
