...
static const struct file_operations auto_comment_fops = {
	.owner = THIS_MODULE,
	.open = sec_qc_auto_comment_proc_open,
	.read = sec_qc_auto_comment_proc_read,
	.llseek = sec_qc_auto_comment_proc_lseek,
	.release = sec_qc_auto_comment_proc_release,
};
...
int __qc_auto_comment_init(struct builder *bd)
{
	...
	auto_comment->proc = proc_create_data(node_name, 0440, NULL,
			&auto_comment_fops, auto_comment);
