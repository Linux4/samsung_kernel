...
static const struct file_operations reset_tzlog_fops = {
	.owner = THIS_MODULE,
	.open = sec_qc_reset_tzlog_proc_open,
	.read = sec_qc_reset_tzlog_proc_read,
	.llseek = sec_qc_reset_tzlog_proc_lseek,
	.release = sec_qc_reset_tzlog_proc_release,
};
