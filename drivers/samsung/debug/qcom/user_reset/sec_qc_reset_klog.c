...
static const struct file_operations reset_klog_fops = {
	.owner = THIS_MODULE,
	.open = sec_qc_reset_klog_proc_open,
	.read = sec_qc_reset_klog_proc_read,
	.llseek = sec_qc_reset_klog_proc_lseek,
	.release = sec_qc_reset_klog_proc_release,
};
