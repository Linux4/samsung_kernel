...
static const struct file_operations reset_summary_fops = {
	.owner = THIS_MODULE,
	.open = sec_qc_reset_summary_proc_open,
	.read = sec_qc_reset_summary_proc_read,
	.llseek = sec_qc_reset_summary_proc_lseek,
	.release = sec_qc_reset_summary_proc_release,
};
...
int __qc_reset_summary_init(struct builder *bd)
{
	...
	reset_summary->proc = proc_create_data(node_name, 0440, NULL,
			&reset_summary_fops, reset_summary);
