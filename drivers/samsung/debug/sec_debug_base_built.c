...
#else
static inline void secdbg_base_built_set_task_in_sys_reboot(struct task_struct *task) { }
static inline void secdbg_base_built_set_task_in_sys_shutdown(struct task_struct *task) { }
