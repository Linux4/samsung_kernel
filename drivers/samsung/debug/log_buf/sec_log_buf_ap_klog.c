...
static const struct file_operations ap_klog_fops = {
	.owner = THIS_MODULE,
	.open = sec_ap_klog_open,
	.read = sec_ap_klog_read,
	.llseek = sec_ap_klog_lseek,
	.release = sec_ap_klog_release,
};
