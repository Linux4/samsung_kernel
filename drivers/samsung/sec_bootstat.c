...
{
	seq_printf(m, "%-50s %6u %6u %6d %4d %4d L%d%d%d%d B%d%d%d%d %2d %2d %2d\n",
...
static int sec_boot_stat_proc_show(struct seq_file *m, void *v)
{
	...
	seq_puts(m, "boot event                                           time  ktime  delta f_c0 f_c1 online_mask  C0  C1  G\n");
	seq_puts(m, "----------------------------------------------------------------------------------------------------------------------\n");
