...
/* light sensor calibrate min value is 1lux */
#define LIGHT_SENSOR_MIN_VALUE  1
/* light sensor calibrate max value is 52000lux */
...
//+++bug696976,fanwenming.wt,modify,20220118, modify acc cali threshold to 0.4G
#define ACC_MAX_X_Y_BIAS_VALUE 39200 /* units: (1/10000) m/s^2 */
#define ACC_MAX_Z_BIAS_VALUE 39200 /* units: (1/10000) m/s^2 */
//---bug696976,fanwenming.wt,modify,20220118, modify acc cali threshold to 0.4G
