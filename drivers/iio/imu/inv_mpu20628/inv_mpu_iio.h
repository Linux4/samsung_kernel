...
#define MPU_INIT_GYRO_AVG_FILTER  0
#define MPU_INIT_ACCEL_AVG_FILTER 0
 ...
 *  @gyro_avg_filter: gyro averaging filter.
 *  @accel_avg_filter: accel averaging filter.
...
struct inv_chip_config_s {
	...
	u32 lpf:3;
	u32 accel_fs:2;
	u32 gyro_avg_filter:3;
	u32 accel_avg_filter:2;
	u32 accel_enable:1;
	u32 gyro_enable:1;
