...
#define MPU_MIN_G_OFFSET_VALUE     -32768
...
#define PEDO_INIT_STEP_THRESHOLD	5
#define PEDO_PEAK_THRESHOLD		1174405

#define INV_REACTIVE_ALERT_THRESHOLD 0x0B

struct inv_mpu_state;

typedef enum
{
	INV_ERR_FUNC_RETURN = -4,
	INV_ERR_MPU_REG = -3,
	INV_ERR_DMP_REG = -2,
	INV_ERROR = -1,
	INV_SUCCESS = 0,
...
struct inv_ped {
	...
	u64 last_step_time;
	u16 step_thresh;
	u32 step_peak_thresh;
	u16 step_thresh_time;
	u16 int_thresh;
	bool int_on;
	bool on;
};
