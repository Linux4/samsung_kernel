...
struct registered_abc_event_struct abc_event_list[] = {
	...
	{"battery", "dc_i2c_fail", "it", true, true},
	{"battery", "over_voltage", "it", true, true},
	{"battery", "pd_input_ocp", "it", true, true},
	{"battery", "safety_timer", "it", true, true},
	{"battery", "pp_open", "it", true, true},
	{"battery", "lim_stuck", "it", true, true},
	{"battery", "vsys_ovp", "it", true, true},
	{"battery", "dc_current", "it", true, true},
	{"battery", "store_fg_asoc0", "it", true, true},
	{"battery", "show_fg_asoc0", "it", true, true},
	...
	{"pmic", "s2dos05_bulk_read", "it", true, true},
	{"pmic", "s2dos05_bulk_write", "it", true, true},
	{"pmic", "s2dos05_read_reg", "it", true, true},
	{"pmic", "s2dos05_read_word", "it", true, true},
	{"pmic", "s2dos05_update_reg", "it", true, true},
	{"pmic", "s2dos05_write_reg", "it", true, true},
	{"pmic", "s2dos05_bulk_read_fail", "it", true, true},
	{"pmic", "s2dos05_bulk_write_fail", "it", true, true},
	{"pmic", "s2dos05_read_reg_fail", "it", true, true},
	{"pmic", "s2dos05_read_word_fail", "it", true, true},
	{"pmic", "s2dos05_update_reg_fail", "it", true, true},
	{"pmic", "s2dos05_write_reg_fail", "it", true, true},
	{"pmic", "s2dos05_scp", "", true, true},
	{"pmic", "s2dos05_ssd", "", true, true},
	{"storage", "mmc_hwreset_err", "", true, true},
	{"storage", "sd_removed_err", "", true, true},
	{"storage", "ufs_hwreset_err", "it", true, true},
	{"storage", "ufs_medium_err", "it", true, true},
	{"tsp", "tsp_int_fault", "", true, false},
	{"tsp_sub", "tsp_int_fault", "", true, false},
	{"ub_main", "ub_disconnected", "it", true, true},
	{"ub_sub", "ub_disconnected", "it", true, true},
