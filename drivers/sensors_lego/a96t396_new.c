...
static void enter_unknown_mode(struct a96t396_data *data, int type);
...
static void a96t396_firmware_work_func(struct work_struct *work)
{
	...
	if (next_idx < GRIP_MAX_CNT &&\
		...
		GRIP_INFO("schedule %d fw download\n", next_idx);
