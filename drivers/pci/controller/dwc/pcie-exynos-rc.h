...
#define PCIE_PHY_CONTROL_MASK1		(0x1 << 5)
#define PCIE_PHY_CONTROL_MASK2		(0x3 << 0)
...
#define PCIE_LINK_L1SS_CAP		0x164
#define PCIE_LINK_L1SS_CAP_GEN2		0x154
#define PCIE_LINK_L1SS_CONTROL		0x168
#define PCIE_LINK_L1SS_CONTROL_GEN2	0x158
...
#define PCIE_LINK_L1SS_CONTROL2_GEN2	0x15c
...
#define PORT_LINK_TPOWERON_170US	(0x89 << 0)
#define PORT_LINK_TPOWERON_180US	(0x91 << 0)
...
#define PORT_LINK_L12_ENABLE		(0x5 << 0) // !!!~~~ need update
...
#define PCIE_AUX_CLK_FREQ_38MHZ		0x26
...
/* exynos9925, HSI1 */
#define PCIE_SYSREG_HSI1_SHARABILITY_CTRL	0x0
