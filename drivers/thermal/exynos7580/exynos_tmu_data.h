...
extern struct exynos_tmu_init_data const exynos7580_default_tmu_data_v1;
#define EXYNOS7580_TMU_DRV_DATA (&exynos7580_default_tmu_data)
#define EXYNOS7580_TMU_DRV_DATA_V1 (&exynos7580_default_tmu_data_v1)
#else
#define EXYNOS7580_TMU_DRV_DATA (NULL)
#define EXYNOS7580_TMU_DRV_DATA_V1 (NULL)
#endif
