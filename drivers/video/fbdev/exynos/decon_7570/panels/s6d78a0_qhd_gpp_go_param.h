...
static const unsigned char SEQ_SOURCE_CTL[] = {
	0xF6,
...
static const unsigned char SEQ_MIPI_RECOVER[] = {
	0xE2,
	0xED, 0xC7, 0x23
};

static const unsigned char SEQ_GOA_OUTPUT[] = {
	0xF7,
