...
#include "td4100_j3y17_param.h"
#include "td4100_j3y17_param_old.h"
#include "dd.h"

#if defined(CONFIG_EXYNOS_DECON_MDNIE)
#include "mdnie.h"
#include "mdnie_lite_table_j3y17.h"
#endif
...
try_read:
	...
	dev_info(&lcd->ld->dev, "%s: %2d(%2d), %02x, %*ph%s\n", __func__, size, rx_size, addr,
		(rx_size > 5) ? 5 : rx_size, buf, (rx_size > 5) ? "..." : "");
	if (rx_size != size) {
		if (--retry)
			goto try_read;
		else {
...
static int isl98611_array_write(struct i2c_client *client, u8 *ptr, u8 len)
{
	unsigned int i = 0;
	int ret = 0;
...
static int td4100_init(struct lcd_info *lcd)
{
	...
	if (lcd->dsim->lcd_info.rev >= 2) { /* LTPS 2nd 4B/62/20 for rev 02 */
		dev_info(&lcd->ld->dev, "%s: [panel] : LTPS 2nd panel\n", __func__);
		...
		DSI_WRITE(SEQ_TD4100_B8, ARRAY_SIZE(SEQ_TD4100_B8));
		DSI_WRITE(SEQ_TD4100_B9, ARRAY_SIZE(SEQ_TD4100_B9));
		...
		DSI_WRITE(SEQ_TD4100_D6_C1, ARRAY_SIZE(SEQ_TD4100_D6_C1));
...
/******************** FOR OLD PANELS *********************/
	} else if (lcd->id_info.id[0] == 0x0b) { /* a-Si 0B/60/20 for rev 01 */
		dev_info(&lcd->ld->dev, "%s: [panel] : bring up a-Si panel\n", __func__);
		DSI_WRITE(SEQ_TD4100_OLD_B0, ARRAY_SIZE(SEQ_TD4100_OLD_B0));
		DSI_WRITE(SEQ_TD4100_OLD_B3, ARRAY_SIZE(SEQ_TD4100_OLD_B3));
		DSI_WRITE(SEQ_TD4100_OLD_B6, ARRAY_SIZE(SEQ_TD4100_OLD_B6));
		DSI_WRITE(SEQ_TD4100_OLD_BA, ARRAY_SIZE(SEQ_TD4100_OLD_BA));
		DSI_WRITE(SEQ_TD4100_OLD_BB, ARRAY_SIZE(SEQ_TD4100_OLD_BB));
		DSI_WRITE(SEQ_TD4100_OLD_BC, ARRAY_SIZE(SEQ_TD4100_OLD_BC));
		DSI_WRITE(SEQ_TD4100_OLD_BD, ARRAY_SIZE(SEQ_TD4100_OLD_BD));
		DSI_WRITE(SEQ_TD4100_OLD_BE, ARRAY_SIZE(SEQ_TD4100_OLD_BE));
		DSI_WRITE(SEQ_TD4100_OLD_C0, ARRAY_SIZE(SEQ_TD4100_OLD_C0));
		DSI_WRITE(SEQ_TD4100_OLD_C1, ARRAY_SIZE(SEQ_TD4100_OLD_C1));
		DSI_WRITE(SEQ_TD4100_OLD_C2, ARRAY_SIZE(SEQ_TD4100_OLD_C2));
		DSI_WRITE(SEQ_TD4100_OLD_C3, ARRAY_SIZE(SEQ_TD4100_OLD_C3));
		DSI_WRITE(SEQ_TD4100_OLD_C4, ARRAY_SIZE(SEQ_TD4100_OLD_C4));
		DSI_WRITE(SEQ_TD4100_OLD_C5, ARRAY_SIZE(SEQ_TD4100_OLD_C5));
		DSI_WRITE(SEQ_TD4100_OLD_C6, ARRAY_SIZE(SEQ_TD4100_OLD_C6));
		DSI_WRITE(SEQ_TD4100_OLD_C7, ARRAY_SIZE(SEQ_TD4100_OLD_C7));
		DSI_WRITE(SEQ_TD4100_OLD_C8, ARRAY_SIZE(SEQ_TD4100_OLD_C8));
		DSI_WRITE(SEQ_TD4100_OLD_C9, ARRAY_SIZE(SEQ_TD4100_OLD_C9));
		DSI_WRITE(SEQ_TD4100_OLD_CA, ARRAY_SIZE(SEQ_TD4100_OLD_CA));
		DSI_WRITE(SEQ_TD4100_OLD_CC, ARRAY_SIZE(SEQ_TD4100_OLD_CC));
		DSI_WRITE(SEQ_TD4100_OLD_CD, ARRAY_SIZE(SEQ_TD4100_OLD_CD));
		DSI_WRITE(SEQ_TD4100_OLD_CE, ARRAY_SIZE(SEQ_TD4100_OLD_CE));
		DSI_WRITE(SEQ_TD4100_OLD_CF, ARRAY_SIZE(SEQ_TD4100_OLD_CF));
		DSI_WRITE(SEQ_TD4100_OLD_D0, ARRAY_SIZE(SEQ_TD4100_OLD_D0));
		DSI_WRITE(SEQ_TD4100_OLD_D1, ARRAY_SIZE(SEQ_TD4100_OLD_D1));
		DSI_WRITE(SEQ_TD4100_OLD_D3, ARRAY_SIZE(SEQ_TD4100_OLD_D3));
		DSI_WRITE(SEQ_TD4100_OLD_D4, ARRAY_SIZE(SEQ_TD4100_OLD_D4));
		DSI_WRITE(SEQ_TD4100_OLD_D6_01, ARRAY_SIZE(SEQ_TD4100_OLD_D6_01));
		DSI_WRITE(SEQ_TD4100_OLD_D7, ARRAY_SIZE(SEQ_TD4100_OLD_D7));
		DSI_WRITE(SEQ_TD4100_OLD_D8, ARRAY_SIZE(SEQ_TD4100_OLD_D8));
		DSI_WRITE(SEQ_TD4100_OLD_DD, ARRAY_SIZE(SEQ_TD4100_OLD_DD));
		DSI_WRITE(SEQ_TD4100_OLD_DE, ARRAY_SIZE(SEQ_TD4100_OLD_DE));
	} else { /* LTPS 1st 4B/62/20 for rev 00, 01 */
		dev_info(&lcd->ld->dev, "%s: [panel] : LTPS 1st panel\n", __func__);
		DSI_WRITE(SEQ_TD4100_OLD2_B0, ARRAY_SIZE(SEQ_TD4100_OLD2_B0));
		DSI_WRITE(SEQ_TD4100_OLD2_B3, ARRAY_SIZE(SEQ_TD4100_OLD2_B3));
		DSI_WRITE(SEQ_TD4100_OLD2_B6, ARRAY_SIZE(SEQ_TD4100_OLD2_B6));
		DSI_WRITE(SEQ_TD4100_OLD2_B8, ARRAY_SIZE(SEQ_TD4100_OLD2_B8));
		DSI_WRITE(SEQ_TD4100_OLD2_B9, ARRAY_SIZE(SEQ_TD4100_OLD2_B9));
		DSI_WRITE(SEQ_TD4100_OLD2_BA, ARRAY_SIZE(SEQ_TD4100_OLD2_BA));
		DSI_WRITE(SEQ_TD4100_OLD2_BB, ARRAY_SIZE(SEQ_TD4100_OLD2_BB));
		DSI_WRITE(SEQ_TD4100_OLD2_BC, ARRAY_SIZE(SEQ_TD4100_OLD2_BC));
		DSI_WRITE(SEQ_TD4100_OLD2_BD, ARRAY_SIZE(SEQ_TD4100_OLD2_BD));
		DSI_WRITE(SEQ_TD4100_OLD2_BE, ARRAY_SIZE(SEQ_TD4100_OLD2_BE));
		DSI_WRITE(SEQ_TD4100_OLD2_C0, ARRAY_SIZE(SEQ_TD4100_OLD2_C0));
		DSI_WRITE(SEQ_TD4100_OLD2_C1, ARRAY_SIZE(SEQ_TD4100_OLD2_C1));
		DSI_WRITE(SEQ_TD4100_OLD2_C2, ARRAY_SIZE(SEQ_TD4100_OLD2_C2));
		DSI_WRITE(SEQ_TD4100_OLD2_C3, ARRAY_SIZE(SEQ_TD4100_OLD2_C3));
		DSI_WRITE(SEQ_TD4100_OLD2_C4, ARRAY_SIZE(SEQ_TD4100_OLD2_C4));
		DSI_WRITE(SEQ_TD4100_OLD2_C5, ARRAY_SIZE(SEQ_TD4100_OLD2_C5));
		DSI_WRITE(SEQ_TD4100_OLD2_C6, ARRAY_SIZE(SEQ_TD4100_OLD2_C6));
		DSI_WRITE(SEQ_TD4100_OLD2_C7, ARRAY_SIZE(SEQ_TD4100_OLD2_C7));
		DSI_WRITE(SEQ_TD4100_OLD2_C8, ARRAY_SIZE(SEQ_TD4100_OLD2_C8));
		DSI_WRITE(SEQ_TD4100_OLD2_C9, ARRAY_SIZE(SEQ_TD4100_OLD2_C9));
		DSI_WRITE(SEQ_TD4100_OLD2_CA, ARRAY_SIZE(SEQ_TD4100_OLD2_CA));
		DSI_WRITE(SEQ_TD4100_OLD2_CC, ARRAY_SIZE(SEQ_TD4100_OLD2_CC));
		DSI_WRITE(SEQ_TD4100_OLD2_CD, ARRAY_SIZE(SEQ_TD4100_OLD2_CD));
		DSI_WRITE(SEQ_TD4100_OLD2_CE, ARRAY_SIZE(SEQ_TD4100_OLD2_CE));
		DSI_WRITE(SEQ_TD4100_OLD2_CF, ARRAY_SIZE(SEQ_TD4100_OLD2_CF));
		DSI_WRITE(SEQ_TD4100_OLD2_D0, ARRAY_SIZE(SEQ_TD4100_OLD2_D0));
		DSI_WRITE(SEQ_TD4100_OLD2_D1, ARRAY_SIZE(SEQ_TD4100_OLD2_D1));
		DSI_WRITE(SEQ_TD4100_OLD2_D3, ARRAY_SIZE(SEQ_TD4100_OLD2_D3));
		DSI_WRITE(SEQ_TD4100_OLD2_D4, ARRAY_SIZE(SEQ_TD4100_OLD2_D4));
		DSI_WRITE(SEQ_TD4100_OLD2_D6_C1, ARRAY_SIZE(SEQ_TD4100_OLD2_D6_C1));
		DSI_WRITE(SEQ_TD4100_OLD2_D7, ARRAY_SIZE(SEQ_TD4100_OLD2_D7));
		DSI_WRITE(SEQ_TD4100_OLD2_D8, ARRAY_SIZE(SEQ_TD4100_OLD2_D8));
		DSI_WRITE(SEQ_TD4100_OLD2_DD, ARRAY_SIZE(SEQ_TD4100_OLD2_DD));
		DSI_WRITE(SEQ_TD4100_OLD2_DE, ARRAY_SIZE(SEQ_TD4100_OLD2_DE));
	}

	DSI_WRITE(SEQ_TD4100_CABC_MIN, ARRAY_SIZE(SEQ_TD4100_CABC_MIN));
...
static struct i2c_device_id isl98611_i2c_id[] = {
	{"isl98611", 0},
	{},
};

MODULE_DEVICE_TABLE(i2c, isl98611_i2c_id);
...
static int td4100_probe(struct lcd_info *lcd)
{
	...
	isl98611_i2c_id->driver_data = (kernel_ulong_t)lcd;
...
static int dsim_panel_resume_early(struct dsim_device *dsim)
{
	...
	isl98611_array_write(lcd->blic_client, ISL98611_INIT, ARRAY_SIZE(ISL98611_INIT));
