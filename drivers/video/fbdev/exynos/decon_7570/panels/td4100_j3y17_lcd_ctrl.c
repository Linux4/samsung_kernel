/* linux/drivers/video/fbdev/exynos/decon_7570/panels/td4100_j3y17_lcd_ctrl.c
 *
...
static int td4100_init(struct lcd_info *lcd)
{
	...
	if(lcd->dsim->lcd_info.rev >= 2) { /* LTPS 2nd 4B/62/20 */ /* rev 02 */
...
/******************** FOR OLD PANELS *********************/
	} else if(lcd->id_info.id[0] == 0x0b) { /* a-Si 0B/60/20 */ /*rev 01 */
	...
	} else { /* LTPS 1st 4B/62/20 */ /* rev 00, 01*/
...
static void lcd_init_sysfs(struct lcd_info *lcd)
{
	...
	init_bl_curve_debugfs(lcd->bd, brightness_table, &lcd->backlight_client);
}
