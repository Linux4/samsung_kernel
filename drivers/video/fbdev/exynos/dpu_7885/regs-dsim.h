...
#ifndef _REGS_DSIM_H_
#define _REGS_DSIM_H_
...
#define DSIM_LINK_STATUS2_CLK_LANE_STATUS_GET(x)    (x >> 4 & 0x3)
...
#define DSIM_CONFIG_PIXEL_FORMAT(_x)			((_x) << 13)
#define DSIM_CONFIG_PIXEL_FORMAT_MASK			(0x3 << 13)
...
#define DSIM_PKTHDR_BTA_TYPE(_x)			(((_x) & 0xff) << 24)
#define DSIM_PKTHDR_DATA1(_x)				(((_x) & 0xff) << 16)
#define DSIM_PKTHDR_DATA0(_x)				(((_x) & 0xff) << 8)
#define DSIM_PKTHDR_ID(_x)				(((_x) & 0xff) << 0)
