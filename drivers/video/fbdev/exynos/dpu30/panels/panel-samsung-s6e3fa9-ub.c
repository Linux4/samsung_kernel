...
static int s6e3fa9ub_suspend(struct exynos_panel_device *panel)
{
	return 0;
}

static int s6e3fa9ub_displayon(struct exynos_panel_device *panel)
{
	int ret = 0;
	u8 buf[4] = {0x0, };
	...
	dsim_write_data_table(dsim, SEQ_FFC_SET);
...
static int s6e3fa9ub_mres(struct exynos_panel_device *panel, int mres_idx)
{
	return 0;
}


static int s6e3fa9ub_doze(struct exynos_panel_device *panel)
{
	return 0;
}

static int s6e3fa9ub_doze_suspend(struct exynos_panel_device *panel)
{
	return 0;
}

static int s6e3fa9ub_dump(struct exynos_panel_device *panel)
{
	return 0;
}

static int s6e3fa9ub_read_state(struct exynos_panel_device *panel)
{
	return 0;
}

struct exynos_panel_ops panel_s6e3fa9ub_ops = {
	.id		= {0x004c81, 0xffffff, 0xffffff},
	.suspend	= s6e3fa9ub_suspend,
	.displayon	= s6e3fa9ub_displayon,
	.mres		= s6e3fa9ub_mres,
	.doze		= s6e3fa9ub_doze,
	.doze_suspend	= s6e3fa9ub_doze_suspend,
	.dump		= s6e3fa9ub_dump,
	.read_state	= s6e3fa9ub_read_state,
};
