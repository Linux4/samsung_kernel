/*
 * linux/drivers/video/fbdev/exynos/panel/hx83102/hx83102_t270_panel_dimming.h
 *
...
#ifndef __HX83102_T270_PANEL_DIMMING_H___
#define __HX83102_T270_PANEL_DIMMING_H___
...
#define HX83102_NR_STEP (256)
#define HX83102_HBM_STEP (51)
#define HX83102_TOTAL_STEP (HX83102_NR_STEP + HX83102_HBM_STEP) /* 0 ~ 365 */

static unsigned int hx83102_t270_brt_tbl[HX83102_TOTAL_STEP] = {
	BRT(0),
...
static unsigned int hx83102_t270_step_cnt_tbl[HX83102_TOTAL_STEP] = {
	[0 ... 255] = 1,
	/* HBM */
	[256 ... 306] = 1,
};

struct brightness_table hx83102_t270_panel_brightness_table = {
	.brt = hx83102_t270_brt_tbl,
	.sz_brt = ARRAY_SIZE(hx83102_t270_brt_tbl),
	.sz_ui_brt = HX83102_NR_STEP,
	.sz_hbm_brt = HX83102_HBM_STEP,
	.lum = NULL,
	.sz_lum = 0,
	.sz_ui_lum = 0,
	.sz_hbm_lum = 0,
	...
	.brt_to_step = NULL,
	.sz_brt_to_step = 0,
	.step_cnt = hx83102_t270_step_cnt_tbl,
	.sz_step_cnt = ARRAY_SIZE(hx83102_t270_step_cnt_tbl),
	.vtotal = 0,
};

static struct panel_dimming_info hx83102_t270_panel_dimming_info = {
	.name = "hx83102_t270",
	.dim_init_info = {
		NULL,
	},
	...
	.brt_tbl = &hx83102_t270_panel_brightness_table,
	/* dimming parameters */
	.dimming_maptbl = NULL,
	.dim_flash_on = false,	/* read dim flash when probe or not */
};
#endif /* __HX83102_T270_PANEL_DIMMING_H___ */
