/*
 * linux/drivers/video/fbdev/exynos/panel/td4162_boe/td4162_boe_a04s_panel_dimming.h
 *
 * Header file for TD4162 Dimming Driver
 *
...
#ifndef __TD4162_A04S_PANEL_DIMMING_H___
#define __TD4162_A04S_PANEL_DIMMING_H___
...
#define TD4162_NR_STEP (256)
#define TD4162_HBM_STEP (51)
#define TD4162_TOTAL_STEP (TD4162_NR_STEP + TD4162_HBM_STEP) /* 0 ~ 365 */

static unsigned int td4162_boe_a04s_brt_tbl[TD4162_TOTAL_STEP] = {
	BRT(0),
...
static unsigned int td4162_boe_a04s_step_cnt_tbl[TD4162_TOTAL_STEP] = {
	[0 ... 255] = 1,
	/* HBM */
	[256 ... 306] = 1,
};

struct brightness_table td4162_boe_a04s_panel_brightness_table = {
	.brt = td4162_boe_a04s_brt_tbl,
	.sz_brt = ARRAY_SIZE(td4162_boe_a04s_brt_tbl),
	.sz_ui_brt = TD4162_NR_STEP,
	.sz_hbm_brt = TD4162_HBM_STEP,
	.lum = NULL,
	.sz_lum = 0,
	.sz_ui_lum = 0,
	.sz_hbm_lum = 0,
	...
	.brt_to_step = NULL,
	.sz_brt_to_step = 0,
	.step_cnt = td4162_boe_a04s_step_cnt_tbl,
	.sz_step_cnt = ARRAY_SIZE(td4162_boe_a04s_step_cnt_tbl),
	.vtotal = 0,
};

static struct panel_dimming_info td4162_boe_a04s_panel_dimming_info = {
	.name = "td4162_boe_a04s",
	.dim_init_info = {
		NULL,
	},
	.target_luminance = -1,
	...
	.brt_tbl = &td4162_boe_a04s_panel_brightness_table,
	/* dimming parameters */
	.dimming_maptbl = NULL,
	.dim_flash_on = false,	/* read dim flash when probe or not */
};
#endif /* __TD4162_A04S_PANEL_DIMMING_H___ */
