/*
 * linux/drivers/video/fbdev/exynos/panel/dummy_lcd/dummy_lcd_v320_panel_dimming.h
 *
 * Header file for DUMMY Dimming Driver
 *
...
#ifndef __DUMMY_V320_PANEL_DIMMING_H___
#define __DUMMY_V320_PANEL_DIMMING_H___
...
#define DUMMY_NR_STEP (256)
#define DUMMY_HBM_STEP (51)
#define DUMMY_TOTAL_STEP (DUMMY_NR_STEP + DUMMY_HBM_STEP) /* 0 ~ 365 */

static unsigned int dummy_lcd_v320_brt_tbl[DUMMY_TOTAL_STEP] = {
	BRT(0),
...
static unsigned int dummy_lcd_v320_step_cnt_tbl[DUMMY_TOTAL_STEP] = {
	[0 ... 255] = 1,
	/* HBM */
	[256 ... 306] = 1,
};

struct brightness_table dummy_lcd_v320_panel_brightness_table = {
	.brt = dummy_lcd_v320_brt_tbl,
	.sz_brt = ARRAY_SIZE(dummy_lcd_v320_brt_tbl),
	.sz_ui_brt = DUMMY_NR_STEP,
	.sz_hbm_brt = DUMMY_HBM_STEP,
	.lum = NULL,
	.sz_lum = 0,
	.sz_ui_lum = 0,
	.sz_hbm_lum = 0,
	...
	.brt_to_step = NULL,
	.sz_brt_to_step = 0,
	.step_cnt = dummy_lcd_v320_step_cnt_tbl,
	.sz_step_cnt = ARRAY_SIZE(dummy_lcd_v320_step_cnt_tbl),
	.vtotal = 0,
};

static struct panel_dimming_info dummy_lcd_v320_panel_dimming_info = {
	.name = "dummy_lcd_v320",
	.dim_init_info = {
		NULL,
	},
	...
	.brt_tbl = &dummy_lcd_v320_panel_brightness_table,
	/* dimming parameters */
	.dimming_maptbl = NULL,
	.dim_flash_on = false,	/* read dim flash when probe or not */
};
#endif /* __DUMMY_V320_PANEL_DIMMING_H___ */
