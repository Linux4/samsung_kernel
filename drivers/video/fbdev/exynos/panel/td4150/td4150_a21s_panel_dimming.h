/*
 * linux/drivers/video/fbdev/exynos/panel/td4150/td4150_a21s_panel_dimming.h
 *
...
#ifndef __TD4150_A21S_PANEL_DIMMING_H___
#define __TD4150_A21S_PANEL_DIMMING_H___
...
static unsigned int td4150_a21s_brt_tbl[TD4150_TOTAL_STEP] = {
	BRT(0),
...
static unsigned int td4150_a21s_step_cnt_tbl[TD4150_TOTAL_STEP] = {
	[0 ... 255] = 1,
	/* HBM */
	[256 ... 306] = 1,
};

struct brightness_table td4150_a21s_panel_brightness_table = {
	.brt = td4150_a21s_brt_tbl,
	.sz_brt = ARRAY_SIZE(td4150_a21s_brt_tbl),
	...
	.brt_to_step = NULL,
	.sz_brt_to_step = 0,
	.step_cnt = td4150_a21s_step_cnt_tbl,
	.sz_step_cnt = ARRAY_SIZE(td4150_a21s_step_cnt_tbl),
	.vtotal = 0,
};

static struct panel_dimming_info td4150_a21s_panel_dimming_info = {
	.name = "td4150_a21s",
	.dim_init_info = {
		NULL,
	},
	...
	.brt_tbl = &td4150_a21s_panel_brightness_table,
	/* dimming parameters */
	.dimming_maptbl = NULL,
	.dim_flash_on = false,	/* read dim flash when probe or not */
};
#endif /* __TD4150_A21S_PANEL_DIMMING_H___ */
