/*
 * linux/drivers/video/fbdev/exynos/panel/td4150/td4150.h
 *
...
static struct rdinfo td4150_rditbl[] = {
...
static DECLARE_RESUI(id) = {
	{.rditbl = &td4150_rditbl[READ_ID_DA], .offset = 0},
	{.rditbl = &td4150_rditbl[READ_ID_DB], .offset = 1},
	{.rditbl = &td4150_rditbl[READ_ID_DC], .offset = 2},
};

static struct resinfo td4150_restbl[] = {
