/*
 * linux/drivers/video/fbdev/exynos/panel/td4150/td4150_a21s_panel.h
 *
...
#ifndef __TD4150_A21S_PANEL_H__
#define __TD4150_A21S_PANEL_H__
#include "../panel_drv.h"
#include "td4150.h"
...
static u8 a21s_brt_table[TD4150_TOTAL_NR_LUMINANCE][1] = {
	{0},
	{2}, {2}, {3}, {3}, {4}, {4}, {5}, {6}, {6}, {7}, /* 1: 2 */
	...
	{72}, {73}, {74}, {74}, {75}, {75}, {76}, {77}, {78}, {79}, /* 128: 77 */
...
static u8 A21S_BRIGHTNESS_CABC_MIN[] = {
	0x5E,
	0x30,
};

static u8 A21S_TD4150_B0_OPEN[] = {
	0xB0, 0x04,
};

static u8 A21S_TD4150_B6[] = {
	0xB6,
	0x30, 0x64, 0x00, 0x06, 0xC3, 0x03,
};

static u8 A21S_TD4150_B7[] = {
	0xB7,
	0x11, 0x00, 0x00, 0x00,
};

static u8 A21S_TD4150_B8[] = {
	0xB8,
	0x00, 0x78, 0x64, 0x10, 0x64, 0xB4,
};

static u8 A21S_TD4150_B9[] = {
	0xB9,
	0x00, 0x78, 0x64, 0x10, 0x64, 0xB4,
};

static u8 A21S_TD4150_BA[] = {
	0xBA,
	0x07, 0x6A, 0x55, 0x0F, 0x32, 0x44,
};

static u8 A21S_TD4150_BB[] = {
	0xBB,
	0x00, 0xB4, 0xA0,
};

static u8 A21S_TD4150_BC[] = {
	0xBC,
	0x00, 0xB4, 0xA0,
};

static u8 A21S_TD4150_BD[] = {
	0xBD,
	0x00, 0xB4, 0xA0,
};

static u8 A21S_TD4150_BE[] = {
	0xBE,
	0x07, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00, 0x00, 0x00,
};

static u8 A21S_TD4150_C0[] = {
	0xC0,
...
static u8 A21S_TD4150_C5[] = {
	0xC5,
	0x08, 0x00, 0x00, 0x00, 0x00,
};

static u8 A21S_TD4150_C6[] = {
	0xC6,
...
static u8 A21S_TD4150_D2[] = {
	0xD2,
	0x0F, 0x00, 0x00,
};

static u8 A21S_TD4150_D3[] = {
	0xD3,
...
static u8 A21S_TD4150_E5[] = {
	0xE5,
	0x03, 0x00, 0x00, 0x00,
 };

static u8 A21S_TD4150_D6[] = {
	0xD6,
	0x00,
};

static u8 A21S_TD4150_D7[] = {
	0xD7,
...
static u8 A21S_TD4150_DD[] = {
	0xDD,
	0x30, 0x06, 0x23, 0x65,
};

static u8 A21S_TD4150_DE[] = {
	0xDE,
	0x00, 0x00, 0x00, 0x0F, 0xFF, 0x00, 0x00, 0x00, 0x00, 0x10,
	0x00, 0x00, 0x00, 0x00,
};

static u8 A21S_TD4150_E3[] = {
	0xE3,
	0xFF,
};

static u8 A21S_TD4150_E9[] = {
	0xE9,
...
static u8 A21S_TD4150_EB[] = {
	0xEB,
	0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x11,
};

static u8 A21S_TD4150_EC[] = {
	0xEC,
...
static u8 A21S_TD4150_B0_CLOSE[] = {
	0xB0, 0x03,
};
...
static DEFINE_STATIC_PACKET(a21s_brightness_cabc_min, DSI_PKT_TYPE_WR, A21S_BRIGHTNESS_CABC_MIN, 0);
...
static DEFINE_STATIC_PACKET(a21s_td4150_b0_open, DSI_PKT_TYPE_WR, A21S_TD4150_B0_OPEN, 0);
static DEFINE_STATIC_PACKET(a21s_td4150_b6, DSI_PKT_TYPE_WR, A21S_TD4150_B6, 0);
static DEFINE_STATIC_PACKET(a21s_td4150_b7, DSI_PKT_TYPE_WR, A21S_TD4150_B7, 0);
static DEFINE_STATIC_PACKET(a21s_td4150_b8, DSI_PKT_TYPE_WR, A21S_TD4150_B8, 0);
static DEFINE_STATIC_PACKET(a21s_td4150_b9, DSI_PKT_TYPE_WR, A21S_TD4150_B9, 0);
static DEFINE_STATIC_PACKET(a21s_td4150_ba, DSI_PKT_TYPE_WR, A21S_TD4150_BA, 0);
static DEFINE_STATIC_PACKET(a21s_td4150_bb, DSI_PKT_TYPE_WR, A21S_TD4150_BB, 0);
static DEFINE_STATIC_PACKET(a21s_td4150_bc, DSI_PKT_TYPE_WR, A21S_TD4150_BC, 0);
static DEFINE_STATIC_PACKET(a21s_td4150_bd, DSI_PKT_TYPE_WR, A21S_TD4150_BD, 0);
static DEFINE_STATIC_PACKET(a21s_td4150_be, DSI_PKT_TYPE_WR, A21S_TD4150_BE, 0);
static DEFINE_STATIC_PACKET(a21s_td4150_c0, DSI_PKT_TYPE_WR, A21S_TD4150_C0, 0);
static DEFINE_STATIC_PACKET(a21s_td4150_c1, DSI_PKT_TYPE_WR, A21S_TD4150_C1, 0);
static DEFINE_STATIC_PACKET(a21s_td4150_c2, DSI_PKT_TYPE_WR, A21S_TD4150_C2, 0);
static DEFINE_STATIC_PACKET(a21s_td4150_c3, DSI_PKT_TYPE_WR, A21S_TD4150_C3, 0);
static DEFINE_STATIC_PACKET(a21s_td4150_c4, DSI_PKT_TYPE_WR, A21S_TD4150_C4, 0);
static DEFINE_STATIC_PACKET(a21s_td4150_c5, DSI_PKT_TYPE_WR, A21S_TD4150_C5, 0);
static DEFINE_STATIC_PACKET(a21s_td4150_c6, DSI_PKT_TYPE_WR, A21S_TD4150_C6, 0);
static DEFINE_STATIC_PACKET(a21s_td4150_c7, DSI_PKT_TYPE_WR, A21S_TD4150_C7, 0);
static DEFINE_STATIC_PACKET(a21s_td4150_c8, DSI_PKT_TYPE_WR, A21S_TD4150_C8, 0);
static DEFINE_STATIC_PACKET(a21s_td4150_c9, DSI_PKT_TYPE_WR, A21S_TD4150_C9, 0);
static DEFINE_STATIC_PACKET(a21s_td4150_ca, DSI_PKT_TYPE_WR, A21S_TD4150_CA, 0);
static DEFINE_STATIC_PACKET(a21s_td4150_cb, DSI_PKT_TYPE_WR, A21S_TD4150_CB, 0);
static DEFINE_STATIC_PACKET(a21s_td4150_ce, DSI_PKT_TYPE_WR, A21S_TD4150_CE, 0);
static DEFINE_STATIC_PACKET(a21s_td4150_cf, DSI_PKT_TYPE_WR, A21S_TD4150_CF, 0);
static DEFINE_STATIC_PACKET(a21s_td4150_d0, DSI_PKT_TYPE_WR, A21S_TD4150_D0, 0);
static DEFINE_STATIC_PACKET(a21s_td4150_d1, DSI_PKT_TYPE_WR, A21S_TD4150_D1, 0);
static DEFINE_STATIC_PACKET(a21s_td4150_d2, DSI_PKT_TYPE_WR, A21S_TD4150_D2, 0);
static DEFINE_STATIC_PACKET(a21s_td4150_d3, DSI_PKT_TYPE_WR, A21S_TD4150_D3, 0);
static DEFINE_STATIC_PACKET(a21s_td4150_e5, DSI_PKT_TYPE_WR, A21S_TD4150_E5, 0);
static DEFINE_STATIC_PACKET(a21s_td4150_d6, DSI_PKT_TYPE_WR, A21S_TD4150_D6, 0);
static DEFINE_STATIC_PACKET(a21s_td4150_d7, DSI_PKT_TYPE_WR, A21S_TD4150_D7, 0);
static DEFINE_STATIC_PACKET(a21s_td4150_d9, DSI_PKT_TYPE_WR, A21S_TD4150_D9, 0);
static DEFINE_STATIC_PACKET(a21s_td4150_dd, DSI_PKT_TYPE_WR, A21S_TD4150_DD, 0);
static DEFINE_STATIC_PACKET(a21s_td4150_de, DSI_PKT_TYPE_WR, A21S_TD4150_DE, 0);
static DEFINE_STATIC_PACKET(a21s_td4150_e3, DSI_PKT_TYPE_WR, A21S_TD4150_E3, 0);
static DEFINE_STATIC_PACKET(a21s_td4150_e9, DSI_PKT_TYPE_WR, A21S_TD4150_E9, 0);
static DEFINE_STATIC_PACKET(a21s_td4150_ea, DSI_PKT_TYPE_WR, A21S_TD4150_EA, 0);
static DEFINE_STATIC_PACKET(a21s_td4150_eb, DSI_PKT_TYPE_WR, A21S_TD4150_EB, 0);
static DEFINE_STATIC_PACKET(a21s_td4150_ec, DSI_PKT_TYPE_WR, A21S_TD4150_EC, 0);
static DEFINE_STATIC_PACKET(a21s_td4150_ed, DSI_PKT_TYPE_WR, A21S_TD4150_ED, 0);
static DEFINE_STATIC_PACKET(a21s_td4150_ee, DSI_PKT_TYPE_WR, A21S_TD4150_EE, 0);
static DEFINE_STATIC_PACKET(a21s_td4150_b0_close, DSI_PKT_TYPE_WR, A21S_TD4150_B0_CLOSE, 0);

static DEFINE_PANEL_MDELAY(a21s_wait_display_off, 1 * 17);	/* 1 frame */
static DEFINE_PANEL_MDELAY(a21s_wait_sleep_in, 4 * 17);	/* 4 frame */
static DEFINE_PANEL_MDELAY(a21s_wait_sleep_out, 4 * 17);	/* 4 frame */
static DEFINE_PANEL_MDELAY(a21s_wait_blic_off, 1);


static void *a21s_init_cmdtbl[] = {
	&td4150_restbl[RES_ID],
	&PKTINFO(a21s_td4150_b0_open),
	&PKTINFO(a21s_td4150_b6),
	&PKTINFO(a21s_td4150_b7),
	&PKTINFO(a21s_td4150_b8),
	&PKTINFO(a21s_td4150_b9),
	&PKTINFO(a21s_td4150_ba),
	&PKTINFO(a21s_td4150_bb),
	&PKTINFO(a21s_td4150_bc),
	&PKTINFO(a21s_td4150_bd),
	&PKTINFO(a21s_td4150_be),
	&PKTINFO(a21s_td4150_c0),
	&PKTINFO(a21s_td4150_c1),
	&PKTINFO(a21s_td4150_c2),
	&PKTINFO(a21s_td4150_c3),
	&PKTINFO(a21s_td4150_c4),
	&PKTINFO(a21s_td4150_c5),
	&PKTINFO(a21s_td4150_c6),
	&PKTINFO(a21s_td4150_c7),
	&PKTINFO(a21s_td4150_c8),
	&PKTINFO(a21s_td4150_c9),
	&PKTINFO(a21s_td4150_ca),
	&PKTINFO(a21s_td4150_cb),
	&PKTINFO(a21s_td4150_ce),
	&PKTINFO(a21s_td4150_cf),
	&PKTINFO(a21s_td4150_d0),
	&PKTINFO(a21s_td4150_d1),
	&PKTINFO(a21s_td4150_d2),
	&PKTINFO(a21s_td4150_d3),
	&PKTINFO(a21s_td4150_e5),
	&PKTINFO(a21s_td4150_d6),
	&PKTINFO(a21s_td4150_d7),
	&PKTINFO(a21s_td4150_d9),
	&PKTINFO(a21s_td4150_dd),
	&PKTINFO(a21s_td4150_de),
	&PKTINFO(a21s_td4150_e3),
	&PKTINFO(a21s_td4150_e9),
	&PKTINFO(a21s_td4150_ea),
	&PKTINFO(a21s_td4150_eb),
	&PKTINFO(a21s_td4150_ec),
	&PKTINFO(a21s_td4150_ed),
	&PKTINFO(a21s_td4150_ee),
	&PKTINFO(a21s_td4150_b0_close),
	&PKTINFO(a21s_brightness_cabc_mode),
	&PKTINFO(a21s_brightness_cabc_min),
...
/* ================================= [EA8076 I2C TABLE] ===========+++================= */
/* ===================================================================================== */
static u8 TD4150_A21S_I2C_INIT[] = {
	0x0C, 0x2C,
	0x0D, 0x26,
	0x0E, 0x26,
	0x09, 0xBE,
...
static u8 TD4150_A21S_I2C_EXIT_VSN[] = {
	0x09, 0xBC,
};

static u8 TD4150_A21S_I2C_EXIT_VSP[] = {
	0x09, 0xB8,
};

static DEFINE_STATIC_PACKET(td4150_a21s_i2c_init, I2C_PKT_TYPE_WR, TD4150_A21S_I2C_INIT, 0);
static DEFINE_STATIC_PACKET(td4150_a21s_i2c_exit_vsn, I2C_PKT_TYPE_WR, TD4150_A21S_I2C_EXIT_VSN, 0);
static DEFINE_STATIC_PACKET(td4150_a21s_i2c_exit_vsp, I2C_PKT_TYPE_WR, TD4150_A21S_I2C_EXIT_VSP, 0);
static DEFINE_STATIC_PACKET(td4150_a21s_i2c_dump, I2C_PKT_TYPE_RD, TD4150_A21S_I2C_INIT, 0);

static void *td4150_a21s_init_cmdtbl[] = {
	&PKTINFO(td4150_a21s_i2c_init),
};

static void *td4150_a21s_exit_cmdtbl[] = {
	&PKTINFO(td4150_a21s_i2c_exit_vsn),
	&DLYINFO(a21s_wait_blic_off),
	&PKTINFO(td4150_a21s_i2c_exit_vsp),
};

static void *td4150_a21s_dump_cmdtbl[] = {
	&PKTINFO(td4150_a21s_i2c_dump),
};
...
static struct seqinfo a21s_seqtbl[MAX_PANEL_SEQ] = {
	...
	[PANEL_I2C_INIT_SEQ] = SEQINFO_INIT("i2c-init-seq", td4150_a21s_init_cmdtbl),
	[PANEL_I2C_EXIT_SEQ] = SEQINFO_INIT("i2c-exit-seq", td4150_a21s_exit_cmdtbl),
	[PANEL_I2C_DUMP_SEQ] = SEQINFO_INIT("i2c-dump-seq", td4150_a21s_dump_cmdtbl),
#endif

};

struct common_panel_info td4150_a21s_default_panel_info = {
	.ldi_name = "td4150",
	.name = "td4150_a21s_default",
	.model = "BOE_6_55_inch",
	.vendor = "BOE",
	.id = 0x8A6220,
	.rev = 0,
...
static int __init td4150_a21s_panel_init(void)
{
	register_common_panel(&td4150_a21s_default_panel_info);

	return 0;
}
arch_initcall(td4150_a21s_panel_init)
#endif /* __TD4150_A21S_PANEL_H__ */
