/*
 * linux/drivers/video/fbdev/exynos/panel/ili9882n/ili9882n_m12s_panel_dimming.h
 *
...
#ifndef __ILI9882N_M12S_PANEL_DIMMING_H___
#define __ILI9882N_M12S_PANEL_DIMMING_H___
...
#define ILI9882N_NR_STEP (256)
#define ILI9882N_HBM_STEP (51)
#define ILI9882N_TOTAL_STEP (ILI9882N_NR_STEP + ILI9882N_HBM_STEP) /* 0 ~ 365 */

static unsigned int ili9882n_m12s_brt_tbl[ILI9882N_TOTAL_STEP] = {
	BRT(0),
...
static unsigned int ili9882n_m12s_step_cnt_tbl[ILI9882N_TOTAL_STEP] = {
	[0 ... 255] = 1,
	/* HBM */
	[256 ... 306] = 1,
};

struct brightness_table ili9882n_m12s_panel_brightness_table = {
	.brt = ili9882n_m12s_brt_tbl,
	.sz_brt = ARRAY_SIZE(ili9882n_m12s_brt_tbl),
	.sz_ui_brt = ILI9882N_NR_STEP,
	.sz_hbm_brt = ILI9882N_HBM_STEP,
	.lum = NULL,
	.sz_lum = 0,
	.sz_ui_lum = 0,
	.sz_hbm_lum = 0,
	...
	.brt_to_step = NULL,
	.sz_brt_to_step = 0,
	.step_cnt = ili9882n_m12s_step_cnt_tbl,
	.sz_step_cnt = ARRAY_SIZE(ili9882n_m12s_step_cnt_tbl),
	.vtotal = 0,
};

static struct panel_dimming_info ili9882n_m12s_panel_dimming_info = {
	.name = "ili9882n_m12s",
	.dim_init_info = {
		NULL,
	},
	...
	.brt_tbl = &ili9882n_m12s_panel_brightness_table,
	/* dimming parameters */
	.dimming_maptbl = NULL,
	.dim_flash_on = false,	/* read dim flash when probe or not */
};
#endif /* __ILI9882N_M12S_PANEL_DIMMING_H___ */
