/*
 * linux/drivers/video/fbdev/exynos/panel/ili7807_boe/ili7807_boe_a14_panel_dimming.h
 *
...
#ifndef __ILI7807_A14_PANEL_DIMMING_H___
#define __ILI7807_A14_PANEL_DIMMING_H___
...
static unsigned int ili7807_boe_a14_brt_tbl[ILI7807_TOTAL_STEP] = {
	BRT(0),
...
static unsigned int ili7807_boe_a14_step_cnt_tbl[ILI7807_TOTAL_STEP] = {
	[0 ... 255] = 1,
	/* HBM */
	[256 ... 306] = 1,
};

struct brightness_table ili7807_boe_a14_panel_brightness_table = {
	.brt = ili7807_boe_a14_brt_tbl,
	.sz_brt = ARRAY_SIZE(ili7807_boe_a14_brt_tbl),
	...
	.brt_to_step = NULL,
	.sz_brt_to_step = 0,
	.step_cnt = ili7807_boe_a14_step_cnt_tbl,
	.sz_step_cnt = ARRAY_SIZE(ili7807_boe_a14_step_cnt_tbl),
	.vtotal = 0,
};

static struct panel_dimming_info ili7807_boe_a14_panel_dimming_info = {
	.name = "ili7807_boe_a14",
	.dim_init_info = {
		NULL,
	},
	.target_luminance = -1,
	...
	.brt_tbl = &ili7807_boe_a14_panel_brightness_table,
	/* dimming parameters */
	.dimming_maptbl = NULL,
	.dim_flash_on = false,	/* read dim flash when probe or not */
};
#endif /* __ILI7807_A14_PANEL_DIMMING_H___ */
