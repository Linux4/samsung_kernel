/*
 * linux/drivers/video/fbdev/exynos/panel/s6e3fa9/s6e3fa9_a71x_panel_hmd_dimming.h
 *
...
#ifndef __S6E3FA9_A71X_PANEL_HMD_DIMMING_H__
#define __S6E3FA9_A71X_PANEL_HMD_DIMMING_H__
 ...
 * PANEL : a71x
 */
#define S6E3FA9_HMD_NR_STEP (256)

static unsigned int a71x_hmd_brt_tbl[S6E3FA9_HMD_NR_STEP] = {
	BRT(0),
...
static unsigned int s6e3fa9_a71x_hmd_step_cnt_tbl[S6E3FA9_HMD_NR_STEP] = {
	[0 ... 255] = 1,
};


static struct brightness_table s6e3fa9_a71x_panel_hmd_brightness_table = {
	.brt = a71x_hmd_brt_tbl,
	.sz_brt = ARRAY_SIZE(a71x_hmd_brt_tbl),
	.sz_ui_brt = S6E3FA9_HMD_NR_STEP,
	.sz_hbm_brt = 0,
	.lum = NULL,
	.sz_lum = 0,
	.sz_ui_lum = 0,
	...
	.brt_to_step = NULL,
	.sz_brt_to_step = 0,
	.step_cnt = s6e3fa9_a71x_hmd_step_cnt_tbl,
	.sz_step_cnt = ARRAY_SIZE(s6e3fa9_a71x_hmd_step_cnt_tbl),
	.vtotal = 0,
 };

static struct panel_dimming_info s6e3fa9_a71x_panel_hmd_dimming_info = {
	.name = "s6e3fa9_a71x_hmd",
	.dim_init_info = {
		NULL,
	},
	.target_luminance = -1,
	...
	.brt_tbl = &s6e3fa9_a71x_panel_hmd_brightness_table,
	/* dimming parameters */
	.dimming_maptbl = NULL,
	.dim_flash_on = false,	/* read dim flash when probe or not */
};
#endif /* __S6E3FA9_a71x_PANEL_HMD_DIMMING_H__ */
