/*
 * linux/drivers/video/fbdev/exynos/panel/ili7806s/ili7806s_m12_panel_dimming.h
 *
...
#ifndef __ILI7806S_M12_PANEL_DIMMING_H___
#define __ILI7806S_M12_PANEL_DIMMING_H___
...
#define ILI7806S_NR_STEP (256)
#define ILI7806S_HBM_STEP (51)
#define ILI7806S_TOTAL_STEP (ILI7806S_NR_STEP + ILI7806S_HBM_STEP) /* 0 ~ 365 */

static unsigned int ili7806s_m12_brt_tbl[ILI7806S_TOTAL_STEP] = {
	BRT(0),
...
static unsigned int ili7806s_m12_step_cnt_tbl[ILI7806S_TOTAL_STEP] = {
	[0 ... 255] = 1,
	/* HBM */
	[256 ... 306] = 1,
};

struct brightness_table ili7806s_m12_panel_brightness_table = {
	.brt = ili7806s_m12_brt_tbl,
	.sz_brt = ARRAY_SIZE(ili7806s_m12_brt_tbl),
	.sz_ui_brt = ILI7806S_NR_STEP,
	.sz_hbm_brt = ILI7806S_HBM_STEP,
	.lum = NULL,
	.sz_lum = 0,
	.sz_ui_lum = 0,
	.sz_hbm_lum = 0,
	...
	.brt_to_step = NULL,
	.sz_brt_to_step = 0,
	.step_cnt = ili7806s_m12_step_cnt_tbl,
	.sz_step_cnt = ARRAY_SIZE(ili7806s_m12_step_cnt_tbl),
	.vtotal = 0,
};

static struct panel_dimming_info ili7806s_m12_panel_dimming_info = {
	.name = "ili7806s_m12",
	.dim_init_info = {
		NULL,
	},
	...
	.brt_tbl = &ili7806s_m12_panel_brightness_table,
	/* dimming parameters */
	.dimming_maptbl = NULL,
	.dim_flash_on = false,	/* read dim flash when probe or not */
};
#endif /* __ILI7806S_M12_PANEL_DIMMING_H___ */
