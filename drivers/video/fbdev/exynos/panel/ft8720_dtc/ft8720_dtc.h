/*
 * linux/drivers/video/fbdev/exynos/panel/ft8720_dtc/ft8720_dtc.h
 *
...
static struct rdinfo ft8720_dtc_rditbl[] = {
...
static DECLARE_RESUI(id) = {
	{.rditbl = &ft8720_dtc_rditbl[READ_ID_DA], .offset = 0},
	{.rditbl = &ft8720_dtc_rditbl[READ_ID_DB], .offset = 1},
	{.rditbl = &ft8720_dtc_rditbl[READ_ID_DC], .offset = 2},
};

static struct resinfo ft8720_dtc_restbl[] = {
