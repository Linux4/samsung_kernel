...
#if IS_ENABLED(CONFIG_ARCH_EXYNOS) && IS_ENABLED(CONFIG_EXYNOS_DPU20)
#include "../dsim.h"
#include "../decon_notify.h"
#elif IS_ENABLED(CONFIG_ARCH_EXYNOS) && IS_ENABLED(CONFIG_EXYNOS_DPU30)
...
void dsi_write_data_dump(struct dsim_device *dsim, u32 id, unsigned long d0, u32 d1)
{
	if (likely(!tx_dump))
		return;
