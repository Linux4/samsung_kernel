/*
 * linux/drivers/video/fbdev/exynos/panel/td4160_boe/td4160_boe_a12s_panel_dimming.h
 *
 * Header file for TD4160 Dimming Driver
 *
...
#ifndef __TD4160_A12S_PANEL_DIMMING_H___
#define __TD4160_A12S_PANEL_DIMMING_H___
...
#define TD4160_TOTAL_STEP (TD4160_NR_STEP + TD4160_HBM_STEP) /* 0 ~ 365 */

static unsigned int td4160_boe_a12s_brt_tbl[TD4160_TOTAL_STEP] = {
	BRT(0),
...
static unsigned int td4160_boe_a12s_step_cnt_tbl[TD4160_TOTAL_STEP] = {
	[0 ... 255] = 1,
	/* HBM */
	[256 ... 306] = 1,
};

struct brightness_table td4160_boe_a12s_panel_brightness_table = {
	.brt = td4160_boe_a12s_brt_tbl,
	.sz_brt = ARRAY_SIZE(td4160_boe_a12s_brt_tbl),
	...
	.brt_to_step = NULL,
	.sz_brt_to_step = 0,
	.step_cnt = td4160_boe_a12s_step_cnt_tbl,
	.sz_step_cnt = ARRAY_SIZE(td4160_boe_a12s_step_cnt_tbl),
	.vtotal = 0,
};

static struct panel_dimming_info td4160_boe_a12s_panel_dimming_info = {
	.name = "td4160_boe_a12s",
	.dim_init_info = {
		NULL,
	},
	.target_luminance = -1,
	...
	.brt_tbl = &td4160_boe_a12s_panel_brightness_table,
	/* dimming parameters */
	.dimming_maptbl = NULL,
	.dim_flash_on = false,	/* read dim flash when probe or not */
};
#endif /* __TD4160_A12S_PANEL_DIMMING_H___ */
