...
static DEFINE_PANEL_MDELAY(xcover5_wait_display_off, 1 * 17);	/* 1 frame */
static DEFINE_PANEL_MDELAY(xcover5_wait_sleep_in, 60);
static DEFINE_PANEL_MDELAY(xcover5_wait_sleep_out, 6 * 17);	/* 6 frame */
...
static void *xcover5_display_on_cmdtbl[] = {
...
static struct seqinfo xcover5_seqtbl[MAX_PANEL_SEQ] = {
	...
	[PANEL_DISPLAY_ON_SEQ] = SEQINFO_INIT("display-on-seq", xcover5_display_on_cmdtbl),
