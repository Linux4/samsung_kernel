/*
 * linux/drivers/video/fbdev/exynos/panel/nt36525/nt36525.c
 *
 * nt36525 Dimming Driver
 *
...
static int generate_brt_step_table(struct brightness_table *brt_tbl)
{
	...
	brt_tbl->brt_to_step = kmalloc(brt_tbl->sz_brt_to_step * sizeof(u32), GFP_KERNEL);
