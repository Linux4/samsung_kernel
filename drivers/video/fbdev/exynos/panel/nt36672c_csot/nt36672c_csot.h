/*
 * linux/drivers/video/fbdev/exynos/panel/nt36672c_csot/nt36672c_csot.h
 *
...
static struct rdinfo nt36672c_csot_rditbl[] = {
...
static DECLARE_RESUI(id) = {
	{.rditbl = &nt36672c_csot_rditbl[READ_ID_DA], .offset = 0},
	{.rditbl = &nt36672c_csot_rditbl[READ_ID_DB], .offset = 1},
	{.rditbl = &nt36672c_csot_rditbl[READ_ID_DC], .offset = 2},
};

static struct resinfo nt36672c_csot_restbl[] = {
