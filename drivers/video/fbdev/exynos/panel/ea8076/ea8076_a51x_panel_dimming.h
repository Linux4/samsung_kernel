/*
 * linux/drivers/video/fbdev/exynos/panel/ea8076/ea8076_a51x_panel_dimming.h
 *
...
#ifndef __EA8076_A51X_PANEL_DIMMING_H___
#define __EA8076_A51X_PANEL_DIMMING_H___
...
static unsigned int ea8076_a51x_brt_tbl[EA8076_TOTAL_STEP] = {
	BRT(0),
...
static unsigned int ea8076_a51x_step_cnt_tbl[EA8076_TOTAL_STEP] = {
	[0 ... 255] = 1,
	/* HBM */
	[256 ... 365] = 1,
};

struct brightness_table ea8076_a51x_panel_brightness_table = {
	.brt = ea8076_a51x_brt_tbl,
	.sz_brt = ARRAY_SIZE(ea8076_a51x_brt_tbl),
	...
	.brt_to_step = NULL,
	.sz_brt_to_step = 0,
	.step_cnt = ea8076_a51x_step_cnt_tbl,
	.sz_step_cnt = ARRAY_SIZE(ea8076_a51x_step_cnt_tbl),
	.vtotal = 0,
};

static struct panel_dimming_info ea8076_a51x_panel_dimming_info = {
	.name = "ea8076_a51x",
	.dim_init_info = {
		NULL,
	},
	...
	.brt_tbl = &ea8076_a51x_panel_brightness_table,
	/* dimming parameters */
	.dimming_maptbl = NULL,
	.dim_flash_on = false,	/* read dim flash when probe or not */
};
#endif /* __EA8076_A51X_PANEL_DIMMING_H___ */
