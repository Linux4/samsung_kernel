/*
 * linux/drivers/video/fbdev/exynos/panel/ana6705/ana6705_a71x_panel_dimming.h
 *
...
#ifndef __ANA6705_A71X_PANEL_DIMMING_H___
#define __ANA6705_A71X_PANEL_DIMMING_H___
...
#define S6E3HA9_NR_STEP (256)
#define S6E3HA9_HBM_STEP (110)
#define S6E3HA9_TOTAL_STEP (S6E3HA9_NR_STEP + S6E3HA9_HBM_STEP) /* 0 ~ 365 */

static unsigned int ana6705_a71x_brt_tbl[S6E3HA9_TOTAL_STEP] = {
	BRT(0),
...
static unsigned int ana6705_a71x_step_cnt_tbl[S6E3HA9_TOTAL_STEP] = {
	[0 ... 255] = 1,
	/* HBM */
	[256 ... 365] = 1,
};

struct brightness_table ana6705_a71x_panel_brightness_table = {
	.brt = ana6705_a71x_brt_tbl,
	.sz_brt = ARRAY_SIZE(ana6705_a71x_brt_tbl),
	.sz_ui_brt = S6E3HA9_NR_STEP,
	.sz_hbm_brt = S6E3HA9_HBM_STEP,
	.lum = NULL,
	.sz_lum = 0,
	.sz_ui_lum = 0,
	.sz_hbm_lum = 0,
	...
	.brt_to_step = NULL,
	.sz_brt_to_step = 0,
	.step_cnt = ana6705_a71x_step_cnt_tbl,
	.sz_step_cnt = ARRAY_SIZE(ana6705_a71x_step_cnt_tbl),
	.vtotal = 0,
};

static struct panel_dimming_info ana6705_a71x_panel_dimming_info = {
	.name = "ana6705_a71x",
	.dim_init_info = {
		NULL,
	},
	...
	.brt_tbl = &ana6705_a71x_panel_brightness_table,
	/* dimming parameters */
	.dimming_maptbl = NULL,
	.dim_flash_on = false,	/* read dim flash when probe or not */
};
#endif /* __ANA6705_A71X_PANEL_DIMMING_H___ */
