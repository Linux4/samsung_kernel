/*
 * linux/drivers/video/fbdev/exynos/panel/nt36525b_dtc/nt36525b_dtc_a12s_panel_dimming.h
 *
...
#ifndef __NT36525B_DTC_A12S_PANEL_DIMMING_H___
#define __NT36525B_DTC_A12S_PANEL_DIMMING_H___
...
#define NT36525B_DTC_NR_STEP (256)
#define NT36525B_DTC_HBM_STEP (51)
#define NT36525B_DTC_TOTAL_STEP (NT36525B_DTC_NR_STEP + NT36525B_DTC_HBM_STEP) /* 0 ~ 365 */

static unsigned int nt36525b_dtc_a12s_brt_tbl[NT36525B_DTC_TOTAL_STEP] = {
	BRT(0),
...
static unsigned int nt36525b_dtc_a12s_step_cnt_tbl[NT36525B_DTC_TOTAL_STEP] = {
	[0 ... 255] = 1,
	/* HBM */
	[256 ... 306] = 1,
};

struct brightness_table nt36525b_dtc_a12s_panel_brightness_table = {
	.brt = nt36525b_dtc_a12s_brt_tbl,
	.sz_brt = ARRAY_SIZE(nt36525b_dtc_a12s_brt_tbl),
	.sz_ui_brt = NT36525B_DTC_NR_STEP,
	.sz_hbm_brt = NT36525B_DTC_HBM_STEP,
	.lum = NULL,
	.sz_lum = 0,
	.sz_ui_lum = 0,
	.sz_hbm_lum = 0,
	...
	.brt_to_step = NULL,
	.sz_brt_to_step = 0,
	.step_cnt = nt36525b_dtc_a12s_step_cnt_tbl,
	.sz_step_cnt = ARRAY_SIZE(nt36525b_dtc_a12s_step_cnt_tbl),
	.vtotal = 0,
};

static struct panel_dimming_info nt36525b_dtc_a12s_panel_dimming_info = {
	.name = "nt36525b_dtc_a12s",
	.dim_init_info = {
		NULL,
	},
	.target_luminance = -1,
	...
	.brt_tbl = &nt36525b_dtc_a12s_panel_brightness_table,
	/* dimming parameters */
	.dimming_maptbl = NULL,
	.dim_flash_on = false,	/* read dim flash when probe or not */
};
#endif /* __NT36525B_DTC_A12S_PANEL_DIMMING_H___ */
