/*
 * linux/drivers/video/fbdev/exynos/panel/ft8203_boe/ft8203_boe_t260_panel_dimming.h
 *
...
#ifndef __FT8203_T260_PANEL_DIMMING_H___
#define __FT8203_T260_PANEL_DIMMING_H___
...
#define FT8203_TOTAL_STEP (FT8203_NR_STEP + FT8203_HBM_STEP) /* 0 ~ 365 */

static unsigned int ft8203_boe_t260_brt_tbl[FT8203_TOTAL_STEP] = {
	BRT(0),
...
static unsigned int ft8203_boe_t260_step_cnt_tbl[FT8203_TOTAL_STEP] = {
	[0 ... 255] = 1,
	/* HBM */
	[256 ... 306] = 1,
};

struct brightness_table ft8203_boe_t260_panel_brightness_table = {
	.brt = ft8203_boe_t260_brt_tbl,
	.sz_brt = ARRAY_SIZE(ft8203_boe_t260_brt_tbl),
	...
	.brt_to_step = NULL,
	.sz_brt_to_step = 0,
	.step_cnt = ft8203_boe_t260_step_cnt_tbl,
	.sz_step_cnt = ARRAY_SIZE(ft8203_boe_t260_step_cnt_tbl),
	.vtotal = 0,
};

static struct panel_dimming_info ft8203_boe_t260_panel_dimming_info = {
	.name = "ft8203_boe_t260",
	.dim_init_info = {
		NULL,
	},
	.target_luminance = -1,
	...
	.brt_tbl = &ft8203_boe_t260_panel_brightness_table,
	/* dimming parameters */
	.dimming_maptbl = NULL,
	.dim_flash_on = false,	/* read dim flash when probe or not */
};
#endif /* __FT8203_T260_PANEL_DIMMING_H___ */
