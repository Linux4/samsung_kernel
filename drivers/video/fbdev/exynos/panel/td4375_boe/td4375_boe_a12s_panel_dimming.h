/*
 * linux/drivers/video/fbdev/exynos/panel/td4375_boe/td4375_boe_a12s_panel_dimming.h
 *
...
#ifndef __TD4375_A12S_PANEL_DIMMING_H___
#define __TD4375_A12S_PANEL_DIMMING_H___
...
static unsigned int td4375_boe_a12s_brt_tbl[TD4375_TOTAL_STEP] = {
	BRT(0),
...
static unsigned int td4375_boe_a12s_step_cnt_tbl[TD4375_TOTAL_STEP] = {
	[0 ... 255] = 1,
	/* HBM */
	[256 ... 306] = 1,
};

struct brightness_table td4375_boe_a12s_panel_brightness_table = {
	.brt = td4375_boe_a12s_brt_tbl,
	.sz_brt = ARRAY_SIZE(td4375_boe_a12s_brt_tbl),
	...
	.brt_to_step = NULL,
	.sz_brt_to_step = 0,
	.step_cnt = td4375_boe_a12s_step_cnt_tbl,
	.sz_step_cnt = ARRAY_SIZE(td4375_boe_a12s_step_cnt_tbl),
	.vtotal = 0,
};

static struct panel_dimming_info td4375_boe_a12s_panel_dimming_info = {
	.name = "td4375_boe_a12s",
	.dim_init_info = {
		NULL,
	},
	.target_luminance = -1,
	...
	.brt_tbl = &td4375_boe_a12s_panel_brightness_table,
	/* dimming parameters */
	.dimming_maptbl = NULL,
	.dim_flash_on = false,	/* read dim flash when probe or not */
};
#endif /* __TD4375_A12S_PANEL_DIMMING_H___ */
