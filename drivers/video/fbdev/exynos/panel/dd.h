...
#if defined(CONFIG_DEBUG_FS) && !defined(CONFIG_SAMSUNG_PRODUCT_SHIP) && defined(CONFIG_SMCDSD_LCD_DEBUG)
struct dsim_device;
extern void dsi_write_data_dump(struct dsim_device *dsim, u32 id, unsigned long d0, u32 d1);
...
#if defined(CONFIG_DEBUG_FS) && !defined(CONFIG_SAMSUNG_PRODUCT_SHIP) && defined(CONFIG_SMCDSD_LCD_DEBUG)
struct panel_device;
extern void init_brightness_assist(struct panel_device *panel);
extern void init_debugfs_brightness(struct panel_device *panel);
#else
#define init_brightness_assist(...)
#define init_debugfs_brightness(...)
#endif
