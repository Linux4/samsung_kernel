...
static struct notifier_block decon_nb_priority_top = {
...
static struct notifier_block decon_nb_priority_low = {
...
{
	decon_unregister_notifier(&decon_nb_priority_low);
	decon_unregister_notifier(&decon_nb_priority_top);
...
static int __init decon_notifier_init(void)
{
	...
	decon_register_notifier(&decon_nb_priority_top);
	decon_register_notifier(&decon_nb_priority_low);
