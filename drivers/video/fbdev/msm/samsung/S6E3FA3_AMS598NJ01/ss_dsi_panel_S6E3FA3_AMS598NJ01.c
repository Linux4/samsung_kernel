 ...
 *
*/
#include "ss_dsi_panel_S6E3FA3_AMS598NJ01.h"
#include "ss_dsi_mdnie_S6E3FA3_AMS598NJ01.h"
#include "../../mdss_dsi.h"
...
static struct dsi_panel_cmds * mdss_acl_on(struct mdss_dsi_ctrl_pdata *ctrl, int *level_key)
{
	...
	*level_key = LEVEL1_KEY;
	...
	if (vdd->gradual_acl_val)
		get_panel_tx_cmds(ctrl, TX_ACL_ON)->cmds[0].payload[4] = vdd->gradual_acl_val;
...
static void mdss_panel_init(struct samsung_display_driver_data *vdd)
{
	...
	vdd->panel_func.samsung_smart_get_conf = smart_get_conf_S6E3FA3_AMS598NJ01;
...
static int __init samsung_panel_init(void)
{
	...
	char panel_string[] = "ss_dsi_panel_S6E3FA3_AMS598NJ01_FHD";
