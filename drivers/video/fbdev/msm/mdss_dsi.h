...
struct mdss_dsi_ctrl_pdata {
	...
	int disp_te_gpio;
	int rst_gpio;
/* bug 441491, wangminglin.wt, 2019/0505, Modify ft8006p tianma timming sequence, start*/
	int wt_tp_rst_gpio;
/* bug 441491, wangminglin.wt, 2019/0505, Modify ft8006p tianma timming sequence, end */
	int disp_en_gpio;
	int bklt_en_gpio;
	int vdd_ext_gpio;
	int mode_gpio;
