...
/* bug 429022 , wangminglin.wt, 2019/0213, Add Lcd backlight map, start*/
	int blmap_size;
	int *blmap;
/* bug 429022 , wangminglin.wt, 2019/0213, Add Lcd backlight map, end*/
};
