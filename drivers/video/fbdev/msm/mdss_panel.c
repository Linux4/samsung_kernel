...
/* bug 436503, wangminglin.wt, 2019/0402, Add LCD phy_timing_12nm debug info, start*/
	DEBUGFS_CREATE_ARRAY("phy_timing_12nm", phy_node,
			     pinfo->mipi.dsi_phy_db.timing_12nm);
/* bug 436503, wangminglin.wt, 2019/0402, Add LCD phy_timing_12nm debug info, end*/

/* bug 440558, wangminglin.wt, 2019/0429, Add Lcd mipi clk info, start*/
	DEBUGFS_CREATE_ARRAY("timing_8996", phy_node,
			     pinfo->mipi.dsi_phy_db.timing_8996);
/* bug 440558, wangminglin.wt, 2019/0429, Add Lcd mipi clk info, end */
