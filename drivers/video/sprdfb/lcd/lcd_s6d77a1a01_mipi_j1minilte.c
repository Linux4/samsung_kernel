/* drivers/video/sprdfb/lcd_s6d77a1a01_mipi_j1minilte.c
 *
...
static int32_t s6d77a1a01_mipi_init_j1minilte(struct panel_spec *self)
{
	int32_t i = 0;
	...
	printk("[LCD] kernel hx8379c_mipi_init\n");
...
static uint32_t s6d77a1a01_readid_jiminilte(struct panel_spec *self)
{
	return 0;
}


static int32_t s6d77a1a01_enter_sleep_j1minilte(struct panel_spec *self, uint8_t is_sleep)
{
	int32_t i = 0;
...
static struct panel_operations lcd_s6d77a1a01_mipi_operations_j1minilte = {
	.panel_init = s6d77a1a01_mipi_init_j1minilte,
	.panel_readid = s6d77a1a01_readid_jiminilte,
	.panel_enter_sleep = s6d77a1a01_enter_sleep_j1minilte,
};

static struct timing_rgb lcd_s6d77a1a01_mipi_timing_j1minilte = {
	.hfp = 126,  /* unit: pixel */
	.hbp = 150,
	.hsync = 40,
	.vfp = 16, /*unit: line*/
...
static struct info_mipi lcd_s6d77a1a01_mipi_info_j1minilte = {
	...
	.timing = &lcd_s6d77a1a01_mipi_timing_j1minilte,
	.ops = NULL,
};

struct panel_spec lcd_s6d77a1a01_mipi_spec_j1minilte = {
	.width = 480,
	.height = 800,
	.fps	= 60,
	.type = LCD_MODE_DSI,
	...
	.info = {
		.mipi = &lcd_s6d77a1a01_mipi_info_j1minilte
	},
	.ops = &lcd_s6d77a1a01_mipi_operations_j1minilte,
};
struct panel_cfg lcd_s6d77a1a01_j1minilte = {
	/* this panel can only be main lcd */
	.dev_id = SPRDFB_MAINLCD_ID,
	.lcd_id = 0x066108,
	.lcd_name = "lcd_s6d77a1a01_mipi_j1minilte",
	.panel = &lcd_s6d77a1a01_mipi_spec_j1minilte,
};

static int __init lcd_s6d77a1a01_mipi_init_j1minilte(void)
{
	return sprdfb_panel_register(&lcd_s6d77a1a01_j1minilte);
}

subsys_initcall(lcd_s6d77a1a01_mipi_init_j1minilte);
