...
#endif
#if defined(CONFIG_MACH_GOYA) || defined(CONFIG_MACH_CS05)
...
#endif
	/*
	Removed clear framebuffer function caused by screen black issue
	when device is working by blank/unblank for sysfs node of xxx/fb0/blank.
	I think this is unnessary function in fb suspend.
	*/
...
#if defined(CONFIG_MACH_WILCOX) || defined(CONFIG_MACH_LT02) || defined(CONFIG_MACH_CT01)
