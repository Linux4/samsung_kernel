 ...
 */
 ...
 #ifndef MDSS_CT01_PANEL_H
 #define MDSS_CT01_PANEL_H
...
#define BL_MAX_BRIGHTNESS_LEVEL		196
#define BL_MID_BRIGHTNESS_LEVEL		96
#define BL_LOW_BRIGHTNESS_LEVEL		6
...
enum {
 ...
 struct mdss_samsung_driver_data{
	struct dsi_buf boe_tx_buf;
	struct msm_fb_data_type *mfd;
	struct dsi_buf boe_rx_buf;
	struct mdss_panel_common_pdata *mdss_boe_disp_pdata;
