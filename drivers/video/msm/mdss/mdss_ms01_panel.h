...
#define BL_MAX_BRIGHTNESS_LEVEL		178
#define BL_MID_BRIGHTNESS_LEVEL		88
#define BL_LOW_BRIGHTNESS_LEVEL		8
#define BL_DIM_BRIGHTNESS_LEVEL		16
#define BL_DEFAULT_BRIGHTNESS		BL_MID_BRIGHTNESS_LEVEL

#define BL_MIN_BRIGHTNESS_JDI			4
#define BL_MAX_BRIGHTNESS_LEVEL_JDI		172
#define BL_MID_BRIGHTNESS_LEVEL_JDI		82
#define BL_LOW_BRIGHTNESS_LEVEL_JDI		5
#define BL_DIM_BRIGHTNESS_LEVEL_JDI		10
#define BL_DEFAULT_BRIGHTNESS_JDI		BL_MID_BRIGHTNESS_LEVEL_JDI
