			...
			struct isl98611_backlight_platform_data *pdata)
{
	...
	/* reset, irq gpio info */
	pdata->gpio_scl = of_get_named_gpio(np, "isl98611,scl-gpio", 0);
	pdata->gpio_sda = of_get_named_gpio(np, "isl98611,sda-gpio", 0);
...
void isl98611_backlight_initialize(void)
{
	...
	pr_info("HHJ start isl98611_backlight_initialize\n");
