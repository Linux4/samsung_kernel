...
#include "ss_dsi_panel_HX83102D_BS060WKM.h"
#include "ss_dsi_mdnie_HX83102D_BS060WKM.h"
...
static struct dsi_panel_cmds * mdss_brightness_tft_pwm(struct mdss_dsi_ctrl_pdata *ctrl, int *level_key)
{
	...
	//#define get_bit(value, shift, width)	((value >> shift) & (GENMASK(width - 1, 0)))
	get_panel_tx_cmds(ctrl, TX_TFT_PWM)->cmds[0].payload[1] = get_bit(vdd->candela_level, 8, 4);
	get_panel_tx_cmds(ctrl, TX_TFT_PWM)->cmds[0].payload[2] = get_bit(vdd->candela_level, 0, 8);
...
static void mdss_panel_init(struct samsung_display_driver_data *vdd)
{
	...
	vdd->support_panel_max = HX83102D_BS060WKM_SUPPORT_PANEL_COUNT;
...
static int __init samsung_panel_init(void)
{
	...
	char panel_string[] = "ss_dsi_panel_HX83102D_BS060WKM_HDP";
