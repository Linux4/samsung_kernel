...
static struct dsi_panel_cmds *mdss_irc_hmt(struct mdss_dsi_ctrl_pdata *ctrl, int *level_key)
{
	...
	*level_key = LEVEL1_KEY;
	...
	return get_panel_tx_cmds(ctrl, TX_HMT_IRC);
}
...
//	vdd->panel_func.samsung_panel_off_post = mdss_panel_off_post;
	...
	vdd->panel_func.samsung_smart_get_conf = smart_get_conf_S6E3FA7_AMS604NL01;
	...
	vdd->panel_func.samsung_smart_get_conf_hmt = smart_get_conf_S6E3FA7_AMS604NL01_hmt;
...
static int __init samsung_panel_init(void)
{
	...
	char panel_string[] = "ss_dsi_panel_S6E3FA7_AMS604NL01_FHD";
