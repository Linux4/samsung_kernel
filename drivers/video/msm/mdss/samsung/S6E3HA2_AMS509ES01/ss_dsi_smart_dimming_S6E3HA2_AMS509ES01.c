 ...
 *
*/
#include "ss_dsi_smart_dimming_S6E3HA2_AMS509ES01.h"
...
static void print_lux_table(struct SMART_DIM *psmart)
{
	...
	for (lux_loop = 0; lux_loop < psmart->lux_table_max; lux_loop++) {
		...
		pr_err("lux : %3d  %s", psmart->plux_table[lux_loop], pBuffer);
		memset(pBuffer, 0x00, 256);
	}
}
...
struct smartdim_conf *smart_get_conf_S6E3HA2_AMS509ES01(void) {
...
struct smartdim_conf *smart_get_conf_S6E3HA2_AMS509ES01_hmt(void) {
