 ...
 *
*/
#include "ss_dsi_panel_S6E3FA3_AMS520KG09.h"
#include "ss_dsi_mdnie_S6E3FA3_AMS520KG09.h"
...
static int mdss_cell_id_read(struct mdss_dsi_ctrl_pdata *ctrl)
{
	...
	if (vdd->dtsi_data[ctrl->ndx].cell_id_rx_cmds[vdd->panel_revision].cmd_cnt) {
		...
		/* For AMS520KG09 exceptionally, MDNIE X&Y value(4bytes) should be get from A1h register read value */
...
static char coordinate_data_2[][COORDINATE_DATA_SIZE] = {
	{0xff, 0x00, 0xff, 0x00, 0xff, 0x00}, /* dummy */
	{0xff, 0x00, 0xf5, 0x00, 0xeb, 0x00}, /* Tune_1 */
	...
	{0xff, 0x00, 0xfa, 0x00, 0xf3, 0x00}, /* Tune_6 */
...
static struct dsi_panel_cmds * mdss_elvss_temperature2(struct mdss_dsi_ctrl_pdata *ctrl, int *level_key)
{
	...
	// T > 0
	if (vdd->temperature > 0) {
		if (candela_value <= 14)	/* 2 ~ 14 nit */
			vdd->dtsi_data[ctrl->ndx].elvss_lowtemp2_tx_cmds[vdd->panel_revision].cmds[1].payload[1] = 0x0F;
		else				/* 15 ~ 420 nit */
...
static void mdss_panel_init(struct samsung_display_driver_data *vdd)
{
	...
	vdd->panel_func.samsung_smart_get_conf = smart_get_conf_S6E3FA3_AMS520KG09;
	...
	vdd->panel_func.samsung_smart_get_conf_hmt = smart_get_conf_S6E3FA3_AMS520KG09_hmt;
...
static int __init samsung_panel_init(void)
{
	...
	char panel_string[] = "ss_dsi_panel_S6E3FA3_AMS520KG09_FHD";
