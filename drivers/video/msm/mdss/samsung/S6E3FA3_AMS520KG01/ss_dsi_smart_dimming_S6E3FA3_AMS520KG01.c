 ...
 *
*/
#include "ss_dsi_smart_dimming_S6E3FA3_AMS520KG01.h"
...
struct smartdim_conf *smart_get_conf_S6E3FA3_AMS520KG01(void) {
...
static void gamma_init_hmt(struct SMART_DIM *pSmart, char *str, int size) {
	...
	/* To avoid overflow */
	for (cnt = 0; cnt < GAMMA_SET_MAX; cnt++)
		str[cnt] = (char)gamma_setting[cnt];
}
...
struct smartdim_conf *smart_get_conf_S6E3FA3_AMS520KG01_hmt(void)
{
