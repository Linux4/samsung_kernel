 ...
 *
*/
#include "ss_dsi_smart_dimming_S6E3HA2_AMS801HK01.h"
...
{
	pr_err("%s MTP Offset VT R:%d G:%d B:%d\n", __func__,
	...
	pr_err("%s MTP Offset V23 R:%d G:%d B:%d\n", __func__,
	...
	pr_err("%s MTP Offset V35 R:%d G:%d B:%d\n", __func__,
	...
	pr_err("%s MTP Offset V51 R:%d G:%d B:%d\n", __func__,
	...
	pr_err("%s MTP Offset V87 R:%d G:%d B:%d\n", __func__,
	...
	pr_err("%s MTP Offset V151 R:%d G:%d B:%d\n", __func__,
	...
	pr_err("%s MTP Offset V203 R:%d G:%d B:%d\n", __func__,
	...
	pr_err("%s MTP Offset V255 R:%d G:%d B:%d\n", __func__,
...
static int v255_adjustment(struct SMART_DIM *pSmart)
{
	...
	pr_err("%s V255 RED:%d GREEN:%d BLUE:%d\n", __func__,
...
#ifdef SMART_DIMMING_DEBUG
	pr_err("%s VT RED:%d GREEN:%d BLUE:%d\n", __func__,
...
#ifdef SMART_DIMMING_DEBUG
	pr_err("%s V203 RED:%d GREEN:%d BLUE:%d\n", __func__,
...
#ifdef SMART_DIMMING_DEBUG
	pr_err("%s V151 RED:%d GREEN:%d BLUE:%d\n", __func__,
...
#ifdef SMART_DIMMING_DEBUG
	pr_err("%s V87 RED:%d GREEN:%d BLUE:%d\n", __func__,
...
#ifdef SMART_DIMMING_DEBUG
	pr_err("%s V51 RED:%d GREEN:%d BLUE:%d\n", __func__,
...
#ifdef SMART_DIMMING_DEBUG
	pr_err("%s V35 RED:%d GREEN:%d BLUE:%d\n", __func__,
...
#ifdef SMART_DIMMING_DEBUG
	pr_err("%s V23 RED:%d GREEN:%d BLUE:%d\n", __func__,
...
#ifdef SMART_DIMMING_DEBUG
	pr_err("%s V11 RED:%d GREEN:%d BLUE:%d\n", __func__,
...
static void gamma_init_revA(struct SMART_DIM *pSmart, char *str, int size)
{
	...
	if ((pSmart->brightness_level <= 360) && (pSmart->brightness_level >= 265)) {
		/* 265CD ~ 350CD */
		...
		/* 172 ~ 77 */
		if (pSmart->brightness_level == 172)
			bl_level = 240;
...
static void gamma_cell_determine(int ldi_revision)
{
	...
	max_lux_table[30] = V0_300CD_R = V0_300CD_R_20;
	max_lux_table[31] = V0_300CD_G = V0_300CD_G_20;
	max_lux_table[32] = V0_300CD_B = V0_300CD_B_20;

	VT_300CD_R = VT_300CD_R_20;
	VT_300CD_G = VT_300CD_G_20;
	max_lux_table[33] = VT_300CD_G << 4 | VT_300CD_R;
	max_lux_table[34] = VT_300CD_B = VT_300CD_B_20;
}
...
static int smart_dimming_init(struct SMART_DIM *psmart)
{
	...
	psmart->vregout_voltage = VREG0_REF_6P8;
...
struct smartdim_conf *smart_get_conf_S6E3HA2_AMS801HK01(void) {
...
struct smartdim_conf *smart_get_conf_S6E3HA2_AMS801HK01_hmt(void) {
