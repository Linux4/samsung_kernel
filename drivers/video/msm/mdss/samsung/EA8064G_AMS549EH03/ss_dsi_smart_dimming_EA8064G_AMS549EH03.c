 ...
 *
*/
#include "ss_dsi_smart_dimming_EA8064G_AMS549EH03.h"
...
struct smartdim_conf *smart_get_conf_EA8064G_AMS549EH03(void) {

	struct smartdim_conf * smartdim_conf;
	struct SMART_DIM *smart_EA8064G_AMS549EH03;
	...
	smart_EA8064G_AMS549EH03 = kzalloc(sizeof(struct SMART_DIM), GFP_KERNEL);
	if (!smart_EA8064G_AMS549EH03) {
		pr_info("%s allocation fail", __func__);
		goto out1;
	}

	smartdim_conf->psmart = smart_EA8064G_AMS549EH03;
	...
	smartdim_conf->mtp_buffer = (char *)(&smart_EA8064G_AMS549EH03->MTP_ORIGN);
