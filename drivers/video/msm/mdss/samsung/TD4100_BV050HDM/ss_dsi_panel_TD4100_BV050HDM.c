 ...
 *
*/
#include "ss_dsi_mdnie_TD4100_BV050HDM.h"
#include "ss_dsi_panel_TD4100_BV050HDM.h"
...
static void mdss_panel_init(struct samsung_display_driver_data *vdd)
{
	...
	vdd->support_panel_max = TD4100_BV050HDM_SUPPORT_PANEL_COUNT;
...
static int __init samsung_panel_init(void)
{
	...
	char panel_string[] = "ss_dsi_panel_TD4100_BV050HDM_HD";
