...
static void mdss_mdp_video_underrun_intr_done(void *arg)
{
	...
	MDSS_XLOG_TOUT_HANDLER("mdp", "dsi0");
...
void mdp5_dump_regs(void)
{
	...
	mdp_print_reg("mdp_h/w", 0x0, 0x50); /*hardware */
	mdp_print_reg("mdp", 0x1000, 0x400);	/* mdp */
	mdp_print_reg("ctl0", 0x2000, 0x38); /* CTL 0*/	
	mdp_print_reg("ctl1", 0x2200, 0x38); /* CTL 1*/	
	mdp_print_reg("ctl2", 0x2400, 0x38); /* CTL 2*/	
	mdp_print_reg("ctl3", 0x2600, 0x38); /* CTL 3*/	
	mdp_print_reg("ctl4", 0x2800, 0x38); /* CTL 4*/	
	mdp_print_reg("vg0", 0x5000, 0x100); /* vg0 */
	mdp_print_reg("vg1", 0x7000, 0x100); /* vg1 */
	mdp_print_reg("vg2", 0x9000, 0x100); /* vg2 */
	mdp_print_reg("rgb0", 0x15000, 0x100); /* rgb0 */
	mdp_print_reg("rgb1", 0x17000, 0x100); /* rgb1 */
	mdp_print_reg("rgb2", 0x19000, 0x100); /* rgb2 */
	mdp_print_reg("layer0", 0x45000, 0x100); /* layer0 */
	mdp_print_reg("layer1", 0x46000, 0x100); /* layer1 */
	mdp_print_reg("layer2", 0x47000, 0x100); /* layer2 */
	mdp_print_reg("layer3", 0x48000, 0x100); /* layer3 */
	mdp_print_reg("layer4", 0x49000, 0x100); /* layer4 */
	mdp_print_reg("intf0", 0x6b000, 0x100); /* intf0 */
	mdp_print_reg("intf1", 0x6b800, 0x100); /* intf1 */
	mdp_print_reg("intf2", 0x6c000, 0x100); /* intf2 */
	mdp_print_reg("intf3", 0x6c800, 0x100); /* intf3 */
	mdp_print_reg("pp0", 0x71000, 0x40); /* pp0 */
	mdp_print_reg("pp1", 0x71800, 0x40); /* pp1 */
	mdp_print_reg("pp2", 0x72000, 0x40); /* pp2 */
}
