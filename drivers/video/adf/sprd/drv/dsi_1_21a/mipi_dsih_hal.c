 ...
 */
void mipi_dsih_write_word(dsih_ctrl_t *instance, uint32_t reg_address,
	uint32_t data)
{

	instance->core_write_function(instance->address, reg_address,
		data);
}
 ...
 */
void mipi_dsih_write_part(dsih_ctrl_t *instance, uint32_t reg_address,
...
{
	return instance->core_read_function(instance->address,
		reg_address);
}
 ...
 */
uint32_t mipi_dsih_read_part(dsih_ctrl_t *instance, uint32_t reg_address,
	uint8_t shift, uint8_t width)
{
	return (mipi_dsih_read_word(instance,
			reg_address) >> shift) & ((1 << width) - 1);
}
...
{
	return (int) (mipi_dsih_read_part(instance, R_DSI_HOST_PWR_UP, 0,
			1));
}
 ...
 */
void mipi_dsih_hal_tx_escape_division(dsih_ctrl_t *instance,
	uint8_t tx_escape_division)
{
	mipi_dsih_write_part(instance, R_DSI_HOST_CLK_MGR,
		tx_escape_division, 0, 8);
}
...
{
	mipi_dsih_write_part(instance, R_DSI_HOST_DPI_VCID,
		(uint32_t) (vc), 0, 2);
}
 ...
 *@return error code
 */
dsih_error_t mipi_dsih_hal_dpi_color_coding(dsih_ctrl_t *instance,
	dsih_color_coding_t color_coding)
{
	...
	if (color_coding > COLOR_CODE_MAX) {
		if (instance->log_error != 0) {
			instance->
				log_error
				("sprdfb: invalid colour configuration");
		}
		err = ERR_DSI_COLOR_CODING;
	} else {
		mipi_dsih_write_part(instance, R_DSI_HOST_DPI_COLOR_CODE,
			color_coding, 0, 4);
	}
	return err;
}
 ...
 */
dsih_color_coding_t mipi_dsih_hal_dpi_get_color_coding(dsih_ctrl_t *
	instance)
{
	return (dsih_color_coding_t) (mipi_dsih_read_part(instance,
			R_DSI_HOST_DPI_COLOR_CODE, 0, 4));
}
...
uint8_t mipi_dsih_hal_dpi_get_color_depth(dsih_ctrl_t *instance)
{
	...
	switch (mipi_dsih_read_part(instance, R_DSI_HOST_DPI_COLOR_CODE, 0,
			4)) {
		case 0:
		case 1:
		case 2:
 ...
 *@param enable
 */
void mipi_dsih_hal_dpi_18_loosely_packet_en(dsih_ctrl_t *instance,
	int enable)
{
	mipi_dsih_write_part(instance, R_DSI_HOST_DPI_COLOR_CODE, enable,
		8, 1);
}
 ...
 */
void mipi_dsih_hal_dpi_color_mode_pol(dsih_ctrl_t *instance,
	int active_low)
{
	mipi_dsih_write_part(instance, R_DSI_HOST_DPI_CFG_POL, active_low,
		4, 1);
}
 ...
 *@param active_low (1) or active high (0)
 */
void mipi_dsih_hal_dpi_shut_down_pol(dsih_ctrl_t *instance,
	int active_low)
{
	mipi_dsih_write_part(instance, R_DSI_HOST_DPI_CFG_POL, active_low,
		3, 1);
...
{
	mipi_dsih_write_part(instance, R_DSI_HOST_VID_MODE_CFG, enable, 14,
		1);
}
...
{
	mipi_dsih_write_part(instance, R_DSI_HOST_VID_MODE_CFG, enable, 13,
		1);
}
...
{
	mipi_dsih_write_part(instance, R_DSI_HOST_VID_MODE_CFG, enable, 12,
		1);
}
 ...
 *@param enable (1) - disable (0)
 */
void mipi_dsih_hal_dpi_lp_during_vactive(dsih_ctrl_t *instance,
	int enable)
{
	mipi_dsih_write_part(instance, R_DSI_HOST_VID_MODE_CFG, enable, 11,
		1);
}
...
{
	mipi_dsih_write_part(instance, R_DSI_HOST_VID_MODE_CFG, enable, 10,
		1);
}
...
{
	mipi_dsih_write_part(instance, R_DSI_HOST_VID_MODE_CFG, enable, 9,
		1);
}
...
{
	mipi_dsih_write_part(instance, R_DSI_HOST_VID_MODE_CFG, enable, 8,
		1);
}
 ...
 *@return error code
 */
dsih_error_t mipi_dsih_hal_dpi_video_mode_type(dsih_ctrl_t *instance,
	dsih_video_mode_t type)
{
	if (type < 3) {
		mipi_dsih_write_part(instance, R_DSI_HOST_VID_MODE_CFG,
			type, 0, 2);
		return OK;
	} else {
		if (instance->log_error != 0)
...
{
	mipi_dsih_write_part(instance, R_DSI_HOST_MODE_CFG, enable ? 0 : 1,
		0, 1);
}
...
{
	return (mipi_dsih_read_part(instance, R_DSI_HOST_MODE_CFG, 0,
			1) == 0);
}
 ...
 *@return error code
 */
dsih_error_t mipi_dsih_hal_dpi_null_packet_size(dsih_ctrl_t *instance,
	uint16_t size)
{
	if (size < (1 << 13)) {	/* 13-bit field */
		mipi_dsih_write_part(instance, R_DSI_HOST_VID_NULL_SIZE,
			size, 0, 13);
		return OK;
	} else {
		return ERR_DSI_OUT_OF_BOUND;
 ...
 *@param no of chunks
 */
dsih_error_t mipi_dsih_hal_dpi_chunks_no(dsih_ctrl_t *instance,
	uint16_t no)
{
	if (no < (1 << 13)) {
		mipi_dsih_write_part(instance, R_DSI_HOST_VID_NUM_CHUNKS,
			no, 0, 13);
		return OK;
	} else {
		return ERR_DSI_OUT_OF_BOUND;
 ...
 *@return error code
 */
dsih_error_t mipi_dsih_hal_dpi_video_packet_size(dsih_ctrl_t *instance,
	uint16_t size)
{
	if (size < (1 << 14)) {	/* 14-bit field */
		mipi_dsih_write_part(instance, R_DSI_HOST_VID_PKT_SIZE,
			size, 0, 14);
		return OK;
	} else {
		return ERR_DSI_OUT_OF_BOUND;
 ...
 */
void mipi_dsih_hal_edpi_max_allowed_size(dsih_ctrl_t *instance,
	uint16_t size)
{
	mipi_dsih_write_part(instance, R_DSI_HOST_EDPI_CMD_SIZE, size, 0,
		16);
}
...
{
	mipi_dsih_write_part(instance, R_DSI_HOST_CMD_MODE_CFG, enable, 0,
		1);
}
...
{
	mipi_dsih_write_part(instance, R_DSI_HOST_CMD_MODE_CFG, enable, 1,
		1);
}
 ...
 *@return error code
 */
dsih_error_t mipi_dsih_hal_dcs_wr_tx_type(dsih_ctrl_t *instance,
	unsigned no_of_param, int lp)
{
	switch (no_of_param) {
	case 0:
		mipi_dsih_write_part(instance,
				     R_DSI_HOST_CMD_MODE_CFG, lp, 16, 1);
		break;
	case 1:
		mipi_dsih_write_part(instance,
				     R_DSI_HOST_CMD_MODE_CFG, lp, 17, 1);
		break;
	default:
		mipi_dsih_write_part(instance,
				     R_DSI_HOST_CMD_MODE_CFG, lp, 19, 1);
		break;
	}
	return OK;
}
 ...
 *@return error code
 */
dsih_error_t mipi_dsih_hal_dcs_rd_tx_type(dsih_ctrl_t *instance,
	unsigned no_of_param, int lp)
{
	dsih_error_t err = OK;
	...
	case 0:
		mipi_dsih_write_part(instance,
				     R_DSI_HOST_CMD_MODE_CFG, lp, 18, 1);
		break;
	default:
		if (instance->log_error != 0) {
			instance->log_error
				("sprdfb: undefined DCS Read packet type");
		}
...
dsih_error_t mipi_dsih_hal_max_rd_packet_size_type(dsih_ctrl_t *instance,
	int lp)
{
	dsih_error_t err = OK;
 ...
 *@return error code
 */
dsih_error_t mipi_dsih_hal_gen_wr_tx_type(dsih_ctrl_t *instance,
	unsigned no_of_param, int lp)
{
	switch (no_of_param) {
	case 0:
		mipi_dsih_write_part(instance,
				     R_DSI_HOST_CMD_MODE_CFG, lp, 8, 1);
		break;
	case 1:
		mipi_dsih_write_part(instance,
				     R_DSI_HOST_CMD_MODE_CFG, lp, 9, 1);
		break;
	case 2:
		mipi_dsih_write_part(instance,
				     R_DSI_HOST_CMD_MODE_CFG, lp, 10, 1);
		break;
	default:
		mipi_dsih_write_part(instance,
				     R_DSI_HOST_CMD_MODE_CFG, lp, 14, 1);
		break;
	}
	return OK;
}
 ...
 *@return error code
 */
dsih_error_t mipi_dsih_hal_gen_rd_tx_type(dsih_ctrl_t *instance,
	unsigned no_of_param, int lp)
{
	dsih_error_t err = OK;
	...
	case 0:
		mipi_dsih_write_part(instance,
				     R_DSI_HOST_CMD_MODE_CFG, lp, 11, 1);
		break;
	case 1:
		mipi_dsih_write_part(instance,
				     R_DSI_HOST_CMD_MODE_CFG, lp, 12, 1);
		break;
	case 2:
		mipi_dsih_write_part(instance,
				     R_DSI_HOST_CMD_MODE_CFG, lp, 13, 1);
		break;
	default:
		if (instance->log_error != 0)
			instance->log_error
				("sprdfb: undefined Generic Read packet type");
		err = ERR_DSI_OUT_OF_BOUND;
		break;
	}
	return err;
...
{
	mipi_dsih_write_part(instance, R_DSI_HOST_MODE_CFG, enable ? 1 : 0,
		0, 1);
}
...
{
	mipi_dsih_write_part(instance, R_DSI_HOST_VID_HLINE_TIME, time, 0,
		15);
}
...
{
	mipi_dsih_write_part(instance, R_DSI_HOST_VID_HBP_TIME, time, 0,
		12);
}
...
{
	mipi_dsih_write_part(instance, R_DSI_HOST_VID_HSA_TIME, time, 0,
		12);
}
...
{
	mipi_dsih_write_part(instance, R_DSI_HOST_VID_VACTIVE_LINES, lines,
		0, 14);
}
...
{
	mipi_dsih_write_part(instance, R_DSI_HOST_VID_VFP_LINES, lines, 0,
		10);
}
...
{
	mipi_dsih_write_part(instance, R_DSI_HOST_VID_VBP_LINES, lines, 0,
		10);
}
...
{
	mipi_dsih_write_part(instance, R_DSI_HOST_VID_VSA_LINES, lines, 0,
		10);
}
 ...
 */
void mipi_dsih_hal_timeout_clock_division(dsih_ctrl_t *instance,
...
{
	mipi_dsih_write_part(instance, R_DSI_HOST_TO_CNT_CFG, count, 0,
		16);
}
...
{
	mipi_dsih_write_part(instance, R_DSI_HOST_TO_CNT_CFG, count, 16,
		16);
}
 ...
 */
uint32_t mipi_dsih_hal_int_get_mask_0(dsih_ctrl_t *instance,
	uint32_t mask)
{
 ...
 *@param mask the bits to read from the mask register
 */
uint32_t mipi_dsih_hal_int_get_mask_1(dsih_ctrl_t *instance,
	uint32_t mask)
{
 ...
 *@return error code
 */
dsih_error_t mipi_dsih_hal_gen_packet_header(dsih_ctrl_t *instance,
	uint8_t vc, uint8_t packet_type, uint8_t ms_byte, uint8_t ls_byte)
{
	if (vc < 4) {
		mipi_dsih_write_part(instance, R_DSI_HOST_GEN_HDR,
			(ms_byte << 16) | (ls_byte << 8) | ((vc << 6) |
				packet_type), 0, 24);
		return OK;
	}
 ...
 *@return error code
 */
dsih_error_t mipi_dsih_hal_gen_packet_payload(dsih_ctrl_t *instance,
	uint32_t payload)
{
 ...
 *@return error code
 */
dsih_error_t mipi_dsih_hal_gen_read_payload(dsih_ctrl_t *instance,
	uint32_t *payload)
{
...
{
	mipi_dsih_write_part(instance, R_DSI_HOST_PCKHDL_CFG, enable, 1,
		1);
}
...
{
	mipi_dsih_write_part(instance, R_DSI_HOST_PCKHDL_CFG, enable, 0,
		1);
}
...
{
	mipi_dsih_write_part(instance, R_DSI_HOST_PCKHDL_CFG, enable, 2,
		1);
}
...
{
	mipi_dsih_write_part(instance, R_DSI_HOST_PCKHDL_CFG, enable, 3,
		1);
}
...
{
	mipi_dsih_write_part(instance, R_DSI_HOST_PCKHDL_CFG, enable, 4,
		1);
}
...
{
	return mipi_dsih_read_part(instance, R_DSI_HOST_CMD_PKT_STATUS, 6,
		1);
}
...
{
	return mipi_dsih_read_part(instance, R_DSI_HOST_CMD_PKT_STATUS, 5,
		1);
}
...
{
	return mipi_dsih_read_part(instance, R_DSI_HOST_CMD_PKT_STATUS, 4,
		1);
}
...
{
	return mipi_dsih_read_part(instance, R_DSI_HOST_CMD_PKT_STATUS, 3,
		1);
}
...
{
	return mipi_dsih_read_part(instance, R_DSI_HOST_CMD_PKT_STATUS, 2,
		1);
}
...
{
	return mipi_dsih_read_part(instance, R_DSI_HOST_CMD_PKT_STATUS, 1,
		1);
}
...
{
	return mipi_dsih_read_part(instance, R_DSI_HOST_CMD_PKT_STATUS, 0,
		1);
}
 ...
 *@return error code
 */
dsih_error_t mipi_dsih_phy_hs2lp_config(dsih_ctrl_t *instance,
	uint8_t no_of_byte_cycles)
{
	mipi_dsih_write_part(instance, R_DSI_HOST_PHY_TMR_CFG,
 ...
 *@return error code
 */
dsih_error_t mipi_dsih_phy_lp2hs_config(dsih_ctrl_t *instance,
	uint8_t no_of_byte_cycles)
{
	mipi_dsih_write_part(instance, R_DSI_HOST_PHY_TMR_CFG,
 ...
 *@return error code
 */
dsih_error_t mipi_dsih_phy_clk_hs2lp_config(dsih_ctrl_t *instance,
	uint8_t no_of_byte_cycles)
{
	mipi_dsih_write_part(instance, R_DSI_HOST_PHY_TMR_LPCLK_CFG,
 ...
 *@return error code
 */
dsih_error_t mipi_dsih_phy_clk_lp2hs_config(dsih_ctrl_t *instance,
	uint8_t no_of_byte_cycles)
{
	mipi_dsih_write_part(instance, R_DSI_HOST_PHY_TMR_LPCLK_CFG,
 ...
 *@return error code
 */
dsih_error_t mipi_dsih_phy_bta_time(dsih_ctrl_t *instance,
...
{
	mipi_dsih_write_part(instance, R_DSI_HOST_LPCLK_CTRL, enable, 1,
		1);
}
 ...
 */
void mipi_dsih_hal_presp_timeout_low_power_write(dsih_ctrl_t *instance,
	uint16_t no_of_byte_cycles)
{
	mipi_dsih_write_part(instance, R_DSI_HOST_LP_WR_TO_CNT,
		no_of_byte_cycles, 0, 16);
}
 ...
 *measured in cycles of lanebyteclk
 */
void mipi_dsih_hal_presp_timeout_low_power_read(dsih_ctrl_t *instance,
	uint16_t no_of_byte_cycles)
{
	mipi_dsih_write_part(instance, R_DSI_HOST_LP_RD_TO_CNT,
		no_of_byte_cycles, 0, 16);
}
 ...
 *measured in cycles of lanebyteclk
 */
void mipi_dsih_hal_presp_timeout_high_speed_write(dsih_ctrl_t *instance,
	uint16_t no_of_byte_cycles)
{
	mipi_dsih_write_part(instance, R_DSI_HOST_HS_WR_TO_CNT,
		no_of_byte_cycles, 0, 16);
}
 ...
 *measured in cycles of lanebyteclk
 */
void mipi_dsih_hal_presp_timeout_high_speed_read(dsih_ctrl_t *instance,
	uint16_t no_of_byte_cycles)
{
	mipi_dsih_write_part(instance, R_DSI_HOST_HS_RD_TO_CNT,
		no_of_byte_cycles, 0, 16);
}
 ...
 *measured in cycles of lanebyteclk
 */
void mipi_dsih_hal_presp_timeout_bta(dsih_ctrl_t *instance,
	uint16_t no_of_byte_cycles)
{
	mipi_dsih_write_part(instance, R_DSI_HOST_BTA_TO_CNT,
		no_of_byte_cycles, 0, 16);
}
