...
#define CONFIG_FIMD_USE_BUS_DEVFREQ
	...
	|| defined(CONFIG_ARM_EXYNOS4415_BUS_DEVFREQ) || defined(CONFIG_ARM_EXYNOS3472_BUS_DEVFREQ)
 ...
 */
#if defined(CONFIG_S5P_LCD_INIT) && !defined(CONFIG_S5P_MDNIE)
...
static int s3c_fb_set_par(struct fb_info *info)
{
	...
	old_wincon &= (~WINCONx_SHADOW_MASK_ENWIN);
...
static int s3c_fb_blank(int blank_mode, struct fb_info *info)
{
	...
	case FB_BLANK_NORMAL:
		...
		exynos3_update_media_layers(TYPE_FIMD1, 0);
#else
...
#elif defined(CONFIG_ARCH_EXYNOS3)
		exynos3_update_media_layers(TYPE_FIMD1, 1);
#else
...
#elif defined(CONFIG_ARCH_EXYNOS3)
		exynos3_update_media_layers(TYPE_FIMD1, regs->win_overlap_cnt);
#else
...
#elif defined(CONFIG_ARCH_EXYNOS3)
		exynos3_update_media_layers(TYPE_RESOLUTION, RESOLUTION_FULLHD);
#else
...
#elif defined(CONFIG_ARCH_EXYNOS3)
		exynos3_update_media_layers(TYPE_RESOLUTION, RESOLUTION_WQXGA);
#else
...
static int s3c_fb_enable(struct s3c_fb *sfb)
{
	...
	!defined(CONFIG_SOC_EXYNOS3250) && !defined(CONFIG_SOC_EXYNOS4415) && !defined(CONFIG_SOC_EXYNOS3472)
