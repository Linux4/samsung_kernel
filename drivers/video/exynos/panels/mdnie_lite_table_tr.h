...
#define COLOR_OFFSET_F1(x, y)		(((y << 10) - (((x << 10) * 447) / 413) + (22 << 10)) >> 10)
#define COLOR_OFFSET_F2(x, y)		(((y << 10) - (((x << 10) * 393) / 373) - (5 << 10)) >> 10)
#define COLOR_OFFSET_F3(x, y)		(((y << 10) + (((x << 10) * 121) / 25) - (17745 << 10)) >> 10)
#define COLOR_OFFSET_F4(x, y)		(((y << 10) + (((x << 10) * 43) / 14) - (12267 << 10)) >> 10)
