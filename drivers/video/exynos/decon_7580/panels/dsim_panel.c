...
struct mipi_dsim_lcd_driver *mipi_lcd_driver = &s6e3fa2_mipi_lcd_driver;
struct dsim_panel_ops *mipi_panel_ops = &s6e3fa2_panel_ops;
...
#elif defined(CONFIG_PANEL_LAGO_DUMMY)
struct mipi_dsim_lcd_driver *mipi_lcd_driver = &lago_mipi_lcd_driver;
struct dsim_panel_ops *mipi_panel_ops = &lago_panel_ops;
#elif defined(CONFIG_PANEL_S6E3AA2_DYNAMIC)
