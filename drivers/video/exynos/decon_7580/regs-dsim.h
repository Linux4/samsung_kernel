...
#define DSIM_CONFIG_NONCONTINUOUS_CLOCK_LANE_MASK	(0x1 << 31)
#define DSIM_CONFIG_CLKLANE_STOP_START		(1 << 30)
#define DSIM_CONFIG_EOT_R03_DISABLE		(1 << 28)
...
#define DSIM_PLLCTRL1_M_PLL0_DEFAULT		(0x5003FA << 0)
#define DSIM_PLLCTRL1_M_PLL0_DEFAULT_MASK	(0xffffffff << 0)
...
/* M_DPHY control register */
#define DSIM_PHYCTRL_M1				(0xac)
#define DSIM_PHYCTRL_M1_PLL_LOCK	(0x1 << 30)
