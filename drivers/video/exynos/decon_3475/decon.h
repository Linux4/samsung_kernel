...
struct decon_resources {
	...
	struct clk *m_sclk_decon_int_vclk_user;
	struct clk *m_sclk_decon_int_eclk_user;

	struct clk *disp_pll;
	struct clk *d_pclk_disp;
	struct clk *m_decon0_eclk;
	struct clk *m_eclk_user;
	struct clk *m_eclk_user_a;
	struct clk *m_bus_pll_top_user;
	struct clk *d_sclk_decon0_eclk;
	struct clk *d_decon0_eclk;
	struct clk *d_decon0_vclk;
	struct clk *m_decon0_vclk;

	/* add for Island */
	struct clk *aclk_dispaud_d;
	struct clk *m_sclk_disp_decon0_vclk;
	struct clk *d_sclk_disp_decon0_vclk;
	struct clk *m_sclk_disp_decon0_eclk;
	struct clk *d_sclk_disp_decon0_eclk;
};
