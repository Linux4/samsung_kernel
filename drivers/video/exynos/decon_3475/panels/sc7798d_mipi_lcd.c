/* drivers/video/exynos/decon_3475/panels/sc7798d_mipi_lcd.c
 *
...
static struct early_suspend    sc7798d_early_suspend;
#endif

static int sc7798d_get_brightness(struct backlight_device *bd)
{
...
static int sc7798d_set_brightness(struct backlight_device *bd)
{
...
static const struct backlight_ops sc7798d_backlight_ops = {
	.get_brightness = sc7798d_get_brightness,
	.update_status = sc7798d_set_brightness,
};
...
static int sc7798d_probe(struct dsim_device *dsim)
{
	...
	bd = backlight_device_register("pwm-backlight.0", NULL,
		NULL, &sc7798d_backlight_ops, NULL);
	if (IS_ERR(bd))
...
static int sc7798d_suspend(struct dsim_device *dsim)
{
	return 1;
}

static int sc7798d_resume(struct dsim_device *dsim)
{
	return 1;
}
...
struct mipi_dsim_lcd_driver sc7798d_mipi_lcd_driver = {
	...
	.suspend	= sc7798d_suspend,
	.resume		= sc7798d_resume,
};
