...
static int sc7798d_displayon_late(struct lcd_info *lcd)
{
	...
	ret = dsim_write_hl_data(lcd, SEQ_INIT4_4, ARRAY_SIZE(SEQ_INIT4_3));
...
static int sc7798d_init(struct lcd_info *lcd)
{
	...
	ret = dsim_write_hl_data(lcd, SEQ_INIT1_6, ARRAY_SIZE(SEQ_INIT1_6));
	...
	ret = dsim_write_hl_data(lcd, SEQ_INIT3_2, ARRAY_SIZE(SEQ_INIT3_2));
