...
/* This is special case, temporal usage */
#define DMA_HEAP_FLAG_ALLOW_KVA BIT(7)
...
static inline bool dma_heap_flags_kva_is_allowed(unsigned long flags)
{
	return !!(flags & DMA_HEAP_FLAG_ALLOW_KVA);
}
