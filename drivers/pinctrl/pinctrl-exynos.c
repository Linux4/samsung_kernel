...
static int exynos_eint_wkup_init(struct samsung_pinctrl_drv_data *d)
{
	 ...
	 */
	if (soc_is_exynos3475() && d->eint_flt_config)
		flt_con = 0;
	else
		flt_con = EXYNOS_EINT_FLTCON_EN;
...
static struct samsung_pin_bank exynos3475_pin_banks0[] = {
	EXYNOS_PIN_BANK_EINTW(bank_type_3, 8, 0x000, "gpa0", 0x00),
	EXYNOS_PIN_BANK_EINTW(bank_type_3, 8, 0x020, "gpa1", 0x04),
	EXYNOS_PIN_BANK_EINTW(bank_type_3, 3, 0x040, "gpq0", 0x08),
};

/* pin banks of exynos3475 pin-controller 1 (AUD) */
static struct samsung_pin_bank exynos3475_pin_banks1[] = {
	EXYNOS_PIN_BANK_EINTG(bank_type_2, 4, 0x000, "gpz0", 0x00),
	EXYNOS_PIN_BANK_EINTG(bank_type_2, 4, 0x020, "gpz1", 0x04),
};

/* pin banks of exynos3475 pin-controller 2 (ESE) */
static struct samsung_pin_bank exynos3475_pin_banks2[] = {
	EXYNOS_PIN_BANK_EINTG(bank_type_2, 4, 0x000, "gpc4", 0x00),
};

/* pin banks of exynos3475 pin-controller 3 (FSYS) */
static struct samsung_pin_bank exynos3475_pin_banks3[] = {
	...
	EXYNOS_PIN_BANK_EINTG(bank_type_2, 6, 0x080, "gpr4", 0x10),
};

/* pin banks of exynos3475 pin-controller 4 (MIF) */
static struct samsung_pin_bank exynos3475_pin_banks4[] = {
	EXYNOS_PIN_BANK_EINTG(bank_type_2, 2, 0x000, "gpm0", 0x00),
};

/* pin banks of exynos3475 pin-controller 5 (NFC) */
static struct samsung_pin_bank exynos3475_pin_banks5[] = {
	EXYNOS_PIN_BANK_EINTG(bank_type_2, 4, 0x000, "gpc2", 0x00),
};

/* pin banks of exynos3475 pin-controller 6 (TOP) */
static struct samsung_pin_bank exynos3475_pin_banks6[] = {
	EXYNOS_PIN_BANK_EINTG(bank_type_2, 8, 0x020, "gpb0", 0x00),
	EXYNOS_PIN_BANK_EINTG(bank_type_2, 2, 0x040, "gpb1", 0x04),
	EXYNOS_PIN_BANK_EINTG(bank_type_2, 3, 0x060, "gpc0", 0x08),
	EXYNOS_PIN_BANK_EINTG(bank_type_2, 4, 0x080, "gpc1", 0x0C),
	EXYNOS_PIN_BANK_EINTG(bank_type_2, 8, 0x0A0, "gpd0", 0x10),
	EXYNOS_PIN_BANK_EINTG(bank_type_2, 8, 0x0C0, "gpd1", 0x14),
	EXYNOS_PIN_BANK_EINTG(bank_type_2, 4, 0x0E0, "gpd2", 0x18),
	EXYNOS_PIN_BANK_EINTG(bank_type_2, 3, 0x100, "gpe0", 0x1C),
	EXYNOS_PIN_BANK_EINTG(bank_type_2, 4, 0x120, "gpf0", 0x20),
	EXYNOS_PIN_BANK_EINTG(bank_type_2, 4, 0x140, "gpf1", 0x24),
};

/* pin banks of exynos3475 pin-controller 7 (TOUCH) */
static struct samsung_pin_bank exynos3475_pin_banks7[] = {
	EXYNOS_PIN_BANK_EINTG(bank_type_2, 3, 0x000, "gpc3", 0x00),
};

struct samsung_pin_ctrl exynos3475_pin_ctrl[] = {
	{
		...
		.suspend	= exynos5430_pinctrl_suspend,
		.resume	= exynos5430_pinctrl_resume,
		.label		= "exynos3475-gpio-ctrl7",
	},
};

#ifdef CONFIG_SEC_GPIO_DVS
int exynos3475_secgpio_get_nr_gpio(void)
{
	int i, j;
	int nr_gpio = 0;

	for (i = 0; i < ARRAY_SIZE(exynos3475_pin_ctrl); i++) {
		for (j = 0; j < exynos3475_pin_ctrl[i].nr_banks; j++)
			nr_gpio += exynos3475_pin_ctrl[i].pin_banks[j].nr_pins;
	}
...
u32 exynos_eint_to_pin_num(int eint)
{
	return exynos3475_pin_ctrl[0].base + eint;
}
#endif
