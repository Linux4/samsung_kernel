...
static struct gpio_dvs_t s5e8835_secgpio_dvs = {
	.result = &gpiomap_result,
	.check_gpio_status = check_gpio_status,
	.skip_grps = "gpv0", /* VTS */
};

const struct secgpio_dvs_data s5e8835_secgpio_dvs_data = {
	.gpio_dvs = &s5e8835_secgpio_dvs,
	.get_nr_gpio = samsung_pinctrl_get_nr_gpio,
};
EXPORT_SYMBOL_GPL(s5e8835_secgpio_dvs_data);
#endif /* CONFIG_PINCTRL_SEC_GPIO_DVS */
