...
#if defined(CONFIG_SENSORS)
static struct sensors_classdev grip_sensor_cdev = {
    .name = "grip_sensor",
    .vendor = "AWINIC",
    .sensor_name = "AW9610X",
    .version = 1,
