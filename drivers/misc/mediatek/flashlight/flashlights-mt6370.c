...
static int is_ss_torch = 0; //Extb 200320-03984, sunhushan.wt, ADD, 2020.4.2, modify for flash torch light level is same in 1 and 2
...
static int mt6370_init(void)
{
	...
	is_decrease_voltage = 0;
	is_ss_torch = 0; //+Extb 200320-03984, sunhushan.wt, ADD, 2020.4.2, modify for flash torch light level is same in 1 and 2
	return 0;
}
