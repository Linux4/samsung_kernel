...
static const u32 vcore_dvfs_binary_rev00[] = {
...
static struct pcm_desc vcore_dvfs_pcm_rev00 = {
	.version	= "pcm_vcore_dvfs_v0.3.9.1_20150901-slow_dvs",
	.base		= vcore_dvfs_binary_rev00,
	.size		= 262,
	.sess		= 1,
	.replace	= 1,
...
static int get_titan_hw_rev(void){
	return board_id;
}
static void spm_vcore_for_hw_rev(int hwrev)
{
	switch (hwrev) {
		case 0:
		case 1:
			__spm_vcore_dvfs.pcmdesc = &vcore_dvfs_pcm_rev00;
			break;
		case 2:
...
void spm_go_to_vcore_dvfs(u32 spm_flags, u32 spm_data)
{
	...
	spm_vcore_for_hw_rev(get_titan_hw_rev());
