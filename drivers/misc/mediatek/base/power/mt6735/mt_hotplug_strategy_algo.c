		...
		unsigned int little_num_online)
{
	...
	for (cpu = hps_ctxt.little_cpu_id_max;
		...
		if(hps_ctxt.quicklanding_enabled == 0)
			break;
...
void hps_algo_smp(void)
{
	...
	for_each_possible_cpu(cpu) {
		per_cpu(hps_percpu_ctxt, cpu).load =
			hps_cpu_get_percpu_load(cpu)*hps_ctxt.cpu_load_weight / 100;
...
ALGO_END_WITH_ACTION:
	...
	hps_warn(
		"(%04lx)(%u)action end(%u)(%u)(%u)(%u) (%u)(%u)(%u)(%u)(%u) (%u)(%u)(%u) (%u)(%u)(%u) (%u)(%u)(%u)(%u)(%u) [(%u)(%u)(%u)]\n",
		...
		hps_ctxt.rush_count, hps_ctxt.tlp_sum, hps_ctxt.tlp_count,
		hps_ctxt.tlp_history_index, hps_ctxt.tlp_avg,
		hps_ctxt.timer_interval,hps_ctxt.cpu_load_weight,hps_ctxt.quicklanding_enabled);
#endif
	hps_ctxt_reset_stas_nolock();
ALGO_END_WO_ACTION:
	mutex_unlock(&hps_ctxt.lock);
