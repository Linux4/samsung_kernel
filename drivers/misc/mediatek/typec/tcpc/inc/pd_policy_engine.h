...
#if (defined(CONFIG_USB_PD_REV30_SNK_CAP_EXT_LOCAL) && defined(CONFIG_HQ_PROJECT_O8))
...
/*A06 code for AL7160A-1630 by shixuanxuan at 20240526 start*/
#if (defined(CONFIG_USB_PD_REV30_REVISION_LOCAL) && defined(CONFIG_HQ_PROJECT_O8))
	PE_GIVE_REVISION,
#endif
