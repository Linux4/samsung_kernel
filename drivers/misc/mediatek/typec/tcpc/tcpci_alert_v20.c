...
//EXTB P210910-05228,chenxu.wt,2021/10/9 add, the USB setting menu is dimmed
#ifdef CONFIG_TCPC_SGM7220
	if (!tcpc->partner) {
		TCPC_ERR("register partner\r\n");
...
//EXTB P210910-05228,chenxu.wt,2021/10/9 add, the USB setting menu is dimmed
	...
	if(tcpc->partner) {
		...
		TCPC_ERR("tcpci_report_usb_port_detached typec_unregister_partner start\r\n");
	}
	tcpc->partner = NULL;
#endif
