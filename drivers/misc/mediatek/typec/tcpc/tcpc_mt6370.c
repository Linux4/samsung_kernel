...
#ifdef CONFIG_USBIF_CV_TEST
	if (en) {
		ret = mt6370_i2c_clr_bit(tcpc_dev, MT6370_REG_IDLE_CTRL, MT6370_REG_AUTOIDLE_EN);
	}
	else {
		ret = mt6370_i2c_set_bit(tcpc_dev, MT6370_REG_IDLE_CTRL, MT6370_REG_AUTOIDLE_EN);
	}
