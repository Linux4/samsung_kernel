...
/*A06 code for SR-AL7160A-01-265 by shixuanxuan at 20240407 end*/
	...
	case TCP_NOTIFY_SINK_VBUS:
		...
		dev_info(rpmd->dev, "%s sink vbus old %dmV %dmA\n",
				    __func__, rpmd->sink_mv_old, rpmd->sink_ma_old);
#ifdef CONFIG_MTK_CHARGER
		...
		charger_dev_set_input_current(rpmd->chg_dev, 1000*rpmd->sink_ma_new);
...
/* HS03s code for SR-AL5625-01-35 by wenyaqi at 20210420 end */
	...
	case TCP_NOTIFY_TYPEC_STATE:
		...
		if (old_state == TYPEC_UNATTACHED &&
			...
			/* A06 code for P240528-06609 by shixuanxuan at 20240531 start*/
			charger_dev_enable_powerpath(rpmd->chg_dev, true);
			/* A06 code for P240528-06609 by shixuanxuan at 20240531 end*/
			/* A06 code for P240610-03562 by shixuanxuan at 20240614 start */
			#ifdef CONFIG_HQ_PROJECT_O8
			g_pr_swap = 0;
			/* A06 code for AL7160A-3570 by shixuanxuan at 20240622 start */
			charger_dev_bypass_chgdet(rpmd->chg_dev, false);
			/* A06 code for AL7160A-3570 by shixuanxuan at 20240622 end */
			pr_info("Charger plug out, g_pr_swap :%d", g_pr_swap);
			#endif
			/* A06 code for P240610-03562 by shixuanxuan at 20240614 end */
			...
			charger_dev_bypass_chgdet(rpmd->chg_dev, false);
			/* A06 code for AL7160A-3570 by shixuanxuan at 20240622 end */
			pr_info("%s OTG plug out, g_pr_swap :%d",__func__, g_pr_swap);
			#endif
			/* A06 code for P240610-03562 by shixuanxuan at 20240614 end */
			     ...
			     enum typec_role role)
{
	...
	if (role == TYPEC_SOURCE) {
		...
		#ifdef CONFIG_HQ_PROJECT_O8
		g_pr_swap = 1;
		pr_err("set power role, g_pr_swap :%d", g_pr_swap);
		#endif
		/* A06 code for P240610-03562 by shixuanxuan at 20240614 end */
