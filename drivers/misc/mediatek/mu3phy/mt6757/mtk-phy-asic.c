...
void usb20_pll_settings(bool host, bool forceOn)
{
	if (host) {
		if (forceOn) {
			...
			/* setting chirp level 0.8V */
			U3PhyWriteField32((phys_addr_t) (uintptr_t) U3D_USBPHYACR5, RG_USB20_CHIRP_EN_OFST,
				RG_USB20_CHIRP_EN, 0x1);	
		} else {
			U3PhyWriteField32((phys_addr_t) (uintptr_t) U3D_PHYA_REG6, RG_SSUSB_RESERVE6_OFST,
			...
			/* setting chirp level default */
			U3PhyWriteField32((phys_addr_t) (uintptr_t) U3D_USBPHYACR5, RG_USB20_CHIRP_EN_OFST,
				RG_USB20_CHIRP_EN, 0x0);	
		}
	}
}
