...
struct _PACKET_PRIVATE_RX_DATA {
...
#define GLUE_GET_PKT_PRIVATE_DATA(_p) \
	((struct _PACKET_PRIVATE_DATA *)(&(((struct sk_buff *)(_p))->cb[0])))
...
#define GLUE_SET_PKT_XTIME2(_p, _rSysTime) \
	(GLUE_GET_PKT_PRIVATE_DATA(_p)->u8ArriveTime = (UINT_64)(_rSysTime))

#define GLUE_GET_PKT_XTIME2(_p)    \
...
#define GLUE_GET_PKT_PRIVATE_RX_DATA(_p) \
	((struct _PACKET_PRIVATE_RX_DATA *)(&(((struct sk_buff *)(_p))->cb[24])))
