...
do {							\
	...
	GLUE_SET_PKT_XTIME2(__Skb__, __SysTime);	\
} while (FALSE)
...
VOID StatsEnvRxTime2Host(ADAPTER_T *prAdapter, struct sk_buff *prSkb);
...
VOID StatsEnvSetPktDelay(IN UINT_8 ucTxOrRx, IN UINT_8 ucIpProto,
			IN UINT_16 u2UdpPort, UINT_32 u4DelayThreshold);

VOID StatsEnvGetPktDelay(OUT PUINT_8 pucTxRxFlag, OUT PUINT_8 pucTxIpProto,
	OUT PUINT_16 pu2TxUdpPort,
