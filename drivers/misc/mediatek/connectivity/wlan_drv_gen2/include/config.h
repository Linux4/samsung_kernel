...
#define CFG_SUPPORT_RN			0	/*support Auto-reconnect*/
#else
#define CFG_SUPPORT_RN			1	/*support Auto-reconnect*/
#endif
...
#define WIFI_MODULE "21"
#define ANDROID_VER "81"
#define RELEASE_DATE "20181024"
