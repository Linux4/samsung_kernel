...
#define HPS_TIMER_INTERVAL_MS		30
...
struct hps_ctxt_struct {
	...
	unsigned int little_num_base_perf_serv_proc;
	unsigned int little_num_base_perf_serv_touch;
	...
	unsigned int quicklanding_enabled;
	unsigned int cpu_load_weight;
