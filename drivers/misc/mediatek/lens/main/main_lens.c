...
static struct stAF_DrvList g_stAF_DrvList[MAX_NUM_OF_LENS] = {
	...
	#ifdef CONFIG_MTK_LENS_AK7372AF_MAIN_SUPPORT
	{1, AFDRV_AK7372AF, AK7372AF_SetI2Cclient, AK7372AF_Ioctl, AK7372AF_Release, NULL},
	#endif
	...
	#ifdef CONFIG_MTK_LENS_DW9807AF_SUPPORT
	{1, AFDRV_DW9807AF, DW9807AF_SetI2Cclient, DW9807AF_Ioctl, DW9807AF_Release, NULL},
	#endif
...
void AF_PowerDown(void)
{
	if (g_pstAF_I2Cclient != NULL) {
		...
		#endif
		#ifdef CONFIG_MTK_LENS_AK7372AF_MAIN_SUPPORT
		AK7372AF_SetI2Cclient(g_pstAF_I2Cclient, &g_AF_SpinLock, &g_s4AF_Opened);
		AK7372AF_PowerDown();
		#endif
