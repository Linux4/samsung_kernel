 ...
 * 20190311 MT6762 GT_ray.lei for Truly 
 *
 */
...
static int s4GT9772AF_ReadReg(unsigned short *a_pu2Result)
{
...
static int initAF(void)
{
	...
	if (*g_pAF_Opened == 1) {
		...
		int i4RetValue = 0;
		char puSendCmd[2] = {0xED, 0xAB}; /* AAC mode */
		char puSendCmd2[2] = {0x06, 0x84};
		char puSendCmd3[2] = {0x07, 0x01};
		//char puSendCmd4[2] = {0x08, 0x49};
