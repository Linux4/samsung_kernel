...
/*
 * DW9808AF voice coil motor driver
 *
 *
 */
...
#define AF_DRVNAME "DW9808AF_DRV"
...
/* ////////////////////////////////////////////////////////////// */
long DW9808AF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
...
int DW9808AF_Release(struct inode *a_pstInode, struct file *a_pstFile)
{
...
int DW9808AF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
...
int DW9808AF_GetFileName(unsigned char *pFileName)
{
