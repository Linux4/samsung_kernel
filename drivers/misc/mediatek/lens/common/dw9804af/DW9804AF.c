...
#define AF_DRVNAME "DW9804AF_DRV"
...
static int s4DW9804AF_ReadReg(unsigned short *a_pu2Result)
{
...
static int s4AF_WriteReg(u16 a_u2Data)
{
	...
	char puSendCmd[4] = { 0x03, 0x04, (char)(a_u2Data >> 8), (char)(a_u2Data & 0xFF) };
...
static inline int moveAF(unsigned long a_u4Position)
{
	...
	if (*g_pAF_Opened == 1) {
		...
		initdrv();
		ret = s4DW9804AF_ReadReg(&InitPos);
...
/* ////////////////////////////////////////////////////////////// */
long DW9804AF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command, unsigned long a_u4Param)
{
	long i4RetValue = 0;
...
int DW9804AF_Release(struct inode *a_pstInode, struct file *a_pstFile)
{
	LOG_INF("Start\n");
...
void DW9804AF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient, spinlock_t *pAF_SpinLock, int *pAF_Opened)
{
