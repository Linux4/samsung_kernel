...
#define AF_DRVNAME "TRULY_HI5021Q_GT9778AF_DRV"
...
/* ////////////////////////////////////////////////////////////// */
long TRULY_HI5021Q_GT9778AF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
...
int TRULY_HI5021Q_GT9778AF_Release(struct inode *a_pstInode, struct file *a_pstFile)
{
     int Ret = 0;
...
int TRULY_HI5021Q_GT9778AF_PowerDown(struct i2c_client *pstAF_I2Cclient,
             int *pAF_Opened)
{
...
int TRULY_HI5021Q_GT9778AF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
...
int TRULY_HI5021Q_GT9778AF_GetFileName(unsigned char *pFileName)
{
