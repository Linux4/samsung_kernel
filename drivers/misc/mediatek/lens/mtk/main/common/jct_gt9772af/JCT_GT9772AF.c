...
/*
 * JCT_GT9772AF voice coil motor driver
...
#define AF_DRVNAME "JCT_GT9772AF_DRV"
...
static int s4JCT_GT9772AF_ReadReg(unsigned short *a_pu2Result)
{
...
/* ////////////////////////////////////////////////////////////// */
long JCT_GT9772AF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
...
int JCT_GT9772AF_Release(struct inode *a_pstInode, struct file *a_pstFile)
{
	LOG_INF("Start\n");
...
int JCT_GT9772AF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
...
int JCT_GT9772AF_GetFileName(unsigned char *pFileName)
{
