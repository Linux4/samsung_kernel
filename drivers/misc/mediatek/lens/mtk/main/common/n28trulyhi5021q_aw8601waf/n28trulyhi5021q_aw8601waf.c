...
#include "lens_info.h"
#include "n28trulyhi5021q_aw8601waf.h"
...
long N28TRULYHI5021Q_AW8601WAF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
...
int N28TRULYHI5021Q_AW8601WAF_Release(struct inode *a_pstInode, struct file *a_pstFile)
{
	AWLOGI("Start.");
...
int N28TRULYHI5021Q_AW8601WAF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
...
int N28TRULYHI5021Q_AW8601WAF_GetFileName(unsigned char *pFileName)
{
