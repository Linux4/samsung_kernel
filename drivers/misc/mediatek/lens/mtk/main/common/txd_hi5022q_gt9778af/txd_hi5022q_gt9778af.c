...
#define AF_DRVNAME "TXD_HI5022Q_GT9778AF_DRV"
...
static int initAF(void)
{
     ...
     if (*g_pAF_Opened == 1) {
		...
		char puSendCmd2[2] = {(char)(0x06), (char)(0x61)};
		char puSendCmd3[2] = {(char)(0x07), (char)(0x37)};
		char puSendCmd4[2] = {(char)(0x0B), (char)(0x00)};
...
/* ////////////////////////////////////////////////////////////// */
long TXD_HI5022Q_GT9778AF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
...
int TXD_HI5022Q_GT9778AF_Release(struct inode *a_pstInode, struct file *a_pstFile)
{
     int Ret = 0;
...
int TXD_HI5022Q_GT9778AF_PowerDown(struct i2c_client *pstAF_I2Cclient,
             int *pAF_Opened)
{
...
int TXD_HI5022Q_GT9778AF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
...
int TXD_HI5022Q_GT9778AF_GetFileName(unsigned char *pFileName)
{
