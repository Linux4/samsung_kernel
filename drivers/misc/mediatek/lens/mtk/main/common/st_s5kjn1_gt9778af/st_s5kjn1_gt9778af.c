...
#define AF_DRVNAME "ST_S5KJN1_GT9778AF_DRV"
...
static int initAF(void)
{
     ...
     if (*g_pAF_Opened == 1) {
		...
		char puSendCmd2[2] = {(char)(0x06), (char)(0xA1)};
		char puSendCmd3[2] = {(char)(0x07), (char)(0x26)};
...
/* ////////////////////////////////////////////////////////////// */
long ST_S5KJN1_GT9778AF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
...
int ST_S5KJN1_GT9778AF_Release(struct inode *a_pstInode, struct file *a_pstFile)
{
     int Ret = 0;
...
int ST_S5KJN1_GT9778AF_PowerDown(struct i2c_client *pstAF_I2Cclient,
             int *pAF_Opened)
{
...
int ST_S5KJN1_GT9778AF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
...
int ST_S5KJN1_GT9778AF_GetFileName(unsigned char *pFileName)
{
