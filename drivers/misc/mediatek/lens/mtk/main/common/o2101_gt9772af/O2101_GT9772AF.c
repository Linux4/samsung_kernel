...
#define AF_DRVNAME "O2101_GT9772AF_DRV"
...
/* ////////////////////////////////////////////////////////////// */
long O2101_GT9772AF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
...
int O2101_GT9772AF_Release(struct inode *a_pstInode, struct file *a_pstFile)
{
	int Ret = 0;

	LOG_INF("Start\n");
/*hs04 code for DEAL6398A-1034 by xutengtao at 2022/09/05 start */
    if (*g_pAF_Opened == 2) {
		LOG_INF("Wait\n");
		setPosition(300);
		msleep(15);
...
/*hs04 code for DEAL6398A-1034 by xutengtao at 2022/09/05 end */
	if (*g_pAF_Opened) {
		LOG_INF("Free\n");
...
int O2101_GT9772AF_PowerDown(struct i2c_client *pstAF_I2Cclient,
			int *pAF_Opened)
{
...
int O2101_GT9772AF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
...
int O2101_GT9772AF_GetFileName(unsigned char *pFileName)
{
