...
/*
 * GT9772AFHLT voice coil motor driver
 *
 *
 */
...
#define AF_DRVNAME "GT9772AFHLT_DRV"
...
/* ////////////////////////////////////////////////////////////// */
long GT9772AFHLT_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
...
int GT9772AFHLT_Release(struct inode *a_pstInode, struct file *a_pstFile)
{
	int Ret = 0;
...
int GT9772AFHLT_PowerDown(struct i2c_client *pstAF_I2Cclient,
			int *pAF_Opened)
{
...
int GT9772AFHLT_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
...
int GT9772AFHLT_GetFileName(unsigned char *pFileName)
{
