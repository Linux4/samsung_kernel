...
/*
 * A1401AW8601WAF voice coil motor driver
 */
...
static int s4A1401AW8601WAF_ReadReg(unsigned char a_uAddr, unsigned char *a_puData,
...
static inline int moveAF(unsigned long a_u4Position)
{
	...
	if (*g_pAF_Opened == 1) {
		...
		ret = s4A1401AW8601WAF_ReadReg(addr, pos, 2);
		if (ret == 0) {
...
long A1401AW8601WAF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
...
int A1401AW8601WAF_Release(struct inode *a_pstInode, struct file *a_pstFile)
{
	AWLOGI("Start.");
...
int A1401AW8601WAF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
...
int A1401AW8601WAF_GetFileName(unsigned char *pFileName)
{
...
MODULE_DESCRIPTION("A1401AW8601WAF VCM Driver");
