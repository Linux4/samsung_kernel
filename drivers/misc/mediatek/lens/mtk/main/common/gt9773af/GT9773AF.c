...
/*
 * GT9773AF voice coil motor driver
 *
 *
 */
...
#define AF_DRVNAME "GT9773AF_DRV"
...
/* ////////////////////////////////////////////////////////////// */
long GT9773AF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
...
int GT9773AF_Release(struct inode *a_pstInode, struct file *a_pstFile)
{
	int Ret = 0;
...
int GT9773AF_PowerDown(struct i2c_client *pstAF_I2Cclient,
			int *pAF_Opened)
{
...
int GT9773AF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
...
int GT9773AF_GetFileName(unsigned char *pFileName)
{
