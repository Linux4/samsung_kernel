...
#define AF_DRVNAME "N28HI5021QDC_DW9800WAF_DRV"
...
static int s4N28HI5021QDC_DW9800WAF_ReadReg(unsigned short *a_pu2Result)
{
...
static int initdrv(void)
{
	...
	{0x02, 0x02}, {0x06, 0x10}, {0x07, 0x62}, {0xFE, 0xFE},
	};
...
/* ////////////////////////////////////////////////////////////// */
long N28HI5021QDC_DW9800WAF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
...
int N28HI5021QDC_DW9800WAF_Release(struct inode *a_pstInode, struct file *a_pstFile)
{
	LOG_INF("Start\n");
...
int N28HI5021QDC_DW9800WAF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
	spinlock_t *pAF_SpinLock, int *pAF_Opened)
{
	...
	if (*g_pAF_Opened == 1) {
		initdrv();
		ret = s4N28HI5021QDC_DW9800WAF_ReadReg(&InitPos);
...
int N28HI5021QDC_DW9800WAF_GetFileName(unsigned char *pFileName)
{
