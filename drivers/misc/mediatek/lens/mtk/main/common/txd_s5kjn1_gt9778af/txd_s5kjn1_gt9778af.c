...
#define AF_DRVNAME "TXD_S5KJN1_GT9778AF_DRV"
...
/* ////////////////////////////////////////////////////////////// */
long TXD_S5KJN1_GT9778AF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
...
int TXD_S5KJN1_GT9778AF_Release(struct inode *a_pstInode, struct file *a_pstFile)
{
     int Ret = 0;
...
int TXD_S5KJN1_GT9778AF_PowerDown(struct i2c_client *pstAF_I2Cclient,
             int *pAF_Opened)
{
...
int TXD_S5KJN1_GT9778AF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
...
int TXD_S5KJN1_GT9778AF_GetFileName(unsigned char *pFileName)
{
