...
/*
 * TXD_GT9772AF voice coil motor driver
 *
 *
 */
...
#define AF_DRVNAME "TXD_GT9772AF_DRV"
...
/* ////////////////////////////////////////////////////////////// */
long TXD_GT9772AF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
...
int TXD_GT9772AF_Release(struct inode *a_pstInode, struct file *a_pstFile)
{
	int Ret = 0;
...
int TXD_GT9772AF_PowerDown(struct i2c_client *pstAF_I2Cclient,
			int *pAF_Opened)
{
...
int TXD_GT9772AF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
...
int TXD_GT9772AF_GetFileName(unsigned char *pFileName)
{
