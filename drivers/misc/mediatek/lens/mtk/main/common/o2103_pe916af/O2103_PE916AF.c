...
#define AF_DRVNAME "O2103_PE916AF_DRV"
...
/* ////////////////////////////////////////////////////////////// */
long O2103_PE916AF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
...
int O2103_PE916AF_Release(struct inode *a_pstInode, struct file *a_pstFile)
{
    int Ret = 0;
...
int O2103_PE916AF_PowerDown(struct i2c_client *pstAF_I2Cclient,int *pAF_Opened)
{
...
int O2103_PE916AF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
...
int O2103_PE916AF_GetFileName(unsigned char *pFileName)
{
