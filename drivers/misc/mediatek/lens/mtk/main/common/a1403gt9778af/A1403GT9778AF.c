...
/*Yanjie for HQ 
 * A1403GT9778AF voice coil motor driver
 *
 *
 */
...
#define AF_DRVNAME "A1403GT9778AF_DRV"
...
static u8 read_data(u8 addr)
{
	...
	LOG_INF("[A1403GT9778AF]  get_byte %d\n", get_byte);
	return get_byte;
}
static int s4AF_ReadReg(unsigned short *a_pu2Result)
{
	...
	*a_pu2Result = (read_data(0x03) << 8) + (read_data(0x04) & 0xff);
	printk("[A1403GT9778AF]  s4A1403GT9778AF_ReadReg %d\n", *a_pu2Result);
	return 0;
}
...
static int s4AF_WriteReg(u16 a_u2Data)
{
	...
	printk("[A1403GT9778AF]  s4A1403GT9778AF_write reg %d\n", i4RetValue);
    if (i4RetValue < 0)
    {
...
/* ////////////////////////////////////////////////////////////// */
long A1403GT9778AF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command, unsigned long a_u4Param)
{
	long i4RetValue = 0;
...
int A1403GT9778AF_Release(struct inode *a_pstInode, struct file *a_pstFile)
{
	LOG_INF("Start\n");
...
int A1403GT9778AF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient, spinlock_t *pAF_SpinLock, int *pAF_Opened)
{
...
int A1403GT9778AF_GetFileName(unsigned char *pFileName)
{
