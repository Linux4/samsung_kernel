...
#define AF_DRVNAME "TRULY_S5KJN1_GT9778AF_DRV"
...
static int initAF(void)
{
     ...
     if (*g_pAF_Opened == 1) {
		...
		char puSendCmd3[2] = {(char)(0x07), (char)(0x2A)};
...
/* ////////////////////////////////////////////////////////////// */
long TRULY_S5KJN1_GT9778AF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
...
int TRULY_S5KJN1_GT9778AF_Release(struct inode *a_pstInode, struct file *a_pstFile)
{
     int Ret = 0;
...
int TRULY_S5KJN1_GT9778AF_PowerDown(struct i2c_client *pstAF_I2Cclient,
             int *pAF_Opened)
{
...
int TRULY_S5KJN1_GT9778AF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
...
int TRULY_S5KJN1_GT9778AF_GetFileName(unsigned char *pFileName)
{
