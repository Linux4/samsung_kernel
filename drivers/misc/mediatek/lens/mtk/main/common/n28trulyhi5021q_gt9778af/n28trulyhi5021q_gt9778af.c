...
#define AF_DRVNAME "N28TRULYHI5021Q_GT9778AF_DRV"
...
static int initAF(void)
{
     ...
     if (*g_pAF_Opened == 1) {
         ...
         s4AF_WriteReg(0, 0x06, 0xA1);
         s4AF_WriteReg(0, 0x07, 0x26);
...
/* ////////////////////////////////////////////////////////////// */
long N28TRULYHI5021Q_GT9778AF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
...
int N28TRULYHI5021Q_GT9778AF_Release(struct inode *a_pstInode, struct file *a_pstFile)
{
     int Ret = 0;
...
int N28TRULYHI5021Q_GT9778AF_PowerDown(struct i2c_client *pstAF_I2Cclient,
             int *pAF_Opened)
{
...
int N28TRULYHI5021Q_GT9778AF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
...
int N28TRULYHI5021Q_GT9778AF_GetFileName(unsigned char *pFileName)
{
