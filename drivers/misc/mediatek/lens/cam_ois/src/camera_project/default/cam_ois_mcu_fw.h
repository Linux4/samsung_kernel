#ifndef CAM_OIS_MCU_FW_H
#define CAM_OIS_MCU_FW_H
...
extern int cam_ois_mcu_fw_update(struct mcu_info *mcu_info, struct i2c_client *client);

extern void cam_ois_mcu_print_fw_version(struct mcu_info *mcu_info, char *str);
