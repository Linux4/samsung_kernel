...
#ifdef CONFIG_MTK_LENS_AK7372AF_SUPPORT
#define AK7372AF_SetI2Cclient AK7372AF_SetI2Cclient_Main2
#define AK7372AF_Ioctl AK7372AF_Ioctl_Main2
#define AK7372AF_Release AK7372AF_Release_Main2
#define AK7372AF_PowerDown AK7372AF_PowerDown_Main2
extern int AK7372AF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient, spinlock_t *pAF_SpinLock, int *pAF_Opened);
extern long AK7372AF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command, unsigned long a_u4Param);
extern int AK7372AF_Release(struct inode *a_pstInode, struct file *a_pstFile);
extern int AK7372AF_PowerDown(void);
#endif
