...
static int mtktsusb_register_thermal(void)
{
	...
	/* trips : trip 0~2 */
	/*A06 code for AL7160A-21 by xiongxiaoliang at 20240327 start*/
	#if defined(CONFIG_HQ_PROJECT_O8)
	thz_dev = mtk_thermal_zone_device_register("mtktsflash", num_trip,
					NULL, /* name: mtktsflash ??? */
	...
	thz_dev = mtk_thermal_zone_device_register("mtktsusb", num_trip,
					...
					interval * 1000);
	#endif
	/*A06 code for AL7160A-21 by xiongxiaoliang at 20240327 end*/
