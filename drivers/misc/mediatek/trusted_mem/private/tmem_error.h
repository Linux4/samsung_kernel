...
enum TMEM_ERROR_STATUS {
	...
	TMEM_CSMC_SEND_CMD_FAILED = -2008,
	TMEM_CSMC_WAIT_COMPLETE_TIMEOUTED = -2009,
	TMEM_CSMC_RECEIVE_CMD_FAILED = -2010,
	TMEM_CSMC_TA_BAD_RESPONSE = -2011,
	TMEM_CSMC_OPEN_SESSION_OUT_OF_MEMORY = -2012,
	TMEM_CSMC_REGISTER_SHARE_MEMORY_FAILED = -2013,
	TMEM_CSMC_REGISTER_NOTIFY_CHAIN_FAILED = -2014,
	TMEM_CSMC_OPEN_DEVICE_FAILED = -2015,
	TMEM_CSMC_GRANT_ACCESS_FAILED = -2016,
