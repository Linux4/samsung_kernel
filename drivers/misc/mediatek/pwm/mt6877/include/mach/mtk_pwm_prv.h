...
#define PWM_3DLCM	(PWM_BASE+0x70)
#define PWM_3DLCM_ENABLE_OFFSET  0

#define PWM_INT_ENABLE (PWM_BASE+0x4)
#define PWM_INT_STATUS (PWM_BASE+0xc)
#define PWM_INT_ACK (PWM_BASE+0x14)
#define PWM_EN_STATUS (PWM_BASE+0x1c)

#define PWM_CK_26M_SEL (PWM_BASE+0x74)
