...
unsigned int DW9763_write_region(struct i2c_client *client, struct CAM_CAL_SENSOR_INFO sensor_info, unsigned int addr,
...
unsigned int BL24SA64_write_region(struct i2c_client *client, struct CAM_CAL_SENSOR_INFO sensor_info, unsigned int addr,
				unsigned char *data, unsigned int size)
{
	unsigned int ret = 0;
#if EEPROM_WRITE_EN
