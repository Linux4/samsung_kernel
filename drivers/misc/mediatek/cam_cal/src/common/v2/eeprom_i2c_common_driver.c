...
unsigned int Otp_read_region_S5K4HAYX(struct i2c_client *client, struct CAM_CAL_SENSOR_INFO sensor_info,
	unsigned int addr, unsigned char *data, unsigned int size)
{
	u32 ret = 0;
...
unsigned int Otp_read_region_S5K3L6(struct i2c_client *client, struct CAM_CAL_SENSOR_INFO sensor_info,
	unsigned int addr, unsigned char *data, unsigned int size)
{
	u32 ret = 0;
...
unsigned int Otp_read_region_SR846(struct i2c_client *client, struct CAM_CAL_SENSOR_INFO sensor_info,
	unsigned int addr, unsigned char *data, unsigned int size)
{
	u16 ret = 0;
...
unsigned int Otp_read_region_GC5035(struct i2c_client *client, struct CAM_CAL_SENSOR_INFO sensor_info,
	unsigned int addr, unsigned char *data, unsigned int size)
{
	u8 OTP_clk_en_rd = 0;
	u8 OTP_clk_en_wr = 0;
...
unsigned int Otp_read_region_GC02M1B(struct i2c_client *client, struct CAM_CAL_SENSOR_INFO sensor_info,
	unsigned int addr, unsigned char *data, unsigned int size)
{
