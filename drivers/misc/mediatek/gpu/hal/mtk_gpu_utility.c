...
void (*mtk_custom_lowbound_gpu_freq_idx_fp)(unsigned int ui32FreqLevel) = NULL;
EXPORT_SYMBOL(mtk_custom_lowbound_gpu_freq_idx_fp);

bool mtk_custom_lowbound_gpu_freq_idx(unsigned int ui32FreqLevel)
{
	if (NULL != mtk_custom_lowbound_gpu_freq_idx_fp)
	{
		mtk_custom_lowbound_gpu_freq_idx_fp(ui32FreqLevel);
		return true;
	}
	return false;
}
EXPORT_SYMBOL(mtk_custom_lowbound_gpu_freq_idx);

//-----------------------------------------------------------------------------

void (*mtk_custom_upbound_gpu_freq_idx_fp)(unsigned int ui32FreqLevel) = NULL;
EXPORT_SYMBOL(mtk_custom_upbound_gpu_freq_idx_fp);

bool mtk_custom_upbound_gpu_freq_idx(unsigned int ui32FreqLevel)
{
    if (NULL != mtk_custom_upbound_gpu_freq_idx_fp)
    {
        mtk_custom_upbound_gpu_freq_idx_fp(ui32FreqLevel);
        return true;
    }
    return false;
}
EXPORT_SYMBOL(mtk_custom_upbound_gpu_freq_idx);

//-----------------------------------------------------------------------------

void (*mtk_custom_lowbound_gpu_freq_fp)(unsigned long) = NULL;
EXPORT_SYMBOL(mtk_custom_lowbound_gpu_freq_fp);

bool mtk_custom_lowbound_gpu_freq(unsigned long ui32Freq)
{
	if (NULL != mtk_custom_lowbound_gpu_freq_fp)
	{
		mtk_custom_lowbound_gpu_freq_fp(ui32Freq);
		return true;
	}
	return false;
}
EXPORT_SYMBOL(mtk_custom_lowbound_gpu_freq);

//-----------------------------------------------------------------------------

void (*mtk_custom_upbound_gpu_freq_fp)(unsigned long ui32Freq) = NULL;
...
bool mtk_custom_upbound_gpu_freq(unsigned long ui32Freq)
{
    ...
    {
		mtk_custom_upbound_gpu_freq_fp(ui32Freq);
        return true;
    }
    return false;
}
...
unsigned int (*mtk_get_custom_lowbound_gpu_freq_idx_fp)(void) = NULL;
EXPORT_SYMBOL(mtk_get_custom_lowbound_gpu_freq_idx_fp);

bool mtk_get_custom_lowbound_gpu_freq_idx(unsigned int *pui32FreqLevel)
{
	if ((NULL != mtk_get_custom_lowbound_gpu_freq_idx_fp) && (NULL != pui32FreqLevel))
	{
		*pui32FreqLevel = mtk_get_custom_lowbound_gpu_freq_idx_fp();
		return true;
	}
	return false;
}
EXPORT_SYMBOL(mtk_get_custom_lowbound_gpu_freq_idx);

//-----------------------------------------------------------------------------

unsigned int (*mtk_get_custom_upbound_gpu_freq_idx_fp)(void) = NULL;
EXPORT_SYMBOL(mtk_get_custom_upbound_gpu_freq_idx_fp);

bool mtk_get_custom_upbound_gpu_freq_idx(unsigned int *pui32FreqLevel)
{
    if ((NULL != mtk_get_custom_upbound_gpu_freq_idx_fp) && (NULL != pui32FreqLevel))
    {
        *pui32FreqLevel = mtk_get_custom_upbound_gpu_freq_idx_fp();
        return true;
    }
    return false;
}
EXPORT_SYMBOL(mtk_get_custom_upbound_gpu_freq_idx);

//-----------------------------------------------------------------------------

unsigned long (*mtk_get_custom_lowbound_gpu_freq_fp)(void) = NULL;
EXPORT_SYMBOL(mtk_get_custom_lowbound_gpu_freq_fp);

bool mtk_get_custom_lowbound_gpu_freq(unsigned long *pui32Freq)
{
	if ((NULL != mtk_get_custom_lowbound_gpu_freq_fp) && (NULL != pui32Freq))
	{
		*pui32Freq = mtk_get_custom_lowbound_gpu_freq_fp();
		return true;
	}
	return false;
}
EXPORT_SYMBOL(mtk_get_custom_lowbound_gpu_freq);
...
{
	if ((NULL != mtk_get_custom_upbound_gpu_freq_fp) && (NULL != pui32Freq))
	{
		*pui32Freq = mtk_get_custom_upbound_gpu_freq_fp();
		return true;
    }
    return false;
}
