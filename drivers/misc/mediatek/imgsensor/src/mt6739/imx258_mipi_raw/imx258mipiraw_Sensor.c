...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[7] = {
	{4208, 3120,    0,    0, 4208, 3120, 4208, 3120,
	   40,   12, 4128, 3096,    0,    0, 4128, 3096},	/* Preview */

	{4208, 3120,    0,    0, 4208, 3120, 4208, 3120,
	   40,   12, 4128, 3096,    0,    0, 4128, 3096},	/* Capture */

	{4208, 3120,    0,    0, 4208, 3120, 4208, 3120,
	   40,  398, 4128, 2324,    0,    0, 4128, 2324},	/* Video */

	{4208, 3120,    0,    0, 4208, 3120, 1052,  780,
	    14,   6, 1024,  768,    0,    0, 1024,  768},	/* Hight speed video - NOT USED */

	{4208, 3120,    0,    0, 4208, 3120, 1052,  780,
	    14,   6, 1024,  768,    0,    0, 1024,  768},	/* Slim video - NOT USED */

	{4208, 3120,    0,    0, 4208, 3120, 4208, 3120,
	    0,    0, 4208, 3120,    0,    0, 4208, 3120},	 /*custom1 */
...
static void sensor_init(void)
{
	...
	ret |= write_cmos_sensor(0x0136, 0x1A);
	ret |= write_cmos_sensor(0x0137, 0x00);
	ret |= write_cmos_sensor(0x3051, 0x00);
	ret |= write_cmos_sensor(0x3052, 0x00);
	ret |= write_cmos_sensor(0x4E21, 0x14);
	ret |= write_cmos_sensor(0x6B11, 0xCF);
	ret |= write_cmos_sensor(0x7FF0, 0x08);
	ret |= write_cmos_sensor(0x7FF1, 0x0F);
	ret |= write_cmos_sensor(0x7FF2, 0x08);
	ret |= write_cmos_sensor(0x7FF3, 0x1B);
	ret |= write_cmos_sensor(0x7FF4, 0x23);
	ret |= write_cmos_sensor(0x7FF5, 0x60);
	ret |= write_cmos_sensor(0x7FF6, 0x00);
	ret |= write_cmos_sensor(0x7FF7, 0x01);
	ret |= write_cmos_sensor(0x7FF8, 0x00);
	ret |= write_cmos_sensor(0x7FF9, 0x78);
	ret |= write_cmos_sensor(0x7FFA, 0x00);
	ret |= write_cmos_sensor(0x7FFB, 0x00);
	ret |= write_cmos_sensor(0x7FFC, 0x00);
	ret |= write_cmos_sensor(0x7FFD, 0x00);
	ret |= write_cmos_sensor(0x7FFE, 0x00);
	ret |= write_cmos_sensor(0x7FFF, 0x03);
	ret |= write_cmos_sensor(0x7F76, 0x03);
	ret |= write_cmos_sensor(0x7F77, 0xFE);
	ret |= write_cmos_sensor(0x7FA8, 0x03);
	ret |= write_cmos_sensor(0x7FA9, 0xFE);
	ret |= write_cmos_sensor(0x7B24, 0x81);
	ret |= write_cmos_sensor(0x7B25, 0x00);
	ret |= write_cmos_sensor(0x6564, 0x07);
	ret |= write_cmos_sensor(0x6B0D, 0x41);
	ret |= write_cmos_sensor(0x653D, 0x04);
	ret |= write_cmos_sensor(0x6B05, 0x8C);
	ret |= write_cmos_sensor(0x6B06, 0xF9);
	ret |= write_cmos_sensor(0x6B08, 0x65);
	ret |= write_cmos_sensor(0x6B09, 0xFC);
	ret |= write_cmos_sensor(0x6B0A, 0xCF);
	ret |= write_cmos_sensor(0x6B0B, 0xD2);
	ret |= write_cmos_sensor(0x6700, 0x0E);
	ret |= write_cmos_sensor(0x6707, 0x0E);
	ret |= write_cmos_sensor(0x5F04, 0x00);
	ret |= write_cmos_sensor(0x5F05, 0xED);
	/* BAD PIXEL BLOCK*/
	ret |= write_cmos_sensor(0x94C7, 0xFF);
	ret |= write_cmos_sensor(0x94C8, 0xFF);
	ret |= write_cmos_sensor(0x94C9, 0xFF);
	ret |= write_cmos_sensor(0x95C7, 0xFF);
	ret |= write_cmos_sensor(0x95C8, 0xFF);
	ret |= write_cmos_sensor(0x95C9, 0xFF);
	ret |= write_cmos_sensor(0x94C4, 0x3F);
	ret |= write_cmos_sensor(0x94C5, 0x3F);
	ret |= write_cmos_sensor(0x94C6, 0x3F);
	ret |= write_cmos_sensor(0x95C4, 0x3F);
	ret |= write_cmos_sensor(0x95C5, 0x3F);
	ret |= write_cmos_sensor(0x95C6, 0x3F);
	ret |= write_cmos_sensor(0x94C1, 0x02);
	ret |= write_cmos_sensor(0x94C2, 0x02);
	ret |= write_cmos_sensor(0x94C3, 0x02);
	ret |= write_cmos_sensor(0x95C1, 0x02);
	ret |= write_cmos_sensor(0x95C2, 0x02);
	ret |= write_cmos_sensor(0x95C3, 0x02);
	ret |= write_cmos_sensor(0x94BE, 0x0C);
	ret |= write_cmos_sensor(0x94BF, 0x0C);
	ret |= write_cmos_sensor(0x94C0, 0x0C);
	ret |= write_cmos_sensor(0x95BE, 0x0C);
	ret |= write_cmos_sensor(0x95BF, 0x0C);
	ret |= write_cmos_sensor(0x95C0, 0x0C);
	ret |= write_cmos_sensor(0x94D0, 0x74);
	ret |= write_cmos_sensor(0x94D1, 0x74);
	ret |= write_cmos_sensor(0x94D2, 0x74);
	ret |= write_cmos_sensor(0x95D0, 0x74);
	ret |= write_cmos_sensor(0x95D1, 0x74);
	ret |= write_cmos_sensor(0x95D2, 0x74);
	ret |= write_cmos_sensor(0x94CD, 0x2E);
	ret |= write_cmos_sensor(0x94CE, 0x2E);
	ret |= write_cmos_sensor(0x94CF, 0x2E);
	ret |= write_cmos_sensor(0x95CD, 0x2E);
	ret |= write_cmos_sensor(0x95CE, 0x2E);
	ret |= write_cmos_sensor(0x95CF, 0x2E);
	ret |= write_cmos_sensor(0x94CA, 0x4C);
	ret |= write_cmos_sensor(0x94CB, 0x4C);
	ret |= write_cmos_sensor(0x94CC, 0x4C);
	ret |= write_cmos_sensor(0x95CA, 0x4C);
	ret |= write_cmos_sensor(0x95CB, 0x4C);
	ret |= write_cmos_sensor(0x95CC, 0x4C);
	ret |= write_cmos_sensor(0x900E, 0x32);
	ret |= write_cmos_sensor(0x94E2, 0xFF);
	ret |= write_cmos_sensor(0x94E3, 0xFF);
	ret |= write_cmos_sensor(0x94E4, 0xFF);
	ret |= write_cmos_sensor(0x95E2, 0xFF);
	ret |= write_cmos_sensor(0x95E3, 0xFF);
	ret |= write_cmos_sensor(0x95E4, 0xFF);
	ret |= write_cmos_sensor(0x94DF, 0x6E);
	ret |= write_cmos_sensor(0x94E0, 0x6E);
	ret |= write_cmos_sensor(0x94E1, 0x6E);
	ret |= write_cmos_sensor(0x95DF, 0x6E);
	ret |= write_cmos_sensor(0x95E0, 0x6E);
	ret |= write_cmos_sensor(0x95E1, 0x6E);
	ret |= write_cmos_sensor(0x7FCC, 0x01);
	ret |= write_cmos_sensor(0x7B78, 0x00);
	ret |= write_cmos_sensor(0x9401, 0x35);
	ret |= write_cmos_sensor(0x9403, 0x23);
	ret |= write_cmos_sensor(0x9405, 0x23);
	ret |= write_cmos_sensor(0x9406, 0x00);
	ret |= write_cmos_sensor(0x9407, 0x31);
	ret |= write_cmos_sensor(0x9408, 0x00);
	ret |= write_cmos_sensor(0x9409, 0x1B);
	ret |= write_cmos_sensor(0x940A, 0x00);
	ret |= write_cmos_sensor(0x940B, 0x15);
	ret |= write_cmos_sensor(0x940D, 0x3F);
	ret |= write_cmos_sensor(0x940F, 0x3F);
	ret |= write_cmos_sensor(0x9411, 0x3F);
	ret |= write_cmos_sensor(0x9413, 0x64);
	ret |= write_cmos_sensor(0x9415, 0x64);
	ret |= write_cmos_sensor(0x9417, 0x64);
	ret |= write_cmos_sensor(0x941D, 0x34);
	ret |= write_cmos_sensor(0x941F, 0x01);
	ret |= write_cmos_sensor(0x9421, 0x01);
	ret |= write_cmos_sensor(0x9423, 0x01);
	ret |= write_cmos_sensor(0x9425, 0x23);
	ret |= write_cmos_sensor(0x9427, 0x23);
	ret |= write_cmos_sensor(0x9429, 0x23);
	ret |= write_cmos_sensor(0x942B, 0x2F);
	ret |= write_cmos_sensor(0x942D, 0x1A);
	ret |= write_cmos_sensor(0x942F, 0x14);
	ret |= write_cmos_sensor(0x9431, 0x3F);
	ret |= write_cmos_sensor(0x9433, 0x3F);
	ret |= write_cmos_sensor(0x9435, 0x3F);
	ret |= write_cmos_sensor(0x9437, 0x6B);
	ret |= write_cmos_sensor(0x9439, 0x7C);
	ret |= write_cmos_sensor(0x943B, 0x81);
	ret |= write_cmos_sensor(0x9443, 0x0F);
	ret |= write_cmos_sensor(0x9445, 0x0F);
	ret |= write_cmos_sensor(0x9447, 0x0F);
	ret |= write_cmos_sensor(0x9449, 0x0F);
	ret |= write_cmos_sensor(0x944B, 0x0F);
	ret |= write_cmos_sensor(0x944D, 0x0F);
	ret |= write_cmos_sensor(0x944F, 0x1E);
	ret |= write_cmos_sensor(0x9451, 0x0F);
	ret |= write_cmos_sensor(0x9453, 0x0B);
	ret |= write_cmos_sensor(0x9455, 0x28);
	ret |= write_cmos_sensor(0x9457, 0x13);
	ret |= write_cmos_sensor(0x9459, 0x0C);
	ret |= write_cmos_sensor(0x945D, 0x00);
	ret |= write_cmos_sensor(0x945E, 0x00);
	ret |= write_cmos_sensor(0x945F, 0x00);
	ret |= write_cmos_sensor(0x946D, 0x00);
	ret |= write_cmos_sensor(0x946F, 0x10);
	ret |= write_cmos_sensor(0x9471, 0x10);
	ret |= write_cmos_sensor(0x9473, 0x40);
	ret |= write_cmos_sensor(0x9475, 0x2E);
	ret |= write_cmos_sensor(0x9477, 0x10);
	ret |= write_cmos_sensor(0x9478, 0x0A);
	ret |= write_cmos_sensor(0x947B, 0xE0);
	ret |= write_cmos_sensor(0x947C, 0xE0);
	ret |= write_cmos_sensor(0x947D, 0xE0);
	ret |= write_cmos_sensor(0x947E, 0xE0);
	ret |= write_cmos_sensor(0x947F, 0xE0);
	ret |= write_cmos_sensor(0x9480, 0xE0);
	ret |= write_cmos_sensor(0x9483, 0x14);
	ret |= write_cmos_sensor(0x9485, 0x14);
	ret |= write_cmos_sensor(0x9487, 0x14);
	ret |= write_cmos_sensor(0x9501, 0x35);
	ret |= write_cmos_sensor(0x9503, 0x14);
	ret |= write_cmos_sensor(0x9505, 0x14);
	ret |= write_cmos_sensor(0x9507, 0x31);
	ret |= write_cmos_sensor(0x9509, 0x1B);
	ret |= write_cmos_sensor(0x950B, 0x15);
	ret |= write_cmos_sensor(0x950D, 0x1E);
	ret |= write_cmos_sensor(0x950F, 0x1E);
	ret |= write_cmos_sensor(0x9511, 0x1E);
	ret |= write_cmos_sensor(0x9513, 0x64);
	ret |= write_cmos_sensor(0x9515, 0x64);
	ret |= write_cmos_sensor(0x9517, 0x64);
	ret |= write_cmos_sensor(0x951D, 0x34);
	ret |= write_cmos_sensor(0x951F, 0x01);
	ret |= write_cmos_sensor(0x9521, 0x01);
	ret |= write_cmos_sensor(0x9523, 0x01);
	ret |= write_cmos_sensor(0x9525, 0x14);
	ret |= write_cmos_sensor(0x9527, 0x14);
	ret |= write_cmos_sensor(0x9529, 0x14);
	ret |= write_cmos_sensor(0x952B, 0x2F);
	ret |= write_cmos_sensor(0x952D, 0x1A);
	ret |= write_cmos_sensor(0x952F, 0x14);
	ret |= write_cmos_sensor(0x9531, 0x1E);
	ret |= write_cmos_sensor(0x9533, 0x1E);
	ret |= write_cmos_sensor(0x9535, 0x1E);
	ret |= write_cmos_sensor(0x9537, 0x6B);
	ret |= write_cmos_sensor(0x9539, 0x7C);
	ret |= write_cmos_sensor(0x953B, 0x81);
	ret |= write_cmos_sensor(0x9543, 0x0F);
	ret |= write_cmos_sensor(0x9545, 0x0F);
	ret |= write_cmos_sensor(0x9547, 0x0F);
	ret |= write_cmos_sensor(0x9549, 0x0F);
	ret |= write_cmos_sensor(0x954B, 0x0F);
	ret |= write_cmos_sensor(0x954D, 0x0F);
	ret |= write_cmos_sensor(0x954F, 0x15);
	ret |= write_cmos_sensor(0x9551, 0x0B);
	ret |= write_cmos_sensor(0x9553, 0x08);
	ret |= write_cmos_sensor(0x9555, 0x1C);
	ret |= write_cmos_sensor(0x9557, 0x0D);
	ret |= write_cmos_sensor(0x9559, 0x08);
	ret |= write_cmos_sensor(0x955D, 0x00);
	ret |= write_cmos_sensor(0x955E, 0x00);
	ret |= write_cmos_sensor(0x955F, 0x00);
	ret |= write_cmos_sensor(0x956D, 0x00);
	ret |= write_cmos_sensor(0x956F, 0x10);
	ret |= write_cmos_sensor(0x9571, 0x10);
	ret |= write_cmos_sensor(0x9573, 0x40);
	ret |= write_cmos_sensor(0x9575, 0x2E);
	ret |= write_cmos_sensor(0x9577, 0x10);
	ret |= write_cmos_sensor(0x9578, 0x0A);
	ret |= write_cmos_sensor(0x957B, 0xE0);
	ret |= write_cmos_sensor(0x957C, 0xE0);
	ret |= write_cmos_sensor(0x957D, 0xE0);
	ret |= write_cmos_sensor(0x957E, 0xE0);
	ret |= write_cmos_sensor(0x957F, 0xE0);
	ret |= write_cmos_sensor(0x9580, 0xE0);
	ret |= write_cmos_sensor(0x9583, 0x14);
	ret |= write_cmos_sensor(0x9585, 0x14);
	ret |= write_cmos_sensor(0x9587, 0x14);
	ret |= write_cmos_sensor(0x7F78, 0x00);
	ret |= write_cmos_sensor(0x7F89, 0x00);
	ret |= write_cmos_sensor(0x7F93, 0x00);
	ret |= write_cmos_sensor(0x924B, 0x1B);
	ret |= write_cmos_sensor(0x924C, 0x0A);
	ret |= write_cmos_sensor(0x9304, 0x04);
	ret |= write_cmos_sensor(0x9315, 0x04);
...
static void preview_setting(void)
{
	...
	write_cmos_sensor(0x7421, 0x5C);
	write_cmos_sensor(0x7422, 0x00);
	write_cmos_sensor(0x7423, 0xD7);
	write_cmos_sensor(0x9104, 0x04);
	...
	write_cmos_sensor(0x0409, 0x28);
	write_cmos_sensor(0x040A, 0x00);
	write_cmos_sensor(0x040B, 0x0C);
...
static void normal_video_setting(kal_uint16 currefps)
{
	...
	write_cmos_sensor(0x040B, 0x8E);
	write_cmos_sensor(0x040C, 0x10);
	write_cmos_sensor(0x040D, 0x20);
	write_cmos_sensor(0x040E, 0x09);
	write_cmos_sensor(0x040F, 0x14);
	write_cmos_sensor(0x3038, 0x00);
	write_cmos_sensor(0x303A, 0x00);
	write_cmos_sensor(0x303B, 0x10);
	write_cmos_sensor(0x300D, 0x00);
...
static void slim_video_setting(void)
{
	...
	write_cmos_sensor(0x0408, 0x00);
	write_cmos_sensor(0x0409, 0x36);
	write_cmos_sensor(0x040A, 0x00);
	write_cmos_sensor(0x040B, 0x06);
	write_cmos_sensor(0x040C, 0x10);
	write_cmos_sensor(0x040D, 0x04);
	write_cmos_sensor(0x040E, 0x03);
	write_cmos_sensor(0x040F, 0x00);
	write_cmos_sensor(0x3038, 0x00);
	write_cmos_sensor(0x303A, 0x00);
	write_cmos_sensor(0x303B, 0x10);
	write_cmos_sensor(0x300D, 0x00);
...
static kal_uint32 streaming_control(kal_bool enable)
{
	...
	if (enable) {
		write_cmos_sensor(0x0100, 0X01);
		//Removed delay time to optimize wide camera's entry time. (10ms)
	}
	else {
		write_cmos_sensor(0x0100, 0x00);
