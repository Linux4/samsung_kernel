 ...
 ****************************************************************************/
#ifndef _BF3905MIPI_SENSOR_H
#define _BF3905MIPI_SENSOR_H
...
typedef struct imgsensor_info_struct { 
	...
	kal_uint8 EvDelay;                          //mp6p14 add drop frame 20150430
	kal_uint8 SatDelay;
...
kal_uint32  gBanding = 0;
kal_uint32  gNightMode  = 0;
kal_bool    gAE_ENABLE = 0;
