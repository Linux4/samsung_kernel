...
#include "w1sc500cswidely_mipi_raw.h"

#define PFX "w1sc500cswidely_camera_sensor"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = W1SC500CSWIDELY_SENSOR_ID,
...
{ 2592, 1944,	  0,	0, 2592, 1944, 1296, 972, 0000, 0000, 1296, 972,    0,	0, 1296, 972}, // Preview
 ...
 { 2592, 1944,	  16,	252, 2560, 1440, 1280, 720, 0000, 0000, 1280, 720,    0,	0, 1280, 720}, //hight speed video
 { 2592, 1944,	  16,	252, 2560, 1440, 1280, 720, 0000, 0000, 1280, 720,    0,	0, 1280, 720},};// slim video

#if MULTI_WRITE
#define I2C_BUFFER_LEN 765

static kal_uint16 w1sc500cswidely_table_write_cmos_sensor(
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_init_w1sc500cswidely[] = {
     0x0103,0x01
};
#endif
...
{
#if MULTI_WRITE
     w1sc500cswidely_table_write_cmos_sensor(
         addr_data_pair_init_w1sc500cswidely,
         sizeof(addr_data_pair_init_w1sc500cswidely) /
         sizeof(kal_uint16));
#else
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_preview_w1sc500cswidely[] = {
	0x0103,0x01,
	0x0100,0x00,
	0x36e9,0x80,
	0x36f9,0x80,
...
#if MULTI_WRITE
     w1sc500cswidely_table_write_cmos_sensor(
         addr_data_pair_preview_w1sc500cswidely,
         sizeof(addr_data_pair_preview_w1sc500cswidely) /
         sizeof(kal_uint16));
#else
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_capture_fps_w1sc500cswidely[] = {
     0x0103,0x01,
     0x0100,0x00,
     0x36e9,0x80,
     0x36f9,0x80,
...
kal_uint16 addr_data_pair_capture_30fps_w1sc500cswidely[] = {
     0x0103,0x01,
     0x0100,0x00,
     0x36e9,0x80,
     0x36f9,0x80,
...
static void capture_setting(kal_uint16 currefps)
{
     ...
     if (currefps == 300) {
     w1sc500cswidely_table_write_cmos_sensor(
         addr_data_pair_capture_30fps_w1sc500cswidely,
         sizeof(addr_data_pair_capture_30fps_w1sc500cswidely) /
         sizeof(kal_uint16));
     } else {
     w1sc500cswidely_table_write_cmos_sensor(
         addr_data_pair_capture_fps_w1sc500cswidely,
         sizeof(addr_data_pair_capture_fps_w1sc500cswidely) /
         sizeof(kal_uint16));
     }
#else
      if (currefps == 300) {
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_hs_video_w1sc500cswidely[] = {
	0x0103,0x01,
	0x0100,0x00,
	0x36e9,0x80,
	0x36f9,0x80,
...
#if MULTI_WRITE
	w1sc500cswidely_table_write_cmos_sensor(
		addr_data_pair_hs_video_w1sc500cswidely,
		sizeof(addr_data_pair_hs_video_w1sc500cswidely) /
		sizeof(kal_uint16));
#else
      write_cmos_sensor8(0x0103,0x01);
     mdelay(10);
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_slim_video_w1sc500cswidely[] = {
	0x0103,0x01,
	0x0100,0x00,
	0x36e9,0x80,
	0x36f9,0x80,
...
#if MULTI_WRITE
	w1sc500cswidely_table_write_cmos_sensor(
		addr_data_pair_slim_video_w1sc500cswidely,
		sizeof(addr_data_pair_slim_video_w1sc500cswidely) /
		sizeof(kal_uint16));
#else
     write_cmos_sensor8(0x0103,0x01);
     mdelay(10);
     ...
     write_cmos_sensor8(0x320f,0xd0);
     write_cmos_sensor8(0x3210,0x00);
     write_cmos_sensor8(0x3211,0x02);
     write_cmos_sensor8(0x3212,0x00);
     write_cmos_sensor8(0x3213,0x02);
...
static struct stCAM_CAL_DATAINFO_STRUCT w1sc500cswidely_eeprom_data ={
	.sensorID= W1SC500CSWIDELY_SENSOR_ID,
	.deviceID = 0x10,
	.dataLength = 0x076A,
...
static struct stCAM_CAL_CHECKSUM_STRUCT w1sc500cswidely_checksum[8] =
{
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
		...
		do {
			*sensor_id = return_sensor_id();
			if (*sensor_id == imgsensor_info.sensor_id) {
				//+bug604664,liuidijin.wt,ADD,2021/01/12,3 gong wide camera sc500cs eeprom bring up
				size = imgSensorReadEepromData(&w1sc500cswidely_eeprom_data,w1sc500cswidely_checksum);
				if((size != w1sc500cswidely_eeprom_data.dataLength) || ((w1sc500cswidely_eeprom_data.sensorVendorid >> 24)!= read_eeprom(0x0001))) {
					pr_err("w1sc500cswidely get eeprom data failed\n");
					if(w1sc500cswidely_eeprom_data.dataBuffer != NULL) {
						kfree(w1sc500cswidely_eeprom_data.dataBuffer);
						w1sc500cswidely_eeprom_data.dataBuffer = NULL;
					}
					//*sensor_id = 0xFFFFFFFF;
					//return ERROR_SENSOR_CONNECT_FAIL;
				} else {
					pr_info("get eeprom data success\n");
					imgSensorSetEepromData(&w1sc500cswidely_eeprom_data);
					//bug604664 liuxiangyin.wt, add, 2021/04/15, add flag for the new and old modules compatible
					get_eeprom_0x004_value=read_eeprom(0x004);
				}
				//-bug604664,liuidijin.wt,ADD,2021/01/12,3 gong wide camera sc500cs eeprom bring up
				pr_info("[w1sc500cswidely_camera_sensor]get_imgsensor_id:i2c write id: 0x%x, sensor id: 0x%x\n",
					imgsensor.i2c_write_id, *sensor_id);
				return ERROR_NONE;
			}
			pr_err("[w1sc500cswidely_camera_sensor]get_imgsensor_id:Read sensor id fail, write id: 0x%x, id: 0x%x\n",
				imgsensor.i2c_write_id, *sensor_id);
			retry--;
		} while (retry > 0);
		i++;
	...
	if (*sensor_id != imgsensor_info.sensor_id) {
		pr_err("w1sc500cswidely Read id fail,sensor id: 0x%x\n", *sensor_id);
		*sensor_id = 0xFFFFFFFF;
		return ERROR_SENSOR_CONNECT_FAIL;
	}
	return ERROR_NONE;
