...
static struct imgsensor_info_struct imgsensor_info = {
	...
	.min_gain_iso = 40, //For A13x5G MAC
	.gain_step = 1,
...
static kal_uint16 set_gain(kal_uint16 gain)
{
	...
	if ((iReg >= ANALOG_GAIN_1) && (iReg < ANALOG_GAIN_2)) {
		...
		LOG_DBG("analogic gain 1x, add pregain = %d\n", temp);
		...
		write_cmos_sensor(0xb1, (temp >> 8) & 0x3f);
		write_cmos_sensor(0xb2, (temp & 0xff));
		LOG_DBG("analogic gain 1.185x, add pregain = %d\n", temp);
		...
		write_cmos_sensor(0xb1, (temp >> 8) & 0x3f);
		write_cmos_sensor(0xb2, (temp & 0xff));
		LOG_DBG("analogic gain 1.4x, add pregain = %d\n", temp);
		...
		write_cmos_sensor(0xb1, (temp >> 8) & 0x3f);
		write_cmos_sensor(0xb2, (temp & 0xff));
		LOG_DBG("analogic gain 1.659x, add pregain = %d\n", temp);
		...
		write_cmos_sensor(0xb1, (temp >> 8) & 0x3f);
		write_cmos_sensor(0xb2, (temp & 0xff));
		LOG_DBG("analogic gain 2.0x, add pregain = %d\n", temp);
		...
		write_cmos_sensor(0xb1, (temp >> 8) & 0x3f);
		write_cmos_sensor(0xb2, (temp & 0xff));
		LOG_DBG("analogic gain 2.37x, add pregain = %d\n", temp);
		...
		write_cmos_sensor(0xb1, (temp >> 8) & 0x3f);
		write_cmos_sensor(0xb2, (temp & 0xff));
		LOG_DBG("analogic gain 2.8x, add pregain = %d\n", temp);
		...
		write_cmos_sensor(0xb1, (temp >> 8) & 0x3f);
		write_cmos_sensor(0xb2, (temp & 0xff));
		LOG_DBG("analogic gain 3.318x, add pregain = %d\n", temp);
		...
		write_cmos_sensor(0xb1, (temp >> 8) & 0x3f);
		write_cmos_sensor(0xb2, (temp & 0xff));
		LOG_DBG("analogic gain 4.0x, add pregain = %d\n", temp);
		...
		write_cmos_sensor(0xb1, (temp >> 8) & 0x3f);
		write_cmos_sensor(0xb2, (temp & 0xff));
		LOG_DBG("analogic gain 4.74x, add pregain = %d\n", temp);
		...
		write_cmos_sensor(0xb1, (temp >> 8) & 0x3f);
		write_cmos_sensor(0xb2, (temp & 0xff));
		LOG_DBG("analogic gain 5.6x, add pregain = %d\n", temp);
		...
		write_cmos_sensor(0xb1, (temp >> 8) & 0x3f);
		write_cmos_sensor(0xb2, (temp & 0xff));
		LOG_DBG("analogic gain 6.636x, add pregain = %d\n", temp);
		...
		write_cmos_sensor(0xb1, (temp >> 8) & 0x3f);
		write_cmos_sensor(0xb2, (temp & 0xff));
		LOG_DBG("analogic gain 8.0x, add pregain = %d\n", temp);
		...
		write_cmos_sensor(0xb1, (temp >> 8) & 0x3f);
		write_cmos_sensor(0xb2, (temp & 0xff));
		LOG_DBG("analogic gain 9.48x, add pregain = %d\n", temp);
		...
		write_cmos_sensor(0xb1, (temp >> 8) & 0x3f);
		write_cmos_sensor(0xb2, (temp & 0xff));
		LOG_DBG("analogic gain 11.2x, add pregain = %d\n", temp);
		...
		write_cmos_sensor(0xb1, (temp >> 8) & 0x3f);
		write_cmos_sensor(0xb2, (temp & 0xff));
		LOG_DBG("analogic gain 13.2725x, add pregain = %d\n", temp);
	} else {
		write_cmos_sensor(0xfe, 0x00);
		write_cmos_sensor(0xb6, 0x0f);
		temp = 1024 * iReg / ANALOG_GAIN_16;
		write_cmos_sensor(0xb1, (temp >> 8) & 0x3f);
		write_cmos_sensor(0xb2, (temp & 0xff));
		LOG_DBG("analogic gain 16x, add pregain = %d\n", temp);
	}
...
{
	LOG_INF("E\n");
	table_write_cmos_sensor(addr_data_pair_normal_video_gc02m1,
		sizeof(addr_data_pair_normal_video_gc02m1) / sizeof(kal_uint16));
}
...
{
	LOG_INF("E\n");
	table_write_cmos_sensor(addr_data_pair_slim_video_gc02m1,
		sizeof(addr_data_pair_hs_video_gc02m1) / sizeof(kal_uint16));
}
...
{
	LOG_INF("E!\n");
	table_write_cmos_sensor(addr_data_pair_custom1_gc02m1,
		sizeof(addr_data_pair_custom1_gc02m1) / sizeof(kal_uint16));
}
