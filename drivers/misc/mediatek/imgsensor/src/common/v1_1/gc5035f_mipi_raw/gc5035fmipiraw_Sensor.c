...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = GC5035F_SENSOR_ID1,	/*record sensor id defined in Kd_imgsensor.h*/
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[] = {
	...
	{ 2608, 1960,    0,    0, 2608, 1960, 2608, 1960,
	   159,  218, 2288, 1524,    0,    0, 2288, 1524 }, /*custom2*/
	{ 2608, 1960,    0,    0, 2608, 1960, 2608, 1960,
	   159,  218, 2288, 1524,    0,    0, 2288, 1524 }, /*custom3*/
	{ 2608, 1960,    0,    0, 2608, 1960, 2608, 1960,
	   159,  218, 2288, 1524,    0,    0, 2288, 1524 }, /*custom4*/
	{ 2608, 1960,    0,    0, 2608, 1960, 2608, 1960,
	    16,   14, 2576, 1932,    0,    0, 2576, 1932 }, /*custom5 -NOT USED*/
};

static kal_uint8 gc5035f_init_setting[] = {
	0xfc, 0x01,
	0xf4, 0x40,
	0xf5, 0xe9,
	0xf6, 0x14,
...
static kal_uint8 gc5035f_preview_setting[] = {
	0xfc, 0x01,
	0xf4, 0x40,
	0xf5, 0xe9,
	0xf6, 0x14,
...
static kal_uint8 gc5035f_capture_setting[] = {
	0xfc, 0x01,
	0xf4, 0x40,
	0xf5, 0xe9,
	0xf6, 0x14,
...
static kal_uint8 gc5035f_normal_video_setting[] = {
	0xfc, 0x01,
	0xf4, 0x40,
	0xf5, 0xe9,
	0xf6, 0x14,
...
static kal_uint8 gc5035f_custom1_setting[] = {
	0xfc, 0x01,
	0xf4, 0x40,
	0xf5, 0xe9,
	0xf6, 0x14,
...
static kal_uint8 gc5035f_custom2_setting[] = {
	0xfc, 0x01,
	0xf4, 0x40,
	0xf5, 0xe9,
	0xf6, 0x14,
...
static kal_uint8 gc5035f_custom5_setting[] = {
//NOT USED
};
...
static kal_uint8 gc5035f_otp_read_byte(kal_uint16 addr)
{
...
static void gc5035f_otp_dd_autoload(void)
{
	...
	valid_defect_num   = gc5035f_otp_read_byte(0x0070);
	invalid_defect_num = gc5035f_otp_read_byte(0x0078);
...
static kal_uint16 set_gain(kal_uint16 gain)
{
	...
	kal_uint16 GC5035F_AGC_Param[MAX_GAIN_INDEX][2] = {
		{  256,  0 },
		{  302,  1 },
		{  358,  2 },
		{  425,  3 },
	...
	LOG_DBG("Exit! GC5035F_AGC_Param[gain_index][1] = 0x%x, temp_gain = 0x%x, reg_gain = %d\n",
...
static void sensor_init(void)
{
	...
	ret = table_write_cmos_sensor(gc5035f_init_setting,
		sizeof(gc5035f_init_setting) / sizeof(kal_uint8));
#ifdef IMGSENSOR_HW_PARAM
	if (ret != 0) {
		imgsensor_sec_get_hw_param(&hw_param, GC5035F_CAL_SENSOR_POSITION);
		if (hw_param)
...
{
	table_write_cmos_sensor(gc5035f_preview_setting,
		sizeof(gc5035f_preview_setting) / sizeof(kal_uint8));
}

static void capture_setting(kal_uint16 currefps)
{
	LOG_INF("E! currefps: %d\n", currefps);
	table_write_cmos_sensor(gc5035f_capture_setting,
		sizeof(gc5035f_capture_setting) / sizeof(kal_uint8));
}

static void normal_video_setting(kal_uint16 currefps)
{
	table_write_cmos_sensor(gc5035f_normal_video_setting,
		sizeof(gc5035f_normal_video_setting) / sizeof(kal_uint8));
}
...
{
	table_write_cmos_sensor(gc5035f_custom1_setting,
		sizeof(gc5035f_custom1_setting) / sizeof(kal_uint8));
}
static void custom2_setting(void)
{
	table_write_cmos_sensor(gc5035f_custom2_setting,
		sizeof(gc5035f_custom2_setting) / sizeof(kal_uint8));
}
...
{
	table_write_cmos_sensor(gc5035f_custom5_setting,
		sizeof(gc5035f_custom5_setting) / sizeof(kal_uint8));
}
...
int gc5035f_read_otp_cal(unsigned int addr, unsigned char *data, unsigned int size)
{
	...
	otp_bank = gc5035f_otp_read_byte(GC5035F_OTP_CHECK_BANK);
	LOG_INF("check OTP bank:0x%x\n", otp_bank);

	switch (otp_bank) {
	case GC5035F_OTP_BANK1_MARK:
		read_addr = GC5035F_OTP_BANK1_START_ADDR;
		break;
	case GC5035F_OTP_BANK2_MARK:
		read_addr = GC5035F_OTP_BANK2_START_ADDR;
		break;
	default:
		LOG_ERR("check bank: fail");
		ret = -1;
		goto GC5035F_READ_OTP_CAL_EXIT;
	}

	for (i = 0; i < size; i++) {
		*(data + i) = gc5035f_otp_read_byte(read_addr);
		LOG_DBG("read data addr:0x%x, value:0x%x\n", read_addr, *(data + i));
		read_addr += 8;
	}
	ret = (int)size;

GC5035F_READ_OTP_CAL_EXIT:
