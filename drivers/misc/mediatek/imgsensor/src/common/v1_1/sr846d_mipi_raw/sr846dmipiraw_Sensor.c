...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[5] = {
	...
	{ 3280, 2464,    0,    0, 3280, 2464, 3280, 2464,
	     8,    8, 3264, 2448,    0,    0, 3264, 2448}, /*high speed video-NOT Arranged*/
	{ 3280, 2464,    0,    0, 3280, 2464, 3280, 2464,
	     8,    8, 3264, 2448,    0,    0, 3264, 2448}, /*slim video-NOT Arranged*/
};

#if MULTI_WRITE
#define I2C_BUFFER_LEN 765

static kal_uint16 sr846d_table_write_cmos_sensor(
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_preview_sr846d[] = {
	0x0A20, 0x0000,
	0x002E, 0x1111,
	0x0032, 0x1111,
	0x0022, 0x0008,
...
#if MULTI_WRITE
	sr846d_table_write_cmos_sensor(
		addr_data_pair_preview_sr846d,
		sizeof(addr_data_pair_preview_sr846d) /
		sizeof(kal_uint16));
#else
	write_cmos_sensor(0x0A20, 0x0000);
	write_cmos_sensor(0x002E, 0x1111);
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_capture_30fps_sr846d[] = {
	0x0A20, 0x0000,
	0x002E, 0x1111,
	0x0032, 0x1111,
	0x0022, 0x0008,
...
#if MULTI_WRITE
	sr846d_table_write_cmos_sensor(
		addr_data_pair_capture_30fps_sr846d,
		sizeof(addr_data_pair_capture_30fps_sr846d) /
		sizeof(kal_uint16));
#else
	write_cmos_sensor(0x0A20, 0x0000);
	write_cmos_sensor(0x002E, 0x1111);
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_hs_video_sr846d[] = {
	0x0A20, 0x0000,
	0x002E, 0x1111,
	0x0032, 0x1111,
	0x0022, 0x0008,
...
#if MULTI_WRITE
	sr846d_table_write_cmos_sensor(
		addr_data_pair_hs_video_sr846d,
		sizeof(addr_data_pair_hs_video_sr846d) /
		sizeof(kal_uint16));
#else
	write_cmos_sensor(0x0A20, 0x0000);
	write_cmos_sensor(0x002E, 0x1111);
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_slim_video_sr846d[] = {
	0x0b0a, 0x8252,
	0x0f30, 0x6e25,
	0x0f32, 0x7167,
	0x004a, 0x0100,
...
#if MULTI_WRITE
	sr846d_table_write_cmos_sensor(
		addr_data_pair_slim_video_sr846d,
		sizeof(addr_data_pair_slim_video_sr846d) /
		sizeof(kal_uint16));
#else
