...
#include "w1bf2253deplh3_mipiraw_sensor.h"


/****************************Modify Following Strings for Debug****************************/
#define PFX "w1bf2253deplh3_camera_sensor"
#define LOG_1 LOG_INF("W1BF2253DEPLH3, MIPI 1LANE\n")
/****************************   Modify end    *******************************************/
...
kal_bool W1_BF2253_DEP_LH3DuringTestPattern = KAL_FALSE;

static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = W1BF2253DEPLH3_SENSOR_ID,
	...
	.min_gain = 64, /*1x gain*/
	.max_gain = 512, /*16x gain*/ //bug 646787 zhanghao2, add, 2021/04/25,fix ITS:cam2 scense1_1 fail[1/3]
	.min_gain_iso = 100,
	.gain_step = 1,
	.gain_type = 0,
	.i2c_speed = 400,
...
{
	return( ((read_cmos_sensor( 0xfc ) << 8) | read_cmos_sensor( 0xfd )) + 1 );
}
...
//+bug 646787 zhanghao2, add, 2021/04/25,fix ITS:cam2 scense1_1 fail[1/3]
...
static kal_uint16 gain2reg(const kal_uint16 gain)
{
    ...
    for (iI = 0; iI < (MaxGainIndex-1); iI++) {
        if((gain >= sensorGainMapping[iI][0])&&(gain <= sensorGainMapping[iI+1][0]))//+bug 646787 zhanghao2, add, 2021/04/25,fix ITS:cam2 scense1_1 fail[1/3]
        {
...
static kal_uint16 set_gain(kal_uint16 gain)
{
	...
	if (gain < 1024)
	    ...
	    gain = 11072;//bug 646787 zhanghao2, add, 2021/04/25,fix ITS:cam2 scense1_1 fail[1/3]
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
	...
	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
		...
		do {
			*sensor_id = return_sensor_id();
			if ((*sensor_id == imgsensor_info.sensor_id) && (W1HI4821QREARSY_SENSOR_ID == main_sensor_id)) {
				LOG_INF("3rd dualcam i2c write id: 0x%x, sensor id: 0x%x\n", imgsensor.i2c_write_id, *sensor_id);
				return ERROR_NONE;
			}
	...
	if ((*sensor_id != imgsensor_info.sensor_id) || (W1HI4821QREARSY_SENSOR_ID != main_sensor_id)) {
		...
		*sensor_id = 0xFFFFFFFF;
		pr_err("3rd dualcam sensor id error,main sensor id:%x,depth sensor id:%x\n",main_sensor_id,*sensor_id);
...
static kal_uint32 open(void)
{
	...
	spin_unlock(&imgsensor_drv_lock);
	W1_BF2253_DEP_LH3DuringTestPattern = KAL_FALSE;
	return ERROR_NONE;
}
