 ...
 *
 ****************************************************************************/
#ifndef _W2SC1300MCSFRONTTXDMIPI_SENSOR_H
#define _W2SC1300MCSFRONTTXDMIPI_SENSOR_H
...
struct imgsensor_info_struct {
	...
	//+bug783860,liangyiyi.wt,ADD,2022/07/25,modify for fix w2sc1300mcsfronttxd photo is black pictures
	kal_uint32 min_gain;
	kal_uint32 max_gain;
