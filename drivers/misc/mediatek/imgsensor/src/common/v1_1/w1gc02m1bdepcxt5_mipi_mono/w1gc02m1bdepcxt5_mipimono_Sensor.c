...
#include "w1gc02m1bdepcxt5_mipimono_Sensor.h"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = W1GC02M1BDEPCXT5_SENSOR_ID,
...
kal_uint16 addr_data_pair_init_gc02m1b_5[] = {
...
kal_uint16 addr_data_pair_preview_gc02m1b_5[] = {
	0xfe, 0x00,
	0x41, 0x04,
	0x42, 0xf4,
	0xfe, 0x00,
...
kal_uint16 addr_data_pair_capture_gc02m1b_5[] = {
	0xfe, 0x00,
	0x41, 0x04,
	0x42, 0xf4,
	0xfe, 0x00,
...
kal_uint16 addr_data_pair_normal_video_gc02m1b_5[] = {
	0xfe, 0x00,
	0x41, 0x04,
	0x42, 0xf4,
	0xfe, 0x00,
...
kal_uint16 addr_data_pair_hs_video_gc02m1b_5[] = {
	0xfe, 0x00,
	0x41, 0x04,
	0x42, 0xf4,
	0xfe, 0x00,
...
kal_uint16 addr_data_pair_slim_video_gc02m1b_5[] = {
	0xfe, 0x00,
	0x41, 0x04,
	0x42, 0xf4,
	0xfe, 0x00,
...
static void sensor_init(void)
{
	...
	gc02m1b_table_write_cmos_sensor(
		addr_data_pair_init_gc02m1b_5,
		sizeof(addr_data_pair_init_gc02m1b_5) /
		sizeof(kal_uint16));
}
...
static void preview_setting(void)
{
	LOG_INF("E\n");
	gc02m1b_table_write_cmos_sensor(
		addr_data_pair_preview_gc02m1b_5,
		sizeof(addr_data_pair_preview_gc02m1b_5) /
		sizeof(kal_uint16));
}
...
static void capture_setting(void)
{
	LOG_INF("E\n");
	gc02m1b_table_write_cmos_sensor(
		addr_data_pair_capture_gc02m1b_5,
		sizeof(addr_data_pair_capture_gc02m1b_5) /
		sizeof(kal_uint16));
}
...
static void normal_video_setting(void)
{
	LOG_INF("E\n");
	gc02m1b_table_write_cmos_sensor(
		addr_data_pair_normal_video_gc02m1b_5,
		sizeof(addr_data_pair_normal_video_gc02m1b_5) /
		sizeof(kal_uint16));
}
...
static void hs_video_setting(void)
{
	LOG_INF("E\n");
	gc02m1b_table_write_cmos_sensor(
		addr_data_pair_hs_video_gc02m1b_5,
		sizeof(addr_data_pair_hs_video_gc02m1b_5) /
		sizeof(kal_uint16));
}
...
static void slim_video_setting(void)
{
	LOG_INF("E\n");
	gc02m1b_table_write_cmos_sensor(
		addr_data_pair_slim_video_gc02m1b_5,
		sizeof(addr_data_pair_slim_video_gc02m1b_5) /
		sizeof(kal_uint16));
}
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
	...
	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
		...
		do {
			*sensor_id = return_sensor_id();
			if ((*sensor_id == imgsensor_info.sensor_id) && (W1OV48B2QREARXL_SENSOR_ID == main_sensor_id)) {
				pr_info("5th dualcam i2c write id: 0x%x, sensor id: 0x%x\n", imgsensor.i2c_write_id, *sensor_id);
				return ERROR_NONE;
			}
	...
	if ((*sensor_id != imgsensor_info.sensor_id) || (W1OV48B2QREARXL_SENSOR_ID != main_sensor_id)) {
		...
		*sensor_id = 0xFFFFFFFF;
		pr_err("5th dualcam sensor id error,main sensor id:%x,depth sensor id:%x\n",main_sensor_id,*sensor_id);
