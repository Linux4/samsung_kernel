...
#include "w1bf2253deplh64_mipiraw_sensor.h"


/****************************Modify Following Strings for Debug****************************/
#define PFX "w1bf2253deplh64_camera_sensor"
#define LOG_1 LOG_INF("W1BF2253DEPLH64, MIPI 1LANE\n")
/****************************   Modify end    *******************************************/
...
kal_bool W1_BF2253_DEP_LH64DuringTestPattern = KAL_FALSE;

static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = W1BF2253DEPLH64_SENSOR_ID,
	...
	.min_gain = 64, /*1x gain*/
	.max_gain = 512, /*8x gain*/ //ExtB P210528-00826 zhanghao2, add, 2021/06/02,fix ITS:cam2 scense1 fail[1/3]
	.min_gain_iso = 100,
	.gain_step = 1,
	.gain_type = 0,
	.i2c_speed = 400,
...
{
	return( ((read_cmos_sensor( 0xfc ) << 8) | read_cmos_sensor( 0xfd )) + 2 );
}
				...
				kal_uint16 shutter, kal_uint16 frame_length)
{
	...
	//LOG_DBG("shutter =%d, frame_time =%d\n", shutter, frame_time);
       //  LOG_INF("000 bf225364 shutter =%d, frame_length =%d\n", shutter, frame_length);
	...
	//LOG_INF("Exit! bf225364 shutter =%d, framelength =%d\n", shutter,imgsensor.frame_length);
...
static kal_uint16 gain2reg(const kal_uint16 gain)
{
    ...
    for (iI = 0; iI < (MaxGainIndex-1); iI++) {
        if((gain >= sensorGainMapping[iI][0])&&(gain <= sensorGainMapping[iI+1][0]))//ExtB P210528-00826 zhanghao2, add, 2021/06/02,fix ITS:cam2 scense1 fail[1/3]
        {
...
static kal_uint16 set_gain(kal_uint16 gain)
{
	...
	if (gain < 1024)
	    ...
	    gain = 11072;//ExtB P210528-00826 zhanghao2, add, 2021/06/02,fix ITS:cam2 scense1 fail[1/3]
...
static void sensor_init(void)
{
	...
	write_cmos_sensor(0x79,0x08);
        ...
        write_cmos_sensor(0x08,0x01);
        write_cmos_sensor(0x07,0x46);
        #endif
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
	...
	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
		...
		do {
			*sensor_id = return_sensor_id();
			if ((*sensor_id == imgsensor_info.sensor_id) && (W1OV64B40REARTXD_SENSOR_ID == main_sensor_id)) {
				LOG_INF("200517 add preview 30fps custom1 24fps 3rd dualcam 64m i2c write id: 0x%x, sensor id: 0x%x\n", imgsensor.i2c_write_id, *sensor_id);
				return ERROR_NONE;
			}
    ...
    #if 0
	//+bug626603 liudijin, add, 2021/04/08,enable w1ov64b40reartxd and w1bf2253deplh64 dual camera mode.
	if ((W1OV64B40REARTXD_SENSOR_ID == main_sensor_id)  ||(W1HI4821QREARSY_SENSOR_ID == main_sensor_id )){
	...
	//-bug626603 liudijin, add, 2021/04/08,enable w1ov64b40reartxd and w1bf2253deplh64 dual camera mode.
		...
		/* if Sensor ID is not correct, Must set *sensor_id to 0xFFFFFFFF */
		*sensor_id = 0xFFFFFFFF;
		pr_err("24fps 3rd dualcam 64m sensor id error,main sensor id:%x,depth sensor id:%x\n",main_sensor_id,*sensor_id);
		return ERROR_SENSOR_CONNECT_FAIL;
	}
...
static kal_uint32 open(void)
{
	...
	spin_unlock(&imgsensor_drv_lock);
	W1_BF2253_DEP_LH64DuringTestPattern = KAL_FALSE;
	return ERROR_NONE;
}
	...
	UINT8 *feature_para, UINT32 *feature_para_len)
{
	...
	//+ExtB P210618-03058 zhanghao2, add, 2021/06/21,fix 64m cam2 its sensor_fusion fail
	case SENSOR_FEATURE_GET_OFFSET_TO_START_OF_EXPOSURE:
		*(MUINT32 *)(uintptr_t)(*(feature_data + 1)) = -520000;
		break;
	//-ExtB P210618-03058 zhanghao2, add, 2021/06/21,fix 64m cam2 its sensor_fusion fail
