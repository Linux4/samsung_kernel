 ...
 * Filename:
 * ---------
 *     w2s5kjn1reartruly_mipi_Sensor.c
 *
 * Project:
 * --------
 *     ALPS
...
#include "w2s5kjn1reartruly_mipiraw_Sensor.h"
//#include "imgsensor_common.h"

#define VENDOR_EDIT 1

/***************Modify Following Strings for Debug**********************/
#define PFX "w2s5kjn1reartruly_camera_sensor"
#define LOG_1 LOG_INF("w2s5kjn1reartruly,MIPI 4LANE\n")
/****************************   Modify end    **************************/
#define LOG_INF(format, args...) pr_err(PFX "[%s] " format, __func__, ##args)
#define LOG_ERR(format, args...) pr_err(PFX "[%s] " format, __func__, ##args)

#define DEVICE_VERSION_S5KJN103     "w2s5kjn1reartruly"
...
static struct imgsensor_info_struct imgsensor_info = {
    .sensor_id = W2S5KJN1REARTRULY_SENSOR_ID,
    .module_id = 0x19,
...
/*w2 2022/04/18, add for HW_GGC write to sensor start*/
...
static void w2s5kjn1reartruly03_set_lsc_reg_setting(
...
static kal_uint16 w2s5kjn1reartruly03_init_setting[] = {
	0x6028,0x2400,
	0x602A,0x1354,
	0x6F12,0x0100,
	0x6F12,0x7017,
...
static kal_uint16 w2s5kjn1reartruly03_capture_setting[] = {
	0x6028, 0x2400,
	0x602A, 0x1A28,
	0x6F12, 0x4C00,
	0x602A, 0x065A,
...
static kal_uint16 w2s5kjn1reartruly03_preview_setting[] = {
	0x6028, 0x2400,
	0x602A, 0x1A28,
	0x6F12, 0x4C00,
	0x602A, 0x065A,
...
static kal_uint16 w2s5kjn1reartruly03_normal_video_setting[] = {
	0x6028, 0x2400,
	0x602A, 0x1A28,
	0x6F12, 0x4C00,
	0x602A, 0x065A,
...
static kal_uint16 w2s5kjn1reartruly03_hs_video_setting[] = {
	0x6028, 0x2400,
	0x602A, 0x1A28,
	0x6F12, 0x4C00,
	0x602A, 0x065A,
...
static kal_uint16 w2s5kjn1reartruly03_slim_video_setting[] = {
	0x6028, 0x2400,
	0x602A, 0x1A28,
	0x6F12, 0x4C00,
	0x602A, 0x065A,
...
static kal_uint16 w2s5kjn1reartruly03_custom1_setting[] = {
	0x6028, 0x2400,
	0x602A, 0x1A28,
	0x6F12, 0x4C00,
	0x602A, 0x065A,
...
static kal_uint16 w2s5kjn1reartruly03_custom2_setting[] = {
	0x6028, 0x2400,
	0x602A, 0x1A28,
	0x6F12, 0x4C00,
	0x602A, 0x065A,
...
static kal_uint16 w2s5kjn1reartruly03_custom3_setting[] = {
	0x6028, 0x2400,
	0x602A, 0x1A28,
	0x6F12, 0x4C00,
	0x602A, 0x065A,
...
static void sensor_init(void)
{
    ...
    table_write_cmos_sensor(w2s5kjn1reartruly03_init_setting,
        sizeof(w2s5kjn1reartruly03_init_setting) / sizeof(kal_uint16));
...
static void preview_setting(void)
{
    ...
    table_write_cmos_sensor(w2s5kjn1reartruly03_preview_setting,
        sizeof(w2s5kjn1reartruly03_preview_setting)/sizeof(kal_uint16));
...
static void capture_setting(kal_uint16 currefps)
{
    ...
    table_write_cmos_sensor(w2s5kjn1reartruly03_capture_setting,
        sizeof(w2s5kjn1reartruly03_capture_setting)/sizeof(kal_uint16));
...
static void normal_video_setting(kal_uint16 currefps)
{
    ...
    table_write_cmos_sensor(w2s5kjn1reartruly03_normal_video_setting,
        sizeof(w2s5kjn1reartruly03_normal_video_setting)/sizeof(kal_uint16));
    LOG_INF("X\n");
}
...
static void hs_video_setting(void)
{
    ...
    table_write_cmos_sensor(w2s5kjn1reartruly03_hs_video_setting,
        sizeof(w2s5kjn1reartruly03_hs_video_setting)/sizeof(kal_uint16));
    LOG_INF("X\n");
}
...
static void slim_video_setting(void)
{
    ...
    table_write_cmos_sensor(w2s5kjn1reartruly03_slim_video_setting,
        sizeof(w2s5kjn1reartruly03_slim_video_setting)/sizeof(kal_uint16));
    LOG_INF("X\n");
}
...
static void custom1_setting(void)
{
    ...
    /*************MIPI output setting************/
    table_write_cmos_sensor(w2s5kjn1reartruly03_custom1_setting,
        sizeof(w2s5kjn1reartruly03_custom1_setting)/sizeof(kal_uint16));
    LOG_INF("X");
}
...
static void custom2_setting(void)
{
    ...
    /*************MIPI output setting************/
    table_write_cmos_sensor(w2s5kjn1reartruly03_custom2_setting,
        sizeof(w2s5kjn1reartruly03_custom2_setting)/sizeof(kal_uint16));
    LOG_INF("X");
}
...
static void custom3_setting(void)
{
    ...
    /*************MIPI output setting************/
    table_write_cmos_sensor(w2s5kjn1reartruly03_custom3_setting,
        sizeof(w2s5kjn1reartruly03_custom3_setting)/sizeof(kal_uint16));
    LOG_INF("X");
}
#if 1 ///otp code
static struct stCAM_CAL_DATAINFO_STRUCT w2s5kjn1reartruly_eeprom_data ={
    .sensorID= W2S5KJN1REARTRULY_SENSOR_ID,
    .deviceID = 0x01,
    .dataLength = 0x3183,
...
static struct stCAM_CAL_CHECKSUM_STRUCT w2s5kjn1reartruly_Checksum[14] =
{
...
static kal_uint16 w2s5kjn1reartruly_read_eeprom(kal_uint32 addr)
{
     kal_uint16 get_byte=0;
        ...
        do {
            *sensor_id = ((read_cmos_sensor_8(0x0000) << 8)
            ...
            if (*sensor_id == imgsensor_info.sensor_id) {
				...
				if((w2s5kjn1reartruly_eeprom_data.sensorVendorid >> 24) != w2s5kjn1reartruly_read_eeprom(0x0001)){
				    // *sensor_id = 0xFFFFFFFF;
					// LOG_ERR("read module id not match i2c write id: 0x%x, sensor id: 0x%x module id: 0x%x\n",imgsensor.i2c_write_id, *sensor_id,
					// w2s5kjn1reartruly_read_eeprom(0x0001));
					// return ERROR_SENSOR_CONNECT_FAIL;
				}

#if 1
  //// add maincamera s5kjn1 otp code
             size = imgSensorReadEepromData(&w2s5kjn1reartruly_eeprom_data,w2s5kjn1reartruly_Checksum);
             if(size != w2s5kjn1reartruly_eeprom_data.dataLength) {
                 LOG_INF("get eeprom data failed\n");
                 if(w2s5kjn1reartruly_eeprom_data.dataBuffer != NULL) {
                     kfree(w2s5kjn1reartruly_eeprom_data.dataBuffer);
                     w2s5kjn1reartruly_eeprom_data.dataBuffer = NULL;
                 }
                 //*sensor_id = 0xFFFFFFFF;
                 //return ERROR_SENSOR_CONNECT_FAIL;
             } else {
                 pr_info("get eeprom data success\n");
                 imgSensorSetEepromData(&w2s5kjn1reartruly_eeprom_data);
#if W2_TXD_S5KJN1_OTP
read_eepromData_HW_GGC();
memcpy(XTCBuffer, (kal_uint8*)&w2s5kjn1reartruly_eeprom_data.dataBuffer[TRULY_S5KJN1_OTP_XTC_OFFSET+1], S5KJN1_OTP_XTC_LEN);
memcpy(SENSORXTCBuffer, (kal_uint8*)&w2s5kjn1reartruly_eeprom_data.dataBuffer[TRULY_S5KJN1_OTP_SENSORXTC_OFFSET+1], S5KJN1_OTP_SENSORXTC_LEN);
memcpy(PDXTCXTCBuffer, (kal_uint8*)&w2s5kjn1reartruly_eeprom_data.dataBuffer[TRULY_S5KJN1_OTP_PDXTC_OFFSET+1], S5KJN1_OTP_PDXTC_LEN);
memcpy(SWGCCBuffer, (kal_uint8*)&w2s5kjn1reartruly_eeprom_data.dataBuffer[TRULY_S5KJN1_OTP_SWGCC_OFFSET+1], S5KJN1_OTP_SWGCC_LEN);
#endif
             }
                 ...
                 UINT8 *feature_para, UINT32 *feature_para_len)
{
    ...
    case SENSOR_FEATURE_SET_LSC_TBL:
    {
        ...
        w2s5kjn1reartruly03_set_lsc_reg_setting(index, feature_data_16,
...
UINT32 W2S5KJN1REARTRULY_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
