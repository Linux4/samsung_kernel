...
static kal_uint16 w2s5kjn1rearst03_init_setting[] = {
	0x6028,0x2400,
	0x602A,0x1354,
	0x6F12,0x0100,
	0x6F12,0x7017,
...
static kal_uint16 w2s5kjn1rearst03_capture_setting[] = {
	0x6028, 0x2400,
	0x602A, 0x1A28,
	0x6F12, 0x4C00,
	0x602A, 0x065A,
...
static kal_uint16 w2s5kjn1rearst03_preview_setting[] = {
	0x6028, 0x2400,
	0x602A, 0x1A28,
	0x6F12, 0x4C00,
	0x602A, 0x065A,
...
static kal_uint16 w2s5kjn1rearst03_normal_video_setting[] = {
	0x6028, 0x2400,
	0x602A, 0x1A28,
	0x6F12, 0x4C00,
	0x602A, 0x065A,
...
static kal_uint16 w2s5kjn1rearst03_hs_video_setting[] = {
	0x6028, 0x2400,
	0x602A, 0x1A28,
	0x6F12, 0x4C00,
	0x602A, 0x065A,
...
static kal_uint16 w2s5kjn1rearst03_slim_video_setting[] = {
	0x6028, 0x2400,
	0x602A, 0x1A28,
	0x6F12, 0x4C00,
	0x602A, 0x065A,
...
static kal_uint16 w2s5kjn1rearst03_custom1_setting[] = {
	0x6028, 0x2400,
	0x602A, 0x1A28,
	0x6F12, 0x4C00,
	0x602A, 0x065A,
...
static kal_uint16 w2s5kjn1rearst03_custom2_setting[] = {
	0x6028, 0x2400,
	0x602A, 0x1A28,
	0x6F12, 0x4C00,
	0x602A, 0x065A,
...
static kal_uint16 w2s5kjn1rearst03_custom3_setting[] = {
	0x6028, 0x2400,
	0x602A, 0x1A28,
	0x6F12, 0x4C00,
	0x602A, 0x065A,
...
static void sensor_init(void)
{
    ...
    table_write_cmos_sensor(w2s5kjn1rearst03_init_setting,
...
static void preview_setting(void)
{
    ...
    table_write_cmos_sensor(w2s5kjn1rearst03_preview_setting,
...
static void capture_setting(kal_uint16 currefps)
{
    ...
    table_write_cmos_sensor(w2s5kjn1rearst03_capture_setting,
...
static void normal_video_setting(kal_uint16 currefps)
{
    ...
    table_write_cmos_sensor(w2s5kjn1rearst03_normal_video_setting,
...
static void hs_video_setting(void)
{
    ...
    table_write_cmos_sensor(w2s5kjn1rearst03_hs_video_setting,
...
static void slim_video_setting(void)
{
    ...
    table_write_cmos_sensor(w2s5kjn1rearst03_slim_video_setting,
...
static void custom1_setting(void)
{
    ...
    /*************MIPI output setting************/
    table_write_cmos_sensor(w2s5kjn1rearst03_custom1_setting,
...
static void custom2_setting(void)
{
    ...
    /*************MIPI output setting************/
    table_write_cmos_sensor(w2s5kjn1rearst03_custom2_setting,
...
static void custom3_setting(void)
{
    ...
    /*************MIPI output setting************/
    table_write_cmos_sensor(w2s5kjn1rearst03_custom3_setting,
        sizeof(w2s5kjn1rearst03_custom3_setting)/sizeof(kal_uint16));
    LOG_INF("X");
}
#if 1 ///otp code
static struct stCAM_CAL_DATAINFO_STRUCT w2s5kjn1rearst_eeprom_data ={
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
        ...
        do {
            *sensor_id = ((read_cmos_sensor_8(0x0000) << 8)
            ...
            if (*sensor_id == imgsensor_info.sensor_id) {
                LOG_INF("i2c write id: 0x%x, sensor id: 0x%x module id: 0x%x\n",imgsensor.i2c_write_id, *sensor_id, w2s5kjn1reartruly_read_eeprom(0x0001));
				if((w2s5kjn1rearst_eeprom_data.sensorVendorid >> 24) != w2s5kjn1reartruly_read_eeprom(0x0001)){
  ...
  //// add maincamera s5kjn1 otp code
             size = imgSensorReadEepromData(&w2s5kjn1rearst_eeprom_data,w2s5kjn1rearst_Checksum);
             if(size != w2s5kjn1rearst_eeprom_data.dataLength) {
...
memcpy(XTCBuffer, (kal_uint8*)&w2s5kjn1rearst_eeprom_data.dataBuffer[TRULY_S5KJN1_OTP_XTC_OFFSET+1], S5KJN1_OTP_XTC_LEN);
memcpy(SENSORXTCBuffer, (kal_uint8*)&w2s5kjn1rearst_eeprom_data.dataBuffer[TRULY_S5KJN1_OTP_SENSORXTC_OFFSET+1], S5KJN1_OTP_SENSORXTC_LEN);
memcpy(PDXTCXTCBuffer, (kal_uint8*)&w2s5kjn1rearst_eeprom_data.dataBuffer[TRULY_S5KJN1_OTP_PDXTC_OFFSET+1], S5KJN1_OTP_PDXTC_LEN);
memcpy(SWGCCBuffer, (kal_uint8*)&w2s5kjn1rearst_eeprom_data.dataBuffer[TRULY_S5KJN1_OTP_SWGCC_OFFSET+1], S5KJN1_OTP_SWGCC_LEN);
#endif
             }
