...
#define FRONT_IMX258_MAX_CAL_SIZE               (0x06C9 + 0x1)

#define FRONT_IMX258_HEADER_CHECKSUM_LEN        (0x004B + 0x1)
#define FRONT_IMX258_MODULE_CAL_CHECKSUM_LEN    (0x0485 - 0x0050 + 0x1)

#define FRONT_IMX258_CONVERTED_MAX_CAL_SIZE     (0x0A17 + 0x1)
#define FRONT_IMX258_CONVERTED_AWB_CHECKSUM_LEN (0x0073 - 0x0068 + 0x1)
#define FRONT_IMX258_CONVERTED_LSC_CHECKSUM_LEN (0x07D3 - 0x078 + 0x1)

const struct rom_converted_cal_addr front_imx258_converted_cal_addr = {
	.rom_awb_cal_data_start_addr            = 0x0068,
	.rom_awb_checksum_addr                  = 0x0074,
	.rom_awb_checksum_len                   = (FRONT_IMX258_CONVERTED_AWB_CHECKSUM_LEN),
	.rom_shading_cal_data_start_addr        = 0x0078,
	.rom_shading_checksum_addr              = 0x07D4,
	.rom_shading_checksum_len               = (FRONT_IMX258_CONVERTED_LSC_CHECKSUM_LEN),
};

const struct imgsensor_vendor_rom_addr front_imx258_cal_addr = {
	/* Set '-1' if not used */
	.camera_module_es_version               = 'A',
	.cal_map_es_version                     = '1',
	.rom_max_cal_size                       = FRONT_IMX258_MAX_CAL_SIZE,
	...
	.rom_header_checksum_len                = FRONT_IMX258_HEADER_CHECKSUM_LEN,
	...
	.rom_module_checksum_len                = FRONT_IMX258_MODULE_CAL_CHECKSUM_LEN,
	...
	.converted_cal_addr                     = &front_imx258_converted_cal_addr,
	.rom_converted_max_cal_size             = FRONT_IMX258_CONVERTED_MAX_CAL_SIZE,
