...
#define FRONT_4HA_MAX_CAL_SIZE (0x045F + 0x1)
#define FRONT_4HA_HEADER_CHECKSUM_LEN (0x49 + 0x1)
#define FRONT_4HA_MODULE_DATA_CHECKSUM_LEN (0x045B - 0x004E + 0x1)

#define FRONT_4HA_CONVERTED_MAX_CAL_SIZE (0x07C7 + 0x1)
#define FRONT_4HA_CONVERTED_AWB_CHECKSUM_LEN (0x0063 - 0x0058 + 0x1)
#define FRONT_4HA_CONVERTED_LSC_CHECKSUM_LEN (0x07C3 - 0x0068 + 0x1)
...
const struct imgsensor_vendor_rom_addr front_4ha_cal_addr = {
	...
	.rom_module_checksum_addr               = 0x045C,
