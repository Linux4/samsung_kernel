...
const struct rom_sac_cal_addr rear_imx582_gc5035_sac_addr = {
	.rom_mode_addr               = 0x0158, //Control, Mode
	.rom_time_addr               = 0x0159, //Resonance
};

const struct rom_cal_addr rear_imx582_gc5035_qsc_addr = {
...
const struct rom_cal_addr rear_imx582_gc5035_lrc_addr = {
	.name                                   = CROSSTALK_CAL_LRC,
	.addr                                   = 0x09D0,
	.size                                   = 384,
	.next                                   = &rear_imx582_gc5035_qsc_addr,
};

const struct imgsensor_vendor_rom_addr rear_imx582_gc5035_cal_addr = {
	...
	.rom_header_main_mtf_data_addr             = 0x015A,
	...
	.crosstalk_cal_addr                        = &rear_imx582_gc5035_lrc_addr,
	.sac_cal_addr                              = &rear_imx582_gc5035_sac_addr,
