#include "imgsensor_otp_front_3l6_v007.h"
...
#define FRONT_3L6_CONVERTED_AWB_CHECKSUM_LEN (0x006D - 0x0064 + 0x1)
#define FRONT_3L6_CONVERTED_LSC_CHECKSUM_LEN (0x07BD - 0x006E + 0x1)
