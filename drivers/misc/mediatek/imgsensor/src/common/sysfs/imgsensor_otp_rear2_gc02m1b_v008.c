...
#define REAR2_GC02M1B_MAX_CAL_SIZE               (0x10 + 0x1)

#define REAR2_GC02M1B_HEADER_CHECKSUM_LEN        (0xC + 0x1)

const struct imgsensor_vendor_rom_addr rear2_gc02m1b_cal_addr = {
	/* Set '-1' if not used */
	.camera_module_es_version               = 'A',
	.cal_map_es_version                     = '1',
	.rom_max_cal_size                       = REAR2_GC02M1B_MAX_CAL_SIZE,
	...
	.rom_header_checksum_len                = REAR2_GC02M1B_HEADER_CHECKSUM_LEN,
	...
	.rom_converted_max_cal_size             = REAR2_GC02M1B_MAX_CAL_SIZE,
	// TODO: Add cal conversion lib & remove temp code
