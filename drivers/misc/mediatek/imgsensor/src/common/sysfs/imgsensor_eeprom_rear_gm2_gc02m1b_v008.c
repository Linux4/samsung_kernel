#include "imgsensor_eeprom_rear_gm2_gc02m1b_v008.h"
...
const struct rom_converted_cal_addr rear_gm2_gc02m1b_converted_cal_addr = {
...
const struct imgsensor_vendor_rom_addr rear_gm2_gc02m1b_cal_addr = {
	/* Set '-1' if not used */
