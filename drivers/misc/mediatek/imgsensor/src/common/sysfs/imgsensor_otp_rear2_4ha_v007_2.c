#include "imgsensor_otp_rear2_4ha_v007_2.h"
...
#define REAR2_4HA_CONVERTED_AWB_CHECKSUM_LEN (0x005F - 0x0058 + 0x1)
#define REAR2_4HA_CONVERTED_LSC_CHECKSUM_LEN (0x07B3 - 0x0064 + 0x1)

const struct rom_converted_cal_addr rear2_4ha_converted_cal_addr = {
	.rom_awb_cal_data_start_addr     = 0x0058,
	.rom_awb_checksum_addr           = 0x0060,
	.rom_awb_checksum_len            = REAR2_4HA_CONVERTED_AWB_CHECKSUM_LEN,
	.rom_shading_cal_data_start_addr = 0x0064,
	.rom_shading_checksum_addr       = 0x07B4,
