...
#define REAR2_SR846D_MAX_CAL_SIZE               (0x046C + 0x1)
#define REAR2_SR846D_HEADER_CHECKSUM_LEN        (0x0047 + 0x1)
#define REAR2_SR846D_MODULE_DATA_CHECKSUM_LEN   (0x0467 - 0x004C + 0x1)

#define REAR2_SR846D_CONVERTED_MAX_CAL_SIZE     (0x07D0 + 0x1)
#define REAR2_SR846D_CONVERTED_AWB_CHECKSUM_LEN (0x006B - 0x0060 + 0x1)
#define REAR2_SR846D_CONVERTED_LSC_CHECKSUM_LEN (0x07CB - 0x0070 + 0x1)

const struct rom_converted_cal_addr rear2_sr846d_converted_cal_addr = {
	.rom_awb_cal_data_start_addr            = 0x0060,
	.rom_awb_checksum_addr                  = 0x006C,
	.rom_awb_checksum_len                   = (REAR2_SR846D_CONVERTED_AWB_CHECKSUM_LEN),
	.rom_shading_cal_data_start_addr        = 0x0070,
	.rom_shading_checksum_addr              = 0x07CC,
	.rom_shading_checksum_len               = (REAR2_SR846D_CONVERTED_LSC_CHECKSUM_LEN),
};

const struct imgsensor_vendor_rom_addr rear2_sr846d_cal_addr = {
	/* Set '-1' if not used */

	.camera_module_es_version               = 'A',
	.cal_map_es_version                     = '1',
	.rom_max_cal_size                       = REAR2_SR846D_MAX_CAL_SIZE,
	...
	.rom_header_module_id_addr              = 0x002D,
	.rom_header_main_sensor_id_addr         = 0x0037,
	...
	.rom_header_checksum_addr               = 0x0048,
	.rom_header_checksum_len                = (REAR2_SR846D_HEADER_CHECKSUM_LEN),

	.rom_module_cal_data_start_addr         = 0x004C,
	.rom_module_module_info_start_addr      = -1,
	.rom_module_checksum_addr               = 0x0468,
	.rom_module_checksum_len                = (REAR2_SR846D_MODULE_DATA_CHECKSUM_LEN),
	...
	.converted_cal_addr                     = &rear2_sr846d_converted_cal_addr,
	.rom_converted_max_cal_size             = REAR2_SR846D_CONVERTED_MAX_CAL_SIZE,
