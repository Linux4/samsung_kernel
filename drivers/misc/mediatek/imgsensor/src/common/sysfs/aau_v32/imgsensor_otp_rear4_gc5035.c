...
#define REAR4_GC5035_MAX_CAL_SIZE (0x00F0)
#define REAR4_GC5035_HEADER_CHECKSUM_LEN (0x0049 + 0x1)
#define REAR4_GC5035_MODULE_DATA_CHECKSUM_LEN (0x00EB - 0x004E + 0x1)
#define REAR4_GC5035_CONVERTED_MAX_CAL_SIZE (0x0800)
#define REAR4_GC5035_CONVERTED_AWB_CHECKSUM_LEN (0x0061 - 0x0058 + 0x1)
#define REAR4_GC5035_CONVERTED_LSC_CHECKSUM_LEN (0x07C3 - 0x0068 + 0x1)

const struct rom_converted_cal_addr rear4_gc5035_converted_cal_addr = {
	.rom_awb_cal_data_start_addr     = 0x0058,
	.rom_awb_checksum_addr           = 0x0062,
	.rom_awb_checksum_len            = REAR4_GC5035_CONVERTED_AWB_CHECKSUM_LEN,
	.rom_shading_cal_data_start_addr = 0x0068,
	.rom_shading_checksum_addr       = 0x07C4,
	.rom_shading_checksum_len        = REAR4_GC5035_CONVERTED_LSC_CHECKSUM_LEN,
};
...
const struct imgsensor_vendor_rom_addr rear4_gc5035_cal_addr = {
	...
	.rom_max_cal_size                       = REAR4_GC5035_MAX_CAL_SIZE,
	...
	.rom_header_checksum_len                = (REAR4_GC5035_HEADER_CHECKSUM_LEN),

	.rom_module_cal_data_start_addr         = 0x004E,
	.rom_module_module_info_start_addr      = -1,
	.rom_module_checksum_addr               = 0x00EC,
	.rom_module_checksum_len                = (REAR4_GC5035_MODULE_DATA_CHECKSUM_LEN),
	...
	.converted_cal_addr                     = &rear4_gc5035_converted_cal_addr,
	.rom_converted_max_cal_size             = REAR4_GC5035_CONVERTED_MAX_CAL_SIZE,
