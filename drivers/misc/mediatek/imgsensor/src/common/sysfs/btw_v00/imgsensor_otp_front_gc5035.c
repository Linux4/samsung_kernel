...
#define FRONT_GC5035_MAX_CAL_SIZE (0x00F0 + 0x1)
#define FRONT_GC5035_HEADER_CHECKSUM_LEN (0x0049 + 0x1)
#define FRONT_GC5035_MODULE_DATA_CHECKSUM_LEN (0x00EB - 0x0058 + 0x1)

#define FRONT_GC5035_CONVERTED_MAX_CAL_SIZE (0x07CD + 0x1)
#define FRONT_GC5035_CONVERTED_AWB_CHECKSUM_LEN (0x0069 - 0x005E + 0x1)
#define FRONT_GC5035_CONVERTED_LSC_CHECKSUM_LEN (0x07C9 - 0x006E + 0x1)

const struct rom_converted_cal_addr front_gc5035_converted_cal_addr = {
	.rom_awb_cal_data_start_addr = 0x004E,
	.rom_awb_checksum_addr = 0x006A,
	.rom_awb_checksum_len = FRONT_GC5035_CONVERTED_AWB_CHECKSUM_LEN,
	.rom_shading_cal_data_start_addr = 0x006E,
	.rom_shading_checksum_addr = 0x07CA,
	.rom_shading_checksum_len = FRONT_GC5035_CONVERTED_LSC_CHECKSUM_LEN,
};
...
const struct imgsensor_vendor_rom_addr front_gc5035_cal_addr = {
	...
	.rom_max_cal_size = FRONT_GC5035_MAX_CAL_SIZE,
	...
	.rom_module_cal_data_start_addr = 0x0058,
	.rom_module_module_info_start_addr = -1,
	.rom_module_checksum_addr = 0xEC,
	.rom_module_checksum_len = FRONT_GC5035_MODULE_DATA_CHECKSUM_LEN,
	...
	.rom_converted_max_cal_size = FRONT_GC5035_CONVERTED_MAX_CAL_SIZE,
