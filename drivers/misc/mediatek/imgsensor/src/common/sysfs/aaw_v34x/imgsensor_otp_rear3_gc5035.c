...
#define REAR3_GC5035_MAX_CAL_SIZE (0x00F4)
#define REAR3_GC5035_HEADER_CHECKSUM_LEN (0x004D + 0x1)
#define REAR3_GC5035_MODULE_DATA_CHECKSUM_LEN (0x00EF - 0x0052 + 0x1)

#define REAR3_GC5035_CONVERTED_MAX_CAL_SIZE (0x07CB + 0x1)
#define REAR3_GC5035_CONVERTED_AWB_CHECKSUM_LEN (0x0067 - 0x005C + 0x1)
#define REAR3_GC5035_CONVERTED_LSC_CHECKSUM_LEN (0x07C7 - 0x006C + 0x1)

const struct rom_converted_cal_addr rear3_gc5035_converted_cal_addr = {
	.rom_awb_cal_data_start_addr     = 0x005C,
	.rom_awb_checksum_addr           = 0x0068,
	.rom_awb_checksum_len            = REAR3_GC5035_CONVERTED_AWB_CHECKSUM_LEN,
	.rom_shading_cal_data_start_addr = 0x006C,
	.rom_shading_checksum_addr       = 0x07C8,
	.rom_shading_checksum_len        = REAR3_GC5035_CONVERTED_LSC_CHECKSUM_LEN,
};

const struct imgsensor_vendor_rom_addr rear3_gc5035_cal_addr = {
	/* Set '-1' if not used */

	.camera_module_es_version               = 'A',
	.cal_map_es_version                     = '1',
	.rom_max_cal_size                       = REAR3_GC5035_MAX_CAL_SIZE,
	...
	.rom_header_module_id_addr              = 0x2C + 0x6,
	...
	.rom_header_checksum_len                = (REAR3_GC5035_HEADER_CHECKSUM_LEN),

	.rom_module_cal_data_start_addr         = 0x0052,
	.rom_module_module_info_start_addr      = -1,
	.rom_module_checksum_addr               = 0x00F0,
	.rom_module_checksum_len                = (REAR3_GC5035_MODULE_DATA_CHECKSUM_LEN),
	...
	.converted_cal_addr                     = &rear3_gc5035_converted_cal_addr,
	.rom_converted_max_cal_size             = REAR3_GC5035_CONVERTED_MAX_CAL_SIZE,
