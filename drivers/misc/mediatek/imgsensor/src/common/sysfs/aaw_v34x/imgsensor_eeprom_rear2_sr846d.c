...
#define REAR2_SR846D_MAX_CAL_SIZE               (0x047F + 0x1)

#define REAR2_SR846D_HEADER_CHECKSUM_LEN        (0x0052)
#define REAR2_SR846D_MODULE_DATA_CHECKSUM_LEN   (0x047C - 0x0056)

#define REAR2_SR846D_CONVERTED_MAX_CAL_SIZE     (0x07CF + 0x1)
