...
#define REAR2_4HA_MAX_CAL_SIZE (0x04BC + 0x1)
#define REAR2_4HA_HEADER_CHECKSUM_LEN (0x51 + 0x1)
#define REAR2_4HA_MODULE_DATA_CHECKSUM_LEN (0x0477 - 0x0056 + 0x1)

#define REAR2_4HA_CONVERTED_MAX_CAL_SIZE (0x080F + 0x1)
#define REAR2_4HA_CONVERTED_AWB_CHECKSUM_LEN (0x006B - 0x0060 + 0x1)
#define REAR2_4HA_CONVERTED_LSC_CHECKSUM_LEN (0x07CB - 0x0070 + 0x1)
...
const struct imgsensor_vendor_rom_addr rear2_4ha_cal_addr = {
	...
	.rom_shading_cal_data_start_addr        = 0x006A,
