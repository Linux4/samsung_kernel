#include "imgsensor_otp_rear2_gc5035_v008.h"

#define REAR2_GC5035_MAX_CAL_SIZE (0x00EC + 0x4)
#define REAR2_GC5035_HEADER_CHECKSUM_LEN (0x0049 + 0x1)
#define REAR2_GC5035_MODULE_DATA_CHECKSUM_LEN (0x00EB - 0x004E + 0x1)

#define REAR2_GC5035_CONVERTED_MAX_CAL_SIZE (0x07C7 + 0x1)
#define REAR2_GC5035_CONVERTED_AWB_CHECKSUM_LEN (0x0063 - 0x0058 + 0x1)
#define REAR2_GC5035_CONVERTED_LSC_CHECKSUM_LEN (0x07C3 - 0x0068 + 0x1)
