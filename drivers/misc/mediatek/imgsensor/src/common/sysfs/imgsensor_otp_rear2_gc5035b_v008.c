...
#define REAR2_GC5035B_MAX_CAL_SIZE (0x00F0 + 0x1)
#define REAR2_GC5035B_HEADER_CHECKSUM_LEN (0x0049 + 0x1)
#define REAR2_GC5035B_MODULE_DATA_CHECKSUM_LEN (0x00EB - 0x004E + 0x1)

#define REAR2_GC5035B_CONVERTED_MAX_CAL_SIZE (0x07CB + 0x1)
#define REAR2_GC5035B_CONVERTED_AWB_CHECKSUM_LEN (0x0063 - 0x0058 + 0x1)
#define REAR2_GC5035B_CONVERTED_LSC_CHECKSUM_LEN (0x07C3 - 0x0068 + 0x1)

const struct rom_converted_cal_addr rear2_gc5035b_converted_cal_addr = {
	.rom_awb_cal_data_start_addr = 0x0058,
	.rom_awb_checksum_addr = 0x0064,
	.rom_awb_checksum_len = REAR2_GC5035B_CONVERTED_AWB_CHECKSUM_LEN,
	.rom_shading_cal_data_start_addr = 0x0068,
	.rom_shading_checksum_addr = 0x07C4,
	.rom_shading_checksum_len = REAR2_GC5035B_CONVERTED_LSC_CHECKSUM_LEN,
};

const struct imgsensor_vendor_rom_addr rear2_gc5035b_cal_addr = {
	/* Set '-1' if not used */
	.camera_module_es_version = 'A',
	.cal_map_es_version = '1',
	.rom_max_cal_size = REAR2_GC5035B_MAX_CAL_SIZE,
	...
	.rom_header_checksum_len = (REAR2_GC5035B_HEADER_CHECKSUM_LEN),

	.rom_module_cal_data_start_addr = 0x004E,
	.rom_module_module_info_start_addr = -1,
	.rom_module_checksum_addr = 0x00EC,
	.rom_module_checksum_len = (REAR2_GC5035B_MODULE_DATA_CHECKSUM_LEN),
	...
	.converted_cal_addr = &rear2_gc5035b_converted_cal_addr,
	.rom_converted_max_cal_size = REAR2_GC5035B_CONVERTED_MAX_CAL_SIZE,
