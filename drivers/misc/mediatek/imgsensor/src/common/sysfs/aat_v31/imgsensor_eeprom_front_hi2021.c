#include "imgsensor_eeprom_front_hi2021.h"

#define IMGSENSOR_FRONT_MAX_CAL_SIZE (8 * 1024)
...
#define FRONT_SENSOR_CAL_CHECKSUM_LEN (0x101B - 0x09D0 + 0x1)

const struct imgsensor_vendor_rom_addr front_hi2021_cal_addr = {
	/* Set '-1' if not used */
	...
	.rom_sensor_cal_module_info_start_addr      = 0x1000,
	...
	.rom_converted_max_cal_size                 = IMGSENSOR_FRONT_MAX_CAL_SIZE,
