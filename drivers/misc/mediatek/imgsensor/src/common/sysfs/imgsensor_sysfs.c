				...
				struct device_attribute *attr, char *buf)
{
	...
	if (imgsensor_sec_is_valid_moduleid(finfo[position]->rom_module_id)) {
		return sprintf(buf, "\"CAMIR_ID\":\"%c%c%c%c%cXX%02X%02X%02X\",\"I2CR_AF\":\"%d\",\"I2CR_SEN\":\"%d\",""\"MIPIR_SEN\":\"%d\"\n",
			finfo[position]->rom_module_id[0], finfo[position]->rom_module_id[1],
			finfo[position]->rom_module_id[2], finfo[position]->rom_module_id[3],
		...
		return sprintf(buf, "\"CAMIR_ID\":\"MIR_ERR\",\"I2CR_AF\":\"%d\",\"I2CR_SEN\":\"%d\",""\"MIPIR_SEN\":\"%d\"\n",
			ec_param->i2c_af_err_cnt, ec_param->i2c_sensor_err_cnt, ec_param->mipi_sensor_err_cnt);
	}
}
				...
				struct device_attribute *attr, char *buf)
{
	...
	if (imgsensor_sec_is_valid_moduleid(finfo[position]->rom_module_id)) {
		return sprintf(buf, "\"CAMIF_ID\":\"%c%c%c%c%cXX%02X%02X%02X\",\"I2CF_SEN\":\"%d\",""\"MIPIR_SEN\":\"%d\"\n",
			finfo[position]->rom_module_id[0], finfo[position]->rom_module_id[1],
			finfo[position]->rom_module_id[2], finfo[position]->rom_module_id[3],
			finfo[position]->rom_module_id[4], finfo[position]->rom_module_id[7],
			finfo[position]->rom_module_id[8], finfo[position]->rom_module_id[9],
		...
		return sprintf(buf, "\"CAMIF_ID\":\"MIR_ERR\",\"I2CF_SEN\":\"%d\",""\"MIPIR_SEN\":\"%d\"\n",
			ec_param->i2c_sensor_err_cnt, ec_param->mipi_sensor_err_cnt);
	}
}
				...
				struct device_attribute *attr, char *buf)
{
	...
	if (imgsensor_sec_is_valid_moduleid(finfo[position]->rom_module_id)) {
		return sprintf(buf, "\"CAMIR2_ID\":\"%c%c%c%c%cXX%02X%02X%02X\",\"I2CR2_SEN\":\"%d\",""\"MIPIR_SEN\":\"%d\"\n",
			finfo[position]->rom_module_id[0], finfo[position]->rom_module_id[1],
			finfo[position]->rom_module_id[2], finfo[position]->rom_module_id[3],
			finfo[position]->rom_module_id[4], finfo[position]->rom_module_id[7],
			finfo[position]->rom_module_id[8], finfo[position]->rom_module_id[9],
		...
		return sprintf(buf, "\"CAMIR2_ID\":\"MIR_ERR\",\"I2CR2_SEN\":\"%d\",""\"MIPIR_SEN\":\"%d\"\n",
			ec_param->i2c_sensor_err_cnt, ec_param->mipi_sensor_err_cnt);
	}
}
				...
				struct device_attribute *attr, char *buf)
{
	...
	if (imgsensor_sec_is_valid_moduleid(finfo[position]->rom_module_id)) {
		return sprintf(buf, "\"CAMIR3_ID\":\"%c%c%c%c%cXX%02X%02X%02X\",\"I2CR3_SEN\":\"%d\",""\"MIPIR_SEN\":\"%d\"\n",
			finfo[position]->rom_module_id[0], finfo[position]->rom_module_id[1],
			finfo[position]->rom_module_id[2], finfo[position]->rom_module_id[3],
			finfo[position]->rom_module_id[4], finfo[position]->rom_module_id[7],
			finfo[position]->rom_module_id[8], finfo[position]->rom_module_id[9],
		...
		return sprintf(buf, "\"CAMIR3_ID\":\"MIR_ERR\",\"I2CR3_SEN\":\"%d\",""\"MIPIR_SEN\":\"%d\"\n",
			ec_param->i2c_sensor_err_cnt, ec_param->mipi_sensor_err_cnt);
	}
}
			...
			struct device_attribute *attr, char *buf)
{
	...
	if (imgsensor_sec_is_valid_moduleid(finfo[position]->rom_module_id)) {
		return sprintf(buf, "\"CAMIR4_ID\":\"%c%c%c%c%cXX%02X%02X%02X\",\"I2CR4_SEN\":\"%d\",""\"MIPIR_SEN\":\"%d\"\n",
			finfo[position]->rom_module_id[0], finfo[position]->rom_module_id[1],
			finfo[position]->rom_module_id[2], finfo[position]->rom_module_id[3],
			finfo[position]->rom_module_id[4], finfo[position]->rom_module_id[7],
			finfo[position]->rom_module_id[8], finfo[position]->rom_module_id[9],
		...
		return sprintf(buf, "\"CAMIR4_ID\":\"MIR_ERR\",\"I2CR4_SEN\":\"%d\",""\"MIPIR_SEN\":\"%d\"\n",
			ec_param->i2c_sensor_err_cnt, ec_param->mipi_sensor_err_cnt);
	}
}
...
static bool imgsensor_check_eeprom_crc32(char *buf, int deviceIdx, int sub_deviceIdx, bool rom_common)
{
	...
	pr_err("[%s] SKIP CRC: PDAF", __func__);
	//crc32_header_temp = compare_crc_checksum(buf, deviceIdx, address_boundary, crc_info);
	if (!crc32_header_temp)
		goto out;
