...
#if SC800CS_OTP_FUNCTION
                    //+S96818AA1-1936,zhujianjia.wt,ADD,2023/04/28,sc800cs otp porting
					size = imgSensorReadEepromData(&n28sc800csfrontdc_eeprom_data,n28sc800csfrontdc_Checksum);
					if(size != n28sc800csfrontdc_eeprom_data.dataLength ||(n28sc800csfrontdc_eeprom_data.sensorVendorid >> 24)!= get_vendor_id()) {
