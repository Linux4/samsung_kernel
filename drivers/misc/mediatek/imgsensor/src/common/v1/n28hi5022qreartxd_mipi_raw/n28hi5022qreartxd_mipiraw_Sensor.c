...
#include "n28hi5022qreartxd_mipiraw_Sensor.h"
#include "n28hi5022qreartxd_mipiraw_Sensor_setting_new.h"

#define PFX "n28hi5022qreartxd_camera_sensor"
...
static kal_uint16 get_eeprom_0x003_value = 0x02;
//-bug767771 liudijin.wt, add, 2022/10/04, add flag for hi5022 the new and old modules compatible
...
static struct imgsensor_info_struct imgsensor_info = {
     .sensor_id = N28HI5022QREARTXD_SENSOR_ID,
...
#if 0 ///otp code
static struct stCAM_CAL_DATAINFO_STRUCT n28hi5022qreartxd_eeprom_data ={
     .sensorID= N28HI5022QREARTXD_SENSOR_ID,
     .deviceID = 0x01,
     .dataLength = 0x21E5,
...
static struct stCAM_CAL_CHECKSUM_STRUCT n28hi5022qreartxd_Checksum[12] =
{
     ...
     while (imgsensor_info.i2c_addr_table[i] != 0xff) {
         ...
         do {
             *sensor_id = return_sensor_id();
             ...
             LOG_INF("read success truly i2c write id : 0x%x, sensor id: 0x%x\n",imgsensor.i2c_write_id, *sensor_id);
#if 0
  //// add maincamera hi5022q otp code
             size = imgSensorReadEepromData(&n28hi5022qreartxd_eeprom_data,n28hi5022qreartxd_Checksum);
             if(size != n28hi5022qreartxd_eeprom_data.dataLength) {
                 LOG_INF("get eeprom data failed\n");
                 if(n28hi5022qreartxd_eeprom_data.dataBuffer != NULL) {
                     kfree(n28hi5022qreartxd_eeprom_data.dataBuffer);
                     n28hi5022qreartxd_eeprom_data.dataBuffer = NULL;
                 }
                // *sensor_id = 0xFFFFFFFF;
                // return ERROR_SENSOR_CONNECT_FAIL;
             } else {
                 pr_info("get eeprom data success\n");
                    imgSensorSetEepromData(&n28hi5022qreartxd_eeprom_data);
#if hi5022q_XGC_QGC_PGC_CALIB
//get the pgc qgc xgc buffer
memcpy(XGCbuffer, (kal_uint8*)&n28hi5022qreartxd_eeprom_data.dataBuffer[hi5022q_OTP_XGC_OFFSET+1], hi5022q_OTP_XGC_LEN);


memcpy(QGCbuffer, (kal_uint8*)&n28hi5022qreartxd_eeprom_data.dataBuffer[hi5022q_OTP_QGC_OFFSET+1], hi5022q_OTP_QGC_LEN);
memcpy(OPCBuffer, (kal_uint8*)&n28hi5022qreartxd_eeprom_data.dataBuffer[hi5022q_OTP_OPC_OFFSET+1], HI5022Q_OTP_OPC_LEN);

//memcpy(PGCbuffer, (kal_uint8*)&n28hi5022qreartxd_eeprom_data.dataBuffer[hi5022q_OTP_PGC_OFFSET+1], hi5022q_OTP_PGC_LEN);

#if hi5022q_OTP_DUMP

//LOG_INF("hi5022q_eeprom:pgc_addr:0x%x\n",n28hi5022qreartxd_Checksum[hi5022q_PGC- 1].startAdress + 3);
LOG_INF("hi5022q_eeprom:qgc_addr:0x%x\n",n28hi5022qreartxd_Checksum[hi5022q_QGC- 1].startAdress + 3);
LOG_INF("hi5022q_eeprom:xgc_addr:0x%x\n",n28hi5022qreartxd_Checksum[hi5022q_XGC- 1].startAdress + 3);
...
UINT32 N28HI5022QREARTXD_MIPI_RAW_SensorInit(struct
