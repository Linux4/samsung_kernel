 ...
 *
 ****************************************************************************/
#ifndef _S5K3L6OFILMMIPI_SENSOR_H
#define _S5K3L6OFILMMIPI_SENSOR_H

#include "kd_camera_typedef.h"
#include "kd_imgsensor.h"
#include "kd_imgsensor_define.h"
#include "kd_imgsensor_errcode.h"
//modify dualcam IDLHLYE-99 by wei.miao@reallytek.com 180629 start
enum IMGSENSOR_MODE {
	IMGSENSOR_MODE_INIT,
...
struct imgsensor_info_struct {
	...
	struct imgsensor_mode_struct
		custom1;    //modify dualcam IDLHLYE-99 by wei.miao@reallytek.com 180629
