 ...
 * Filename:
 * ---------
 *	 N21_DONGCI_MAIN_S5K2P6_Sensor.h
 *
 * Project:
 * --------
 *	 ALPS
 ...
 *
 ****************************************************************************/
#ifndef _N21_DONGCI_MAIN_S5K2P6MIPI_SENSOR_H
#define _N21_DONGCI_MAIN_S5K2P6MIPI_SENSOR_H
...
extern bool dc_read_2P6_eeprom(kal_uint16 addr, BYTE *data, kal_uint32 size);

extern int iBurstWriteReg_multi(u8 *pData, u32 bytes,
		u16 i2cId, u16 transfer_length, u16 timing);

#endif  /*_N21_DONGCI_MAIN_S5K2P6MIPI_SENSOR_H*/
