...
#include "n23_hi1336_rear_txd_mipiraw_Sensor.h"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = N23_HI1336_REAR_TXD_SENSOR_ID,
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[6] = {
    ...
    { 4224, 3136,   0,   4, 4224, 3128,	 2112, 1564,  16,  2, 2080, 1560, 0, 0, 2080, 1560},		// preview (2080 x 1560)//DIFF
	...
	{ 4224, 3136,   0, 482, 4224, 2172,  1408,  724,  64, 2, 1280,  720, 0, 0, 1280,  720},		// hight speed video (640 x 480)
...
write_cmos_sensor(0x0730, 0xb817);
...
write_cmos_sensor(0x1014, 0x001f);
write_cmos_sensor(0x1016, 0x001f);
write_cmos_sensor(0x101a, 0x001f);
...
write_cmos_sensor(0x0b12, 0x0820);
...
static struct stCAM_CAL_DATAINFO_STRUCT n23_hi1336_rear_txd_eeprom_data ={
	.sensorID= N23_HI1336_REAR_TXD_SENSOR_ID,
	.deviceID = 0x01,
	.dataLength =  0x0D5F,
...
static struct stCAM_CAL_CHECKSUM_STRUCT n23_hi1336_rear_txd_checksum[8] =
{
	...
	{TOTAL_ITEM,0x0000,0x0000,0x0D5D,0x0D5E,0x55},
...
//-bug682590,zhanghengyuan.wt,ADD,2021/8/24,diff txd and st hi1336
//+bug682590,zhanghengyuan.wt,ADD,2021/8/25,add n23_hi1336_rear_txd OTP
				size = imgSensorReadEepromData(&n23_hi1336_rear_txd_eeprom_data,n23_hi1336_rear_txd_checksum);
				if((size != n23_hi1336_rear_txd_eeprom_data.dataLength) || ((n23_hi1336_rear_txd_eeprom_data.sensorVendorid >> 24)!=      *(n23_hi1336_rear_txd_eeprom_data.dataBuffer+1))) {
					pr_err("n23_hi1336_rear_txd get eeprom data failed\n");
					if(n23_hi1336_rear_txd_eeprom_data.dataBuffer != NULL) {
						kfree(n23_hi1336_rear_txd_eeprom_data.dataBuffer);
						n23_hi1336_rear_txd_eeprom_data.dataBuffer = NULL;
					}
					*sensor_id = 0xFFFFFFFF;
					return ERROR_SENSOR_CONNECT_FAIL;
				} else {
					pr_info("get eeprom data success\n");
					imgSensorSetEepromData(&n23_hi1336_rear_txd_eeprom_data);
				}
//-bug682590,zhanghengyuan.wt,ADD,2021/8/25,add n23_hi1336_rear_txd OTP
