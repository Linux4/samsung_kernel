...
#include "o2102_hi1336txd_back_mipi_raw.h"
/* hs04 code for DEVAL6398A-24 by xutengtao at 2022/07/24 start */

#define PFX "o2102_hi1336txd_back_mipi_raw"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = O2102_HI1336TXD_BACK_SENSOR_ID,
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
	...
	static kal_uint8 vendor_id_last = 0;

    //vendor_id!=0x10
    imgsensor.i2c_write_id = 0xA0;            //eeprom i2c addr 0xA0.
    vendor_id  = read_cmos_sensor(0x0001);    //vendor id addr 0x0001

	if(vendor_id == 0)
	{
		vendor_id = vendor_id_last;
	}
    else
    {
        vendor_id_last = vendor_id;
    }

	if(vendor_id == 0x10)
	{
		printk("HS04_OTP return vendor_id=0x%x vendor_id_last=0x%x",vendor_id,vendor_id_last);
...
static kal_uint32 open(void)
{
	...
	LOG_INF("[open]: hi1336_txd@MT6765,MIPI 4LANE\n");
...
/* hs03s code for DEVAL5625-1453 by xuxianwei at 2021/06/11 end */
	case SENSOR_FEATURE_GET_CROP_INFO:
		...
		break;
		/* hs03s code for DEVAL5625-971 by xutengtao at 2021/06/11 start */
		/* hs03s code for CAM-AL5625-01-247 by majunfen at 2021/05/27 start */
		case MSDK_SCENARIO_ID_CUSTOM1:
			memcpy((void *)wininfo,
