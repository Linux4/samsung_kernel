...
#define IMX582_OTP_PAGE_SETUP_ADDR         (0x0A02)
#define IMX582_OTP_READ_TRANSFER_MODE_ADDR (0x0A00)
#define IMX582_OTP_STATUS_REGISTER_ADDR    (0x0A01)
#define IMX582_OTP_CHIP_REVISION_ADDR      (0x0018)
