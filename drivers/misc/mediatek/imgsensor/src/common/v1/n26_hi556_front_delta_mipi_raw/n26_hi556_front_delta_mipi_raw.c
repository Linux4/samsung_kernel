...
#include "n26_hi556_front_delta_mipi_raw.h"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = N26_HI556_FRONT_DELTA_SENSOR_ID,
...
static int read_hi556_module_info(void)
{
	...
	if(hi556_module_id != 0x1d){
		LOG_INF("hi556_module_id = 0x%x,it's not delta hi556_module_id!",hi556_module_id);
		return 0;
	}
...
{
	return ((read_cmos_sensor(0x0F16) << 8) | read_cmos_sensor(0x0F17)) + 1; //+bug682590,zhanghengyuan.wt,ADD,2022/2/17,+1 for N26_HI556_FRONT_DELTA_SENSOR_ID
}
...
//+bug682590,zhanghengyuan.wt,ADD,2022/2/18, n26 hi556 front delta porting otp
#include "cam_cal_define.h"
#include <linux/slab.h>
static struct stCAM_CAL_DATAINFO_STRUCT delta_front_hi556_eeprom_data ={
	.sensorID= N26_HI556_FRONT_DELTA_SENSOR_ID,
	.deviceID = 0x02,
	.dataLength = 0x0766,
	.sensorVendorid = 0x1d050101,
	.vendorByte = {1,2,3,4},
	.dataBuffer = NULL,
};
			...
			if (*sensor_id == imgsensor_info.sensor_id) {
				LOG_INF(
				   ...
				   //+bug682590,zhanghengyuan.wt,ADD,2022/2/18, n26 hi556 front xl porting otp
					...
					delta_front_hi556_eeprom_data.dataBuffer = kmalloc(delta_front_hi556_eeprom_data.dataLength, GFP_KERNEL);
					if (delta_front_hi556_eeprom_data.dataBuffer == NULL) {
						LOG_INF("delta_front_hi556_eeprom_data->dataBuffer is malloc fail\n");
						return -EFAULT;
					}

					memcpy(delta_front_hi556_eeprom_data.dataBuffer, (u8 *)&hi556_data_info, MODULE_INFO_SIZE);
					memcpy(delta_front_hi556_eeprom_data.dataBuffer+MODULE_INFO_SIZE, (u8 *)&hi556_data_awb, AWB_DATA_SIZE);
					memcpy(delta_front_hi556_eeprom_data.dataBuffer+MODULE_INFO_SIZE+AWB_DATA_SIZE, (u8 *)&hi556_data_lsc, LSC_DATA_SIZE);

					imgSensorSetEepromData(&delta_front_hi556_eeprom_data);
				}
				    //-bug682590,zhanghengyuan.wt,ADD,2022/2/18, n26 hi556 front xl porting otp
				    #endif
				return ERROR_NONE;
