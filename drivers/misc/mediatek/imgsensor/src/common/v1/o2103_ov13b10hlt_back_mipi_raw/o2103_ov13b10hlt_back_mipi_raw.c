...
#define PFX "o2103_ov13b10hlt_back_mipi_raw"
...
#include "o2103_ov13b10hlt_back_mipi_raw.h"
#define cam_pr_debug(format, args...)    \
	pr_debug(PFX "[%s] " format, __func__, ##args)

//PDAF
/*hs04 code for DEVAL6398A-462 by xutengtao at 2022/08/04 start */
#define ENABLE_PDAF
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = O2103_OV13B10HLT_BACK_SENSOR_ID,
...
/*hs04 code for DEAL6398A-68 by xutengtao at 2022/08/15 start */
	.i2c_speed = 1000,
/*hs04 code for DEAL6398A-68 by xutengtao at 2022/08/15 end */
};
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[6] = {
	{ 4240, 3136,    0,    0, 4240, 3136, 2120, 1568, 8,    4, 2104, 1560,    0,    0, 2104, 1560}, //PREVIEW
	{ 4240, 3136,    0,    0, 4240, 3136, 4240, 3136, 16,    8, 4208, 3120,    0,    0, 4208, 3120}, //CAPTURE
	{ 4240, 3136,    0,    0, 4240, 3136, 4240, 3136, 16,    8, 4208, 3120,    0,    0, 4208, 3120}, //NORMAL VIDEO
	{ 4240, 3136,  800,  576, 2640, 1984,  660,  496, 10,    8,  640,  480,    0,    0,  640,  480}, // HS VIDEO
	{ 4240, 3136,    0,    0, 4240, 3136, 2120, 1568, 8,    4, 2104, 1560,    0,    0, 2104, 1560},//SLIM VIDEO
	{ 4240, 3136,    0,    0, 4240, 3136, 4240, 3136, 16,    8, 4208, 3120,    0,    0, 4208, 3120}, //custom1 24fps (4208 x 3120)
};
...
/*hs04 code for P220817-01963  by xutengtao at 2022/08/26 start */
...
/*hs04 code for P220817-01963  by xutengtao at 2022/08/26 end */
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_init_ov13b10_hlt[] = {
	0x0103, 0x01,
	0x0303, 0x01,
	0x0305, 0x46,
	0x0321, 0x00,
...
static void sensor_init(void)
{
	...
	ov13b10_table_write_cmos_sensor(
		addr_data_pair_init_ov13b10_hlt,
		sizeof(addr_data_pair_init_ov13b10_hlt) / sizeof(kal_uint16));
#else
	cam_pr_debug("E\n");
	write_cmos_sensor(0x0103, 0x01);
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_preview_ov13b10_hlt[] = {
	0x0305, 0x23,
    0x0325, 0x50,
    0x3501, 0x06,
    0x3502, 0x10,
...
#if MULTI_WRITE
	ov13b10_table_write_cmos_sensor(
		addr_data_pair_preview_ov13b10_hlt,
		sizeof(addr_data_pair_preview_ov13b10_hlt) / sizeof(kal_uint16));
#else
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_capture_15fps_ov13b10_hlt[] = {
	0x0305, 0x46,
    0x0325, 0x50,
    0x3501, 0x0c,
    0x3502, 0x10,
...
kal_uint16 addr_data_pair_capture_30fps_ov13b10_hlt[] = {
	0x0305, 0x46,
    0x0325, 0x50,
    0x3501, 0x0c,
    0x3502, 0x10,
...
static void capture_setting(kal_uint16 currefps)
{
	...
	if (currefps == 150) {
		ov13b10_table_write_cmos_sensor(
			addr_data_pair_capture_15fps_ov13b10_hlt,
			sizeof(addr_data_pair_capture_15fps_ov13b10_hlt) /
			sizeof(kal_uint16));
	} else {
		ov13b10_table_write_cmos_sensor(
			addr_data_pair_capture_30fps_ov13b10_hlt,
			sizeof(addr_data_pair_capture_30fps_ov13b10_hlt) /
			sizeof(kal_uint16));
	}
#else
	if (currefps == 150) {
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_video_ov13b10_dd[] = {
	0x0305, 0x46,
    0x0325, 0x50,
    0x3501, 0x0c,
    0x3502, 0x10,
...
#if MULTI_WRITE
	ov13b10_table_write_cmos_sensor(
		addr_data_pair_video_ov13b10_dd,
		sizeof(addr_data_pair_video_ov13b10_dd) /
		sizeof(kal_uint16));
#else
	write_cmos_sensor(0x0305, 0x46);
	write_cmos_sensor(0x3501, 0x0c);
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_hs_video_ov13b10_hlt[] = {
	0x0305, 0x23,
    0x0325, 0x50,
    0x3501, 0x02,
    0x3502, 0x00,
...
#if MULTI_WRITE
	ov13b10_table_write_cmos_sensor(
		addr_data_pair_hs_video_ov13b10_hlt,
		sizeof(addr_data_pair_hs_video_ov13b10_hlt) /
		sizeof(kal_uint16));
#else
	write_cmos_sensor(0x0305, 0x23);
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_slim_video_ov13b10_hlt[] = {
	0x0305, 0x23,
    0x0325, 0x50,
    0x3501, 0x06,
    0x3502, 0x10,
...
#if MULTI_WRITE
	ov13b10_table_write_cmos_sensor(
		addr_data_pair_slim_video_ov13b10_hlt,
		sizeof(addr_data_pair_slim_video_ov13b10_hlt) /
		sizeof(kal_uint16));
#else
	write_cmos_sensor(0x0305, 0x23);
	write_cmos_sensor(0x3501, 0x06);
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_custom1_ov13b10_hlt[] = {
	0x0305, 0x46,
    0x0325, 0x50,
    0x3501, 0x0c,
    0x3502, 0x10,
...
#if MULTI_WRITE
	ov13b10_table_write_cmos_sensor(
		addr_data_pair_custom1_ov13b10_hlt,
		sizeof(addr_data_pair_custom1_ov13b10_hlt) /
		sizeof(kal_uint16));
#else
...
{
cam_pr_debug("ddRead sensor id %0x",read_cmos_sensor(0x300c));
if(read_cmos_sensor(0x300c)==0x43){
	cam_pr_debug("lilulingddRead sensor id 0x300a:%0x,0x300b:%0x",read_cmos_sensor(0x300a),read_cmos_sensor(0x300b));
	return ((read_cmos_sensor(0x300a) << 16) |
		(read_cmos_sensor(0x300b) << 8) | read_cmos_sensor(0x300c)-1)+3;
}else{
	return ((read_cmos_sensor(0x300a) << 16) |
		(read_cmos_sensor(0x300b) << 8) | read_cmos_sensor(0x300c));
}
}
/*A03s code for SR-AL5625-01-324 by xuxianwei at 2021/05/20 end*/
...
/*hs04 code for DEVAL6398A-462 by xutengtao at 2022/08/04 end */
/*  hs04 code for DEVAL6398A-462 by liluling at 2022/08/11 end */
