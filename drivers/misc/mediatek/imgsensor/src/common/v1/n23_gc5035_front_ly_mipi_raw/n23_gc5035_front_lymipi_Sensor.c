...
#include "n23_gc5035_front_lymipi_Sensor.h"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = N23_GC5035_FRONT_LY_SENSOR_ID,
	...
	.isp_driving_current = ISP_DRIVING_2MA,//+Bug682590 liudijin.wt, add, 2021/10/15, add fae code change mipi rate to fix gc5035 sensor radio-frequency interference issue.
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[5] = {
	...
	{ 2592, 1944,   0,   0, 2592, 1944, 2592, 1944, 0, 0, 2592, 1944, 0, 0, 2592, 1944 },
	{ 2592, 1944,   0, 232, 2592, 1480, 1296,  740, 8, 10, 1280,  720, 0, 0, 1280,  720 },
...
static void sensor_init(void)
{
	...
	/* MIPI */
	write_cmos_sensor(0xfe, 0x03);
	write_cmos_sensor(0x02, 0x55);//Bug682590 liudijin.wt, add, 2021/10/15, add fae code change mipi rate to fix gc5035 sensor radio-frequency interference issue.
...
static void preview_setting(void)
{
	...
	/* MIPI */
	write_cmos_sensor(0xfe, 0x03);
	write_cmos_sensor(0x02, 0x56);//Bug682590 liudijin.wt, add, 2021/10/15, add fae code change mipi rate to fix gc5035 sensor radio-frequency interference issue.
...
static struct stCAM_CAL_DATAINFO_STRUCT n23_gc5035_front_ly_eeprom_data ={
	.sensorID= N23_GC5035_FRONT_LY_SENSOR_ID,
	.deviceID = 0x02,
	.dataLength = 0x0778,
			...
			*sensor_id = return_sensor_id();
			if (*sensor_id == imgsensor_info.sensor_id) {
				...
				if(size != n23_gc5035_front_ly_eeprom_data.dataLength || (n23_gc5035_front_ly_eeprom_data.sensorVendorid >> 24)!= read_eeprom(0x0001)) {
					...
					if(n23_gc5035_front_ly_eeprom_data.dataBuffer != NULL) {
						kfree(n23_gc5035_front_ly_eeprom_data.dataBuffer);
						n23_gc5035_front_ly_eeprom_data.dataBuffer = NULL;
					}
					*sensor_id = 0xFFFFFFFF;
					return ERROR_SENSOR_CONNECT_FAIL;
				} else {
					pr_info("get eeprom data success\n");
					imgSensorSetEepromData(&n23_gc5035_front_ly_eeprom_data);
				}
				//-bug682590 liudijin.wt, add, 2021/8/26, gc5035 otp porting
