...
#include "n26_hi556_front_xl_mipi_raw.h"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = N26_HI556_FRONT_XL_SENSOR_ID,
...
#define MODULE_GROUP_FLAG 0x401
#define MODULE_GROUP1_ADDR 0x0402
#define MODULE_GROUP2_ADDR 0x040A
#define MODULE_GROUP3_ADDR 0x0412

#define AWB_GROUP_FLAG 0x0442
#define AWB_GROUP1_FLAG 0x0443
#define AWB_GROUP2_FLAG 0x0454
#define AWB_GROUP3_FLAG 0x0465

#define LSC_GROUP_FLAG 0x0476
#define LSC_GROUP1_FLAG 0x0477
#define LSC_GROUP2_FLAG 0x0BC4
#define LSC_GROUP3_FLAG 0x1311
//-bug604664, liuxingyu, add, 2020/12/18, add for hi556 eeprom bring up

#define VALID_OTP_FLAG 0x55
//#define OTP_GROUP_OFFSET 0x76A

static unsigned char hi556_data_lsc[LSC_DATA_SIZE + 1] = {0};/*Add check sum*/
static unsigned char hi556_data_awb[AWB_DATA_SIZE + 1] = {0};/*Add check sum*/
static unsigned char hi556_data_info[MODULE_INFO_SIZE + 1] = {0};/*Add check sum*/
static unsigned char hi556_module_id = 0;
static unsigned char hi556_lsc_valid = 0;
static unsigned char hi556_awb_valid = 0;
...
static int read_hi556_module_info(void)
{
	...
	if(hi556_module_id != 0x6){
		LOG_INF("hi556_module_id = 0x%x,it's not xl hi556_module_id!",hi556_module_id);
		return 0;
	}
...
#if MULTI_WRITE
static kal_uint16 addr_data_pair_init_hi556[] = {
	0x0a00, 0x0000,
	0x0e00, 0x0102,
	0x0e02, 0x0102,
	0x0e0c, 0x0100,
...
#if MULTI_WRITE
static kal_uint16 addr_data_pair_preview_hi556[] = {
	0x0b0a, 0x8259,
	0x0f30, 0x6925,
	0x0f32, 0x7167,
	0x004a, 0x0100,
...
#if MULTI_WRITE
static kal_uint16 addr_data_pair_capture_fps_hi556[] = {
	0x0b0a, 0x8252,
	0x0f30, 0x6925,
	0x0f32, 0x7067,
	0x004a, 0x0100,
...
static kal_uint16 addr_data_pair_capture_30fps_hi556[] = {
	0x0b0a, 0x8252,
	0x0f30, 0x6925,
	0x0f32, 0x7067,
	0x004a, 0x0100,
...
#if MULTI_WRITE
static kal_uint16 addr_data_pair_hs_video_hi556[] = {
	0x0b0a, 0x8252,
	0x0f30, 0x6925,
	0x0f32, 0x7267,
	0x004a, 0x0100,
...
#if MULTI_WRITE
static kal_uint16 addr_data_pair_slim_video_hi556[] = {
	0x0b0a, 0x8252,
	0x0f30, 0x6925,
	0x0f32, 0x7167,
	0x004a, 0x0100,
...
//+bug682590,zhanghengyuan.wt,ADD,2022/2/18, n26 hi556 front xl porting otp
#include "cam_cal_define.h"
#include <linux/slab.h>
static struct stCAM_CAL_DATAINFO_STRUCT xl_front_hi556_eeprom_data ={
	.sensorID= N26_HI556_FRONT_XL_SENSOR_ID,
	.deviceID = 0x02,
	.dataLength = 0x0766,
			...
			*sensor_id = return_sensor_id();
			if (*sensor_id == imgsensor_info.sensor_id) {
				...
				if(rc == 0){
					...
					xl_front_hi556_eeprom_data.dataBuffer = kmalloc(xl_front_hi556_eeprom_data.dataLength, GFP_KERNEL);
					if (xl_front_hi556_eeprom_data.dataBuffer == NULL) {
						LOG_INF("xl_front_hi556_eeprom_data->dataBuffer is malloc fail\n");
						return -EFAULT;
					}

					memcpy(xl_front_hi556_eeprom_data.dataBuffer, (u8 *)&hi556_data_info, MODULE_INFO_SIZE);
					memcpy(xl_front_hi556_eeprom_data.dataBuffer+MODULE_INFO_SIZE, (u8 *)&hi556_data_awb, AWB_DATA_SIZE);
					memcpy(xl_front_hi556_eeprom_data.dataBuffer+MODULE_INFO_SIZE+AWB_DATA_SIZE, (u8 *)&hi556_data_lsc, LSC_DATA_SIZE);

					imgSensorSetEepromData(&xl_front_hi556_eeprom_data);
				}
				    //+bug682590,zhanghengyuan.wt,ADD,2022/2/18, n26 hi556 front xl porting otp
				    #endif
				return ERROR_NONE;
