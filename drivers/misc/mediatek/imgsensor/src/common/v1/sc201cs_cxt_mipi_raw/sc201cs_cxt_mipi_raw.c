...
#include "sc201cs_cxt_mipi_raw.h"
...
static imgsensor_info_struct imgsensor_info = { 
    .sensor_id = SC201CS_CXT_SENSOR_ID,
...
{
	return ((read_cmos_sensor(0x3107) << 8) | read_cmos_sensor(0x3108))+1; //0xeb2c+1
}
