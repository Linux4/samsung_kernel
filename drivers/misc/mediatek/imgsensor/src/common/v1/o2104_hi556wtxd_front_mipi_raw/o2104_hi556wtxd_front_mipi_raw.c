...
#include "o2104_hi556wtxd_front_mipi_raw.h"

#define PFX "o2104_hi556wtxd_camera_sensor"
...
static kal_uint16 o2104_hi556w_table_write_cmos_sensor(
...
/* hs04 code for SR-AL6398A-01-12 by liluling at 2022/7/24 begin */
//otp init before read
...
/* hs04 code for SR-AL6398A-01-12 by liluling at 2022/7/24 end */
static kal_uint32 return_sensor_id(void)
{
	return ((read_cmos_sensor(0x0F16) << 8) | read_cmos_sensor(0x0F17)+1)+2;
}
...
/* A03s code for DEVAL5625-907 by xuxianwei at 2021/06/01 start */
/* A03s code for DEVAL5625-907 by xuxianwei at 2021/06/18 start */
kal_uint16 addr_data_pair_init_o2104_hi556w[] = {
...
{
o2104_hi556w_table_write_cmos_sensor(
	addr_data_pair_init_o2104_hi556w,
	sizeof(addr_data_pair_init_o2104_hi556w) /
	sizeof(kal_uint16));
}

kal_uint16 addr_data_pair_preview_o2104_hi556w[] = {
	0x0b0a, 0x8252,
	0x0f30, 0x6e25,
	0x0f32, 0x7067,
	0x004a, 0x0100,
...
{
	o2104_hi556w_table_write_cmos_sensor(
		addr_data_pair_preview_o2104_hi556w,
		sizeof(addr_data_pair_preview_o2104_hi556w) /
		sizeof(kal_uint16));
}


kal_uint16 addr_data_pair_capture_fps_o2104_hi556w[] = {
	0x0b0a, 0x8252,
	0x0f30, 0x6e25,
	0x0f32, 0x7067,
	0x004a, 0x0100,
...
kal_uint16 addr_data_pair_capture_30fps_o2104_hi556w[] = {
	0x0b0a, 0x8252,
	0x0f30, 0x6e25,
	0x0f32, 0x7067,
	0x004a, 0x0100,
...
static void capture_setting(kal_uint16 currefps)
{
	if (currefps == 300) {
		o2104_hi556w_table_write_cmos_sensor(
			addr_data_pair_capture_30fps_o2104_hi556w,
			sizeof(addr_data_pair_capture_30fps_o2104_hi556w) /
			sizeof(kal_uint16));
	} else {
		o2104_hi556w_table_write_cmos_sensor(
			addr_data_pair_capture_fps_o2104_hi556w,
			sizeof(addr_data_pair_capture_fps_o2104_hi556w) /
			sizeof(kal_uint16));
	}
}

kal_uint16 addr_data_pair_normal_video_o2104_hi556w[] = {
	0x0b0a, 0x8252,
	0x0f30, 0x6e25,
	0x0f32, 0x7067,
	0x004a, 0x0100,
...
{
o2104_hi556w_table_write_cmos_sensor(
		addr_data_pair_normal_video_o2104_hi556w,
		sizeof(addr_data_pair_normal_video_o2104_hi556w) /
		sizeof(kal_uint16));
}

kal_uint16 addr_data_pair_hs_video_o2104_hi556w[] = {
	0x0b0a, 0x8252,
	0x0f30, 0x6e25,
	0x0f32, 0x7067,
	0x004a, 0x0100,
...
{
	o2104_hi556w_table_write_cmos_sensor(
		addr_data_pair_hs_video_o2104_hi556w,
		sizeof(addr_data_pair_hs_video_o2104_hi556w) /
		sizeof(kal_uint16));
}

kal_uint16 addr_data_pair_slim_video_o2104_hi556w[] = {
	0x0b0a, 0x8252,
	0x0f30, 0x6e25,
	0x0f32, 0x7067,
	0x004a, 0x0100,
...
/* A03s code for DEVAL5625-907 by xuxianwei at 2021/06/18 end */
/* A03s code for DEVAL5625-907 by xuxianwei at 2021/06/01 end */
static void slim_video_setting(void)
{
	o2104_hi556w_table_write_cmos_sensor(
		addr_data_pair_slim_video_o2104_hi556w,
		sizeof(addr_data_pair_slim_video_o2104_hi556w) /
		sizeof(kal_uint16));
}
/* hs04 code for SR-AL6398A-01-12 by liluling at 2022/7/24 begin */
...
static kal_uint16 get_module_id()
{
	kal_uint16 module_id = 0;
    o2104_hi556wtxd_front_otp_init();
    if(OTP_read_cmos_sensor(0x401)==0x01)
    {
		LOG_INF("o2104_hi556wtxd_front_otp read in group 1\n");
		module_id = OTP_read_cmos_sensor(0x403);
	}
	else if(OTP_read_cmos_sensor(0x40c)==0x01)
	{
		LOG_INF("o2104_hi556wtxd_front_otp read in group 2\n");
		module_id = OTP_read_cmos_sensor(0x40e);
	}
	else if(OTP_read_cmos_sensor(0x417)==0x01)
	{
		LOG_INF("o2104_hi556wtxd_front_otp read in group 3\n");
		module_id = OTP_read_cmos_sensor(0x419);
	}
...
/*hs04 code for DEVAL6398A-24 by xutengtao at 2022/07/28 start */
    ...
    if(module_id != 0x44)
    {
        LOG_INF("hi556w_txd Read modele id fail,module_id: 0x%x\n", module_id);
...
UINT32 O2104_HI556WWTXD_FRONT_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
	...
	if (pfFunc != NULL)
		*pfFunc =  &sensor_func;
	return ERROR_NONE;
}	/*	o2104_hi556w_MIPI_RAW_SensorInit	*/
