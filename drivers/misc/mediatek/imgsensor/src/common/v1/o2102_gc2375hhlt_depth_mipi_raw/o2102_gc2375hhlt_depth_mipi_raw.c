 ...
 * Filename:
 * ---------
 *     o2102_gc2375h_hlt_depth_mipi_Sensor.c
 *
 * Project:
 * --------
 *     ALPS
...
#include "o2102_gc2375hhlt_depth_mipi_raw.h"

/************************** Modify Following Strings for Debug **************************/
#define PFX "o2102_gc2375h_hlt_camera_sensor"
#define LOG_1 LOG_INF("GC2375H_HLT, MIPI 1LANE\n")
/****************************   Modify end    *******************************************/

#define LOG_INF(format, args...)    pr_debug(PFX "[%s] " format, __func__, ##args)

static DEFINE_SPINLOCK(imgsensor_drv_lock);
kal_bool GC2375H_HLTDuringTestPattern = KAL_FALSE;

/* hs03s code for CAM-AL5625-01-247 by lisizhou at 2021/05/24 start */
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = O2102_GC2375HHLT_DEPTH_SENSOR_ID,
...
/*hs04 code for DEVAL6398A-24 by xutengtao at 2022/07/27 start */
	.sensor_output_dataformat = SENSOR_OUTPUT_FORMAT_RAW_MONO,
/*hs04 code for DEVAL6398A-24 by xutengtao at 2022/07/27 end */
	.mclk = 24,
...
/* A03s code for SR-AL5625-01-324 by wuwenjie at 2021/06/1 start*/
	return (((read_cmos_sensor(0xf0) << 8) | read_cmos_sensor(0xf1)) + 2 ); //return sensor ID 0x2377
...
static void sensor_init(void)
{
	...
	write_cmos_sensor(0x17, GC2375H_HLT_MIRROR);
	...
	write_cmos_sensor(0x4e, GC2375H_HLT_BLK_Select1_H);
	write_cmos_sensor(0x4f, GC2375H_HLT_BLK_Select1_L);
	write_cmos_sensor(0x66, GC2375H_HLT_BLK_Select2_H);
	write_cmos_sensor(0x67, GC2375H_HLT_BLK_Select2_L);
...
/*  hs04 code for DEVAL6398A-462 by liluling at 2022/08/08 start */
...
/* hs03s code for CAM-AL5625-01-247 by lisizhou at 2021/05/24 end */
/*  hs04 code for DEVAL6398A-462 by liluling at 2022/08/08 end */
...
static kal_uint32 open(void)
{
	...
	spin_unlock(&imgsensor_drv_lock);
	GC2375H_HLTDuringTestPattern = KAL_FALSE;
	return ERROR_NONE;
}
