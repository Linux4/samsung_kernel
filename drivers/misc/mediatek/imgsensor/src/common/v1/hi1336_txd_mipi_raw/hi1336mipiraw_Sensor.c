...
/* hs03s code for DEVAL5625-1005 by xuxianwei at 2021/06/02 start */
/* hs03s code for CAM-AL5625-01-247 by lisizhou at 2021/05/27 start */
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = HI1336_TXD_SENSOR_ID,
	/* A03s code for SR-AL5625-01-324 by wuwenjie at 2021/05/20 start */
...
/* hs03s code for CAM-AL5625-01-247 by lisizhou at 2021/05/27 end */
...
/* hs03s code for CAM-AL5625-01-247 by lisizhou at 2021/05/24 start */
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[7] = {
	...
	{ 4224, 3136,   0,   6, 4224, 3124,	 4224, 3124,  8,  2, 4208, 3120, 0, 0, 4208, 3120},		//custom2	
};
/* hs03s code for CAM-AL5625-01-247 by lisizhou at 2021/05/24 end */
...
static kal_uint16 hi1336_txd_table_write_cmos_sensor(
...
kal_uint16 addr_data_pair_init_hi1336_txd[] = {
	0x2000, 0x0021,
	0x2002, 0x04a5,
	0x2004, 0xb124,
	0x2006, 0xc09c,
...
{
	hi1336_txd_table_write_cmos_sensor(
		addr_data_pair_init_hi1336_txd,
		sizeof(addr_data_pair_init_hi1336_txd) /
		sizeof(kal_uint16));
}

kal_uint16 addr_data_pair_preview_hi1336_txd[] = {
...
{
	hi1336_txd_table_write_cmos_sensor(
		addr_data_pair_preview_hi1336_txd,
		sizeof(addr_data_pair_preview_hi1336_txd) /
		sizeof(kal_uint16));
}

kal_uint16 addr_data_pair_capture_30fps_hi1336_txd[] = {
	0x3250, 0xa060, //sreg8 - RAMP,B[15:10]:d2a_ramp_rng_ctrl
	0x0730, 0x770f, //pll_cfg_mipi_a PLL_CLK=750mhz b7-6:00_isp_div2(1/1) 
...
kal_uint16 addr_data_pair_capture_15fps_hi1336_txd[] = {
	0x3250, 0xa060, //sreg8 - RAMP,B[15:10]:d2a_ramp_rng_ctrl
	0x0730, 0x770f, 
	0x0732, 0xe0b0, 
	0x1118, 0x0006, 
...
static void capture_setting(kal_uint16 currefps)
{
	if (currefps == 300) {
	hi1336_txd_table_write_cmos_sensor(
		addr_data_pair_capture_30fps_hi1336_txd,
		sizeof(addr_data_pair_capture_30fps_hi1336_txd) /
		sizeof(kal_uint16));

	} else {
	hi1336_txd_table_write_cmos_sensor(
		addr_data_pair_capture_15fps_hi1336_txd,
		sizeof(addr_data_pair_capture_15fps_hi1336_txd) /
		sizeof(kal_uint16));
	}
}

kal_uint16 addr_data_pair_video_hi1336_txd[] = {
	0x3250, 0xa060, //sreg8 - RAMP,B[15:10]:d2a_ramp_rng_ctrl
	0x0730, 0x770f, //pll_cfg_mipi_a PLL_CLK=750mhz b7-6:00_isp_div2(1/1) 
	0x0732, 0xe0b0, //pll_cfg_mipi_b b13-11:100_isp_div1(1/5) b10-8:000_mipi_div1(1/1) b1-0:00_mipi_div2(1/1) 
	0x1118, 0x0006, //LSC r_win_y B[11]: Bit8 of y offset in start block when cropping. B[10:8] y start index of block when cropping. B[7:0] y offset in start block when cropping.
...
{
	hi1336_txd_table_write_cmos_sensor(
		addr_data_pair_video_hi1336_txd,
		sizeof(addr_data_pair_video_hi1336_txd) /
		sizeof(kal_uint16));
}

kal_uint16 addr_data_pair_hs_video_hi1336_txd[] = {
	0x3250, 0xa470, //sreg8 - RAMP,B[15:10]:d2a_ramp_rng_ctrl
	0x0730, 0x770f, //pll_cfg_mipi_a PLL_CLK=750mhz b7-6:00_isp_div2(1/1) 
...
{
	hi1336_txd_table_write_cmos_sensor(
		addr_data_pair_hs_video_hi1336_txd,
		sizeof(addr_data_pair_hs_video_hi1336_txd) /
		sizeof(kal_uint16));
}

kal_uint16 addr_data_pair_slim_video_hi1336_txd[] = {
	0x3250, 0xa060, //sreg8 - RAMP,B[15:10]:d2a_ramp_rng_ctrl
	0x0730, 0x770f, //pll_cfg_mipi_a PLL_CLK=750mhz b7-6:00_isp_div2(1/1) 
...
{
	hi1336_txd_table_write_cmos_sensor(
		addr_data_pair_slim_video_hi1336_txd,
		sizeof(addr_data_pair_slim_video_hi1336_txd) /
		sizeof(kal_uint16));
}
...
/* hs03s code for DEVAL5625-1005 by xuxianwei at 2021/06/02 end */
			...
			UINT8 *feature_para, UINT32 *feature_para_len)
{
	...
	case SENSOR_FEATURE_GET_TEST_PATTERN_CHECKSUM_VALUE:
	    ...
	    *feature_para_len = 4;
	break;
/* hs03s code for DEVAL5625-1453 by xuxianwei at 2021/06/11 start */
	...
	case SENSOR_FEATURE_SET_HDR:
	    ...
	    spin_unlock(&imgsensor_drv_lock);
	break;
/* hs03s code for DEVAL5625-1453 by xuxianwei at 2021/06/11 end */
...
/* hs03s code for CAM-AL5625-01-247 by lisizhou at 2021/05/24 end */
	...
	{
		kal_uint32 rate;
		/* hs03s code for DEVAL5625-971 by xutengtao at 2021/06/11 start */
		switch (*feature_data) {
			case MSDK_SCENARIO_ID_CAMERA_CAPTURE_JPEG:
		...
		/* hs03s code for DEVAL5625-971 by xutengtao at 2021/06/11 end */
...
/* A03s code for SR-AL5625-01-324 by wuwenjie at 2021/05/20 end */
