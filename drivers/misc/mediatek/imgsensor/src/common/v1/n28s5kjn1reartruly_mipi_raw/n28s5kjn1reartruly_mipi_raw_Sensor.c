 ...
 * Filename:
 * ---------
 *     n28s5kjn1reartruly_mipi_Sensor.c
 *
 * Project:
 * --------
 *     ALPS
...
#define PFX "n28s5kjn1reartruly_camera_sensor"
#define LOG_1 LOG_INF("n28s5kjn1reartruly,MIPI 4LANE\n")
/****************************   Modify end    **************************/
#define LOG_INF(format, args...) pr_err(PFX "[%s] " format, __func__, ##args)
#define LOG_ERR(format, args...) pr_err(PFX "[%s] " format, __func__, ##args)

#define DEVICE_VERSION_S5KJN103     "n28s5kjn1reartruly"
...
static struct imgsensor_info_struct imgsensor_info = {
    .sensor_id = N28S5KJN1REARTRULY_SENSOR_ID,
    .module_id = 0x06,
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[9] = {
    ...
    {8160, 6144, 240, 912,    7680, 4320, 1920, 1080,  0,   0,   1920, 1080,    0,    0, 1920, 1080}, /* custom4 */
};
...
static kal_int32 write_Module_data(ACDK_SENSOR_ENGMODE_STEREO_STRUCT * pStereodata)
{
    ...
    if(pStereodata != NULL) {
        ...
        if ((pStereodata->uSensorId == N28_S5KJN1_REAR_TRULY_SENSOR_ID) && (data_length == DUALCAM_CALI_DATA_LENGTH)
...
/*n28 2022/04/18, add for HW_GGC write to sensor start*/
...
/*n28 2022/04/18, add for HW_GGC write to sensor end*/
#endif
...
static void n28s5kjn1reartruly03_set_lsc_reg_setting(
...
static kal_uint16 n28s5kjn1reartruly03_init_setting[] = {
	0x6028,0x2400,
	0x602A,0x1354,
	0x6F12,0x0100,
	0x6F12,0x7017,
...
static kal_uint16 n28s5kjn1reartruly03_capture_setting[] = {
	0x6028, 0x2400,
	0x602A, 0x1A28,
	0x6F12, 0x4C00,
	0x602A, 0x065A,
...
static kal_uint16 n28s5kjn1reartruly03_preview_setting[] = {
	0x6028, 0x2400,
	0x602A, 0x1A28,
	0x6F12, 0x4C00,
	0x602A, 0x065A,
...
static kal_uint16 n28s5kjn1reartruly03_normal_video_setting[] = {
	0x6028, 0x2400,
	0x602A, 0x1A28,
	0x6F12, 0x4C00,
	0x602A, 0x065A,
...
static kal_uint16 n28s5kjn1reartruly03_hs_video_setting[] = {
	0x6028, 0x2400,
	0x602A, 0x1A28,
	0x6F12, 0x4C00,
	0x602A, 0x065A,
...
static kal_uint16 n28s5kjn1reartruly03_slim_video_setting[] = {
	0x6028, 0x2400,
	0x602A, 0x1A28,
	0x6F12, 0x4C00,
	0x602A, 0x065A,
...
static kal_uint16 n28s5kjn1reartruly03_custom1_setting[] = {
	0x6028, 0x2400,
	0x602A, 0x1A28,
	0x6F12, 0x4C00,
	0x602A, 0x065A,
...
static kal_uint16 n28s5kjn1reartruly03_custom2_setting[] = {
	0x6028, 0x2400,
	0x602A, 0x1A28,
	0x6F12, 0x4C00,
	0x602A, 0x065A,
...
static kal_uint16 n28s5kjn1reartruly03_custom3_setting[] = {
	0x6028, 0x2400,
	0x602A, 0x1A28,
	0x6F12, 0x4C00,
	0x602A, 0x065A,
...
static kal_uint16 n28s5kjn1reartruly03_custom4_setting[] = {
	0x6028, 0x2400,
	0x602A, 0x1A28,
	0x6F12, 0x4C00,
	0x602A, 0x065A,
...
static void sensor_init(void)
{
    ...
    table_write_cmos_sensor(n28s5kjn1reartruly03_init_setting,
        sizeof(n28s5kjn1reartruly03_init_setting) / sizeof(kal_uint16));
...
static void preview_setting(void)
{
    ...
    table_write_cmos_sensor(n28s5kjn1reartruly03_preview_setting,
        sizeof(n28s5kjn1reartruly03_preview_setting)/sizeof(kal_uint16));
...
static void capture_setting(kal_uint16 currefps)
{
    ...
    table_write_cmos_sensor(n28s5kjn1reartruly03_capture_setting,
        sizeof(n28s5kjn1reartruly03_capture_setting)/sizeof(kal_uint16));
...
static void normal_video_setting(kal_uint16 currefps)
{
    ...
    table_write_cmos_sensor(n28s5kjn1reartruly03_normal_video_setting,
        sizeof(n28s5kjn1reartruly03_normal_video_setting)/sizeof(kal_uint16));
    LOG_INF("X\n");
}
...
static void hs_video_setting(void)
{
    ...
    table_write_cmos_sensor(n28s5kjn1reartruly03_hs_video_setting,
        sizeof(n28s5kjn1reartruly03_hs_video_setting)/sizeof(kal_uint16));
    LOG_INF("X\n");
}
...
static void slim_video_setting(void)
{
    ...
    table_write_cmos_sensor(n28s5kjn1reartruly03_slim_video_setting,
        sizeof(n28s5kjn1reartruly03_slim_video_setting)/sizeof(kal_uint16));
    LOG_INF("X\n");
}
...
static void custom1_setting(void)
{
    ...
    /*************MIPI output setting************/
    table_write_cmos_sensor(n28s5kjn1reartruly03_custom1_setting,
        sizeof(n28s5kjn1reartruly03_custom1_setting)/sizeof(kal_uint16));
    LOG_INF("X");
}
...
static void custom2_setting(void)
{
    ...
    /*************MIPI output setting************/
    table_write_cmos_sensor(n28s5kjn1reartruly03_custom2_setting,
        sizeof(n28s5kjn1reartruly03_custom2_setting)/sizeof(kal_uint16));
    LOG_INF("X");
}
...
static void custom3_setting(void)
{
    ...
    /*************MIPI output setting************/
    table_write_cmos_sensor(n28s5kjn1reartruly03_custom3_setting,
        sizeof(n28s5kjn1reartruly03_custom3_setting)/sizeof(kal_uint16));
    LOG_INF("X");
}

static void custom4_setting(void)
{
    LOG_INF("%s CUS4_1920*1080@30fps E! currefps\n", __func__);
    /*************MIPI output setting************/
    table_write_cmos_sensor(n28s5kjn1reartruly03_custom4_setting,
        sizeof(n28s5kjn1reartruly03_custom4_setting)/sizeof(kal_uint16));
    LOG_INF("X");
}
#if 1 ///otp code
static struct stCAM_CAL_DATAINFO_STRUCT n28s5kjn1reartruly_eeprom_data ={
...
static struct stCAM_CAL_CHECKSUM_STRUCT n28s5kjn1reartruly_Checksum[14] =
{
    ...
    {XTC_DATA,0x0D5E,0x0D5E,0x1B0C,0x1B0D,0x55},
    {SENSOR_XTC_DATA,0x1B0E,0x1B0E,0x1E0E,0x1E0F,0x55},
    {PDXTC_DATA,0x1E10,0x1E10,0x2DB0,0x2DB1,0x55},
    {SWGCC_DATA,0x2DB2,0x2DB2,0x3024,0x3025,0x55},
    {HWGCC_DATA,0x3026,0x3026,0x3180,0x3181,0x55},
    {TOTAL_ITEM,0x0000,0x0000,0x3181,0x3182,0x55},
...
static kal_uint16 n28s5kjn1reartruly_read_eeprom(kal_uint32 addr)
{
     kal_uint16 get_byte=0;
        ...
        do {
            *sensor_id = ((read_cmos_sensor_8(0x0000) << 8)
            ...
            if (*sensor_id == imgsensor_info.sensor_id) {
				...
				eepromModuleValue = n28s5kjn1reartruly_read_eeprom(0x0001);
                 LOG_INF("s5kjn1_truly eepromModuleValue : 0x%x,", eepromModuleValue);
				if((n28s5kjn1reartruly_eeprom_data.sensorVendorid >> 24) != n28s5kjn1reartruly_read_eeprom(0x0001)){
				    *sensor_id = 0xFFFFFFFF;
					LOG_ERR("read module id not match i2c write id: 0x%x, sensor id: 0x%x module id: 0x%x\n",imgsensor.i2c_write_id, *sensor_id,
					n28s5kjn1reartruly_read_eeprom(0x0001));
					return ERROR_SENSOR_CONNECT_FAIL;
				}

#if 1
  //// add maincamera s5kjn1 otp code
             size = imgSensorReadEepromData(&n28s5kjn1reartruly_eeprom_data,n28s5kjn1reartruly_Checksum);
             if(size != n28s5kjn1reartruly_eeprom_data.dataLength) {
                 LOG_INF("get eeprom data failed\n");
                 if(n28s5kjn1reartruly_eeprom_data.dataBuffer != NULL) {
                     kfree(n28s5kjn1reartruly_eeprom_data.dataBuffer);
                     n28s5kjn1reartruly_eeprom_data.dataBuffer = NULL;
                 }
                 //*sensor_id = 0xFFFFFFFF;
                 //return ERROR_SENSOR_CONNECT_FAIL;
             } else {
                 pr_info("get eeprom data success\n");
                 imgSensorSetEepromData(&n28s5kjn1reartruly_eeprom_data);
#if N28_TRULY_S5KJN1_OTP
read_eepromData_HW_GGC();
memcpy(XTCBuffer, (kal_uint8*)&n28s5kjn1reartruly_eeprom_data.dataBuffer[TRULY_S5KJN1_OTP_XTC_OFFSET+1], S5KJN1_OTP_XTC_LEN);
memcpy(SENSORXTCBuffer, (kal_uint8*)&n28s5kjn1reartruly_eeprom_data.dataBuffer[TRULY_S5KJN1_OTP_SENSORXTC_OFFSET+1], S5KJN1_OTP_SENSORXTC_LEN);
memcpy(PDXTCXTCBuffer, (kal_uint8*)&n28s5kjn1reartruly_eeprom_data.dataBuffer[TRULY_S5KJN1_OTP_PDXTC_OFFSET+1], S5KJN1_OTP_PDXTC_LEN);
memcpy(SWGCCBuffer, (kal_uint8*)&n28s5kjn1reartruly_eeprom_data.dataBuffer[TRULY_S5KJN1_OTP_SWGCC_OFFSET+1], S5KJN1_OTP_SWGCC_LEN);
#endif
             }
...
static void read_4cell_from_eeprom(char *data, kal_uint16 datasize)
{
    if(datasize == (S5KJN1_OTP_XTC_LEN+2)){
        ...
        memcpy(data, size, 2);
        memcpy(&data[2], XTCBuffer, datasize);
                 ...
                 UINT8 *feature_para, UINT32 *feature_para_len)
{
    ...
    //    *(MUINT32 *)(uintptr_t)(*(feature_data + 1)) = 1602000;
    //    break;
    //-bug767771, liangyiyi.wt, ADD, 2022/8/31, modify for fixed sensor_fusion of its test fail
    ...
    case SENSOR_FEATURE_SET_LSC_TBL:
    {
        ...
        n28s5kjn1reartruly03_set_lsc_reg_setting(index, feature_data_16,
