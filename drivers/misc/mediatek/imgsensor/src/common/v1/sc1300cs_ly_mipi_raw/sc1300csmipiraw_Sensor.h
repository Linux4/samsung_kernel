 ...
 *
 ****************************************************************************/
#ifndef _SC1300CSMIPI_SENSOR_H
#define _SC1300CSMIPI_SENSOR_H
...
#define SC1300CS_SENSOR_GAIN_BASE             0x400
#define SC1300CS_SENSOR_GAIN_MAX              (635 * SC1300CS_SENSOR_GAIN_BASE / 10)
#define SC1300CS_SENSOR_GAIN_MAP_SIZE  6
...
struct imgsensor_info_struct {
	...
	struct imgsensor_mode_struct custom1;    //modify dualcam IDLHLYE-99 by wei.miao@reallytek.com 180629
	...
	kal_uint8 frame_time_delay_frame;    //modify dualcam IDLHLYE-99 by wei.miao@reallytek.com 180629
