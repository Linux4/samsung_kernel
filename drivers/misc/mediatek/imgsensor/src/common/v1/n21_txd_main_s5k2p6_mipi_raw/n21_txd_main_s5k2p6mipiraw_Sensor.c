 ...
 * Filename:
 * ---------
 *	 n21_txd_main_s5k2p6mipi_Sensor.c
 *
 * Project:
 * --------
 *	 ALPS
 ...
 *============================================================================
 ****************************************************************************/
#define PFX "N21_TXD_MAIN_S5K2P6_camera_sensor"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = N21_TXD_MAIN_S5K2P6_SENSOR_ID,
	...
	.pre = {
		...
		.grabwindow_width = 2304, //+bug537577 guojiabin.wt,MODIFY,20200305,modifi sensor mode preview->video
		/*record different mode's height of grabwindow*/
		.grabwindow_height = 1728, //+bug537577 guojiabin.wt,MODIFY,20200305,modifi sensor mode preview->video
	...
	/*bug 536165,gaoyu1.wt,mod,2020.3.5,mod power and register way for performance*/
        .i2c_speed = 400,
};
...
static struct SENSOR_VC_INFO_STRUCT SENSOR_VC_INFO[3] = {
	...
	0x00, 0x2B, 0x0900, 0x06C0, 0x01, 0x00, 0x0000, 0x0000,//+bug537577 guojiabin.wt,MODIFY,20200305,modifi sensor mode preview->video
	0x01, 0x30, 0x0168, 0x06C0, 0x03, 0x00, 0x0000, 0x0000},//+bug537577 guojiabin.wt,MODIFY,20200305,modifi sensor mode preview->video
	/* Video mode setting */
	{0x02, 0x0A,   0x00,   0x08, 0x40, 0x00,
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[5] = {
 { 4640, 3488,  16,	16, 4608, 3456, 2304,  1728, 0000, 0000, 2304, 1728,	    0,	0, 2304, 1728}, // //+bug537577 guojiabin.wt,MODIFY,20200305,modifi sensor mode preview->video
 //+Bug 524054, wanglei6.wt,MODIFY, 2019.12.23, modify image size and add log to the algorithm
 //bug528935,wanglei6.wt,MODIFY,20200110,The rear main camera does not support pdaf
...
static kal_uint16 addr_data_pair_init_2p6[] = {
	0x6028, 0x4000,
	0x0000, 0x0130,
	0x0000, 0x2106,
	0x6214, 0x7971,
...
{
//+bug 536165,gaoyu1.wt,mod,2020.3.5,mod power and register way for performance
table_write_cmos_sensor(addr_data_pair_init_2p6,
	sizeof(addr_data_pair_init_2p6) / sizeof(kal_uint16));
//-bug 536165,gaoyu1.wt,mod,2020.3.5,mod power and register way for performance
# if 0
printk("sensor_init 2 () E\n");
write_cmos_sensor(0x6028, 0x4000); 
...
//+bug537577 guojiabin.wt,MODIFY,20200305,modifi sensor mode preview->video
...
static struct stCAM_CAL_DATAINFO_STRUCT txd_main_s5k2p6_eeprom_data ={
	.sensorID= N21_TXD_MAIN_S5K2P6_SENSOR_ID,
	.deviceID = 0x01,
	.dataLength = 0x0D5D,
...
static struct stCAM_CAL_CHECKSUM_STRUCT txd_main_s5k2p6_Checksum[8] =
{
		...
		do {
	      ...
	      (read_cmos_sensor_8(0x0000) << 8) | read_cmos_sensor_8(0x0001));
			...
			if (*sensor_id == imgsensor_info.sensor_id) {
				//+Bug 492443, sunhushan.wt, ADD, 2019.10.15, porting the otp of the 12sensor 
				size = imgSensorReadEepromData(&txd_main_s5k2p6_eeprom_data,txd_main_s5k2p6_Checksum);
				if(size != txd_main_s5k2p6_eeprom_data.dataLength || (txd_main_s5k2p6_eeprom_data.sensorVendorid >> 24)!= read_eeprom(0x0001)) {
					printk("get eeprom data failed\n");
					if(txd_main_s5k2p6_eeprom_data.dataBuffer != NULL) {
						kfree(txd_main_s5k2p6_eeprom_data.dataBuffer);
						txd_main_s5k2p6_eeprom_data.dataBuffer = NULL;
					}
					*sensor_id = 0xFFFFFFFF;
					return ERROR_SENSOR_CONNECT_FAIL;
				} else {
					pr_debug("get eeprom data success\n");
					imgSensorSetEepromData(&txd_main_s5k2p6_eeprom_data);
				}
				//-Bug 492443, sunhushan.wt, ADD, 2019.10.15, porting the otp of the 12sensor 
