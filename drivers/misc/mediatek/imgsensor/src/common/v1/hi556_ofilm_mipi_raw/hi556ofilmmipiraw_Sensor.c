...
#include "hi556ofilmmipiraw_Sensor.h"

#define PFX "hi556_ofilm_camera_sensor"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = HI556_OFILM_SENSOR_ID,
...
/* A03s code for SR-AL5625-01-324 by wuwenjie at 2021/05/20 start */
	...
	.pre = {
		.pclk = 174400000,				//record different mode's pclk
		.linelength = 2816,				//record different mode's linelength
		.framelength = 2064,			//record different mode's framelength
		...
		.max_framerate = 300,
		.mipi_pixel_rate = 174400000,//872M x 2 / 10
	},
	.cap = {
		.pclk = 174400000,
		.linelength = 2816,	
...
static kal_uint16 hi556_ofilm_table_write_cmos_sensor(
...
kal_uint16 addr_data_pair_init_hi556_ofilm[] = {
...
{
hi556_ofilm_table_write_cmos_sensor(
	addr_data_pair_init_hi556_ofilm,
	sizeof(addr_data_pair_init_hi556_ofilm) /
	sizeof(kal_uint16));
}

kal_uint16 addr_data_pair_preview_hi556_ofilm[] = {
	0x0b0a, 0x8252,
	0x0f30, 0x6d25,
	0x0f32, 0x7067,
	0x004a, 0x0100,
...
{
	hi556_ofilm_table_write_cmos_sensor(
		addr_data_pair_preview_hi556_ofilm,
		sizeof(addr_data_pair_preview_hi556_ofilm) /
		sizeof(kal_uint16));
}


kal_uint16 addr_data_pair_capture_fps_hi556_ofilm[] = {
	0x0b0a, 0x8252,
	0x0f30, 0x6d25,
	0x0f32, 0x7067,
	0x004a, 0x0100,
...
kal_uint16 addr_data_pair_capture_30fps_hi556_ofilm[] = {
	0x0b0a, 0x8252,
	0x0f30, 0x6d25,
	0x0f32, 0x7067,
	0x004a, 0x0100,
...
static void capture_setting(kal_uint16 currefps)
{
	if (currefps == 300) {
		hi556_ofilm_table_write_cmos_sensor(
			addr_data_pair_capture_30fps_hi556_ofilm,
			sizeof(addr_data_pair_capture_30fps_hi556_ofilm) /
			sizeof(kal_uint16));
	} else {
		hi556_ofilm_table_write_cmos_sensor(
			addr_data_pair_capture_fps_hi556_ofilm,
			sizeof(addr_data_pair_capture_fps_hi556_ofilm) /
			sizeof(kal_uint16));
	}
}

kal_uint16 addr_data_pair_normal_video_hi556_ofilm[] = {
	0x0b0a, 0x8252,
	0x0f30, 0x6d25,
	0x0f32, 0x7067,
	0x004a, 0x0100,
...
{
hi556_ofilm_table_write_cmos_sensor(
		addr_data_pair_normal_video_hi556_ofilm,
		sizeof(addr_data_pair_normal_video_hi556_ofilm) /
		sizeof(kal_uint16));
}

kal_uint16 addr_data_pair_hs_video_hi556_ofilm[] = {
	0x0b0a, 0x8252,
	0x0f30, 0x6d25,
	0x0f32, 0x7067,
	0x004a, 0x0100,
...
{
	hi556_ofilm_table_write_cmos_sensor(
		addr_data_pair_hs_video_hi556_ofilm,
		sizeof(addr_data_pair_hs_video_hi556_ofilm) /
		sizeof(kal_uint16));
}

kal_uint16 addr_data_pair_slim_video_hi556_ofilm[] = {
	0x0b0a, 0x8252,
	0x0f30, 0x6d25,
	0x0f32, 0x7067,
	0x004a, 0x0100,
...
{
	hi556_ofilm_table_write_cmos_sensor(
		addr_data_pair_slim_video_hi556_ofilm,
		sizeof(addr_data_pair_slim_video_hi556_ofilm) /
		sizeof(kal_uint16));
}
