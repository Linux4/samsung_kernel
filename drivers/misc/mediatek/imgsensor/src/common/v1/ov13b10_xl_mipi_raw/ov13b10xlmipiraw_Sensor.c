...
#include "ov13b10xlmipiraw_Sensor.h"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = OV13B10_XL_SENSOR_ID,
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_init_ov13b10_xl[] = {
	0x0103, 0x01,
	0x0303, 0x01,
	0x0305, 0x46,
	0x0321, 0x00,
...
static void sensor_init(void)
{
	...
	ov13b10_table_write_cmos_sensor(
		addr_data_pair_init_ov13b10_xl,
		sizeof(addr_data_pair_init_ov13b10_xl) / sizeof(kal_uint16));
#else
	cam_pr_debug("E\n");
	write_cmos_sensor(0x0103, 0x01);
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_preview_ov13b10_xl[] = {
	0x0305, 0x23,
    0x0325, 0x50,
    0x3501, 0x06,
    0x3502, 0x10,
...
#if MULTI_WRITE
	ov13b10_table_write_cmos_sensor(
		addr_data_pair_preview_ov13b10_xl,
		sizeof(addr_data_pair_preview_ov13b10_xl) / sizeof(kal_uint16));
#else
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_capture_15fps_ov13b10_xl[] = {
	0x0305, 0x46,
    0x0325, 0x50,
    0x3501, 0x0c,
    0x3502, 0x10,
...
kal_uint16 addr_data_pair_capture_30fps_ov13b10_xl[] = {
	0x0305, 0x46,
    0x0325, 0x50,
    0x3501, 0x0c,
    0x3502, 0x10,
...
static void capture_setting(kal_uint16 currefps)
{
	...
	if (currefps == 150) {
		ov13b10_table_write_cmos_sensor(
			addr_data_pair_capture_15fps_ov13b10_xl,
			sizeof(addr_data_pair_capture_15fps_ov13b10_xl) /
			sizeof(kal_uint16));
	} else {
		ov13b10_table_write_cmos_sensor(
			addr_data_pair_capture_30fps_ov13b10_xl,
			sizeof(addr_data_pair_capture_30fps_ov13b10_xl) /
			sizeof(kal_uint16));
	}
#else
	if (currefps == 150) {
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_video_ov13b10_xl[] = {
	0x0305, 0x46,
    0x0325, 0x50,
    0x3501, 0x0c,
    0x3502, 0x10,
...
#if MULTI_WRITE
	ov13b10_table_write_cmos_sensor(
		addr_data_pair_video_ov13b10_xl,
		sizeof(addr_data_pair_video_ov13b10_xl) /
		sizeof(kal_uint16));
#else
	write_cmos_sensor(0x0305, 0x46);
	write_cmos_sensor(0x3501, 0x0c);
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_hs_video_ov13b10_xl[] = {
	0x0305, 0x23,
    0x0325, 0x50,
    0x3501, 0x02,
    0x3502, 0x00,
...
#if MULTI_WRITE
	ov13b10_table_write_cmos_sensor(
		addr_data_pair_hs_video_ov13b10_xl,
		sizeof(addr_data_pair_hs_video_ov13b10_xl) /
		sizeof(kal_uint16));
#else
	write_cmos_sensor(0x0305, 0x23);
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_slim_video_ov13b10_xl[] = {
	0x0305, 0x23,
    0x0325, 0x50,
    0x3501, 0x06,
    0x3502, 0x10,
...
#if MULTI_WRITE
	ov13b10_table_write_cmos_sensor(
		addr_data_pair_slim_video_ov13b10_xl,
		sizeof(addr_data_pair_slim_video_ov13b10_xl) /
		sizeof(kal_uint16));
#else
	write_cmos_sensor(0x0305, 0x23);
	write_cmos_sensor(0x3501, 0x06);
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_custom1_ov13b10_xl[] = {
	0x0305, 0x46,
    0x0325, 0x50,
    0x3501, 0x0c,
    0x3502, 0x10,
...
#if MULTI_WRITE
	ov13b10_table_write_cmos_sensor(
		addr_data_pair_custom1_ov13b10_xl,
		sizeof(addr_data_pair_custom1_ov13b10_xl) /
		sizeof(kal_uint16));
#else
...
{
cam_pr_debug("xlRead sensor id %0x",read_cmos_sensor(0x300c));
if(read_cmos_sensor(0x300c)==0x42){
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
	...
	module_id = read_cmos_sensor(0x0001);
        cam_pr_debug("xlRead sensor id fail%0x",module_id);
	if(module_id !=0x02)
