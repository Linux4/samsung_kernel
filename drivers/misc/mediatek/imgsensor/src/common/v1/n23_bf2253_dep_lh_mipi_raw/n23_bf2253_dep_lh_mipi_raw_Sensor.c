...
#include "n23_bf2253_dep_lh_mipi_raw_Sensor.h"


/****************************Modify Following Strings for Debug****************************/
#define PFX "n23_bf2253_dep_lh_camera_sensor"
#define LOG_1 LOG_INF("N23_BF2253_DEP_LH, MIPI 1LANE\n")
/****************************   Modify end    *******************************************/

#define LOG_INF(format, args...)    pr_err(PFX "[%s] " format, __func__, ##args)

#define SHUTTER_MAX 16383
#define VB_MIN 102//326 for 24fps,0 for 30fps
#define BASIC_LINE 1236

static DEFINE_SPINLOCK(imgsensor_drv_lock);
kal_bool N23_BF2253_DEP_LHDuringTestPattern = KAL_FALSE;

//+bug 682590, zhanghao2.wt, ADD, 2021/9/17, modify 1st'dep bf2253 to 572M
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = N23_BF2253_DEP_LH_SENSOR_ID,
	.checksum_value = 0xf7375923,
	.pre = {
		.pclk = 57200000, 				//record different mode's pclk
		.linelength = 1780,				//record different mode's linelength
		.framelength = 1338,			//record different mode's framelength
		.startx = 0,
		.starty = 0,
		.grabwindow_width = 1600,
		.grabwindow_height = 1200,
		.mipi_data_lp2hs_settle_dc = 85,
		.mipi_pixel_rate = 57200000,
		.max_framerate = 240,
	},
	.cap = {
		.pclk = 57200000,
...
static void sensor_init(void)
{
	...
	//;;FrameH:1236
	  ...
	  write_cmos_sensor(0xe3,0x06);	//bug 682590, zhanghao2.wt, ADD, 2021/9/17, modify 1st'dep bf2253 to 572M
	...
	//write_cmos_sensor(0xd0,0x02);
	  write_cmos_sensor(0x00,0x2e); //mirror on/flip on
...
static kal_uint32 open(void)
{
	...
	spin_unlock(&imgsensor_drv_lock);
	N23_BF2253_DEP_LHDuringTestPattern = KAL_FALSE;
	return ERROR_NONE;
}
