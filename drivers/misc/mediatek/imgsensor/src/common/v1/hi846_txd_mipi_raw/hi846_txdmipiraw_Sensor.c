...
#include "hi846_txdmipiraw_Sensor.h"

#define PFX "hi846_txd_camera_sensor"
...
/* TabA7 Lite code for OT8-3892 by wangqi at 20210309 start */
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = HI846_TXD_SENSOR_ID,
...
static kal_uint16 hi846_txd_table_write_cmos_sensor(
...
{
	return ((read_cmos_sensor(0x0F17) << 8) | read_cmos_sensor(0x0F16) + 1);//change this for af compatible by lisizhou at 2020/11/29
}
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_init_hi846_txd[] = {
	0x0066, 0x0101,
	0x2000, 0x98E8,
	0x2002, 0x00FF,
	0x2004, 0x0006,
...
{
#if MULTI_WRITE
	hi846_txd_table_write_cmos_sensor(
		addr_data_pair_init_hi846_txd,
		sizeof(addr_data_pair_init_hi846_txd) /
		sizeof(kal_uint16));
#else
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_preview_hi846_txd[] = {
	//Sensor Information////////////////////////////
	//Sensor	  : Hi-846
	//Date		  : 2021-02-02
...
#if MULTI_WRITE
	hi846_txd_table_write_cmos_sensor(
		addr_data_pair_preview_hi846_txd,
		sizeof(addr_data_pair_preview_hi846_txd) /
		sizeof(kal_uint16));
#else
	LOG_INF("E1 preview\n");
#endif
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_capture_fps_hi846_txd[] = {
	//Sensor Information////////////////////////////
	//Sensor	  : Hi-846
	//Date		  : 2021-02-02
	//Image size	  : 3264x2448
...
kal_uint16 addr_data_pair_capture_30fps_hi846_txd[] = {
	//Sensor Information////////////////////////////
	//Sensor	  : Hi-846
	//Date		  : 2021-02-02
	//Image size	  : 3264x2448
...
static void capture_setting(kal_uint16 currefps)
{
	...
	if (currefps == 300) {
	hi846_txd_table_write_cmos_sensor(
		addr_data_pair_capture_30fps_hi846_txd,
		sizeof(addr_data_pair_capture_30fps_hi846_txd) /
		sizeof(kal_uint16));
	} else {
	hi846_txd_table_write_cmos_sensor(
		addr_data_pair_capture_fps_hi846_txd,
		sizeof(addr_data_pair_capture_fps_hi846_txd) /
		sizeof(kal_uint16));
	}
#else
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_video_hi846_txd[] = {
	//Sensor Information////////////////////////////
	//Sensor	  : Hi-846
	//Date		  : 2021-02-02
	//Image size	  : 3264x2448
...
#if MULTI_WRITE
	hi846_txd_table_write_cmos_sensor(
		addr_data_pair_video_hi846_txd,
		sizeof(addr_data_pair_video_hi846_txd) /
		sizeof(kal_uint16));
#else
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_hs_video_hi846_txd[] = {
	//Sensor Information////////////////////////////
	//Sensor	  : Hi-846
	//Date		  : 2021-02-02
	//Image size	  : 3264x2448
...
#if MULTI_WRITE
	hi846_txd_table_write_cmos_sensor(
		addr_data_pair_hs_video_hi846_txd,
		sizeof(addr_data_pair_hs_video_hi846_txd) /
		sizeof(kal_uint16));
#else
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_slim_video_hi846_txd[] = {
	//Sensor Information////////////////////////////
	//Sensor	  : Hi-846
	//Date		  : 2021-02-02
	//Image size	  : 3264x2448
...
#endif
/* TabA7 Lite code for OT8-3892 by wangqi at 20210309 end */
...
#if MULTI_WRITE
	hi846_txd_table_write_cmos_sensor(
		addr_data_pair_slim_video_hi846_txd,
		sizeof(addr_data_pair_slim_video_hi846_txd) /
		sizeof(kal_uint16));
#else
