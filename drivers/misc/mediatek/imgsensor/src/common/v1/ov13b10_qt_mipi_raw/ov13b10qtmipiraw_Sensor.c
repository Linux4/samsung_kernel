...
#include "ov13b10qtmipiraw_Sensor.h"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = OV13B10_QT_SENSOR_ID,
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_init_ov13b10_qt[] = {
	0x0103, 0x01,
	0x0303, 0x01,
	0x0305, 0x46,
	0x0321, 0x00,
...
static void sensor_init(void)
{
	...
	ov13b10_table_write_cmos_sensor(
		addr_data_pair_init_ov13b10_qt,
		sizeof(addr_data_pair_init_ov13b10_qt) / sizeof(kal_uint16));
#else
	cam_pr_debug("E\n");
	write_cmos_sensor(0x0103, 0x01);
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_preview_ov13b10_qt[] = {
	0x0305, 0x23,
    0x0325, 0x50,
    0x3501, 0x06,
    0x3502, 0x10,
...
#if MULTI_WRITE
	ov13b10_table_write_cmos_sensor(
		addr_data_pair_preview_ov13b10_qt,
		sizeof(addr_data_pair_preview_ov13b10_qt) / sizeof(kal_uint16));
#else
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_capture_15fps_ov13b10_qt[] = {
	0x0305, 0x46,
    0x0325, 0x50,
    0x3501, 0x0c,
    0x3502, 0x10,
...
kal_uint16 addr_data_pair_capture_30fps_ov13b10_qt[] = {
	0x0305, 0x46,
    0x0325, 0x50,
    0x3501, 0x0c,
    0x3502, 0x10,
...
static void capture_setting(kal_uint16 currefps)
{
	...
	if (currefps == 150) {
		ov13b10_table_write_cmos_sensor(
			addr_data_pair_capture_15fps_ov13b10_qt,
			sizeof(addr_data_pair_capture_15fps_ov13b10_qt) /
			sizeof(kal_uint16));
	} else {
		ov13b10_table_write_cmos_sensor(
			addr_data_pair_capture_30fps_ov13b10_qt,
			sizeof(addr_data_pair_capture_30fps_ov13b10_qt) /
			sizeof(kal_uint16));
	}
#else
	if (currefps == 150) {
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_video_ov13b10_qt[] = {
	0x0305, 0x46,
    0x0325, 0x50,
    0x3501, 0x0c,
    0x3502, 0x10,
...
#if MULTI_WRITE
	ov13b10_table_write_cmos_sensor(
		addr_data_pair_video_ov13b10_qt,
		sizeof(addr_data_pair_video_ov13b10_qt) /
		sizeof(kal_uint16));
#else
	write_cmos_sensor(0x0305, 0x46);
	write_cmos_sensor(0x3501, 0x0c);
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_hs_video_ov13b10_qt[] = {
	0x0305, 0x23,
    0x0325, 0x50,
    0x3501, 0x02,
    0x3502, 0x00,
...
#if MULTI_WRITE
	ov13b10_table_write_cmos_sensor(
		addr_data_pair_hs_video_ov13b10_qt,
		sizeof(addr_data_pair_hs_video_ov13b10_qt) /
		sizeof(kal_uint16));
#else
	write_cmos_sensor(0x0305, 0x23);
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_slim_video_ov13b10_qt[] = {
	0x0305, 0x23,
    0x0325, 0x50,
    0x3501, 0x06,
    0x3502, 0x10,
...
#if MULTI_WRITE
	ov13b10_table_write_cmos_sensor(
		addr_data_pair_slim_video_ov13b10_qt,
		sizeof(addr_data_pair_slim_video_ov13b10_qt) /
		sizeof(kal_uint16));
#else
	write_cmos_sensor(0x0305, 0x23);
	write_cmos_sensor(0x3501, 0x06);
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_custom1_ov13b10_qt[] = {
	0x0305, 0x46,
    0x0325, 0x50,
    0x3501, 0x0c,
    0x3502, 0x10,
...
#if MULTI_WRITE
	ov13b10_table_write_cmos_sensor(
		addr_data_pair_custom1_ov13b10_qt,
		sizeof(addr_data_pair_custom1_ov13b10_qt) /
		sizeof(kal_uint16));
#else
...
/*A03s code for SR-AL5625-01-324 by xuxianwei at 2021/05/19 start*/
static kal_uint32 return_sensor_id(void)
{
cam_pr_debug("qtRead sensor id %0x",read_cmos_sensor(0x300c));
if(read_cmos_sensor(0x300c)==0x43){
	return ((read_cmos_sensor(0x300a) << 16) |
		(read_cmos_sensor(0x300b) << 8) | read_cmos_sensor(0x300c)+1);
}else{
	return ((read_cmos_sensor(0x300a) << 16) |
		(read_cmos_sensor(0x300b) << 8) | read_cmos_sensor(0x300c)+2);
}
}
/*A03s code for SR-AL5625-01-324 by xuxianwei at 2021/05/19 end*/
/*static kal_uint16 read_cmos_sensor_ov13b10(kal_uint32 addr)
{
	kal_uint16 get_byte = 0;
...
static void ov13b10_fusion_id_read(void)
{
	int i, flag;
	flag = read_cmos_sensor_ov13b10(0x0ED6);
	pr_err("%s %d flag=0x%2x\n", __func__, __LINE__, flag);
	for (i=0; i<16; i++) {
		fusion_id_main[i] = read_cmos_sensor_ov13b10(0x0ED7+i);
		pr_err("%s %d fusion_id_main[%d]=0x%2x\n",__func__, __LINE__, i, fusion_id_main[i]);
	}
}*/
/*A03s code for SR-AL5625-01-324 by xuxianwei at 2021/05/19 start*/
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
	...
	module_id = read_cmos_sensor(0x0001);
        cam_pr_debug("qtRead sensor id fail%0x",module_id);
	if(module_id !=0x06)
