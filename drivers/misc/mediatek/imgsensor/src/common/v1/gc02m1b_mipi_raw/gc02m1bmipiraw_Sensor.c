...
static kal_uint16 set_gain(kal_uint16 gain)
{
	...
	if ((iReg >= ANALOG_GAIN_1) && (iReg < ANALOG_GAIN_2)) {
		...
		pr_debug("analogic gain 1x, add pregain = %d\n", temp);
		...
		write_cmos_sensor(0xb1, (temp>>8)&0x3f);
		write_cmos_sensor(0xb2, (temp&0xff));
		pr_debug("analogic gain 1.185x, add pregain = %d\n", temp);
		...
		write_cmos_sensor(0xb1, (temp>>8)&0x3f);
		write_cmos_sensor(0xb2, (temp&0xff));
		pr_debug("analogic gain 1.4x, add pregain = %d\n", temp);
		...
		write_cmos_sensor(0xb1, (temp>>8)&0x3f);
		write_cmos_sensor(0xb2, (temp&0xff));
		pr_debug("analogic gain 1.659x, add pregain = %d\n", temp);
		...
		write_cmos_sensor(0xb1, (temp>>8)&0x3f);
		write_cmos_sensor(0xb2, (temp&0xff));
		pr_debug("analogic gain 2.0x, add pregain = %d\n", temp);
		...
		write_cmos_sensor(0xb1, (temp>>8)&0x3f);
		write_cmos_sensor(0xb2, (temp&0xff));
		pr_debug("analogic gain 2.37x, add pregain = %d\n", temp);
		...
		write_cmos_sensor(0xb1, (temp>>8)&0x3f);
		write_cmos_sensor(0xb2, (temp&0xff));
		pr_debug("analogic gain 2.8x, add pregain = %d\n", temp);
		...
		write_cmos_sensor(0xb1, (temp>>8)&0x3f);
		write_cmos_sensor(0xb2, (temp&0xff));
		pr_debug("analogic gain 3.318x, add pregain = %d\n", temp);
		...
		write_cmos_sensor(0xb1, (temp>>8)&0x3f);
		write_cmos_sensor(0xb2, (temp&0xff));
		pr_debug("analogic gain 4.0x, add pregain = %d\n", temp);
		...
		write_cmos_sensor(0xb1, (temp>>8)&0x3f);
		write_cmos_sensor(0xb2, (temp&0xff));
		pr_debug("analogic gain 4.74x, add pregain = %d\n", temp);
		...
		write_cmos_sensor(0xb1, (temp>>8)&0x3f);
		write_cmos_sensor(0xb2, (temp&0xff));
		pr_debug("analogic gain 5.6x, add pregain = %d\n", temp);
		...
		write_cmos_sensor(0xb1, (temp>>8)&0x3f);
		write_cmos_sensor(0xb2, (temp&0xff));
		pr_debug("analogic gain 6.636x, add pregain = %d\n", temp);
		...
		write_cmos_sensor(0xb1, (temp>>8)&0x3f);
		write_cmos_sensor(0xb2, (temp&0xff));
		pr_debug("analogic gain 8.0x, add pregain = %d\n", temp);
		...
		write_cmos_sensor(0xb1, (temp>>8)&0x3f);
		write_cmos_sensor(0xb2, (temp&0xff));
		pr_debug("analogic gain 9.48x, add pregain = %d\n", temp);
		...
		write_cmos_sensor(0xb1, (temp>>8)&0x3f);
		write_cmos_sensor(0xb2, (temp&0xff));
		pr_debug("analogic gain 11.2x, add pregain = %d\n", temp);
	} else {
		write_cmos_sensor(0xfe,  0x00);
		...
		write_cmos_sensor(0xb1, (temp>>8)&0x3f);
		write_cmos_sensor(0xb2, (temp&0xff));
		pr_debug("analogic gain 13.2725x, add pregain = %d\n", temp);
	}
	pr_debug("celery--0xb6 =0x%x, 0xb1 =0x%x,0xb2 =0x%x\n",
...
/** GC02M1 MIPI data rate 676M official setfile V0.0.5 **/
...
static void sensor_init(void)
{
	...
	if (ret != 0) {
		imgsensor_sec_get_hw_param(&hw_param, SENSOR_POSITION_REAR3);
		if (hw_param)
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
	 ...
	 *LOG_INF("gc02mo_mipi_raw_Sensor I2C_BUS = %d\n", I2C_BUS);
	 *if(I2C_BUS != 2){
...
int gc02m1b_read_otp_cal(unsigned int addr, unsigned char *data, unsigned int size)
{
	...
	// OTP initial setting
	if (write_cmos_sensor(0xf3, 0x30) == -1) {
		pr_err("[%s] Failed to write_cmos_sensor", __func__);
		gc02m1b_otp_off_setting();
		return -1;
	}
