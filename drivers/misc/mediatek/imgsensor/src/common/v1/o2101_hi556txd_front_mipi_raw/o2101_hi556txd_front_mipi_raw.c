...
#include "o2101_hi556txd_front_mipi_raw.h"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = O2101_HI556TXD_FRONT_SENSOR_ID,
...
static kal_uint16 o2101_hi556_table_write_cmos_sensor(
...
static void o2101_hi556wtxd_front_otp_init(void)
{
	printk("o2101_hi556wtxd_front otp_init_setting\n");
	//sensor init --start
...
{
	return ((read_cmos_sensor(0x0F16) << 8) | read_cmos_sensor(0x0F17)+1)+1;
}
...
kal_uint16 addr_data_pair_init_o2101_hi556[] = {
...
{
o2101_hi556_table_write_cmos_sensor(
	addr_data_pair_init_o2101_hi556,
	sizeof(addr_data_pair_init_o2101_hi556) /
	sizeof(kal_uint16));
}

kal_uint16 addr_data_pair_preview_o2101_hi556[] = {
	0x0b0a, 0x8252,
	0x0f30, 0x6e25,
	0x0f32, 0x7067,
	0x004a, 0x0100,
...
{
	o2101_hi556_table_write_cmos_sensor(
		addr_data_pair_preview_o2101_hi556,
		sizeof(addr_data_pair_preview_o2101_hi556) /
		sizeof(kal_uint16));
}


kal_uint16 addr_data_pair_capture_fps_o2101_hi556[] = {
	0x0b0a, 0x8252,
	0x0f30, 0x6e25,
	0x0f32, 0x7067,
	0x004a, 0x0100,
...
kal_uint16 addr_data_pair_capture_30fps_o2101_hi556[] = {
	0x0b0a, 0x8252,
	0x0f30, 0x6e25,
	0x0f32, 0x7067,
	0x004a, 0x0100,
...
static void capture_setting(kal_uint16 currefps)
{
	if (currefps == 300) {
		o2101_hi556_table_write_cmos_sensor(
			addr_data_pair_capture_30fps_o2101_hi556,
			sizeof(addr_data_pair_capture_30fps_o2101_hi556) /
			sizeof(kal_uint16));
	} else {
		o2101_hi556_table_write_cmos_sensor(
			addr_data_pair_capture_fps_o2101_hi556,
			sizeof(addr_data_pair_capture_fps_o2101_hi556) /
			sizeof(kal_uint16));
	}
}

kal_uint16 addr_data_pair_normal_video_o2101_hi556[] = {
	0x0b0a, 0x8252,
	0x0f30, 0x6e25,
	0x0f32, 0x7067,
	0x004a, 0x0100,
...
{
o2101_hi556_table_write_cmos_sensor(
		addr_data_pair_normal_video_o2101_hi556,
		sizeof(addr_data_pair_normal_video_o2101_hi556) /
		sizeof(kal_uint16));
}

kal_uint16 addr_data_pair_hs_video_o2101_hi556[] = {
	0x0b0a, 0x8252,
	0x0f30, 0x6e25,
	0x0f32, 0x7067,
	0x004a, 0x0100,
...
{
	o2101_hi556_table_write_cmos_sensor(
		addr_data_pair_hs_video_o2101_hi556,
		sizeof(addr_data_pair_hs_video_o2101_hi556) /
		sizeof(kal_uint16));
}

kal_uint16 addr_data_pair_slim_video_o2101_hi556[] = {
	0x0b0a, 0x8252,
	0x0f30, 0x6e25,
	0x0f32, 0x7067,
	0x004a, 0x0100,
...
{
	o2101_hi556_table_write_cmos_sensor(
		addr_data_pair_slim_video_o2101_hi556,
		sizeof(addr_data_pair_slim_video_o2101_hi556) /
		sizeof(kal_uint16));
}
/* hs04 code for SR-AL6398A-01-12 by liluling at 2022/7/25 begin */
...
static kal_uint16 get_module_id()
{
    ...
    o2101_hi556wtxd_front_otp_init();

	flag = OTP_read_cmos_sensor(0x401);
    if(flag == 0x01)
    {
	...
	{
		module_id = OTP_read_cmos_sensor(0x414);
	}
	else if(flag == 0x37)
	{
		module_id = OTP_read_cmos_sensor(0x425);
	}
	LOG_INF("hi556_txd flag %x, module_id:%x\n", flag, module_id);
	return module_id;
...
/*hs04 code for DEVAL6398A-24 by xutengtao at 2022/07/28 start */
    ...
    if(module_id != 0x41)
    {
        LOG_INF("hi556_txd Read modele id fail,module_id: 0x%x\n", module_id);
...
UINT32 O2101_HI556TXD_FRONT_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
	...
	if (pfFunc != NULL)
		*pfFunc =  &sensor_func;
	return ERROR_NONE;
}	/*	o2101_hi556_MIPI_RAW_SensorInit	*/
