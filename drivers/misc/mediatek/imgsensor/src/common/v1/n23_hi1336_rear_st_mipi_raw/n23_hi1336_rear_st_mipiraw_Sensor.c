...
#include "n23_hi1336_rear_st_mipiraw_Sensor.h"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = N23_HI1336_REAR_ST_SENSOR_ID,
...
static int read_hi1336_otp_moudle(void){
	...
	if(moudle_id == 0x17){
		printk("this is st hi1336 moudle\n");
		return 1;
	}
...
static struct stCAM_CAL_DATAINFO_STRUCT n23_hi1336_rear_st_eeprom_data ={
	.sensorID= N23_HI1336_REAR_ST_SENSOR_ID,
	.deviceID = 0x01,
	.dataLength =  0x0D5F,
...
static struct stCAM_CAL_CHECKSUM_STRUCT n23_hi1336_rear_st_checksum[8] =
{
...
//-bug682590,zhanghengyuan.wt,ADD,2021/8/24,diff txd and st hi1336
//+bug682590,zhanghengyuan.wt,ADD,2021/8/27,add n23_hi1336_rear_st OTP
				size = imgSensorReadEepromData(&n23_hi1336_rear_st_eeprom_data,n23_hi1336_rear_st_checksum);
				if((size != n23_hi1336_rear_st_eeprom_data.dataLength) || ((n23_hi1336_rear_st_eeprom_data.sensorVendorid >> 24) !=  *(n23_hi1336_rear_st_eeprom_data.dataBuffer+1))) {
					pr_err("n23_hi1336_rear_txd get eeprom data failed\n");
					if(n23_hi1336_rear_st_eeprom_data.dataBuffer != NULL) {
						kfree(n23_hi1336_rear_st_eeprom_data.dataBuffer);
						n23_hi1336_rear_st_eeprom_data.dataBuffer = NULL;
					}
					*sensor_id = 0xFFFFFFFF;
					return ERROR_SENSOR_CONNECT_FAIL;
				} else {
					pr_info("get eeprom data success\n");
					imgSensorSetEepromData(&n23_hi1336_rear_st_eeprom_data);
				}
//-bug682590,zhanghengyuan.wt,ADD,2021/8/27,add n23_hi1336_rear_st OTP
