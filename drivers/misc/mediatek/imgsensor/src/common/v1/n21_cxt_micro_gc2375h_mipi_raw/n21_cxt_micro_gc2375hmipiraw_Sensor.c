...
#include "n21_cxt_micro_gc2375hmipiraw_Sensor.h"

#define MULTI_WRITE    1

/**************** Modify Following Strings for Debug ******************/
#define PFX "gc2375h_camera_sensor"
#define LOG_1 cam_pr_debug("N21_CXT_MICRO_GC2375H, MIPI 1LANE\n")
...
#define EEPROM_PL24C64F_ID 0xA4
...
static kal_uint16 read_eeprom(kal_uint32 addr)
{
	...
	iReadRegI2C(pu_send_cmd, 2, (u8*)&get_byte, 1, EEPROM_PL24C64F_ID);
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = N21_CXT_MICRO_GC2375H_SENSOR_ID,
...
kal_uint16 addr_data_pair_init_n21_cxt_micro_gc2375h[] = {
    0xfe, 0x00,
    0xfe, 0x00,
    0xfe, 0x00,
    0xf7, 0x01,
    ...
    0x0f, 0x06,
    0x10, 0x48,
    0x17, N21_CXT_MICRO_GC2375H_MIRROR,
    0x1c, 0x10,
    0x1d, 0x13,
    0x20, 0x0b,
    0x21, 0x6d,
    ...
    0x43, 0x03,
    0x4a, 0x00,
    0x4e, N21_CXT_MICRO_GC2375H_BLK_Select1_H,
    0x4f, N21_CXT_MICRO_GC2375H_BLK_Select1_L,
    0x66, N21_CXT_MICRO_GC2375H_BLK_Select2_H,
    0x67, N21_CXT_MICRO_GC2375H_BLK_Select2_L,
    0x68, 0x00,
    0xb0, 0x58,
    0xb1, 0x01,
    0xb2, 0x00,
...
static void sensor_init(void)
{
    ...
    addr_data_pair_init_n21_cxt_micro_gc2375h,
    sizeof(addr_data_pair_init_n21_cxt_micro_gc2375h) /
    sizeof(kal_uint16));
#else
	/* System */
	write_cmos_sensor(0xfe, 0x00);
	...
	write_cmos_sensor(0x17, N21_CXT_MICRO_GC2375H_MIRROR);
	...
	write_cmos_sensor(0x4e, N21_CXT_MICRO_GC2375H_BLK_Select1_H);
	write_cmos_sensor(0x4f, N21_CXT_MICRO_GC2375H_BLK_Select1_L);
	write_cmos_sensor(0x66, N21_CXT_MICRO_GC2375H_BLK_Select2_H);
	write_cmos_sensor(0x67, N21_CXT_MICRO_GC2375H_BLK_Select2_L);
...
static struct stCAM_CAL_DATAINFO_STRUCT cxt_micro_gc2375h_eeprom_data ={
	.sensorID= N21_CXT_MICRO_GC2375H_SENSOR_ID,
	.deviceID = 0x10,
	.dataLength = 0x0E5E,
	.sensorVendorid = 0x16050300,
	.vendorByte = {1,2,3,4},
	.dataBuffer = NULL,
};
static struct stCAM_CAL_CHECKSUM_STRUCT cxt_micro_gc2375h_Checksum[8] =
{
		...
		do {
			*sensor_id = return_sensor_id() + 1;
			if (*sensor_id == imgsensor_info.sensor_id) {
				//+Bug 492443, sunhushan.wt, ADD, 2019.10.15, porting the otp of the 12sensor 
				size = imgSensorReadEepromData(&cxt_micro_gc2375h_eeprom_data,cxt_micro_gc2375h_Checksum);
				if(size != cxt_micro_gc2375h_eeprom_data.dataLength || (cxt_micro_gc2375h_eeprom_data.sensorVendorid >> 24)!= read_eeprom(0x0001)) {
					printk("get eeprom data failed\n");
					if(cxt_micro_gc2375h_eeprom_data.dataBuffer != NULL) {
						kfree(cxt_micro_gc2375h_eeprom_data.dataBuffer);
						cxt_micro_gc2375h_eeprom_data.dataBuffer = NULL;
					}
					*sensor_id = 0xFFFFFFFF;
					return ERROR_SENSOR_CONNECT_FAIL;
				} else {
					LOG_INF("get eeprom data success\n");
					imgSensorSetEepromData(&cxt_micro_gc2375h_eeprom_data);
				}
				//-Bug 492443, sunhushan.wt, ADD, 2019.10.15, porting the otp of the 12sensor 
