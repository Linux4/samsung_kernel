...
static kal_int32 write_Module_data(ACDK_SENSOR_ENGMODE_STEREO_STRUCT * pStereodata)
{
    ...
    if(pStereodata != NULL) {
        ...
        if ((pStereodata->uSensorId == N28_S5KJN1_REAR_DC_SENSOR_ID) && (data_length == DUALCAM_CALI_DATA_LENGTH)
...
static kal_uint16 n28s5kjn1reardc03_init_setting[] = {
	0x6028,0x2400,
	0x602A,0x1354,
	0x6F12,0x0100,
	0x6F12,0x7017,
...
static kal_uint16 n28s5kjn1reardc03_capture_setting[] = {
	0x6028, 0x2400,
	0x602A, 0x1A28,
	0x6F12, 0x4C00,
	0x602A, 0x065A,
...
static kal_uint16 n28s5kjn1reardc03_preview_setting[] = {
	0x6028, 0x2400,
	0x602A, 0x1A28,
	0x6F12, 0x4C00,
	0x602A, 0x065A,
...
static kal_uint16 n28s5kjn1reardc03_normal_video_setting[] = {
	0x6028, 0x2400,
	0x602A, 0x1A28,
	0x6F12, 0x4C00,
	0x602A, 0x065A,
...
static kal_uint16 n28s5kjn1reardc03_hs_video_setting[] = {
	0x6028, 0x2400,
	0x602A, 0x1A28,
	0x6F12, 0x4C00,
	0x602A, 0x065A,
...
static kal_uint16 n28s5kjn1reardc03_slim_video_setting[] = {
	0x6028, 0x2400,
	0x602A, 0x1A28,
	0x6F12, 0x4C00,
	0x602A, 0x065A,
...
static kal_uint16 n28s5kjn1reardc03_custom1_setting[] = {
	0x6028, 0x2400,
	0x602A, 0x1A28,
	0x6F12, 0x4C00,
	0x602A, 0x065A,
...
static kal_uint16 n28s5kjn1reardc03_custom2_setting[] = {
	0x6028, 0x2400,
	0x602A, 0x1A28,
	0x6F12, 0x4C00,
	0x602A, 0x065A,
...
static kal_uint16 n28s5kjn1reardc03_custom3_setting[] = {
	0x6028, 0x2400,
	0x602A, 0x1A28,
	0x6F12, 0x4C00,
	0x602A, 0x065A,
...
static kal_uint16 n28s5kjn1reardc03_custom4_setting[] = {
	0x6028, 0x2400,
	0x602A, 0x1A28,
	0x6F12, 0x4C00,
	0x602A, 0x065A,
...
#if 1 ///otp code
static struct stCAM_CAL_DATAINFO_STRUCT n28s5kjn1reardc_eeprom_data ={
...
static struct stCAM_CAL_CHECKSUM_STRUCT n28s5kjn1reardc_Checksum[14] =
{
...
static kal_uint16 n28s5kjn1reardc_read_eeprom(kal_uint32 addr)
{
     kal_uint16 get_byte=0;
        ...
        do {
            *sensor_id = ((read_cmos_sensor_8(0x0000) << 8)
            ...
            LOG_INF(
                ...
                read_cmos_sensor_8(0x0001) + 1,
                read_cmos_sensor(0x0000) + 1, *sensor_id);
            if (*sensor_id == imgsensor_info.sensor_id) {
				...
				if((n28s5kjn1reardc_eeprom_data.sensorVendorid >> 24) != n28s5kjn1reardc_read_eeprom(0x0001)){
				    *sensor_id = 0xFFFFFFFF;
					LOG_ERR("read module id not match i2c write id: 0x%x, sensor id: 0x%x module id: 0x%x\n",imgsensor.i2c_write_id, *sensor_id,
					n28s5kjn1reardc_read_eeprom(0x0001));
					return ERROR_SENSOR_CONNECT_FAIL;
				}

#if 1
  //// add maincamera s5kjn1 otp code
             size = imgSensorReadEepromData(&n28s5kjn1reardc_eeprom_data,n28s5kjn1reardc_Checksum);
             if(size != n28s5kjn1reardc_eeprom_data.dataLength) {
                 LOG_INF("get eeprom data failed\n");
                 if(n28s5kjn1reardc_eeprom_data.dataBuffer != NULL) {
                     kfree(n28s5kjn1reardc_eeprom_data.dataBuffer);
                     n28s5kjn1reardc_eeprom_data.dataBuffer = NULL;
                 }
                 //*sensor_id = 0xFFFFFFFF;
                 //return ERROR_SENSOR_CONNECT_FAIL;
             } else {
                 pr_info("get eeprom data success\n");
                 imgSensorSetEepromData(&n28s5kjn1reardc_eeprom_data);
#if N28_DC_S5KJN1_OTP
read_eepromData_HW_GGC();
memcpy(XTCBuffer, (kal_uint8*)&n28s5kjn1reardc_eeprom_data.dataBuffer[DC_S5KJN1_OTP_XTC_OFFSET+1], S5KJN1_OTP_XTC_LEN);
memcpy(SENSORXTCBuffer, (kal_uint8*)&n28s5kjn1reardc_eeprom_data.dataBuffer[DC_S5KJN1_OTP_SENSORXTC_OFFSET+1], S5KJN1_OTP_SENSORXTC_LEN);
memcpy(PDXTCXTCBuffer, (kal_uint8*)&n28s5kjn1reardc_eeprom_data.dataBuffer[DC_S5KJN1_OTP_PDXTC_OFFSET+1], S5KJN1_OTP_PDXTC_LEN);
memcpy(SWGCCBuffer, (kal_uint8*)&n28s5kjn1reardc_eeprom_data.dataBuffer[DC_S5KJN1_OTP_SWGCC_OFFSET+1], S5KJN1_OTP_SWGCC_LEN);
#endif
             }
