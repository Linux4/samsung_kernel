...
#include "n26_sc201cs_dep_lh_mipi_mono_Sensor.h"

/****************************Modify Following Strings for Debug****************************/
#define PFX "SC201CS_camera_sensor"

#define LOG_1 LOG_INF("n26_sc201cs_dep_lh_mipimono,MIPI 1LANE\n")
...
static imgsensor_info_struct imgsensor_info = { 
    .sensor_id = N26_SC201CS_DEP_LH_SENSOR_ID,
...
static void sensor_init(void)
{
    ...
    write_cmos_sensor(0x3944,0x01);
    write_cmos_sensor(0x3945,0xf6);
