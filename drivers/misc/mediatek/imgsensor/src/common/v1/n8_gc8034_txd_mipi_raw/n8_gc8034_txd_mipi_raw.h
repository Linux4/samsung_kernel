 ...
 *
 ****************************************************************************/
#ifndef __N8_GC8034_TXDMIPI_SENSOR_H__
#define __N8_GC8034_TXDMIPI_SENSOR_H__

#undef FULLSIZE_PREVIEW

#undef  N8_GC8034_TXD_MIRROR_NORMAL
#undef  N8_GC8034_TXD_MIRROR_H
#undef  N8_GC8034_TXD_MIRROR_V
#undef  N8_GC8034_TXD_MIRROR_HV

#define  N8_GC8034_TXD_MIRROR_NORMAL

#if defined(N8_GC8034_TXD_MIRROR_NORMAL)
	#define N8_GC8034_TXD_MIRROR         0xc0
	#define N8_GC8034_TXD_BinStartY      0x04
	#define N8_GC8034_TXD_BinStartX      0x05
	#define N8_GC8034_TXD_FullStartY     0x08
	#define N8_GC8034_TXD_FullStartX     0x09
#elif defined(N8_GC8034_TXD_MIRROR_H)
	#define N8_GC8034_TXD_MIRROR         0xc1
	#define N8_GC8034_TXD_BinStartY      0x04
	#define N8_GC8034_TXD_BinStartX      0x05
	#define N8_GC8034_TXD_FullStartY     0x08
	#define N8_GC8034_TXD_FullStartX     0x0b
#elif defined(N8_GC8034_TXD_MIRROR_V)
	#define N8_GC8034_TXD_MIRROR         0xc2
	#define N8_GC8034_TXD_BinStartY      0x04
	#define N8_GC8034_TXD_BinStartX      0x05
	#define N8_GC8034_TXD_FullStartY     0x08
	#define N8_GC8034_TXD_FullStartX     0x09
#elif defined(N8_GC8034_TXD_MIRROR_HV)
	#define N8_GC8034_TXD_MIRROR         0xc3
	#define N8_GC8034_TXD_BinStartY      0x04
	#define N8_GC8034_TXD_BinStartX      0x05
	#define N8_GC8034_TXD_FullStartY     0x08
	#define N8_GC8034_TXD_FullStartX     0x0b
...
struct n8_gc8034_txd_dd_t { 
	kal_uint16 x;
	kal_uint16 y;
	kal_uint16 t;
};

struct n8_gc8034_txd_otp_t {
	kal_uint8  dd_cnt;
	kal_uint8  dd_flag;
	struct n8_gc8034_txd_dd_t dd_param[160];
	kal_uint8  reg_flag;
	kal_uint8  reg_num;
