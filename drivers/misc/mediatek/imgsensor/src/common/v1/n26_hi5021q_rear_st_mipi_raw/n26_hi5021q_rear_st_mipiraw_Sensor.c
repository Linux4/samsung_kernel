...
#include "n26_hi5021q_rear_st_mipiraw_Sensor.h"

#define PFX "st_hi5021q_camera_sensor"
...
static struct imgsensor_info_struct imgsensor_info = {
     .sensor_id = N26_HI5021Q_REAR_ST_SENSOR_ID,
...
#if 1 ///otp code
static struct stCAM_CAL_DATAINFO_STRUCT n26_hi5021q_rear_st_eeprom_data ={
     .sensorID= N26_HI5021Q_REAR_ST_SENSOR_ID,
     .deviceID = 0x01,
     .dataLength = 0x2149,
...
static struct stCAM_CAL_CHECKSUM_STRUCT n26_hi5021q_rear_st_Checksum[12] =
{
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
  ...
  //// add maincamera hi5021q otp code
             size = imgSensorReadEepromData(&n26_hi5021q_rear_st_eeprom_data,n26_hi5021q_rear_st_Checksum);
             if(size != n26_hi5021q_rear_st_eeprom_data.dataLength) {
                 LOG_INF("get eeprom data failed\n");
                 if(n26_hi5021q_rear_st_eeprom_data.dataBuffer != NULL) {
                     kfree(n26_hi5021q_rear_st_eeprom_data.dataBuffer);
                     n26_hi5021q_rear_st_eeprom_data.dataBuffer = NULL;
                 }
                 *sensor_id = 0xFFFFFFFF;
                 return ERROR_SENSOR_CONNECT_FAIL;
             } else {
                 pr_info("get eeprom data success\n");
                 imgSensorSetEepromData(&n26_hi5021q_rear_st_eeprom_data);
#if hi5021q_XGC_QGC_PGC_CALIB
//get the pgc qgc xgc buffer
memcpy(XGCbuffer, (kal_uint8*)&n26_hi5021q_rear_st_eeprom_data.dataBuffer[hi5021Q_OTP_XGC_OFFSET+1], hi5021Q_OTP_XGC_LEN);
memcpy(QGCbuffer, (kal_uint8*)&n26_hi5021q_rear_st_eeprom_data.dataBuffer[hi5021Q_OTP_QGC_OFFSET+1], hi5021Q_OTP_QGC_LEN);
memcpy(PGCbuffer, (kal_uint8*)&n26_hi5021q_rear_st_eeprom_data.dataBuffer[hi5021Q_OTP_PGC_OFFSET+1], hi5021Q_OTP_PGC_LEN);

#if hi5021q_OTP_DUMP

LOG_INF("hi5021q_eeprom:pgc_addr:0x%x\n",n26_hi5021q_rear_st_Checksum[hi5021q_PGC- 1].startAdress + 3);
LOG_INF("hi5021q_eeprom:qgc_addr:0x%x\n",n26_hi5021q_rear_st_Checksum[hi5021q_QGC- 1].startAdress + 3);
LOG_INF("hi5021q_eeprom:xgc_addr:0x%x\n",n26_hi5021q_rear_st_Checksum[hi5021q_XGC- 1].startAdress + 3);
...
UINT32 N26_HI5021Q_REAR_ST_MIPI_RAW_SensorInit(struct
