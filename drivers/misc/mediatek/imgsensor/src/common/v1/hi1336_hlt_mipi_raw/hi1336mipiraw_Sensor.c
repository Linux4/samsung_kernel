...
#define PFX "hi1336_hlt_camera_sensor"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = HI1336_HLT_SENSOR_ID,
...
static kal_uint16 hi1336_hlt_table_write_cmos_sensor(
...
kal_uint16 addr_data_pair_init_hi1336_hlt[] = {
	0x2000, 0x0021,
	0x2002, 0x04a5,
	0x2004, 0xb124,
	0x2006, 0xc09c,
...
{
	hi1336_hlt_table_write_cmos_sensor(
		addr_data_pair_init_hi1336_hlt,
		sizeof(addr_data_pair_init_hi1336_hlt) /
		sizeof(kal_uint16));
}

kal_uint16 addr_data_pair_preview_hi1336_hlt[] = {
...
{
	hi1336_hlt_table_write_cmos_sensor(
		addr_data_pair_preview_hi1336_hlt,
		sizeof(addr_data_pair_preview_hi1336_hlt) /
		sizeof(kal_uint16));
}

kal_uint16 addr_data_pair_capture_30fps_hi1336_hlt[] = {
	0x3250, 0xa060, 
	0x0730, 0x770f, 
	0x0732, 0xe0b0, 
	0x1118, 0x0006, 
...
kal_uint16 addr_data_pair_capture_15fps_hi1336_hlt[] = {
	0x3250, 0xa060, 
	0x0730, 0x770f, 
	0x0732, 0xe0b0, 
	0x1118, 0x0006, 
...
static void capture_setting(kal_uint16 currefps)
{
	if (currefps == 300) {
	hi1336_hlt_table_write_cmos_sensor(
		addr_data_pair_capture_30fps_hi1336_hlt,
		sizeof(addr_data_pair_capture_30fps_hi1336_hlt) /
		sizeof(kal_uint16));

	} else {
	hi1336_hlt_table_write_cmos_sensor(
		addr_data_pair_capture_15fps_hi1336_hlt,
		sizeof(addr_data_pair_capture_15fps_hi1336_hlt) /
		sizeof(kal_uint16));
	}
}

kal_uint16 addr_data_pair_video_hi1336_hlt[] = {
	0x3250, 0xa060, 
	0x0730, 0x770f, 
	0x0732, 0xe0b0, 
	0x1118, 0x0006, 
...
{
	hi1336_hlt_table_write_cmos_sensor(
		addr_data_pair_video_hi1336_hlt,
		sizeof(addr_data_pair_video_hi1336_hlt) /
		sizeof(kal_uint16));
}

kal_uint16 addr_data_pair_hs_video_hi1336_hlt[] = {
	0x3250, 0xa470, //sreg8 - RAMP,B[15:10]:d2a_ramp_rng_ctrl
	0x0730, 0x770f, //pll_cfg_mipi_a PLL_CLK=750mhz b7-6:00_isp_div2(1/1) 
...
{
	hi1336_hlt_table_write_cmos_sensor(
		addr_data_pair_hs_video_hi1336_hlt,
		sizeof(addr_data_pair_hs_video_hi1336_hlt) /
		sizeof(kal_uint16));
}

kal_uint16 addr_data_pair_slim_video_hi1336_hlt[] = {
...
{
	hi1336_hlt_table_write_cmos_sensor(
		addr_data_pair_slim_video_hi1336_hlt,
		sizeof(addr_data_pair_slim_video_hi1336_hlt) /
		sizeof(kal_uint16));
}
...
static kal_uint32 open(void)
{
	...
	LOG_INF("[open]: hi1336_hlt@MT6765,MIPI 4LANE\n");
