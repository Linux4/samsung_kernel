...
#include "n26_s5k5e9_front_txd_mipi_raw.h"
...
static struct imgsensor_info_struct imgsensor_info = { 
    .sensor_id = N26_S5K5E9_FRONT_TXD_SENSOR_ID,
...
//+bug682590,zhanghengyuan.wt,ADD,2022/2/24, n26 s5k5e9 front  porting otp
...
static struct stCAM_CAL_DATAINFO_STRUCT n26_txd_sub_s5k3l6_eeprom_data ={
	.sensorID= N26_S5K5E9_FRONT_TXD_SENSOR_ID,
	.deviceID = 0x02,
	.dataLength = 0x0778,
...
//bug734817,liangyiyi.wt,MODIFY,2022/3/18, n26 s5k5e9 front Function "get_imgsensor_id" cross border visit
static struct stCAM_CAL_CHECKSUM_STRUCT n26_txd_sub_s5k3l6_Checksum[MAX_ITEM] =
{
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
	...
	kal_uint8 retry = 2;
	int size;
    printk("s5k5e9 get_imgsensor_id\n");
	...
	while(imgsensor_info.i2c_addr_table[i] != 0xff) {
		...
		do {
			*sensor_id = return_sensor_id();
                        printk("s5k5e9 get_imgsensor_id ,*sensor_id=%d\n",*sensor_id);
                        printk("s5k5e9 get_imgsensor_id ,S5K5E9_SENSOR_ID=%d\n",N26_S5K5E9_FRONT_TXD_SENSOR_ID);
		//+bug682590,zhanghengyuan.wt,ADD,2022/2/24, n26 s5k5e9 front  porting otp
			if (*sensor_id == N26_S5K5E9_FRONT_TXD_SENSOR_ID) {//S5K5E9YX_SENSOR_ID
				printk("s5k5e9 i2c write id: 0x%x, sensor id: 0x%x\n", imgsensor.i2c_write_id,*sensor_id);

				size = imgSensorReadEepromData(&n26_txd_sub_s5k3l6_eeprom_data,n26_txd_sub_s5k3l6_Checksum);
					if(size != n26_txd_sub_s5k3l6_eeprom_data.dataLength || (n26_txd_sub_s5k3l6_eeprom_data.sensorVendorid >> 24)!= get_vendor_id()) {
						printk("get eeprom data failed\n");
						if(n26_txd_sub_s5k3l6_eeprom_data.dataBuffer != NULL) {
							kfree(n26_txd_sub_s5k3l6_eeprom_data.dataBuffer);
							n26_txd_sub_s5k3l6_eeprom_data.dataBuffer = NULL;
						}
						*sensor_id = 0xFFFFFFFF;
						return ERROR_SENSOR_CONNECT_FAIL;
					} else {
						LOG_INF("get eeprom data success\n");
						imgSensorSetEepromData(&n26_txd_sub_s5k3l6_eeprom_data);
					}
		//-bug682590,zhanghengyuan.wt,ADD,2022/2/24, n26 s5k5e9 front  porting otp
				return ERROR_NONE;
			}
			printk("s5k5e9 Read sensor id fail, id: 0x%x\n", *sensor_id);
			retry--;
		} while(retry > 0);
		i++;
		retry = 2;
