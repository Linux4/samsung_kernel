...
#include "o2101_sc201cscxt_depth_mipi_raw.h"
...
static imgsensor_info_struct imgsensor_info = {
    .sensor_id = O2101_SC201CSCXT_DEPTH_SENSOR_ID,
...
{
	return ((read_cmos_sensor(0x3107) << 8) | read_cmos_sensor(0x3108))+2; //0xeb2c+1
}
