...
#define per_frame 1
extern bool read_n8_hi1336_xl_jct_eeprom( kal_uint16 addr, BYTE *data, kal_uint32 size);
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = N8_HI1336_XL_JCT_SENSOR_ID,
	...
	.pre = {
		...
		.max_framerate = 300,
		.mipi_pixel_rate =285600000,//bug 612420,zhanghao2.wt,add,2021/2/20,add dual camera custom1 mode
	},
	.cap = {
		.pclk = 600000000,
		.linelength = 6004,
		...
		.mipi_data_lp2hs_settle_dc = 85,
		.max_framerate = 300,
		//.mipi_pixel_rate =571200000, //bug 621172,zhanghao2.wt,add,2021/5/24,fix after-sale cablibration preview fail
	},
	// need to setting
    .cap1 = {
		.pclk = 600000000,
		...
		.mipi_data_lp2hs_settle_dc = 85,
		.max_framerate = 150,
		.mipi_pixel_rate =571200000,//bug 612420,zhanghao2.wt,add,2021/2/20,add dual camera custom1 mode
	...
	.hs_video = {
		...
		.max_framerate = 1200,
		.mipi_pixel_rate =71400000,//bug 612420,zhanghao2.wt,add,2021/2/20,add dual camera custom1 mode
    ...
    .slim_video = {
    	...
    	.mipi_data_lp2hs_settle_dc = 85,//unit , ns
    	.max_framerate = 1200,
		.mipi_pixel_rate =142800000,//bug 612420,zhanghao2.wt,add,2021/2/20,add dual camera custom1 mode
    },
	.custom1 = {//24.005
		.pclk = 600000000,
		.linelength = 6004,
		...
		.mipi_data_lp2hs_settle_dc = 85,//unit , ns
		.max_framerate = 240,
		.mipi_pixel_rate =434100000,//bug 612420,zhanghao2.wt,add,2021/2/20,add dual camera custom1 mode
	},
	.margin = 7,
	.min_shutter = 7,
...
static kal_uint16 n8_hi1336_xl_jct_table_write_cmos_sensor(
...
#if MULTI_WRITE
static kal_uint16 addr_data_pair_init_n8_hi1336_xl_jct[] = {
	0x2000, 0x0021,
	0x2002, 0x04a5,
	0x2004, 0xb124,
	0x2006, 0xc09c,
...
static void sensor_init(void)
{
	...
	n8_hi1336_xl_jct_table_write_cmos_sensor(
		addr_data_pair_init_n8_hi1336_xl_jct,
		sizeof(addr_data_pair_init_n8_hi1336_xl_jct) /
		sizeof(kal_uint16));
#else
...
#if MULTI_WRITE
static kal_uint16 addr_data_pair_preview_n8_hi1336_xl_jct[] = {
	0x3250, 0xa470,
	0x0730, 0x770f,
	0x0732, 0xe1b0,
	0x1118, 0x0004,
...
static void preview_setting(void)
{
	...
	n8_hi1336_xl_jct_table_write_cmos_sensor(
		addr_data_pair_preview_n8_hi1336_xl_jct,
		sizeof(addr_data_pair_preview_n8_hi1336_xl_jct) /
		sizeof(kal_uint16));
#else
...
#if MULTI_WRITE
static kal_uint16 addr_data_pair_capture_30fps_n8_hi1336_xl_jct[] = {
...
static kal_uint16 addr_data_pair_capture_15fps_n8_hi1336_xl_jct[] = {
	0x3250, 0xa060,
	0x0730, 0x7d4f,
	0x0732, 0xe0b1,
	0x1118, 0x0006,
...
static void capture_setting(kal_uint16 currefps)
{
	...
	if (currefps > 150) {
	n8_hi1336_xl_jct_table_write_cmos_sensor(
		addr_data_pair_capture_30fps_n8_hi1336_xl_jct,
		sizeof(addr_data_pair_capture_30fps_n8_hi1336_xl_jct) /
		sizeof(kal_uint16));

	} else {
	n8_hi1336_xl_jct_table_write_cmos_sensor(
		addr_data_pair_capture_15fps_n8_hi1336_xl_jct,
		sizeof(addr_data_pair_capture_15fps_n8_hi1336_xl_jct) /
		sizeof(kal_uint16));
	}
#else
...
static kal_uint16 addr_data_pair_video_hi1336[] = {
	...
	0x022c, 0x0c89,
//+bug449738 maliping.wt, add, 2019/06/25,video pdaf flow 	
	0x0224, 0x01a4,    //0x01a6, //maliping
	0x022e, 0x0ae7,	//0x0ae9,
//-bug449738 maliping.wt, add, 2019/06/25,video pdaf flow 	
	0x0f04, 0x0008,
	0x0f06, 0x0000,
	0x023a, 0x1111,
...
static void video_setting(void)
{
	...
	write_cmos_sensor(0x022c, 0x0c89);
//+bug449738 maliping.wt, add, 2019/06/25,video pdaf flow 	
	write_cmos_sensor(0x0224, 0x01a4);	//write_cmos_sensor(0x0224, 0x01a6);
	write_cmos_sensor(0x022e, 0x0ae7);	//write_cmos_sensor(0x022e, 0x0ae9);  //maliping
//-bug449738 maliping.wt, add, 2019/06/25,video pdaf flow 	
	write_cmos_sensor(0x0f04, 0x0008);
	write_cmos_sensor(0x0f06, 0x0000);
	write_cmos_sensor(0x023a, 0x1111);
...
#if MULTI_WRITE
static kal_uint16 addr_data_pair_hs_video_n8_hi1336_xl_jct[] = {
	0x3250, 0xa470,
	0x0730, 0x770f,
	0x0732, 0xe4b0,
	0x1118, 0x0072,
...
#if MULTI_WRITE
	n8_hi1336_xl_jct_table_write_cmos_sensor(
		addr_data_pair_hs_video_n8_hi1336_xl_jct,
		sizeof(addr_data_pair_hs_video_n8_hi1336_xl_jct) /
		sizeof(kal_uint16));
#else
...
#if MULTI_WRITE
static kal_uint16 addr_data_pair_slim_video_n8_hi1336_xl_jct[] = {
	0x3250, 0xa060,
	0x0730, 0x770f,
	0x0732, 0xe2b0,
	0x1118, 0x01a8,
...
static void slim_video_setting(void)
{
	...
	n8_hi1336_xl_jct_table_write_cmos_sensor(
		addr_data_pair_slim_video_n8_hi1336_xl_jct,
		sizeof(addr_data_pair_slim_video_n8_hi1336_xl_jct) /
		sizeof(kal_uint16));
#else
...
static struct stCAM_CAL_DATAINFO_STRUCT hi1336_xl_jct_eeprom_data ={
	.sensorID= N8_HI1336_XL_JCT_SENSOR_ID,
	.deviceID = 0x01,
	.dataLength = 0x0CE3,
	.sensorVendorid = 0x06000001,
	.vendorByte = {1,2,3,4},
	.dataBuffer = NULL,
};
		...
		do {
			*sensor_id = return_sensor_id() +3;
			if (*sensor_id == imgsensor_info.sensor_id) {
				//Type Bug431177 + , chenshengqian.wt, modify, 2019.03.14, otp funtion, multi cam compatibility
				size = imgSensorReadEepromData(&hi1336_xl_jct_eeprom_data,hi1336XlChecksum);
				if(size != hi1336_xl_jct_eeprom_data.dataLength) {
					printk("get eeprom data failed\n");
					if(hi1336_xl_jct_eeprom_data.dataBuffer != NULL) {
						kfree(hi1336_xl_jct_eeprom_data.dataBuffer);
						hi1336_xl_jct_eeprom_data.dataBuffer = NULL;
					}
					*sensor_id = 0xFFFFFFFF;
					return ERROR_SENSOR_CONNECT_FAIL;
				} else {
					LOG_INF("get eeprom data success\n");
					imgSensorSetEepromData(&hi1336_xl_jct_eeprom_data);
				}
				//Type Bug431177 - , chenshengqian.wt, modify, 2019.03.14, otp funtion, multi cam compatibility
			...
			UINT8 *feature_para, UINT32 *feature_para_len)
{
	...
	switch (feature_id) {
	//+bug 612420,zhanghao2.wt,add,2021/2/20,add dual camera custom1 mode
