...
#include "n28hi5021qreardc_mipiraw_Sensor.h"
...
static kal_uint16 hi5021q_read_eeprom(kal_uint32 addr)
{
...
static kal_uint8 XGCbuffer[hi5021Q_OTP_XGC_LEN] = {0};
static kal_uint8 QGCbuffer[hi5021Q_OTP_QGC_LEN] = {0};
static kal_uint8 PGCbuffer[hi5021Q_OTP_PGC_LEN] = {0};
...
static struct imgsensor_info_struct imgsensor_info = {
     .sensor_id = N28HI5021QREARDC_SENSOR_ID,
     ...
     .cap = {
         ...
         /*     following for GetDefaultFramerateByScenario()    */
         .max_framerate = 300,
         .mipi_pixel_rate =859200000,//2148Mbps*4/10=859 200 000
     },
     // need to setting
     .cap1 = {
         .pclk = 124000000,
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[9] = {
     ...
     {8224, 6176, 16,   16, 8192, 6144, 2048, 1536,  384,408, 1280,  720, 0,0, 1280,  720},  //hs_video(1280 x 720)@120fps
...
static void apply_sensor_Cali(void)
{
     ...
     kal_uint8 *PGC_CalData = (kal_uint8*)PGCbuffer;
     ...
     kal_uint16 nReadData;
     kal_uint16 TEMP1;
     kal_uint16 nWriteData;
     kal_uint16 XGC_Flag;
     kal_uint16 QGC_Flag;
     kal_uint16 PGC_Flag;
     int i = 0;
...
//Burst write XGC_Gb line //
          ...
          {
               //hi5021qrearqt_table_write_cmos_sensor(
...
//*********Burst write apply XGC GR line start**************//
     ...
     write_cmos_sensor(0x0318, TEMP1 & 0xFFDF); // PGC data loading disable B[5]
     PGC_Flag=((read_cmos_sensor(0x0318) << 8) | read_cmos_sensor(0x0319));
     LOG_INF("PGC_Flag = %d", PGC_Flag);
     write_cmos_sensor(0xffff, 0x0B40); // PGC(Gb line) enable
     //*********Burst write apply PGC Gb line start**************//
     {
          ...
          for(i = 0; i < 946;i+=2)
          {
               ...
               PGC_GB_setting_burst[2*length_pgc_gb]=hi5021_pgc_gb_addr;
               PGC_GB_setting_burst[2*length_pgc_gb+1]=hi5021_pgc_gb_data;
               length_pgc_gb++;
          ...
          {
               //hi5021qrearqt_table_write_cmos_sensor(
               //PGC_GB_setting_burst,sizeof(PGC_GB_setting_burst)/sizeof(kal_uint16));
               skhynix_write_burst_mode(PGC_GB_setting_burst,
                    sizeof(PGC_GB_setting_burst)/sizeof(kal_uint16));
          }
#if HI5021Q_ISP_CALIBRATION_OTP_DUMP
          pr_info("================hi5021q PGC_GB burst write    data.================\n");
          for(n=0; n<946; n=n+2)
          {
               pr_info("hi5021q pgc_gb addr:0x%x,data:0x%x",PGC_GB_setting_burst[n],PGC_GB_setting_burst[n+1]);
               if(n%10 == 9)
               {
                    pr_info("\n");
               }
          ...
          write_cmos_sensor(0xffff, 0x0000); // PGC(Gr line) disable
     ...
     {
          write_cmos_sensor(0xffff, 0x0C40); // PGC(Gr line) enable
          hi5021_pgc_gr_addr = 0x0000;
          for(i = 946; i < 1892;i+=2)
          {
               hi5021_pgc_gr_data = ((((PGC_CalData[i+1]) & (0x00ff))<<8) +((PGC_CalData[i]) & (0x00ff)));
               PGC_GR_setting_burst[2*length_pgc_gr]=hi5021_pgc_gr_addr;
               PGC_GR_setting_burst[2*length_pgc_gr+1]=hi5021_pgc_gr_data;
               length_pgc_gr++;
          ...
          {
               //hi5021qrearqt_table_write_cmos_sensor(
               //PGC_GR_setting_burst,sizeof(PGC_GR_setting_burst)/sizeof(kal_uint16));
               skhynix_write_burst_mode(PGC_GR_setting_burst,
                    sizeof(PGC_GR_setting_burst)/sizeof(kal_uint16));
          }
#if HI5021Q_ISP_CALIBRATION_OTP_DUMP
          pr_info("================hi5021q PGC_GR burst write data.================\n");
          for(n=0; n<946; n=n+2)
          {
               pr_info("hi5021q pgc_gr addr:0x%x,data:0x%x ",PGC_GR_setting_burst[n],PGC_GR_setting_burst[n+1]);
               if(n%10 == 9)
               {
                    pr_info("\n");
               }
...
{
     return ((read_cmos_sensor(0x0716) << 8) | read_cmos_sensor(0x0717)) + 5;
}
...
#if 1 ///otp code
static struct stCAM_CAL_DATAINFO_STRUCT n28hi5021qreardc_eeprom_data ={
     .sensorID= N28HI5021QREARDC_SENSOR_ID,
     .deviceID = 0x01,
     .dataLength = 0x2149,
     .sensorVendorid = 0x13000000,
     .vendorByte = {1,2,3,4},
     .dataBuffer = NULL,
};

static struct stCAM_CAL_CHECKSUM_STRUCT n28hi5021qreardc_Checksum[12] =
{
      ...
      {hi5021q_XGC,0x0D5E,0x0D5E,0x14DE,0x14DF,0x55},
      {hi5021q_QGC,0x14E0,0x14E0,0x19E0,0x19E1,0x55},
      {hi5021q_PGC,0x19E2,0x19E2,0x2146,0x2147,0x55},
      {TOTAL_ITEM,0x0000,0x0000,0x2147,0x2148,0x55},
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
         ...
         do {
             *sensor_id = return_sensor_id();
             ...
             LOG_INF("truly i2c write id : 0x%x, sensor id: 0x%x\n",imgsensor.i2c_write_id, *sensor_id);
                ...
                if((n28hi5021qreardc_eeprom_data.sensorVendorid >> 24) != hi5021q_read_eeprom(0x0001)){
  ...
  //// add maincamera hi5021q otp code
             size = imgSensorReadEepromData(&n28hi5021qreardc_eeprom_data,n28hi5021qreardc_Checksum);
             if(size != n28hi5021qreardc_eeprom_data.dataLength) {
                 LOG_INF("get eeprom data failed\n");
                 if(n28hi5021qreardc_eeprom_data.dataBuffer != NULL) {
                     kfree(n28hi5021qreardc_eeprom_data.dataBuffer);
                     n28hi5021qreardc_eeprom_data.dataBuffer = NULL;
                 }
                 //*sensor_id = 0xFFFFFFFF;
                 //return ERROR_SENSOR_CONNECT_FAIL;
             } else {
                 pr_info("get eeprom data success\n");
                    imgSensorSetEepromData(&n28hi5021qreardc_eeprom_data);

#if hi5021q_XGC_QGC_PGC_CALIB
//get the pgc qgc xgc buffer
memcpy(XGCbuffer, (kal_uint8*)&n28hi5021qreardc_eeprom_data.dataBuffer[hi5021Q_OTP_XGC_OFFSET+1], hi5021Q_OTP_XGC_LEN);
memcpy(QGCbuffer, (kal_uint8*)&n28hi5021qreardc_eeprom_data.dataBuffer[hi5021Q_OTP_QGC_OFFSET+1], hi5021Q_OTP_QGC_LEN);
memcpy(PGCbuffer, (kal_uint8*)&n28hi5021qreardc_eeprom_data.dataBuffer[hi5021Q_OTP_PGC_OFFSET+1], hi5021Q_OTP_PGC_LEN);

#if hi5021q_OTP_DUMP

LOG_INF("hi5021q_eeprom:pgc_addr:0x%x\n",n28hi5021qreardc_Checksum[hi5021q_PGC- 1].startAdress + 3);
LOG_INF("hi5021q_eeprom:qgc_addr:0x%x\n",n28hi5021qreardc_Checksum[hi5021q_QGC- 1].startAdress + 3);
LOG_INF("hi5021q_eeprom:xgc_addr:0x%x\n",n28hi5021qreardc_Checksum[hi5021q_XGC- 1].startAdress + 3);
...
UINT32 N28HI5021QREARDC_MIPI_RAW_SensorInit(struct
