 ...
 *
 ****************************************************************************/
#ifndef _SC200CSmipi_SENSOR_H
#define _SC200CSmipi_SENSOR_H
...
typedef enum{
    ...
    IMGSENSOR_MODE_CUSTOM1,//bug 663265 zhoumin.wt, add, 2021/09/17, modify framerate of dualcam to be 24fps
} IMGSENSOR_MODE;
...
typedef struct imgsensor_info_struct {
    ...
    imgsensor_mode_struct custom1;//bug 663265 zhoumin.wt, add, 2021/09/17, modify framerate of dualcam to be 24fps

    kal_uint8  ae_shut_delay_frame;    //shutter delay frame for AE cycle
    kal_uint8  ae_sensor_gain_delay_frame;    //sensor gain delay frame for AE cycle
    kal_uint8  ae_ispGain_delay_frame;    //isp gain delay frame for AE cycle
    kal_uint8  frame_time_delay_frame;//bug 663265 zhoumin.wt, add, 2021/09/13, modify for dualcam sync
    ...
    kal_uint8  custom1_delay_frame;//bug 663265 zhoumin.wt, add, 2021/09/17, modify framerate of dualcam to be 24fps
...
#define SC200CS_VALID_IXEL_NUMS            800
#define SC200CS_VALID_LINE_NUMS            1200
#define SC200CS_DEFAULT_DUMMY_PIXEL_NUMS   0x11c //244 
#define SC200CS_DEFAULT_DUMMY_LINE_NUMS    0x0e //64

#define SC200CS_INTERNAL_DUMMY_PIXEL_NUMS  36
#define SC200CS_INTERNAL_DUMMY_LINE_NUMS   32

#define SC200CS_VIDEO_PERIOD_PIXEL_NUMS          (1120)
#define SC200CS_VIDEO_PERIOD_LINE_NUMS           (1246)
#define SC200CS_PV_PERIOD_PIXEL_NUMS            (1120)
#define SC200CS_PV_PERIOD_LINE_NUMS             (1246)

#define SC200CS_FULL_PERIOD_PIXEL_NUMS          (1120)
#define SC200CS_FULL_PERIOD_LINE_NUMS           (1246)
