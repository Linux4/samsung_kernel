...
#include "gc5035xlmipi_Sensor.h"

/**************** Modify Following Strings for Debug ******************/
#define PFX "gc5035_xl_camera_sensor"
...
{       
	...
	printk("GC5035_XL  compatilbe=%0x ",module_id);
	write_cmos_sensor(0xf3, 0x00);
	return module_id;
}
