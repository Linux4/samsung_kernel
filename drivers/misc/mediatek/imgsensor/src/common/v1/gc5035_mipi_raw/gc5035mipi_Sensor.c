...
static int write_cmos_sensor(kal_uint32 addr, kal_uint32 para)
{
	...
	ret = iWriteRegI2C(pu_send_cmd, 2, imgsensor.i2c_write_id);
	return ret;
}
...
static kal_uint16 set_gain(kal_uint16 gain)
{
	...
	pr_debug("Exit! GC5035_AGC_Param[gain_index][1] =");
	pr_debug("0x%x, temp_gain = 0x%x, reg_gain = %d\n",
...
static void sensor_init(void)
{
	...
	/* System Setting */
	ret |= write_cmos_sensor(0xfc, 0x01);
	ret |= write_cmos_sensor(0xf4, 0x40);
	ret |= write_cmos_sensor(0xf5, 0xe9);
	ret |= write_cmos_sensor(0xf6, 0x14);
	ret |= write_cmos_sensor(0xf8, 0x45);
	ret |= write_cmos_sensor(0xf9, 0x82);
	ret |= write_cmos_sensor(0xfa, 0x00);
	ret |= write_cmos_sensor(0xfc, 0x81);
	ret |= write_cmos_sensor(0xfe, 0x00);
	ret |= write_cmos_sensor(0x36, 0x01);
	ret |= write_cmos_sensor(0xd3, 0x87);
	ret |= write_cmos_sensor(0x36, 0x00);
	ret |= write_cmos_sensor(0x33, 0x00);
	ret |= write_cmos_sensor(0xfe, 0x03);
	ret |= write_cmos_sensor(0x01, 0xe7);
	ret |= write_cmos_sensor(0xf7, 0x01);
	ret |= write_cmos_sensor(0xfc, 0x8f);
	ret |= write_cmos_sensor(0xfc, 0x8f);
	ret |= write_cmos_sensor(0xfc, 0x8e);
	ret |= write_cmos_sensor(0xfe, 0x00);
	ret |= write_cmos_sensor(0xee, 0x30);
	ret |= write_cmos_sensor(0x87, 0x18);
	ret |= write_cmos_sensor(0xfe, 0x01);
	ret |= write_cmos_sensor(0x8c, 0x90);
	ret |= write_cmos_sensor(0xfe, 0x00);
	ret |= write_cmos_sensor(0x11, 0x02);
	ret |= write_cmos_sensor(0x17, 0x80);
	ret |= write_cmos_sensor(0x19, 0x05);
	ret |= write_cmos_sensor(0xfe, 0x02);
	ret |= write_cmos_sensor(0x30, 0x03);
	ret |= write_cmos_sensor(0x31, 0x03);
	ret |= write_cmos_sensor(0xfe, 0x00);
	ret |= write_cmos_sensor(0xd9, 0xc0);
	ret |= write_cmos_sensor(0x1b, 0x20);
	ret |= write_cmos_sensor(0x21, 0x48);
	ret |= write_cmos_sensor(0x28, 0x22);
	ret |= write_cmos_sensor(0x29, 0x58);
	ret |= write_cmos_sensor(0x44, 0x20);
	ret |= write_cmos_sensor(0x4b, 0x10);
	ret |= write_cmos_sensor(0x4e, 0x1a);
	ret |= write_cmos_sensor(0x50, 0x11);
	ret |= write_cmos_sensor(0x52, 0x33);
	ret |= write_cmos_sensor(0x53, 0x44);
	ret |= write_cmos_sensor(0x55, 0x10);
	ret |= write_cmos_sensor(0x5b, 0x11);
	ret |= write_cmos_sensor(0xc5, 0x02);
	ret |= write_cmos_sensor(0x8c, 0x1a);
	ret |= write_cmos_sensor(0xfe, 0x02);
	ret |= write_cmos_sensor(0x33, 0x05);
	ret |= write_cmos_sensor(0x32, 0x38);
	ret |= write_cmos_sensor(0xfe, 0x00);
	ret |= write_cmos_sensor(0x16, 0x0c);
	ret |= write_cmos_sensor(0x1a, 0x1a);
	ret |= write_cmos_sensor(0x20, 0x10);
	ret |= write_cmos_sensor(0x46, 0x83);
	ret |= write_cmos_sensor(0x4a, 0x04);
	ret |= write_cmos_sensor(0x54, 0x02);
	ret |= write_cmos_sensor(0x62, 0x00);
	ret |= write_cmos_sensor(0x72, 0x8f);
	ret |= write_cmos_sensor(0x73, 0x89);
	ret |= write_cmos_sensor(0x7a, 0x05);
	ret |= write_cmos_sensor(0x7c, 0xa0);
	ret |= write_cmos_sensor(0x7d, 0xcc);
	ret |= write_cmos_sensor(0x90, 0x00);
	ret |= write_cmos_sensor(0xce, 0x18);
	ret |= write_cmos_sensor(0xd2, 0x40);
	ret |= write_cmos_sensor(0xe6, 0xe0);
	ret |= write_cmos_sensor(0xfe, 0x02);
	ret |= write_cmos_sensor(0x12, 0x01);
	ret |= write_cmos_sensor(0x13, 0x01);
	ret |= write_cmos_sensor(0x14, 0x01);
	ret |= write_cmos_sensor(0x15, 0x02);
	ret |= write_cmos_sensor(0x22, 0x7c);
	ret |= write_cmos_sensor(0xfe, 0x00);
	ret |= write_cmos_sensor(0xfc, 0x88);
	ret |= write_cmos_sensor(0xfe, 0x10);
	ret |= write_cmos_sensor(0xfe, 0x00);
	ret |= write_cmos_sensor(0xfc, 0x8e);
	ret |= write_cmos_sensor(0xfe, 0x00);
	ret |= write_cmos_sensor(0xfe, 0x00);
	...
	/* Gain */
	ret |= write_cmos_sensor(0xfe, 0x00);
	ret |= write_cmos_sensor(0xb0, 0x6e);
	ret |= write_cmos_sensor(0xb1, 0x01);
	ret |= write_cmos_sensor(0xb2, 0x00);
	ret |= write_cmos_sensor(0xb3, 0x00);
	ret |= write_cmos_sensor(0xb4, 0x00);
	ret |= write_cmos_sensor(0xb6, 0x00);

	/* ISP Setting */
	ret |= write_cmos_sensor(0xfe, 0x01);
	ret |= write_cmos_sensor(0x53, 0x00);
	ret |= write_cmos_sensor(0x89, 0x03);
	ret |= write_cmos_sensor(0x60, 0x40);

	/* Stream Off */
	ret |= write_cmos_sensor(0xfe, 0x00);
	ret |= write_cmos_sensor(0x3e, 0x00);
