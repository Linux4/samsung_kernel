 ...
 * Filename:
 * ---------
 *     n26_s5kjn1_rear_txd_mipi_Sensor.c
 *
 * Project:
 * --------
 *     ALPS
...
#include "n26_s5kjn1_rear_txd_mipiraw_Sensor.h"
//#include "imgsensor_common.h"

#define VENDOR_EDIT 1

/***************Modify Following Strings for Debug**********************/
#define PFX "n26_txd_s5kjn1_camera_sensor"
#define LOG_1 LOG_INF("n26_txd_s5kjn1,MIPI 4LANE\n")
/****************************   Modify end    **************************/
#define LOG_INF(format, args...) pr_err(PFX "[%s] " format, __func__, ##args)
#define LOG_ERR(format, args...) pr_err(PFX "[%s] " format, __func__, ##args)

#define DEVICE_VERSION_S5KJN103     "n26_txd_s5kjn1"
...
#define N26_TXD_S5KJN1_OTP 1
#define USE_BURST_MODE 1
#define JN1_HW_GGC_SIZE 173
#define JN1_HW_GGC_START_ADDR 0x3027

#define hi5021Q_OTP_XTC_OFFSET   0x0D5E
#define hi5021Q_OTP_SENSORXTC_OFFSET   0x1B0E
#define hi5021Q_OTP_PDXTC_OFFSET   0x1E10
#define hi5021Q_OTP_SWGCC_OFFSET   0x2DB2
...
static struct imgsensor_info_struct imgsensor_info = {
    .sensor_id = N26_S5KJN1_REAR_TXD_SENSOR_ID,
    .module_id = 0x19,
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[8] = {
    ...
    {8160, 6144,   0,    0,   8160, 6144, 2040, 1536,  380, 408, 1280, 720,     0,    0, 1280,  720}, /* hs_video */
...
static kal_int32 write_Module_data(ACDK_SENSOR_ENGMODE_STEREO_STRUCT * pStereodata)
{
    ...
    if(pStereodata != NULL) {
        ...
        if ((pStereodata->uSensorId == N26_S5KJN1_REAR_TXD_SENSOR_ID) && (data_length == DUALCAM_CALI_DATA_LENGTH)
...
/*n26 2022/04/18, add for HW_GGC write to sensor start*/
#if N26_TXD_S5KJN1_OTP
...
/*n26 2022/04/18, add for HW_GGC write to sensor end*/
#endif
...
static void n26_txd_s5kjn103_set_lsc_reg_setting(
...
static kal_uint16 n26_txd_s5kjn103_init_setting[] = {
    0x6028,0x2400,
    0x602A,0x1354,
    0x6F12,0x0100,
    0x6F12,0x7017,
...
static kal_uint16 n26_txd_s5kjn103_capture_setting[] = {
    0x6028, 0x2400,
    0x602A, 0x1A28,
    0x6F12, 0x4C00,
    0x602A, 0x065A,
...
static kal_uint16 n26_txd_s5kjn103_preview_setting[] = {
    0x6028, 0x2400,
    0x602A, 0x1A28,
    0x6F12, 0x4C00,
    0x602A, 0x065A,
...
static kal_uint16 n26_txd_s5kjn103_normal_video_setting[] = {
    0x6028, 0x2400,
    0x602A, 0x1A28,
    0x6F12, 0x4C00,
    0x602A, 0x065A,
...
static kal_uint16 n26_txd_s5kjn103_hs_video_setting[] = {
    0x6028, 0x2400,
    0x602A, 0x1A28,
    0x6F12, 0x4C00,
    0x602A, 0x065A,
...
static kal_uint16 n26_txd_s5kjn103_slim_video_setting[] = {
    0x6028, 0x2400,
    0x602A, 0x1A28,
    0x6F12, 0x4C00,
    0x602A, 0x065A,
...
static kal_uint16 n26_txd_s5kjn103_custom1_setting[] = {
    0x6028, 0x2400,
    0x602A, 0x1A28,
    0x6F12, 0x4C00,
    0x602A, 0x065A,
...
static kal_uint16 n26_txd_s5kjn103_custom2_setting[] = {
    0x6028, 0x2400,
    0x602A, 0x1A28,
    0x6F12, 0x4C00,
    0x602A, 0x065A,
...
static kal_uint16 n26_txd_s5kjn103_custom3_setting[] = {
    0x6028, 0x2400,
    0x602A, 0x1A28,
    0x6F12, 0x4C00,
    0x602A, 0x065A,
...
static void sensor_init(void)
{
    ...
    table_write_cmos_sensor(n26_txd_s5kjn103_init_setting,
        sizeof(n26_txd_s5kjn103_init_setting) / sizeof(kal_uint16));
...
static void preview_setting(void)
{
    ...
    table_write_cmos_sensor(n26_txd_s5kjn103_preview_setting,
        sizeof(n26_txd_s5kjn103_preview_setting)/sizeof(kal_uint16));
...
static void capture_setting(kal_uint16 currefps)
{
    ...
    table_write_cmos_sensor(n26_txd_s5kjn103_capture_setting,
        sizeof(n26_txd_s5kjn103_capture_setting)/sizeof(kal_uint16));
...
static void normal_video_setting(kal_uint16 currefps)
{
    ...
    table_write_cmos_sensor(n26_txd_s5kjn103_normal_video_setting,
        sizeof(n26_txd_s5kjn103_normal_video_setting)/sizeof(kal_uint16));
    LOG_INF("X\n");
}
...
static void hs_video_setting(void)
{
    ...
    table_write_cmos_sensor(n26_txd_s5kjn103_hs_video_setting,
        sizeof(n26_txd_s5kjn103_hs_video_setting)/sizeof(kal_uint16));
    LOG_INF("X\n");
}
...
static void slim_video_setting(void)
{
    ...
    table_write_cmos_sensor(n26_txd_s5kjn103_slim_video_setting,
        sizeof(n26_txd_s5kjn103_slim_video_setting)/sizeof(kal_uint16));
    LOG_INF("X\n");
}
...
static void custom1_setting(void)
{
    ...
    /*************MIPI output setting************/
    table_write_cmos_sensor(n26_txd_s5kjn103_custom1_setting,
        sizeof(n26_txd_s5kjn103_custom1_setting)/sizeof(kal_uint16));
    LOG_INF("X");
}
...
static void custom2_setting(void)
{
    ...
    /*************MIPI output setting************/
    table_write_cmos_sensor(n26_txd_s5kjn103_custom2_setting,
        sizeof(n26_txd_s5kjn103_custom2_setting)/sizeof(kal_uint16));
    LOG_INF("X");
}
...
static void custom3_setting(void)
{
    ...
    /*************MIPI output setting************/
    table_write_cmos_sensor(n26_txd_s5kjn103_custom3_setting,
        sizeof(n26_txd_s5kjn103_custom3_setting)/sizeof(kal_uint16));
    LOG_INF("X");
}
#if 1 ///otp code
static struct stCAM_CAL_DATAINFO_STRUCT n26_s5kjn1_rear_txd_eeprom_data ={
    .sensorID= N26_S5KJN1_REAR_TXD_SENSOR_ID,
    .deviceID = 0x01,
    .dataLength = 0x3183,
...
static struct stCAM_CAL_CHECKSUM_STRUCT n26_s5kjn1_rear_txd_Checksum[14] =
{
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
  ...
  //// add maincamera s5kjn1 otp code
             size = imgSensorReadEepromData(&n26_s5kjn1_rear_txd_eeprom_data,n26_s5kjn1_rear_txd_Checksum);
             if(size != n26_s5kjn1_rear_txd_eeprom_data.dataLength) {
                 LOG_INF("get eeprom data failed\n");
                 if(n26_s5kjn1_rear_txd_eeprom_data.dataBuffer != NULL) {
                     kfree(n26_s5kjn1_rear_txd_eeprom_data.dataBuffer);
                     n26_s5kjn1_rear_txd_eeprom_data.dataBuffer = NULL;
                 }
                 *sensor_id = 0xFFFFFFFF;
                 return ERROR_SENSOR_CONNECT_FAIL;
             } else {
                 pr_info("get eeprom data success\n");
                 imgSensorSetEepromData(&n26_s5kjn1_rear_txd_eeprom_data);
#if N26_TXD_S5KJN1_OTP
read_eepromData_HW_GGC();
memcpy(XTCBuffer, (kal_uint8*)&n26_s5kjn1_rear_txd_eeprom_data.dataBuffer[hi5021Q_OTP_XTC_OFFSET+1], S5KJN1_OTP_XTC_LEN);
memcpy(SENSORXTCBuffer, (kal_uint8*)&n26_s5kjn1_rear_txd_eeprom_data.dataBuffer[hi5021Q_OTP_SENSORXTC_OFFSET+1], S5KJN1_OTP_SENSORXTC_LEN);
memcpy(PDXTCXTCBuffer, (kal_uint8*)&n26_s5kjn1_rear_txd_eeprom_data.dataBuffer[hi5021Q_OTP_PDXTC_OFFSET+1], S5KJN1_OTP_PDXTC_LEN);
memcpy(SWGCCBuffer, (kal_uint8*)&n26_s5kjn1_rear_txd_eeprom_data.dataBuffer[hi5021Q_OTP_SWGCC_OFFSET+1], S5KJN1_OTP_SWGCC_LEN);
#endif
             }
                 ...
                 UINT8 *feature_para, UINT32 *feature_para_len)
{
    ...
    case SENSOR_FEATURE_SET_LSC_TBL:
    {
        ...
        n26_txd_s5kjn103_set_lsc_reg_setting(index, feature_data_16,
