...
#include "n21_hlt_depth_gc2375hmipiraw_Sensor.h"

/**************** Modify Following Strings for Debug ******************/
#define PFX "n21_hlt_depth_gc2375h_camera_sensor"
#define LOG_1 cam_pr_debug("N21_HLT_DEPTH_GC2375H, MIPI 1LANE\n")
/********************   Modify end    *********************************/
...
extern int getDepthCameraIdGpioValue(void);//bug497390,gaoyu.git,add,20191106,Distinguish between 2st depth camera and 3rd depth camera
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = N21_HLT_DEPTH_GC2375H_SENSOR_ID,
...
#if N21_HLT_DEPTH_GC2375H_MIRROR_FLIP_ENABLE
...
kal_uint16 addr_data_pair_init_n21_hlt_depth_gc2375h[] = {
    0xfe, 0x00,
    0xfe, 0x00,
    0xfe, 0x00,
    0xf7, 0x01,
    ...
    0x0f, 0x06,
    0x10, 0x48,
    0x17, N21_HLT_DEPTH_GC2375H_MIRROR,
    0x1c, 0x10,
    0x1d, 0x13,
    0x20, 0x0b,
    0x21, 0x6d,
    ...
    0x43, 0x03,
    0x4a, 0x00,
    0x4e, N21_HLT_DEPTH_GC2375H_BLK_Select1_H,
    0x4f, N21_HLT_DEPTH_GC2375H_BLK_Select1_L,
    0x66, N21_HLT_DEPTH_GC2375H_BLK_Select2_H,
    0x67, N21_HLT_DEPTH_GC2375H_BLK_Select2_L,
    0x68, 0x00,
    0xb0, 0x58,
    0xb1, 0x01,
    0xb2, 0x00,
...
static void sensor_init(void)
{
    ...
    addr_data_pair_init_n21_hlt_depth_gc2375h,
    sizeof(addr_data_pair_init_n21_hlt_depth_gc2375h) /
    sizeof(kal_uint16));
#else
	/* System */
	write_cmos_sensor(0xfe, 0x00);
	...
	write_cmos_sensor(0x17, N21_HLT_DEPTH_GC2375H_MIRROR);
	...
	write_cmos_sensor(0x4e, N21_HLT_DEPTH_GC2375H_BLK_Select1_H);
	write_cmos_sensor(0x4f, N21_HLT_DEPTH_GC2375H_BLK_Select1_L);
	write_cmos_sensor(0x66, N21_HLT_DEPTH_GC2375H_BLK_Select2_H);
	write_cmos_sensor(0x67, N21_HLT_DEPTH_GC2375H_BLK_Select2_L);
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
	kal_uint8 i = 0;
	kal_uint8 retry = 2;
        int val = 0;//bug497390,gaoyu.git,add,20191106,Distinguish between 2st depth camera and 3rd depth camera
	...
	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
		...
		do {
			...
			*sensor_id = return_sensor_id() + (val ? 2 : 0);//bug497390,gaoyu.git,add,20191106,Distinguish between 2st depth camera and 3rd depth camera
