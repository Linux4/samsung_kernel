...
#if 1 ///otp code
static struct stCAM_CAL_DATAINFO_STRUCT n28hi5021qreartruly_eeprom_data ={
...
static struct stCAM_CAL_CHECKSUM_STRUCT n28hi5021qreartruly_Checksum[12] =
{
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
         ...
         do {
             *sensor_id = return_sensor_id();
             if (*sensor_id == imgsensor_info.sensor_id) {
                 ...
                 if((n28hi5021qreartruly_eeprom_data.sensorVendorid >> 24) != hi5021q_read_eeprom(0x0001)){
  ...
  //// add maincamera hi5021q otp code
             size = imgSensorReadEepromData(&n28hi5021qreartruly_eeprom_data,n28hi5021qreartruly_Checksum);
             if(size != n28hi5021qreartruly_eeprom_data.dataLength) {
                 LOG_INF("hi5021 probe fail: get eeprom data failed\n");
                 if(n28hi5021qreartruly_eeprom_data.dataBuffer != NULL) {
                     kfree(n28hi5021qreartruly_eeprom_data.dataBuffer);
                     n28hi5021qreartruly_eeprom_data.dataBuffer = NULL;
                 }
                 *sensor_id = 0xFFFFFFFF;
                 return ERROR_SENSOR_CONNECT_FAIL;
             } else {
                 pr_info("get eeprom data success\n");
                    imgSensorSetEepromData(&n28hi5021qreartruly_eeprom_data);

#if hi5021q_XGC_QGC_PGC_CALIB
//get the pgc qgc xgc buffer
memcpy(XGCbuffer, (kal_uint8*)&n28hi5021qreartruly_eeprom_data.dataBuffer[hi5021Q_OTP_XGC_OFFSET+1], hi5021Q_OTP_XGC_LEN);
memcpy(QGCbuffer, (kal_uint8*)&n28hi5021qreartruly_eeprom_data.dataBuffer[hi5021Q_OTP_QGC_OFFSET+1], hi5021Q_OTP_QGC_LEN);
memcpy(PGCbuffer, (kal_uint8*)&n28hi5021qreartruly_eeprom_data.dataBuffer[hi5021Q_OTP_PGC_OFFSET+1], hi5021Q_OTP_PGC_LEN);

#if hi5021q_OTP_DUMP

LOG_INF("hi5021q_eeprom:pgc_addr:0x%x\n",n28hi5021qreartruly_Checksum[hi5021q_PGC- 1].startAdress + 3);
LOG_INF("hi5021q_eeprom:qgc_addr:0x%x\n",n28hi5021qreartruly_Checksum[hi5021q_QGC- 1].startAdress + 3);
LOG_INF("hi5021q_eeprom:xgc_addr:0x%x\n",n28hi5021qreartruly_Checksum[hi5021q_XGC- 1].startAdress + 3);
