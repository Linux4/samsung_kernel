...
#include "n8_hi846_ly_mipi_raw.h"

#define PFX "n8_hi846_ly_camera_sensor"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = N8_HI846_LY_SENSOR_ID,
...
static kal_uint16 n8_hi846_ly_table_write_cmos_sensor(
...
#if MULTI_WRITE
static kal_uint16 addr_data_pair_init_n8_hi846_ly[] = {
	0x2000, 0x987A, 
	0x2002, 0x00FF,
	0x2004, 0x0047, 
	0x2006, 0x3FFF,
...
{
#if MULTI_WRITE
	n8_hi846_ly_table_write_cmos_sensor(
		addr_data_pair_init_n8_hi846_ly,
		sizeof(addr_data_pair_init_n8_hi846_ly) /
		sizeof(kal_uint16));
#else
...
#if MULTI_WRITE
static kal_uint16 addr_data_pair_preview_n8_hi846_ly[] = {
	0x002E, 0x3311,
	0x0032, 0x3311,
	0x0026, 0x0040,
	0x002C, 0x09CF,
...
#if MULTI_WRITE
	n8_hi846_ly_table_write_cmos_sensor(
		addr_data_pair_preview_n8_hi846_ly,
		sizeof(addr_data_pair_preview_n8_hi846_ly) /
		sizeof(kal_uint16));
#else
	LOG_INF("E preview\n");
	//Sensor Information////////////////////////////
...
#if MULTI_WRITE
static kal_uint16 addr_data_pair_capture_fps_n8_hi846_ly[] = {
	0x002E, 0x1111,
	0x0032, 0x1111,
	0x0026, 0x0040,
	0x002C, 0x09CF,
...
static kal_uint16 addr_data_pair_capture_30fps_n8_hi846_ly[] = {
	0x002E, 0x1111,
	0x0032, 0x1111,
	0x0026, 0x0040,
	0x002C, 0x09CF,
...
static void capture_setting(kal_uint16 currefps)
{
	...
	if (currefps == 300) {
	n8_hi846_ly_table_write_cmos_sensor(
		addr_data_pair_capture_30fps_n8_hi846_ly,
		sizeof(addr_data_pair_capture_30fps_n8_hi846_ly) /
		sizeof(kal_uint16));
	} else {
	n8_hi846_ly_table_write_cmos_sensor(
		addr_data_pair_capture_fps_n8_hi846_ly,
		sizeof(addr_data_pair_capture_fps_n8_hi846_ly) /
		sizeof(kal_uint16));
	}
#else
	if (currefps == 300) {
...
#if MULTI_WRITE
static kal_uint16 addr_data_pair_video_n8_hi846_ly[] = {
	0x002E, 0x1111,
	0x0032, 0x1111,
	0x0026, 0x0040,
	0x002C, 0x09CF,
...
#if MULTI_WRITE
	n8_hi846_ly_table_write_cmos_sensor(
		addr_data_pair_video_n8_hi846_ly,
		sizeof(addr_data_pair_video_n8_hi846_ly) /
		sizeof(kal_uint16));
#else
	  //Sensor Information////////////////////////////
	  //Sensor		: Hi-846
...
#if MULTI_WRITE
static kal_uint16 addr_data_pair_hs_video_n8_hi846_ly[] = {
	0x002E, 0x7711,
	0x0032, 0x7711,
	0x0026, 0x0148,
	0x002C, 0x08C7,
...
#if MULTI_WRITE
	n8_hi846_ly_table_write_cmos_sensor(
		addr_data_pair_hs_video_n8_hi846_ly,
		sizeof(addr_data_pair_hs_video_n8_hi846_ly) /
		sizeof(kal_uint16));
#else
...
#if MULTI_WRITE
static kal_uint16 addr_data_pair_slim_video_n8_hi846_ly[] = {
	0x002E, 0x3311,
	0x0032, 0x3311,
	0x0026, 0x0238,
	0x002C, 0x07D7,
...
#if MULTI_WRITE
	n8_hi846_ly_table_write_cmos_sensor(
		addr_data_pair_slim_video_n8_hi846_ly,
		sizeof(addr_data_pair_slim_video_n8_hi846_ly) /
		sizeof(kal_uint16));
#else
	//Sensor Information////////////////////////////
	//Sensor	  : Hi-846
...
static struct stCAM_CAL_DATAINFO_STRUCT hi846_ly_eeprom_data ={
	.sensorID= N8_HI846_LY_SENSOR_ID,
	.deviceID = 0x02,
	.dataLength = 0x075E,
	.sensorVendorid = 0x18020300,
	.vendorByte = {0,1,2,3},
	.dataBuffer = NULL,
};

#if MULTI_WRITE
kal_uint16 addr_data_pair_init_otp_n8_hi846_ly[] = {
	0x0A00, 0x0000,          
	0x2000, 0x0000,
	0x2002, 0x00FF,
	0x2004, 0x0000,
...
static kal_int32 hi846_ly_get_sensor_otp_info(struct stCAM_CAL_DATAINFO_STRUCT*pData)
{
	...
	#if MULTI_WRITE
	n8_hi846_ly_table_write_cmos_sensor(
		addr_data_pair_init_otp_n8_hi846_ly,
		sizeof(addr_data_pair_init_otp_n8_hi846_ly) /
		sizeof(kal_uint16));
	mdelay(1);
	#else
	write_cmos_sensor(0x0A00, 0x0000);			
...
static void hi846_ly_apply_awb_otp_info(struct stCAM_CAL_DATAINFO_STRUCT*pData){
	kal_uint16 R_unit = 0;
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
		...
		do {
			*sensor_id = return_sensor_id()+1;
			if (*sensor_id == imgsensor_info.sensor_id) {
				...
				//Type Bug431177 + , chenshengqian.wt, modify, 2019.03.14, otp funtion, multi cam compatibility
				ret = hi846_ly_get_sensor_otp_info(&hi846_ly_eeprom_data);
				if(ret < 0) {
					LOG_INF("get eeprom data failed, ret=%d, datalength=%d\n", ret, hi846_ly_eeprom_data.dataLength);
					*sensor_id = 0xFFFFFFFF;
					return ERROR_SENSOR_CONNECT_FAIL;
				} else {
					LOG_INF("get eeprom data success\n");
					imgSensorSetEepromData(&hi846_ly_eeprom_data);
				}
				//Type Bug431177 - , chenshengqian.wt, modify, 2019.03.14, otp funtion, multi cam compatibility
				return ERROR_NONE;
			}
	...
	if (*sensor_id != imgsensor_info.sensor_id) {
		LOG_INF("Read id fail, sensor id: 0x%x not match 0x%x\n", *sensor_id, imgsensor_info.sensor_id);
		*sensor_id = 0xFFFFFFFF;
		return ERROR_SENSOR_CONNECT_FAIL;
	}
	return ERROR_NONE;
...
static kal_uint32 open(void)
{
	...
	hi846_ly_apply_awb_otp_info(&hi846_ly_eeprom_data);
	//Type Bug431177 - , chenshengqian.wt, modify, 2019.03.14, otp funtion, multi cam compatibilit
