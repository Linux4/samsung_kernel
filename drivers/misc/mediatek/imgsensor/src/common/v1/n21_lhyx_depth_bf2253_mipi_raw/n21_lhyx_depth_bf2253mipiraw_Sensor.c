 ...
 * Filename:
 * ---------
 *     n21_lhyx_depth_bf2253mipi_Sensor.c
 *
 * Project:
 * --------
 *     ALPS
...
#include "n21_lhyx_depth_bf2253mipiraw_Sensor.h"

/************************** Modify Following Strings for Debug **************************/
#define PFX "n21_lhyx_depth_bf2253_camera_sensor"
#define LOG_1 LOG_INF("N21_LHYX_DEPTH_BF2253, MIPI 1LANE\n")
/****************************   Modify end    *******************************************/

#define LOG_INF(format, args...)    pr_err(PFX "[%s] " format, __func__, ##args)

static DEFINE_SPINLOCK(imgsensor_drv_lock);
kal_bool N21_LHYX_DEPTH_BF2253DuringTestPattern = KAL_FALSE;

static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = N21_LHYX_DEPTH_BF2253_SENSOR_ID,
...
static kal_uint32 open(void)
{
	...
	spin_unlock(&imgsensor_drv_lock);
	N21_LHYX_DEPTH_BF2253DuringTestPattern = KAL_FALSE;
	return ERROR_NONE;
}
