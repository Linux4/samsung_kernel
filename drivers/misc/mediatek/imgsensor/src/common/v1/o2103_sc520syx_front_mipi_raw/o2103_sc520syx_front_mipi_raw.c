...
#include "o2103_sc520syx_front_mipi_raw.h"

#define PFX "o2103_sc520syx_front_mipi_raw"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = O2103_SC520SYX_FRONT_SENSOR_ID,
	...
	.pre = {
		...
		.max_framerate = 300,
		.mipi_pixel_rate = 182400000, //(912M*2/10)
	},
	.cap = {
		.pclk = 90000000,
		.linelength = 1500,
...
static void sensor_init(void)
{
	...
	write_cmos_sensor8(0x301f,0x05);
...
static kal_uint32 open(void)
{
	...
	LOG_INF("preview  2592*1944@30fps,912Mbp/lane;"
