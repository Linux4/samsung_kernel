 ...
 * Filename:
 * ---------
 *	 N21_HLT_MAIN_N21_HLT_MAIN_OV16B10_Sensor.h
 *
 * Project:
 * --------
 *	 ALPS
 ...
 *
 ****************************************************************************/
#ifndef _N21_HLT_MAIN_N21_HLT_MAIN_OV16B10MIPI_SENSOR_H
#define _N21_HLT_MAIN_N21_HLT_MAIN_OV16B10MIPI_SENSOR_H
...
extern bool read_n21_hlt_main_ov16b10_eeprom(kal_uint16 addr, BYTE *data, kal_uint32 size);

extern int iBurstWriteReg_multi(u8 *pData, u32 bytes,
		u16 i2cId, u16 transfer_length, u16 timing);

#endif  /*_N21_HLT_MAIN_N21_HLT_MAIN_OV16B10MIPI_SENSOR_H*/
