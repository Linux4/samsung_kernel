...
#include "n26_sc501cs_front_ly_mipi_raw_Sensor.h"
...
static struct imgsensor_info_struct imgsensor_info = {
    .sensor_id = N26_SC501CS_FRONT_LY_SENSOR_ID,
    ...
    .slim_video = {
     ...
     .isp_driving_current = ISP_DRIVING_2MA,// bug727089, liangyiyi.wt, MODIFY, 2022/5/46, modify for solving the problem of RF interference
...
static kal_uint16 n26sc501csfrontly_table_write_cmos_sensor(
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_init_n26sc501csfrontly[] = {
     0x0103,0x01
};
#endif
...
static void sensor_init(void)
{
     ...
     n26sc501csfrontly_table_write_cmos_sensor(
         addr_data_pair_init_n26sc501csfrontly,
         sizeof(addr_data_pair_init_n26sc501csfrontly) /
         sizeof(kal_uint16));
#else
...
#if MULTI_WRITE
     n26sc501csfrontly_table_write_cmos_sensor(
         addr_data_pair_preview_n26sc501csfrontly,
...
static void capture_setting(kal_uint16 currefps)
{
     ...
     if (currefps == 300) {
     n26sc501csfrontly_table_write_cmos_sensor(
         addr_data_pair_capture_30fps_n26sc501csfrontly,
         sizeof(addr_data_pair_capture_30fps_n26sc501csfrontly) /
         sizeof(kal_uint16));
     } else {
     n26sc501csfrontly_table_write_cmos_sensor(
         addr_data_pair_capture_fps_n26sc501csfrontly,
         sizeof(addr_data_pair_capture_fps_n26sc501csfrontly) /
         sizeof(kal_uint16));
     }
#else
     if (currefps == 300) {
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_hs_video_n26sc501csfrontly[] = {
    0x0103,0x01,
    0x0100,0x00,
    0x36e9,0x80,
    0x37f9,0x80,
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_slim_video_n26sc501csfrontly[] = {
    0x0103,0x01,
    0x0100,0x00,
    0x36e9,0x80,
    0x37f9,0x80,
...
#if MULTI_WRITE
    n26sc501csfrontly_table_write_cmos_sensor(
        addr_data_pair_slim_video_n26sc501csfrontly,
        sizeof(addr_data_pair_slim_video_n26sc501csfrontly) /
        sizeof(kal_uint16));
#else
     write_cmos_sensor8(0x0103,0x01);
     mdelay(10);
...
static struct stCAM_CAL_DATAINFO_STRUCT n26sc501csfrontly_eeprom_data ={
    .sensorID= N26_SC501CS_FRONT_LY_SENSOR_ID,
    .deviceID = 0x02,
    .dataLength = 0x0766,
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
    ...
    while (imgsensor_info.i2c_addr_table[i] != 0xff) {
        ...
        do {
            *sensor_id = return_sensor_id();
			...
			n26sc501csfrontly_eeprom_data.dataBuffer = kmalloc(n26sc501csfrontly_eeprom_data.dataLength, GFP_KERNEL);
			if (n26sc501csfrontly_eeprom_data.dataBuffer == NULL) {
				LOG_INF("n26sc501csfrontly_eeprom_data->dataBuffer is malloc fail\n");
				return -EFAULT;
			}

			memcpy(n26sc501csfrontly_eeprom_data.dataBuffer, (u8 *)&sc501cs_data_info, MODULE_INFO_SIZE);
			memcpy(n26sc501csfrontly_eeprom_data.dataBuffer+MODULE_INFO_SIZE, (u8 *)&sc501cs_data_awb, AWB_DATA_SIZE);
			memcpy(n26sc501csfrontly_eeprom_data.dataBuffer+MODULE_INFO_SIZE+AWB_DATA_SIZE, (u8 *)&sc501cs_data_lsc, LSC_DATA_SIZE);

			imgSensorSetEepromData(&n26sc501csfrontly_eeprom_data);
		}
		//+bug682590,zhanghengyuan.wt,ADD,2022/2/18, n26 sc501cs front xl porting otp
#endif
    ...
    if (*sensor_id != imgsensor_info.sensor_id) {
        pr_err("n26sc501csfrontly Read id fail,sensor id: 0x%x", *sensor_id);
        *sensor_id = 0xFFFFFFFF;
        return ERROR_SENSOR_CONNECT_FAIL;
    }
    return ERROR_NONE;
