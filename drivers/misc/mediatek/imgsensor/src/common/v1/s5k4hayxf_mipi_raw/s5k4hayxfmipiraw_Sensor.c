...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = S5K4HAYXF_SENSOR_ID1,
...
static void set_max_framerate(UINT16 framerate, kal_bool min_framelength_en)
{
	...
	LOG_DBG("framerate = %d, min_framelength_en=%d", framerate, min_framelength_en);
	frame_length = imgsensor.pclk / framerate * 10 / imgsensor.line_length;
	LOG_DBG("frame_length =%d", frame_length);
...
static kal_uint16 s5k4hayxf_init_setting[] = {
	0x0100, 0x00,
	0x0A02, 0x7F,
	0x3B45, 0x01,
	0x3264, 0x01,
...
static kal_uint16 s5k4hayxf_preview_setting[] = {
	/* Clock Setting */
	0x0136, 0x1A,
	0x0137, 0x00,
	0x0301, 0x04,
...
static kal_uint16 s5k4hayxf_cap_setting[] = {
	/* Clock Setting */
	0x0136, 0x1A,
	0x0137, 0x00,
	0x0301, 0x04,
...
static kal_uint16 s5k4hayxf_normal_video_setting[] = {
	/* Clock Setting */
	0x0136, 0x1A,
	0x0137, 0x00,
	0x0301, 0x04,
...
static kal_uint16 s5k4hayxf_hs_video_setting[] = {
	/* Clock Setting */
	0x0136, 0x1A,
	0x0137, 0x00,
	0x0301, 0x04,
...
static kal_uint16 s5k4hayxf_slim_video_setting[] = {
	/* Clock Setting */
	0x0136, 0x1A,
	0x0137, 0x00,
	0x0301, 0x04,
...
static kal_uint16 s5k4hayxf_custom1_setting[] = {
	0x0136, 0x1A,
	0x0137, 0x00,
	0x0301, 0x04,
	0x0305, 0x05,
...
static kal_uint16 s5k4hayxf_custom2_3_setting[] = {
	0x0136, 0x1A,
	0x0137, 0x00,
	0x0301, 0x04,
	0x0305, 0x05,
...
static kal_uint16 s5k4hayxf_custom4_setting[] = {
	0x0136, 0x1A,
	0x0137, 0x00,
	0x0301, 0x04,
	0x0305, 0x05,
...
static void sensor_init(void)
{
	...
	ret = table_write_cmos_sensor(s5k4hayxf_init_setting,
		sizeof(s5k4hayxf_init_setting) / sizeof(kal_uint16));
...
}				/*  s5k4hayxfMIPI_Sensor_Init  */


static void preview_setting(void)
{
	table_write_cmos_sensor(s5k4hayxf_preview_setting,
		sizeof(s5k4hayxf_preview_setting) / sizeof(kal_uint16));
}

static void capture_setting(kal_uint16 currefps)
{
	table_write_cmos_sensor(s5k4hayxf_cap_setting,
		sizeof(s5k4hayxf_cap_setting) / sizeof(kal_uint16));
}

static void normal_video_setting(kal_uint16 currefps)
{
	LOG_INF("E! currefps:%d", currefps);
	table_write_cmos_sensor(s5k4hayxf_normal_video_setting,
		sizeof(s5k4hayxf_normal_video_setting) / sizeof(kal_uint16));
}

static void hs_video_setting(void)
{
	LOG_INF("EVGA 120fps");
	table_write_cmos_sensor(s5k4hayxf_hs_video_setting,
		sizeof(s5k4hayxf_hs_video_setting) / sizeof(kal_uint16));
}

static void slim_video_setting(void)
{
	LOG_INF("E");
	table_write_cmos_sensor(s5k4hayxf_slim_video_setting,
		sizeof(s5k4hayxf_slim_video_setting) / sizeof(kal_uint16));
}

static void custom1_setting(void)
{
	LOG_INF("E");
	table_write_cmos_sensor(s5k4hayxf_custom1_setting,
		sizeof(s5k4hayxf_custom1_setting) / sizeof(kal_uint16));
}

static void custom2_setting(void)
{
	LOG_INF("E");
	table_write_cmos_sensor(s5k4hayxf_custom2_3_setting,
		sizeof(s5k4hayxf_custom2_3_setting) / sizeof(kal_uint16));
}
...
{
	LOG_INF("E");
	table_write_cmos_sensor(s5k4hayxf_custom4_setting,
		sizeof(s5k4hayxf_custom4_setting) / sizeof(kal_uint16));
}
...
static kal_uint32 open(void)
{
	...
	LOG_INF("imgsensor.enable_secure %d", imgsensor.enable_secure);
	LOG_INF("MIPI 4LANE, 671Mbps/lane");
				  ...
				  UINT8 *feature_para, UINT32 *feature_para_len)
{
	...
	case SENSOR_FEATURE_SET_FRAMERATE:
		...
		// LOG_INF("ihdr enable :%d", *feature_data_16);
		// spin_lock(&imgsensor_drv_lock);
...
bool s5k4hayxf_select_otp_page(unsigned int page)
{
...
void s5k4hayxf_otp_off_setting()
{
	write_cmos_sensor_8(0x0A00, 0x04);
	write_cmos_sensor_8(0x0A00, 0x00);
}

int s5k4hayxf_read_otp_cal(unsigned int addr, unsigned char *data, unsigned int size)
{
	...
	msleep(50);
	s5k4hayxf_select_otp_page(17);
	bank = read_cmos_sensor_8(PAGE_START_ADDR);

	if (bank >= BANK_PAGE_SIZE || bank_page[bank] == -1) {
		LOG_ERR("[%s] Invalid bank data %d", __func__, bank);
		s5k4hayxf_otp_off_setting();
		return -1;
	}

	LOG_INF("[%s] otp bank: %d", __func__, bank);
	otp_page = bank_page[bank];

	if (!s5k4hayxf_select_otp_page(otp_page)) {
		LOG_ERR("[%s] Failed to select OTP bank page: %d", __func__, otp_page);
		s5k4hayxf_otp_off_setting();
		return -1;
	}
	...
	for (i = 0; i < size; i++) {
		if (otp_addr > PAGE_END_ADDR) {
			s5k4hayxf_select_otp_page(++otp_page);
