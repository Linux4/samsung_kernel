...
static struct imgsensor_info_struct imgsensor_info = {
	...
	.pre = {
		...
		.max_framerate = 300,
		.mipi_pixel_rate = 227200000,//bug 612420,zhanghao2.wt,add,2021/2/20,add dual camera custom1 mode
	},
	...
	.cap = {
		...
		/*	 following for GetDefaultFramerateByScenario()	*/
		.max_framerate = 300,
		//.mipi_pixel_rate = 480000000, //bug 621172,zhanghao2.wt,add,2021/5/24,fix after-sale cablibration preview fail
	},
	...
	.cap1 = {							//capture for PIP 15ps relative information, capture1 mode must use same framelength, linelength with Capture mode for shutter calculate
		...
		/*	 following for GetDefaultFramerateByScenario()	*/
		.max_framerate = 150,
		.mipi_pixel_rate = 480000000,//bug 612420,zhanghao2.wt,add,2021/2/20,add dual camera custom1 mode
	},
	...
	.hs_video = {
		...
		/*	 following for GetDefaultFramerateByScenario()	*/
		.max_framerate = 1200,
		.mipi_pixel_rate = 74400000,//bug 612420,zhanghao2.wt,add,2021/2/20,add dual camera custom1 mode
	},
	.slim_video = {
		.pclk = 480000000,				//record different mode's pclk
		.linelength  = 4896,//5808,				//record different mode's linelength
		...
		/*	 following for GetDefaultFramerateByScenario()	*/
		.max_framerate = 300,
		.mipi_pixel_rate = 208000000,//bug 612420,zhanghao2.wt,add,2021/2/20,add dual camera custom1 mode
	},
    ...
    .custom1 = {
        ...
        /*   following for GetDefaultFramerateByScenario()  */
        .max_framerate = 240,
	.mipi_pixel_rate = 320000000,//bug 612420,zhanghao2.wt,add,2021/2/20,add dual camera custom1 mode
    },
 ...
 //for 3l6
{
    ...
    .i4SubBlkW =16,
    .i4SubBlkH =16,
    //+bug 612420,huangguoyong.wt,add,2021/01/27,add for s5k3l6 pdaf bring up
