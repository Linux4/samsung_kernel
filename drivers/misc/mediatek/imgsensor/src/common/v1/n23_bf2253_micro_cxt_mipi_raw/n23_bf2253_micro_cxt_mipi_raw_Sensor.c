...
#include "n23_bf2253_micro_cxt_mipi_raw_Sensor.h"


/****************************Modify Following Strings for Debug****************************/
#define PFX "n23_bf2253_micro_cxt_mipi_raw"
#define LOG_1 LOG_INF("W1_BF2253_MICRO_CXT, MIPI 1LANE\n")
/****************************   Modify end    *******************************************/
...
#define EEPROM_GT24P64M_ID 0xA4
...
kal_bool N23_BF2253_MICRO_CXTDuringTestPattern = KAL_FALSE;

static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = N23_BF2253_MICRO_CXT_SENSOR_ID,
...
static void sensor_init(void)
{
	...
	write_cmos_sensor(0x00,0x2e);//mirror on/flip on    //+bug584789,zhanghengyuan.wt,MODIFY,2020/12/30,depth bf2253 mirror
...
static struct stCAM_CAL_DATAINFO_STRUCT n23_bf2253_micro_cxt_eeprom_data ={
	.sensorID= N23_BF2253_MICRO_CXT_SENSOR_ID,
	.deviceID = 0x08,	//bug 682590, zhanghao2.wt, modify, 2021/8/27, fix otp data not correct.
	.dataLength =  0x0778,
	.sensorVendorid = 0x16020000,
	.vendorByte = {1,2,3,4},
	.dataBuffer = NULL,
};
static struct stCAM_CAL_CHECKSUM_STRUCT n23_bf2253_micro_cxt_checksum[8] =
{
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
	...
	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
		...
		do {
			*sensor_id = return_sensor_id();
			pr_info("n23_bf2253_micro_cxt read id success, depth sensor id:%x\n",*sensor_id);
			if (*sensor_id == imgsensor_info.sensor_id) {
				size = imgSensorReadEepromData(&n23_bf2253_micro_cxt_eeprom_data,n23_bf2253_micro_cxt_checksum);
				if((size != n23_bf2253_micro_cxt_eeprom_data.dataLength) || ((n23_bf2253_micro_cxt_eeprom_data.sensorVendorid >> 24)!= read_eeprom(0x0001))) {
					pr_err("n23_bf2253_micro_cxt get eeprom data failed\n");
					if(n23_bf2253_micro_cxt_eeprom_data.dataBuffer != NULL) {
						kfree(n23_bf2253_micro_cxt_eeprom_data.dataBuffer);
						n23_bf2253_micro_cxt_eeprom_data.dataBuffer = NULL;
					}
					*sensor_id = 0xFFFFFFFF;
					return ERROR_SENSOR_CONNECT_FAIL;
				} else {
					pr_info("get eeprom data success\n");
					imgSensorSetEepromData(&n23_bf2253_micro_cxt_eeprom_data);
				}
	...
	if (*sensor_id != imgsensor_info.sensor_id) {
		...
		*sensor_id = 0xFFFFFFFF;
		pr_err("1st dualcam sensor id error,depth sensor id:%x\n",*sensor_id);
		return ERROR_SENSOR_CONNECT_FAIL;
	}
	//-bug604664 chenbocheng.wt, add, 2021/01/13, distinguish depth camera params for dualcam
	return ERROR_NONE;
...
static kal_uint32 open(void)
{
	...
	spin_unlock(&imgsensor_drv_lock);
	N23_BF2253_MICRO_CXTDuringTestPattern = KAL_FALSE;
	return ERROR_NONE;
}
