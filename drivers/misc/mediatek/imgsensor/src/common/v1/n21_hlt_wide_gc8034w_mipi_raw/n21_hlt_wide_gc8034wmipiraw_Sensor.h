 ...
 * Filename:
 * ---------
 *     n21_hlt_wide_gc8034wmipi_Sensor.h
 *
 * Project:
 * --------
 *     ALPS
 ...
 *
 ****************************************************************************/
#ifndef __N21_HLT_WIDE_GC8034WMIPI_SENSOR_H__
#define __N21_HLT_WIDE_GC8034WMIPI_SENSOR_H__

#define FULLSIZE_PREVIEW    0

/* SENSOR MIRROR FLIP INFO */
#define N21_HLT_WIDE_GC8034W_MIRROR_FLIP_ENABLE         0
#if N21_HLT_WIDE_GC8034W_MIRROR_FLIP_ENABLE
#define N21_HLT_WIDE_GC8034W_MIRROR		  0xc3
#define N21_HLT_WIDE_GC8034W_BIN_STARTY	  0x04
#define N21_HLT_WIDE_GC8034W_BIN_STARTX	  0x05
#define N21_HLT_WIDE_GC8034W_FULL_STARTY	  0x08
#define N21_HLT_WIDE_GC8034W_FULL_STARTX	  0x0b
#else
#define N21_HLT_WIDE_GC8034W_MIRROR		  0xc0
#define N21_HLT_WIDE_GC8034W_BIN_STARTY	  0x04
#define N21_HLT_WIDE_GC8034W_BIN_STARTX	  0x05
#define N21_HLT_WIDE_GC8034W_FULL_STARTY	  0x08
#define N21_HLT_WIDE_GC8034W_FULL_STARTX	  0x09
#endif
...
/* SENSOR OTP INFO */
#define N21_HLT_WIDE_GC8034WOTP_FOR_CUSTOMER       0
/* Please do not enable the following micro definition, if you are not debuging otp function*/
#define N21_HLT_WIDE_GC8034WOTP_DEBUG              0

#define DD_WIDTH                     3284
#define DD_HEIGHT                    2464
#define N21_HLT_WIDE_GC8034W_OTP_ID_SIZE           9
#define N21_HLT_WIDE_GC8034W_OTP_ID_DATA_OFFSET    0x0010
...
struct n21_hlt_wide_gc8034w_dd_t {
	kal_uint16 x;
	kal_uint16 y;
	kal_uint16 t;
};

struct n21_hlt_wide_gc8034w_otp_t {
	kal_uint8 otp_id[N21_HLT_WIDE_GC8034W_OTP_ID_SIZE];
	kal_uint8  dd_cnt;
	kal_uint8  dd_flag;
	struct n21_hlt_wide_gc8034w_dd_t dd_param[160];
	kal_uint8  reg_flag;
	kal_uint8  reg_num;
