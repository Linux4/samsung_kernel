...
#include "n8_gc2375h_hlt_mipi_raw.h"

/****************************Modify Following Strings for Debug****************************/
#define PFX "n8_gc2375h_hlt_camera_sensor"
#define LOG_1 LOG_INF("N8_GC2375H_HLT, MIPI 1LANE\n")
/****************************   Modify end    *******************************************/

#define LOG_INF(format, args...)    pr_err(PFX "[%s] " format, __func__, ##args)

static DEFINE_SPINLOCK(imgsensor_drv_lock);
kal_bool N8_GC2375H_HLTDuringTestPattern = KAL_FALSE;

#define MULTI_WRITE 1

static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = N8_GC2375H_HLT_MIPI_SENSOR_ID, /* record sensor id defined in Kd_imgsensor.h */
	...
	.pre = {
		...
		.framelength = 1240,//VB 0x10  30fps
		...
		.mipi_pixel_rate = 62400000,//bug 612420,zhanghao2.wt,add,2021/2/20,add dual camera custom1 mode
...
static kal_uint8 n8_gc2375h_hlt_table_write_cmos_sensor(
...
static kal_uint16 set_gain(kal_uint16 gain)
{
	...
	if ((ANALOG_GAIN_1 <= iReg) && (iReg < ANALOG_GAIN_2)) {
		...
		LOG_INF("N8_GC2375H_HLTMIPI analogic gain 1x, N8_GC2375H_HLTMIPI add pregain = %d\n", temp);
		...
		write_cmos_sensor(0xb1, temp >> 6);
		write_cmos_sensor(0xb2, (temp << 2) & 0xfc);
		LOG_INF("N8_GC2375H_HLTMIPI analogic gain 1.43x , N8_GC2375H_HLTMIPI add pregain = %d\n", temp);
		...
		write_cmos_sensor(0xb1, temp >> 6);
		write_cmos_sensor(0xb2, (temp << 2) & 0xfc);
		LOG_INF("N8_GC2375H_HLTMIPI analogic gain 2x , N8_GC2375H_HLTMIPI add pregain = %d\n", temp);
		...
		write_cmos_sensor(0xb1, temp >> 6);
		write_cmos_sensor(0xb2, (temp << 2) & 0xfc);
		LOG_INF("N8_GC2375H_HLTMIPI analogic gain 2.84x , N8_GC2375H_HLTMIPI add pregain = %d\n", temp);
		...
		write_cmos_sensor(0xb1, temp >> 6);
		write_cmos_sensor(0xb2, (temp << 2) & 0xfc);
		LOG_INF("N8_GC2375H_HLTMIPI analogic gain 3.97x , N8_GC2375H_HLTMIPI add pregain = %d\n", temp);
		...
		write_cmos_sensor(0xb1, temp >> 6);
		write_cmos_sensor(0xb2, (temp << 2) & 0xfc);
		LOG_INF("N8_GC2375H_HLTMIPI analogic gain 5.68x , N8_GC2375H_HLTMIPI add pregain = %d\n", temp);
		...
		write_cmos_sensor(0xb1, temp >> 6);
		write_cmos_sensor(0xb2, (temp << 2) & 0xfc);
		LOG_INF("N8_GC2375H_HLTMIPI analogic gain 8.14x , N8_GC2375H_HLTMIPI add pregain = %d\n", temp);
		...
		write_cmos_sensor(0xb1, temp >> 6);
		write_cmos_sensor(0xb2, (temp << 2) & 0xfc);
		LOG_INF("N8_GC2375H_HLTMIPI analogic gain 11.34x , N8_GC2375H_HLTMIPI add pregain = %d\n", temp);
	} else {
		write_cmos_sensor(0x20, 0x0c);
		write_cmos_sensor(0x22, 0x0e);
		write_cmos_sensor(0x26, 0x0e);
		...
		write_cmos_sensor(0xb1, temp >> 6);
		write_cmos_sensor(0xb2, (temp << 2) & 0xfc);
		LOG_INF("N8_GC2375H_HLTMIPI analogic gain 16.23x , N8_GC2375H_HLTMIPI add pregain = %d\n", temp);
	}
	return gain;
}
...
#if MULTI_WRITE
kal_uint8 addr_data_pair_init_n8_gc2375h_hlt[] = {
	0xfe, 0x00,
	0xfe, 0x00,
	0xfe, 0x00,
	0xf7, 0x01,
...
static void sensor_init(void)
{
	LOG_INF("E");
#if MULTI_WRITE
	n8_gc2375h_hlt_table_write_cmos_sensor(
		addr_data_pair_init_n8_gc2375h_hlt,
		sizeof(addr_data_pair_init_n8_gc2375h_hlt) /
		sizeof(kal_uint8));
#else
	/* System */
	write_cmos_sensor(0xfe, 0x00);
	...
	write_cmos_sensor(0x17, N8_GC2375H_HLT_MIRROR);
	...
	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
		...
		do {
			*sensor_id = return_sensor_id();
			...
			pr_err("qhq gc2375 i2c write sensor id : 0x%x\n", *sensor_id);
...
static kal_uint32 open(void)
{
	...
	spin_unlock(&imgsensor_drv_lock);
	N8_GC2375H_HLTDuringTestPattern = KAL_FALSE;
