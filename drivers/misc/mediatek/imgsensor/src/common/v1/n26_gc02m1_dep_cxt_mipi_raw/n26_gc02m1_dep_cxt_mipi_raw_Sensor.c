 ...
 * Filename:
 * ---------
 *     n26_gc02m1_dep_cxt_mipi_raw_Sensor.c
 *
 * Project:
 * --------
 *     ALPS
...
#include "n26_gc02m1_dep_cxt_mipi_raw_Sensor.h"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = N26_GC02M1_DEP_CXT_SENSOR_ID,
...
static void set_shutter_frame_length(kal_uint16 shutter, kal_uint16 frame_length)
{
	...
	LOG_INF("[lj gc02m1] shutter =%d, framelength =%d/%d, dummy_line=%d, \n", shutter,
