...
#include "gc2375h_cxtmipi_Sensor.h"

/************************** Modify Following Strings for Debug **************************/
#define PFX "gc2375h_cxt_camera_sensor"
#define LOG_1 LOG_INF("GC2375H_CXT, MIPI 1LANE\n")
/****************************   Modify end    *******************************************/

#define LOG_INF(format, args...)    pr_debug(PFX "[%s] " format, __func__, ##args)

static DEFINE_SPINLOCK(imgsensor_drv_lock);
kal_bool GC2375H_CXTDuringTestPattern = KAL_FALSE;

/* hs03s code for CAM-AL5625-01-247 by lisizhou at 2021/05/24 start */
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = GC2375H_CXT_SENSOR_ID,
...
#if GC2375H_CXT_MIRROR_FLIP_ENABLE
...
static void sensor_init(void)
{
	...
	write_cmos_sensor(0x17, GC2375H_CXT_MIRROR);
	...
	write_cmos_sensor(0x4e, GC2375H_CXT_BLK_Select1_H);
	write_cmos_sensor(0x4f, GC2375H_CXT_BLK_Select1_L);
	write_cmos_sensor(0x66, GC2375H_CXT_BLK_Select2_H);
	write_cmos_sensor(0x67, GC2375H_CXT_BLK_Select2_L);
...
static kal_uint32 open(void)
{
	...
	spin_unlock(&imgsensor_drv_lock);
	GC2375H_CXTDuringTestPattern = KAL_FALSE;
	return ERROR_NONE;
}
