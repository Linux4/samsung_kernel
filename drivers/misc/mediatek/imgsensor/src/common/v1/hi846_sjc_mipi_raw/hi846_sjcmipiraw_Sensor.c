...
#include "hi846_sjcmipiraw_Sensor.h"

#define PFX "hi846_sjc_camera_sensor"
...
static struct imgsensor_info_struct imgsensor_info = {
	...
	.pre = {
		...
		.max_framerate = 300,
		.mipi_pixel_rate = 278400000, //(696M*4/10)
	},
	.cap = {
		.pclk = 288000000,
		.linelength = 3800,
...
static kal_uint16 hi846_sjc_table_write_cmos_sensor(
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_init_hi846_sjc[] = {
	0x0066, 0x0101,
	0x2000, 0x98E8,
	0x2002, 0x00FF,
	0x2004, 0x0006,
...
{
#if MULTI_WRITE
	hi846_sjc_table_write_cmos_sensor(
		addr_data_pair_init_hi846_sjc,
		sizeof(addr_data_pair_init_hi846_sjc) /
		sizeof(kal_uint16));
#else
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_preview_hi846_sjc[] = {
	//Sensor Information////////////////////////////
	//Sensor	  : Hi-846
	//Date		  : 2021-02-02
...
#if MULTI_WRITE
	hi846_sjc_table_write_cmos_sensor(
		addr_data_pair_preview_hi846_sjc,
		sizeof(addr_data_pair_preview_hi846_sjc) /
		sizeof(kal_uint16));
#else
	LOG_INF("E1 preview\n");
#endif
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_capture_fps_hi846_sjc[] = {
	//Sensor Information////////////////////////////
	//Sensor	  : Hi-846
	//Date		  : 2021-02-02
	//Image size	  : 3264x2448
...
kal_uint16 addr_data_pair_capture_30fps_hi846_sjc[] = {
	//Sensor Information////////////////////////////
	//Sensor	  : Hi-846
	//Date		  : 2021-02-02
	//Image size	  : 3264x2448
...
static void capture_setting(kal_uint16 currefps)
{
	...
	if (currefps == 300) {
	hi846_sjc_table_write_cmos_sensor(
		addr_data_pair_capture_30fps_hi846_sjc,
		sizeof(addr_data_pair_capture_30fps_hi846_sjc) /
		sizeof(kal_uint16));
	} else {
	hi846_sjc_table_write_cmos_sensor(
		addr_data_pair_capture_fps_hi846_sjc,
		sizeof(addr_data_pair_capture_fps_hi846_sjc) /
		sizeof(kal_uint16));
	}
#else
	LOG_INF("E1 capture_setting\n");
#endif
}


#if MULTI_WRITE
kal_uint16 addr_data_pair_video_hi846_sjc[] = {
	//Sensor Information////////////////////////////
	//Sensor	  : Hi-846
	//Date		  : 2021-02-02
	//Image size	  : 3264x2448
...
#if MULTI_WRITE
	hi846_sjc_table_write_cmos_sensor(
		addr_data_pair_video_hi846_sjc,
		sizeof(addr_data_pair_video_hi846_sjc) /
		sizeof(kal_uint16));
#else
	LOG_INF("E1 normal_video_setting\n");
#endif
}


#if MULTI_WRITE
kal_uint16 addr_data_pair_hs_video_hi846_sjc[] = {
	//Sensor Information////////////////////////////
	//Sensor	  : Hi-846
	//Date		  : 2021-02-02
	//Image size	  : 3264x2448
...
#if MULTI_WRITE
	hi846_sjc_table_write_cmos_sensor(
		addr_data_pair_hs_video_hi846_sjc,
		sizeof(addr_data_pair_hs_video_hi846_sjc) /
		sizeof(kal_uint16));
#else
	LOG_INF("E1 hs_video_setting\n");
#endif
}

#if MULTI_WRITE
kal_uint16 addr_data_pair_slim_video_hi846_sjc[] = {
	//Sensor Information////////////////////////////
	//Sensor	  : Hi-846
	//Date		  : 2021-02-02
	//Image size	  : 3264x2448
...
#if MULTI_WRITE
	hi846_sjc_table_write_cmos_sensor(
		addr_data_pair_slim_video_hi846_sjc,
		sizeof(addr_data_pair_slim_video_hi846_sjc) /
		sizeof(kal_uint16));
#else
	LOG_INF("E1 slim_video_setting\n");
#endif
}
