...
#include "gc5035lymipi_Sensor.h"

/**************** Modify Following Strings for Debug ******************/
#define PFX "gc5035_ly_camera_sensor"
...
{       
	...
	printk("GC5035_LY  compatilbe=%0x ",module_id);
	write_cmos_sensor(0xf3, 0x00);
	return module_id;
}
