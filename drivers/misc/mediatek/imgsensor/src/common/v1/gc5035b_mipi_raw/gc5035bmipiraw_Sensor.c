...
#include "gc5035bmipiraw_Sensor.h"

/************************** Modify Following Strings for Debug **************************/
#define PFX "gc5035b_camera_sensor"
#define LOG_1 LOG_INF("GC5035BMIPI, 2LANE\n")
/****************************   Modify end	*******************************************/
#define GC5035B_DEBUG
#if defined(GC5035B_DEBUG)
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = GC5035B_SENSOR_ID1,	/*record sensor id defined in Kd_imgsensor.h*/
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[] = {
	...
	{ 2608, 1960,    0,    0, 2608, 1960, 2608, 1960,
	    16,   14, 2576, 1932,    0,    0, 2576, 1932 }, /*custom2 -NOT USED*/
	{ 2608, 1960,    0,    0, 2608, 1960, 2608, 1960,
	    16,   14, 2576, 1932,    0,    0, 2576, 1932 }, /*custom3 -NOT USED*/
	{ 2608, 1960,    0,    0, 2608, 1960, 2608, 1960,
	    16,   14, 2576, 1932,    0,    0, 2576, 1932 }, /*custom4 -NOT USED*/
	{ 2608, 1960,    0,    0, 2608, 1960, 2608, 1960,
	    16,   14, 2576, 1932,    0,    0, 2576, 1932 }, /*custom5 -NOT USED*/
};

static kal_uint8 gc5035b_init_setting[] = {
	0xfc, 0x01,
	0xf4, 0x40,
	0xf5, 0xe9,
	0xf6, 0x14,
...
static kal_uint8 gc5035b_preview_setting[] = {
	0xfc, 0x01,
	0xf4, 0x40,
	0xf5, 0xe9,
	0xf6, 0x14,
...
static kal_uint8 gc5035b_capture_setting[] = {
	0xfc, 0x01,
	0xf4, 0x40,
	0xf5, 0xe9,
	0xf6, 0x14,
...
static kal_uint8 gc5035b_normal_video_setting[] = { // NOT USED
	0xfc, 0x01,
	0xf4, 0x40,
	0xf5, 0xe9,
	0xf6, 0x14,
...
static kal_uint8 gc5035b_custom1_setting[] = {
	0xfc, 0x01,
	0xf4, 0x40,
	0xf5, 0xe9,
	0xf6, 0x14,
...
static kal_uint8 gc5035b_custom2_setting[] = {
//NOT USED
};

static kal_uint8 gc5035b_custom3_setting[] = {
//NOT USED
};

static kal_uint8 gc5035b_custom4_setting[] = {
//NOT USED
};

static kal_uint8 gc5035b_custom5_setting[] = {
//NOT USED
};

static struct gc5035b_otp gc5035b_otp_data = { 0 };
...
static kal_uint8 gc5035b_otp_read_byte(kal_uint16 addr)
{
...
#if defined(GC5035B_OTP_CUSTOMER)
static void gc5035b_otp_read_group(kal_uint16 addr, kal_uint8 *data, kal_uint16 length)
{
	kal_uint16 i = 0;
...
static void gc5035b_otp_read_sensor_info(void)
{
	kal_uint8 flag_dd = 0;
	...
	/* DPC */
	flag_dd = gc5035b_otp_read_byte(DPC_FLAG_OFFSET);
	LOG_INF("flag_dd = 0x%x\n", flag_dd);
	switch (flag_dd & 0x03) {
	case 0x00:
		LOG_INF("DD is empty !!\n");
		gc5035b_otp_data.dd_flag = 0x00;
		break;
	case 0x01:
		LOG_INF("DD is valid!!\n");
		gc5035b_otp_data.dd_num = gc5035b_otp_read_byte(DPC_TOTAL_NUMBER_OFFSET)
						+ gc5035b_otp_read_byte(DPC_ERROR_NUMBER_OFFSET);
		gc5035b_otp_data.dd_flag = 0x01;
		LOG_INF("total_num = %d\n", gc5035b_otp_data.dd_num);
		break;
	case 0x02:
	case 0x03:
		LOG_INF("DD is invalid !!\n");
		gc5035b_otp_data.dd_flag = 0x02;
		break;
	default:
		break;
	}
	...
	/*Register Update*/
	gc5035b_otp_data.reg_flag = gc5035b_otp_read_byte(REG_INFO_FLAG_OFFSET);
	LOG_INF("Register value flag = 0x%x\n", gc5035b_otp_data.reg_flag);
	if ((gc5035b_otp_data.reg_flag & 0x03) == 0x01)
		for (i = 0; i < REG_INFO_SIZE; i++) {
			temp = gc5035b_otp_read_byte(REG_INFO_PAGE_OFFSET + REG_INFO_SIZE * 8 * i);
			for (j = 0; j < 2; j++) {
				if (((temp >> (4 * j + 3)) & 0x01) == 0x01) {// check
					gc5035b_otp_data.regs[gc5035b_otp_data.reg_num][0] =
						(temp >> (4 * j)) & 0x07;// page
					gc5035b_otp_data.regs[gc5035b_otp_data.reg_num][1] =
						gc5035b_otp_read_byte(REG_INFO_ADDR_OFFSET + REG_INFO_SIZE * 8 * i + 0x10 * j);
					gc5035b_otp_data.regs[gc5035b_otp_data.reg_num][2] =
						gc5035b_otp_read_byte(REG_INFO_VALUE_OFFSET + REG_INFO_SIZE * 8 * i + 0x10 * j);
					gc5035b_otp_data.reg_num++;
				}
			}
		}
}

static void gc5035b_otp_update_dd(void)
{
	kal_uint8 state = 0;
	kal_uint8 n = 0;

	if (gc5035b_otp_data.dd_flag == 0x01) {
		...
		write_cmos_sensor(0x01, (gc5035b_otp_data.dd_num >> 8) & 0x07);
		write_cmos_sensor(0x02, gc5035b_otp_data.dd_num & 0xff);
...
static void gc5035b_otp_update_reg(void)
{
	kal_uint8 i = 0;
	...
	if ((gc5035b_otp_data.reg_flag & 0x03) == 0x01) {
		for (i = 0; i < gc5035b_otp_data.reg_num; i++) {
			write_cmos_sensor(0xfe, gc5035b_otp_data.regs[i][0]);
			write_cmos_sensor(gc5035b_otp_data.regs[i][1], gc5035b_otp_data.regs[i][2]);
		}
	}
...
#if defined(GC5035B_OTP_CUSTOMER)
static void gc5035b_otp_read_module_info(void)
{
	...
	flag_module = gc5035b_otp_read_byte(MODULE_INFO_FLAG_OFFSET);
	...
	for (index = 0; index < 2; index++)
		...
		case 0x04:
			...
			gc5035b_otp_read_group(MODULE_INFO_OFFSET + MODULE_INFO_SIZE * 8 * index, &info[0], MODULE_INFO_SIZE);
			for (i = 0; i < 6; i++)
...
static void gc5035b_otp_read_wb_info(void)
{
	kal_uint8  flag_wb = 0;
	...
	flag_wb = gc5035b_otp_read_byte(WB_INFO_FLAG_OFFSET);
	...
	for (index = 0; index < 2; index++) {
		...
		case 0x00:
			...
			gc5035b_otp_data.wb_flag = gc5035b_otp_data.wb_flag | 0x00;
			break;
		case 0x04:
			LOG_INF("wb unit group %d is valid!!\n", index + 1);
			gc5035b_otp_read_group(WB_INFO_OFFSET + WB_INFO_SIZE * 8 * index, &wb[0], WB_INFO_SIZE);
			...
			if ((checkwb % 255 + 1) == wb[WB_INFO_SIZE - 1]) {
				gc5035b_otp_data.rg_gain = (wb[0] | ((wb[1] & 0xf0) << 4)) > 0 ?
					(wb[0] | ((wb[1] & 0xf0) << 4)) : 0x400;
				gc5035b_otp_data.bg_gain = (((wb[1] & 0x0f) << 8) | wb[2]) > 0 ?
					(((wb[1] & 0x0f) << 8) | wb[2]) : 0x400;
				gc5035b_otp_data.wb_flag = gc5035b_otp_data.wb_flag | 0x01;
			} else
		...
		case 0x0c:
			...
			gc5035b_otp_data.wb_flag = gc5035b_otp_data.wb_flag | 0x02;
			break;
		default:
			break;
		}
		...
		case 0x00:
			...
			gc5035b_otp_data.golden_flag = gc5035b_otp_data.golden_flag | 0x00;
			break;
		case 0x40:
			LOG_INF("wb golden group %d is valid!!\n", index + 1);
			gc5035b_otp_read_group(WB_GOLDEN_INFO_OFFSET + WB_GOLDEN_INFO_SIZE * 8 * index, &golden[0], WB_GOLDEN_INFO_SIZE);
			for (i = 0; i < 4; i++)
			...
			if ((checkgolden % 255 + 1) == golden[WB_GOLDEN_INFO_SIZE - 1]) {
				gc5035b_otp_data.golden_rg = (golden[0] | ((golden[1] & 0xf0) << 4)) > 0 ?
					(golden[0] | ((golden[1] & 0xf0) << 4)) : RG_TYPICAL;
				gc5035b_otp_data.golden_bg = (((golden[1] & 0x0f) << 8) | golden[2]) > 0 ?
					(((golden[1] & 0x0f) << 8) | golden[2]) : BG_TYPICAL;
				gc5035b_otp_data.golden_flag = gc5035b_otp_data.golden_flag | 0x01;
			} else
		...
		case 0xc0:
			...
			gc5035b_otp_data.golden_flag = gc5035b_otp_data.golden_flag | 0x02;
			break;
		default:
			break;
		}
...
static void gc5035b_otp_update_wb(void)
{
	...
	if (gc5035b_otp_data.golden_flag == 0x02)
		return;

	if ((gc5035b_otp_data.golden_flag & 0x01) == 0x01) {
		rg_typical = gc5035b_otp_data.golden_rg;
		bg_typical = gc5035b_otp_data.golden_bg;
		LOG_INF("golden_flag = %d, rg_typical = 0x%x, bg_typical = 0x%x\n",
			gc5035b_otp_data.golden_flag, rg_typical, bg_typical);
	} else {
	...
	if ((gc5035b_otp_data.wb_flag & 0x01) == 0x01) {
		r_gain_current = 2048 * rg_typical / gc5035b_otp_data.rg_gain;
		b_gain_current = 2048 * bg_typical / gc5035b_otp_data.bg_gain;
		g_gain_current = 2048;
...
static void gc5035b_otp_update(void)
{
	gc5035b_otp_update_dd();
#if defined(GC5035B_OTP_CUSTOMER)
	gc5035b_otp_update_wb();
#endif
	gc5035b_otp_update_reg();
}

static void gc5035b_otp_function(void)
{
	memset(&gc5035b_otp_data, 0, sizeof(gc5035b_otp_data));
...
static kal_uint16 set_gain(kal_uint16 gain)
{
	...
	kal_uint16 GC5035B_AGC_Param[MAX_GAIN_INDEX][2] = {
		{  256,  0 },
		{  302,  1 },
		{  358,  2 },
		{  425,  3 },
	...
	for (gain_index = E_GAIN_INDEX - 1; gain_index >= 0; gain_index--) {
		if (reg_gain >= GC5035B_AGC_Param[gain_index][0])
			break;
	}

	write_cmos_sensor(0xfe, 0x00);
	write_cmos_sensor(0xb6, GC5035B_AGC_Param[gain_index][1]);
	temp_gain = reg_gain * Dgain_ratio / GC5035B_AGC_Param[gain_index][0];
	write_cmos_sensor(0xb1, (temp_gain >> 8) & 0x0f);
	write_cmos_sensor(0xb2, temp_gain & 0xfc);
	LOG_INF("Exit! GC5035B_AGC_Param[gain_index][1] = 0x%x, temp_gain = 0x%x, reg_gain = %d\n",
		GC5035B_AGC_Param[gain_index][1], temp_gain, reg_gain);
...
static void sensor_init(void)
{
	...
	table_write_cmos_sensor(gc5035b_init_setting, sizeof(gc5035b_init_setting) / sizeof(kal_uint8));
}

static void preview_setting(void)
{
	table_write_cmos_sensor(gc5035b_preview_setting, sizeof(gc5035b_preview_setting) / sizeof(kal_uint8));
}

static void capture_setting(kal_uint16 currefps)
{
	LOG_INF("E! currefps: %d\n", currefps);
	table_write_cmos_sensor(gc5035b_capture_setting, sizeof(gc5035b_capture_setting) / sizeof(kal_uint8));
}

static void normal_video_setting(kal_uint16 currefps)
{
	table_write_cmos_sensor(gc5035b_normal_video_setting, sizeof(gc5035b_normal_video_setting) / sizeof(kal_uint8));
}
...
static void hs_video_setting(void)
{
	...
	/* Integration Time */
	write_cmos_sensor(0xfe, 0x00);
	write_cmos_sensor(0x41, 0x03);
	write_cmos_sensor(0x42, 0xf8);
	write_cmos_sensor(0x03, 0x02);
	write_cmos_sensor(0x04, 0x64);
	...
	write_cmos_sensor(0x97, 0x0a);
	write_cmos_sensor(0x98, 0x32);
	write_cmos_sensor(0x99, 0x03);
	write_cmos_sensor(0x9a, 0xc9);
...
{
	table_write_cmos_sensor(gc5035b_custom1_setting, sizeof(gc5035b_custom1_setting) / sizeof(kal_uint8));
}
static void custom2_setting(void)
{
	table_write_cmos_sensor(gc5035b_custom2_setting, sizeof(gc5035b_custom2_setting) / sizeof(kal_uint8));
}

static void custom3_setting(void)
{
	table_write_cmos_sensor(gc5035b_custom3_setting, sizeof(gc5035b_custom3_setting) / sizeof(kal_uint8));
}

static void custom4_setting(void)
{
	table_write_cmos_sensor(gc5035b_custom4_setting, sizeof(gc5035b_custom4_setting) / sizeof(kal_uint8));
}

static void custom5_setting(void)
{
	table_write_cmos_sensor(gc5035b_custom5_setting, sizeof(gc5035b_custom5_setting) / sizeof(kal_uint8));
}
...
int gc5035b_read_otp_cal(unsigned int addr, unsigned char *data, unsigned int size)
{
	...
	otp_bank = gc5035b_otp_read_byte(GC5035B_OTP_CHECK_BANK);
	pr_info("%s, check OTP bank:0x%x\n", __func__, otp_bank);

	switch (otp_bank) {
	case GC5035B_OTP_BANK1_MARK:
		read_addr = GC5035B_OTP_BANK1_START_ADDR;
		break;
	case GC5035B_OTP_BANK2_MARK:
		read_addr = GC5035B_OTP_BANK2_START_ADDR;
		break;
	case GC5035B_OTP_BANK3_MARK:
		read_addr = GC5035B_OTP_BANK3_START_ADDR;
		break;
	case GC5035B_OTP_BANK4_MARK:
		read_addr = GC5035B_OTP_BANK4_START_ADDR;
		break;
	default:
	...
	for (i = 0; i < size; i++) {
		*(data + i) = gc5035b_otp_read_byte(read_addr);
		pr_debug("read data addr:0x%x, value:0x%x\n", read_addr, *(data + i));
		read_addr += 8;
	}
	pr_debug("%s - X\n", __func__);
	return (int)size;
