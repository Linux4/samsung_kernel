...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[] = {
	...
	{ 3280, 2460,    0,    0, 3280, 2460, 3280, 2460,
	     8,    6, 3264, 2448,    0,    0, 3264, 2448 }, /*high speed-NOT USED*/
	{ 3280, 2460,    0,    0, 3280, 2460, 3280, 2460,
	     8,    6, 3264, 2448,    0,    0, 3264, 2448 }, /*slim video-NOT USED*/
	{ 3280, 2460,    0,    0, 3280, 2460, 3280, 2460,
	     8,    6, 3264, 2448,    0,    0, 3264, 2448 }, /*custom1*/
	{ 3280, 2460,    0,    0, 3280, 2460, 3280, 2460,
	   320,  240, 2640, 1980,    0,    0, 2640, 1980 }, /*custom2*/
	{ 3280, 2460,    0,    0, 3280, 2460, 3280, 2460,
	   320,  240, 2640, 1980,    0,    0, 2640, 1980 }, /*custom3*/
	{ 3280, 2460,    0,    0, 3280, 2460, 3280, 2460,
	   320,  486, 2640, 1488,    0,    0, 2640, 1488 }, /*custom4*/
	{ 3280, 2460,    0,    0, 3280, 2460, 3280, 2460,
	     8,    6, 3264, 2448,    0,    0, 3264, 2448 }, /*custom5-NOT USED*/
};
...
static void custom2_setting(void)
{
	...
	write_cmos_sensor(0x0099, 0x00);
	write_cmos_sensor(0x0351, 0x00);
	write_cmos_sensor(0x0352, 0xf0);
	write_cmos_sensor(0x0353, 0x01);
	write_cmos_sensor(0x0354, 0x40);
	write_cmos_sensor(0x034c, 0x0a);
	write_cmos_sensor(0x034d, 0x50);
	write_cmos_sensor(0x034e, 0x07);
	write_cmos_sensor(0x034f, 0xbc);
	write_cmos_sensor(0x0108, 0x08);
	write_cmos_sensor(0x0112, 0x0a);
	write_cmos_sensor(0x0113, 0x0a);
	write_cmos_sensor(0x0114, 0x03);
