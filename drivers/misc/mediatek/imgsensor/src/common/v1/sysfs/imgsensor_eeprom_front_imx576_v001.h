#ifndef IMGSENSOR_EEPROM_FRONT_IMX576_V001_H
#define IMGSENSOR_EEPROM_FRONT_IMX576_V001_H

#define IMGSENSOR_FRONT_MAX_CAL_SIZE (16 * 1024)
#define FRONT_HEADER_CHECKSUM_LEN (0xFB - 0x00 + 0x1)
#define FRONT_OEM_CHECKSUM_LEN (0x01BB - 0x0100 + 0x1)
#define FRONT_AWB_CHECKSUM_LEN (0x025B - 0x1C0 + 0x1)
#define FRONT_SHADING_CHECKSUM_LEN (0x09CB - 0x0260 + 0x1)
#define FRONT_SENSOR_CAL_CHECKSUM_LEN (0x180B - 0x09D0 + 0x1)

const struct imgsensor_vendor_rom_addr front_imx576_cal_addr = {
	/* Set '-1' if not used */

	.camera_module_es_version                  = 'A',
	.cal_map_es_version                        = '1',
	.rom_max_cal_size                          = IMGSENSOR_FRONT_MAX_CAL_SIZE,
	...
	.rom_sensor_cal_module_info_start_addr     = 0x17F0,
	.rom_sensor_cal_checksum_addr              = 0x180C,
