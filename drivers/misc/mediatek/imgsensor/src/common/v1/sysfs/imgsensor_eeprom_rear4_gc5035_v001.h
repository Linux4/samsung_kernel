#ifndef IMGSENSOR_EEPROM_REAR4_GC5035_V001_H
#define IMGSENSOR_EEPROM_REAR4_GC5035_V001_H

#define IMGSENSOR_REAR4_MAX_CAL_SIZE (8 * 1024)
#define REAR4_HEADER_CHECKSUM_LEN (0xFB - 0x00 + 0x1)
#define REAR4_OEM_CHECKSUM_LEN (0x01BB - 0x0100 + 0x1)
#define REAR4_AWB_CHECKSUM_LEN (0x025B - 0x1C0 + 0x1)
#define REAR4_SHADING_CHECKSUM_LEN (0x09CB - 0x0260 + 0x1)

const struct imgsensor_vendor_rom_addr rear4_gc5035_cal_addr = {
	/* Set '-1' if not used */
