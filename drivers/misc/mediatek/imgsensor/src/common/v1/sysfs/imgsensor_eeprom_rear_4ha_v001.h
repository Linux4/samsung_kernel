#ifndef IMGSENSOR_EEPROM_REAR_4HA_V001_H
#define IMGSENSOR_EEPROM_REAR_4HA_V001_H

#ifndef IMGSENSOR_REAR_4HA_MAX_CAL_SIZE
#define IMGSENSOR_REAR_4HA_MAX_CAL_SIZE (0xC00)
#endif

#define REAR_4HA_HEADER_CHECKSUM_LEN (0x00FB - 0x0000 + 0x1)
#define REAR_4HA_OEM_CHECKSUM_LEN (0x01BB - 0x0100 + 0x1)
#define REAR_4HA_AWB_CHECKSUM_LEN (0x025B - 0x01C0 + 0x1)
#define REAR_4HA_SHADING_CHECKSUM_LEN (0x09CB - 0x0260 + 0x1)
#define REAR_4HA_AE_CHECKSUM_LEN (0x0A1B - 0x09D0 + 0x1)//TODO

const struct imgsensor_vendor_rom_addr rear_4ha_cal_addr = {
		/* Set '-1' if not used */

	.camera_module_es_version = 'A',//TODO
	.cal_map_es_version = '1', //TODO
	.rom_max_cal_size = IMGSENSOR_REAR_4HA_MAX_CAL_SIZE,
	...
	.rom_header_checksum_len = (REAR_4HA_HEADER_CHECKSUM_LEN),
	...
	.rom_oem_checksum_len = (REAR_4HA_OEM_CHECKSUM_LEN),

	.rom_awb_module_info_start_addr = 0x024A,
	.rom_awb_checksum_addr = 0x025C,
	.rom_awb_checksum_len = (REAR_4HA_AWB_CHECKSUM_LEN),

	.rom_shading_module_info_start_addr = 0x09B2,
	.rom_shading_checksum_addr = 0x09CC,
	.rom_shading_checksum_len = (REAR_4HA_SHADING_CHECKSUM_LEN),
...
#endif /* IMGSENSOR_EEPROM_REAR_4HA_V001_H */
