 ...
 * Filename:
 * ---------
 *	 n21_txd_sub_s5k3l6mipiraw_Sensor.c
 *
 * Project:
 * --------
 *	 ALPS
...
#include "n21_txd_sub_s5k3l6mipiraw_Sensor.h"

#define MULTI_WRITE 1
#undef ORINGNAL_VERSION

//#define N21_TXD_SUB_S5K3L6_EEPROM_CALI
#undef N21_TXD_SUB_S5K3L6_EEPROM_CALI
#define EEPROM_P24S64E_ID 0xA0
static kal_uint16 read_eeprom(kal_uint32 addr)
{
	kal_uint16 get_byte=0;

	char pu_send_cmd[2] = { (char)(addr >> 8), (char)(addr & 0xFF) };
	iReadRegI2C(pu_send_cmd, 2, (u8*)&get_byte, 1, EEPROM_P24S64E_ID);
...
extern int dump_dualcam_cali_data_n21_txd_sub_s5k3l6(void);
#endif
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = N21_TXD_SUB_S5K3L6_SENSOR_ID,
...
static void write_shutter(kal_uint16 shutter)
{
	...
	/* Update Shutter*/
	//write_cmos_sensor_8(0x0104, 0x01); //bug546588 guojiabin.wt,modify,2020/04/11,modify for ITS test latching fail
	write_cmos_sensor(0x0202, shutter);
	//write_cmos_sensor_8(0x0104, 0x00); //bug546588 guojiabin.wt,modify,2020/04/11,modify for ITS test latching fail
...
#ifdef N21_TXD_SUB_S5K3L6_EEPROM_CALI
static struct n21_txd_sub_s5k3l6_otp_data_str pOTP_Data = {0};

static kal_uint32 read_eeprom_info_data(
		struct n21_txd_sub_s5k3l6_otp_data_str *pData, kal_uint16 addr)
{
...
static kal_uint32 n21_txd_sub_s5k3l6_otp_apply(struct n21_txd_sub_s5k3l6_otp_data_str *pData)
{
	/* Apply AWB */
...
static void n21_txd_sub_s5k3l6_get_eeprom_data(void)
{
...
static struct stCAM_CAL_DATAINFO_STRUCT txd_sub_s5k3l6_eeprom_data ={
	.sensorID= N21_TXD_SUB_S5K3L6_SENSOR_ID,
	.deviceID = 0x02,
	.dataLength = 0x0E60,
	.sensorVendorid = 0x19020101,
	.vendorByte = {1,2,3,4},
	.dataBuffer = NULL,
};
static struct stCAM_CAL_CHECKSUM_STRUCT txd_sub_s5k3l6_Checksum[8] =
{
	{MODULE_ITEM,0x0000,0x0000,0x0007,0x0008,0x55},
	{AWB_ITEM,0x0009,0x0009,0x0025,0x0026,0x55},
	{LSC_ITEM,0x0027,0x0027,0x0773,0x0774,0x55},
	{TOTAL_ITEM,0x0000,0x0000,0x0E5E,0x0E5F,0x55},
	...
	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
		...
		do {
			*sensor_id = ((read_cmos_sensor_8(0x0000) << 8) | read_cmos_sensor_8(0x0001)) + 1;
			...
			//+Bug 492443, sunhushan.wt, ADD, 2019.10.15, porting the otp of the 12sensor 
			size = imgSensorReadEepromData(&txd_sub_s5k3l6_eeprom_data,txd_sub_s5k3l6_Checksum);
				if(size != txd_sub_s5k3l6_eeprom_data.dataLength || (txd_sub_s5k3l6_eeprom_data.sensorVendorid >> 24)!= read_eeprom(0x0001)) {
					printk("get eeprom data failed\n");
					if(txd_sub_s5k3l6_eeprom_data.dataBuffer != NULL) {
						kfree(txd_sub_s5k3l6_eeprom_data.dataBuffer);
						txd_sub_s5k3l6_eeprom_data.dataBuffer = NULL;
					}
					*sensor_id = 0xFFFFFFFF;
					return ERROR_SENSOR_CONNECT_FAIL;
				} else {
					LOG_INF("get eeprom data success\n");
					imgSensorSetEepromData(&txd_sub_s5k3l6_eeprom_data);
				}
				//-Bug 492443, sunhushan.wt, ADD, 2019.10.15, porting the otp of the 12sensor 
...
static kal_uint32 open(void)
{
	...
	if ((pOTP_Data.info_flag != 0x01) || (pOTP_Data.awb_flag != 0x01))
		n21_txd_sub_s5k3l6_get_eeprom_data();
	if ((pOTP_Data.awb_flag == 0x01) &&
			(pOTP_Data.awb_checksum_calc == pOTP_Data.awb_checksum_readout))
		n21_txd_sub_s5k3l6_otp_apply(&pOTP_Data);
#endif
...
UINT32 N21_TXD_SUB_S5K3L6_MIPI_RAW_SensorInit(
