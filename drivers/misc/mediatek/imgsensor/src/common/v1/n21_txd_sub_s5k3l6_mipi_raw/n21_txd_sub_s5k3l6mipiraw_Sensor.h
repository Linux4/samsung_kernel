 ...
 * Filename:
 * ---------
 *	 n21_txd_sub_s5k3l6mipiraw_Sensor.h
 *
 * Project:
 * --------
 *	 ALPS
 ...
 *
 ****************************************************************************/
#ifndef _N21_TXD_SUB_S5K3L6MIPI_SENSOR_H
#define _N21_TXD_SUB_S5K3L6MIPI_SENSOR_H
...
struct imgsensor_info_struct {
	...
	/* custom1 & custom2 for Dual Camera */
...
struct n21_txd_sub_s5k3l6_otp_data_str {
	kal_uint8 info_flag;
	kal_uint8 supplier_code;	//Holitech:0x55
	...
	kal_uint8 info_checksum_readout;
	kal_uint8 info_checksum_calc;
	kal_uint8 awb_flag;
	kal_uint8 R_over_Gr_unit_h;
	kal_uint8 R_over_Gr_unit_l;
	kal_uint8 B_over_Gr_unit_h;
	kal_uint8 B_over_Gr_unit_l;
	kal_uint8 Gb_over_Gr_unit_h;
	kal_uint8 Gb_over_Gr_unit_l;
	kal_uint8 R_over_Gr_golden_h;
	kal_uint8 R_over_Gr_golden_l;
	kal_uint8 B_over_Gr_golden_h;
	kal_uint8 B_over_Gr_golden_l;
	kal_uint8 Gb_over_Gr_golden_h;
	kal_uint8 Gb_over_Gr_golden_l;
	kal_uint8 awb_checksum_readout;
