...
static imgsensor_info_struct imgsensor_info = {
	...
	.i2c_addr_table = {0x6c, 0x6D, 0x20, 0xff},	/* record sensor support all write id addr,
...
static SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[5] = {
	{2592, 1944, 0, 0, 2592, 1944, 1296, 972, 0000,
		0000, 1296, 972, 1, 0, 1280, 960},	/* Preview */
	{2592, 1944, 0, 0, 2592, 1944, 2592, 1944, 0000,
		0000, 2592, 1944, 1, 0, 2560, 1920},	/* capture */
	{2592, 1944, 0, 0, 2592, 1944, 1296, 972, 0000,
		0000, 1296, 972, 1, 0, 1280, 960},	/* video */
	{2592, 1944, 0, 0, 2592, 1944, 644, 480, 0000,
		0000, 644, 480, 1, 0, 640, 480},	/* hight speed video */
	{2592, 1944, 0, 0, 2592, 1944, 1296, 972, 0000,
		0000, 1296, 972, 1, 0, 1280, 960}
};				/* slim video */
				  ...
				  UINT8 *feature_para, UINT32 *feature_para_len)
{
	...
	case SENSOR_FEATURE_SET_IHDR_SHUTTER_GAIN:
		LOG_INF("SENSOR_SET_SENSOR_IHDR LE=%d, SE=%d, Gain=%d\n", (UINT32) *feature_data,
			(UINT32) *(feature_data + 1), (UINT32) *(feature_data + 2));
