...
#include "s5k5e3yxmipiraw_Sensor.h"
/****************************Modify following Strings for debug****************************/
#define PFX "s5k5e3yx_camera_sensor"
#define LOG_1 LOG_INF("s5k5e3yx,MIPI 2LANE\n")
...
{
 { 2576, 1936,	  0,	2,    2576, 1932, 2576, 1932, 0000, 0000, 2576, 1932,	  0,	0, 2576, 1932},  // Preview 
 { 2576, 1936,	  0,	2,    2576, 1932, 2576, 1932, 0000, 0000, 2576, 1932,	  0,	0, 2576, 1932}, // capture 
 { 2576, 1936,	  0,	2,    2576, 1932, 2576, 1932, 0000, 0000, 2576, 1932,	  0,	0, 2576, 1932}, // video 
 { 2576, 1936,	  8,    8,  2560,  1920,  640,  480, 0000, 0000,  640,  480,	  0,	0,  640,  480}, //hight speed video 
 { 2576, 1936,	  8,    8,  2560,  1920,  1280, 960, 0000, 0000,  1280,  960,	  0,	0,  1280,  960}, //slim video 
};
...
static void preview_setting(void)
{
	...
	write_cmos_sensor(0x3941	, 0x04  );
	write_cmos_sensor(0x3942	, 0xB5  );
	write_cmos_sensor(0x3924	, 0x2F  );
	write_cmos_sensor(0x3925	, 0x10  );
	write_cmos_sensor(0x3C31, 0x54  );
	write_cmos_sensor(0x3C32, 0x60  );
	write_cmos_sensor(0x3C08, 0x5D );
	write_cmos_sensor(0x3C09, 0xC0 );
	write_cmos_sensor(0x3320	, 0x02  );
...
UINT32 S5K5E3YX_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc)
{
