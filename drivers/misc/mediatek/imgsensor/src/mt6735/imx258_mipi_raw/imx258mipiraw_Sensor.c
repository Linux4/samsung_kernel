...
#define LOG_2 LOG_INF("preview 2080*1560@30fps,324Mbps/lane; video 4160*3120@30fps,1266Mbps/lane; video 2080*1560@30fps,324Mbps/lane;\n")
/****************************   Modify end    *******************************************/
...
#ifdef CONFIG_KERNEL_IMGSENSOR_180_ROTATION
...
static void sensor_init(void)
{
  ...
  //Global Setting
	...
	write_cmos_sensor(0x4E21,0x14);//@20151216 refered to LG and Sony
...
{
	//@20151221 refered to LG Mode B3
	LOG_INF("preview E\n");
  write_cmos_sensor(0x0100,0x00);
	mdelay(10);
...
static void capture_setting(kal_uint16 curretfps, kal_uint8  pdaf_mode)
{
	...
	{
		//@20151215 Refered to LG A1 Mode
		write_cmos_sensor(0x0100,0x00);
		mdelay(10);
...
{
	//@20151221 refered to LG B3 Mode
