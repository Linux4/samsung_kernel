...
{
 { 3280, 2464,	0,	4,     3280, 2456, 3280, 2456, 0, 0, 3280, 2456,	8,	0, 3264, 2456}, // preview
 { 3280, 2464,	0,	4,     3280, 2456, 3280, 2456, 0, 0, 3280, 2456,	8,	0, 3264, 2456},// capture 
 { 3280, 2464,	0,	4,     3280, 2456, 3280, 2456, 0, 0, 3280, 2456,	8,	0, 3264, 2456}, // video 
 { 3280, 2464,	0, 312,    3280, 1840,  816,  460, 0, 0, 816,   460,	0,	0,  816,  460}, //hight speed video 
 { 3280, 2464,	0,  4,     3280, 2456, 1640, 1228, 0, 0, 1640, 1228,	0,	0, 1640, 1228}};// slim video 
...
static void preview_setting(void)
{
	...
	write_cmos_sensor(0x0160,	0x0A);
	write_cmos_sensor(0x0161,   	0x83);
	write_cmos_sensor(0x0162,	0x0D);
	write_cmos_sensor(0x0163,	0x78);
...
static void hs_video_setting(void)
{
	LOG_INF("E\n");
		...
		write_cmos_sensor(0x0160,	0x02);
		write_cmos_sensor(0x0161,	0xA1);
		write_cmos_sensor(0x0162,	0x0D);
		write_cmos_sensor(0x0163,	0x78);
		write_cmos_sensor(0x0164,	0x00);
		write_cmos_sensor(0x0165,	0x08);
		write_cmos_sensor(0x0166,	0x0C);
		write_cmos_sensor(0x0167,	0xC7);
		write_cmos_sensor(0x0168,	0x01);
		write_cmos_sensor(0x0169,	0x38);
		write_cmos_sensor(0x016A,	0x08);
		write_cmos_sensor(0x016B,	0x67);
		write_cmos_sensor(0x016C,	0x03);
		write_cmos_sensor(0x016D,	0x30);
		write_cmos_sensor(0x016E,	0x01);
		write_cmos_sensor(0x016F,	0xCC);
		write_cmos_sensor(0x0170,	0x01);
		write_cmos_sensor(0x0171,	0x01);
...
static void slim_video_setting(void)
{
	...
	write_cmos_sensor(0x030B,   0x01); 
	write_cmos_sensor(0x030C,   0x00); 
	write_cmos_sensor(0x030D,   0x55);//0x54
	write_cmos_sensor(0x4767,   0x0F); 
	write_cmos_sensor(0x4750,   0x14); 
	write_cmos_sensor(0x47B4,   0x14); 
	write_cmos_sensor(0x0100,   0x01); 
