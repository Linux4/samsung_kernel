...
#include <linux/of_gpio.h>//bug497390,gaoyu.git,add,20191106,Distinguish between 2st depth camera and 3rd depth camera
#include <linux/gpio.h>//bug497390,gaoyu.git,add,20191106,Distinguish between 2st depth camera and 3rd depth camera
