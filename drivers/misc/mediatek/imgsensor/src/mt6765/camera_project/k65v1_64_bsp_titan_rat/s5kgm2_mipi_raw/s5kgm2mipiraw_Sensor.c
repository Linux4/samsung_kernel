...
static struct imgsensor_struct imgsensor = {
	...
	.dummy_line = 0,
	.current_fps = 0,
	///full size current fps : 24fps for PIP,
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[7] = {
	...
	{8000, 6000, 160, 120, 7680, 5760, 1920, 1440,
	 0, 0, 1920, 1440, 0, 0, 1920, 1440},	/* slim video */
	{8000, 6000, 0, 0, 8000, 6000, 4000, 3000,
	 0, 0, 4000, 3000, 0, 0, 4000, 3000},	/* Custom1 */ /* Preview */
...
static void check_streamon(void)
{
	...
	mdelay(3);
	for (i = 0; i < timeout; i++) {
		frm_cnt = (read_cmos_sensor_8(0x0005) & 0xFF);
		if (frm_cnt == 0xFF) {
			mdelay(1);
			LOG_INF("stream not start frame_cnt = 0x%x", frm_cnt);
		} else {
			if (frm_cnt > j) {
				LOG_INF("stream started frame_cnt = 0x%x", frm_cnt);
				break;
			}
			j = frm_cnt;
		}
...
static kal_uint32 open(void)
{
	...
	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
		...
		do {
			...
			if (sensor_id == imgsensor_info.sensor_id) {
				LOG_INF("%s:i2c write id: 0x%x, sensor id: 0x%x\n",
			...
			MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	...
	case MSDK_SCENARIO_ID_CAMERA_PREVIEW:
		LOG_INF("MSDK_SCENARIO_ID_CAMERA_PREVIEW ");
	...
	case MSDK_SCENARIO_ID_CAMERA_CAPTURE_JPEG:
		LOG_INF("%s:MSDK_SCENARIO_ID_CAMERA_PREVIEW ");
		LOG_INF("scenario_id= %d\n", scenario_id);
		sensor_info->SensorGrabStartX =
	...
	case MSDK_SCENARIO_ID_HIGH_SPEED_VIDEO:
		LOG_INF("%s:MSDK_SCENARIO_ID_HIGH_SPEED_VIDEO ");
		LOG_INF("scenario_id= %d\n", scenario_id);
		sensor_info->SensorGrabStartX =
	...
	case MSDK_SCENARIO_ID_SLIM_VIDEO:
		LOG_INF("MSDK_SCENARIO_ID_SLIM_VIDEO ");
		LOG_INF("scenario_id= %d\n", scenario_id);
		sensor_info->SensorGrabStartX =
	...
	case MSDK_SCENARIO_ID_CUSTOM1:
		LOG_INF("MSDK_SCENARIO_ID_CUSTOM1 ");
		LOG_INF("scenario_id= %d\n", scenario_id);
		sensor_info->SensorGrabStartX =
	...
	case MSDK_SCENARIO_ID_CUSTOM2:
		LOG_INF("MSDK_SCENARIO_ID_CUSTOM2 ");
		LOG_INF("scenario_id= %d\n", scenario_id);
		sensor_info->SensorGrabStartX =
			...
			MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	...
	case MSDK_SCENARIO_ID_CAMERA_PREVIEW:
		...
		break;
	case MSDK_SCENARIO_ID_CAMERA_CAPTURE_JPEG:
		LOG_INF("MSDK_SCENARIO_ID_CAMERA_CAPTURE_JPEG");
		LOG_INF("scenario_id= %d\n", scenario_id);
		capture(image_window, sensor_config_data);
		break;
	case MSDK_SCENARIO_ID_VIDEO_PREVIEW:
		LOG_INF("MSDK_SCENARIO_ID_VIDEO_PREVIEW ");
		LOG_INF("scenario_id= %d\n", scenario_id);
		normal_video(image_window, sensor_config_data);
		break;
	case MSDK_SCENARIO_ID_HIGH_SPEED_VIDEO:
		LOG_INF("MSDK_SCENARIO_ID_HIGH_SPEED_VIDEO");
		LOG_INF("scenario_id= %d\n", scenario_id);
	...
	MUINT32 framerate)
{
	...
	case MSDK_SCENARIO_ID_HIGH_SPEED_VIDEO:
		...
		break;
	case MSDK_SCENARIO_ID_SLIM_VIDEO:
		LOG_INF("MSDK_SCENARIO_ID_SLIM_VIDEO scenario_id");
		LOG_INF("= %d\n", scenario_id);
	...
	case MSDK_SCENARIO_ID_CUSTOM1:
		LOG_INF("MSDK_SCENARIO_ID_CUSTOM1 scenario_id");
		LOG_INF("= %d\n", scenario_id);
		...
		break;
	case MSDK_SCENARIO_ID_CUSTOM2:
		LOG_INF("MSDK_SCENARIO_ID_CUSTOM2 scenario_id");
		LOG_INF("= %d\n", scenario_id);
	...
	default:
		...
		LOG_INF("we use preview scenario\n");
		break;
	}
	return ERROR_NONE;
}
				...
				UINT8 *feature_para, UINT32 *feature_para_len)
{
	...
	case SENSOR_FEATURE_GET_PIXEL_CLOCK_FREQ:
		LOG_INF("SENSOR_FEATURE_GET_PIXEL_CLOCK_FREQ");
		LOG_INF(" = %d\n", feature_id);
	...
	case SENSOR_FEATURE_SET_MAX_FRAME_RATE_BY_SCENARIO:
		LOG_INF("SENSOR_FEATURE_SET_MAX_FRAME_RATE");
		LOG_INF("_BY_SCENARIO = %d\n", feature_id);
	...
	case SENSOR_FEATURE_GET_DEFAULT_FRAME_RATE_BY_SCENARIO:
		LOG_INF("SENSOR_FEATURE_GET_DEFAULT_FRAME_RATE");
		LOG_INF("_BY_SCENARIO=%d\n", feature_id);
	...
	case SENSOR_FEATURE_GET_PDAF_INFO:
		...
		case MSDK_SCENARIO_ID_SLIM_VIDEO:
		case MSDK_SCENARIO_ID_CAMERA_PREVIEW:
			pr_info("MSDK_SCENARIO_ID_CAMERA_PREVIEW:%d\n",
