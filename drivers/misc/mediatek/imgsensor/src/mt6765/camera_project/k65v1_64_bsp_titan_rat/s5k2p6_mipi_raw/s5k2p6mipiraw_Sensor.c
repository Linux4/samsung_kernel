...
static struct imgsensor_info_struct imgsensor_info = {
	...
	.pre = {
		.pclk = 560440000,      /*record different mode's pclk*/
		.linelength = 5160,   /* 6450 0x1428 = 5160 record different mode's linelength*/
		.framelength = 3610,  /* 0x0E1A = 3610record different mode's framelength*/
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[6] = {
	/*preview*/
	{ 4640, 3488, 16, 16, 4608, 3456, 4608, 3456,
	  0000, 0000, 4608, 3456, 0, 0, 4608, 3456},
	/*capture*/
	{ 4640, 3488, 16, 16, 4608, 3456, 4608, 3456,
	  0000, 0000, 4608, 3456, 0, 0, 4608, 3456},
	/*Video*/
	{ 4640, 3488, 16, 448, 4608, 2592, 4608, 2592,
				 ...
				 UINT8 *feature_para, UINT32 *feature_para_len)
{
	...
	case SENSOR_FEATURE_GET_TEST_PATTERN_CHECKSUM_VALUE:
			LOG_INF("SENSOR_FEATURE_GET_TEST_PATTERN_CHECKSUM_VALUE\n");
