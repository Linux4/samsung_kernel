 ...
 *
 ****************************************************************************/
#ifndef _A0603DDFRONTMT811_MIPI_RAW_H
#define _A0603DDFRONTMT811_MIPI_RAW_H
/* A06 code for SR-AL7160A-01-539 by xuyunhui at 20240626 start */
#define MT811_LONG_EXP  0
...
typedef struct imgsensor_info_struct {
	...
	kal_uint32 min_shutter;			//min shutteriWriteRegI2C
