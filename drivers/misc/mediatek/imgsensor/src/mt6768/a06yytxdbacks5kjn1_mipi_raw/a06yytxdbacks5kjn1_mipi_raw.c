...
#include "a06yytxdbacks5kjn1_mipi_raw.h"
...
#define PFX "A06YYTXDBACKS5KJN1_MIPI_RAW_camera_sensor"

#define LOG_INF(format, args...) pr_err(PFX "[%s] " format, __func__, ##args)
static DEFINE_SPINLOCK(imgsensor_drv_lock);
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = A06YYTXDBACKS5KJN1_SENSOR_ID ,
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_preview_s5kjn1acc2[] = {
0x6028,	0x2400,
0x602A,	0x1A28,
0x6F12,	0x4C00,
0x602A,	0x065A,
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_hs_video_s5kjn1acc2[] = {
    0x6028, 0x2400,
    0x602A, 0x1A28,
    0x6F12, 0x4C00,
    0x602A, 0x065A,
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_capture_s5kjn1acc2[] = {
0x6028,	0x2400,
0x602A,	0x1A28,
0x6F12,	0x4C00,
0x602A,	0x065A,
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_normal_video_s5kjn1acc2[] = {
0x6028,	0x2400,
0x602A,	0x1A28,
0x6F12,	0x4C00,
0x602A,	0x065A,
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_slim_video_s5kjn1acc2[] = {
    0x6028, 0x2400,
    0x602A, 0x1A28,
    0x6F12, 0x4C00,
    0x602A, 0x065A,
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_custom1_s5kjn1acc2[] = {
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_custom2_s5kjn1acc2[] = {
0x6028, 0x2400,
0x602A, 0x1A28,
0x6F12, 0x4C00,
0x602A, 0x065A,
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_custom3_s5kjn1acc2[] = {
	0x6028, 0x2400, 0x602A, 0x1A28, 0x6F12, 0x4C00, 0x602A, 0x065A, 0x6F12,
	0x0000, 0x602A, 0x139E, 0x6F12, 0x0100, 0x602A, 0x139C, 0x6F12, 0x0000,
	0x602A, 0x13A0, 0x6F12, 0x0A00, 0x6F12, 0x0120, 0x602A, 0x2072, 0x6F12,
	0x0000, 0x602A, 0x1A64, 0x6F12, 0x0301, 0x6F12, 0xFF00, 0x602A, 0x19E6,
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_custom4_s5kjn1acc2[] = {
0x6028, 0x2400,
0x602A, 0x1A28,
0x6F12, 0x4C00,
0x602A, 0x065A,
...
UINT32
A06YYTXDBACKS5KJN1_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
	LOG_INF("A06YYTXDBACKS5KJN1_MIPI_RAW_SensorInit in  fufu\n");
