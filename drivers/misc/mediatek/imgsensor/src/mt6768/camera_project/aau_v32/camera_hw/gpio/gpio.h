...
enum GPIO_CTRL_STATE_CAM  {
	...
	GPIO_CTRL_STATE_COMPANION_RST_H,
	GPIO_CTRL_STATE_COMPANION_RST_L,
	GPIO_CTRL_STATE_COMPANION_AVDD_H,
	GPIO_CTRL_STATE_COMPANION_AVDD_L,
	...
	GPIO_CTRL_STATE_COMPANION_DVDD_H,
	GPIO_CTRL_STATE_COMPANION_DVDD_L,
