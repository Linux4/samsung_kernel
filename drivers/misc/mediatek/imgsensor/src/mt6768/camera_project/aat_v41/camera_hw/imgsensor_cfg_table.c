...
enum IMGSENSOR_RETURN
	...
	imgsensor_hw_gpio_exp_open,
	/*imgsensor_hw_mt6306_open,*/
	imgsensor_hw_mclk_open
};

extern struct IMGSENSOR_HW_CFG imgsensor_custom_config_hw_rev00[];
extern struct IMGSENSOR_HW_CFG imgsensor_custom_config_hw_rev01[];
extern struct IMGSENSOR_HW_CFG imgsensor_custom_config_hw_rev02[];

struct IMGSENSOR_HW_CFG_LIST  imgsensor_custom_config_hw_list[] = {
	{ 0, imgsensor_custom_config_hw_rev00},
	{ 1, imgsensor_custom_config_hw_rev01},
	{ 2, imgsensor_custom_config_hw_rev02},
	{-1, NULL},
};

struct IMGSENSOR_HW_CFG imgsensor_custom_config_hw_rev00[] = {
	{
...
struct IMGSENSOR_HW_CFG imgsensor_custom_config_hw_rev01[] = {
	{
		IMGSENSOR_SENSOR_IDX_MAIN,
		IMGSENSOR_I2C_DEV_0,
		{
...
struct IMGSENSOR_HW_CFG imgsensor_custom_config_hw_rev02[] = {
	{
		IMGSENSOR_SENSOR_IDX_MAIN,
		IMGSENSOR_I2C_DEV_0,
		{
			{IMGSENSOR_HW_ID_MCLK, IMGSENSOR_HW_PIN_MCLK},
			{IMGSENSOR_HW_ID_REGULATOR, IMGSENSOR_HW_PIN_AVDD},
			{IMGSENSOR_HW_ID_GPIO, IMGSENSOR_HW_PIN_AVDD2_LDO_EN},
			{IMGSENSOR_HW_ID_REGULATOR, IMGSENSOR_HW_PIN_DOVDD},
			{IMGSENSOR_HW_ID_REGULATOR, IMGSENSOR_HW_PIN_DVDD},
			{IMGSENSOR_HW_ID_REGULATOR, IMGSENSOR_HW_PIN_AFVDD},
			{IMGSENSOR_HW_ID_GPIO, IMGSENSOR_HW_PIN_PDN},
...
struct IMGSENSOR_HW_POWER_SEQ sensor_power_sequence[] = {
	...
	{
		SENSOR_DRVNAME_GC5035_MACRO_MIPI_RAW,
		{
			{PDN, Vol_Low, 1},
			{RST, Vol_Low, 3},
			{DOVDD, Vol_1800, 1},
