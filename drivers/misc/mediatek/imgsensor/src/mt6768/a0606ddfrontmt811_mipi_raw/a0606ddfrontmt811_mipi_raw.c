...
#include "a0606ddfrontmt811_mipi_raw.h"
/* A06 code for SR-AL7160A-01-502 by xuyunhui at 20240628 start */
#define PFX "a0606ddfrontmt811_mipi_raw"
...
#define MT811_MIRROR_NORMAL  0
#define MT811_MIRROR_H       0
#define MT811_MIRROR_V       0
#define MT811_MIRROR_HV      1
/* A06 code for SR-AL7160A-01-502 by xuyunhui at 20240617 end */
static DEFINE_SPINLOCK(imgsensor_drv_lock);

static struct imgsensor_info_struct imgsensor_info = {
    .sensor_id = A0606DDFRONTMT811_SENSOR_ID,
...
static void sensor_init(void)
{
    ...
    write_cmos_sensor(0x0056, 0x46);
    write_cmos_sensor(0x0057, 0x58);
    write_cmos_sensor(0x0058, 0x27);
    write_cmos_sensor(0x0059, 0x3f);
    write_cmos_sensor(0x005a, 0x6e);
    write_cmos_sensor(0x005b, 0x45);
    write_cmos_sensor(0x005c, 0x12);
    write_cmos_sensor(0x005d, 0x25);
    write_cmos_sensor(0x005e, 0x3a);
    write_cmos_sensor(0x005f, 0x58);
    write_cmos_sensor(0x0068, 0x27);
    write_cmos_sensor(0x0069, 0x3f);
    write_cmos_sensor(0x006a, 0xce);
    write_cmos_sensor(0x006b, 0x45);
...
static void capture_setting(kal_uint16 currefps)
{
    ...
    // Frame Length     : 2542@4lane
    // Line Length      : 4432@4lane
    // line Time        : 13112@4lane
    ...
    write_cmos_sensor(0x041b, 0xee);
    write_cmos_sensor(0x041c, 0x09);
    write_cmos_sensor(0x041d, 0x50);
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
    ...
    while(imgsensor_info.i2c_addr_table[i] != 0xff)
    {
        ...
        {
            msleep(10);
            *sensor_id = ((read_cmos_sensor(0x0000) << 8) | read_cmos_sensor(0x0001))+ 2;
            if (*sensor_id == imgsensor_info.sensor_id)
            {
                /*A06 code for SR-AL7160A-01-501 by zhongbin at 20240415 start*/
                kal_uint32 mt811VendorId = 0;
                mt811VendorId = read_cmos_sensor_moduleid();
                if(mt811VendorId != 0x00 && mt811VendorId != 0x86){
...
/* A06 code for SR-AL7160A-01-502 by xuyunhui at 20240628 end */
...
UINT32 A0606DDFRONTMT811_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT  **pfFunc)
{
    LOG_INF("A0606DDFRONTMT811_MIPI_RAW_SensorInit\n");
    if (pfFunc!=NULL)
            *pfFunc=&sensor_func;
    return ERROR_NONE;
}
