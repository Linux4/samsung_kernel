 ...
 * Filename:
 * ---------
 *     a0601cxtdepthgc02m1b_mipi_raw.c
 *
 * Project:
 * --------
 *     ALPS
...
#include "a0601cxtdepthgc02m1b_mipi_raw.h"

/* a06 code for SR-AL7160A-01-543 by liugang at 20240416 start */
/************************** Modify Following Strings for Debug **************************/
#define PFX "A0601CXTDEPTHGC02M1B_MIPI_RAW_camera_sensor"
#define LOG_1 LOG_INF("A0601CXTDEPTHGC02M1B, MIPI 1LANE\n")
/****************************   Modify end    *******************************************/
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = A0601CXTDEPTHGC02M1B_SENSOR_ID,
		...
		do {
			*sensor_id = return_sensor_id();
			if (*sensor_id == imgsensor_info.sensor_id) {
				LOG_INF("GC02M1B(Y1&Y6) i2c write id: 0x%x, sensor id: 0x%x\n", imgsensor.i2c_write_id, *sensor_id);
				return ERROR_NONE;
			}
