...
#include "a06yycxtdepthgc02m1_mipi_raw.h"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = A06YYCXTDEPTHGC02M1_SENSOR_ID,
...
UINT32 A06YYCXTDEPTHGC02M1_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
