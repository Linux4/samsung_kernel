 ...
 ****************************************************************************
 ***
 ***   This file defines the adapters for imgsensor adaptive mipi functions.
 ***   The adapters are made for preventing build error, when CONFIG_CAMERA_ADAPTIVE_MIPI is not defined.
 ***   If CONFIG_CAMERA_ADAPTIVE_MIPI is not defined, below functions do nothing or return error.
 ***
 ****************************************************************************
 ****************************************************************************/
...
#else
static inline int imgsensor_register_ril_notifier(void)
{
	return	-1;
};
static inline int imgsensor_print_cp_info(void)
{
	return	-1;
};
static inline int imgsensor_select_mipi_by_rf_channel(const struct cam_mipi_channel *channel_list, const int size)
{
	return	-1;
};
