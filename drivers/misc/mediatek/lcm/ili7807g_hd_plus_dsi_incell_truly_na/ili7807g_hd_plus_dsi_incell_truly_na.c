...
#if (LCM_DSI_CMD_MODE)
struct LCM_DRIVER ili7807g_hd_plus_dsi_vdo_truly_na_lcm_drv = {
	.name = "ili7807g_hd_plus_dsi_cmd_truly_na_lcm_drv",
#else

struct LCM_DRIVER ili7807g_hd_plus_dsi_vdo_truly_na_lcm_drv = {
	.name = "ili7807g_hd_plus_vdo_truly_na",
#endif
