...
static struct LCM_setting_table init_setting_vdo[] = {
    ...
    {0xFF,1,{0x23}},
    {0x25,1,{0x03}},
    {0x01,16,{0x00,0x00,0x00,0x21,0x00,0x51,0x00,0x6e,0x00,0x83,0x00,0x98,0x00,0xa8,0x00,0xb9}},
    {0x02,16,{0x00,0xc4,0x00,0xf1,0x01,0x12,0x01,0x44,0x01,0x68,0x01,0x9c,0x01,0xc4,0x01,0xc6}},
    {0x03,16,{0x01,0xf3,0x02,0x30,0x02,0x5a,0x02,0x94,0x02,0xba,0x02,0xf0,0x03,0x03,0x03,0x15}},
    {0x04,12,{0x03,0x32,0x03,0x42,0x03,0x69,0x03,0x96,0x03,0xd0,0x03,0xff}},
    {0x0D,16,{0x00,0x00,0x00,0x21,0x00,0x51,0x00,0x6e,0x00,0x83,0x00,0x98,0x00,0xa8,0x00,0xb9}},
    {0x0E,16,{0x00,0xc4,0x00,0xf1,0x01,0x12,0x01,0x44,0x01,0x68,0x01,0x9c,0x01,0xc4,0x01,0xc6}},
    {0x0F,16,{0x01,0xf3,0x02,0x30,0x02,0x5a,0x02,0x94,0x02,0xba,0x02,0xf0,0x03,0x03,0x03,0x15}},
    {0x10,12,{0x03,0x32,0x03,0x42,0x03,0x69,0x03,0x96,0x03,0xd0,0x03,0xff}},
    {0x2D,1,{0x65}},
    {0x37,1,{0x01}},
    {0x2E,1,{0x00}},
    {0x32,1,{0x01}},
...
{
    LCM_LOGI("%s,[M04] gc7202_ls_hsd backlight: level = %d\n", __func__, level);

    if (level == 0) {
        pr_notice("[LCM],[M04] gc7202_ls_hsd backlight off, diming disable first\n");
        push_table(NULL,
