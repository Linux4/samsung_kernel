...
static struct LCM_setting_table init_setting_vdo[] = {
    ...
    {0xDE,1,{0x00}},
    {0xB3,18,{0x10,0x80,0x85,0x00,0x65,0x1E,0x00,0x00,0x00,0x00,0x64,0x64,0x3C,0x3C,0x33,0x11,0x5A,0x5A}},
    ...
    {0xBD,2,{0x00,0xB1}},
    {0xC0,5,{0x00,0xD5,0x10,0xD5,0x10}},
    {0xCB,42,{0x5e,0x55,0x4f,0x40,0x36,0x32,0x22,0x26,0x0f,0x28,0x27,0x25,0x40,0x2c,0x32,0x23,0x21,0x16,0x0a,0x05,0x02,0x5e,0x55,0x4f,0x40,0x36,0x32,0x22,0x26,0x0f,0x28,0x27,0x25,0x40,0x2c,0x32,0x23,0x21,0x16,0x0a,0x05,0x02}},
    {0xCC,1,{0x32}},
    {0xCD,2,{0x10,0x10}},
    {0xBF,4,{0x5A,0x3C,0x33,0xC3}},
    {0xC3,13,{0x13,0x00,0x06,0x16,0x99,0x00,0x9E,0x08,0x16,0x04,0x18,0x08,0x16}},
    {0xC5,10,{0x30,0x20,0x87,0x00,0x00,0x00,0x00,0x38,0x00,0x11}},
    {0xC6,4,{0x00,0xB6,0xD2,0x14}},
    {0xCE,18,{0x01,0x3C,0x00,0x00,0x00,0x3C,0x00,0x3C,0x3F,0x3F,0x00,0x3C,0x3C,0x3C,0x3C,0x00,0x3C,0x3C}},
    {0xCF,16,{0x00,0x00,0x00,0x00,0x00,0x00,0xC0,0xC0,0xC0,0xC0,0xC0,0xC0,0xC0,0xC0,0xC0,0xC0}},
    {0xD0,29,{0x00,0x1F,0x1F,0x1F,0x1F,0x1F,0x1F,0x15,0x15,0x16,0x1F,0x05,0x07,0x09,0x0B,0x1F,0x01,0x03,0x1F,0x1F,0x1F,0x1F,0x1F,0x00,0x00,0x00,0x00,0x00,0x00}},
    {0xD1,29,{0x00,0x1F,0x1F,0x1F,0x1F,0x1F,0x1F,0x15,0x15,0x16,0x1F,0x04,0x06,0x08,0x0A,0x1F,0x00,0x02,0x1F,0x1F,0x1F,0x1F,0x1F,0x00,0x00,0x00,0x00,0x00,0x00}},
    {0xD2,29,{0x00,0x1F,0x1F,0x1F,0x1F,0x15,0x1F,0x1F,0x15,0x16,0x1F,0x0A,0x08,0x06,0x04,0x1F,0x02,0x00,0x1F,0x1F,0x1F,0x1F,0x1F,0x00,0x00,0x00,0x03,0x00,0x00}},
    {0xD3,29,{0x00,0x1F,0x1F,0x1F,0x1F,0x15,0x1F,0x1F,0x15,0x16,0x1F,0x0B,0x09,0x07,0x05,0x1F,0x03,0x01,0x1F,0x1F,0x1F,0x1F,0x1F,0x00,0x00,0x00,0x03,0x00,0x00}},
    {0xD4,62,{0x30,0x00,0x00,0x07,0x00,0x09,0x00,0x00,0x00,0x00,0x00,0x06,0x06,0x00,0x10,0x26,0x54,0x00,0x04,0x03,0x03,0x00,0x01,0x00,0x04,0x01,0x01,0x11,0x60,0x03,0x00,0x05,0x01,0x01,0x00,0x00,0x06,0x04,0x07,0x06,0x55,0x06,0x53,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x81,0x03,0xD4}},
    {0xD5,27,{0x03,0x10,0x03,0x00,0x01,0x00,0x00,0x00,0x00,0x43,0x00,0x00,0x00,0x07,0x32,0x5A,0x00,0x48,0x77,0x00,0x02,0x1E,0x02,0x73,0x00,0x0E,0x08}},
    {0xD7,19,{0x00,0x7C,0x7C,0x7C,0x7C,0x7C,0x7C,0x7C,0x7C,0x7C,0x7C,0x7C,0x7C,0x7C,0x7C,0x7C,0x7C,0x7C,0x7C}},
    {0xDE,1,{0x01}},
    {0xB5,1,{0x6F}},
    {0xC5,2,{0x22,0x12}},
    {0xC6,7,{0x3F,0x0C,0x00,0x00,0x01,0x80,0x60}},
    {0xDE,1,{0x02}},
...
/* HS03S code added for SR-AL5625-01-506 by gaozhengwei at 20210526 start */
#ifdef CONFIG_HQ_SET_LCD_BIAS
    lcd_bias_set_vspn(ON, VSP_FIRST_VSN_AFTER, 5800);  //open lcd bias
#else
    MDELAY(2);
    display_bias_enable();
#endif
...
/* HS03S code added for SR-AL5625-01-506 by gaozhengwei at 20210526 start */
#ifdef CONFIG_HQ_SET_LCD_BIAS
    lcd_bias_set_vspn(OFF, VSN_FIRST_VSP_AFTER, 5800);  //close lcd bias
#else
...
{
    LCM_LOGI("%s,[M04] jd9365t_txd_ctc_jbpd backlight: level = %d\n", __func__, level);

    if (level == 0) {
        pr_notice("[LCM],[M04] jd9365t_txd_ctc_jbpd backlight off, diming disable first\n");
        push_table(NULL,
    ...
    /* HS04 code for SR-AL6398A-01-148 by suyurui at 20220719 start */
    bl_level[0].para_list[0] = level >> 8;
    bl_level[0].para_list[1] = level & 0xFF;
    /* HS04 code for SR-AL6398A-01-148 by suyurui at 20220719 end */

    push_table(handle, bl_level,
        sizeof(bl_level) / sizeof(struct LCM_setting_table), 1);
}

struct LCM_DRIVER lcd_jd9365t_txd_ctc_jbpd_mipi_hdp_video_lcm_drv = {
    .name = "lcd_jd9365t_txd_ctc_jbpd_mipi_hdp_video",
