...
/* HS04 code for DEAL6398A-398 by zhawei at 20220803 start */
#define F6_VALUE 3
#define F6_CODELINE 32
#define F6_CHARLEN 22
/* HS04 code for DEAL6398A-398 by zhawei at 20220803 end*/
...
static struct LCM_setting_table init_setting_vdo[] = {
    {0xF0, 2,{0x5A,0x59}},
    {0xF1, 2,{0xA5,0xA6}},
    {0xB0,32,{0x87,0x86,0x85,0x84,0x88,0x89,0x04,0x05,0x33,0x33,0x33,0x33,0x03,0x00,0x00,0x78,0x00,0x00,0x0F,0x05,0x04,0x03,0x02,0x01,0x02,0x03,0x04,0x00,0x00,0x00,0x00,0x00}},
    {0xB1,32,{0x53,0x42,0x85,0x81,0x7C,0x00,0x00,0x75,0x00,0x00,0x04,0x08,0x54,0x00,0x00,0x00,0x44,0x40,0x02,0x01,0x40,0x02,0x01,0x40,0x02,0x01,0x40,0x02,0x01,0x00,0x00,0x00}},
    {0xB2,17,{0x54,0xC4,0x82,0x05,0x40,0x02,0x01,0x40,0x02,0x01,0x05,0x05,0x54,0x0C,0x0C,0x0D,0x0B}},
    {0xB3,32,{0x02,0x0C,0x0A,0x0E,0x0A,0x26,0x26,0x91,0xA2,0x33,0x44,0x00,0x26,0x00,0x18,0x01,0x02,0x08,0x20,0x30,0x0E,0x09,0x42,0x20,0x00,0x20,0x40,0x08,0x09,0x22,0x33,0x00}},
    {0xB4,28,{0x09,0x00,0x00,0x23,0x00,0x05,0x07,0x22,0x22,0x0D,0x0D,0x0F,0x0F,0x11,0x11,0x13,0x13,0x03,0x03,0x03,0x03,0x03,0xFF,0xFF,0xFC,0x10,0x00,0x00}},
    {0xB5,28,{0x08,0x00,0x00,0x23,0x00,0x04,0x06,0x22,0x22,0x0C,0x0C,0x0E,0x0E,0x10,0x10,0x12,0x12,0x03,0x03,0x03,0x03,0x03,0xFF,0xFF,0xFC,0x10,0x00,0x00}},
    ...
    {0xBE,10,{0x77,0x77,0x50,0x32,0x0C,0x77,0x43,0x07,0x0E,0x0E}},
    {0xBF, 8,{0x07,0x25,0x07,0x25,0x7F,0x00,0x11,0x04}},
    {0xC0, 9,{0x10,0x00,0x1F,0xFF,0xFF,0xFF,0x00,0xFF,0x00}},
    {0xC1,19,{0xC0,0x20,0x20,0x96,0x04,0x28,0x28,0x04,0x2A,0x40,0x36,0x00,0x07,0xC0,0x10,0xFF,0x95,0x01,0xC0}},
    {0xC2, 1,{0x00}},
    {0xC3, 9,{0x06,0x00,0xFF,0x00,0xFF,0x00,0x00,0x81,0x01}},
    {0xC4,10,{0x84,0x01,0x2B,0x41,0x00,0x3C,0x00,0x03,0x03,0x2E}},
    {0xC5,11,{0x03,0x1C,0xC0,0xC0,0x40,0x10,0x42,0x44,0x0C,0x0D,0x14}},
    {0xC6,10,{0x87,0xA0,0x2A,0x29,0x29,0x00,0x64,0x34,0x08,0x04}},
    {0xC7,22,{0xF7,0xB1,0x8E,0x74,0x46,0x22,0xF1,0x40,0x0B,0xDF,0xB6,0x8B,0xE8,0xC2,0xA6,0x7F,0x68,0x44,0x1A,0x7E,0xC0,0x00}},
    {0xC8,22,{0xF7,0xB1,0x8E,0x74,0x46,0x22,0xF1,0x40,0x0B,0xDF,0xB6,0x8B,0xE8,0xC2,0xA6,0x7F,0x68,0x44,0x1A,0x7E,0xC0,0x00}},
...
{
    LCM_LOGI("%s,nl9911c_hr_hr backlight: level = %d\n", __func__, level);

    if (level == 0) {
        pr_notice("[LCM],nl9911c_hr_hr backlight off, diming disable first\n");
        push_table(NULL,
...
struct LCM_DRIVER lcd_nl9911c_hr_hr_mipi_hdp_video_lcm_drv = {
    .name = "lcd_nl9911c_hr_hr_mipi_hdp_video",
