...
{
    LCM_LOGI("%s,[M04] jd9365t_txd_ctc backlight: level = %d\n", __func__, level);

    if (level == 0) {
        pr_notice("[LCM],[M04] jd9365t_txd_ctc backlight off, diming disable first\n");
        push_table(NULL,
...
struct LCM_DRIVER lcd_jd9365t_txd_ctc_mipi_hdp_video_lcm_drv = {
    .name = "lcd_jd9365t_txd_ctc_mipi_hdp_video",
