...
#include "nt36525b_a01core_param.h"
...
#define DPUI_MODEL_NAME		"NT36525B"
#endif
...
static int nt36525b_read_id(struct lcd_info *lcd)
{
	int ret = 0;
...
static int nt36525b_read_rddpm(struct lcd_info *lcd)
{
	int ret = 0;
...
static int nt36525b_read_init_info(struct lcd_info *lcd)
{
	int ret = 0;
...
static int nt36525b_exit(struct lcd_info *lcd)
{
	int ret = 0;
...
static int nt36525b_displayon(struct lcd_info *lcd)
{
	int ret = 0;
...
static int nt36525b_init(struct lcd_info *lcd)
{
	int ret = 0;
...
#if defined(CONFIG_SEC_FACTORY)
	nt36525b_read_id(lcd);
#endif

	DSI_WRITE(SEQ_NT36525B_FF_0, ARRAY_SIZE(SEQ_NT36525B_FF_0));
    msleep(1);
	DSI_WRITE(SEQ_NT36525B_FB_0, ARRAY_SIZE(SEQ_NT36525B_FB_0));
	DSI_WRITE(SEQ_NT36525B_00_0, ARRAY_SIZE(SEQ_NT36525B_00_0));
	DSI_WRITE(SEQ_NT36525B_01, ARRAY_SIZE(SEQ_NT36525B_01));
	DSI_WRITE(SEQ_NT36525B_03, ARRAY_SIZE(SEQ_NT36525B_03));
	DSI_WRITE(SEQ_NT36525B_05, ARRAY_SIZE(SEQ_NT36525B_05));
	DSI_WRITE(SEQ_NT36525B_07_0, ARRAY_SIZE(SEQ_NT36525B_07_0));
	DSI_WRITE(SEQ_NT36525B_08_0, ARRAY_SIZE(SEQ_NT36525B_08_0));
	DSI_WRITE(SEQ_NT36525B_0E, ARRAY_SIZE(SEQ_NT36525B_0E));
	DSI_WRITE(SEQ_NT36525B_0F_0, ARRAY_SIZE(SEQ_NT36525B_0F_0));
	DSI_WRITE(SEQ_NT36525B_1F_0, ARRAY_SIZE(SEQ_NT36525B_1F_0));
	DSI_WRITE(SEQ_NT36525B_69, ARRAY_SIZE(SEQ_NT36525B_69));
	DSI_WRITE(SEQ_NT36525B_94_0, ARRAY_SIZE(SEQ_NT36525B_94_0));
	DSI_WRITE(SEQ_NT36525B_95, ARRAY_SIZE(SEQ_NT36525B_95));
	DSI_WRITE(SEQ_NT36525B_96, ARRAY_SIZE(SEQ_NT36525B_96));
	DSI_WRITE(SEQ_NT36525B_FF_1, ARRAY_SIZE(SEQ_NT36525B_FF_1));
	msleep(1);
	DSI_WRITE(SEQ_NT36525B_FB_1, ARRAY_SIZE(SEQ_NT36525B_FB_1));
	DSI_WRITE(SEQ_NT36525B_00_1, ARRAY_SIZE(SEQ_NT36525B_00_1));
	DSI_WRITE(SEQ_NT36525B_04, ARRAY_SIZE(SEQ_NT36525B_04));
	DSI_WRITE(SEQ_NT36525B_06, ARRAY_SIZE(SEQ_NT36525B_06));
	DSI_WRITE(SEQ_NT36525B_07_1, ARRAY_SIZE(SEQ_NT36525B_07_1));
	DSI_WRITE(SEQ_NT36525B_08_1, ARRAY_SIZE(SEQ_NT36525B_08_1));
	DSI_WRITE(SEQ_NT36525B_0A_0, ARRAY_SIZE(SEQ_NT36525B_0A_0));
	DSI_WRITE(SEQ_NT36525B_0B_0, ARRAY_SIZE(SEQ_NT36525B_0B_0));
	DSI_WRITE(SEQ_NT36525B_0C_0, ARRAY_SIZE(SEQ_NT36525B_0C_0));
	DSI_WRITE(SEQ_NT36525B_0D, ARRAY_SIZE(SEQ_NT36525B_0D));
	DSI_WRITE(SEQ_NT36525B_0F_1, ARRAY_SIZE(SEQ_NT36525B_0F_1));
	DSI_WRITE(SEQ_NT36525B_10, ARRAY_SIZE(SEQ_NT36525B_10));
	DSI_WRITE(SEQ_NT36525B_12_0, ARRAY_SIZE(SEQ_NT36525B_12_0));
	DSI_WRITE(SEQ_NT36525B_13_0, ARRAY_SIZE(SEQ_NT36525B_13_0));
	DSI_WRITE(SEQ_NT36525B_14, ARRAY_SIZE(SEQ_NT36525B_14));
	DSI_WRITE(SEQ_NT36525B_16_0, ARRAY_SIZE(SEQ_NT36525B_16_0));
	DSI_WRITE(SEQ_NT36525B_1A, ARRAY_SIZE(SEQ_NT36525B_1A));
	DSI_WRITE(SEQ_NT36525B_1C, ARRAY_SIZE(SEQ_NT36525B_1C));
	DSI_WRITE(SEQ_NT36525B_1D, ARRAY_SIZE(SEQ_NT36525B_1D));
	DSI_WRITE(SEQ_NT36525B_1E, ARRAY_SIZE(SEQ_NT36525B_1E));
	DSI_WRITE(SEQ_NT36525B_20, ARRAY_SIZE(SEQ_NT36525B_20));
	DSI_WRITE(SEQ_NT36525B_21, ARRAY_SIZE(SEQ_NT36525B_21));
	DSI_WRITE(SEQ_NT36525B_22, ARRAY_SIZE(SEQ_NT36525B_22));
	DSI_WRITE(SEQ_NT36525B_23, ARRAY_SIZE(SEQ_NT36525B_23));
	DSI_WRITE(SEQ_NT36525B_25, ARRAY_SIZE(SEQ_NT36525B_25));
	DSI_WRITE(SEQ_NT36525B_26_0, ARRAY_SIZE(SEQ_NT36525B_26_0));
	DSI_WRITE(SEQ_NT36525B_28, ARRAY_SIZE(SEQ_NT36525B_28));
	DSI_WRITE(SEQ_NT36525B_29_0, ARRAY_SIZE(SEQ_NT36525B_29_0));
	DSI_WRITE(SEQ_NT36525B_2A, ARRAY_SIZE(SEQ_NT36525B_2A));
	DSI_WRITE(SEQ_NT36525B_2F, ARRAY_SIZE(SEQ_NT36525B_2F));
	DSI_WRITE(SEQ_NT36525B_30, ARRAY_SIZE(SEQ_NT36525B_30));
	DSI_WRITE(SEQ_NT36525B_33, ARRAY_SIZE(SEQ_NT36525B_33));
	DSI_WRITE(SEQ_NT36525B_34, ARRAY_SIZE(SEQ_NT36525B_34));
	DSI_WRITE(SEQ_NT36525B_37, ARRAY_SIZE(SEQ_NT36525B_37));
	DSI_WRITE(SEQ_NT36525B_39, ARRAY_SIZE(SEQ_NT36525B_39));
	DSI_WRITE(SEQ_NT36525B_3A, ARRAY_SIZE(SEQ_NT36525B_3A));
	DSI_WRITE(SEQ_NT36525B_3B, ARRAY_SIZE(SEQ_NT36525B_3B));
	DSI_WRITE(SEQ_NT36525B_3D, ARRAY_SIZE(SEQ_NT36525B_3D));
	DSI_WRITE(SEQ_NT36525B_4D, ARRAY_SIZE(SEQ_NT36525B_4D));
	DSI_WRITE(SEQ_NT36525B_4E, ARRAY_SIZE(SEQ_NT36525B_4E));
	DSI_WRITE(SEQ_NT36525B_51, ARRAY_SIZE(SEQ_NT36525B_51));
	DSI_WRITE(SEQ_NT36525B_52, ARRAY_SIZE(SEQ_NT36525B_52));
	DSI_WRITE(SEQ_NT36525B_55, ARRAY_SIZE(SEQ_NT36525B_55));
	DSI_WRITE(SEQ_NT36525B_56, ARRAY_SIZE(SEQ_NT36525B_56));
	DSI_WRITE(SEQ_NT36525B_5A_0, ARRAY_SIZE(SEQ_NT36525B_5A_0));
	DSI_WRITE(SEQ_NT36525B_5B_0, ARRAY_SIZE(SEQ_NT36525B_5B_0));
	DSI_WRITE(SEQ_NT36525B_5C_0, ARRAY_SIZE(SEQ_NT36525B_5C_0));
	DSI_WRITE(SEQ_NT36525B_5D_0, ARRAY_SIZE(SEQ_NT36525B_5D_0));
	DSI_WRITE(SEQ_NT36525B_5E_0, ARRAY_SIZE(SEQ_NT36525B_5E_0));
	DSI_WRITE(SEQ_NT36525B_5F_0, ARRAY_SIZE(SEQ_NT36525B_5F_0));
	DSI_WRITE(SEQ_NT36525B_60_0, ARRAY_SIZE(SEQ_NT36525B_60_0));
	DSI_WRITE(SEQ_NT36525B_61_0, ARRAY_SIZE(SEQ_NT36525B_61_0));
	DSI_WRITE(SEQ_NT36525B_64, ARRAY_SIZE(SEQ_NT36525B_64));
	DSI_WRITE(SEQ_NT36525B_82, ARRAY_SIZE(SEQ_NT36525B_82));
	DSI_WRITE(SEQ_NT36525B_83, ARRAY_SIZE(SEQ_NT36525B_83));
	DSI_WRITE(SEQ_NT36525B_85, ARRAY_SIZE(SEQ_NT36525B_85));
	DSI_WRITE(SEQ_NT36525B_86, ARRAY_SIZE(SEQ_NT36525B_86));
	DSI_WRITE(SEQ_NT36525B_92, ARRAY_SIZE(SEQ_NT36525B_92));
	DSI_WRITE(SEQ_NT36525B_93, ARRAY_SIZE(SEQ_NT36525B_93));
	DSI_WRITE(SEQ_NT36525B_94_1, ARRAY_SIZE(SEQ_NT36525B_94_1));
	DSI_WRITE(SEQ_NT36525B_AB, ARRAY_SIZE(SEQ_NT36525B_AB));
	DSI_WRITE(SEQ_NT36525B_AC, ARRAY_SIZE(SEQ_NT36525B_AC));
	DSI_WRITE(SEQ_NT36525B_AD, ARRAY_SIZE(SEQ_NT36525B_AD));
	DSI_WRITE(SEQ_NT36525B_AF, ARRAY_SIZE(SEQ_NT36525B_AF));
	DSI_WRITE(SEQ_NT36525B_B0_0, ARRAY_SIZE(SEQ_NT36525B_B0_0));
	DSI_WRITE(SEQ_NT36525B_B1_0, ARRAY_SIZE(SEQ_NT36525B_B1_0));
	DSI_WRITE(SEQ_NT36525B_FF_2, ARRAY_SIZE(SEQ_NT36525B_FF_2));
	msleep(1);
	DSI_WRITE(SEQ_NT36525B_FB_2, ARRAY_SIZE(SEQ_NT36525B_FB_2));
	DSI_WRITE(SEQ_NT36525B_0A_1, ARRAY_SIZE(SEQ_NT36525B_0A_1));
	DSI_WRITE(SEQ_NT36525B_0B_1, ARRAY_SIZE(SEQ_NT36525B_0B_1));
	DSI_WRITE(SEQ_NT36525B_0C_1, ARRAY_SIZE(SEQ_NT36525B_0C_1));
	DSI_WRITE(SEQ_NT36525B_17, ARRAY_SIZE(SEQ_NT36525B_17));
	DSI_WRITE(SEQ_NT36525B_18, ARRAY_SIZE(SEQ_NT36525B_18));
	DSI_WRITE(SEQ_NT36525B_19, ARRAY_SIZE(SEQ_NT36525B_19));
	DSI_WRITE(SEQ_NT36525B_58, ARRAY_SIZE(SEQ_NT36525B_58));
	DSI_WRITE(SEQ_NT36525B_59, ARRAY_SIZE(SEQ_NT36525B_59));
	DSI_WRITE(SEQ_NT36525B_5A_1, ARRAY_SIZE(SEQ_NT36525B_5A_1));
	DSI_WRITE(SEQ_NT36525B_5B_1, ARRAY_SIZE(SEQ_NT36525B_5B_1));
	DSI_WRITE(SEQ_NT36525B_5C_1, ARRAY_SIZE(SEQ_NT36525B_5C_1));
	DSI_WRITE(SEQ_NT36525B_5D_1, ARRAY_SIZE(SEQ_NT36525B_5D_1));
	DSI_WRITE(SEQ_NT36525B_5E_1, ARRAY_SIZE(SEQ_NT36525B_5E_1));
	DSI_WRITE(SEQ_NT36525B_5F_1, ARRAY_SIZE(SEQ_NT36525B_5F_1));
	DSI_WRITE(SEQ_NT36525B_60_1, ARRAY_SIZE(SEQ_NT36525B_60_1));
	DSI_WRITE(SEQ_NT36525B_61_1, ARRAY_SIZE(SEQ_NT36525B_61_1));
	DSI_WRITE(SEQ_NT36525B_62, ARRAY_SIZE(SEQ_NT36525B_62));
	DSI_WRITE(SEQ_NT36525B_65, ARRAY_SIZE(SEQ_NT36525B_65));
	DSI_WRITE(SEQ_NT36525B_66, ARRAY_SIZE(SEQ_NT36525B_66));
	DSI_WRITE(SEQ_NT36525B_C0_0, ARRAY_SIZE(SEQ_NT36525B_C0_0));
	DSI_WRITE(SEQ_NT36525B_CA, ARRAY_SIZE(SEQ_NT36525B_CA));
	DSI_WRITE(SEQ_NT36525B_CC, ARRAY_SIZE(SEQ_NT36525B_CC));
	DSI_WRITE(SEQ_NT36525B_D3, ARRAY_SIZE(SEQ_NT36525B_D3));
	DSI_WRITE(SEQ_NT36525B_D4, ARRAY_SIZE(SEQ_NT36525B_D4));
	DSI_WRITE(SEQ_NT36525B_D5, ARRAY_SIZE(SEQ_NT36525B_D5));
	DSI_WRITE(SEQ_NT36525B_D6, ARRAY_SIZE(SEQ_NT36525B_D6));
	DSI_WRITE(SEQ_NT36525B_D7, ARRAY_SIZE(SEQ_NT36525B_D7));
	DSI_WRITE(SEQ_NT36525B_FF_3, ARRAY_SIZE(SEQ_NT36525B_FF_3));
	msleep(1);
	DSI_WRITE(SEQ_NT36525B_FB_3, ARRAY_SIZE(SEQ_NT36525B_FB_3));
	DSI_WRITE(SEQ_NT36525B_00_2, ARRAY_SIZE(SEQ_NT36525B_00_2));
	DSI_WRITE(SEQ_NT36525B_FF_4, ARRAY_SIZE(SEQ_NT36525B_FF_4));
	msleep(1);
	DSI_WRITE(SEQ_NT36525B_FB_4, ARRAY_SIZE(SEQ_NT36525B_FB_4));
	DSI_WRITE(SEQ_NT36525B_13_1, ARRAY_SIZE(SEQ_NT36525B_13_1));
	DSI_WRITE(SEQ_NT36525B_15_0, ARRAY_SIZE(SEQ_NT36525B_15_0));
	DSI_WRITE(SEQ_NT36525B_1F_1, ARRAY_SIZE(SEQ_NT36525B_1F_1));
	DSI_WRITE(SEQ_NT36525B_26_1, ARRAY_SIZE(SEQ_NT36525B_26_1));
	DSI_WRITE(SEQ_NT36525B_C0_1, ARRAY_SIZE(SEQ_NT36525B_C0_1));
	DSI_WRITE(SEQ_NT36525B_C1, ARRAY_SIZE(SEQ_NT36525B_C1));
	DSI_WRITE(SEQ_NT36525B_C2, ARRAY_SIZE(SEQ_NT36525B_C2));
	DSI_WRITE(SEQ_NT36525B_C3, ARRAY_SIZE(SEQ_NT36525B_C3));
	DSI_WRITE(SEQ_NT36525B_C4, ARRAY_SIZE(SEQ_NT36525B_C4));
	DSI_WRITE(SEQ_NT36525B_C5, ARRAY_SIZE(SEQ_NT36525B_C5));
	DSI_WRITE(SEQ_NT36525B_C6, ARRAY_SIZE(SEQ_NT36525B_C6));
	DSI_WRITE(SEQ_NT36525B_C7, ARRAY_SIZE(SEQ_NT36525B_C7));
	DSI_WRITE(SEQ_NT36525B_FF_5, ARRAY_SIZE(SEQ_NT36525B_FF_5));
	msleep(1);
	DSI_WRITE(SEQ_NT36525B_FB_5, ARRAY_SIZE(SEQ_NT36525B_FB_5));
	DSI_WRITE(SEQ_NT36525B_07_2, ARRAY_SIZE(SEQ_NT36525B_07_2));
	DSI_WRITE(SEQ_NT36525B_08_2, ARRAY_SIZE(SEQ_NT36525B_08_2));
	DSI_WRITE(SEQ_NT36525B_12_1, ARRAY_SIZE(SEQ_NT36525B_12_1));
	DSI_WRITE(SEQ_NT36525B_15_1, ARRAY_SIZE(SEQ_NT36525B_15_1));
	DSI_WRITE(SEQ_NT36525B_16_1, ARRAY_SIZE(SEQ_NT36525B_16_1));
	DSI_WRITE(SEQ_NT36525B_FF_6, ARRAY_SIZE(SEQ_NT36525B_FF_6));
	msleep(1);
	DSI_WRITE(SEQ_NT36525B_FB_6, ARRAY_SIZE(SEQ_NT36525B_FB_6));
	DSI_WRITE(SEQ_NT36525B_B0_1, ARRAY_SIZE(SEQ_NT36525B_B0_1));
	DSI_WRITE(SEQ_NT36525B_B1_1, ARRAY_SIZE(SEQ_NT36525B_B1_1));
	DSI_WRITE(SEQ_NT36525B_B2_0, ARRAY_SIZE(SEQ_NT36525B_B2_0));
	DSI_WRITE(SEQ_NT36525B_B3_0, ARRAY_SIZE(SEQ_NT36525B_B3_0));
	DSI_WRITE(SEQ_NT36525B_B4_0, ARRAY_SIZE(SEQ_NT36525B_B4_0));
	DSI_WRITE(SEQ_NT36525B_B5_0, ARRAY_SIZE(SEQ_NT36525B_B5_0));
	DSI_WRITE(SEQ_NT36525B_B6_0, ARRAY_SIZE(SEQ_NT36525B_B6_0));
	DSI_WRITE(SEQ_NT36525B_B7_0, ARRAY_SIZE(SEQ_NT36525B_B7_0));
	DSI_WRITE(SEQ_NT36525B_B8_0, ARRAY_SIZE(SEQ_NT36525B_B8_0));
	DSI_WRITE(SEQ_NT36525B_B9_0, ARRAY_SIZE(SEQ_NT36525B_B9_0));
	DSI_WRITE(SEQ_NT36525B_BA_0, ARRAY_SIZE(SEQ_NT36525B_BA_0));
	DSI_WRITE(SEQ_NT36525B_BB_0, ARRAY_SIZE(SEQ_NT36525B_BB_0));
	DSI_WRITE(SEQ_NT36525B_FF_7, ARRAY_SIZE(SEQ_NT36525B_FF_7));
	msleep(1);
	DSI_WRITE(SEQ_NT36525B_FB_7, ARRAY_SIZE(SEQ_NT36525B_FB_7));
	DSI_WRITE(SEQ_NT36525B_B0_2, ARRAY_SIZE(SEQ_NT36525B_B0_2));
	DSI_WRITE(SEQ_NT36525B_B1_2, ARRAY_SIZE(SEQ_NT36525B_B1_2));
	DSI_WRITE(SEQ_NT36525B_B2_1, ARRAY_SIZE(SEQ_NT36525B_B2_1));
	DSI_WRITE(SEQ_NT36525B_B3_1, ARRAY_SIZE(SEQ_NT36525B_B3_1));
	DSI_WRITE(SEQ_NT36525B_B4_1, ARRAY_SIZE(SEQ_NT36525B_B4_1));
	DSI_WRITE(SEQ_NT36525B_B5_1, ARRAY_SIZE(SEQ_NT36525B_B5_1));
	DSI_WRITE(SEQ_NT36525B_B6_1, ARRAY_SIZE(SEQ_NT36525B_B6_1));
	DSI_WRITE(SEQ_NT36525B_B7_1, ARRAY_SIZE(SEQ_NT36525B_B7_1));
	DSI_WRITE(SEQ_NT36525B_B8_1, ARRAY_SIZE(SEQ_NT36525B_B8_1));
	DSI_WRITE(SEQ_NT36525B_B9_1, ARRAY_SIZE(SEQ_NT36525B_B9_1));
	DSI_WRITE(SEQ_NT36525B_BA_1, ARRAY_SIZE(SEQ_NT36525B_BA_1));
	DSI_WRITE(SEQ_NT36525B_BB_1, ARRAY_SIZE(SEQ_NT36525B_BB_1));
	DSI_WRITE(SEQ_NT36525B_FF_8, ARRAY_SIZE(SEQ_NT36525B_FF_8));
	DSI_WRITE(SEQ_NT36525B_FB_8, ARRAY_SIZE(SEQ_NT36525B_FB_8));
	DSI_WRITE(SEQ_NT36525B_07_3, ARRAY_SIZE(SEQ_NT36525B_07_3));
	DSI_WRITE(SEQ_NT36525B_08_3, ARRAY_SIZE(SEQ_NT36525B_08_3));
	DSI_WRITE(SEQ_NT36525B_FF_9, ARRAY_SIZE(SEQ_NT36525B_FF_9));
	msleep(1);
	DSI_WRITE(SEQ_NT36525B_FB_9, ARRAY_SIZE(SEQ_NT36525B_FB_9));
	DSI_WRITE(SEQ_NT36525B_BA_2, ARRAY_SIZE(SEQ_NT36525B_BA_2));
	DSI_WRITE(SEQ_DISPLAY_ON, ARRAY_SIZE(SEQ_DISPLAY_ON));
	msleep(10);
...
static int nt36525b_register_notifier(struct lcd_info *lcd)
{
...
static int nt36525b_probe(struct lcd_info *lcd)
{
	int ret = 0;
	...
	ret = nt36525b_read_init_info(lcd);
	if (ret < 0)
...
static int smcdsd_panel_probe(struct platform_device *pdev)
{
	...
	ret = nt36525b_probe(lcd);
	if (ret < 0)
		dev_info(&lcd->ld->dev, "%s: failed to probe panel\n", __func__);

	lcd_init_sysfs(lcd);

	nt36525b_register_notifier(lcd);
...
struct mipi_dsi_lcd_driver nt36525b_mipi_lcd_driver = {
	.driver = {
		.name = "nt36525b",
	},
