...
static int nt36525b_dtc_read_id(struct lcd_info *lcd)
{
	int i = 0, ret = 0;
...
static int nt36525b_dtc_read_init_info(struct lcd_info *lcd)
{
	int ret = 0;
...
static int nt36525b_dtc_init(struct lcd_info *lcd)
{
	...
	nt36525b_dtc_read_init_info(lcd);
