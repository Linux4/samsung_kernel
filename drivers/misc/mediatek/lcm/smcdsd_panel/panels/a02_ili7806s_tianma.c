...
#include "a02_ili7806s_tianma_param.h"
#include "dd.h"
...
static int ili7806s_read_id(struct lcd_info *lcd)
{
	int i, ret = 0;
...
static int ili7806s_read_init_info(struct lcd_info *lcd)
{
	int ret = 0;
