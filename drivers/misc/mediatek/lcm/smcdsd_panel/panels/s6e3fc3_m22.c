...
#include "mdnie.h"
#include "s6e3fc3_m22_mdnie.h"
#endif

#include "s6e3fc3_m22_param.h"
#if defined(CONFIG_SMCDSD_DYNAMIC_MIPI)
...
struct mipi_dsi_lcd_driver s6e3fc3_m22_mipi_lcd_driver = {
	.driver = {
		.name = "s6e3fc3_m22",
	},
...
__XX_ADD_LCD_DRIVER(s6e3fc3_m22_mipi_lcd_driver);
