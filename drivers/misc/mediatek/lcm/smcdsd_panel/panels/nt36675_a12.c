...
static int nt36675_read_id(struct lcd_info *lcd, bool need_lock)
{
	int i, ret = 0;
...
static int nt36675_read_init_info(struct lcd_info *lcd, bool need_lock)
{
	int ret = 0;
...
static int nt36675_init(struct lcd_info *lcd)
{
	...
	nt36675_read_init_info(lcd, false);
...
static int nt36675_probe(struct lcd_info *lcd)
{
	...
	nt36675_read_init_info(lcd, true);
