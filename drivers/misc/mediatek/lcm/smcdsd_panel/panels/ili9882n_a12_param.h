...
static struct lcd_seq_info LCD_SEQ_INIT_1[] = {
	...
	{SEQ_ILI9882N_SLEEP_OUT, ARRAY_SIZE(SEQ_ILI9882N_SLEEP_OUT), 80, },
	{SEQ_ILI9882N_DISPLAY_ON, ARRAY_SIZE(SEQ_ILI9882N_DISPLAY_ON), 0, },
	{SEQ_ILI9882N_BRIGHTNESS_MODE, ARRAY_SIZE(SEQ_ILI9882N_BRIGHTNESS_MODE), 0, },
};

static struct lcd_seq_info LCD_SEQ_EXIT_1[] = {
	{SEQ_ILI9882N_DISPLAY_OFF, ARRAY_SIZE(SEQ_ILI9882N_DISPLAY_OFF), 20, },
	{SEQ_ILI9882N_SLEEP_IN, ARRAY_SIZE(SEQ_ILI9882N_SLEEP_IN), 0, },
};
