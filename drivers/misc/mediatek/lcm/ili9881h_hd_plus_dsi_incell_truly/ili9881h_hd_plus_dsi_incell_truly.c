...
//平台AVDD=6V,AVEE=-6V
//平台Vsync=4,Vbp=8,Vfp=236,Hsync=8,Hbp=40,Hbp=40,CLK=720Mbps
//GIP timing
...
{0xD6,0x01,{0x87}},//FTE=TSHD,FTE1=TSHD 1019
{0x27,0x01,{0x20}},
{0x28,0x01,{0x20}},
{0x2E,0x01,{0x01}},
{0xC0,0x01,{0xF7}},
...
{0xE0,0x1b,{0x00,0x0A,0x2A,0x40,0x78,0x40,0xA5,0xCA,0xF9,0x22,0x55,0x60,0x96,0xCB,0xFE,0xAA,0x33,0x72,0x99,0xC9,0xFE,0xF2,0x27,0x65,0x9A,0x03,0xEC}},
{0xE1,0x1b,{0x00,0x00,0x2A,0x40,0x78,0x40,0xA5,0xCA,0xF9,0x22,0x55,0x60,0x96,0xCB,0xFE,0xAA,0x33,0x72,0x99,0xC9,0xFE,0xF2,0x27,0x65,0x9A,0x03,0xEC}},
...
{0x06,0x01,{0xC4}},
{0xFF,0x03,{0x98,0x81,0x03}},
{0x83,0x01,{0x20}},//set PWM frequence 15khz
{0x84,0x01,{0x00}},
...
static void lcm_init(void)
{
	...
	//pr_debug("[LCM] ili9881h--truly--sm5109----init success ----\n");
...
static void lcm_setbacklight_cmdq(void *handle, unsigned int level)
{
	...
	pr_debug("[truly_ili9881h]para_list[0]=%x,para_list[1]=%x\n",bl_level[1].para_list[0],bl_level[1].para_list[1]);
...
{
	pr_err("[truly_ili9881h] cabc get to %d\n", cabc_status);
	*status = cabc_status;
}
...
struct LCM_DRIVER ili9881c_hdp_dsi_cmd_ilitek_rt5081_lcm_drv = {
	.name = "ili9881h_hd_plus_dsi_cmd_truly_lcm_drv",
#else

struct LCM_DRIVER ili9881h_hd_plus_dsi_vdo_truly_lcm_drv = {
	.name = "ili9881h_hd_plus_vdo_truly",
#endif
