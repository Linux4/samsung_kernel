...
static struct LCM_setting_table lcm_diming_disable_setting[] = {
    {0xDF, 3, {0x69,0X96,0x55}},//unlock
    {0x53, 0x01, {0x24}},
    {0xDF,3,{0x00,0X00,0x00}}//lock
};
...
static struct LCM_setting_table init_setting_vdo[] = {
    ...
    {0xCB,42,{0x5E,0x54,0x4C,0x3E,0x32,0x2E,0x1F,0x24,0x0E,0x27,0x26,0x24,0x40,0x2B,0x31,0x23,0x20,0x15,0x08,0x03,0x02,0x5E,0x54,0x4C,0x3E,0x32,0x2E,0x1F,0x24,0x0E,0x27,0x26,0x24,0x40,0x2B,0x31,0x23,0x20,0x15,0x08,0x03,0x02}},
    {0xCC,1,{0x32}},
    {0xCD,2,{0x10,0x10}},
...
{
    LCM_LOGI("%s,jd9365t_hlt_ctc backlight: level = %d\n", __func__, level);

    if (level == 0) {
        pr_notice("[LCM],jd9365t_hlt_ctc backlight off, diming disable first\n");
        push_table(NULL,
