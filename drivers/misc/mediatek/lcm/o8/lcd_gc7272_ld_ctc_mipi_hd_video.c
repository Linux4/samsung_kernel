...
#define LCM_ID_GC7272_LD 0x80

/*A06 code for AL7160A-1673 by yuli at 20240619 start*/
/*backlight from 46ma to 45ma*/
#define BACKLIGHT_MAX_REG_VAL   (4095*45)
...
static struct LCM_setting_table init_setting_cmd[] =
{
    ...
    {0xEF,1,{0x05}},//V5
    {0x29,1,{0x03}},
    {0x01,16,{0x00,0x11,0x00,0x2B,0x00,0x48,0x00,0x60,0x00,0x74,0x00,0x87,0x00,0x92,0x00,0x9D}},
    {0x02,16,{0x00,0xB0,0x00,0xDA,0x00,0xF4,0x01,0x2C,0x01,0x51,0x01,0x89,0x01,0xBE,0x01,0xBF}},
    {0x03,16,{0x01,0xF5,0x02,0x38,0x02,0x68,0x02,0xA6,0x02,0xD0,0x03,0x07,0x03,0x16,0x03,0x2B}},
    {0x04,12,{0x03,0x41,0x03,0x5C,0x03,0x79,0x03,0x9F,0x03,0xCE,0x03,0xEE}},
    {0x0D,16,{0x00,0x11,0x00,0x2B,0x00,0x48,0x00,0x60,0x00,0x74,0x00,0x87,0x00,0x92,0x00,0x9D}},
    {0x0E,16,{0x00,0xB0,0x00,0xDA,0x00,0xF4,0x01,0x2C,0x01,0x51,0x01,0x89,0x01,0xBE,0x01,0xBF}},
    {0x0F,16,{0x01,0xF5,0x02,0x38,0x02,0x68,0x02,0xA6,0x02,0xD0,0x03,0x07,0x03,0x16,0x03,0x2B}},
    {0x10,12,{0x03,0x41,0x03,0x5C,0x03,0x79,0x03,0x9F,0x03,0xCE,0x03,0xEE}},
    {0x2B,1,{0x41}},
    {0xF0,1,{0x01}},
    {0x2D,1,{0x65}},
    {0x2E,1,{0x00}},
...
static void lcm_get_params(struct LCM_PARAMS *params)
{
    ...
    params->dsi.horizontal_frontporch = 305;
...
static void lcm_init(void)
{
    ...
    LCM_LOGI("gc7272_ld_ctc----tps6132----lcm mode = vdo mode :%d----\n",lcm_dsi_mode);
}
...
{
    LCM_LOGI("%s,gc7272_ld_ctc backlight: level = %d\n", __func__, level);

    if (level == 0) {
        pr_notice("[LCM],gc7272_ld_ctc backlight off, diming disable first\n");
        push_table(NULL,
...
struct LCM_DRIVER lcd_gc7272_ld_ctc_mipi_hd_video_lcm_drv = {
    .name = "lcd_gc7272_ld_ctc_mipi_hd_video",
