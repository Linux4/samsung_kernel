...
#define LCM_ID_FT8057P 0x30

/*A06 code for AL7160A-1674 by yuli at 20240607 start*/
/*backlight from 46ma to 43ma*/
#define BACKLIGHT_MAX_REG_VAL   (65295*43)
#define BACKLIGHT_MAX_APP_VAL   (255*46)
/*A06 code for AL7160A-1674 by yuli at 20240607 end*/
...
static struct LCM_setting_table init_setting_cmd[] =
{
    ...
    {0xFF,1,{0x00}},
    {0x00,1,{0x00}},
    {0xE1,16,{0x0D,0x29,0x2B,0x3E,0x4A,0x56,0x6A,0x79,0x7A,0x86,0x88,0x9C,0x6A,0x57,0x59,0x50}},
    {0x00,1,{0x10}},
    {0xE1,8,{0x49,0x3F,0x33,0x29,0x21,0x14,0x17,0x14}},
    {0x00,1,{0x00}},
    {0xE2,16,{0x0D,0x29,0x2B,0x3E,0x4A,0x56,0x6A,0x79,0x7A,0x86,0x88,0x9C,0x6A,0x57,0x59,0x50}},
    {0x00,1,{0x10}},
    {0xE2,8,{0x49,0x3F,0x33,0x29,0x21,0x14,0x17,0x14}},
    {0x00,1,{0x80}},
    {0xC0,6,{0x00,0xFC,0x00,0xC0,0x00,0x10}},
    {0x00,1,{0x90}},
    {0xC0,6,{0x00,0xFC,0x00,0xC0,0x00,0x10}},
    {0x00,1,{0xA0}},
    {0xC0,6,{0x00,0xFC,0x00,0xC0,0x00,0x10}},
    {0x00,1,{0xB0}},
    {0xC0,5,{0x00,0xFD,0x00,0xC0,0x10}},
    {0x00,1,{0xC1}},
    {0xC0,8,{0x00,0xB4,0x00,0xAB,0x00,0x78,0x01,0x00}},
    {0x00,1,{0x70}},
    {0xC0,6,{0x00,0xFC,0x00,0xC0,0x00,0x10}},
    {0x00,1,{0xA3}},
    {0xC1,6,{0x00,0x2E,0x00,0x2E,0x00,0x02}},
    {0x00,1,{0xB7}},
    {0xC1,2,{0x00,0x2E}},
    {0x00,1,{0x73}},
    {0xCE,2,{0x0A,0x09}},
    {0x00,1,{0x80}},
    {0xCE,16,{0x01,0x81,0x09,0x09,0x00,0x67,0x00,0x96,0x00,0x64,0x00,0x96,0x00,0x67,0x00,0x96}},
    {0x00,1,{0x90}},
    {0xCE,15,{0x00,0xA5,0x16,0x8F,0x00,0xA5,0x80,0x09,0x09,0x00,0x07,0xD0,0x11,0x11,0x11}},
    {0x00,1,{0xA0}},
    ...
    {0x00,1,{0xE1}},
    {0xCE,11,{0x06,0x03,0x39,0x04,0x4C,0x02,0xCB,0x00,0x00,0x00,0x00}},
    {0x00,1,{0xF1}},
    {0xCE,9,{0x15,0x15,0x15,0x01,0xC4,0x01,0xC4,0x01,0xC4}},
    {0x00,1,{0xB0}},
    {0xCF,4,{0x00,0x00,0x5E,0x62}},
    {0x00,1,{0xB5}},
    {0xCF,4,{0x03,0x03,0x4C,0x50}},
    {0x00,1,{0xC0}},
    {0xCF,4,{0x06,0x06,0x3B,0x3F}},
    {0x00,1,{0xC5}},
    {0xCF,4,{0x06,0x06,0x3F,0x43}},
    {0x00,1,{0x60}},
    {0xCF,8,{0x00,0x00,0x5E,0x62,0x03,0x03,0x4C,0x50}},
    {0x00,1,{0x70}},
    {0xCF,8,{0x00,0x00,0x5B,0x5F,0x03,0x03,0x94,0x98}},
    {0x00,1,{0xAA}},
    {0xCF,4,{0x80,0x80,0x10,0x0C}},
    {0x00,1,{0xD1}},
    {0xC1,12,{0x05,0xCB,0x08,0x8E,0x10,0x93,0x03,0xD8,0x05,0x61,0x09,0xD8}},
    {0x00,1,{0xE1}},
    {0xC1,2,{0x08,0x8E}},
    {0x00,1,{0xE2}},
    {0xCF,12,{0x07,0x64,0x07,0x63,0x07,0x63,0x07,0x63,0x07,0x63,0x07,0x63}},
    {0x00,1,{0x80}},
    {0xC1,2,{0x00,0x00}},
    {0x00,1,{0x90}},
    {0xC1,1,{0x01}},
    ...
    {0x1F,2,{0x3C,0x3C}},
    {0x00,1,{0x80}},
    {0xCC,16,{0x26,0x00,0x26,0x00,0x17,0x03,0x01,0x00,0x00,0x00,0x0D,0x0B,0x09,0x07,0x00,0x00}},
    {0x00,1,{0x90}},
    {0xCC,8,{0x00,0x00,0x26,0x26,0x26,0x00,0x00,0x00}},
    {0x00,1,{0x80}},
    {0xCD,16,{0x26,0x00,0x26,0x00,0x16,0x02,0x01,0x00,0x00,0x00,0x0C,0x0A,0x08,0x06,0x00,0x00}},
    {0x00,1,{0x90}},
    {0xCD,8,{0x00,0x00,0x26,0x26,0x26,0x00,0x00,0x00}},
    {0x00,1,{0xA0}},
    {0xCC,16,{0x26,0x00,0x26,0x00,0x17,0x03,0x01,0x00,0x00,0x00,0x0D,0x0B,0x09,0x07,0x00,0x00}},
    {0x00,1,{0xB0}},
    {0xCC,8,{0x00,0x00,0x26,0x26,0x26,0x00,0x00,0x00}},
    ...
    {0xCB,1,{0xC1}},
    {0x00,1,{0x90}},
    {0xCB,16,{0x30,0x00,0x00,0x30,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00}},
    {0x00,1,{0xEE}},
    {0xCB,1,{0x00}},
    {0x00,1,{0x90}},
    {0xC3,1,{0x00}},
    ...
    {0xCB,1,{0x05}},
    {0x00,1,{0x68}},
    {0xC2,4,{0x87,0x06,0xC3,0x00}},
    {0x00,1,{0x6C}},
    {0xC2,4,{0x86,0x06,0xC3,0x00}},
    {0x00,1,{0xEA}},
    {0xC2,8,{0x12,0x00,0x07,0x08,0x00,0x00,0x00,0x00}},
    {0x00,1,{0x8C}},
    {0xC2,5,{0x84,0x85,0x25,0xD0,0xBA}},
    {0x00,1,{0x91}},
    {0xC2,5,{0x83,0x84,0x25,0xD0,0xBA}},
    {0x00,1,{0x96}},
    {0xC2,5,{0x82,0x83,0x25,0xD0,0xBA}},
    {0x00,1,{0x9B}},
    {0xC2,5,{0x81,0x82,0x25,0xD0,0xBA}},
    {0x00,1,{0xA0}},
    {0xC2,5,{0x80,0x81,0x25,0xD0,0xBA}},
    {0x00,1,{0xA5}},
    {0xC2,5,{0x01,0x80,0x25,0xD0,0xBA}},
    {0x00,1,{0xAA}},
    {0xC2,5,{0x02,0x01,0x25,0xD0,0xBA}},
    {0x00,1,{0xAF}},
    {0xC2,5,{0x03,0x02,0x25,0xD0,0xBA}},
    {0x00,1,{0xDC}},
    {0xC2,8,{0x77,0x77,0x77,0x77,0x00,0x00,0x00,0x00}},
    {0x00,1,{0x78}},
    {0xC2,4,{0x02,0x03,0x00,0x00}},
    {0x00,1,{0x7C}},
    {0xC2,4,{0x03,0x03,0x00,0x00}},
    {0x00,1,{0x98}},
    {0xC4,1,{0x08}},
    {0x00,1,{0x90}},
    ...
    {0xC1,1,{0x10}},
    {0x00,1,{0x71}},
    {0xC0,5,{0xFC,0x00,0xB1,0x00,0x1E}},
    {0x00,1,{0xD1}},
...
static void lcm_get_params(struct LCM_PARAMS *params)
{
    ...
    params->dsi.vertical_frontporch = 178;
    ...
    params->dsi.horizontal_backporch = 432;
    params->dsi.horizontal_frontporch = 450;
    ...
    /*A06 code for AL7160A-1186 by yuli at 20240516 start*/
    ...
    /*A06 code for AL7160A-1186 by yuli at 20240516 end*/
...
static void lcm_init(void)
{
    ...
    LCM_LOGI("ft8057p_xx_ctc----tps6132----lcm mode = vdo mode :%d----\n",lcm_dsi_mode);
}
...
{
    LCM_LOGI("%s,ft8057p_xx_ctc backlight: level = %d\n", __func__, level);

    if (level == 0) {
        pr_notice("[LCM],ft8057p_xx_ctc backlight off, diming disable first\n");
        push_table(NULL,
            lcm_diming_disable_setting,
            sizeof(lcm_diming_disable_setting) / sizeof(struct LCM_setting_table),
            1);
    }
    /*A06 code for AL7160A-1674 by yuli at 20240606 start*/
    ...
    /*A06 code for AL7160A-1674 by yuli at 20240606 end*/
    push_table(handle, bl_level, ARRAY_SIZE(bl_level), 1);
}

struct LCM_DRIVER lcd_ft8057p_xx_ctc_mipi_hd_video_lcm_drv = {
