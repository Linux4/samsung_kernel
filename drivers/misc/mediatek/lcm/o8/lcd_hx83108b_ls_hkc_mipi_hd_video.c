...
#define LCM_ID_HX83103B_LS 0x20
...
/*a06 code for AL7160A-1221 by suyurui at 20240517 start*/
static struct LCM_setting_table init_setting_cmd[] =
{
    ...
    {0xD9, 1, {0xD7}},
    {0xE9, 1, {0x3F}},
    {0xB1, 18, {0x2C, 0x32, 0x32, 0x2F, 0x2F, 0x22, 0x43, 0x43, 0x1A, 0x1A, 0x0C, 0x98, 0x21, 0x11, 0x46, 0x43, 0x64, 0x24}},
    {0xB2, 16, {0x00,0x26,0xD0,0x40,0x00,0x26,0xBA,0x20,0x98,0x31,0x00,0x00,0x00,0x54,0x22,0xDF}},
    {0xB4, 14, {0x5A,0x5A,0x5A,0x5A,0x5A,0x5A,0x75,0x6A,0x75,0x6A,0x02,0x8D,0x01,0x02}},
    ...
    {0xD3, 31, {0xC0,0x00,0x0C,0x0C,0x00,0x00,0x5B,0x5B,0x66,0x6B,0x1D,0x1D,0x1D,0x1D,0x32,0x10,0x19,0x00,0x19,0x32,0x10,0x1D,0x00,0x1D,0x32,0x10,0x19,0x00,0x19,0x00,0x00}},
    ...
    {0xD6, 44, {0x18,0x18,0x18,0x18,0x3E,0x3E,0x3E,0x3E,0x18,0x18,0x18,0x18,0xBE,0xBE,0x18,0x18,0x18,0x18,0x18,0x18,0xBE,0xBE,0x01,0x00,0x03,0x02,0x05,0x04,0x07,0x06,0x09,0x08,0x0B,0x0A,0x25,0x24,0x23,0x22,0x21,0x20,0x18,0x18,0x18,0x18}},
    ...
    {0xE0, 46, {0x00,0x04,0x0C,0x11,0x18,0x25,0x3B,0x41,0x48,0x45,0x60,0x67,0x6F,0x81,0x81,0x8B,0x94,0xA8,0xA7,0x52,0x5A,0x65,0x73,0x00,0x04,0x0C,0x11,0x18,0x25,0x3B,0x41,0x48,0x45,0x60,0x67,0x6F,0x81,0x81,0x8B,0x94,0xA8,0xA7,0x52,0x5A,0x65,0x73}},
    {0xE7, 19, {0x07,0x14,0x14,0x15,0x0F,0x84,0x00,0x3C,0x3C,0x32,0x32,0x00,0x00,0x00,0x00,0x98,0x10,0x01,0x02}},
    {0xBD, 1, {0x01}},
    ...
    {0xD2, 2, {0x18,0x34}},
    {0xE9, 1, {0x3F}},
    {0xD3, 9, {0x00,0x04,0x00,0x28,0x00,0x00,0x00,0x80,0x04}},
    {0xD8, 36, {0xFF,0xFF,0xFF,0xFF,0xFF,0x00,0xFF,0xFF,0xFF,0xFF,0xFF,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00}},
...
/*a06 code for AL7160A-1221 by suyurui at 20240517 end*/
...
static void lcm_get_params(struct LCM_PARAMS *params)
{
    ...
    /*a06 code for AL7160A-2837 by suyurui at 20240607 start*/
    ...
    /*a06 code for AL7160A-2837 by suyurui at 20240607 end*/
...
static void lcm_init(void)
{
    ...
    if (smart_wakeup_open_flag) {
        ...
        MDELAY(2);
        lcm_set_gpio_output(GPIO_LCD_RST, GPIO_OUT_ONE);
        pr_notice("[LCM]deep_standby lcd_rst last high\n");
        MDELAY(20);
    }

    push_table(NULL, init_setting_cmd, ARRAY_SIZE(init_setting_cmd), 1);
    LCM_LOGI("hx83108b_ls_hkc----tps6132----lcm mode = vdo mode :%d----\n",lcm_dsi_mode);
}
/*a06 code for SR-AL7160A-01-69  by suyurui at 20240415 end*/
...
{
    LCM_LOGI("%s,hx83108b_ls_hkc backlight: level = %d\n", __func__, level);

    if (level == 0) {
        pr_notice("[LCM],hx83108b_ls_hkc backlight off, diming disable first\n");
        push_table(NULL,
...
struct LCM_DRIVER lcd_hx83108b_ls_hkc_mipi_hd_video_lcm_drv = {
