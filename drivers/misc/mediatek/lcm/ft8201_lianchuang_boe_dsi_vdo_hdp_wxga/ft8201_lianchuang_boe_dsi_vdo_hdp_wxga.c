...
{
	pr_notice("ft8201 [Kernel/LCM] %s enter\n", __func__);
...
static void lcm_setbacklight_cmdq(void *handle, unsigned int level)
{
	...
	printk("[LCM]%s,ft8201 backlight: level = %d\n", __func__, level);
...
struct LCM_DRIVER ft8201_lianchuang_boe_dsi_vdo_hdp_wxga_lcm_drv = {
	.name = "ft8201_lianchuang_boe_dsi_vdo_hdp_wxga",
