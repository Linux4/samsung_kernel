...
#define PHYSICAL_WIDTH  (71)/* mm */
#define PHYSICAL_HEIGHT (126)/* mm */
...
static struct LCM_setting_table lcm_initialization_setting[] = {
	...
	{0xFC, 2, {0x5A, 0x5A} }, /* Dimming Control */
	{0xB0, 1, {0x1E} }, /* Luminance Setting */
	{0xFD, 1, {0xB2} },
	{0xFC, 2, {0xA5, 0xA5} },
	{0xCA, 35, {0x01, 0x00, 0x01, 0x00,
				0x01, 0x00, 0x80, 0x80,
				0x80, 0x80, 0x80, 0x80,
				0x80, 0x80, 0x80, 0x80,
				0x80, 0x80, 0x80, 0x80,
...
{
#ifdef CONFIG_CUSTOM_LCM_USE_PMIC_VRF18_2
	pmic_config_interface(0x1850, 0x1, 0x01, 0);
	pmic_config_interface(0x1852, 0x1, 0x01, 0);
#endif
#ifdef BUILD_LK
	mt_set_gpio_mode(GPIO78, GPIO_MODE_00);
	mt_set_gpio_dir(GPIO78, GPIO_DIR_OUT);
	mt_set_gpio_out(GPIO78, GPIO_OUT_ONE);
#endif
	SET_RESET_PIN(1);
	MDELAY(1);
...
LCM_DRIVER s6e3fa3_fhd_cmd_ams549ku01_drv = {
	.name				= "s6e3fa3_fhd_cmd_ams549ku01",
