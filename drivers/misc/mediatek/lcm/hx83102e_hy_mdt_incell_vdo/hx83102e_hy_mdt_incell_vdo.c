 ...
 */
/**
*Name：<hx83102e_hy_mdt_incell_vdo>
...
static struct LCM_setting_table init_setting_vdo[] = {
    ...
    {0xD2, 0x02, {0x2D,0x2D}},
    {0xB1, 0x11, {0x10,0xFA,0xAF,0xAF,0x2D,0x2D,0xB1,0x6B,0x43,0x36,0x36,0x36,0x36,0x43,0x21,0x15,0x00}},
    {0xB2, 0x10, {0x00,0x20,0x35,0x3C,0x00,0x26,0xD2,0x5E,0x00,0x00,0x00,0x00,0x15,0x20,0xD7,0x00}},
    {0xBD, 0x01, {0x03}},
    {0xB2, 0x01, {0x80}},
    {0xBD, 0x01, {0x00}},
    {0xB4, 0x10, {0xD3,0xBB,0xC0,0xC0,0xD5,0xD5,0x68,0x50,0x0A,0xDD,0x09,0x58,0x00,0xFF,0x00,0xFF}},
    {0xE9, 0x01, {0xCD}},
    {0xBB, 0x01, {0x01}},
    {0xE9, 0x01, {0x00}},
    {0xBF, 0x03, {0xFC,0x85,0x80}},
    {0xBA, 0x08, {0x70,0x03,0xA8,0x83,0xF2,0x00,0x80,0x0D}},
    {0xD3, 0x2B, {0x00,0x00,0x00,0x00,0x01,0x04,0x00,0x00,0x0C,0x27,0x27,0x73,0x4F,0x27,0x27,0x04,0x04,0x32,0x10,0x21,0x00,0x21,0x32,0x17,0xA8,0x00,0x02,0x32,0x15,0x64,0x05,0x64,0x00,0x00,0x21,0x38,0x01,0x55,0x21,0x38,0x01,0x55,0x0F}},
    {0xE0, 0x2E, {0x00,0x09,0x15,0x1E,0x26,0x45,0x5B,0x5F,0x64,0x5D,0x73,0x74,0x76,0x82,0x7E,0x84,0x8D,0x9F,0x9F,0x4E,0x57,0x62,0x73,0x00,0x09,0x15,0x1E,0x26,0x45,0x5B,0x5F,0x64,0x5D,0x73,0x74,0x76,0x82,0x7E,0x84,0x8D,0x9F,0x9F,0x4E,0x57,0x62,0x73}},
    {0xBD, 0x01, {0x01}},
    ...
    {0xBD, 0x01, {0x00}},
    {0xC0, 0x0E, {0x26,0x26,0x25,0x11,0xA2,0x10,0x00,0x80,0x00,0x00,0x08,0x00,0x63,0x63}},
    {0xC6, 0x01, {0xF9}},
    {0xC7, 0x01, {0x30}},
    {0xC8, 0x08, {0x00,0x04,0x04,0x00,0x00,0x82,0x13,0x01}},
...
static void lcm_setbacklight_cmdq(void *handle, unsigned int level)
{
    ...
    /*TabA7 Lite code for OT8-5336 by huangzhongjie at 20220301 start*/
    level = mult_frac(level, 2730, 187); //Backlight current setting 22mA -> 20mA
    /*TabA7 Lite code for OT8-5336 by huangzhongjie at 20220301 end*/
...
struct LCM_DRIVER hx83102e_hy_mdt_incell_vdo_lcm_drv = {
    .name = "hx83102e_hy_mdt_incell_vdo",
