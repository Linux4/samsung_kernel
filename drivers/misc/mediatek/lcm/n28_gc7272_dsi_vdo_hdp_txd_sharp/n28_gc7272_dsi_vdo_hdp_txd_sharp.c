...
static struct LCM_setting_table init_setting_vdo[] = {
	...
	{0x29,1,{0x03}},
	{0xEF,1,{0x01}},
	{0x01,16,{0x00,0x00,0x00,0x03,0x00,0x4A,0x00,0x60,0x00,0x79,0x00,0x88,0x00,0x9c,0x00,0xaa}},
	{0x02,16,{0x00,0xC6,0x00,0xFD,0x01,0x23,0x01,0x56,0x01,0x6C,0x01,0xB5,0x01,0xE6,0x01,0xE8}},
	{0x03,16,{0x02,0x1C,0x02,0x5E,0x02,0x8A,0x02,0xC1,0x02,0xEA,0x03,0x1A,0x03,0x2E,0x03,0x41}},
	{0x04,12,{0x03,0x53,0x03,0x71,0x03,0x8A,0x03,0xB6,0x03,0xE0,0x03,0xFF}},
	{0x0D,16,{0x00,0x00,0x00,0x03,0x00,0x4A,0x00,0x60,0x00,0x79,0x00,0x88,0x00,0x9c,0x00,0xaa}},
	{0x0E,16,{0x00,0xC6,0x00,0xFD,0x01,0x23,0x01,0x56,0x01,0x6C,0x01,0xB5,0x01,0xE6,0x01,0xE8}},
	{0x0F,16,{0x02,0x1C,0x02,0x5E,0x02,0x8A,0x02,0xC1,0x02,0xEA,0x03,0x1A,0x03,0x2E,0x03,0x41}},
	{0x10,12,{0x03,0x53,0x03,0x71,0x03,0x8A,0x03,0xB6,0x03,0xE0,0x03,0xFF}},
	{0x2B,1,{0x41}},
	{0xF0,1,{0x01}},
	{0x2D,1,{0x65}},
	{0x2E,1,{0x00}},
...
static void lcm_suspend_power(void)
{
    if (ovt_gesture_flag == 1) {
               pr_err("[LCM] gc7272_txd_sharp lcm_suspend_power ovt_gesture_flag = 1!\n");
	} else {
		int ret  = 0;
        pr_err("[LCM] gc7272_txd_sharp lcm_suspend_power ovt_gesture_flag = 0!\n");
