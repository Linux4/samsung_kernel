...
//+S96818BA1-1936,liyuhong1.wt,modify,2023/08/04,modify panel timming
static struct LCM_setting_table init_setting_vdo[] = {
	...
	{0x82,1,{0x03}},
	{0xFF,1,{0x23}},
	{0xEF,1,{0x07}}, //software version
	{0x29,1,{0x03}},
	{0x01,16,{0x00,0x00,0x00,0x24,0x00,0x4D,0x00,0x62,0x00,0x78,0x00,0x8A,0x00,0x99,0x00,0xA6}},
	{0x02,16,{0x00,0xB5,0x00,0xDE,0x00,0xFE,0x01,0x2E,0x01,0x57,0x01,0x96,0x01,0xCC,0x01,0xCE}},
	{0x03,16,{0x02,0x06,0x02,0x4E,0x02,0x7C,0x02,0xB9,0x02,0xE2,0x03,0x1A,0x03,0x2A,0x03,0x3F}},
	{0x04,12,{0x03,0x55,0x03,0x70,0x03,0x8E,0x03,0xB1,0x03,0xDF,0x03,0xFF}},
	{0x0D,16,{0x00,0x00,0x00,0x24,0x00,0x4D,0x00,0x62,0x00,0x78,0x00,0x8A,0x00,0x99,0x00,0xA6}},
	{0x0E,16,{0x00,0xB5,0x00,0xDE,0x00,0xFE,0x01,0x2E,0x01,0x57,0x01,0x96,0x01,0xCC,0x01,0xCE}},
	{0x0F,16,{0x02,0x06,0x02,0x4E,0x02,0x7C,0x02,0xB9,0x02,0xE2,0x03,0x1A,0x03,0x2A,0x03,0x3F}},
	{0x10,12,{0x03,0x55,0x03,0x70,0x03,0x8E,0x03,0xB1,0x03,0xDF,0x03,0xFF}},
	{0x2B,1,{0x41}},
	{0xF0,1,{0x01}},
	{0x2D,1,{0x65}},
	{0x2E,1,{0x00}},
...
//+S96818AA1-1936,liyuhong1.wt,modify,2023/08/23,n28-lcd modify lcd timming
static void lcm_init_power(void)
{
	int ret = 0;
	pr_err("[LCM]gc7272_txd_sharp lcm_init_power !\n");
	//ret = lcm_power_enable();
	lcm_bais_enp_enable(HIGH);
  	MDELAY(4);
  	lcm_bais_enn_enable(HIGH);
	MDELAY(2);
	ret = lcm_set_power_reg(0X00,0x14,(0x1F << 0));
	ret = lcm_set_power_reg(0X01,0x14,(0x1F << 0));
	ret = lcm_set_power_reg(0X03,((1<<0) | (1<<1)),((1<<0) | (1<<1)));
	MDELAY(5);
}
//-S96818AA1-1936,liyuhong1.wt,modify,2023/08/23,n28-lcd modify lcd timming
//+S96818AA1-1936,liyuhong1.wt,modify,2023/05/23,n28-lcd modify gesture flag
extern bool gc_gestrue_status;
static void lcm_suspend_power(void)
{
    if (gc_gestrue_status == 1) {
               pr_err("[LCM] gc7272_txd_sharp lcm_suspend_power gc_gestrue_status = 1!\n");
	} else {
		int ret  = 0;
        pr_err("[LCM] gc7272_txd_sharp lcm_suspend_power gc_gestrue_status = 0!\n");
...
{
	pr_err("[LCM]gc7272_txd_sharp lcm_resume_power !\n");
	lcm_init_power();
}
...
static void lcm_setbacklight_cmdq(void* handle,unsigned int level)
{
	...
	if(bl_lvl > 4073)
		bl_lvl = 4073;
	pr_err("%s,gc7272_txd_sharp backlight: level = %d,bl_lvl=%d\n", __func__, level,bl_lvl);
	// set 12bit
	bl_level[0].para_list[0] = (bl_lvl & 0xF00) >> 8;
	bl_level[0].para_list[1] = (bl_lvl & 0xFF);
	pr_err("gc7272_txd_sharp backlight: para_list[0]=%x,para_list[1]=%x\n",bl_level[0].para_list[0],bl_level[0].para_list[1]);
	push_table(handle, bl_level, sizeof(bl_level) / sizeof(struct LCM_setting_table), 1);
}
struct LCM_DRIVER n28_gc7272_dsi_vdo_hdp_txd_sharp_drv = {
