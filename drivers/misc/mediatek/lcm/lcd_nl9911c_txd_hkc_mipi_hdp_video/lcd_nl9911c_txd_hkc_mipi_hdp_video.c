...
static struct LCM_setting_table init_setting_vdo[] = {
    ...
    {0xBE,10,{0x68,0x7C,0x64,0x3C,0x0C,0x77,0x43,0x07,0x0E,0x0E}},
    {0xBF,8,{0x07,0x25,0x07,0x25,0x7F,0x00,0x11,0x04}},
    {0xC0,9,{0x10,0x00,0x1F,0xFF,0xFF,0xFF,0x00,0xFF,0x00}},
    {0xC1,19,{0xC0,0x0C,0x20,0x96,0x04,0x30,0x30,0x04,0x2A,0x40,0x36,0x00,0x07,0xC0,0x10,0xFF,0x97,0x01,0xC0}},
    {0xC2,1,{0x00}},
...
static void kernel_F6_reg_update(void)
{
    ...
    //printk("lcm_resume TempBuf_F6 = %x\n",Temp_F6);
    init_setting_vdo[31].para_list[0] = Temp_F6;
}
...
{
    LCM_LOGI("%s,nl9911c_txd_hkc backlight: level = %d\n", __func__, level);

    if (level == 0) {
        pr_notice("[LCM],nl9911c_txd_hkc backlight off, diming disable first\n");
        push_table(NULL,
...
struct LCM_DRIVER lcd_nl9911c_txd_hkc_mipi_hdp_video_lcm_drv = {
    .name = "lcd_nl9911c_txd_hkc_mipi_hdp_video",
