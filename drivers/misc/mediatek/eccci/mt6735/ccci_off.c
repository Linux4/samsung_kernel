...
int internal_md_power_down(void *clk_ptr)
{
...
#if !defined(CONFIG_MTK_CLKMGR)
	struct clk *clk_scp_sys_md1_main = (struct clk *)clk_ptr;

	if (clk_scp_sys_md1_main == NULL) {
		pr_err("ccci_off: clk_scp_sys_md1_main NULL\r\n");
		return -1;
	}
#endif
