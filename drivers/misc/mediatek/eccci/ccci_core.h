...
struct ccci_modem_ops {
	...
	int (*force_off)(struct ccci_modem *md);
};
...
void drv_tri_panic_by_lvl(void *md);
void ccci_trigger_reset(void *md);
extern unsigned int ccci_drv_trigger_upload;
extern volatile int ee_on_going_for_force_off;
