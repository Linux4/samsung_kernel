...
typedef enum {
	...
	MD_FORCE_ASSERT_BY_RIL_USER_TRIGGER	= 0x700,
	MD_FORCE_ASSERT_BY_RIL_MNG		= 0x701,
	MD_FORCE_ASSERT_BY_RIL_REQ_FULL		= 0x702,
	MD_FORCE_ASSERT_BY_RIL_PHONE_DIE	= 0x703,
	MD_FORCE_ASSERT_BY_RIL_RSV_MAX		= 0x704
#endif
...
#define CCCI_IOC_ENTER_UPLOAD		_IO(CCCI_IOC_MAGIC, 72) /* modem log for S */
...
#define CCCI_IOC_DRV_ENTER_UPLOAD	_IO(CCCI_IOC_MAGIC, 73) /* modem log for s */
#define CCCI_IOC_LOG_LVL		_IOW(CCCI_IOC_MAGIC, 74, unsigned int) /* modem log for s */
#define CCCI_IOC_FORCE_MD_OFF		_IO(CCCI_IOC_MAGIC, 75) /* force power off modem for s factory mode */
#define CCCI_IOC_GET_MD_STATE_SYNC	_IOR(CCCI_IOC_MAGIC, 76, unsigned int) /* meta for s */
...
typedef enum {
	...
	/* 101 ~ 147 has been reserved */
	CCCI_RIL_IPC0_RX		= 148,
	CCCI_RIL_IPC0_TX		= 149,
	CCCI_RIL_IPC1_RX		= 150,
	CCCI_RIL_IPC1_TX		= 151,
