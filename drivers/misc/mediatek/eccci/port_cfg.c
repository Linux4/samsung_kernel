...
/* network port first for performace */
	{CCCI_CCMNI1_TX, CCCI_CCMNI1_RX, 3, 3, 0xF4, 0xFF, 8, &net_port_ops, 0, NET_IF_NAME"0",},
	{CCCI_CCMNI2_TX, CCCI_CCMNI2_RX, 3, 4, 0xF4, 0xFF, 8, &net_port_ops, 1, NET_IF_NAME"1",},
	{CCCI_CCMNI3_TX, CCCI_CCMNI3_RX, 5, 5, 0xF5, 0xFF, 0, &net_port_ops, 2, NET_IF_NAME"2",},
	{CCCI_CCMNI4_TX, CCCI_CCMNI4_RX, 5, 5, 0xF5, 0xFF, 0, &net_port_ops, 3, NET_IF_NAME"3",},
	{CCCI_CCMNI5_TX, CCCI_CCMNI5_RX, 5, 5, 0xF5, 0xFF, 0, &net_port_ops, 4, NET_IF_NAME"4",},
	{CCCI_CCMNI6_TX, CCCI_CCMNI6_RX, 5, 5, 0xF5, 0xFF, 0, &net_port_ops, 5, NET_IF_NAME"5",},
	{CCCI_CCMNI7_TX, CCCI_CCMNI7_RX, 5, 5, 0xF5, 0xFF, 0, &net_port_ops, 6, NET_IF_NAME"6",},
	{CCCI_CCMNI8_TX, CCCI_CCMNI8_RX, 3, 3, 0xF4, 0xFF, 0, &net_port_ops, 7, NET_IF_NAME"7",},
...
/* char port, notes ccci_monitor must be first for get_port_by_minor() implement */
	...
	{CCCI_RIL_IPC1_TX, CCCI_RIL_IPC1_RX, 1, 1, 0xFF, 0xFF, 0, &char_port_ops, 23, "ccci_umts_ipc1",},
	{CCCI_VT_CTL_TX, CCCI_VT_CTL_RX, 7, 7, 0xFF, 0xFF, 0, &char_port_ops, 24, "ttyC4",},
...
{CCCI_C2K_PPP_DATA,	CCCI_C2K_PPP_DATA, 2, 2, 0xFF, 0xFF, 0, &char_port_ops, 19, "ccci3_data",},
	...
	{CCCI_C2K_AT9, CCCI_C2K_AT9, 7, 7, 0xFF, 0xFF, 0, &char_port_ops, 28, "ccci3_meta",},
	{CCCI_C2K_LB_DL, CCCI_C2K_LB_DL, 5, 5, 0xFF, 0xFF, 0, &char_port_ops, 29, "ccci3_lb_dl",},
/* sys port */
