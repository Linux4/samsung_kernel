...
/* network port first for performace */
	{CCCI_CCMNI1_TX, CCCI_CCMNI1_RX, 3, 3, 0xF4, 0xFF, 8, &net_port_ops, 0xF1, NET_IF_NAME"0",},
	{CCCI_CCMNI2_TX, CCCI_CCMNI2_RX, 3, 4, 0xF4, 0xFF, 8, &net_port_ops, 0xF2, NET_IF_NAME"1",},
	{CCCI_CCMNI3_TX, CCCI_CCMNI3_RX, 5, 5, 0xF5, 0xFF, 8, &net_port_ops, 0xF3, NET_IF_NAME"2",},
/*for IMS*/
	{CCCI_CCMNI4_TX, CCCI_CCMNI4_RX, 5, 5, 0xF5, 0xFF, 8, &net_port_ops, 0xF4, NET_IF_NAME"3",},
	{CCCI_CCMNI5_TX, CCCI_CCMNI5_RX, 5, 5, 0xF5, 0xFF, 8, &net_port_ops, 0xF5, NET_IF_NAME"4",},
	{CCCI_CCMNI6_TX, CCCI_CCMNI6_RX, 5, 5, 0xF5, 0xFF, 8, &net_port_ops, 0xF6, NET_IF_NAME"5",},
	{CCCI_CCMNI7_TX, CCCI_CCMNI7_RX, 5, 5, 0xF5, 0xFF, 8, &net_port_ops, 0xF7, NET_IF_NAME"6",},
	{CCCI_CCMNI8_TX, CCCI_CCMNI8_RX, 5, 5, 0xF5, 0xFF, 8, &net_port_ops, 0xF8, NET_IF_NAME"7",},
/* char port, notes ccci_monitor must be first for md_cd_get_port_by_minor() implement */
	...
	{CCCI_RIL_IPC0_TX, CCCI_RIL_IPC0_RX, 1, 1, 0xFF, 0xFF, 0, &char_port_ops, 20, "ccci_umts_ipc0",},
	{CCCI_RIL_IPC1_TX, CCCI_RIL_IPC1_RX, 1, 1, 0xFF, 0xFF, 0, &char_port_ops, 21, "ccci_umts_ipc1",},
	{CCCI_RPC_TX, CCCI_RPC_RX, 1, 1, 1, 1, 4, &char_port_ops, 22, "ccci_rpc",},
	{CCCI_VT_CTL_TX, CCCI_VT_CTL_RX, 7, 7, 0xFF, 0xFF, 0, &char_port_ops, 23, "ttyC4",},
/*char port, kernel port only */
