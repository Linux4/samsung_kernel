...
void ddp_cmdq_wait(cmdqRecHandle cmdq)
{
	cmdqRecReadToDataRegister(cmdq, DISP_REG_DSI_STATE, CMDQ_DATA_REG_DEBUG);
}
...
void DSI_PHY_clk_settingByCmdq(DISP_MODULE_ENUM module, cmdqRecHandle cmdq,
				 LCM_DSI_PARAMS *dsi_params)
{
#ifdef CONFIG_FPGA_EARLY_PORTING
#if 0
...
/* unsigned int fmod = 30; Fmod = 30KHz by default */
	...
	for (i = DSI_MODULE_BEGIN(module); i <= DSI_MODULE_END(module); i++) {
		...
		DSI_OUTREGBIT(cmdq, struct MIPITX_DSI_BG_CON_REG, DSI_PHY_REG[i]->MIPITX_DSI_BG_CON,
				RG_DSI_BG_CORE_EN, 1);
		...
		/*MIPITX_OUTREGBIT(struct MIPITX_DSI_TOP_CON_REG, DSI_PHY_REG[i]->MIPITX_DSI_TOP_CON,
				 RG_DSI_LNT_HS_BIAS_EN, 1);*/
		DSI_OUTREGBIT(cmdq, struct MIPITX_DSI_TOP_CON_REG, DSI_PHY_REG[i]->MIPITX_DSI_TOP_CON,
				RG_DSI_LNT_HS_BIAS_EN, 1);
		...
		MIPITX_OUTREGBIT(struct MIPITX_DSI_CON_REG, DSI_PHY_REG[i]->MIPITX_DSI_CON,
				 RG_DSI_LDOCORE_EN, 1);*/
		DSI_OUTREGBIT(cmdq, struct MIPITX_DSI_CON_REG, DSI_PHY_REG[i]->MIPITX_DSI_CON,
				RG_DSI_CKG_LDOOUT_EN, 1);
		...
		/*MIPITX_OUTREGBIT(struct MIPITX_DSI_PLL_PWR_REG, DSI_PHY_REG[i]->MIPITX_DSI_PLL_PWR,
				 DA_DSI_MPPLL_SDM_PWR_ON, 1);*/
		DSI_OUTREGBIT(cmdq, struct MIPITX_DSI_PLL_PWR_REG, DSI_PHY_REG[i]->MIPITX_DSI_PLL_PWR,
				DA_DSI_MPPLL_SDM_PWR_ON, 1);
		...
		/*MIPITX_OUTREGBIT(struct MIPITX_DSI_CLOCK_LANE_REG, DSI_PHY_REG[i]->MIPITX_DSI_CLOCK_LANE,
				 RG_DSI_LNTC_LDOOUT_EN, 1);*/
		DSI_OUTREGBIT(cmdq, struct MIPITX_DSI_CLOCK_LANE_REG, DSI_PHY_REG[i]->MIPITX_DSI_CLOCK_LANE,
				RG_DSI_LNTC_LDOOUT_EN, 1);
		...
		if (dsi_params->LANE_NUM > 0) {
			/*MIPITX_OUTREGBIT(struct MIPITX_DSI_DATA_LANE0_REG, DSI_PHY_REG[i]->MIPITX_DSI_DATA_LANE0,
					 RG_DSI_LNT0_LDOOUT_EN, 1);*/
			DSI_OUTREGBIT(cmdq, struct MIPITX_DSI_DATA_LANE0_REG, DSI_PHY_REG[i]->MIPITX_DSI_DATA_LANE0,
					RG_DSI_LNT0_LDOOUT_EN, 1);
		}
		/* step 13 */
		if (dsi_params->LANE_NUM > 1) {
			/*MIPITX_OUTREGBIT(struct MIPITX_DSI_DATA_LANE1_REG, DSI_PHY_REG[i]->MIPITX_DSI_DATA_LANE1,
					 RG_DSI_LNT1_LDOOUT_EN, 1);*/
			DSI_OUTREGBIT(cmdq, struct MIPITX_DSI_DATA_LANE1_REG, DSI_PHY_REG[i]->MIPITX_DSI_DATA_LANE1,
					RG_DSI_LNT1_LDOOUT_EN, 1);
		}
		/* step 14 */
		if (dsi_params->LANE_NUM > 2) {
			/*MIPITX_OUTREGBIT(struct MIPITX_DSI_DATA_LANE2_REG, DSI_PHY_REG[i]->MIPITX_DSI_DATA_LANE2,
					 RG_DSI_LNT2_LDOOUT_EN, 1);*/
			DSI_OUTREGBIT(cmdq, struct MIPITX_DSI_DATA_LANE2_REG, DSI_PHY_REG[i]->MIPITX_DSI_DATA_LANE2,
					RG_DSI_LNT2_LDOOUT_EN, 1);
		}
		/* step 15 */
		if (dsi_params->LANE_NUM > 3) {
			/*MIPITX_OUTREGBIT(struct MIPITX_DSI_DATA_LANE3_REG, DSI_PHY_REG[i]->MIPITX_DSI_DATA_LANE3,
					 RG_DSI_LNT3_LDOOUT_EN, 1);*/
			DSI_OUTREGBIT(cmdq, struct MIPITX_DSI_DATA_LANE3_REG, DSI_PHY_REG[i]->MIPITX_DSI_DATA_LANE3,
					RG_DSI_LNT3_LDOOUT_EN, 1);
		}
		/* step 16 */
		/*MIPITX_OUTREGBIT(struct MIPITX_DSI_PLL_CON0_REG, DSI_PHY_REG[i]->MIPITX_DSI_PLL_CON0,
		...
		DSI_OUTREGBIT(cmdq, struct MIPITX_DSI_PLL_CHG_REG, DSI_PHY_REG[i]->MIPITX_DSI_PLL_CHG,
				RG_DSI0_MPPLL_SDM_PCW_CHG, 0);
		DSI_OUTREGBIT(cmdq, struct MIPITX_DSI_PLL_CHG_REG, DSI_PHY_REG[i]->MIPITX_DSI_PLL_CHG,
				RG_DSI0_MPPLL_SDM_PCW_CHG, 1);
...
void DSI_PHY_PLL_Off(DISP_MODULE_ENUM module, cmdqRecHandle cmdq)
{
	int i = 0;
	...
	for (i = DSI_MODULE_BEGIN(module); i <= DSI_MODULE_END(module); i++) {
		...
		DSI_OUTREG32(cmdq, &DSI_PHY_REG[i]->MIPITX_DSI_PLL_CON1, 0x00000000);
		DSI_OUTREG32(cmdq, &DSI_PHY_REG[i]->MIPITX_DSI_PLL_CON2, 0x50000000);
...
void DSI_ChangeClkByCmdq(DISP_MODULE_ENUM module, void *cmdq, uint32_t clk)
{
	...
	for (i = DSI_MODULE_BEGIN(module); i <= DSI_MODULE_END(module); i++) {
		...
		/*DSI_PHY_PLL_Off(module, cmdq);*/
		DSI_PHY_clk_settingByCmdq(module, cmdq, dsi_params);
...
const LCM_UTIL_FUNCS PM_lcm_utils_dsi0 = {
	...
	.dsi_set_cmdq_V3 = DSI_set_cmdq_V3_Wrapper_DSI0
};
