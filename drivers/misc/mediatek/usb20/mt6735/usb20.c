...
#if defined(CONFIG_MTK_STANDALONE_FUEL_GAUGE)
kal_bool upmu_is_chr_det_u(void)
{
	return pmic_get_register_value(PMIC_RGS_CHRDET);
}
#endif
...
#ifdef CONFIG_USB_NOTIFY_LAYER
void mtk_otg_vbus_event(bool is_active)
{
	printk("usb: %s, is_active=%d\n", __func__, is_active);
