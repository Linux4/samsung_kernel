...
void set_usb_phy_mode(int mode)
{
	...
	/* VBUSVALID=1, AVALID=1, BVALID=1, SESSEND=0, IDDIG=1, IDPULLUP=1 */
		...
		if (strncmp(CONFIG_ARCH_MTK_PROJECT, "S96116CA1", 9) == 0 || strncmp(CONFIG_ARCH_MTK_PROJECT, "S96116DA1", 9) == 0 )
		{
...
void usb_phy_recover(void)
{
	...
	//bug501206,chenxu.wt.add,19/11/8,samsumg SSD write/read speed is to low
