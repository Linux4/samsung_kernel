...
/*TabA7 Lite code for USB-IF LeCory TDA 2.3.1.2 by qiaodan at 20210527 start*/
struct mt_usb_work otg_vbus_work;

static void do_vbus_work(struct work_struct *data);
/*TabA7 Lite code for USB-IF LeCory TDA 2.3.1.2 by qiaodan at 20210527 end*/
...
/*TabA7 Lite code for USB-IF LeCory TDA 2.3.1.2 by qiaodan at 20210527 start*/
	INIT_DELAYED_WORK(&otg_vbus_work.dwork, do_vbus_work);
/*TabA7 Lite code for USB-IF LeCory TDA 2.3.1.2 by qiaodan at 20210527 end*/
...
static void do_vbus_work(struct work_struct *data)
{
    ...
    bool vbus_on = (otg_vbus_work.ops ==
             VBUS_OPS_ON ? true : false);
...
static void issue_vbus_work(int ops, int delay)
{
	...
	/*queue_delayed_work(mtk_musb->st_wq,
				&work->dwork, msecs_to_jiffies(delay));*/
	schedule_delayed_work(&otg_vbus_work.dwork, delay);
	}
/*TabA7 Lite code for USB-IF LeCory TDA 2.3.1.2 by qiaodan at 20210527 end*/
