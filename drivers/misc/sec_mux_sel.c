...
int EAR_MIC_TYPEC_MUX_SEL_NUM;
int EAR_MIC_35MM_MUX_SEL_NUM;
int EAR_OUT_TYPEC_MUX_SEL_NUM;
int EAR_OUT_35MM_MUX_SEL_NUM;
...
static void sec_mux_sel_get_info(void)
{
	...
	#ifdef CONFIG_SEC_EARJACK_35_USB_SWITCH
	EAR_MIC_TYPEC_MUX_SEL_NUM = 0;
	EAR_MIC_35MM_MUX_SEL_NUM = 0;
	EAR_OUT_TYPEC_MUX_SEL_NUM = 0;
	EAR_OUT_35MM_MUX_SEL_NUM = 0;
	#endif /* CONFIG_SEC_EARJACK_35_USB_SWITCH */
	...
	if (mux_sel->pdata->mux_sel_1_en) {
		...
		#ifdef CONFIG_SEC_EARJACK_35_USB_SWITCH	
		if(mux_sel->pdata->mux_sel_1_type & EAR_MIC_TYPEC_MUX_SEL)
			 EAR_MIC_TYPEC_MUX_SEL_NUM= SEC_MUX_SEL_1;
		if(mux_sel->pdata->mux_sel_1_type & EAR_MIC_35MM_MUX_SEL)
			 EAR_MIC_35MM_MUX_SEL_NUM= SEC_MUX_SEL_1;
		if(mux_sel->pdata->mux_sel_1_type & EAR_OUT_TYPEC_MUX_SEL)
			 EAR_OUT_TYPEC_MUX_SEL_NUM= SEC_MUX_SEL_1;
		if(mux_sel->pdata->mux_sel_1_type & EAR_OUT_35MM_MUX_SEL)
			 EAR_OUT_35MM_MUX_SEL_NUM= SEC_MUX_SEL_1;
		#endif /* CONFIG_SEC_EARJACK_35_USB_SWITCH */	 
	}
	...
	if (mux_sel->pdata->mux_sel_2_en) {
		...
		#ifdef CONFIG_SEC_EARJACK_35_USB_SWITCH	
		if(mux_sel->pdata->mux_sel_2_type & EAR_MIC_TYPEC_MUX_SEL)
			 EAR_MIC_TYPEC_MUX_SEL_NUM= SEC_MUX_SEL_2;
		if(mux_sel->pdata->mux_sel_2_type & EAR_MIC_35MM_MUX_SEL)
			 EAR_MIC_35MM_MUX_SEL_NUM= SEC_MUX_SEL_2;
		if(mux_sel->pdata->mux_sel_2_type & EAR_OUT_TYPEC_MUX_SEL)
			 EAR_OUT_TYPEC_MUX_SEL_NUM= SEC_MUX_SEL_2;
		if(mux_sel->pdata->mux_sel_2_type & EAR_OUT_35MM_MUX_SEL)
			 EAR_OUT_35MM_MUX_SEL_NUM= SEC_MUX_SEL_2;
		#endif /* CONFIG_SEC_EARJACK_35_USB_SWITCH */
	}
	...
	if (mux_sel->pdata->mux_sel_3_en) {
		...
		#ifdef CONFIG_SEC_EARJACK_35_USB_SWITCH		
		if(mux_sel->pdata->mux_sel_3_type & EAR_MIC_TYPEC_MUX_SEL)
			 EAR_MIC_TYPEC_MUX_SEL_NUM= SEC_MUX_SEL_3;
		if(mux_sel->pdata->mux_sel_3_type & EAR_MIC_35MM_MUX_SEL)
			 EAR_MIC_35MM_MUX_SEL_NUM= SEC_MUX_SEL_3;
		if(mux_sel->pdata->mux_sel_3_type & EAR_OUT_TYPEC_MUX_SEL)
			 EAR_OUT_TYPEC_MUX_SEL_NUM= SEC_MUX_SEL_3;
		if(mux_sel->pdata->mux_sel_3_type & EAR_OUT_35MM_MUX_SEL)
			 EAR_OUT_35MM_MUX_SEL_NUM= SEC_MUX_SEL_3;
		#endif /* CONFIG_SEC_EARJACK_35_USB_SWITCH */
	}
	...
	#ifdef CONFIG_SEC_EARJACK_35_USB_SWITCH	
	pr_info("%s EAR MIC TYPEC SEL NUM = %d,EAR MIC 3.5MM SEL NUM = %d,TYPEC OUT SEL NUM = %d,3.5MM OUT SEL NUM = %d.\n", 
	__func__,
	EAR_MIC_TYPEC_MUX_SEL_NUM,
	EAR_MIC_35MM_MUX_SEL_NUM,
	EAR_OUT_TYPEC_MUX_SEL_NUM,
	EAR_OUT_35MM_MUX_SEL_NUM);
	#endif /* CONFIG_SEC_EARJACK_35_USB_SWITCH */
