...
#if defined(CONFIG_ARCH_EXYNOS) || defined(CONFIG_ARCH_WHALE) || defined(CONFIG_ARCH_MT6755) || defined(CONFIG_ARCH_MT6735)
	if (!ion_dev) {
...
/* On Whale platform ION driver starts as module,
