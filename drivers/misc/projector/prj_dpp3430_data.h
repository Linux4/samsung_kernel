...
static unsigned char dpp_ReadDMDID[] = {
	PRJ_READ, 2, 1, 0xD5, 0x00,
};

static unsigned char READ_SHORT_STATUS[] = {
	PRJ_READ, 2, 1, 0xD0, 0x00,
};
...
static unsigned char TI_On_LABB[] = {
        PRJ_WRITE, 9, 0xF1, 0x80, 0xE1, 0x00, 0xE0, 0xC0, 0x39, 0x01, 0x00
};

static unsigned char TI_On_DMD[] = {
        PRJ_WRITE, 9, 0xF1, 0x80, 0xE1, 0x00, 0xE0, 0xC0, 0x38, 0x01, 0x00
};

static unsigned char TI_Off[] = {
        PRJ_WRITE, 9, 0xF1, 0x00, 0xE1, 0x00, 0xE0, 0xC0, 0x39, 0x01, 0x04
};
...
static unsigned char Output_Rotate_0[] = {
    PRJ_WRITE, 2, 0x14, 0x02,
    PRJ_WRITE, 5, 0x12, 0x20, 0x01, 0xE0, 0x01, //288x480
    PRJ_WRITE, 9, 0x10, 0x00, 0x00, 0x00, 0x00, 0xE0, 0x01, 0x20, 0x03, //crop 480x800
};
static unsigned char Output_Rotate_180[] = {
    PRJ_WRITE, 2, 0x14, 0x04,
    PRJ_WRITE, 5, 0x12, 0x20, 0x01, 0xE0, 0x01,//288x480
...
static unsigned char Output_Rotate_270[] = {
    PRJ_WRITE, 2, 0x14, 0x03,
    PRJ_WRITE, 5, 0x12, 0xE0, 0x01, 0x20, 0x03, //480x800
    PRJ_WRITE, 9, 0x10, 0x00, 0x00, 0x00, 0x00, 0xE0, 0x01, 0x20, 0x03, //crop 480x800
};
static unsigned char Output_Rotate_270_full[] = {
    PRJ_WRITE, 2, 0x14, 0x03,
    PRJ_WRITE, 5, 0x12, 0xE0, 0x01, 0x56, 0x03, //480x854
    PRJ_WRITE, 9, 0x10, 0x0F, 0x00, 0x00, 0x00, 0xC2, 0x01, 0x20, 0x03, //crop 15x0~ 450x800
};
static unsigned char Output_Rotate_90[] = {
    PRJ_WRITE, 2, 0x14, 0x05,
    PRJ_WRITE, 5, 0x12, 0xE0, 0x01, 0x20, 0x03, //480x800
...
static unsigned char Output_Rotate_90_full[] = {
    PRJ_WRITE, 2, 0x14, 0x05,
    PRJ_WRITE, 5, 0x12, 0xE0, 0x01, 0x56, 0x03, //480x854
    PRJ_WRITE, 9, 0x10, 0x0F, 0x00, 0x00, 0x00, 0xC2, 0x01, 0x20, 0x03, //crop 15x0~ 450x800
};
...
static unsigned char Internal_pattern_direction[] = {
    PRJ_WRITE, 2, 0x14, 0x02, //140108_sks
...
//////////////////////////////////////////////////////////sks_140225
static unsigned char dpp_Read_ShortStatus[] = {
	PRJ_READ, 1, 1, 0xD0,
};
static unsigned char dpp_Read_SystemStatus[] = {
	PRJ_READ, 1, 4, 0xD1,
};
static unsigned char dpp_Read_CommStatus[] = {
	PRJ_READ, 2, 6, 0xD3, 0x02,    //2byte send --> 6byte return
};
////////////////////////////////////////////////////////
static unsigned char M08980Read_LDO_STAT[] = {
	PRJMSPD_READ, 1, 1, 0x40,
};
static unsigned char M08980Read_BOOST_STAT[] = {
	PRJMSPD_READ, 1, 1, 0x44,
};
static unsigned char M08980Read_DMD_STAT_RB[] = {
	PRJMSPD_READ, 1, 1, 0x45,
};
static unsigned char M08980Read_MOTOR_BUCK_STAT[] = {
	PRJMSPD_READ, 1, 1, 0x46,
};
static unsigned char M08980Read_BUCKBOOST_STAT[] = {
	PRJMSPD_READ, 1, 1, 0x48,
};
static unsigned char M08980Read_RED_VBAT_LSB[] = {
	PRJMSPD_READ, 1, 1, 0x49,
};
static unsigned char M08980Read_GREEN_VBAT_LSB[] = {
	PRJMSPD_READ, 1, 1, 0x4A,
};
static unsigned char M08980Read_BLUE_VBAT_LSB[] = {
	PRJMSPD_READ, 1, 1, 0x4B,
};
static unsigned char M08980Read_VBAT_MSB[] = {
	PRJMSPD_READ, 1, 1, 0x4C,
};
static unsigned char M08980Read_RED_VLED_LSB[] = {
	PRJMSPD_READ, 1, 1, 0x4D,
};
static unsigned char M08980Read_GREEN_VLED_LSB[] = {
	PRJMSPD_READ, 1, 1, 0x4E,
};
static unsigned char M08980Read_BLUE_VLED_LSB[] = {
	PRJMSPD_READ, 1, 1, 0x4F,
};
static unsigned char M08980Read_VLED_MSB[] = {
	PRJMSPD_READ, 1, 1, 0x50,
};
static unsigned char M08980Read_TEMP_LSB[] = {
	PRJMSPD_READ, 1, 1, 0x51,
};
static unsigned char M08980Read_TEMP_MSB[] = {
	PRJMSPD_READ, 1, 1, 0x52,
};
static unsigned char M08980Read_ADC_STATUS[] = {
	PRJMSPD_READ, 1, 1, 0x53,
};
static unsigned char M08980Read_PWM_READBACK[] = {
	PRJMSPD_READ, 1, 1, 0x54,
};
static unsigned char M08980Read_IOUT0_HDRM_DAC_READBACK[] = {
	PRJMSPD_READ, 1, 1, 0x55,
};
static unsigned char M08980Read_IOUT1_HDRM_DAC_READBACK[] = {
	PRJMSPD_READ, 1, 1, 0x56,
};
static unsigned char M08980Read_IOUT2_HDRM_DAC_READBACK[] = {
	PRJMSPD_READ, 1, 1, 0x57,
};
static unsigned char M08980Read_DEVICE_ID[] = {
	PRJMSPD_READ, 1, 1, 0x60,
};
static unsigned char M08980Read_ALARM0[] = {
	PRJMSPD_READ, 1, 1, 0x70,
};
static unsigned char M08980Read_ALARM1[] = {
	PRJMSPD_READ, 1, 1, 0x71,
};
