...
static struct hx9031a_addr_val_pair hx9031a_reg_init_list[] = {
    ...
    {RA_RAW_BL_RD_CFG_0x38,            0x0F}, //7:4 lp_bl_sel 3:0 lp_diff_sel
    ...
    {RA_PROX_HIGH_DIFF_CFG_CH1_0_0x82, 0x04}, //high int 0x3FF*32  160
    {RA_PROX_HIGH_DIFF_CFG_CH1_1_0x83, 0x00},
    {RA_PROX_HIGH_DIFF_CFG_CH2_0_0x84, 0x04}, //high int 0x3FF*32  160
    {RA_PROX_HIGH_DIFF_CFG_CH2_1_0x85, 0x00},
    {RA_PROX_HIGH_DIFF_CFG_CH3_0_0x86, 0x08}, //high int 0x3FF*32  256
    {RA_PROX_HIGH_DIFF_CFG_CH3_1_0x87, 0x00},

    {RA_PROX_LOW_DIFF_CFG_CH0_0_0x88,  0x07}, //low int 0x2FF*32  192
    {RA_PROX_LOW_DIFF_CFG_CH0_1_0x89,  0x00},
    {RA_PROX_LOW_DIFF_CFG_CH1_0_0x8a,  0x04}, //low int 0x2FF*32  128
    {RA_PROX_LOW_DIFF_CFG_CH1_1_0x8b,  0x00},
    {RA_PROX_LOW_DIFF_CFG_CH2_0_0x8c,  0x04}, //low int 0x2FF*32  128
    {RA_PROX_LOW_DIFF_CFG_CH2_1_0x8d,  0x00},
    {RA_PROX_LOW_DIFF_CFG_CH3_0_0x8e,  0x06}, //low int 0x2FF*32  192
    {RA_PROX_LOW_DIFF_CFG_CH3_1_0x8f,  0x00},

    {RA_CH0_SAMP_CFG_0xbf,             0x00},
    {RA_CH10_SCAN_FACTOR_0xc0,         0x00}, // 0x32: ch1 odr * 1     ch0 odr * 1.
    {RA_CH32_SCAN_FACTOR_0xc1,         0x70}, // 0x70: ch3 odr * 128   ch2 odr * 1
    {RA_OFFSET_CALI_CTRL_0xc2,         0x40},
    {RA_DSP_CONFIG_CTRL0_0xc3,         0xF0}, //baseline cali en
    {RA_DSP_CONFIG_CTRL3_0xca,         0x00}, //lp out offset 0

    {RA_CH0_CFG_7_0_0x03,              0x2C}, //channel config
    {RA_CH0_CFG_9_8_0x04,              0x00},
    {RA_CH1_CFG_7_0_0x05,              0xC0},
    {RA_CH1_CFG_9_8_0x06,              0x02},
    {RA_CH2_CFG_7_0_0x07,              0x03},
    {RA_CH2_CFG_9_8_0x08,              0x02},
    {RA_CH3_CFG_7_0_0x09,              0x00},
    {RA_CH3_CFG_9_8_0x0A,              0x03},
