...
/* F52 code for QN3979-325 by feihui at 2021/02/26 start*/
#define QSEECOM_SCM_EBUSY_MAX_RETRY 130
/* F52 code for QN3979-325 by feihui at 2021/02/26 end*/
...
static int __qseecom_scm_call2_locked(uint32_t smc_id, struct scm_desc *desc)
{
	...
	do {
		...
		/* F52 code for QN3979-325 by feihui at 2021/02/26 start*/
		if (retry_count == QSEECOM_SCM_EBUSY_MAX_RETRY - 1)
			BUG_ON(1);
		/* F52 code for QN3979-325 by feihui at 2021/02/26 end*/
	} while (ret == -EBUSY &&
