...
#ifndef __MIF_REG_8835_H
#define __MIF_REG_8835_H
...
/* MAILBOX_AP_WLBT_PMU_BASE   0x11BC0000    */
/********************************************/
...
/* #define INTREQ_ACTIVE BIT(14) this bit is not used in S5E8835 */
...
/* #define SHIFTING_DONE_OTP_BLK  BIT(5) this bit is not present in S5E8835 */
...
/* VALUES for MAILBOX */
#define WLBT_MAILBOX_AP_WLAN 0x11B40000
...
#define WLBT_CBUS_BAAW_1_START 0x58090000
...
#define WLBT_CBUS_BAAW_7_END 0x5823FFFF
...
#define CHIP_IP_ID_8835 0xAC  /* QUARTZ CHIP ID */
...
#define PMU_BOOT_RAM_END ((PMU_BOOT_RAM_START) + 0xffff)
