...
#if 0
enum mxman_states mxman_if_get_state(struct mxman *mxman)
{
...
void mxman_if_fail(struct mxman *mxman, u16 scsc_panic_code, const char *reason)
{
	mxman_fail(mxman, scsc_panic_code, reason);
}
...
int mxman_if_force_panic(struct mxman *mxman)
{
