...
#define DREX_TIMING_PARA(rfcpb, row, data, power, fetch, etc_con, train_timing, hw_ptrain_period, \
		hwpr_train_config, hwpr_train_control, mr13, mr1, mr2, mr22, mr11, mr14, vtmon_drex_timing_set_sw) \
{ \
...
#define WR_TRAIN_CODE 0x04000400
#else
#define WR_TRAIN_CODE 0
#endif

#define dvfs_offset 0

#define RD_PREAMBLE			0

#if RD_PREAMBLE
#define MR1_OP_DIFF			0xDE
#define GATEADJ				0xA0
#define RPRE_OPT			1
#else
#define MR1_OP_DIFF			0x56
#define GATEADJ				0xB0
#define RPRE_OPT			0
#endif
...
{
	DREX_TIMING_PARA(0x00002323, 0x46588652, 0x4732BBE0, 0x404A0336, 0x00004E02, 0x00000000, 0x319BA14A, 0x00005DC0, 0x01010101|(WR_TRAIN_CODE), 0x00000003,
			0x00211400, 0x00200400|(MR1_OP_DIFF<<2), 0x00200800|(0x2D<<2), 0x00221800 | (0x26<<2), 0x00210c00|(0x04<<2), 0x00211800|(0x0F<<2), 0x00000000),
	DREX_TIMING_PARA(0x00002121, 0x42588611, 0x4732BBE0, 0x3C460336, 0x00004902, 0x00000000, 0x319BA14A, 0x00005DC0, 0x01010101|(WR_TRAIN_CODE), 0x00000003,
			0x00211400, 0x00200400|(MR1_OP_DIFF<<2), 0x00200800|(0x2D<<2), 0x00221800 | (0x26<<2), 0x00210c00|(0x04<<2), 0x00211800|(0x0F<<2), 0x00000000),
	DREX_TIMING_PARA(0x00001D1D, 0x3947754F, 0x4632B3DC, 0x343D0335, 0x00004002, 0x00000000, 0x319BA13A, 0x00005DC0, 0x01010101, 0x00000003,
			0x00211400, 0x00200400|(MR1_OP_DIFF<<2), 0x00200800|(0x24<<2), 0x00221800 | (0x26<<2), 0x00210c00|(0x04<<2), 0x00211800|(0x0F<<2), 0x00000000),
	...
	DREX_TIMING_PARA(0x00001313, 0x2635538A, 0x3422AAD6, 0x24280234, 0x00002A02, 0x00000000, 0x219BA12A, 0x00FFFFFF, 0x00000000, 0x00000000,
			0x00211400, 0x00200400|(0x56<<2), 0x00200800|(0x1B<<2), 0x00221800 | (0x26<<2), 0x00210c00|(0x04<<2), 0x00211800|(0x0F<<2), 0x00000000),
	DREX_TIMING_PARA(0x00000F0F, 0x1D2442C8, 0x2322A310, 0x1C1F0233, 0x00002003, 0x00000000, 0x019BA10B, 0x00FFFFFF, 0x00000000, 0x00000000,
			0x00211400, 0x00200400|(0x56<<2), 0x00200800|(0x12<<2), 0x00221800 | (0x26<<2), 0x00210c00|(0x04<<2), 0x00211800|(0x0F<<2), 0x00000000),
	...
	DREX_TIMING_PARA(0x00000D0D, 0x19233247, 0x23229ACC, 0x181F0233, 0x00001C02, 0x00000000, 0x019BA10A, 0x00FFFFFF, 0x00000000, 0x00000000,
			0x00211400, 0x00200400|(0x56<<2), 0x00200800|(0x09<<2), 0x00221800 | (0x26<<2), 0x00210c00|(0x04<<2), 0x00211800|(0x0F<<2), 0x00000000),
#else
	...
	DREX_TIMING_PARA(0x00000A0A, 0x192331C5, 0x22229ACC, 0x141F0233, 0x00001502, 0x00000000, 0x019BA0FA, 0x00FFFFFF, 0x00000000, 0x00000000,
			0x00211400, 0x00200400|(0x56<<2), 0x00200800|(0x09<<2), 0x00221800 | (0x24<<2), 0x00210c00|(0x00<<2), 0x00211800|(0x0F<<2), 0x00000000),
	...
	DREX_TIMING_PARA(0x00000707, 0x19232144, 0x22229286, 0x0C1F0233, 0x00000E02, 0x00000000, 0x019BA0FA, 0x00FFFFFF, 0x00000000, 0x00000000,
			0x00211400, 0x00200400|(0x56<<2), 0x00200800|(0x00<<2), 0x00221800 | (0x24<<2), 0x00210c00|(0x00<<2), 0x00211800|(0x0F<<2), 0x00000000),
#else
...
static struct dmc_phy_dfs_mif_table dfs_phy_mif_table[] =
{
	PHY_DVFS_CON(0x80200000|(dvfs_dqs_osc_en<<17), 0x40100000|(dvfs_dqs_osc_en<<16), PHY_DVFS_CON0_SET1_MASK, PHY_DVFS_CON0_SET0_MASK,
			0x20000000|(GATEADJ<<8), 0x00200000|(GATEADJ), PHY_DVFS_CON1_SET1_MASK, PHY_DVFS_CON1_SET0_MASK,
			0x20000000, 0x00400000, PHY_DVFS_CON2_SET1_MASK, PHY_DVFS_CON2_SET0_MASK,
			0x0860E000|(RPRE_OPT<<29), 0x0400060E|(RPRE_OPT<<28), PHY_DVFS_CON3_SET1_MASK, PHY_DVFS_CON3_SET0_MASK,
	...
	PHY_DVFS_CON(0x82200000|(dvfs_dqs_osc_en<<17), 0x41100000|(dvfs_dqs_osc_en<<16), PHY_DVFS_CON0_SET1_MASK, PHY_DVFS_CON0_SET0_MASK,
			0x20000000|(GATEADJ<<8), 0x00200000|(GATEADJ), PHY_DVFS_CON1_SET1_MASK, PHY_DVFS_CON1_SET0_MASK,
			0x20000000, 0x00400000, PHY_DVFS_CON2_SET1_MASK, PHY_DVFS_CON2_SET0_MASK,
			0x085B0000|(RPRE_OPT<<29), 0x040005B0|(RPRE_OPT<<28), PHY_DVFS_CON3_SET1_MASK, PHY_DVFS_CON3_SET0_MASK,
			0x00000000, 0x00000000, PHY_DVFS_CON4_SET1_MASK, PHY_DVFS_CON4_SET0_MASK,
			0x80700000, 0x40070000, PHY_DVFS_CON5_SET1_MASK, PHY_DVFS_CON5_SET0_MASK),
	PHY_DVFS_CON(0x82200000|(dvfs_dqs_osc_en<<17), 0x41100000|(dvfs_dqs_osc_en<<16), PHY_DVFS_CON0_SET1_MASK, PHY_DVFS_CON0_SET0_MASK,
			0x1C000000|(GATEADJ<<8), 0x001C0000|(GATEADJ), PHY_DVFS_CON1_SET1_MASK, PHY_DVFS_CON1_SET0_MASK,
			0x20000000, 0x00400000, PHY_DVFS_CON2_SET1_MASK, PHY_DVFS_CON2_SET0_MASK,
			0x084F0000|(RPRE_OPT<<29), 0x040004F0|(RPRE_OPT<<28), PHY_DVFS_CON3_SET1_MASK, PHY_DVFS_CON3_SET0_MASK,
			0x00000000, 0x00000000, PHY_DVFS_CON4_SET1_MASK, PHY_DVFS_CON4_SET0_MASK,
			0x80700000, 0x40070000, PHY_DVFS_CON5_SET1_MASK, PHY_DVFS_CON5_SET0_MASK),
	PHY_DVFS_CON(0x82200000|(dvfs_dqs_osc_en<<17), 0x41100000|(dvfs_dqs_osc_en<<16), PHY_DVFS_CON0_SET1_MASK, PHY_DVFS_CON0_SET0_MASK,
			0x1C000000|(GATEADJ<<8), 0x001C0000|(GATEADJ), PHY_DVFS_CON1_SET1_MASK, PHY_DVFS_CON1_SET0_MASK,
			0x20000000, 0x00400000, PHY_DVFS_CON2_SET1_MASK, PHY_DVFS_CON2_SET0_MASK,
			0x0842C000|(RPRE_OPT<<29), 0x0400042C|(RPRE_OPT<<28), PHY_DVFS_CON3_SET1_MASK, PHY_DVFS_CON3_SET0_MASK,
			0x00000000, 0x00000000, PHY_DVFS_CON4_SET1_MASK, PHY_DVFS_CON4_SET0_MASK,
			0x80700000, 0x40070000, PHY_DVFS_CON5_SET1_MASK, PHY_DVFS_CON5_SET0_MASK),
	PHY_DVFS_CON(0x82200000|(dvfs_dqs_osc_en<<17), 0x41100000|(dvfs_dqs_osc_en<<16), PHY_DVFS_CON0_SET1_MASK, PHY_DVFS_CON0_SET0_MASK,
...
static struct dmc_drex_dfs_mif_table dfs_drex_mif_table[] =
{
	DREX_TIMING_PARA(0x00002323, 0x46588652, 0x4732BBE0, 0x404A0336, 0x00004E02, 0x00000000, 0x319BA14A, 0x00005DC0, 0x01010101, 0x00000003,
			0x00211400, 0x00200400|(0x56<<2), 0x00200800|(0x2D<<2), 0x00221800 | (0x26<<2), 0x00210c00|(0x04<<2), 0x00211800|(0x0F<<2), 0x00000000),
	DREX_TIMING_PARA(0x00002121, 0x42588611, 0x4732BBE0, 0x3C460336, 0x00004902, 0x00000000, 0x319BA14A, 0x00005DC0, 0x01010101, 0x00000003,
			0x00211400, 0x00200400|(0x56<<2), 0x00200800|(0x2D<<2), 0x00221800 | (0x26<<2), 0x00210c00|(0x04<<2), 0x00211800|(0x0F<<2), 0x00000000),
	DREX_TIMING_PARA(0x00001D1D, 0x3947754F, 0x4632B3DC, 0x343D0335, 0x00004002, 0x00000000, 0x319BA13A, 0x00005DC0, 0x01010101, 0x00000003,
			0x00211400, 0x00200400|(0x56<<2), 0x00200800|(0x24<<2), 0x00221800 | (0x26<<2), 0x00210c00|(0x04<<2), 0x00211800|(0x0F<<2), 0x00000000),
	DREX_TIMING_PARA(0x00001919, 0x3146648C, 0x3532B39C, 0x2C340335, 0x00003602, 0x00000000, 0x319BA13A, 0x00005DC0, 0x01010101, 0x00000003,
			0x00211400, 0x00200400|(0x56<<2), 0x00200800|(0x24<<2), 0x00221800 | (0x26<<2), 0x00210c00|(0x04<<2), 0x00211800|(0x0F<<2), 0x00000000),
	DREX_TIMING_PARA(0x00001313, 0x2635538A, 0x3422AAD6, 0x24280234, 0x00002A02, 0x00000000, 0x219BA12A, 0x00FFFFFF, 0x00000000, 0x00000000,
			0x00211400, 0x00200400|(0x56<<2), 0x00200800|(0x1B<<2), 0x00221800 | (0x26<<2), 0x00210c00|(0x04<<2), 0x00211800|(0x0F<<2), 0x00000000),
...
#ifdef L9_RL_WL_DECREASE
	DREX_TIMING_PARA(0x00000707, 0x19232144, 0x22229286, 0x0C1F0233, 0x00000E02, 0x00000000, 0x019BA0FA, 0x00FFFFFF, 0x00000000, 0x00000000,
			0x00211400, 0x00200400|(0x56<<2), 0x00200800|(0x00<<2), 0x00221800 | (0x26<<2), 0x00210c00|(0x04<<2), 0x00211800|(0x0F<<2), 0x00000000),
#else
	DREX_TIMING_PARA(0x00000707, 0x19232144, 0x22229A8C, 0x0C1F0233, 0x00000E02, 0x00000000, 0x019BA0FA, 0x00FFFFFF, 0x00000000, 0x00000000,
			0x00211400, 0x00200400|(0x56<<2), 0x00200800|(0x09<<2), 0x00221800 | (0x26<<2), 0x00210c00|(0x04<<2), 0x00211800|(0x0F<<2), 0x00000000),
#endif
...
static struct dmc_drex_dfs_mif_table dfs_drex_mif_table[] =
{
	DREX_TIMING_PARA(0x00002323, 0x46588652, 0x4732BBE0, 0x404A0336, 0x00004E02, 0x00000000, 0x319BA14A, 0x00FFFFFF, 0x00000000, 0x00000000,
			0x00211400, 0x00200400|(0x56<<2), 0x00200800|(0x2D<<2), 0x00210c00|(0x04<<2), 0x00211800|(0x0F<<2), 0x00000000),
	...
	DREX_TIMING_PARA(0x00001D1D, 0x3947754F, 0x4632B3DC, 0x343D0335, 0x00004002, 0x00000000, 0x319BA13A, 0x00FFFFFF, 0x00000000, 0x00000000,
			0x00211400, 0x00200400|(0x56<<2), 0x00200800|(0x24<<2), 0x00210c00|(0x04<<2), 0x00211800|(0x0F<<2), 0x00000000),
	DREX_TIMING_PARA(0x00001919, 0x3146648C, 0x3532B39C, 0x2C340335, 0x00003602, 0x00000000, 0x319BA13A, 0x00FFFFFF, 0x00000000, 0x00000000,
			0x00211400, 0x00200400|(0x56<<2), 0x00200800|(0x24<<2), 0x00210c00|(0x04<<2), 0x00211800|(0x0F<<2), 0x00000000),
	DREX_TIMING_PARA(0x00001313, 0x2635538A, 0x3422AAD6, 0x24280234, 0x00002A02, 0x00000000, 0x219BA12A, 0x00FFFFFF, 0x00000000, 0x00000000,
			0x00211400, 0x00200400|(0x56<<2), 0x00200800|(0x1B<<2), 0x00210c00|(0x04<<2), 0x00211800|(0x0F<<2), 0x00000000),
	DREX_TIMING_PARA(0x00000F0F, 0x1D2442C8, 0x2322A310, 0x1C1F0233, 0x00002003, 0x00000000, 0x019BA10B, 0x00FFFFFF, 0x00000000, 0x00000000,
			0x00211400, 0x00200400|(0x56<<2), 0x00200800|(0x12<<2), 0x00210c00|(0x04<<2), 0x00211800|(0x0F<<2), 0x00000000),
	DREX_TIMING_PARA(0x00000D0D, 0x19233247, 0x2322A2D0, 0x181F0233, 0x00001C02, 0x00000000, 0x019BA10A, 0x00FFFFFF, 0x00000000, 0x00000000,
			0x00211400, 0x00200400|(0x56<<2), 0x00200800|(0x12<<2), 0x00210c00|(0x04<<2), 0x00211800|(0x0F<<2), 0x00000000),
	DREX_TIMING_PARA(0x00000A0A, 0x192331C5, 0x22229ACC, 0x141F0233, 0x00001502, 0x00000000, 0x019BA0FA, 0x00FFFFFF, 0x00000000, 0x00000000,
			0x00211400, 0x00200400|(0x56<<2), 0x00200800|(0x09<<2), 0x00210c00|(0x04<<2), 0x00211800|(0x0F<<2), 0x00000000),
	DREX_TIMING_PARA(0x00000808, 0x19232185, 0x22229ACC, 0x101F0233, 0x00001202, 0x00000000, 0x019BA0FA, 0x00FFFFFF, 0x00000000, 0x00000000,
			0x00211400, 0x00200400|(0x56<<2), 0x00200800|(0x09<<2), 0x00210c00|(0x04<<2), 0x00211800|(0x0F<<2), 0x00000000),
#ifdef L9_RL_WL_DECREASE
	DREX_TIMING_PARA(0x00000707, 0x19232144, 0x22229286, 0x0C1F0233, 0x00000E02, 0x00000000, 0x019BA0FA, 0x00FFFFFF, 0x00000000, 0x00000000,
			0x00211400, 0x00200400|(0x56<<2), 0x00200800|(0x00<<2), 0x00210c00|(0x04<<2), 0x00211800|(0x0F<<2), 0x00000000),
#else
	DREX_TIMING_PARA(0x00000707, 0x19232144, 0x22229A8C, 0x0C1F0233, 0x00000E02, 0x00000000, 0x019BA0FA, 0x00FFFFFF, 0x00000000, 0x00000000,
			0x00211400, 0x00200400|(0x56<<2), 0x00200800|(0x09<<2), 0x00210c00|(0x04<<2), 0x00211800|(0x0F<<2), 0x00000000),
#endif
							...
							int target_idx, int timing_set_num)
{
	...
	if (timing_set_num) {
		for (i = 0; i< MIF_BLK_NUM; i++) {
			...
			__raw_writel(cur_drex_param->drex_DirectCmd_mr1, data->base_drex[i] + DREX_DIRECTCMD);
						...
						void *v)
{
	...
	if (event == MIF_TH_LV2) {
		...
		if (*on) {
			...
			prev_volt = (unsigned long)data->old_volt;
