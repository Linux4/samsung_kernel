					...
					const char *buf, size_t count)
{
	...
	trace_sprd_dfs_sysfs(__func__, request_freq);
	return count;
}
...
static DEVICE_ATTR(scaling_request_ddr_freq, 0664,
	scaling_request_ddr_freq_show, scaling_request_ddr_freq_store);
