...
//checklist 102625 and 102624, cjd.wt,update eye diagram parameter,2022/06/01
#define TFREGRES_TUNE_VALUE    0x0bbdd00
...
static int sprd_hsphy_init(struct usb_phy *x)
{
	...
	msk = 0x0ffff00;//checklist 102625 and 102624,cjd.wt,modify,2022/06/01,modify "msk = MASK_ANLG_PHY_G2_ANALOG_USB20_USB20_TFREGRES" to "msk = 0x0ffff00"
	ret |= regmap_update_bits(phy->ana_g2,
		REG_ANLG_PHY_G2_ANALOG_USB20_USB20_TRIMMING,
		msk, reg);
