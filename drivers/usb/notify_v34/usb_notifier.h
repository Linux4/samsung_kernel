...
#else
static inline int dwc3_exynos_id_event(struct device *dev, int state)
{
	return 0;
}
static inline int dwc3_exynos_vbus_event(struct device *dev, int state)
{
	return 0;
}
#endif
...
#else
static inline int exynos_otg_vbus_event(struct platform_device *pdev, int state)
{
	return 0;
}
#endif
