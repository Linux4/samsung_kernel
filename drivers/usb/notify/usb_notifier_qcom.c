...
extern int msm_otg_vbus_event(int online);
extern void dwc3_max_speed_setting(int speed);

extern void set_ncm_ready(bool ready);
extern int msm_otg_id_event(int enable);
extern int msm_otg_vbus_power(bool enable);
...
#endif
#if defined(CONFIG_USB_CHARGING_EVENT)
...
{
#if defined(CONFIG_CCIC_NOTIFIER) || defined(CONFIG_MUIC_NOTIFIER) || defined(CONFIG_VBUS_NOTIFIER)
