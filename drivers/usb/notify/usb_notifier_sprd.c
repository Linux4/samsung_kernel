...
{
	pdata->gpio_redriver_en = of_get_named_gpio(np, "sprd,gpios_redriver_en", 0);
...
static void of_get_disable_control_en_dt(struct device_node *np,
		struct usb_notifier_platform_data *pdata)
{
	of_property_read_u32(np, "sprd,disable_control_en", &pdata->disable_control_en);
...
static void of_get_unsupport_host_dt(struct device_node *np,
		struct usb_notifier_platform_data *pdata)
{
	of_property_read_u32(np, "sprd,unsupport_host_en", &pdata->unsupport_host_en);
...
#if 0
static int sprd_set_host(bool enable)
{
	return 0;
}

static int sprd_set_peripheral(bool enable)
{
	return 0;
}

static int sprd_get_gadget_speed(void)
{
	return 0;
}
#endif
...
#endif
#if 0
	.set_host = sprd_set_host,
	.set_peripheral	= sprd_set_peripheral,
	.get_gadget_speed = sprd_get_gadget_speed,
#endif
