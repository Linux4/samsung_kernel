...
static int gs_start_io(struct gs_port *port)
{
	...
	/* F52 code for P210503-01278 Fix the bug that kernel panic when samsung use AUT start */
	//if (started) {
	if (started && port->port.tty != NULL) {
	/* F52 code for P210503-01278 Fix the bug that kernel panic when samsung use AUT end */
		gs_start_tx(port);
