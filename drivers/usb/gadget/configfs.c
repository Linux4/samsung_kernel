...
#ifdef CONFIG_USB_SAMSUNG_NO_SERIAL
		gi->cdev.desc.iSerialNumber = 0x0;
#else
					...
					const char *buff, size_t size)
{
	...
	cdev->flag_factory_for_u2 = false;
#endif
...
#ifdef CONFIG_USB_ANDROID_SAMSUNG_COMPOSITE
					if (!strcmp(f->name, "mbim")) {
						cdev->desc.bcdDevice = cpu_to_le16(0x0419);
						is_mbim_exist = 1;
#ifdef CONFIG_USB_CONFIGFS_F_MBIM
						/* enable U2 */
						cdev->flag_factory_for_u2 = true;
#endif
					}
