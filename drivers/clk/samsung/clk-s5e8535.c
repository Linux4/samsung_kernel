...
struct init_vclk s5e8535_aud_vclks[] = {
	...
	VCLK(DOUT_DIV_CLK_AUD_DMIC_SYS, DIV_CLK_AUD_DMIC_SYS, "DOUT_DIV_CLK_AUD_DMIC_SYS", 0, 0, NULL),
	VCLK(DOUT_DIV_CLK_AUD_DMIC, DIV_CLK_AUD_DMIC, "DOUT_DIV_CLK_AUD_DMIC", 0, 0, NULL),
