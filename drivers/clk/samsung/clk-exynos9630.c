...
struct init_vclk exynos9630_peri_hwacg_vclks[] __initdata = {
	...
	HWACG_VCLK(GATE_USI01_USI_QCH, USI01_USI_QCH, "GATE_USI01_USI_QCH", "UMUX_CLKCMU_PERI_BUS_USER", 0, VCLK_GATE, "fp_spi_pclk"),
#else
...
#ifdef CONFIG_SENSORS_FINGERPRINT		
	VCLK(DOUT_CLK_PERI_USI01_USI, VCLK_DIV_CLK_PERI_USI01_USI, "DOUT_CLK_PERI_USI01_USI", 0, 0, "fp_spi_sclk"),
#else
