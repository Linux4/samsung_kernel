...
static const struct ufs_cal_phy_cfg init_cfg[] = {
	...
	{0x1B4, 0x01, PMD_ALL, PHY_PMA_TRSV, BRD_ALL},	/* Enable CDR HW retry */
...
static struct ufs_cal_phy_cfg calib_of_hs_rate_a[] = {
	...
	{0x134, 0x33, PMD_HS_G2_L2, PHY_PMA_TRSV, BRD_HSIE},
	{0x134, 0x03, PMD_HS_G2_L2, PHY_PMA_TRSV, BRD_ALL^BRD_HSIE},
	{0x134, 0x03, PMD_HS_G1_L2|PMD_HS_G3_L2, PHY_PMA_TRSV, BRD_ALL},
...
static struct ufs_cal_phy_cfg pre_h8_exit[] = {
	...
	{0x1fc, 0x01, PMD_HS, PHY_CDR_AFC_WAIT, BRD_ALL},	/* Enable CDR SW retry */
	{},
};
