			    ...
			    const struct i2c_device_id *id)
{
...

	{
		...
		/* buck damage issue workaround */
		s2mpb01_write_reg(s2mpb01->i2c, 0x25, 0x91);
		s2mpb01_write_reg(s2mpb01->i2c, 0x22, 0x5B);
		s2mpb01_write_reg(s2mpb01->i2c, 0x24, 0x0C);
		pr_info("%s: buck damage patch applied\n", __func__);
	}
