...
// bayhub add for degrade code at 2021/10/21 start
#ifdef CONFIG_MMC_SDHCI_BH201
			/* Set degrade flag */
			card->host->degrade = 1;
			pr_err("### Bayhub debug: Set degrade flag, because MMC_BLK_CMD_ERR retry %d ###", retry);
#endif
// bayhub add for degrade code at 2021/10/21 end
