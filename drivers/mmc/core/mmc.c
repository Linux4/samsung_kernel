...
#include <linux/mm.h> //bug 760817,cjd.wt,add flash_name and vendor node,2022/05/26
...
MMC_DEV_ATTR(life_time, "0x%02x 0x%02x\n",
	card->ext_csd.device_life_time_est_typ_a,
	card->ext_csd.device_life_time_est_typ_b);
MMC_DEV_ATTR(life_time_est_typ_a, "0x%02x\n",card->ext_csd.device_life_time_est_typ_a);//bug 760817,cjd.wt,add life_time node,2022/05/26
MMC_DEV_ATTR(life_time_est_typ_b, "0x%02x\n",card->ext_csd.device_life_time_est_typ_b);//bug 760817,cjd.wt,add life_time node,2022/05/26
...
//bug 696988,huangxiaotian,add flash_name and vendor node,2021/10/27,start
static int calc_mem_size(void)
{
    int temp_size;
    temp_size = totalram_pages/1024; //page size 4K
...
static struct attribute *mmc_std_attrs[] = {
	...
	&dev_attr_life_time_est_typ_a.attr,      //bug 760817,cjd.wt,add life_time node,2022/05/26
	&dev_attr_life_time_est_typ_b.attr,      //bug 760817,cjd.wt,add life_time node,2022/05/26
