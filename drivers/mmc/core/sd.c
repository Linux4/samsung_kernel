...
extern int sdcard_insert_or_not;//plug in:1     plug out:0. Add for sdcard status node
/*
	...
	struct mmc_card *oldcard)
{
	...
	sdcard_insert_or_not = 1;//Add for sdcard status node
...
static void mmc_sd_remove(struct mmc_host *host)
{
	...
	host->card = NULL;
	sdcard_insert_or_not = 0;//Add for sdcard status node
}
