...
/*V1:0x5A514177;V2:0x6A614177;V3:0x7A714177*/
#define   GGC_CFG_DATA {0x07000000, 0x07364022, 0x01015412, 0x01062400,\
  ...
  0x00020006, 0x40000400, 0x12200310, 0x29414177}
...
extern int sprd_calc_tuning_range(struct sprd_sdhc_host* host, int* value_t);
extern int sprd_sdhc_execute_tuning(struct mmc_host* mmc, u32 opcode);
#endif
