...
#define MSDC_SD_USE_EXT_LDO (1 << 15)	/* sd card use external ldo for VMCH */
...
#define msdc_set_sd_ext_ldo(h) ((h)->hw->flags |= MSDC_SD_USE_EXT_LDO)
#define msdc_clr_sd_ext_ldo(h) ((h)->hw->flags &= ~MSDC_SD_USE_EXT_LDO)
#define msdc_sd_use_ext_ldo(h) ((h)->hw->flags & MSDC_SD_USE_EXT_LDO)
