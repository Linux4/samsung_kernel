...
#if 0
static int sm5703_muic_logically_detach(struct sm5703_muic_data *muic_data,
						muic_attached_dev_t new_dev)
{
	bool noti = true;
...
#endif
#if 0
	ret = sm5703_muic_logically_detach(muic_data, new_dev);
	if (ret)
...
#ifdef CONFIG_MUIC_SM5703_SUPPORT_OTG
		intr = MUIC_INTR_ATTACH;
#endif
...
#ifdef CONFIG_MUIC_SM5703_ENABLE_AUTOSW
	/* set AUTO SW mode */
