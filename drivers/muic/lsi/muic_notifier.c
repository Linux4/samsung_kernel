...
#if defined(CONFIG_CCIC_S2MU004) || defined(CONFIG_MUIC_S2MU107)//TEMP CCIC_S2MU107
static struct muic_notifier_struct muic_ccic_notifier;
#endif

#if defined(CONFIG_SWITCH) && !defined(CONFIG_MUIC_S2MU107)//TEMP CCIC_S2MU107
...
#else
	pcxt = (void *)&(muic_notifier.attached_dev);

	/* current muic's attached_device status notify */
	nb->notifier_call(nb, muic_notifier.cmd, pcxt);
#endif
...
#if defined(CONFIG_CCIC_S2MU004) || defined(CONFIG_CCIC_S2MU107)//TEMP CCIC_S2MU107
