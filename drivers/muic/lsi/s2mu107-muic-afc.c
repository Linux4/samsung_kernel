...
muic_attached_dev_t hv_muic_check_id_err(struct s2mu107_muic_data *muic_data,
		muic_attached_dev_t new_dev)
{
...
void hv_muic_change_afc_voltage(struct s2mu107_muic_data *muic_data, int tx_data)
{
	struct muic_platform_data *muic_pdata = muic_data->pdata;
