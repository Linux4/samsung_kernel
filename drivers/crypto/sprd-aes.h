...
#define SWITCH_ENC_DEC			0x03

/* the self-defined return value */
#define CE_ERROR	0

/* config register address offset outside of ce */
#define SPRD_CE_MM			0x00
#define SPRD_CE_EN			0x04
#define SPRD_PM_AUTO_FORCE_EN		0x001c
#define SPRD_PM_AUTO_FORCE		0x01a4

/* the configure value of the register outside of ce. */
#define CMD_CE_MM			0x02000000
#define CMD_CE_EN			0x10000000
#define CMD_PM_AUTO_WAY			0x01000000
#define CMD_PM_FORCE_WAY		0x02000000

/*it only used to test multi-list mode of sprd.*/
/*#define MULTI_LIST_TEST*/

/* it only used to enable the polling-mode of aes driver. */
/*#define	POLL_WHILE*/
