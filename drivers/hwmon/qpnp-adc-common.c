...
#elif (defined(CONFIG_MACH_MS01_EUR_3G) || defined(CONFIG_MACH_MS01_LTE) || defined(CONFIG_MACH_CRATERQ) || \
defined(CONFIG_MACH_MS01_CHN_CMCC_3G) || defined(CONFIG_MACH_MS01_CHN_CU_3G)) || defined(CONFIG_MACH_CS03_SGLTE)
...
#elif defined(CONFIG_MACH_MS01_LTE_KOR)
static const struct qpnp_vadc_map_pt adcmap_btm_threshold[] = {
	{-200,	1678},
	{-150,	1624},
	{-100,	1558},
