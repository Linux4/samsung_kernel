...
static int __init cm36657_light_factory_init(void)
{
...
static void __exit cm36657_light_factory_exit(void)
{
	adsp_factory_unregister(ADSP_FACTORY_LIGHT);
	pr_info("[FACTORY] %s\n", __func__);
}
module_init(cm36657_light_factory_init);
module_exit(cm36657_light_factory_exit);
