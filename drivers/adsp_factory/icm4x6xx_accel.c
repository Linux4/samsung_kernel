...
static int __init icm4x6xx_accel_factory_init(void)
{
...
static void __exit icm4x6xx_accel_factory_exit(void)
{
...
module_init(icm4x6xx_accel_factory_init);
module_exit(icm4x6xx_accel_factory_exit);
