...
static int __init cs5032_light_factory_init(void)
{
...
static void __exit cs5032_light_factory_exit(void)
{
	adsp_factory_unregister(ADSP_FACTORY_LIGHT);
	pr_info("[FACTORY] %s\n", __func__);
}
module_init(cs5032_light_factory_init);
module_exit(cs5032_light_factory_exit);
