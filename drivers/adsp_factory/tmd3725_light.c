...
static int __init tmd3725_light_factory_init(void)
{
...
static void __exit tmd3725_light_factory_exit(void)
{
	adsp_factory_unregister(ADSP_FACTORY_LIGHT);
	pr_info("[FACTORY] %s\n", __func__);
}
module_init(tmd3725_light_factory_init);
module_exit(tmd3725_light_factory_exit);
