...
#define SX9310_NORMAL_TOUCH_THRESHOLD 96
#define SX9310_INIT_TOUCH_THRESHOLD 2000
...
static void sx9310_initialize_variable(struct sx9310_p *data)
{
	...
	memset(data->calData, 0, sizeof(int) * 3);
	atomic_set(&data->enable, OFF);
	data->initTh = (int)SX9310_INIT_TOUCH_THRESHOLD;
	pr_info("[SX9310]: %s - Init Touch Threshold : %d\n",
		__func__, data->initTh);
	data->touchTh = (u8)SX9310_NORMAL_TOUCH_THRESHOLD;
