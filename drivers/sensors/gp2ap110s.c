...
#define FORCE_CLOSE_OFFSET_THD   100
#define FORCE_CLOSE_HIGH_THD     0x01
#define FORCE_CLOSE_LOW_THD	     0x01
...
static void gp2ap_InitData(struct gp2ap_data *data)
{
	...
	if (offset >= FORCE_CLOSE_OFFSET_THD) {
