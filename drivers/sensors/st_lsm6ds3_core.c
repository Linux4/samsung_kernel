...
#ifdef CONFIG_SENSORS_J7MAX_QUEUE_PRIORITY_FOR_CTS
	cdata->accel_wq = alloc_ordered_workqueue("accel_wq", WQ_HIGHPRI | __WQ_ORDERED);
#else
...
#ifdef CONFIG_SENSORS_J7MAX_QUEUE_PRIORITY_FOR_CTS
	cdata->gyro_wq = alloc_ordered_workqueue("gyro_wq", WQ_HIGHPRI | __WQ_ORDERED);
#else
