...
/* F52  code for QN3979-3133 by xiongxiaoliang at 20210419 start */
#ifdef HQ_FACTORY_BUILD
    char *factory_flag = NULL;
    module_param(factory_flag, charp, 0644);
#endif
/* F52  code for QN3979-3133 by xiongxiaoliang at 20210419 end */
