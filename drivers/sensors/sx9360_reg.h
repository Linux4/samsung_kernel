...
static struct smtc_reg_data usefilter_reg[] = {
	/* 0x90~0x9b and 0x9e-0x9f, UseFilter Registers */
	{	.reg = SX9360_REGUSEMSBPHR,	},
    {	.reg = SX9360_REGUSELSBPHR,	},
    {	.reg = SX9360_REGOFFSETMSBPHR,	},
    {	.reg = SX9360_REGOFFSETLSBPHR,	},
    {	.reg = SX9360_REGUSEMSBPHM,	},
	{	.reg = SX9360_REGUSEMSBPHR,	},
    {	.reg = SX9360_REGUSELSBPHM,	},
    {	.reg = SX9360_REGAVGMSBPHM,	},
    {	.reg = SX9360_REGAVGLSBPHM,	},
    {	.reg = SX9360_REGDIFFLSBPHM,	},
	{	.reg = SX9360_REGOFFSETMSBPHM,	},
    {	.reg = SX9360_REGOFFSETLSBPHM,	},
    {	.reg = SX9360_USEFILTMSB,	},
    {	.reg = SX9360_USEFILTLSB,	},	
};
