...
#define I2C_CONTROL_IRQ_SEL     (0x1 << 7)//Bug 527462, add I2C_CONTROL_IRQ_SEL, dulinyu.wt, 20200107
...
struct mtk_i2c_compatible {
	...
	unsigned char cnt_constraint;
        ...
        /* 0 : disable, 1 : enable*/
    unsigned char control_irq_sel;  //Bug 527462,add control_irq_sel dulinyu.wt, 20200107
	u16 ext_time_config;
