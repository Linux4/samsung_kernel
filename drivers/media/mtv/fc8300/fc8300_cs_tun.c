							...
							u32 offset)
{
	...
	n_val =	f_vco / main_xtal_freq;
	f_diff = f_vco - main_xtal_freq * n_val;

	f_diff_shifted = f_diff << (20 - pre_shift_bits);

	k_val = f_diff_shifted / (main_xtal_freq >> pre_shift_bits);
	k_val = k_val | 1;
		...
		enum BROADCAST_TYPE broadcast)
{
	...
	cal_temp = main_xtal_freq * 720 / 9000;
...
#if (BBM_BAND_WIDTH == 6)
	cal_temp = main_xtal_freq * 720 / 30000;
#elif (BBM_BAND_WIDTH == 7)
	cal_temp = main_xtal_freq * 720 / 35000;
#else /* BBM_BAND_WIDTH == 8 */
	cal_temp = main_xtal_freq * 720 / 40000;
	...
	fc8300_write(handle, devid, 0x4b, (u8) (main_xtal_freq / 1000));
