...
char *EWS_PRIORITY_TABLE[4] = {
	"Unknown", "Î≥¥ÌÜµ", "Í∏¥Í∏â", "Îß§Ïö∞Í∏¥Í∏â"
};
...
char *EWS_CATEGORY[67][3] = {
	{"?∏Ïö∞ Ï£ºÏùòÎ≥?,              "HRA", "Heavy Rain Watch"},
	{"?∏Ïö∞ Í≤ΩÎ≥¥",                "HRW", "Heavy Rain Warning"},
	{"?Ä??Ï£ºÏùòÎ≥?,              "HSW", "Heavy Snow Watch"},
	{"?Ä??Í≤ΩÎ≥¥",                "HAS", "Heavy Snow Warning"},
	{"??íç?¥ÏùºÏ£ºÏùòÎ≥?,           "SSA", "Storm Surge Watch"},
	{"??íç?¥Ïùº Í≤ΩÎ≥¥",            "SSW", "Storm Surge Warning"},
	{"?©ÏÇ¨ Í≤ΩÎ≥¥",                "YSW", "Yellow Sand Warning"},
	{"?úÌåå Ï£ºÏùòÎ≥?,              "CWA", "Cold Wave Watch"},
	{"?úÌåå Í≤ΩÎ≥¥",                "CWW", "Cold Wave Warning"},
	{"?çÎûë Í≤ΩÎ≥¥",                "WWW", "Wind and Waves Warning"},
	{"Í±¥Ï°∞ Í≤ΩÎ≥¥",                "HAW", "Heavy Arid Warning"},
	{"?∞Î∂à Í≤ΩÎ≥¥",                "MFW", "Mountain Fire Warning"},
	{"ÍµêÌÜµ ?µÏ†ú",                "RTW", "Regulate Traffic Warning"},
	{"Íµ?? ÎπÑÏÉÅ ?ÅÌô© Î∞úÏÉù",
	"EAN", "Emergency Action Notification(National only)"},
	{"Íµ?? ÎπÑÏÉÅ ?ÅÌô© Ï¢ÖÎ£å",
	"EAT", "Emergency Action Termination(National only)"},
	{"Ï§ëÏïô ?¨ÎÇú ?àÏ†Ñ ?ÄÏ±?Î≥∏Î?",
	"NIC", "National Information Center"},
	{"?ÑÍµ≠??Ï£ºÍ∏∞ ?åÏä§??,       "NPT", "National Periodic Test"},
	{"?ÑÍµ≠???îÎ≥Ñ ?òÎ¨¥ ?åÏä§??,  "RMT", "Required Monthly Test"},
	{"?ÑÍµ≠??Ï£ºÍ∞ÑÎ≥??òÎ¨¥ ?åÏä§??, "RWT", "Required Weekly Test"},
	{"?πÏàò ?òÏã†Í∏??åÏä§??,       "STT", "Special Terminal Test"},
	{"?âÏ†ï Î©îÏãúÏßÄ",              "ADR", "Administrative Message"},
	{"?∞ÏÇ¨??Í≤ΩÎ≥¥",              "AVW", "Avalanche Warning"},
	{"?∞ÏÇ¨??Ï£ºÏùòÎ≥?,            "AVA", "Avalanche Watch"},
	{"??íç?§Í≤ΩÎ≥?,               "BZW", "Blizzard Warning"},
	{"?¥Î¶∞???†Í¥¥ Í∏¥Í∏â ?ÅÌô©",
	"CAE", "Child Abduction Emergency"},
	{"?úÎ? ?ÑÌóò ?ÅÌô© Í≤ΩÎ≥¥",      "CDW", "Civil Danger Warning"},
	{"?úÎ? ?ëÍ∏â ?ÅÌô© Î©îÏãúÏßÄ",    "CEM", "Civil Emergency Message"},
	{"?¥Ïïà Ïπ®Ïàò Í≤ΩÎ≥¥",           "CFW", "Coastal Flood Warning"},
	{"?¥Ïïà Ïπ®Ïàò Ï£ºÏùòÎ≥?,         "CFA", "Coastal Flood Watch"},
	{"Î™®Îûò ??íç Í≤ΩÎ≥¥",           "DSW", "Dust Storm Warning"},
	{"ÏßÄÏß?Í≤ΩÎ≥¥",                "EQW", "Earthquake Warning"},
	{"Ï¶âÏãú ?Ä??,                "EVI", "Evacuation Immediate"},
	{"?îÏû¨ Í≤ΩÎ≥¥",                "FRW", "Fire Warning"},
	{"Í∏¥Í∏â ?çÏàò Í≤ΩÎ≥¥",           "FFW", "Flash Flood Warning"},
	{"Í∏¥Í∏â ?çÏàò Ï£ºÏùòÎ≥?,         "FFA", "Flash Flood Watch"},
	{"Í∏¥Í∏â ?çÏàò ?ÅÌô©",           "FFS", "Flash Flood Statement"},
	{"?çÏàò Í≤ΩÎ≥¥",                "FLW", "Flood Warning"},
	{"?çÏàò Ï£ºÏùòÎ≥?,              "FLA", "Flood Watch"},
	{"?çÏàò ?ÅÌô©",                "FLS", "Flood Statement"},
	{"?ÑÌóò Î¨ºÏßà Í≤ΩÎ≥¥",
	"HMW", "Hazardous Materials Warning"},
	{"Í∞ïÌíç Í≤ΩÎ≥¥",                "HWW", "High Wind Warning"},
	{"Í∞ïÌíç Ï£ºÏùòÎ≥?,              "HWA", "High Wind Watch"},
	{"?úÌíç Í≤ΩÎ≥¥",                "HUW", "Hurricane Warning"},
	{"?úÌíç Ï£ºÏùòÎ≥?,              "HUA", "Hurricane Watch"},
	{"?úÌíç?ïÎ≥¥",                 "HLS", "Hurricane Statement"},
	{"Î≤ïÏßë??Í≤ΩÍ≥†",              "LEW", "Law Enforcement Warning"},
	{"ÏßÄ??Í∏¥Í∏â ?ÅÌô©",           "LAE", "Local Area Emergency"},
	{"?µÏã† Î©îÏ????åÎ¶º",
	"NMN", "Network Message Notification"},
	{"119 ?ÑÌôî Î∂àÌÜµ ?ëÍ∏â ?ÅÌô©",
	"TOE", "119 Telephone Outage Emergency"},
	{"?µÎ∞ú?ÑÏÜå Í¥Ä??Í≤ΩÎ≥¥",
	"NUW", "Nuclear Power Plant Warning"},
	{"?§Ï†ú/?∞Ïäµ Í≤ΩÎ≥¥",           "DMO", "Practice/Demo Warning"},
	{"Î∞©ÏÇ¨???ÑÌóò Í≤ΩÎ≥¥",
	"RHW", "Radiological Hazard Warning"},
	{"?åÏö∞ Í≤ΩÎ≥¥",                "SVR", "Severe Thunderstorm Warning"},
	{"?åÏö∞ Ï£ºÏùòÎ≥?,              "SVA", "Severe Thunderstorm Watch"},
	{"?ÖÍ∏∞?ÅÏ†ïÎ≥?,               "SVS", "Severe Weather Statement"},
	{"?àÏ†Ñ???•ÏÜåÎ°??ºÎÇú Í≤ΩÎ≥¥",
	"SPW", "Shelter in Place Warning"},
	{"?πÏàò ?¥Ïñë Í≤ΩÎ≥¥",           "SMW", "Special Marine Warning"},
	{"?πÏù¥ Í∏∞ÏÉÅ ?ïÎ≥¥",           "SPS", "Special Weather Statement"},
	{"?†ÎÑ§?¥ÎèÑ Í≤ΩÎ≥¥",            "TOR", "Tornado Warning"},
	{"?†ÎÑ§?¥ÎèÑ Ï£ºÏùòÎ≥?,          "TOA", "Tornado Watch"},
	{"?¥Î? ??íç(?úÌíç) Í≤ΩÎ≥¥",     "TRW", "Tropical Storm Warning"},
	{"?¥Î? ??íç(?úÌíç) Ï£ºÏùòÎ≥?,   "TRA", "Tropical Storm Watch"},
	{"ÏßÄÏßÑÌï¥??Í≤ΩÎ≥¥",            "TSW", "Tsunami Warning"},
	{"ÏßÄÏßÑÌï¥??Ï£ºÏùòÎ≥?,          "TSA", "Tsunami Watch"},
	{"?îÏÇ∞ Í≤ΩÎ≥¥",                "VOW", "Volcano Warning"},
	{"?àÌè≠??Í≤ΩÎ≥¥",              "WSW", "Winter Storm Warning"},
	{"?àÌè≠??Ï£ºÏùòÎ≥?,            "WSA", "Winter Storm Watch"}
};
