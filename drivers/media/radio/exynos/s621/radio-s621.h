...
#ifndef CONFIG_SOC_EXYNOS8835
#define CONFIG_SOC_EXYNOS8835
#endif

#ifndef CONFIG_RADIO_S621
#define CONFIG_RADIO_S621
#endif
...
struct s621_radio {
	...
	struct i2c_client *i2c_sub1;
	struct i2c_client *i2c_sub2;
	u8 ldo8s;
	u8 ldo27m_ctrl;
	u8 ldo27m_out;
#endif /* USE_AUDIO_PM */
...
extern int s2mpu16_read_reg(struct i2c_client *i2c, u8 reg, u8 *dest);
extern int s2mpu16_write_reg(struct i2c_client *i2c, u8 reg, u8 value);
