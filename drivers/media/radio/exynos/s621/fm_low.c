...
const u32 build_identifier_integer = 0X22072908;	/*YYMMDDHH*/
...
void s621_if_work(struct work_struct *work)
{
	...
	radio = container_of(work, struct s621_radio, if_work);
...
{
#ifndef	S621_TO_DO_CHANGE
	fmspeedy_set_reg(AUX_CON, 0x04300308); /*TODO: CHANGED REGISTER >>>>> */
...
/* ############### CHECK TO DO: End PLL_CON* Init and reset and off */
