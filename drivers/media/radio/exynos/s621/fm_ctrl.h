...
/*
 * drivers/media/radio/exynos/s621/fm_ctrl.h
 *
 * Speedy driver header for SAMSUNG s621 chip
 *
...
void fm_audio_control(struct s621_radio *radio, bool audio_out, bool lr_switch,
