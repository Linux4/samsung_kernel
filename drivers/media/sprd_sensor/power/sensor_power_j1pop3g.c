...
static int sensor_gc0310_poweron(struct sensor_power *main_cfg, struct sensor_power *sub_cfg)
{
	int ret = 0;
	...
	printk("gc0310_poweron OK \n");
	return ret;
}

static int sensor_gc0310_poweroff(struct sensor_power *main_cfg, struct sensor_power *sub_cfg)
{
	int ret = 0;
...
int sensor_power_on(uint8_t sensor_id, struct sensor_power *main_cfg, struct sensor_power *sub_cfg)
{
	...
	if (SENSOR_MAIN == sensor_id) {
		...
		ret = sensor_gc0310_poweron(main_cfg, sub_cfg);
	}
	return ret;
}
...
int sensor_power_off(uint8_t sensor_id, struct sensor_power *main_cfg, struct sensor_power *sub_cfg)
{
	...
	if (SENSOR_MAIN == sensor_id) {
		...
		ret = sensor_gc0310_poweroff(main_cfg, sub_cfg);
	}
