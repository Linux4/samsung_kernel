...
static int sensor_sr200pc20_poweron(uint32_t *fd_handle, struct sensor_power *dev0, struct sensor_power *dev1, struct sensor_power *dev2)
{
	int ret = 0;
...
static int sensor_sr200pc20_poweroff(uint32_t *fd_handle, struct sensor_power *dev0, struct sensor_power *dev1, struct sensor_power *dev2)
{
	int ret = 0;
...
int sensor_power_on(uint32_t *fd_handle, uint32_t sensor_id, struct sensor_power *dev0, struct sensor_power *dev1, struct sensor_power *dev2)
{
	...
	if (SENSOR_DEV_0 == sensor_id) {
		...
		ret = sensor_sr200pc20_poweron(fd_handle, dev0, dev1, dev2);
	}
	return ret;
}
...
int sensor_power_off(uint32_t *fd_handle, uint32_t sensor_id, struct sensor_power *dev0, struct sensor_power *dev1, struct sensor_power *dev2)
{
	...
	if (SENSOR_DEV_0 == sensor_id) {
		...
		ret = sensor_sr200pc20_poweroff(fd_handle, dev0, dev1, dev2);
	}
