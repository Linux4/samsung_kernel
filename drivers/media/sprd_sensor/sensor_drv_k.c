...
LOCAL long sensor_k_ioctl(struct file *file, unsigned int cmd, unsigned long arg)
{
	...
	case SENSOR_IO_IF_CFG:
		...
		case SENSOR_IO_POWER_CFG:
		{
			...
			if (0 == ret) {
#if defined(CONFIG_MACH_J1MINILTE) || defined(CONFIG_MACH_J1ACEVELTE) || defined(CONFIG_MACH_J1MINILTE)
				if(1 == pwr_cfg.is_on) {
...
#if defined(CONFIG_MACH_J1MINILTE) || defined(CONFIG_MACH_J1MINIVELTE)		// Set Front Camera GPIO value for DVS
...
#elif defined(CONFIG_MACH_J1MINILTE) || defined(CONFIG_MACH_J1MINIVELTE)
...
{
#if defined(CONFIG_MACH_J3XLTE) || defined(CONFIG_MACH_J3XNLTE) || defined(CONFIG_MACH_J1MINILTE) || defined(CONFIG_MACH_J2XLTE) || defined(CONFIG_MACH_J1MINIVELTE)
...
{
#if defined(CONFIG_MACH_J1MINILTE) || defined(CONFIG_MACH_J1MINIVELTE)
