...
#endif
#elif defined(CONFIG_MACH_LT02) || defined(CONFIG_MACH_COCOA7) || defined(CONFIG_MACH_HARRISON)
...
#if defined(CONFIG_MACH_LT02) || defined(CONFIG_MACH_HARRISON)
...
#if defined(CONFIG_MACH_LT02) || defined(CONFIG_MACH_COCOA7) || defined(CONFIG_MACH_HARRISON)
...
#if defined(__DEBUG_ENABLE_SKIP_EOF_CHECK) && (defined(CONFIG_MACH_LT02) || defined(CONFIG_MACH_COCOA7) || defined(CONFIG_MACH_HARRISON))
...
#if defined(CONFIG_CPU_PXA988) && (defined(CONFIG_MACH_LT02) || defined(CONFIG_MACH_COCOA7) || defined(CONFIG_MACH_HARRISON))
...
#if !defined(CONFIG_MACH_LT02) && !defined(CONFIG_MACH_COCOA7) && !defined(CONFIG_MACH_HARRISON)//Vincent Wan marks it, no use for ssg but to waste a little of time.
	/*
	 * To get frame_rate
	 */
