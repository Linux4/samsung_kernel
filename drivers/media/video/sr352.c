...
static int sr352_init(struct v4l2_subdev *sd, u32 val)
{
	...
	sr352_write_regs(c,sr352_50hz_setting,ARRAY_SIZE(sr352_50hz_setting),"sr352_50hz_setting");
...
static struct sr352_win_size  sr352_win_sizes_jpeg[] = {
	/* QXGA */
	{
		.width		= QXGA_WIDTH,
		.height		= QXGA_HEIGHT,
		...
		if(sr352_cam_state == SR352_STATE_PREVIEW)
		{
			...
			{							
				...
				case 720:
					...
					sr352_write_regs(c,sr352_preview_720_480,ARRAY_SIZE(sr352_preview_720_480),"sr352_preview_720_480");
				...
				case WIDTH_1024:
					...
					else if(mf->height==HEIGHT_640){
						sensor->preview_size = PREVIEW_SIZE_1024_640;
						sr352_write_regs(c, sr352_Enterpreview_1024x640, ARRAY_SIZE(sr352_Enterpreview_1024x640),"sr352_Enterpreview_1024x640");					
						Cam_Printk(KERN_ERR"choose (1024x640) setting \n");
					}
				...
				case HD_WIDTH:
					...
					sr352_write_regs(c, sr352_recording_50Hz_HD, ARRAY_SIZE(sr352_recording_50Hz_HD),"sr352_recording_50Hz_HD");					
				...
				{			
					...
					case QXGA_WIDTH:
						if((mf->height)==QXGA_HEIGHT){// 3M Capture
							...
							sr352_write_regs(c, sr352_Capture_2048_1232, ARRAY_SIZE(sr352_Capture_2048_1232),"sr352_Capture_2048_1232"); 	
							Cam_Printk(KERN_ERR"choose 2.4M(2048x1232) Wide jpeg setting \n");
						}
						else if((mf->height)==HEIGHT_1152){
					...
					case UXGA_WIDTH: // 2M Capture
						if((mf->height)==UXGA_HEIGHT){// 1.5M Capture
							...
							sr352_write_regs(c, sr352_Capture_1600_960, ARRAY_SIZE(sr352_Capture_1600_960),"sr352_Capture_1600_960");					
							Cam_Printk(KERN_ERR"choose 1.5M(1600x960) jpeg setting \n");
						}
						break;

					case WIDTH_1280:// 1.3M Capture
						sr352_write_regs(c, sr352_Capture_1280_960, ARRAY_SIZE(sr352_Capture_1280_960),"sr352_Capture_1280_960");					
						Cam_Printk(KERN_ERR"choose 1.3M(1280x960) Wide jpeg setting \n");
						break;
