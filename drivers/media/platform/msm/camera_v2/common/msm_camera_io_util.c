...
#if defined (CONFIG_SEC_DREAMQLTE_PROJECT) ||defined (CONFIG_SEC_DREAM2QLTE_PROJECT) || defined (CONFIG_SEC_CRUISERLTE_PROJECT) || defined (CONFIG_SEC_KELLYLTE_PROJECT)
