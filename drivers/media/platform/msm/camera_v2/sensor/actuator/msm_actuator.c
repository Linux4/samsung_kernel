...
#if defined(CONFIG_SEC_GTAXLQLTE_USA_SPR)
#define PARK_LENS_LONG_STEP 14
#define PARK_LENS_MID_STEP 10
...
#if defined(CONFIG_MACH_C5LTE_CHN_OPEN) || defined(CONFIG_MACH_ELITELTE_CHN_OPEN)
