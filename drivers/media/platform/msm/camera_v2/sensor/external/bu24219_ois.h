...
enum bu24219_ois_state_t {
    OIS_POWER_UP,
    OIS_POWER_DOWN,
};


struct bu24219_ois_vreg {
    struct camera_vreg_t *cam_vreg;
    void *data[MSM_OIS_MAX_VREGS];
    int num_vreg;
};

struct bu24219_ois_ver_t {
    uint8_t  core_ver;
    uint8_t  gyro_sensor;
    uint8_t  driver_ic;
    uint8_t  year;
...
typedef struct __bu24219_ois_shift_table {
    int16_t shift_x[NUM_AF_POSITION];
    int16_t shift_y[NUM_AF_POSITION];
} bu24219_ois_shift_table_t;

typedef struct __bu24219_ois_fw_info {
    bool is_loaded;
    bool force_phone;
    bool force_test;
    u8 *phone_fw;
    ...
    struct bu24219_ois_ver_t phone_ver;
    struct bu24219_ois_ver_t module_ver;
    struct msm_ois_cal_info_t cal_info;
    bool is_phone_fw;
    char load_fw_name[256];
} bu24219_ois_fw_info_t;

struct bu24219_ois_ctrl_t {
    ...
    uint32_t subdev_id;
    enum bu24219_ois_state_t ois_state;
    enum msm_camera_i2c_data_type i2c_data_type;
    enum bu24219_ois_modes ois_mode;
    struct bu24219_ois_vreg vreg_cfg;
    struct msm_camera_gpio_conf *gpio_conf;
    bu24219_ois_fw_info_t fw_info;
    bu24219_ois_shift_table_t shift_tbl;
    bool is_camera_run;
    bool is_set_debug_info;
    struct bu24219_ois_debug_t debug_info;
    int ois_en;
    int ois_reset;
...
#ifdef CONFIG_SEC_A9XPROLTE_PROJECT
#undef OIS_SE_FW
#define OIS_SE_FW 'E'
#endif
...
static int32_t bu24219_ois_power_up(struct bu24219_ois_ctrl_t *a_ctrl);
static int32_t bu24219_ois_power_down(struct bu24219_ois_ctrl_t *a_ctrl);
