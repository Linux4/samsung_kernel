...
#if defined(CONFIG_SEC_KELLYLTE_PROJECT)
#define FROM_REAR_AF_CAL_D80_ADDR           0x6840  // AF 80 position
#define FROM_REAR_AF_CAL_PAN_ADDR           0x6844  // AF Far position
#define FROM_REAR_AF_CAL_D50_ADDR           0x6848  // AF 50 position
#define FROM_REAR_AF_CAL_D40_ADDR           0x684C  // AF middle position
#define FROM_REAR_AF_CAL_MACRO_ADDR         0x6850  // AF near position
#else
#define FROM_REAR_AF_CAL_D40_ADDR           0x3C2C
#define FROM_REAR_AF_CAL_D50_ADDR           0x3C28
