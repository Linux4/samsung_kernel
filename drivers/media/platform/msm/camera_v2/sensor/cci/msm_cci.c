...
#define CCI_TIMEOUT msecs_to_jiffies(1000)//bug 600732,huangguoyong.wt, add,2020/11/16,86118 project camera kernel code for bring up(increase cci wait times)
