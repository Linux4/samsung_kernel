...
#if defined(CONFIG_SEC_J4CORELTE_PROJECT) || defined(CONFIG_SEC_J2COREY20LTE_PROJECT) //Temp increase timeout to 5 sec(unable to get contiguous memory in 1 sec)
