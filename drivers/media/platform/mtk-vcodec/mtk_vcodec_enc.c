...
int mtk_vcodec_enc_ctrls_setup(struct mtk_vcodec_ctx *ctx)
{
	...
	cfg.min = -1;//EXTB P220408-05024 liangyiyi.wt, MODIFY, 2022/05/10, modify for solving the problem of the imaging is very fake in HEIF mode
	cfg.max = 51;
	cfg.step = 1;
	cfg.def = -1;//EXTB P220408-05024 liangyiyi.wt, MODIFY, 2022/05/10, modify for solving the problem of the imaging is very fake in HEIF mode
	cfg.ops = ops;
	ctrl = v4l2_ctrl_new_custom(handler, &cfg, NULL);
