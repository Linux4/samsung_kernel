...
#ifndef CAMERAPP_SFR_GDC_V401_H
#define CAMERAPP_SFR_GDC_V401_H
...
enum camerapp_gdc_reg_name {
	...
	GDC_R_FRAME_SEQ_COUNTER,
	GDC_R_FRAME_SEQ_COUNTER_RESET,
	GDC_R_RDMA0_IMG_CRC_1P,
	GDC_R_RDMA0_HEADER_CRC_1P,
	GDC_R_RDMA0_MON_STATUS0,
	GDC_R_RDMA0_MON_STATUS1,
	GDC_R_RDMA0_MON_STATUS2,
	GDC_R_RDMA0_MON_STATUS3,
	GDC_R_RDMA1_IMG_CRC_1P,
	GDC_R_RDMA1_HEADER_CRC_1P,
	GDC_R_RDMA1_MON_STATUS0,
	GDC_R_RDMA1_MON_STATUS1,
	GDC_R_RDMA1_MON_STATUS2,
	GDC_R_RDMA1_MON_STATUS3,
	GDC_R_WDMA_IMG_CRC_1P,
	GDC_R_WDMA_IMG_CRC_2P,
	GDC_R_WDMA_HEADER_CRC_1P,
	GDC_R_WDMA_HEADER_CRC_2P,
	GDC_R_WDMA_MON_STATUS0,
	GDC_R_WDMA_MON_STATUS1,
	GDC_R_WDMA_MON_STATUS2,
	GDC_R_WDMA_MON_STATUS3,
...
static const struct camerapp_sfr_reg gdc_regs[GDC_REG_CNT] = {
	...
	{0x590, "FRAME_SEQ_COUNTER"},
	{0x594, "FRAME_SEQ_COUNTER_RESET"},
	{0x600, "RDMA0_IMG_CRC_1P"},
	{0x60C, "RDMA0_HEADER_CRC_1P"},
	{0x620, "RDMA0_MON_STATUS0"},
	{0x624, "RDMA0_MON_STATUS1"},
	{0x628, "RDMA0_MON_STATUS2"},
	{0x62c, "RDMA0_MON_STATUS3"},
	{0x630, "RDMA1_IMG_CRC_1P"},
	{0x63c, "RDMA1_HEADER_CRC_1P"},
	{0x650, "RDMA1_MON_STATUS0"},
	{0x654, "RDMA1_MON_STATUS1"},
	{0x658, "RDMA1_MON_STATUS2"},
	{0x65c, "RDMA1_MON_STATUS3"},
	{0x660, "WDMA_IMG_CRC_1P"},
	{0x664, "WDMA_IMG_CRC_2P"},
	{0x66c, "WDMA_HEADER_CRC_1P"},
	{0x670, "WDMA_HEADER_CRC_2P"},
	{0x680, "WDMA_MON_STATUS0"},
	{0x684, "WDMA_MON_STATUS1"},
	{0x688, "WDMA_MON_STATUS2"},
	{0x68c, "WDMA_MON_STATUS3"},
	{0x0900, "SECU_CTRL_SEQID"},
	{0x0910, "SECU_CTRL_TZINFO_SEQID_0"},
	{0x0914, "SECU_CTRL_TZINFO_SEQID_1"},
	{0x0918, "SECU_CTRL_TZINFO_SEQID_2"},
	{0x091c, "SECU_CTRL_TZINFO_SEQID_3"},
	{0x0920, "SECU_CTRL_TZINFO_SEQID_4"},
	{0x0924, "SECU_CTRL_TZINFO_SEQID_5"},
	{0x0928, "SECU_CTRL_TZINFO_SEQID_6"},
	{0x092c, "SECU_CTRL_TZINFO_SEQID_7"},
...
enum camerapp_gdc_reg_field {
	...
	GDC_F_INT_MASK_VOTF_LOST_FLUSH_S,
	GDC_F_INT_MASK_VOTF_SLOW_RING_S,
	GDC_F_INT_MASK_VOTF_LOST_FLUSH_M,
	GDC_F_INT_MASK_VOTF_SLOW_RING_M,
	GDC_F_INT_MASK_IP_OP_START,
	GDC_F_INT_MASK_FRAME_END,
	GDC_F_INT_STATUS_VOTF_LOST_FLUSH_S,
	GDC_F_INT_STATUS_VOTF_SLOW_RING_S,
	GDC_F_INT_STATUS_VOTF_LOST_FLUSH_M,
	GDC_F_INT_STATUS_VOTF_SLOW_RING_M,
	GDC_F_INT_STATUS_IP_OP_START,
	...
	GDC_F_FRAME_SEQ_COUNTER,
	GDC_F_FRAME_SEQ_COUNTER_RESET,
	GDC_F_RDMA0_IMG_CRC_1P,
	GDC_F_RDMA0_HEADER_CRC_1P,
	GDC_F_RDMA0_MON_STATUS0,
	GDC_F_RDMA0_MON_STATUS1,
	GDC_F_RDMA0_MON_STATUS2,
	GDC_F_RDMA0_MON_STATUS3,
	GDC_F_RDMA1_IMG_CRC_1P,
	GDC_F_RDMA1_HEADER_CRC_1P,
	GDC_F_RDMA1_MON_STATUS0,
	GDC_F_RDMA1_MON_STATUS1,
	GDC_F_RDMA1_MON_STATUS2,
	GDC_F_RDMA1_MON_STATUS3,
	GDC_F_WDMA_IMG_CRC_1P,
	GDC_F_WDMA_IMG_CRC_2P,
	GDC_F_WDMA_HEADER_CRC_1P,
	GDC_F_WDMA_HEADER_CRC_2P,
...
static const struct camerapp_sfr_field gdc_fields[GDC_REG_FIELD_CNT] = {
	...
	{"GDC_VERSION", 0, 32, RWI, 0x4010000},
	...
	{"GDC_BOUNDARY_OPTION", 0, 1, RW, 0x0},
	...
	{"GDC_OUT_SCALE_Y", 16, 14, RW, 0x2000},
	{"GDC_OUT_SCALE_X", 0, 14, RW, 0x2000},
	...
	{"MAX_RD1_MO", 8, 8, RW, 0x0},
	{"MAX_RD0_MO", 0, 8, RW, 0x0},
	{"FLUSH", 0, 1, RW, 0x0},
	...
	{"INT_MASK_VOTF_LOST_FLUSH_S", 5, 1, RW, 0x0},
	{"INT_MASK_VOTF_SLOW_RING_S", 4, 1, RW, 0x0},
	{"INT_MASK_VOTF_LOST_FLUSH_M", 3, 1, RW, 0x0},
	{"INT_MASK_VOTF_SLOW_RING_M", 2, 1, RW, 0x0},
	{"INT_MASK_IP_OP_START", 1, 1, RW, 0x0},
	{"INT_MASK_FRAME_END", 0, 1, RW, 0x0},
	{"INT_STATUS_VOTF_LOST_FLUSH_S", 5, 1, RW, 0x0},
	{"INT_STATUS_VOTF_SLOW_RING_S", 4, 1, RW, 0x0},
	{"INT_STATUS_VOTF_LOST_FLUSH_M", 3, 1, RW, 0x0},
	{"INT_STATUS_VOTF_SLOW_RING_M", 2, 1, RW, 0x0},
	{"INT_STATUS_IP_OP_START", 1, 1, RW, 0x0},
	...
	{"DST_VOTF", 3, 3, RW, 0x0},
	{"SRC_VOTF", 0, 3, RW, 0x0},
	{"BUS_USER_INFO_RDMA_HINT", 10, 1, RW, 0x0},
	...
	{"RDMA0_IMG_CRC_1P", 0, 32, RWI, 0x0},
	{"RDMA0_HEADER_CRC_1P", 0, 32, RWI, 0x0},
	{"RDMA0_MON_STATUS0", 0, 32, RO, 0x0},
	{"RDMA0_MON_STATUS1", 0, 32, RO, 0x0},
	{"RDMA0_MON_STATUS2", 0, 32, RO, 0x0},
	{"RDMA0_MON_STATUS3", 0, 32, RO, 0x0},
	{"RDMA1_IMG_CRC_1P", 0, 32, RO, 0x0},
	{"RDMA1_HEADER_CRC_1P", 0, 32, RO, 0x0},
	{"RDMA1_MON_STATUS0", 0, 32, RO, 0x0},
	{"RDMA1_MON_STATUS1", 0, 32, RO, 0x0},
	{"RDMA1_MON_STATUS2", 0, 32, RO, 0x0},
	{"RDMA1_MON_STATUS3", 0, 32, RO, 0x0},
	{"WDMA_IMG_CRC_1P", 0, 32, RO, 0x0},
	{"WDMA_IMG_CRC_2P", 0, 32, RO, 0x0},
	{"WDMA_HEADER_CRC_1P", 0, 32, RO, 0x0},
	{"WDMA_HEADER_CRC_2P", 0, 32, RO, 0x0},
	{"WDMA_MON_STATUS0", 0, 32, RO, 0x0},
	{"WDMA_MON_STATUS1", 0, 32, RO, 0x0},
	{"WDMA_MON_STATUS2", 0, 32, RO, 0x0},
	{"WDMA_MON_STATUS3", 0, 32, RO, 0x0},
