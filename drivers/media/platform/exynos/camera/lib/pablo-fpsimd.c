...
EXPORT_SYMBOL_GPL(is_fpsimd_get_isr);
...
EXPORT_SYMBOL_GPL(is_fpsimd_put_isr);
...
EXPORT_SYMBOL_GPL(is_fpsimd_get_func);
...
EXPORT_SYMBOL_GPL(is_fpsimd_put_func);

void is_fpsimd_get_task(void)
{

}
EXPORT_SYMBOL_GPL(is_fpsimd_get_task);

void is_fpsimd_put_task(void)
{

}
EXPORT_SYMBOL_GPL(is_fpsimd_put_task);
...
EXPORT_SYMBOL_GPL(is_fpsimd_probe);
...
EXPORT_SYMBOL_GPL(is_fpsimd_set_task_using);
#endif
