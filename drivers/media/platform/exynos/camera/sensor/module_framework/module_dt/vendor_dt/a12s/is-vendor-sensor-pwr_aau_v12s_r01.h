...
#define GM2_IOVDD		<&gpa1 7 0x1>		/* CAM_VDDIO_1P8 is used for all camera commonly */
...
/***** FRONT - SR846 *****/
#define SR846_IOVDD		<&gpa1 7 0x1>		/* CAM_VDDIO_1P8 */
#define SR846_LDO_EN	<&gpa2 2 0x1>		/* FCAM_LDO_EN */
#define SR846_AVDD		SR846_LDO_EN		/* FRONT_AVDD_2P8 */
#define SR846_DVDD		SR846_LDO_EN		/* FCAM_DVDD_1P2 */
#define SR846_RST		<&gpa2 4 0x1>

/***** FRONT - S5K4HA *****/
#define S5K4HA_IOVDD	<&gpa1 7 0x1>		/* CAM_VDDIO_1P8 */
#define S5K4HA_LDO_EN	<&gpa2 2 0x1>		/* FCAM_LDO_EN */
#define S5K4HA_AVDD		S5K4HA_LDO_EN		/* FRONT_AVDD_2P8 */
#define S5K4HA_DVDD		S5K4HA_LDO_EN		/* FCAM_DVDD_1P2 */
#define S5K4HA_RST		<&gpa2 4 0x1>

/***** REAR2 SUB - GC02M1 *****/
#define GC02M1_IOVDD	<&gpa1 7 0x1>		/* CAM_VDDIO_1P8 */
...
/***** REAR3 WIDE - GC5035 *****/
#define GC5035_IOVDD	<&gpa1 7 0x1>		/* CAM_VDDIO_1P8 - RCAM_VDDIO_LDO_EN */
...
/***** REAR4 MACRO - GC02M1 *****/
#define GC02M1_MACRO_IOVDD	<&gpa1 7 0x1>			/* CAM_VDDIO_1P8 - RCAM_VDDIO_LDO_EN */
