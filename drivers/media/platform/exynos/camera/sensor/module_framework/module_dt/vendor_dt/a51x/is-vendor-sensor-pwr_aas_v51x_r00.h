#ifndef IS_VENDOR_SENSOR_PWR_AAS_V51X_H
#define IS_VENDOR_SENSOR_PWR_AAS_V51X_H
...
#define IMX582_AVDD1	<&s2mpb03_0_l5>		/* RCAM1_AVDD1_2P9 */
#define IMX582_AVDD2	<&s2mpb03_1_l3>		/* RCAM1_AVDD2_1P8 */
#define IMX582_DVDD	<&s2mpb03_0_l2>		/* RCAM1_DVDD_1P1 */
#define IMX582_IOVDD	<&s2mpb03_0_l3>		/* CAM_VDDIO_1P8 : CAM0_VLDO3 is used for all camera commonly */
#define IMX582_RST	<&gpp3 2 0x1>
...
#endif /* IS_VENDOR_SENSOR_PWR_AAS_V51X_H */
