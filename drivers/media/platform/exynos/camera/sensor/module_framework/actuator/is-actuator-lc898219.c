...
int sensor_lc898219_actuator_init(struct v4l2_subdev *subdev, u32 val)
{
	...
	ret = is_sensor_addr8_read8(client, 0xF0, &product_id);
	...
	/* Go active mode */
	ret = is_sensor_addr8_write8(client, 0xE0, 0x01);
	if (ret < 0)
		goto p_err_mutex;
...
static int sensor_lc898219_actuator_probe(struct i2c_client *client,
...
static struct i2c_driver sensor_actuator_lc898219_driver = {
	.probe  = sensor_lc898219_actuator_probe,
	.driver = {
		.name	= ACTUATOR_NAME,
		.owner	= THIS_MODULE,
