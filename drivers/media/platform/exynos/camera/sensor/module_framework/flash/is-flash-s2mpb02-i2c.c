...
static int flash_s2mpb02_platform_probe_i2c(struct platform_device *pdev)
{
	int ret = 0;
	struct device *dev;
...
static struct platform_driver sensor_flash_s2mpb02_platform_driver = {
	.probe = flash_s2mpb02_platform_probe_i2c,
	.driver = {
...
#else
static int __init sensor_flash_s2mpb02_init_i2c(void)
{
	int ret;

	ret = platform_driver_probe(&sensor_flash_s2mpb02_platform_driver,
				flash_s2mpb02_platform_probe_i2c);
	if (ret)
...
late_initcall_sync(sensor_flash_s2mpb02_init_i2c);
#endif
