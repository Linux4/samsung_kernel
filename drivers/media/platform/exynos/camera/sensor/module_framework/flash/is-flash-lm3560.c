...
long flash_lm3560_ioctl(struct v4l2_subdev *subdev, unsigned int cmd, void *arg)
{
	int ret = 0;
	...
	case SENSOR_IOCTL_FLS_S_CTRL:
		ret = flash_lm3560_s_ctrl(subdev, ctrl);
		if (ret) {
...
static int flash_lm3560_i2c_probe_i2c(struct i2c_client *client,
...
static int __init flash_lm3560_platform_probe_i2c(struct platform_device *pdev)
{
	int ret = 0;
	struct device *dev;
...
static struct i2c_driver sensor_flash_lm3560_i2c_driver = {
	.probe	= flash_lm3560_i2c_probe_i2c,
	.driver = {
...
static int __init sensor_flash_lm3560_i2c_init_i2c(void)
{
	int ret;
...
late_initcall_sync(sensor_flash_lm3560_i2c_init_i2c);
...
static int __init sensor_flash_lm3560_platform_init_i2c(void)
{
	int ret;

	ret = platform_driver_probe(&sensor_flash_lm3560_platform_driver,
				flash_lm3560_platform_probe_i2c);
	if (ret)
...
late_initcall_sync(sensor_flash_lm3560_platform_init_i2c);
