...
static int flash_i2c_probe_i2c(struct i2c_client *client,
...
static int __init sensor_flash_i2c_init_i2c(void)
{
	int ret;
...
late_initcall_sync(sensor_flash_i2c_init_i2c);
