...
//IMX258ES1_SEC(0ATH5)_26MHz_Mirror-Flip_RegisterSetting_ver1.00-0.23_210201.xlsx
...
const struct sensor_pll_info_compact sensor_imx258_pllinfo_B_4128x3096_30fps = {
	...
	1092000000,                  /* mipi_datarate = OPSYCK */
...
const struct sensor_pll_info_compact sensor_imx258_pllinfo_B_1028x772_60fps = {
	EXT_CLK_Mhz * 1000 * 1000, /* ext_clk */
	1092000000,                  /* mipi_datarate = OPSYCK */
	436800000,                   /* pclk = VTPXCK of Clock Information */
	1360,                        /* frame_length_lines */
	5352,                        /* line_length_pck */
};

const struct sensor_pll_info_compact sensor_imx258_pllinfo_B_1024x708_120fps = {
	EXT_CLK_Mhz * 1000 * 1000, /* ext_clk */
	1300000000,                  /* mipi_datarate = OPSYCK */
	520000000,                   /* pclk = VTPXCK of Clock Information */
...
static const struct sensor_pll_info_compact *sensor_imx258_pllinfos_B[] = {
	...
	&sensor_imx258_pllinfo_B_1024x708_120fps,
};
