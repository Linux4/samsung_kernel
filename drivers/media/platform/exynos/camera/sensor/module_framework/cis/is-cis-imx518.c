...
int sensor_imx518_cis_set_vcsel_current(struct v4l2_subdev *subdev, u32 value)
{
	...
	cis->ixc_ops->write8(client, 0x0501, 0x0f);
	cis->ixc_ops->write8(client, 0x0502, 0xC4);
...
int sensor_imx518_cis_get_vcsel_photo_diode(struct v4l2_subdev *subdev, u16 *value)
{
	...
	cis->ixc_ops->read8(client, 0x0588, &value8_1); 	/*0x058B for APC2_CHECK_DATA[9:8]*/
	cis->ixc_ops->read8(client, 0x058F, &value8_0); 	/* 0x0582 for APC2_CHECK_DATA[7:0] */
