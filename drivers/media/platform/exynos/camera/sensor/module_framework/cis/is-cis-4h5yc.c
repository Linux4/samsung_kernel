...
int sensor_4h5yc_cis_set_exposure_time(struct v4l2_subdev *subdev, struct ae_param *target_exposure)
{
	...
	ret = cis->ixc_ops->write16(client, 0x0200, (u16)(fine_int & 0xFFFF));
	if (ret < 0)
		goto p_err;
...
static int cis_4h5yc_probe_i2c(struct i2c_client *client,
...
#ifdef MODULE
builtin_i2c_driver(sensor_cis_4h5yc_driver);
#else
