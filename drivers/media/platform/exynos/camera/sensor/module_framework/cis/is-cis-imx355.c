...
int sensor_imx355_cis_mode_change(struct v4l2_subdev *subdev, u32 mode)
{
	...
	ret = is_sensor_write8(client, 0x300C, 0x01);
	if (ret < 0) {
	...
	const struct i2c_device_id *id)
{
	...
	if (strcmp(setfile, "default") == 0 ||
		...
		cis->mipi_sensor_mode = sensor_imx355_setfile_A_mipi_sensor_mode;
		cis->mipi_sensor_mode_size = ARRAY_SIZE(sensor_imx355_setfile_A_mipi_sensor_mode);
		verify_sensor_mode = sensor_imx355_setfile_A_verify_sensor_mode;
		verify_sensor_mode_size = ARRAY_SIZE(sensor_imx355_setfile_A_verify_sensor_mode);
