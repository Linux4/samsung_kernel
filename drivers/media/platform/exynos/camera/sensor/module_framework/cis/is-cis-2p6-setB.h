...
const u32 sensor_2p6_setfile_B_4608x2176_30fps[] = {
	0xFCFC, 0x4000, 0x02,
	0x6028, 0x2000, 0x02,
	0x6214, 0x7971, 0x02,
	0x6218, 0x7150, 0x02,
...
const u32 sensor_2p6_setfile_B_3456x3456_30fps[] = {
	0xFCFC, 0x4000, 0x02,
	0x6028, 0x2000, 0x02,
	0x6214, 0x7971, 0x02,
	0x6218, 0x7150, 0x02,
...
/* 11. 1152 x 864 / 4-Bin, 4:3, 120fps, EXTCLK 26Mhz */
...
const struct sensor_pll_info_compact sensor_2p6_pllinfo_B_4608x2176_30fps = {
    EXT_CLK_Mhz * 1000 * 1000, /* ext_clk */
    1443 * 1000 * 1000, /* mipi_datarate */
    560440000,  /* pclk  = VT pix CLK * 4(this value is different by cis) */
    0x0E1A, /* frame_length_lines   (0x0340) */
...
const struct sensor_pll_info_compact sensor_2p6_pllinfo_B_3456x3456_30fps = {
    EXT_CLK_Mhz * 1000 * 1000, /* ext_clk */
    1443 * 1000 * 1000, /* mipi_datarate */
    560440000,  /* pclk  = VT pix CLK * 4(this value is different by cis) */
    0x0E1A, /* frame_length_lines   (0x0340) */
...
static const u32 *sensor_2p6_setfiles_B[] = {
	...
	sensor_2p6_setfile_B_4608x2176_30fps,
	sensor_2p6_setfile_B_3456x3456_30fps,
...
static const u32 sensor_2p6_setfile_B_sizes[] = {
	...
	ARRAY_SIZE(sensor_2p6_setfile_B_4608x2592_30fps),
	ARRAY_SIZE(sensor_2p6_setfile_B_4608x2240_30fps),
	ARRAY_SIZE(sensor_2p6_setfile_B_4608x2176_30fps),
	ARRAY_SIZE(sensor_2p6_setfile_B_3456x3456_30fps),
	...
	ARRAY_SIZE(sensor_2p6_setfile_B_2304x1296_30fps),
	ARRAY_SIZE(sensor_2p6_setfile_B_2304x1120_30fps),
	ARRAY_SIZE(sensor_2p6_setfile_B_1280x720_120fps),
...
static const struct sensor_pll_info_compact *sensor_2p6_pllinfos_B[] =
{
	...
	&sensor_2p6_pllinfo_B_4608x2176_30fps,
	&sensor_2p6_pllinfo_B_3456x3456_30fps,
