...
#define SENSOR_2LD_PAGE_LENGTH 256
#define SENSOR_2LD_VALID_TAG 0x5A
#define SENSOR_2LD_FRAME_ID_PAGE 1
#define SENSOR_2LD_FRAME_ID_OFFSET 194
#define SENSOR_2LD_FLL_MSB_PAGE 1
#define SENSOR_2LD_FLL_MSB_OFFSET 48
#define SENSOR_2LD_FLL_LSB_PAGE 1
#define SENSOR_2LD_FLL_LSB_OFFSET 50
...
static void sensor_2ld_set_integration_max_margin(u32 mode, cis_shared_data *cis_data)
{
	...
	case SENSOR_2LD_4032X1908_30FPS:
	case SENSOR_2LD_3024X3024_30FPS:
	case SENSOR_2LD_4032X3024_24FPS:
	case SENSOR_2LD_4032X2268_24FPS:
	case SENSOR_2LD_4032X1908_24FPS:
	case SENSOR_2LD_3024X3024_24FPS:
		cis_data->max_margin_coarse_integration_time = 0x18;
		break;
	case SENSOR_2LD_2016X1512_30FPS:
	case SENSOR_2LD_2016X1134_30FPS:
	case SENSOR_2LD_1504X1504_30FPS:
	case SENSOR_2LD_2016X1134_240FPS_MODE2:
	case SENSOR_2LD_1008X568_120FPS_MODE2:
...
int sensor_2ld_cis_retention_crc_enable(struct v4l2_subdev *subdev, u32 mode)
{
	...
	default:
		...
		is_sensor_write8(client, 0x010E, 0x01); /* TO BE CHECKED */
...
int sensor_2ld_cis_mode_change(struct v4l2_subdev *subdev, u32 mode)
{
	...
	is_sensor_write16(cis->client, 0x602A, 0x1090); /* TO BE CHECKED */
	...
	if (ext_info->use_retention_mode == SENSOR_RETENTION_ACTIVATED) {
		...
		case SENSOR_2LD_4032X2268_60FPS:
			...
			break;
		case SENSOR_2LD_1008X568_120FPS_MODE2:
			info("[%s] retention mode: SENSOR_2LD_1008X568_120FPS_MODE2\n", __func__);
			ret = sensor_cis_set_registers(subdev,
