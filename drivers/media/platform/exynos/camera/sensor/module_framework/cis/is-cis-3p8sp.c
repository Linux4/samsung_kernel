...
int sensor_3p8sp_cis_set_global_setting(struct v4l2_subdev *subdev)
{
	...
	ret = cis->ixc_ops->write16(cis->client, 0x6010, 0x0001);
...
int sensor_3p8sp_cis_stream_on(struct v4l2_subdev *subdev)
{
	...
	/* Sensor stream on */
	ret = cis->ixc_ops->write16(client, 0x6028, 0x4000);
	if (ret < 0)
...
static int cis_3p8sp_probe_i2c(struct i2c_client *client,
