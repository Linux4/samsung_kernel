...
int sensor_2l1_cis_check_rev(struct is_cis *cis)
{
	...
	case 0x00:
		...
		cis->ixc_ops->write16(client, 0x6018, 0x0001);
		cis->ixc_ops->write16(client, 0x70A2, 0x0001);
		cis->ixc_ops->write16(client, 0x7002, 0x0001);
		cis->ixc_ops->write16(client, 0x6014, 0x0001);
		usleep_range(3000, 3000);
		cis->ixc_ops->write16(client, 0x7002, 0x0000);
		usleep_range(1000, 1000);
		cis->ixc_ops->write16(client, 0x0000, 0x20C1);
		cis->ixc_ops->write16(client, 0x0002, 0xC101);
		break;
	default:
...
int sensor_2l1_cis_mode_change(struct v4l2_subdev *subdev, u32 mode)
{
	...
	if (ext_info->use_retention_mode == SENSOR_RETENTION_ACTIVATED) {
		...
		case SENSOR_2L1_8064X3024_30FPS:
			...
			cis->ixc_ops->write16(cis->client, 0x602A, 0x0A78);
			cis->ixc_ops->write16(cis->client, 0x6F12, 0x2000);
			cis->ixc_ops->write16(cis->client, 0x6F12, 0x8800);
		...
		case SENSOR_2L1_8064X2268_30FPS:
			...
			cis->ixc_ops->write16(cis->client, 0x602A, 0x0A78);
			cis->ixc_ops->write16(cis->client, 0x6F12, 0x2000);
			cis->ixc_ops->write16(cis->client, 0x6F12, 0x8A00);
			cis->ixc_ops->write16(cis->client, 0x0100, 0x0103);
			break;
		case SENSOR_2L1_4032X2268_60FPS:
			...
			cis->ixc_ops->write16(cis->client, 0x602A, 0x0A78);
			cis->ixc_ops->write16(cis->client, 0x6F12, 0x2000);
			cis->ixc_ops->write16(cis->client, 0x6F12, 0x8E00);
			cis->ixc_ops->write16(cis->client, 0x0100, 0x0103);
			break;
		case SENSOR_2L1_1008X756_120FPS:
			...
			cis->ixc_ops->write16(cis->client, 0x602A, 0x0A78);
			cis->ixc_ops->write16(cis->client, 0x6F12, 0x2000);
			cis->ixc_ops->write16(cis->client, 0x6F12, 0x8C00);
			cis->ixc_ops->write16(cis->client, 0x0100, 0x0103);
			break;
		default:
...
int sensor_2l1_cis_retention_crc_check(struct v4l2_subdev *subdev)
{
	...
	cis->ixc_ops->write16(cis->client, 0x6018, 0x0001);
	cis->ixc_ops->write16(cis->client, 0x7002, 0x0001);
	cis->ixc_ops->write16(cis->client, 0x6014, 0x0001);
	usleep_range(4000, 4000);
	cis->ixc_ops->write16(cis->client, 0x7002, 0x0000);
	usleep_range(4000, 4000);

	cis->ixc_ops->read8(cis->client, 0x070B, &crc_check);
	cis->ixc_ops->read8(cis->client, 0x070F, &crc_status);
	I2C_MUTEX_UNLOCK(cis->i2c_lock);
...
int sensor_2l1_cis_stream_off(struct v4l2_subdev *subdev)
{
	...
	cis->ixc_ops->write8(client, 0x070A, 0x01);
...
int sensor_2l1_cis_set_digital_gain(struct v4l2_subdev *subdev, struct ae_param *dgain)
{
	...
	if (ret < 0)
		goto p_err;
	ret = cis->ixc_ops->write16_array(client, 0x0216, dgains, 4);
	if (ret < 0)
		goto p_err;
	...
	if (is_vender_wdr_mode_on(cis_data)) {
		...
		ret = cis->ixc_ops->write16_array(client, 0x3072, dgains, 4);
		if (ret < 0)
			goto p_err;
		ret = cis->ixc_ops->write16_array(client, 0x307A, dgains, 4);
		if (ret < 0)
			goto p_err;
	}
...
int sensor_2l1_cis_long_term_exposure(struct v4l2_subdev *subdev)
{
	...
	if (lte_mode->sen_strm_off_on_enable) {
		...
		ret |= cis->ixc_ops->write16(cis->client, 0x602A, 0x0B52);
		ret |= cis->ixc_ops->write16(cis->client, 0x6F12, 0x1064);
		ret |= cis->ixc_ops->write16(cis->client, 0x602A, 0x0BFE);
		ret |= cis->ixc_ops->write16(cis->client, 0x6F12, 0x1064);
		ret |= cis->ixc_ops->write16(cis->client, 0x602A, 0x0C0E);
		ret |= cis->ixc_ops->write16(cis->client, 0x6F12, 0x1064);
		ret |= cis->ixc_ops->write16(cis->client, 0x602A, 0x0C16);
		ret |= cis->ixc_ops->write16(cis->client, 0x6F12, 0x1064);
		ret |= cis->ixc_ops->write16(cis->client, 0x602A, 0x858C);
		ret |= cis->ixc_ops->write16(cis->client, 0x6F12, 0x03C0);

		ret |= cis->ixc_ops->write16(cis->client, 0x0340, 0x7FFF);
		ret |= cis->ixc_ops->write16(cis->client, 0x0342, 0xBF00);
		...
		ret |= cis->ixc_ops->write16(cis->client, 0x6028, 0x2000);
		ret |= cis->ixc_ops->write16(cis->client, 0x602A, 0x0B52);
		ret |= cis->ixc_ops->write16(cis->client, 0x6F12, 0x0295);
		ret |= cis->ixc_ops->write16(cis->client, 0x602A, 0x0BFE);
		ret |= cis->ixc_ops->write16(cis->client, 0x6F12, 0x0295);
		ret |= cis->ixc_ops->write16(cis->client, 0x602A, 0x0C0E);
		ret |= cis->ixc_ops->write16(cis->client, 0x6F12, 0x0295);
		...
		ret |= cis->ixc_ops->write16(cis->client, 0x6F12, 0x0295);
		ret |= cis->ixc_ops->write16(cis->client, 0x602A, 0x858C);
		ret |= cis->ixc_ops->write16(cis->client, 0x6F12, 0x0220);

		ret |= cis->ixc_ops->write16(cis->client, 0x0340, 0x0C57);
		ret |= cis->ixc_ops->write16(cis->client, 0x0342, 0x2100);
...
static int cis_2l1_probe_i2c(struct i2c_client *client,
