...
#include "sfr/is-sfr-mcsc-v9_0.h"
#include "is-hw.h"
...
u32 is_scaler_get_scaler_path(void __iomem *base_addr, u32 hw_id, u32 output_id)
{
	...
	case MCSC_OUTPUT3:
		...
		enable_post = 0;
		enable_dma = is_hw_get_field(base_addr,
			&mcsc_regs[MCSC_R_WDMA3_ENABLE], &mcsc_fields[MCSC_F_WDMA3_EN]);
		break;
	case MCSC_OUTPUT4:
		enable_poly = is_hw_get_field(base_addr,
		...
		enable_post = 0;
		enable_dma = is_hw_get_field(base_addr,
			&mcsc_regs[MCSC_R_WDMA4_ENABLE], &mcsc_fields[MCSC_F_WDMA4_EN]);
		break;
	default:
		break;
	}
	...
	struct scaler_coef_cfg *sc_coefs[], int num_coef)
{
	...
	if (sc_coefs[0]) {
		h_coef = get_scaler_coef_ver2(hratio, sc_coefs[0]);
		v_coef = get_scaler_coef_ver2(vratio, sc_coefs[0]);
	}
...
void is_scaler_set_dma_out_enable(void __iomem *base_addr, u32 output_id, bool dma_out_en)
{
	...
	case MCSC_OUTPUT2:
		...
		break;
	case MCSC_OUTPUT3:
		is_hw_set_field(base_addr, &mcsc_regs[MCSC_R_WDMA3_ENABLE],
			&mcsc_fields[MCSC_F_WDMA3_EN], (u32)dma_out_en);
		break;
	case MCSC_OUTPUT4:
		is_hw_set_field(base_addr, &mcsc_regs[MCSC_R_WDMA4_ENABLE],
			&mcsc_fields[MCSC_F_WDMA4_EN], (u32)dma_out_en);
		break;
	default:
		break;
	}
...
u32 is_scaler_get_dma_out_enable(void __iomem *base_addr, u32 output_id)
{
	...
	case MCSC_OUTPUT2:
		...
		break;
	case MCSC_OUTPUT3:
		ret = is_hw_get_field(base_addr, &mcsc_regs[MCSC_R_WDMA3_ENABLE],
			&mcsc_fields[MCSC_F_WDMA3_EN]);
		break;
	case MCSC_OUTPUT4:
		ret = is_hw_get_field(base_addr, &mcsc_regs[MCSC_R_WDMA4_ENABLE],
			&mcsc_fields[MCSC_F_WDMA4_EN]);
		break;
	default:
		break;
	}
...
void is_scaler_set_wdma_votf_enable(void __iomem *base_addr, u32 output_id, bool votf_en)
{
	...
	case MCSC_OUTPUT2:
		...
		break;
	case MCSC_OUTPUT3:
		is_hw_set_field(base_addr, &mcsc_regs[MCSC_R_WDMA3_VOTF_EN],
			&mcsc_fields[MCSC_F_WDMA3_VOTF_EN], (u32)votf_en);
		break;
	case MCSC_OUTPUT4:
		is_hw_set_field(base_addr, &mcsc_regs[MCSC_R_WDMA4_VOTF_EN],
			&mcsc_fields[MCSC_F_WDMA4_VOTF_EN], (u32)votf_en);
		break;
	default:
		break;
	}
...
void is_scaler_set_wdma_format_type(void __iomem *base_addr, u32 output_id, u32 format_type)
{
	...
	case MCSC_OUTPUT3:
		is_hw_set_field(base_addr, &mcsc_regs[MCSC_R_WDMA3_DATA_FORMAT],
			&mcsc_fields[MCSC_F_WDMA3_DATA_FORMAT_TYPE], 0);
		break;
	case MCSC_OUTPUT4:
		is_hw_set_field(base_addr, &mcsc_regs[MCSC_R_WDMA4_DATA_FORMAT],
			&mcsc_fields[MCSC_F_WDMA4_DATA_FORMAT_TYPE], 0);
		break;
	default:
		break;
	}
...
void is_scaler_set_wdma_rgb_format(void __iomem *base_addr, u32 output_id, u32 out_fmt)
{
	...
	case MCSC_OUTPUT3:
		is_hw_set_field(base_addr, &mcsc_regs[MCSC_R_WDMA3_DATA_FORMAT],
			&mcsc_fields[MCSC_F_WDMA3_DATA_FORMAT_RGB], out_fmt);
		break;
	case MCSC_OUTPUT4:
		is_hw_set_field(base_addr, &mcsc_regs[MCSC_R_WDMA4_DATA_FORMAT],
			&mcsc_fields[MCSC_F_WDMA4_DATA_FORMAT_RGB], out_fmt);
		break;
	default:
		break;
	}
...
void is_scaler_set_wdma_yuv_format(void __iomem *base_addr, u32 output_id, u32 out_fmt)
{
	...
	case MCSC_OUTPUT3:
		is_hw_set_field(base_addr, &mcsc_regs[MCSC_R_WDMA3_DATA_FORMAT],
			&mcsc_fields[MCSC_F_WDMA3_DATA_FORMAT_YUV], out_fmt);
		break;
	case MCSC_OUTPUT4:
		is_hw_set_field(base_addr, &mcsc_regs[MCSC_R_WDMA4_DATA_FORMAT],
			&mcsc_fields[MCSC_F_WDMA4_DATA_FORMAT_YUV], out_fmt);
		break;
	default:
		break;
	}
...
void is_scaler_get_wdma_format(void __iomem *base_addr, u32 output_id, u32 color_type, u32 *out_fmt)
{
	...
	case MCSC_OUTPUT3:
		*out_fmt = is_hw_get_field(base_addr, &mcsc_regs[MCSC_R_WDMA3_DATA_FORMAT],
			&mcsc_fields[MCSC_F_WDMA3_DATA_FORMAT_YUV - color_type]);
		break;
	case MCSC_OUTPUT4:
		*out_fmt = is_hw_get_field(base_addr, &mcsc_regs[MCSC_R_WDMA4_DATA_FORMAT],
			&mcsc_fields[MCSC_F_WDMA4_DATA_FORMAT_YUV - color_type]);
		break;
	default:
		break;
	}
...
void is_scaler_set_wdma_size(void __iomem *base_addr, u32 output_id, u32 width, u32 height)
{
	...
	case MCSC_OUTPUT2:
		...
		break;
	case MCSC_OUTPUT3:
		is_hw_set_field(base_addr, &mcsc_regs[MCSC_R_WDMA3_WIDTH],
			&mcsc_fields[MCSC_F_WDMA3_WIDTH], width);
		is_hw_set_field(base_addr, &mcsc_regs[MCSC_R_WDMA3_HEIGHT],
			&mcsc_fields[MCSC_F_WDMA3_HEIGHT], height);
		break;
	case MCSC_OUTPUT4:
		is_hw_set_field(base_addr, &mcsc_regs[MCSC_R_WDMA4_WIDTH],
			&mcsc_fields[MCSC_F_WDMA4_WIDTH], width);
		is_hw_set_field(base_addr, &mcsc_regs[MCSC_R_WDMA4_HEIGHT],
			&mcsc_fields[MCSC_F_WDMA4_HEIGHT], height);
		break;
	default:
		break;
	}
...
void is_scaler_get_wdma_size(void __iomem *base_addr, u32 output_id, u32 *width, u32 *height)
{
	...
	case MCSC_OUTPUT2:
		...
		*height = is_hw_get_field(base_addr, &mcsc_regs[MCSC_R_WDMA2_HEIGHT],
		...
		break;
	case MCSC_OUTPUT3:
		*width = is_hw_get_field(base_addr, &mcsc_regs[MCSC_R_WDMA3_WIDTH],
			&mcsc_fields[MCSC_F_WDMA3_WIDTH]);
		*height = is_hw_get_field(base_addr, &mcsc_regs[MCSC_R_WDMA3_HEIGHT],
			&mcsc_fields[MCSC_F_WDMA3_HEIGHT]);
		break;
	case MCSC_OUTPUT4:
		*width = is_hw_get_field(base_addr, &mcsc_regs[MCSC_R_WDMA4_WIDTH],
			&mcsc_fields[MCSC_F_WDMA4_WIDTH]);
		*height = is_hw_get_field(base_addr, &mcsc_regs[MCSC_R_WDMA4_HEIGHT],
...
void is_scaler_set_wdma_stride(void __iomem *base_addr, u32 output_id, u32 y_stride, u32 uv_stride)
{
	...
	case MCSC_OUTPUT2:
		...
		break;
	case MCSC_OUTPUT3:
		is_hw_set_field(base_addr, &mcsc_regs[MCSC_R_WDMA3_STRIDE_1P],
			&mcsc_fields[MCSC_F_WDMA3_STRIDE_1P], y_stride);
		is_hw_set_field(base_addr, &mcsc_regs[MCSC_R_WDMA3_STRIDE_2P],
			&mcsc_fields[MCSC_F_WDMA3_STRIDE_2P], uv_stride);
		is_hw_set_field(base_addr, &mcsc_regs[MCSC_R_WDMA3_STRIDE_3P],
			&mcsc_fields[MCSC_F_WDMA3_STRIDE_3P], uv_stride);
		break;
	case MCSC_OUTPUT4:
		is_hw_set_field(base_addr, &mcsc_regs[MCSC_R_WDMA4_STRIDE_1P],
			&mcsc_fields[MCSC_F_WDMA4_STRIDE_1P], y_stride);
		is_hw_set_field(base_addr, &mcsc_regs[MCSC_R_WDMA4_STRIDE_2P],
			&mcsc_fields[MCSC_F_WDMA4_STRIDE_2P], uv_stride);
		is_hw_set_field(base_addr, &mcsc_regs[MCSC_R_WDMA4_STRIDE_3P],
			&mcsc_fields[MCSC_F_WDMA4_STRIDE_3P], uv_stride);
		break;
	default:
		break;
	}
...
void is_scaler_get_wdma_stride(void __iomem *base_addr, u32 output_id, u32 *y_stride, u32 *uv_stride)
{
	...
	case MCSC_OUTPUT2:
		...
		*uv_stride = is_hw_get_field(base_addr, &mcsc_regs[MCSC_R_WDMA2_STRIDE_2P],
		...
		break;
	case MCSC_OUTPUT3:
		*y_stride = is_hw_get_field(base_addr, &mcsc_regs[MCSC_R_WDMA3_STRIDE_1P],
			&mcsc_fields[MCSC_F_WDMA3_STRIDE_1P]);
		*uv_stride = is_hw_get_field(base_addr, &mcsc_regs[MCSC_R_WDMA3_STRIDE_2P],
			&mcsc_fields[MCSC_F_WDMA3_STRIDE_2P]);
		break;
	case MCSC_OUTPUT4:
		*y_stride = is_hw_get_field(base_addr, &mcsc_regs[MCSC_R_WDMA4_STRIDE_1P],
			&mcsc_fields[MCSC_F_WDMA4_STRIDE_1P]);
		*uv_stride = is_hw_get_field(base_addr, &mcsc_regs[MCSC_R_WDMA4_STRIDE_2P],
			&mcsc_fields[MCSC_F_WDMA4_STRIDE_2P]);
		break;
	default:
		break;
	}
...
void get_wdma_addr_arr(u32 output_id, u32 *addr)
{
	...
	case MCSC_OUTPUT2:
		...
		break;
	case MCSC_OUTPUT3:
		addr[0] = MCSC_R_WDMA3_IMG_BASE_ADDR_1P_FRO_00;
		addr[1] = MCSC_R_WDMA3_IMG_BASE_ADDR_2P_FRO_00;
		addr[2] = MCSC_R_WDMA3_IMG_BASE_ADDR_3P_FRO_00;
		addr[3] = 0;
		addr[4] = 0;
		break;
	case MCSC_OUTPUT4:
		addr[0] = MCSC_R_WDMA4_IMG_BASE_ADDR_1P_FRO_00;
		addr[1] = MCSC_R_WDMA4_IMG_BASE_ADDR_2P_FRO_00;
		addr[2] = MCSC_R_WDMA4_IMG_BASE_ADDR_3P_FRO_00;
		addr[3] = 0;
		addr[4] = 0;
		break;
	default:
	...
	u32 output_id, u32 fmt, u32 plane, u32 dma_idx, u32 width, u32 height)
{
	...
	case MCSC_OUTPUT3:
		...
		is_hw_set_field(base_addr, &mcsc_regs[MCSC_R_HWFC_MASTER_SEL],
			&mcsc_fields[MCSC_F_HWFC_MASTER_SEL_A], MCSC_OUTPUT3);
		break;
	case MCSC_OUTPUT4:
		...
		/* WDMA master */
		is_hw_set_field(base_addr, &mcsc_regs[MCSC_R_HWFC_MASTER_SEL],
			&mcsc_fields[MCSC_F_HWFC_MASTER_SEL_B], MCSC_OUTPUT4);
		break;
	default:
		break;
	}
