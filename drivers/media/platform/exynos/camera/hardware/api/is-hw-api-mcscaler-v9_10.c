...
#include "sfr/is-sfr-mcsc-v9_10.h"
#include "is-hw.h"
...
void is_scaler_start(void __iomem *base_addr, u32 hw_id)
{
	...
	case DEV_HW_MCSC0:
		...
		is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_CQ_MS_ADD_TO_QUEUE], 0);
		break;
	default:
...
void is_scaler_clear_intr_all(void __iomem *base_addr, u32 hw_id)
{
	...
	switch (hw_id) {
	case DEV_HW_MCSC0:
		reg_val = is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_VOTF_WDMA_SLOW_RING_STATUS_INT_0], 1);
		reg_val = is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_VOTF_WDMA_LOST_FLUSH_INT_0], 1);
		reg_val = is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_VOTF_RDMA_LOST_FLUSH_INT_0], 1);
		reg_val = is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_VOTF_RDMA_SLOW_RING_STATUS_INT_0], 1);
		reg_val = is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_VOTF_RDMA0_ERR_LOST_INT_0], 1);
		reg_val = is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_COMP_DEC_ERR_INT_0], 1);
		reg_val = is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_STALL_TIMEOUT_INT_0], 1);
		reg_val = is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_FM_SUB_FRAME_START_INT_0], 1);
		reg_val = is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_FM_SUB_FRAME_FINISH_INT_0], 1);
		reg_val = is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_COREX_CMD_QUE_FULL_INT_0], 1);
		reg_val = is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_COREX_ERROR_INT_0], 1);
		reg_val = is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_COREX_COPY_FINISH_INT_0], 1);
...
void is_scaler_disable_intr(void __iomem *base_addr, u32 hw_id)
{
	...
	case DEV_HW_MCSC0:
		reg_val = is_hw_set_field_value(reg_val,
			&mcsc_fields[MCSC_F_VOTF_WDMA_SLOW_RING_STATUS_INT_MASK_0], 1);
		reg_val = is_hw_set_field_value(reg_val,
			&mcsc_fields[MCSC_F_VOTF_WDMA_LOST_FLUSH_INT_MASK_0], 1);
		reg_val = is_hw_set_field_value(reg_val,
			&mcsc_fields[MCSC_F_VOTF_RDMA_LOST_FLUSH_INT_MASK_0], 1);
		reg_val = is_hw_set_field_value(reg_val,
			&mcsc_fields[MCSC_F_VOTF_RDMA_SLOW_RING_STATUS_INT_MASK_0], 1);
		reg_val = is_hw_set_field_value(reg_val,
			&mcsc_fields[MCSC_F_VOTF_RDMA0_ERR_LOST_INT_MASK_0], 1);
		reg_val = is_hw_set_field_value(reg_val,
			&mcsc_fields[MCSC_F_COMP_DEC_ERR_INT_MASK_0], 1);
		reg_val = is_hw_set_field_value(reg_val,
			&mcsc_fields[MCSC_F_STALL_TIMEOUT_INT_MASK_0], 1);
		reg_val = is_hw_set_field_value(reg_val,
			&mcsc_fields[MCSC_F_FM_SUB_FRAME_START_INT_MASK_0], 1);
		reg_val = is_hw_set_field_value(reg_val,
			&mcsc_fields[MCSC_F_FM_SUB_FRAME_FINISH_INT_MASK_0], 1);
		reg_val = is_hw_set_field_value(reg_val,
			&mcsc_fields[MCSC_F_COREX_CMD_QUE_FULL_MASK_0], 1);
		reg_val = is_hw_set_field_value(reg_val,
			&mcsc_fields[MCSC_F_COREX_ERROR_MASK_0], 1);
		reg_val = is_hw_set_field_value(reg_val,
			&mcsc_fields[MCSC_F_COREX_COPY_FINISH_INT_MASK_0], 1);
		reg_val = is_hw_set_field_value(reg_val,
...
unsigned int is_scaler_intr_occurred0(unsigned int status, enum mcsc_event_type type)
{
	...
	case INTR_OVERFLOW:
		...
		break;
	case INTR_OUTSTALL:
		mask = 1 << INTR_MC_SCALER_OUTSTALL;
		break;
...
u32 is_scaler_get_scaler_path(void __iomem *base_addr, u32 hw_id, u32 output_id)
{
	...
	case MCSC_OUTPUT0:
		...
		enable_dma = is_hw_get_field(base_addr,
			&mcsc_regs[MCSC_R_WDMA0_ENABLE], &mcsc_fields[MCSC_F_WDMA0_EN]);
		break;
	case MCSC_OUTPUT1:
		enable_poly = is_hw_get_field(base_addr,
		...
		enable_dma = is_hw_get_field(base_addr,
			&mcsc_regs[MCSC_R_WDMA1_ENABLE], &mcsc_fields[MCSC_F_WDMA1_EN]);
		break;
	case MCSC_OUTPUT2:
		enable_poly = is_hw_get_field(base_addr,
		...
		enable_dma = is_hw_get_field(base_addr,
			&mcsc_regs[MCSC_R_WDMA2_ENABLE], &mcsc_fields[MCSC_F_WDMA2_EN]);
		break;
	default:
		break;
	}
...
void is_scaler_set_rdma_enable(void __iomem *base_addr, u32 hw_id, bool dma_in_en)
{
	switch (hw_id) {
	case DEV_HW_MCSC0:
		is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_RDMA0_ENABLE], (u32)dma_in_en);
		break;
	default:
		warn_hw("invalid hw_id(%d) for MCSC api\n", hw_id);
		break;
...
void is_scaler_set_dma_out_enable(void __iomem *base_addr, u32 output_id, bool dma_out_en)
{
	switch (output_id) {
	case MCSC_OUTPUT0:
		is_hw_set_field(base_addr, &mcsc_regs[MCSC_R_WDMA0_ENABLE],
			&mcsc_fields[MCSC_F_WDMA0_EN], (u32)dma_out_en);
		break;
	case MCSC_OUTPUT1:
		is_hw_set_field(base_addr, &mcsc_regs[MCSC_R_WDMA1_ENABLE],
			&mcsc_fields[MCSC_F_WDMA1_EN], (u32)dma_out_en);
		break;
	case MCSC_OUTPUT2:
		is_hw_set_field(base_addr, &mcsc_regs[MCSC_R_WDMA2_ENABLE],
			&mcsc_fields[MCSC_F_WDMA2_EN], (u32)dma_out_en);
		break;
	default:
		break;
	}
...
u32 is_scaler_get_dma_out_enable(void __iomem *base_addr, u32 output_id)
{
	...
	switch (output_id) {
	case MCSC_OUTPUT0:
		ret = is_hw_get_field(base_addr, &mcsc_regs[MCSC_R_WDMA0_ENABLE],
			&mcsc_fields[MCSC_F_WDMA0_EN]);
		break;
	case MCSC_OUTPUT1:
		ret = is_hw_get_field(base_addr, &mcsc_regs[MCSC_R_WDMA1_ENABLE],
			&mcsc_fields[MCSC_F_WDMA1_EN]);
		break;
	case MCSC_OUTPUT2:
		ret = is_hw_get_field(base_addr, &mcsc_regs[MCSC_R_WDMA2_ENABLE],
			&mcsc_fields[MCSC_F_WDMA2_EN]);
		break;
	default:
		break;
	}
...
void is_scaler_set_rdma_sbwc_enable(void __iomem *base_addr, u32 hw_id, bool sbwc_en)
{
	switch (hw_id) {
	case DEV_HW_MCSC0:
		is_hw_set_field(base_addr, &mcsc_regs[MCSC_R_RDMA0_COMP_CTRL],
			&mcsc_fields[MCSC_F_RDMA0_SBWC_EN], (u32)sbwc_en);
		break;
	default:
		warn_hw("invalid hw_id(%d) for MCSC api\n", hw_id);
		break;
...
u32 is_scaler_get_rdma_sbwc_enable(void __iomem *base_addr, u32 hw_id)
{
	...
	switch (hw_id) {
	case DEV_HW_MCSC0:
		ret = is_hw_get_field(base_addr, &mcsc_regs[MCSC_R_RDMA0_COMP_CTRL],
			&mcsc_fields[MCSC_F_RDMA0_SBWC_EN]);
		break;
	default:
		warn_hw("invalid hw_id(%d) for MCSC api\n", hw_id);
		break;
...
void is_scaler_set_rdma_sbwc_64b_align(void __iomem *base_addr, u32 hw_id, u32 align_64b)
{
	...
	case DEV_HW_MCSC0:
		is_hw_set_field(base_addr, &mcsc_regs[MCSC_R_RDMA0_COMP_CTRL],
			&mcsc_fields[MCSC_F_RDMA0_SBWC_64B_ALIGN], align_64b);
		break;
	default:
		warn_hw("invalid hw_id(%d) for MCSC api\n", hw_id);
		break;
...
void is_scaler_set_rdma_sbwc_lossy_rate(void __iomem *base_addr, u32 hw_id, u32 lossy_rate)
{
	switch (hw_id) {
	case DEV_HW_MCSC0:
		is_hw_set_field(base_addr, &mcsc_regs[MCSC_R_RDMA0_COMP_LOSSY_BYTE32NUM],
			&mcsc_fields[MCSC_F_RDMA0_COMP_LOSSY_BYTE32NUM], lossy_rate);
		break;
	default:
		warn_hw("invalid hw_id(%d) for MCSC api\n", hw_id);
		break;
...
void is_scaler_set_wdma_sbwc_enable(void __iomem *base_addr, u32 output_id, bool sbwc_en)
{
	switch (output_id) {
	case MCSC_OUTPUT0:
		is_hw_set_field(base_addr, &mcsc_regs[MCSC_R_WDMA0_COMP_CTRL],
			&mcsc_fields[MCSC_F_WDMA0_SBWC_EN], (u32)sbwc_en);
		break;
	case MCSC_OUTPUT1:
		is_hw_set_field(base_addr, &mcsc_regs[MCSC_R_WDMA1_COMP_CTRL],
			&mcsc_fields[MCSC_F_WDMA1_SBWC_EN], (u32)sbwc_en);
		break;
	case MCSC_OUTPUT2:
		/* not support */
		break;
...
u32 is_scaler_get_wdma_sbwc_enable(void __iomem *base_addr, u32 output_id)
{
	...
	switch (output_id) {
	case MCSC_OUTPUT0:
		ret = is_hw_get_field(base_addr, &mcsc_regs[MCSC_R_WDMA0_COMP_CTRL],
			&mcsc_fields[MCSC_F_WDMA0_SBWC_EN]);
		break;
	case MCSC_OUTPUT1:
		ret = is_hw_get_field(base_addr, &mcsc_regs[MCSC_R_WDMA1_COMP_CTRL],
			&mcsc_fields[MCSC_F_WDMA1_SBWC_EN]);
		break;
	case MCSC_OUTPUT2:
		/* not support */
		break;
...
void is_scaler_set_wdma_sbwc_64b_align(void __iomem *base_addr, u32 output_id, u32 align_64b)
{
	...
	case MCSC_OUTPUT0:
		is_hw_set_field(base_addr, &mcsc_regs[MCSC_R_WDMA0_COMP_CTRL],
			&mcsc_fields[MCSC_F_WDMA0_SBWC_64B_ALIGN], align_64b);
		break;
	case MCSC_OUTPUT1:
		is_hw_set_field(base_addr, &mcsc_regs[MCSC_R_WDMA1_COMP_CTRL],
			&mcsc_fields[MCSC_F_WDMA1_SBWC_64B_ALIGN], align_64b);
		break;
	case MCSC_OUTPUT2:
		/* not support */
		break;
...
void is_scaler_set_wdma_sbwc_lossy_rate(void __iomem *base_addr, u32 output_id, u32 lossy_rate)
{
	switch (output_id) {
	case MCSC_OUTPUT0:
		is_hw_set_field(base_addr, &mcsc_regs[MCSC_R_WDMA0_COMP_LOSSY_BYTE32NUM],
			&mcsc_fields[MCSC_F_WDMA0_COMP_LOSSY_BYTE32NUM], lossy_rate);
		break;
	case MCSC_OUTPUT1:
		is_hw_set_field(base_addr, &mcsc_regs[MCSC_R_WDMA1_COMP_LOSSY_BYTE32NUM],
			&mcsc_fields[MCSC_F_WDMA1_COMP_LOSSY_BYTE32NUM], lossy_rate);
		break;
	case MCSC_OUTPUT2:
		/* not support */
		break;
...
{
	/* WDMA0_COMP_SRAM_START_ADDR + WDMA1_COMP_SRAM_START_ADDR <= 5760 */
	switch (output_id) {
	case MCSC_OUTPUT0:
		is_hw_set_field(base_addr, &mcsc_regs[MCSC_R_WDMA0_COMP_SRAM_START_ADDR],
			&mcsc_fields[MCSC_F_WDMA0_COMP_SRAM_START_ADDR], sram_addr);
		break;
	case MCSC_OUTPUT1:
		is_hw_set_field(base_addr, &mcsc_regs[MCSC_R_WDMA1_COMP_SRAM_START_ADDR],
			&mcsc_fields[MCSC_F_WDMA1_COMP_SRAM_START_ADDR], sram_addr);
		break;
	case MCSC_OUTPUT2:
		/* not support */
		break;
...
void is_scaler_set_rdma_votf_enable(void __iomem *base_addr, u32 hw_id, bool votf_en)
{
	switch (hw_id) {
	case DEV_HW_MCSC0:
		is_hw_set_field(base_addr, &mcsc_regs[MCSC_R_RDMA0_VOTF_EN],
			&mcsc_fields[MCSC_F_RDMA0_VOTF_EN], (u32)votf_en);
		break;
	default:
		warn_hw("invalid hw_id(%d) for MCSC api\n", hw_id);
		break;
...
void is_scaler_set_wdma_votf_enable(void __iomem *base_addr, u32 output_id, bool votf_en)
{
	switch (output_id) {
	case MCSC_OUTPUT0:
		is_hw_set_field(base_addr, &mcsc_regs[MCSC_R_WDMA0_VOTF_EN],
			&mcsc_fields[MCSC_F_WDMA0_VOTF_EN], (u32)votf_en);
		break;
	case MCSC_OUTPUT1:
		is_hw_set_field(base_addr, &mcsc_regs[MCSC_R_WDMA1_VOTF_EN],
			&mcsc_fields[MCSC_F_WDMA1_VOTF_EN], (u32)votf_en);
		break;
	case MCSC_OUTPUT2:
		is_hw_set_field(base_addr, &mcsc_regs[MCSC_R_WDMA2_VOTF_EN],
			&mcsc_fields[MCSC_F_WDMA2_VOTF_EN], (u32)votf_en);
		break;
	default:
		break;
	}
...
void is_scaler_set_rdma_format(void __iomem *base_addr, u32 hw_id, u32 in_fmt)
{
	...
	case DEV_HW_MCSC0:
		...
		reg_val = is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_RDMA0_DATA_FORMAT_BAYER], 0);
		/* 0 : SBWC 1 : No SBWC */
		reg_val = is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_RDMA0_DATA_FORMAT_MSBALIGN_UNSIGN], 1);
		is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_RDMA0_DATA_FORMAT], reg_val);
		break;
	default:
		warn_hw("invalid hw_id(%d) for MCSC api\n", hw_id);
		break;
...
void is_scaler_set_wdma_format_type(void __iomem *base_addr, u32 output_id, u32 format_type)
{
	...
	case MCSC_OUTPUT0:
		is_hw_set_field(base_addr, &mcsc_regs[MCSC_R_WDMA0_DATA_FORMAT],
			&mcsc_fields[MCSC_F_WDMA0_DATA_FORMAT_TYPE], 0);
		break;
	case MCSC_OUTPUT1:
		is_hw_set_field(base_addr, &mcsc_regs[MCSC_R_WDMA1_DATA_FORMAT],
			&mcsc_fields[MCSC_F_WDMA1_DATA_FORMAT_TYPE], 0);
		break;
	case MCSC_OUTPUT2:
		is_hw_set_field(base_addr, &mcsc_regs[MCSC_R_WDMA2_DATA_FORMAT],
			&mcsc_fields[MCSC_F_WDMA2_DATA_FORMAT_TYPE], format_type);
		break;
	default:
		break;
	}
...
void is_scaler_set_wdma_rgb_format(void __iomem *base_addr, u32 output_id, u32 out_fmt)
{
	...
	case MCSC_OUTPUT0:
		is_hw_set_field(base_addr, &mcsc_regs[MCSC_R_WDMA0_DATA_FORMAT],
			&mcsc_fields[MCSC_F_WDMA0_DATA_FORMAT_RGB], out_fmt);
		break;
	case MCSC_OUTPUT1:
		is_hw_set_field(base_addr, &mcsc_regs[MCSC_R_WDMA1_DATA_FORMAT],
			&mcsc_fields[MCSC_F_WDMA1_DATA_FORMAT_RGB], out_fmt);
		break;
	case MCSC_OUTPUT2:
		is_hw_set_field(base_addr, &mcsc_regs[MCSC_R_WDMA2_DATA_FORMAT],
			&mcsc_fields[MCSC_F_WDMA2_DATA_FORMAT_RGB], out_fmt);
		break;
	default:
		break;
	}
...
void is_scaler_set_wdma_yuv_format(void __iomem *base_addr, u32 output_id, u32 out_fmt)
{
	...
	case MCSC_OUTPUT0:
		is_hw_set_field(base_addr, &mcsc_regs[MCSC_R_WDMA0_DATA_FORMAT],
			&mcsc_fields[MCSC_F_WDMA0_DATA_FORMAT_YUV], out_fmt);
		break;
	case MCSC_OUTPUT1:
		is_hw_set_field(base_addr, &mcsc_regs[MCSC_R_WDMA1_DATA_FORMAT],
			&mcsc_fields[MCSC_F_WDMA1_DATA_FORMAT_YUV], out_fmt);
		break;
	case MCSC_OUTPUT2:
		is_hw_set_field(base_addr, &mcsc_regs[MCSC_R_WDMA2_DATA_FORMAT],
			&mcsc_fields[MCSC_F_WDMA2_DATA_FORMAT_YUV], out_fmt);
		break;
	default:
		break;
	}
...
void is_scaler_get_wdma_format(void __iomem *base_addr, u32 output_id, u32 color_type, u32 *out_fmt)
{
	...
	case MCSC_OUTPUT0:
		*out_fmt = is_hw_get_field(base_addr, &mcsc_regs[MCSC_R_WDMA0_DATA_FORMAT],
			&mcsc_fields[MCSC_F_WDMA0_DATA_FORMAT_YUV - color_type]);
		break;
	case MCSC_OUTPUT1:
		*out_fmt = is_hw_get_field(base_addr, &mcsc_regs[MCSC_R_WDMA1_DATA_FORMAT],
			&mcsc_fields[MCSC_F_WDMA1_DATA_FORMAT_YUV - color_type]);
		break;
	case MCSC_OUTPUT2:
		*out_fmt = is_hw_get_field(base_addr, &mcsc_regs[MCSC_R_WDMA2_DATA_FORMAT],
			&mcsc_fields[MCSC_F_WDMA2_DATA_FORMAT_YUV - color_type]);
		break;
	default:
		break;
	}
...
{
	is_hw_set_field(base_addr, &mcsc_regs[MCSC_R_RDMA0_WIDTH],
			&mcsc_fields[MCSC_F_RDMA0_WIDTH], width);
	is_hw_set_field(base_addr, &mcsc_regs[MCSC_R_RDMA0_HEIGHT],
			&mcsc_fields[MCSC_F_RDMA0_HEIGHT], height);
}

void is_scaler_get_rdma_size(void __iomem *base_addr, u32 *width, u32 *height)
{
	*width = is_hw_get_field(base_addr, &mcsc_regs[MCSC_R_RDMA0_WIDTH],
		&mcsc_fields[MCSC_F_RDMA0_WIDTH]);
	*height = is_hw_get_field(base_addr, &mcsc_regs[MCSC_R_RDMA0_HEIGHT],
		&mcsc_fields[MCSC_F_RDMA0_HEIGHT]);
}
...
void is_scaler_set_wdma_size(void __iomem *base_addr, u32 output_id, u32 width, u32 height)
{
	...
	case MCSC_OUTPUT0:
		...
		break;
	case MCSC_OUTPUT1:
		is_hw_set_field(base_addr, &mcsc_regs[MCSC_R_WDMA1_WIDTH],
			&mcsc_fields[MCSC_F_WDMA1_WIDTH], width);
		is_hw_set_field(base_addr, &mcsc_regs[MCSC_R_WDMA1_HEIGHT],
			&mcsc_fields[MCSC_F_WDMA1_HEIGHT], height);
		break;
	case MCSC_OUTPUT2:
		is_hw_set_field(base_addr, &mcsc_regs[MCSC_R_WDMA2_WIDTH],
			&mcsc_fields[MCSC_F_WDMA2_WIDTH], width);
		is_hw_set_field(base_addr, &mcsc_regs[MCSC_R_WDMA2_HEIGHT],
			&mcsc_fields[MCSC_F_WDMA2_HEIGHT], height);
		break;
	default:
		break;
	}
...
void is_scaler_get_wdma_size(void __iomem *base_addr, u32 output_id, u32 *width, u32 *height)
{
	...
	case MCSC_OUTPUT0:
		...
		*height = is_hw_get_field(base_addr, &mcsc_regs[MCSC_R_WDMA0_HEIGHT],
		...
		break;
	case MCSC_OUTPUT1:
		*width = is_hw_get_field(base_addr, &mcsc_regs[MCSC_R_WDMA1_WIDTH],
			&mcsc_fields[MCSC_F_WDMA1_WIDTH]);
		*height = is_hw_get_field(base_addr, &mcsc_regs[MCSC_R_WDMA1_HEIGHT],
			&mcsc_fields[MCSC_F_WDMA1_HEIGHT]);
		break;
	case MCSC_OUTPUT2:
		*width = is_hw_get_field(base_addr, &mcsc_regs[MCSC_R_WDMA2_WIDTH],
			&mcsc_fields[MCSC_F_WDMA2_WIDTH]);
		*height = is_hw_get_field(base_addr, &mcsc_regs[MCSC_R_WDMA2_HEIGHT],
...
{
	/* RDMA format - Bayer */
	is_hw_set_field(base_addr, &mcsc_regs[MCSC_R_RDMA0_STRIDE_1P],
			&mcsc_fields[MCSC_F_RDMA0_STRIDE_1P], y_stride);
}

void is_scaler_set_rdma_2bit_stride(void __iomem *base_addr, u32 y_2bit_stride, u32 uv_2bit_stride)
{
	/* RDMA format - Bayer */
	is_hw_set_field(base_addr, &mcsc_regs[MCSC_R_RDMA0_STRIDE_HEADER_1P],
			&mcsc_fields[MCSC_F_RDMA0_STRIDE_HEADER_1P], y_2bit_stride);
}

void is_scaler_get_rdma_stride(void __iomem *base_addr, u32 *y_stride, u32 *uv_stride)
{
	/* RDMA format - Bayer */
	*y_stride = is_hw_get_field(base_addr, &mcsc_regs[MCSC_R_RDMA0_STRIDE_1P],
			&mcsc_fields[MCSC_F_RDMA0_STRIDE_1P]);
	*uv_stride = 0;
}
...
void is_scaler_set_wdma_stride(void __iomem *base_addr, u32 output_id, u32 y_stride, u32 uv_stride)
{
	switch (output_id) {
	case MCSC_OUTPUT0:
		is_hw_set_field(base_addr, &mcsc_regs[MCSC_R_WDMA0_STRIDE_1P],
			&mcsc_fields[MCSC_F_WDMA0_STRIDE_1P], y_stride);
		is_hw_set_field(base_addr, &mcsc_regs[MCSC_R_WDMA0_STRIDE_2P],
			&mcsc_fields[MCSC_F_WDMA0_STRIDE_2P], uv_stride);
		is_hw_set_field(base_addr, &mcsc_regs[MCSC_R_WDMA0_STRIDE_3P],
			&mcsc_fields[MCSC_F_WDMA0_STRIDE_3P], uv_stride);
		break;
	case MCSC_OUTPUT1:
		is_hw_set_field(base_addr, &mcsc_regs[MCSC_R_WDMA1_STRIDE_1P],
			&mcsc_fields[MCSC_F_WDMA1_STRIDE_1P], y_stride);
		is_hw_set_field(base_addr, &mcsc_regs[MCSC_R_WDMA1_STRIDE_2P],
			&mcsc_fields[MCSC_F_WDMA1_STRIDE_2P], uv_stride);
		is_hw_set_field(base_addr, &mcsc_regs[MCSC_R_WDMA1_STRIDE_3P],
			&mcsc_fields[MCSC_F_WDMA1_STRIDE_3P], uv_stride);
		break;
	case MCSC_OUTPUT2:
		is_hw_set_field(base_addr, &mcsc_regs[MCSC_R_WDMA2_STRIDE_1P],
			&mcsc_fields[MCSC_F_WDMA2_STRIDE_1P], y_stride);
		is_hw_set_field(base_addr, &mcsc_regs[MCSC_R_WDMA2_STRIDE_2P],
			&mcsc_fields[MCSC_F_WDMA2_STRIDE_2P], uv_stride);
		is_hw_set_field(base_addr, &mcsc_regs[MCSC_R_WDMA2_STRIDE_3P],
			&mcsc_fields[MCSC_F_WDMA2_STRIDE_3P], uv_stride);
	...
	u32 y_2bit_stride, u32 uv_2bit_stride)
{
	switch (output_id) {
	case MCSC_OUTPUT0:
		is_hw_set_field(base_addr, &mcsc_regs[MCSC_R_WDMA0_STRIDE_HEADER_1P],
			&mcsc_fields[MCSC_F_WDMA0_STRIDE_HEADER_1P], y_2bit_stride);
		is_hw_set_field(base_addr, &mcsc_regs[MCSC_R_WDMA0_STRIDE_HEADER_2P],
			&mcsc_fields[MCSC_F_WDMA0_STRIDE_HEADER_2P], uv_2bit_stride);
		break;
	case MCSC_OUTPUT1:
		is_hw_set_field(base_addr, &mcsc_regs[MCSC_R_WDMA1_STRIDE_HEADER_1P],
			&mcsc_fields[MCSC_F_WDMA1_STRIDE_HEADER_1P], y_2bit_stride);
		is_hw_set_field(base_addr, &mcsc_regs[MCSC_R_WDMA1_STRIDE_HEADER_2P],
			&mcsc_fields[MCSC_F_WDMA1_STRIDE_HEADER_2P], uv_2bit_stride);
		break;
	case MCSC_OUTPUT2:
		/* not support */
		break;
...
void is_scaler_get_wdma_stride(void __iomem *base_addr, u32 output_id, u32 *y_stride, u32 *uv_stride)
{
	switch (output_id) {
	case MCSC_OUTPUT0:
		*y_stride = is_hw_get_field(base_addr, &mcsc_regs[MCSC_R_WDMA0_STRIDE_1P],
			&mcsc_fields[MCSC_F_WDMA0_STRIDE_1P]);
		*uv_stride = is_hw_get_field(base_addr, &mcsc_regs[MCSC_R_WDMA0_STRIDE_2P],
			&mcsc_fields[MCSC_F_WDMA0_STRIDE_2P]);
		break;
	case MCSC_OUTPUT1:
		*y_stride = is_hw_get_field(base_addr, &mcsc_regs[MCSC_R_WDMA1_STRIDE_1P],
			&mcsc_fields[MCSC_F_WDMA1_STRIDE_1P]);
		*uv_stride = is_hw_get_field(base_addr, &mcsc_regs[MCSC_R_WDMA1_STRIDE_2P],
			&mcsc_fields[MCSC_F_WDMA1_STRIDE_2P]);
		break;
	case MCSC_OUTPUT2:
		*y_stride = is_hw_get_field(base_addr, &mcsc_regs[MCSC_R_WDMA2_STRIDE_1P],
			&mcsc_fields[MCSC_F_WDMA2_STRIDE_1P]);
		*uv_stride = is_hw_get_field(base_addr, &mcsc_regs[MCSC_R_WDMA2_STRIDE_2P],
			&mcsc_fields[MCSC_F_WDMA2_STRIDE_2P]);
		break;
	default:
		break;
	}
	...
	u32 y_addr, u32 cb_addr, u32 cr_addr, int buf_index)
{
	is_hw_set_reg(base_addr,
		&mcsc_regs[MCSC_R_RDMA0_IMG_BASE_ADDR_1P_FRO_00 + buf_index],
		y_addr);
}
...
{
	is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_RDMA0_HEADER_BASE_ADDR_1P_FRO_00], y_2bit_addr);
}
...
void get_wdma_addr_arr(u32 output_id, u32 *addr)
{
	switch (output_id) {
	case MCSC_OUTPUT0:
		addr[0] = MCSC_R_WDMA0_IMG_BASE_ADDR_1P_FRO_00;
		addr[1] = MCSC_R_WDMA0_IMG_BASE_ADDR_2P_FRO_00;
		addr[2] = MCSC_R_WDMA0_IMG_BASE_ADDR_3P_FRO_00;
		addr[3] = MCSC_R_WDMA0_HEADER_BASE_ADDR_1P_FRO_00;
		addr[4] = MCSC_R_WDMA0_HEADER_BASE_ADDR_2P_FRO_00;
		break;
	case MCSC_OUTPUT1:
		addr[0] = MCSC_R_WDMA1_IMG_BASE_ADDR_1P_FRO_00;
		addr[1] = MCSC_R_WDMA1_IMG_BASE_ADDR_2P_FRO_00;
		addr[2] = MCSC_R_WDMA1_IMG_BASE_ADDR_3P_FRO_00;
		addr[3] = MCSC_R_WDMA1_HEADER_BASE_ADDR_1P_FRO_00;
		addr[4] = MCSC_R_WDMA1_HEADER_BASE_ADDR_2P_FRO_00;
		break;
	case MCSC_OUTPUT2:
		addr[0] = MCSC_R_WDMA2_IMG_BASE_ADDR_1P_FRO_00;
		addr[1] = MCSC_R_WDMA2_IMG_BASE_ADDR_2P_FRO_00;
		addr[2] = MCSC_R_WDMA2_IMG_BASE_ADDR_3P_FRO_00;
		addr[3] = 0;
		addr[4] = 0;
		break;
	default:
...
{
	is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_RDMA0_IMG_BASE_ADDR_1P_FRO_00], 0x0);
	is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_RDMA0_HEADER_BASE_ADDR_1P_FRO_00], 0x0);
}
	...
	u32 output_id, u32 fmt, u32 plane, u32 dma_idx, u32 width, u32 height)
{
	...
	case MCSC_OUTPUT1:
		...
		/* WDMA master */
		is_hw_set_field(base_addr, &mcsc_regs[MCSC_R_HWFC_MASTER_SEL],
			&mcsc_fields[MCSC_F_HWFC_MASTER_SEL_A], MCSC_OUTPUT1);
		break;
	case MCSC_OUTPUT2:
		...
		/* WDMA master */
		is_hw_set_field(base_addr, &mcsc_regs[MCSC_R_HWFC_MASTER_SEL],
			&mcsc_fields[MCSC_F_HWFC_MASTER_SEL_B], MCSC_OUTPUT2);
		break;
	default:
		break;
	}
...
void is_scaler_set_djag_enable(void __iomem *base_addr, u32 djag_enable)
{
	...
	reg_val = is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_DJAG0_EZPOST_ENABLE], djag_enable);
...
void is_scaler_set_djag_src_size(void __iomem *base_addr, u32 pos_x, u32 pos_y, u32 width, u32 height)
{
	...
	reg_val = is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_DJAG0_PS_SRC_HPOS], pos_x);
	reg_val = is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_DJAG0_PS_SRC_VPOS], pos_y);
...
{
	u32 reg_val = 0;
	u32 djag_enable = is_hw_get_field(base_addr, &mcsc_regs[MCSC_R_DJAG0_CTRL],
			&mcsc_fields[MCSC_F_DJAG0_ENABLE]);
	if (hf_enable && !djag_enable) {
		err_hw("To enable HF block, DJAG should be enabled. Force HF block off\n");
		is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_DJAG0_HF_CTRL], reg_val);
	}
	reg_val = is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_DJAG0_HF_SC_ENABLE], hf_scaler_enable);
	reg_val = is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_DJAG0_HF_ENABLE_A], hf_enable);
	is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_DJAG0_HF_CTRL], reg_val);
}
...
void is_scaler_set_djag_hf_img_size(void __iomem *base_addr, u32 width, u32 height)
{
	...
	reg_val = is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_DJAG0_HF_INPUT_IMG_HSIZE], width);
	reg_val = is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_DJAG0_HF_INPUT_IMG_VSIZE], height);
	is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_DJAG0_HF_IMG_SIZE], reg_val);
}

void is_scaler_set_djag_hf_cfg(void __iomem *base_addr, struct hf_cfg_by_ni *hf_cfg)
{
	is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_DJAG0_HF_WEIGHT], hf_cfg->hf_weight);
}
...
void is_scaler_set_cac_enable(void __iomem *base_addr, u32 en)
{
	...
	/* If CAC is enabled, DJAG should be enabled */
	if (en && !djag_enable)
		reg_val = is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_CAC0_ENABLE], djag_enable);
	else
...
void is_scaler_set_cac_map_crt_thr(void __iomem *base_addr, struct cac_cfg_by_ni *cfg)
{
	...
	/*
	 * FIX-ME : Need to tune parameters of CAC
	 * Currently use reset value
	 */
	is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_CAC0_MAP_RIGHT_SHIFT], cfg->map_thr_cfg.map_right_shift);
	is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_CAC0_MAP_NORMAL_GAIN], cfg->map_thr_cfg.map_normal_gain);
	is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_CAC0_MAP_LINE_THR], cfg->map_thr_cfg.map_line_thr);

	/* Line Detector Coef */
	reg_val = is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_CAC0_MAP_COEF_00],
			cfg->map_thr_cfg.map_coef_y0[0]);
	reg_val = is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_CAC0_MAP_COEF_01],
			cfg->map_thr_cfg.map_coef_y0[1]);
	reg_val = is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_CAC0_MAP_COEF_02],
			cfg->map_thr_cfg.map_coef_y0[2]);
	is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_CAC0_MAP_COEF_Y0], reg_val);

	reg_val = 0;
	reg_val = is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_CAC0_MAP_COEF_10],
			cfg->map_thr_cfg.map_coef_y1[0]);
	reg_val = is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_CAC0_MAP_COEF_11],
			cfg->map_thr_cfg.map_coef_y1[1]);
	reg_val = is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_CAC0_MAP_COEF_12],
			cfg->map_thr_cfg.map_coef_y1[2]);
	is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_CAC0_MAP_COEF_Y1], reg_val);

	reg_val = 0;
	reg_val = is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_CAC0_MAP_COEF_20],
			cfg->map_thr_cfg.map_coef_y2[0]);
	reg_val = is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_CAC0_MAP_COEF_21],
			cfg->map_thr_cfg.map_coef_y2[1]);
	reg_val = is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_CAC0_MAP_COEF_22],
			cfg->map_thr_cfg.map_coef_y2[2]);
	is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_CAC0_MAP_COEF_Y2], reg_val);

	/* Line Detector Blend Table */
	reg_val = 0;
	reg_val = is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_CAC0_MAP_BLEND_TBL_0],
			cfg->map_thr_cfg.map_blend_tbl[0]);
	reg_val = is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_CAC0_MAP_BLEND_TBL_1],
			cfg->map_thr_cfg.map_blend_tbl[1]);
	reg_val = is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_CAC0_MAP_BLEND_TBL_2],
			cfg->map_thr_cfg.map_blend_tbl[2]);
	reg_val = is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_CAC0_MAP_BLEND_TBL_3],
			cfg->map_thr_cfg.map_blend_tbl[3]);
	is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_CAC0_MAP_BLEND_TBL_0_3], reg_val);
	reg_val = 0;
	reg_val = is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_CAC0_MAP_BLEND_TBL_4],
			cfg->map_thr_cfg.map_blend_tbl[4]);
	reg_val = is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_CAC0_MAP_BLEND_TBL_5],
			cfg->map_thr_cfg.map_blend_tbl[5]);
	reg_val = is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_CAC0_MAP_BLEND_TBL_6],
			cfg->map_thr_cfg.map_blend_tbl[6]);
	reg_val = is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_CAC0_MAP_BLEND_TBL_7],
			cfg->map_thr_cfg.map_blend_tbl[7]);
	is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_CAC0_MAP_BLEND_TBL_4_7], reg_val);
	reg_val = 0;
	reg_val = is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_CAC0_MAP_BLEND_TBL_8],
			cfg->map_thr_cfg.map_blend_tbl[8]);
	is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_CAC0_MAP_BLEND_TBL_8], reg_val);

	/* CRT Hue Gain Table */
	reg_val = 0;
	reg_val = is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_CAC0_CRT_HUE_TBL_0],
			cfg->crt_thr_cfg.crt_hue_tbl[0]);
	reg_val = is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_CAC0_CRT_HUE_TBL_1],
			cfg->crt_thr_cfg.crt_hue_tbl[1]);
	reg_val = is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_CAC0_CRT_HUE_TBL_2],
			cfg->crt_thr_cfg.crt_hue_tbl[2]);
	reg_val = is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_CAC0_CRT_HUE_TBL_3],
			cfg->crt_thr_cfg.crt_hue_tbl[3]);
	is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_CAC0_CRT_HUE_TBL_0_3], reg_val);
	reg_val = 0;
	reg_val = is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_CAC0_CRT_HUE_TBL_4],
			cfg->crt_thr_cfg.crt_hue_tbl[4]);
	reg_val = is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_CAC0_CRT_HUE_TBL_5],
			cfg->crt_thr_cfg.crt_hue_tbl[5]);
	reg_val = is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_CAC0_CRT_HUE_TBL_6],
			cfg->crt_thr_cfg.crt_hue_tbl[6]);
	reg_val = is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_CAC0_CRT_HUE_TBL_7],
			cfg->crt_thr_cfg.crt_hue_tbl[7]);
	is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_CAC0_CRT_HUE_TBL_4_7], reg_val);
	reg_val = 0;
	reg_val = is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_CAC0_CRT_HUE_TBL_8],
			cfg->crt_thr_cfg.crt_hue_tbl[8]);
	reg_val = is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_CAC0_CRT_HUE_TBL_9],
			cfg->crt_thr_cfg.crt_hue_tbl[9]);
	reg_val = is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_CAC0_CRT_HUE_TBL_10],
			cfg->crt_thr_cfg.crt_hue_tbl[10]);
	reg_val = is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_CAC0_CRT_HUE_TBL_11],
			cfg->crt_thr_cfg.crt_hue_tbl[11]);
	is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_CAC0_CRT_HUE_TBL_8_11], reg_val);
}
...
{
	u32 reg_val = 0;
	/* horizontal scaler for HF component */
	reg_val = is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_DJAG0_HF_SC_SRC_HPOS], pos_x);
	reg_val = is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_DJAG0_HF_SC_SRC_VPOS], pos_y);
	is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_DJAG0_HF_SC_SRC_POS], reg_val);

	reg_val = 0;
	reg_val = is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_DJAG0_HF_SC_SRC_HSIZE], width);
	reg_val = is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_DJAG0_HF_SC_SRC_VSIZE], height);
	is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_DJAG0_HF_SC_SRC_SIZE], reg_val);
}
...
void is_scaler_set_hf_scaler_dst_size(void __iomem *base_addr, u32 width, u32 height)
{
	u32 reg_val = 0;
	/* horizontal scaler for HF component */
	reg_val = is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_DJAG0_HF_SC_DST_HSIZE], width);
	reg_val = is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_DJAG0_HF_SC_DST_VSIZE], height);
	is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_DJAG0_HF_SC_DST_SIZE], reg_val);
}

void is_scaler_set_hf_scaler_scaling_ratio(void __iomem *base_addr, u32 hratio, u32 vratio)
{
	/* horizontal scaler for HF component */
	is_hw_set_field(base_addr, &mcsc_regs[MCSC_R_DJAG0_HF_SC_H_RATIO],
			&mcsc_fields[MCSC_F_DJAG0_HF_SC_H_RATIO], hratio);
}
	...
	enum exynos_sensor_position sensor_position)
{
	...
	/* horizontal scaler for HF component */
	is_hw_set_field(base_addr, &mcsc_regs[MCSC_R_DJAG0_HF_SC_H_INIT_PHASE_OFFSET],
		&mcsc_fields[MCSC_F_DJAG0_HF_SC_H_INIT_PHASE_OFFSET], h_phase_offset);
}

void is_scaler_set_hf_scaler_round_mode(void __iomem *base_addr, u32 mode)
{
	is_hw_set_field(base_addr, &mcsc_regs[MCSC_R_DJAG0_HF_SC_ROUND_MODE],
		&mcsc_fields[MCSC_R_DJAG0_HF_SC_ROUND_MODE], mode);
}
...
int is_scaler_set_hf_config(void __iomem *base_addr, u32 hw_id,
	...
	u32 *payload_size)
{
	bool hf_scaler_enable;
	u32 hratio, vratio;
	u32 in_pos_x, in_pos_y, in_width, in_height;
	u32 out_width = is_hw_get_field(base_addr,
						&mcsc_regs[MCSC_R_DJAG0_HF_IMG_SIZE], &mcsc_fields[MCSC_F_DJAG0_HF_INPUT_IMG_HSIZE]);
	u32 out_height = is_hw_get_field(base_addr,
						&mcsc_regs[MCSC_R_DJAG0_HF_IMG_SIZE], &mcsc_fields[MCSC_F_DJAG0_HF_INPUT_IMG_VSIZE]);

	in_pos_x = hf_param->crop_offset_x;
	in_pos_y = hf_param->crop_offset_y;
	in_width = hf_param->crop_width;
	in_height = hf_param->crop_height;

	if (in_width > MCSC_LINE_BUF_SIZE)
		in_width = out_width;
	if (in_width > out_width || in_height != out_height) {
		err_hw("high frequency: hf support only horizontal upscaling!! input(%dx%d), output(%dx%d)",
				in_width, in_height, out_width, out_height);
		is_scaler_set_rdma_enable(base_addr, hw_id, false);
		is_scaler_set_djag_hf_enable(base_addr, false, false);
		return -EINVAL;
	}

	hf_scaler_enable = (in_width < out_width ? true : false);

	hratio = GET_ZOOM_RATIO(in_width, out_width);
	vratio = GET_ZOOM_RATIO(in_height, out_height);

	dbg_hw(2, "high frequency: hf scaler input(%dx%d), output(%dx%d), format(bayer)",
		in_width, in_height, out_width, out_height);
	...
	is_scaler_set_rdma_size(base_addr, in_width, in_height);
	is_scaler_set_rdma_stride(base_addr, hf_param->dma_stride_y, hf_param->dma_stride_c);
	/* HF scaling */
	is_scaler_set_hf_scaler_src_size(base_addr, in_pos_x, in_pos_y, in_width, in_height);
	is_scaler_set_hf_scaler_dst_size(base_addr, out_width, out_height);
	is_scaler_set_hf_scaler_scaling_ratio(base_addr, hratio, vratio);
	is_scaler_set_hf_scaler_coef(base_addr, hratio, vratio,
		sc_coef, sensor_position);
	is_scaler_set_hf_scaler_round_mode(base_addr, true);
	is_scaler_set_hf_scaler_enable(base_addr, hw_id, hf_scaler_enable);
	/* Enable DJAG HF Recomposition */
	is_scaler_set_djag_hf_enable(base_addr, hf_enable, hf_scaler_enable);
...
{
	if (status & (1 << INTR_MC_SCALER_COREX_CMD_QUE_FULL))
		is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_SCALER_INTERRUPT_0],
			(u32)1 << INTR_MC_SCALER_COREX_CMD_QUE_FULL);

	if (status & (1 << INTR_MC_SCALER_COREX_ERROR))
		is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_SCALER_INTERRUPT_0],
			(u32)1 << INTR_MC_SCALER_COREX_ERROR);

	if (status & (1 << INTR_MC_SCALER_COREX_COPY_FINISH))
		is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_SCALER_INTERRUPT_0],
			(u32)1 << INTR_MC_SCALER_COREX_COPY_FINISH);
...
u32 is_scaler_handle_extended_intr(u32 status)
{
	...
	if (status & (1 << INTR_MC_SCALER_COREX_ERROR)) {
		err_hw("[MCSC]Corex Error!! (0x%x)", status);
		/* TODO: Corex Error recovery logic */
	}
	if (status & (1 << INTR_MC_SCALER_VOTF_WDMA_LOST_FLUSH)) {
		err_hw("[MCSC]VOTF Lost Flush for All WDMA!! (0x%x)", status);
		/* TODO: VOTF lost flush recovery logic */
	}
	if (status & (1 << INTR_MC_SCALER_VOTF_WDMA_SLOW_RING_STATUS)) {
		err_hw("[MCSC]VOTF Slow Ring for WDMA!! (0x%x)", status);
		/* TODO: VOTF slow ring recovery logic */
	}
