...
int rgbp_hw_s_rdma_init(struct is_hw_ip *hw_ip, struct is_common_dma *rdma,
...
int rgbp_hw_s_rdma_addr(struct is_common_dma *rdma, pdma_addr_t *addr, u32 plane, u32 num_buffers,
	int buf_idx, u32 comp_sbwc_en, u32 payload_size, u32 in_rgb);

void rgbp_hw_s_wdma_corex_id(struct is_common_dma *wdma, u32 set_id);
int rgbp_hw_s_wdma_init(struct is_hw_ip *hw_ip, struct is_common_dma *wdma,
...
int rgbp_hw_s_wdma_addr(struct is_common_dma *wdma, pdma_addr_t *addr, u32 plane, u32 num_buffers,
	int buf_idx, u32 comp_sbwc_en, u32 payload_size, u32 out_yuv);
