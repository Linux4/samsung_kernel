...
#include "sfr/is-sfr-cstat-v1_1.h"
#include "is-debug.h"
...
const static struct cstat_hw_dma cstat_dmas[CSTAT_DMA_NUM] = {
	...
	{CSTAT_W_VHIST,		CSTAT_R_STAT_WDMASVHIST_EN,	"W_SVHIST"},
	...
	{CSTAT_W_MEDS1,		CSTAT_REG_CNT,			"DMA_NONE"}, /* Not existing DMA */
...
void cstat_hw_s_crc_seed(void __iomem *base, u32 seed)
{
	...
	CSTAT_SET_F(base, CSTAT_R_RGB_SVHIST_CRC, CSTAT_F_RGB_SVHIST_CRC_SEED, seed);
