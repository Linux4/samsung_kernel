...
int lme_hw_s_reset(void __iomem *base)
{
	...
	while (1) {
		temp = LME_GET_R(base + GET_LME_COREX_OFFSET(COREX_DIRECT),
					LME_R_SW_RESET);
		if (temp == 0)
			break;
...
{
	info_hw("[LME] SFR DUMP (v3.0)\n");
	info_hw("[LME] set_id :%d\n", set_id);
	is_hw_dump_regs(base + GET_LME_COREX_OFFSET(set_id),
			lme_regs, LME_REG_CNT);
}
...
static void lme_hw_s_common(void __iomem *base, u32 set_id)
{
	...
	LME_SET_F(base + GET_LME_COREX_OFFSET(set_id),
		LME_R_IP_POST_FRAME_GAP, LME_F_IP_POST_FRAME_GAP, 0x0);
	LME_SET_F(base + GET_LME_COREX_OFFSET(set_id),
	...
	LME_SET_R(base + GET_LME_COREX_OFFSET(set_id),
		LME_R_DMA_SIPULME3P0P0_CNTX0_RD_SLOT_LEN_0, 0xb);
	LME_SET_R(base + GET_LME_COREX_OFFSET(set_id),
	LME_R_DMA_SIPULME3P0P0_CNTX0_WR_SLOT_LEN_0, 0x10);

	val = 0;
	val = LME_SET_V(val, LME_F_DMA_SIPULME3P0P0_CNTX0_SLOT_REG_RD_0_0, 1);
	val = LME_SET_V(val, LME_F_DMA_SIPULME3P0P0_CNTX0_SLOT_REG_RD_0_1, 0);
	val = LME_SET_V(val, LME_F_DMA_SIPULME3P0P0_CNTX0_SLOT_REG_RD_0_2, 0);
	val = LME_SET_V(val, LME_F_DMA_SIPULME3P0P0_CNTX0_SLOT_REG_RD_0_3, 0);
	val = LME_SET_V(val, LME_F_DMA_SIPULME3P0P0_CNTX0_SLOT_REG_RD_0_4, 0);
	val = LME_SET_V(val, LME_F_DMA_SIPULME3P0P0_CNTX0_SLOT_REG_RD_0_5, 0);
	LME_SET_R(base + GET_LME_COREX_OFFSET(set_id),
			LME_R_DMA_SIPULME3P0P0_CNTX0_SLOT_REG_RD_0_0, val);

	val = 0;
	val = LME_SET_V(val, LME_F_DMA_SIPULME3P0P0_CNTX0_SLOT_REG_WR_0_0, 0);
	val = LME_SET_V(val, LME_F_DMA_SIPULME3P0P0_CNTX0_SLOT_REG_WR_0_1, 1);
	val = LME_SET_V(val, LME_F_DMA_SIPULME3P0P0_CNTX0_SLOT_REG_WR_0_2, 0);
	val = LME_SET_V(val, LME_F_DMA_SIPULME3P0P0_CNTX0_SLOT_REG_WR_0_3, 1);
	val = LME_SET_V(val, LME_F_DMA_SIPULME3P0P0_CNTX0_SLOT_REG_WR_0_4, 0);
	val = LME_SET_V(val, LME_F_DMA_SIPULME3P0P0_CNTX0_SLOT_REG_WR_0_5, 1);
	LME_SET_R(base + GET_LME_COREX_OFFSET(set_id),
			LME_R_DMA_SIPULME3P0P0_CNTX0_SLOT_REG_WR_0_0, val);

	val = 0;
	val = LME_SET_V(val, LME_F_DMA_SIPULME3P0P0_CNTX0_SLOT_REG_WR_0_6, 0);
	val = LME_SET_V(val, LME_F_DMA_SIPULME3P0P0_CNTX0_SLOT_REG_WR_0_7, 1);
	val = LME_SET_V(val, LME_F_DMA_SIPULME3P0P0_CNTX0_SLOT_REG_WR_0_8, 0);
	val = LME_SET_V(val, LME_F_DMA_SIPULME3P0P0_CNTX0_SLOT_REG_WR_0_9, 1);
	val = LME_SET_V(val, LME_F_DMA_SIPULME3P0P0_CNTX0_SLOT_REG_WR_0_10, 0);
	val = LME_SET_V(val, LME_F_DMA_SIPULME3P0P0_CNTX0_SLOT_REG_WR_0_11, 1);
	LME_SET_R(base + GET_LME_COREX_OFFSET(set_id),
			 LME_R_DMA_SIPULME3P0P0_CNTX0_SLOT_REG_WR_0_1, val);

	val = 0;
	val = LME_SET_V(val, LME_F_DMA_SIPULME3P0P0_CNTX0_SLOT_REG_WR_0_12, 0);
	val = LME_SET_V(val, LME_F_DMA_SIPULME3P0P0_CNTX0_SLOT_REG_WR_0_13, 1);
	val = LME_SET_V(val, LME_F_DMA_SIPULME3P0P0_CNTX0_SLOT_REG_WR_0_14, 0);
	val = LME_SET_V(val, LME_F_DMA_SIPULME3P0P0_CNTX0_SLOT_REG_WR_0_15, 1);
	val = LME_SET_V(val, LME_F_DMA_SIPULME3P0P0_CNTX0_SLOT_REG_WR_0_16, 2);
	val = LME_SET_V(val, LME_F_DMA_SIPULME3P0P0_CNTX0_SLOT_REG_WR_0_17, 0);
	LME_SET_R(base + GET_LME_COREX_OFFSET(set_id),
			LME_R_DMA_SIPULME3P0P0_CNTX0_SLOT_REG_WR_0_2, val);


	LME_SET_F(base + GET_LME_COREX_OFFSET(set_id),
		LME_R_DMA_SIPULME3P0P0_CNTX0_WR_ADDR_FIFO_DEPTH_0,
		LME_F_DMA_SIPULME3P0P0_CNTX0_WR_ADDR_FIFO_DEPTH_0, 0x60);
	LME_SET_F(base + GET_LME_COREX_OFFSET(set_id),
		LME_R_DMA_SIPULME3P0P0_CNTX0_WR_DATA_FIFO_DEPTH_0,
		LME_F_DMA_SIPULME3P0P0_CNTX0_WR_DATA_FIFO_DEPTH_0, 0x60);
	LME_SET_F(base + GET_LME_COREX_OFFSET(set_id),
		LME_R_DMA_SIPULME3P0P0_CNTX0_WR_ADDR_MO_LIMIT_0,
		LME_F_DMA_SIPULME3P0P0_CNTX0_WR_ADDR_MO_LIMIT_0, 0x60);
}
...
static void lme_hw_s_block_crc(void __iomem *base, u32 set_id)
{
	...
	LME_SET_F(base + GET_LME_COREX_OFFSET(set_id),
		LME_R_AXICRC_SIPULME3P0P0_CNTX0_SEED_0,
			LME_F_AXICRC_SIPULME3P0P0_CNTX0_SEED_0, 0x37);
	LME_SET_F(base + GET_LME_COREX_OFFSET(set_id),
		LME_R_AXICRC_SIPULME3P0P0_CNTX0_SEED_1,
			LME_F_AXICRC_SIPULME3P0P0_CNTX0_SEED_1, 0x37);
}
	...
	u32 enable, u32 id, u32 set_id)
{
	...
	case LME_RDMA_CACHE_IN_0:
		...
		LME_SET_R(base + GET_LME_COREX_OFFSET(set_id),
			LME_R_DMACLIENT_CNTX0_CACHE_IN_DATA_FIFO_DEPTH, 251);
		LME_SET_R(base + GET_LME_COREX_OFFSET(set_id),
	...
	case LME_RDMA_MBMV_IN:
		...
		LME_SET_R(base + GET_LME_COREX_OFFSET(set_id),
			LME_R_DMACLIENT_CNTX0_MBMV_IN_OUTSTANDING_LIMIT, 0x2);
	...
	enum lme_sps_out_mode sps_mode)
{
	...
	case LME_WDMA_MV_OUT:
		...
		LME_SET_R(base + GET_LME_COREX_OFFSET(set_id),
			LME_R_DMACLIENT_CNTX0_SPS_MV_OUT_DATA_FIFO_DEPTH, 0x20);
	...
	case LME_WDMA_SAD_OUT:
		...
		LME_SET_R(base + GET_LME_COREX_OFFSET(set_id),
			LME_R_DMACLIENT_CNTX0_SAD_OUT_OUTSTANDING_LIMIT, 0x3);

		LME_SET_R(base + GET_LME_COREX_OFFSET(set_id),
			LME_R_DMACLIENT_CNTX0_SAD_OUT_DATA_FIFO_DEPTH, 0x20);
		LME_SET_R(base + GET_LME_COREX_OFFSET(set_id),
	...
	case LME_WDMA_MBMV_OUT:
		...
		LME_SET_R(base + GET_LME_COREX_OFFSET(set_id),
			LME_R_DMACLIENT_CNTX0_MBMV_OUT_OUTSTANDING_LIMIT, 0x3);
		LME_SET_R(base + GET_LME_COREX_OFFSET(set_id),
			LME_R_DMACLIENT_CNTX0_MBMV_OUT_DATA_FIFO_DEPTH, 0x20);
		LME_SET_R(base + GET_LME_COREX_OFFSET(set_id),
	...
	u32 *irq_state, u32 set_id)
{
	...
	if (clear)
		LME_SET_R(base + GET_LME_COREX_OFFSET(set_id),
			LME_R_CONTINT_SIPULME3P0P0_4SETS_INT1_CLEAR, src_all);
		 ...
		 u32 prev_height, u32 cur_width, u32 cur_height)
{
	...
	val = 0;
	val = LME_SET_V(val, LME_F_CACHE_8BIT_CROP_START_X_0,
			prev_crop_start_x);
	val = LME_SET_V(val, LME_F_CACHE_8BIT_CROP_START_Y_0,
			prev_crop_start_y);
	LME_SET_R(base + GET_LME_COREX_OFFSET(set_id),
...
void lme_hw_s_first_frame(void __iomem *base, u32 set_id, bool first_frame)
{
	...
	LME_SET_F(base + GET_LME_COREX_OFFSET(set_id),
		...
		LME_F_MVCT_8BIT_LME_FIRST_FRAME, first_frame);
...
void lme_hw_s_sps_out_mode(void __iomem *base, u32 set_id, enum lme_sps_out_mode outmode)
{
	LME_SET_F(base + GET_LME_COREX_OFFSET(set_id),
		LME_R_MVCT_8BIT_LME_CONFIG,
		LME_F_MVCT_8BIT_SPS_OUTPUT_MODE, outmode);
}
KUNIT_EXPORT_SYMBOL(lme_hw_s_sps_out_mode);

void lme_hw_s_crc(void __iomem *base, u32 seed)
{
	LME_SET_F(base, LME_R_AXICRC_SIPULME3P0P0_CNTX0_SEED_0,
			LME_F_AXICRC_SIPULME3P0P0_CNTX0_SEED_0, seed);
	LME_SET_F(base, LME_R_AXICRC_SIPULME3P0P0_CNTX0_SEED_1,
			LME_F_AXICRC_SIPULME3P0P0_CNTX0_SEED_1, seed);
}
