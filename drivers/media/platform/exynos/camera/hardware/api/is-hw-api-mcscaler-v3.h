...
#define MCSC_SET_F(base, R, F, val) \
	is_hw_set_field(base, &mcsc_regs[R], &mcsc_fields[F], val)
#define MCSC_SET_F_DIRECT(base, R, F, val) \
	is_hw_set_field(base, &mcsc_regs[R], &mcsc_fields[F], val)
#define MCSC_SET_R(base, R, val) \
	is_hw_set_reg(base, &mcsc_regs[R], val)
#define MCSC_SET_R_DIRECT(base, R, val) \
	is_hw_set_reg(base, &mcsc_regs[R], val)
#define MCSC_SET_V(reg_val, F, val) \
	is_hw_set_field_value(reg_val, &mcsc_fields[F], val)

#define MCSC_GET_F(base, R, F) \
	is_hw_get_field(base, &mcsc_regs[R], &mcsc_fields[F])
#define MCSC_GET_R(base, R) \
	is_hw_get_reg(base, &mcsc_regs[R])
#define MCSC_GET_R_COREX(base, R) \
	is_hw_get_reg(base, &mcsc_regs[R])
#define MCSC_GET_V(reg_val, F) \
	is_hw_get_field_value(reg_val, &mcsc_fields[F])
