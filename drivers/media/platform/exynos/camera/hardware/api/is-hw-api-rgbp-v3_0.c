...
static int rgbp_hw_rdma_create_mmio(struct is_common_dma *dma, void __iomem *base, u32 input_id)
{
	...
	case RGBP_RDMA_BYR:
		...
		break;
	case RGBP_RDMA_RGB_EVEN:
		base_reg = base + rgbp_regs[RGBP_R_RGB_RDMAREPRGBEVEN_EN].sfr_offset;
		...
		break;
	case RGBP_RDMA_RGB_ODD:
		base_reg = base + rgbp_regs[RGBP_R_RGB_RDMAREPRGBODD_EN].sfr_offset;
		/* is_rgbp_rgb_format: 0,1,2,3,4,5,6,8,9,10,11,12,13 */
		available_bayer_format_map = 0x3F3F;
