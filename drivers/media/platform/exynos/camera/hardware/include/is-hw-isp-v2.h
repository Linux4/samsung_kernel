...
enum is_hw_isp_buf_id {
	ISP_INTERNAL_BUF_IMG,
	ISP_INTERNAL_BUF_WGT,
	ISP_INTERNAL_BUF_MAX
};

static const char *isp_internal_buf_name[ISP_INTERNAL_BUF_MAX] = {
	"MCFP_IMG",
	"MCFP_WGT",
};
...
struct is_hw_isp {
	...
	struct pablo_internal_subdev	subdev[IS_STREAM_COUNT][ISP_INTERNAL_BUF_MAX];
};
