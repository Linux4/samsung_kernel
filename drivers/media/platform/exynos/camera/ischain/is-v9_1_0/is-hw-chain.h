...
#define IORESOURCE_ORBMCH0	10 /* TODO: add ORBMCH1 at EVT1 */
#define IORESOURCE_LME		11
#define IORESOURCE_ITP		12
#define IORESOURCE_MCFP0	13
#define IORESOURCE_MCFP1	14
#define IORESOURCE_DNS		15
#define IORESOURCE_YUVPP	16
#define IORESOURCE_MCSC		17
...
#define GROUP_LME_MAX_WIDTH	1664
#define GROUP_LME_MAX_HEIGHT	1248

/* RTA HEAP: 6MB */
#define IS_RESERVE_LIB_SIZE	(0x00600000)

/* ME/DRC DMA: 93518 kB = 91.32 MB */
/* DRC */
/* Size for 1 frame(byte) : 256x256(Grid size) * 4 = 262,144 */
/* Preview/Recording size(byte) : */
/* 262,144 * 32(# of frame) * 4(# of instance) = 33,554,432 */
/* Capture/Snapshot size : use preview/recording buffer */
/* DRC GAIN */
/* Size for 1 frame(byte) : (5760/4) x (4320/4) = 1,555,200 */
/* Preview/Recording size(byte) : */
/* 1555200 * 8(# of frame)* 4(# of instance) = 49,766,400 */
/* Capture/Snapshot size(byte) : */
/* 1555200 * 2(# of frame)* 4(# of instance) = 12,441,600 */
/* Total Size(byte) : 49,766,400 + 12,441,600 = 62,208,000 */
#define TAAISP_MEDRC_SIZE	(0x05B53800)

/* ORBMCH DMA: 40.17 MB */
/* ORB DS */
/* #1. Max Width : 2016 */
/* #2. Max Height : 1512 (※ L2 max size is equal with L1) */
/* #3. Path Bittage : 12b */
/* #4. Extract 2 image : L1: org x1 and L2: org x1/4, therefore 1+1/4 =5/4 */
/* #5. # of buffer for VOTF : 3 */
/* #6. DMA align : 16 */
/* #7. # of Orb Mch : 2 */
/* Size for 1 frame(byte) : (2016(#1) * 1512(#2) * 12/8(#3) * 5/4(#4) * 3(#5) + 16(#6)) * 2(#7) = 34,292,192 */
/* ORBMCH */
/* #1. Byte Per Clock : 16 */
/* #2. Max DB Size : 300 (The sum of database vectors and query vectors cannot exceed the 300) */
/* #3. # of region : 8(L1) + 1(L2) = 9 */
/* #4. OrbKpt / Frame : 43,200 = 16 * 300 * 9 (Keypoint is 16byte) */
/* #5. OrbDesc / Frame : 86,400 = 16 * 300 * 9 * 2 (Descripter is 32byte) */
/* #6. Stride : 32400 = 300(#2) * 3 * 4(ORBMCH_MODE_A==1) * 9 (L1:8 + L2:1) */
/* #7. # of operating frames : 8 */
/* Size for 1 frame(byte) : (43,200(#4) + 86,400(#5) + 32400(#6)) * 8(#7) * 2(#of ORBMCH) = 2,592,000 + 32(DMA align) = 2,592,032 */
#define TAAISP_ORBMCH_SIZE	(0x0232CF00)
...
/* CLAHE DMA: 8.4375MB :  */
/* 1. Width : ALIGN_UP(2048, 16) : 2048 */
/* ( per grid stat : 256 bins * SVHIST 64bit {9’d0, V(u23), 9’d0, S(u23)}) */
/* 2. Height : 144 (sv_hist_grid_x_max * sv_hist_grid_y_max = 12 * 12) */
/* Size for 1 frame(byte) : 294,912 */
/* Preview/Recording size(byte) : */
/* 294,912 * 8(# of frame) * 3(# of instance) =7,077,888 */
/* Capture/Snapshot size(byte) : */
/* 294,912 * 2(# of frame) * 3(# of instance) =1,769,472? */
/* Total Size(byte) : 7,077,888+ 1,769,472= 8,847,360 */
