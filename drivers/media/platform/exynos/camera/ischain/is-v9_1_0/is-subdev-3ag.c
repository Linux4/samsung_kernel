	...
	IS_DECLARE_PMAP(pmap))
{
	...
	u32 hw_sbwc = 0, hw_msb = MSB_OF_DNG_DMA_OUT; /* 9 */
	...
	if (hw_format == DMA_INOUT_FORMAT_BAYER_PACKED && flag_pixel_size == CAMERA_PIXEL_SIZE_13BIT) {
