...
enum dma_input_format {
	...
	DMA_INPUT_FORMAT_YUV422_COMP			= 13,
	DMA_INPUT_FORMAT_YUV422_COMP_LOSSY		= 14,
	DMA_INPUT_FORMAT_YUV422_PACKED			= 15,
	DMA_INPUT_FORMAT_YUV422_PACKED_COMP		= 16,
	DMA_INPUT_FORMAT_YUV422_PACKED_COMP_LOSSY	= 17,
};
...
enum dma_output_format {
	...
	DMA_OUTPUT_FORMAT_YUV422_COMP			= 13,
	DMA_OUTPUT_FORMAT_YUV422_COMP_LOSSY		= 14,
	DMA_OUTPUT_FORMAT_YUV422_PACKED			= 15,
	DMA_OUTPUT_FORMAT_YUV422_PACKED_COMP		= 16,
	DMA_OUTPUT_FORMAT_YUV422_PACKED_COMP_LOSSY	= 17,
};
...
struct taa_param {
	...
	struct param_dma_output		orbds_output;	/* ORBDS */
	struct param_dma_output		lmeds_output;	/* LMEDS */
