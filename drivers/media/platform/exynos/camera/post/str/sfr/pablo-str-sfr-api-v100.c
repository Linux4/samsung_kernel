...
void _str_sfr_top_apb_sw_rst(void __iomem *base_addr, enum str_ip ip)
{
	...
	is_hw_set_reg(base_addr, &str_top_regs[STR_R_STR_PU_APB_SW_RST_0], reg_val);
	is_hw_set_reg(base_addr, &str_top_regs[STR_R_STR_PU_APB_SW_RST_0], 0);
}
...
void _str_sfr_mux_sel(void __iomem *base_addr, enum str_mux_port src, enum str_mux_port dst)
{
	...
	reg_val = 0;
	reg_val = is_hw_set_field_value(reg_val, &str_mux_fields[field_id], dst);
	is_hw_set_reg(base_addr, &str_mux_regs[reg_id], reg_val);
}
...
{
	const struct is_reg *pos_reg;
	const struct is_reg *size_reg;
	const struct is_field *pos_x_field;
	const struct is_field *pos_y_field;
	const struct is_field *width_field;
	const struct is_field *height_field;
	u32 reg_val;
	...
	reg_val = 0;
	reg_val = is_hw_set_field_value(reg_val, pos_x_field, pos_x);
	reg_val = is_hw_set_field_value(reg_val, pos_y_field, pos_y);
	is_hw_set_reg(base_addr, pos_reg, reg_val);

	reg_val = 0;
	reg_val = is_hw_set_field_value(reg_val, width_field, width);
	reg_val = is_hw_set_field_value(reg_val, height_field, height);
	is_hw_set_reg(base_addr, size_reg, reg_val);
}

void _str_sfr_dma_set_tile_size(void __iomem *base_addr, enum str_mux_port dma_ch, u32 width, u32 height)
{
	const struct is_reg *reg;
	const struct is_field *width_field;
	const struct is_field *height_field;
	u32 reg_val;
	...
	reg_val = is_hw_set_field_value(reg_val, width_field, width);
	reg_val = is_hw_set_field_value(reg_val, height_field, height);
	is_hw_set_reg(base_addr, reg, reg_val);
}

void _str_sfr_dma_set_tile_num(void __iomem *base_addr, enum str_mux_port dma_ch, u32 num_x, u32 num_y)
{
	const struct is_reg *reg;
	const struct is_field *num_x_field;
	const struct is_field *num_y_field;
	u32 reg_val;
	...
	reg_val = 0;
	reg_val = is_hw_set_field_value(reg_val, num_x_field, num_x);
	reg_val = is_hw_set_field_value(reg_val, num_y_field, num_y);
	is_hw_set_reg(base_addr, reg, reg_val);
}
...
{
	const struct is_reg *reg;
	const struct is_field *left_field;
	const struct is_field *top_field;
	const struct is_field *right_field;
	const struct is_field *bottom_field;
	u32 reg_val;
	...
	reg_val = 0;
	reg_val = is_hw_set_field_value(reg_val, left_field, left);
	reg_val = is_hw_set_field_value(reg_val, top_field, top);
	reg_val = is_hw_set_field_value(reg_val, right_field, right);
	reg_val = is_hw_set_field_value(reg_val, bottom_field, bottom);
	is_hw_set_reg(base_addr, reg, reg_val);
}
		...
		bool asym, bool rand, bool manual)
{
	...
	const struct is_field *right_field;
	const struct is_field *bottom_field;
	const struct is_field *tile_h_field;
	const struct is_field *tile_v_field;
	const struct is_field *asym_field;
	const struct is_field *rand_field;
	const struct is_field *manual_field;
	u32 reg_val;
	...
	reg_val = is_hw_set_field_value(reg_val, right_field, right);
	reg_val = is_hw_set_field_value(reg_val, bottom_field, bottom);
	reg_val = is_hw_set_field_value(reg_val, tile_h_field, tile_h);
	reg_val = is_hw_set_field_value(reg_val, tile_v_field, tile_v);
	reg_val = is_hw_set_field_value(reg_val, asym_field, asym);
	reg_val = is_hw_set_field_value(reg_val, rand_field, rand);
	reg_val = is_hw_set_field_value(reg_val, manual_field, manual);
...
void _str_sfr_dma_set_addr(void __iomem *base_addr, enum str_mux_port dma_ch, u32 addr)
{
	...
	is_hw_set_reg(base_addr, reg, addr);
}

void _str_sfr_dma_set_stride(void __iomem *base_addr, enum str_mux_port dma_ch, u32 str, bool neg)
{
	const struct is_reg *reg;
	const struct is_field *str_field;
	const struct is_field *neg_field;
	u32 reg_val;
	...
	reg_val = 0;
	reg_val = is_hw_set_field_value(reg_val, str_field, str);
	reg_val = is_hw_set_field_value(reg_val, neg_field, neg);
	is_hw_set_reg(base_addr, reg, reg_val);
}
...
{
	const struct is_reg *reg;
	const struct is_field *bpp_field;
	const struct is_field *ppc_field;
	const struct is_field *rep_field;
	const struct is_field *val_field;
	const struct is_field *skip_field;
	u8 repeat = 0;
	u32 reg_val;
	...
	reg_val = 0;
	reg_val = is_hw_set_field_value(reg_val, bpp_field, bpp);
	reg_val = is_hw_set_field_value(reg_val, ppc_field, ppc);
	reg_val = is_hw_set_field_value(reg_val, rep_field, repeat);
	reg_val = is_hw_set_field_value(reg_val, val_field, line_valid);
	reg_val = is_hw_set_field_value(reg_val, skip_field, line_skip);
	is_hw_set_reg(base_addr, reg, reg_val);
}
...
{
	const struct is_reg *reg;
	const struct is_field *start_field;
	const struct is_field *size_field;
	const struct is_field *fake_field;
	u32 reg_val;
	...
	reg_val = 0;
	reg_val = is_hw_set_field_value(reg_val, start_field, fifo_start);
	reg_val = is_hw_set_field_value(reg_val, size_field, fifo_size);
	reg_val = is_hw_set_field_value(reg_val, fake_field, fake_run);
	is_hw_set_reg(base_addr, reg, reg_val);
}

u32 _str_sfr_top_pu_tile_done_intr_status(void __iomem *base_addr)
{
	return is_hw_get_reg(base_addr, &str_top_regs[STR_R_STR_INTR_STATUS_PU_TILE_0]);
}

u32 _str_sfr_top_pu_frame_done_intr_status(void __iomem *base_addr)
{
	return is_hw_get_reg(base_addr, &str_top_regs[STR_R_STR_INTR_STATUS_PU_FRAME_0]);
}

u32 _str_sfr_top_pu_err_done_intr_status(void __iomem *base_addr)
{
	return is_hw_get_reg(base_addr, &str_top_regs[STR_R_STR_INTR_STATUS_PU_ERROR_0]);
}

u32 _str_sfr_top_dma_tile_done_intr_status(void __iomem *base_addr)
{
	return is_hw_get_reg(base_addr, &str_top_regs[STR_R_STR_INTR_STATUS_DMA_TILE_0]);
}

u32 _str_sfr_top_dma_frame_done_intr_status(void __iomem *base_addr)
{
	return is_hw_get_reg(base_addr, &str_top_regs[STR_R_STR_INTR_STATUS_DMA_FRAME_0]);
}

u32 _str_sfr_top_dma_err_done_intr_status(void __iomem *base_addr)
{
	return is_hw_get_reg(base_addr, &str_top_regs[STR_R_STR_INTR_STATUS_DMA_ERROR_0]);
}

u32 _str_sfr_top_dxi_tile_done_intr_status(void __iomem *base_addr)
{
	return is_hw_get_reg(base_addr, &str_top_regs[STR_R_STR_INTR_STATUS_DXI_TILE_0]);
}

u32 _str_sfr_top_dxi_frame_done_intr_status(void __iomem *base_addr)
{
	return is_hw_get_reg(base_addr, &str_top_regs[STR_R_STR_INTR_STATUS_DXI_FRAME_0]);
}

void _str_sfr_top_pu_tile_done_intr_clear(void __iomem *base_addr, u32 reg_val)
{
	is_hw_set_reg(base_addr, &str_top_regs[STR_R_STR_INTR_CLEAR_PU_TILE_0], reg_val);
}

void _str_sfr_top_pu_frame_done_intr_clear(void __iomem *base_addr, u32 reg_val)
{
	is_hw_set_reg(base_addr, &str_top_regs[STR_R_STR_INTR_CLEAR_PU_FRAME_0], reg_val);
}

void _str_sfr_top_pu_err_done_intr_clear(void __iomem *base_addr, u32 reg_val)
{
	is_hw_set_reg(base_addr, &str_top_regs[STR_R_STR_INTR_CLEAR_PU_ERROR_0], reg_val);
}

void _str_sfr_top_dma_tile_done_intr_clear(void __iomem *base_addr, u32 reg_val)
{
	is_hw_set_reg(base_addr, &str_top_regs[STR_R_STR_INTR_CLEAR_DMA_TILE_0], reg_val);
}

void _str_sfr_top_dma_frame_done_intr_clear(void __iomem *base_addr, u32 reg_val)
{
	is_hw_set_reg(base_addr, &str_top_regs[STR_R_STR_INTR_CLEAR_DMA_FRAME_0], reg_val);
}

void _str_sfr_top_dma_err_done_intr_clear(void __iomem *base_addr, u32 reg_val)
{
	is_hw_set_reg(base_addr, &str_top_regs[STR_R_STR_INTR_CLEAR_DMA_ERROR_0], reg_val);
}

void _str_sfr_top_dxi_tile_done_intr_clear(void __iomem *base_addr, u32 reg_val)
{
	is_hw_set_reg(base_addr, &str_top_regs[STR_R_STR_INTR_CLEAR_DXI_TILE_0], reg_val);
}

void _str_sfr_top_dxi_frame_done_intr_clear(void __iomem *base_addr, u32 reg_val)
{
	is_hw_set_reg(base_addr, &str_top_regs[STR_R_STR_INTR_CLEAR_DXI_FRAME_0], reg_val);
}
...
{
	const struct is_reg *reg;
	const struct is_field *x_field;
	const struct is_field *y_field;
	u32 reg_val;
	...
	reg_val = 0;
	reg_val = is_hw_set_field_value(reg_val, x_field, num_x);
	reg_val = is_hw_set_field_value(reg_val, y_field, num_y);
	is_hw_set_reg(base_addr, reg, reg_val);
}
...
void _str_sfr_pu_set_tile_pos(void __iomem *base_addr, enum str_ip ip, u32 pos_x, u32 pos_y)
{
	...
	reg_val = 0;
	reg_val = is_hw_set_field_value(reg_val, x_field, pos_x);
	reg_val = is_hw_set_field_value(reg_val, y_field, pos_y);
	is_hw_set_reg(base_addr, reg, reg_val);
}
...
void _str_sfr_pu_set_face_num(void __iomem *base_addr, enum str_ip ip, u8 num)
{
	...
	reg_val = 0;
	reg_val = is_hw_set_field_value(reg_val, field, num);
	is_hw_set_reg(base_addr, reg, reg_val);
}
...
void _str_sfr_stra_set_ctrl(void __iomem *base_addr, bool rev_uv, u8 cam_type, u8 gyro)
{
	...
	reg_val = is_hw_set_field_value(reg_val, &str_stra_fields[STR_F_STRA_REVERSE_UV], rev_uv);
	reg_val = is_hw_set_field_value(reg_val, &str_stra_fields[STR_F_STRA_CAM_TYPE], cam_type);
	reg_val = is_hw_set_field_value(reg_val, &str_stra_fields[STR_F_STRA_GYRO], gyro);

	is_hw_set_reg(base_addr, &str_stra_regs[STR_R_STRA_CTRL], reg_val);
}
...
void _str_sfr_stra_set_ref_skin_num(void __iomem *base_addr, u8 num)
{
	...
	reg_val = is_hw_set_field_value(reg_val, &str_stra_fields[STR_F_STRA_NUM_REF_SKIN], num);
	is_hw_set_reg(base_addr, &str_stra_regs[STR_R_STRA_NUM_REF_SKIN], reg_val);
}

void _str_sfr_stra_set_ref_param_mean(void __iomem *base_addr, enum str_stra_ref_param_id id, u32 mean0, u32 mean1)
{
	const struct is_reg *reg;
	const struct is_field *mean0_field;
	const struct is_field *mean1_field;
	u32 reg_val;
	...
	reg_val = 0;
	reg_val = is_hw_set_field_value(reg_val, mean0_field, mean0);
	reg_val = is_hw_set_field_value(reg_val, mean1_field, mean1);
	is_hw_set_reg(base_addr, reg, reg_val);
}
...
{
	const struct is_reg *cov0_reg, *cov1_reg;
	const struct is_field *cov00_field;
	const struct is_field *cov01_field;
	const struct is_field *cov11_field;
	u32 reg_val;
	...
	reg_val = 0;
	reg_val = is_hw_set_field_value(reg_val, cov00_field, cov00);
	reg_val = is_hw_set_field_value(reg_val, cov01_field, cov01);
	is_hw_set_reg(base_addr, cov0_reg, reg_val);

	reg_val = 0;
	reg_val = is_hw_set_field_value(reg_val, cov11_field, cov11);
	is_hw_set_reg(base_addr, cov1_reg, reg_val);
}

void _str_sfr_stra_set_ref_param_weight(void __iomem *base_addr, enum str_stra_ref_param_id id, u8 weight)
{
	const struct is_reg *reg;
	const struct is_field *weight_field;
	u32 reg_val;
	...
	reg_val = 0;
	reg_val = is_hw_set_field_value(reg_val, weight_field, weight);
	is_hw_set_reg(base_addr, reg, reg_val);
}
...
void _str_sfr_stra_set_image_size(void __iomem *base_addr, u32 width, u32 height)
{
	...
	reg_val = is_hw_set_field_value(reg_val, &str_stra_fields[STR_F_STRA_IMAGE_SIZE_H], width);
	reg_val = is_hw_set_field_value(reg_val, &str_stra_fields[STR_F_STRA_IMAGE_SIZE_V], height);
	is_hw_set_reg(base_addr, &str_stra_regs[STR_R_STRA_IMAGE_SIZE], reg_val);
}
...
void _str_sfr_stra_set_dist_th(void __iomem *base_addr, u32 face_th, u32 no_face_th)
{
	...
	reg_val = is_hw_set_field_value(reg_val, &str_stra_fields[STR_F_STRA_FACE_TH], face_th);
	reg_val = is_hw_set_field_value(reg_val, &str_stra_fields[STR_F_STRA_NO_FACE_TH], no_face_th);
	is_hw_set_reg(base_addr, &str_stra_regs[STR_R_STRA_DIST_THRESHOLD], reg_val);
}
...
void _str_sfr_stra_set_skin_ratio(void __iomem *base_addr, u32 ratio)
{
	...
	reg_val = is_hw_set_field_value(reg_val, &str_stra_fields[STR_F_STRA_SKIN_RATIO], ratio);
	is_hw_set_reg(base_addr, &str_stra_regs[STR_R_STRA_SKIN_RATIO], reg_val);
}
		...
		bool is_preview, bool res_delta, bool is_second)
{
	...
	reg_val = is_hw_set_field_value(reg_val, &str_strb_fields[STR_F_STRB_REVERSE_UV], rev_uv);
	reg_val = is_hw_set_field_value(reg_val, &str_strb_fields[STR_F_STRB_CAM_TYPE], cam_type);
	reg_val = is_hw_set_field_value(reg_val, &str_strb_fields[STR_F_STRB_GYRO], gyro);
	reg_val = is_hw_set_field_value(reg_val, &str_strb_fields[STR_F_STRB_PARAM_IN_REG], use_reg);
	reg_val = is_hw_set_field_value(reg_val, &str_strb_fields[STR_F_STRB_PREVIEW], is_preview);
	reg_val = is_hw_set_field_value(reg_val, &str_strb_fields[STR_F_STRB_RES_DELARR], res_delta);
	reg_val = is_hw_set_field_value(reg_val, &str_strb_fields[STR_F_STRB_SECOND], is_second);

	is_hw_set_reg(base_addr, &str_strb_regs[STR_R_STRB_CTRL], reg_val);
}
...
void _str_sfr_strb_set_cov_scale(void __iomem *base_addr, u32 cov_scale)
{
	...
	reg_val = is_hw_set_field_value(reg_val, &str_strb_fields[STR_F_STRB_COVSCALE], cov_scale);
	is_hw_set_reg(base_addr, &str_strb_regs[STR_R_STRB_COVSCALE], reg_val);
}
		...
		u32 inv_mu_yse, u8 y_int, u8 mul_k)
{
	...
	reg_val = is_hw_set_field_value(reg_val, &str_strb_fields[STR_F_STRB_MU_YE], mu_ye);
	reg_val = is_hw_set_field_value(reg_val, &str_strb_fields[STR_F_STRB_MU_YS], mu_ys);
	is_hw_set_reg(base_addr, &str_strb_regs[STR_R_STRB_PARAM0], reg_val);

	reg_val = 0;
	reg_val = is_hw_set_field_value(reg_val, &str_strb_fields[STR_F_STRB_INV_MU_YSE], inv_mu_yse);
	reg_val = is_hw_set_field_value(reg_val, &str_strb_fields[STR_F_STRB_YINTERP_PARAM], y_int);
	is_hw_set_reg(base_addr, &str_strb_regs[STR_R_STRB_PARAM1], reg_val);

	reg_val = 0;
	is_hw_set_field_value(reg_val, &str_strb_fields[STR_F_STRB_MUL_K], mul_k);
	is_hw_set_reg(base_addr, &str_strb_regs[STR_R_STRB_PARAM2], reg_val);
}
...
void _str_sfr_strb_set_grp_num(void __iomem *base_addr, u8 num)
{
	...
	reg_val = is_hw_set_field_value(reg_val, &str_strb_fields[STR_F_STRB_NUM_GROUP], num);
	is_hw_set_reg(base_addr, &str_strb_regs[STR_R_STRB_NUM_GROUP], reg_val);
}

void _str_sfr_strb_set_grp_param_mean(void __iomem *base_addr, enum str_strb_grp_param_id id,
		u32 mu0, u32 mu1, u32 mu2)
{
	const struct is_reg *muc_reg, *muy_reg;
	const struct is_field *mu0_field;
	const struct is_field *mu1_field;
	const struct is_field *mu2_field;
	u32 reg_val;
	...
	reg_val = 0;
	reg_val = is_hw_set_field_value(reg_val, mu0_field, mu0);
	reg_val = is_hw_set_field_value(reg_val, mu1_field, mu1);
	is_hw_set_reg(base_addr, muc_reg, reg_val);

	reg_val = 0;
	reg_val = is_hw_set_field_value(reg_val, mu2_field, mu2);
	is_hw_set_reg(base_addr, muy_reg, reg_val);
}
...
{
	const struct is_reg *cov_a_reg, *cov_b_reg;
	const struct is_field *cov0_field;
	const struct is_field *cov1_field;
	const struct is_field *cov2_field;
	u32 reg_val;
	...
	reg_val = 0;
	reg_val = is_hw_set_field_value(reg_val, cov0_field, invcov0);
	reg_val = is_hw_set_field_value(reg_val, cov1_field, invcov1);
	is_hw_set_reg(base_addr, cov_a_reg, reg_val);

	reg_val = 0;
	reg_val = is_hw_set_field_value(reg_val, cov2_field, invcov2);
	is_hw_set_reg(base_addr, cov_b_reg, reg_val);
...
{
	const struct is_reg *reg;
	const struct is_field *col0_field;
	const struct is_field *col1_field;
	const struct is_field *col2_field;
	const struct is_field *col3_field;
	u32 reg_val;
	...
	reg_val = 0;
	reg_val = is_hw_set_field_value(reg_val, col0_field, col0);
	reg_val = is_hw_set_field_value(reg_val, col1_field, col1);
	reg_val = is_hw_set_field_value(reg_val, col2_field, col2);
	reg_val = is_hw_set_field_value(reg_val, col3_field, col3);
	is_hw_set_reg(base_addr, reg, reg_val);
}
...
void _str_sfr_strb_set_grp_param_del_y(void __iomem *base_addr, enum str_strb_grp_param_id id, u32 del_y)
{
	...
	reg_val = 0;
	reg_val = is_hw_set_field_value(reg_val, field, del_y);
	is_hw_set_reg(base_addr, reg, reg_val);
}
...
void _str_sfr_strc_set_ctrl(void __iomem *base_addr, bool rev_uv, u8 cam_type, u8 gyro, bool use_reg)
{
	...
	reg_val = is_hw_set_field_value(reg_val, &str_strc_fields[STR_F_STRC_REVERSE_UV], rev_uv);
	reg_val = is_hw_set_field_value(reg_val, &str_strc_fields[STR_F_STRC_CAM_TYPE], cam_type);
	reg_val = is_hw_set_field_value(reg_val, &str_strc_fields[STR_F_STRC_GYRO], gyro);
	reg_val = is_hw_set_field_value(reg_val, &str_strc_fields[STR_F_STRC_PARAM_IN_REG], use_reg);
	is_hw_set_reg(base_addr, &str_strc_regs[STR_R_STRC_CTRL], reg_val);
}
...
void _str_sfr_strc_set_clip_ratio(void __iomem *base_addr, u32 ratio, u32 inv_ratio)
{
	...
	reg_val = is_hw_set_field_value(reg_val, &str_strc_fields[STR_F_STRC_CLIP_RATIO], ratio);
	reg_val = is_hw_set_field_value(reg_val, &str_strc_fields[STR_F_STRC_INVS_CR], inv_ratio);
	is_hw_set_reg(base_addr, &str_strc_regs[STR_R_STRC_CLIP_RATIO], reg_val);
}
...
void _str_sfr_strc_set_mask_mul(void __iomem *base_addr, u32 mask_mul)
{
	...
	reg_val = is_hw_set_field_value(reg_val, &str_strc_fields[STR_F_STRC_MASK_MUL], mask_mul);
	is_hw_set_reg(base_addr, &str_strc_regs[STR_R_STRC_MASK_MUL], reg_val);
}
...
void _str_sfr_strc_set_invs(void __iomem *base_addr, u32 inv_x, u32 inv_y)
{
	...
	reg_val = is_hw_set_field_value(reg_val, &str_strc_fields[STR_F_STRC_INVS_X], inv_x);
	is_hw_set_reg(base_addr, &str_strc_regs[STR_R_STRC_INVS_X], reg_val);

	reg_val = 0;
	reg_val = is_hw_set_field_value(reg_val, &str_strc_fields[STR_F_STRC_INVS_Y], inv_y);
	is_hw_set_reg(base_addr, &str_strc_regs[STR_R_STRC_INVS_Y], reg_val);
}
...
void _str_sfr_strc_set_face(void __iomem *base_addr, u32 left, u32 top, u32 right, u32 bottom)
{
	...
	reg_val = is_hw_set_field_value(reg_val, &str_strc_fields[STR_F_STRC_FACE_LEFT], left);
	reg_val = is_hw_set_field_value(reg_val, &str_strc_fields[STR_F_STRC_FACE_RIGHT], right);
	is_hw_set_reg(base_addr, &str_strc_regs[STR_R_STRC_FACE_POS_H], reg_val);

	reg_val = 0;
	reg_val = is_hw_set_field_value(reg_val, &str_strc_fields[STR_F_STRC_FACE_TOP], top);
	reg_val = is_hw_set_field_value(reg_val, &str_strc_fields[STR_F_STRC_FACE_BOTTOM], bottom);
	is_hw_set_reg(base_addr, &str_strc_regs[STR_R_STRC_FACE_POS_V], reg_val);
...
void _str_sfr_strc_set_roi(void __iomem *base_addr, u32 left, u32 top, u32 right, u32 bottom)
{
	...
	reg_val = is_hw_set_field_value(reg_val, &str_strc_fields[STR_F_STRC_ROI_LEFT], left);
	reg_val = is_hw_set_field_value(reg_val, &str_strc_fields[STR_F_STRC_ROI_RIGHT], right);
	is_hw_set_reg(base_addr, &str_strc_regs[STR_R_STRC_FACE_POS_H], reg_val);

	reg_val = 0;
	reg_val = is_hw_set_field_value(reg_val, &str_strc_fields[STR_F_STRC_ROI_TOP], top);
	reg_val = is_hw_set_field_value(reg_val, &str_strc_fields[STR_F_STRC_ROI_BOTTOM], bottom);
	is_hw_set_reg(base_addr, &str_strc_regs[STR_R_STRC_FACE_POS_V], reg_val);
...
void _str_sfr_strd_set_ctrl(void __iomem *base_addr, bool enable_denoise)
{
	...
	is_hw_set_reg(base_addr, &str_strd_regs[STR_R_STRD_CTRL], reg_val);
}
...
void _str_sfr_strd_set_denoise_kern(void __iomem *base_addr, u8 kern_size, bool no_center_pix)
{
	...
	reg_val = is_hw_set_field_value(reg_val, &str_strd_fields[STR_F_STRD_KERNEL_SIZE], kern_size);
	reg_val = is_hw_set_field_value(reg_val, &str_strd_fields[STR_F_STRD_NO_CENTER_PIX], no_center_pix);
	is_hw_set_reg(base_addr, &str_strd_regs[STR_R_STRD_DENOISE_KERNEL], reg_val);
}
...
void _str_sfr_strd_set_denoise_muldiv(void __iomem *base_addr, u32 muldiv)
{
	...
	reg_val = is_hw_set_field_value(reg_val, &str_strd_fields[STR_F_STRD_DENOISE_MUDIV], muldiv);
	is_hw_set_reg(base_addr, &str_strd_regs[STR_R_STRD_DENOISE_MUDIV], reg_val);
}
...
void _str_sfr_strd_set_denoise_param0(void __iomem *base_addr, u32 non_edge, u32 denoise)
{
	...
	reg_val = is_hw_set_field_value(reg_val, &str_strd_fields[STR_F_STRD_NON_EDGE_IN_HI], non_edge);
	reg_val = is_hw_set_field_value(reg_val, &str_strd_fields[STR_F_STRD_DENOISE_HI], denoise);
	is_hw_set_reg(base_addr, &str_strd_regs[STR_R_STRD_DENOISE_PARAM0], reg_val);
}
...
void _str_sfr_strd_set_denoise_param1(void __iomem *base_addr, u32 blur, u32 inv_mul)
{
	...
	reg_val = is_hw_set_field_value(reg_val, &str_strd_fields[STR_F_STRD_BLUR_ALPHA], blur);
	reg_val = is_hw_set_field_value(reg_val, &str_strd_fields[STR_F_STRD_DENOISE_INVMULK], inv_mul);
	is_hw_set_reg(base_addr, &str_strd_regs[STR_R_STRD_DENOISE_PARAM1], reg_val);
}
...
void _str_sfr_dma_start(void __iomem *base_addr, enum str_mux_port port)
{
	...
	reg_val = 0;
	reg_val = is_hw_set_field_value(reg_val, field, 1);
	is_hw_set_reg(base_addr, reg, reg_val);
}
...
void _str_sfr_top_dma_drcg_diable(void __iomem *base_addr, bool disable)
{
	...
	is_hw_set_reg(base_addr, &str_top_regs[STR_R_STR_DMA_DRCG_DIS_0], reg_val);
}

void _str_sfr_dma_sbi_stop_request(void __iomem *base_addr, bool stop)
{
	is_hw_set_field(base_addr, &str_dma_cfg_regs[STR_R_RDMA0_SBI_CONFIG],
			&str_dma_cfg_fields[STR_F_RDMA0_SBI_STOP_REQ], stop);
	is_hw_set_field(base_addr, &str_dma_cfg_regs[STR_R_WDMA0_SBI_CONFIG],
			&str_dma_cfg_fields[STR_F_WDMA0_SBI_STOP_REQ], stop);
}

bool _str_sfr_rdma_get_sbi_stop_ack(void __iomem *base_addr)
{
	return is_hw_get_field(base_addr, &str_dma_cfg_regs[STR_R_RDMA0_SBI_STATUS],
			&str_dma_cfg_fields[STR_F_RDMA0_SBI_STOP_ACK]);
}

bool _str_sfr_wdma_get_sbi_stop_ack(void __iomem *base_addr)
{
	return is_hw_get_field(base_addr, &str_dma_cfg_regs[STR_R_WDMA0_SBI_STATUS],
...
void _str_sfr_sw_reset(void __iomem *base_addr, bool reset)
{
	...
	is_hw_set_reg(base_addr, &str_top_regs[STR_R_STR_PU_CORE_SW_RST_0], reg_val);
	is_hw_set_reg(base_addr, &str_top_regs[STR_R_STR_PU_APB_SW_RST_0], reg_val);
	is_hw_set_reg(base_addr, &str_top_regs[STR_R_STR_DMA_CORE_SW_RST_0], reg_val);
	is_hw_set_reg(base_addr, &str_top_regs[STR_R_STR_DMA_APB_SW_RST_0], reg_val);

	is_hw_set_field(base_addr, &str_cmdq_regs[STR_R_STR_CMDQ_RESET],
			&str_cmdq_fields[STR_F_STR_CMDQ_RESET], reg_val);
}

u32 str_sfr_get_reg_ver(void __iomem *base_addr)
{
	return is_hw_get_reg(base_addr, &str_top_regs[STR_R_STR_REG_VERSION]);
}

u32 str_sfr_get_str_ver(void __iomem *base_addr)
{
	return is_hw_get_reg(base_addr, &str_top_regs[STR_R_STR_SLSI_VERSION]);
}
...
void str_sfr_cmdq_set_mode(void __iomem *base_addr, bool enable)
{
	...
	is_hw_set_field(base_addr, &str_cmdq_regs[STR_R_STR_CMDQ_SET_MODE],
...
void str_sfr_cmdq_set_frm_marker(void __iomem *base_addr)
{
	...
	reg_val = is_hw_set_field_value(reg_val, &str_cmdq_fields[STR_F_STR_CMDQ_FRM_MARKER], 1);
	is_hw_set_reg(base_addr, &str_cmdq_regs[STR_R_STR_CMDQ_FRM_MARKER], reg_val);

	reg_val = is_hw_get_reg(base_addr, &str_cmdq_regs[STR_R_STR_CMDQ_FRM_MARKER]); 
...
void str_sfr_strb_rerun(void __iomem *base_addr)
{
	...
	reg_val = is_hw_set_field_value(reg_val, &str_strb_fields[STR_F_STRB_SECOND], 1);
	is_hw_set_reg(base_addr, &str_strb_regs[STR_R_STRB_CTRL], reg_val);
...
void str_sfr_cmdq_set_run_cnt(void __iomem *base_addr, u8 face_num)
{
	...
	is_hw_set_reg(base_addr, &str_cmdq_regs[STR_R_STR_CMDQ_RUN_CNT], reg_val);
}
...
void str_sfr_top_irq_enable(void __iomem *base_addr, u8 port_num, enum str_irq_src_id src)
{
	...
	reg_val = is_hw_get_reg(base_addr, reg);
	reg_val |= (1 << src);
...
void str_sfr_top_roi_evt_enable(void __iomem *base_addr, enum str_ip ip)
{
	...
	is_hw_set_reg(base_addr, &str_top_regs[STR_R_STR_CMDQ_ROI_EVT_EN], reg_val);
}

void str_sfr_top_pu_frame_done_intr_enable(void __iomem *base_addr, enum str_ip ip)
{
	u32 reg_val = is_hw_get_reg(base_addr, &str_top_regs[STR_R_STR_INTR_ENABLE_PU_FRAME_0]);
	...
	is_hw_set_reg(base_addr, &str_top_regs[STR_R_STR_INTR_ENABLE_PU_FRAME_0], reg_val);
}
...
u32 str_sfr_dma_get_err_status(void __iomem *base_addr, enum str_mux_port dma_ch)
{
	...
	return is_hw_get_reg(base_addr, reg);
}
...
{
	u32 reg_val = is_hw_get_reg(base_addr, &str_top_regs[STR_R_STR_INTR_ENABLE_PU_ERROR_0]);
	...
	is_hw_set_reg(base_addr, &str_top_regs[STR_R_STR_INTR_ENABLE_PU_ERROR_0], reg_val);
}
...
{
	u32 reg_val = is_hw_get_reg(base_addr, &str_top_regs[STR_R_STR_INTR_ENABLE_DMA_FRAME_0]);
	...
	is_hw_set_reg(base_addr, &str_top_regs[STR_R_STR_INTR_ENABLE_DMA_FRAME_0], reg_val);
}
...
{
	u32 reg_val = is_hw_get_reg(base_addr, &str_top_regs[STR_R_STR_INTR_ENABLE_DMA_ERROR_0]);
	...
	is_hw_set_reg(base_addr, &str_top_regs[STR_R_STR_INTR_ENABLE_DMA_ERROR_0], reg_val);
}
...
{
	u32 reg_val = is_hw_get_reg(base_addr, &str_top_regs[STR_R_STR_INTR_ENABLE_PU_TILE_0]);
	...
	is_hw_set_reg(base_addr, &str_top_regs[STR_R_STR_INTR_ENABLE_PU_TILE_0], reg_val);
}
...
{
	u32 reg_val = is_hw_get_reg(base_addr, &str_top_regs[STR_R_STR_INTR_ENABLE_DMA_TILE_0]);
	...
	is_hw_set_reg(base_addr, &str_top_regs[STR_R_STR_INTR_ENABLE_DMA_TILE_0], reg_val);
}
...
{
	u32 reg_val = is_hw_get_reg(base_addr, &str_top_regs[STR_R_STR_INTR_ENABLE_DXI_TILE_0]);
	...
	is_hw_set_reg(base_addr, &str_top_regs[STR_R_STR_INTR_ENABLE_DXI_TILE_0], reg_val);
}
...
{
	u32 reg_val = is_hw_get_reg(base_addr, &str_top_regs[STR_R_STR_INTR_ENABLE_DXI_FRAME_0]);
	...
	is_hw_set_reg(base_addr, &str_top_regs[STR_R_STR_INTR_ENABLE_DXI_FRAME_0], reg_val);
}
