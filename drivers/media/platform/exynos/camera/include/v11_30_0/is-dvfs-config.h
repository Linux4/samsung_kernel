...
enum IS_DVFS_SN {
	...
	IS_DVFS_SN_REAR_SINGLE_VIDEO_FHD60_HF,
	IS_DVFS_SN_REAR_SINGLE_VIDEO_FHD60_SUPERSTEADY,
	IS_DVFS_SN_REAR_SINGLE_VIDEO_FHD60_HF_SUPERSTEADY,
	...
	IS_DVFS_SN_REAR_SINGLE_VIDEO_FHD30_HF_SUPERSTEADY,
...
static struct is_dvfs_dt_t is_dvfs_dt_arr[IS_DVFS_SN_END] = {
	...
	/* rear sensor scenarios */
	{
		...
		.parse_scenario_nm	= "rear_single_video_fhd60_hf_",
		.scenario_id		= IS_DVFS_SN_REAR_SINGLE_VIDEO_FHD60_HF,
		.keep_frame_tick	= -1,
	}, {
		...
		.parse_scenario_nm	= "rear_single_video_fhd60_hf_supersteady_",
		.scenario_id		= IS_DVFS_SN_REAR_SINGLE_VIDEO_FHD60_HF_SUPERSTEADY,
		.keep_frame_tick	= -1,
	}, {
	...
	},
	{
		...
		.parse_scenario_nm	= "rear_single_video_fhd30_hf_supersteady_",
		.scenario_id		= IS_DVFS_SN_REAR_SINGLE_VIDEO_FHD30_HF_SUPERSTEADY,
		.keep_frame_tick	= -1,
	},
	/* wide and tele dual sensor scenarios */
	{
