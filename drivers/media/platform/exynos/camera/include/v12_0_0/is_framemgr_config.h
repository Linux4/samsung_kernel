...
struct is_frame {
	...
	u32 cstat_ctx;
	dma_addr_t dva_cstat_sat[CSTAT_CTX_NUM][IS_MAX_PLANES];		/* CSTAT SAT WDMA */
	dma_addr_t dva_cstat_cav[CSTAT_CTX_NUM][IS_MAX_PLANES];		/* CSTAT CAV WDMA */
	...
	dma_addr_t dva_rgbp_in_rgb[IS_MAX_PLANES];		/* RGBP RGB RDMA */
	dma_addr_t dva_byrp_hdr[IS_MAX_PLANES];			/* BYRP HDR0 RDMA */
	dma_addr_t dva_byrp_hdr1[IS_MAX_PLANES];		/* BYRP HDR1 RDMA */
	...
	dma_addr_t dva_byrp_rgby_hist[IS_MAX_PLANES];	/* BYRP WDMA RGBY hist */
	dma_addr_t dva_byrp_thstat_awb[IS_MAX_PLANES];	/* BYRP WDMA thstat awb */
	...
	u64 kva_dlfe_rta_info[IS_MAX_PLANES];
