...
#define IS_VIDEO_SHRP_NAME		IS_VIDEO_NAME("shrp")
#define LVN_VC_OFFSET			(IS_LVN_SS1_VC0 - IS_LVN_SS0_VC0)
#define GET_LVN_VC_OFFSET(vid)		(((vid) - IS_LVN_SS0_VC0) % LVN_VC_OFFSET)
...
enum is_video_dev_num {
	...
	IS_LVN_BYRP_HDR1,
	IS_LVN_BYRP_RGBY_HIST,
	IS_LVN_BYRP_THSTAT_AWB,
	IS_LVN_RGBP_HF = 450,
	IS_LVN_RGBP_SF,
	IS_LVN_RGBP_YUV,
	IS_LVN_RGBP_RGB,
...
static const char * const vn_name[IS_VIDEO_MAX_NUM + 1] = {
	...
	[IS_LVN_CSTAT0_SAT] = "V:CSTAT0_SAT",
	[IS_LVN_CSTAT0_CAV] = "V:CSTAT0_CAV",
	...
	[IS_LVN_CSTAT1_SAT] = "V:CSTAT1_SAT",
	[IS_LVN_CSTAT1_CAV] = "V:CSTAT1_CAV",
	...
	[IS_LVN_CSTAT2_SAT] = "V:CSTAT2_SAT",
	[IS_LVN_CSTAT2_CAV] = "V:CSTAT2_CAV",
	...
	[IS_LVN_CSTAT3_SAT] = "V:CSTAT3_SAT",
	[IS_LVN_CSTAT3_CAV] = "V:CSTAT3_CAV",

	[IS_LVN_BYRP_BYR] = "V:BYRP_BYR",
	[IS_LVN_BYRP_HDR] = "V:BYRP_HDR0",
	[IS_LVN_BYRP_HDR1] = "V:BYRP_HDR1",
	[IS_LVN_BYRP_RTA_INFO] = "V:BYRP_RTA_INFO",
	[IS_LVN_BYRP_BYR_PROCESSED] = "V:BYRP_BYR_PROCESSED",
	[IS_LVN_BYRP_RGBY_HIST] = "V:BYRP_RGBY_HIST",
	[IS_LVN_BYRP_THSTAT_AWB] = "V:BYRP_THSTAT_AWB",

	[IS_LVN_RGBP_HF] = "V:RGBP_HF",
	[IS_LVN_RGBP_SF] = "V:RGBP_SF",
	[IS_LVN_RGBP_YUV] = "V:RGBP_YUV",
	[IS_LVN_RGBP_RGB] = "V:RGBP_OT_RGB",
	[IS_LVN_RGBP_RTA_INFO] = "V:RGBP_RTA_INFO",
	[IS_LVN_RGBP_IN_RGB] = "V:RGBP_IN_RGB",
	...
	[IS_LVN_MCFP_CUR_W] = "V:MCFP_CUR_W",
	[IS_LVN_MCFP_MVMIXER] = "V:MCFP_MVMIXER",
