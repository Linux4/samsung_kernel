...
#define GROUP_ID_ORB0			(GROUP_ID_MAX + 1)
#define GROUP_ID_ORB1			(GROUP_ID_MAX + 2)
...
#define GROUP_SLOT_YPP		7
#define GROUP_SLOT_MAX		7
/* not used, just for compatibility */
#define GROUP_SLOT_ORB			(GROUP_SLOT_MAX + 1)
...
#define IS_SENSOR_GROUP(id)			false
