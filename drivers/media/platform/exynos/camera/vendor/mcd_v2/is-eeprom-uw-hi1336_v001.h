#ifndef IS_EEPROM_UW_HI1336_V001_H
#define IS_EEPROM_UW_HI1336_V001_H

/* Reference File
 * Universal EEPROM map data_V001_20190819_for_A71_NEUS_8K_(Hi1336_12M_UW).xlsx
 */
...
struct rom_ae_cal_data uw_hi1336_ae_cal_info = {
...
const struct rom_extend_cal_addr uw_hi1336_extend_cal_addr = {
	.name = EXTEND_AE_CAL,
	.data = &uw_hi1336_ae_cal_info,
	.next = NULL,
};

const struct is_vender_rom_addr uw_hi1336_cal_addr = {
	/* Set '-1' if not used */
	...
	.extend_cal_addr                           = &uw_hi1336_extend_cal_addr,
};

#endif /* IS_EEPROM_UW_HI1336_V001_H */
