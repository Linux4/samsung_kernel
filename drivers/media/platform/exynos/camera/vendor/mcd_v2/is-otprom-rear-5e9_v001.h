#ifndef IS_OTPROM_REAR_5E9_V001_H
#define IS_OTPROM_REAR_5E9_V001_H
...
const struct is_vender_rom_addr rear_5e9_otp_cal_addr = {
	/* Set '-1' if not used */
	...
	-1,				//int32_t		rom_dual_tilt_dll_model_id_addr;
	-1,				//int32_t		rom_dual_tilt_dll_model_id_size;
...
#endif /* IS_OTPROM_REAR_5E9_V001_H */
