#ifndef IS_VENDOR_CONFIG_MMV_V13_H
#define IS_VENDOR_CONFIG_MMV_V13_H
...
//#define REAR_MACRO_CAMERA          (SENSOR_POSITION_REAR4)    /* Supported Camera Type for rear macro */
...
#endif /* IS_VENDOR_CONFIG_MMV_V13_H */
