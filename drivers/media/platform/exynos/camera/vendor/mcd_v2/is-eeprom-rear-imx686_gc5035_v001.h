#ifndef IS_EEPROM_REAR_IMX686_GC5035_V002_H
#define IS_EEPROM_REAR_IMX686_GC5035_V002_H

/* Reference File
 * Universal EEPROM map data V001_20190923_for_A71_2019_NEUS_16K_EEPROM_(PDAF_IMX686_64M_GC5035_5M_Bokeh).xlsx
 */
...
struct rom_ae_cal_data rear_imx686_ae_cal_info = {
...
const struct rom_extend_cal_addr rear_imx686_extend_cal_addr = {
	.name = EXTEND_AE_CAL,
	.data = &rear_imx686_ae_cal_info,
	.next = NULL,
};

const struct is_vender_rom_addr rear_imx686_cal_addr = {
	/* Set '-1' if not used */
	...
	/*rear2_dualcal : wide-uw, rear3_dualcal : tele-wide */
	/* for sub */
	//.rom_dual_cal_data_start_addr              = 0x1A84,
	//.rom_dual_cal_data_size                    = (512),
	...
	.rom_dual_tilt_dll_model_id_addr           = 0x1C2C,
...
#ifdef DUAL_CAL2
	/* for UW */
	.rom_dual_cal_data2_start_addr             = 0x1EB4,
	.rom_dual_cal_data2_size                   = (512),
	.rom_dual_tilt_x_addr2                     = -1,
	.rom_dual_tilt_y_addr2                     = -1,
	.rom_dual_tilt_z_addr2                     = -1,
	.rom_dual_tilt_sx_addr2                    = -1,
	.rom_dual_tilt_sy_addr2                    = -1,
	.rom_dual_tilt_range_addr2                 = -1,
	.rom_dual_tilt_max_err_addr2               = -1,
	.rom_dual_tilt_avg_err_addr2               = -1,
	.rom_dual_tilt_dll_version_addr2           = -1,
	.rom_dual_tilt_dll_model_id_addr           = -1,
	.rom_dual_tilt_dll_model_id_size           = -1,
	.rom_dual_shift_x_addr2                    = -1,
	.rom_dual_shift_y_addr2                    = -1,
#endif
	.extend_cal_addr                           = &rear_imx686_extend_cal_addr,
};
