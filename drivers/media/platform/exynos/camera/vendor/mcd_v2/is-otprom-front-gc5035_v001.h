#ifndef IS_OTPROM_FRONT_GC5035_V001_H
#define IS_OTPROM_FRONT_GC5035_V001_H

/*
 * Reference File
 * 20200922_Xcover5_CAM1(Front_5M_GC5035B)_OTP_Front_Cal map V008.001.xlsx
 */
...
#define IS_FRONT_MAX_CAL_SIZE                   ((0xE2DF - 0x1020 + 0x1) / 8)
#define FRONT_HEADER_CHECKSUM_LEN               ((0x126F - 0x1020 + 0x1) / 8)

#define FRONT_STANDARD_CAL_CHECKSUM_LEN         ((0x177F - 0x1290 + 0x1) / 8)
#define FRONT_AWB_SEC2LSI_CHECKSUM_LEN          ((0x133F - 0x12E0 + 0x1) / 8)
#define FRONT_SHADING_SEC2LSI_CHECKSUM_LEN      ((0xE2BF - 0x1360 + 0x1) / 8)

struct rom_standard_cal_data front_gc5035_standard_cal_info = {
...
const struct rom_extend_cal_addr front_gc5035_extend_cal_addr = {
	.name = EXTEND_STANDARD_CAL,
	.data = &front_gc5035_standard_cal_info,
	.next = NULL,
};

const struct is_vender_rom_addr front_gc5035_otp_cal_addr = {
	/* Set '-1' if not used */
	...
	.extend_cal_addr                        = &front_gc5035_extend_cal_addr,
};
...
#endif /* IS_OTPROM_FRONT_GC5035_V001_H */
