...
#define DISABLE_DUAL_SYNC                                     /* Not Support DUAL SYNC between Main Sensor and Slave Sensor */
...
//#define USE_HIGH_RES_FLASH_FIRE_BEFORE_STREAM_ON            /* Remosaic Flash Capture */
