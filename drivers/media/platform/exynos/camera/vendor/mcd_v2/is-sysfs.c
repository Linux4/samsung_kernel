...
static ssize_t camera_rear2_phy_tune_show(struct device *dev,
		struct device_attribute *attr, char *buf)
{
	return camera_phy_tune_show(buf, (enum is_cam_info_index)CAMERA_REAR2);
}
...
static ssize_t camera_rear3_phy_tune_show(struct device *dev,
		struct device_attribute *attr, char *buf)
{
	return camera_phy_tune_show(buf, (enum is_cam_info_index)CAMERA_REAR3);
}
...
static ssize_t camera_rear4_phy_tune_show(struct device *dev,
		struct device_attribute *attr, char *buf)
{
	return camera_phy_tune_show(buf, (enum is_cam_info_index)CAMERA_REAR4);
}
