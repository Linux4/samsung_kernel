		...
		struct device_attribute *attr, char *buf)
{
	...
	if (specific->rom_data[SENSOR_POSITION_FRONT].rom_valid) {
		if (force_caldata_dump == false) {
			is_vender_check_hw_init_running();
			ret = is_sec_run_fw_sel(SENSOR_POSITION_FRONT);
			if (ret) {
				err("is_sec_run_fw_sel is fail(%d)", ret);
			}
		}
...
static ssize_t camera_rear2_info_show(struct device *dev,
		struct device_attribute *attr, char *buf)
{
	return camera_info_show(buf, (enum is_cam_info_index)CAMERA_REAR2);
}

static ssize_t camera_rear2_camfw_show(struct device *dev,
		struct device_attribute *attr, char *buf)
{
	return camera_camfw_show(buf, (enum is_cam_info_index)CAMERA_REAR2, false);
}

static ssize_t camera_rear2_camfw_full_show(struct device *dev,
		struct device_attribute *attr, char *buf)
{
	return camera_camfw_show(buf, (enum is_cam_info_index)CAMERA_REAR2, true);
}

static ssize_t camera_rear2_checkfw_user_show(struct device *dev,
		struct device_attribute *attr, char *buf)
{
	return camera_checkfw_user_show(buf, (enum is_cam_info_index)CAMERA_REAR2);
}

static ssize_t camera_rear2_checkfw_factory_show(struct device *dev,
		struct device_attribute *attr, char *buf)
{
	return camera_checkfw_factory_show(buf, (enum is_cam_info_index)CAMERA_REAR2);
}

static ssize_t camera_rear2_sensorid_exif_show(struct device *dev,
		struct device_attribute *attr, char *buf)
{
	return camera_sensorid_exif_show(buf, (enum is_cam_info_index)CAMERA_REAR2);
}

static ssize_t camera_rear2_mtf_exif_show(struct device *dev,
		struct device_attribute *attr, char *buf)
{
	return camera_mtf_exif_show(buf, (enum is_cam_info_index)CAMERA_REAR2);
}
...
static ssize_t camera_rear2_moduleid_show(struct device *dev,
		struct device_attribute *attr, char *buf)
{
	return camera_moduleid_show(buf, (enum is_cam_info_index)CAMERA_REAR2);
}
#endif
...
static ssize_t camera_rear2_afcal_show(struct device *dev,
		struct device_attribute *attr, char *buf)
{
	return camera_afcal_show(buf, (enum is_cam_info_index)CAMERA_REAR2);
}

static ssize_t camera_rear2_paf_cal_check_show(struct device *dev,
		struct device_attribute *attr, char *buf)
{
	return camera_paf_cal_check_show(buf, (enum is_cam_info_index)CAMERA_REAR2);
}
#endif
#endif
...
static ssize_t camera_rear3_info_show(struct device *dev,
		struct device_attribute *attr, char *buf)
{
	return camera_info_show(buf, (enum is_cam_info_index)CAMERA_REAR3);
}
		...
		struct device_attribute *attr, char *buf)
{
	...
	ret = is_get_sensor_data(sensor_maker, sensor_name, CAMERA_REAR3);
...
static ssize_t camera_rear3_camfw_show(struct device *dev,
		struct device_attribute *attr, char *buf)
{
	return camera_camfw_show(buf, (enum is_cam_info_index)CAMERA_REAR3, false);
}

static ssize_t camera_rear3_camfw_full_show(struct device *dev,
		struct device_attribute *attr, char *buf)
{
	return camera_camfw_show(buf, (enum is_cam_info_index)CAMERA_REAR3, true);
}

static ssize_t camera_rear3_checkfw_user_show(struct device *dev,
		struct device_attribute *attr, char *buf)
{
	return camera_checkfw_user_show(buf, (enum is_cam_info_index)CAMERA_REAR3);
}

static ssize_t camera_rear3_checkfw_factory_show(struct device *dev,
		struct device_attribute *attr, char *buf)
{
	return camera_checkfw_factory_show(buf, (enum is_cam_info_index)CAMERA_REAR3);
}

static ssize_t camera_rear3_sensorid_exif_show(struct device *dev,
		struct device_attribute *attr, char *buf)
{
	return camera_sensorid_exif_show(buf, (enum is_cam_info_index)CAMERA_REAR3);
}

static ssize_t camera_rear3_mtf_exif_show(struct device *dev,
		struct device_attribute *attr, char *buf)
{
	return camera_mtf_exif_show(buf, (enum is_cam_info_index)CAMERA_REAR3);
}
...
static ssize_t camera_rear3_moduleid_show(struct device *dev,
		struct device_attribute *attr, char *buf)
{
	return camera_moduleid_show(buf, (enum is_cam_info_index)CAMERA_REAR3);
}
#endif
...
static ssize_t camera_rear3_afcal_show(struct device *dev,
		struct device_attribute *attr, char *buf)
{
	return camera_afcal_show(buf, (enum is_cam_info_index)CAMERA_REAR3);
}

static ssize_t camera_rear3_paf_cal_check_show(struct device *dev,
		struct device_attribute *attr, char *buf)
{
	return camera_paf_cal_check_show(buf, (enum is_cam_info_index)CAMERA_REAR3);
}
#endif
...
static ssize_t camera_rear4_info_show(struct device *dev,
		struct device_attribute *attr, char *buf)
{
	return camera_info_show(buf, (enum is_cam_info_index)CAMERA_REAR4);
}

static ssize_t camera_rear4_camfw_show(struct device *dev,
		struct device_attribute *attr, char *buf)
{
	return camera_camfw_show(buf, (enum is_cam_info_index)CAMERA_REAR4, false);
}

static ssize_t camera_rear4_camfw_full_show(struct device *dev,
		struct device_attribute *attr, char *buf)
{
	return camera_camfw_show(buf, (enum is_cam_info_index)CAMERA_REAR4, true);
}

static ssize_t camera_rear4_checkfw_user_show(struct device *dev,
		struct device_attribute *attr, char *buf)
{
	return camera_checkfw_user_show(buf, (enum is_cam_info_index)CAMERA_REAR4);
}

static ssize_t camera_rear4_checkfw_factory_show(struct device *dev,
		struct device_attribute *attr, char *buf)
{
	return camera_checkfw_factory_show(buf, (enum is_cam_info_index)CAMERA_REAR4);
}

static ssize_t camera_rear4_sensorid_exif_show(struct device *dev,
		struct device_attribute *attr, char *buf)
{
	return camera_sensorid_exif_show(buf, (enum is_cam_info_index)CAMERA_REAR4);
}

static ssize_t camera_rear4_mtf_exif_show(struct device *dev,
		struct device_attribute *attr, char *buf)
{
	return camera_mtf_exif_show(buf, (enum is_cam_info_index)CAMERA_REAR4);
}
...
static ssize_t camera_rear4_moduleid_show(struct device *dev,
		struct device_attribute *attr, char *buf)
{
	return camera_moduleid_show(buf, (enum is_cam_info_index)CAMERA_REAR4);
}
#endif
...
static ssize_t camera_rear4_afcal_show(struct device *dev,
		struct device_attribute *attr, char *buf)
{
	return camera_afcal_show(buf, (enum is_cam_info_index)CAMERA_REAR4);
}

static ssize_t camera_rear4_paf_cal_check_show(struct device *dev,
		struct device_attribute *attr, char *buf)
{
	return camera_paf_cal_check_show(buf, (enum is_cam_info_index)CAMERA_REAR4);
}
#endif
#endif
...
static ssize_t camera_cam_cdr_fastaec_store(struct device *dev,
		struct device_attribute *attr, const char *buf, size_t count)
{
	/* ToDo */
	return count;
...
static ssize_t camera_cam_cdr_value_store(struct device *dev,
		struct device_attribute *attr, const char *buf, size_t count)
{
	/* ToDo */
	return count;
...
static ssize_t camera_cam_cdr_result_show(struct device *dev,
		struct device_attribute *attr, char *buf)
{
	int err_type;
	u64 timestamp;
	...
	err_type = g_cdr.err_type;
	timestamp = g_cdr.time - g_cdr.stream_on_time;
	if (g_cdr.stream_on_time > g_cdr.time)
		err("cdr error detected before stream on (err time: %llu, stream on time : %llu",
			g_cdr.time, g_cdr.stream_on_time);
		...
		struct device_attribute *attr, char *buf)
{
	...
	if (force_caldata_dump == false) {
		is_vender_check_hw_init_running();
		ret = is_sec_run_fw_sel(SENSOR_POSITION_REAR);
		if (ret) {
			err("is_sec_run_fw_sel is fail(%d)", ret);
		}
	}
		...
		struct device_attribute *attr, char *buf)
{
	...
	is_get_cam_info_from_index(&cam_info, (enum is_cam_info_index)CAMERA_REAR2);
	position = cam_info->internal_id;
		...
		struct device_attribute *attr, char *buf)
{
	...
	is_get_cam_info_from_index(&cam_info, (enum is_cam_info_index)CAMERA_REAR3);
	position = cam_info->internal_id;
		...
		struct device_attribute *attr, char *buf)
{
	...
	is_get_cam_info_from_index(&cam_info, (enum is_cam_info_index)CAMERA_REAR4);
	position = cam_info->internal_id;
...
static DEVICE_ATTR(cam_cdr_fastaec, S_IWUSR, NULL, camera_cam_cdr_fastaec_store);
static DEVICE_ATTR(cam_cdr_value, S_IWUSR, NULL, camera_cam_cdr_value_store);
static DEVICE_ATTR(cam_cdr_result, S_IRUGO, camera_cam_cdr_result_show, NULL);
...
static struct attribute *is_sysfs_attr_entries_rear[] = {
	...
	&dev_attr_cam_cdr_fastaec.attr,
	&dev_attr_cam_cdr_value.attr,
	&dev_attr_cam_cdr_result.attr,
	NULL,
};
