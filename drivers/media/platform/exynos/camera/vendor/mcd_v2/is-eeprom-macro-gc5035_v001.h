#ifndef IS_EEPROM_MACRO_GC5035_V001_H
#define IS_EEPROM_MACRO_GC5035_V001_H

/* Reference File
 * Universal EEPROM map data_V001_20190819_for_A71_NEUS_8K_(GC5035_5M_Macro).xlsx
 */
...
struct rom_ae_cal_data macro_gc5035_ae_cal_info = {
...
const struct rom_extend_cal_addr macro_gc5035_extend_cal_addr = {
	.name = EXTEND_AE_CAL,
	.data = &macro_gc5035_ae_cal_info,
	.next = NULL,
};

const struct is_vender_rom_addr macro_gc5035_cal_addr = {
	/* Set '-1' if not used */
	...
	.extend_cal_addr                           = &macro_gc5035_extend_cal_addr,
};

#endif /* IS_EEPROM_MACRO_GC5035_V001_H */
