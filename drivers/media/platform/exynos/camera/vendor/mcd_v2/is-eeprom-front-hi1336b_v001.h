#ifndef IS_EEPROM_FRONT_HI1336B_V001_H
#define IS_EEPROM_FRONT_HI1336B_V001_H

/* Reference File
 * Universal EEPROM map data V001_20191206_for_A21s_Nacho+_8K_(Hi1336_13M_Front).xlsx
 */
...
#define FRONT_SHADING_CHECKSUM_LEN    (0x1C4F - 0x0260 + 0x1)

const struct is_vender_rom_addr front_hi1336b_cal_addr = {
	/* Set '-1' if not used */
...
#endif /* IS_EEPROM_FRONT_HI1336B_V001_H */
