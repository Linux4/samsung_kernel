#ifndef IS_VENDER_ROM_CONFIG_HTV_V00_H
#define IS_VENDER_ROM_CONFIG_HTV_V00_H

#include "is-otprom-front-gc5035_v001.h"
#include "is-eeprom-rear-imx355_v001.h"

const struct is_vender_rom_addr *vender_rom_addr[SENSOR_POSITION_MAX] = {
	&rear_imx355_cal_addr,	//[0] SENSOR_POSITION_REAR
...
#endif /*IS_VENDER_ROM_CONFIG_HTV_V00_H*/
