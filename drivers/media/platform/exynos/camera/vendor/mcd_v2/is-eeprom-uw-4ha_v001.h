#ifndef IS_EEPROM_UW_4HA_V001_H
#define IS_EEPROM_UW_4HA_V001_H

/* Reference File
 * Universal EEPROM map data V001_20191210_for_A21s_Nacho_8K_(4HA_8M_UW).xlsx
 */

#define IS_REAR3_MAX_CAL_SIZE (8 * 1024)
...
const struct is_vender_rom_addr uw_4ha_cal_addr = {
	/* Set '-1' if not used */
