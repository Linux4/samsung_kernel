#ifndef IS_VENDOR_CONFIG_BEYOND2_H
#define IS_VENDOR_CONFIG_BEYOND2_H
...
#define CAMERA_FRONT2
#define CAMERA_FRONT2_TILT
#define CAMERA_FRONT2_USE_DEFAULT_AWB_CAL
...
#endif /* IS_VENDOR_CONFIG_BEYOND2_H */
