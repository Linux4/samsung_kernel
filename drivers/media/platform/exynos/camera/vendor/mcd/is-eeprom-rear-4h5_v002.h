#ifndef IS_EEPROM_REAR_4H5_V002_H
#define IS_EEPROM_REAR_4H5_V002_H
...
/* etc section */
#define IS_MAX_CAL_SIZE                (8 * 1024)
#define IS_MAX_FW_SIZE                 (8 * 1024)
#define IS_MAX_SETFILE_SIZE            (1120 * 1024)
#define HEADER_CRC32_LEN                    (80)

#endif /* IS_EEPROM_REAR_4H5_V002_H */
