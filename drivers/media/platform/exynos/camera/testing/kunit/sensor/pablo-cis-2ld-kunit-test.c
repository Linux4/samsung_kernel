...
static void pablo_sensor_2ld_cis_wait_seamless_update_delay_kunit_test(struct kunit *test)
{
	int ret;
...
static struct kunit_case pablo_cis_2ld_kunit_test_cases[] = {
	...
	KUNIT_CASE(pablo_sensor_2ld_cis_wait_seamless_update_delay_kunit_test),
	{},
};
