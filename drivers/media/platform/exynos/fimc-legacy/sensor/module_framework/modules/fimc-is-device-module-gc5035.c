	...
	struct exynos_platform_fimc_is_module *pdata)
{
	...
	if (gpio_is_valid(gpio_cam_core_en)) {
		...
		SET_PIN(pdata, SENSOR_SCENARIO_NORMAL, GPIO_SCENARIO_ON, gpio_none, "VDDIOR1_1.8V_CAM", PIN_REGULATOR, 1, 200); //ldo3
	}
	...
	if (gpio_is_valid(gpio_cam_core_en)) {
		...
		SET_PIN(pdata, SENSOR_SCENARIO_NORMAL, GPIO_SCENARIO_OFF, gpio_none, "VDDIOR1_1.8V_CAM", PIN_REGULATOR, 0, 50);
	}
