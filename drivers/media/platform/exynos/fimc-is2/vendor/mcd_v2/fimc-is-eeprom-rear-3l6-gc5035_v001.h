...
#define REAR_3L6_GC5035_V001_HEADER_CHECKSUM_LEN (0xDF - 0x00 + 0x1) 
...
#define REAR_3L6_GC5035_V001_SHADING_CHECKSUM_LEN (0x15BF - 0x0240 + 0x1)
#define REAR_3L6_GC5035_V001_PDAF_CHECKSUM_LEN (0x1B7F - 0x15E0 + 0x1)
#define REAR_3L6_GC5035_V001_DUAL_CHECKSUM_LEN (0x1FFF - 0x1BA0 + 0x1)
...
const struct fimc_is_vender_rom_addr rear_3l6_gc5035_cal_addr = {
	...
	0x5C,				//int32_t		rom_header_sub_mtf_data_addr;
	...
	0x15C0,			//int32_t		rom_shading_module_info_start_addr;
	0x15DC,			//int32_t		rom_shading_checksum_addr;
	...
	0x2000,			//int32_t		rom_dual_module_info_start_addr;
	0x201C,			//int32_t		rom_dual_checksum_addr;
	REAR_3L6_GC5035_V001_DUAL_CHECKSUM_LEN,			//int32_t		rom_dual_checksum_len;

	0x1B80,				//int32_t		rom_pdaf_module_info_start_addr;
	0x1B9C,				//int32_t		rom_pdaf_checksum_addr;
