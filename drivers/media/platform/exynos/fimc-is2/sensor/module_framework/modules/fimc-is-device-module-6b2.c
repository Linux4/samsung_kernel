...
static struct fimc_is_sensor_cfg config_module_6b2[] = {
	/* 5968x3368@30fps */
	FIMC_IS_SENSOR_CFG(1936, 1090, 30, 19, 0),
	/* for FPGA, actual FPS is 1fps */
	FIMC_IS_SENSOR_CFG(656, 490, 30, 12, 1),
};
	...
	struct exynos_platform_fimc_is_module *pdata)
{
	...
	SET_PIN(pdata, SENSOR_SCENARIO_NORMAL, GPIO_SCENARIO_ON, gpio_reset, "sen_rst high", PIN_OUTPUT, 1, 47);
	...
	SET_PIN(pdata, SENSOR_SCENARIO_VISION, GPIO_SCENARIO_ON, gpio_none, "VDDIO_1.8V_CAM", PIN_REGULATOR, 1, 1000);
	SET_PIN(pdata, SENSOR_SCENARIO_VISION, GPIO_SCENARIO_ON, gpio_standby, "stby high", PIN_OUTPUT, 1, 28);
	...
	SET_PIN(pdata, SENSOR_SCENARIO_VISION, GPIO_SCENARIO_OFF, gpio_standby, "stby low", PIN_OUTPUT, 0, 0);
