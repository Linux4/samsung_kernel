...
static struct fimc_is_sensor_cfg config_module_4h5yc[] = {
	...
	/* 3280x2458@24fps */
	FIMC_IS_SENSOR_CFG(3280, 2458, 24, 14, 1),
	/* 3280x1846@30fps */
	FIMC_IS_SENSOR_CFG(3280, 1846, 30, 14, 2),
	/* 3280x1846@24fps */
	FIMC_IS_SENSOR_CFG(3280, 1846, 24, 14, 3),
	/* 816x604_115fps */
	FIMC_IS_SENSOR_CFG(816, 604, 120, 14, 4),
	/* 816x460_120fps */
	FIMC_IS_SENSOR_CFG(816, 460, 120, 14, 5),
};
	...
	struct exynos_platform_fimc_is_module *pdata)
{
	...
	/* Normal off */
	SET_PIN(pdata, SENSOR_SCENARIO_NORMAL, GPIO_SCENARIO_OFF, gpio_none, "VDDAF_2.8V_CAM", PIN_REGULATOR, 0, 90);
	...
	/* Vision on */
	SET_PIN(pdata, SENSOR_SCENARIO_VISION, GPIO_SCENARIO_ON, gpio_reset, "sen_rst low", PIN_OUTPUT, 0, 2000);
#ifdef CONFIG_MACH_UNIVERSAL3475
	...
	SET_PIN(pdata, SENSOR_SCENARIO_VISION, GPIO_SCENARIO_ON, gpio_none, "VDDIO_1.8V_CAM", PIN_REGULATOR, 1, 2000);
	SET_PIN(pdata, SENSOR_SCENARIO_VISION, GPIO_SCENARIO_ON, gpio_none, "pin", PIN_FUNCTION, 0, 50);
	SET_PIN(pdata, SENSOR_SCENARIO_VISION, GPIO_SCENARIO_ON, gpio_reset, "sen_rst high", PIN_OUTPUT, 1, 1320);

	/* Vision off */
	SET_PIN(pdata, SENSOR_SCENARIO_VISION, GPIO_SCENARIO_OFF, gpio_none, "VDDAF_2.8V_CAM", PIN_REGULATOR, 0, 90);
...
#endif
	SET_PIN(pdata, SENSOR_SCENARIO_READ_ROM, GPIO_SCENARIO_ON, gpio_none, "VDDIO_1.8V_CAM", PIN_REGULATOR, 1, 5000);
