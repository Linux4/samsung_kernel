...
static struct fimc_is_sensor_cfg config_module_3p8[] = {
	/* 4640x3488@30fps */
	FIMC_IS_SENSOR_CFG(4640, 3488, 30, 32, 0, CSI_DATA_LANES_4),
	/* 2320x1744@60fps */
	FIMC_IS_SENSOR_CFG(2320, 1744, 60, 32, 1, CSI_DATA_LANES_4),
	/* 1536x1160@90fps */
	FIMC_IS_SENSOR_CFG(1536, 1160, 90, 32, 2, CSI_DATA_LANES_4),
	/* 1152x872@120fps */
	FIMC_IS_SENSOR_CFG(1152, 872, 120, 32, 3, CSI_DATA_LANES_4),
	/* 4624x3466@30fps */
	FIMC_IS_SENSOR_CFG(4624, 3466, 30, 32, 4, CSI_DATA_LANES_4),
	/* 4624x2602@30fps */
	FIMC_IS_SENSOR_CFG(4624, 2602, 30, 32, 5, CSI_DATA_LANES_4),
	/* 1152x648@120fps */
	FIMC_IS_SENSOR_CFG(1152, 648, 120, 32, 6, CSI_DATA_LANES_4),
};
	...
	struct exynos_platform_fimc_is_module *pdata)
{
	...
	int gpio_mclk = 0;
	int gpio_none = 0;
#if defined (VDD_CAM_CORE_GPIO_CONTROL)
	int gpio_cam_core_en = 0;
#endif
#if defined (VDD_CAM_AF_GPIO_CONTROL)
	int gpio_camaf_2p8_en = 0;
#endif
#if defined (VDD_CAM_IO_GPIO_CONTROL)
...
int sensor_module_3p8_probe(struct platform_device *pdev)
{
	...
	fimc_is_sensor_module_parse_dt(pdev, sensor_module_3p8_power_setpin);
