...
static struct fimc_is_sensor_cfg config_module_sr556[] = {
	/* 2592x1944@30fps */
	FIMC_IS_SENSOR_CFG(2592, 1944, 30, 22, 0, CSI_DATA_LANES_2),
	/* 2560x1440@30fps */
	FIMC_IS_SENSOR_CFG(2560, 1440, 30, 22, 1, CSI_DATA_LANES_2),
	/* 1296x972@30fps */
	FIMC_IS_SENSOR_CFG(1296, 972, 30, 22, 2, CSI_DATA_LANES_2),
	/* 1296x972@15fps */
	FIMC_IS_SENSOR_CFG(1296, 972, 15, 22, 3, CSI_DATA_LANES_2),
	/* 1296x972@7fps */
	FIMC_IS_SENSOR_CFG(1296, 972, 7, 22, 4, CSI_DATA_LANES_2),
	/* 648x486@120fps */
	FIMC_IS_SENSOR_CFG(648, 484, 118, 6, 5, CSI_DATA_LANES_2),
};
...
static int sensor_module_sr556_power_setpin(struct platform_device *pdev,
...
int sensor_module_sr556_probe(struct platform_device *pdev)
{
	...
	fimc_is_sensor_module_parse_dt(pdev, sensor_module_sr556_power_setpin);
