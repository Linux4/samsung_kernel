...
static struct fimc_is_sensor_cfg config_module_2x5[] = {
	...
	/* 0: 2880x2156@30fps */
	FIMC_IS_SENSOR_CFG_EXT(2880, 2156,  30, 53, 0, CSI_DATA_LANES_4, 2392, 0, 0, 0),
	/* 1: 2880x1620@30fps */
	FIMC_IS_SENSOR_CFG_EXT(2880, 1620,  30, 53, 1, CSI_DATA_LANES_4, 2392, 0, 0, 0),
	/* 2: 2880x1332@30fps */
	FIMC_IS_SENSOR_CFG_EXT(2880, 1332,  30, 53, 2, CSI_DATA_LANES_4, 2392, 0, 0, 0),
	/* 3: 2156x2156@30fps */
	FIMC_IS_SENSOR_CFG_EXT(2156, 2156,  30, 53, 3, CSI_DATA_LANES_4, 2392, 0, 0, 0),
	/* 4: 2880x2156@120fps FAST AE*/
	FIMC_IS_SENSOR_CFG_EXT(2880, 2156, 120, 53, 4, CSI_DATA_LANES_4, 2392, 0, 0, 0),
	/* 5: 5760x4312@30fps */
	FIMC_IS_SENSOR_CFG_EXT(5760, 4312, 30, 53, 5, CSI_DATA_LANES_4, 2392, 0, 0, 0),
	/* 6: 5760x3240@30fps */
	FIMC_IS_SENSOR_CFG_EXT(5760,  3240, 30, 53, 6, CSI_DATA_LANES_4, 2392, 0, 0, 0),
	/* 7: 5760x2664@30fps */
	FIMC_IS_SENSOR_CFG_EXT(5760, 2664,  30, 53, 7, CSI_DATA_LANES_4, 2392, 0, 0, 0),
	/* 8: 4312x4312@30fps */
	FIMC_IS_SENSOR_CFG_EXT(4312, 4312,  30, 53, 8, CSI_DATA_LANES_4, 2392, 0, 0, 0),
};
