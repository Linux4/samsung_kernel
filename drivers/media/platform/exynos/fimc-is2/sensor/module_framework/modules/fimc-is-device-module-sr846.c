...
static struct fimc_is_sensor_cfg config_module_sr846[] = {
	...
	/* 1640x924@30fps */
	FIMC_IS_SENSOR_CFG(1640, 924, 30, 18, 4, CSI_DATA_LANES_2),
	/* 1640x924@15fps */
	FIMC_IS_SENSOR_CFG(1640, 924, 15, 18, 5, CSI_DATA_LANES_2),
	/* 1640x924@7fps */
	FIMC_IS_SENSOR_CFG(1640, 924, 7, 18, 6, CSI_DATA_LANES_2),
	/* 816x604@120fps */
	FIMC_IS_SENSOR_CFG(816, 604, 120, 10, 7, CSI_DATA_LANES_2),
	/* 816x460@120fps */
	FIMC_IS_SENSOR_CFG(816, 460, 120, 10, 8, CSI_DATA_LANES_2),	
};
