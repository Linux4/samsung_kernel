...
static struct fimc_is_sensor_cfg config_module_sr846[] = {
	/* 3280x2458@30fps */
	FIMC_IS_SENSOR_CFG(3280, 2458, 30, 34, 0, CSI_DATA_LANES_2),
	/* 3280x1846@30fps */
	FIMC_IS_SENSOR_CFG(3280, 1846, 30, 34, 1, CSI_DATA_LANES_2),
	/* 1640x1228@30fps */
	FIMC_IS_SENSOR_CFG(1640, 1228, 30, 18, 2, CSI_DATA_LANES_2),
	/* 1640x1228@15fps */
	FIMC_IS_SENSOR_CFG(1640, 1228, 15, 18, 3, CSI_DATA_LANES_2),
	/* 1640x1228@7fps */
	FIMC_IS_SENSOR_CFG(1640, 1228, 7, 18, 4, CSI_DATA_LANES_2),
	/* 1640x924@30fps */
	FIMC_IS_SENSOR_CFG(1640, 924, 30, 18, 5, CSI_DATA_LANES_2),
	/* 1640x924@15fps */
	FIMC_IS_SENSOR_CFG(1640, 924, 15, 18, 6, CSI_DATA_LANES_2),
	/* 1640x924@7fps */
	FIMC_IS_SENSOR_CFG(1640, 924, 7, 18, 7, CSI_DATA_LANES_2),
	/* 816x604@120fps */
	FIMC_IS_SENSOR_CFG(816, 604, 120, 10, 8, CSI_DATA_LANES_2),
	/* 816x460@120fps */
	FIMC_IS_SENSOR_CFG(816, 460, 120, 10, 9, CSI_DATA_LANES_2),
};
...
static int sensor_module_sr846_power_setpin(struct platform_device *pdev,
		struct exynos_platform_fimc_is_module *pdata)
{
	...
	/* Normal On */
	SET_PIN(pdata, SENSOR_SCENARIO_NORMAL, GPIO_SCENARIO_ON, gpio_reset, "sen_rst low", PIN_OUTPUT, 0, 500);
	SET_PIN(pdata, SENSOR_SCENARIO_NORMAL, GPIO_SCENARIO_ON, gpio_none, "VDD18_CAM_SENSOR_IO", PIN_REGULATOR, 1, 500);
	SET_PIN(pdata, SENSOR_SCENARIO_NORMAL, GPIO_SCENARIO_ON, gpio_none, "AVDD24_CAM_2P8", PIN_REGULATOR, 1, 500);
	SET_PIN(pdata, SENSOR_SCENARIO_NORMAL, GPIO_SCENARIO_ON, gpio_none, "VDD23_CAM_CORE_1P2", PIN_REGULATOR, 1, 500);
	...
	SET_PIN(pdata, SENSOR_SCENARIO_NORMAL, GPIO_SCENARIO_OFF, gpio_none, "VDD23_CAM_CORE_1P2", PIN_REGULATOR, 0, 500);
	SET_PIN(pdata, SENSOR_SCENARIO_NORMAL, GPIO_SCENARIO_OFF, gpio_none, "AVDD24_CAM_2P8", PIN_REGULATOR, 0, 500);
	SET_PIN(pdata, SENSOR_SCENARIO_NORMAL, GPIO_SCENARIO_OFF, gpio_none, "VDD18_CAM_SENSOR_IO", PIN_REGULATOR, 0, 500);
...
int sensor_module_sr846_probe(struct platform_device *pdev)
{
	...
	fimc_is_sensor_module_parse_dt(pdev, sensor_module_sr846_power_setpin);
