...
static struct fimc_is_sensor_cfg config_gw1[] = {
	...
	FIMC_IS_SENSOR_CFG_EX(9248, 6936,  13, 0, 0, CSI_DATA_LANES_4, 2392, CSI_MODE_VC_ONLY, PD_MSPD_TAIL, EX_NONE,
		VC_IN(0, HW_FORMAT_RAW10, 9248, 6936),   VC_OUT(HW_FORMAT_RAW10, VC_NOTHING, 0, 0),
		VC_IN(1, HW_FORMAT_RAW10, 584, 3472),    VC_OUT(HW_FORMAT_RAW10, VC_NOTHING, 0, 0),
		VC_IN(2, HW_FORMAT_UNKNOWN, 0, 0),       VC_OUT(HW_FORMAT_USER, VC_MIPISTAT, 584, 3472),
		VC_IN(3, HW_FORMAT_UNKNOWN, 0, 0),       VC_OUT(HW_FORMAT_USER, VC_PRIVATE, 584, 3472)),
	...
	FIMC_IS_SENSOR_CFG_EX(1280, 720,  240, 0, 5, CSI_DATA_LANES_4, 2392, CSI_MODE_VC_ONLY, PD_MSPD_TAIL, EX_NONE,
		VC_IN(0, HW_FORMAT_RAW10, 1280, 720),   VC_OUT(HW_FORMAT_RAW10, VC_NOTHING, 0, 0),
		VC_IN(1, HW_FORMAT_RAW10, 320, 364),    VC_OUT(HW_FORMAT_RAW10, VC_NOTHING, 0, 0),
		VC_IN(2, HW_FORMAT_UNKNOWN, 0, 0),       VC_OUT(HW_FORMAT_USER, VC_MIPISTAT, 320, 364),
		VC_IN(3, HW_FORMAT_UNKNOWN, 0, 0),       VC_OUT(HW_FORMAT_USER, VC_PRIVATE, 320, 364)),
	FIMC_IS_SENSOR_CFG_EX(2000, 1128,  240, 0, 6, CSI_DATA_LANES_4, 2392, CSI_MODE_VC_ONLY, PD_MSPD_TAIL, EX_NONE,
		VC_IN(0, HW_FORMAT_RAW10, 2000, 1128),   VC_OUT(HW_FORMAT_RAW10, VC_NOTHING, 0, 0),
		VC_IN(1, HW_FORMAT_RAW10, 504, 572),    VC_OUT(HW_FORMAT_RAW10, VC_NOTHING, 0, 0),
		VC_IN(2, HW_FORMAT_UNKNOWN, 0, 0),       VC_OUT(HW_FORMAT_USER, VC_MIPISTAT, 504, 572),
		VC_IN(3, HW_FORMAT_UNKNOWN, 0, 0),       VC_OUT(HW_FORMAT_USER, VC_PRIVATE, 504, 572)),
	FIMC_IS_SENSOR_CFG_EX(2304, 1728,  120, 0, 7, CSI_DATA_LANES_4, 2392, CSI_MODE_VC_ONLY, PD_MSPD_TAIL, EX_NONE,
		VC_IN(0, HW_FORMAT_RAW10, 2304, 1728),   VC_OUT(HW_FORMAT_RAW10, VC_NOTHING, 0, 0),
		VC_IN(1, HW_FORMAT_RAW10, 584, 868),    VC_OUT(HW_FORMAT_RAW10, VC_NOTHING, 0, 0),
		VC_IN(2, HW_FORMAT_UNKNOWN, 0, 0),       VC_OUT(HW_FORMAT_USER, VC_MIPISTAT, 584, 868),
		VC_IN(3, HW_FORMAT_UNKNOWN, 0, 0),       VC_OUT(HW_FORMAT_USER, VC_PRIVATE, 584, 868)),
};
		...
		struct exynos_platform_fimc_is_module *pdata)
{
	...
	SET_PIN(pdata, SENSOR_SCENARIO_NORMAL, GPIO_SCENARIO_ON,  gpio_none,  MCLK_GPIO,   PIN_MCLK,  0, 0);
	...
	SET_PIN(pdata, SENSOR_SCENARIO_NORMAL, GPIO_SCENARIO_ON,  gpio_none,  I2C_OFF,   PIN_I2C,  0, 0);
	...
	for (int t = VC_BUF_DATA_TYPE_SENSOR_STAT1; t < VC_BUF_DATA_TYPE_MAX; t++) {
		...
		if (IS_ENABLED(CONFIG_CAMERA_PAFSTAT)) {
			...
			case VC_BUF_DATA_TYPE_GENERAL_STAT1:
				...
				module->vc_extra_info[t].max_height = 3472;
