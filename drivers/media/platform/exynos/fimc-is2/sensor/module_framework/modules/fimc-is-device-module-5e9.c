...
#if defined (CONFIG_CAMERA_M10LTE)
	SET_PIN(pdata, SENSOR_SCENARIO_READ_ROM, GPIO_SCENARIO_ON, gpio_vtcam_a2p8_en, "sensor_vtcam_a2p8_en", PIN_OUTPUT, 0, 0);
	SET_PIN(pdata, SENSOR_SCENARIO_READ_ROM, GPIO_SCENARIO_ON, gpio_vtcam_core_en, "sensor_vtcam_core_en", PIN_OUTPUT, 0, 500);
	SET_PIN(pdata, SENSOR_SCENARIO_READ_ROM, GPIO_SCENARIO_ON, gpio_rcam1_ldo_en, "sensor_rcam1_ldo_en", PIN_OUTPUT, 0, 500);
#else /* CONFIG_CAMERA_M10LTE */
