...
static struct fimc_is_sensor_cfg config_module_imx471[] = {
	/* 4608x3456@30fps, MIPI CLK: 728MHz, MIPI Rate: 1404Mbps*/
	FIMC_IS_SENSOR_CFG_EXT(4608, 3456, 30, 30, 0, CSI_DATA_LANES_4, 1404, 0, 0, 0),
	/* 4608x2592@30fps, MIPI CLK: 728MHz, MIPI Rate: 1404Mbps*/
	FIMC_IS_SENSOR_CFG_EXT(4608, 2592, 30, 30, 1, CSI_DATA_LANES_4, 1404, 0, 0, 0),
	/* 4608x2240@30fps, MIPI CLK: 728MHz, MIPI Rate: 1404Mbps*/
	FIMC_IS_SENSOR_CFG_EXT(4608, 2240, 30, 30, 2, CSI_DATA_LANES_4, 1404, 0, 0, 0),
	/* 4608x2176@30fps, MIPI CLK: 728MHz, MIPI Rate: 1404Mbps*/
	FIMC_IS_SENSOR_CFG_EXT(4608, 2176, 30, 30, 3, CSI_DATA_LANES_4, 1404, 0, 0, 0),
	/*3824x2868@30fps, MIPI CLK: 728MHz, MIPI Rate: 1404Mbps*/
	FIMC_IS_SENSOR_CFG_EXT(3824, 2868, 30, 30, 4, CSI_DATA_LANES_4, 1404, 0, 0, 0),
	/* 3824x2152@30fps, MIPI CLK: 728MHz, MIPI Rate: 1404Mbps*/
	FIMC_IS_SENSOR_CFG_EXT(3824, 2152, 30, 30, 5, CSI_DATA_LANES_4, 1404, 0, 0, 0),
	/* 3824x1764@30fps, MIPI CLK: 728MHz, MIPI Rate: 1404Mbps*/
	FIMC_IS_SENSOR_CFG_EXT(3824, 1764, 30, 30, 6, CSI_DATA_LANES_4, 1404, 0, 0, 0),
	/* 3456x3456@30fps, MIPI CLK: 728MHz, MIPI Rate: 1404Mbps*/
	FIMC_IS_SENSOR_CFG_EXT(3456, 3456, 30, 30, 7, CSI_DATA_LANES_4, 1404, 0, 0, 0),
	/*2864x2864@30fps, MIPI CLK: 728MHz, MIPI Rate: 1404Mbps*/
	FIMC_IS_SENSOR_CFG_EXT(2864, 2864, 30, 30, 8, CSI_DATA_LANES_4, 1404, 0, 0, 0),
	/* 2304x1728@30fps, MIPI CLK: 728MHz, MIPI Rate: 1404Mbps*/
	FIMC_IS_SENSOR_CFG_EXT(2304, 1728, 30, 30, 9, CSI_DATA_LANES_4, 1404, 0, 0, 0),
	/* 2304x1728@60fps, MIPI CLK: 728MHz, MIPI Rate: 1404Mbps*/
	FIMC_IS_SENSOR_CFG_EXT(2304, 1728, 60, 30, 10, CSI_DATA_LANES_4, 1404, 0, 0, 0),
	/* 2304x1296@30fps, MIPI CLK: 728MHz, MIPI Rate: 1404Mbps*/
	FIMC_IS_SENSOR_CFG_EXT(2304, 1296, 30, 30, 11, CSI_DATA_LANES_4, 1404, 0, 0, 0),
	/* 2304x1120@30fps, MIPI CLK: 728MHz, MIPI Rate: 1404Mbps*/
	FIMC_IS_SENSOR_CFG_EXT(2304, 1120, 30, 30, 12, CSI_DATA_LANES_4, 1404, 0, 0, 0),
	/* 2304x1088@30fps, MIPI CLK: 728MHz, MIPI Rate: 1404Mbps*/
	FIMC_IS_SENSOR_CFG_EXT(2304, 1088, 30, 30, 13, CSI_DATA_LANES_4, 1404, 0, 0, 0),
	/* 1920x1440@30fps, MIPI CLK: 728MHz, MIPI Rate: 1404Mbps*/
	FIMC_IS_SENSOR_CFG_EXT(1920, 1440, 30, 30, 14, CSI_DATA_LANES_4, 1404, 0, 0, 0),
	/* 1920x1080@30fps, MIPI CLK: 728MHz, MIPI Rate: 1404Mbps*/
	FIMC_IS_SENSOR_CFG_EXT(1920, 1080, 30, 30, 15, CSI_DATA_LANES_4, 1404, 0, 0, 0),
	/* 1920x888@30fps, MIPI CLK: 728MHz, MIPI Rate: 1404Mbps*/
	FIMC_IS_SENSOR_CFG_EXT(1920, 888, 30, 30, 16, CSI_DATA_LANES_4, 1404, 0, 0, 0),
	/* 1728x1728@30fps, MIPI CLK: 728MHz, MIPI Rate: 1404Mbps*/
	FIMC_IS_SENSOR_CFG_EXT(1728, 1728, 30, 30, 17, CSI_DATA_LANES_4, 1404, 0, 0, 0),
	/* 1440x1440@30fps, MIPI CLK: 728MHz, MIPI Rate: 1404Mbps*/
	FIMC_IS_SENSOR_CFG_EXT(1440, 1440, 30, 30, 18, CSI_DATA_LANES_4, 1404, 0, 0, 0),
};

static struct fimc_is_vci vci_module_imx471[] = {
#if 0
        {
...
static int sensor_module_imx471_power_setpin(struct device *dev,
...
int sensor_module_imx471_probe(struct platform_device *pdev)
{
	int ret = 0;
	...
	fimc_is_module_parse_dt(dev, sensor_module_imx471_power_setpin);
	...
	module->pdata = pdata;
	module->dev = dev;
	module->sensor_id = SENSOR_NAME_IMX471;
	...
	module->bitwidth = 10;
	module->vcis = ARRAY_SIZE(vci_module_imx471);
	module->vci = vci_module_imx471;
	module->sensor_maker = "SONY";
	module->sensor_name = "IMX471";
	module->setfile_name = "setfile_imx471.bin";
	module->cfgs = ARRAY_SIZE(config_module_imx471);
	module->cfg = config_module_imx471;
	module->ops = NULL;
...
static int sensor_module_imx471_remove(struct platform_device *pdev)
{
	int ret = 0;
...
static const struct of_device_id exynos_fimc_is_sensor_module_imx471_match[] = {
	{
		.compatible = "samsung,sensor-module-imx471",
	},
	{},
};
MODULE_DEVICE_TABLE(of, exynos_fimc_is_sensor_module_imx471_match);

static struct platform_driver sensor_module_imx471_driver = {
	.probe  = sensor_module_imx471_probe,
	.remove = sensor_module_imx471_remove,
	.driver = {
		.name   = "FIMC-IS-SENSOR-MODULE-IMX471",
		.owner  = THIS_MODULE,
		.of_match_table = exynos_fimc_is_sensor_module_imx471_match,
	}
};

module_platform_driver(sensor_module_imx471_driver);
