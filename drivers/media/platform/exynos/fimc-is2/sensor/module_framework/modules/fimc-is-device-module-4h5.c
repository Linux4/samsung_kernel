...
static struct fimc_is_sensor_cfg config_module_4h5[] = {
	...
	/* 816x604_120fps */
	FIMC_IS_SENSOR_CFG(816, 604, 120, 29, 3),
	/* 816x460_120fps */
	FIMC_IS_SENSOR_CFG(816, 460, 120, 29, 4),
};
	...
	struct exynos_platform_fimc_is_module *pdata)
{
	...
	SET_PIN(pdata, SENSOR_SCENARIO_NORMAL, GPIO_SCENARIO_ON, gpio_reset, "sen_rst low", PIN_OUTPUT, 0, 2000);
	...
	SET_PIN(pdata, SENSOR_SCENARIO_NORMAL, GPIO_SCENARIO_ON, gpio_reset, "sen_rst high", PIN_OUTPUT, 1, 750);
	...
	SET_PIN(pdata, SENSOR_SCENARIO_VISION, GPIO_SCENARIO_ON, gpio_reset, "sen_rst high", PIN_OUTPUT, 1, 750);
