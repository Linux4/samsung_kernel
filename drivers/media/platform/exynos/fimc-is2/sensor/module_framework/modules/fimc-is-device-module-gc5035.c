...
static struct fimc_is_sensor_cfg config_gc5035[] = {
	...
	/* 2576x1188@30fps */
	FIMC_IS_SENSOR_CFG_EXT(2576, 1188, 30, 19, 4, CSI_DATA_LANES_2, 884, 0, 0, 0),
	/* 2576x1932@24fps */
	FIMC_IS_SENSOR_CFG_EXT(2576, 1932, 24, 19, 5, CSI_DATA_LANES_2, 884, 0, 0, 0),
	/* 2560x1440@24fps */
	FIMC_IS_SENSOR_CFG_EXT(2560, 1440, 24, 19, 6, CSI_DATA_LANES_2, 884, 0, 0, 0),
	/* 2224x1080@24fps */
	FIMC_IS_SENSOR_CFG_EXT(2224, 1080, 24, 19, 7, CSI_DATA_LANES_2, 884, 0, 0, 0),
	/*1920x1920@24fps */
	FIMC_IS_SENSOR_CFG_EXT(1920, 1920, 24, 19, 8, CSI_DATA_LANES_2, 884, 0, 0, 0),
	/*640x480@120fps */
	FIMC_IS_SENSOR_CFG_EXT(640, 480, 120, 9, 9, CSI_DATA_LANES_2, 442, 0, 0, 0),
};
