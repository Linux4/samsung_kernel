...
const u32 sensor_3p8_setfile_A_4640x3488_30fps[] = {
	0xFCFC, 0x4000, 0x02,
	0x6214, 0x7971, 0x02,
	0x6218, 0x7150, 0x02,
	0x0136, 0x1A00, 0x02,
...
const u32 sensor_3p8_setfile_A_2320x1744_60fps[] = {
	0xFCFC, 0x4000, 0x02,
	0x6214, 0x7971, 0x02,
	0x6218, 0x7150, 0x02,
	0x0136, 0x1A00, 0x02,
...
const u32 sensor_3p8_setfile_A_1536x1160_90fps[] = {
	0xFCFC, 0x4000, 0x02,
	0x6214, 0x7971, 0x02,
	0x6218, 0x7150, 0x02,
	0x0136, 0x1A00, 0x02,
...
const u32 sensor_3p8_setfile_A_1152x872_120fps[] = {
	0xFCFC, 0x4000, 0x02,
	0x6214, 0x7971, 0x02,
	0x6218, 0x7150, 0x02,
	0x0136, 0x1A00, 0x02,
...
const struct sensor_pll_info sensor_3p8_pllinfo_A_4640x3488_30fps = {
...
const struct sensor_pll_info sensor_3p8_pllinfo_A_2320x1744_60fps = {
	EXT_CLK_Mhz * 1000 * 1000, /* ext_clk */
	0x03, /* vt_pix_clk_div	(0x0300) */
	0x01, /* vt_sys_clk_div	(0x0302) */
	0x07, /* pre_pll_clk_div(0x0304) */
...
const struct sensor_pll_info sensor_3p8_pllinfo_A_1536x1160_90fps = {
	EXT_CLK_Mhz * 1000 * 1000, /* ext_clk */
	0x03, /* vt_pix_clk_div	(0x0300) */
	0x01, /* vt_sys_clk_div	(0x0302) */
	0x07, /* pre_pll_clk_div(0x0304) */
...
const struct sensor_pll_info sensor_3p8_pllinfo_A_1152x872_120fps = {
	EXT_CLK_Mhz * 1000 * 1000, /* ext_clk */
	0x03, /* vt_pix_clk_div	(0x0300) */
	0x01, /* vt_sys_clk_div	(0x0302) */
	0x07, /* pre_pll_clk_div(0x0304) */
...
static const u32 *sensor_3p8_setfiles_A[] = {
	/* 16x12 margin */
	sensor_3p8_setfile_A_4640x3488_30fps,
	sensor_3p8_setfile_A_2320x1744_60fps,
	sensor_3p8_setfile_A_1536x1160_90fps,
	sensor_3p8_setfile_A_1152x872_120fps,
...
static const u32 sensor_3p8_setfile_A_sizes[] = {
	/* 16x12 margin */
	sizeof(sensor_3p8_setfile_A_4640x3488_30fps) / sizeof(sensor_3p8_setfile_A_4640x3488_30fps[0]),
	sizeof(sensor_3p8_setfile_A_2320x1744_60fps) / sizeof(sensor_3p8_setfile_A_2320x1744_60fps[0]),
	sizeof(sensor_3p8_setfile_A_1536x1160_90fps) / sizeof(sensor_3p8_setfile_A_1536x1160_90fps[0]),
	sizeof(sensor_3p8_setfile_A_1152x872_120fps) / sizeof(sensor_3p8_setfile_A_1152x872_120fps[0]),
...
static const struct sensor_pll_info *sensor_3p8_pllinfos_A[] = {
	/* 16x12 margin */
	&sensor_3p8_pllinfo_A_4640x3488_30fps,
	&sensor_3p8_pllinfo_A_2320x1744_60fps,
	&sensor_3p8_pllinfo_A_1536x1160_90fps,
	&sensor_3p8_pllinfo_A_1152x872_120fps,
