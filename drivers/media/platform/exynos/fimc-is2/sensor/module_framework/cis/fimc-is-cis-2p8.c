...
#include "fimc-is-cis-2p8.h"
#include "fimc-is-cis-2p8-setA.h"
#include "fimc-is-cis-2p8-setB.h"
...
static int cis_2p8_remove(struct i2c_client *client)
{
	int ret = 0;
	return ret;
}

static const struct of_device_id exynos_fimc_is_cis_2p8_match[] = {
	{
		.compatible = "samsung,exynos5-fimc-is-cis-2p8",
	},
	{},
};
MODULE_DEVICE_TABLE(of, exynos_fimc_is_cis_2p8_match);
...
static struct i2c_driver cis_2p8_driver = {
	.driver = {
		.name	= SENSOR_NAME,
		.owner	= THIS_MODULE,
		.of_match_table = exynos_fimc_is_cis_2p8_match
	},
	.probe	= cis_2p8_probe,
	.remove	= cis_2p8_remove,
	.id_table = cis_2p8_idt
};
module_i2c_driver(cis_2p8_driver);
