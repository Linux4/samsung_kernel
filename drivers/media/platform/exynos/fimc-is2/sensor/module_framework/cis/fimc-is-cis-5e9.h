...
#define SENSOR_5E9_MAX_WIDTH		(2560 + 16)
#define SENSOR_5E9_MAX_HEIGHT		(1920 + 12)

/* TODO: Check below values are valid */
#define SENSOR_5E9_FINE_INTEGRATION_TIME_MIN                0x64
#define SENSOR_5E9_FINE_INTEGRATION_TIME_MAX                0x64
#define SENSOR_5E9_COARSE_INTEGRATION_TIME_MIN              0x3
#define SENSOR_5E9_COARSE_INTEGRATION_TIME_MAX_MARGIN       0x4
