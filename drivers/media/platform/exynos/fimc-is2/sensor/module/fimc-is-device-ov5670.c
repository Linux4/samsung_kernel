...
static struct fimc_is_sensor_cfg config_ov5670[] = {
	/* 2608x1960@30fps */
	FIMC_IS_SENSOR_CFG(2608, 1960,  30, 18, 0),
	/* 1304x980@30fps */
	FIMC_IS_SENSOR_CFG(1304,  980,  30, 18, 1),
	/* 1304x980@15fps */
	FIMC_IS_SENSOR_CFG(1304,  980,  15, 18, 2),
	/* 1304x980@7fps */
	FIMC_IS_SENSOR_CFG(1304,  980,   7, 18, 3),
	/* 640x480@120fps */
	FIMC_IS_SENSOR_CFG(640,   480, 120, 18, 4),
};
...
static int sensor_ov5670_open(struct v4l2_subdev *sd,
	struct v4l2_subdev_fh *fh)
{
	pr_info("%s\n", __func__);
	return 0;
}
static int sensor_ov5670_close(struct v4l2_subdev *sd,
	struct v4l2_subdev_fh *fh)
{
	pr_info("%s\n", __func__);
	return 0;
}
static int sensor_ov5670_registered(struct v4l2_subdev *sd)
{
	pr_info("%s\n", __func__);
	return 0;
}

static void sensor_ov5670_unregistered(struct v4l2_subdev *sd)
{
	pr_info("%s\n", __func__);
}

static const struct v4l2_subdev_internal_ops internal_ops = {
	.open = sensor_ov5670_open,
	.close = sensor_ov5670_close,
	.registered = sensor_ov5670_registered,
	.unregistered = sensor_ov5670_unregistered,
};
...
static int sensor_ov5670_init(struct v4l2_subdev *subdev, u32 val)
{
	...
	struct fimc_is_module_ov5670 *module_ov5670;
	struct i2c_client *client;

	BUG_ON(!subdev);

	module = (struct fimc_is_module_enum *)v4l2_get_subdevdata(subdev);
	module_ov5670 = module->private_data;
	client = module->client;

	module_ov5670->system_clock = 146 * 1000 * 1000;
	module_ov5670->line_length_pck = 146 * 1000 * 1000;
...
static int sensor_ov5670_s_stream(struct v4l2_subdev *subdev, int enable)
{
	int ret = 0;
...
static int sensor_ov5670_s_param(struct v4l2_subdev *subdev, struct v4l2_streamparm *param)
{
	int ret = 0;
	struct fimc_is_module_enum *sensor;
...
static int sensor_ov5670_s_format(struct v4l2_subdev *subdev, struct v4l2_mbus_framefmt *fmt)
{
	/* TODO */
	return 0;
}
...
static const struct v4l2_subdev_video_ops video_ops = {
	.s_stream = sensor_ov5670_s_stream,
	.s_parm = sensor_ov5670_s_param,
	.s_mbus_fmt = sensor_ov5670_s_format
};
...
int sensor_ov5670_stream_on(struct v4l2_subdev *subdev)
{
	int ret = 0;
	struct fimc_is_module_enum *sensor;
	struct i2c_client *client;
...
int sensor_ov5670_stream_off(struct v4l2_subdev *subdev)
{
	int ret = 0;
	struct fimc_is_module_enum *sensor;
	struct i2c_client *client;
 ...
 * @ remarks
 */
int sensor_ov5670_s_duration(struct v4l2_subdev *subdev, u64 duration)
{
	int ret = 0;
	u8 value[2];
	struct fimc_is_module_enum *sensor;
...
int sensor_ov5670_g_min_duration(struct v4l2_subdev *subdev)
{
	int ret = 0;
	return ret;
}

int sensor_ov5670_g_max_duration(struct v4l2_subdev *subdev)
{
	int ret = 0;
	return ret;
}

int sensor_ov5670_s_exposure(struct v4l2_subdev *subdev, u64 exposure)
{
	int ret = 0;
	u8 value;
	struct fimc_is_module_enum *sensor;
...
int sensor_ov5670_g_min_exposure(struct v4l2_subdev *subdev)
{
	int ret = 0;
	return ret;
}

int sensor_ov5670_g_max_exposure(struct v4l2_subdev *subdev)
{
	int ret = 0;
	return ret;
}

int sensor_ov5670_s_again(struct v4l2_subdev *subdev, u64 sensitivity)
{
	int ret = 0;
...
int sensor_ov5670_g_min_again(struct v4l2_subdev *subdev)
{
	int ret = 0;
	return ret;
}

int sensor_ov5670_g_max_again(struct v4l2_subdev *subdev)
{
	int ret = 0;
	return ret;
}

int sensor_ov5670_s_dgain(struct v4l2_subdev *subdev)
{
	int ret = 0;
	return ret;
}

int sensor_ov5670_g_min_dgain(struct v4l2_subdev *subdev)
{
	int ret = 0;
	return ret;
}

int sensor_ov5670_g_max_dgain(struct v4l2_subdev *subdev)
{
	int ret = 0;
	return ret;
}

struct fimc_is_sensor_ops module_ov5670_ops = {
	.stream_on	= sensor_ov5670_stream_on,
	.stream_off	= sensor_ov5670_stream_off,
	.s_duration	= sensor_ov5670_s_duration,
	.g_min_duration	= sensor_ov5670_g_min_duration,
	.g_max_duration	= sensor_ov5670_g_max_duration,
	.s_exposure	= sensor_ov5670_s_exposure,
	.g_min_exposure	= sensor_ov5670_g_min_exposure,
	.g_max_exposure	= sensor_ov5670_g_max_exposure,
	.s_again	= sensor_ov5670_s_again,
	.g_min_again	= sensor_ov5670_g_min_again,
	.g_max_again	= sensor_ov5670_g_max_again,
	.s_dgain	= sensor_ov5670_s_dgain,
	.g_min_dgain	= sensor_ov5670_g_min_dgain,
	.g_max_dgain	= sensor_ov5670_g_max_dgain
};
...
int sensor_ov5670_probe(struct platform_device *pdev)
{
	...
	module->pdata = pdata;
	module->pdev = pdev;
	module->sensor_id = SENSOR_OV5670_NAME;
	module->subdev = subdev_module;
	module->device = pdata->id;
	module->ops = &module_ov5670_ops;
	module->client = NULL;
	module->active_width = 2608;
	module->active_height = 1960;
	...
	module->private_data = kzalloc(sizeof(struct fimc_is_module_ov5670), GFP_KERNEL);
...
MODULE_DESCRIPTION("Sensor OV5670 driver");
