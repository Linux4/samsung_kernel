...
static struct fimc_is_sensor_cfg config_4e6[] = {
	...
	/* 1304X980@15 */
	FIMC_IS_SENSOR_CFG(1304, 980, 15, 5, 1),
	/* 1304X980@7 */
	FIMC_IS_SENSOR_CFG(1304, 980, 7, 5, 1),
};
...
static const struct v4l2_subdev_video_ops video_ops = {
	...
	.s_mbus_fmt = sensor_4e6_s_format
};
...
module_platform_driver(sensor_4e6_driver);

static int __init fimc_is_sensor_module_init(void)
{
	int ret = 0;

	ret = platform_driver_register(&sensor_4e6_driver);
	if (ret)
