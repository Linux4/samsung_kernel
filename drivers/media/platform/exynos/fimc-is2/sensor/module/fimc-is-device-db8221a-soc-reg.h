...
#ifndef FIMC_IS_DEVICE_DB8221A_REG_H
#define FIMC_IS_DEVICE_DB8221A_REG_H

static struct sensor_reg db8221a_Init_Reg[] = {
	/*==================================*/
	/* OutFormatter                     */
	/*==================================*/
	{0xFF, 0xE1},	// Page
	...
	{0xCA, 0x05},	// DarkTh
	{0xCB, 0x01},	// MinEXP 10=1/1100sec
	{0xCC, 0x02},	// MinEXPth DNP4300Lux=20
	{0xCD, 0x00},	// AE speed
	...
	{0xF3, 0x00},	// AWB_Weight_Indoor_5_TL84
	{0xF4, 0x00},	// AWB_Weight_Indoor_6_A
	{0xF5, 0x12},	// AWB_Weight_Indoor_7_Horizon
	...
	/*==================================*/
	{0xFF, 0x95},	// Page
	{0xC6, 0x31},	// ADF_ThrLevel_LVLSC
	{0xC7, 0xCB},	// ADF_ThrLevel_LSLSC
	...
	{0xEA, 0x20},	// ADF_EndVal_GDC_TH1
	{0xEB, 0x20},	// ADF_EndVal_GDC_TH2
	...
	{0xF4, 0x14},	// ADF_MaxVal_NSF_TH1
	{0xF5, 0x10},	// ADF_MaxVal_NSF_TH2
	{0xF6, 0x11},	// ADF_EndVal_NSF_TH1
	{0xF7, 0x10},	// ADF_EndVal_NSF_TH2

	{0xF8, 0xED},	// ADF_ThrNoiseLevel_NSF
	{0xF9, 0x10},	// ADF_NSF_Noisegain
	{0xFA, 0x98},	// ADF_ThrLevel_NSF_SASP
	{0xFB, 0x00},	// ADF_MinVal_NSF_SASP
	{0xFC, 0x00},	// ADF_MaxVal_NSF_SASP
...
static struct sensor_reg db8221a_Init_VT_Reg_640_480[] = {
	/*==================================*/
	/* OutFormatter                     */
	/*==================================*/
	{0xFF, 0xE1},	// Page
...
static struct sensor_reg db8221a_Init_VT_Reg_352_288[] = {
	/*==================================*/
	/* OutFormatter                     */
	/*==================================*/
	{0xFF, 0xE1},	// Page
	...
	{0xFF, 0x97},	// Page
	{0x13, 0x1E},	// gPT_u8PR_Active_VGA_DATA_TYPE_Addr
	{0x14, 0x02},	// gPT_u8PR_Active_VGA_WORD_COUNT_Addr0
	{0x15, 0xC0},	// gPT_u8PR_Active_VGA_WORD_COUNT_Addr1
...
static struct sensor_reg db8221a_Init_VT_Reg_176_144[] = {
	/*==================================*/
	/* OutFormatter                     */
	/*==================================*/
	{0xFF, 0xE1},	// Page
	...
	//==================================
	{0xFF, 0x95},	// Page
	{0xB8, 0x33},	//APThreshold

	{0xFF, 0x97},	// Page
	{0x58, 0x40},	//AddedAnalogADFCtrl
	{0x59, 0x15},	//AddedDigitalADFCtrl
	{0x5C, 0xE8},	//u8An_Addr_H Manual Analog SNR Address

	{0x6C, 0xE8},	//u8DiEn0_Addr_0__FallSx_CDS1_L
	{0x6D, 0x2E},	//u8DiEn0_Addr_1
	{0x6E, 0x66},	//u8DiEn0_Threshold
	{0x6F, 0x60},	//u8DiEn0_Min_Value
	{0x70, 0x80},	//u8DiEn0_Max_Value
	{0x71, 0x80},	//u8UpdateValue

	{0x72, 0xE8},	//u8DiEn1_Addr_0_CPGA_Buffer_Bias
	{0x73, 0x14},	//u8DiEn1_Addr_1
	{0x74, 0x66},	//u8DiEn1_Threshold
	{0x75, 0xC4},	//u8DiEn1_Min_Value
	{0x76, 0xC7},	//u8DiEn1_Max_Value
	{0x77, 0xC7},	//u8UpdateValue
	...
	/* PT : AGAIN Control               */
	/*==================================*/
	{0x98, 0x1E},	// AE_UsrDeminoAGain_0
	{0x99, 0x1E},	// AE_UsrDeminoAGain_1
	{0x9A, 0x2D},	// AE_UsrDeminoAGain_2
	{0x9B, 0x38},	// AE_UsrDeminoAGain_3
	{0x9C, 0x48},	// AE_UsrDeminoAGain_4
	{0x9D, 0x58},	// AE_UsrDeminoAGain_5
	...
	/*==================================*/
	{0xFF, 0x97},	// Page
	{0x8B, 0x41},	//ADF_Threshold_LNF

	{0x8C, 0x18},	//ADF_Min_LNFLLimit
	{0x8E, 0x02},	//ADF_Min_LNFTh0
	{0x90, 0x00},	//ADF_Min_LNFTh1
	{0x92, 0x00},	//ADF_Min_LNFClrSmTh

	{0x8D, 0x18},	//ADF_Max_LNFLLimit
	{0x8F, 0x02},	//ADF_Max_LNFTh0
	{0x91, 0x00},	//ADF_Max_LNFTh1
	{0x93, 0x00},	//ADF_Max_LNFClrSmTh
	...
	{0x22, 0x3C},	//Outdoor Target
	{0x23, 0x3C},	//indoor Target
	...
	{0x8A, 0x05},	//60Hz Frame Rate - Fixed 15fps
	{0x8B, 0x04},	//

	{0x8C, 0x04},	//50Hz Frame Rate - Fixed 15fps
	{0x8D, 0xF4},	//
	...
	{0xC9, 0x05},	//DarkOffset
	{0xCA, 0x05},	//DarkTh
	{0xCB, 0x02},	//MinEXP 10=1/1100sec
	{0xCC, 0x03},	//MinEXPth DNP4300Lux=20
	{0xCD, 0x00},	//AE speed
	...
	{0xA7, 0x4B},	//AWBZone1RBy
	{0xA8, 0x71},	//AWBZone2LTx - D65
	{0xA9, 0x67},	//AWBZone2LTy
	{0xAA, 0x8F},	//AWBZone2RBx
	{0xAB, 0x44},	//AWBZone2RBy
	{0xAC, 0x6B},	//AWBZone3LTx - Fluorecent
	{0xAD, 0x7F},	//AWBZone3LTy
	{0xAE, 0x90},	//AWBZone3RBx
	{0xAF, 0x52},	//AWBZone3RBy
	{0xB0, 0x48},	//AWBZone4LTx - CWF
	{0xB1, 0x76},	//AWBZone4LTy
	{0xB2, 0x6E},	//AWBZone4RBx
	{0xB3, 0x50},	//AWBZone4RBy
	{0xB4, 0x44},	//AWBZone5LTx - TL84
	{0xB5, 0x83},	//AWBZone5LTy
	{0xB6, 0x5E},	//AWBZone5RBx
	{0xB7, 0x6F},	//AWBZone5RBy
	{0xB8, 0x41},	//AWBZone6LTx - A
	{0xB9, 0x91},	//AWBZone6LTy
	{0xBA, 0x58},	//AWBZone6RBx
	{0xBB, 0x7B},	//AWBZone6RBy
	{0xBC, 0x3E},	//AWBZone7LTx - Horizon
	{0xBD, 0xAA},	//AWBZone7LTy
	{0xBE, 0x52},	//AWBZone7RBx
	{0xBF, 0x8C},	//AWBZone7RBy
	{0xC0, 0x00},	//AWBZone8LTx - Skin
	{0xC1, 0x00},	//AWBZone8LTy
	{0xC2, 0x00},	//AWBZone8RBx
	{0xC3, 0x00},	//AWBZone8RBy
	...
	{0xE6, 0x00},	//AWB_Weight_Genernal_0_Flash
	{0xE7, 0x00},	//AWB_Weight_Genernal_1_Cloudy
	{0xE8, 0x1A},	//AWB_Weight_Genernal_2_D65
	{0xE9, 0x00},	//AWB_Weight_Genernal_3_Fluorescent
	{0xEA, 0x20},	//AWB_Weight_Genernal_4_CWF
	{0xEB, 0x18},	//AWB_Weight_Genernal_5_TL84
	{0xEC, 0x20},	//AWB_Weight_Genernal_6_A
	{0xED, 0x20},	//AWB_Weight_Genernal_7_Horizon
	{0xEE, 0x00},	//AWB_Weight_Indoor_0_Flash
	{0xEF, 0x00},	//AWB_Weight_Indoor_1_Cloudy
	{0xF0, 0x14},	//AWB_Weight_Indoor_2_D65
	{0xF1, 0x14},	//AWB_Weight_Indoor_3_Fluorescent
	{0xF2, 0x14},	//AWB_Weight_Indoor_4_CWF
	{0xF3, 0x08},	//AWB_Weight_Indoor_5_TL84
	{0xF4, 0x14},	//AWB_Weight_Indoor_6_A
	{0xF5, 0x08},	//AWB_Weight_Indoor_7_Horizon
	{0xF6, 0x00},	//AWB_Weight_Outdoor_0_Flash
	...
	{0xFF, 0x94},	// Page
	{0x7B, 0x00},	// D65_CCM_11
	{0x7C, 0x74},	// D65_CCM_11
	{0x7D, 0xFF},	// D65_CCM_12
	{0x7E, 0xD0},	// D65_CCM_12
	{0x7F, 0xFF},	// D65_CCM_13
	{0x80, 0xFC},	// D65_CCM_13
	{0x81, 0xFF},	// D65_CCM_21
	{0x82, 0xF1},	// D65_CCM_21
	{0x83, 0x00},	// D65_CCM_22
	{0x84, 0x5F},	// D65_CCM_22
	{0x85, 0xFF},	// D65_CCM_23
	{0x86, 0xF0},	// D65_CCM_23
	{0x87, 0xFF},	// D65_CCM_31
	{0x88, 0xFE},	// D65_CCM_31
	{0x89, 0xFF},	// D65_CCM_32
	{0x8A, 0xC5},	// D65_CCM_32
	{0x8B, 0x00},	// D65_CCM_33
	{0x8C, 0x7D},	// D65_CCM_33


	//CWF lgiht
	{0x8D, 0x00},	// CWF_CCM_11
	{0x8E, 0x68},	// CWF_CCM_11
	{0x8F, 0xFF},	// CWF_CCM_12
	{0x90, 0xDD},	// CWF_CCM_12
	{0x91, 0xFF},	// CWF_CCM_13
	{0x92, 0xFB},	// CWF_CCM_13
	{0x93, 0xFF},	// CWF_CCM_21
	{0x94, 0xEF},	// CWF_CCM_21
	{0x95, 0x00},	// CWF_CCM_22
	{0x96, 0x5D},	// CWF_CCM_22
	{0x97, 0xFF},	// CWF_CCM_23
	{0x98, 0xF4},	// CWF_CCM_23
	{0x99, 0xFF},	// CWF_CCM_31
	{0x9A, 0xEB},	// CWF_CCM_31
	{0x9B, 0xFF},	// CWF_CCM_32
	{0x9C, 0xEF},	// CWF_CCM_32
	{0x9D, 0x00},	// CWF_CCM_33
	{0x9E, 0x66},	// CWF_CCM_33
	...
	{0xFF, 0x96},	// Page
	{0xEA, 0x00},	// Outdoor_CCM_11
	{0xEB, 0x68},	// Outdoor_CCM_11
	{0xEC, 0xFF},	// Outdoor_CCM_12
	{0xED, 0xEB},	// Outdoor_CCM_12
	{0xEE, 0xFF},	// Outdoor_CCM_13
	{0xEF, 0xED},	// Outdoor_CCM_13
	{0xF0, 0xFF},	// Outdoor_CCM_21
	{0xF1, 0xFA},	// Outdoor_CCM_21
	{0xF2, 0x00},	// Outdoor_CCM_22
	{0xF3, 0x5C},	// Outdoor_CCM_22
	{0xF4, 0xFF},	// Outdoor_CCM_23
	{0xF5, 0xEB},	// Outdoor_CCM_23
	{0xF6, 0xFF},	// Outdoor_CCM_31
	{0xF7, 0xF9},	// Outdoor_CCM_31
	{0xF8, 0xFF},	// Outdoor_CCM_32
	{0xF9, 0xD1},	// Outdoor_CCM_32
	{0xFA, 0x00},	// Outdoor_CCM_33
	{0xFB, 0x76},	// Outdoor_CCM_33
	...
	/*==================================*/
	{0xFF, 0x95},	// Page
	{0xC6, 0x32},	//ADF_ThrLevel_LVLSC
	{0xC7, 0xCB},	//ADF_ThrLevel_LSLSC
	{0xC8, 0x90},	//ADF_MinVal_LVLSC_VAL
	{0xC9, 0xE0},	//ADF_MaxVal_LVLSC_VAL
	...
	{0x49, 0x0C},	//Min_Gamma_2
	{0x4A, 0x1C},	//Min_Gamma_3
	{0x4B, 0x2E},	//Min_Gamma_4
	{0x4C, 0x3B},	//Min_Gamma_5
	{0x4D, 0x50},	//Min_Gamma_6
	{0x4E, 0x61},	//Min_Gamma_7
	{0x4F, 0x6D},	//Min_Gamma_8
	{0x50, 0x79},	//Min_Gamma_9
	{0x51, 0x8D},	//Min_Gamma_10
	{0x52, 0xAA},	//Min_Gamma_11
	{0x53, 0xBE},	//Min_Gamma_12
	{0x54, 0xD0},	//Min_Gamma_13
	{0x55, 0xE2},	//Min_Gamma_14
	{0x56, 0xF0},	//Min_Gamma_15
	{0x57, 0xFF},	//Min_Gamma_16

	{0x58, 0x00},	//Max_Gamma_0
	{0x59, 0x02},	//Max_Gamma_1
	{0x5A, 0x05},	//Max_Gamma_2
	{0x5B, 0x0E},	//Max_Gamma_3
	{0x5C, 0x1E},	//Max_Gamma_4
	{0x5D, 0x29},	//Max_Gamma_5
	{0x5E, 0x3D},	//Max_Gamma_6
	{0x5F, 0x51},	//Max_Gamma_7
	{0x60, 0x60},	//Max_Gamma_8
	{0x61, 0x6B},	//Max_Gamma_9
	{0x62, 0x81},	//Max_Gamma_10
	...
	//Outdoor
	{0x69, 0x00},	//gAdf_u8OutGMAVal_0
	{0x6A, 0x02},	//gAdf_u8OutGMAVal_1
	{0x6B, 0x06},	//gAdf_u8OutGMAVal_2
	{0x6C, 0x14},	//gAdf_u8OutGMAVal_3
	{0x6D, 0x26},	//gAdf_u8OutGMAVal_4
	{0x6E, 0x32},	//gAdf_u8OutGMAVal_5
	{0x6F, 0x45},	//gAdf_u8OutGMAVal_6
	{0x70, 0x55},	//gAdf_u8OutGMAVal_7
	{0x71, 0x64},	//gAdf_u8OutGMAVal_8
	{0x72, 0x72},	//gAdf_u8OutGMAVal_9
	{0x73, 0x87},	//gAdf_u8OutGMAVal_10
	{0x74, 0xA7},	//gAdf_u8OutGMAVal_11
	{0x75, 0xC0},	//gAdf_u8OutGMAVal_12
	{0x76, 0xD5},	//gAdf_u8OutGMAVal_13
	{0x77, 0xE5},	//gAdf_u8OutGMAVal_14
	{0x78, 0xF2},	//gAdf_u8OutGMAVal_15
	{0x79, 0xFF},	//gAdf_u8OutGMAVal_16
	...
	/* ADF NSF                          */
	/*==================================*/
	{0xEF, 0x53},	//ADF_ThrLevel_NSF
	{0xF0, 0x20},	//ADF_STVal_NSF_TH1
	{0xF1, 0x28},	//ADF_STVal_NSF_TH2
	{0xF2, 0x1C},	//ADF_MinVal_NSF_TH1
	{0xF3, 0x20},	//ADF_MinVal_NSF_TH2
	{0xF4, 0x10},	//ADF_MaxVal_NSF_TH1
	{0xF5, 0x18},	//ADF_MaxVal_NSF_TH2
	{0xF6, 0x10},	//ADF_EndVal_NSF_TH1
	{0xF7, 0x10},	//ADF_EndVal_NSF_TH2
	...
	{0x02, 0xCB},	//ADF_ThrLevel_EDEOption
	{0x03, 0x10},	//ADF_Indoor_EDEOption
	{0x04, 0x10},	//ADF_Outdoor_EDEOption
	{0x05, 0x30},	//ADF_Indoor_EDESmEdgThrd
	{0x06, 0x16},	//ADF_Outdoor_EDESmEdgThrd
	...
	{0x0E, 0x06},	//ADF_Min_Coring
	{0x10, 0x0A},	//ADF_Min_Edge_Slope2
	{0x12, 0x03},	//ADF_Min_Edge_SmallOffset
	{0x14, 0x23},	//ADF_Min_Edge_Slope

	{0x0F, 0x04},	//ADF_Max_Coring
	{0x11, 0x0B},	//ADF_Max_Edge_Slope2
	{0x13, 0x02},	//ADF_Max_Edge_SmallOffset
	{0x15, 0x33},	//ADF_Max_Edge_Slope

	{0x16, 0x87},	//ADF_ThrLevel_EDE_RB
	{0x17, 0x03},	//MinVal_EDE_RBTH
	{0x18, 0x53},	//MaxVal_EDE_RBTH
	{0x19, 0x98},	//ThrLevel_EDE_SASP
	{0x1A, 0x00},	//MinVal_EDE_SASP
	{0x1B, 0x00},	//MaxVal_EDE_SASP
	...
	// ADF - CKLTh1
	{0x27, 0x92},	//ADF_ThrLevel_CKLTh1
	{0x28, 0x12},	//ADF_MinVal_CKL_TH1
	{0x29, 0x12},	//ADF_MidVal_CKL_TH1
	{0x2A, 0x12},	//ADF_MaxVal_CKL_TH1

	// ADF - CKLTh2
	{0x2B, 0x08},	//ADF_Min_CKL_TH2
	{0x2C, 0x06},	//ADF_Max_CKL_TH2

	// ADF - CNFTh3, 4
	{0x2F, 0x00},	//ADF_CKL_TH3_at_Dark
	{0x32, 0x14},	//ADF_CKL_TH4_at_Dark
...
static struct sensor_reg db8221a_resol_352_288[] = {
	// 352x288 Size
	{0xFF, 0xE4},
...
static struct sensor_reg db8221a_resol_176_144[] = {
	// 176x144 Size
	{0xFF, 0xE4},
	{0x04, 0x00},	// Stream off
...
static struct sensor_reg db8221a_resol_640_480[] = {
	// 64{0x48, 0x0_}PR
	{0xFF, 0xE4},
	{0x04, 0x00},	// Stream off
...
static struct sensor_reg db8221a_resol_800_600[] = {
	// 80{0x60, 0x0_}PR
	{0xFF, 0xE4},
	{0x04, 0x00},	// Stream off
...
static struct sensor_reg db8221a_resol_704_576[] = {
	// 704x576_PR
	{0xFF, 0xE4},
	{0x04, 0x00},	// Stream off
...
static struct sensor_reg db8221a_resol_1280_960[] = {
...
static struct sensor_reg db8221a_resol_1600_1200[] = {
	{0xFF, 0xE4},
	{0x04, 0x00},	// Stream off
...
/*==============================================*/
static struct sensor_reg  db8221a_DTP_On[] = {
	{0xFF, 0x98},	// Page mode
	{0xB9, 0x00},	// BayerFunc
	{0xBA, 0x28},	// RGBYcFunc
	{0xFF, 0xE0},	// Page mode
	...
	{0xE7, 0x64},	// Wait  100ms
};

static struct sensor_reg  db8221a_DTP_Off[] = {
	{0xFF, 0x98},	// Page mode
	{0xB9, 0xFF},	// BayerFunc
	{0xBA, 0xFF},	// RGBYcFunc
	{0xFF, 0xE0},	// Page mode
...
/* CAMERA_Flip_X				*/
/*==============================================*/
static struct sensor_reg  db8221a_hflip[] = {
	{0xFF, 0x98},
	{0xDF, 0x01},	// X-Flip
};
...
/* CAMERA_Flip_Y		                */
/*==============================================*/
static struct sensor_reg  db8221a_vflip[] = {
	{0xFF, 0x98},
	{0xDF, 0x02},	// Y-Flip
};


static struct sensor_reg  db8221a_flip_off[] = {
	{0xFF, 0x98},
	{0xDF, 0x00},	// Y-Flip
};

static struct sensor_reg  db8221a_stop_stream[] = {
	{0xFF, 0xE4},
	{0x04, 0x00},
};

static struct sensor_reg  db8221a_start_stream[] = {
	{0xFF, 0xE4},
	{0x04, 0x01},	// Stream on
};

static struct sensor_reg  db8221a_Effect_Normal[] = {
	{0xFF, 0x98},
	{0xCB, 0x00},	// SPECtrl
	{0xCC, 0x00},	// PEDData1
	{0xCD, 0x00},	// PEDData2
...
static struct sensor_reg  db8221a_Effect_Negative[] = {
	{0xFF, 0x98},
	{0xCB, 0x20},	// SPECtrl
	{0xCC, 0x00},	// PEDData1
	{0xCD, 0x00},	// PEDData2
...
static struct sensor_reg  db8221a_Effect_Gray[] = {
	{0xFF, 0x98},
	{0xCB, 0x08},	// SPECtrl
	{0xCC, 0x00},	// PEDData1
	{0xCD, 0x00},	// PEDData2
...
static struct sensor_reg  db8221a_Effect_Sepia[] = {
	{0xFF, 0x98},
	{0xCB, 0x18},	// SPECtrl
	{0xCC, 0x00},	// PEDData1
	{0xCD, 0x71},	// PEDData2
...
static struct sensor_reg  db8221a_Effect_Aqua[] = {
	{0xFF, 0x98},
	{0xCB, 0x18},	// SPECtrl
	{0xCC, 0x00},	// PEDData1
	{0xCD, 0xAB},	// PEDData2
...
static struct sensor_reg  db8221a_fps_auto[] = {
	{0xFF, 0x93},
	{0x07, 0x01},	// AEMODE
...
static struct sensor_reg  db8221a_fps_15_fixed[] = {
	{0xFF, 0x93},
	{0x07, 0x02},	// AEMODE
	{0x7E, 0x05},	// Min Frame High
	{0x7F, 0xDD},	// Min Frame Low
...
static struct sensor_reg  db8221a_fps_7_fixed[] = {
	{0xFF, 0x93},
	{0x07, 0x02},	// AEMODE
	{0x7E, 0x02},	// Min Frame High
	{0x7F, 0xBD},	// Min Frame Low

	{0x82, 0x11},	// 60Hz Max
	{0x83, 0x10},	// 60Hz 3 Lut
	{0x84, 0x0C},	// 60Hz 2 Lut
	{0x85, 0x08},	// 60Hz 1 Lut
	{0x86, 0x0E},	// 50Hz Max
	{0x87, 0x0D},	// 50Hz 3 Lut
	{0x88, 0x0A},	// 50Hz 2 Lut
	{0x89, 0x06},	// 50Hz 1 Lut
	{0x8A, 0x0A},	// 60Hz Max Frame High
	{0x8B, 0x1B},	// 60Hz Max Frame Low
	{0x8C, 0x09},	// 50Hz Max Frame High
	{0x8D, 0xFC},	// 50Hz Max Frame Low
...
static struct sensor_reg  db8221a_24fps_camcoder_640_480[] = {
	// 64{0x48, 0x0_}PR
	{0xFF, 0xE4},
	{0x04, 0x00},	// Stream off
	...
	{0x8B, 0xFD},	// 60Hz Max Frame Low
	{0x8C, 0x02},	// 50Hz Max Frame High
	{0x8D, 0xDA},	// 50Hz Max Frame Low
...
static struct sensor_reg  db8221a_24fps_camcoder_352_288[] = {
	// 64{0x48, 0x0_}PR
	{0xFF, 0xE4},
	{0x04, 0x00},	// Stream off
...
static struct sensor_reg  db8221a_24fps_camcoder_176_144[] = {
	// 64{0x48, 0x0_}PR
	{0xFF, 0xE4},
	{0x04, 0x00},	// Stream off
...
/*==============================================*/
static struct sensor_reg  db8221a_brightness_m4[] = {
	// Brightness -4
	{0xFF, 0x98},	// Page mode
...
/*==============================================*/
static struct sensor_reg  db8221a_brightness_m3[] = {
	// Brightness -3
	{0xFF, 0x98},	// Page mode
...
/*==============================================*/
static struct sensor_reg  db8221a_brightness_m2[] = {
	// Brightness -2
	{0xFF, 0x98},	// Page mode
...
/*==============================================*/
static struct sensor_reg  db8221a_brightness_m1[] = {
	// Brightness -1
	{0xFF, 0x98},	// Page mode
...
/*==============================================*/
static struct sensor_reg  db8221a_brightness_default[] = {
	// Brightness 0
	{0xFF, 0x98},	// Page mode
...
/*==============================================*/
static struct sensor_reg  db8221a_brightness_p1[] = {
	// Brightness +1
	{0xFF, 0x98},	// Page mode
...
/*==============================================*/
static struct sensor_reg  db8221a_brightness_p2[] = {
	// Brightness +2
	{0xFF, 0x98},	// Page mode
...
/*==============================================*/
static struct sensor_reg  db8221a_brightness_p3[] = {
	// Brightness +3
	{0xFF, 0x98},	// Page mode
...
/*==============================================*/
static struct sensor_reg  db8221a_brightness_p4[] = {
	// Brightness +4
	{0xFF, 0x98},	// Page mode
...
/*==============================================*/
static struct sensor_reg  db8221a_contrast_m4[] = {
	// Contrast -4
	{0xFF, 0x98},	// Page mode
	{0xBD, 0xA0},	// Contrast
};
...
/*==============================================*/
static struct sensor_reg  db8221a_contrast_m3[] = {
	// Contrast -3
	{0xFF, 0x98},	// Page mode
	{0xBD, 0x98},	// Contrast
};
...
/*==============================================*/
static struct sensor_reg  db8221a_contrast_m2[] = {
	// Contrast -2
	{0xFF, 0x98},	// Page mode
	{0xBD, 0x90},	// Contrast
};
...
/*==============================================*/
static struct sensor_reg  db8221a_contrast_m1[] = {
	// Contrast -1
	{0xFF, 0x98},	// Page mode
	{0xBD, 0x88},	// Contrast
};
...
/*==============================================*/
static struct sensor_reg  db8221a_contrast_default[] = {
	// Contrast 0
	{0xFF, 0x98},	// Page mode
	{0xBD, 0x80},	// Contrast
};
...
/*==============================================*/
static struct sensor_reg  db8221a_contrast_p1[] = {
	// Contrast +1
	{0xFF, 0x98},	// Page mode
	{0xBD, 0x78},	// Contrast
};
...
/*==============================================*/
static struct sensor_reg  db8221a_contrast_p2[] = {
	// Contrast +2
	{0xFF, 0x98},	// Page mode
	{0xBD, 0x70},	// Contrast
};
...
/*==============================================*/
static struct sensor_reg  db8221a_contrast_p3[] = {
	// Contrast +3
	{0xFF, 0x98},	// Page mode
	{0xBD, 0x68},	// Contrast
};
...
/*==============================================*/
static struct sensor_reg  db8221a_contrast_p4[] = {
	// Contrast +4
	{0xFF, 0x98},	// Page mode
	{0xBD, 0x60},	// Contrast
};

static struct sensor_reg db8221a_wb_auto[] = {
	{0xFF, 0x94},
...
/* CAMERA_AWB_DayLight				*/
/*==============================================*/
static struct sensor_reg db8221a_wb_daylight[] = {
	{0xFF, 0x94},
	{0xDA, 0x00},	// Indoor Lux Threshold
	{0xDB, 0x00},
...
/* CAMERA_AWB_CLOUDY				*/
/*==============================================*/
static struct sensor_reg db8221a_wb_cloudy[] = {
	{0xFF, 0x94},
	{0xDA, 0x00},	// Indoor Lux Threshold
	{0xDB, 0x00},
	{0xDC, 0x00},	// Outdoor Lux Threshold
...
/*==============================================*/
/* CAMERA_AWB_FLUORESCENT			*/
/*==============================================*/
static struct sensor_reg db8221a_wb_fluorescent[] = {
	{0xFF, 0x94},
	{0xDA, 0x00},	// Indoor Lux Threshold
	{0xDB, 0x00},
	{0xDC, 0x00},	// Outdoor Lux Threshold
...
/* CAMERA_AWB_INCA				*/
/*==============================================*/
static struct sensor_reg db8221a_wb_incandescent[] = {
	{0xFF, 0x94},
	{0xDA, 0x00},	// Indoor Lux Threshold
	{0xDB, 0x00},
	{0xDC, 0x00},	// Outdoor Lux Threshold
...
/*==============================================*/
static struct sensor_reg db8221a_anti_banding_flicker_50hz[] = {
	{0xFF, 0x92},
	{0x08, 0x3D},	// 50Hz
};
...
/*==============================================*/
static struct sensor_reg db8221a_anti_banding_flicker_60hz[] = {
	{0xFF, 0x92},
	{0x08, 0x3F},	// 60Hz
};
...
/*==============================================*/
static struct sensor_reg db8221a_metering_matrix[] = {
	// AE : Matrix
	{0xFF, 0x93},
	{0x0B, 0x88},	 // Weight_0
	{0x0C, 0x88},	 // Weight_1
...
static struct sensor_reg db8221a_metering_center[] = {
	// AE : Center
	{0xFF, 0x93},
	{0x0B, 0x11},	//Weight_0
	{0x0C, 0x11},	//Weight_1
...
static struct sensor_reg db8221a_metering_spot[] = {
	// AE : Spot
	{0xFF, 0x93},
	{0x0B, 0x00},	//Weight_0
	{0x0C, 0x00},	//Weight_1
