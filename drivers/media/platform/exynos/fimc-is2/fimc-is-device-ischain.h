...
/* hack exynos7580, exynos3475 use vdma2 as 3AC DMA */
#if defined(CONFIG_SOC_EXYNOS7580) || defined(CONFIG_SOC_EXYNOS3475)
#define PARAM_3AC_VDMA_OUTPUT PARAM_3AA_VDMA2_OUTPUT
#else
#define PARAM_3AC_VDMA_OUTPUT PARAM_3AA_VDMA4_OUTPUT
#endif
...
#ifdef ENABLE_FD_SW
	/* f/w shared part */
	u32			dvaddr_dshared;	/* FD ymap using */
	ulong			kvaddr_dshared;	/* 1.5KB: 0 ~ 0x600 */
