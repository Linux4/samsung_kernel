...
int fimc_is_hw_mcsc_shot(struct fimc_is_hw_ip *hw_ip, struct fimc_is_frame *frame, unsigned long hw_map);
...
void fimc_is_hw_mcsc_update_param(struct scp_param *param, struct fimc_is_hw_mcsc *hw_scp);
...
void fimc_is_hw_mcsc_set_dma_mo8_sel(u32 base_addr, u32 width, u32 hoffset, u32 plane);
#endif
