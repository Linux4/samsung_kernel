...
#ifdef SUPPORT_TPU
#define PARAM_TPU_CONTROL 		INC_NUM(PARAM_SCALERC_DMA_OUTPUT)
#define PARAM_TPU_CONFIG     		INC_NUM(PARAM_TPU_CONTROL)
#define PARAM_TPU_OTF_INPUT		INC_NUM(PARAM_TPU_CONFIG)
#define PARAM_TPU_DMA_INPUT		INC_NUM(PARAM_TPU_OTF_INPUT)
#define PARAM_TPU_OTF_OUTPUT          	INC_NUM(PARAM_TPU_DMA_INPUT)
#define PARAM_TPU_DMA_OUTPUT         	INC_NUM(PARAM_TPU_OTF_OUTPUT)
#define PARAM_SCALERP_CONTROL		INC_NUM(PARAM_TPU_DMA_OUTPUT)
...
#ifdef SUPPORT_TPU
#define PARAM_STRNUM_TPU		(PARAM_TPU_CONTROL)
#define PARAM_RANGE_TPU			6
#else
...
#define PARAM_HIGH_MASK		(0x003FFFFF)
#else
#define PARAM_LOW_MASK		(0xFFFFFFFF)
