...
#if defined(CONFIG_CAMERA_GPVELTE)
#include "../vendor/fimc-is-vendor-config_gpvelteve.h"
#elif defined(CONFIG_CAMERA_J2LTE)
#include "../vendor/fimc-is-vendor-config_j2lte.h"
#elif defined(CONFIG_CAMERA_GTES)
...
#elif defined(CONFIG_CAMERA_XCOVER3VEELTE)
#include "../vendor/fimc-is-vendor-config_xcover3veelte.h"
#else
...
#define SOC_SCP
#define SOC_VRA
#define ENABLE_3AAISP
#define HW_SLOT_3AAISP_MAX	1
#define HW_SLOT_SUBIP_MAX	2
#define HW_SLOT_MAX		3	/* HW_SLOT_3AAISP_MAX + HW_SLOT_SUBIP_MAX */
#define valid_hw_slot_id(slot_id) \
	(0 <= slot_id && slot_id < HW_SLOT_MAX)
#define valid_3aaisp_intr_slot_id(slot_id) \
	(0 <= slot_id && slot_id < HW_SLOT_3AAISP_MAX)
#define valid_subip_intr_slot_id(slot_id) \
	(0 <= slot_id && slot_id < HW_SLOT_SUBIP_MAX)
...
/* #define FIXED_EXPOSURE_DEBUG */
#define FIXED_EXPOSURE_VALUE (33000)
/* #define FIXED_AGAIN_DEBUG */
#define FIXED_AGAIN_VALUE (200)
/* #define FIXED_DGAIN_DEBUG */
#define FIXED_DGAIN_VALUE (200)
/* #define DBG_CSIISR */
/* #define DBG_FLITEISR */
