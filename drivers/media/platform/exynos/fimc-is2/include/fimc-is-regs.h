...
#define MIPICSI3_REG_BASE			(S5P_VA_MIPICSI3)
...
#define FIMCLITE3_REG_BASE                      (S5P_VA_FIMCLITE3)
...
#define PA_FIMC_IS_GIC_C			(0x145E0000)
#define PA_FIMC_IS_GIC_D			(0x145F0000)

#ifndef CONFIG_ARM64
#define EXYNOS_PMU_CAM0_STATUS EXYNOS7420_CAM0_STATUS
#define EXYNOS_PMU_CAM1_STATUS EXYNOS7420_CAM1_STATUS
#define EXYNOS_PMU_ISP0_STATUS EXYNOS7420_ISP0_STATUS
#define EXYNOS_PMU_ISP1_STATUS EXYNOS7420_ISP1_STATUS
#endif
...
#define MIPICSI0_REG_BASE			(S5P_VA_MIPICSI0)
#define MIPICSI1_REG_BASE			0
#define MIPICSI2_REG_BASE			0
#define MIPICSI3_REG_BASE			0

#define FIMCLITE0_REG_BASE			(S5P_VA_FIMCLITE0)
#define FIMCLITE1_REG_BASE			0
#define FIMCLITE2_REG_BASE			0
#define FIMCLITE3_REG_BASE			0

#define PMUREG_ISP_LOW_POWER_OFF		(S5P_VA_PMU  + 0x0004)
#define PMUREG_ISP_CONFIGURATION		(S5P_VA_PMU  + 0x4140)
#define PMUREG_ISP_STATUS			(S5P_VA_PMU  + 0x4144)
#define PMUREG_ISP_OPTION			(S5P_VA_PMU  + 0x4148)
...
#endif
#define FD_LIB_BASE	S5P_VA_FD_LIB
