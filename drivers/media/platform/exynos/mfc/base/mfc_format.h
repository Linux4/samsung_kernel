...
static struct mfc_fmt mfc_formats[] = {
	...
	{
		.name = "4:2:0 2 Planes 8bit Compress single (SBWC 256)",
	...
	{
		.name = "4:2:0 2 Planes 10bit Compress single (SBWC 256)",
	...
	{
		.name = "4:2:0 2 Planes 8bit Compress Lossy (SBWCL) 32",
	...
	{
		.name = "4:2:0 2 Planes 10bit Compress Lossy (SBWCL) 32",
	...
	{
		.name = "4:2:0 2 Planes 8bit Compress Lossy single (SBWCL) 32",
	...
	{
		.name = "4:2:0 2 Planes 10bit Compress Lossy single (SBWCL) 32",
	...
	{
		.name = "4:2:0 2 Planes 8bit Compress Lossy (SBWCL) 64",
	...
	{
		.name = "4:2:0 2 Planes 10bit Compress Lossy (SBWCL) 64",
	...
	{
		.name = "4:2:0 2 Planes 8bit Compress Lossy single (SBWCL) 64",
	...
	{
		.name = "4:2:0 2 Planes 10bit Compress Lossy single (SBWCL) 64",
