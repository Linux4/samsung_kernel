...
static int __mfc_core_otf_set_buf_info(struct mfc_ctx *ctx)
{
	...
	mfc_ctx_debug(2, "[OTF][FRAME] resolution w: %d, h: %d, format: %s, bufcnt: %d\n",
...
int mfc_core_otf_register_cb(struct mfc_ctx *ctx)
{
	...
	mfc_ctx_debug(2, "[OTF] ready for encoding\n");
...
static int __mfc_core_otf_init_hwfc_buf(struct mfc_ctx *ctx)
{
	...
	mfc_ctx_debug(2, "[OTF] HWFC buffer initialized\n");
...
static void __mfc_core_otf_deinit_hwfc_buf(struct mfc_ctx *ctx)
{
	...
	mfc_ctx_debug(2, "[OTF] HWFC buffer de-initialized\n");
