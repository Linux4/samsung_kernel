...
#define mfc_core_get_hdr10_plus_info_stat_done()	((MFC_CORE_READL(MFC_REG_E_HDR10_PLUS_INFO)	\
						>> MFC_REG_E_HDR10_PLUS_INFO_STAT_DONE_SHIFT)		\
						& MFC_REG_E_HDR10_PLUS_INFO_STAT_DONE_MASK)
#define mfc_core_get_hdr10_plus_info_sei_size()	((MFC_CORE_READL(MFC_REG_E_HDR10_PLUS_INFO)	\
						>> MFC_REG_E_HDR10_PLUS_INFO_SEI_SIZE_SHIFT)		\
						& MFC_REG_E_HDR10_PLUS_INFO_SEI_SIZE_MASK)
#define mfc_core_get_hdr10_plus_info_offset()	((MFC_CORE_READL(MFC_REG_E_HDR10_PLUS_INFO)	\
						>> MFC_REG_E_HDR10_PLUS_INFO_OFFSET_SHIFT)		\
...
#define mfc_core_get_nal_q_exe_nal_ll()		((MFC_CORE_READL(MFC_REG_NAL_QUEUE_INFO)	\
						>> MFC_REG_NAL_QUEUE_EXE_NAL_LL_SHIFT)		\
						& MFC_REG_NAL_QUEUE_EXE_NAL_LL_MASK)
#define mfc_core_get_nal_q_out_cmd_cnt()	((MFC_CORE_READL(MFC_REG_NAL_QUEUE_INFO)	\
						>> MFC_REG_NAL_QUEUE_OUT_CMD_COUNT_SHIFT)	\
						& MFC_REG_NAL_QUEUE_OUT_CMD_COUNT_MASK)
