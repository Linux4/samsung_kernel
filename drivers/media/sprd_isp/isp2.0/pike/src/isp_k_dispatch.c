...
static int32_t isp_k_dispatch_block(struct isp_io_param *param)
{
	...
	REG_MWR(ISP_DISPATCH_CH0_BAYER, 0x03, dispatch_info.bayer_ch0);
	REG_MWR(ISP_DISPATCH_CH0_BAYER, 0x0C, dispatch_info.bayer_ch1);
...
static int32_t isp_k_dispatch_ch0_bayer(struct isp_io_param *param)
{
	...
	REG_MWR(ISP_DISPATCH_CH0_BAYER, 0x03, val);
...
static int32_t isp_k_dispatch_ch1_bayer(struct isp_io_param *param)
{
	...
	REG_MWR(ISP_DISPATCH_CH0_BAYER, 0x0C, val);
