...
static struct sr200_regval regs_res_vga_cam[] = {
  ...
  {0x03, 0x00},
  {0x01, 0x30},
  {0xff, 0x30}, /* 28->5a changed delay to hunting NEED Delay 900ms */
	{SR200_TERM, SR200_TERM}, /* NEED Delay 400ms */
...
static struct sr200_regval regs_res_qvga_vt[] = {
	/* Recording 8fps Anti-Flicker 50Hz END of Initial */
  /* CAMERA INITIAL for Self Recording 8 Fixed Frame */
...
static struct sr200_regval regs_res_vga_vt[] = {
	...
	{0x1d, 0x0f},
	{0x1e, 0x06},
	{0x1f, 0x04}, /* 0x05->0x03 20131024 */ /* 0x03->0x02 20140509 */
	{0x20, 0x00},
...
static struct sr200_regval regs_start_setting_60hz[] = {
	...
	{0x1d, 0x10},
	{0x1e, 0x06},
	{0x1f, 0x04}, /* 0x02->0x03 20150105 03->04 150429 */
	{0x20, 0x00},
