...
tagCamReg32_t regs_s5k4ecgx_flash[] = 
{
	// flash
	// 0xFCFC, 0xD000
	// 0x0028, 0x7000
...
{0x0F12, 0x2AD8}, //REG_TC_IPRM_MinOutRate4KHz_0
{0x0F12, 0x2AD9}, //REG_TC_IPRM_MaxOutRate4KHz_0
{0x0F12, 0x4F1A}, //REG_TC_IPRM_MinOutRate4KHz_1
{0x0F12, 0x2AD8}, //REG_TC_IPRM_MinOutRate4KHz_1 //PCLK Min : 43Mhz
{0x0F12, 0x2AD9}, //REG_TC_IPRM_MaxOutRate4KHz_1 //PCLK Max : 43Mhz

/*
{0x002A, 0x021A},
{0x0F12, 0x4F1A}, //REG_TC_IPRM_OpClk4KHz_0 //SCLK : 81Mhz
{0x0F12, 0x29FE},	//REG_TC_IPRM_MinOutRate4KHz_0
{0x0F12, 0x29FE},	//REG_TC_IPRM_MaxOutRate4KHz_0
{0x0F12, 0x4F1A},	//REG_TC_IPRM_MinOutRate4KHz_1
{0x0F12, 0x29FE}, //REG_TC_IPRM_MinOutRate4KHz_1 //PCLK Min : 43Mhz
{0x0F12, 0x29FE}, //REG_TC_IPRM_MaxOutRate4KHz_1 //PCLK Max : 43Mhz
*/
...
//==================================================================================
	...
	{0x002A, 0x17F6}, 
 	{0x0F12, 0x024A}, //fls_afl_DefaultWPr //5C 54 54
	{0x0F12, 0x0255}, //fls_afl_DefaultWPb //28 30 28
...
//===================================================================                                 
	...
	{0x0F12, 0x2AD9},   	//REG_0TC_PCFG_usMaxOut4KHzRate
	{0x0F12, 0x2AD8},   	//REG_0TC_PCFG_usMinOut4KHzRate
...
//===================================================================                                 
	...
	{0x0F12, 0x2AD9},   	//REG_0TC_CCFG_usMaxOut4KHzRate
	{0x0F12, 0x2AD8},   	//REG_0TC_CCFG_usMinOut4KHzRate
...
tagCamReg32_t regs_s5k4ecgx_camcorder_brightness_level_0[]=
{
	{0xFCFC, 0xD000},
	{0x0028, 0x7000},
	{0x002A, 0x1484},
...
tagCamReg32_t regs_s5k4ecgx_camcorder_brightness_level_1[]=
{
	{0xFCFC, 0xD000},
	{0x0028, 0x7000},
	{0x002A, 0x1484},
...
tagCamReg32_t regs_s5k4ecgx_camcorder_brightness_level_2[]=
{
	{0xFCFC, 0xD000},
	{0x0028, 0x7000},
	{0x002A, 0x1484},
...
tagCamReg32_t regs_s5k4ecgx_camcorder_brightness_level_3[]=
{
	{0xFCFC, 0xD000}, 
	{0x0028, 0x7000},
	{0x002A, 0x1484},
...
tagCamReg32_t regs_s5k4ecgx_camcorder_brightness_level_4[]=
{
	{0xFCFC, 0xD000},  //default
	{0x0028, 0x7000},
	{0x002A, 0x1484},
...
tagCamReg32_t regs_s5k4ecgx_camcorder_brightness_level_5[]=
{
	{0xFCFC, 0xD000},
	{0x0028, 0x7000},
	{0x002A, 0x1484},
...
tagCamReg32_t regs_s5k4ecgx_camcorder_brightness_level_6[]=
{
	{0xFCFC, 0xD000},                                     
	{0x0028, 0x7000},                                     
	{0x002A, 0x1484},                                     
...
tagCamReg32_t regs_s5k4ecgx_camcorder_brightness_level_7[]=
{
	{0xFCFC, 0xD000},                     
	{0x0028, 0x7000},                     
	{0x002A, 0x1484},                     
...
tagCamReg32_t regs_s5k4ecgx_camcorder_brightness_level_8[]=
{
	{0xFCFC, 0xD000},                     
	{0x0028, 0x7000},                     
	{0x002A, 0x1484},                     
...
tagCamReg32_t regs_s5k4ecgx_50hz[]=
{
	{0x002A, 0x0F30},
	{0x0F12, 0x0001}, ///*AFC_D_ConvAccelerPower */
	{0x002A, 0x0F2A},
...
tagCamReg32_t regs_s5k4ecgx_60hz[]=
{
	{0x002A, 0x0F30},
	{0x0F12, 0x0001}, ///*AFC_D_ConvAccelerPower */
	{0x002A, 0x0F2A},
...
tagCamReg32_t regs_s5k4ecgx_AF_normal_mode_1[]=
{
	...
	{0x002A, 0x028E},
	{0x0F12, 0x0000},
	//{SENSOR_WRITE_DELAY, 0x0150}, // delay 150 msec //min 1frame delay
};
...
tagCamReg32_t regs_s5k4ecgx_preview_1280_768[]=
{
	{0xFCFC, 0xD000},
...
tagCamReg32_t regs_s5k4ecgx_preview_960_960[]=
{
    {0xFCFC, 0xD000},
    ...
    {0x002A, 0x0250},
    {0x0F12, 0x0780}, //REG_TC_GP_PrevReqInputWidth //1920
    {0x0F12, 0x0780}, //REG_TC_GP_PrevReqInputHeight //1920
    {0x0F12, 0x0150}, //REG_TC_GP_PrevInputWidthOfs //(2592-1920)/2
    ...
    {0x002A, 0x0494},
    {0x0F12, 0x0780},	//REG_TC_PZOOM_PrevZoomReqInputWidth //1920
...
tagCamReg32_t regs_s5k4ecgx_preview_1280_960[]={
	{0xFCFC, 0xD000},
...
tagCamReg32_t regs_s5k4ecgx_preview_1024_768[]=
{
     {0xFCFC, 0xD000},
...
tagCamReg32_t regs_s5k4ecgx_preview_720_720[]=
{
        {0xFCFC, 0xD000},
	...
	{0x002A, 0x0494},
	{0x0F12, 0x0780},	//REG_TC_PZOOM_PrevZoomReqInputWidth //2560
    {0x0F12, 0x0780},	//REG_TC_PZOOM_PrevZoomReqInputHeight //1920
	{0x0F12, 0x0000},	//REG_TC_PZOOM_PrevZoomReqInputWidthOfs
	{0x0F12, 0x0000},	//REG_TC_PZOOM_PrevZoomReqInputHeightOfs
...
/*4:3 maximum preview setting*/

tagCamReg32_t regs_s5k4ecgx_preview_1288_966[]={
	{0xFCFC, 0xD000},
	{0x0028, 0xD000},
	{0x002A, 0xE410},
	{0x0F12, 0x3E01},
	...
	{0x0F12, 0x0000}, /*REG_TC_PZOOM_PrevZoomReqInputHeightOfs */                    
	{0x002A, 0x02A6},
	{0x0F12, 0x0508}, /*REG_0TC_PCFG_usWidth //1288 */  
	{0x0F12, 0x03C6}, /*REG_0TC_PCFG_usHeight //966 */             
...
/*5:3 maximum preview setting*/

tagCamReg32_t regs_s5k4ecgx_preview_1288_772[]={
	{0xFCFC, 0xD000},
	{0x0028, 0xD000},
	{0x002A, 0xE410},
	{0x0F12, 0x3E01},
	...
	{0x002A, 0x0250},
	{0x0F12, 0x0A10}, /*REG_TC_GP_PrevReqInputWidth //2576 */        
	{0x0F12, 0x0608}, /*REG_TC_GP_PrevReqInputHeight //1544 */       
	{0x0F12, 0x0008}, /*REG_TC_GP_PrevInputWidthOfs //(2592-2576)/2*/
	{0x0F12, 0x00C8}, /*REG_TC_GP_PrevInputHeightOfs/(1944-1544/2*/                 
	{0x002A, 0x0262},
	{0x0F12, 0x0001}, /*REG_TC_GP_bUseReqInputInPre */             
	{0x002A, 0x0494},
	{0x0F12, 0x0A10}, /*REG_TC_GP_PrevReqInputWidth //2576 */        
	...
	{0x002A, 0x02A6},
	{0x0F12, 0x0508}, /*REG_0TC_PCFG_usWidth //1288 */  
	{0x0F12, 0x0304}, /*REG_0TC_PCFG_usHeight //772 */             
...
/*1:1 maximum preview setting*/

tagCamReg32_t regs_s5k4ecgx_preview_964_964[]={
	{0xFCFC, 0xD000},
	{0x0028, 0xD000},
	{0x002A, 0xE410},
	{0x0F12, 0x3E01},
	...
	{0x0F12, 0x0AB0}, /*senHal_uMinColsNoBin */                 
	{0x002A, 0x0250},
	{0x0F12, 0x0788}, /*REG_TC_GP_PrevReqInputWidth //1928 */        
	{0x0F12, 0x0788}, /*REG_TC_GP_PrevReqInputHeight //1928 */       
	{0x0F12, 0x014C}, /*REG_TC_GP_PrevInputWidthOfs //(2592-1928)/2*/
	{0x0F12, 0x0008}, /*REG_TC_GP_PrevInputHeightOfs/(1944-1928)/2*/                 
	{0x002A, 0x0262},
	{0x0F12, 0x0001}, /*REG_TC_GP_bUseReqInputInPre */             
	{0x002A, 0x0494},
	{0x0F12, 0x0788}, /*REG_TC_GP_PrevReqInputWidth //1928 */        
	...
	{0x0F12, 0x0000}, /*REG_TC_PZOOM_PrevZoomReqInputHeightOfs */                    
	{0x002A, 0x02A6},
	{0x0F12, 0x03C4}, /*REG_0TC_PCFG_usWidth //964 */  
	{0x0F12, 0x03C4}, /*REG_0TC_PCFG_usHeight //964 */             
...
// 5M[4:3] Capture_150331
tagCamReg32_t regs_s5k4ecgx_capture_2576_1932[]=
{
	{0xFCFC, 0xD000},

	{0x0028, 0x7000},
	{0x002A, 0x0258},
	{0x0F12, 0x0A10},		/*REG_TC_GP_CapReqInputWidth 2576 */
	{0x0F12, 0x078C},		/*REG_TC_GP_CapReqInputHeight 1932 */
	{0x0F12, 0x0008},		/*REG_TC_GP_CapInputWidthOfs (2592-2576)/2 */
	{0x0F12, 0x0006},		/*REG_TC_GP_CapInputHeightOfs (1944-1932)/2 */

	{0x002A, 0x0264},
	{0x0F12, 0x0001},		/*REG_TC_GP_bUseReqInputInCap */

	{0x002A, 0x049C},
	{0x0F12, 0x0A10},		/*REG_TC_PZOOM_CapZoomReqInputWidth 2576 */
	{0x0F12, 0x078C},		/*REG_TC_PZOOM_CapZoomReqInputHeight 1932 */
	{0x0F12, 0x0000},		/*REG_TC_PZOOM_CapZoomReqInputWidthOfs */
	{0x0F12, 0x0000},		/*REG_TC_PZOOM_CapZoomReqInputHeightOfs */
...
// 3.9M [1:1] Wide Capture _ 150331_
tagCamReg32_t regs_s5k4ecgx_capture_2576_1544[]=
{
	{0xFCFC, 0xD000},
	...
	{0x002A, 0x0258},
	{0x0F12, 0x0A10},		/*REG_TC_GP_CapReqInputWidth 2576 */
	{0x0F12, 0x0608},		/*REG_TC_GP_CapReqInputHeight 1544 */
	{0x0F12, 0x0008},		/*REG_TC_GP_CapInputWidthOfs (2592-2576)/2 */
	{0x0F12, 0x00C8},		/*REG_TC_GP_CapInputHeightOfs (1944-1544)/2 */
	...
	{0x002A, 0x049C},
	{0x0F12, 0x0A10},		/*REG_TC_PZOOM_CapZoomReqInputWidth 2576 */
	{0x0F12, 0x0608},		/*REG_TC_PZOOM_CapZoomReqInputHeight 1544 */
	{0x0F12, 0x0000},		/*REG_TC_PZOOM_CapZoomReqInputWidthOfs */
	{0x0F12, 0x0000},		/*REG_TC_PZOOM_CapZoomReqInputHeightOfs */
	...
	{0x002A, 0x0398},
	{0x0F12, 0x0A10},	//REG_0TC_CCFG_usWidth //2576
	{0x0F12, 0x0608},	//REG_0TC_CCFG_usHeight //1544
...
// 3.7M [1:1] Wide Capture _ 150331_
tagCamReg32_t regs_s5k4ecgx_capture_1928_1928[]=
{
	{0xFCFC, 0xD000},

	{0x0028, 0x7000},
	{0x002A, 0x0258},
	{0x0F12, 0x0788},		/*REG_TC_GP_CapReqInputWidth 1928 */
	{0x0F12, 0x0788},		/*REG_TC_GP_CapReqInputHeight 1928 */
	{0x0F12, 0x014C},		/*REG_TC_GP_CapInputWidthOfs (2592-1928)/2 */
	{0x0F12, 0x0008},		/*REG_TC_GP_CapInputHeightOfs (1944-1928)/2 */

	{0x002A, 0x0264},
	{0x0F12, 0x0001},		/*REG_TC_GP_bUseReqInputInCap */

	{0x002A, 0x049C},
	{0x0F12, 0x0788},		/*REG_TC_PZOOM_CapZoomReqInputWidth 1928 */
	{0x0F12, 0x0788},		/*REG_TC_PZOOM_CapZoomReqInputHeight 1928 */
	{0x0F12, 0x0000},		/*REG_TC_PZOOM_CapZoomReqInputWidthOfs */
	{0x0F12, 0x0000},		/*REG_TC_PZOOM_CapZoomReqInputHeightOfs */
	
	{0x002A, 0x047C},
	{0x0F12, 0x0001},	//REG_TC_THUMB_Thumb_bActive
	{0x0F12, 0x01E0},		/*REG_TC_THUMB_Thumb_uWidth 480 */
	{0x0F12, 0x01E0},		/*REG_TC_THUMB_Thumb_uHeight 480 */
	
	{0x002A, 0x0398},
	{0x0F12, 0x0788},	//REG_0TC_CCFG_usWidth //1928
	{0x0F12, 0x0788},	//REG_0TC_CCFG_usHeight //1928
...
// 3.1M[4:3] Capture_150331
tagCamReg32_t regs_s5k4ecgx_capture_2036_1526[]=
{
	{0xFCFC, 0xD000},
	...
	{0x002A, 0x0398},
	{0x0F12, 0x07F4},		/*REG_0TC_CCFG_usWidth 2036 */
	{0x0F12, 0x05F6},		/*REG_0TC_CCFG_usHeight 1526 */
...
// 2M[4:3] Capture_150331
tagCamReg32_t regs_s5k4ecgx_capture_1632_1218[]=
{
	{0xFCFC, 0xD000},
	...
	{0x002A, 0x0398},
	{0x0F12, 0x0660},		/*REG_0TC_CCFG_usWidth 1632 */
	{0x0F12, 0x04C2},		/*REG_0TC_CCFG_usHeight 1218 */
...
tagCamReg32_t regs_s5k4ecgx_capture_1920_1920[]=
{
	{0xFCFC, 0xD000},

	{0x0028, 0x7000},
	{0x002A, 0x0258},
	{0x0F12, 0x078C},		/*REG_TC_GP_CapReqInputWidth 1932 */
	{0x0F12, 0x078C},		/*REG_TC_GP_CapReqInputHeight 1932 */
	{0x0F12, 0x014A},		/*REG_TC_GP_CapInputWidthOfs (2592-1932)/2 */
	{0x0F12, 0x0006},		/*REG_TC_GP_CapInputHeightOfs (1944-1932)/2 */
	...
	{0x002A, 0x049C},
	{0x0F12, 0x078C},		/*REG_TC_PZOOM_CapZoomReqInputWidth 1932 */
	{0x0F12, 0x078C},		/*REG_TC_PZOOM_CapZoomReqInputHeight 1932 */
	{0x0F12, 0x0000},		/*REG_TC_PZOOM_CapZoomReqInputWidthOfs */
	{0x0F12, 0x0000},		/*REG_TC_PZOOM_CapZoomReqInputHeightOfs */
	...
	{0x002A, 0x0398},
	{0x0F12, 0x0780},		/*REG_0TC_CCFG_usWidth 1920 */
	{0x0F12, 0x0780},		/*REG_0TC_CCFG_usHeight 1920 */
...
tagCamReg32_t s5k4ec_anti_banding_flicker_50[]=
{
{0x0028, 0x7000},
{0x002a, 0x04e6},
{0x0f12, 0x075f},
...
//	60HZ
// ==========================================================
tagCamReg32_t s5k4ec_anti_banding_flicker_60[]=
{
{0x0028, 0x7000},
{0x002a, 0x04e6},
{0x0f12, 0x075f},
...
//	50HZ
// ==========================================================
tagCamReg32_t regs_s5k4ecgx_50hz_auto[]=
{
{0x002A, 0x0F30},
{0x0F12, 0x0001}, ///*AFC_D_ConvAccelerPower */
{0x002A, 0x0F2A},
...
tagCamReg32_t regs_s5k4ecgx_50hz_fixed[]=
{
{0x002A, 0x0F30},
{0x0F12, 0x0001}, ///*AFC_D_ConvAccelerPower */
{0x002A, 0x04E6},
...
//	60HZ
// ==========================================================
tagCamReg32_t regs_s5k4ecgx_60hz_auto[]=
{
{0x002A, 0x0F30},
{0x0F12, 0x0001}, ///*AFC_D_ConvAccelerPower */
{0x002A, 0x0F2A},
...
tagCamReg32_t regs_s5k4ecgx_60hz_fixed[]=
{
{0x002A, 0x0F30},
{0x0F12, 0x0001}, ///*AFC_D_ConvAccelerPower */
{0x002A, 0x04E6},
...
tagCamReg32_t regs_s5k4ecgx_stream_off[]=
{
{0x0028, 0x7000},
{0x002a, 0x023e},
{0x0F12, 0x0000},
