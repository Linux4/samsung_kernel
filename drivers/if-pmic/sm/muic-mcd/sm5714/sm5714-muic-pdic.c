...
#if IS_ENABLED(CONFIG_MUIC_NOTIFIER_SM5714)
...
#endif
#if IS_ENABLED(CONFIG_USB_TYPEC_MANAGER_NOTIFIER_SM5714)
#include <linux/usb/typec/manager/sm/usb_typec_manager_notifier.h>
#endif
