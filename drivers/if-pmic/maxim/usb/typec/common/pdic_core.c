...
EXPORT_SYMBOL(ccic_register_switch_device);
...
EXPORT_SYMBOL(ccic_send_dock_intent);
...
EXPORT_SYMBOL(ccic_send_dock_uevent);
...
EXPORT_SYMBOL(ccic_core_register_chip);
...
EXPORT_SYMBOL(ccic_core_unregister_chip);
...
EXPORT_SYMBOL(ccic_core_get_drvdata);
