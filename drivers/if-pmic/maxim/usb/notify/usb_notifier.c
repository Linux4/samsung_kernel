...
#endif
#if defined(CONFIG_CCIC_NOTIFIER) || IS_ENABLED(CONFIG_PDIC_NOTIFIER)
#include <linux/usb/typec/common/pdic_notifier.h>
#endif
#if defined(CONFIG_MUIC_NOTIFIER) || IS_ENABLED(CONFIG_MUIC_NOTIFIER_SM5714)
#include <linux/muic/muic.h>
#include <linux/muic/muic_notifier.h>
#endif
#if defined(CONFIG_VBUS_NOTIFIER) || IS_ENABLED(CONFIG_VBUS_NOTIFIER_SM5714)
#include <linux/vbus_notifier.h>
#endif
#if defined(CONFIG_USB_TYPEC_MANAGER_NOTIFIER) || IS_ENABLED(CONFIG_USB_TYPEC_MANAGER_NOTIFIER_SM5714)
...
#endif
#elif defined(CONFIG_MUIC_NOTIFIER) || IS_ENABLED(CONFIG_MUIC_NOTIFIER_SM5714)
