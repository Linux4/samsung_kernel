...
void ilitek_resume_by_ddi(void)
{
	...
	mutex_lock(&ilits->touch_mutex);
	ilits->tp_suspend = false;
	/*F52 Lite code for SR-QN3979-01-144 by fengzhigang at 20210204 start*/
	if (!ilits->gesture){
		#if ILI_POWER_SOURCE_CUST_EN
			ili_lcm_power_source_ctrl(ilits, 1);//enable vsp/vsn
			ILI_INFO("tp resume enable vsp/vsn\n");
		#endif
	}
	/*F52 Lite code for SR-QN3979-01-144 by fengzhigang at 20210204 end*/
...
int ili_set_tp_data_len(int format, bool send, u8* data)
{
	...
	u16 self_key = 2;
/*F52 Lite code for P210302-05023  by fengzhigang at 20210312 start*/
...
#if AXIS_PACKET
	demo_mode_packet_len += P5_X_DEMO_MODE_PACKET_INFO_LEN +
			P5_X_DEMO_MODE_AXIS_LEN + P5_X_DEMO_MODE_STATE_INFO;
#endif
/*F52 Lite code for P210302-05023  by fengzhigang at 20210312 end*/
	switch (format) {
	/*F52 Lite code for SR-QN3979-01-801  by fengzhigang at 20210329 start*/
...
/*F52 Lite code for P210302-05023  by fengzhigang at 20210312 end*/
	...
	case DATA_FORMAT_GESTURE_SPECIAL_DEMO:
		...
		/*F52 Lite code for SR-QN3979-01-801  by fengzhigang at 20210329 end*/
...
int ili_report_handler(void)
{
	...
	if (checksum != pack_checksum && pid != P5_X_I2CUART_PACKET_ID) {
		...
		/*F52 Lite code for QN3979-329 by fengzhigang at 20210225 start*/
		//debug_en = DEBUG_ALL;
		//ili_dump_data(trdata, 8, rlen, 0, "finger report with wrong");
		/*F52 Lite code for QN3979-329 by fengzhigang at 20210225 end*/
		debug_en = tmp;
		ret = -EINVAL;
		goto out;
	}
...
static int ilitek_get_tp_module(void)
{
	...
	// 	ILI_INFO("cmdline:%s\n", panel_name);
	// }
	// if (NULL != strstr(panel_name, "mdss_dsi_ili7807s_txd_120hz_fhd_dsc_video")){
	// 	fw_num = MODEL_TXD;
	// }
...
int ili_tddi_init(void)
{
	...
	/*F52 Lite code for SR-QN3979-01-144 by fengzhigang at 20210203 start*/
	ilitek_tddi_wq_init();
	/*F52 Lite code for SR-QN3979-01-144 by fengzhigang at 20210203 end*/
