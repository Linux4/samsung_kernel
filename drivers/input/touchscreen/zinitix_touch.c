...
#define BT532_PALM_INTERNAL_FLAG			0x0017
...
static void cover_set(struct bt532_ts_info *info, int state){
	...
	if(state == COVER_OPEN){
		...
		cap->threshold=(u16)(80);
		write_data(info->client, BT532_THRESHOLD, (u8 *)&cap->threshold, 2);
		cap->palm_internal_flag=0xA5B4;
		write_data(info->client,BT532_PALM_INTERNAL_FLAG, (u8 *)&cap->palm_internal_flag ,2);
		...
		cap->threshold=(u16)(60);
		write_data(info->client, BT532_THRESHOLD, (u8 *)&cap->threshold, 2);
		cap->palm_internal_flag=0xA504;
		write_data(info->client,BT532_PALM_INTERNAL_FLAG, (u8 *)&cap->palm_internal_flag ,2);
		read_data(info->client, ZINITIX_INTERNAL_FLAG_02, (u8 *)&reg_val, 2);
