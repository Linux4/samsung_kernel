...
#define SEC_DND_FREQUENCY			106 /* 200khz */
#define SEC_PDND_FREQUENCY			72 /* 303khz */
...
void zinitix_vdd_on(struct bt532_ts_info *info,bool onoff)
{
	...
	pr_info("%s: vddo: %d vdd_en: %d\n", __func__,
			...
			gpio_get_value(info->pdata->gpio_ldo_en));
