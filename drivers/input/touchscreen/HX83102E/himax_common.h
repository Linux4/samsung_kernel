...
#define SEC_TSP_FEATURE
#endif

#define HIMAX_DRIVER_VER "2.0.0.81_N29_01"
...
#define HX_USB_DETECT_GLOBAL//bug752760,fangzhihua.wt,open,20220617,for USB detect
...
/******* SPI-end *******/
	...
	//+bug752760,fangzhihua.wt,mod,20220518,fix doubleclick fail to wakeup sometimes
