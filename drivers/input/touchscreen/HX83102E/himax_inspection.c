...
extern char hx_touch_test_time[40];  //bug696971,fangzhihua.wt,add, 20220311,for TP openshort test result save
...
static int himax_self_test_data_init(void)
{
	...
	snprintf(g_file_path, (int)(strlen(HX_RSLT_OUT_PATH)
			+ strlen(HX_RSLT_OUT_FILE)+strlen(hx_touch_test_time)+5),
			"%s%s_%s.txt", HX_RSLT_OUT_PATH, HX_RSLT_OUT_FILE,hx_touch_test_time);
	//-bug696971,fangzhihua.wt,add, 20220311,for TP openshort test result save
	file_w_flag = true;
	return ret;
