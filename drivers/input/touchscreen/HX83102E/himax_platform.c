...
#ifdef CONFIG_PANEL_NOTIFIER
static int himax_notifier_callback(struct notifier_block *self, unsigned long event, void *data);
#endif
...
#ifdef CONFIG_PANEL_NOTIFIER
static int himax_notifier_callback(struct notifier_block *self,
...
#ifdef CONFIG_PANEL_NOTIFIER
	ts->panel_notif.notifier_call = himax_notifier_callback;
