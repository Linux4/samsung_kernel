...
static int syna_ccic_notification(struct notifier_block *nb, unsigned long action, void *data);
#endif
static int syna_vbus_notification(struct notifier_block *nb, unsigned long cmd, void *data);
#endif
