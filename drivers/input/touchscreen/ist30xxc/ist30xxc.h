...
#if defined(CONFIG_MACH_SS_SHARKLT8) || defined(CONFIG_MACH_SS_SHARKLT8LIGHTSLEEP) || defined(CONFIG_MACH_J3XLTE) || defined(CONFIG_MACH_J3XNLTE)
...
/* i2c setting */
// I2C Device info
#define IST30XX_DEV_NAME		"IST3038C"
...
void ist30xx_set_ta_mode(int charging);
