...
#define SEC_TS_DEFAULT_ENABLE_BIT_SETFUNC	\
	(SEC_TS_BIT_SETFUNC_TOUCH | SEC_TS_BIT_SETFUNC_PALM | SEC_TS_BIT_SETFUNC_WET)
...
#define SEC_TS_I2C_RETRY_CNT		2	/*old value is 3*/
#define SEC_TS_WAIT_RETRY_CNT		5	/*old value is 100*/
