...
#define FTS_REG_POCKET_MODE		0xB2

#define FTS_POWER_MODE_FOD		(1 << 1)
#define FTS_POWER_MODE_POCKET			(1 << 2)
#define FTS_POWER_MODE_EAR_DETECT		(1 << 3)
#define FTS_POWER_MODE_SWIPE		(1 << 4)
#define FTS_POWER_MODE_SINGLE_TAP	(1 << 5)
#define FTS_POWER_MODE_AOD	(1 << 6)
#define FTS_POWER_MODE_DOUBLETAP_TO_WAKEUP	(1 << 7)

#define FTS_REG_HOST_POWER_MODE 		0xB5
#define FTS_REG_HOST_POWER_MODE_STATUS	0xB6

#define FTS_REG_SPAY_EN			0xC4
#define FTS_REG_SINGLETAP_EN	0xC5
#define FTS_REG_AOD_EN	        0xC6
#define FTS_REG_AOD_RECT	    0xC7
#define FTS_REG_DOUBLETAP_TO_WAKEUP_EN	0xD1
#define FTS_REG_FOD_RECT			0xCD
#define FTS_REG_FOD_MODE			0xCF

#define POCKET_DATA_REG		0xC9
#define PROXIMITY_DATA_REG	0x8D

#define FOD_EVENT_REG	0xE1
#define FOD_TX_NUM		0xE2
#define FOD_RX_NUM		0xE3
#define FOD_VI_SIZE		0xE4
#define FOD_VI_DATA		0xE5

#define FTS_REG_REFRESH_RATE 		0x88

#define FTS_REG_CHARGER_MODE_EN 		0x8B

#define GESTURE_SINGLETAP_EN                    0x01
#define GESTURE_DOUBLECLICK_EN                  0x02
#define GESTURE_SPAY_EN                         0x04
#define GESTURE_FOD_EN                          0x08
#define GESTURE_AOD_EN                          0x10
...
#define FTS_REG_SNR_TEST_RESULT2		0x74
...
#define FTS_REG_GRIP_LANDSCAPE_GRIP_ZONE	0x63
#define FTS_REG_GRIP_LANDSCAPE_REJECT_ZONE	0x64
...
#define FTS_APP_VER_INFO_OFFSET			0x120
...
#define FACTORY_REG_RAWADDR_SET			0xAA
