...
/*****************************************************************************
*
* File Name: focaltech_upgrade_ft3519.c
*
...
#include "focaltech_pramboot.h"

/*****************************************************************************
* Private constant and macro definitions using #define
*****************************************************************************/
/************************************************************************
* Name: fts_ft3519_upgrade
* Brief:
* Input:
* Output:
* Return: return 0 if success, otherwise return error code
***********************************************************************/
static int fts_ft3519_upgrade(u8 *buf, u32 len)
{
	int ret = 0;
	u32 start_addr = 0;
	u8 cmd[4] = { 0 };
	...
	/* write app */
	start_addr = upgrade_func_ft3519.appoff;
...
struct upgrade_func upgrade_func_ft3519 = {
	.ctype = {0x89},
	.fwveroff = 0x010E,
	.fwcfgoff = 0x1FFB0,
	.appoff = 0x0000,
