...
#define TSP_EXTERNAL_FW		"/sdcard/Firmware/Tsp/tsp.bin"
#define TSP_EXTERNAL_FW_SIGNED	"/sdcard/Firmware/Tsp/tsp_signed.bin"
...
extern void himax_set_cover_mode(struct himax_ts_data *ts, bool closed);
