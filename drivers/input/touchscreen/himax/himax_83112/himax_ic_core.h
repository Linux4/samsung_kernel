...
#define FW_EDGE_BORDER_CASE1					0x05	// 5px
#define FW_EDGE_BORDER_OFF						0x00
#define FW_EDGE_BORDER_ADDR						0x1000728C
#define FW_EDGE_SHIFT_ON						0x11
#define FW_EDGE_SHIFT_ADDR						0x10007FF4
#define FW_SET_BENDING_FOR_FAC					0x10007FE8
#define FW_SET_FACTORY_ON					0x01
#define FW_SET_FACTORY_OFF					0x00
...
struct fw_operation {
	...
	uint8_t addr_edge_shift[4];
	uint8_t addr_edge_border[4];
	uint8_t addr_bending_factory[4];
	uint8_t addr_cal[4];
...
/*void (*fp_flash_write_burst_lenth)(uint8_t *reg_byte, uint8_t *write_data, uint32_t length);*/
	...
	int (*set_bending_algo_for_factory) (int set_val);
