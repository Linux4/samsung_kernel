...
#define HIMAX_DRIVER_VER "1.2.2.73_SEC_A21S_04"
...
#define HX_ABS(x) (x < 0) ? 0 - x : x

#define HX_ADR_RAW_FLASH 0x1A000
#define HX_SZ_4K 0x1000
#define HX_1K 0x400

#define HX_EVENT_STCK_HEADR 4
#ifdef HX_SP_INFO
#define HX_SP_INFO_SZ 20
#define HX_SP_INFO_CHK_SZ 2
#else
#define HX_SP_INFO_SZ 0
#define HX_SP_INFO_CHK_SZ 0
#endif
...
extern unsigned int hx_bootmode;
