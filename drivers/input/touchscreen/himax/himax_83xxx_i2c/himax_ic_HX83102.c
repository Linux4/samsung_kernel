	...
	for (i = 0; i < 5; i++) {
		...
		if ((tmp_data[3] == 0x83) && (tmp_data[2] == 0x10) && ((tmp_data[1] == 0x2a) || (tmp_data[1] == 0x2b) || (tmp_data[1] == 0x2d))) {
			if (tmp_data[1] == 0x2a) {
				...
				ic_data->dsram_size = hx83102d_dsram_size;
				ic_data->isram_size = hx83102d_isram_size;
				ic_data->dsram_addr = hx83102d_dsram_addr;
				ic_data->isram_addr = hx83102d_isram_addr;
			}
