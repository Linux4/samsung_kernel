...
static bool hx83102_sense_off(bool check_en)
{
	...
	do {
		...
		KI("%s: Check enter_save_mode data[0]=0x%X, 0x%X 0x%X 0x%X\n", __func__, tmp_data[0], tmp_data[1], tmp_data[2], tmp_data[3]);
...
static void himax_hx83102e_reg_re_init(void)
{
	...
	himax_in_parse_assign_cmd(hx83102e_fw_addr_gesture_history, pfw_op->addr_gesture_history, sizeof(pfw_op->addr_gesture_history));
#endif
}
