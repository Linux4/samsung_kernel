...
//	himax_in_parse_assign_cmd(FW_CAL_ADDR, pfw_op->addr_cal, sizeof(pfw_op->addr_cal));
	...
	pfw_op->addr_grip_zone = HX122A_ADDR_GRIP_ZONE;
	pfw_op->addr_reject_zone = HX122A_ADDR_REJECT_ZONE;
	pfw_op->addr_reject_zone_boud = HX122A_ADDR_REJECT_ZONE_BOUD;
	pfw_op->addr_except_zone = HX122A_ADDR_EXCEPT_ZONE;
