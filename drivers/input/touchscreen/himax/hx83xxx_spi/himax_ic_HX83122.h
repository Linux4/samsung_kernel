...
#define hx83122a_addr_osr_ctrl		(hx122a_cfg_base + 0x1c4) //0x100071c4
#define hx83122a_addr_snr_measurement (hx122a_func_base + 0x30) //0x10007f30
#define hx83122a_addr_reject_idle		(hx122a_func_base + 0xD4) //0x10007FD4
