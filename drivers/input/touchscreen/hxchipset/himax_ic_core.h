...
/* CORE_FW */
	...
	#define fw_addr_ap_nodfy_fw_sus				  0x10007FD0
	#define fw_data_ap_nodfy_fw_sus_en			  0xA55AA55A
	#define fw_data_ap_nodfy_fw_sus_dis			  0x00000000
...
struct fw_operation {
	...
	uint8_t addr_ap_nodfy_fw_sus[4];
	uint8_t data_ap_nodfy_fw_sus_en[4];
	uint8_t data_ap_nodfy_fw_sus_dis[4];
...
/* CORE_FW */
	...
	int (*fp_chip_self_test_for_hq)(void);
