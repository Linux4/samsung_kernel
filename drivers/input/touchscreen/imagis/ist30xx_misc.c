...
static DEVICE_ATTR(max_fingers, MISC_DEFAULT_ATTR, ist30xx_fingers_show, ist30xx_fingers_store);
static DEVICE_ATTR(max_keys, MISC_DEFAULT_ATTR, ist30xx_keys_show, ist30xx_keys_store);
