...
static void synaptics_rmi4_remove_factory_mode(struct synaptics_rmi4_data *rmi4_data)
{
	...
	device_destroy(sec_class, f54->factory_data->fac_dev_ts->devt);
...
static int synaptics_rmi4_init_factory_mode(struct synaptics_rmi4_data *rmi4_data)
{
	...
	factory_data->fac_dev_ts = device_create(sec_class, NULL,
					(dev_t)&factory_data->fac_dev_ts,
...
exit_sec_device_create:
	device_destroy(sec_class, factory_data->fac_dev_ts->devt);
