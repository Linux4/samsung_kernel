...
unsigned char CTPM_FW_TXD_CD_ILI7807G[] = {
	#include "firmware/SMS1871_TXD-CD_639_LongH_V0xCD.0x12.0x00_AP_0x04.0x00_MP_20200414.ili"
};
/*HS70 code for txd-cd bringup by gaozhengwei at 2020/03/26 end*/
...
unsigned char CTPM_FW_TXD_ILI7807G[] = {
	#include "firmware/SMS1871_TXD_639_LongH_V0xCD.0x11.0x00_AP_0x04.0x00_MP_20200414.ili"
};
