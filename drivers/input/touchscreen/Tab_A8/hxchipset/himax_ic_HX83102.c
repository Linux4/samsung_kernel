...
static void hx83102e_sense_on(uint8_t FlashMode)
{
	...
	/*msleep(20);*/
	/*Tab A8 code for AX6300DEV-805 by suyurui at 2021/10/11 start*/
	usleep_range(100, 101);
	/*Tab A8 code for AX6300DEV-805 by suyurui at 2021/10/11 end*/
	if (!FlashMode) {
	...
	for (i = 0; i < 5; i++) {
		...
		|| (tmp_data[1] == 0x2e))) {
			if (tmp_data[1] == 0x2a) {
				...
				g_fw_boot_upgrade_name =  private_ts->himax_nomalfw_rq_name;
				g_fw_mp_upgrade_name = private_ts->himax_mpfw_rq_name;
