...
struct nvt_ts_mem_map {
	u32 EVENT_BUF_ADDR;
	u32 RAW_PIPE0_ADDR;
	u32 RAW_PIPE0_Q_ADDR;
	u32 RAW_PIPE1_ADDR;
	u32 RAW_PIPE1_Q_ADDR;
	u32 BASELINE_ADDR;
	u32 BASELINE_Q_ADDR;
	u32 BASELINE_BTN_ADDR;
	u32 BASELINE_BTN_Q_ADDR;
	u32 DIFF_PIPE0_ADDR;
	u32 DIFF_PIPE0_Q_ADDR;
	u32 DIFF_PIPE1_ADDR;
	u32 DIFF_PIPE1_Q_ADDR;
	u32 RAW_BTN_PIPE0_ADDR;
	u32 RAW_BTN_PIPE0_Q_ADDR;
	u32 RAW_BTN_PIPE1_ADDR;
	u32 RAW_BTN_PIPE1_Q_ADDR;
	u32 DIFF_BTN_PIPE0_ADDR;
	u32 DIFF_BTN_PIPE0_Q_ADDR;
	u32 DIFF_BTN_PIPE1_ADDR;
	u32 DIFF_BTN_PIPE1_Q_ADDR;
