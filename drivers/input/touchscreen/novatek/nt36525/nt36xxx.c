...
//real_glove_mode for active model
	platdata->real_glove_mode = of_property_read_bool(np, "novatek,real_glove_mode");
	input_info(true, dev, "%s: real glove mode %s\n",
				__func__, platdata->real_glove_mode ? "ON" : "OFF");
