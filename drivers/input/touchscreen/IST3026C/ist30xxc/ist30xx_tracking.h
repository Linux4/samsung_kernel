...
#define IST30XXC_RINGBUF_NO_ERR      (0)
#define IST30XXC_RINGBUF_NOT_ENOUGH  (1)
#define IST30XXC_RINGBUF_EMPTY       (2)
#define IST30XXC_RINGBUF_FULL        (3)
#define IST30XXC_RINGBUF_TIMEOUT     (4)
#define IST30XXC_MAX_LOG_SIZE        (4 * 100 * 1024)    // 4bytes * 100Kbytes, Single touch: about 12minutes
...
#define IST30XXC_TRACKING_MAGIC     (0x7750 << 16)


typedef struct _IST30XXC_RINGBUF {
	u32	RingBufCtr; // Number of characters in the ring buffer
	u32	RingBufInIdx;
	u32	RingBufOutIdx;
	u8	LogBuf[IST30XXC_MAX_LOG_SIZE];        // Ring buffer for status
} IST30XXC_RING_BUF;
