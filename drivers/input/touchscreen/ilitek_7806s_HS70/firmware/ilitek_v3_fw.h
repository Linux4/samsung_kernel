...
#define TM_INI_NAME_PATH		"/vendor/firmware/mp_tm_ili7806s.ini"
#define TM_FW_FILP_PATH                 "/sdcard/ILITEK_FW"
#define TM_INI_REQUEST_PATH		"mp_tm_ili7806s.ini"
#define TM_FW_REQUEST_PATH		"ILITEK_FW"
static unsigned char CTPM_FW_TM[] = {
	#include "TM_639_LongH_V0x16_0x03_0x00_AP_0x02_MP_20200914.ili"
};
