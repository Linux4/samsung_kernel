...
#if defined(CONFIG_MACH_SS_SHARKLT8) || defined(CONFIG_MACH_SS_SHARKLT8LIGHTSLEEP)|| defined(CONFIG_MACH_SP9830I_J3LTE)  || defined(CONFIG_MACH_J2XLTE) || defined(CONFIG_MACH_TABELTE) || defined(CONFIG_MACH_SHARKLS_J3VLT) || defined(CONFIG_MACH_J3XNLTE)
