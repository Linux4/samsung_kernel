/*
 * MELFAS MMS500 Touchscreen Driver
 *
 * Copyright (C) 2014 MELFAS Inc.
 *
 */

#ifndef __MELFAS_MMS500_H
#define __MELFAS_MMS500_H
...
#elif defined(CONFIG_TOUCHSCREEN_MELFAS_MMS549)
#define CHIP_MMS500
#define CHIP_NAME		"MMS500"
#define CHIP_FW_CODE		"M5H0"
#define FW_UPDATE_TYPE		"MMS500"
#endif
...
struct mms_ts_info {
	...
	struct delayed_work work_flash_count;
	struct delayed_work work_write_flash_count;
	int create_file;
	int flash_alert_cnt;
	struct wake_lock wakelock_write;
