...
#define FW_IMAGE_NAME "td4375_txd_jdi_firmware.img"
...
static int zeroflash_get_fw_image(void)
{
    ...
    /*hs14 code for AL6528A-467 by hehaoran5 at 20220909 start*/
    if (zeroflash_hcd->image == NULL) {
        retval = request_firmware(&zeroflash_hcd->fw_entry,
                tcm_hcd->tp_firmware_name,
    ...
    /*hs14 code for AL6528A-467 by hehaoran5 at 20220909 end*/
    LOGD(tcm_hcd->pdev->dev.parent,
...
exit:
    LOGN(tcm_hcd->pdev->dev.parent,"End of config download\n");
