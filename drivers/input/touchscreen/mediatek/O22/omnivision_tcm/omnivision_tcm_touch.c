...
/*hs14 code for AL6528A-607 by hehaoran5 at 20221104 end*/
    ...
    /*hs14 code for AL6528A-183 by hehaoran5 at 20220928 start*/
    if (tcm_hcd->tp_is_enabled == 0) {
        goto exit;
    }
    /*hs14 code for AL6528A-183 by hehaoran5 at 20220928 end*/
...
static int ovt_tcm_input_open(struct input_dev *dev)
{
    touch_hcd->tcm_hcd->tp_is_enabled = 1;
    return 0;
}

static void ovt_tcm_input_close(struct input_dev *dev)
{
    touch_hcd->tcm_hcd->tp_is_enabled = 0;
}
...
static int touch_set_input_dev(void)
{
    ...
    /*hs14 code for AL6528A-13 by hehaoran5 at 20220901 start*/
    touch_hcd->input_dev->open = ovt_tcm_input_open;
    touch_hcd->input_dev->close = ovt_tcm_input_close;
    /*hs14 code for AL6528A-13 by hehaoran5 at 20220901 end*/
