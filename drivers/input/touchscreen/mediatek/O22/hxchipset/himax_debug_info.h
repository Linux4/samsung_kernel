...
#define HELP_FLASH_DUMP "flash_dump:\n"\
HX_TAB "echo [flash/ram],[print/file],[size],[address] > flash_dump\n"\
HX_TAB "If using flash, you don't need to setup size and address\n"\
HX_TAB "ex1: echo flash,print > flash_dump\n"\
HX_TAB "ex2: echo ram,file,65536,20000000 > flash_dump\n"
