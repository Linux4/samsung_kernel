...
static int hx_panel_coords[4] = {0, 799, 0, 1339};
...
/*TabA7 Lite code for SR-AX3565-01-840 by liupengtao at 20210524 start*/
static int himax_get_tp_module(void)
{
    int fw_num = 0;
    char *command_line = saved_command_line;

    if (NULL != strstr(command_line, "hx83102e_hlt_hsd")){
        fw_num = MODEL_HLT_HSD;
    } else if(NULL != strstr(command_line, "hx83102e_liansi_mdt")){
        fw_num = MODEL_LS_MDT;
    /*TabA7 Lite code for OT8-5213 by huangzhongjie at 20211022 start*/
    } else if(NULL != strstr(command_line, "hx83102e_copper_hlt_hsd")) {
        fw_num = MODEL_COPPER_HLT_HSD;
    /*TabA7 Lite code for OT8-5213 by huangzhongjie at 20211022 end*/
    	/*TabA7 Lite code for OT8-5316 by suyurui at 20220217 start*/
    } else if(NULL != strstr(command_line, "hx83102e_gx_hsd")) {
        fw_num = MODEL_GX_HSD;
    /*TabA7 Lite code for OT8-5316 by suyurui at 20220217 end*/
		/*TabA7 Lite code for OT8-5321 by suyurui at 20220217 start*/
    } else if(NULL != strstr(command_line, "hx83102e_hy_mdt")) {
        fw_num = MODEL_HY_MDT;
    /*TabA7 Lite code for OT8-5321 by suyurui at 20220217 end*/
	} else
...
static void himax_update_module_info(void)
{
    ...
    {
    case MODEL_HLT_HSD:
            strcpy(ts->himax_name,"hx83102e_hlt_hsd");
            strcpy(ts->himax_nomalfw_rq_name, "Himax_hsd_firmware.bin");
            strcpy(ts->himax_mpfw_rq_name, "Himax_hsd_mpfw.bin");
            strcpy(ts->himax_csv_name, "hx_hsd_criteria.csv");
            break;
    case MODEL_LS_MDT:
            strcpy(ts->himax_name,"hx83102e_liansi_mdt");
            strcpy(ts->himax_nomalfw_rq_name, "Himax_mdt_firmware.bin");
            strcpy(ts->himax_mpfw_rq_name, "Himax_mdt_mpfw.bin");
            strcpy(ts->himax_csv_name, "hx_mdt_criteria.csv");
            break;
    /*TabA7 Lite code for OT8-5213 by huangzhongjie at 20211022 start*/
    case MODEL_COPPER_HLT_HSD:
            strcpy(ts->himax_name,"hx83102e_copper_hlt_hsd");
            strcpy(ts->himax_nomalfw_rq_name, "Himax_copper_hsd_firmware.bin");
            strcpy(ts->himax_mpfw_rq_name, "Himax_copper_hsd_mpfw.bin");
            strcpy(ts->himax_csv_name, "hx_copper_hsd_criteria.csv");
            break;
    /*TabA7 Lite code for OT8-5213 by huangzhongjie at 20211022 end*/
	/*TabA7 Lite code for OT8-5316 by suyurui at 20220217 start*/
	case MODEL_GX_HSD:
            strcpy(ts->himax_name,"hx83102e_gx_hsd");
            strcpy(ts->himax_nomalfw_rq_name, "Himax_gx_hsd_firmware.bin");
            strcpy(ts->himax_mpfw_rq_name, "Himax_gx_hsd_mpfw.bin");
            strcpy(ts->himax_csv_name, "hx_gx_hsd_criteria.csv");
            break;
	/*TabA7 Lite code for OT8-5316 by suyurui at 20220217 end*/
	/*TabA7 Lite code for OT8-5321 by suyurui at 20220217 start*/
	case MODEL_HY_MDT:
            strcpy(ts->himax_name,"hx83102e_hy_mdt");
            strcpy(ts->himax_nomalfw_rq_name, "Himax_hy_mdt_firmware.bin");
            strcpy(ts->himax_mpfw_rq_name, "Himax_hy_mdt_mpfw.bin");
            strcpy(ts->himax_csv_name, "hx_hy_mdt_criteria.csv");
            break;
	/*TabA7 Lite code for OT8-5321 by suyurui at 20220217 end*/
    default:
...
/*TabA7 Lite code for SR-AX3565-01-840 by liupengtao at 20210524 end*/
...
/*TabA7 Lite code for SR-AX3565-01-840 by liupengtao at 20210524 end*/
	...
	hx_test_node_init(&hwinfo_device);
