...
*****************************************************************************/
/* Huaqin add for SR-AX3565-01-700 ito test by fengzhigang at 2021/01/11 start */
#define FTS_INI_FILE_PATH                       "/sdcard/tpdata/"
#define FTS_CSV_PASS_FILE_NAME              "_testdata_pass.csv"
#define FTS_CSV_FAIL_FILE_NAME              "_testdata_fail.csv"
#define FTS_TXT_PASS_FILE_NAME              "_testresult_pass.txt"
#define FTS_TXT_FAIL_FILE_NAME              "_testresult_fail.txt"
/* Huaqin add for SR-AX3565-01-700 ito test by fengzhigang at 2021/01/11 end */
#define false 0
#define true  1
...
/*TabA7 Lite code for OT8-2503 by liufurong at 20210210 start*/
    char data_filepath[FILE_NAME_LENGTH];
    char result_filepath[FILE_NAME_LENGTH];
    char *data_buffer;
    int data_buffer_len;
