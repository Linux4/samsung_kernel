...
/*hs04 code for DEAL6398A-1067 by tangsumian1 at 20220827 end*/
enum cts_dev_hw_reg {
...
static const cts_upgrade_module cts_module_list[] = {
    {
        .lcd_name = "lcd_nl9911c_hlt_hkc_mipi_hdp_video",
        .fw_num = MODEL_HLT_HKC,
        .cts_name_data = "chipone_hlt_hkc",
    },
    {
        .lcd_name = "lcd_nl9911c_hr_hr_mipi_hdp_video",
        .fw_num = MODEL_HR_HR,
        .cts_name_data = "chipone_hr_hr",
    },
};
/*hs04 code for SR-AL6398A-01-676 by tangsumian1 at 20220722 end*/
