...
extern const struct cts_firmware *cts_request_firmware( const struct cts_device *cts_dev,
...
#else
static inline const struct cts_firmware *cts_request_firmware(const struct cts_device *cts_dev,
