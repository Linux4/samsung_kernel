...
//#define SAMSUNG_PROCTORL 
#define P5_X_SAMSUNG_PACKET_INFO_LEN			3
#define P5_X_SAMSUNG_AXIS_LEN				50
#define P5_X_SAMSUNG_STATE_INFO			16

#define P5_X_DEMO_SAMSUNG_PACKET_ID		0x5B
#define P5_X_DEBUG_SAMSUNG_PACKET_ID		0xA8
...
#define TDDI_DEV_ID				"mediatek,ili9882q"
