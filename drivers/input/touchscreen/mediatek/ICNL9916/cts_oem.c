...
#define OEM_OF_DEF_PROPVAL_TEST_INT_PIN     false    //S96818AA1-1936,daijun1.wt,modify,2023/10/26,icnl9916 disable int-test
...
/* +S96818AA1-1936,daijun1.wt,modify,2023/10/12,icnl9916_dsbj update firmware 102& adjusting openshortTest limits */
...
#define OEM_TEST_DATA_DIR                   "/data/vendor/fac_sources/chipone_sources"
...
/* +S96818AA1-1936,daijun1.wt,modify,2023/10/12,icnl9916_dsbj update firmware 102& adjusting openshortTest limits */
		if (strstr(saved_command_line,"n28_icnl9916c_dsi_vdo_hdp_dsbj_mdt")){
...
//		d_inode(dentry)->i_private = &thread;
		cts_err("Failed to create directory for chiponetest\n");
...
static int save_selftest_data_to_file(struct cts_oem_data *oem_data)
{
	...
	if ((dev_mkdir(OEM_TEST_DATA_DIR, S_IRWXU | S_IRWXG | S_IRWXO)) != 0)
