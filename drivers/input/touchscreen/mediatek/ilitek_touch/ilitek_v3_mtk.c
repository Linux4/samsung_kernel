...
#define DTS_OF_NAME	"mediatek,ilitek-spi-touch"
...
#if AXIS_PACKET
	set_bit(BTN_PALM, ilits->input->keybit);
...
static int __init ilitek_plat_dev_init(void)
{
	...
	// if(strcmp(lcd_identify_name,"ili9881t_liansi_inx_incell_vdo")){
