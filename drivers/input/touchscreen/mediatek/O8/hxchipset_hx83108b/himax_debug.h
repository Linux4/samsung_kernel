...
extern int g_flag_eb_event;
extern int g_flag_ec_event;
#if defined(HW_ED_EXCP_EVENT)
extern int g_flag_ee_event;
#else
extern int g_flag_ed_event;
#endif
#endif
...
extern struct proc_dir_entry *hx_touch_proc_dir;
