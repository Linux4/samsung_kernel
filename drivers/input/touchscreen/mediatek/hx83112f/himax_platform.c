...
{
	if (g_lcm_name == 3) {
		g_fw_boot_upgrade_name = "Himax_firmware_fw_txd.bin";
		g_fw_mp_upgrade_name = "Himax_firmware_mp_txd.bin";
	} else if(g_lcm_name == 5) {
		g_fw_boot_upgrade_name = "Himax_firmware_fw_jdi.bin";
		g_fw_mp_upgrade_name = "Himax_firmware_mp_jdi.bin";
	}
