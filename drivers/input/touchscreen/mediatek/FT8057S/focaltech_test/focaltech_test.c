...
//+S96818AA1-1936,wangtao14.wt,modify,2023/05/23,ft8057s tp openshort_test not failed
...
//+S96818AA1-1936,wangtao14.wt,modify,2023/05/19,ft8057s tp openshort_test
int fts_factory_test()
{
    int ret = 0;
    char fwname[FILE_NAME_LENGTH] = { "focaltech_ft8057s_mdt.ini" };
