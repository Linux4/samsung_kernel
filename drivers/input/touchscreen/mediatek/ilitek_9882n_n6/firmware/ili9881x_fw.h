...
#define BOE_INI_NAME_PATH		"/vendor/firmware/mp_ili9882n_boe.ini"
#define BOE_FW_FILP_PATH		"/sdcard/ILITEK_FW_BOE"
#define BOE_INI_REQUEST_PATH		"mp_ili9882n_boe.ini"
#define BOE_FW_REQUEST_PATH		"ILITEK_FW_BOE"
static unsigned char CTPM_FW_BOE[] = {
	#include "FW_TDDI_TRUNK_FB.ili"
};

#define LS_BOE_INI_NAME_PATH		"/vendor/firmware/mp_ls_ili9882n_boe.ini"
#define LS_BOE_FW_FILP_PATH		"/sdcard/LS_ILI9882N_BOE_FW"
#define LS_BOE_INI_REQUEST_PATH		"mp_ls_ili9882n_boe.ini"
#define LS_BOE_FW_REQUEST_PATH		"LS_ILI9882N_BOE_FW"
static unsigned char CTPM_FW_LS[] = {
	#include "FW_TDDI_9882N_LS_BOE.ili"
};
