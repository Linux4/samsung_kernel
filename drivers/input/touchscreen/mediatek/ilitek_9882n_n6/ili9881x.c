...
static void ili_update_tp_module_info(void)
{
	...
	case MODEL_LS:
		ilits->md_name = "LS";
		ilits->md_fw_filp_path = LS_BOE_FW_FILP_PATH;
		ilits->md_fw_rq_path = LS_BOE_FW_REQUEST_PATH;
		ilits->md_ini_path = LS_BOE_INI_NAME_PATH;
		ilits->md_ini_rq_path = LS_BOE_INI_REQUEST_PATH;
