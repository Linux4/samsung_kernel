...
/*****************************************************************************
*
* File Name: focaltech_upgrade_ft3617-003.c
*
...
*****************************************************************************/
/************************************************************************
* Name: fts_ft3617_003_upgrade
* Brief:
* Input:
* Output:
* Return: return 0 if success, otherwise return error code
***********************************************************************/
static int fts_ft3617_003_upgrade(u8 *buf, u32 len)
{
    int ret = 0;
    u32 start_addr = 0;
    u8 cmd[4] = { 0 };
    ...
    /* write app */
    start_addr = upgrade_func_ft3617_003.appoff;
...
struct upgrade_func upgrade_func_ft3617_003 = {
    .ctype = {0x86},
    .fwveroff = 0x10A,
    .fwcfgoff = 0x103B0,
    .appoff = 0x0000,
    ...
    .hid_supported = true,
    .upgrade = fts_ft3617_003_upgrade,
};
