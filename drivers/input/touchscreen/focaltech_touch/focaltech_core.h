...
#include <linux/input/sec_cmd.h>    //guoyan1 for sec_cmd 20210111
...
/* guoyan1 20210104 */
#define FTS_VENDOR_UPGRADE
#ifdef FTS_VENDOR_UPGRADE
extern char fts_fw_name[64];
extern char fts_mp_name[64];
#define BOOT_UPDATE_FIRMWARE_NAME fts_fw_name
#define MP_UPDATE_FIRMWARE_NAME fts_mp_name
#else
#define BOOT_UPDATE_FIRMWARE_NAME "focal_ts_fw.bin"
#define MP_UPDATE_FIRMWARE_NAME   "focal_ts_mp.bin"
#endif
/* guoyan1 20210104 */
/*****************************************************************************
...
#define SEC_FTS_TSP_FACTORY_TEST    /* guoyan1 for sec_cmd */
...
struct fts_ts_data {
    ...
    struct touch_info_dev *tid; /* guoyan1 */
#if FTS_PINCTRL_EN
...
#endif
#ifdef SEC_FTS_TSP_FACTORY_TEST    /* guoyan1 for sec_cmd */
