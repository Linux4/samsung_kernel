...
struct zt7548_ts_info {
	...
	const u16				*hfdnd_h_gap_jitter_spec;
#endif
#endif
...
struct tsp_raw_data {
	...
	s16 hfhgap_jitter_data[TSP_CMD_NODE_NUM];	//add zinitix 160718
#if defined(CONFIG_TOUCHSCREEN_ZT7548_TS)
...
static void run_hfdnd_h_gap_jitter_read(void * device_data);	//add zinitix  160718
static void get_hfdnd_h_gap_jitter_read(void *device_data);	//add zinitix  160718
