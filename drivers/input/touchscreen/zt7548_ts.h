...
#define MAX_SUPPORTED_BUTTON_NUM_WITH_DUMMY	4	/* max 8 */
...
#define ZINITIX_DEFAULT_UMS_FW		"/sdcard/Firmware/TSP/zinitix.fw"
...
#endif
	u16 trxshort_data[TSP_CMD_NODE_NUM];
};
