...
/**
* Command : Get firmware version from bin file
*/
static void cmd_get_fw_ver_bin(void *device_data)
{
	...
	sprintf(buf, "%02X.%02X_%02X.%02X_%02X.%02X_%02X.%02X\n", 
		(bin_info->ver_boot >> 8) & 0xFF, bin_info->ver_boot & 0xFF, 
		(bin_info->ver_core >> 8) & 0xFF, bin_info->ver_core & 0xFF, 
		(bin_info->ver_app >> 8) & 0xFF, bin_info->ver_app & 0xFF, 
		(bin_info->ver_param >> 8) & 0xFF, bin_info->ver_param & 0xFF);	
