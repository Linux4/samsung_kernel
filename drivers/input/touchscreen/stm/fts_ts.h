...
#define FTS_SUPPORT_WATER_MODE		/* Wet mode, water proof */
#define FTS_SUPPORT_STRINGLIB		/* Display Lab algorithm */
#define FTS_SUPPORT_NOISE_PARAM		/* save & resrote noise parameter */
...
#define FTS_FIRMWARE_NAME				"tsp_stm/stm.fw"
...
#define FTS_FIRMWARE_NAME_ZERO_F			"tsp_stm/stm_zero_f.fw"
...
/* will be changed to 0x3000 */
#define FTS_CMD_STRING_ACCESS				0x3000
#define STRING_ADDRESS_ZERO				0xEC00
#define STRING_ADDRESS					0x3000

#define STRING_OFFSET_REGISTER			0x08
...
#if 0//defined(CONFIG_SEC_TBLTE_PROJECT) || defined(CONFIG_SEC_TRLTE_PROJECT)
#define TSP_RAWDATA_DUMP
#endif

#undef FTS_ADDED_RESETCODE_IN_LPM		//all TB, TR chn for lpm mode.
...
struct fts_ts_info {
	...
	int (*fts_power_ctrl)(struct fts_ts_info *info, bool enable);
