...
#define FTS_TS_DRV_NAME			"fts_touch_spi"
...
/* ST COMMANDS */
#define FTS_CMD_REG_W		0xFA
#define FTS_CMD_REG_R		0xFB
#define FTS_CMD_SCAN_MODE	0xA0
#define FTS_CMD_FEATURE		0xA2
#define FTS_CMD_SYSTEM		0xA4
#define FTS_CMD_FRM_BUFF_W	0xA6
#define FTS_CMD_FRM_BUFF_R	0xA7
#define FTS_CMD_CUSTOM_W	0xC0
#define FTS_CMD_SPONGE_W	0xD0
#define FTS_CMD_CUSTOM_R	0xD1
...
#define FTS_READ_ONE_EVENT				0x87//0x87
#define FTS_READ_ALL_EVENT				0x87//0x87
...
#define FTS_CMD_SET_TEST_MODE				0xE4
#define FTS_CMD_SET_FAC_LEVEL				0x74
#define FTS_CMD_SEND_FAC_RESULT				0x76
#define FTS_CMD_SET_FAC_DATA_TYPE			0x7D
...
#define FTS_INFO_LIGHTSENSOR_DETECT		0x05
...
/* PROTOS */
#define PROTOS_EVENT_LIGHTSENSOR_DETECT		21
#define PROTOS_EVENT_LIGHTSENSOR_RELEASE	20
...
//	struct i2c_client *client;
	...
	struct wakeup_source *sec_ts_ws;
...
#if 1//def CONFIG_TOUCHSCREEN_DUAL_FOLDABLE
...
#ifdef TCLM_CONCEPT
int fts_tclm_data_read(struct spi_device *client, int address);
int fts_tclm_data_write(struct spi_device *client, int address);
int fts_tclm_execute_force_calibration(struct spi_device *client, int cal_mode);
#endif
int fts_set_nvm_data(struct fts_ts_info *info, u8 type, u8 *buf);
int fts_get_nvm_data(struct fts_ts_info *info, int type, u8 *nvdata);
...
int fts_tool_proc_init(struct fts_ts_info *info);
int fts_tool_proc_remove(void);
