  ...
  /* Automatically generated on 2016-Jun-30  05:43:20, do not edit */
  ...
  /*      Register Name                                      Address     Register Description */
  /*      -------------                                      -------     -------------------- */
  #define SYNA_F51_CUSTOM_CTRL21_00                          0x0400   /* Column Noise Remover Threshold */
  #define SYNA_F51_CUSTOM_CTRL21_01                          0x0401   /* Row Noise Remover Threshold (Left) */
  #define SYNA_F51_CUSTOM_CTRL21_02                          0x0402   /* Row Noise Remover Threshold (Right) */
  #define SYNA_F51_CUSTOM_CTRL23                             0x0403   /* Palm Filter Mode3 Distance Threshold LSB */
  #define SYNA_F51_CUSTOM_CTRL24                             0x0404   /* Palm Filter Mode3 Distance Threshold MSB */
  #define SYNA_F51_CUSTOM_CTRL27                             0x0405   /* anti-Bending Delta Threshold */
  #define SYNA_F51_CUSTOM_CTRL28                             0x0406   /* anti-Bending Log Threshold */
  #define SYNA_F51_CUSTOM_QUERY00                            0x0407   /* F$51 Query Register Count */
  #define SYNA_F51_CUSTOM_QUERY01                            0x0408   /* F$51 Data Register Count */
  #define SYNA_F51_CUSTOM_QUERY02                            0x0409   /* F$51 Control Register Count */
  #define SYNA_F51_CUSTOM_QUERY03                            0x040A   /* F$51 Command Register Count */
  #define SYNA_F51_CUSTOM_QUERY04                            0x040B   /* MultiTap LPWG */
  #define SYNA_F51_CUSTOM_QUERY05                            0x040C   /* Misc Control */
  #define SYNA_F51_CUSTOM_QUERY06                            0x040D   /* LGM Thresholds */
  #define SYNA_F51_CUSTOM_QUERY07                            0x040E   /* Force Detection */
  ...
  #define SYNA_F51_CUSTOM_CTRL21_00_CFGBLK_OFS               0x01EA   /* Column Noise Remover Threshold */
  #define SYNA_F51_CUSTOM_CTRL21_01_CFGBLK_OFS               0x01EB   /* Row Noise Remover Threshold (Left) */
  #define SYNA_F51_CUSTOM_CTRL21_02_CFGBLK_OFS               0x01EC   /* Row Noise Remover Threshold (Right) */
  #define SYNA_F51_CUSTOM_CTRL23_CFGBLK_OFS                  0x01ED   /* Palm Filter Mode3 Distance Threshold LSB */
  #define SYNA_F51_CUSTOM_CTRL24_CFGBLK_OFS                  0x01EE   /* Palm Filter Mode3 Distance Threshold MSB */
  #define SYNA_F51_CUSTOM_CTRL27_CFGBLK_OFS                  0x01EF   /* anti-Bending Delta Threshold */
  #define SYNA_F51_CUSTOM_CTRL28_CFGBLK_OFS                  0x01F0   /* anti-Bending Log Threshold */
  #define SYNA_FDC_PRINT_CTRL00_CFGBLK_OFS                   0x01F1   /* Print Control */
