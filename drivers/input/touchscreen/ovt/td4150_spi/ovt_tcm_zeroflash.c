...
re_check:
	...
	retval = ovt_tcm_rmi_read(tcm_hcd, PDT_START_ADDR,
	...
	retval = ovt_tcm_rmi_read(tcm_hcd, zeroflash_hcd->f35_addr.query_base,
...
static int zeroflash_download_open_short_config(void)
{
	...
	retval = ovt_tcm_alloc_mem(tcm_hcd, &zeroflash_hcd->out,
...
static void zeroflash_do_f35_firmware_download(void)
{
	...
	retval = ovt_tcm_rmi_read(tcm_hcd, zeroflash_hcd->f35_addr.data_base,
