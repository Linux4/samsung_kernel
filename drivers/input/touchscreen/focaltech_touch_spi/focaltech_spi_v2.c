...
static int fts_ts_probe(struct spi_device *spi)
{
    ...
    if (!Lcm_name_tp[0]) {
        FTS_ERROR("Lcm_name_tp is missing.");
        return -EPROBE_DEFER;
	}
//+P86801AA1,wanwen2.wt,modify,2023/08/29,add lcm_name identify
    if ((strcmp(Lcm_name_tp,"focaltech_ft8203_wt_dsi_vdo_90hz_apf_boe") != 0) &&
	(strcmp(Lcm_name_tp,"ft8203_wt_dsi_vdo_90hz_focaltech") != 0) &&
	(strcmp(Lcm_name_tp,"dsbj_ft8203_wt_dsi_vdo_90hz_inx") != 0)) {
		FTS_ERROR("Lcm_name_tp Match failed\n");
		return -ENOMEM;
    }
//-P86801AA1,wanwen2.wt,modify,2023/08/29,add lcm_name identify
