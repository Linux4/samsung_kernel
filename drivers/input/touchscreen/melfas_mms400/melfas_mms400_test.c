...
* Sysfs functions
*/
static DEVICE_ATTR(fw_version, 0444, mms_sys_fw_version, NULL);
static DEVICE_ATTR(info, 0444, mms_sys_info, NULL);
static DEVICE_ATTR(device_enable, 0444, mms_sys_device_enable, NULL);
static DEVICE_ATTR(device_disable, 0444, mms_sys_device_disable, NULL);
static DEVICE_ATTR(irq_enable, 0444, mms_sys_irq_enable, NULL);
static DEVICE_ATTR(irq_disable, 0444, mms_sys_irq_disable, NULL);
static DEVICE_ATTR(power_on, 0444, mms_sys_power_on, NULL);
static DEVICE_ATTR(power_off, 0444, mms_sys_power_off, NULL);
static DEVICE_ATTR(reboot, 0444, mms_sys_reboot, NULL);
static DEVICE_ATTR(mode_glove, 0664, mms_sys_glove_mode_show, mms_sys_glove_mode_store);
static DEVICE_ATTR(mode_charger, 0664, mms_sys_charger_mode_show, mms_sys_charger_mode_store);
static DEVICE_ATTR(mode_cover_window, 0664, mms_sys_window_mode_show, mms_sys_window_mode_store);
static DEVICE_ATTR(mode_palm_rejection, 0664, mms_sys_palm_rejection_mode_show, mms_sys_palm_rejection_mode_store);
static DEVICE_ATTR(image_intensity, 0444, mms_sys_intensity, NULL);
static DEVICE_ATTR(image_rawdata, 0444, mms_sys_rawdata, NULL);
static DEVICE_ATTR(test_cm_delta, 0444, mms_sys_test_cm_delta, NULL);
static DEVICE_ATTR(test_cm_abs, 0444, mms_sys_test_cm_abs, NULL);
static DEVICE_ATTR(test_cm_jitter, 0444, mms_sys_test_cm_jitter, NULL);
static DEVICE_ATTR(test_short, 0444, mms_sys_test_short, NULL);
