...
/* sysfs : sys */
static DEVICE_ATTR(printk, MISC_DEFAULT_ATTR,
...
static DEVICE_ATTR(direct, MISC_DEFAULT_ATTR,
...
#if IST30XX_CHKIC
/* sysfs : chkic */
static DEVICE_ATTR(chkic, MISC_DEFAULT_ATTR, ist30xx_chkic_show, NULL);
#endif
