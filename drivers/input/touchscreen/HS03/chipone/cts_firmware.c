    ...
    u32 hwid, u16 fwid, u16 curr_firmware_ver)
{
    ...
    /*HS03 code for SL6215DEV-2689  by lishuai at 20211013 start*/
    char cfg_cts_firmware_filepath[70];
    char cfg_cts_firmware_filename[50];
    /*HS03 code for SL6215DEV-2689  by lishuai at 20211013 end*/
...
/*HS03 code for SR-SL6215-01-97  by lishuai at 20210924 start*/
#ifdef CFG_CTS_FIRMWARE_IN_FS
    /* Check firmware in file system when probe only when build to .ko */
    sprintf(cfg_cts_firmware_filepath, "/vendor/firmware/%s_ICNL9911C.bin", chipone_ts_data_global->cts_lcd_module_name);
    sprintf(cfg_cts_firmware_filename, "%s_ICNL9911C.bin", chipone_ts_data_global->cts_lcd_module_name);
...
/*HS03 code for SR-SL6215-01-97  by lishuai at 20210924 end*/
#endif /* CFG_CTS_FIRMWARE_IN_FS */
...
out:
    ...
    if (ret == 0) {
        ...
        chipone_ts_data_global->fw_update_stat = 1;
