...
{
	/*HS03 code for SL6215DEV-150  by zhoulingyun at 20210817 start*/
	int ret;
	int count = 0;
	/*HS03 code for SL6215DEV-150 by zhoulingyun at 20210817 end*/
	...
	if (gcore_start_mp_test()) {
		...
		ret = 0;
		GTP_ERROR("JZ GC7202 mp test success!");
	}
	count = sprintf(buf, "%s\n", (ret == 0) ? "1" : "0");//return test  success
	return count;
	/*HS03 code for SL6215DEV-150 by zhoulingyun at 20210817 end*/
}
...
#if TP_INFO
#if GCORE_TOUCH_MP
	if (platform_device_register(&hwinfo_device) == 0) {
