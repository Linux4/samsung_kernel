...
/*HS03 code for SR-SL6215-01-571 by duanyaoming at 20220304 start*/
#include <linux/proc_fs.h>
/*HS03 code for SR-SL6215-01-571 by duanyaoming at 20220304 end*/
static struct gcore_dev *gcore_ts_data = NULL;
...
gc_module_struct gc_module_info_list[] = {
    {
        .gc_all_lcdname_data = "lcd_gc7202h_hlt_ctc_mipi_hdp",
        .gc_fw_name_data = "gc7202h_hlt.bin",
        .gc_mp_name_data = "gc7202h_hlt_mp.bin",
        .gc_mp_ini_name_data = "/vendor/firmware/gc7202h_hlt_mp.ini",
        .gc_module_name_data = "HLT",
        .gc_ic_name_data = "GC7202H",
    },
    {
        .gc_all_lcdname_data = "lcd_gc7202_ls_hsd_mipi_hdp_video",
        .gc_fw_name_data = "gc7202_ls.bin",
        .gc_mp_name_data = "gc7202_ls_mp.bin",
        .gc_mp_ini_name_data = "/vendor/firmware/gc7202_ls_mp.ini",
        .gc_module_name_data = "LS",
        .gc_ic_name_data = "GC7202",
    }
...
static int gcore_ito_test_node_init(struct platform_device *tp_device);
/*HS03 code for SR-SL6215-01-577 by duanyaoming at 20220304 end*/
/*HS03 code for SR-SL6215-01-571 by duanyaoming at 20220304 start*/
static int gcore_proc_tpinfo_init(void);
...
/*HS03 code for SR-SL6215-01-590 by duanyaoming at 20220307 start*/
extern void enable_gesture_wakeup(void);
/*HS03 code for SR-SL6215-01-590 by duanyaoming at 20220307 end*/
/*HS03 code for SL6215DEV-4128 by duanyaoming at 202200308 start*/
bool gcore_usb_detect_flag = 0;
/*HS03 code for SL6215DEV-4128 by duanyaoming at 202200308 end*/
/*HS03 code for SL6215DEV-4129 by duanyaoming at 202200309 start*/
static int gcore_input_open(struct input_dev *dev);
static void gcore_input_close(struct input_dev *dev);
/*HS03 code for SL6215DEV-4129 by duanyaoming at 202200309 end*/
#if 0
...
static irqreturn_t tpd_event_handler(int irq, void *dev_id)
{
    ...
    /*HS03 code for SL6215DEV-4130 by duanyaoming at 20220317 start*/
    if (gdev->dev_pm_suspend) {
        ret = wait_for_completion_timeout(&gdev->dev_pm_resume_completion, msecs_to_jiffies(700));
        if (!ret) {
            GTP_ERROR("system(bus) can't finished resuming procedure, skip it\n");
            return IRQ_HANDLED;
        }
    }
    /*HS03 code for SL6215DEV-4130 by duanyaoming at 20220317 end*/
...
{
    u16 chip_7202H = 0x9503;
    u16 chip_7202 = 0x3202;
    ...
    while (retries++ < 3) {
        ...
        id = (buf[0] << 8) | buf[1];
        if ((id == chip_7202H) || (id == chip_7202)) {
            GTP_DEBUG("GC%04x chip id match success", id);
            if (id == chip_7202H) {
                ret = IC_GC7202H;
                GTP_DEBUG("ic type is GC7202H");
            } else {
                ret = IC_GC7202;
                GTP_DEBUG("ic type is GC7202");
            }
            break;
        } else {
...
void gcore_wdt_recovery_works(struct work_struct *work)
{
    ...
    /*HS03 code for SR-SL6215-01-1148 by wenghailong at 20220421 start */
    if (fn_data.gdev->ic_type == IC_GC7202H) {
        return;
    }
    /*HS03 code for SR-SL6215-01-1148 by wenghailong at 20220421 end */
...
static void gcore_resume_work_function(struct work_struct *work)
{
    gcore_resume();
}
...
{
    GTP_DEBUG("event = %d,fn_data.gdev->tp_suspend=%d\n", event, fn_data.gdev->tp_suspend);
    if ((event == DISPC_POWER_OFF) && (fn_data.gdev->tp_suspend == false)) {
        gcore_suspend();
    }
    else if ((event == DISPC_POWER_ON) && (fn_data.gdev->tp_suspend == true)) {
        queue_work(fn_data.gdev->resume_workqueue, &fn_data.gdev->resume_work);
    }
    return 0;
}

/*HS03 code for SL6215DEV-4128 by duanyaoming at 20220308 start*/
static int gcore_charger_usb_check_notifier_callback(struct notifier_block *nb,
                                unsigned long val, void *v)
{
    ...
    if (gcore_usb_detect_flag != usb_connect) {
        ...
        /*HS03 code for SL6215DEV-4207 by duanyaoming at 2022424 start*/
        ...
        /*HS03 code for SL6215DEV-4207 by duanyaoming at 2022424 end*/
    }
    return 0;
}
static void gcore_charger_usb_check_init(void)
{
    int ret = 0;
    struct power_supply *psy_usb = NULL;
    struct power_supply *psy_ac = NULL;
    ...
    fn_data.gdev->charger_notif.notifier_call = gcore_charger_usb_check_notifier_callback;
    ...
    GTP_DEBUG("boot check usb_plug_status = %d\n", gcore_usb_detect_flag);
}
...
static int gcore_input_open(struct input_dev *dev)
{
    fn_data.gdev->tp_is_enabled = 1;
    return 0;
}

static void gcore_input_close(struct input_dev *dev)
{
    fn_data.gdev->tp_is_enabled = 0;
}
/*HS03 code for SL6215DEV-4129 by duanyaoming at 20220309 end*/
/*HS03 code for SR-SL6215-01-1189 by duanyaoming at 20220407 start*/
static void gcore_module_info(struct gcore_dev *gdev)
{
    gdev->gc_all_lcdname=gc_module_info_list[gdev->ic_type].gc_all_lcdname_data;
    gdev->gc_fw_name=gc_module_info_list[gdev->ic_type].gc_fw_name_data;
    gdev->gc_ic_name=gc_module_info_list[gdev->ic_type].gc_ic_name_data;
    gdev->gc_module_name=gc_module_info_list[gdev->ic_type].gc_module_name_data;
    gdev->gc_mp_ini_name=gc_module_info_list[gdev->ic_type].gc_mp_ini_name_data;
    gdev->gc_mp_name=gc_module_info_list[gdev->ic_type].gc_mp_name_data;
}
/*HS03 code for SR-SL6215-01-1189 by duanyaoming at 20220407  end*/
...
int gcore_touch_probe(struct gcore_dev *gdev)
{
...
#endif
    /*HS03 code for SL6215DEV-4130 by duanyaoming at 20220317 start*/
    gdev->dev_pm_suspend = false;
    init_completion(&gdev->dev_pm_resume_completion);
    /*HS03 code for SL6215DEV-4130 by duanyaoming at 20220317 end*/
    msleep(50);
    ...
    retval = disp_notifier_register(&gdev->drm_notifier);
    if (retval < 0) {
        GTP_ERROR("Failed to register gcore notifier");
        return retval;
    }
#endif
    gdev->resume_workqueue = create_singlethread_workqueue("resume_wq");
    if (!gdev->resume_workqueue) {
        GTP_ERROR("allocate resume_wq failed");
        return -EPERM;
    }
    INIT_WORK(&gdev->resume_work, gcore_resume_work_function);
    gcore_ts_data = gdev;
    /*HS03 code for SL6215DEV-4129 by duanyaoming at 20220309 start*/
    gdev->tp_is_enabled = 1;
    gdev->input_device->open = gcore_input_open;
    gdev->input_device->close = gcore_input_close;
    /*HS03 code for SL6215DEV-4129 by duanyaoming at 20220309 end*/
    /*HS03 code for SL6215DEV-4128 by duanyaoming at 20220308 start*/
    ...
    /*HS03 code for SL6215DEV-4294 by duanyaoming at 20220517 end*/
    /*HS03 code for SR-SL6215-01-577 by duanyaoming at 20220304 start*/
    gcore_ito_test_node_init(&hwinfo_device);
    /*HS03 code for SR-SL6215-01-577 by duanyaoming at 20220304 end*/
    /*HS03 code for SR-SL6215-01-571 by duanyaoming at 20220304 start*/
    gcore_proc_tpinfo_init();
    /*HS03 code for SR-SL6215-01-571 by duanyaoming at 20220304 end*/
    /*HS03 code for SR-SL6215-01-589 by duanyaoming at 20220304 start*/
    ...
    GTP_DEBUG("Double click gesture default on in D85 version\n");
#endif
    /*HS03 code for SR-SL6215-01-590 by duanyaoming at 20220307 end*/
...
/*HS03 code for SR-SL6215-01-577 by duanyaoming at 20220304 start*/
static ssize_t gcore_ito_test_show(struct device *dev,struct device_attribute *attr,char *buf)
{
    int count = 0;
    int ret = 0;

    GTP_DEBUG("Run MP test with LCM on\n");
...
static ssize_t gcore_ito_test_store(struct device *dev,struct device_attribute *attr,const char *buf, size_t count)
{
    return count;
}
static DEVICE_ATTR(factory_check, 0644, gcore_ito_test_show, gcore_ito_test_store);
...
static int gcore_ito_test_node_init(struct platform_device *tp_device)
{
    ...
    err = sysfs_create_group(&tp_device->dev.kobj, &factory_group);
    if (err != 0) {
...
/*HS03 code for SR-SL6215-01-571 by duanyaoming at 20220304 start*/
static ssize_t gcore_tp_info_read(struct file *file, char *buff,
                                size_t len, loff_t *pos)
{
    char buf[150] = {0};
    int rc = 0;
    /*HS03 code for SR-SL6215-01-1189 by duanyaoming at 20220407 start*/
    snprintf(buf, 150, "Module_name: %s\nIC_name: %s\nTouch_FW_ver:V0%02x\n", gc_module_info_list[fn_data.gdev->ic_type].gc_module_name_data,\
                    gc_module_info_list[fn_data.gdev->ic_type].gc_ic_name_data,(u8)(fn_data.gdev->fw_ver&0xff));
    /*HS03 code for SR-SL6215-01-1189 by duanyaoming at 20220407  end*/
    rc = simple_read_from_buffer(buff, len, pos, buf, strlen(buf));
    return rc;
}

static struct file_operations proc_tp_info_ops = {
    .owner = THIS_MODULE,
    .read = gcore_tp_info_read,
};

static int gcore_proc_tpinfo_init(void)
{
    proc_tpinfo_file = proc_create(PROC_TPINFO_FILE, (S_IWUSR | S_IRUGO),
                                        NULL, &proc_tp_info_ops);
    if (proc_tpinfo_file == NULL) {
        GTP_ERROR("proc tp_info file create failed!\n");
        return -EPERM;
    }
    return 0;
}
...
#endif
    /*HS03 code for SL6215DEV-4130 by duanyaoming at 20220317 start*/
    gcore_spi_slave->mode = SPI_MODE_0;
    /*HS03 code for SL6215DEV-4130 by duanyaoming at 20220317 end*/
...
/*HS03 code for SR-SL6215-01-1189 by duanyaoming at 20220407  end*/
    ...
    /*HS03 code for SR-SL6215-01-1189 by duanyaoming at 20220407 start*/
    touch_dev->ic_type = ret;
    gcore_module_info(touch_dev);
    /*HS03 code for SR-SL6215-01-1189 by duanyaoming at 20220407  end*/
    if (gcore_touch_probe(touch_dev)) {
        GTP_ERROR("touch registration fail!");
        //kfree(touch_dev);
...
#endif
/*HS03 code for SL6215DEV-4130 by duanyaoming at 20220317 start*/
static int gcore_pm_suspend(struct device *dev)
{
    GTP_REPORT("start.");
    fn_data.gdev->dev_pm_suspend = true;
    reinit_completion(&fn_data.gdev->dev_pm_resume_completion);
    GTP_REPORT("end.");
    return 0;
}

static int gcore_pm_resume(struct device *dev)
{
    GTP_REPORT("start.");
    fn_data.gdev->dev_pm_suspend = false;
    complete(&fn_data.gdev->dev_pm_resume_completion);
    GTP_REPORT("end.");
    return 0;
}

static const struct dev_pm_ops gcore_dev_pm_ops = {
    .suspend = gcore_pm_suspend,
    .resume = gcore_pm_resume,
};
/*HS03 code for SL6215DEV-4130 by duanyaoming at 20220317 end*/
