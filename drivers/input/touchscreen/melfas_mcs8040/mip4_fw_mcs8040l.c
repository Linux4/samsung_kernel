	...
	if(force == true){
		...
		if(retry < 0){
			...
			if(section == false){
				...
				//Section download
				if(ver_chip[0] < bin_info->ver_boot || ver_chip[0] == 0xFFFF){
				...
				else if(ver_chip[1] < bin_info->ver_core || ver_chip[1] == 0xFFFF){
				...
				else if(ver_chip[2] < bin_info->ver_app || ver_chip[2] == 0xFFFF){
				...
				else if(ver_chip[3] < bin_info->ver_param || ver_chip[3] == 0xFFFF){
