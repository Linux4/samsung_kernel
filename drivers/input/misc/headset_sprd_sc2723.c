...
static SPRD_HEADSET_TYPE headset_type_detect(int last_gpio_detect_value)
{
	...
	PRINT_INFO("%s: gnd %d, left %d, 3pole %d, 4pole %d\n", __func__, pdata->adc_threshold_gnd_average, pdata->adc_threshold_left_average,
		 pdata->adc_threshold_3pole_detect, pdata->adc_threshold_4pole_detect);
