...
#define ECOMPASS_IOC_GET_OPEN_STATUS	_IOR(ECOMPASS_IOM, 0x16, int)
...
#define ECOMPASS_IOC_SET_ACC_DATA            _IOW(ECOMPASS_IOM, 0x31, int[3])
#define ECOMPASS_IOC_GET_ACC_DATA            _IOR(ECOMPASS_IOM, 0x32, int[3])
