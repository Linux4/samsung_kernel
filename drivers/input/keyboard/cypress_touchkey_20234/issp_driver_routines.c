...
#undef GPIO_TOUCHKEY_SDA	
#undef GPIO_TOUCHKEY_SCL	
#undef GPIO_TOUCHKEY_INT	
#undef GPIO_TOUCHKEY_VDD	

#define GPIO_TOUCHKEY_SDA	22
#define GPIO_TOUCHKEY_SCL	23
//#define GPIO_TOUCHKEY_INT	64
...
extern struct cypress_touchkey_info *copy_info;
extern void cypress_power_onoff(struct cypress_touchkey_info *info, int onoff);

static void issp_power_onoff(int onoff)
{
	cypress_power_onoff(copy_info,onoff);
}
...
void ApplyTargetVDD(void)
{
	...
	issp_power_onoff(1);
	//printk(KERN_ERR "cypress firmup power on %d \n", __LINE__);
}
...
{
	issp_power_onoff(0);	
	//printk(KERN_ERR "cypress firmup power off %d \n", __LINE__);
}
#endif
