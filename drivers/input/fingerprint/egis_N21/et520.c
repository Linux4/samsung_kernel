...
bool egis_fp_exist = false;
extern bool fpc_fp_exist;
...
static int __init egis512_init(void)
{
	...
	if(fpc_fp_exist){
       printk(KERN_ERR "%s, fpc sensor has been detected.\n", __func__);
        return -EINVAL;
    }
