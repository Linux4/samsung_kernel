/* drivers/input/sec_input/nvt/nvt_ts_reg.h
 *
 * Copyright (C) 2021 Samsung Electronics Co., Ltd.
  *
 * Core file for Samsung TSP driver
 *
 * This program is free software; you can redistribute it and/or modify
 * it under the terms of the GNU General Public License version 2 as
 * published by the Free Software Foundation.
 */
#ifndef _LINUX_NVT_TS_REG_H_
#define _LINUX_NVT_TS_REG_H_

#define NVT_TS_I2C_NAME		"nvt_ts"
#define NVT_TS_SPI_NAME		"nvt_ts_spi"
#define NVT_TS_DEVICE_NAME	"NVT_TS"
...
#define NVT_TS_TOUCHTYPE_NORMAL		0
#define NVT_TS_TOUCHTYPE_GLOVE		3
