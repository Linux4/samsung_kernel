...
#if defined (CONFIG_WT_PROJECT_S96616AA1) || defined (CONFIG_WT_PROJECT_S96516SA1)
#define  INPUT_FEATURE_ENABLE_SETTINGS_AOT 1
static ssize_t support_feature(struct device *dev,
	struct device_attribute *attr, char *buf)
{
	u32 feature = 0;
...
#if defined (CONFIG_WT_PROJECT_S96616AA1) || defined (CONFIG_WT_PROJECT_S96516SA1)
static DEVICE_ATTR(support_feature, 0444, support_feature, NULL);
#endif
...
#if defined (CONFIG_N26_CHARGER_PRIVATE) || defined (CONFIG_W2_CHARGER_PRIVATE)	
	data->fac_dev = sec_device_create(data, dev_name);
#else	
	data->fac_dev = sec_device_create(data, dev_name);
#endif	
