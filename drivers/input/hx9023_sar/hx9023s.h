...
static struct hx9023s_addr_val_pair hx9023s_reg_init_list[] = {
    ...
    {RW_10_AVG0_NOSR0_CFG,             0x31},
    {RW_11_NOSR12_CFG,                 0x44},
    {RW_12_NOSR34_CFG,                 0x44},
    {RW_13_AVG12_CFG,                  0x11},
    {RW_14_AVG34_CFG,                  0x11},

    {RW_1F_SAMPLE_NUM_7_0,             0x32},
    {RW_21_INTEGRATION_NUM_7_0,        0x32},

    {RW_2A_LP_ALP_1_0_CFG,             0x11},
    {RW_2B_LP_ALP_3_2_CFG,             0x11},
