...
#define HX9031AS_ALG_COMPILE_EN 1          //默认仅编译alg，功能关闭，可通过节点控制开启

#define HX9031AS_DRIVER_NAME "hx9031as" //i2c addr: HX9031AS=0x2A | 0x28

#define HX9031AS_CH_NUM 5
#define HX9031AS_MAX_XFER_SIZE 32

#define HX9031AS_ODR_MS 50
...
static struct hx9031as_channel_info hx9031as_channels[] = {
    {
        .name = "grip_sensor",
        .enabled = false,
        .used = false,
...
/*+S96818AA1-1936, liuling3.wt,ADD, 2023/05/22, update parameter configuration*/
    {RW_23_GLOBAL_CTRL2,               0x1f},

    {RW_02_PRF_CFG,                    0x14},
    {RW_0D_RANGE_7_0,                  0x13},
    {RW_0E_RANGE_9_8,                  0x01},
/*-S96818AA1-1936, liuling3.wt,ADD, 2023/05/22, update parameter configuration*/
    {RW_0F_RANGE_18_16,                0x00},

/*+S96818AA1-1936, liuling3.wt,ADD, 2023/05/22, update parameter configuration*/
    {RW_10_AVG0_NOSR0_CFG,             0x51},
/*-S96818AA1-1936, liuling3.wt,ADD, 2023/05/22, update parameter configuration*/
    {RW_11_NOSR12_CFG,                 0x44},
/*+S96818AA1-1936, liuling3.wt,ADD, 2023/05/22, update parameter configuration*/
    {RW_12_NOSR34_CFG,                 0x00},
    {RW_13_AVG12_CFG,                  0x23},
