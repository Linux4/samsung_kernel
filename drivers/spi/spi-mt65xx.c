...
static int mtk_spi_probe(struct platform_device *pdev)
{
	...
	if (mdata->dev_comp->need_pad_sel) {
		...
		master->num_chipselect = mdata->pad_num; //+ add by songbinbo.wt for compitible more slave spi devices 20191118
	}
...
//+ add by songbinbo.wt for compitible more slave spi devices 20191118
