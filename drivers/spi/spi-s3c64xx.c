...
static void s3c64xx_spi_config(struct s3c64xx_spi_driver_data *sdd)
{
	...
	/* Disable Clock */
	if (sdd->port_conf->clk_from_cmu && sdd->ignore_sclk_gate == 0) {
...
static int s3c64xx_spi_probe(struct platform_device *pdev)
{
	...
	if (of_get_property(pdev->dev.of_node, "samsung,ignore-sclk-gate", NULL)) {
		dev_err(&pdev->dev, "Ignore sclk gate at clock change.\n");
		sdd->ignore_sclk_gate = 1;
	} else {
		sdd->ignore_sclk_gate = 0;
	}
...
static struct s3c64xx_spi_port_config exynos3475_spi_port_config = {
...
static struct platform_device_id s3c64xx_spi_driver_ids[] = {
	{
		...
		.name		= "exynos3475-spi",
		.driver_data	= (kernel_ulong_t)&exynos3475_spi_port_config,
	},
	{ },
};
...
static const struct of_device_id s3c64xx_spi_dt_match[] = {
	...
	{ .compatible = "samsung,exynos3475-spi",
			.data = (void *)&exynos3475_spi_port_config,
	},
	{ },
};
