...
/* S2MU005_REG_MUIC_RESERVED1 register */
#define DETACH_TIME_SET_SHIFT	0
#define DETACH_TIME_SET_MASK	0x3
#define DETACH_TIME_SET_5MS	0x3
...
#define IS_JIG_ADC(adc)( ((adc) == (ADC_JIG_USB_OFF)) || ((adc) == (ADC_JIG_USB_ON)) || ((adc) == (ADC_JIG_UART_OFF)) || ((adc) == (ADC_JIG_UART_ON)) ? 1 : 0 )
