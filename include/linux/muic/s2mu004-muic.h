...
typedef enum {
	...
	S2MU004_WATER_MUIC_PDIC_DET,
	S2MU004_WATER_MUIC_PDIC_STABLE,
	S2MU004_WATER_MUIC_PDIC_INVALID,
} t_water_status;

typedef enum {
	S2MU004_WATER_DRY_MUIC_IDLE,
	S2MU004_WATER_DRY_MUIC_DET,
	S2MU004_WATER_DRY_MUIC_PDIC_DET,
	S2MU004_WATER_DRY_MUIC_PDIC_INVALID,
} t_water_dry_status;
