...
#define WATER_DRY_RETRY_INTERVAL_TEST_MS		((WATER_DRY_RETRY_2MIN_SEC) * (1000))
#if water_test
#define WATER_DRY_RETRY_INTERVAL_MS			WATER_DRY_RETRY_INTERVAL_TEST_MS
#else
...
#define IS_WATER_STATUS(x)\
		(((x) == (S2MU107_WATER_MUIC_PDIC_DET)) \
		|| ((x) == (S2MU107_WATER_MUIC_PDIC_STABLE)) \
		? 1 : 0)
#endif
...
typedef enum {
	S2MU107_WATER_MUIC_IDLE,
	S2MU107_WATER_MUIC_VERIFY,
	S2MU107_WATER_MUIC_DET,
	S2MU107_WATER_MUIC_PDIC_DET,
	S2MU107_WATER_MUIC_PDIC_STABLE,
	S2MU107_WATER_MUIC_PDIC_INVALID,
} t_water_status;

typedef enum {
	S2MU107_WATER_DRY_MUIC_IDLE,
	S2MU107_WATER_DRY_MUIC_DET,
	S2MU107_WATER_DRY_MUIC_PDIC_DET,
	S2MU107_WATER_DRY_MUIC_PDIC_INVALID,
} t_water_dry_status;
