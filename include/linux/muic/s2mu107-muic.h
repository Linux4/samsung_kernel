...
#define IS_WATER_STATUS(x)\
		(((x) == (S2MU107_WATER_MUIC_CCIC_DET)) \
		|| ((x) == (S2MU107_WATER_MUIC_CCIC_STABLE)) \
		? 1 : 0)
#endif
...
typedef enum {
	...
	S2MU107_WATER_MUIC_CCIC_DET,
	S2MU107_WATER_MUIC_CCIC_STABLE,
	S2MU107_WATER_MUIC_CCIC_INVALID,
} t_water_status;

typedef enum {
	S2MU107_WATER_DRY_MUIC_IDLE,
	S2MU107_WATER_DRY_MUIC_DET,
	S2MU107_WATER_DRY_MUIC_CCIC_DET,
	S2MU107_WATER_DRY_MUIC_CCIC_INVALID,
} t_water_dry_status;
