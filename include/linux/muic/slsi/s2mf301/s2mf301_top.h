...
enum {
	...
	S2MF301_TOP_REG_TOPINT_MASK				= 0x08,
	...
	S2MF301_TOP_AUTO_FAC_CHG			= 0xC1,
	S2MF301_TOP_REG_JIG_CTRL			= 0xC2,
	S2MF301_TOP_MRSTB_RESET				= 0xC4,
	S2MF301_TOP_I2C_RESET_CTRL			= 0xC5,
	S2MF301_TOP_SHIP_MODE_CTRL1			= 0xCA,
	S2MF301_TOP_COMMON_OTP5				= 0xEA,
};
...
/* 0xC2 S2MF301_TOP_REG_JIG_CTRL */
#define S2MF301_TOP_REG_JIG_MANUAL_LOW_SHIFT	0
#define S2MF301_TOP_REG_JIG_MANUAL_LOW_MASK	(0x1 << S2MF301_TOP_REG_JIG_MANUAL_LOW_SHIFT)
...
struct s2mf301_top_data {
	...
	struct	power_supply_desc psy_top_desc;
};
