...
#if defined (CONFIG_HV_MUIC_S2MU205_AFC)
#include <linux/muic/s2mu205-muic-hv.h>
#endif
...
enum s2mu205_muic_registers {
	...
	/* Power Meter
	S2MU205_REG_PM_VAL_UP1		= 0x03,
	S2MU205_REG_PM_VAL_UP2		= 0x04,
	S2MU205_REG_PM_INT1			= 0x05,
	S2MU205_REG_PM_INT2			= 0x06,
	*/
	S2MU205_REG_MUIC_INT1_MASK	= 0x0E,
	S2MU205_REG_MUIC_INT2_MASK	= 0x0F,
	/* AFC --------------------------
	S2MU205_REG_AFC_INT_MASK = 0x8,
	S2MU205_REG_MUIC_INT1_MASK = 0x9,
	S2MU205_REG_MUIC_INT2_MASK = 0xa,
	S2MU205_REG_AFC_STATUS = 0x10,
	S2MU205_REG_VAL1_VCHGIN = 0x12,
	S2MU205_REG_VAL2_VCHGIN = 0x13,
	S2MU205_REG_AFC_CTRL1 = 0x2b,
	S2MU205_REG_AFC_CTRL2 = 0x2c,
	S2MU205_REG_AFC_TX_BYTE = 0x2d,
	S2MU205_REG_AFC_LOGIC_RDATA1 = 0x3e,
	S2MU205_REG_AFC_LOGIC_RDATA2 = 0x3f,
	S2MU205_REG_AFC_LOGIC_CTRL1 = 0x40,
	S2MU205_REG_AFC_LOGIC_CTRL2 = 0x41,
	S2MU205_REG_AFC_LOGIC_RDATA3 = 0x42,
	S2MU205_REG_QC30_DP_STEP = 0x43,
	S2MU205_REG_QC30_DM_STEP = 0x44,
	S2MU205_REG_AFC_MONITOR = 0x45,
	*/
	...
	/* AFC --------------------------
	S2MU205_REG_REQ_BOX_CO1 = 0x5F,
	S2MU205_REG_AFC_OTP0 = 0x65,
	S2MU205_REG_AFC_OTP1 = 0x66,
	S2MU205_REG_AFC_OTP2 = 0x67,
	S2MU205_REG_AFC_OTP3 = 0x68,
	S2MU205_REG_AFC_OTP4 = 0x69,
	S2MU205_REG_AFC_OTP5 = 0x6a,
	S2MU205_REG_AFC_OTP6 = 0x6b,
	*/
...
/* S2MU205 MUIC_INT1 register (0x01)*/
...
/* S2MU205 MUIC_INT2 register (0x02)*/
...
/* S2MU205 AFC_INT_MASK register (0x08) */
...
/* S2MU205 MUIC_INT1_MASK register (0x09)*/
...
/* S2MU205 MUIC_INT2_MASK register (0x0A)*/
...
/* S2MU205 AFC_STATUS register (0x10)*/
...
/* S2MU205 DEVICE_TYP1 register (0x47)*/
...
/* S2MU205 DEVICE_TYP2 register (0x48)*/
...
/* S2MU205 DEVICE_TYP3 register (0x49)*/
...
/* S2MU205 MUIC CHG_TYP Register (0x4D) */
...
/* S2MU205 MUIC DEVICE_APPLE Register (0x4E) */
...
/* S2MU205 MUIC TIMER_SET1 Register (0x6E) */
...
/* S2MU205 MUIC TIMER_SET2 Register (0x6F) */
...
/* S2MU205 MUIC MANUAL_SW_CTRL Register (0x70) */
...
/* S2MU205 MUIC TIMER_SET3 Register (0x71) */
...
/* S2MU205 MUIC MUIC_CTRL2 Register (0x72) */
...
/* S2MU205 MUIC MUIC_CTRL3 Register (0x73) */
...
/* S2MU205 MUIC CHARGER_DET_OTP Register (0x74) */
...
/* S2MU205 MUIC ADC_VREF_OTP Register (0x75) */
...
/* S2MU205 MUIC ADCBIAS_OTP1 Register (0x76) */
...
/* S2MU205 MUIC ADCBIAS_OTP2 Register (0x77) */
...
/* S2MU205 MUIC ADCBIAS_OTP3 Register (0x78) */
...
/* S2MU205 MUIC ADCBIAS_OTP4 Register (0x79) */
...
/* S2MU205 MUIC LDOADC_VSETL Register (0x7A) */
...
/* S2MU205 MUIC LDOADC_VSETH Register (0x7B) */
...
/* S2MU205 MUIC LDOPCP_VSET_OTP Register (0x7C) */
...
/* S2MU205 MUIC RID_DISCHARGE Register (0x7F) */
...
/* S2MU205 MUIC MUIC_RSVD1 Register (0x80) */


/* S2MU205 MUIC MUIC_RSVD2 Register (0x81) */


/* S2MU205 MUIC MUIC_RSVD3 Register (0x82) */


/* S2MU205 MUIC MUIC_RSVD4 Register (0x83) */
...
/* S2MU205 MUIC MUIC_RSVD5 Register (0x84) */


/* S2MU205 MUIC MUIC_RSVD6 Register (0x85) */


/* S2MU205 MUIC MUIC_RSVD7 Register (0x86) */


/* S2MU205 MUIC MUIC_RSVD8 Register (0x87) */


/* S2MU205 MUIC ATE_OTP0 Register (0xFC) */


/* S2MU205 MUIC ATE_OTP1 Register (0xFD) */


/* S2MU205 MUIC ATE_OTP2 Register (0xFE) */


/* S2MU205 MUIC ATE_OTP3 Register (0xFF) */

/* Power meter */
/* S2MU205 Powermeter VAL1 VCHGIN Register (0x12) */
#define PM_VAL1_VCHGIN_MASK 	(0xff)

/* S2MU205 Powermeter VAL2 VCHGIN Register (0x13) */
#define PM_VAL2_VCHGIN_SHIFT 	(4)
#define PM_VAL2_VCHGIN_MASK 	(0xf << PM_VAL2_VCHGIN_SHIFT)

/* S2MU205 Powermeter REQ BOX CO1 Register (0x5F) */
