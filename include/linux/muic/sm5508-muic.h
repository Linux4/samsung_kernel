...
#define SM5508_RID_DISABLE_MASK		0x01
 ...
 * 011: DM_CON_U connected to TxD
  */
#define SM5508_SW_U_TO_A		((1 << 5) | (1 << 2))
#define SM5508_SW_U_TO_UART		((3 << 5) | (3 << 2))
#define SM5508_SW_ALL_OPEN		(0)

enum sm5508_reg_manual_sw1_value {
	SM5508_MANSW1_OPEN			= SM5508_SW_ALL_OPEN,
	SM5508_MANSW1_U_TO_A		= SM5508_SW_U_TO_A,
	SM5508_MANSW1_U_TO_UART		= SM5508_SW_U_TO_UART,
};
