...
#define S2MPU04_IRQ_PWRONF_MASK		(1 << 0)
#define S2MPU04_IRQ_PWRONR_MASK		(1 << 1)
#define S2MPU04_IRQ_JIGONBF_MASK	(1 << 2)
#define S2MPU04_IRQ_JIGONBR_MASK	(1 << 3)
#define S2MPU04_IRQ_ACOKF_MASK		(1 << 4)
#define S2MPU04_IRQ_ACOKR_MASK		(1 << 5)
#define S2MPU04_IRQ_PWRON1S_MASK	(1 << 6)
#define S2MPU04_IRQ_MRB_MASK		(1 << 7)

#define S2MPU04_IRQ_RTC60S_MASK		(1 << 0)
#define S2MPU04_IRQ_RTCA1_MASK		(1 << 1)
#define S2MPU04_IRQ_RTCA0_MASK		(1 << 2)
#define S2MPU04_IRQ_SMPL_MASK		(1 << 3)
#define S2MPU04_IRQ_RTC1S_MASK		(1 << 4)
#define S2MPU04_IRQ_WTSR_MASK		(1 << 5)

#define S2MPU04_IRQ_INT120C_MASK	(1 << 0)
#define S2MPU04_IRQ_INT140C_MASK	(1 << 1)
#define S2MPU04_IRQ_TSD_MASK		(1 << 2)
