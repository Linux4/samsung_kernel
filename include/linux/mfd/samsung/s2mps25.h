/*
 * s2mps25.h - Driver for the s2mps25
 *
...
#ifndef __S2MPS25_MFD_H__
#define __S2MPS25_MFD_H__
#include <linux/platform_device.h>
#include <linux/regmap.h>
#define MFD_DEV_NAME "s2mps25"
/**
 * sec_regulator_data - regulator data
 * @id: regulator id
 * @initdata: regulator init data (contraints, supplies, ...)
 */
struct s2mps25_regulator_data {
	int id;
...
struct s2mps25_platform_data {
	struct s2mps25_regulator_data *regulators;
