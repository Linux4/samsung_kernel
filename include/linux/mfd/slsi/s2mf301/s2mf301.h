...
enum s2mf301x_irq {
#if IS_ENABLED(CONFIG_TOP_S2MF301)
	S2MF301X_TOP_DC_IRQ_RAMP_UP_DONE,
	S2MF301X_TOP_DC_IRQ_RAMP_UP_FAIL,
	S2MF301X_TOP_DC_IRQ_THERMAL_CONTROL,
	S2MF301X_TOP_DC_IRQ_CHARGING_STATE_CHAGNE,
	S2MF301X_TOP_DC_IRQ_CHARGING_DONE,

	S2MF301X_TOP_PM_RID_IRQ_RID_56K,
	S2MF301X_TOP_PM_RID_IRQ_RID_255K,
	S2MF301X_TOP_PM_RID_IRQ_RID_301K,
	S2MF301X_TOP_PM_RID_IRQ_RID_523K,
	S2MF301X_TOP_PM_RID_IRQ_RID_619KK,
	S2MF301X_TOP_PM_RID_IRQ_RID_OTG,
	S2MF301X_TOP_PM_RID_IRQ_RID_DETACH,
	S2MF301X_TOP_PM_RID_IRQ_RID_ATTACH,

	S2MF301X_TOP_CC_RID_IRQ_RID_255K,
	S2MF301X_TOP_CC_RID_IRQ_RID_301K,
	S2MF301X_TOP_CC_RID_IRQ_RID_523K,
	S2MF301X_TOP_CC_RID_IRQ_RID_619K,
	S2MF301X_TOP_CC_RID_IRQ_RID_OTG,
	S2MF301X_TOP_CC_RID_IRQ_RID_DETACH,
	S2MF301X_TOP_CC_RID_IRQ_RID_ATTACH,
#endif
#if IS_ENABLED(CONFIG_FUELGAUGE_S2MF301)
	S2MF301X_FG_IRQ_LOW_SOC,
	S2MF301X_FG_IRQ_LOW_VBAT,
	S2MF301X_FG_IRQ_HIGH_TEMP,
	S2MF301X_FG_IRQ_LOW_TEMP,
#endif
#if IS_ENABLED(CONFIG_LEDS_S2MF301_FLASH)
	S2MF301X_FLED_IRQ_C2F_Vbyp_ovp_prot,
	S2MF301X_FLED_IRQ_C2F_Vbyp_OK_Warning,
	S2MF301X_FLED_IRQ_TORCH_ON,
	S2MF301X_FLED_IRQ_LED_ON_TA_Detach,
	S2MF301X_FLED_IRQ_CH1_ON,
	S2MF301X_FLED_IRQ_OPEN_CH1,
	S2MF301X_FLED_IRQ_SHORT_CH1,
#endif
#if IS_ENABLED(CONFIG_HV_MUIC_S2MF301_AFC)
	S2MF301X_AFC_IRQ_AFC_LOOP,
	S2MF301X_AFC_IRQ_VDNMon,
	S2MF301X_AFC_IRQ_DNRes,
	S2MF301X_AFC_IRQ_MPNack,
	S2MF301X_AFC_IRQ_MRxBufOw,
	S2MF301X_AFC_IRQ_MRxTrf,
	S2MF301X_AFC_IRQ_MRxPerr,
	S2MF301X_AFC_IRQ_MRxRdy,
#endif
#if IS_ENABLED(CONFIG_MUIC_S2MF301)
	S2MF301X_MUIC_IRQ_ATTACH,
	S2MF301X_MUIC_IRQ_DETACH,
	S2MF301X_MUIC_IRQ_RESERVED,
	S2MF301X_MUIC_IRQ_USB_OVP,
	S2MF301X_MUIC_IRQ_VBUS_ON,
	S2MF301X_MUIC_IRQ_VBUS_OFF,
	S2MF301X_MUIC_IRQ_USB_Killer,
	S2MF301X_MUIC_IRQ_GP_OVP,
#endif
#if IS_ENABLED(CONFIG_PM_S2MF301)
	S2MF301X_PM_ADC_REQ_DONE1_VCC2UP,
	S2MF301X_PM_ADC_REQ_DONE1_VCC1UP,
	S2MF301X_PM_ADC_REQ_DONE1_VBATUP,
	S2MF301X_PM_ADC_REQ_DONE1_VSYSUP,
	S2MF301X_PM_ADC_REQ_DONE1_VBYPUP,
	S2MF301X_PM_ADC_REQ_DONE1_VWCINUP,
	S2MF301X_PM_ADC_REQ_DONE1_VCHGINUP,
	S2MF301X_PM_ADC_REQ_DONE2_GPADC3UP,
	S2MF301X_PM_ADC_REQ_DONE2_GPADC2UP,
	S2MF301X_PM_ADC_REQ_DONE2_GPADC1UP,
	S2MF301X_PM_ADC_REQ_DONE2_ITXUP,
	S2MF301X_PM_ADC_REQ_DONE2_IOTGUP,
	S2MF301X_PM_ADC_REQ_DONE2_IWCINUP,
	S2MF301X_PM_ADC_REQ_DONE2_ICHGINUP,
	S2MF301X_PM_ADC_CHANGE_INT1_VCC2UP,
	S2MF301X_PM_ADC_CHANGE_INT1_VCC1UP,
	S2MF301X_PM_ADC_CHANGE_INT1_VBATUP,
	S2MF301X_PM_ADC_CHANGE_INT1_VSYSUP,
	S2MF301X_PM_ADC_CHANGE_INT1_VBYPUP,
	S2MF301X_PM_ADC_CHANGE_INT1_VWCINUP,
	S2MF301X_PM_ADC_CHANGE_INT1_VCHGINUP,
	S2MF301X_PM_ADC_CHANGE_INT2_GPADC3UP,
	S2MF301X_PM_ADC_CHANGE_INT2_GPADC2UP,
	S2MF301X_PM_ADC_CHANGE_INT2_GPADC1UP,
	S2MF301X_PM_ADC_CHANGE_INT2_ITXUP,
	S2MF301X_PM_ADC_CHANGE_INT2_IOTGUP,
	S2MF301X_PM_ADC_CHANGE_INT2_IWCINUP,
	S2MF301X_PM_ADC_CHANGE_INT2_ICHGINUP,
#endif
#if IS_ENABLED(CONFIG_REGULATOR_S2MF301)
	S2MF301X_HBST_IRQ_OFF,
	S2MF301X_HBST_IRQ_ON,
	S2MF301X_HBST_IRQ_SCP,
#endif
#if IS_ENABLED(CONFIG_CHARGER_S2MF301)
	S2MF301X_CHG0_IRQ_CHGIN_UVLOB,
	S2MF301X_CHG0_IRQ_CHGIN2BATB,
	S2MF301X_CHG0_IRQ_CHGIN_OVP,
	S2MF301X_CHG0_IRQ_VBUS_DET,
	S2MF301X_CHG0_IRQ_BATID,

	S2MF301X_CHG1_IRQ_RECHARGING,
	S2MF301X_CHG1_IRQ_DONE,
	S2MF301X_CHG1_IRQ_TOPOFF,
	S2MF301X_CHG1_IRQ_CV,
	S2MF301X_CHG1_IRQ_SC,
	S2MF301X_CHG1_IRQ_LC,
	S2MF301X_CHG1_IRQ_TRICKLE,
	S2MF301X_CHG1_IRQ_PRECHG,

	S2MF301X_CHG2_IRQ_IVR,
	S2MF301X_CHG2_IRQ_ICR,
	S2MF301X_CHG2_IRQ_VOLTAGE_LOOP,
	S2MF301X_CHG2_IRQ_SC_CC_LOOP,
	S2MF301X_CHG2_IRQ_BST_ON,
	S2MF301X_CHG2_IRQ_OTG_ON_OFF,
	S2MF301X_CHG2_IRQ_BST_LBAT,
	S2MF301X_CHG2_IRQ_OTG_TO_BAT,

	S2MF301X_CHG3_IRQ_TOPOFF_TIMER_FAULT,
	S2MF301X_CHG3_IRQ_COOL_FAST_CHG_TIMER_FAULT,
	S2MF301X_CHG3_IRQ_PRE_TRICKLE_CHG_TIMER_FAULT,
	S2MF301X_CHG3_IRQ_BAT_OCP,
	S2MF301X_CHG3_IRQ_WDT_AP_RESET,
	S2MF301X_CHG3_IRQ_WDT_SUSPEND,
	S2MF301X_CHG3_IRQ_VSYS_OVP,
	S2MF301X_CHG3_IRQ_VSYS_SCP,

	S2MF301X_CHG4_IRQ_QBAT_OFF,
	S2MF301X_CHG4_IRQ_TFB,
	S2MF301X_CHG4_IRQ_TSD,
#endif
	S2MF301X_IRQ_NR,
};
...
enum s2mf301_irq {
	...
	S2MF301_CHG5_IRQ_BYP_CHG_IN2BAT_OK,
