/*
 * max77888-private.h - Voltage regulator driver for the Maxim 77803
 *
...
/* pmic revision */
enum max77888_pmic_rev {
	MAX77888_REV_PASS1	= 0x00,
	MAX77888_REV_PASS2	= 0x01,
...
#define MAX77888_ENABLE_BIT 1
#define MAX77888_DISABLE_BIT 0
...
#define CTRL2_CPEn1_LOWPWD0 ((MAX77888_ENABLE_BIT << CTRL2_CPEn_SHIFT) | \
				(MAX77888_DISABLE_BIT << CTRL2_LOWPWD_SHIFT))
#define CTRL2_CPEn0_LOWPWD1 ((MAX77888_DISABLE_BIT << CTRL2_CPEn_SHIFT) | \
				(MAX77888_ENABLE_BIT << CTRL2_LOWPWD_SHIFT))
...
enum max77888_reg_ctrl1_val {
	MAX77888_MUIC_CTRL1_BIN_0_000 = 0x00,
	MAX77888_MUIC_CTRL1_BIN_1_001 = 0x01,
	MAX77888_MUIC_CTRL1_BIN_2_010 = 0x02,
	MAX77888_MUIC_CTRL1_BIN_3_011 = 0x03,
	MAX77888_MUIC_CTRL1_BIN_4_100 = 0x04,
	MAX77888_MUIC_CTRL1_BIN_5_101 = 0x05,
	MAX77888_MUIC_CTRL1_BIN_6_110 = 0x06,
	MAX77888_MUIC_CTRL1_BIN_7_111 = 0x07,
};
#if defined(CONFIG_SWITCH_DUAL_MODEM)
enum max77888_switch_sel_val {
	MAX77888_SWITCH_SEL_1st_BIT_USB		= 0x3 << 0,
	MAX77888_SWITCH_SEL_2nd_BIT_UART	= 0x3 << 2,
};
#else
enum max77888_switch_sel_val {
	MAX77888_SWITCH_SEL_1st_BIT_USB		= 0x1 << 0,
	MAX77888_SWITCH_SEL_2nd_BIT_UART	= 0x1 << 1,
#ifdef CONFIG_LTE_VIA_SWITCH
	MAX77888_SWITCH_SEL_3rd_BIT_LTE_UART	= 0x1 << 2,
#endif
};
#endif

enum max77888_reg_ctrl1_type {
	CTRL1_AP_USB =
		(MAX77888_MUIC_CTRL1_BIN_1_001 << COMP2SW_SHIFT)
		| MAX77888_MUIC_CTRL1_BIN_1_001 ,
	CTRL1_AUDIO =
		(MAX77888_MUIC_CTRL1_BIN_2_010 << COMP2SW_SHIFT)
		| MAX77888_MUIC_CTRL1_BIN_2_010 ,
	CTRL1_CP_USB =
		(MAX77888_MUIC_CTRL1_BIN_4_100 << COMP2SW_SHIFT)
		| MAX77888_MUIC_CTRL1_BIN_4_100 ,
	CTRL1_AP_UART =
		(MAX77888_MUIC_CTRL1_BIN_3_011 << COMP2SW_SHIFT)
		| MAX77888_MUIC_CTRL1_BIN_3_011 ,
	CTRL1_CP_UART =
		(MAX77888_MUIC_CTRL1_BIN_5_101 << COMP2SW_SHIFT)
		| MAX77888_MUIC_CTRL1_BIN_5_101 ,
};
...
enum max77888_irq {
	...
	MAX77888_MUIC_IRQ_INT2_VIDRM,

	/* MUIC INT3 */
	MAX77888_MUIC_IRQ_INT3_EOC,
	MAX77888_MUIC_IRQ_INT3_CGMBC,
	MAX77888_MUIC_IRQ_INT3_OVP,
	MAX77888_MUIC_IRQ_INT3_MBCCHGERR,
	MAX77888_MUIC_IRQ_INT3_CHGENABLED,
	MAX77888_MUIC_IRQ_INT3_BATDET,
...
extern int max77888_bulk_write(struct i2c_client *i2c, u8 reg, int count,
				u8 *buf);
extern int max77888_update_reg(struct i2c_client *i2c,
				u8 reg, u8 val, u8 mask);
extern int max77888_muic_get_charging_type(void);
extern int max77888_muic_get_status1_adc1k_value(void);
extern int max77888_muic_get_status1_adc_value(void);
extern int muic_otg_control(int enable);
extern void powered_otg_control(int);
extern int max77888_muic_set_audio_switch(bool enable);
extern int max77888_muic_read_adc(void);
extern int max77888_muic_read_vbvolt(void);
extern int max77888_muic_read_vbus(void);

#ifdef CONFIG_USB_HOST_NOTIFY
extern int max77888_muic_host_notify_cb(int enable);
#endif
