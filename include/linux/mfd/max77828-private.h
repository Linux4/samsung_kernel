...
#define CTRL4_FCTAUTO_MASK		(0x1 << CTRL4_FCTAUTO_SHIFT)
...
#define HVCTRL1_VBUSADCEN_MASK		(0x1 << HVCTRL1_VBUSADCEN_SHIFT)
...
#define HVCTRL2_MPNGENB_SHIFT		6
...
#define HVCTRL2_MPNGENB_MASK		(0x1 << HVCTRL2_MPNGENB_SHIFT)
...
extern void max77828_muic_set_chgdeten(int enable);
