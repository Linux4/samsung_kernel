...
#if defined(CONFIG_SEC_PERF_BUILD_KERNEL)
#define SEC_LOG_BASE				0x4B000000    /* SZ_512K */
#define SEC_LASTKMSG_BASE			0x4B080000    /* SZ_512K */
#define SEC_LOGGER_BASE				0x4B100000    /* SZ_512K */
#else
...
enum sec_debug_reset_reason_t {
	...
	RR_N = 9,		// not support in MTK, Thermal reset
	RR_T = 10,
	RR_C = 11,
};
