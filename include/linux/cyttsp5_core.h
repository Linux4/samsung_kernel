...
#define CY_DRIVER_REVCTRL 000006
...
#define CY_DRIVER_DATE "20131217"	/* YYYYMMDD */
...
struct cyttsp5_swd_loader_platform_data {
	struct cyttsp5_touch_firmware *fw;
	u32 flags;
	int swdck_ndelay;
};
...
struct cyttsp5_core_platform_data {
	...
	int (*irq_stat)(struct cyttsp5_core_platform_data *pdata,
		struct device *dev);
	int (*swd_xres)(struct cyttsp5_core_platform_data *pdata,
		struct device *dev);
	int (*swd_init)(struct cyttsp5_core_platform_data *pdata,
		int on, struct device *dev);
...
struct cyttsp5_platform_data {
	...
	struct cyttsp5_swd_loader_platform_data *swd_loader_pdata;
