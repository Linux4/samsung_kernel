 ...
 */
#define MMC_CAP2_DISABLE_BLK_ASYNC		(1 << 14)
#define MMC_CAP2_PACKED_RD      (1 << 28)       /* Allow packed read */
#define MMC_CAP2_PACKED_WR      (1 << 29)       /* Allow packed write */
#define MMC_CAP2_PACKED_CMD     (MMC_CAP2_PACKED_RD | \
		MMC_CAP2_PACKED_WR) /* Allow packed commands */
#define MMC_CAP2_PACKED_WR_CONTROL (1 << 30) /* Allow write packing control */
...
extern int mmc_shutdown_host(struct mmc_host *);
