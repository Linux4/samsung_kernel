...
enum TIMEOUT_CURRENT {
	TIMEOUT_CURRENT_100MA = 0x0,
	TIMEOUT_CURRENT_150MA = 0x1,
	TIMEOUT_CURRENT_200MA = 0x2,
	TIMEOUT_CURRENT_250MA = 0x3,
	TIMEOUT_CURRENT_300MA = 0x4,
	TIMEOUT_CURRENT_350MA = 0x5,
	TIMEOUT_CURRENT_400MA = 0x7,
};

#define STROBE_CURRENT_MASK 0x1F
#define TORCH_CURRENT_MASK  0x0F
#define STROBE_TIMING_MASK  0x3F
#define TIMEOUT_CURRENT_MASK 0xE0
...
struct rt8547_platform_data {
	...
	unsigned short timeout_current:3;
#endif
};
...
#if defined(CONFIG_MACH_BAFFINQ) || defined(CONFIG_MACH_CS05)
int rt8547_set_torch_current(int);
#endif
