/*
 * s2mpa05-regulator.h - Voltage regulator driver for the s2mpa05
 *
...
#define S2MPA05_VGI0_IRQ_S			(1 << 3)

/* PMIC ADDRESS: COMMON_bitmap */
#define S2MPA05_COMMON_VGPIO_REG0_1		0x00
#define S2MPA05_COMMON_VGPIO_REG0_2		0x01
#define S2MPA05_COMMON_CHIP_ID			0x0E
#define S2MPA05_COMMON_SPMI_CFG1		0x0F
#define S2MPA05_COMMON_SPMI_CFG2		0x10
#define S2MPA05_COMMON_SPMI_CFG3		0x11
#define S2MPA05_COMMON_COM_CTRL1		0x12
#define S2MPA05_COMMON_COM_CTRL2		0x13
#define S2MPA05_COMMON_COM_CTRL3		0x14
#define S2MPA05_COMMON_COM_CTRL5		0x15
#define S2MPA05_COMMON_TX_MASK			0x16
#define S2MPA05_COMMON_IRQ			0x17
#define S2MPA05_COMMON_COM_CTRL4		0x18
...
#define S2MPA05_PM1_SEQ_CTRL1			0x78
#define S2MPA05_PM1_SEQ_CTRL2			0x79
#define S2MPA05_PM1_CFG_PM2			0x7A
#define S2MPA05_PM1_CFG_PM3			0x7B
#define S2MPA05_PM1_CFG_PM4			0x7C
#define S2MPA05_PM1_CFG_PM5			0x7D
#define S2MPA05_PM1_SUB_CTRL			0x7E
#define S2MPA05_PM1_PSI_CTRL1			0x7F
#define S2MPA05_PM1_PSI_CTRL2			0x80
#define S2MPA05_PM1_SEL_HW_GPIO			0x81
...
#define S2MPA05_NUM_IRQ_PMIC_REGS	4 /* INT1 to INT4 */
...
extern int s2mpa05_bulk_read(struct i2c_client *i2c, uint8_t reg, int count, uint8_t *buf);
extern int s2mpa05_write_reg(struct i2c_client *i2c, uint8_t reg, uint8_t value);
extern int s2mpa05_bulk_write(struct i2c_client *i2c, uint8_t reg, int count, uint8_t *buf);
