...
#define SMC_SECCAM_GETSTATUS            (0x82002125)
...
#define SMC_SECCAM_PREPARE		(0x82002135)
#define SMC_SECCAM_UNPREPARE		(0x82002136)
#define SMC_SECCAM_STATUS		(0x82002125)
#define SMC_SECCAM_SUPPORT_VRA		(0x8200213A)
...
#define PROT_JPEG			(13)
#define PROT_G2D			(14)
#define PROT_CSIS0			(15)
#define PROT_CSIS1			(16)
