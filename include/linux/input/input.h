...
#define SET_BOOSTER  { \
	pr_debug("[Input Booster2] %s      set_freq_limit : %d\n", glGage, _this->param[_this->index].cpu_freq); \
	mt_perfmgr_boost_freq(_this->param[_this->index].cpu_freq); \
	pr_debug("[Input Booster2] %s      mt_perfmgr_boost_core : %d\n", glGage, _this->param[_this->index].core_num_lock); \
	mt_perfmgr_boost_core(_this->param[_this->index].core_num_lock); \
}
#define REMOVE_BOOSTER  { \
	pr_debug("[Input Booster2] %s      set_freq_limit : %d\n", glGage, -1); \
	mt_perfmgr_boost_freq(-1);  \
	pr_debug("[Input Booster2] %s      mt_perfmgr_boost_core : %d\n", glGage, -1); \
