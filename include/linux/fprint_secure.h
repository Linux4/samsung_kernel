...
#define __FPRINT_SECURE_H
	...
	|| defined(CONFIG_SEC_HESTIA_PROJECT) || defined(CONFIG_MACH_A5LTE_JPN_KDI)
...
#if defined(CONFIG_SEC_ATLANTIC_PROJECT) || defined(CONFIG_SEC_HESTIA_PROJECT) || defined(CONFIG_MACH_A5LTE_JPN_KDI)
