...
enum power_supply_type {
	...
	POWER_SUPPLY_TYPE_USB_PARALLEL,		/* USB Parallel Path (44) */
	POWER_SUPPLY_TYPE_WIPOWER,		/* Wipower (45) */
	POWER_SUPPLY_TYPE_TYPEC,	/*Type-C (46) */
	POWER_SUPPLY_TYPE_UFP,		/* Type-C UFP (47) */
	POWER_SUPPLY_TYPE_DFP,		/* TYpe-C DFP (48) */
