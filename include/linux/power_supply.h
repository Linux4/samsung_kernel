...
enum power_supply_property {
	...
	POWER_SUPPLY_PROP_BATTERY_CYCLE,//chk 80637,xuejizhou.wt,ADD,20210203,battery protect
	#endif
	//-Bug 615302,xuejizhou.wt,ADD,20210113,battery Current event and slate mode
...
enum power_supply_type {
	...
	POWER_SUPPLY_TYPE_OTG,			/*host device mode*/ //Bug615303,xuejizhou.wt,ADD,20200107,OTG status
	/* Added by Customer */
