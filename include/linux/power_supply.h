...
#if defined(CONFIG_SSDEV_IN_MTK)
#undef __LINUX_POWER_SUPPLY_H__
/* compatible GED */
#include <linux/ssdev_in_mtk/power_supply.h>
#else
...
#if defined(CONFIG_BATTERY_GKI)
	POWER_SUPPLY_LSI_PROP_MAX = POWER_SUPPLY_PROP_MAX + 256,
#else
