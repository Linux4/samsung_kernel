...
enum power_supply_property {
	...
	POWER_SUPPLY_PROP_FORCE_HIZ_MODE,
	POWER_SUPPLY_PROP_SHIPMODE, //bug781105,wujishuai.wt,20220712,add shipmode node
...
enum power_supply_usb_type {
	...
	POWER_SUPPLY_USB_TYPE_AFC,//add afc type by guoyanjun
};
