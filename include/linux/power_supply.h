...
enum power_supply_property {
	...
	POWER_SUPPLY_PROP_VOLTAGE,  //Bug682956,yangyuhang.wt ,20210813, reading charging vol
	POWER_SUPPLY_PROP_TYPEC_POLARITY,//Bug682956,yangyuhang.wt ,20210813, add cc polarity node
	POWER_SUPPLY_PROP_REAL_TYPE,  //Bug686637,yangyuhang.wt ,20210819, add real type node
	POWER_SUPPLY_PROP_BATT_MISC_EVENT,//Bug682591,wangmingyuan.wt,ADD,20210813,battery misc event
	POWER_SUPPLY_PROP_BATT_CURRENT_UA_NOW,//Bug682591,wangmingyuan.wt,ADD,20210813,battery Current Consumption
	POWER_SUPPLY_PROP_NEW_CHARGE_TYPE,//Bug682591,wangmimgyuan.wt,ADD,20210813,charging type report,Fast or Slow
	POWER_SUPPLY_PROP_AFC_FLAG,//Bug685833,yangyuhang.wt ,20210826, add Charging afc flag node
	POWER_SUPPLY_PROP_HV_CHARGER_STATUS,//Bug682591,wangmingyuan.wt,ADD,20210814,hv charger status
	POWER_SUPPLY_PROP_STORE_MODE,//bug 682591,wangmingyuan.wt,ADD,20210814, battery SOC limitation for store mode
...
enum power_supply_type {
	...
	POWER_SUPPLY_TYPE_OTG,			/*host device mode*/ //Bug682591,yangyuhang.wt,ADD,20210812,OTG status
	/* Added by Customer */
