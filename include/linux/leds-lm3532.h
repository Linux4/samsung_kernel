...
struct lm3532_platform_data {
	...
	u32 flags;
	u32 ramp_time;          /* Ramp time if ramping in the driver */
	u32 ctrl_a_fs_current;  /* control a full scale current */
	u32 ctrl_b_fs_current;  /* control b full scale current */
	u32 ctrl_c_fs_current;  /* control c full scale current */
	u32 ctrl_a_mapping_mode; /* Control A Mapping mode (linear/exp) */
	u32 ctrl_b_mapping_mode; /* Control B Mapping mode (linear/exp) */
	u32 ctrl_c_mapping_mode; /* Control C Mapping mode (linear/exp) */
	u32 ctrl_a_pwm;
};
#endif
