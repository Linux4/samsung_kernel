...
#define SENSOR_TYPE_CAPSENSE (SENSOR_TYPE_DEVICE_PRIVATE_BASE + 24)
//-Bug 445219 huangcunzhu_wt,20190513,MODIFY,change sar type ID
//+P86801AA1 ludandan2.wt,MODIFY,change sar type ID
#define SENSOR_TYPE_SAR_MIAN (SENSOR_TYPE_DEVICE_PRIVATE_BASE + 24)
#define SENSOR_TYPE_SAR_SUB  (SENSOR_TYPE_DEVICE_PRIVATE_BASE)
...
// + wt add Adaptive ss sensor hal-vts fail,ludandan2 20230815, start
	int	(*sensors_flush)(struct sensors_classdev *sensors_cdev, unsigned char flush);
