...
extern int pdic_policy_send_pdo(void *data, int max_v, int min_v, int max_icl, int cnt, int num, int snum);
extern void *pdic_policy_init(struct pp_ic_data *ic_data);
extern void pdic_policy_deinit(struct pp_ic_data *ic_data);
#else
static inline int pdic_policy_send_msg(void *data, int msg) {return 0; }
static inline int pdic_policy_send_pdo(void *data, int max_v, int min_v, int max_icl, int cnt, int num, int snum) {return 0; }
