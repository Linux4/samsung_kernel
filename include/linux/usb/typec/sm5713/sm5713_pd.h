...
#define MAX_CHARGING_VOLT		11000 /* 9V */
...
#define tSenderResponse			(30)	/* 24~30 ms */
#define tSendSourceCap			(150)	/* 100 ~ 200 ms */
#define tPSHardReset			(25)	/* 25~35 ms */
#define tSinkWaitCap			(600)	/* 310~620 ms  */
#define tPSTransition			(540)	/* 450~550 ms */
...
extern int (*fp_sec_pd_get_apdo_max_current)(unsigned int *pdo_pos,
		unsigned int taMaxVol, unsigned int *taMaxCur);
