...
#elif defined(CONFIG_CHARGER_88PM886)
#include <linux/battery/charger/88pm886_charger.h>
#elif defined(CONFIG_CHARGER_88PM88X)
#include <linux/battery/charger/88pm88x_charger.h>
#endif
