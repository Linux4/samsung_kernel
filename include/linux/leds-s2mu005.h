/*
 * leds-s2mu005.h - Flash-led driver for Samsung S2MU005
 *
...
#define S2MU005_FLASH_BRIGHTNESS(mA) mA<=400?(((mA-25)/25) & 0x1f):(mA<=1200?(((((mA-400)/50)+0x0F)) & 0x1f):31)
#define S2MU005_TORCH_BRIGHTNESS(mA) mA<=400?(((mA - 25) /25) & 0x0f):400
...
extern bool s2mu005_is_fd_in_use(void);
