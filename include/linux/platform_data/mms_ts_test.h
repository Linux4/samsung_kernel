...
int get_cm_delta(struct mms_ts_test *test);
int get_cm_abs(struct mms_ts_test *test);
int get_cm_jitter(struct mms_ts_test *test);
int get_intensity(struct mms_ts_test *test);
#endif
