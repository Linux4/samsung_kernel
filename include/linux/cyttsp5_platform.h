...
extern struct cyttsp5_swd_loader_platform_data
		_cyttsp5_swd_loader_platform_data;
...
int cyttsp5_irq_stat(struct cyttsp5_core_platform_data *pdata,
		struct device *dev);
int cyttsp5_swd_xres(struct cyttsp5_core_platform_data *pdata,
		struct device *dev);
int cyttsp5_swd_init(struct cyttsp5_core_platform_data *pdata, int on,
		struct device *dev);
