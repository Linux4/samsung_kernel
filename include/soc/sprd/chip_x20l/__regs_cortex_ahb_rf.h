...
#define REG_CORTEX_AHB_RF_CLK_CORTEX_AXI_CTRL             SCI_ADDR(REGS_CORTEX_AHB_RF_BASE, 0x0000)/*CORTEX_AXI clock control*/
#define REG_CORTEX_AHB_RF_CLK_CORTEX_AHB_CTRL             SCI_ADDR(REGS_CORTEX_AHB_RF_BASE, 0x0004)/*CORTEX_AHB clock control*/
#define REG_CORTEX_AHB_RF_CLK_CORTEX_APB_CTRL             SCI_ADDR(REGS_CORTEX_AHB_RF_BASE, 0x0008)/*CORTEX_APB clock control*/
#define REG_CORTEX_AHB_RF_CLK_SEC0_CTRL                   SCI_ADDR(REGS_CORTEX_AHB_RF_BASE, 0x000C)/*SEC0 clock control*/
#define REG_CORTEX_AHB_RF_CLK_SEC1_CTRL                   SCI_ADDR(REGS_CORTEX_AHB_RF_BASE, 0x0010)/*SEC1 clock control*/
#define REG_CORTEX_AHB_RF_CA5_CFG                         SCI_ADDR(REGS_CORTEX_AHB_RF_BASE, 0x0030)/* CortexA5 config*/
#define REG_CORTEX_AHB_RF_AHB_CTRL0                       SCI_ADDR(REGS_CORTEX_AHB_RF_BASE, 0x0034)/*AHB control 0*/
#define REG_CORTEX_AHB_RF_AHB_CTRL2                       SCI_ADDR(REGS_CORTEX_AHB_RF_BASE, 0x003C)/*AHB control 2*/
#define REG_CORTEX_AHB_RF_AHB_RST0_STS                    SCI_ADDR(REGS_CORTEX_AHB_RF_BASE, 0x0060)/*AHB software reset*/
#define REG_CORTEX_AHB_RF_CA5_RST_SET                     SCI_ADDR(REGS_CORTEX_AHB_RF_BASE, 0x0064)
#define REG_CORTEX_AHB_RF_ARCH_EB                         SCI_ADDR(REGS_CORTEX_AHB_RF_BASE, 0x0068)
#define REG_CORTEX_AHB_RF_PTEST_FUNC                      SCI_ADDR(REGS_CORTEX_AHB_RF_BASE, 0x006C)
#define REG_CORTEX_AHB_RF_AHB_MISC_CTL                    SCI_ADDR(REGS_CORTEX_AHB_RF_BASE, 0x0070)
#define REG_CORTEX_AHB_RF_CA5_CTRL                        SCI_ADDR(REGS_CORTEX_AHB_RF_BASE, 0x0074)/* Cortex A5 control*/
#define REG_CORTEX_AHB_RF_AUTO_GATE_CTRL                  SCI_ADDR(REGS_CORTEX_AHB_RF_BASE, 0x0078)/*Auto gate control*/
#define REG_CORTEX_AHB_RF_AHB_PAUSE                       SCI_ADDR(REGS_CORTEX_AHB_RF_BASE, 0x0080)/*AHB sleep control*/
#define REG_CORTEX_AHB_RF_AHB_SLP_CTL                     SCI_ADDR(REGS_CORTEX_AHB_RF_BASE, 0x0084)
#define REG_CORTEX_AHB_RF_AHB_SLP_STS                     SCI_ADDR(REGS_CORTEX_AHB_RF_BASE, 0x0088)
#define REG_CORTEX_AHB_RF_MCU_CLK_CTL                     SCI_ADDR(REGS_CORTEX_AHB_RF_BASE, 0x008C)
#define REG_CORTEX_AHB_RF_RES_REG0                        SCI_ADDR(REGS_CORTEX_AHB_RF_BASE, 0x00F4)
#define REG_CORTEX_AHB_RF_CHIP_ID                         SCI_ADDR(REGS_CORTEX_AHB_RF_BASE, 0x0200)
