...
#define REG_AON_APB_TGDSP_BOOT_EN                      SCI_ADDR(REGS_AON_APB_BASE, 0x0134)/*TGDSP_BOOT_EN*/
#define REG_AON_APB_TGDSP_BOOT_VEC                     SCI_ADDR(REGS_AON_APB_BASE, 0x0138)/*TGDSP_BOOT_VEC*/
#define REG_AON_APB_TGDSP_RST                          SCI_ADDR(REGS_AON_APB_BASE, 0x013C)/*TGDSP_RST*/
#define REG_AON_APB_RFFE_CFG                           SCI_ADDR(REGS_AON_APB_BASE, 0x0140)/*RFFE_CFG*/
#define REG_AON_APB_OSC_CTRL                           SCI_ADDR(REGS_AON_APB_BASE, 0x0144)/*osc_ctrl*/
#define REG_AON_APB_OSC_OBS                            SCI_ADDR(REGS_AON_APB_BASE, 0x0148)/*CA53_OSC_OBS*/
#define REG_AON_APB_CA7_SDISABLE                       SCI_ADDR(REGS_AON_APB_BASE, 0x014C)/*CA7_SDISABLE*/
...
#define REG_AON_APB_CP0_MISC_CTL0                      SCI_ADDR(REGS_AON_APB_BASE, 0x306C)/*CP0_MISC_CTL0*/
#define REG_AON_APB_CP0_MCU_C2C_SEMA                   SCI_ADDR(REGS_AON_APB_BASE, 0x3070)/*CP0_MCU_C2C_SEMA*/
#define REG_AON_APB_CP0_MCU_CLK_CTL                    SCI_ADDR(REGS_AON_APB_BASE, 0x3074)/*CP0_MCU_CLK_CTL*/
...
#define REG_AON_APB_APB_ROM_PD_CTL                     SCI_ADDR(REGS_AON_APB_BASE, 0x3088)/*APB_ROM_PD_CTL*/
#define REG_AON_APB_CP0_SLP_STS                        SCI_ADDR(REGS_AON_APB_BASE, 0x308C)/*CP0_SLP_STS*/
#define REG_AON_APB_CP0_DSP_JTAG_CTL                   SCI_ADDR(REGS_AON_APB_BASE, 0x3090)/*CP0_DSP_JTAG_CTL*/
#define REG_AON_APB_ANA_PD_STS                         SCI_ADDR(REGS_AON_APB_BASE, 0x3094)/*ANA_PD_STS*/
...
#define REG_AON_APB_AON_CHIP_ID_DIG                    SCI_ADDR(REGS_AON_APB_BASE, 0x00F8)/*AON_DCHIP_ID_DIG*/
...
#define BIT_MIPI_DSI_TXCLKHSSRC_DIV_EN                    ( BIT(28) )
...
#define BITS_LVDSDISPLL_POSTDIV(_X_)                      ( (_X_) << 11 & (BIT(11)|BIT(12)|BIT(13)|BIT(14)) )
...
#define BIT_FUNCTST_DMA_EB                                ( BIT(2) )
#define BIT_ARM7_FUNCTST_BUS_SLEEP                        ( BIT(1) )
...
/* bits definitions for register REG_AON_APB_RF_TGDSP_BOOT_EN */
#define BIT_AHB_VCP1_DEEP_SLEEP_EN                        ( BIT(4) )
#define BIT_ASHB_ARMTODSP_EN                              ( BIT(3) )
#define BIT_ARM_DAHB_SLEEP_EN                             ( BIT(2) )
#define BIT_FRC_CLK_TGDSP_EN                              ( BIT(1) )
#define BIT_TGDSP_BOOT_EN                                 ( BIT(0) )

/* bits definitions for register REG_AON_APB_RF_TGDSP_BOOT_VEC */
#define BITS_AON_APB_RF_TGDSP_BOOT_VECTOR(_X_)            (_X_)

/* bits definitions for register REG_AON_APB_RF_TGDSP_RST */
#define BIT_AON_APB_RF_TGDSP_SYS_SRST                     ( BIT(1) )
#define BIT_AON_APB_RF_TGDSP_CORE_SRST_N                  ( BIT(0) )

/* bits definitions for register REG_AON_APB_RF_RFFE_CFG */
#define BIT_AON_APB_RF_LTE_RFFE_SEL                       ( BIT(1) )
#define BIT_AON_APB_RF_TG_RFFE_SEL                        ( BIT(0) )

/* bits definitions for register REG_AON_APB_RF_osc_ctrl */
#define BITS_AON_APB_RF_OSC_CTRL_SEL(_X_)                 ( (_X_) << 16 & (BIT(16)|BIT(17)|BIT(18)) )
#define BIT_AON_APB_RF_OSC_CTRL_EN                        ( BIT(15) )
#define BIT_AON_APB_RF_OSC_CTRL_START                     ( BIT(14) )
#define BIT_AON_APB_RF_OSC_CTRL_RSTN                      ( BIT(13) )
#define BITS_AON_APB_RF_OSC_CTRL_CLK_NUM(_X_)             ( (_X_) & (BIT(0)|BIT(1)|BIT(2)|BIT(3)|BIT(4)|BIT(5)|BIT(6)|BIT(7)|BIT(8)|BIT(9)|BIT(10)|BIT(11)|BIT(12)) )

/* bits definitions for register REG_AON_APB_RF_OSC_OBS */
#define BIT_AON_APB_RF_OSC_OBS_OVERFLOW                   ( BIT(15) )
#define BITS_AON_APB_RF_OSC_OBS_SPEED_CNT(_X_)            ( (_X_) & (BIT(0)|BIT(1)|BIT(2)|BIT(3)|BIT(4)|BIT(5)|BIT(6)|BIT(7)|BIT(8)|BIT(9)|BIT(10)|BIT(11)|BIT(12)|BIT(13)|BIT(14)) )

/* bits definitions for register REG_AON_APB_RF_CA7_SDISABLE */
#define BIT_AON_APB_RF_CA7_CFGSDISABLE                    ( BIT(4) )
#define BITS_AON_APB_RF_CA7_CP15SDISABLE(_X_)             ( (_X_) & (BIT(0)|BIT(1)|BIT(2)|BIT(3)) )
...
#define BITS_LVDSDIS_TXIMP(_X_)                           ( (_X_) << 29 & (BIT(29)|BIT(30)|BIT(31)) )
#define BITS_LVDSDIS_TXPD(_X_)                            ( (_X_) << 23 & (BIT(23)|BIT(24)|BIT(25)|BIT(26)|BIT(27)|BIT(28)) )
#define BITS_LVDSDIS_TXCLKDATA(_X_)                       ( (_X_) << 16 & (BIT(16)|BIT(17)|BIT(18)|BIT(19)|BIT(20)|BIT(21)|BIT(22)) )
#define BIT_LVDSDIS_OFF_OCT	                              ( BIT(15) )
...
#define BIT_LVDSDIS_CLKOUT_EN                             ( BIT(7) )
#define BITS_LVDSDIS_TXRERSER(_X_)                        ( (_X_) << 3 & (BIT(3)|BIT(4)|BIT(5)|BIT(6)) )
#define BITS_LVDSDIS_PRE_EMP(_X_)                         ( (_X_) << 1 & (BIT(1)|BIT(2)) )

/* bits definitions for register REG_AON_APB_PLL_LOCK_OUT_SEL */
#define BITS_DPLL_DBG_SEL(_X_)                            ( (_X_) << 16 & (BIT(16)|BIT(17)) )
#define BITS_LPLL_DBG_SEL(_X_)                            ( (_X_) << 14 & (BIT(14)|BIT(15)) )
#define BITS_LVDSPLL_DBG_SEL(_X_)                         ( (_X_) << 12 & (BIT(12)|BIT(13)) )
#define BITS_MPLL_DBG_SEL(_X_)                            ( (_X_) << 10 & (BIT(10)|BIT(11)) )
#define BITS_TWPLL_DBG_SEL(_X_)                           ( (_X_) << 8 & (BIT(8)|BIT(9)) )
...
/* bits definitions for register REG_AON_APB_RF_CP0_MISC_CTL0 */
#define BITS_ARM_FRC_STOP(_X_)                            ( (_X_) << 6 & (BIT(6)|BIT(7)|BIT(8)|BIT(9)|BIT(10)|BIT(11)|BIT(12)|BIT(13)|BIT(14)) )
#define BIT_MCU_FORCE_LIGHT_SLEEP                         ( BIT(5) )
#define BIT_MCU_FORCE_DEEP_SLEEP                          ( BIT(4) )
#define BIT_CHIP_SLP_ARM_CLR                              ( BIT(3) )
#define BIT_ALL_CLK_EN                                    ( BIT(2) )
#define BIT_WAKEUP_XTL_EN_2G                              ( BIT(1) )
#define BIT_WAKEUP_XTL_EN_3G_TD                           ( BIT(0) )

/* bits definitions for register REG_AON_APB_RF_CP0_MCU_C2C_SEMA */
...
/* bits definitions for register REG_AON_APB_RF_CP0_MCU_CLK_CTL */
#define BIT_CLK_MCU_DBG_SEL                               ( BIT(4) )
#define BITS_CLK_COM_DBG_SEL(_X_)                         ( (_X_) << 2 & (BIT(2)|BIT(3)) )
#define BITS_CLK_SYS_DBG_SEL(_X_)                         ( (_X_) & (BIT(0)|BIT(1)) )

/* bits definitions for register REG_AON_APB_RF_PROT_BUS_SECURE_EN */
#define BIT_BUS_SECURE_EN                                 ( BIT(0) )

/* bits definitions for register REG_AON_APB_RF_PROT_ARM7_SPACE_EN */
#define BIT_ARM7_SPACE_EN                                 ( BIT(0) )

/* bits definitions for register REG_AON_APB_RF_APB_ROM_PD_CTL */
#define BIT_ROM_FORCE_ON                                  ( BIT(0) )

/* bits definitions for register REG_AON_APB_RF_CP0_SLP_STS */
#define BITS_CP0_SLP_STS(_X_)                             (_X_)

/* bits definitions for register REG_AON_APB_RF_CP0_DSP_JTAG_CTL */
...
/* bits definitions for register REG_AON_APB_RF_ANA_PD_STS */
#define BITS_ANA_PD_STS(_X_)                              (_X_)

/* bits definitions for register REG_AON_APB_RF_AON_APB_RSV */
#define BITS_AON_APB_RSV(_X_)                             (_X_)

/* bits definitions for register REG_AON_APB_AON_CHIP_ID */
#define BITS_AON_CHIP_ID(_X_)                             (_X_)

/* bits definitions for register REG_AON_APB_RF_AON_CHIP_ID_DIG */
#define BITS_AON_CHIP_ID_DIG(_X_)                         (_X_)
