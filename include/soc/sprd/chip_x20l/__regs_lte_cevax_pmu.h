...
#define REG_LTE_CEVAX_PMU_AXI_MON_CTRL                    SCI_ADDR(REGS_LTE_CEVAX_PMU_BASE, 0xA8)
...
#define BIT_LTE_CEVAX_PMU_CLK_LTE_ANA_4X_EN	              ( BIT(18) )
...
/* bits definitions for register REG_LTE_CEVAX_PMU_AXI_MON_CTRL */
#define BIT_AXI_MON_WAIT_EB                               ( BIT(21) )
#define BIT_AXI_MON_CLKEN_EB                              ( BIT(20) )
#define BITS_AXI_MONITOR_STATUS(_X_)                      ( (_X_) & (BIT(0)|BIT(1)|BIT(2)|BIT(3)|BIT(4)|BIT(5)|BIT(6)|BIT(7)|BIT(8)|BIT(9)|BIT(10)|BIT(11)|BIT(12)|BIT(13)|BIT(14)|BIT(15)|BIT(16)|BIT(17)|BIT(18)|BIT(19)) )
