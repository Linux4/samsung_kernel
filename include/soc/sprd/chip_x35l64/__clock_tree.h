...
SCI_CLK_ADD(clk_66m_d, 0, REG_PMU_APB_PLL_DIV_EN1, BIT(2),
	8, 0, 0, 0,
	1, &clk_dpll);
...
SCI_CLK_ADD(clk_40m_wf1, 0, REG_PMU_APB_PLL_DIV_EN1, BIT(27),
	22, 0, 0, 0,
	1, &clk_wifipll);
...
SCI_CLK_ADD(clk_208m, 0, REG_PMU_APB_CGM_AP_EN, BIT(20),
	3, 0, 0, 0,
	1, &clk_cpll);
...
SCI_CLK_ADD(clk_ca7_dbg, 0, REG_AP_AHB_MISC_CKG_EN, BIT(8),
...
SCI_CLK_ADD(clk_zip_emc, 0, REG_AON_APB_APB_EB1, BIT(12),
	0, 0, 0, 0,
	1, &clk_aon_apb);
...
SCI_CLK_ADD(clk_gsp, 0, REG_AP_AHB_AHB_EB, BIT(3),
	...
	4, &clk_76m8, &clk_96m, &clk_128m, &clk_153m6);

SCI_CLK_ADD(clk_disc0, 0, REG_AP_AHB_AHB_EB, BIT(1),
	REG_AP_CLK_DISPC0_CFG, BIT(8)|BIT(9)|BIT(10), REG_AP_CLK_DISPC0_CFG, BIT(0),
...
SCI_CLK_ADD(clk_disc1, 0, REG_AP_AHB_AHB_EB, BIT(2),
	REG_AP_CLK_DISPC1_CFG, BIT(8)|BIT(9)|BIT(10), REG_AP_CLK_DISPC1_CFG, BIT(0),
	2, &clk_153m6, &clk_192m);
...
SCI_CLK_ADD(clk_jpg, 0, &clk_jpg_ckg_i, 0,
	...
	4, &clk_76m8, &clk_128m, &clk_153m6, &clk_192m);
...
SCI_CLK_ADD(clk_aux0, 0, REG_AON_APB_APB_EB1, BIT(2),
	...
	9, &ext_32k, &ext_26m, &ext_26m, &clk_48m, &clk_52m, &clk_51m2_w, &clk_37m5, &clk_40m_wf1, &clk_66m_d);
