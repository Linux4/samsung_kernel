...
#define REG_CORTEX_GLB_APB_EB0_STS                        SCI_ADDR(REGS_CORTEX_GLB_BASE, 0x0008)
#define REG_CORTEX_GLB_APB_RST0_STS                       SCI_ADDR(REGS_CORTEX_GLB_BASE, 0x0014)
#define REG_CORTEX_GLB_APB_MCU_RST                        SCI_ADDR(REGS_CORTEX_GLB_BASE, 0x0018)
#define REG_CORTEX_GLB_APB_CLK_SEL0                       SCI_ADDR(REGS_CORTEX_GLB_BASE, 0x001C)
#define REG_CORTEX_GLB_APB_CLK_SEL1                       SCI_ADDR(REGS_CORTEX_GLB_BASE, 0x0020)
#define REG_CORTEX_GLB_APB_ARCH_EB                        SCI_ADDR(REGS_CORTEX_GLB_BASE, 0x0024)
#define REG_CORTEX_GLB_APB_MISC_CTL0                      SCI_ADDR(REGS_CORTEX_GLB_BASE, 0x0028)
#define REG_CORTEX_GLB_APB_MISC_CTL1                      SCI_ADDR(REGS_CORTEX_GLB_BASE, 0x002C)
#define REG_CORTEX_GLB_APB_CLK_SEL2                       SCI_ADDR(REGS_CORTEX_GLB_BASE, 0x0030)
#define REG_CORTEX_GLB_APB_BUS_CTL0                       SCI_ADDR(REGS_CORTEX_GLB_BASE, 0x0058)
#define REG_CORTEX_GLB_APB_MEM_LP_CTRL0                   SCI_ADDR(REGS_CORTEX_GLB_BASE, 0x005c)
#define REG_CORTEX_GLB_APB_MEM_LP_CTRL1                   SCI_ADDR(REGS_CORTEX_GLB_BASE, 0x0060)
#define REG_CORTEX_GLB_APB_DSP_INT_CLR                    SCI_ADDR(REGS_CORTEX_GLB_BASE, 0x0074)
#define REG_CORTEX_GLB_APB_MISC_INT_STS                   SCI_ADDR(REGS_CORTEX_GLB_BASE, 0x0078)
#define REG_CORTEX_GLB_APB_HWRST                          SCI_ADDR(REGS_CORTEX_GLB_BASE, 0x0080)
#define REG_CORTEX_GLB_APB_ARM_BOOT_ADDR                  SCI_ADDR(REGS_CORTEX_GLB_BASE, 0x0084)
...
/* bits definitions for register REG_CORTEX_GLB_APB_MEM_LP_CTRL0 */
#define BITS_APB_MEM_LP_CTRL0(_X_)                        (_X_)

/* bits definitions for register REG_CORTEX_GLB_APB_MEM_LP_CTRL1 */
#define BITS_APB_MEM_LP_CTRL1(_X_)                        (_X_)
