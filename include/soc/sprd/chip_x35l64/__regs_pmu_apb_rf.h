...
#define BIT_DDR_PHY_CKE_RET_EN   BIT_DDR_PHY_RET_EN
...
#define BIT_PD_CA7_TOP_BISR_DONE                          BIT_PD_APCPU_TOP_BISR_DONE
#define BIT_PD_CA7_C3_BISR_DONE                           BIT_PD_APCPU_C3_BISR_DONE
#define BIT_PD_CA7_C2_BISR_DONE                           BIT_PD_APCPU_C2_BISR_DONE
#define BIT_PD_CA7_C1_BISR_DONE                           BIT_PD_APCPU_C1_BISR_DONE
#define BIT_PD_CA7_C0_BISR_DONE                           BIT_PD_APCPU_C0_BISR_DONE
...
#define BIT_PD_CA7_TOP_BISR_BUSY                          BIT_PD_APCPU_TOP_BISR_BUSY
#define BIT_PD_CA7_C3_BISR_BUSY                           BIT_PD_APCPU_C3_BISR_BUSY
#define BIT_PD_CA7_C2_BISR_BUSY                           BIT_PD_APCPU_C2_BISR_BUSY
#define BIT_PD_CA7_C1_BISR_BUSY                           BIT_PD_APCPU_C1_BISR_BUSY
#define BIT_PD_CA7_C0_BISR_BUSY                           BIT_PD_APCPU_C0_BISR_BUSY
...
#define BIT_PD_CA7_TOP_BISR_FORCE_BYP                     BIT_PD_APCPU_TOP_BISR_FORCE_BYP
#define BIT_PD_CA7_C3_BISR_FORCE_BYP                      BIT_PD_APCPU_C3_BISR_FORCE_BYP
#define BIT_PD_CA7_C2_BISR_FORCE_BYP                      BIT_PD_APCPU_C2_BISR_FORCE_BYP
#define BIT_PD_CA7_C1_BISR_FORCE_BYP                      BIT_PD_APCPU_C1_BISR_FORCE_BYP
#define BIT_PD_CA7_C0_BISR_FORCE_BYP                      BIT_PD_APCPU_C0_BISR_FORCE_BYP
...
#define BIT_PD_CA7_TOP_BISR_FORCE_EN                      BIT_PD_APCPU_TOP_BISR_FORCE_EN
#define BIT_PD_CA7_C3_BISR_FORCE_EN                       BIT_PD_APCPU_C3_BISR_FORCE_EN
#define BIT_PD_CA7_C2_BISR_FORCE_EN                       BIT_PD_APCPU_C2_BISR_FORCE_EN
#define BIT_PD_CA7_C1_BISR_FORCE_EN                       BIT_PD_APCPU_C1_BISR_FORCE_EN
#define BIT_PD_CA7_C0_BISR_FORCE_EN                       BIT_PD_APCPU_C0_BISR_FORCE_EN
...
#define BIT_CGM_TWPLL_128M_MM_AUTO_GATE_SEL_CFG1	(BIT(31))
#define BIT_CGM_TWPLL_153M6_MM_AUTO_GATE_SEL	(BIT(30))
#define BIT_CGM_TWPLL_192M_MM_AUTO_GATE_SEL	( BIT(29) )
#define BIT_CGM_TWPLL_256M_MM_AUTO_GATE_SEL	( BIT(28) )
#define BIT_CGM_TWPLL_307M2_MM_AUTO_GATE_SEL	( BIT(27) )
#define BIT_CGM_26M_MM_AUTO_GATE_SEL		( BIT(26) )
#define BIT_CGM_TWPLL_12M_AP_AUTO_GATE_SEL	( BIT(25) )
#define BIT_CGM_TWPLL_24M_AP_AUTO_GATE_SEL	( BIT(24) )
#define BIT_CGM_TWPLL_48M_AP_AUTO_GATE_SEL	( BIT(23) )
#define BIT_CGM_TWPLL_51M2_AP_AUTO_GATE_SEL	( BIT(22) )
#define BIT_CGM_TWPLL_64M_AP_AUTO_GATE_SEL	( BIT(21) )
#define BIT_CGM_TWPLL_76M8_AP_AUTO_GATE_SEL	( BIT(20) )
#define BIT_CGM_TWPLL_96M_AP_AUTO_GATE_SEL	( BIT(19) )
#define BIT_CGM_TWPLL_128M_AP_AUTO_GATE_SEL	( BIT(18) )
#define BIT_CGM_TWPLL_153M6_AP_AUTO_GATE_SEL	( BIT(17) )
#define BIT_CGM_TWPLL_192M_AP_AUTO_GATE_SEL	( BIT(16) )
#define BIT_CGM_TWPLL_256M_AP_AUTO_GATE_SEL	( BIT(15) )
#define BIT_CGM_TWPLL_307M2_AP_AUTO_GATE_SEL	( BIT(14) )
#define BIT_CGM_TWPLL_384M_AP_AUTO_GATE_SEL	( BIT(13) )
#define BIT_CGM_TWPLL_512M_AP_AUTO_GATE_SEL	( BIT(12) )
#define BIT_CGM_TWPLL_768M_AP_AUTO_GATE_SEL	( BIT(11) )
#define BIT_CGM_LTEPLL_AP_AUTO_GATE_SEL		( BIT(10) )
#define BIT_CGM_TWPLL_AP_AUTO_GATE_SEL		( BIT(9) )
#define BIT_CGM_DPLL_AP_AUTO_GATE_SEL		( BIT(8) )
#define BIT_CGM_MPLL_AP_AUTO_GATE_SEL		( BIT(7) )
#define BIT_CGM_26M_AP_AUTO_GATE_SEL		( BIT(6) )
#define BIT_RC1_2M_AUTO_GATE_SEL		( BIT(5) )
#define BIT_RC0_2M_AUTO_GATE_SEL		( BIT(4) )
#define BIT_AON_1M_AUTO_GATE_SEL		( BIT(3) )
#define BIT_AON_2M_AUTO_GATE_SEL		( BIT(2) )
#define BIT_AON_13M_AUTO_GATE_SEL		( BIT(1) )
#define BIT_LTEPLL_DIV_30M72_AUTO_GATE_SEL	( BIT(0) )
#define BITS_CGM_AUTO_GATE_SEL_CFG1(_X_)	(_X_)
/* bits definitions for register REG_PMU_APB_CGM_AUTO_GATE_SEL_CFG2 */
#define BIT_CGM_LTEPLL_245M76_CP1_AUTO_GATE_SEL	( BIT(31) )
#define BIT_CGM_LTEPLL_307M2_CP1_AUTO_GATE_SEL	( BIT(30) )
#define BIT_CGM_LTEPLL_614M4_CP1_AUTO_GATE_SEL	( BIT(29) )
#define BIT_CGM_26M_CP1_AUTO_GATE_SEL		( BIT(28) )
#define BIT_CGM_TWPLL_5M12_CP0_AUTO_GATE_SEL	( BIT(27) )
#define BIT_CGM_TWPLL_10M24_CP0_AUTO_GATE_SEL	( BIT(26) )
#define BIT_CGM_TWPLL_51M2_CP0_AUTO_GATE_SEL	( BIT(25) )
#define BIT_CGM_TWPLL_76M8_CP0_AUTO_GATE_SEL	( BIT(24) )
#define BIT_CGM_TWPLL_153M6_CP0_AUTO_GATE_SEL	( BIT(23) )
#define BIT_CGM_TWPLL_48M_CP0_AUTO_GATE_SEL	( BIT(22) )
#define BIT_CGM_TWPLL_96M_CP0_AUTO_GATE_SEL	( BIT(21) )
#define BIT_CGM_TWPLL_192M_CP0_AUTO_GATE_SEL	( BIT(20) )
#define BIT_CGM_TWPLL_64M_CP0_AUTO_GATE_SEL	( BIT(19) )
#define BIT_CGM_TWPLL_102M4_CP0_AUTO_GATE_SEL	( BIT(18) )
#define BIT_CGM_TWPLL_128M_CP0_AUTO_GATE_SEL	( BIT(17) )
#define BIT_CGM_TWPLL_256M_CP0_AUTO_GATE_SEL	( BIT(16) )
#define BIT_CGM_TWPLL_219M_CP0_AUTO_GATE_SEL	( BIT(15) )
#define BIT_CGM_TWPLL_219M4_CP0_AUTO_GATE_SEL	( BIT(14) )
#define BIT_CGM_TWPLL_307M2_CP0_AUTO_GATE_SEL	( BIT(13) )
#define BIT_CGM_TWPLL_512M_CP0_AUTO_GATE_SEL	( BIT(12) )
#define BIT_CGM_26M_CP0_AUTO_GATE_SEL		( BIT(11) )
#define BIT_CGM_TWPLL_153M6_GPU_AUTO_GATE_SEL	( BIT(10) )
#define BIT_CGM_TWPLL_192M_GPU_AUTO_GATE_SEL	( BIT(9) )
#define BIT_CGM_TWPLL_256M_GPU_AUTO_GATE_SEL	( BIT(8) )
#define BIT_CGM_TWPLL_307M2_GPU_AUTO_GATE_SEL	( BIT(7) )
#define BIT_CGM_TWPLL_384M_GPU_AUTO_GATE_SEL	( BIT(6) )
#define BIT_CGM_TWPLL_512M_GPU_AUTO_GATE_SEL	( BIT(5) )
#define BIT_CGM_TWPLL_24M_MM_AUTO_GATE_SEL	( BIT(4) )
#define BIT_CGM_TWPLL_48M_MM_AUTO_GATE_SEL	( BIT(3) )
#define BIT_CGM_TWPLL_64M_MM_AUTO_GATE_SEL	( BIT(2) )
#define BIT_CGM_TWPLL_76M8_MM_AUTO_GATE_SEL	( BIT(1) )
#define BIT_CGM_TWPLL_96M_MM_AUTO_GATE_SEL	( BIT(0) )
#define BITS_CGM_AUTO_GATE_SEL_CFG2(_X_)	(_X_)
/* bits definitions for register REG_PMU_APB_CGM_AUTO_GATE_SEL_CFG3 */
#define BIT_CA5_TOP_AUTO_GATE_SEL		( BIT(19) )
#define BIT_CA7_TOP_AUTO_GATE_SEL		( BIT(18) )
#define BIT_CGM_TWPLL_48M_CP1_AUTO_GATE_SEL	( BIT(17) )
#define BIT_CGM_TWPLL_51M2_CP1_AUTO_GATE_SEL	( BIT(16) )
#define BIT_CGM_TWPLL_64M_CP1_AUTO_GATE_SEL	( BIT(15) )
#define BIT_CGM_TWPLL_76M8_CP1_AUTO_GATE_SEL	( BIT(14) )
#define BIT_CGM_TWPLL_96M_CP1_AUTO_GATE_SEL	( BIT(13) )
#define BIT_CGM_TWPLL_128M_CP1_AUTO_GATE_SEL	( BIT(12) )
#define BIT_CGM_TWPLL_153M6_CP1_AUTO_GATE_SEL	( BIT(11) )
#define BIT_CGM_TWPLL_192M_CP1_AUTO_GATE_SEL	( BIT(10) )
#define BIT_CGM_TWPLL_256M_CP1_AUTO_GATE_SEL	( BIT(9) )
#define BIT_CGM_TWPLL_512M_CP1_AUTO_GATE_SEL	( BIT(8) )
#define BIT_CGM_TWPLL_768M_CP1_AUTO_GATE_SEL	( BIT(7) )
#define BIT_CGM_LTEPLL_30M72_CP1_AUTO_GATE_SEL	( BIT(6) )
#define BIT_CGM_LTEPLL_61M44_CP1_AUTO_GATE_SEL	( BIT(5) )
#define BIT_CGM_LTEPLL_68M26_CP1_AUTO_GATE_SEL	( BIT(4) )
#define BIT_CGM_LTEPLL_102M4_CP1_AUTO_GATE_SEL	( BIT(3) )
#define BIT_CGM_LTEPLL_122M88_CP1_AUTO_GATE_SEL	( BIT(2) )
#define BIT_CGM_LTEPLL_153M6_CP1_AUTO_GATE_SEL	( BIT(1) )
#define BIT_CGM_LTEPLL_204M8_CP1_AUTO_GATE_SEL	( BIT(0) )
#define BITS_CGM_AUTO_GATE_SEL_CFG3(_X_)	(_X_)
/* bits definitions for register REG_PMU_APB_CGM_FORCE_EN_CFG0 */
#define BIT_CGM_TWPLL_512M_GPU_FORCE_EN	( BIT(31) )
#define BIT_CGM_TWPLL_24M_MM_FORCE_EN	( BIT(30) )
#define BIT_CGM_TWPLL_48M_MM_FORCE_EN	( BIT(29) )
#define BIT_CGM_TWPLL_64M_MM_FORCE_EN	( BIT(28) )
#define BIT_CGM_TWPLL_76M8_MM_FORCE_EN	( BIT(27) )
#define BIT_CGM_TWPLL_96M_MM_FORCE_EN	( BIT(26) )
#define BIT_CGM_TWPLL_128M_MM_FORCE_EN_CFG1	( BIT(25) )
#define BIT_CGM_TWPLL_153M6_MM_FORCE_EN	( BIT(24) )
#define BIT_CGM_TWPLL_192M_MM_FORCE_EN	( BIT(23) )
#define BIT_CGM_TWPLL_256M_MM_FORCE_EN	( BIT(22) )
#define BIT_CGM_TWPLL_307M2_MM_FORCE_EN	( BIT(21) )
#define BIT_CGM_26M_MM_FORCE_EN		( BIT(20) )
#define BIT_CGM_TWPLL_12M_AP_FORCE_EN	( BIT(19) )
#define BIT_CGM_TWPLL_24M_AP_FORCE_EN	( BIT(18) )
#define BIT_CGM_TWPLL_48M_AP_FORCE_EN	( BIT(17) )
#define BIT_CGM_TWPLL_51M2_AP_FORCE_EN	( BIT(16) )
#define BIT_CGM_TWPLL_64M_AP_FORCE_EN	( BIT(15) )
#define BIT_CGM_TWPLL_76M8_AP_FORCE_EN	( BIT(14) )
#define BIT_CGM_TWPLL_96M_AP_FORCE_EN	( BIT(13) )
#define BIT_CGM_TWPLL_128M_AP_FORCE_EN	( BIT(12) )
#define BIT_CGM_TWPLL_153M6_AP_FORCE_EN	( BIT(11) )
#define BIT_CGM_TWPLL_192M_AP_FORCE_EN	( BIT(10) )
#define BIT_CGM_TWPLL_256M_AP_FORCE_EN	( BIT(9) )
#define BIT_CGM_TWPLL_307M2_AP_FORCE_EN	( BIT(8) )
#define BIT_CGM_TWPLL_384M_AP_FORCE_EN	( BIT(7) )
#define BIT_CGM_TWPLL_512M_AP_FORCE_EN	( BIT(6) )
#define BIT_CGM_TWPLL_768M_AP_FORCE_EN	( BIT(5) )
#define BIT_CGM_LTEPLL_AP_FORCE_EN	( BIT(4) )
#define BIT_CGM_TWPLL_AP_FORCE_EN	( BIT(3) )
#define BIT_CGM_DPLL_AP_FORCE_EN	( BIT(2) )
#define BIT_CGM_MPLL_AP_FORCE_EN	( BIT(1) )
#define BIT_CGM_26M_AP_FORCE_EN		( BIT(0) )
#define BITS_CGM_FORCE_EN_CFG0(_X_)	(_X_)
/* bits definitions for register REG_PMU_APB_CGM_FORCE_EN_CFG1 */
#define BIT_CGM_LTEPLL_61M44_CP1_FORCE_EN	( BIT(31) )
#define BIT_CGM_LTEPLL_68M26_CP1_FORCE_EN	( BIT(30) )
#define BIT_CGM_LTEPLL_102M4_CP1_FORCE_EN	( BIT(29) )
#define BIT_CGM_LTEPLL_122M88_CP1_FORCE_EN	( BIT(28) )
#define BIT_CGM_LTEPLL_153M6_CP1_FORCE_EN	( BIT(27) )
#define BIT_CGM_LTEPLL_204M8_CP1_FORCE_EN	( BIT(26) )
#define BIT_CGM_LTEPLL_245M76_CP1_FORCE_EN	( BIT(25) )
#define BIT_CGM_LTEPLL_307M2_CP1_FORCE_EN	( BIT(24) )
#define BIT_CGM_LTEPLL_614M4_CP1_FORCE_EN	( BIT(23) )
#define BIT_CGM_26M_CP1_FORCE_EN		( BIT(22) )
#define BIT_CGM_TWPLL_5M12_CP0_FORCE_EN		( BIT(21) )
#define BIT_CGM_TWPLL_10M24_CP0_FORCE_EN	( BIT(20) )
#define BIT_CGM_TWPLL_51M2_CP0_FORCE_EN		( BIT(19) )
#define BIT_CGM_TWPLL_76M8_CP0_FORCE_EN		( BIT(18) )
#define BIT_CGM_TWPLL_153M6_CP0_FORCE_EN	( BIT(17) )
#define BIT_CGM_TWPLL_48M_CP0_FORCE_EN	( BIT(16) )
#define BIT_CGM_TWPLL_96M_CP0_FORCE_EN	( BIT(15) )
#define BIT_CGM_TWPLL_192M_CP0_FORCE_EN	( BIT(14) )
#define BIT_CGM_TWPLL_64M_CP0_FORCE_EN	( BIT(13) )
#define BIT_CGM_TWPLL_102M4_CP0_FORCE_EN	( BIT(12) )
#define BIT_CGM_TWPLL_128M_CP0_FORCE_EN	( BIT(11) )
#define BIT_CGM_TWPLL_256M_CP0_FORCE_EN	( BIT(10) )
#define BIT_CGM_TWPLL_219M_CP0_FORCE_EN	( BIT(9) )
#define BIT_CGM_TWPLL_219M4_CP0_FORCE_EN	( BIT(8) )
#define BIT_CGM_TWPLL_307M2_CP0_FORCE_EN	( BIT(7) )
#define BIT_CGM_TWPLL_512M_CP0_FORCE_EN	( BIT(6) )
#define BIT_CGM_26M_CP0_FORCE_EN	( BIT(5) )
#define BIT_CGM_TWPLL_153M6_GPU_FORCE_EN	( BIT(4) )
#define BIT_CGM_TWPLL_192M_GPU_FORCE_EN	( BIT(3) )
#define BIT_CGM_TWPLL_256M_GPU_FORCE_EN	( BIT(2) )
#define BIT_CGM_TWPLL_307M2_GPU_FORCE_EN	( BIT(1) )
#define BIT_CGM_TWPLL_384M_GPU_FORCE_EN	( BIT(0) )
#define BITS_CGM_FORCE_EN_CFG1(_X_)	(_X_)
/* bits definitions for register REG_PMU_APB_CGM_FORCE_EN_CFG2 */
#define BIT_TWPLL_DIV_38M4_FORCE_EN	( BIT(31) )
#define BIT_TWPLL_DIV_76M8_FORCE_EN	( BIT(30) )
#define BIT_TWPLL_DIV_51M2_FORCE_EN	( BIT(29) )
#define BIT_TWPLL_DIV_153M6_FORCE_EN	( BIT(28) )
#define BIT_TWPLL_DIV_64M_FORCE_EN	( BIT(27) )
#define BIT_TWPLL_DIV_128M_FORCE_EN	( BIT(26) )
#define BIT_TWPLL_DIV_256M_FORCE_EN	( BIT(25) )
#define BIT_TWPLL_DIV_12M_FORCE_EN	( BIT(24) )
#define BIT_TWPLL_DIV_24M_FORCE_EN	( BIT(23) )
#define BIT_TWPLL_DIV_48M_FORCE_EN	( BIT(22) )
#define BIT_TWPLL_DIV_96M_FORCE_EN	( BIT(21) )
#define BIT_TWPLL_DIV_102M4_FORCE_EN	( BIT(20) )
#define BIT_TWPLL_DIV_192M_FORCE_EN	( BIT(19) )
#define BIT_TWPLL_DIV_219M4_FORCE_EN	( BIT(18) )
#define BIT_TWPLL_DIV_307M2_FORCE_EN	( BIT(17) )
#define BIT_TWPLL_DIV_384M_FORCE_EN	( BIT(16) )
#define BIT_TWPLL_DIV_512M_FORCE_EN	( BIT(15) )
#define BIT_TWPLL_DIV_768M_FORCE_EN	( BIT(14) )
#define BIT_DPLL_DIV_33M_FORCE_EN	( BIT(13) )
#define BIT_MPLL_DIV_50M_FORCE_EN	( BIT(12) )
#define BIT_CGM_TWPLL_48M_CP1_FORCE_EN	( BIT(11) )
#define BIT_CGM_TWPLL_51M2_CP1_FORCE_EN	( BIT(10) )
#define BIT_CGM_TWPLL_64M_CP1_FORCE_EN	( BIT(9) )
#define BIT_CGM_TWPLL_76M8_CP1_FORCE_EN	( BIT(8) )
#define BIT_CGM_TWPLL_96M_CP1_FORCE_EN	( BIT(7) )
#define BIT_CGM_TWPLL_128M_CP1_FORCE_EN	( BIT(6) )
#define BIT_CGM_TWPLL_153M6_CP1_FORCE_EN	( BIT(5) )
#define BIT_CGM_TWPLL_192M_CP1_FORCE_EN	( BIT(4) )
#define BIT_CGM_TWPLL_256M_CP1_FORCE_EN	( BIT(3) )
#define BIT_CGM_TWPLL_512M_CP1_FORCE_EN	( BIT(2) )
#define BIT_CGM_TWPLL_768M_CP1_FORCE_EN	( BIT(1) )
#define BIT_CGM_LTEPLL_30M72_CP1_FORCE_EN	( BIT(0) )
#define BITS_CGM_FORCE_EN_CFG2(_X_)	(_X_)
/* bits definitions for register REG_PMU_APB_CGM_FORCE_EN_CFG3 */
#define BIT_RC1_2M_FORCE_EN		( BIT(17) )
#define BIT_RC0_2M_FORCE_EN		( BIT(16) )
#define BIT_AON_1M_FORCE_EN		( BIT(15) )
#define BIT_AON_2M_FORCE_EN		( BIT(14) )
#define BIT_AON_13M_FORCE_EN		( BIT(13) )
#define BIT_LTEPLL_DIV_30M72_FORCE_EN	( BIT(12) )
#define BIT_LTEPLL_DIV_61M44_FORCE_EN	( BIT(11) )
#define BIT_LTEPLL_DIV_122M88_FORCE_EN	( BIT(10) )
#define BIT_LTEPLL_DIV_245M76_FORCE_EN	( BIT(9) )
#define BIT_LTEPLL_DIV_68M26_FORCE_EN	( BIT(8) )
#define BIT_LTEPLL_DIV_102M4_FORCE_EN	( BIT(7) )
#define BIT_LTEPLL_DIV_204M8_FORCE_EN	( BIT(6) )
#define BIT_LTEPLL_DIV_409M6_FORCE_EN	( BIT(5) )
#define BIT_LTEPLL_DIV_153M6_FORCE_EN	( BIT(4) )
#define BIT_LTEPLL_DIV_307M2_FORCE_EN	( BIT(3) )
#define BIT_LTEPLL_DIV_614M4_FORCE_EN	( BIT(2) )
#define BIT_TWPLL_DIV_5M12_FORCE_EN	( BIT(1) )
#define BIT_TWPLL_DIV_10M24_FORCE_EN	( BIT(0) )
...
#define BIT_ARM7_MEM_SLP_UART		( BIT(28) )
#define BIT_ARM7_MEM_SLP_IMC		( BIT(27) )
#define BIT_AON_MEM_SLP_IMC		( BIT(26) )
#define BIT_AON_MEM_SLP_DMA		( BIT(25) )
#define BIT_AON_MEM_SLP_VBC		( BIT(24) )
#define BIT_AON_MEM_SLP_AUD		( BIT(23) )
#define BIT_AON_MEM_SLP_FM		( BIT(22) )
#define BIT_CP0_GGE_DSP_MEM_SLP_RFT	( BIT(21) )
#define BIT_CP0_GGE_DSP_MEM_SLP_DMA	( BIT(20) )
#define BIT_CP0_GGE_DSP_MEM_SLP_SHM	( BIT(19) )
#define BIT_CP0_GGE_DSP_MEM_SLP_STC	( BIT(18) )
#define BIT_CP0_W_MEM_SLP_UART1		( BIT(17) )
#define BIT_CP0_W_MEM_SLP_UART0		( BIT(16) )
#define BIT_CP0_W_MEM_SLP_IRAM		( BIT(15) )
#define BIT_CP0_W_MEM_SLP_PERIF		( BIT(14) )
#define BIT_CP0_DSP_MEM_SLP_DMA		( BIT(13) )
#define BIT_CP0_DSP_MEM_SLP_SHM		( BIT(12) )
#define BIT_CP0_DSP_MEM_SLP_RFT		( BIT(11) )
#define BIT_CP0_DSP_MEM_SLP_STC		( BIT(10) )
#define BIT_CP0_ARM_MEM_SLP_IIS3	( BIT(9) )
#define BIT_CP0_ARM_MEM_SLP_IIS2	( BIT(8) )
#define BIT_CP0_ARM_MEM_SLP_IIS1	( BIT(7) )
#define BIT_CP0_ARM_MEM_SLP_IIS0	( BIT(6) )
#define BIT_CP0_ARM_MEM_SLP_UART2	( BIT(5) )
#define BIT_CP0_ARM_MEM_SLP_UART1	( BIT(4) )
#define BIT_CP0_ARM_MEM_SLP_UART0	( BIT(3) )
#define BIT_CP0_ARM_MEM_SLP_EPT		( BIT(2) )
#define BIT_CP0_ARM_MEM_SLP_LZMA	( BIT(1) )
#define BIT_CP0_ARM_MEM_SLP_DMA		( BIT(0) )
#define BITS_MEM_SLP_CFG(_X_)		(_X_)
/* bits definitions for register REG_PMU_APB_MEM_SD_CFG */
#define BIT_ARM7_MEM_SD_UART		( BIT(28) )
#define BIT_ARM7_MEM_SD_IMC		( BIT(27) )
#define BIT_AON_MEM_SD_IMC		( BIT(26) )
#define BIT_AON_MEM_SD_DMA		( BIT(25) )
#define BIT_AON_MEM_SD_VBC		( BIT(24) )
#define BIT_AON_MEM_SD_AUD		( BIT(23) )
#define BIT_AON_MEM_SD_FM		( BIT(22) )
#define BIT_CP0_GGE_DSP_MEM_SD_RFT	( BIT(21) )
#define BIT_CP0_GGE_DSP_MEM_SD_DMA	( BIT(20) )
#define BIT_CP0_GGE_DSP_MEM_SD_SHM	( BIT(19) )
#define BIT_CP0_GGE_DSP_MEM_SD_STC	( BIT(18) )
#define BIT_CP0_W_MEM_SD_UART1		( BIT(17) )
#define BIT_CP0_W_MEM_SD_UART0		( BIT(16) )
#define BIT_CP0_W_MEM_SD_IRAM		( BIT(15) )
#define BIT_CP0_W_MEM_SD_PERIF		( BIT(14) )
#define BIT_CP0_DSP_MEM_SD_DMA		( BIT(13) )
#define BIT_CP0_DSP_MEM_SD_SHM		( BIT(12) )
#define BIT_CP0_DSP_MEM_SD_RFT		( BIT(11) )
#define BIT_CP0_DSP_MEM_SD_STC		( BIT(10) )
#define BIT_CP0_ARM_MEM_SD_IIS3		( BIT(9) )
#define BIT_CP0_ARM_MEM_SD_IIS2		( BIT(8) )
#define BIT_CP0_ARM_MEM_SD_IIS1		( BIT(7) )
#define BIT_CP0_ARM_MEM_SD_IIS0		( BIT(6) )
#define BIT_CP0_ARM_MEM_SD_UART2	( BIT(5) )
#define BIT_CP0_ARM_MEM_SD_UART1	( BIT(4) )
#define BIT_CP0_ARM_MEM_SD_UART0	( BIT(3) )
#define BIT_CP0_ARM_MEM_SD_EPT		( BIT(2) )
#define BIT_CP0_ARM_MEM_SD_LZMA		( BIT(1) )
#define BIT_CP0_ARM_MEM_SD_DMA		( BIT(0) )
...
#define BIT_CA7_C3_GIC_WAKEUP_EN                          BIT_APCPU_C3_GIC_WAKEUP_EN
#define BIT_CA7_C2_GIC_WAKEUP_EN                          BIT_APCPU_C2_GIC_WAKEUP_EN
#define BIT_CA7_C1_GIC_WAKEUP_EN                          BIT_APCPU_C1_GIC_WAKEUP_EN
#define BIT_CA7_C0_GIC_WAKEUP_EN                          BIT_APCPU_C0_GIC_WAKEUP_EN
...
#define BIT_PD_CA7_TOP_CMG_HOLD_EN                        BIT_PD_APCPU_TOP_CMG_HOLD_EN
#define BIT_PD_CA7_C3_CMG_HOLD_EN                         BIT_PD_APCPU_C3_CMG_HOLD_EN
#define BIT_PD_CA7_C2_CMG_HOLD_EN                         BIT_PD_APCPU_C2_CMG_HOLD_EN
#define BIT_PD_CA7_C1_CMG_HOLD_EN                         BIT_PD_APCPU_C1_CMG_HOLD_EN
#define BIT_PD_CA7_C0_CMG_HOLD_EN                         BIT_PD_APCPU_C0_CMG_HOLD_EN
...
#define BIT_PD_CA7_TOP_WAKEUP_LOCK_EN                     BIT_PD_APCPU_TOP_WAKEUP_LOCK_EN	
#define BIT_PD_CA7_C3_WAKEUP_LOCK_EN                      BIT_PD_APCPU_C3_WAKEUP_LOCK_EN	
#define BIT_PD_CA7_C2_WAKEUP_LOCK_EN                      BIT_PD_APCPU_C2_WAKEUP_LOCK_EN
#define BIT_PD_CA7_C1_WAKEUP_LOCK_EN                      BIT_PD_APCPU_C1_WAKEUP_LOCK_EN
#define BIT_PD_CA7_C0_WAKEUP_LOCK_EN                      BIT_PD_APCPU_C0_WAKEUP_LOCK_EN
...
#define BITS_PD_CA7_C0_SHUTDOWN_MARK(_X_)	BITS_PD_APCPU_C0_SHUTDOWN_MARK(_X_)
...
#define BITS_PD_CA7_C1_SHUTDOWN_MARK(_X_) 	BITS_PD_APCPU_C1_SHUTDOWN_MARK(_X_)
...
#define BITS_PD_CA7_C2_SHUTDOWN_MARK(_X_) 	BITS_PD_APCPU_C2_SHUTDOWN_MARK(_X_)
...
#define BITS_PD_CA7_C3_SHUTDOWN_MARK(_X_)	BITS_PD_APCPU_C3_SHUTDOWN_MARK(_X_)
...
#define BITS_PD_CA7_TOP_SHUTDOWN_MARK(_X_) 		BITS_PD_APCPU_TOP_SHUTDOWN_MARK(_X_)
