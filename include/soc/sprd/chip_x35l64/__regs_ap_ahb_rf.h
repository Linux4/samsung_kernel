...
#define REG_AP_AHB_APCPU_QCHN_STA			SCI_ADDR(REGS_AP_AHB_BASE, 0x3040)/*APCPU_QCHN_STA*/
...
#define BIT_AP_QCHN_SOFT_RST		( BIT(17) )
#define BIT_APCPU_TRACE_SOFT_RST	( BIT(16) )
#define BIT_APCPU_GIC_SOFT_RST		( BIT(15) )
#define BIT_APCPU_CS_DBG_SOFT_RST	( BIT(14) )
#define BIT_APCPU_L2_SOFT_RST		( BIT(13) )
...
#define BIT_CA7_L2_SOFT_RST             BIT_APCPU_L2_SOFT_RST
...
#define BITS_APCPU_TRACE_CKG_DIV(_x_)	( (_x_) << 20 & (BIT(20)|BIT(21)|BIT(22)|BIT(23)) )
#define BITS_APCPU_DBG_CKG_DIV(_x_)	( (_x_) << 16 & (BIT(16)|BIT(17)|BIT(18)) )
#define BITS_APCPU_AXI_CKG_DIV(_x_)	( (_x_) << 8 & (BIT(8)|BIT(9)|BIT(10)) )
#define BITS_APCPU_MCU_CKG_DIV(_x_)	( (_x_) << 4 & (BIT(4)|BIT(5)|BIT(6)) )
#define BITS_CA7_DBG_CKG_DIV(_x_)       BITS_APCPU_DBG_CKG_DIV(_x_)
#define BITS_CA7_AXI_CKG_DIV(_x_)       BITS_APCPU_AXI_CKG_DIV(_x_)
#define BITS_CA7_MCU_CKG_DIV(_x_)       BITS_APCPU_MCU_CKG_DIV(_x_)
...
#define BITS_APCPU_MCU_CKG_SEL(_x_)	( (_x_) & (BIT(0)|BIT(1)|BIT(2)) )
#define BITS_CA7_MCU_CKG_SEL(_x_)       BITS_APCPU_MCU_CKG_SEL(_x_)
...
#define BIT_APCPU_STANDBYWFIL2		( BIT(12) )
#define BITS_APCPU_ETMSTANDBYWFX(_x_)	( (_x_) << 8 & (BIT(8)|BIT(9)|BIT(10)|BIT(11)) )
#define BITS_APCPU_STANDBYWFE(_x_)	( (_x_) << 4 & (BIT(4)|BIT(5)|BIT(6)|BIT(7)) )
#define BITS_APCPU_STANDBYWFI(_x_)	( (_x_) & (BIT(0)|BIT(1)|BIT(2)|BIT(3)) )
#define BIT_CA7_STANDBYWFIL2            BIT_APCPU_STANDBYWFIL2
#define BITS_CA7_ETMSTANDBYWFX(_x_)     BITS_APCPU_ETMSTANDBYWFX(_x_)
#define BITS_CA7_STANDBYWFE(_x_)        BITS_APCPU_STANDBYWFE(_x_)
#define BITS_CA7_STANDBYWFI(_x_)        BITS_APCPU_STANDBYWFI(_x_)
...
/* bits definitions for register REG_AP_AHB_APCPU_QCHN_CTL */
#define BITS_APCPU_Q_NEG_THD(_x_)	( (_x_) << 16 & (BIT(16)|BIT(17)|BIT(18)|BIT(19)|BIT(20)|BIT(21)|BIT(22)|BIT(23)|BIT(24)|BIT(25)|BIT(26)|BIT(27)|BIT(28)|BIT(29)|BIT(30)|BIT(31)) )
#define BITS_APCPU_Q_WAIT_GAP(_x_)	( (_x_) << 12 & (BIT(12)|BIT(13)|BIT(14)|BIT(15)) )
#define BITS_APCPU_Q_PGEN_DUR(_x_)	( (_x_) << 8 & (BIT(8)|BIT(9)|BIT(10)|BIT(11)) )
#define BITS_APCPU_Q_WAIT_REQ(_x_)	( (_x_) << 4 & (BIT(4)|BIT(5)|BIT(6)|BIT(7)) )
#define BIT_APCPU_Q_RETN_BYP		( BIT(2) )
#define BIT_APCPU_Q_RETN_SEL		( BIT(1) )
#define BIT_APCPU_Q_LP_EN		( BIT(0) )

/* bits definitions for register REG_AP_AHB_APCPU_QCHN_STA */
#define BITS_APCPU_Q_STATUS(_x_)	(_x_)
