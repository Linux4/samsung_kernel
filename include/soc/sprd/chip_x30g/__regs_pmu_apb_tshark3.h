/* the head file modifier:     ang   2015-01-21 14:39:32*/
...
#define REG_PMU_APB_CGM_CODEC_AUTO_GATE_EN		SCI_ADDR(REGS_PMU_APB_BASE, 0x014C)/*CGM_GPU_CODEC_AUTO_GATE_EN*/
#define REG_PMU_APB_CGM_CODEC_EN			SCI_ADDR(REGS_PMU_APB_BASE, 0x0150)/*CGM_GPU_CODEC_EN*/
#define REG_PMU_APB_PD_CODEC_TOP_CFG			SCI_ADDR(REGS_PMU_APB_BASE, 0x0154)/*PD_CODEC_TOP_CFG*/
#define REG_PMU_APB_PUB_SYS_PD_FLAG			SCI_ADDR(REGS_PMU_APB_BASE, 0x0158)/*PUB_SYS_PD_FLAG*/
#define REG_PMU_APB_DDR_PHY_PD_FLAG			SCI_ADDR(REGS_PMU_APB_BASE, 0x015C)/*DDR_PHY_PD_FLAG*/
#define REG_PMU_APB_PWR_STATUS4_DBG			SCI_ADDR(REGS_PMU_APB_BASE, 0x0160)
#define REG_PMU_APB_PD_CRYPTO_TOP_CFG			SCI_ADDR(REGS_PMU_APB_BASE, 0x0164)
#define REG_PMU_APB_PD_CP0_ARM_IRAM_CFG			SCI_ADDR(REGS_PMU_APB_BASE, 0x0168)
#define REG_PMU_APB_MEM_PD_CFG2				SCI_ADDR(REGS_PMU_APB_BASE, 0x016C)
#define REG_PMU_APB_MEM_PD_CFG3				SCI_ADDR(REGS_PMU_APB_BASE, 0x0170)
#define REG_PMU_APB_MEM_PD_FRC				SCI_ADDR(REGS_PMU_APB_BASE, 0x017C)
#define REG_PMU_APB_PLL_WAIT_CNT3			SCI_ADDR(REGS_PMU_APB_BASE, 0x0180)
#define REG_PMU_APB_RPLL_REL_CFG			SCI_ADDR(REGS_PMU_APB_BASE, 0x018C)
...
#define BIT_CRYPTO_SOFT_RST					( BIT(8) )
...
#define BITS_PD_CODEC_TOP_STATE(_X_)				((_X_) << 20 & (BIT(20)|BIT(21)|BIT(22)|BIT(23)))
...
#define BITS_MPLL_300M_DIV(_X_)					((_X_) << 3 & (BIT(3)|BIT(4)))
...
#define BIT_CGM_WIFIPLL2_GPU_AUTO_GATE_EN			( BIT(7) )
...
#define BIT_CGM_WIFIPLL2_GPU_EN					( BIT(7) )
...
#define BIT_REF1_26M_SEL					( BIT(10) )
...
#define BIT_PD_CP0_ARM_IRAM_BISR_DONE				( BIT(11) )
#define BIT_PD_CP0_ARM_IRAM_BISR_BUSY				( BIT(10) )
#define BIT_PD_CP0_ARM_IRAM_BISR_FORCE_EN			( BIT(9) )
#define BIT_PD_CP0_ARM_IRAM_BISR_FORCE_BYP			( BIT(8) )
...
/* bits definitions for register REG_PMU_APB_CGM_CODEC_AUTO_GATE_EN */
#define BIT_CGM_384M_CRYPTO_AUTO_GATE_EN			( BIT(9) )
#define BIT_CGM_307M2_CRYPTO_AUTO_GATE_EN			( BIT(8) )
#define BIT_CGM_256M_CRYPTO_AUTO_GATE_EN			( BIT(7) )
#define BIT_CGM_26M_CRYPTO_AUTO_GATE_EN				( BIT(6) )
#define BIT_CGM_76M8_CODEC_AUTO_GATE_EN				( BIT(5) )
#define BIT_CGM_96M_CODEC_AUTO_GATE_EN				( BIT(4) )
#define BIT_CGM_128M_CODEC_AUTO_GATE_EN				( BIT(3) )
#define BIT_CGM_153M6_CODEC_AUTO_GATE_EN			( BIT(2) )
#define BIT_CGM_192M_CODEC_AUTO_GATE_EN				( BIT(1) )
#define BIT_CGM_26M_CODEC_AUTO_GATE_EN				( BIT(0) )

/* bits definitions for register REG_PMU_APB_CGM_CODEC_EN */
#define BIT_CGM_384M_CRYPTO_EN					( BIT(9) )
#define BIT_CGM_307M2_CRYPTO_EN					( BIT(8) )
#define BIT_CGM_256M_CRYPTO_EN					( BIT(7) )
#define BIT_CGM_26M_CRYPTO_EN					( BIT(6) )
#define BIT_CGM_76M8_CODEC_EN					( BIT(5) )
#define BIT_CGM_96M_CODEC_EN					( BIT(4) )
#define BIT_CGM_128M_CODEC_EN					( BIT(3) )
#define BIT_CGM_153M6_CODEC_EN					( BIT(2) )
#define BIT_CGM_192M_CODEC_EN					( BIT(1) )
#define BIT_CGM_26M_CODEC_EN					( BIT(0) )
...
#define BITS_PD_CODEC_TOP_PWR_ON_DLY(_X_)			((_X_) << 16 & (BIT(16)|BIT(17)|BIT(18)|BIT(19)|BIT(20)|BIT(21)|BIT(22)|BIT(23)))
#define BITS_PD_CODEC_TOP_PWR_ON_SEQ_DLY(_X_)			((_X_) << 8 & (BIT(8)|BIT(9)|BIT(10)|BIT(11)|BIT(12)|BIT(13)|BIT(14)|BIT(15)))
#define BITS_PD_CODEC_TOP_ISO_ON_DLY(_X_)			((_X_) & (BIT(0)|BIT(1)|BIT(2)|BIT(3)|BIT(4)|BIT(5)|BIT(6)|BIT(7)))

/* bits definitions for register REG_PMU_APB_PUB_SYS_PD_FLAG */
#define BIT_PUB_SYS_PD_FLAG					(BIT(0))

/* bits definitions for register REG_PMU_APB_DDR_PHY_PD_FLAG */
#define BIT_DDR_PHY_PD_FLAG					(BIT(0))

/* bits definitions for register REG_PMU_APB_PWR_STATUS4_DBG */
#define BITS_PD_CP0_ARM_IRAM_STATE(_X_)				( (_X_) << 4 & (BIT(4)|BIT(5)|BIT(6)|BIT(7)) )
#define BITS_PD_CRYPTO_TOP_STATE(_X_)				( (_X_) & (BIT(0)|BIT(1)|BIT(2)|BIT(3)) )

/* bits definitions for register REG_PMU_APB_PD_CRYPTO_TOP_CFG */
#define BIT_PD_CRYPTO_TOP_FORCE_SHUTDOWN			( BIT(25) )
#define BIT_PD_CRYPTO_TOP_AUTO_SHUTDOWN_EN			( BIT(24) )
#define BITS_PD_CRYPTO_TOP_PWR_ON_DLY(_X_)			( (_X_) << 16 & (BIT(16)|BIT(17)|BIT(18)|BIT(19)|BIT(20)|BIT(21)|BIT(22)|BIT(23)) )
#define BITS_PD_CRYPTO_TOP_PWR_ON_SEQ_DLY(_X_)			( (_X_) << 8 & (BIT(8)|BIT(9)|BIT(10)|BIT(11)|BIT(12)|BIT(13)|BIT(14)|BIT(15)) )
#define BITS_PD_CRYPTO_TOP_ISO_ON_DLY(_X_)			( (_X_) & (BIT(0)|BIT(1)|BIT(2)|BIT(3)|BIT(4)|BIT(5)|BIT(6)|BIT(7)) )

/* bits definitions for register REG_PMU_APB_PD_CP0_ARM_IRAM_CFG */
#define BIT_PD_CP0_ARM_IRAM_FORCE_SHUTDOWN			( BIT(25) )
#define BIT_PD_CP0_ARM_IRAM_AUTO_SHUTDOWN_EN			( BIT(24) )
#define BITS_PD_CP0_ARM_IRAM_PWR_ON_DLY(_X_)			( (_X_) << 16 & (BIT(16)|BIT(17)|BIT(18)|BIT(19)|BIT(20)|BIT(21)|BIT(22)|BIT(23)) )
#define BITS_PD_CP0_ARM_IRAM_PWR_ON_SEQ_DLY(_X_)		( (_X_) << 8 & (BIT(8)|BIT(9)|BIT(10)|BIT(11)|BIT(12)|BIT(13)|BIT(14)|BIT(15)) )
#define BITS_PD_CP0_ARM_IRAM_ISO_ON_DLY(_X_)			( (_X_) & (BIT(0)|BIT(1)|BIT(2)|BIT(3)|BIT(4)|BIT(5)|BIT(6)|BIT(7)) )

/* bits definitions for register REG_PMU_APB_MEM_PD_CFG2 */
#define BITS_CP0_ARM_MEM_PD_CFG_IRAM15(_X_)			( (_X_) << 30 & (BIT(30)|BIT(31)) )
#define BITS_CP0_ARM_MEM_PD_CFG_IRAM14(_X_)			( (_X_) << 28 & (BIT(28)|BIT(29)) )
#define BITS_CP0_ARM_MEM_PD_CFG_IRAM13(_X_)			( (_X_) << 26 & (BIT(26)|BIT(27)) )
#define BITS_CP0_ARM_MEM_PD_CFG_IRAM12(_X_)			( (_X_) << 24 & (BIT(24)|BIT(25)) )
#define BITS_CP0_ARM_MEM_PD_CFG_IRAM11(_X_)			( (_X_) << 22 & (BIT(22)|BIT(23)) )
#define BITS_CP0_ARM_MEM_PD_CFG_IRAM10(_X_)			( (_X_) << 20 & (BIT(20)|BIT(21)) )
#define BITS_CP0_ARM_MEM_PD_CFG_IRAM9(_X_)			( (_X_) << 18 & (BIT(18)|BIT(19)) )
#define BITS_CP0_ARM_MEM_PD_CFG_IRAM8(_X_)			( (_X_) << 16 & (BIT(16)|BIT(17)) )
#define BITS_CP0_ARM_MEM_PD_CFG_IRAM7(_X_)			( (_X_) << 14 & (BIT(14)|BIT(15)) )
#define BITS_CP0_ARM_MEM_PD_CFG_IRAM6(_X_)			( (_X_) << 12 & (BIT(12)|BIT(13)) )
#define BITS_CP0_ARM_MEM_PD_CFG_IRAM5(_X_)			( (_X_) << 10 & (BIT(10)|BIT(11)) )
#define BITS_CP0_ARM_MEM_PD_CFG_IRAM4(_X_)			( (_X_) << 8 & (BIT(8)|BIT(9)) )
#define BITS_CP0_ARM_MEM_PD_CFG_IRAM3(_X_)			( (_X_) << 6 & (BIT(6)|BIT(7)) )
#define BITS_CP0_ARM_MEM_PD_CFG_IRAM2(_X_)			( (_X_) << 4 & (BIT(4)|BIT(5)) )
#define BITS_CP0_ARM_MEM_PD_CFG_IRAM1(_X_)			( (_X_) << 2 & (BIT(2)|BIT(3)) )
#define BITS_CP0_ARM_MEM_PD_CFG_IRAM0(_X_)			( (_X_) & (BIT(0)|BIT(1)) )

/* bits definitions for register REG_PMU_APB_MEM_PD_CFG3 */
#define BITS_CP0_DSP_MEM_PD_CFG_IRAM1(_X_)			( (_X_) << 2 & (BIT(2)|BIT(3)) )
#define BITS_CP0_DSP_MEM_PD_CFG_IRAM0(_X_)			( (_X_) & (BIT(0)|BIT(1)) )

/* bits definitions for register REG_PMU_APB_MEM_PD_FRC */
#define BITS_CP0_W_MEM_PD_CFG_ICI(_X_)				( (_X_) & (BIT(0)|BIT(1)) )

/* bits definitions for register REG_PMU_APB_PLL_WAIT_CNT3 */
#define BITS_RPLL_WAIT_CNT(_X_)					( (_X_) & (BIT(0)|BIT(1)|BIT(2)|BIT(3)|BIT(4)|BIT(5)|BIT(6)|BIT(7)) )

/* bits definitions for register REG_PMU_APB_RPLL_REL_CFG */
#define BITS_RPLL_REF_SEL(_X_)					( (_X_) << 4 & (BIT(4)|BIT(5)) )
#define BIT_RPLL_CP2_SEL					( BIT(3) )
#define BIT_RPLL_CP1_SEL					( BIT(2) )
#define BIT_RPLL_CP0_SEL					( BIT(1) )
#define BIT_RPLL_AP_SEL						( BIT(0) )
