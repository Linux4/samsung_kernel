...
#define BIT_RF_SWT_AUTO_EN                                ( BIT(1) )
...
#define BITS_ARMMTX_M5TOS4_RND_THR(_X_)                   ( (_X_) << 20 & (BIT(20)|BIT(21)|BIT(22)|BIT(23)) )
#define BIT_ARMMTX_M5TOS4_ADJ_EN                          ( BIT(19) )
#define BIT_ARMMTX_M5TOS4_RND_EN                          ( BIT(18) )
#define BITS_ARMMTX_M5TOS4_SEL(_X_)                       ( (_X_) << 16 & (BIT(16)|BIT(17)) )
...
#define BITS_CLK_LZMA_SEL(_X_)                            ( (_X_) << 22 & (BIT(22)|BIT(23)) )
...
#define BITS_CLK_MCU_SEL(_X_)                             ( (_X_) & (BIT(0)|BIT(1)|BIT(2)) )
