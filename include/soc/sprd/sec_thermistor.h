...
struct sec_therm_platform_data {
	unsigned int ap_adc_arr_size;
	unsigned int dcxo_adc_arr_size;
	unsigned int ap_channel;
	unsigned int dcxo_channel;
	struct sec_therm_adc_table *ap_adc_table;
	struct sec_therm_adc_table *dcxo_adc_table;
};
