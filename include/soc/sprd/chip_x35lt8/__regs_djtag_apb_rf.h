/* the head file modifier:     g   2015-03-19 15:38:39*/
...
#define REG_DJTAG_APB_RF_DJTAG_IR_LEN_CFG		SCI_ADDR(REGS_DJTAG_APB_RF_BASE, 0x0000)/*DJTAG_IR_LEN_CFG*/
#define REG_DJTAG_APB_RF_DJTAG_DR_LEN_CFG		SCI_ADDR(REGS_DJTAG_APB_RF_BASE, 0x0004)/*DJTAG_DR_LEN_CFG*/
#define REG_DJTAG_APB_RF_DJTAG_IR_CFG			SCI_ADDR(REGS_DJTAG_APB_RF_BASE, 0x0008)/*DJTAG_IR_CFG*/
#define REG_DJTAG_APB_RF_DJTAG_DR_CFG			SCI_ADDR(REGS_DJTAG_APB_RF_BASE, 0x000C)/*DJTAG_DR_CFG*/
#define REG_DJTAG_APB_RF_DR_PAUSE_RECOV_CFG		SCI_ADDR(REGS_DJTAG_APB_RF_BASE, 0x0010)/*DR_PAUSE_RECOV_CFG*/
#define REG_DJTAG_APB_RF_DJTAG_RND_EN_CFG		SCI_ADDR(REGS_DJTAG_APB_RF_BASE, 0x0014)/*DJTAG_RND_EN_CFG*/
#define REG_DJTAG_APB_RF_DJTAG_UPD_DR_CFG		SCI_ADDR(REGS_DJTAG_APB_RF_BASE, 0x0018)/*DJTAG_UPD_DR_CFG*/
