/* the head file modifier:     g   2015-03-19 17:11:11*/
...
#define REG_WCDMA_AHB_RF_AHB_EB0			SCI_ADDR(REGS_WCDMA_AHB_RF_BASE, 0x0000)/*AHB_EB0*/
#define REG_WCDMA_AHB_RF_AHB_RST0			SCI_ADDR(REGS_WCDMA_AHB_RF_BASE, 0x0004)/*AHB_RST0*/
#define REG_WCDMA_AHB_RF_ARCH_EB_REG			SCI_ADDR(REGS_WCDMA_AHB_RF_BASE, 0x0018)/*ARCH_EB_REG*/
#define REG_WCDMA_AHB_RF_AHB_REMAP			SCI_ADDR(REGS_WCDMA_AHB_RF_BASE, 0x001C)/*AHB_REMAP*/
#define REG_WCDMA_AHB_RF_AHB_MISC_CTL			SCI_ADDR(REGS_WCDMA_AHB_RF_BASE, 0x0020)/*AHB_MISC_CTL*/
#define REG_WCDMA_AHB_RF_AHB_MTX_PRI_SEL0		SCI_ADDR(REGS_WCDMA_AHB_RF_BASE, 0x0024)/*AHB_MTX_PRI_SEL0*/
#define REG_WCDMA_AHB_RF_AHB_MTX_PRI_SEL1		SCI_ADDR(REGS_WCDMA_AHB_RF_BASE, 0x0028)/*AHB_MTX_PRI_SEL1*/
#define REG_WCDMA_AHB_RF_AHB1_PAUSE			SCI_ADDR(REGS_WCDMA_AHB_RF_BASE, 0x002C)/*AHB1_PAUSE*/
#define REG_WCDMA_AHB_RF_AHB_SLP_CTL			SCI_ADDR(REGS_WCDMA_AHB_RF_BASE, 0x0034)/*AHB_SLP_CTL*/
#define REG_WCDMA_AHB_RF_AHB2_SLP_STS			SCI_ADDR(REGS_WCDMA_AHB_RF_BASE, 0x0038)/*AHB2_SLP_STS*/
#define REG_WCDMA_AHB_RF_MCU_CLK_CTL			SCI_ADDR(REGS_WCDMA_AHB_RF_BASE, 0x003C)/*MCU_CLK_CTL*/
#define REG_WCDMA_AHB_RF_CHIP_ID			SCI_ADDR(REGS_WCDMA_AHB_RF_BASE, 0x01FC)/*CHIP_ID*/
