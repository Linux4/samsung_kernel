/* the head file modifier:     g   2015-03-19 15:50:04*/
...
/* bits definitions for register REG_MM_AHB_RF_BUSMON_CNT_START */
#define BIT_PUB_BUSMON_CNT_START				( BIT(0) )

/* bits definitions for register REG_MM_AHB_RF_BUSMON_CFG */
...
/* bits definitions for register REG_MM_AHB_RF_DDR_EB */

/* bits definitions for register REG_MM_AHB_RF_DDR_SOFT_RST */

/* bits definitions for register REG_MM_AHB_RF_DDR_QOS_CFG1 */
...
/* bits definitions for register REG_MM_AHB_RF_DDR_QOS_CFG2 */
...
/* bits definitions for register REG_MM_AHB_RF_DDR_QOS_CFG3 */
...
/* bits definitions for register REG_MM_AHB_RF_DDR_MRR_STATUS */
...
/* bits definitions for register REG_MM_AHB_RF_DDR_ID2QOS_SEL */
...
/* bits definitions for register REG_MM_AHB_RF_DDR_ID2QOS_RCFG0 */
...
/* bits definitions for register REG_MM_AHB_RF_DDR_ID2QOS_RCFG1 */
...
/* bits definitions for register REG_MM_AHB_RF_DDR_ID2QOS_RCFG2 */
...
/* bits definitions for register REG_MM_AHB_RF_DDR_ID2QOS_RCFG3 */
...
/* bits definitions for register REG_MM_AHB_RF_DDR_ID2QOS_RCFG4 */
...
/* bits definitions for register REG_MM_AHB_RF_DDR_ID2QOS_RCFG5 */
...
/* bits definitions for register REG_MM_AHB_RF_DDR_ID2QOS_RCFG6 */
...
/* bits definitions for register REG_MM_AHB_RF_DDR_ID2QOS_RCFG7 */
...
/* bits definitions for register REG_MM_AHB_RF_DDR_ID2QOS_RCFG8 */
...
/* bits definitions for register REG_MM_AHB_RF_DDR_ID2QOS_RCFG9 */
...
/* bits definitions for register REG_MM_AHB_RF_DDR_ID2QOS_WCFG0 */
...
/* bits definitions for register REG_MM_AHB_RF_DDR_ID2QOS_WCFG1 */
...
/* bits definitions for register REG_MM_AHB_RF_DDR_ID2QOS_WCFG2 */
...
/* bits definitions for register REG_MM_AHB_RF_DDR_ID2QOS_WCFG3 */
...
/* bits definitions for register REG_MM_AHB_RF_DDR_ID2QOS_WCFG4 */
...
/* bits definitions for register REG_MM_AHB_RF_DDR_ID2QOS_WCFG5 */
...
/* bits definitions for register REG_MM_AHB_RF_DDR_ID2QOS_WCFG6 */
...
/* bits definitions for register REG_MM_AHB_RF_DDR_ID2QOS_WCFG7 */
...
/* bits definitions for register REG_MM_AHB_RF_DDR_ID2QOS_WCFG8 */
...
/* bits definitions for register REG_MM_AHB_RF_DDR_ID2QOS_WCFG9 */
...
/* bits definitions for register REG_MM_AHB_RF_DFI_TIMEOUT_CFG */
...
/* bits definitions for register REG_MM_AHB_RF_DFI_TIMEOUT_STATUS */
#define BITS_DFI_TIMEOUT_STATUS(_X_)				( (_X_) & (BIT(0)|BIT(1)|BIT(2)|BIT(3)) )

/* bits definitions for register REG_MM_AHB_RF_DFI_TIMEOUT_EN_CNT */
...
/* bits definitions for register REG_MM_AHB_RF_DFI_TIMEOUT_VALID_CNT */
...
/* bits definitions for register REG_MM_AHB_RF_DMC_PORT_REMAP_EN */
...
/* bits definitions for register REG_MM_AHB_RF_DMC_PORTS_MPU_EN */
...
/* bits definitions for register REG_MM_AHB_RF_DMC_PORT0_ADDR_REMAP */
#define BITS_DMC_PORT0_ADDR_REMAP(_X_)				(_X_)

/* bits definitions for register REG_MM_AHB_RF_DMC_PORT1_ADDR_REMAP */
#define BITS_DMC_PORT1_ADDR_REMAP(_X_)				(_X_)

/* bits definitions for register REG_MM_AHB_RF_DMC_PORT2_ADDR_REMAP */
#define BITS_DMC_PORT2_ADDR_REMAP(_X_)				(_X_)

/* bits definitions for register REG_MM_AHB_RF_DMC_PORT3_ADDR_REMAP */
#define BITS_DMC_PORT3_ADDR_REMAP(_X_)				(_X_)

/* bits definitions for register REG_MM_AHB_RF_DMC_PORT4_ADDR_REMAP */
#define BITS_DMC_PORT4_ADDR_REMAP(_X_)				(_X_)

/* bits definitions for register REG_MM_AHB_RF_DMC_PORT5_ADDR_REMAP */
#define BITS_DMC_PORT5_ADDR_REMAP(_X_)				(_X_)

/* bits definitions for register REG_MM_AHB_RF_DMC_PORT6_ADDR_REMAP */
#define BITS_DMC_PORT6_ADDR_REMAP(_X_)				(_X_)

/* bits definitions for register REG_MM_AHB_RF_DMC_PORT7_ADDR_REMAP */
#define BITS_DMC_PORT7_ADDR_REMAP(_X_)				(_X_)

/* bits definitions for register REG_MM_AHB_RF_DMC_PORT8_ADDR_REMAP */
#define BITS_DMC_PORT8_ADDR_REMAP(_X_)				(_X_)

/* bits definitions for register REG_MM_AHB_RF_DMC_PORT9_ADDR_REMAP */
#define BITS_DMC_PORT9_ADDR_REMAP(_X_)				(_X_)

/* bits definitions for register REG_MM_AHB_RF_DMC_PORT0_MPU_RANGE */
#define BITS_DMC_PORT0_MPU_RANGE(_X_)				(_X_)

/* bits definitions for register REG_MM_AHB_RF_DMC_PORT1_MPU_RANGE */
#define BITS_DMC_PORT1_MPU_RANGE(_X_)				(_X_)

/* bits definitions for register REG_MM_AHB_RF_DMC_PORT2_MPU_RANGE */
#define BITS_DMC_PORT2_MPU_RANGE(_X_)				(_X_)

/* bits definitions for register REG_MM_AHB_RF_DMC_PORT3_MPU_RANGE */
#define BITS_DMC_PORT3_MPU_RANGE(_X_)				(_X_)

/* bits definitions for register REG_MM_AHB_RF_DMC_PORT4_MPU_RANGE */
#define BITS_DMC_PORT4_MPU_RANGE(_X_)				(_X_)

/* bits definitions for register REG_MM_AHB_RF_DMC_PORT5_MPU_RANGE */
#define BITS_DMC_PORT5_MPU_RANGE(_X_)				(_X_)

/* bits definitions for register REG_MM_AHB_RF_DMC_PORT6_MPU_RANGE */
#define BITS_DMC_PORT6_MPU_RANGE(_X_)				(_X_)

/* bits definitions for register REG_MM_AHB_RF_DMC_PORT7_MPU_RANGE */
#define BITS_DMC_PORT7_MPU_RANGE(_X_)				(_X_)

/* bits definitions for register REG_MM_AHB_RF_DMC_PORT8_MPU_RANGE */
#define BITS_DMC_PORT8_MPU_RANGE(_X_)				(_X_)

/* bits definitions for register REG_MM_AHB_RF_DMC_PORT9_MPU_RANGE */
#define BITS_DMC_PORT9_MPU_RANGE(_X_)				(_X_)

/* bits definitions for register REG_MM_AHB_RF_DMC_PORT0_DUMP_ADDR */
#define BITS_DMC_PORT0_DUMP_ADDR(_X_)				(_X_)

/* bits definitions for register REG_MM_AHB_RF_DMC_PORT1_DUMP_ADDR */
#define BITS_DMC_PORT1_DUMP_ADDR(_X_)				(_X_)

/* bits definitions for register REG_MM_AHB_RF_DMC_PORT2_DUMP_ADDR */
#define BITS_DMC_PORT2_DUMP_ADDR(_X_)				(_X_)

/* bits definitions for register REG_MM_AHB_RF_DMC_PORT3_DUMP_ADDR */
#define BITS_DMC_PORT3_DUMP_ADDR(_X_)				(_X_)

/* bits definitions for register REG_MM_AHB_RF_DMC_PORT4_DUMP_ADDR */
#define BITS_DMC_PORT4_DUMP_ADDR(_X_)				(_X_)

/* bits definitions for register REG_MM_AHB_RF_DMC_PORT5_DUMP_ADDR */
#define BITS_DMC_PORT5_DUMP_ADDR(_X_)				(_X_)

/* bits definitions for register REG_MM_AHB_RF_DMC_PORT6_DUMP_ADDR */
#define BITS_DMC_PORT6_DUMP_ADDR(_X_)				(_X_)

/* bits definitions for register REG_MM_AHB_RF_DMC_PORT7_DUMP_ADDR */
#define BITS_DMC_PORT7_DUMP_ADDR(_X_)				(_X_)

/* bits definitions for register REG_MM_AHB_RF_DMC_PORT8_DUMP_ADDR */
#define BITS_DMC_PORT8_DUMP_ADDR(_X_)				(_X_)

/* bits definitions for register REG_MM_AHB_RF_DMC_PORT9_DUMP_ADDR */
