/* the head file modifier:     g   2015-03-19 17:13:17*/
...
#define REG_MM_AHB_MM_QOS_CFG0			SCI_ADDR(REGS_MM_AHB_BASE, 0x0010)/*MM_QOS_CFG0*/
#define REG_MM_AHB_MM_QOS_CFG1			SCI_ADDR(REGS_MM_AHB_BASE, 0x0014)/*MM_QOS_CFG1*/
#define REG_MM_AHB_RF_AHB_EB                              REG_MM_AHB_AHB_EB
#define REG_MM_AHB_RF_AHB_RST                             REG_MM_AHB_AHB_RST
#define REG_MM_AHB_RF_GEN_CKG_CFG                         REG_MM_AHB_GEN_CKG_CFG
#define REG_MM_AHB_RF_MIPI_CSI2_CTRL                      REG_MM_AHB_MIPI_CSI2_CTRL
#define REG_MM_AHB_RF_MM_QOS_CFG                          REG_MM_AHB_MM_QOS_CFG0
...
#define BIT_MM_CKG_EB       			BIT_CKG_EB
...
#define BIT_MM_CKG_SOFT_RST     			BIT_CKG_SOFT_RST
...
/* bits definitions for register REG_MM_AHB_MM_QOS_CFG0 */
...
/* bits definitions for register REG_MM_AHB_MM_QOS_CFG1 */
#define BITS_QOS_R_VPP(_X_)					( (_X_) << 12 & (BIT(12)|BIT(13)|BIT(14)|BIT(15)) )
#define BITS_QOS_W_VPP(_X_)					( (_X_) << 8 & (BIT(8)|BIT(9)|BIT(10)|BIT(11)) )
#define BITS_QOS_R_CODEC(_X_)					( (_X_) << 4 & (BIT(4)|BIT(5)|BIT(6)|BIT(7)) )
#define BITS_QOS_W_CODEC(_X_)					( (_X_) & (BIT(0)|BIT(1)|BIT(2)|BIT(3)) )
