...
struct sysdump_mem sprd_dump_mem[] = {
	...
	},
	{
		...
		.vaddr = PAGE_OFFSET +	(CPT_START_ADDR - CONFIG_PHYS_OFFSET),
		.soff  = 0xffffffff,
		.size  = CPT_TOTAL_SIZE,
	...
	},
	{
		...
		.vaddr = PAGE_OFFSET +	(CPW_START_ADDR - CONFIG_PHYS_OFFSET),
		.soff  = 0xffffffff,
		.size  = CPW_TOTAL_SIZE,
	...
	},
	{
		...
		.vaddr = PAGE_OFFSET + (GGE_START_ADDR - CONFIG_PHYS_OFFSET),
		.soff  = 0xffffffff,
		.size  = GGE_TOTAL_SIZE,
	...
	},
	{
		...
		.vaddr = PAGE_OFFSET + (LTE_START_ADDR - CONFIG_PHYS_OFFSET),
		.soff  = 0xffffffff,
		.size  = LTE_TOTAL_SIZE,
...
/*		.type  = SYSDUMP_RAM,
	...
	},
	{
		...
		.soff  = 0xffffffff,
		.size  = 0,  /* fill this dynamically
				according to real ram size */
		.type  = SYSDUMP_RAM,
	},
#endif
/*	{
