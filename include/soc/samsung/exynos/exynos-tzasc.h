...
#define TZASC_INTR_STATUS_INTR_STAT_MASK		(0xFF << 0)
#define TZASC_INTR_STATUS_OVERRUN_MASK			(0xFF << 8)
...
#define TZASC_FAIL_CONTROL_DIRECTION_MASK		(0x1 << 1)
#define TZASC_FAIL_CONTROL_DIRECTION_MASK_TZC380	(0xF << 4)
