...
/**
 * VTS hw params fixup helper
 * @param[in]	rtd	snd_soc_pcm_runtime
 * @param[out]	params	snd_pcm_hw_params
 * @return		error code if any
 */
extern int vts_hw_params_fixup_helper(struct snd_soc_pcm_runtime *rtd,
		struct snd_pcm_hw_params *params);

/**
 * Notifier for bargein call
 */
...
static inline void vts_bargein_call_notifier(void) { return; }
static inline int vts_hw_params_fixup_helper(struct snd_soc_pcm_runtime *rtd,
