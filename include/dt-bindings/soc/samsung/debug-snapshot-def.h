/*
 * Dxynos-SnapShot for Samsung's SoC's.
 *
...
#define DSS_LOG_TEEGRIS_SIZE		SZ_8K
#define DSS_LOG_LAST_SIZE		(2 * SZ_1M)
...
#define DSS_LOG_TEEGRIS_OFFSET		(DSS_LOG_FATAL_OFFSET + DSS_LOG_FATAL_SIZE)
#define DSS_LOG_LAST_OFFSET		(DSS_LOG_TEEGRIS_OFFSET + DSS_LOG_TEEGRIS_SIZE)
...
#define DSS_LOG_TEEGRIS_ADDR		(DSS_START_ADDR + DSS_LOG_TEEGRIS_OFFSET)
#define DSS_LOG_LAST_ADDR		(DSS_START_ADDR + DSS_LOG_LAST_OFFSET)
...
#define DSS_ITEM_LAST			"log_last"
#define DSS_ITEM_LAST_ID		(14)
