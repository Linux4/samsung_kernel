...
#ifndef S5E8825_DEBUG_H
#define S5E8825_DEBUG_H
...
#define DSS_S2D_SIZE		(10 * SZ_1M)
#define DSS_ARRAYRESET_SIZE	((2 * SZ_1M) + SZ_256K)
#define DSS_ARRAYPANIC_SIZE	((2 * SZ_1M) + SZ_256K)
