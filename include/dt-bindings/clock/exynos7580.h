...
#define CLK_PCLK_PPMU_MFC			(CLK_MFC_BASE + 4)
#define CLK_PCLK_SASYNC_AHB2APB_MFC		(CLK_MFC_BASE + 5)
#define CLK_PCLK_MFC				(CLK_MFC_BASE + 6)
#define CLK_ACLK_BUS_D_MFC			(CLK_MFC_BASE + 7)
#define CLK_ACLK_UPSIZER_MFC			(CLK_MFC_BASE + 8)
#define CLK_ACLK_PPMU_MFC			(CLK_MFC_BASE + 9)
#define CLK_ACLK_SASYNC_AHB2APB_MFC		(CLK_MFC_BASE + 10)
#define CLK_ACLK_AHB2APB_MFC			(CLK_MFC_BASE + 11)
...
#define CLK_PCLK_AHB_JPEG			(CLK_M2M_SCALER_BASE + 7)
...
#define CLK_ACLK_DISP_200			(CLK_DISP_BASE + 29)
