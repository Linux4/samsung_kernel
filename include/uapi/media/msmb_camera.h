...
#define MSM_MAX_CAMERA_SENSORS  16//bug515614 yinjie1.wt, add,2019/12/02,86118 project camera kernel code for bring up ,modify camera id(main back:0,front:1,back aux:50,back wide:51,bokeh:21) 
