...
FUNC_BUILD_DTIMAGE_TARGET()
{
	...
	cp $BUILD_KERNEL_OUT_DIR/arch/arm/boot/dts/samsung/sdm450/*.dtb $BUILD_KERNEL_OUT_DIR/arch/arm/boot/dts/.
...
#	fi
	...
	make -C $BUILD_KERNEL_DIR O=$BUILD_KERNEL_OUT_DIR -j1 ARCH=arm \
